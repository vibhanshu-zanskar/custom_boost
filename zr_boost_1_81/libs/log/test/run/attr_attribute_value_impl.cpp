...
namespace {
    ...
    struct my_dispatcher :
        public logging::static_type_dispatcher<
            zr_boost_1_81::mpl::vector< int, double, std::string >
        >
    {
...
{
    zr_boost_1_81::intrusive_ptr< logging::attribute_value::impl > p1(new attrs::attribute_value_impl< int >(10));
    zr_boost_1_81::intrusive_ptr< logging::attribute_value::impl > p2 = p1->detach_from_thread();
    BOOST_CHECK(!!p2);
}
