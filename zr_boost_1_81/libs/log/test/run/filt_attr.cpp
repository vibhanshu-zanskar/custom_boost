...
namespace zr_boost_1_81phoenix = zr_boost_1_81::zr_boost_1_81phoenix;
...
// The test checks that zr_boost_1_81phoenix::bind interaction works
BOOST_AUTO_TEST_CASE(bind_support_check)
{
    ...
    filter f = zr_boost_1_81phoenix::bind(predicate(present_counter, predicate_result), expr::attr< int >(data::attr1()));
    ...
    f = zr_boost_1_81phoenix::bind(predicate(present_counter, predicate_result), expr::attr< logging::numeric_types >(data::attr2()));
    BOOST_CHECK_EQUAL(f(values1), predicate_result);
    BOOST_CHECK_EQUAL(present_counter, 3U);

    f = zr_boost_1_81phoenix::bind(predicate(present_counter, predicate_result), expr::attr< int >(data::attr2()).or_throw());
    BOOST_CHECK_THROW(f(values1), logging::runtime_error);
    f = zr_boost_1_81phoenix::bind(predicate(present_counter, predicate_result), expr::attr< int >(data::attr2()));
    BOOST_CHECK_EQUAL(f(values1), true);
    BOOST_CHECK_EQUAL(present_counter, 3U);

    f = zr_boost_1_81phoenix::bind(predicate(present_counter, predicate_result), expr::attr< int >(data::attr4()).or_throw());
    BOOST_CHECK_THROW(f(values1), logging::runtime_error);
    f = zr_boost_1_81phoenix::bind(predicate(present_counter, predicate_result), expr::attr< int >(data::attr4()));
    BOOST_CHECK_EQUAL(f(values1), true);
    BOOST_CHECK_EQUAL(present_counter, 3U);
}
