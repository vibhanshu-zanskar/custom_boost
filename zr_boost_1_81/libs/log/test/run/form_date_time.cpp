...
typedef zr_boost_1_81::posix_time::ptime ptime;
typedef zr_boost_1_81::gregorian::date gdate;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(date_time, CharT, char_types)
{
    ...
    typedef zr_boost_1_81::date_time::time_facet< ptime, CharT > facet;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(date, CharT, char_types)
{
    ...
    typedef test_data< CharT > data;
    typedef date_time_formats< CharT > formats;
    typedef zr_boost_1_81::date_time::date_facet< gdate, CharT > facet;
