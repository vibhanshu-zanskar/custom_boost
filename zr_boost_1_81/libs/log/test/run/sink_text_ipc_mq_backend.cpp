...
const zr_boost_1_81::log::ipc::object_name ipc_queue_name(zr_boost_1_81::log::ipc::object_name::session, "boost_log_test_text_ipc_mq_backend");
...
BOOST_AUTO_TEST_CASE(text_ipc_message_queue_backend)
{
    ...
    typedef zr_boost_1_81::log::sinks::text_ipc_message_queue_backend< queue_t > backend_t;
    ...
    zr_boost_1_81::log::record_view rec = make_record_view();
