...
BOOST_AUTO_TEST_CASE_TEMPLATE(width_formatting, CharT, char_types)
{
    ...
    test::BOOST_NESTED_TEMPLATE width_formatting< zr_boost_1_81::basic_string_view< CharT > >();
#if !defined(BOOST_NO_CXX17_HDR_STRING_VIEW)
...
BOOST_AUTO_TEST_CASE_TEMPLATE(fill_formatting, CharT, char_types)
{
    ...
    test::BOOST_NESTED_TEMPLATE fill_formatting< zr_boost_1_81::basic_string_view< CharT > >();
#if !defined(BOOST_NO_CXX17_HDR_STRING_VIEW)
...
BOOST_AUTO_TEST_CASE_TEMPLATE(alignment, CharT, char_types)
{
    ...
    test::BOOST_NESTED_TEMPLATE alignment< zr_boost_1_81::basic_string_view< CharT > >();
#if !defined(BOOST_NO_CXX17_HDR_STRING_VIEW)
...
BOOST_AUTO_TEST_CASE_TEMPLATE(rvalue_stream, CharT, char_types)
{
    ...
    test::BOOST_NESTED_TEMPLATE rvalue_stream< zr_boost_1_81::basic_string_view< CharT > >();
#if !defined(BOOST_NO_CXX17_HDR_STRING_VIEW)
...
BOOST_AUTO_TEST_CASE(character_code_conversion)
{
    ...
    test_narrowing_code_conversion< zr_boost_1_81::wstring_view >();
    test_widening_code_conversion< zr_boost_1_81::string_view >();
#if !defined(BOOST_NO_CXX17_HDR_STRING_VIEW)
