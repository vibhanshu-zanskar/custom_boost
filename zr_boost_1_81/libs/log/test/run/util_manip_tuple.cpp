...
BOOST_AUTO_TEST_CASE_TEMPLATE(tuple_char_separator, CharT, char_types)
{
    ...
    zr_boost_1_81::tuple< int, my_int_wrapper, string_type > data(1, my_int_wrapper(5), string_type(test_data_type::abc()));
...
BOOST_AUTO_TEST_CASE_TEMPLATE(tie_string_separator, CharT, char_types)
{
    ...
    ostream_type strm_dump;
    strm_dump << logging::tuple_manip(zr_boost_1_81::tie(x, y, z), ", ");
