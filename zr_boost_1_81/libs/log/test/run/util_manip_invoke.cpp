...
BOOST_AUTO_TEST_CASE_TEMPLATE(invoke_boost_bind, CharT, char_types)
{
    ...
    {
        ostream_type strm_dump;
        strm_dump << logging::invoke_manip(zr_boost_1_81::bind(my_function1(), zr_boost_1_81::placeholders::_1, 10));

        ostream_type strm_correct;
        zr_boost_1_81::bind(my_function1(), zr_boost_1_81::placeholders::_1, 10)(strm_correct);

        BOOST_CHECK(equal_strings(strm_dump.str(), strm_correct.str()));
    }
    {
        ostream_type strm_dump;
        strm_dump << logging::invoke_manip(zr_boost_1_81::bind(&free_function< ostream_type >, zr_boost_1_81::placeholders::_1, 10));

        ostream_type strm_correct;
        zr_boost_1_81::bind(&free_function< ostream_type >, zr_boost_1_81::placeholders::_1, 10)(strm_correct);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(invoke_lambda_args_ref, CharT, char_types)
{
    ...
    strm_dump << logging::invoke_manip([](ostream_type& strm, int x, int y, int& z)
    {
        strm << "lambda(" << x << ", " << y << ", " << z << ")";
        ++z;
    }, 10, 20, zr_boost_1_81::ref(external_var));
