...
BOOST_AUTO_TEST_CASE(type_dispatch)
{
    ...
    disp.register_type< int >(zr_boost_1_81::bind(&my_visitor::on_int, &vis, zr_boost_1_81::placeholders::_1));
    disp.register_type< double >(zr_boost_1_81::bind(&my_visitor::on_double, &vis, zr_boost_1_81::placeholders::_1));
    ...
    // And now they are
    disp.register_type< std::string >(zr_boost_1_81::bind(&my_visitor::on_string, &vis, zr_boost_1_81::placeholders::_1));
