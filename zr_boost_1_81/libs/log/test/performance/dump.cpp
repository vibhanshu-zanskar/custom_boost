...
void test(std::size_t block_size)
{
    ...
    std::vector< zr_boost_1_81::uint8_t > data;
    ...
    const zr_boost_1_81::uint8_t* const p = &data[0];

    zr_boost_1_81::uint64_t data_processed = 0, duration = 0;
    zr_boost_1_81::posix_time::ptime start, end;
    start = zr_boost_1_81::date_time::microsec_clock< zr_boost_1_81::posix_time::ptime >::universal_time();
    do
    {
