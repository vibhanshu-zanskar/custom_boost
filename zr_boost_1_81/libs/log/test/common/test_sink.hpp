...
struct test_sink :
    public zr_boost_1_81::log::sinks::sink
{
public:
    typedef zr_boost_1_81::log::attribute_value_set attribute_values;
    typedef zr_boost_1_81::log::record_view record_type;
    typedef zr_boost_1_81::log::filter filter_type;
...
public:
    test_sink() : zr_boost_1_81::log::sinks::sink(false), m_RecordCounter(0) {}
