...
// This warning is caused by a compiler bug which is exposed when zr_boost_1_81::optional is used: https://gcc.gnu.org/bugzilla/show_bug.cgi?id=47679
...
namespace qi = zr_boost_1_81::spirit::qi;
...
struct is_case_insensitive_equal
{
    ...
    {
        typedef typename zr_boost_1_81::log::aux::encoding< CharT >::type encoding;
...
inline bool param_cast_to_bool(const char* param_name, std::basic_string< CharT > const& value)
{
    ...
    typedef zr_boost_1_81::log::aux::char_constants< char_type > constants;
    typedef zr_boost_1_81::log::basic_string_literal< char_type > literal_type;
...
inline sinks::auto_newline_mode param_cast_to_auto_newline_mode(const char* param_name, std::basic_string< CharT > const& value)
{
    ...
    else
    {
        BOOST_LOG_THROW_DESCR(invalid_value,
            "Auto newline mode \"" + zr_boost_1_81::log::aux::to_narrow(value) + "\" is not supported");
    }
}
...
template< typename CharT >
inline bool is_weekday(const CharT* str, std::size_t len, zr_boost_1_81::log::basic_string_literal< CharT > const& weekday, zr_boost_1_81::log::basic_string_literal< CharT > const& short_weekday)
{
...
sinks::file::rotation_at_time_point param_cast_to_rotation_time_point(const char* param_name, std::basic_string< CharT > const& value)
{
    typedef CharT char_type;
    typedef zr_boost_1_81::log::aux::char_constants< char_type > constants;
    typedef typename zr_boost_1_81::log::aux::encoding< char_type >::type encoding;
...
protected:
    ...
    static shared_ptr< sinks::sink > init_sink(shared_ptr< BackendT > const& backend, settings_section const& params)
    {
        ...
        if (!async)
        {
            p = init_formatter(zr_boost_1_81::make_shared< sinks::synchronous_sink< backend_t > >(backend), params, is_formatting_t());
        }
        else
        {
            p = init_formatter(zr_boost_1_81::make_shared< sinks::asynchronous_sink< backend_t > >(backend), params, is_formatting_t());
        ...
        p = init_formatter(zr_boost_1_81::make_shared< sinks::unlocked_sink< backend_t > >(backend), params, is_formatting_t());
#endif
...
private:
    ...
    struct impl
    {
        ...
        result_type operator() (settings_section const& params, type< BackendCharT >) const
        {
            ...
            typedef zr_boost_1_81::log::aux::char_constants< BackendCharT > constants;
            typedef sinks::basic_text_ostream_backend< BackendCharT > backend_t;
            shared_ptr< backend_t > backend = zr_boost_1_81::make_shared< backend_t >();
            backend->add_stream(shared_ptr< typename backend_t::stream_type >(&constants::get_console_log_stream(), zr_boost_1_81::null_deleter()));
    ...
    shared_ptr< sinks::sink > create_sink(settings_section const& params) BOOST_OVERRIDE
    {
        ...
        if (optional< string_type > target_param = params["Target"])
        {
            ...
            if (optional< string_type > scan_param = params["ScanForFiles"])
            {
                ...
                {
                    BOOST_LOG_THROW_DESCR(invalid_value,
                        "File scan method \"" + zr_boost_1_81::log::aux::to_narrow(value) + "\" is not supported");
                }
            }
        }
    ...
    public log::aux::lazy_singleton< sinks_repository< CharT > >
{
    ...
    typedef zr_boost_1_81::log::aux::char_constants< char_type > constants;
    typedef zr_boost_1_81::shared_ptr< sink_factory< char_type > > sink_factory_ptr;
    ...
    static void init_instance()
    {
        ...
        instance.m_Factories["TextFile"] = zr_boost_1_81::make_shared< default_text_file_sink_factory< char_type > >();
        instance.m_Factories["Console"] = zr_boost_1_81::make_shared< default_console_sink_factory< char_type > >();
#ifndef BOOST_LOG_WITHOUT_SYSLOG
        instance.m_Factories["Syslog"] = zr_boost_1_81::make_shared< default_syslog_sink_factory< char_type > >();
#endif
#ifndef BOOST_LOG_WITHOUT_DEBUG_OUTPUT
        instance.m_Factories["Debugger"] = zr_boost_1_81::make_shared< default_debugger_sink_factory< char_type > >();
#endif
#ifndef BOOST_LOG_WITHOUT_EVENT_LOG
        instance.m_Factories["SimpleEventLog"] = zr_boost_1_81::make_shared< default_simple_event_log_sink_factory< char_type > >();
#endif
    }
...
void apply_core_settings(basic_settings_section< CharT > const& params)
{
    ...
    core_ptr core = zr_boost_1_81::log::core::get();
...
BOOST_LOG_SETUP_API void init_from_settings(basic_settings_section< CharT > const& setts)
{
    ...
    if (section sink_params = setts["Sinks"])
    {
        ...
        std::for_each(new_sinks.begin(), new_sinks.end(), zr_boost_1_81::bind(&core::add_sink, core::get(), zr_boost_1_81::placeholders::_1));
    }
}
