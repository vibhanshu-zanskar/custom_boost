...
#endif
        m_first(zr_boost_1_81::move(first)), m_second(zr_boost_1_81::move(second))
    {
    }
...
#if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES)
    explicit literal_formatter(string_type&& str) : m_str(zr_boost_1_81::move(str))
#else
...
public:
    ...
    formatter_type get_formatter()
    {
        ...
        return zr_boost_1_81::move(m_Formatter.get());
    }
...
private:
    ...
    void push_string(iterator_type begin, iterator_type end)
    {
        ...
        append_formatter(literal_formatter< char_type >(zr_boost_1_81::move(s)));
    }
    ...
    {
        if (!!m_Formatter)
            m_Formatter = zr_boost_1_81::in_place(chained_formatter< char_type, FormatterT >(zr_boost_1_81::move(m_Formatter.get()), zr_boost_1_81::move(fmt)));
        else
            m_Formatter = zr_boost_1_81::in_place(zr_boost_1_81::move(fmt));
    }
