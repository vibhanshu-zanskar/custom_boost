...
inline const char* severity_level_to_string(zr_boost_1_81::log::trivial::severity_level lvl)
{
    switch (lvl)
    {
    case zr_boost_1_81::log::trivial::trace:
        return "[trace]  ";
    case zr_boost_1_81::log::trivial::debug:
        return "[debug]  ";
    case zr_boost_1_81::log::trivial::info:
        return "[info]   ";
    case zr_boost_1_81::log::trivial::warning:
        return "[warning]";
    case zr_boost_1_81::log::trivial::error:
        return "[error]  ";
    case zr_boost_1_81::log::trivial::fatal:
        return "[fatal]  ";
    default:
        return "[-]      ";
    }
...
struct message_printer
{
    ...
    explicit message_printer(zr_boost_1_81::log::trivial::severity_level lvl) : m_level(lvl)
    {
    }
    ...
    result_type operator() (std::string const& msg) const
    {
        ...
        zr_boost_1_81::log::aux::format_thread_id(thread_id_buf, sizeof(thread_id_buf), zr_boost_1_81::log::aux::this_thread::get_id());
#endif
...
private:
    const zr_boost_1_81::log::trivial::severity_level m_level;
};
...
default_sink::default_sink() :
    sink(false),
    m_severity_name(zr_boost_1_81::log::aux::default_attribute_names::severity()),
    m_message_name(zr_boost_1_81::log::aux::default_attribute_names::message()),
    m_severity_extractor(zr_boost_1_81::log::trivial::info)
{
}
