...
private:
    ...
    //! A list of buckets
    typedef zr_boost_1_81::array< bucket, 1u << BOOST_LOG_HASH_TABLE_SIZE_LOG > buckets;
...
{
    m_pImpl = implementation::create(zr_boost_1_81::move(source_attrs), thread_attrs, global_attrs, reserve_count);
}
