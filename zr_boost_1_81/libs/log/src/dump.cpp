            ...
            if (max_cpuid_function >= 7)
            {
                ...
                if (ecx & (1u << 27))
                {
                    ...
                    if (hKernel32)
                    {
                        ...
                        get_enabled_extended_features_t get_enabled_extended_features = (get_enabled_extended_features_t)zr_boost_1_81::winapi::get_proc_address(hKernel32, "GetEnabledExtendedFeatures");
