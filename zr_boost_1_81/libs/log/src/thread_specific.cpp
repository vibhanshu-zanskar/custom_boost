...
thread_specific_base::thread_specific_base()
{
    ...
    {
        BOOST_LOG_THROW_DESCR_PARAMS(system_error, "TLS capacity depleted", (zr_boost_1_81::system::errc::not_enough_memory));
    }
}
...
template< typename KeyT, bool IsStoreableV = sizeof(KeyT) <= sizeof(void*), bool IsIntegralV = zr_boost_1_81::is_integral< KeyT >::value >
...
struct pthread_key_traits< KeyT, true, true >
{
    ...
    typedef typename zr_boost_1_81::conditional<
        zr_boost_1_81::is_signed< pthread_key_type >::value,
        intptr_t,
        uintptr_t
    >::type intptr_type;
#else
