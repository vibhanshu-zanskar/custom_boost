...
namespace karma = zr_boost_1_81::spirit::karma;
...
private:
    typedef zr_boost_1_81::log::aux::light_function< void (stream_type&, value_type const&) > formatter_type;
...
public:
    ...
    {
        m_formatters.emplace_back(zr_boost_1_81::forward< FunT >(fun));
    }
#else
    template< typename FunT >
...
template< typename CharT >
BOOST_FORCEINLINE zr_boost_1_81::log::aux::light_function< void (basic_formatting_ostream< CharT >&, attributes::named_scope::value_type::value_type const&) >
do_parse_named_scope_format(const CharT* begin, const CharT* end)
{
    typedef CharT char_type;
    typedef zr_boost_1_81::log::aux::light_function< void (basic_formatting_ostream< char_type >&, attributes::named_scope::value_type::value_type const&) > result_type;
    ...
    return result_type(zr_boost_1_81::move(fmt));
}
