...
public:
    explicit auto_handle(zr_boost_1_81::winapi::HANDLE_ h = NULL) BOOST_NOEXCEPT : m_handle(h)
    {
    }
    ...
    void init(zr_boost_1_81::winapi::HANDLE_ h) BOOST_NOEXCEPT
    {
        BOOST_ASSERT(m_handle == NULL);
        m_handle = h;
    }

    zr_boost_1_81::winapi::HANDLE_ get() const BOOST_NOEXCEPT { return m_handle; }
    zr_boost_1_81::winapi::HANDLE_* get_ptr() BOOST_NOEXCEPT { return &m_handle; }

    void swap(auto_handle& that) BOOST_NOEXCEPT
    {
        zr_boost_1_81::winapi::HANDLE_ h = m_handle;
