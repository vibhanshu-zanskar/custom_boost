...
BOOST_LOG_ANONYMOUS_NAMESPACE {
    ...
    void init_self_module_handle(HMODULE& handle)
    {
        ...
        if (!handle)
            BOOST_LOG_THROW_DESCR_PARAMS(system_error, "Could not find self module information", (zr_boost_1_81::system::windows_error::invalid_handle));
    }
...
struct basic_event_log_backend< CharT >::implementation
{
    ...
    //        as it ICEs if zr_boost_1_81::functions are not the first members. Doh!
