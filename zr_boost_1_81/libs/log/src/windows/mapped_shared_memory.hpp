...
private:
    ...
    {
        void* base_address;
        zr_boost_1_81::winapi::ULONG_ section_attributes;
        zr_boost_1_81::winapi::LARGE_INTEGER_ section_size;
    };
    typedef zr_boost_1_81::winapi::NTSTATUS_ (__stdcall *nt_query_section_t)(zr_boost_1_81::winapi::HANDLE_ h, unsigned int info_class, section_basic_information* pinfo, zr_boost_1_81::winapi::ULONG_ info_size, zr_boost_1_81::winapi::ULONG_* ret_len);

private:
    zr_boost_1_81::winapi::HANDLE_ m_handle;
    void* m_mapped_address;
    std::size_t m_size;
    static zr_boost_1_81::atomic< nt_query_section_t > nt_query_section;
...
private:
    ...
    static std::size_t obtain_size(zr_boost_1_81::winapi::HANDLE_ h);
};
