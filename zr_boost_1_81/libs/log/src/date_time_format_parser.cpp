...
template< typename CharT >
BOOST_LOG_API void put_integer(zr_boost_1_81::log::aux::basic_ostringstreambuf< CharT >& strbuf, uint32_t value, unsigned int width, CharT fill_char)
{
    typedef CharT char_type;
...
template BOOST_LOG_API
void put_integer(zr_boost_1_81::log::aux::basic_ostringstreambuf< char >& strbuf, uint32_t value, unsigned int width, char fill_char);
...
template BOOST_LOG_API
void put_integer(zr_boost_1_81::log::aux::basic_ostringstreambuf< wchar_t >& strbuf, uint32_t value, unsigned int width, wchar_t fill_char);
