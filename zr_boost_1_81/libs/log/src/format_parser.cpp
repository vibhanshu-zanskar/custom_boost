        ...
        if ((end - p) >= 2)
        {
            ...
            if (traits::isdigit(c))
            {
                if (c != static_cast< char_type >('0'))
                {
                    ...
                    {
                        zr_boost_1_81::throw_exception(zr_boost_1_81::enable_error_info(parse_error("Invalid positional format placeholder")) << zr_boost_1_81::throw_file(__FILE__) << zr_boost_1_81::throw_line(__LINE__)
                            << zr_boost_1_81::log::position_info(static_cast< unsigned int >(p - original_begin))
                        );
                    }
                    ...
                    if (n > 1000)
                    {
                        zr_boost_1_81::throw_exception(zr_boost_1_81::enable_error_info(limitation_error("Positional format placeholder too big")) << zr_boost_1_81::throw_file(__FILE__) << zr_boost_1_81::throw_line(__LINE__)
                            << zr_boost_1_81::log::position_info(static_cast< unsigned int >(p - original_begin))
                        );
                    }
            ...
            zr_boost_1_81::throw_exception(zr_boost_1_81::enable_error_info(parse_error("Unsupported format placeholder")) << zr_boost_1_81::throw_file(__FILE__) << zr_boost_1_81::throw_line(__LINE__)
                << zr_boost_1_81::log::position_info(static_cast< unsigned int >(p - original_begin))
            );
        }
        else
