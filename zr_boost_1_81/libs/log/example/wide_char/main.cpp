...
BOOST_LOG_ATTRIBUTE_KEYWORD(timestamp, "TimeStamp", zr_boost_1_81::posix_time::ptime)

void init_logging()
{
    zr_boost_1_81::shared_ptr< sinks::synchronous_sink< sinks::text_file_backend > > sink = logging::add_file_log
    (
        "sample.log",
    ...
    std::locale loc = zr_boost_1_81::locale::generator()("en_US.UTF-8");
    sink->imbue(loc);
