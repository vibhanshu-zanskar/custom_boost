...
int main(int argc, char* argv[])
{
...

    {
        ...
        shared_ptr< std::ostream > pStream(&std::clog, zr_boost_1_81::null_deleter());
    ...
    pSink->set_formatter(expr::stream
        ...
        << " [" << expr::format_date_time< zr_boost_1_81::posix_time::ptime >("TimeStamp", "%d.%m.%Y %H:%M:%S.%f")
        << "] [" << expr::attr< severity_level >("Severity")
        << "] [" << expr::attr< zr_boost_1_81::posix_time::time_duration >("Uptime")
