...
void thread_fun(zr_boost_1_81::barrier& bar)
{
...
int main(int argc, char* argv[])
{
    try
    {
        ...
        shared_ptr< sink_t > sink(new sink_t(
            zr_boost_1_81::make_shared< backend_t >(),
        ...
        (
            expr::format("%1%: [%2%] [%3%] - %4%")
                ...
                % expr::attr< zr_boost_1_81::posix_time::ptime >("TimeStamp")
                % expr::attr< zr_boost_1_81::thread::id >("ThreadID")
                % expr::smessage
        );
        ...
        for (unsigned int i = 0; i < THREAD_COUNT; ++i)
            threads.create_thread(zr_boost_1_81::bind(&thread_fun, zr_boost_1_81::ref(bar)));
