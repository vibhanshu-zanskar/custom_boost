...
struct scope_list_formatter
{
    ...
    void operator()(logging::record_view const& rec, logging::formatting_ostream& strm) const
    {
        ...
        (
            ...
            zr_boost_1_81::bind(&scope_list_formatter::format, zr_boost_1_81::placeholders::_1, zr_boost_1_81::ref(strm))
        );
    }
...
void init_logging()
{
    ...
    logging::register_formatter_factory("MyScopes", zr_boost_1_81::make_shared< my_scopes_formatter_factory >());
