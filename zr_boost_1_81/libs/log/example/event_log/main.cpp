...
void init_logging()
{
    ...
    zr_boost_1_81::shared_ptr< sinks::event_log_backend > backend(
    ...
    composer[LOW_DISK_SPACE_MSG]
        ...
        % expr::attr< zr_boost_1_81::uintmax_t >("Size");
    ...
    zr_boost_1_81::shared_ptr< sinks::synchronous_sink< sinks::event_log_backend > > sink(
...
void announce_low_disk_space(std::string const& drive, zr_boost_1_81::uintmax_t size)
{
