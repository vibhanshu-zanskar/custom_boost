...
//[example_code
#define BOOST_TEST_MODULE zr_boost_1_81_test_container_lex
...
BOOST_AUTO_TEST_CASE( test_compare_c_arrays_lexicographic )
{
  ...
  // BOOST_TEST(a == b, zr_boost_1_81::test_tools::lexicographic()); // does not compile
  // BOOST_TEST(a != b, zr_boost_1_81::test_tools::lexicographic()); // does not compile
  BOOST_TEST(a < b, zr_boost_1_81::test_tools::lexicographic());
  BOOST_TEST(b < c, zr_boost_1_81::test_tools::lexicographic());
  BOOST_TEST(c < a, zr_boost_1_81::test_tools::lexicographic());
}
//]
