...
//[example_code
#define BOOST_TEST_MODULE zr_boost_1_81_test_sequence_per_element
...
BOOST_AUTO_TEST_CASE( test_compare_c_arrays_element_wise )
{
  ...
  BOOST_TEST(a == b, zr_boost_1_81::test_tools::per_element());
  BOOST_TEST(a != b, zr_boost_1_81::test_tools::per_element());
  BOOST_TEST(a < b, zr_boost_1_81::test_tools::per_element());
  BOOST_TEST(b < c, zr_boost_1_81::test_tools::per_element());
  BOOST_TEST(c < a, zr_boost_1_81::test_tools::per_element());
}
//]
