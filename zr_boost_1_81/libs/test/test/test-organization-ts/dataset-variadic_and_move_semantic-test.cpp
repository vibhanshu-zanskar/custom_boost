...
namespace zr_boost_1_81 { namespace unit_test { namespace data { namespace monomorphic {
  // registering fibonacci_dataset as a proper dataset
  template <>
  struct is_dataset< fibonacci_dataset<int> > : zr_boost_1_81::mpl::true_ {};

  template <>
  struct is_dataset< fibonacci_dataset<non_copyable_type> > : zr_boost_1_81::mpl::true_ {};
}}}}
