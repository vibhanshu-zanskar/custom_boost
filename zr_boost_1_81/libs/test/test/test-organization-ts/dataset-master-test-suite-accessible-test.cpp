...
public:
    ...
    zr_boost_1_81::unit_test::data::size_t size() const {
...
dataset_loader::dataset_loader()
{
    ...
    int argc = zr_boost_1_81::unit_test::framework::master_test_suite().argc;
    char** argv = zr_boost_1_81::unit_test::framework::master_test_suite().argv;
...
namespace zr_boost_1_81 { namespace unit_test { namespace data {

namespace monomorphic {
  template <>
  struct is_dataset<dataset_loader> : zr_boost_1_81::mpl::true_ {};
}
}}}
...
BOOST_DATA_TEST_CASE(master_access_zips,
    zr_boost_1_81::unit_test::data::make_delayed<dataset_loader>( ) ^ zr_boost_1_81::unit_test::data::make(expected),
    input, expect)
{
    // ...
...
BOOST_DATA_TEST_CASE(master_access_zips_flip,
    zr_boost_1_81::unit_test::data::make_delayed<dataset_loader>( ) ^ dataset_loader({"--param1=1", "--param2=2"}),
    input, expect)
{
    BOOST_TEST(input == expect);
}
...
BOOST_DATA_TEST_CASE(master_access_zips_args_forward,
    zr_boost_1_81::unit_test::data::make_delayed<dataset_loader>( "--param1=1", "--param2=2" ) ^ zr_boost_1_81::unit_test::data::make_delayed<dataset_loader>( ),
    input, expect)
{
    BOOST_TEST(input == expect);
}
...
BOOST_DATA_TEST_CASE(master_access_grid_flip,
    dataset_loader({"--param1=1", "--param2=2"}) * zr_boost_1_81::unit_test::data::make_delayed<dataset_loader>( ),
    input, expect)
{
    BOOST_TEST((input == expect || input == "--param1=1" || expect == "--param1=1" ));
}
...
BOOST_DATA_TEST_CASE(master_access_joins_flip,
    dataset_loader({"--param2=2", "--param1=1"}) + zr_boost_1_81::unit_test::data::make_delayed<dataset_loader>( ),
    input)
{
...
namespace monomorphic {
  template <>
  struct is_dataset<dataset_loader_arity3> : zr_boost_1_81::mpl::true_ {};
}
}}}

BOOST_DATA_TEST_CASE(master_access_make_ds_with_arity,
    zr_boost_1_81::unit_test::data::make_delayed<dataset_loader_arity3>( "something-in-the-middle"),
