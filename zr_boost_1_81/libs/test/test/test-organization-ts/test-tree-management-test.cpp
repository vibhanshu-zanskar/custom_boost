...
#else
BOOST_TEST_DECORATOR(*zr_boost_1_81::unit_test::expected_failures(1)) BOOST_AUTO_TEST_CASE( tc1 ) /* on the same line, otherwise some test below should be updated */
#endif
{ BOOST_ERROR(""); }
...
BOOST_AUTO_TEST_CASE( tc1, * expected_failures(1) )
#else
BOOST_TEST_DECORATOR(*zr_boost_1_81::unit_test::expected_failures(1)) BOOST_AUTO_TEST_CASE( tc1 ) /* on the same line, otherwise some test below should be updated (the test is sensitive to line numbers) */
#endif
{ BOOST_ERROR( "" ); }
...
typedef zr_boost_1_81::mpl::vector<int,float,char> test_types;
...
typedef zr_boost_1_81::mpl::vector<int,float,char,double,short int> test_types;
...
{
    zr_boost_1_81::shared_ptr<A> instA( new A );
    ...
    zr_boost_1_81::shared_ptr<B> instB( new B );
    ...
    zr_boost_1_81::shared_ptr<C> instC1( new D );
    ...
    zr_boost_1_81::shared_ptr<C> instC2( new E );
