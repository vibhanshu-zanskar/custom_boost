...
namespace data=zr_boost_1_81::unit_test::data;
...
{
  zr_boost_1_81::unit_test::test_case const& current_test_case = zr_boost_1_81::unit_test::framework::current_test_case();
...
BOOST_DATA_TEST_CASE(BoostDataTest
  , zr_boost_1_81::unit_test::data::make({ false, true, true, true, false, false }) ^
    zr_boost_1_81::unit_test::data::make(ExpectedValues)
  , value, expectedValue)
{
