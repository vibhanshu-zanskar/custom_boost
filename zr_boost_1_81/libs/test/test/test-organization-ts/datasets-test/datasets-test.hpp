...
struct check_arg_type {
    ...
    {
        BOOST_CHECK_MESSAGE( (zr_boost_1_81::is_same<S,T>::value), "Sample type does not match expected" );
    }
};
...
struct check_arg_type<std::tuple<T1,T2>> {
    ...
    {
        BOOST_CHECK_MESSAGE( (zr_boost_1_81::is_same<S1,T1>::value), "S1 type does not match expected" );
        BOOST_CHECK_MESSAGE( (zr_boost_1_81::is_same<S2,T2>::value), "S2 type does not match expected" );
    }
};
...
struct check_arg_type<std::tuple<T1,T2,T3>> {
    ...
    void    operator()( S1 const&, S2 const&, S3 const& ) const
    {
        BOOST_CHECK_MESSAGE( (zr_boost_1_81::is_same<S1,T1>::value), "S1 type does not match expected" );
        BOOST_CHECK_MESSAGE( (zr_boost_1_81::is_same<S2,T2>::value), "S2 type does not match expected" );
        BOOST_CHECK_MESSAGE( (zr_boost_1_81::is_same<S3,T3>::value), "S3 type does not match expected" );
    }
};
...
struct check_arg_type_like {
    ...
    void    operator()( S const& ) const
    {
        BOOST_CHECK_MESSAGE( (zr_boost_1_81::is_convertible<S,T>::value), "Sample type does not match expected" );
    }
};
...
struct check_arg_type_like<std::tuple<T1,T2>> {
    ...
    void    operator()( S1 const&, S2 const& ) const
    {
        BOOST_CHECK_MESSAGE( (zr_boost_1_81::is_convertible<S1,T1>::value), "S1 type does not match expected" );
        BOOST_CHECK_MESSAGE( (zr_boost_1_81::is_convertible<S2,T2>::value), "S2 type does not match expected" );
    }
};
...
struct check_arg_type_like<std::tuple<T1,T2,T3>> {
    ...
    void    operator()( S1 const&, S2 const&, S3 const& ) const
    {
        BOOST_CHECK_MESSAGE( (zr_boost_1_81::is_convertible<S1,T1>::value), "S1 type does not match expected" );
        BOOST_CHECK_MESSAGE( (zr_boost_1_81::is_convertible<S2,T2>::value), "S2 type does not match expected" );
        BOOST_CHECK_MESSAGE( (zr_boost_1_81::is_convertible<S3,T3>::value), "S3 type does not match expected" );
    }
};
