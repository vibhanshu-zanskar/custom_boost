...
void some_test() {}
#define TC( name )                                                      \
zr_boost_1_81::unit_test::make_test_case( zr_boost_1_81::function<void ()>(some_test),  \
...
struct test_tree {
    test_tree() {
        ...
        {
          tsuites.push_back(BOOST_TEST_SUITE( "ts1_" +  zr_boost_1_81::unit_test::utils::string_cast(s)));
        ...
        {
          tsuites.push_back(BOOST_TEST_SUITE( "ts2_" +  zr_boost_1_81::unit_test::utils::string_cast(s)));
        ...
        {
            ut::test_case* tc = zr_boost_1_81::unit_test::make_test_case(
                                    zr_boost_1_81::function<void ()>(some_test),
                                    "tc_" +  zr_boost_1_81::unit_test::utils::string_cast(s),
                                    __FILE__, __LINE__ );
