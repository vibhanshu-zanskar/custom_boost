...
public:
    explicit output_test_stream_for_loggers(
        zr_boost_1_81::unit_test::const_string    pattern_file_name = zr_boost_1_81::unit_test::const_string(),
...
struct log_setup_teardown {
  ...
  {
    zr_boost_1_81::unit_test::unit_test_log.set_format(log_format);
    if(additional_log_format != OF_INVALID) {
      zr_boost_1_81::unit_test::unit_test_log.add_format(additional_log_format);
    }
    zr_boost_1_81::unit_test::unit_test_log.set_stream(output);
    if(level_to_restore == invalid_log_level) {
      m_previous_ll = zr_boost_1_81::unit_test::unit_test_log.set_threshold_level(ll);
    }
  }

  ~log_setup_teardown() {
    zr_boost_1_81::unit_test::unit_test_log.set_format(OF_CLF);
    zr_boost_1_81::unit_test::unit_test_log.set_stream(std::cout);
    zr_boost_1_81::unit_test::unit_test_log.set_threshold_level( m_previous_ll );
    zr_boost_1_81::unit_test::unit_test_log.configure(); // forces reconfiguration
  }
