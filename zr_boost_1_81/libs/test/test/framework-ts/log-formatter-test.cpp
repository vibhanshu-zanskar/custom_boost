...
typedef zr_boost_1_81::onullstream onullstream_type;
...
void timeout_foo()
{
    using zr_boost_1_81::execution_exception;
...
struct guard {
    ~guard()
    {
        zr_boost_1_81::unit_test::unit_test_log.set_format( runtime_config::get<output_format>( runtime_config::btrt_log_format ) );
...
#line 249
    ...
    zr_boost_1_81::unit_test::runtime_config::init( argc, (char**)argv );
    zr_boost_1_81::unit_test::framework::impl::setup_for_execution( *ts_main );
    ...
    zr_boost_1_81::unit_test::runtime_config::init( argc2, (char**)argv2 );
    zr_boost_1_81::unit_test::framework::impl::setup_for_execution( *ts_account_failures );
