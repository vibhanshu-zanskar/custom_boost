...
BOOST_DATA_TEST_CASE(test_update,
                     zr_boost_1_81::unit_test::data::make(filenames))
{
...
#define PATTERN_FILE_NAME "messages-in-datasets-test.pattern"
    ...
    auto dataset = zr_boost_1_81::unit_test::data::make(filenames);

    test_unit_generator const& generator = zr_boost_1_81::unit_test::data::ds_detail::test_case_gen<test_updatecase, decltype(dataset)>(
        "fake_name",
        __FILE__,
        200,
