...
typedef mpl::transform<mutable_char_types,zr_boost_1_81::add_const<mpl::_1> >::type const_char_types;
...
struct string_literal {
    typedef typename zr_boost_1_81::remove_const<CharT>::type   mutable_char;
