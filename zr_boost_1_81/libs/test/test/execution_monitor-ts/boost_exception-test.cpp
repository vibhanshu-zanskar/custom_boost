...
//
//  Checks zr_boost_1_81::exception, see https://github.com/boostorg/test/issues/147
// ***************************************************************************
...
using zr_boost_1_81::test_tools::output_test_stream;
using namespace zr_boost_1_81::unit_test;

typedef zr_boost_1_81::error_info<struct tag_error_code, zr_boost_1_81::uint32_t> error_code;
typedef zr_boost_1_81::error_info<struct tag_error_string, std::string> error_string;
struct myexception : std::exception, virtual zr_boost_1_81::exception
{};
...
BOOST_AUTO_TEST_CASE( test_logs )
{
    ...
    zr_boost_1_81::unit_test::unit_test_log.set_stream(test_output);
    zr_boost_1_81::unit_test::unit_test_log.set_threshold_level( log_successful_tests );
    ...
    zr_boost_1_81::unit_test::unit_test_log.set_stream(std::cout);

    std::string error_string(test_output.get_stream_string_representation());
    // the message is "Dynamic exception type: zr_boost_1_81::exception_detail::clone_impl<myexception>" on Unix
    // and "Dynamic exception type: zr_boost_1_81::exception_detail::clone_impl<struct myexception>" on Windows.
    ...
    BOOST_TEST(error_string.find("zr_boost_1_81::wrapexcept<") != std::string::npos);
