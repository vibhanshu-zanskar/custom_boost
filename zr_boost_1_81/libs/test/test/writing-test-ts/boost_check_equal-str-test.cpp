...
{
  namespace bp = zr_boost_1_81::unit_test;
...
#ifndef BOOST_TEST_MACRO_LIMITED_SUPPORT
    BOOST_TEST( buf_ptr_cch == buf_ptr_cch, zr_boost_1_81::test_tools::per_element() );
    BOOST_TEST( buf_ptr_cch <= "abd" , zr_boost_1_81::test_tools::per_element() );
    BOOST_TEST( buf_ptr_cch >= "aba" , zr_boost_1_81::test_tools::per_element() );
    BOOST_TEST( buf_str == buf_ptr_cch , zr_boost_1_81::test_tools::per_element() );
    BOOST_TEST( buf_str <= "abd" , zr_boost_1_81::test_tools::per_element() );
    BOOST_TEST( buf_str >= "aba" , zr_boost_1_81::test_tools::per_element() );

    BOOST_TEST( buf_ptr_cch <= buf_ptr_cch, zr_boost_1_81::test_tools::lexicographic() );
    BOOST_TEST( buf_ptr_cch >= buf_ptr_cch, zr_boost_1_81::test_tools::lexicographic() );
    BOOST_TEST( buf_ptr_cch <= "abc" , zr_boost_1_81::test_tools::lexicographic() );
    BOOST_TEST( buf_ptr_cch < "abd" , zr_boost_1_81::test_tools::lexicographic() );
    BOOST_TEST( buf_ptr_cch < "abcd" , zr_boost_1_81::test_tools::lexicographic() );
    BOOST_TEST( buf_ptr_cch >= "abc" , zr_boost_1_81::test_tools::lexicographic() );
    BOOST_TEST( buf_ptr_cch > "aba" , zr_boost_1_81::test_tools::lexicographic() );
    BOOST_TEST( buf_ptr_cch > "abad" , zr_boost_1_81::test_tools::lexicographic() );
    BOOST_TEST( buf_str <= buf_ptr_cch , zr_boost_1_81::test_tools::lexicographic() );
    BOOST_TEST( buf_str >= buf_ptr_cch , zr_boost_1_81::test_tools::lexicographic() );
    BOOST_TEST( buf_str <= "abc" , zr_boost_1_81::test_tools::lexicographic() );
    BOOST_TEST( buf_str < "abd" , zr_boost_1_81::test_tools::lexicographic() );
    BOOST_TEST( buf_str > "aba" , zr_boost_1_81::test_tools::lexicographic() );
#endif
...
BOOST_AUTO_TEST_CASE( check_string_view_compare )
{
    ...
    BOOST_TEST_CHECK(str <= sv, zr_boost_1_81::test_tools::lexicographic());
    BOOST_TEST_CHECK(sv >= str, zr_boost_1_81::test_tools::lexicographic());
    BOOST_TEST_CHECK(str < sv, zr_boost_1_81::test_tools::lexicographic());
    BOOST_TEST_CHECK(sv > str, zr_boost_1_81::test_tools::lexicographic());
    ...
    BOOST_TEST_CHECK("str"sv <= sv, zr_boost_1_81::test_tools::lexicographic());
    BOOST_TEST_CHECK(sv >= "str"sv, zr_boost_1_81::test_tools::lexicographic());
    BOOST_TEST_CHECK("str"sv < sv, zr_boost_1_81::test_tools::lexicographic());
    BOOST_TEST_CHECK(sv > "str"sv, zr_boost_1_81::test_tools::lexicographic());

    // per element, left-right operand
    BOOST_TEST( "sv" <= sv , zr_boost_1_81::test_tools::per_element() );
    BOOST_TEST( "sv" >= sv , zr_boost_1_81::test_tools::per_element() );
    BOOST_TEST( "sv" == sv , zr_boost_1_81::test_tools::per_element() );
    ...
    BOOST_TEST( "rv" <= sv , zr_boost_1_81::test_tools::per_element() );
    BOOST_TEST( "tv" >= sv , zr_boost_1_81::test_tools::per_element() );
    BOOST_TEST( "tw" != sv , zr_boost_1_81::test_tools::per_element() );

    BOOST_TEST( sv <= "tv" , zr_boost_1_81::test_tools::per_element() );
    BOOST_TEST( sv >= "rv" , zr_boost_1_81::test_tools::per_element() );
    BOOST_TEST( sv != "ru" , zr_boost_1_81::test_tools::per_element() );
