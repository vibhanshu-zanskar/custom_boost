...
typedef zr_boost_1_81::multiprecision::number<
   zr_boost_1_81::multiprecision::cpp_dec_float<50>,
   zr_boost_1_81::multiprecision::et_off> cpp_dec_float_50_noet;

typedef zr_boost_1_81::multiprecision::number<
   zr_boost_1_81::multiprecision::cpp_dec_float<50>,
   zr_boost_1_81::multiprecision::et_on> cpp_dec_float_50_et;
...
// comparison.
#if 0
namespace zr_boost_1_81 { namespace math { namespace fpc {

  template <class A, zr_boost_1_81::multiprecision::expression_template_option B>
  struct tolerance_based< zr_boost_1_81::multiprecision::number<
   A,
   B > > : zr_boost_1_81::mpl::true_ {};

  template <class tag, class Arg1, class Arg2, class Arg3, class Arg4>
  struct tolerance_based<
    zr_boost_1_81::multiprecision::detail::expression<
      tag, Arg1, Arg2, Arg3, Arg4> > : zr_boost_1_81::mpl::true_ {};
...
you must pass two template parameters to `zr_boost_1_81::multiprecision::number`.

It may be more legible to use a two-staged type definition such as this:

``
typedef zr_boost_1_81::multiprecision::cpp_dec_float<50> mp_backend;
typedef zr_boost_1_81::multiprecision::number<mp_backend, zr_boost_1_81::multiprecision::et_off> cpp_dec_float_50_noet;
``

Here, we first define `mp_backend` as `cpp_dec_float` with 50 digits.
The second step passes this backend to `zr_boost_1_81::multiprecision::number`
with `zr_boost_1_81::multiprecision::et_off`, an enumerated type.

  typedef zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<50>, zr_boost_1_81::multiprecision::et_off>
  cpp_dec_float_50_noet;

You can reduce typing with a `using` directive `using namespace zr_boost_1_81::multiprecision;`
if desired, as shown below.
*/

using namespace zr_boost_1_81::multiprecision;
...
{ // Using expression templates.
  ...
  */
  ...
  // cannot convert from 'int' to 'zr_boost_1_81::multiprecision::detail::expression<tag,Arg1,Arg2,Arg3,Arg4>'
  //] [/expression_template_1]
