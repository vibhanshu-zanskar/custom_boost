...
typedef zr_boost_1_81::mpl::list<float,double,long double> test_types;
...
BOOST_AUTO_TEST_CASE(test_strict_order_operations_ne,
                     * zr_boost_1_81::unit_test::tolerance(0.01)
                     * expected_failures( 1 ) )
{
    double x = 10.00;
...
BOOST_AUTO_TEST_CASE(test_strict_order_operations_lt_0,
                     * zr_boost_1_81::unit_test::tolerance(0.02)
                     * expected_failures( 3 ) )
{
    double x = 0.00;
    double y = 0.01;
...
namespace fpc = zr_boost_1_81::math::fpc;
...
BOOST_AUTO_TEST_CASE( test_comparison_if_one_is_FPV, * zr_boost_1_81::unit_test::tolerance(1E-6) )
{
