...
namespace zr_boost_1_81{ namespace test_tools{ namespace tt_detail{
template<>
...
{                                                   \
    ...
    try {                                           \
        tool_usage;                                 \
    } catch( zr_boost_1_81::execution_aborted const& ) {    \
        throw_ = true;                              \
    }                                               \
                                                    \
...
struct shorten_lf : public zr_boost_1_81::unit_test::output::compiler_log_formatter
{
    void    print_prefix( std::ostream& output, zr_boost_1_81::unit_test::const_string, std::size_t line )
    {
    }
};
...
ots()
{
    static zr_boost_1_81::shared_ptr<tt::output_test_stream> inst;
...
zr_boost_1_81::test_tools::predicate_result
test_pred1()
{
    zr_boost_1_81::test_tools::predicate_result res( false );
...
{
    zr_boost_1_81::test_tools::predicate_result res( c1.m_i == c2.m_i && c1.m_id == c2.m_id );
...
zr_boost_1_81::test_tools::assertion_result
...
TEST_CASE( test_BOOST_CHECK_PREDICATE )
{
    ...
    int j=15;
    BOOST_CHECK_PREDICATE( zr_boost_1_81::bind( is_even, zr_boost_1_81::bind( &foo, _1, _2 ) ), (i)(j) );
...
TEST_CASE( test_BOOST_TEST_fpv_comp )
{
    ...
    zr_boost_1_81::ignore_unused( norm );
...
{
    using namespace zr_boost_1_81::test_tools;
...
struct copy_counter : zr_boost_1_81::noncopyable {
    static int s_value;
