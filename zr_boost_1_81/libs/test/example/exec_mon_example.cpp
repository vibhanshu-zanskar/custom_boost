...
cpp_main( int argc , char *[] )
{
    ...
    catch ( zr_boost_1_81::execution_exception const& ex ) {
...
// this seems to come from the way clang handles floating point exceptions + UB.
    ...
    ex_mon.p_detect_fp_exceptions.value = zr_boost_1_81::fpe::BOOST_FPE_DIVBYZERO;
    ...
    ex_mon.p_detect_fp_exceptions.value = zr_boost_1_81::fpe::BOOST_FPE_ALL;
    ...
    ex_mon.p_detect_fp_exceptions.value = zr_boost_1_81::fpe::BOOST_FPE_OFF;
