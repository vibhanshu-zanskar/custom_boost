...
using zr_boost_1_81::math::fpc::close_at_tolerance;
using zr_boost_1_81::math::fpc::percent_tolerance;
...
struct account_test_suite : public test_suite {
    account_test_suite( double init_value ) : test_suite("account_test_suite") {
        ...
        zr_boost_1_81::shared_ptr<account_test> instance( new account_test( init_value ) );
...
init_unit_test_suite( int argc, char * argv[] ) {
    ...
    try {
        ...
        framework::master_test_suite().add( new account_test_suite( zr_boost_1_81::lexical_cast<double>( argv[1] ) ) );
    }
    catch( zr_boost_1_81::bad_lexical_cast const& ) {
