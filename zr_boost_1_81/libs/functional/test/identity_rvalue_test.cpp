...
void simple_test()
{
    ...
    BOOST_TEST(zr_boost_1_81::identity()(string("a")) == string("a"));
    BOOST_TEST(result(zr_boost_1_81::identity()(string("a"))) == rvalue);
    typedef const std::string cstring;
    BOOST_TEST(zr_boost_1_81::identity()(cstring("a")) == cstring("a"));
    BOOST_TEST(result(zr_boost_1_81::identity()(cstring("a"))) == crvalue);
}
