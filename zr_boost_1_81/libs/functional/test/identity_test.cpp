...
{
    std::string s1("a");
    BOOST_TEST(zr_boost_1_81::identity()(s1) == s1);
    BOOST_TEST(&zr_boost_1_81::identity()(s1) == &s1);
    BOOST_TEST(result(zr_boost_1_81::identity()(s1)) == ref);
    const std::string s2("a");
    BOOST_TEST(zr_boost_1_81::identity()(s2) == s2);
    BOOST_TEST(&zr_boost_1_81::identity()(s2) == &s2);
    BOOST_TEST(result(zr_boost_1_81::identity()(s2)) == cref);
}
