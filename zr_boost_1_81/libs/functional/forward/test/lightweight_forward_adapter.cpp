...
template <class Base = zr_boost_1_81::blank>
...
{
    {
        ...
        typedef zr_boost_1_81::lightweight_forward_adapter< test_func<> > f;
        typedef zr_boost_1_81::reference_wrapper<int> ref;
        typedef zr_boost_1_81::reference_wrapper<int const> cref;
    ...
    {
        using zr_boost_1_81::noncopyable;
        using zr_boost_1_81::lightweight_forward_adapter;

        int v = 0; zr_boost_1_81::reference_wrapper<int> x(v);
