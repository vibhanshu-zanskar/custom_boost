...
ios_flags_saver_unit_test()
{
    ...
    {
        zr_boost_1_81::io::ios_flags_saver ifs(ss);
        BOOST_TEST_EQ(std::ios_base::skipws | std::ios_base::dec, ss.flags());
...
ios_precision_saver_unit_test()
{
    ...
    {
        zr_boost_1_81::io::ios_precision_saver ips(ss);
        BOOST_TEST_EQ(6, ss.precision());
    ...
    BOOST_TEST_EQ(6, ss.precision());
    {
        zr_boost_1_81::io::ios_precision_saver ips(ss, 8);
...
ios_width_saver_unit_test()
{
    ...
    {
        zr_boost_1_81::io::ios_width_saver iws(ss);
        BOOST_TEST_EQ(0, ss.width());
        ss << std::setw(4);
    ...
    BOOST_TEST_EQ(0, ss.width());
    {
        zr_boost_1_81::io::ios_width_saver iws(ss, 8);
...
ios_iostate_saver_unit_test()
{
    ...
    BOOST_TEST(ss.good());
    {
        zr_boost_1_81::io::ios_iostate_saver iis(ss);
        char c;
        BOOST_TEST_EQ(std::ios_base::goodbit, ss.rdstate());
        BOOST_TEST(ss.good());
        ss >> c;
    ...
    BOOST_TEST(ss.good());
    {
        zr_boost_1_81::io::ios_iostate_saver iis(ss, std::ios_base::eofbit);
...
ios_exception_saver_unit_test()
{
    ...
    {
        zr_boost_1_81::io::ios_exception_saver ies(ss);
        BOOST_TEST_EQ(std::ios_base::goodbit, ss.exceptions());
    ...
    BOOST_TEST_EQ(std::ios_base::goodbit, ss.exceptions());
    {
        zr_boost_1_81::io::ios_exception_saver ies(ss, std::ios_base::eofbit);
...
ios_tie_saver_unit_test()
{
    ...
    {
        zr_boost_1_81::io::ios_tie_saver its(std::cout);
        BOOST_TEST(NULL == std::cout.tie());
    ...
    BOOST_TEST(NULL == std::cout.tie());
    {
        zr_boost_1_81::io::ios_tie_saver its(std::cout, &std::clog);
        BOOST_TEST_EQ(&std::clog, std::cout.tie());
...
ios_rdbuf_saver_unit_test()
{
    ...
    {
        std::stringbuf sb;
        zr_boost_1_81::io::ios_rdbuf_saver irs(s);
        BOOST_TEST(NULL == s.rdbuf());
        s.rdbuf(&sb);
    ...
    BOOST_TEST(NULL == s.rdbuf());
    {
        ...
        zr_boost_1_81::io::ios_rdbuf_saver irs(s, &sb1);
...
ios_fill_saver_unit_test()
{
    ...
    {
        zr_boost_1_81::io::ios_fill_saver ifs(ss);
        BOOST_TEST_EQ(' ', ss.fill());
        ss.fill('x');
    ...
    BOOST_TEST_EQ(' ', ss.fill());
    {
        zr_boost_1_81::io::ios_fill_saver ifs(ss, '3');
...
ios_locale_saver_unit_test()
{
    ...
    {
        zr_boost_1_81::io::ios_locale_saver ils(ss);
        BOOST_TEST(std::locale() == ss.getloc());
    ...
    BOOST_TEST(!std::has_facet<npc_type>(ss.getloc()) ||
        ...
        std::use_facet<npc_type>(ss.getloc())));
    {
        zr_boost_1_81::io::ios_locale_saver ils(ss, std::locale::classic());
        BOOST_TEST(std::locale::classic() == ss.getloc());
        BOOST_TEST(!std::has_facet<npc_type>(ss.getloc()) ||
            !dynamic_cast<const backward_bool_names*>(&
            std::use_facet<npc_type>(ss.getloc())));
...
ios_iword_saver_unit_test(int index)
{
    ...
    {
        zr_boost_1_81::io::ios_iword_saver iis(ss, index);
        BOOST_TEST_EQ(0, ss.iword(index));
        ss.iword(index) = 6;
    ...
    BOOST_TEST_EQ(0, ss.iword(index));
    {
        zr_boost_1_81::io::ios_iword_saver iis(ss, index, 100);
...
ios_pword_saver_unit_test(int index)
{
    ...
    {
        zr_boost_1_81::io::ios_pword_saver ips(ss, index);
        BOOST_TEST(NULL == ss.pword(index));
        ss.pword(index) = &ss;
    ...
    BOOST_TEST(NULL == ss.pword(index));
    {
        zr_boost_1_81::io::ios_pword_saver ips(ss, index, ss.rdbuf());
...
ios_base_all_saver_unit_test()
{
    ...
    BOOST_TEST_EQ(0, ss.width());
    {
        zr_boost_1_81::io::ios_base_all_saver ibas(ss);
        BOOST_TEST_EQ(std::ios_base::skipws | std::ios_base::dec, ss.flags());
        BOOST_TEST_EQ(6, ss.precision());
        BOOST_TEST_EQ(0, ss.width());
...
ios_all_saver_unit_test()
{
    ...
    BOOST_TEST(std::locale() == ss.getloc());
    {
        zr_boost_1_81::io::ios_all_saver ias(ss);
        BOOST_TEST_EQ(std::ios_base::skipws | std::ios_base::dec, ss.flags());
        BOOST_TEST_EQ(6, ss.precision());
        BOOST_TEST_EQ(0, ss.width());
        BOOST_TEST_EQ(std::ios_base::goodbit, ss.rdstate());
...
ios_word_saver_unit_test(int index)
{
    ...
    BOOST_TEST(NULL == ss.pword(index));
    {
        zr_boost_1_81::io::ios_all_word_saver iaws(ss, index);
        BOOST_TEST_EQ(0, ss.iword(index));
        BOOST_TEST(NULL == ss.pword(index));
        ss.iword(index) = -11;
