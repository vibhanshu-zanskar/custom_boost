            ...
            if(!normalized_) {
                ...
                if(is_local_) {
...
#endif
                        {
                            throw date_time_error("zr_boost_1_81::locale::gregorian_calendar: invalid time");
                        }
                    }
                } else {
                    ...
                    if(point < 0 || (revert_point = gmtime(&point)) == 0)
                        throw date_time_error("zr_boost_1_81::locale::gregorian_calendar time is out of range");
                    val = *revert_point;
#else
...
#endif
            if(!t) {
                throw date_time_error("zr_boost_1_81::locale::gregorian_calendar: invalid time point");
            }
            tm_ = *t;
            tm_updated_ = *t;
            normalized_ = true;
