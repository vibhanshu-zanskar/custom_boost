...
namespace zr_boost_1_81 { namespace locale { namespace impl_icu {
    ...
    private:
        ...
        mutable zr_boost_1_81::thread_specific_ptr<icu::NumberFormat> number_format_[num_fmt_type_count];
        ...
        mutable zr_boost_1_81::thread_specific_ptr<icu::SimpleDateFormat> date_formatter_;
        icu::Locale locale_;
    };
