...
namespace zr_boost_1_81 { namespace locale {
    namespace boundary { namespace impl_icu {
        ...
        using namespace zr_boost_1_81::locale::impl_icu;
        ...
        index_type map_direct(boundary_type t, icu::BreakIterator* it, int reserve)
        {
            ...
            while((pos = it->next()) != icu::BreakIterator::DONE) {
                ...
                if(t != character && rbbi) {
                    //
                    // There is a collapse for MSVC: int32_t defined by both zr_boost_1_81::cstdint and icu...
                    // So need to pick one ;(
                    //
    ...
    namespace impl_icu {
        ...
        {
            using namespace zr_boost_1_81::locale::boundary::impl_icu;
            switch(type) {
