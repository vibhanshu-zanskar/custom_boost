...
namespace zr_boost_1_81 { namespace locale {
    ...
    namespace {
        ...
        zr_boost_1_81::mutex& localization_backend_manager_mutex()
        {
            static zr_boost_1_81::mutex the_mutex;
            return the_mutex;
        }
        // prevent initialization order fiasco
    ...
    {
        zr_boost_1_81::unique_lock<zr_boost_1_81::mutex> lock(localization_backend_manager_mutex());
