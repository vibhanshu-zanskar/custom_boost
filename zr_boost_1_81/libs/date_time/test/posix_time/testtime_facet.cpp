...
int main() {
  ...
  try {
    ...
    {
      zr_boost_1_81::gregorian::date date(2009, 1, 1);
      zr_boost_1_81::posix_time::time_duration tdx(0, 0, 0, 0);
      zr_boost_1_81::posix_time::ptime boost_time(date, tdx);
      std::stringstream sstr;
    
      zr_boost_1_81::posix_time::time_facet* pFacet = new zr_boost_1_81::posix_time::time_facet("");
