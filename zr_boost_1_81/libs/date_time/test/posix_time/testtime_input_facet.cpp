...
bool failure_test(temporal_type component,
                  ...
                  zr_boost_1_81::posix_time::time_input_facet* facet)
{
...
do_all_tests()
{
  ...
  */
...

  {
    ...
    zr_boost_1_81::date_time::format_date_parser<date, char> fdp("%Y-%b-%d", std::locale::classic());
    special_values_parser svp; // default constructor
    period_parser pp; // default constructor
    zr_boost_1_81::date_time::date_generator_parser<date, char> dgp; // default constructor
  ...
  // trac 13194 (https://svn.boost.org/trac10/ticket/13194)
  {
      ...
      zr_boost_1_81::posix_time::time_input_facet* facet4 = new zr_boost_1_81::posix_time::time_input_facet("%B %H:%M:%s %e %Y");
      zr_boost_1_81::posix_time::ptime ptx;
  ...
  // trac 12910
  {
      ...
      zr_boost_1_81::posix_time::time_input_facet* facet = new zr_boost_1_81::posix_time::time_input_facet("%j-%H:%M:%S");
      zr_boost_1_81::posix_time::ptime pt;
