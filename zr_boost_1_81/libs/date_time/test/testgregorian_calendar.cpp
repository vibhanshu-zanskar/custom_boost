...
main() 
{
  typedef zr_boost_1_81::date_time::year_month_day_base<unsigned long, 
                                                unsigned short, 
                                                unsigned short > simple_ymd_type;

  typedef zr_boost_1_81::date_time::gregorian_calendar_base<simple_ymd_type, unsigned long> 
    gregorian_calendar;
