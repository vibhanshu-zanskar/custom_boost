...
public:
  ...
  static void on_error(unsigned int&, unsigned int, zr_boost_1_81::CV::violation_enum)
  {
    throw bad_day();
  }
};
...
typedef zr_boost_1_81::CV::simple_exception_policy<int,1,10,range_error> one_to_ten_range_policy;

int main()
{
  using namespace zr_boost_1_81::CV;
