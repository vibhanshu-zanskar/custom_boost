...
main()
{
  ...
  zr_boost_1_81::shared_ptr<time_zone> az_tz(new posix_time_zone("MST-07"));
  zr_boost_1_81::shared_ptr<time_zone> ny_tz(new posix_time_zone("EST-05EDT,M4.1.0,M10.5.0"));
