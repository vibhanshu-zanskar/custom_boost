...
//#ifndef BOOST_NO_STD_LOCALE
  ...
  typedef zr_boost_1_81::date_time::all_date_names_put<facet_config> date_facet;
  typedef zr_boost_1_81::date_time::date_names_put<facet_config> date_facet_base;
  typedef zr_boost_1_81::date_time::ostream_month_formatter<date_facet_base> month_formatter;
  ...
  date_facet gdnp(de_short_month_names, de_long_month_names, 
                  ...
                  '.', 
                  zr_boost_1_81::date_time::ymd_order_dmy);
...
//         ss.str() == std::string("Oktober"));
  ...
  typedef zr_boost_1_81::date_time::ostream_ymd_formatter<greg_year_month_day, date_facet_base> ymd_formatter;
  ss.str(""); //reset string stream 
  ...
  typedef zr_boost_1_81::date_time::ostream_date_formatter<date, date_facet_base> datef;
...
//   //Locale tests
  ...
  check("facet registered here",
        std::has_facet<zr_boost_1_81::date_time::date_names_put<facet_config> >(global2));
...
//   // date formatter that takes locale and gets facet from locale
  std::locale german_dates1(global, 
                            new date_facet(de_short_month_names, 
                                           ...
                                           '.',
                                           zr_boost_1_81::date_time::ymd_order_dmy,
                                           zr_boost_1_81::date_time::month_as_integer));
  ...
  std::locale german_dates2(global, 
                            new date_facet(de_short_month_names, 
                                           ...
                                           de_long_weekday_names,
                                           ' ',
                                           zr_boost_1_81::date_time::ymd_order_iso,
                                           zr_boost_1_81::date_time::month_as_short_string));
  ...
  std::locale german_dates3(global, 
                            new date_facet(de_short_month_names, 
                                           ...
                                           de_long_weekday_names,
                                           ' ',
                                           zr_boost_1_81::date_time::ymd_order_us,
                                           zr_boost_1_81::date_time::month_as_long_string));
  ...
  dur = date_duration(zr_boost_1_81::date_time::pos_infin);
  ss2.str("");
  ss2 << dur;
