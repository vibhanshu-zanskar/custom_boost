...
bool failure_test(temporal_type component,
                  ...
                  zr_boost_1_81::gregorian::date_input_facet* facet)
{
...
int main(){
...

  {
    ...
    typedef zr_boost_1_81::date_time::format_date_parser<date, char> date_parser;
    ...
    typedef zr_boost_1_81::date_time::date_generator_parser<date,char> date_gen_parser;
