...
void test_yearlimit(int yr, bool allowed)
{
    ...
    try {
        zr_boost_1_81::gregorian::greg_year chkyr(yr);
...
main() 
{
  ...
  check("traits min year", (zr_boost_1_81::gregorian::greg_year::min)() == 1400);
  check("traits max year", (zr_boost_1_81::gregorian::greg_year::max)() == 9999);
