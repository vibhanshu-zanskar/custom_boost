...
void system_crypt_random(void* buf, std::size_t len, zr_boost_1_81::system::error_code* ec)
{
#if defined(BOOST_POSIX_API)
    ...
    if (BOOST_UNLIKELY(err != 0))
        emit_error(err, ec, "zr_boost_1_81::filesystem::unique_path");
    ...
    {
    fail:
        emit_error(translate_ntstatus(status), ec, "zr_boost_1_81::filesystem::unique_path");
        return;
    }

    status = zr_boost_1_81::winapi::BCryptGenRandom(handle, static_cast< zr_boost_1_81::winapi::PUCHAR_ >(buf), static_cast< zr_boost_1_81::winapi::ULONG_ >(len), 0);
    ...
    zr_boost_1_81::winapi::HCRYPTPROV_ handle;
    zr_boost_1_81::winapi::DWORD_ err = 0u;
    if (BOOST_UNLIKELY(!zr_boost_1_81::winapi::CryptAcquireContextW(&handle, NULL, NULL, zr_boost_1_81::winapi::PROV_RSA_FULL_, zr_boost_1_81::winapi::CRYPT_VERIFYCONTEXT_ | zr_boost_1_81::winapi::CRYPT_SILENT_)))
    {
        err = zr_boost_1_81::winapi::GetLastError();
    ...
    zr_boost_1_81::winapi::BOOL_ gen_ok = zr_boost_1_81::winapi::CryptGenRandom(handle, static_cast< zr_boost_1_81::winapi::DWORD_ >(len), static_cast< zr_boost_1_81::winapi::BYTE_* >(buf));

    if (BOOST_UNLIKELY(!gen_ok))
        err = zr_boost_1_81::winapi::GetLastError();

    zr_boost_1_81::winapi::CryptReleaseContext(handle, 0);
