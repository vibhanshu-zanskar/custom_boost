...
class codecvt_error_cat BOOST_FINAL :
    public zr_boost_1_81::system::error_category
{
public:
...
BOOST_FILESYSTEM_DECL zr_boost_1_81::system::error_category const& codecvt_error_category() BOOST_NOEXCEPT
{
    static
...
{
    codecvt_error_category_initializer() { zr_boost_1_81::filesystem::codecvt_error_category(); }
};
