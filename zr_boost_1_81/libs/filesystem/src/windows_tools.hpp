...
inline zr_boost_1_81::filesystem::perms make_permissions(zr_boost_1_81::filesystem::path const& p, DWORD attr)
{
    zr_boost_1_81::filesystem::perms prms = zr_boost_1_81::filesystem::owner_read | zr_boost_1_81::filesystem::group_read | zr_boost_1_81::filesystem::others_read;
    if ((attr & FILE_ATTRIBUTE_READONLY) == 0u)
        prms |= zr_boost_1_81::filesystem::owner_write | zr_boost_1_81::filesystem::group_write | zr_boost_1_81::filesystem::others_write;
    zr_boost_1_81::filesystem::path ext = p.extension();
    ...
    if (equal_extension(q, L".exe", L".EXE") || equal_extension(q, L".com", L".COM") || equal_extension(q, L".bat", L".BAT") || equal_extension(q, L".cmd", L".CMD"))
        prms |= zr_boost_1_81::filesystem::owner_exe | zr_boost_1_81::filesystem::group_exe | zr_boost_1_81::filesystem::others_exe;
    return prms;
}
...
typedef zr_boost_1_81::winapi::NTSTATUS_ (NTAPI NtCreateFile_t)(
...
typedef zr_boost_1_81::winapi::NTSTATUS_ (NTAPI NtQueryDirectoryFile_t)(
...
inline HANDLE create_file_handle(zr_boost_1_81::filesystem::path const& p, DWORD dwDesiredAccess, DWORD dwShareMode, LPSECURITY_ATTRIBUTES lpSecurityAttributes, DWORD dwCreationDisposition, DWORD dwFlagsAndAttributes, HANDLE hTemplateFile = NULL)
{
