...
const bool zr_boost_1_81::random::random_device::has_fixed_range;
#endif
...
class zr_boost_1_81::random::random_device::impl
{
public:
  ...
  void error(const char * msg) {
    ...
    zr_boost_1_81::throw_exception(
      zr_boost_1_81::system::system_error(
        error_code, zr_boost_1_81::system::system_category(),
        std::string("zr_boost_1_81::random_device: ") + msg + 
...
BOOST_RANDOM_DECL zr_boost_1_81::random::random_device::random_device()
  : pimpl(new impl(default_token))
{}

BOOST_RANDOM_DECL zr_boost_1_81::random::random_device::random_device(const std::string& token)
  : pimpl(new impl(token))
{}

BOOST_RANDOM_DECL zr_boost_1_81::random_device::~random_device()
{
  delete pimpl;
}

BOOST_RANDOM_DECL double zr_boost_1_81::random_device::entropy() const
{
  return 10;
}

BOOST_RANDOM_DECL unsigned int zr_boost_1_81::random_device::operator()()
{
  return pimpl->next();
}
