...
struct heun_a1 : zr_boost_1_81::array< Value , 1 > {
    heun_a1( void )
    {
...
template< class Value = double >
struct heun_a2 : zr_boost_1_81::array< Value , 2 >
{
    heun_a2( void )
    {
...
template< class Value = double >
struct heun_b : zr_boost_1_81::array< Value , 3 >
{
    heun_b( void )
    {
...
template< class Value = double >
struct heun_c : zr_boost_1_81::array< Value , 3 >
{
    heun_c( void )
    {
        (*this)[0] = static_cast< Value >( 0 );
...
template<
    ...
    class Deriv = State ,
    class Time = Value ,
    class Algebra = zr_boost_1_81::numeric::odeint::range_algebra ,
    class Operations = zr_boost_1_81::numeric::odeint::default_operations ,
    class Resizer = zr_boost_1_81::numeric::odeint::initially_resizer
>
class heun : public
zr_boost_1_81::numeric::odeint::explicit_generic_rk< 3 , 3 , State , Value , Deriv , Time ,
                                             Algebra , Operations , Resizer >
{

public:

    typedef zr_boost_1_81::numeric::odeint::explicit_generic_rk< 3 , 3 , State , Value , Deriv , Time ,
