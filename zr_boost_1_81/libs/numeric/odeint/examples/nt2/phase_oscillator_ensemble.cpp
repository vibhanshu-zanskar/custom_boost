...
{
  typedef typename zr_boost_1_81::dispatch::meta::as_integer<T,unsigned>::type int_type;
  ...
  {
    zr_boost_1_81::mt19937 rng;
    zr_boost_1_81::cauchy_distribution<> cauchy( 0.0 , g );
    zr_boost_1_81::variate_generator< zr_boost_1_81::mt19937&, zr_boost_1_81::cauchy_distribution<> > gen( rng , cauchy );
...
struct test_ode_table
{
  ...
  void operator()()
  {
    for( T epsilon = 0.0 ; epsilon < 5.0 ; epsilon += 0.1 )
    {
      ...
      integrate_const( runge_kutta4< array_type, T >() , zr_boost_1_81::ref( ensemble ) , x , T(0.0) , T(10.0) , dt );

      // integrate and compute the statistics
      integrate_const( runge_kutta4< array_type, T >() , zr_boost_1_81::ref( ensemble ) , x , T(0.0) , T(100.0) , dt , zr_boost_1_81::ref( obs ) );
  ...
  private:
    ...
    zr_boost_1_81::uniform_real<> unif;
    array_type x;
    zr_boost_1_81::mt19937 rng;
    zr_boost_1_81::variate_generator< zr_boost_1_81::mt19937&, zr_boost_1_81::uniform_real<> > gen;
