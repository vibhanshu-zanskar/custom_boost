...
public:
    ...
    typedef zr_boost_1_81::array< double , N > deriv_type;
    typedef double value_type;
    typedef double time_type;
    typedef unsigned short order_type;
    typedef zr_boost_1_81::numeric::odeint::stepper_tag stepper_category;
...
{
    zr_boost_1_81::mt19937 &m_rng;
    zr_boost_1_81::normal_distribution<> m_dist;

  ornstein_stoch( zr_boost_1_81::mt19937 &rng , double sigma ) : m_rng( rng ) , m_dist( 0.0 , sigma ) { }
