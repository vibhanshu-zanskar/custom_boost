...
using zr_boost_1_81::timer::cpu_timer;
using zr_boost_1_81::math::double_constants::pi;
...
struct phase_chain_mpi_state
{
    ...
    void operator()( const state_type &x , state_type &dxdt , double /* t */ ) const
    {
        ...
        zr_boost_1_81::mpi::request r_left, r_right;
        if( have_left )
        {
...
int main( int argc , char **argv )
{
    ...
    zr_boost_1_81::mpi::communicator world;
    ...
    {
        x.resize( N );
        zr_boost_1_81::random::uniform_real_distribution<double> distribution( 0.0 , 2.0*pi );
        zr_boost_1_81::random::mt19937 engine( 0 );
        generate( x.begin() , x.end() , zr_boost_1_81::bind( distribution , engine ) );
    }
