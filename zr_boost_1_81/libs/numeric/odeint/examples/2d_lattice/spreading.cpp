...
typedef zr_boost_1_81::numeric::odeint::symplectic_rkn_sb3a_mclachlan< 
    state_type , state_type , double , state_type , state_type , double , 
    nested_range_algebra< zr_boost_1_81::numeric::odeint::range_algebra > ,
    zr_boost_1_81::numeric::odeint::default_operations > stepper_type;
...
int main( int argc, const char* argv[] ) {
    ...
    {
        stepper.do_step( zr_boost_1_81::ref( lattice ) , 
                         make_pair( zr_boost_1_81::ref( q ) , zr_boost_1_81::ref( p ) ) , 
                         0.0 , 0.1 );
    }
