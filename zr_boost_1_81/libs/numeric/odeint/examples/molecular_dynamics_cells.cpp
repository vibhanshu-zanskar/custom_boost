...
public:
    ...
    struct cell_functor
    {
        ...
        {
            auto point = zr_boost_1_81::get< 0 >( t );
            size_t i1 = size_t( point[0] / m_p.cell_size ) , i2 = size_t( point[1] / m_p.cell_size );
            zr_boost_1_81::get< 1 >( t ) = index_type( i1 , i2 );
            zr_boost_1_81::get< 2 >( t ) = hash_func( zr_boost_1_81::get< 1 >( t ) , m_p );
        }
    };
    ...
    struct interaction_functor
    {
        ...
        void operator()( Tuple const &t ) const
        {
            point_type x = periodic_bc( zr_boost_1_81::get< 0 >( t ) , m_p ) , v = zr_boost_1_81::get< 1 >( t );
            index_type index = zr_boost_1_81::get< 3 >( t );
            size_t pos_hash = zr_boost_1_81::get< 4 >( t );
    ...
    void operator()( point_vector const& x , point_vector const& v , point_vector &a , double t ) const
    {
        ...
        zr_boost_1_81::iota( pos_order , 0 );
        zr_boost_1_81::iota( cell_order , 0 );

        // calculate grid hash
        // calcHash( m_dGridParticleHash, m_dGridParticleIndex, dPos, m_numParticles);
        std::for_each(
            zr_boost_1_81::make_zip_iterator( zr_boost_1_81::make_tuple( x.begin() , pos_index.begin() , pos_hash.begin() ) ) ,
            zr_boost_1_81::make_zip_iterator( zr_boost_1_81::make_tuple( x.end() , pos_index.end() , pos_hash.end() ) ) ,
            cell_functor( m_p ) );

//         // sort particles based on hash
//         // sortParticles(m_dGridParticleHash, m_dGridParticleIndex, m_numParticles);        
        zr_boost_1_81::sort( pos_order , [&]( size_t i1 , size_t i2 ) -> bool {
        ...
        std::for_each( cell_order.begin() , cell_order.end() , [&]( size_t i ) {
            auto pos_begin = zr_boost_1_81::make_transform_iterator( pos_order.begin() , transform_functor( pos_hash ) );
            auto pos_end = zr_boost_1_81::make_transform_iterator( pos_order.end() , transform_functor( pos_hash ) );
        ...
        std::for_each(
            zr_boost_1_81::make_zip_iterator( zr_boost_1_81::make_tuple(
                x.begin() ,
                v.begin() ,
                a.begin() ,
                pos_index.begin() ,
                zr_boost_1_81::counting_iterator< size_t >( 0 )
            ) ) ,
            zr_boost_1_81::make_zip_iterator( zr_boost_1_81::make_tuple(
                x.end() ,
                v.end() ,
                a.end() ,
                pos_index.end() ,
                zr_boost_1_81::counting_iterator< size_t >( m_p.n )
            ) ) ,
