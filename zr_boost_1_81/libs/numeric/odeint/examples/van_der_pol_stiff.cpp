...
typedef zr_boost_1_81::numeric::ublas::vector< double > vector_type;
typedef zr_boost_1_81::numeric::ublas::matrix< double > matrix_type;
...
int main( int argc , char **argv )
{
    ...
    size_t num_of_steps = integrate_const( make_dense_output< rosenbrock4< double > >( 1.0e-6 , 1.0e-6 ) ,
            ...
            x , 0.0 , 1000.0 , 1.0
            , cout << zr_boost_1_81phoenix::arg_names::arg2 << " " << zr_boost_1_81phoenix::arg_names::arg1[0] << " " << zr_boost_1_81phoenix::arg_names::arg1[1] << "\n"
            );
    //]
