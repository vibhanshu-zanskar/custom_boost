...
typedef zr_boost_1_81::array< double , N > state_type;
...
typedef zr_boost_1_81::array< double , 1 > vector_type;
...
int main( int argc , char **argv )
{
    ...
    // Symplectic harmonic oscillator example
    {
        ...
        harm_osc h;
        rkn.do_step( make_pair( zr_boost_1_81::bind( &harm_osc::f1 , h , _1 , _2 ) , zr_boost_1_81::bind( &harm_osc::f2 , h , _1 , _2 ) ) ,
                x , t , dt );
        //]
    }
    ...
    // Simplified harmonic oscillator example
    {
        ...
        rkn.do_step( harm_osc_f1() , make_pair( zr_boost_1_81::ref( q ) , zr_boost_1_81::ref( p ) ) , t , dt );
    ...
    // dense output stepper examples
    {
        ...
        typedef zr_boost_1_81::numeric::odeint::result_of::make_dense_output<
