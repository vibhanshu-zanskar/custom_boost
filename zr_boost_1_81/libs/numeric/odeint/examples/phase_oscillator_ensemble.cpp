...
int main( int argc , char **argv )
{
    ...
    zr_boost_1_81::mt19937 rng;
    zr_boost_1_81::uniform_real<> unif( 0.0 , 2.0 * M_PI );
    zr_boost_1_81::variate_generator< zr_boost_1_81::mt19937&, zr_boost_1_81::uniform_real<> > gen( rng , unif );
    ...
    for( double epsilon = 0.0 ; epsilon < 5.0 ; epsilon += 0.1 )
    {
        ...
        integrate_const( runge_kutta4< container_type >() , zr_boost_1_81::ref( ensemble ) , x , 0.0 , 10.0 , dt );

        // integrate and compute the statistics
        integrate_const( runge_kutta4< container_type >() , zr_boost_1_81::ref( ensemble ) , x , 0.0 , 100.0 , dt , zr_boost_1_81::ref( obs ) );
