...
BOOST_AUTO_TEST_CASE_TEMPLATE( stepper_iterator_factory , Stepper , dummy_steppers )
{
    ...
    std::for_each(
        make_n_step_time_iterator_begin( stepper , zr_boost_1_81::ref( system ) , x , 0.0 , 0.1 , 10 ) ,
        make_n_step_time_iterator_end( stepper , zr_boost_1_81::ref( system ) , x ) ,
        dummy_observer() );
...
BOOST_AUTO_TEST_CASE_TEMPLATE( stepper_range , Stepper , dummy_steppers )
{
    ...
    zr_boost_1_81::for_each( make_n_step_time_range( stepper , zr_boost_1_81::ref( system ) , x , 0.0 , 0.1 , 10 ) ,
                     dummy_observer() );
...
BOOST_AUTO_TEST_CASE_TEMPLATE( stepper_iterator_with_reference_wrapper_factory , Stepper , dummy_steppers )
{
    ...
    std::for_each(
        make_n_step_time_iterator_begin( zr_boost_1_81::ref( stepper ) , zr_boost_1_81::ref( system ) , x , 0.0 , 0.1 , 10 ) ,
        make_n_step_time_iterator_end( zr_boost_1_81::ref( stepper ) , zr_boost_1_81::ref( system ) , x ) ,
        dummy_observer() );
...
BOOST_AUTO_TEST_CASE_TEMPLATE( stepper_range_with_reference_wrapper , Stepper , dummy_steppers )
{
    ...
    zr_boost_1_81::for_each( make_n_step_time_range( zr_boost_1_81::ref( stepper ) , zr_boost_1_81::ref( system ) , x , 0.0 , 0.1 , 10 ) ,
                     dummy_observer() );
...
BOOST_AUTO_TEST_CASE_TEMPLATE( copy_algorithm_with_range_factory , Stepper , dummy_steppers )
{
    state_type x = {{ 1.0 }};
    result_vector res;
    zr_boost_1_81::range::copy( make_n_step_time_range( Stepper() , empty_system() , x , 0.0 , 0.1 , 3 ) ,
                        std::back_insert_iterator< result_vector >( res ) );
