...
struct perform_controlled_stepper_test
{
    ...
    void operator()( void ) const
    {
        ...
        check_controlled_stepper_concept( controlled_stepper ,
                                          ...
                                          , x );
#else
        check_controlled_stepper_concept( controlled_stepper , zr_boost_1_81::cref( sys ) , x );
#endif
        check_controlled_stepper_concept( controlled_stepper , zr_boost_1_81::cref( sys ) , x );
...
template< class ControlledStepper , typename T >
struct perform_controlled_stepper_test< ControlledStepper , zr_boost_1_81::array<T,1> >
{
    typedef zr_boost_1_81::array<T,1> array_type;
    void operator()( void )
    {
        using std::abs;
        array_type x;
