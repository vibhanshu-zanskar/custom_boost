/*
 ...
 [begin_description]
 Tests the integrate functions with zr_boost_1_81::ref( stepper)
 [end_description]
...
class State
>
class simple_stepper_nc : zr_boost_1_81::noncopyable
{
public :
...
class State
>
class controlled_stepper_nc : zr_boost_1_81::noncopyable
{
public :
    typedef State state_type;
    typedef double value_type;
...
class State
>
class dense_out_stepper_nc : zr_boost_1_81::noncopyable
{
public :
    typedef State state_type;
    typedef double value_type;
...
struct push_back_time
{
    ...
    {
        m_times.push_back( t );
        zr_boost_1_81::numeric::odeint::copy( x , m_x );
    }
};
...
struct perform_integrate_const_test
{
    void operator()()
    {
        ...
        integrate_const( zr_boost_1_81::ref(stepper) , lorenz , x , 0.0 , 1.0 ,
...
struct perform_integrate_adaptive_test
{
    void operator()()
    {
        ...
        integrate_adaptive( zr_boost_1_81::ref(stepper) , lorenz , x , 0.0 , 1.0 ,
                            0.1, push_back_time( times , x_end ) );
    }
};
...
struct perform_integrate_n_steps_test
{
    void operator()()
    {
        ...
        integrate_n_steps( zr_boost_1_81::ref(stepper) , lorenz , x , 0.0 , 0.1 ,
...
struct perform_integrate_times_test
{
    void operator()()
    {
        ...
        integrate_times( zr_boost_1_81::ref(stepper) , lorenz , x ,
                         zr_boost_1_81::counting_iterator<int>(0) , zr_boost_1_81::counting_iterator<int>(10) , 0.1 ,
