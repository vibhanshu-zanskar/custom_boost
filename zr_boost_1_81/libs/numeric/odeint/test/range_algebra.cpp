...
using zr_boost_1_81::numeric::odeint::default_operations;
using zr_boost_1_81::numeric::odeint::range_algebra;
using zr_boost_1_81::numeric::odeint::array_algebra;


BOOST_AUTO_TEST_SUITE( standard_algebra_test )

typedef zr_boost_1_81::mpl::list< range_algebra , array_algebra > algebra_types;
range_algebra algebra;

BOOST_AUTO_TEST_CASE_TEMPLATE( for_each2 , algebra_type , algebra_types )
{
    algebra_type algebra;
    zr_boost_1_81::array< double , 2 > x1 = {{ 1.0 , 1.0 }} , x2 = {{ 2.0 , 2.0 }};
...
{
    algebra_type algebra;
    zr_boost_1_81::array< double , 2 > x1 = {{ 1.0 , 1.0 }} , x2 = {{ 2.0 , 2.0 }} , x3 = {{ 3.0 , 3.0 }};
...
{
    algebra_type algebra;
    zr_boost_1_81::array< double , 2 > x1 = {{ 1.0 , 1.0 }} , x2 = {{ 2.0 , 2.0 }} , x3 = {{ 3.0 , 3.0 }} , x4 = {{ 4.0 , 4.0 }};
...
{
    algebra_type algebra;
    zr_boost_1_81::array< double , 2 > x1 = {{ 1.0 , 1.0 }} , x2 = {{ 2.0 , 2.0 }} , x3 = {{ 3.0 , 3.0 }} , x4 = {{ 4.0 , 4.0 }} , x5 = {{ 5.0 , 5.0 }};
...
{
    algebra_type algebra;
    zr_boost_1_81::array< double , 2 > x1 = {{ 1.0 , 1.0 }} , x2 = {{ 2.0 , 2.0 }} , x3 = {{ 3.0 , 3.0 }} , x4 = {{ 4.0 , 4.0 }} , x5 = {{ 5.0 , 5.0 }} , x6 = {{ 6.0 , 6.0 }};
...
{
    algebra_type algebra;
    zr_boost_1_81::array< double , 2 > x1 = {{ 1.0 , 1.0 }} , x2 = {{ 2.0 , 2.0 }} , x3 = {{ 3.0 , 3.0 }} , x4 = {{ 4.0 , 4.0 }} , x5 = {{ 5.0 , 5.0 }} , x6 = {{ 6.0 , 6.0 }} , x7 = {{ 7.0 , 7.0 }};
...
{
    algebra_type algebra;
    zr_boost_1_81::array< double , 2 > x1 = {{ 1.0 , 1.0 }} , x2 = {{ 2.0 , 2.0 }} , x3 = {{ 3.0 , 3.0 }} , x4 = {{ 4.0 , 4.0 }} , x5 = {{ 5.0 , 5.0 }} , x6 = {{ 6.0 , 6.0 }} , x7 = {{ 7.0 , 7.0 }} , x8 = {{ 8.0 , 8.0 }};
...
{
    algebra_type algebra;
    zr_boost_1_81::array< double , 2 > x = {{ 1.25 , 2.25 }};
...
BOOST_AUTO_TEST_CASE( for_each2_with_units )
{
    ...
    zr_boost_1_81::array< length_type , 2 > x1 = {{ 1.0 * si::meter , 1.0 * si::meter }};
    zr_boost_1_81::array< velocity_type , 2 > x2 = {{ 2.0 * si::meter / si::seconds , 2.0 * si::meter / si::seconds }};
