...
typedef zr_boost_1_81::array< double , 3 > state_type2;
...
struct system1
{
    ...
    {
        typename zr_boost_1_81::range_iterator< const State >::type x = zr_boost_1_81::begin( x_ );
        typename zr_boost_1_81::range_iterator< Deriv >::type dxdt = zr_boost_1_81::begin( dxdt_ );
...
struct vector_fixture
{
    ...
    zr_boost_1_81::array< double , dim > in;
    zr_boost_1_81::array< double , dim > q;
    zr_boost_1_81::array< double , dim > p;
    state_type err;
...
{
    vector_fixture f;
    zr_boost_1_81::numeric::odeint::euler< state_type > euler;
...
{
    vector_fixture f;
    zr_boost_1_81::numeric::odeint::runge_kutta_cash_karp54_classic< state_type > rk54;
...
{
    vector_fixture f;
    zr_boost_1_81::numeric::odeint::runge_kutta_dopri5< state_type > dopri5;
...
BOOST_AUTO_TEST_CASE( controlled_error_stepper_rk54 )
{
    double t = 0.0 , dt = 0.1;
    vector_fixture f;
    zr_boost_1_81::numeric::odeint::controlled_runge_kutta< zr_boost_1_81::numeric::odeint::runge_kutta_cash_karp54_classic< state_type > > stepper;
...
BOOST_AUTO_TEST_CASE( controlled_error_stepper_dopri5 )
{
    double t = 0.0 , dt = 0.1;
    vector_fixture f;
    zr_boost_1_81::numeric::odeint::controlled_runge_kutta< zr_boost_1_81::numeric::odeint::runge_kutta_dopri5< state_type > > stepper;
    stepper.try_step( system2() , std::make_pair( f.in.begin() + 1 , f.in.begin() + 4 ) , t , dt );
    CHECK_VALUES( f.in , 0.0 , 1.1 , 2.2 , 3.3 , 4.0 , 5.0 );
}
...
{
    vector_fixture f;
    zr_boost_1_81::numeric::odeint::symplectic_euler< state_type > euler;
