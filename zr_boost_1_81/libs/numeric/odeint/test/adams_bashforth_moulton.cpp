...
struct lorenz
{
    ...
    void operator()( const State &_x , Deriv &_dxdt , const Value &dt ) const
    {
        ...
        typename zr_boost_1_81::range_iterator< const State >::type x = zr_boost_1_81::begin( _x );
        typename zr_boost_1_81::range_iterator< Deriv >::type dxdt = zr_boost_1_81::begin( _dxdt );
