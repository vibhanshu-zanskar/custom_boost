...
{
    typedef adaptive_time_iterator< zr_boost_1_81::reference_wrapper< dummy_dense_output_stepper > , empty_system , state_type > iterator_type;
    state_type x = {{ 1.0 }};
    dummy_dense_output_stepper stepper;
    iterator_type iter1 = iterator_type( zr_boost_1_81::ref( stepper ) , empty_system() , x , 0.0 , 1.0 , 0.1 );
    iterator_type iter2 = iter1;
    BOOST_CHECK_EQUAL( &( iter1->first ) , &( iter2->first ) );
    BOOST_CHECK( iter1.same( iter2 ) );
}
...
BOOST_AUTO_TEST_CASE( assignment_dense_output_stepper_iterator_with_reference_wrapper )
{
    ...
    state_type x1 = {{ 1.0 }} , x2 = {{ 2.0 }};
    dummy_dense_output_stepper stepper;
    iterator_type iter1 = iterator_type( zr_boost_1_81::ref( stepper ) , empty_system() , x1 , 0.0 , 1.0 , 0.1 );
    iterator_type iter2 = iterator_type( zr_boost_1_81::ref( stepper ) , empty_system() , x2 , 0.0 , 1.0 , 0.2 );
...
BOOST_AUTO_TEST_CASE( stepper_iterator_factory )
{
    ...
    std::for_each(
        make_adaptive_time_iterator_begin( stepper , zr_boost_1_81::ref( system ) , x , 0.0 , 1.0 , 0.1 ) ,
        make_adaptive_time_iterator_end( stepper , zr_boost_1_81::ref( system ) , x ) ,
        dummy_observer() );
...
BOOST_AUTO_TEST_CASE( stepper_range )
{
    ...
    zr_boost_1_81::for_each( make_adaptive_time_range( stepper , zr_boost_1_81::ref( system ) , x , 0.0 , 1.0 , 0.1 ) ,
                     dummy_observer() );
...
BOOST_AUTO_TEST_CASE( stepper_iterator_with_reference_wrapper_factory )
{
    ...
    std::for_each(
        make_adaptive_time_iterator_begin( zr_boost_1_81::ref( stepper ) , zr_boost_1_81::ref( system ) , x , 0.0 , 1.0 , 0.1 ) ,
        make_adaptive_time_iterator_end( zr_boost_1_81::ref( stepper ) , zr_boost_1_81::ref( system ) , x ) ,
        dummy_observer() );
...
BOOST_AUTO_TEST_CASE( stepper_range_with_reference_wrapper )
{
    ...
    zr_boost_1_81::for_each( make_adaptive_time_range( zr_boost_1_81::ref( stepper ) , zr_boost_1_81::ref( system ) , x , 0.0 , 1.0 , 0.1 ) ,
                     dummy_observer() );
...
BOOST_AUTO_TEST_CASE_TEMPLATE( copy_algorithm_with_range_factory , Stepper , dummy_steppers )
{
    state_type x = {{ 1.0 }};
    result_vector res;
    zr_boost_1_81::range::copy( make_adaptive_time_range( Stepper() , empty_system() , x , 0.0 , 0.35 , 0.1 ) ,
                        std::back_insert_iterator< result_vector >( res ) );
