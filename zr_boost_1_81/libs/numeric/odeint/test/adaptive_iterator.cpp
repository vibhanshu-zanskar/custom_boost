...
BOOST_AUTO_TEST_CASE( copy_dense_output_stepper_iterator_with_reference_wrapper )
{
    ...
    typedef adaptive_iterator< zr_boost_1_81::reference_wrapper< dummy_dense_output_stepper > , empty_system , state_type > iterator_type;

    state_type x = {{ 1.0 }};
    dummy_dense_output_stepper stepper;
    iterator_type iter1( zr_boost_1_81::ref( stepper ) , empty_system() , x , 0.0 , 0.9 , 0.1 );
    iterator_type iter2( iter1 );
...
BOOST_AUTO_TEST_CASE( assignment_dense_output_stepper_iterator_with_reference_wrapper )
{
    ...
    iterator_type iter2 = iterator_type( zr_boost_1_81::ref( stepper ) , empty_system() , x1 , 0.0 , 1.0 , 0.2 );
...
BOOST_AUTO_TEST_CASE( controlled_stepper_iterator_factory )
{
    ...
    std::for_each(
         make_adaptive_iterator_begin( stepper , zr_boost_1_81::ref( system ) , x , 0.0 , 1.0 , 0.1 ) ,
         make_adaptive_iterator_end( stepper , zr_boost_1_81::ref( system ) , x ) ,
         dummy_observer() );
...
BOOST_AUTO_TEST_CASE( controlled_stepper_range )
{
    ...
    zr_boost_1_81::for_each( make_adaptive_range( stepper , zr_boost_1_81::ref( system ) , x , 0.0 , 1.0 , 0.1 ) ,
                     dummy_observer() );
...
BOOST_AUTO_TEST_CASE( controlled_stepper_iterator_with_reference_wrapper_factory )
{
    ...
    std::for_each(
        make_adaptive_iterator_begin( zr_boost_1_81::ref( stepper ) , zr_boost_1_81::ref( system ) , x , 0.0 , 1.0 , 0.1 ) ,
        make_adaptive_iterator_end( zr_boost_1_81::ref( stepper ) , zr_boost_1_81::ref( system ) , x ) ,
        dummy_observer() );
...
BOOST_AUTO_TEST_CASE( controlled_stepper_range_with_reference_wrapper )
{
    ...
    zr_boost_1_81::for_each( make_adaptive_range( zr_boost_1_81::ref( stepper ) , zr_boost_1_81::ref( system ) , x , 0.0 , 1.0 , 0.1 ) ,
                     dummy_observer() );
...
BOOST_AUTO_TEST_CASE_TEMPLATE( copy_algorithm_with_range_factory , Stepper , dummy_steppers )
{
    state_type x = {{ 1.0 }};
    std::vector< state_type > res;
    zr_boost_1_81::range::copy( make_adaptive_range( Stepper() , empty_system() , x , 0.0 , 0.35 , 0.1 ) ,
                        std::back_insert_iterator< std::vector< state_type > >( res ) );
