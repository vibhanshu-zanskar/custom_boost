...
typedef zr_boost_1_81::multi_array< double , 1 > vector_type;
typedef zr_boost_1_81::multi_array< double , 2 > matrix_type;
typedef zr_boost_1_81::multi_array< double , 3 > tensor_type;
...
{
    vector_type v1( zr_boost_1_81::extents[12] );
    vector_type v2( zr_boost_1_81::extents[12] );
...
{
    vector_type v1( zr_boost_1_81::extents[12] );
    vector_type v2( zr_boost_1_81::extents[13] );
    BOOST_CHECK( !same_size( v1 , v2 ) );
}
...
{
    vector_type v1( zr_boost_1_81::extents[12] );
    vector_type v2( zr_boost_1_81::extents[vector_type::extent_range(-1,11)] );
    BOOST_CHECK( !same_size( v1 , v2 ) );
}
...
{
    vector_type v1( zr_boost_1_81::extents[12] );
    vector_type v2( zr_boost_1_81::extents[vector_type::extent_range(-1,10)] );
    BOOST_CHECK( !same_size( v1 , v2 ) );
}

BOOST_AUTO_TEST_CASE( test_same_size_vector5 )
{
    vector_type v1( zr_boost_1_81::extents[vector_type::extent_range(-1,10)] );
    vector_type v2( zr_boost_1_81::extents[vector_type::extent_range(-1,10)] );
    BOOST_CHECK( same_size( v1 , v2 ) );
}
...
{
    matrix_type m1( zr_boost_1_81::extents[12][4] );
    matrix_type m2( zr_boost_1_81::extents[12][4] );
...
{
    matrix_type m1( zr_boost_1_81::extents[12][4] );
    matrix_type m2( zr_boost_1_81::extents[12][3] );
    BOOST_CHECK( !same_size( m1 , m2 ) );
}

BOOST_AUTO_TEST_CASE( test_same_size_matrix3 )
{
    matrix_type m1( zr_boost_1_81::extents[12][matrix_type::extent_range(-1,2)] );
    matrix_type m2( zr_boost_1_81::extents[12][3] );
    BOOST_CHECK( !same_size( m1 , m2 ) );
}
...
{
    matrix_type m1( zr_boost_1_81::extents[12][matrix_type::extent_range(-1,1)] );
    matrix_type m2( zr_boost_1_81::extents[12][3] );
    BOOST_CHECK( !same_size( m1 , m2 ) );
}
...
{
    tensor_type t1( zr_boost_1_81::extents[ tensor_type::extent_range( -2 , 9 ) ]
                                  [ tensor_type::extent_range( 5 , 11 ) ]
                                  [ tensor_type::extent_range( -1 , 2 ) ] );
    tensor_type t2( zr_boost_1_81::extents[ tensor_type::extent_range( 2 , 13 ) ]
...
BOOST_AUTO_TEST_CASE( test_same_size_tensor2 )
{
    tensor_type t1( zr_boost_1_81::extents[ tensor_type::extent_range( -2 , 9 ) ]
                                  [ tensor_type::extent_range( 5 , 11 ) ]
                                  [ tensor_type::extent_range( -1 , 2 ) ] );
    tensor_type t2( zr_boost_1_81::extents[ tensor_type::extent_range( -2 , 9 ) ]
                                  [ tensor_type::extent_range( 5 , 11 ) ]
                                  [ tensor_type::extent_range( -1 , 2 ) ] );
    BOOST_CHECK( same_size( t1 , t2 ) );    
}
...
{
    vector_type v1( zr_boost_1_81::extents[4] );
    vector_type v2;
    resize( v2 , v1 );
    BOOST_CHECK( same_size( v1 , v2 ) );
}
...
{
    vector_type v1( zr_boost_1_81::extents[ vector_type::extent_range( -2 , 9 ) ] );
    vector_type v2;
    resize( v2 , v1 );
    BOOST_CHECK( same_size( v1 , v2 ) );
}
...
{
    vector_type v1( zr_boost_1_81::extents[ vector_type::extent_range( -2 , 9 ) ] );
    vector_type v2( zr_boost_1_81::extents[ vector_type::extent_range( 2 , 9 ) ] );
    BOOST_CHECK( !same_size( v1 , v2 ) );
    resize( v2 , v1 );
    BOOST_CHECK( same_size( v1 , v2 ) );
}
...
{
    vector_type v1( zr_boost_1_81::extents[ vector_type::extent_range( -2 , 9 ) ] );
    vector_type v2( zr_boost_1_81::extents[ vector_type::extent_range( 2 , 13 ) ] );
    for( int i=-2 ; i<9 ; ++i )
        v1[i] = i * 2;
...
{
    vector_type v1( zr_boost_1_81::extents[ vector_type::extent_range( -1 , vector_ode::n+1 ) ] );
