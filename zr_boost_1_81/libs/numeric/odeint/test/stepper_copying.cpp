...
typedef zr_boost_1_81::numeric::odeint::euler< state_type , double , deriv_type > euler_type;
typedef zr_boost_1_81::numeric::odeint::runge_kutta4_classic< state_type , double , deriv_type > rk4_type;
typedef zr_boost_1_81::numeric::odeint::runge_kutta4< state_type , double , deriv_type > rk4_generic_type;
typedef zr_boost_1_81::numeric::odeint::runge_kutta_cash_karp54_classic< state_type , double , deriv_type > rk54_type;
typedef zr_boost_1_81::numeric::odeint::runge_kutta_cash_karp54< state_type , double , deriv_type > rk54_generic_type;
typedef zr_boost_1_81::numeric::odeint::runge_kutta_dopri5< state_type , double , deriv_type > dopri5_type;
typedef zr_boost_1_81::numeric::odeint::controlled_runge_kutta< rk54_type > controlled_rk54_type;
typedef zr_boost_1_81::numeric::odeint::controlled_runge_kutta< rk54_generic_type > controlled_rk54_generic_type;
typedef zr_boost_1_81::numeric::odeint::controlled_runge_kutta< dopri5_type > controlled_dopri5_type;
typedef zr_boost_1_81::numeric::odeint::dense_output_runge_kutta< euler_type > dense_output_euler_type;
typedef zr_boost_1_81::numeric::odeint::dense_output_runge_kutta< controlled_dopri5_type > dense_output_dopri5_type;
