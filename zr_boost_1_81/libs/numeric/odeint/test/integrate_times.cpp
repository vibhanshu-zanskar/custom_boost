...
BOOST_AUTO_TEST_CASE( test_integrate_times )
{
    ...
    // simple stepper
    integrate_times( runge_kutta4< state_type >() , lorenz , x , zr_boost_1_81::counting_iterator<int>(0) , zr_boost_1_81::counting_iterator<int>(10) ,
    ...
    integrate_times( controlled_runge_kutta< runge_kutta_dopri5< state_type > >() , lorenz , x ,
                zr_boost_1_81::counting_iterator<int>(0) , zr_boost_1_81::counting_iterator<int>(10) ,
                dt , push_back_time( times ) );
...
BOOST_AUTO_TEST_CASE( test_integrate_times_ranges )
{
    ...
    integrate_times( runge_kutta4< state_type >() , lorenz , x ,
                std::make_pair( zr_boost_1_81::counting_iterator<int>(0) , zr_boost_1_81::counting_iterator<int>(10) ) ,
                dt , push_back_time( times ) );
