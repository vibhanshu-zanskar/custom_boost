...
BOOST_AUTO_TEST_CASE( test_case )
{
    ...
    typedef zr_boost_1_81::numeric::odeint::runge_kutta4<state_type> stepper_type;
// check if array algebra is selected, but only if odeint detects c++11
#ifdef BOOST_NUMERIC_ODEINT_CXX11
    BOOST_STATIC_ASSERT(( zr_boost_1_81::is_same< stepper_type::algebra_type , 
                          zr_boost_1_81::numeric::odeint::array_algebra >::value ));
#endif
    stepper_type stepper1;
    stepper1.do_step(rhs, x, 0.0, 0.1);

    zr_boost_1_81::numeric::odeint::runge_kutta4<
        state_type, double, state_type, double,
        zr_boost_1_81::numeric::odeint::array_algebra > stepper;
