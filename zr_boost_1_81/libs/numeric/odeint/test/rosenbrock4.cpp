...
{
    typedef rosenbrock4_dense_output< zr_boost_1_81::reference_wrapper< rosenbrock4_controller_max_dt_adaptable > > stepper_type;
    rosenbrock4_controller_max_dt_adaptable  c_stepper;
    stepper_type stepper( zr_boost_1_81::ref( c_stepper ) );
