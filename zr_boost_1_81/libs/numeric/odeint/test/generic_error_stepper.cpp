...
typedef zr_boost_1_81::array< value_type , 2 > state_type;
...
const zr_boost_1_81::array< double , 1 > a1 = {{ 0.2 }};
const zr_boost_1_81::array< double , 2 > a2 = {{ 3.0/40.0 , 9.0/40 }};
const zr_boost_1_81::array< double , 3 > a3 = {{ 0.3 , -0.9 , 1.2 }};
const zr_boost_1_81::array< double , 4 > a4 = {{ -11.0/54.0 , 2.5 , -70.0/27.0 , 35.0/27.0 }};
const zr_boost_1_81::array< double , 5 > a5 = {{ 1631.0/55296.0 , 175.0/512.0 , 575.0/13824.0 , 44275.0/110592.0 , 253.0/4096.0 }};
