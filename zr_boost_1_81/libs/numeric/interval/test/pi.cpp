...
typedef zr_boost_1_81::numeric::interval<int>         I_i;
typedef zr_boost_1_81::numeric::interval<float>       I_f;
typedef zr_boost_1_81::numeric::interval<double>      I_d;
typedef zr_boost_1_81::numeric::interval<long double> I_ld;

using zr_boost_1_81::numeric::interval_lib::pi;
using zr_boost_1_81::numeric::interval_lib::pi_half;
using zr_boost_1_81::numeric::interval_lib::pi_twice;
