...
struct my_interval {
private:
  typedef zr_boost_1_81::numeric::interval_lib::save_state<Rounding> my_rounding;
  typedef zr_boost_1_81::numeric::interval_lib::policies<my_rounding, my_checking> my_policies;
public:
  typedef zr_boost_1_81::numeric::interval<pexpr, my_policies> type;
};

int main() {
  typedef my_interval<zr_boost_1_81::numeric::interval_lib::rounded_arith_std<pexpr> >::type I1;
  typedef my_interval<zr_boost_1_81::numeric::interval_lib::rounded_arith_opp<pexpr> >::type I2;
