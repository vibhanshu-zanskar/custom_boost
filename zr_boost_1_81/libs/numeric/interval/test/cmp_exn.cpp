...
typedef zr_boost_1_81::numeric::interval_lib::policies< empty_class, my_checking >
  my_policies;

typedef zr_boost_1_81::numeric::interval<int, my_policies> I;

#define BOOST_C_EXN(e) \
  BOOST_TEST_THROWS(e, zr_boost_1_81::numeric::interval_lib::comparison_error)

static void test_cer()
{
  I const a(I::empty()), b(1,2);
  int const c = 0, d = my_checking::nan();
  using namespace zr_boost_1_81::numeric::interval_lib::compare::certain;
...
static void test_lex()
{
  I const a(I::empty()), b(1,2);
  int const c = 0, d = my_checking::nan();
  using namespace zr_boost_1_81::numeric::interval_lib::compare::lexicographic;
...
static void test_pos()
{
  I const a(I::empty()), b(1,2);
  int const c = 0, d = my_checking::nan();
  using namespace zr_boost_1_81::numeric::interval_lib::compare::possible;
...
static void test_set()
{
  I const a(I::empty()), b(1,2);
  int const c = 0;
  using namespace zr_boost_1_81::numeric::interval_lib::compare::set;
...
static void test_tri()
{
  I const a(I::empty()), b(1,2);
  int const c = 0, d = my_checking::nan();
  using namespace zr_boost_1_81::numeric::interval_lib::compare::tribool;
