...
I horner(const I& x, const I p[], int n) {
  ...
  typedef typename zr_boost_1_81::numeric::interval_lib::unprotect<I>::type R;
...
std::ostream &operator<<(std::ostream &os,
                         const zr_boost_1_81::numeric::interval<T, Policies> &x) {
  os << "[" << x.lower() << ", " << x.upper() << "]";
  return os;
}

int main() {
  typedef zr_boost_1_81::numeric::interval<double> I;
  I p[3] = { -1.0, 0, 1.0 };
  I x = 1.0;
