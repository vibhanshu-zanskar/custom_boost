...
namespace custom
{
    ...
    struct range_checker
    {
        ...
        static zr_boost_1_81::numeric::range_check_result out_of_range( argument_type s )
        {
            using namespace zr_boost_1_81::numeric;
    ...
    template<class S>
    struct Ceil : zr_boost_1_81::numeric::Ceil<S>{};
    ...
    struct Ceil<Double>
    {
      ...
      typedef zr_boost_1_81::mpl::integral_c< std::float_round_style, std::round_toward_infinity> round_style;
    };

    //! Define a rounding policy and specialize on the custom type.
    template<class S>
    struct Trunc: zr_boost_1_81::numeric::Trunc<S>{};
    ...
    struct Trunc<Double>
    {
      ...
      typedef zr_boost_1_81::mpl::integral_c< std::float_round_style, std::round_toward_zero> round_style;
    };
}//namespace custom;
...
namespace zr_boost_1_81 { namespace numeric {
    ...
    struct numeric_cast_traits<Double, S>
    {
        ...
        typedef custom::range_checker
                <
                    zr_boost_1_81::numeric::conversion_traits<Double, S>
                  , overflow_policy
                >                                                range_checking_policy;
        typedef zr_boost_1_81::numeric::Trunc<S>                         rounding_policy;
    };
    ...
    struct numeric_cast_traits<T, Double>
    {
        ...
        typedef custom::range_checker
                <
                    zr_boost_1_81::numeric::conversion_traits<T, Double>
                  , overflow_policy
                >                                                range_checking_policy;
...
struct test_cast_traits
{
    ...
    {
        Double d = zr_boost_1_81::numeric_cast<Double>( static_cast<T>(50) );
        BOOST_TEST( d.v == 50. );
        T v = zr_boost_1_81::numeric_cast<T>( d );
        BOOST_TEST( v == 50 );
    }
};
...
{
    typedef zr_boost_1_81::mpl::vector
        <
          ...
          , long double 
        > types;
    zr_boost_1_81::mpl::for_each<types>( test_cast_traits() );
        
    //! Check overflow handler.
    Double d( 56.0 );
    BOOST_TEST_CATCH_CUSTOM_POSITIVE_OVERFLOW( d = zr_boost_1_81::numeric_cast<Double>( 101 ) );
    BOOST_TEST( d.v == 56. );
    BOOST_TEST_CATCH_CUSTOM_NEGATIVE_OVERFLOW( d = zr_boost_1_81::numeric_cast<Double>( -101 ) );
    BOOST_TEST( d.v == 56.);

    //! Check custom round policy.
    d = 5.9;
    int five = zr_boost_1_81::numeric_cast<int>( d );
    BOOST_TEST( five == 5 );
}
