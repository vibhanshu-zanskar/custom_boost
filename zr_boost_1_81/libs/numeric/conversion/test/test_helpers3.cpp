...
void test_conv_base( Instance const& conv )
{
  ...
  catch ( zr_boost_1_81::numeric::negative_overflow const& )
  { 
    BOOST_TEST_EQ(conv.post, c_neg_overflow);
  }
  catch ( zr_boost_1_81::numeric::positive_overflow const& )
  {
    BOOST_TEST_EQ(conv.post, c_pos_overflow);
  }
  catch ( zr_boost_1_81::numeric::bad_numeric_cast const& )
  {
...
#define DEF_CONVERTER(T,S) zr_boost_1_81::numeric::converter< T , S >
