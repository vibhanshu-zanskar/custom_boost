...
void test_conversions()
{
  ...
  zr_boost_1_81::int16_t v16 ;
  zr_boost_1_81::uint16_t uv16 ;
  zr_boost_1_81::int32_t v32 ;
  zr_boost_1_81::uint32_t uv32 ;
  ...
  // integral to integral
    ...
    // signed to signed
      ...
      // not subranged
      v16 = static_cast<zr_boost_1_81::int16_t>(rand());
      TEST_SUCCEEDING_CONVERSION_DEF(zr_boost_1_81::int32_t,zr_boost_1_81::int16_t,v16,v16);

      // subranged
      v16 = static_cast<zr_boost_1_81::int16_t>(rand());
      TEST_SUCCEEDING_CONVERSION_DEF(zr_boost_1_81::int16_t,zr_boost_1_81::int32_t,v16,v16);
      TEST_POS_OVERFLOW_CONVERSION_DEF(zr_boost_1_81::int16_t,zr_boost_1_81::int32_t,bounds<zr_boost_1_81::int16_t>::highest() + zr_boost_1_81::int32_t(1) ) ;
      TEST_NEG_OVERFLOW_CONVERSION_DEF(zr_boost_1_81::int16_t,zr_boost_1_81::int32_t,bounds<zr_boost_1_81::int16_t>::lowest()  - zr_boost_1_81::int32_t(1) ) ;

    // signed to unsigned

      // subranged
      v32 = absG(static_cast<zr_boost_1_81::int32_t>(rand()));
      v16 = absG(static_cast<zr_boost_1_81::int16_t>(rand()));
      TEST_SUCCEEDING_CONVERSION_DEF(zr_boost_1_81::uint32_t,zr_boost_1_81::int32_t,v32,v32);
      TEST_SUCCEEDING_CONVERSION_DEF(zr_boost_1_81::uint16_t,zr_boost_1_81::int32_t,v16,v16);
      TEST_POS_OVERFLOW_CONVERSION_DEF(zr_boost_1_81::uint16_t,zr_boost_1_81::int32_t,bounds<zr_boost_1_81::uint16_t>::highest() + zr_boost_1_81::int32_t(1) ) ;
      TEST_NEG_OVERFLOW_CONVERSION_DEF(zr_boost_1_81::uint32_t,zr_boost_1_81::int32_t,zr_boost_1_81::int32_t(-1) ) ;

    // unsigned to signed

      // not subranged
      v32 = absG(static_cast<zr_boost_1_81::int32_t>(rand()));
      TEST_SUCCEEDING_CONVERSION_DEF(zr_boost_1_81::int32_t,zr_boost_1_81::uint32_t,v32,v32);

      // subranged
      v16 = absG(static_cast<zr_boost_1_81::int16_t>(rand()));
      TEST_SUCCEEDING_CONVERSION_DEF(zr_boost_1_81::int16_t,zr_boost_1_81::uint32_t,v16,v16);
      TEST_POS_OVERFLOW_CONVERSION_DEF(zr_boost_1_81::int32_t,zr_boost_1_81::uint32_t,bounds<zr_boost_1_81::uint32_t>::highest() ) ;
      TEST_POS_OVERFLOW_CONVERSION_DEF(zr_boost_1_81::int16_t,zr_boost_1_81::uint32_t,bounds<zr_boost_1_81::uint32_t>::highest() ) ;

    // unsigned to unsigned

      // not subranged
      uv16 = static_cast<zr_boost_1_81::uint16_t>(rand());
      TEST_SUCCEEDING_CONVERSION_DEF(zr_boost_1_81::uint32_t,zr_boost_1_81::uint16_t,uv16,uv16);

      // subranged
      uv16 = static_cast<zr_boost_1_81::uint16_t>(rand());
      TEST_SUCCEEDING_CONVERSION_DEF(zr_boost_1_81::uint16_t,zr_boost_1_81::uint32_t,uv16,uv16);
      TEST_POS_OVERFLOW_CONVERSION_DEF(zr_boost_1_81::uint16_t,zr_boost_1_81::uint32_t,bounds<zr_boost_1_81::uint32_t>::highest() ) ;

  // integral to float

     // from signed integral
     v32 = static_cast<zr_boost_1_81::int32_t>(rand());
     TEST_SUCCEEDING_CONVERSION_DEF(double,zr_boost_1_81::int32_t,v32,v32);

     // from uint32_tegral
     uv32 = static_cast<zr_boost_1_81::uint32_t>(rand());
     TEST_SUCCEEDING_CONVERSION_DEF(double,zr_boost_1_81::uint32_t,uv32,uv32);

  // float to integral

     // to signed integral
     v32 =  static_cast<zr_boost_1_81::int32_t>(rand());
     TEST_SUCCEEDING_CONVERSION_DEF(zr_boost_1_81::int32_t,double,v32,v32);

     dv = static_cast<double>(bounds<zr_boost_1_81::uint32_t>::highest()) + 1.0 ;
     TEST_POS_OVERFLOW_CONVERSION_DEF(zr_boost_1_81::int32_t,double,dv) ;
     TEST_NEG_OVERFLOW_CONVERSION_DEF(zr_boost_1_81::int32_t,double,-dv) ;
...
{
  void operator() ( zr_boost_1_81::numeric::range_check_result r )
  {
    if ( r == zr_boost_1_81::numeric::cNegOverflow )
      cout << "negative_overflow detected!\n" ;
    else if ( r == zr_boost_1_81::numeric::cPosOverflow )
                          ...
                          )
{
  ...
  typedef zr_boost_1_81::numeric::converter<T,S,traits,OverflowHandler> converter ;

  static const S psrc = zr_boost_1_81::numeric::bounds<S>::highest();
  static const S nsrc = zr_boost_1_81::numeric::bounds<S>::lowest ();
...
void test_overflow_handlers( MATCH_FNTPL_ARG(T), MATCH_FNTPL_ARG(S) )
{
  ...
  test_overflow_handler( SET_FNTPL_ARG(T),
                         SET_FNTPL_ARG(S),
                         SET_FNTPL_ARG(zr_boost_1_81::numeric::silent_overflow_handler),
                         c_converted,
                         c_converted
                       ) ;
  ...
  test_overflow_handler( SET_FNTPL_ARG(T),
                         SET_FNTPL_ARG(S),
                         SET_FNTPL_ARG(zr_boost_1_81::numeric::def_overflow_handler),
                         c_pos_overflow,
                         c_neg_overflow
                       ) ;
                              ...
                              )
{
  ...
  typedef zr_boost_1_81::numeric::converter<T,S, Traits, zr_boost_1_81::numeric::def_overflow_handler,Float2IntRounder>
           Converter ;
...
{
  S min = zr_boost_1_81::numeric::bounds<T>::lowest();
  S max = zr_boost_1_81::numeric::bounds<T>::highest();

  cout << "Testing 'Trunc' Float2IntRounder policy\n";

  test_rounding_conversion(SET_FNTPL_ARG(T),
                           SET_FNTPL_ARG(zr_boost_1_81::numeric::Trunc<S>),
                           min,
                           c_neg_overflow,
                           c_converted,
                           c_converted,
  ...
  test_rounding_conversion(SET_FNTPL_ARG(T),
                           SET_FNTPL_ARG(zr_boost_1_81::numeric::RoundEven<S>),
                           min,
                           c_neg_overflow,
                           c_converted,
                           c_converted,
  ...
  test_rounding_conversion(SET_FNTPL_ARG(T),
                           SET_FNTPL_ARG(zr_boost_1_81::numeric::Ceil<S>),
                           min,
                           c_neg_overflow,
                           c_converted,
                           c_converted,
  ...
  test_rounding_conversion(SET_FNTPL_ARG(T),
                           SET_FNTPL_ARG(zr_boost_1_81::numeric::Floor<S>),
                           min,
                           c_neg_overflow,
                           c_neg_overflow,
                           c_converted,
...
{
  double r = zr_boost_1_81::numeric::RoundEven<double>::nearbyint(n);
  BOOST_TEST( r == x ) ;
}
...
void test_round_even()
{
  ...
  double min = zr_boost_1_81::numeric::bounds<double>::lowest();
  double max = zr_boost_1_81::numeric::bounds<double>::highest();
...
void test_converter_as_function_object()
{
  ...
  std::transform(S.begin(),
                 S.end(),
                 std::back_inserter(I),
                 zr_boost_1_81::numeric::converter<int,double>()
                ) ;
  ...
  std::transform(S.begin(),
                 S.end(),
                 std::back_inserter(D),
                 zr_boost_1_81::numeric::converter<double,double>()
                ) ;
...
int main()
{
  ...
  test_conversions();
  test_overflow_handlers( SET_FNTPL_ARG(zr_boost_1_81::int16_t), SET_FNTPL_ARG(zr_boost_1_81::int32_t));
  test_round_style(SET_FNTPL_ARG(zr_boost_1_81::int32_t), SET_FNTPL_ARG(double) ) ;
  test_round_even() ;
