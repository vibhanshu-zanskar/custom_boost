...
BOOST_UBLAS_TEST_DEF( test_vector_iteration )
{
    ...
    for (
            zr_boost_1_81::numeric::ublas::iterator_type<vector_type>::type it = zr_boost_1_81::numeric::ublas::begin<vector_type>(v);
            it != zr_boost_1_81::numeric::ublas::end<vector_type>(v);
            ++it
    ) {
...
BOOST_UBLAS_TEST_DEF( test_vector_const_iteration )
{
    ...
    vector_type::size_type ix = 0;
    for (
            zr_boost_1_81::numeric::ublas::const_iterator_type<vector_type>::type it = zr_boost_1_81::numeric::ublas::begin<vector_type>(v);
            it != zr_boost_1_81::numeric::ublas::end<vector_type>(v);
            ++it
    ) {
        BOOST_UBLAS_DEBUG_TRACE( "*it = " << *it << " ==> " << v(ix) );
...
BOOST_UBLAS_TEST_DEF( test_row_major_matrix_iteration )
{
    ...
    typedef zr_boost_1_81::numeric::ublas::iterator_type<matrix_type, zr_boost_1_81::numeric::ublas::tag::major>::type outer_iterator_type;
    typedef zr_boost_1_81::numeric::ublas::iterator_type<matrix_type, zr_boost_1_81::numeric::ublas::tag::minor>::type inner_iterator_type;
    ...
    for (
            outer_iterator_type outer_it = zr_boost_1_81::numeric::ublas::begin<zr_boost_1_81::numeric::ublas::tag::major>(A);
            outer_it != zr_boost_1_81::numeric::ublas::end<zr_boost_1_81::numeric::ublas::tag::major>(A);
            ++outer_it
    ) {
        matrix_type::size_type col(0);

        for (
                inner_iterator_type inner_it = zr_boost_1_81::numeric::ublas::begin(outer_it);
                inner_it != zr_boost_1_81::numeric::ublas::end(outer_it);
                ++inner_it
        ) {
