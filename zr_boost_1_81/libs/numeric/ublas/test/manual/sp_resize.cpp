...
int main(int, char **) {
  ...
  std::cout << "---- MAPPED ----\n";
  run_test< zr_boost_1_81::numeric::ublas::mapped_vector<Real> >();
  std::cout << "---- COMPRESSED ----\n";
  run_test< zr_boost_1_81::numeric::ublas::compressed_vector<Real> >();
  std::cout << "---- COORDINATE ----\n";
  run_test< zr_boost_1_81::numeric::ublas::coordinate_vector<Real> >();
