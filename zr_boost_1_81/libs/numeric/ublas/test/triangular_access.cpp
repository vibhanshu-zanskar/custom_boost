...
using zr_boost_1_81::numeric::ublas::iterator1_tag;
using zr_boost_1_81::numeric::ublas::iterator2_tag;
#endif
...
int main () {
    ...
    return (getResults().second > 0) ? zr_boost_1_81::exit_failure : zr_boost_1_81::exit_success;
}
