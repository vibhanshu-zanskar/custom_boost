...
// BOOST_AUTO_TEST_SUITE ( test_tensor_matrix_interoperability, * zr_boost_1_81::unit_test::depends_on("test_tensor") ) ;

BOOST_AUTO_TEST_SUITE ( test_tensor_matrix_interoperability )

using test_types = zip<int,long,float,double>::with_t<zr_boost_1_81::numeric::ublas::first_order, zr_boost_1_81::numeric::ublas::last_order>;
