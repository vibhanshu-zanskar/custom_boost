...
using double_extended = zr_boost_1_81::multiprecision::cpp_bin_float_double_extended;

using test_types = zip<int,long,float,double,double_extended>::with_t<zr_boost_1_81::numeric::ublas::first_order, zr_boost_1_81::numeric::ublas::last_order>;

struct fixture
{
	using extents_type = zr_boost_1_81::numeric::ublas::basic_extents<std::size_t>;
	fixture()
	  : extents{
	      extents_type{},    // 0
	      extents_type{1,1}, // 1
...
BOOST_AUTO_TEST_SUITE(test_tensor_arithmetic_operations, * zr_boost_1_81::unit_test::depends_on("test_tensor"))
