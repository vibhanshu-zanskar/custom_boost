...
//BOOST_AUTO_TEST_SUITE(test_strides, * zr_boost_1_81::unit_test::depends_on("test_extents"));

BOOST_AUTO_TEST_SUITE(test_strides)

using test_types = std::tuple<zr_boost_1_81::numeric::ublas::first_order, zr_boost_1_81::numeric::ublas::last_order>;
