...
//*zr_boost_1_81::unit_test::label("extents")
//*zr_boost_1_81::unit_test::label("constructor")
...
struct fixture {
	using extents_type = zr_boost_1_81::numeric::ublas::basic_extents<unsigned>;
	fixture() : extents{
	              extents_type{},            // 0
...
BOOST_FIXTURE_TEST_CASE(test_extents_access, fixture, *zr_boost_1_81::unit_test::label("extents") *zr_boost_1_81::unit_test::label("access"))
{
	using namespace zr_boost_1_81::numeric;
...
BOOST_FIXTURE_TEST_CASE(test_extents_copy_ctor, fixture, *zr_boost_1_81::unit_test::label("extents") *zr_boost_1_81::unit_test::label("copy_ctor"))
{
	BOOST_REQUIRE_EQUAL(extents.size(),13);
...
BOOST_FIXTURE_TEST_CASE(test_extents_is, fixture, *zr_boost_1_81::unit_test::label("extents") *zr_boost_1_81::unit_test::label("query"))
{
	BOOST_REQUIRE_EQUAL(extents.size(),13);
...
BOOST_FIXTURE_TEST_CASE(test_extents_squeeze, fixture, *zr_boost_1_81::unit_test::label("extents") *zr_boost_1_81::unit_test::label("squeeze"))
{
	BOOST_REQUIRE_EQUAL(extents.size(),13);
...
BOOST_FIXTURE_TEST_CASE(test_extents_valid, fixture, *zr_boost_1_81::unit_test::label("extents") *zr_boost_1_81::unit_test::label("valid"))
{
...
BOOST_FIXTURE_TEST_CASE(test_extents_product, fixture, *zr_boost_1_81::unit_test::label("extents") *zr_boost_1_81::unit_test::label("product"))
{
