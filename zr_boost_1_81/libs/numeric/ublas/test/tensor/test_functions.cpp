...
BOOST_AUTO_TEST_SUITE ( test_tensor_functions, * zr_boost_1_81::unit_test::depends_on("test_tensor_contraction") )


using test_types = zip<int,long,float,double,std::complex<float>>::with_t<zr_boost_1_81::numeric::ublas::first_order, zr_boost_1_81::numeric::ublas::last_order>;

//using test_types = zip<int>::with_t<zr_boost_1_81::numeric::ublas::first_order>;


struct fixture
{
	using extents_type = zr_boost_1_81::numeric::ublas::shape;
	fixture()
	  : extents {
	      extents_type{1,1}, // 1
	      extents_type{1,2}, // 2
