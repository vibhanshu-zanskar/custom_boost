...
namespace ublas  = zr_boost_1_81::numeric::ublas;
...
int main() {
  ...
  {
    zr_boost_1_81::timer::auto_cpu_timer t(std::cerr, "col_low x: %t sec CPU, %w sec real\n");
    ublas::vector<double>  x(b);
    ublas::inplace_solve(mat_col_low,  x, ublas::lower_tag());
    std::cerr << "delta: " << diff(mat_col_low, x, b) << "\n";
  }
  {
    zr_boost_1_81::timer::auto_cpu_timer t(std::cerr, "row_low x: %t sec CPU, %w sec real\n");
    ublas::vector<double>  x(b);
  ...
  {
    zr_boost_1_81::timer::auto_cpu_timer t(std::cerr, "col_upp x: %t sec CPU, %w sec real\n");
    ublas::vector<double>  x(b);
    ublas::inplace_solve(mat_col_upp,  x, ublas::upper_tag());
    std::cerr << "delta: " << diff(mat_col_upp, x, b) << "\n";
  }
  {
    zr_boost_1_81::timer::auto_cpu_timer t(std::cerr, "row_upp x: %t sec CPU, %w sec real\n");
    ublas::vector<double>  x(b);
  ...
  {
    zr_boost_1_81::timer::auto_cpu_timer t(std::cerr, "x col_low: %t sec CPU, %w sec real\n");
    ublas::vector<double>  x(b);
    ublas::inplace_solve(x, mat_col_low, ublas::lower_tag());
    std::cerr << "delta: " << diff(x, mat_col_low, b) << "\n";
  }
  {
    zr_boost_1_81::timer::auto_cpu_timer t(std::cerr, "x row_low: %t sec CPU, %w sec real\n");
    ublas::vector<double>  x(b);
  ...
  {
    zr_boost_1_81::timer::auto_cpu_timer t(std::cerr, "x col_upp: %t sec CPU, %w sec real\n");
    ublas::vector<double>  x(b);
    ublas::inplace_solve(x, mat_col_upp, ublas::upper_tag());
    std::cerr << "delta: " << diff(x, mat_col_upp, b) << "\n";
  }
  {
    zr_boost_1_81::timer::auto_cpu_timer t(std::cerr, "x row_upp: %t sec CPU, %w sec real\n");
    ublas::vector<double>  x(b);
