...
namespace po = zr_boost_1_81::program_options;
namespace ublas = zr_boost_1_81::numeric::ublas;
namespace bm = zr_boost_1_81::numeric::ublas::benchmark;
namespace opencl = zr_boost_1_81::numeric::ublas::opencl;

namespace zr_boost_1_81 { namespace numeric { namespace ublas { namespace benchmark { namespace opencl {
