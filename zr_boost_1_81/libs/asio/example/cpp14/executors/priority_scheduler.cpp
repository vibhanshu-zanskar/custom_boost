...
int main()
{
  ...
  auto prefer_low = zr_boost_1_81::asio::prefer(ex, custom_props::low_priority);
  auto low = zr_boost_1_81::asio::require(ex, custom_props::low_priority);
  auto med = zr_boost_1_81::asio::require(ex, custom_props::normal_priority);
  auto high = zr_boost_1_81::asio::require(ex, custom_props::high_priority);
  ...
  zr_boost_1_81::asio::require(ex, custom_props::priority{-1}).execute([&]{ sched.stop(); });
  sched.run();
  std::cout << "polymorphic query result = " << zr_boost_1_81::asio::query(poly_high, custom_props::priority{}) << "\n";
}
