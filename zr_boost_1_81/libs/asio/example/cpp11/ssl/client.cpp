...
private:
  ...
  void connect(const tcp::resolver::results_type& endpoints)
  {
    zr_boost_1_81::asio::async_connect(socket_.lowest_layer(), endpoints,
        [this](const zr_boost_1_81::system::error_code& error,
  ...
  void send_request()
  {
    ...
    zr_boost_1_81::asio::async_write(socket_,
        ...
        [this](const zr_boost_1_81::system::error_code& error, std::size_t length)
        {
          if (!error)
          {
  ...
  void receive_response(std::size_t length)
  {
    zr_boost_1_81::asio::async_read(socket_,
        zr_boost_1_81::asio::buffer(reply_, length),
        [this](const zr_boost_1_81::system::error_code& error, std::size_t length)
        {
          if (!error)
          {
