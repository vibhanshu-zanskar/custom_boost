...
struct custom_tracking
{
  ...
  static void creation(zr_boost_1_81::asio::execution_context& /*ctx*/,
  ...
  static void operation(zr_boost_1_81::asio::execution_context& /*ctx*/,
  ...
  static void reactor_registration(zr_boost_1_81::asio::execution_context& context,
  ...
  static void reactor_deregistration(zr_boost_1_81::asio::execution_context& context,
      uintmax_t native_handle, uintmax_t registration)
  {
  ...
  static void reactor_events(zr_boost_1_81::asio::execution_context& context,
  ...
  static void reactor_operation(const tracked_handler& h,
      const char* op_name, const zr_boost_1_81::system::error_code& ec)
  {
    std::printf(
