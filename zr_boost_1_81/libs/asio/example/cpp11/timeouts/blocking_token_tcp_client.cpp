...
// NOTE: This example uses the new form of the zr_boost_1_81::asio::async_result trait.
...
using tcp_socket = zr_boost_1_81::asio::basic_stream_socket<
    tcp, zr_boost_1_81::asio::io_context::executor_type>;
...
public:
  ...
  static T initiate(Init init, close_after token, Args&&... args)
  {
    zr_boost_1_81::asio::io_context& io_context = zr_boost_1_81::asio::query(
        token.socket_.get_executor(), zr_boost_1_81::asio::execution::context);
    ...
    T result;
    init([&](zr_boost_1_81::system::error_code e, T t)
        {
          error = e;
          result = t;
