...
void get_daytime(zr_boost_1_81::asio::io_context& io_context, const char* hostname)
{
  try
  {
    ...
    std::future<std::size_t> send_length =
      socket.async_send_to(zr_boost_1_81::asio::buffer(send_buf),
    ...
    std::future<std::size_t> recv_length =
      socket.async_receive_from(
          zr_boost_1_81::asio::buffer(recv_buf),
          sender_endpoint,
          zr_boost_1_81::asio::use_future);
...
int main(int argc, char* argv[])
{
  try
  {
    ...
    auto work = zr_boost_1_81::asio::make_work_guard(io_context);
