...
public:
  ...
  void do_receive()
  {
    socket_.async_receive_from(
        ...
        [this](zr_boost_1_81::system::error_code ec, std::size_t bytes_recvd)
        {
          if (!ec && bytes_recvd > 0)
          {
            do_send(bytes_recvd);
  ...
  void do_send(std::size_t length)
  {
    socket_.async_send_to(
        zr_boost_1_81::asio::buffer(data_, length), sender_endpoint_,
        [this](zr_boost_1_81::system::error_code /*ec*/, std::size_t /*bytes_sent*/)
        {
          do_receive();
        });
  }
