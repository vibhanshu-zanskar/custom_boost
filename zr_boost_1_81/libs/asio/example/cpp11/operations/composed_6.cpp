...
struct async_write_message_initiation
{
  ...
  void operator()(CompletionHandler&& completion_handler, tcp::socket& socket,
      ...
      std::unique_ptr<zr_boost_1_81::asio::steady_timer> delay_timer) const
  {
...
auto async_write_messages(tcp::socket& socket,
  ...
  //
  // In C++11 we deduce the type from the call to zr_boost_1_81::asio::async_initiate.
  -> decltype(
      zr_boost_1_81::asio::async_initiate<
        CompletionToken, void(zr_boost_1_81::system::error_code)>(
          ...
          std::declval<std::unique_ptr<zr_boost_1_81::asio::steady_timer>>()))
{
