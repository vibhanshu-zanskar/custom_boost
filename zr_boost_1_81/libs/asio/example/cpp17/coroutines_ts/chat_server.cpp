...
using zr_boost_1_81::asio::redirect_error;
...
private:
  awaitable<void> reader()
  {
    try
    {
      ...
      {
        std::size_t n = co_await zr_boost_1_81::asio::async_read_until(socket_,
            zr_boost_1_81::asio::dynamic_buffer(read_msg, 1024), "\n", use_awaitable);
  ...
  awaitable<void> writer()
  {
    try
    {
      while (socket_.is_open())
      {
        ...
        {
          co_await zr_boost_1_81::asio::async_write(socket_,
              zr_boost_1_81::asio::buffer(write_msgs_.front()), use_awaitable);
