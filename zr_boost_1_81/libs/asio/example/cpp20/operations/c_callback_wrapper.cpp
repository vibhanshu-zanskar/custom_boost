...
template <zr_boost_1_81::asio::completion_handler_for<void(std::string)> Handler>
class read_input_state
{
public:
  read_input_state(Handler&& handler)
    : handler_(std::move(handler)),
      work_(zr_boost_1_81::asio::make_work_guard(handler_))
  {
  }
  ...
  static read_input_state* create(Handler&& handler)
  {
    ...
    struct deleter
    {
      ...
      typename std::allocator_traits<
        zr_boost_1_81::asio::associated_allocator_t<Handler,
          zr_boost_1_81::asio::recycling_allocator<void>>>::template
    ...
    } d{zr_boost_1_81::asio::get_associated_allocator(handler,
          zr_boost_1_81::asio::recycling_allocator<void>())};
  ...
  static void callback(void* arg, const char* result)
  {
    ...
    } d{zr_boost_1_81::asio::get_associated_allocator(self->handler_,
          zr_boost_1_81::asio::recycling_allocator<void>())};
    ...
    zr_boost_1_81::asio::dispatch(state.work_.get_executor(),
        zr_boost_1_81::asio::bind_allocator(d.alloc,
          [
...
private:
  ...
  zr_boost_1_81::asio::executor_work_guard<
    zr_boost_1_81::asio::associated_executor_t<Handler>> work_;
};

// The initiating function for the asynchronous operation.
template <zr_boost_1_81::asio::completion_token_for<void(std::string)> CompletionToken>
auto async_read_input(const std::string& prompt, CompletionToken&& token)
{
  ...
  auto init = [](
      zr_boost_1_81::asio::completion_handler_for<void(std::string)> auto handler,
  ...
  // such as a future.
  return zr_boost_1_81::asio::async_initiate<CompletionToken, void(std::string)>(
...
void test_callback()
{
  ...
  async_read_input("Enter your name",
      zr_boost_1_81::asio::bind_executor(io_context,
...
void test_deferred()
{
  ...
  auto op = async_read_input("Enter your name", zr_boost_1_81::asio::deferred);
...
void test_future()
{
  ...
  std::future<std::string> f =
    async_read_input("Enter your name", zr_boost_1_81::asio::use_future);
