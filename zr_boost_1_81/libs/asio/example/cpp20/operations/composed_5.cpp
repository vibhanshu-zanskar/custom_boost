  ...
  // the return type of zr_boost_1_81::asio::async_initiate.
{
      ...
      std::unique_ptr<std::string> encoded_message)
  {
    ...
    struct intermediate_completion_handler
    {
      ...
      void operator()(const zr_boost_1_81::system::error_code& error, std::size_t /*n*/)
      {
...
void test_deferred()
{
  ...
  zr_boost_1_81::asio::async_operation auto op = async_write_message(
      socket, std::string("abcdef"), zr_boost_1_81::asio::deferred);
...
void test_future()
{
  ...
  std::future<void> f = async_write_message(
      socket, 654.321, zr_boost_1_81::asio::use_future);
