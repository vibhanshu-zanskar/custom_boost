...
using zr_boost_1_81::asio::as_tuple;
...
using zr_boost_1_81::asio::experimental::channel;
using zr_boost_1_81::asio::io_context;
...
using namespace zr_boost_1_81::asio::experimental::awaitable_operators;
using namespace std::literals::chrono_literals;

using token_channel = channel<void(zr_boost_1_81::system::error_code, std::size_t)>;
    ...
    steady_timer::duration token_interval, token_channel& tokens)
{
  ...
  for (;;)
  {
    co_await tokens.async_send(
        zr_boost_1_81::system::error_code{}, bytes_per_token,
        use_awaitable);
