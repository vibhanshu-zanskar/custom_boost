...
class request_parser : zr_boost_1_81::asio::coroutine
{
public:
  ...
  zr_boost_1_81::tuple<zr_boost_1_81::tribool, InputIterator> parse(request& req,
      InputIterator begin, InputIterator end)
  {
    while (begin != end)
    {
      zr_boost_1_81::tribool result = consume(req, *begin++);
      if (result || !result)
        return zr_boost_1_81::make_tuple(result, begin);
    }
    zr_boost_1_81::tribool result = zr_boost_1_81::indeterminate;
    return zr_boost_1_81::make_tuple(result, begin);
  }
...
private:
  ...
  zr_boost_1_81::tribool consume(request& req, char input);
