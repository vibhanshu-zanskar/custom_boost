...
server::server(zr_boost_1_81::asio::io_context& io_context,
...
void server::operator()(zr_boost_1_81::system::error_code ec, std::size_t length)
{
  ...
  if (!ec)
  {
    ...
    reenter (this)
    {
      ...
      buffer_.reset(new zr_boost_1_81::array<char, 8192>);
      ...
      do
      {
        ...
        // operation.
        yield socket_->async_read_some(zr_boost_1_81::asio::buffer(*buffer_), *this);

        // Parse the data we just received.
        zr_boost_1_81::tie(valid_request_, zr_boost_1_81::tuples::ignore)
      ...
      } while (zr_boost_1_81::indeterminate(valid_request_));
      ...
      yield zr_boost_1_81::asio::async_write(*socket_, reply_->to_buffers(), *this);
