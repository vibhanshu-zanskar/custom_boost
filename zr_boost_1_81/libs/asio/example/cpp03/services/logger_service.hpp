...
class logger_service
  : public zr_boost_1_81::asio::execution_context::service
{
public:
  ...
  logger_service(zr_boost_1_81::asio::execution_context& context)
    : zr_boost_1_81::asio::execution_context::service(context),
      work_io_context_(),
      work_(zr_boost_1_81::asio::make_work_guard(work_io_context_)),
      work_thread_(new zr_boost_1_81::thread(
            zr_boost_1_81::bind(&zr_boost_1_81::asio::io_context::run, &work_io_context_)))
  {
  }
  ...
  void use_file(impl_type& /*impl*/, const std::string& file)
  {
    ...
    zr_boost_1_81::asio::post(work_io_context_, zr_boost_1_81::bind(
...
private:
  ...
  zr_boost_1_81::asio::io_context work_io_context_;
  ...
  zr_boost_1_81::asio::executor_work_guard<
      zr_boost_1_81::asio::io_context::executor_type> work_;

  /// Thread used for running the work io_context's run loop.
  zr_boost_1_81::scoped_ptr<zr_boost_1_81::thread> work_thread_;
