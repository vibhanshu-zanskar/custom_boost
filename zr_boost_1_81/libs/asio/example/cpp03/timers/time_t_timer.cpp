...
{
  // The duration type.
  typedef zr_boost_1_81::asio::chrono::steady_clock::duration duration;
  ...
  typedef zr_boost_1_81::asio::chrono::time_point<time_t_clock> time_point;
  ...
  {
    return time_point() + zr_boost_1_81::asio::chrono::seconds(std::time(0));
  }
};

// The zr_boost_1_81::asio::basic_waitable_timer template accepts an optional WaitTraits
...
struct time_t_wait_traits
{
  ...
  {
    if (d > zr_boost_1_81::asio::chrono::seconds(1))
      return d - zr_boost_1_81::asio::chrono::seconds(1);
    else if (d > zr_boost_1_81::asio::chrono::seconds(0))
      return zr_boost_1_81::asio::chrono::milliseconds(10);
    else
      return zr_boost_1_81::asio::chrono::seconds(0);
  }
...
void handle_timeout(const zr_boost_1_81::system::error_code&)
{
...
int main()
{
  try
  {
    ...
    timer.expires_after(zr_boost_1_81::asio::chrono::seconds(5));
