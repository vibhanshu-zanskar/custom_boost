...
public:
  ...
  zr_boost_1_81::asio::ip::address_v4 source_address() const
  {
    zr_boost_1_81::asio::ip::address_v4::bytes_type bytes
      = { { rep_[12], rep_[13], rep_[14], rep_[15] } };
    return zr_boost_1_81::asio::ip::address_v4(bytes);
  }

  zr_boost_1_81::asio::ip::address_v4 destination_address() const
  {
    zr_boost_1_81::asio::ip::address_v4::bytes_type bytes
