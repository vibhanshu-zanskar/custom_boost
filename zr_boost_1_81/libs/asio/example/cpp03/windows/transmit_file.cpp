...
using zr_boost_1_81::asio::windows::overlapped_ptr;
using zr_boost_1_81::asio::windows::random_access_handle;

typedef zr_boost_1_81::asio::basic_stream_socket<tcp,
    zr_boost_1_81::asio::io_context::executor_type> tcp_socket;

typedef zr_boost_1_81::asio::basic_socket_acceptor<tcp,
    zr_boost_1_81::asio::io_context::executor_type> tcp_acceptor;
...
private:
  connection(zr_boost_1_81::asio::io_context& io_context, const std::string& filename)
    : socket_(io_context),
      filename_(filename),
      file_(io_context)
  {
