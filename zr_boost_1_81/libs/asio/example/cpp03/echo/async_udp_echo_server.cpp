...
public:
    ...
    : socket_(io_context, udp::endpoint(udp::v4(), port))
  {
    socket_.async_receive_from(
        ...
        zr_boost_1_81::bind(&server::handle_receive_from, this,
      ...
      size_t bytes_recvd)
  {
    if (!error && bytes_recvd > 0)
    {
      socket_.async_send_to(
          zr_boost_1_81::asio::buffer(data_, bytes_recvd), sender_endpoint_,
          zr_boost_1_81::bind(&server::handle_send_to, this,
            zr_boost_1_81::asio::placeholders::error,
            zr_boost_1_81::asio::placeholders::bytes_transferred));
    }
    else
