...
int main(int argc, char* argv[])
{
  try
  {
    ...
    zr_boost_1_81::shared_ptr<udp::socket> data_socket(
    ...
    zr_boost_1_81::asio::write(control_socket, start.to_buffers());
    ...
    for (;;)
    {
      ...
      zr_boost_1_81::shared_ptr<udp::socket> new_data_socket(
          new udp::socket(io_context, udp::endpoint(udp::v4(), 0)));
      ...
      zr_boost_1_81::system::error_code control_result;
      zr_boost_1_81::asio::async_write(control_socket, change.to_buffers(),
          (
      ...
      // cancelled.
      frame f1;
      zr_boost_1_81::system::error_code new_data_socket_result;
      new_data_socket->async_receive(f1.to_buffers(),
          (
            ...
            [
              ...
              lambda::var(data_socket) = zr_boost_1_81::shared_ptr<udp::socket>()
            ]
          ));
          ...
          data_socket->async_receive(f2.to_buffers(), 0,
              (
                ...
                [
                  ...
                  lambda::bind(&zr_boost_1_81::asio::io_context::stop, &io_context),
      ...
      // errors.
      if (control_result)
        throw zr_boost_1_81::system::system_error(control_result);
      if (new_data_socket_result)
        throw zr_boost_1_81::system::system_error(new_data_socket_result);
