...
public:
  ...
  zr_boost_1_81::array<zr_boost_1_81::asio::mutable_buffer, 1> to_buffers()
  {
    zr_boost_1_81::array<zr_boost_1_81::asio::mutable_buffer, 1> buffers
      = { { zr_boost_1_81::asio::buffer(data_) } };
    return buffers;
  }
