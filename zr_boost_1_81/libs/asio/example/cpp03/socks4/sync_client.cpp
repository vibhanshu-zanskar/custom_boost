...
int main(int argc, char* argv[])
{
  try
  {
    ...
    zr_boost_1_81::asio::write(socket, socks_request.buffers());

    // Receive a response from the SOCKS 4 server.
    socks4::reply socks_reply;
    zr_boost_1_81::asio::read(socket, socks_reply.buffers());
    ...
    zr_boost_1_81::array<char, 512> response;
    zr_boost_1_81::system::error_code error;
    while (std::size_t s = socket.read_some(
          zr_boost_1_81::asio::buffer(response), error))
