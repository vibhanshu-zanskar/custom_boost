...
using zr_boost_1_81::asio::detached_t;
using zr_boost_1_81::asio::dispatch;
using zr_boost_1_81::asio::spawn;
using zr_boost_1_81::asio::strand;
using zr_boost_1_81::asio::thread_pool;
using zr_boost_1_81::asio::yield_context;
    ...
    strand<thread_pool::executor_type> output_strand, yield_context yield)
{
  ...
  while (std::getline(is, line))
  {
    ...
    {
      dispatch(output_strand, zr_boost_1_81::bind(&print_match, input_file, line));
    }
...
int main(int argc, char* argv[])
{
  try
  {
    ...
    for (int argn = 2; argn < argc; ++argn)
    {
      ...
      spawn(pool,
          zr_boost_1_81::bind(&search_file, search_string,
            input_file, output_strand, zr_boost_1_81::placeholders::_1),
          detached_t());
    }
