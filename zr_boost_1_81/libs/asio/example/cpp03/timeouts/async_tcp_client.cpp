...
public:
  ...
  void start(tcp::resolver::results_type endpoints)
  {
    ...
    deadline_.async_wait(zr_boost_1_81::bind(&client::check_deadline, this));
  }
...
private:
  void start_connect(tcp::resolver::results_type::iterator endpoint_iter)
  {
    if (endpoint_iter != endpoints_.end())
    {
      ...
      deadline_.expires_after(zr_boost_1_81::asio::chrono::seconds(60));

      // Start the asynchronous connect operation.
      socket_.async_connect(endpoint_iter->endpoint(),
          zr_boost_1_81::bind(&client::handle_connect, this,
            zr_boost_1_81::placeholders::_1, endpoint_iter));
    }
    else
    {
  ...
  void handle_connect(const zr_boost_1_81::system::error_code& ec,
  ...
  void start_read()
  {
    ...
    deadline_.expires_after(zr_boost_1_81::asio::chrono::seconds(30));
  ...
  void start_write()
  {
    ...
    zr_boost_1_81::asio::async_write(socket_, zr_boost_1_81::asio::buffer("\n", 1),
        zr_boost_1_81::bind(&client::handle_write, this, zr_boost_1_81::placeholders::_1));
  }
  ...
  void handle_write(const zr_boost_1_81::system::error_code& ec)
  {
    ...
    if (!ec)
    {
      ...
      heartbeat_timer_.expires_after(zr_boost_1_81::asio::chrono::seconds(10));
      heartbeat_timer_.async_wait(zr_boost_1_81::bind(&client::start_write, this));
    }
    else
    {
