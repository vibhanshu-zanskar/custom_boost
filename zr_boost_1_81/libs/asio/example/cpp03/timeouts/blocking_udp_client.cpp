...
// use zr_boost_1_81::bind to specify the completion handler:
//
//   +---------------+
//   |               |
//   |    receive    |
...
public:
  ...
  std::size_t receive(const zr_boost_1_81::asio::mutable_buffer& buffer,
      ...
      zr_boost_1_81::system::error_code& ec)
  {
    ...
    std::size_t length = 0;
    socket_.async_receive(zr_boost_1_81::asio::buffer(buffer),
        zr_boost_1_81::bind(&client::handle_receive,
          zr_boost_1_81::placeholders::_1, zr_boost_1_81::placeholders::_2, &ec, &length));
...
private:
  ...
  static void handle_receive(
      const zr_boost_1_81::system::error_code& ec, std::size_t length,
      zr_boost_1_81::system::error_code* out_ec, std::size_t* out_length)
  {
    *out_ec = ec;
    *out_length = length;
  }
...
int main(int argc, char* argv[])
{
  try
  {
    ...
    for (;;)
    {
      char data[1024];
      zr_boost_1_81::system::error_code ec;
      std::size_t n = c.receive(zr_boost_1_81::asio::buffer(data),
          zr_boost_1_81::asio::chrono::seconds(10), ec);
