...
{
public:
  udp_daytime_server(zr_boost_1_81::asio::io_context& io_context)
...
private:
  void start_receive()
  {
    socket_.async_receive_from(
        ...
        zr_boost_1_81::bind(&udp_daytime_server::handle_receive,
          this, zr_boost_1_81::placeholders::_1));
  }

  void handle_receive(const zr_boost_1_81::system::error_code& ec)
  {
    if (!ec)
    {
      ...
      socket_.send_to(zr_boost_1_81::asio::buffer(message),
...
int main()
{
  try
  {
    ...
    signals.async_wait(
        zr_boost_1_81::bind(&zr_boost_1_81::asio::io_context::stop, &io_context));
    ...
    io_context.notify_fork(zr_boost_1_81::asio::io_context::fork_prepare);
    ...
    if (pid_t pid = fork())
    {
      if (pid > 0)
      {
        ...
        //
        //   io_context.notify_fork(zr_boost_1_81::asio::io_context::fork_parent);
        //
    ...
    io_context.notify_fork(zr_boost_1_81::asio::io_context::fork_child);
