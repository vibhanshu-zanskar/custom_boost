...
private:
  ...
  {
    signal_.async_wait(zr_boost_1_81::bind(&server::handle_signal_wait, this));
  }
  ...
  void start_accept()
  {
    acceptor_.async_accept(socket_,
        zr_boost_1_81::bind(&server::handle_accept, this, zr_boost_1_81::placeholders::_1));
  }

  void handle_accept(const zr_boost_1_81::system::error_code& ec)
  {
    if (!ec)
    {
      ...
      // forking.
      io_context_.notify_fork(zr_boost_1_81::asio::io_context::fork_prepare);
      ...
      if (fork() == 0)
      {
        ...
        io_context_.notify_fork(zr_boost_1_81::asio::io_context::fork_child);
      ...
      else
      {
        ...
        io_context_.notify_fork(zr_boost_1_81::asio::io_context::fork_parent);
  ...
  void start_read()
  {
    socket_.async_read_some(zr_boost_1_81::asio::buffer(data_),
        zr_boost_1_81::bind(&server::handle_read, this,
          zr_boost_1_81::placeholders::_1, zr_boost_1_81::placeholders::_2));
  }

  void handle_read(const zr_boost_1_81::system::error_code& ec, std::size_t length)
  {
    if (!ec)
      start_write(length);
  }
  ...
  {
    zr_boost_1_81::asio::async_write(socket_, zr_boost_1_81::asio::buffer(data_, length),
        zr_boost_1_81::bind(&server::handle_write, this, zr_boost_1_81::placeholders::_1));
  }
  ...
  zr_boost_1_81::asio::signal_set signal_;
