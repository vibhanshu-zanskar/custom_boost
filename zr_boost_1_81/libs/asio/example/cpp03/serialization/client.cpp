...
public:
    ...
    : connection_(io_context.get_executor())
  {
    ...
    zr_boost_1_81::asio::ip::tcp::resolver::query query(host, service);
    zr_boost_1_81::asio::ip::tcp::resolver::iterator endpoint_iterator =
      resolver.resolve(query);

    // Start an asynchronous connect operation.
    zr_boost_1_81::asio::async_connect(connection_.socket(), endpoint_iterator,
        zr_boost_1_81::bind(&client::handle_connect, this,
          zr_boost_1_81::asio::placeholders::error));
  }

  /// Handle completion of a connect operation.
  void handle_connect(const zr_boost_1_81::system::error_code& e)
  {
    if (!e)
    {
