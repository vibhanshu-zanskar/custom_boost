...
public:
        ...
        zr_boost_1_81::asio::ip::tcp::endpoint(zr_boost_1_81::asio::ip::tcp::v4(), port))
  {
    ...
    acceptor_.async_accept(new_conn->socket(),
        zr_boost_1_81::bind(&server::handle_accept, this,
          zr_boost_1_81::asio::placeholders::error, new_conn));
  }

  /// Handle completion of a accept operation.
  void handle_accept(const zr_boost_1_81::system::error_code& e, connection_ptr conn)
  {
    if (!e)
    {
      ...
      conn->async_write(stocks_,
          zr_boost_1_81::bind(&server::handle_write, this,
            zr_boost_1_81::asio::placeholders::error, conn));
    }
  ...
  void handle_write(const zr_boost_1_81::system::error_code& e, connection_ptr conn)
  {
...
int main(int argc, char* argv[])
{
  try
  {
    ...
    unsigned short port = zr_boost_1_81::lexical_cast<unsigned short>(argv[1]);
