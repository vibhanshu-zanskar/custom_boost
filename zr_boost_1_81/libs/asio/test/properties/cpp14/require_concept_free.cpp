...
{
  object<1> o1 = {};
  object<2> o2 = zr_boost_1_81::asio::require_concept(o1, prop<2>());
  (void)o2;

  const object<1> o3 = {};
  object<2> o4 = zr_boost_1_81::asio::require_concept(o3, prop<2>());
  (void)o4;

  constexpr object<2> o5 = zr_boost_1_81::asio::require_concept(object<1>(), prop<2>());
  (void)o5;
}
