...
public:
  ...
  test_random_access_device(zr_boost_1_81::asio::io_context& io_context)
  ...
  bool check_buffers(zr_boost_1_81::asio::uint64_t offset,
  ...
  {
    return check_buffers(offset, zr_boost_1_81::asio::buffer_sequence_begin(buffers),
        zr_boost_1_81::asio::buffer_sequence_end(buffers), length);
  }

  template <typename Mutable_Buffers>
  size_t read_some_at(zr_boost_1_81::asio::uint64_t offset,
      const Mutable_Buffers& buffers)
  {
    return zr_boost_1_81::asio::buffer_copy(buffers,
        zr_boost_1_81::asio::buffer(data_, length_) + offset,
        next_read_length_);
  }

  template <typename Mutable_Buffers>
  size_t read_some_at(zr_boost_1_81::asio::uint64_t offset,
      const Mutable_Buffers& buffers, zr_boost_1_81::system::error_code& ec)
  {
  ...
  void async_read_some_at(zr_boost_1_81::asio::uint64_t offset,
...
void test_3_arg_mutable_buffer_read_at()
{
  ...
  size_t bytes_transferred = zr_boost_1_81::asio::read_at(s, 0, buffers);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(0, buffers, sizeof(read_data)));

  s.reset(read_data, sizeof(read_data));
  memset(read_buf, 0, sizeof(read_buf));
  bytes_transferred = zr_boost_1_81::asio::read_at(s, 1234, buffers);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  ...
  memset(read_buf, 0, sizeof(read_buf));
  bytes_transferred = zr_boost_1_81::asio::read_at(s, 0, buffers);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(0, buffers, sizeof(read_data)));
...
void test_3_arg_streambuf_read_at()
{
  ...
  s.reset(read_data, sizeof(read_data));
  sb.consume(sb.size());
  size_t bytes_transferred = zr_boost_1_81::asio::read_at(s, 0, sb);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  ...
  s.reset(read_data, sizeof(read_data));
  sb.consume(sb.size());
  bytes_transferred = zr_boost_1_81::asio::read_at(s, 1234, sb);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(sb.size() == sizeof(read_data));
  ...
  s.next_read_length(1);
  sb.consume(sb.size());
  bytes_transferred = zr_boost_1_81::asio::read_at(s, 0, sb);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(sb.size() == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(0, sb.data(), sizeof(read_data)));
...
void test_4_arg_nothrow_mutable_buffer_read_at()
{
  ...
  size_t bytes_transferred = zr_boost_1_81::asio::read_at(s, 0, buffers, error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(0, buffers, sizeof(read_data)));
  ...
  s.reset(read_data, sizeof(read_data));
  memset(read_buf, 0, sizeof(read_buf));
  bytes_transferred = zr_boost_1_81::asio::read_at(s, 1234, buffers, error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(1234, buffers, sizeof(read_data)));
  BOOST_ASIO_CHECK(!error);
  ...
  s.next_read_length(1);
  memset(read_buf, 0, sizeof(read_buf));
  bytes_transferred = zr_boost_1_81::asio::read_at(s, 0, buffers, error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(0, buffers, sizeof(read_data)));
  BOOST_ASIO_CHECK(!error);
...
void test_4_arg_nothrow_streambuf_read_at()
{
  ...
  sb.consume(sb.size());
  zr_boost_1_81::system::error_code error;
  size_t bytes_transferred = zr_boost_1_81::asio::read_at(s, 0, sb, error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(sb.size() == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(0, sb.data(), sizeof(read_data)));
  BOOST_ASIO_CHECK(!error);
  ...
  s.reset(read_data, sizeof(read_data));
  sb.consume(sb.size());
  bytes_transferred = zr_boost_1_81::asio::read_at(s, 1234, sb, error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(sb.size() == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(1234, sb.data(), sizeof(read_data)));
  BOOST_ASIO_CHECK(!error);
  ...
  s.next_read_length(1);
  sb.consume(sb.size());
  bytes_transferred = zr_boost_1_81::asio::read_at(s, 0, sb, error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(sb.size() == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(0, sb.data(), sizeof(read_data)));
  BOOST_ASIO_CHECK(!error);
...
void test_4_arg_mutable_buffer_read_at()
{
  ...
  s.reset(read_data, sizeof(read_data));
  memset(read_buf, 0, sizeof(read_buf));
  bytes_transferred = zr_boost_1_81::asio::read_at(s, 0, buffers, short_transfer());
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(0, buffers, sizeof(read_data)));

  s.reset(read_data, sizeof(read_data));
  memset(read_buf, 0, sizeof(read_buf));
  bytes_transferred = zr_boost_1_81::asio::read_at(s, 1234, buffers, short_transfer());
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(1234, buffers, sizeof(read_data)));
...
void test_4_arg_streambuf_read_at()
{
  ...
  s.reset(read_data, sizeof(read_data));
  sb.consume(sb.size());
  bytes_transferred = zr_boost_1_81::asio::read_at(s, 0, sb, short_transfer());
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(sb.size() == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(0, sb.data(), sizeof(read_data)));
  ...
  s.reset(read_data, sizeof(read_data));
  sb.consume(sb.size());
  bytes_transferred = zr_boost_1_81::asio::read_at(s, 1234, sb, short_transfer());
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(sb.size() == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(1234, sb.data(), sizeof(read_data)));
...
void test_4_arg_mutable_buffer_async_read_at()
{
  ...
  memset(read_buf, 0, sizeof(read_buf));
  bool called = false;
  zr_boost_1_81::asio::async_read_at(s, 0, buffers,
  ...
  memset(read_buf, 0, sizeof(read_buf));
  called = false;
  zr_boost_1_81::asio::async_read_at(s, 1234, buffers,
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset(read_data, sizeof(read_data));
  memset(read_buf, 0, sizeof(read_buf));
  int i = zr_boost_1_81::asio::async_read_at(s, 1234, buffers,
...
void test_4_arg_streambuf_async_read_at()
{
  ...
  sb.consume(sb.size());
  bool called = false;
  zr_boost_1_81::asio::async_read_at(s, 0, sb,
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.consume(sb.size());
  called = false;
  zr_boost_1_81::asio::async_read_at(s, 1234, sb,
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset(read_data, sizeof(read_data));
  sb.consume(sb.size());
  int i = zr_boost_1_81::asio::async_read_at(s, 1234, sb,
      archetypes::lazy_handler());
  BOOST_ASIO_CHECK(i == 42);
  ioc.restart();
  ioc.run();
...
void test_5_arg_mutable_buffer_async_read_at()
{
  ...
  memset(read_buf, 0, sizeof(read_buf));
  called = false;
  zr_boost_1_81::asio::async_read_at(s, 0, buffers, old_style_transfer_all,
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  memset(read_buf, 0, sizeof(read_buf));
  called = false;
  zr_boost_1_81::asio::async_read_at(s, 1234, buffers, old_style_transfer_all,
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  memset(read_buf, 0, sizeof(read_buf));
  called = false;
  zr_boost_1_81::asio::async_read_at(s, 0, buffers, short_transfer(),
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  memset(read_buf, 0, sizeof(read_buf));
  called = false;
  zr_boost_1_81::asio::async_read_at(s, 1234, buffers, short_transfer(),
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
...
void test_5_arg_streambuf_async_read_at()
{
  ...
  sb.consume(sb.size());
  called = false;
  zr_boost_1_81::asio::async_read_at(s, 0, sb, old_style_transfer_all,
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.consume(sb.size());
  called = false;
  zr_boost_1_81::asio::async_read_at(s, 1234, sb, old_style_transfer_all,
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.consume(sb.size());
  called = false;
  zr_boost_1_81::asio::async_read_at(s, 0, sb, short_transfer(),
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.consume(sb.size());
  called = false;
  zr_boost_1_81::asio::async_read_at(s, 1234, sb, short_transfer(),
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
