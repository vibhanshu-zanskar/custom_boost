...
void test()
{
  ...
  try
  {
    ...
    zr_boost_1_81::asio::uint64_t s1 = file1.size();
    (void)s1;
    zr_boost_1_81::asio::uint64_t s2 = file1.size(ec);
    (void)s2;

    file1.resize(zr_boost_1_81::asio::uint64_t(0));
    file1.resize(zr_boost_1_81::asio::uint64_t(0), ec);
    ...
    zr_boost_1_81::asio::uint64_t s3 = file1.seek(0, stream_file::seek_set);
    (void)s3;
    zr_boost_1_81::asio::uint64_t s4 = file1.seek(0, stream_file::seek_set, ec);
    (void)s4;
