...
void overlapped_handler_1(const zr_boost_1_81::system::error_code&, std::size_t)
{
}
...
void test()
{
  ...
  namespace win = zr_boost_1_81::asio::windows;

  try
  {
    io_context ioc;
    zr_boost_1_81::asio::any_io_executor ex1(ioc.get_executor());
#if !defined(BOOST_ASIO_NO_TS_EXECUTORS)
    zr_boost_1_81::asio::executor ex2(ioc.get_executor());
