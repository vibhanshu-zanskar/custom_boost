...
class tcp_server : zr_boost_1_81::asio::coroutine
{
public:
  ...
  void operator()(zr_boost_1_81::system::error_code ec, std::size_t n = 0)
  {
    reenter (this) for (;;)
    {
      ...
      while (!ec)
      {
        yield zr_boost_1_81::asio::async_read(socket_,
            zr_boost_1_81::asio::buffer(buffer_), ref(this));
...
int main(int argc, char* argv[])
{
  ...
  std::vector<zr_boost_1_81::shared_ptr<tcp_server> > servers;

  for (int i = 0; i < max_connections; ++i)
  {
    zr_boost_1_81::shared_ptr<tcp_server> s(new tcp_server(acceptor, buf_size));
    servers.push_back(s);
    (*s)(zr_boost_1_81::system::error_code());
  }
