...
void connect_handler(const zr_boost_1_81::system::error_code&)
{
}

void send_handler(const zr_boost_1_81::system::error_code&, std::size_t)
{
}

void receive_handler(const zr_boost_1_81::system::error_code&, std::size_t)
{
}
...
void test()
{
  ...
  namespace generic = zr_boost_1_81::asio::generic;
  ...
  try
  {
    ...
    socket1 = zr_boost_1_81::asio::ip::tcp::socket(ioc);
#endif // defined(BOOST_ASIO_HAS_MOVE)
