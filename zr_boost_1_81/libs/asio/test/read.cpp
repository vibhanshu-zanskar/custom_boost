...
void test_2_arg_zero_buffers_read()
{
  ...
  test_stream s(ioc);
  std::vector<zr_boost_1_81::asio::mutable_buffer> buffers;

  size_t bytes_transferred = zr_boost_1_81::asio::read(s, buffers);
...
void test_2_arg_mutable_buffer_read()
{
  ...
  zr_boost_1_81::asio::mutable_buffer buffers
    = zr_boost_1_81::asio::buffer(read_buf, sizeof(read_buf));
  ...
  memset(read_buf, 0, sizeof(read_buf));
  bytes_transferred = zr_boost_1_81::asio::read(s, buffers);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(read_data)));
...
void test_2_arg_vector_buffers_read()
{
  ...
  char read_buf[sizeof(read_data)];
  std::vector<zr_boost_1_81::asio::mutable_buffer> buffers;
  buffers.push_back(zr_boost_1_81::asio::buffer(read_buf, 32));
  buffers.push_back(zr_boost_1_81::asio::buffer(read_buf, 39) + 32);
  buffers.push_back(zr_boost_1_81::asio::buffer(read_buf) + 39);
...
void test_2_arg_dynamic_string_read()
{
  ...
  zr_boost_1_81::asio::dynamic_string_buffer<char, std::string::traits_type,
    std::string::allocator_type> sb
      = zr_boost_1_81::asio::dynamic_buffer(data, sizeof(read_data));

  s.reset(read_data, sizeof(read_data));
  sb.consume(sb.size());
  size_t bytes_transferred = zr_boost_1_81::asio::read(s, sb);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  ...
  s.next_read_length(1);
  sb.consume(sb.size());
  bytes_transferred = zr_boost_1_81::asio::read(s, sb);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(sb.size() == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(sb.data(0, sb.size()), sizeof(read_data)));
...
void test_2_arg_streambuf_read()
{
  ...
  zr_boost_1_81::asio::io_context ioc;
  test_stream s(ioc);
  zr_boost_1_81::asio::streambuf sb(sizeof(read_data));
...
void test_3_arg_nothrow_zero_buffers_read()
{
  ...
  size_t bytes_transferred = zr_boost_1_81::asio::read(s, buffers, error);
  BOOST_ASIO_CHECK(bytes_transferred == 0);
...
void test_3_arg_nothrow_mutable_buffer_read()
{
  ...
  s.next_read_length(1);
  memset(read_buf, 0, sizeof(read_buf));
  bytes_transferred = zr_boost_1_81::asio::read(s, buffers, error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(read_data)));
  BOOST_ASIO_CHECK(!error);
...
void test_3_arg_nothrow_dynamic_string_read()
{
  ...
  sb.consume(sb.size());
  zr_boost_1_81::system::error_code error;
  size_t bytes_transferred = zr_boost_1_81::asio::read(s, sb, error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(sb.size() == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(sb.data(0, sb.size()), sizeof(read_data)));
  BOOST_ASIO_CHECK(!error);
  ...
  s.next_read_length(1);
  sb.consume(sb.size());
  bytes_transferred = zr_boost_1_81::asio::read(s, sb, error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(sb.size() == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(sb.data(0, sb.size()), sizeof(read_data)));
  BOOST_ASIO_CHECK(!error);
...
void test_3_arg_mutable_buffer_read()
{
  ...
  s.reset(read_data, sizeof(read_data));
  memset(read_buf, 0, sizeof(read_buf));
  bytes_transferred = zr_boost_1_81::asio::read(s, buffers, old_style_transfer_all);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(read_data)));
  ...
  s.reset(read_data, sizeof(read_data));
  memset(read_buf, 0, sizeof(read_buf));
  bytes_transferred = zr_boost_1_81::asio::read(s, buffers, short_transfer());
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(read_data)));
...
void test_3_arg_dynamic_string_read()
{
  ...
  s.reset(read_data, sizeof(read_data));
  sb.consume(sb.size());
  bytes_transferred = zr_boost_1_81::asio::read(s, sb, old_style_transfer_all);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(sb.size() == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(sb.data(0, sb.size()), sizeof(read_data)));
  ...
  s.reset(read_data, sizeof(read_data));
  sb.consume(sb.size());
  bytes_transferred = zr_boost_1_81::asio::read(s, sb, short_transfer());
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(sb.size() == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(sb.data(0, sb.size()), sizeof(read_data)));
...
void test_4_arg_mutable_buffer_read()
{
  ...
  s.reset(read_data, sizeof(read_data));
  memset(read_buf, 0, sizeof(read_buf));
  bytes_transferred = zr_boost_1_81::asio::read(s, buffers, short_transfer(), error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(read_data)));
  BOOST_ASIO_CHECK(!error);
...
void test_4_arg_dynamic_string_read()
{
  ...
  s.reset(read_data, sizeof(read_data));
  sb.consume(sb.size());
  bytes_transferred = zr_boost_1_81::asio::read(s, sb, short_transfer(), error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(read_data));
  BOOST_ASIO_CHECK(sb.size() == sizeof(read_data));
  BOOST_ASIO_CHECK(s.check_buffers(sb.data(0, sb.size()), sizeof(read_data)));
  BOOST_ASIO_CHECK(!error);
...
void async_read_handler(const zr_boost_1_81::system::error_code& e,
...
void test_3_arg_mutable_buffer_async_read()
{
  ...
  memset(read_buf, 0, sizeof(read_buf));
  bool called = false;
  zr_boost_1_81::asio::async_read(s, buffers,
  ...
  s.reset(read_data, sizeof(read_data));
  memset(read_buf, 0, sizeof(read_buf));
  int i = zr_boost_1_81::asio::async_read(s, buffers, archetypes::lazy_handler());
...
void test_3_arg_boost_array_buffers_async_read()
{
  ...
  test_stream s(ioc);
  char read_buf[sizeof(read_data)];
  zr_boost_1_81::array<zr_boost_1_81::asio::mutable_buffer, 2> buffers = { {
    zr_boost_1_81::asio::buffer(read_buf, 32),
    zr_boost_1_81::asio::buffer(read_buf) + 32 } };
...
void test_3_arg_std_array_buffers_async_read()
{
  ...
  test_stream s(ioc);
  char read_buf[sizeof(read_data)];
  std::array<zr_boost_1_81::asio::mutable_buffer, 2> buffers = { {
    zr_boost_1_81::asio::buffer(read_buf, 32),
    zr_boost_1_81::asio::buffer(read_buf) + 32 } };
...
void test_3_arg_dynamic_string_async_read()
{
  ...
  sb.consume(sb.size());
  bool called = false;
  zr_boost_1_81::asio::async_read(s, sb,
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset(read_data, sizeof(read_data));
  sb.consume(sb.size());
  int i = zr_boost_1_81::asio::async_read(s, sb, archetypes::lazy_handler());
  BOOST_ASIO_CHECK(i == 42);
  ioc.restart();
  ioc.run();
  BOOST_ASIO_CHECK(sb.size() == sizeof(read_data));
...
void test_4_arg_mutable_buffer_async_read()
{
  ...
  memset(read_buf, 0, sizeof(read_buf));
  bool called = false;
  zr_boost_1_81::asio::async_read(s, buffers, zr_boost_1_81::asio::transfer_all(),
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  memset(read_buf, 0, sizeof(read_buf));
  called = false;
  zr_boost_1_81::asio::async_read(s, buffers, zr_boost_1_81::asio::transfer_at_least(1),
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  memset(read_buf, 0, sizeof(read_buf));
  called = false;
  zr_boost_1_81::asio::async_read(s, buffers, zr_boost_1_81::asio::transfer_at_least(10),
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  memset(read_buf, 0, sizeof(read_buf));
  called = false;
  zr_boost_1_81::asio::async_read(s, buffers, zr_boost_1_81::asio::transfer_at_least(42),
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  memset(read_buf, 0, sizeof(read_buf));
  called = false;
  zr_boost_1_81::asio::async_read(s, buffers, zr_boost_1_81::asio::transfer_exactly(1),
      bindns::bind(async_read_handler,
        _1, _2, 1, &called));
  ioc.restart();
  ioc.run();
  ...
  memset(read_buf, 0, sizeof(read_buf));
  called = false;
  zr_boost_1_81::asio::async_read(s, buffers, zr_boost_1_81::asio::transfer_exactly(10),
      bindns::bind(async_read_handler,
        _1, _2, 10, &called));
  ioc.restart();
  ioc.run();
  ...
  memset(read_buf, 0, sizeof(read_buf));
  called = false;
  zr_boost_1_81::asio::async_read(s, buffers, zr_boost_1_81::asio::transfer_exactly(42),
      bindns::bind(async_read_handler,
        _1, _2, 42, &called));
  ioc.restart();
  ioc.run();
  ...
  memset(read_buf, 0, sizeof(read_buf));
  called = false;
  zr_boost_1_81::asio::async_read(s, buffers, old_style_transfer_all,
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  memset(read_buf, 0, sizeof(read_buf));
  called = false;
  zr_boost_1_81::asio::async_read(s, buffers, short_transfer(),
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset(read_data, sizeof(read_data));
  memset(read_buf, 0, sizeof(read_buf));
  int i = zr_boost_1_81::asio::async_read(s, buffers,
...
void test_4_arg_dynamic_string_async_read()
{
  ...
  sb.consume(sb.size());
  bool called = false;
  zr_boost_1_81::asio::async_read(s, sb, zr_boost_1_81::asio::transfer_all(),
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.consume(sb.size());
  called = false;
  zr_boost_1_81::asio::async_read(s, sb, zr_boost_1_81::asio::transfer_at_least(1),
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.consume(sb.size());
  called = false;
  zr_boost_1_81::asio::async_read(s, sb, zr_boost_1_81::asio::transfer_at_least(10),
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.consume(sb.size());
  called = false;
  zr_boost_1_81::asio::async_read(s, sb, zr_boost_1_81::asio::transfer_at_least(42),
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.consume(sb.size());
  called = false;
  zr_boost_1_81::asio::async_read(s, sb, zr_boost_1_81::asio::transfer_exactly(1),
      bindns::bind(async_read_handler,
        _1, _2, 1, &called));
  ioc.restart();
  ioc.run();
  ...
  sb.consume(sb.size());
  called = false;
  zr_boost_1_81::asio::async_read(s, sb, zr_boost_1_81::asio::transfer_exactly(10),
      bindns::bind(async_read_handler,
        _1, _2, 10, &called));
  ioc.restart();
  ioc.run();
  ...
  sb.consume(sb.size());
  called = false;
  zr_boost_1_81::asio::async_read(s, sb, zr_boost_1_81::asio::transfer_exactly(42),
      bindns::bind(async_read_handler,
        _1, _2, 42, &called));
  ioc.restart();
  ioc.run();
  ...
  sb.consume(sb.size());
  called = false;
  zr_boost_1_81::asio::async_read(s, sb, old_style_transfer_all,
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.consume(sb.size());
  called = false;
  zr_boost_1_81::asio::async_read(s, sb, short_transfer(),
      bindns::bind(async_read_handler,
        _1, _2, sizeof(read_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset(read_data, sizeof(read_data));
  sb.consume(sb.size());
  int i = zr_boost_1_81::asio::async_read(s, sb,
      short_transfer(), archetypes::lazy_handler());
  BOOST_ASIO_CHECK(i == 42);
  ioc.restart();
  ioc.run();
