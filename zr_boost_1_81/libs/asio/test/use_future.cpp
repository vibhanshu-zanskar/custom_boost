...
{
  using zr_boost_1_81::asio::use_future;
  ...
  {
    BOOST_ASIO_CHECK(e.code() == zr_boost_1_81::asio::error::operation_aborted);
  }
  catch (...)
  {
    BOOST_ASIO_CHECK(false);
...
int package_ec_0(zr_boost_1_81::system::error_code ec)
{
  return ec ? 0 : 42;
}
...
int package_ec_1(zr_boost_1_81::system::error_code ec, int i)
{
  return ec ? 0 : i;
}
...
int package_ec_2(zr_boost_1_81::system::error_code ec, int i, double)
{
  return ec ? 0 : i;
}
...
int package_ec_3(zr_boost_1_81::system::error_code ec, int i, double, char)
{
  return ec ? 0 : i;
}
