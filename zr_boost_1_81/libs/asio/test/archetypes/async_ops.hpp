...
{
  typedef typename zr_boost_1_81::asio::async_completion<CompletionToken,
    void()>::completion_handler_type handler_type;

  zr_boost_1_81::asio::async_completion<CompletionToken,
    void()> completion(token);

  typename zr_boost_1_81::asio::associated_allocator<handler_type>::type a
    = zr_boost_1_81::asio::get_associated_allocator(completion.completion_handler);

  typename zr_boost_1_81::asio::associated_executor<handler_type>::type ex
    = zr_boost_1_81::asio::get_associated_executor(completion.completion_handler);
...
template <typename CompletionToken>
BOOST_ASIO_INITFN_RESULT_TYPE(CompletionToken, void(zr_boost_1_81::system::error_code))
async_op_ec_0(bool ok, BOOST_ASIO_MOVE_ARG(CompletionToken) token)
{
  typedef typename zr_boost_1_81::asio::async_completion<CompletionToken,
    void(zr_boost_1_81::system::error_code)>::completion_handler_type handler_type;

  zr_boost_1_81::asio::async_completion<CompletionToken,
    void(zr_boost_1_81::system::error_code)> completion(token);
  ...
  if (ok)
  {
    ex.post(
        bindns::bind(
          ...
          zr_boost_1_81::system::error_code()), a);
  }
  else
  {
    ex.post(
        bindns::bind(
          BOOST_ASIO_MOVE_CAST(handler_type)(completion.completion_handler),
          zr_boost_1_81::system::error_code(zr_boost_1_81::asio::error::operation_aborted)), a);
  }
...
{
  typedef typename zr_boost_1_81::asio::async_completion<CompletionToken,
    void(zr_boost_1_81::system::error_code, int)>::completion_handler_type
      handler_type;

  zr_boost_1_81::asio::async_completion<CompletionToken,
    void(zr_boost_1_81::system::error_code, int)> completion(token);
  ...
  if (ok)
  {
    ex.post(
        bindns::bind(
          BOOST_ASIO_MOVE_CAST(handler_type)(completion.completion_handler),
          zr_boost_1_81::system::error_code(), 42), a);
  }
  else
  {
    ex.post(
        bindns::bind(
          BOOST_ASIO_MOVE_CAST(handler_type)(completion.completion_handler),
          zr_boost_1_81::system::error_code(zr_boost_1_81::asio::error::operation_aborted),
          0), a);
  }
...
template <typename CompletionToken>
BOOST_ASIO_INITFN_RESULT_TYPE(CompletionToken,
    void(zr_boost_1_81::system::error_code, int, double))
async_op_ec_2(bool ok, BOOST_ASIO_MOVE_ARG(CompletionToken) token)
{
  typedef typename zr_boost_1_81::asio::async_completion<CompletionToken,
    void(zr_boost_1_81::system::error_code, int, double)>::completion_handler_type
      handler_type;

  zr_boost_1_81::asio::async_completion<CompletionToken,
    void(zr_boost_1_81::system::error_code, int, double)> completion(token);
  ...
  if (ok)
  {
    ex.post(
        bindns::bind(
          BOOST_ASIO_MOVE_CAST(handler_type)(completion.completion_handler),
          zr_boost_1_81::system::error_code(), 42, 2.0), a);
  }
  else
  {
    ex.post(
...
template <typename CompletionToken>
BOOST_ASIO_INITFN_RESULT_TYPE(CompletionToken,
    void(zr_boost_1_81::system::error_code, int, double, char))
async_op_ec_3(bool ok, BOOST_ASIO_MOVE_ARG(CompletionToken) token)
{
  typedef typename zr_boost_1_81::asio::async_completion<CompletionToken,
    void(zr_boost_1_81::system::error_code, int, double, char)>::completion_handler_type
      handler_type;

  zr_boost_1_81::asio::async_completion<CompletionToken,
    void(zr_boost_1_81::system::error_code, int, double, char)> completion(token);
  ...
  if (ok)
  {
    ex.post(
        bindns::bind(
          BOOST_ASIO_MOVE_CAST(handler_type)(completion.completion_handler),
          zr_boost_1_81::system::error_code(), 42, 2.0, 'a'), a);
  }
  else
  {
    ex.post(
