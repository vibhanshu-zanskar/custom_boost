...
public:
  ...
  template <typename Const_Buffers>
  size_t write_some_at(zr_boost_1_81::asio::uint64_t offset,
      const Const_Buffers& buffers)
  {
    return zr_boost_1_81::asio::buffer_copy(
  ...
  template <typename Const_Buffers>
  size_t write_some_at(zr_boost_1_81::asio::uint64_t offset,
      const Const_Buffers& buffers, zr_boost_1_81::system::error_code& ec)
  {
  ...
  void async_write_some_at(zr_boost_1_81::asio::uint64_t offset,
...
void test_4_arg_nothrow_const_buffer_write_at()
{
  ...
  size_t bytes_transferred = zr_boost_1_81::asio::write_at(s, 0, buffers, error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(0, buffers, sizeof(write_data)));
  BOOST_ASIO_CHECK(!error);

  s.reset();
  bytes_transferred = zr_boost_1_81::asio::write_at(s, 1234, buffers, error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(1234, buffers, sizeof(write_data)));
  BOOST_ASIO_CHECK(!error);
  ...
  s.reset();
  s.next_write_length(1);
  bytes_transferred = zr_boost_1_81::asio::write_at(s, 0, buffers, error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(0, buffers, sizeof(write_data)));
  BOOST_ASIO_CHECK(!error);
...
void test_4_arg_const_buffer_write_at()
{
  ...
  s.reset();
  bytes_transferred = zr_boost_1_81::asio::write_at(s, 0, buffers, short_transfer());
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(0, buffers, sizeof(write_data)));

  s.reset();
  bytes_transferred = zr_boost_1_81::asio::write_at(s, 1234, buffers, short_transfer());
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(1234, buffers, sizeof(write_data)));
...
void test_4_arg_const_buffer_async_write_at()
{
  ...
  s.reset();
  bool called = false;
  zr_boost_1_81::asio::async_write_at(s, 0, buffers,
  ...
  s.reset();
  called = false;
  zr_boost_1_81::asio::async_write_at(s, 1234, buffers,
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  int i = zr_boost_1_81::asio::async_write_at(s, 0, buffers,
...
void test_4_arg_streambuf_async_write_at()
{
  ...
  bool called = false;
  zr_boost_1_81::asio::async_write_at(s, 0, sb,
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.sputn(write_data, sizeof(write_data));
  called = false;
  zr_boost_1_81::asio::async_write_at(s, 1234, sb,
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.consume(sb.size());
  sb.sputn(write_data, sizeof(write_data));
  int i = zr_boost_1_81::asio::async_write_at(s, 0, sb,
      archetypes::lazy_handler());
  BOOST_ASIO_CHECK(i == 42);
  ioc.restart();
  ioc.run();
...
void test_5_arg_const_buffer_async_write_at()
{
  ...
  s.reset();
  called = false;
  zr_boost_1_81::asio::async_write_at(s, 0, buffers, old_style_transfer_all,
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  called = false;
  zr_boost_1_81::asio::async_write_at(s, 1234, buffers, old_style_transfer_all,
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  called = false;
  zr_boost_1_81::asio::async_write_at(s, 0, buffers, short_transfer(),
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  called = false;
  zr_boost_1_81::asio::async_write_at(s, 1234, buffers, short_transfer(),
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  int i = zr_boost_1_81::asio::async_write_at(s, 0, buffers, short_transfer(),
      archetypes::lazy_handler());
  BOOST_ASIO_CHECK(i == 42);
  ioc.restart();
  ioc.run();
...
void test_5_arg_streambuf_async_write_at()
{
  ...
  sb.sputn(write_data, sizeof(write_data));
  called = false;
  zr_boost_1_81::asio::async_write_at(s, 0, sb, old_style_transfer_all,
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.sputn(write_data, sizeof(write_data));
  called = false;
  zr_boost_1_81::asio::async_write_at(s, 1234, sb, old_style_transfer_all,
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.sputn(write_data, sizeof(write_data));
  called = false;
  zr_boost_1_81::asio::async_write_at(s, 0, sb, short_transfer(),
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.sputn(write_data, sizeof(write_data));
  called = false;
  zr_boost_1_81::asio::async_write_at(s, 1234, sb, short_transfer(),
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  sb.consume(sb.size());
  sb.sputn(write_data, sizeof(write_data));
  int i = zr_boost_1_81::asio::async_write_at(s, 0, sb, short_transfer(),
      archetypes::lazy_handler());
  BOOST_ASIO_CHECK(i == 42);
  ioc.restart();
  ioc.run();
