...
void yield_break_coro(zr_boost_1_81::asio::coroutine& coro)
{
  reenter (coro)
  {
    yield return;
...
{
  zr_boost_1_81::asio::coroutine coro;
...
void return_coro(zr_boost_1_81::asio::coroutine& coro)
{
  reenter (coro)
  {
    return;
...
void exception_coro(zr_boost_1_81::asio::coroutine& coro)
{
  reenter (coro)
  {
    throw 1;
...
void fall_off_end_coro(zr_boost_1_81::asio::coroutine& coro)
{
  reenter (coro)
  {
  }
