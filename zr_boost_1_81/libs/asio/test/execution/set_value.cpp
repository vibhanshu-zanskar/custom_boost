...
struct const_member_set_value_1
{
  ...
  {
    typename zr_boost_1_81::asio::decay<V1>::type tmp(BOOST_ASIO_MOVE_CAST(V1)(v1));
    (void)tmp;
    ++call_count;
  }
};
...
struct const_member_set_value_2
{
  ...
  {
    typename zr_boost_1_81::asio::decay<V1>::type tmp1(BOOST_ASIO_MOVE_CAST(V1)(v1));
    (void)tmp1;
    typename zr_boost_1_81::asio::decay<V2>::type tmp2(BOOST_ASIO_MOVE_CAST(V2)(v2));
    (void)tmp2;
    ++call_count;
  }
};
