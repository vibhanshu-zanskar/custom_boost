...
{
  BOOST_ASIO_CHECK((
      !zr_boost_1_81::asio::execution::is_executor_of<
        void,
        void(*)()
      >::value));
...
void executor_shape_test()
{
  BOOST_ASIO_CHECK((
      zr_boost_1_81::asio::is_same<
        zr_boost_1_81::asio::execution::executor_shape<executor>::type,
        std::size_t
      >::value));

  BOOST_ASIO_CHECK((
      zr_boost_1_81::asio::is_same<
        zr_boost_1_81::asio::execution::executor_shape<
...
void executor_index_test()
{
  BOOST_ASIO_CHECK((
      zr_boost_1_81::asio::is_same<
        zr_boost_1_81::asio::execution::executor_index<executor>::type,
        std::size_t
      >::value));

  BOOST_ASIO_CHECK((
      zr_boost_1_81::asio::is_same<
        zr_boost_1_81::asio::execution::executor_index<
          executor_with_other_shape_type
        >::type,
        double
      >::value));
