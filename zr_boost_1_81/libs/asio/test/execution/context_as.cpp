...
void context_as_executor_query_test()
{
  ...
  BOOST_ASIO_CHECK(
      &zr_boost_1_81::asio::query(ex1,
        execution::context_as_t<static_thread_pool&>())
        == &pool);

  BOOST_ASIO_CHECK(
      &zr_boost_1_81::asio::query(ex1, execution::context)
        == &pool);
  ...
  BOOST_ASIO_CHECK(
      &zr_boost_1_81::asio::query(ex2,
        execution::context_as_t<const static_thread_pool&>())
        == &pool);

  BOOST_ASIO_CHECK(
      &zr_boost_1_81::asio::query(ex2, execution::context)
        == &pool);

  io_context io_ctx;

  BOOST_ASIO_CHECK(
      &zr_boost_1_81::asio::query(io_ctx.get_executor(),
  ...
  BOOST_ASIO_CHECK(
      &zr_boost_1_81::asio::query(ex3,
        execution::context_as_t<io_context&>())
        == &io_ctx);

  BOOST_ASIO_CHECK(
      &zr_boost_1_81::asio::query(ex3, execution::context)
        == &io_ctx);
  ...
  BOOST_ASIO_CHECK(
      &zr_boost_1_81::asio::query(ex4,
        execution::context_as_t<const io_context&>())
        == &io_ctx);

  BOOST_ASIO_CHECK(
      &zr_boost_1_81::asio::query(ex4, execution::context)
        == &io_ctx);
  ...
  BOOST_ASIO_CHECK(
      &zr_boost_1_81::asio::query(ex5,
        execution::context_as_t<execution_context&>())
        == &io_ctx);

  BOOST_ASIO_CHECK(
      &zr_boost_1_81::asio::query(ex5, execution::context)
        == &io_ctx);
  ...
  BOOST_ASIO_CHECK(
      &zr_boost_1_81::asio::query(ex6,
        execution::context_as_t<const execution_context&>())
        == &io_ctx);

  BOOST_ASIO_CHECK(
      &zr_boost_1_81::asio::query(ex6, execution::context)
        == &io_ctx);
}
