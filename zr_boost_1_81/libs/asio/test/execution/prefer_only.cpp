...
struct query_static_constexpr_member<
  ...
  typename zr_boost_1_81::asio::enable_if<
    zr_boost_1_81::asio::is_convertible<Param, execution::blocking_t>::value
  >::type>
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
...
void prefer_only_executor_query_test()
{
  ...
  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex1, execution::blocking)
        == execution::blocking.possibly);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex1, execution::blocking.possibly)
        == execution::blocking.possibly);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex1, execution::blocking.never)
        == execution::blocking.possibly);

  executor_type ex2 = zr_boost_1_81::asio::prefer(ex1, execution::blocking.possibly);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex2, execution::blocking)
        == execution::blocking.possibly);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex2, execution::blocking.possibly)
        == execution::blocking.possibly);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex2, execution::blocking.never)
        == execution::blocking.possibly);

  executor_type ex3 = zr_boost_1_81::asio::prefer(ex1, execution::blocking.never);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex3, execution::blocking)
        == execution::blocking.possibly);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex3, execution::blocking.possibly)
        == execution::blocking.possibly);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex3, execution::blocking.never)
        == execution::blocking.possibly);

  executor_type ex4 = never_blocking_executor();

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex4, execution::blocking)
        == execution::blocking.never);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex4, execution::blocking.possibly)
        == execution::blocking.never);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex4, execution::blocking.never)
        == execution::blocking.never);

  executor_type ex5 = zr_boost_1_81::asio::prefer(ex4, execution::blocking.possibly);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex5, execution::blocking)
        == execution::blocking.never);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex5, execution::blocking.possibly)
        == execution::blocking.never);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex5, execution::blocking.never)
        == execution::blocking.never);

  executor_type ex6 = zr_boost_1_81::asio::prefer(ex4, execution::blocking.never);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex6, execution::blocking)
        == execution::blocking.never);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex6, execution::blocking.possibly)
        == execution::blocking.never);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex6, execution::blocking.never)
        == execution::blocking.never);

  executor_type ex7 = either_blocking_executor(execution::blocking.possibly);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex7, execution::blocking)
        == execution::blocking.possibly);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex7, execution::blocking.possibly)
        == execution::blocking.possibly);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex7, execution::blocking.never)
        == execution::blocking.possibly);

  executor_type ex8 = zr_boost_1_81::asio::prefer(ex7, execution::blocking.possibly);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex8, execution::blocking)
        == execution::blocking.possibly);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex8, execution::blocking.possibly)
        == execution::blocking.possibly);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex8, execution::blocking.never)
        == execution::blocking.possibly);

  executor_type ex9 = zr_boost_1_81::asio::prefer(ex7, execution::blocking.never);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex9, execution::blocking)
        == execution::blocking.never);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex9, execution::blocking.possibly)
        == execution::blocking.never);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex9, execution::blocking.never)
        == execution::blocking.never);

  executor_type ex10 = either_blocking_executor(execution::blocking.never);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex10, execution::blocking)
        == execution::blocking.never);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex10, execution::blocking.possibly)
        == execution::blocking.never);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex10, execution::blocking.never)
        == execution::blocking.never);

  executor_type ex11 = zr_boost_1_81::asio::prefer(ex7, execution::blocking.possibly);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex11, execution::blocking)
        == execution::blocking.possibly);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex11, execution::blocking.possibly)
        == execution::blocking.possibly);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex11, execution::blocking.never)
        == execution::blocking.possibly);

  executor_type ex12 = zr_boost_1_81::asio::prefer(ex7, execution::blocking.never);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex12, execution::blocking)
        == execution::blocking.never);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex12, execution::blocking.possibly)
        == execution::blocking.never);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex12, execution::blocking.never)
        == execution::blocking.never);
}
