...
void any_executor_construction_test()
{
  ...
  thread_pool pool(1);
  zr_boost_1_81::asio::nullptr_t null_ptr = zr_boost_1_81::asio::nullptr_t();
...
void any_executor_query_test()
{
  ...
  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex, zr_boost_1_81::asio::execution::blocking)
        == zr_boost_1_81::asio::execution::blocking.possibly);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex, zr_boost_1_81::asio::execution::blocking.possibly)
        == zr_boost_1_81::asio::execution::blocking.possibly);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex, zr_boost_1_81::asio::execution::outstanding_work)
        == zr_boost_1_81::asio::execution::outstanding_work.untracked);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex, zr_boost_1_81::asio::execution::outstanding_work.untracked)
        == zr_boost_1_81::asio::execution::outstanding_work.untracked);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex, zr_boost_1_81::asio::execution::relationship)
        == zr_boost_1_81::asio::execution::relationship.fork);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex, zr_boost_1_81::asio::execution::relationship.fork)
        == zr_boost_1_81::asio::execution::relationship.fork);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex, zr_boost_1_81::asio::execution::mapping)
        == zr_boost_1_81::asio::execution::mapping.thread);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(ex, zr_boost_1_81::asio::execution::occupancy)
        == 1);
}
...
void any_executor_execute_test()
{
  ...
  zr_boost_1_81::asio::require(ex, zr_boost_1_81::asio::execution::blocking.possibly).execute(
      bindns::bind(increment, &count));

  zr_boost_1_81::asio::require(ex, zr_boost_1_81::asio::execution::blocking.never).execute(
      bindns::bind(increment, &count));

  zr_boost_1_81::asio::require(ex,
