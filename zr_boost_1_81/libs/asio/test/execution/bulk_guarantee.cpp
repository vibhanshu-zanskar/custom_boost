...
void test_query()
{
  exec::bulk_guarantee_t result1 = zr_boost_1_81::asio::query(Executor(), Param());
  BOOST_ASIO_CHECK(result1 == ExpectedResult());

  Executor ex1 = {};
  exec::bulk_guarantee_t result2 = zr_boost_1_81::asio::query(ex1, Param());
  BOOST_ASIO_CHECK(result2 == ExpectedResult());

  const Executor ex2 = {};
  exec::bulk_guarantee_t result3 = zr_boost_1_81::asio::query(ex2, Param());
...
void test_constexpr_query()
{
  ...
  constexpr exec::bulk_guarantee_t result1 = zr_boost_1_81::asio::query(ex1, Param());
  BOOST_ASIO_CHECK(result1 == ExpectedResult());
