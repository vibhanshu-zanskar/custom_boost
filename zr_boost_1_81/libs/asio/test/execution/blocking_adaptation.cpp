...
namespace exec = zr_boost_1_81::asio::execution;
...
struct query_static_constexpr_member<
  ...
  typename zr_boost_1_81::asio::enable_if<
    zr_boost_1_81::asio::is_convertible<Param, ParamType>::value
  >::type>
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
...
struct query_member<
  ...
  typename zr_boost_1_81::asio::enable_if<
    zr_boost_1_81::asio::is_convertible<Param, CurrentType>::value
      || zr_boost_1_81::asio::is_convertible<Param, OtherType>::value
  >::type>
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
...
struct require_member<
  ...
  typename zr_boost_1_81::asio::enable_if<
    zr_boost_1_81::asio::is_convertible<Param, OtherType>::value
      && !zr_boost_1_81::asio::is_same<CurrentType, OtherType>::value
  >::type>
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
...
void test_can_query()
{
  BOOST_ASIO_CONSTEXPR bool b1 =
    zr_boost_1_81::asio::can_query<Executor, Param>::value;
  BOOST_ASIO_CHECK(b1 == ExpectedResult);

  BOOST_ASIO_CONSTEXPR bool b2 =
    zr_boost_1_81::asio::can_query<const Executor, Param>::value;
...
void test_query()
{
  exec::blocking_adaptation_t result1 = zr_boost_1_81::asio::query(Executor(), Param());
  BOOST_ASIO_CHECK(result1 == ExpectedResult());

  Executor ex1 = {};
  exec::blocking_adaptation_t result2 = zr_boost_1_81::asio::query(ex1, Param());
  BOOST_ASIO_CHECK(result2 == ExpectedResult());

  const Executor ex2 = {};
  exec::blocking_adaptation_t result3 = zr_boost_1_81::asio::query(ex2, Param());
...
void test_constexpr_query()
{
  ...
  constexpr exec::blocking_adaptation_t result1 = zr_boost_1_81::asio::query(ex1, Param());
  BOOST_ASIO_CHECK(result1 == ExpectedResult());
...
{
  BOOST_ASIO_CONSTEXPR bool b1 =
    zr_boost_1_81::asio::can_require<Executor, Param>::value;
  BOOST_ASIO_CHECK(b1 == ExpectedResult);

  BOOST_ASIO_CONSTEXPR bool b2 =
    zr_boost_1_81::asio::can_require<const Executor, Param>::value;
  BOOST_ASIO_CHECK(b2 == ExpectedResult);
...
{
  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(
        zr_boost_1_81::asio::require(Executor(), Param()),
  ...
  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(
        zr_boost_1_81::asio::require(ex1, Param()),
        Param()) == ExpectedResult());

  BOOST_ASIO_CHECK((
      zr_boost_1_81::asio::execution::is_executor<
        typename zr_boost_1_81::asio::decay<
          typename zr_boost_1_81::asio::require_result<Executor&, Param>::type
        >::type
      >::value));
  ...
  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(
        zr_boost_1_81::asio::require(ex2, Param()),
        Param()) == ExpectedResult());

  BOOST_ASIO_CHECK((
      zr_boost_1_81::asio::execution::is_executor<
        typename zr_boost_1_81::asio::decay<
          typename zr_boost_1_81::asio::require_result<const Executor&, Param>::type
        >::type
      >::value));
}
...
{
  BOOST_ASIO_CONSTEXPR bool b1 =
    zr_boost_1_81::asio::can_prefer<Executor, Param>::value;
  BOOST_ASIO_CHECK(b1 == ExpectedResult);

  BOOST_ASIO_CONSTEXPR bool b2 =
    zr_boost_1_81::asio::can_prefer<const Executor, Param>::value;
  BOOST_ASIO_CHECK(b2 == ExpectedResult);
...
{
  BOOST_ASIO_CHECK(
      s(zr_boost_1_81::asio::query(
        zr_boost_1_81::asio::prefer(Executor(), Param()),
          s())) == s(ExpectedResult()));

  Executor ex1 = {};
  BOOST_ASIO_CHECK(
      s(zr_boost_1_81::asio::query(
        zr_boost_1_81::asio::prefer(ex1, Param()),
          s())) == s(ExpectedResult()));

  const Executor ex2 = {};
  BOOST_ASIO_CHECK(
      s(zr_boost_1_81::asio::query(
        zr_boost_1_81::asio::prefer(ex2, Param()),
          s())) == s(ExpectedResult()));
}
