...
namespace chronons = zr_boost_1_81::posix_time;
#elif defined(BOOST_ASIO_HAS_CHRONO)
typedef steady_timer timer;
namespace chronons = zr_boost_1_81::asio::chrono;
#endif // defined(BOOST_ASIO_HAS_BOOST_DATE_TIME)
...
void decrement_to_zero(io_context* ioc, int* count)
{
  if (*count > 0)
  {
    ...
    zr_boost_1_81::asio::post(*ioc, bindns::bind(decrement_to_zero, ioc, count));
...
void nested_decrement_to_zero(io_context* ioc, int* count)
{
  if (*count > 0)
  {
    ...
    zr_boost_1_81::asio::dispatch(*ioc,
...
void sleep_increment(io_context* ioc, int* count)
{
  ...
  if (++(*count) < 3)
    zr_boost_1_81::asio::post(*ioc, bindns::bind(sleep_increment, ioc, count));
}
...
void io_context_test()
{
  ...
  zr_boost_1_81::asio::post(ioc, bindns::bind(increment, &count));
  ...
  zr_boost_1_81::asio::post(ioc, bindns::bind(&io_context::stop, &ioc));
  BOOST_ASIO_CHECK(!ioc.stopped());
  ioc.run();
  ...
  count = 10;
  ioc.restart();
  zr_boost_1_81::asio::post(ioc, bindns::bind(nested_decrement_to_zero, &ioc, &count));
  ...
  ioc.restart();
  BOOST_ASIO_CHECK(!ioc.stopped());
  zr_boost_1_81::asio::post(ioc, bindns::bind(start_sleep_increments, &ioc, &count));
  zr_boost_1_81::asio::post(ioc, bindns::bind(start_sleep_increments, &ioc, &count2));
  zr_boost_1_81::asio::detail::thread thread1(bindns::bind(io_context_run, &ioc));
  zr_boost_1_81::asio::detail::thread thread2(bindns::bind(io_context_run, &ioc));
  thread1.join();
  thread2.join();
  ...
  count = 10;
  io_context ioc2;
  zr_boost_1_81::asio::dispatch(ioc, zr_boost_1_81::asio::bind_executor(ioc2,
  ...
  ioc.restart();
  zr_boost_1_81::asio::post(ioc, &throw_exception);
  zr_boost_1_81::asio::post(ioc, bindns::bind(increment, &count));
  zr_boost_1_81::asio::post(ioc, bindns::bind(increment, &count));
  zr_boost_1_81::asio::post(ioc, &throw_exception);
  zr_boost_1_81::asio::post(ioc, bindns::bind(increment, &count));
...
class test_service : public zr_boost_1_81::asio::io_context::service
{
public:
  static zr_boost_1_81::asio::io_context::id id;
  test_service(zr_boost_1_81::asio::io_context& s)
    : zr_boost_1_81::asio::io_context::service(s) {}
private:
  virtual void shutdown_service() {}
};

zr_boost_1_81::asio::io_context::id test_service::id;

void io_context_service_test()
{
  zr_boost_1_81::asio::io_context ioc1;
  zr_boost_1_81::asio::io_context ioc2;
  zr_boost_1_81::asio::io_context ioc3;

  // Implicit service registration.

  zr_boost_1_81::asio::use_service<test_service>(ioc1);

  BOOST_ASIO_CHECK(zr_boost_1_81::asio::has_service<test_service>(ioc1));

  test_service* svc1 = new test_service(ioc1);
  try
  {
    zr_boost_1_81::asio::add_service(ioc1, svc1);
  ...
  zr_boost_1_81::asio::add_service(ioc2, svc2);

  BOOST_ASIO_CHECK(zr_boost_1_81::asio::has_service<test_service>(ioc2));
  BOOST_ASIO_CHECK(&zr_boost_1_81::asio::use_service<test_service>(ioc2) == svc2);

  test_service* svc3 = new test_service(ioc2);
  try
  {
    zr_boost_1_81::asio::add_service(ioc2, svc3);
    BOOST_ASIO_ERROR("add_service did not throw");
  }
  catch (zr_boost_1_81::asio::service_already_exists&)
  {
  ...
  try
  {
    zr_boost_1_81::asio::add_service(ioc3, svc4);
    BOOST_ASIO_ERROR("add_service did not throw");
  }
  ...
  BOOST_ASIO_CHECK(!zr_boost_1_81::asio::has_service<test_service>(ioc3));
}
...
void io_context_executor_query_test()
{
  ...
  BOOST_ASIO_CHECK(
      &zr_boost_1_81::asio::query(ioc.get_executor(),
...
void io_context_executor_execute_test()
{
  ...
  count = 0;
  ioc.restart();
  zr_boost_1_81::asio::require(ioc.get_executor(),
      zr_boost_1_81::asio::execution::blocking.possibly
