...
void test()
{
  ...
  try
  {
    ...
    zr_boost_1_81::asio::write(p2, zr_boost_1_81::asio::buffer(data1));

    std::string data2;
    data2.resize(data1.size());
    zr_boost_1_81::asio::read(p1, zr_boost_1_81::asio::buffer(data2));

    BOOST_ASIO_CHECK(data1 == data2);

    char read_buffer[sizeof(write_data)];
    bool read_completed = false;
    zr_boost_1_81::asio::async_read(p1,
        zr_boost_1_81::asio::buffer(read_buffer),
        bindns::bind(handle_read,
          _1, _2, &read_completed));

    bool write_completed = false;
    zr_boost_1_81::asio::async_write(p2,
