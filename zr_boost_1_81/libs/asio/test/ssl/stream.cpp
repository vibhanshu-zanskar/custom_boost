...
bool verify_callback(bool, zr_boost_1_81::asio::ssl::verify_context&)
{
  return false;
}

void handshake_handler(const zr_boost_1_81::system::error_code&)
{
}

void buffered_handshake_handler(const zr_boost_1_81::system::error_code&, std::size_t)
{
}

void shutdown_handler(const zr_boost_1_81::system::error_code&)
{
}
...
void test()
{
  ...
  try
  {
    ...
    zr_boost_1_81::asio::ssl::context context(zr_boost_1_81::asio::ssl::context::sslv23);
