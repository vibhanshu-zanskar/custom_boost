...
void handle_send(size_t expected_bytes_sent,
    const zr_boost_1_81::system::error_code& err, size_t bytes_sent)
{
...
void handle_recv(size_t expected_bytes_recvd,
    const zr_boost_1_81::system::error_code& err, size_t bytes_recvd)
{
  BOOST_ASIO_CHECK(!err);
...
struct resolve_handler
{
  resolve_handler() {}
  void operator()(const zr_boost_1_81::system::error_code&,
      zr_boost_1_81::asio::ip::udp::resolver::results_type) {}
#if defined(BOOST_ASIO_HAS_MOVE)
