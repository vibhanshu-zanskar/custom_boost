...
void test()
{
  ...
  namespace ip = zr_boost_1_81::asio::ip;
...
{
  send_handler() {}
  void operator()(const zr_boost_1_81::system::error_code&, std::size_t) {}
#if defined(BOOST_ASIO_HAS_MOVE)
...
void handle_read_noop(const zr_boost_1_81::system::error_code& err,
...
void handle_write_noop(const zr_boost_1_81::system::error_code& err,
    size_t bytes_transferred, bool* called)
{
  *called = true;
  BOOST_ASIO_CHECK(!err);
...
void handle_read(const zr_boost_1_81::system::error_code& err,
    size_t bytes_transferred, bool* called)
{
  *called = true;
  BOOST_ASIO_CHECK(!err);
...
void handle_write(const zr_boost_1_81::system::error_code& err,
    size_t bytes_transferred, bool* called)
{
  *called = true;
  BOOST_ASIO_CHECK(!err);
...
void handle_read_cancel(const zr_boost_1_81::system::error_code& err,
    size_t bytes_transferred, bool* called)
{
  *called = true;
  BOOST_ASIO_CHECK(err == zr_boost_1_81::asio::error::operation_aborted);
  BOOST_ASIO_CHECK(bytes_transferred == 0);
}

void handle_read_eof(const zr_boost_1_81::system::error_code& err,
    size_t bytes_transferred, bool* called)
{
  *called = true;
  BOOST_ASIO_CHECK(err == zr_boost_1_81::asio::error::eof);
  BOOST_ASIO_CHECK(bytes_transferred == 0);
}
...
void test()
{
  ...
  client_side_socket.async_read_some(
      zr_boost_1_81::asio::mutable_buffer(0, 0),
  ...
  client_side_socket.async_write_some(
      zr_boost_1_81::asio::const_buffer(0, 0),
  ...
  zr_boost_1_81::asio::async_read(client_side_socket,
      zr_boost_1_81::asio::buffer(read_buffer),
      bindns::bind(handle_read,
        _1, _2, &read_completed));

  bool write_completed = false;
  zr_boost_1_81::asio::async_write(server_side_socket,
      zr_boost_1_81::asio::buffer(write_data),
  ...
  zr_boost_1_81::asio::async_read(server_side_socket,
      zr_boost_1_81::asio::buffer(read_buffer),
...
struct move_accept_handler
{
  move_accept_handler() {}
  void operator()(
      const zr_boost_1_81::system::error_code&, zr_boost_1_81::asio::ip::tcp::socket) {}
...
struct move_accept_ioc_handler
{
  ...
  void operator()(const zr_boost_1_81::system::error_code&,
      zr_boost_1_81::asio::basic_stream_socket<zr_boost_1_81::asio::ip::tcp,
        zr_boost_1_81::asio::io_context::executor_type>) {}
...
void test()
{
  ...
  try
  {
    ...
    zr_boost_1_81::asio::basic_stream_socket<ip::tcp,
...
void handle_accept(const zr_boost_1_81::system::error_code& err)
{
  BOOST_ASIO_CHECK(!err);
}
...
struct resolve_handler
{
  resolve_handler() {}
  void operator()(const zr_boost_1_81::system::error_code&,
      zr_boost_1_81::asio::ip::tcp::resolver::results_type) {}
#if defined(BOOST_ASIO_HAS_MOVE)
...
struct legacy_resolve_handler
{
  ...
  void operator()(const zr_boost_1_81::system::error_code&,
      zr_boost_1_81::asio::ip::tcp::resolver::iterator) {}
#if defined(BOOST_ASIO_HAS_MOVE)
...
void test()
{
  ...
  zr_boost_1_81::asio::ip::tcp::socket sock(ioc);
  ...
  zr_boost_1_81::system::error_code ec = ios1.error();
  (void)ec;
