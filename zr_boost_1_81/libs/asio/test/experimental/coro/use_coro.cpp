...
zr_boost_1_81::asio::experimental::coro<void(), int>
awaiter(zr_boost_1_81::asio::any_io_executor exec)
{
  zr_boost_1_81::asio::steady_timer timer{exec};
  co_await timer.async_wait(use_coro);
  co_return 42;
}

zr_boost_1_81::asio::experimental::coro<void() noexcept, int>
awaiter_noexcept(zr_boost_1_81::asio::any_io_executor exec)
{
  zr_boost_1_81::asio::steady_timer timer{exec};
  auto ec = co_await timer.async_wait(zr_boost_1_81::asio::deferred);
  BOOST_ASIO_CHECK(ec == zr_boost_1_81::system::error_code{});
  co_return 42;
}
