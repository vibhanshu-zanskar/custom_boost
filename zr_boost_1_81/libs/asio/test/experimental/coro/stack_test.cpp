...
zr_boost_1_81::asio::experimental::coro<int()>
  stack_generator(zr_boost_1_81::asio::any_io_executor, int i = 1)
{
  for (;;)
  {
    co_yield i;
...
stack_accumulate(zr_boost_1_81::asio::any_io_executor exec)
{
...
zr_boost_1_81::asio::experimental::coro<int>
main_stack_coro(zr_boost_1_81::asio::io_context&, bool & done)
{
  auto g = stack_accumulate(co_await zr_boost_1_81::asio::this_coro::executor);
...
void stack_test()
{
  ...
  k.async_resume(zr_boost_1_81::asio::detached);
  ctx.run();
