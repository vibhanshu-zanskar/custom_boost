...
{
  zr_boost_1_81::asio::thread_pool th_ctx{1u};
  zr_boost_1_81::asio::io_context ctx;

  auto o = std::make_optional(
      zr_boost_1_81::asio::prefer(th_ctx.get_executor(),
  ...
  struct c_inner_t
  {
    auto operator()(zr_boost_1_81::asio::any_io_executor e) -> zr_boost_1_81::asio::experimental::coro<T>
    {
      auto p = e.target<zr_boost_1_81::asio::thread_pool::executor_type>();
  ...
  struct c_outer_t
  {
    ...
    auto operator()(zr_boost_1_81::asio::any_io_executor e, int,
        zr_boost_1_81::asio::experimental::coro<T> tp)
      -> zr_boost_1_81::asio::experimental::coro<void>
    {
      auto p = e.target<zr_boost_1_81::asio::io_context::executor_type>();
