...
{
  for (;;)
    co_await zr_boost_1_81::asio::post(zr_boost_1_81::asio::use_awaitable);
}
...
void test_and_awaitable_operator()
{
  ...
  co_spawn(ctx, do_test_and_awaitable_operator(), zr_boost_1_81::asio::detached);
  ctx.run();
}
...
{
  zr_boost_1_81::asio::io_context ctx;
  co_spawn(ctx, do_test_or_awaitable_operator(), zr_boost_1_81::asio::detached);
  ctx.run();
}
