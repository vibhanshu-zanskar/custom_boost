...
void promise_tester()
{
  ...
  p([&](zr_boost_1_81::system::error_code ec_)
      {
        ec = ec_;
        called = true;
  ...
  static_assert(
      zr_boost_1_81::asio::is_async_operation<decltype(p)>::value,
      "promise is async_op");
...
void promise_slot_tester()
{
  ...
  p(zr_boost_1_81::asio::bind_cancellation_slot(
        sig.slot(),
  ...
  timer2.async_wait(
      ...
      {
        timer2_done = steady_clock::now();
        sig.emit(zr_boost_1_81::asio::cancellation_type::all);
      });
...
void early_completion()
{
  ...
  io_context ctx;
  auto p = zr_boost_1_81::asio::post(ctx, zr_boost_1_81::asio::experimental::use_promise);
  ctx.run();
...
{
  zr_boost_1_81::asio::steady_timer & tim;
  zr_boost_1_81::system::error_code &ec;
  ...
  template<typename Self>
  void operator()(Self& self, zr_boost_1_81::system::error_code ec_)
  {
    ec = ec_;
    self.complete(ec_);
  }
...
test_cancel_impl(zr_boost_1_81::asio::steady_timer & tim,
                 zr_boost_1_81::system::error_code &ec,
                 CompletionToken&& token)
{
  return zr_boost_1_81::asio::async_compose<CompletionToken, void(zr_boost_1_81::system::error_code)>(
...
void test_cancel()
{
  ...
  zr_boost_1_81::asio::steady_timer tim{ctx, std::chrono::seconds(10)};
  zr_boost_1_81::system::error_code ec;

  {
    auto p = test_cancel_impl(
        tim, ec, zr_boost_1_81::asio::experimental::use_promise);
  }
