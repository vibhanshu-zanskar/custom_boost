...
void increment_on_cancel(int* count, const zr_boost_1_81::system::error_code& error)
{
  if (error == zr_boost_1_81::asio::error::operation_aborted)
    ++(*count);
}
...
struct incrementer_handler_v1
{
  ...
  void operator()(zr_boost_1_81::system::error_code error)
  {
...
template <>
class async_result<incrementer_token_v1, void(zr_boost_1_81::system::error_code)>
{
public:
...
template <>
class async_result<incrementer_token_v2, void(zr_boost_1_81::system::error_code)>
{
public:
  typedef void return_type;
