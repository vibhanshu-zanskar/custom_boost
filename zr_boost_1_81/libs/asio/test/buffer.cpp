...
#if defined(BOOST_ASIO_HAS_BOOST_ARRAY)
    zr_boost_1_81::array<char, 1024> array_data;
    const zr_boost_1_81::array<char, 1024>& const_array_data_1 = array_data;
    zr_boost_1_81::array<const char, 1024> const_array_data_2 = { { 0 } };
#endif // defined(BOOST_ASIO_HAS_BOOST_ARRAY)
#if defined(BOOST_ASIO_HAS_STD_ARRAY)
...
void test()
{
  ...
  mutable_buffer mb1 = zr_boost_1_81::asio::buffer(dest_data);
  mutable_buffer mb2 = zr_boost_1_81::asio::buffer(source_data);
  std::size_t n = buffer_copy(mb1, mb2);
  BOOST_ASIO_CHECK(n == sizeof(source_data));
  BOOST_ASIO_CHECK(memcmp(dest_data, source_data, n) == 0);

  memset(dest_data, 0, sizeof(dest_data));
  mb1 = zr_boost_1_81::asio::buffer(dest_data);
  const_buffer cb1 = zr_boost_1_81::asio::buffer(source_data);
  ...
  memset(dest_data, 0, sizeof(dest_data));
  mb1 = zr_boost_1_81::asio::buffer(dest_data);
  mutable_buffers_1 mbc1 = zr_boost_1_81::asio::buffer(source_data);
  ...
  memset(dest_data, 0, sizeof(dest_data));
  mb1 = zr_boost_1_81::asio::buffer(dest_data);
  const_buffers_1 cbc1 = const_buffers_1(zr_boost_1_81::asio::buffer(source_data));
  n = buffer_copy(mb1, cbc1);
  BOOST_ASIO_CHECK(n == sizeof(source_data));
  BOOST_ASIO_CHECK(memcmp(dest_data, source_data, n) == 0);

  memset(dest_data, 0, sizeof(dest_data));
  mbc1 = zr_boost_1_81::asio::buffer(dest_data);
  mb1 = zr_boost_1_81::asio::buffer(source_data);
  ...
  memset(dest_data, 0, sizeof(dest_data));
  mbc1 = zr_boost_1_81::asio::buffer(dest_data);
  cb1 = zr_boost_1_81::asio::buffer(source_data);
  ...
  memset(dest_data, 0, sizeof(dest_data));
  mbc1 = zr_boost_1_81::asio::buffer(dest_data);
  mutable_buffers_1 mbc2 = zr_boost_1_81::asio::buffer(source_data);
  ...
  memset(dest_data, 0, sizeof(dest_data));
  mbc1 = zr_boost_1_81::asio::buffer(dest_data);
  cbc1 = const_buffers_1(zr_boost_1_81::asio::buffer(source_data));
  ...
  mv1.push_back(zr_boost_1_81::asio::buffer(source_data, 5));
  mv1.push_back(zr_boost_1_81::asio::buffer(source_data) + 5);
  ...
  cv1.push_back(zr_boost_1_81::asio::buffer(source_data, 6));
  cv1.push_back(zr_boost_1_81::asio::buffer(source_data) + 6);
  ...
  memset(dest_data, 0, sizeof(dest_data));
  mv1.clear();
  mv1.push_back(zr_boost_1_81::asio::buffer(dest_data, 7));
  mv1.push_back(zr_boost_1_81::asio::buffer(dest_data) + 7);
  cb1 = zr_boost_1_81::asio::buffer(source_data);
  ...
  mv1.push_back(zr_boost_1_81::asio::buffer(dest_data) + 7);
  cv1.clear();
  cv1.push_back(zr_boost_1_81::asio::buffer(source_data, 8));
  cv1.push_back(zr_boost_1_81::asio::buffer(source_data) + 8);
  ...
  memset(dest_data, 0, sizeof(dest_data));
  mb1 = zr_boost_1_81::asio::buffer(dest_data);
  mb2 = zr_boost_1_81::asio::buffer(source_data);
  ...
  memset(dest_data, 0, sizeof(dest_data));
  mb1 = zr_boost_1_81::asio::buffer(dest_data);
  mbc1 = zr_boost_1_81::asio::buffer(source_data);
  ...
  memset(dest_data, 0, sizeof(dest_data));
  mbc1 = zr_boost_1_81::asio::buffer(dest_data);
  mbc2 = zr_boost_1_81::asio::buffer(source_data);
