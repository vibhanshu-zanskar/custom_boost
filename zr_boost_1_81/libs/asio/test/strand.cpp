...
void strand_query_test()
{
  ...
  BOOST_ASIO_CHECK(
      &zr_boost_1_81::asio::query(s1, zr_boost_1_81::asio::execution::context)
        == &ioc);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(s1, zr_boost_1_81::asio::execution::blocking)
        == zr_boost_1_81::asio::execution::blocking.possibly);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(s1, zr_boost_1_81::asio::execution::blocking.possibly)
        == zr_boost_1_81::asio::execution::blocking.possibly);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(s1, zr_boost_1_81::asio::execution::outstanding_work)
        == zr_boost_1_81::asio::execution::outstanding_work.untracked);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(s1, zr_boost_1_81::asio::execution::outstanding_work.untracked)
        == zr_boost_1_81::asio::execution::outstanding_work.untracked);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(s1, zr_boost_1_81::asio::execution::relationship)
        == zr_boost_1_81::asio::execution::relationship.fork);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(s1, zr_boost_1_81::asio::execution::relationship.fork)
        == zr_boost_1_81::asio::execution::relationship.fork);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(s1, zr_boost_1_81::asio::execution::mapping)
        == zr_boost_1_81::asio::execution::mapping.thread);

  BOOST_ASIO_CHECK(
      zr_boost_1_81::asio::query(s1, zr_boost_1_81::asio::execution::allocator)
        == std::allocator<void>());
}
...
void strand_execute_test()
{
  ...
  count = 0;
  ioc.restart();
  zr_boost_1_81::asio::require(s1, zr_boost_1_81::asio::execution::blocking.possibly).execute(
  ...
  count = 0;
  ioc.restart();
  zr_boost_1_81::asio::require(s1, zr_boost_1_81::asio::execution::blocking.never).execute(
      bindns::bind(increment, &count));
