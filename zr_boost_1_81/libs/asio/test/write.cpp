...
public:
  ...
  bool check_buffers(Iterator begin, Iterator end, size_t length)
  {
    ...
    {
      size_t buffer_length = zr_boost_1_81::asio::buffer_size(*iter);
  ...
  {
    return check_buffers(zr_boost_1_81::asio::buffer_sequence_begin(buffers),
        zr_boost_1_81::asio::buffer_sequence_end(buffers), length);
  }

  template <typename Const_Buffers>
  size_t write_some(const Const_Buffers& buffers)
  {
    size_t n = zr_boost_1_81::asio::buffer_copy(
  ...
  template <typename Const_Buffers>
  size_t write_some(const Const_Buffers& buffers, zr_boost_1_81::system::error_code& ec)
  {
...
void test_2_arg_zero_buffers_write()
{
  ...
  size_t bytes_transferred = zr_boost_1_81::asio::write(s, buffers);
...
void test_2_arg_const_buffer_write()
{
  zr_boost_1_81::asio::io_context ioc;
  test_stream s(ioc);
  zr_boost_1_81::asio::const_buffer buffers
    = zr_boost_1_81::asio::buffer(write_data, sizeof(write_data));
  ...
  bytes_transferred = zr_boost_1_81::asio::write(s, buffers);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
...
void test_2_arg_mutable_buffer_write()
{
  zr_boost_1_81::asio::io_context ioc;
  test_stream s(ioc);
  zr_boost_1_81::asio::mutable_buffer buffers
    = zr_boost_1_81::asio::buffer(mutable_write_data, sizeof(mutable_write_data));
...
void test_2_arg_vector_buffers_write()
{
  ...
  test_stream s(ioc);
  std::vector<zr_boost_1_81::asio::const_buffer> buffers;
  buffers.push_back(zr_boost_1_81::asio::buffer(write_data, 32));
  buffers.push_back(zr_boost_1_81::asio::buffer(write_data, 39) + 32);
  buffers.push_back(zr_boost_1_81::asio::buffer(write_data) + 39);
...
void test_2_arg_dynamic_string_write()
{
  ...
  zr_boost_1_81::asio::dynamic_string_buffer<char, std::string::traits_type,
    std::string::allocator_type> sb
      = zr_boost_1_81::asio::dynamic_buffer(data, sizeof(write_data));
  zr_boost_1_81::asio::const_buffer buffers
    = zr_boost_1_81::asio::buffer(write_data, sizeof(write_data));

  s.reset();
  data.assign(write_data, sizeof(write_data));
  size_t bytes_transferred = zr_boost_1_81::asio::write(s, sb);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
  ...
  data.assign(write_data, sizeof(write_data));
  s.next_write_length(1);
  bytes_transferred = zr_boost_1_81::asio::write(s, sb);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
...
void test_3_arg_nothrow_zero_buffers_write()
{
  ...
  size_t bytes_transferred = zr_boost_1_81::asio::write(s, buffers, error);
  BOOST_ASIO_CHECK(bytes_transferred == 0);
...
void test_3_arg_nothrow_const_buffer_write()
{
  ...
  s.reset();
  s.next_write_length(1);
  bytes_transferred = zr_boost_1_81::asio::write(s, buffers, error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
  BOOST_ASIO_CHECK(!error);
...
void test_3_arg_nothrow_dynamic_string_write()
{
  ...
  data.assign(write_data, sizeof(write_data));
  zr_boost_1_81::system::error_code error;
  size_t bytes_transferred = zr_boost_1_81::asio::write(s, sb, error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
  BOOST_ASIO_CHECK(!error);
  ...
  data.assign(write_data, sizeof(write_data));
  s.next_write_length(1);
  bytes_transferred = zr_boost_1_81::asio::write(s, sb, error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
  BOOST_ASIO_CHECK(!error);
...
bool old_style_transfer_all(const zr_boost_1_81::system::error_code& ec,
...
struct short_transfer
{
  ...
  size_t operator()(const zr_boost_1_81::system::error_code& ec,
      size_t /*bytes_transferred*/)
  {
    return !!ec ? 0 : 3;
  }
...
void test_3_arg_const_buffer_write()
{
  ...
  s.reset();
  size_t bytes_transferred = zr_boost_1_81::asio::write(s, buffers,
      zr_boost_1_81::asio::transfer_all());
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
  ...
  s.reset();
  bytes_transferred = zr_boost_1_81::asio::write(s, buffers,
      zr_boost_1_81::asio::transfer_at_least(10));
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
  ...
  s.reset();
  bytes_transferred = zr_boost_1_81::asio::write(s, buffers,
      zr_boost_1_81::asio::transfer_at_least(42));
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
  ...
  s.reset();
  bytes_transferred = zr_boost_1_81::asio::write(s, buffers,
      zr_boost_1_81::asio::transfer_exactly(1));
  BOOST_ASIO_CHECK(bytes_transferred == 1);
  BOOST_ASIO_CHECK(s.check_buffers(buffers, 1));
  ...
  s.reset();
  bytes_transferred = zr_boost_1_81::asio::write(s, buffers,
      zr_boost_1_81::asio::transfer_exactly(10));
  BOOST_ASIO_CHECK(bytes_transferred == 10);
  BOOST_ASIO_CHECK(s.check_buffers(buffers, 10));
  ...
  s.reset();
  bytes_transferred = zr_boost_1_81::asio::write(s, buffers,
      zr_boost_1_81::asio::transfer_exactly(42));
  BOOST_ASIO_CHECK(bytes_transferred == 42);
  BOOST_ASIO_CHECK(s.check_buffers(buffers, 42));
  ...
  s.reset();
  bytes_transferred = zr_boost_1_81::asio::write(s, buffers, old_style_transfer_all);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
  ...
  s.reset();
  bytes_transferred = zr_boost_1_81::asio::write(s, buffers, short_transfer());
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
...
void test_3_arg_dynamic_string_write()
{
  ...
  s.reset();
  data.assign(write_data, sizeof(write_data));
  bytes_transferred = zr_boost_1_81::asio::write(s, sb, old_style_transfer_all);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
  ...
  s.reset();
  data.assign(write_data, sizeof(write_data));
  bytes_transferred = zr_boost_1_81::asio::write(s, sb, short_transfer());
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
...
void test_4_arg_const_buffer_write()
{
  ...
  zr_boost_1_81::system::error_code error;
  size_t bytes_transferred = zr_boost_1_81::asio::write(s, buffers,
      zr_boost_1_81::asio::transfer_all(), error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
  BOOST_ASIO_CHECK(!error);
  ...
  s.reset();
  s.next_write_length(1);
  error = zr_boost_1_81::system::error_code();
  bytes_transferred = zr_boost_1_81::asio::write(s, buffers,
      zr_boost_1_81::asio::transfer_all(), error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
  ...
  error = zr_boost_1_81::system::error_code();
  bytes_transferred = zr_boost_1_81::asio::write(s, buffers,
      zr_boost_1_81::asio::transfer_at_least(1), error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
  BOOST_ASIO_CHECK(!error);
  ...
  error = zr_boost_1_81::system::error_code();
  bytes_transferred = zr_boost_1_81::asio::write(s, buffers,
      zr_boost_1_81::asio::transfer_at_least(10), error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
  BOOST_ASIO_CHECK(!error);
  ...
  error = zr_boost_1_81::system::error_code();
  bytes_transferred = zr_boost_1_81::asio::write(s, buffers,
      zr_boost_1_81::asio::transfer_at_least(42), error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
  BOOST_ASIO_CHECK(!error);
  ...
  error = zr_boost_1_81::system::error_code();
  bytes_transferred = zr_boost_1_81::asio::write(s, buffers,
      zr_boost_1_81::asio::transfer_exactly(1), error);
  BOOST_ASIO_CHECK(bytes_transferred == 1);
  BOOST_ASIO_CHECK(s.check_buffers(buffers, 1));
  BOOST_ASIO_CHECK(!error);
  ...
  error = zr_boost_1_81::system::error_code();
  bytes_transferred = zr_boost_1_81::asio::write(s, buffers,
      zr_boost_1_81::asio::transfer_exactly(10), error);
  BOOST_ASIO_CHECK(bytes_transferred == 10);
  BOOST_ASIO_CHECK(s.check_buffers(buffers, 10));
  BOOST_ASIO_CHECK(!error);
  ...
  error = zr_boost_1_81::system::error_code();
  bytes_transferred = zr_boost_1_81::asio::write(s, buffers,
      zr_boost_1_81::asio::transfer_exactly(42), error);
  BOOST_ASIO_CHECK(bytes_transferred == 42);
  BOOST_ASIO_CHECK(s.check_buffers(buffers, 42));
  BOOST_ASIO_CHECK(!error);
  ...
  s.reset();
  bytes_transferred = zr_boost_1_81::asio::write(s, buffers, short_transfer(), error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
  BOOST_ASIO_CHECK(!error);
...
void test_4_arg_dynamic_string_write()
{
  ...
  s.reset();
  data.assign(write_data, sizeof(write_data));
  bytes_transferred = zr_boost_1_81::asio::write(s, sb, short_transfer(), error);
  BOOST_ASIO_CHECK(bytes_transferred == sizeof(write_data));
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
  BOOST_ASIO_CHECK(!error);
...
void async_write_handler(const zr_boost_1_81::system::error_code& e,
...
void test_3_arg_const_buffer_async_write()
{
  ...
  s.reset();
  bool called = false;
  zr_boost_1_81::asio::async_write(s, buffers,
  ...
  s.reset();
  int i = zr_boost_1_81::asio::async_write(s, buffers, archetypes::lazy_handler());
...
void test_3_arg_boost_array_buffers_async_write()
{
  ...
  zr_boost_1_81::array<zr_boost_1_81::asio::const_buffer, 2> buffers = { {
    zr_boost_1_81::asio::buffer(write_data, 32),
    zr_boost_1_81::asio::buffer(write_data) + 32 } };
...
void test_3_arg_std_array_buffers_async_write()
{
  ...
  zr_boost_1_81::asio::io_context ioc;
  test_stream s(ioc);
  std::array<zr_boost_1_81::asio::const_buffer, 2> buffers = { {
    zr_boost_1_81::asio::buffer(write_data, 32),
    zr_boost_1_81::asio::buffer(write_data) + 32 } };
...
void test_3_arg_dynamic_string_async_write()
{
  ...
  data.assign(write_data, sizeof(write_data));
  bool called = false;
  zr_boost_1_81::asio::async_write(s, sb,
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  data.assign(write_data, sizeof(write_data));
  int i = zr_boost_1_81::asio::async_write(s, sb, archetypes::lazy_handler());
  BOOST_ASIO_CHECK(i == 42);
  ioc.restart();
  ioc.run();
  BOOST_ASIO_CHECK(s.check_buffers(buffers, sizeof(write_data)));
...
void test_3_arg_streambuf_async_write()
{
  ...
  zr_boost_1_81::asio::io_context ioc;
  test_stream s(ioc);
  zr_boost_1_81::asio::streambuf sb;
  zr_boost_1_81::asio::const_buffer buffers
    = zr_boost_1_81::asio::buffer(write_data, sizeof(write_data));
...
void test_4_arg_const_buffer_async_write()
{
  ...
  s.reset();
  bool called = false;
  zr_boost_1_81::asio::async_write(s, buffers, zr_boost_1_81::asio::transfer_all(),
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  called = false;
  zr_boost_1_81::asio::async_write(s, buffers, zr_boost_1_81::asio::transfer_at_least(1),
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  called = false;
  zr_boost_1_81::asio::async_write(s, buffers, zr_boost_1_81::asio::transfer_at_least(10),
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  called = false;
  zr_boost_1_81::asio::async_write(s, buffers, zr_boost_1_81::asio::transfer_at_least(42),
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  called = false;
  zr_boost_1_81::asio::async_write(s, buffers, zr_boost_1_81::asio::transfer_exactly(1),
      bindns::bind(async_write_handler,
        _1, _2, 1, &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  called = false;
  zr_boost_1_81::asio::async_write(s, buffers, zr_boost_1_81::asio::transfer_exactly(10),
      bindns::bind(async_write_handler,
        _1, _2, 10, &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  called = false;
  zr_boost_1_81::asio::async_write(s, buffers, zr_boost_1_81::asio::transfer_exactly(42),
      bindns::bind(async_write_handler,
        _1, _2, 42, &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  called = false;
  zr_boost_1_81::asio::async_write(s, buffers, old_style_transfer_all,
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  called = false;
  zr_boost_1_81::asio::async_write(s, buffers, short_transfer(),
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  int i = zr_boost_1_81::asio::async_write(s, buffers, short_transfer(),
...
void test_4_arg_dynamic_string_async_write()
{
  ...
  data.assign(write_data, sizeof(write_data));
  bool called = false;
  zr_boost_1_81::asio::async_write(s, sb, zr_boost_1_81::asio::transfer_all(),
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  data.assign(write_data, sizeof(write_data));
  called = false;
  zr_boost_1_81::asio::async_write(s, sb, zr_boost_1_81::asio::transfer_at_least(1),
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  data.assign(write_data, sizeof(write_data));
  called = false;
  zr_boost_1_81::asio::async_write(s, sb, zr_boost_1_81::asio::transfer_at_least(10),
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  data.assign(write_data, sizeof(write_data));
  called = false;
  zr_boost_1_81::asio::async_write(s, sb, zr_boost_1_81::asio::transfer_at_least(42),
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  data.assign(write_data, sizeof(write_data));
  called = false;
  zr_boost_1_81::asio::async_write(s, sb, zr_boost_1_81::asio::transfer_exactly(1),
      bindns::bind(async_write_handler,
        _1, _2, 1, &called));
  ioc.restart();
  ioc.run();
  ...
  data.assign(write_data, sizeof(write_data));
  called = false;
  zr_boost_1_81::asio::async_write(s, sb, zr_boost_1_81::asio::transfer_exactly(10),
      bindns::bind(async_write_handler,
        _1, _2, 10, &called));
  ioc.restart();
  ioc.run();
  ...
  data.assign(write_data, sizeof(write_data));
  called = false;
  zr_boost_1_81::asio::async_write(s, sb, zr_boost_1_81::asio::transfer_exactly(42),
      bindns::bind(async_write_handler,
        _1, _2, 42, &called));
  ioc.restart();
  ioc.run();
  ...
  data.assign(write_data, sizeof(write_data));
  called = false;
  zr_boost_1_81::asio::async_write(s, sb, old_style_transfer_all,
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  data.assign(write_data, sizeof(write_data));
  called = false;
  zr_boost_1_81::asio::async_write(s, sb, short_transfer(),
      bindns::bind(async_write_handler,
        _1, _2, sizeof(write_data), &called));
  ioc.restart();
  ioc.run();
  ...
  s.reset();
  data.assign(write_data, sizeof(write_data));
  int i = zr_boost_1_81::asio::async_write(s, sb, short_transfer(),
      archetypes::lazy_handler());
  BOOST_ASIO_CHECK(i == 42);
  ioc.restart();
  ioc.run();
