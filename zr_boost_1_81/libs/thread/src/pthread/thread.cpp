...
//#endif
        ...
        {
            zr_boost_1_81::detail::thread_exit_function_base* func;
            thread_exit_callback_node* next;

            thread_exit_callback_node(zr_boost_1_81::detail::thread_exit_function_base* func_,
        ...
        namespace
        {
          ...
          zr_boost_1_81::once_flag current_thread_tls_init_flag;
#else
            zr_boost_1_81::once_flag current_thread_tls_init_flag=BOOST_ONCE_INIT;
#endif
            ...
            extern "C"
            {
                ...
                {
                    //zr_boost_1_81::detail::thread_data_base* thread_info=static_cast<zr_boost_1_81::detail::thread_data_base*>(data);
                    zr_boost_1_81::detail::thread_data_ptr thread_info = static_cast<zr_boost_1_81::detail::thread_data_base*>(data)->shared_from_this();
            ...
            struct  delete_current_thread_tls_key_on_dlclose_t
            {
                ...
                ~delete_current_thread_tls_key_on_dlclose_t()
                {
                    const zr_boost_1_81::once_flag uninitialized = BOOST_ONCE_INIT;
                    if (memcmp(&current_thread_tls_init_flag, &uninitialized, sizeof(zr_boost_1_81::once_flag)))
                    {
        ...
        zr_boost_1_81::detail::thread_data_base* get_current_thread_data()
        {
            zr_boost_1_81::call_once(current_thread_tls_init_flag,&create_current_thread_tls_key);
            return (zr_boost_1_81::detail::thread_data_base*)pthread_getspecific(current_thread_tls_key);
        }
    ...
    namespace
    {
        extern "C"
        {
            ...
            {
                //zr_boost_1_81::detail::thread_data_ptr thread_info = static_cast<zr_boost_1_81::detail::thread_data_base*>(param)->self;
                zr_boost_1_81::detail::thread_data_ptr thread_info = static_cast<zr_boost_1_81::detail::thread_data_base*>(param)->shared_from_this();
                thread_info->self.reset();
...
//                 }
                ...
                zr_boost_1_81::lock_guard<zr_boost_1_81::mutex> lock(thread_info->data_mutex);
...
#   endif
    ...
    unsigned thread::physical_concurrency() BOOST_NOEXCEPT
    {
        ...
        try {
            ...
            while ( getline(proc_cpuinfo, line) ) {
                ...
                zr_boost_1_81::split(key_val, line, zr_boost_1_81::is_any_of(":"));
                ...
                zr_boost_1_81::trim(key);
                zr_boost_1_81::trim(value);

                if (key == physical_id) {
                    current_core_entry.first = zr_boost_1_81::lexical_cast<unsigned>(value);
                    continue;
                }

                if (key == core_id) {
                    current_core_entry.second = zr_boost_1_81::lexical_cast<unsigned>(value);
    ...
    void thread::interrupt()
    {
        ...
        if(local_thread_info)
        {
            ...
            {
                zr_boost_1_81::pthread::pthread_mutex_scoped_lock internal_lock(local_thread_info->cond_mutex);
    ...
    namespace this_thread
    {
        ...
        {
#ifndef BOOST_NO_EXCEPTIONS
            zr_boost_1_81::detail::thread_data_base* const thread_info=detail::get_current_thread_data();
