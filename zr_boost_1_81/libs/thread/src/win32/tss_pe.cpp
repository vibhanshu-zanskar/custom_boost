...
extern "C" {
    ...
    void (* after_ctors )() __attribute__((section(".ctors")))     = zr_boost_1_81::zr_boost_1_81on_process_enter;
    void (* before_dtors)() __attribute__((section(".dtors")))     = zr_boost_1_81::zr_boost_1_81on_thread_exit;
    void (* after_dtors )() __attribute__((section(".dtors.zzz"))) = zr_boost_1_81::zr_boost_1_81on_process_exit;
...
#pragma warning(pop)
        ...
        {
            //Schedule zr_boost_1_81on_thread_exit() to be called for the main
            ...
            atexit(zr_boost_1_81::zr_boost_1_81on_thread_exit);
