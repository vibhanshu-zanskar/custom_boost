...
//  parameter supplied while instantiating the zr_boost_1_81::wave::context<> template
//  (see the file cpp.cpp).
//
///////////////////////////////////////////////////////////////////////////////

#if !defined(BOOST_WAVE_STRINGTYPE_USE_STDSTRING)
template struct BOOST_SYMBOL_VISIBLE zr_boost_1_81::wave::cpplexer::new_lexer_gen<std::string::iterator>;
template struct BOOST_SYMBOL_VISIBLE zr_boost_1_81::wave::cpplexer::new_lexer_gen<std::string::const_iterator>;
#endif
