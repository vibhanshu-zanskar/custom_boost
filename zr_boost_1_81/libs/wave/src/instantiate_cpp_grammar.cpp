...
typedef zr_boost_1_81::wave::cpplexer::lex_iterator<token_type> lexer_type;
typedef std::list<token_type, zr_boost_1_81::fast_pool_allocator<token_type> >
    token_sequence_type;

template struct BOOST_SYMBOL_VISIBLE zr_boost_1_81::wave::grammars::cpp_grammar_gen<lexer_type, token_sequence_type>;
