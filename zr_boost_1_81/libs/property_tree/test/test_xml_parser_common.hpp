...
struct ReadFuncWS
{
    ...
    {
        zr_boost_1_81::property_tree::read_xml(filename, pt,
          zr_boost_1_81::property_tree::xml_parser::no_concat_text);
    }
};
...
struct WriteFuncWS
{
    ...
    {
        zr_boost_1_81::property_tree::write_xml(filename, pt);
    }
};
...
struct WriteFuncNS
{
    ...
    void operator()(const std::string &filename, const Ptree &pt) const
    {
        zr_boost_1_81::property_tree::write_xml(filename, pt, std::locale(),
            zr_boost_1_81::property_tree::xml_writer_make_settings<typename Ptree::key_type>(' ', 4));
    }
};
