...
void test_get_put(PTREE *)
{
    ...
    // Temporary storage
    str_t tmp_string;
    zr_boost_1_81::optional<int> opt_int;
    zr_boost_1_81::optional<long> opt_long;
    zr_boost_1_81::optional<double> opt_double;
    zr_boost_1_81::optional<float> opt_float;
    zr_boost_1_81::optional<str_t> opt_string;
    zr_boost_1_81::optional<CHTYPE> opt_char;
    zr_boost_1_81::optional<bool> opt_bool;
    ...
    catch (zr_boost_1_81::property_tree::ptree_bad_path &) { }
    catch (...)
    {
    ...
    catch (zr_boost_1_81::property_tree::ptree_bad_data &) { }
    catch (...)
    {
        BOOST_ERROR("Wrong exception type thrown");
    }
...
void test_get_child_put_child(PTREE *)
{
    ...
    zr_boost_1_81::optional<PTREE &> opt;
    zr_boost_1_81::optional<const PTREE &> copt;
...
void test_equal_range(PTREE *)
{
    ...
    BOOST_TEST(zr_boost_1_81::distance(pt.equal_range(T("k1"))) == 3);
    BOOST_TEST(zr_boost_1_81::distance(pt.equal_range(T("k2"))) == 2);
    BOOST_TEST(zr_boost_1_81::distance(pt.equal_range(T("k3"))) == 1);
}
...
{
    typedef zr_boost_1_81::property_tree::translator_between<
    ...
    catch (zr_boost_1_81::property_tree::ptree_error &)
    {
        throw;
    }
...
void test_custom_data_type(PTREE *)
{
    ...
    // Property_tree with zr_boost_1_81::any as data type
    typedef zr_boost_1_81::property_tree::basic_ptree<Str, zr_boost_1_81::any, Comp> my_ptree;
    my_ptree pt;
...
void test_ptree_bad_path(PTREE *)
{
    ...
    catch (zr_boost_1_81::property_tree::ptree_bad_path &e)
    {
...
void test_ptree_bad_data(PTREE *)
{
    ...
    catch (zr_boost_1_81::property_tree::ptree_bad_data &e)
    {
...
void test_serialization(PTREE *)
{
    ...
    // Test text archives
    {
        ...
        zr_boost_1_81::archive::text_oarchive oa(stream);
        oa & pt1;
        zr_boost_1_81::archive::text_iarchive ia(stream);
        PTREE pt2;
        ia & pt2;
        BOOST_TEST(pt1 == pt2);
    }
    ...
    {
        std::stringstream stream;
        zr_boost_1_81::archive::binary_oarchive oa(stream);
        oa & pt1;
        zr_boost_1_81::archive::binary_iarchive ia(stream);
        PTREE pt2;
        ia & pt2;
        BOOST_TEST(pt1 == pt2);
    }
    ...
    // Test XML archives
    {
        ...
        {
            zr_boost_1_81::archive::xml_oarchive oa(stream);
            oa & zr_boost_1_81::serialization::make_nvp("pt", pt1);
        }

        PTREE pt2;

        {
            zr_boost_1_81::archive::xml_iarchive ia(stream);
            ia & zr_boost_1_81::serialization::make_nvp("pt", pt2);
        }
