...
// If using VC, disable some warnings that trip in zr_boost_1_81::serialization bowels
#ifdef BOOST_MSVC
...
// Custom translator that works with zr_boost_1_81::any instead of std::string
template <typename E>
struct any_translator
{
    typedef zr_boost_1_81::any internal_type;
    typedef E external_type;

    zr_boost_1_81::optional<E> get_value(const internal_type &v) {
        if(const E *p = zr_boost_1_81::any_cast<E>(&v)) {
            return *p;
        }
        return zr_boost_1_81::optional<E>();
    }
    zr_boost_1_81::optional<internal_type> put_value(const E &v) {
        return zr_boost_1_81::any(v);
    }
};

namespace zr_boost_1_81 { namespace property_tree {
    template <typename E>
    struct translator_between<zr_boost_1_81::any, E>
    {
...
#define CHTYPE char
#define T(s) s
#define PTREE zr_boost_1_81::property_tree::ptree
#define NOCASE 0
#define WIDECHAR 0
...
#   define T(s) L ## s
#   define PTREE zr_boost_1_81::property_tree::wptree
#   define NOCASE 0
#   define WIDECHAR 1
#       include "test_property_tree.hpp"
#   undef CHTYPE
...
#define CHTYPE char
#define T(s) s
#define PTREE zr_boost_1_81::property_tree::iptree
#define NOCASE 1
#   define WIDECHAR 0
#   include "test_property_tree.hpp"
#undef CHTYPE
...
#   define CHTYPE wchar_t
#   define T(s) L ## s
#   define PTREE zr_boost_1_81::property_tree::wiptree
#   define NOCASE 1
#   define WIDECHAR 1
#       include "test_property_tree.hpp"
#   undef CHTYPE
...
int main(int, char *[])
{
    ...
    using namespace zr_boost_1_81::property_tree;
