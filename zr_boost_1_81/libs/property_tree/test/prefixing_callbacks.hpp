...
struct prefixing_callbacks
        : zr_boost_1_81::property_tree::json_parser::detail::standard_callbacks<Ptree> {
    typedef zr_boost_1_81::property_tree::json_parser::detail::standard_callbacks<Ptree>
        base;
