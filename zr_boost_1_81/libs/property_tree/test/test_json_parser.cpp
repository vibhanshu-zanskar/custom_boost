...
struct ReadFunc
{
    ...
    {
        zr_boost_1_81::property_tree::read_json(filename, pt);
    }
    template <class Ptree>
    void operator()(
        ...
        Ptree& pt) const
    {
        zr_boost_1_81::property_tree::read_json(is, pt);
    }
};
...
struct WriteFunc
{
    ...
    {
        zr_boost_1_81::property_tree::write_json(filename, pt, std::locale(), pretty);
    }
    ...
    void operator()(
        ...
        Ptree& pt) const
    {
        zr_boost_1_81::property_tree::write_json(os, pt, pretty);
    }
...
void test_escaping_utf8()
{
    ...
    BOOST_TEST(zr_boost_1_81::property_tree::json_parser::create_escapes(str) == str);
}
...
void test_escaping_wide()
{
    ...
    BOOST_TEST(zr_boost_1_81::property_tree::json_parser::create_escapes(str1) == str1);
    // Should escape characters outside ASCII range - this is NOT utf-8
    // This is cyrillic text
    std::wstring str2 = L"\u041C\u0430\u043C\u0430 "
        L"\u043C\u044B\u043B\u0430 \u0440\u0430\u043C\u0443";
    BOOST_TEST(zr_boost_1_81::property_tree::json_parser::create_escapes(str2) ==
        L"\\u041C\\u0430\\u043C\\u0430 "
        L"\\u043C\\u044B\\u043B\\u0430 \\u0440\\u0430\\u043C\\u0443");
}
