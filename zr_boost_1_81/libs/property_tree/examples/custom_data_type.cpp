...
//
// It creates my_ptree type, which is a basic_ptree having zr_boost_1_81::any as its data
...
template <class Ext, class Int = zr_boost_1_81::any>
struct variant_translator
{
    ...
    {
        return zr_boost_1_81::any_cast<external_type>(value);
    }
    internal_type
...
int main()
{
    ...
    // Key type:        std::string
    // Data type:       zr_boost_1_81::any
    // Key comparison:  default (std::less<std::string>)
    typedef basic_ptree<std::string, zr_boost_1_81::any> my_ptree;
    my_ptree pt;
