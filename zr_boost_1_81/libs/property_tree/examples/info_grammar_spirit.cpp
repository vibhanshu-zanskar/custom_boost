...
/* This is grammar of INFO file format written in form of zr_boost_1_81::spirit rules.
...
struct info_grammar: public zr_boost_1_81::spirit::grammar<info_grammar>
{
    ...
    struct definition
    {
        ...
        zr_boost_1_81::spirit::rule<typename zr_boost_1_81::spirit::lexeme_scanner<Scanner>::type> chr, qchr, escape_seq;
        zr_boost_1_81::spirit::rule<Scanner> string, qstring, cstring, key, value, entry, info;

        definition(const info_grammar &self)
        {

            using namespace zr_boost_1_81::spirit;
        ...
        const zr_boost_1_81::spirit::rule<Scanner> &start() const
        {
            return info;
        }
