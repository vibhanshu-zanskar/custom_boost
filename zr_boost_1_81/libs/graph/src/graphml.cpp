...
public:
    ...
    static zr_boost_1_81::property_tree::ptree::path_type path(const std::string& str)
    {
        return zr_boost_1_81::property_tree::ptree::path_type(str, '/');
    }

    void get_graphs(const zr_boost_1_81::property_tree::ptree& top,
        size_t desired_idx /* or -1 for all */, bool is_root,
        std::vector< const zr_boost_1_81::property_tree::ptree* >& result)
    {
        using zr_boost_1_81::property_tree::ptree;
    ...
    void run(std::istream& in, size_t desired_idx)
    {
        ...
        ptree pt;
        read_xml(in, pt,
            zr_boost_1_81::property_tree::xml_parser::no_comments
                | zr_boost_1_81::property_tree::xml_parser::trim_whitespace);
        ...
        BOOST_FOREACH (const ptree::value_type& child, gml)
        {
            ...
            m_key_name[id] = name;
            m_key_type[id] = type;
            zr_boost_1_81::optional< std::string > default_
...
private:
    ...
    void handle_edge(const std::string& u, const std::string& v)
    {
        ...
        any edge;
        bool added;
        zr_boost_1_81::tie(edge, added) = m_g.do_add_edge(source, target);
        if (!added)
        {
