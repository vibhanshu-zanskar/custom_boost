...
int main(int argc, char* argv[])
{
    ...
    A a1;
    {
        ...
        std::stringstream ss;
        {
            ...
            zr_boost_1_81::archive::polymorphic_text_oarchive oa(ss);
            zr_boost_1_81::archive::polymorphic_oarchive & oa_interface = oa;
            // we can just just the interface for saving
            oa_interface << a;
        }
        {
            // or we can use the implementation directly
            zr_boost_1_81::archive::polymorphic_text_iarchive ia(ss);
            ia >> a1;
        }
    }
    if(! (a == a1))
        return 1;
    {
        ...
        std::stringstream ss;
        {
            ...
            zr_boost_1_81::archive::polymorphic_binary_oarchive oa(ss);
            oa << a;
        }
        {
            // see above
            zr_boost_1_81::archive::polymorphic_binary_iarchive ia(ss);
            zr_boost_1_81::archive::polymorphic_iarchive & ia_interface = ia;
