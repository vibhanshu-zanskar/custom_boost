...
private:
    ...
    template<class Archive>
    void serialize(Archive & ar, const unsigned int /* file_version */){
        ar & zr_boost_1_81::serialization::base_object<A>(*this);
    }
public:
    static int count;
    B() : A() {};
...
void display(zr_boost_1_81::shared_ptr<A> &spa, zr_boost_1_81::shared_ptr<A> &spa1)
{
...
{
    std::string filename(zr_boost_1_81::archive::tmpdir());
    filename += "/testfile";

    // create  a new shared pointer to ta new object of type A
    zr_boost_1_81::shared_ptr<A> spa(new A);
    zr_boost_1_81::shared_ptr<A> spa1;
    spa1 = spa;
    display(spa, spa1);
    // serialize it
    {
        std::ofstream ofs(filename.c_str());
        zr_boost_1_81::archive::text_oarchive oa(ofs);
        oa << spa;
        oa << spa1;
    }
    ...
    // creating a new type A object
    {
        ...
        zr_boost_1_81::archive::text_iarchive ia(ifs);
    ...
    // ADDITION BY DT
    // create  a new shared pointer to ta new object of type A
    spa = zr_boost_1_81::shared_ptr<A>(new B);
    spa1 = spa;
    display(spa, spa1);
    // serialize it
    {
