...
public:
    ...
    virtual const char *what( ) const throw( )
    {
        ...
        default:
            zr_boost_1_81::archive::archive_exception::what();
        }
        return msg;
    }
};
...
class portable_binary_oarchive :
    public zr_boost_1_81::archive::basic_binary_oprimitive<
        portable_binary_oarchive,
        std::ostream::char_type,
        std::ostream::traits_type
    >,
    public zr_boost_1_81::archive::detail::common_oarchive<
        portable_binary_oarchive
    >
{
    typedef zr_boost_1_81::archive::basic_binary_oprimitive<
        portable_binary_oarchive,
        std::ostream::char_type,
        std::ostream::traits_type
    > primitive_base_t;
    typedef zr_boost_1_81::archive::detail::common_oarchive<
        portable_binary_oarchive
    > archive_base_t;
...
public:
    ...
    friend class zr_boost_1_81::archive::detail::interface_oarchive<
        portable_binary_oarchive
    >;
...
protected:
    ...
    void save_impl(const zr_boost_1_81::intmax_t l, const char maxsize);
    ...
    typedef zr_boost_1_81::archive::detail::common_oarchive<portable_binary_oarchive>
    ...
    void save_override(
        const zr_boost_1_81::archive::class_id_optional_type & /* t */
    ){}
