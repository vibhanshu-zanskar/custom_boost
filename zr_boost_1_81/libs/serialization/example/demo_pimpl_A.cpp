...
template void A::serialize<zr_boost_1_81::archive::text_iarchive>(
    zr_boost_1_81::archive::text_iarchive & ar,
    const unsigned int file_version
);
template void A::serialize<zr_boost_1_81::archive::text_oarchive>(
    zr_boost_1_81::archive::text_oarchive & ar,
    const unsigned int file_version
);
