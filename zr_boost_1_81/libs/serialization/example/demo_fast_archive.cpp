...
using namespace zr_boost_1_81::archive;
...
public:
#else
    friend class zr_boost_1_81::archive::detail::interface_oarchive<derived_t>;
    ...
    void save_override(T & t){
        ...
        BOOST_STATIC_ASSERT(! (zr_boost_1_81::is_array<T>::value) );
    }
    template<int N>
...
public:
#else
    friend class zr_boost_1_81::archive::detail::interface_iarchive<derived_t>;
