...
class simple_log_archive {
    ...
    void save(const T &t){
        typedef
            BOOST_DEDUCED_TYPENAME zr_boost_1_81::mpl::eval_if<zr_boost_1_81::is_enum< T >,
                zr_boost_1_81::mpl::identity<save_enum_type<simple_log_archive> >,
            //else
            BOOST_DEDUCED_TYPENAME zr_boost_1_81::mpl::eval_if<
                // if its primitive
                    zr_boost_1_81::mpl::equal_to<
                        zr_boost_1_81::serialization::implementation_level< T >,
                        zr_boost_1_81::mpl::int_<zr_boost_1_81::serialization::primitive_type>
                    >,
                    zr_boost_1_81::mpl::identity<save_primitive<simple_log_archive> >,
            // else
                zr_boost_1_81::mpl::identity<save_only<simple_log_archive> >
            > >::type typex;
        typex::invoke(*this, t);
    }
...
public:
    ...
    typedef zr_boost_1_81::mpl::bool_<false> is_loading;
    typedef zr_boost_1_81::mpl::bool_<true> is_saving;
    ...
    simple_log_archive & operator<<(const T (&t)[N]){
        return *this << zr_boost_1_81::serialization::make_array(
            static_cast<const T *>(&t[0]),
            N
        );
    }
    template<class T>
    simple_log_archive & operator<<(const zr_boost_1_81::serialization::nvp< T > & t){
