...
int main(int argc, char *argv[]){
    ...
    zr_boost_1_81::archive::binary_iarchive ia(fb);
    zr_boost_1_81::archive::library_version_type lvt = ia.get_library_version();
    if(zr_boost_1_81::archive::library_version_type(6) != lvt){
        std::cout << "library version not equal to six" << std::endl;
        return 1;
    }
    lvt = zr_boost_1_81::archive::library_version_type(7);
