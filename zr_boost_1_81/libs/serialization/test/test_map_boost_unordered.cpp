...
struct random_key {
    ...
    void serialize(
        ...
        ar & zr_boost_1_81::serialization::make_nvp("random_key", m_i);
    }
    int m_i;
...
test_unordered_map(){
    ...
    zr_boost_1_81::unordered_map<random_key, A> anunordered_map;
    anunordered_map.insert(std::make_pair(random_key(), A()));
    anunordered_map.insert(std::make_pair(random_key(), A()));
    {
        test_ostream os(testfile, TEST_STREAM_FLAGS);
        test_oarchive oa(os, TEST_ARCHIVE_FLAGS);
        oa << zr_boost_1_81::serialization::make_nvp("anunorderedmap",anunordered_map);
    }
    zr_boost_1_81::unordered_map<random_key, A> anunordered_map1;
    {
        test_istream is(testfile, TEST_STREAM_FLAGS);
        test_iarchive ia(is, TEST_ARCHIVE_FLAGS);
        ia >> zr_boost_1_81::serialization::make_nvp("anunorderedmap",anunordered_map1);
    }
...
test_unordered_multimap(){
    ...
    zr_boost_1_81::unordered_multimap<random_key, A> anunordered_multimap;
    anunordered_multimap.insert(std::make_pair(random_key(), A()));
    anunordered_multimap.insert(std::make_pair(random_key(), A()));
    {
        test_ostream os(testfile, TEST_STREAM_FLAGS);
        test_oarchive oa(os, TEST_ARCHIVE_FLAGS);
        oa << zr_boost_1_81::serialization::make_nvp("anunordered_multimap", anunordered_multimap);
    }
    zr_boost_1_81::unordered_multimap<random_key, A> anunordered_multimap1;
    {
        test_istream is(testfile, TEST_STREAM_FLAGS);
        test_iarchive ia(is, TEST_ARCHIVE_FLAGS);
        ia >> zr_boost_1_81::serialization::make_nvp("anunordered_multimap", anunordered_multimap1);
    }
    std::vector< std::pair<random_key, A> > tvec, tvec1;
    tvec.clear();
    tvec1.clear();
