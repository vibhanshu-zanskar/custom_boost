...
bool A::operator==(const A &rhs) const
{
    return
        ...
        && u == rhs.u
        && v == rhs.v
        && std::abs( zr_boost_1_81::math::float_distance(w, rhs.w)) < 2
        && std::abs( zr_boost_1_81::math::float_distance(x, rhs.x)) < 2
    ;
}
...
bool A::operator<(const A &rhs) const
{
    ...
    if(! (v == rhs.v) )
        return t < rhs.v;
    if(std::abs( zr_boost_1_81::math::float_distance(w, rhs.w)) > 1)
        return false;
    if(std::abs( zr_boost_1_81::math::float_distance(x, rhs.x)) > 1)
        return false;
    return false;
}
...
void serialize(
    ...
    ar & zr_boost_1_81::serialization::make_nvp("s", a.s);
    ar & zr_boost_1_81::serialization::make_nvp("t", a.t);
    ar & zr_boost_1_81::serialization::make_nvp("u", a.u);
    ar & zr_boost_1_81::serialization::make_nvp("v", a.v);
    ar & zr_boost_1_81::serialization::make_nvp("w", a.w);
    ar & zr_boost_1_81::serialization::make_nvp("x", a.x);
}
