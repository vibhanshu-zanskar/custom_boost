...
class A
{
    ...
    void serialize(Archive & /*ar*/, const unsigned int file_version){
        ...
        BOOST_STATIC_ASSERT(0 == ::zr_boost_1_81::serialization::version<A>::value);
        ++count;
    }
public:
    unsigned int count;
...
BOOST_CLASS_IMPLEMENTATION(A, ::zr_boost_1_81::serialization::object_serializable)
BOOST_CLASS_TRACKING(A, ::zr_boost_1_81::serialization::track_never)
...
class B
{
    ...
    void serialize(Archive & /*ar*/, const unsigned int file_version){
        ...
        BOOST_CHECK(
            ...
            == ::zr_boost_1_81::serialization::version<B>::value
        );
        ++count;
    }
public:
...
BOOST_CLASS_IMPLEMENTATION(B, ::zr_boost_1_81::serialization::object_class_info)
BOOST_CLASS_TRACKING(B, zr_boost_1_81::serialization::track_always)
...
test_main( int /* argc */, char* /* argv */[] )
{
    ...
    B b;
    std::string filename;
    filename += zr_boost_1_81::archive::tmpdir();
    filename += '/';
