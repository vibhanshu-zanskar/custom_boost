...
int x = f<A>();  // Warn
int y = f<zr_boost_1_81::is_polymorphic<non_polymorphic> >(); // Warn.
int z = f<zr_boost_1_81::is_polymorphic<polymorphic> >();

BOOST_STATIC_WARNING(sizeof(a1) == sizeof(a2)); // Warn.
BOOST_STATIC_WARNING(sizeof(a1) != sizeof(a1)); // Warn.
BOOST_STATIC_WARNING(! zr_boost_1_81::is_polymorphic<polymorphic>::value); // Warn.
BOOST_STATIC_WARNING(zr_boost_1_81::is_polymorphic<non_polymorphic>::value); // Warn.
