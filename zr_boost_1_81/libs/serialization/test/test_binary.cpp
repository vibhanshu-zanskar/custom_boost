...
class A {
    ...
    void serialize(Archive & ar, const unsigned int /* file_version */){
        ar & zr_boost_1_81::serialization::make_nvp(
            "data",
            zr_boost_1_81::serialization::make_binary_object(data, sizeof(data))
        );
    }
...
int test_main( int /* argc */, char* /* argv */[] )
{
    ...
    std::memset(s1_4, '\0', sizeof(s1_4));
    {
        ...
        oa << zr_boost_1_81::serialization::make_nvp(
            "s1",
            zr_boost_1_81::serialization::make_binary_object(
                s1,
                sizeof(s1)
            )
        );
    ...
    }
    {
        ...
        ia >> zr_boost_1_81::serialization::make_nvp(
            "s1",
            zr_boost_1_81::serialization::make_binary_object(
                s1_1,
                sizeof(s1)
