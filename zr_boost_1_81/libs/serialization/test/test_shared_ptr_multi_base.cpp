...
zr_boost_1_81::shared_ptr<T> dynamic_pointer_cast(zr_boost_1_81::shared_ptr<U> const & u)
BOOST_NOEXCEPT
{
    return zr_boost_1_81::dynamic_pointer_cast<T>(u);
}
...
{
    bool result = true;
    result &= test<zr_boost_1_81::shared_ptr, zr_boost_1_81::weak_ptr>();
    #ifndef BOOST_NO_CXX11_SMART_PTR
