...
void save_and_load2(T & first, T & second)
{
    ...
    zr_boost_1_81::shared_ptr<A> first1, second1;
...
int test_main(int /* argc */, char * /* argv */[])
{
    ...
    zr_boost_1_81_132::shared_ptr<A> spa;
