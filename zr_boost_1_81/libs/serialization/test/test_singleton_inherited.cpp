...
struct Foo: zr_boost_1_81::serialization::singleton<Foo>{
    Foo(): i(42) {
...
controller::~controller() {
    ...
    THROW_ON_FALSE(zr_boost_1_81::serialization::singleton<Foo>::is_destroyed());
...
test_main( int /* argc */, char* /* argv */[] )
{
    ...
    BOOST_CHECK(!zr_boost_1_81::serialization::singleton<Foo>::is_destroyed());
    BOOST_CHECK(!Foo::is_destroyed());

    BOOST_CHECK(zr_boost_1_81::serialization::singleton<Foo>::get_const_instance().i == 42);
