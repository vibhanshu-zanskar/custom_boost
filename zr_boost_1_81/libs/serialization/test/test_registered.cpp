...
void load_derived(const char *testfile)
{
    ...
    const zr_boost_1_81::serialization::extended_type_info * p1;
    p1 = & zr_boost_1_81::serialization::type_info_implementation<polymorphic_derived1>
        ::type::get_const_instance();

    BOOST_CHECK(NULL != p1);

    const zr_boost_1_81::serialization::extended_type_info * p2;
    p2 = zr_boost_1_81::serialization::type_info_implementation<polymorphic_derived1>
    ...
    BOOST_CHECK_MESSAGE(
        & zr_boost_1_81::serialization::type_info_implementation<polymorphic_derived2>
            ::type::get_const_instance()
        ==
        zr_boost_1_81::serialization::type_info_implementation<polymorphic_derived2>
    ...
    p2 = zr_boost_1_81::serialization::type_info_implementation<polymorphic_base>
    ...
    BOOST_CHECK_MESSAGE(
        & zr_boost_1_81::serialization::type_info_implementation<polymorphic_derived2>
            ::type::get_const_instance()
        == zr_boost_1_81::serialization::type_info_implementation<polymorphic_base>
...
void load_registered(const char *testfile)
{
    ...
    BOOST_CHECK_MESSAGE(
        & zr_boost_1_81::serialization::type_info_implementation<polymorphic_derived1>
            ::type::get_const_instance()
        == zr_boost_1_81::serialization::type_info_implementation<polymorphic_base>
            ::type::get_const_instance().get_derived_extended_type_info(*rb1),
