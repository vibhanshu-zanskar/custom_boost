...
test_unordered_set(){
    ...
    zr_boost_1_81::unordered_set<A> anunordered_set;
    A a, a1;
    ...
    anunordered_set.insert(a1);
    {
        ...
        oa << zr_boost_1_81::serialization::make_nvp("anunordered_set", anunordered_set);
    }
    zr_boost_1_81::unordered_set<A> anunordered_set1;
    {
        test_istream is(testfile, TEST_STREAM_FLAGS);
        test_iarchive ia(is, TEST_ARCHIVE_FLAGS);
        ia >> zr_boost_1_81::serialization::make_nvp("anunordered_set", anunordered_set1);
    }
...
test_unordered_multiset(){
    ...
    zr_boost_1_81::unordered_multiset<A> anunordered_multiset;
    anunordered_multiset.insert(A());
    anunordered_multiset.insert(A());
    {
        test_ostream os(testfile, TEST_STREAM_FLAGS);
        test_oarchive oa(os, TEST_ARCHIVE_FLAGS);
        oa << zr_boost_1_81::serialization::make_nvp("anunordered_multiset", anunordered_multiset);
    }
    zr_boost_1_81::unordered_multiset<A> anunordered_multiset1;
    {
        test_istream is(testfile, TEST_STREAM_FLAGS);
        test_iarchive ia(is, TEST_ARCHIVE_FLAGS);
        ia >> zr_boost_1_81::serialization::make_nvp("anunordered_multiset", anunordered_multiset1);
    }
