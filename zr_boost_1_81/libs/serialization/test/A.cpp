...
A::A() :
    b(true),
    #ifndef BOOST_NO_INT64_T
    f(static_cast<zr_boost_1_81::int64_t>(std::rand()) * static_cast<zr_boost_1_81::int64_t>(std::rand())),
    g(static_cast<zr_boost_1_81::uint64_t>(std::rand()) * static_cast<zr_boost_1_81::uint64_t>(std::rand())),
    #endif
