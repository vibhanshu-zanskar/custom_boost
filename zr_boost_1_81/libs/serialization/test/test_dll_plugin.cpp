...
class polymorphic_derived1 : public polymorphic_base
{
    ...
    const char * get_key() const{
        return
            zr_boost_1_81::serialization::type_info_implementation<
...
void save_exported(const char *testfile)
{
    ...
    zr_boost_1_81::serialization::extended_type_info const * const d2_eti =
        zr_boost_1_81::serialization::extended_type_info::find(
