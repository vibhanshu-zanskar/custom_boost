...
BOOST_CLASS_IMPLEMENTATION(check1, zr_boost_1_81::serialization::object_serializable)
BOOST_CLASS_TRACKING(check1, zr_boost_1_81::serialization::track_selectively)
...
BOOST_CLASS_IMPLEMENTATION(check2, zr_boost_1_81::serialization::object_serializable)
BOOST_CLASS_VERSION(check2, 1)
// use track always to turn off warning tested above
BOOST_CLASS_TRACKING(check2, zr_boost_1_81::serialization::track_always)
...
BOOST_CLASS_TRACKING(check3, zr_boost_1_81::serialization::track_never)
...
int main(int /* argc */, char * /* argv */[]){
    std::stringstream s;
    {
        zr_boost_1_81::archive::text_oarchive oa(s);
    ...
    {
        zr_boost_1_81::archive::text_iarchive ia(s);
