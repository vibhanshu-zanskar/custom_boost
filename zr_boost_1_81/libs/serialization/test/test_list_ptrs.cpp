...
template<class T>
struct ptr_equal_to {
    BOOST_STATIC_ASSERT(::zr_boost_1_81::is_pointer< T >::value);
...
void test_list(){
    ...
    std::list<A *> alist;
    {
        ...
        oa << zr_boost_1_81::serialization::make_nvp("alist", alist);
        oa << zr_boost_1_81::serialization::make_nvp("free_a_ptr", free_a_ptr);
    }
    std::list<A *> alist1;
    {
        ...
        A * free_a_ptr1;
        ia >> zr_boost_1_81::serialization::make_nvp("alist", alist1);
        ia >> zr_boost_1_81::serialization::make_nvp("free_a_ptr", free_a_ptr1);
        BOOST_CHECK(
    ...
    std::for_each(
        alist.begin(),
        alist.end(),
        zr_boost_1_81::checked_deleter<A>()
    );
    std::for_each(
        alist1.begin(),
        alist1.end(),
