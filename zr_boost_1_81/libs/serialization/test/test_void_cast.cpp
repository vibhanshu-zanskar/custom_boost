...
const zr_boost_1_81::serialization::extended_type_info & eti(){
    return zr_boost_1_81::serialization::singleton<
        zr_boost_1_81::serialization::extended_type_info_typeid< T >
    >::get_const_instance();
}
...
test_main( int /* argc */, char* /* argv */[] )
{
    ...
    BOOST_CHECK(vpd == zr_boost_1_81::serialization::void_downcast(
        eti<Derived>(),
        eti<Base1>(),
        vpb1
    ));
    BOOST_CHECK(vpb1 == zr_boost_1_81::serialization::void_upcast(
        eti<Derived>(),
        eti<Base1>(),
        vpd
    ));
    ...
    BOOST_CHECK(vpb2 == zr_boost_1_81::serialization::void_upcast(
        eti<Derived>(),
        eti<Base2>(),
        vpd
    ));
    BOOST_CHECK(vpmd == zr_boost_1_81::serialization::void_downcast(
        eti<MostDerived>(),
        eti<Derived>(),
        vpd
    ));
    BOOST_CHECK(vpd == zr_boost_1_81::serialization::void_upcast(
        eti<MostDerived>(),
        eti<Derived>(),
        vpmd
    ));
    ...
    BOOST_CHECK(NULL == zr_boost_1_81::serialization::void_downcast(
        eti<Base2>(),
        eti<Base1>(),
        vpb1
    ));
    ...
    zr_boost_1_81::serialization::void_cast_register<Derived, Base1>(
        static_cast<Derived *>(NULL),
        static_cast<Base1 *>(NULL)
    );
    zr_boost_1_81::serialization::void_cast_register<Derived, Base2>(
        static_cast<Derived *>(NULL),
        static_cast<Base2 *>(NULL)
    );
    zr_boost_1_81::serialization::void_cast_register<MostDerived, Derived>(
