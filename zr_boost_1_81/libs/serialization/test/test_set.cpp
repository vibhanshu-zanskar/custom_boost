...
test_set(){
    ...
    const A * a_ptr = & * aset.begin();
    {
        ...
        oa << zr_boost_1_81::serialization::make_nvp("aset", aset);
        // serialize a pointer into the set
        oa << zr_boost_1_81::serialization::make_nvp("a_ptr", a_ptr);
    }
    std::set<A> aset1;
    A * a_ptr1;
    {
        ...
        ia >> zr_boost_1_81::serialization::make_nvp("aset", aset1);
        // deserialize a pointer into the set
        ia >> zr_boost_1_81::serialization::make_nvp("a_ptr1", a_ptr1);
    }
...
test_multiset(){
    ...
    const A * a_ptr = & * amultiset.begin();
    {
        test_ostream os(testfile, TEST_STREAM_FLAGS);
        test_oarchive oa(os, TEST_ARCHIVE_FLAGS);
        oa << zr_boost_1_81::serialization::make_nvp("amultiset", amultiset);
        // serialize a pointer into the set
        oa << zr_boost_1_81::serialization::make_nvp("a_ptr", a_ptr);
    }
    ...
    A * a_ptr1;
    {
        test_istream is(testfile, TEST_STREAM_FLAGS);
        test_iarchive ia(is, TEST_ARCHIVE_FLAGS);
        ia >> zr_boost_1_81::serialization::make_nvp("amultiset", amultiset1);
        // deserialize a pointer into the set
        ia >> zr_boost_1_81::serialization::make_nvp("a_ptr1", a_ptr1);
    }
