...
// zr_boost_1_81::archive::xml::node macros
...
#define BSL_INST_BASE(Z, N, L)                                                 \
  T0 T0 ## _ ## N(BOOST_PP_ENUM_ ## Z(                                         \
    ...
    zr_boost_1_81::archive::xml::random<BSL_TYPE> BOOST_PP_LPAREN() BOOST_PP_RPAREN()  \
  ));                                                                          \
  /**/
...
#define BSL_TYPEDEF_NODES(Z, N, L)                                             \
  typedef zr_boost_1_81::archive::xml::node<                                           \
    BOOST_PP_ENUM_ ## Z(                                                       \
...
#define BSL_MAIN                                                               \
  int main (void) {                                                            \
    ...
    using namespace zr_boost_1_81::archive::xml;                                       \
                                                                               \
