...
void file_descriptor_impl::open(const detail::path& p, BOOST_IOS::openmode mode)
{
    ...
    if ( !(mode & (BOOST_IOS::in | BOOST_IOS::out | BOOST_IOS::app)) ||
        ...
        zr_boost_1_81::throw_exception(BOOST_IOSTREAMS_FAILURE("bad open mode"));
    }
    ...
    if (fd == -1) {
        zr_boost_1_81::throw_exception(system_failure("failed opening file"));
    } else {
    ...
    (stream_offset off, BOOST_IOS::seekdir way)
{
    ...
    {
        zr_boost_1_81::throw_exception(system_failure("failed seeking"));
    } else {
