...
struct my_iterator1
    : zr_boost_1_81::forward_iterator_helper<my_iterator1, char, long, const char*, const char&>
{
...
// iterator.
struct my_iterator2
    : zr_boost_1_81::equality_comparable<my_iterator2
    , zr_boost_1_81::incrementable<my_iterator2
    , zr_boost_1_81::dereferenceable<my_iterator2,const char*> > >
{
...
struct assert_same
    : assertion<(::zr_boost_1_81::is_same<T,U>::value)>
{
};
