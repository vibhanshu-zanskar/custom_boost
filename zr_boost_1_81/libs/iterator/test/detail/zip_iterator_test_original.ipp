...
void category_test()
{
    ...
    zr_boost_1_81::make_zip_iterator(
        ZI_MAKE_TUPLE(
            zr_boost_1_81::make_transform_iterator(rng1.begin(), &to_value), // BidirectionalInput
...
int main( void )
{
  ...
  std::cout << "\n"
            << "***********************************************\n"
            << "*                                             *\n"
            << "* Test driver for zr_boost_1_81::zip_iterator         *\n"
  ...
  typedef zr_boost_1_81::zip_iterator<cons_12_its_type> zip_it_12_type;
...
//  zip_it_non_const = ++zip_it_const;  // Error: can't convert from const to non-const
  ...
  bool bBigItIsBidirectionalIterator = zr_boost_1_81::is_convertible<
    zr_boost_1_81::iterator_traversal<zip_it_12_type>::type
        , zr_boost_1_81::bidirectional_traversal_tag
        >::value;

  bool bBigItIsRandomAccessIterator = zr_boost_1_81::is_convertible<
    zr_boost_1_81::iterator_traversal<zip_it_12_type>::type
  ...
  // traversal.
  //
  typedef zr_boost_1_81::zip_iterator<
    ZI_TUPLE<
      std::vector<double>::const_iterator,
      std::vector<double>::const_iterator
      >
  ...
  bool bAllVectsIsRandomAccessIterator = zr_boost_1_81::is_convertible<
    zr_boost_1_81::iterator_traversal<all_vects_type>::type
        , zr_boost_1_81::random_access_traversal_tag
    >::value;
