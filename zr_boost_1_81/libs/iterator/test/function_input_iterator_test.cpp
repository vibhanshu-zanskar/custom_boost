...
// Force zr_boost_1_81::result_of use decltype, even on compilers that don't support N3276.
...
int main()
{
    ...
    copy(
        zr_boost_1_81::make_function_input_iterator(ones_generator, 0),
        zr_boost_1_81::make_function_input_iterator(ones_generator, 10),
    ...
    copy(
        zr_boost_1_81::make_function_input_iterator(&ones_function, 0),
        zr_boost_1_81::make_function_input_iterator(&ones_function, 10),
        back_inserter(generated)
        );
    ...
    vector<int>().swap(generated);
    copy(
        zr_boost_1_81::make_function_input_iterator(counter_generator, 0),
        zr_boost_1_81::make_function_input_iterator(counter_generator, 10),
        back_inserter(generated)
        );
    ...
    {
        typedef zr_boost_1_81::iterators::function_input_iterator<counter, int> function_counter_iterator_t;
    ...
    vector<int>().swap(generated);
    copy(
        zr_boost_1_81::make_function_input_iterator(lambda_generator, 0),
        zr_boost_1_81::make_function_input_iterator(lambda_generator, 10),
        back_inserter(generated)
        );
