...
void iterop_test()
{
    typedef zr_boost_1_81::permutation_iterator< double*, int const* > permutation_type;
    typedef zr_boost_1_81::permutation_iterator< double const*, int const* > permutation_const_type;

    BOOST_CONCEPT_ASSERT((
      zr_boost_1_81_concepts::InteroperableIteratorConcept<
           permutation_type
...
void permutation_test()
{
  ...
  typedef zr_boost_1_81::permutation_iterator< element_range_type::iterator, index_type::iterator > permutation_type;
  permutation_type begin = zr_boost_1_81::make_permutation_iterator( elements.begin(), indices.begin() );
  permutation_type it = begin;
  permutation_type end = zr_boost_1_81::make_permutation_iterator( elements.begin(), indices.end() );
