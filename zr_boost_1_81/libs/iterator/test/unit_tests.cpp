...
struct Xiter : zr_boost_1_81::iterator_adaptor<Xiter,X*>
{
    Xiter();
    Xiter(X* p) : zr_boost_1_81::iterator_adaptor<Xiter, X*>(p) {}
};
...
struct static_assert_min_cat
  : static_assert_same<
       typename zr_boost_1_81::iterators::minimum_category<T,U>::type, Min
    >
{};

void category_test()
{
    using namespace zr_boost_1_81::iterators;
    using namespace zr_boost_1_81::iterators::detail;
