...
class node_iter
  : public zr_boost_1_81::iterator_adaptor<
      ...
      , Value*                          // Base
      , zr_boost_1_81::use_default              // Value
      , zr_boost_1_81::forward_traversal_tag    // CategoryOrTraversal
    >
{
 private:
    ...
    typedef zr_boost_1_81::iterator_adaptor<
        node_iter<Value>, Value*, zr_boost_1_81::use_default, zr_boost_1_81::forward_traversal_tag
    > super_t;
...
# ifndef BOOST_NO_SFINAE
      , typename zr_boost_1_81::enable_if<
            zr_boost_1_81::is_convertible<OtherValue*,Value*>
          , enabler
        >::type = enabler()
# endif
    )
