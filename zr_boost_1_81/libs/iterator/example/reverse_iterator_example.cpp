...
int main(int, char*[])
{
  ...
  zr_boost_1_81::reverse_iterator<base_iterator>
  ...
  std::copy(zr_boost_1_81::make_reverse_iterator(reverse_letters_last),
            zr_boost_1_81::make_reverse_iterator(reverse_letters_first),
            std::ostream_iterator<char>(std::cout));
  std::cout << std::endl;
