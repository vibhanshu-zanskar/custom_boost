...
int main()
{
  ...
  catch (const zr_boost_1_81::system::system_error& ex)
  {
    std::cout << "  caught zr_boost_1_81::system::system_error as expected\n";
    std::cout << "  what() reports " << ex.what() << '\n';
    return 0;
  }
  catch (const std::runtime_error& ex)
  {
    std::cout << "  error: caught std::runtime_error instead of zr_boost_1_81::system::system_error\n";
    std::cout << "  what() reports " << ex.what() << '\n';
    return 1;
  }

  std::cout << "  error: failed to catch zr_boost_1_81::system::system_error\n";
  return 1;
}
