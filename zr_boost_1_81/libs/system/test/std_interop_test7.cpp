...
{
    {
        zr_boost_1_81::system::error_code e1 = make_error_code( zr_boost_1_81::system::errc::bad_address );

        BOOST_TEST( e1 == zr_boost_1_81::system::errc::bad_address );
        BOOST_TEST_NOT( e1 != zr_boost_1_81::system::errc::bad_address );
    ...
    {
        zr_boost_1_81::system::error_code e1 = make_error_code( std::errc::bad_address );
