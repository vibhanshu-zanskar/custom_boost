...
class my_category: public zr_boost_1_81::system::error_category
{
public:
    ...
    zr_boost_1_81::system::error_condition default_error_condition( int ev ) const BOOST_NOEXCEPT
    {
        switch( ev )
        {
        case my_enoent:

            return zr_boost_1_81::system::error_condition( ENOENT, zr_boost_1_81::system::generic_category() );
...
template<> struct zr_boost_1_81::system::is_error_code_enum<my_errc>: std::true_type {};
...
zr_boost_1_81::system::error_code make_error_code( my_errc e )
{
    ...
    return zr_boost_1_81::system::error_code( e, cat );
}

int main()
{
    {
        zr_boost_1_81::system::error_code e1 = my_enoent;

        BOOST_TEST( e1 == my_enoent );
        BOOST_TEST_NOT( e1 != my_enoent );

        BOOST_TEST( e1 == zr_boost_1_81::system::errc::no_such_file_or_directory );
