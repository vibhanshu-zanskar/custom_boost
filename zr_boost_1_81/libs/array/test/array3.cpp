...
int main()
{
    ...
    zr_boost_1_81::array<std::string,4> seasons = {
        { "spring", "summer", "autumn", "winter" }
    };

    // copy and change order
    zr_boost_1_81::array<std::string,4> seasons_orig = seasons;
    ...
    std::cout << "reverse:   ";
    for (zr_boost_1_81::array<std::string,4>::reverse_iterator pos
    ...
    std::cout << "reverse:   ";
    for (zr_boost_1_81::array<std::string,4>::const_reverse_iterator pos
