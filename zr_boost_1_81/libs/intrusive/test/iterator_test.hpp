...
namespace zr_boost_1_81{  namespace intrusive {  namespace test{
...
void test_iterator_compatible(C &c)
{
   ...
   BOOST_STATIC_ASSERT((!zr_boost_1_81::intrusive::detail::is_convertible<const_iterator, iterator>::value));
   BOOST_STATIC_ASSERT((!zr_boost_1_81::intrusive::detail::is_convertible<const_reverse_iterator, reverse_iterator>::value));
...
void test_iterator_forward(C &c)
{
   ...
   using zr_boost_1_81::intrusive::detail::is_same;
   //iterator_category
