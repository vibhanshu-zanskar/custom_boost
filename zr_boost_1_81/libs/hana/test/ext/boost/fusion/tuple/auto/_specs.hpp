...
#define MAKE_TUPLE(...) ::zr_boost_1_81::fusion::make_tuple(__VA_ARGS__)
#define TUPLE_TYPE(...) ::zr_boost_1_81::fusion::tuple<__VA_ARGS__>
#define TUPLE_TAG ::zr_boost_1_81::hana::ext::zr_boost_1_81::fusion::tuple_tag
