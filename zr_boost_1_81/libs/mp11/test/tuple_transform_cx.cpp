...
{
    {
        ...
        constexpr auto r = zr_boost_1_81::mp11::tuple_transform( f, tp );
...

    {
        ...
        constexpr auto r = zr_boost_1_81::mp11::tuple_transform( g, tp1, tp2 );
...
// "error: default initialization of an object of const type 'const std::tuple<>' without a user-provided default constructor"
...

    {
        ...
        constexpr std::tuple<> r = zr_boost_1_81::mp11::tuple_transform( f, tp );
        (void)r;
    }
