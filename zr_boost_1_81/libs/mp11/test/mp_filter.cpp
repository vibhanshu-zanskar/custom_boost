...
using zr_boost_1_81::mp11::mp_not;
using zr_boost_1_81::mp11::mp_plus;

template<class T> using P1 = mp_not<mod_6<T>>;
template<class T1, class... T> using P2 = mp_not<mp_plus<T...>>;

using zr_boost_1_81::mp11::mp_bool;
...
using zr_boost_1_81::mp11::mp_first;
using zr_boost_1_81::mp11::mp_filter_q;
using zr_boost_1_81::mp11::mp_iota;
using zr_boost_1_81::mp11::mp_size;
...
int main()
{
    ...
    using zr_boost_1_81::mp11::mp_filter;
