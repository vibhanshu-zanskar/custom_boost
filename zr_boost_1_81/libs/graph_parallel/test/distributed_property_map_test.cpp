...
template<typename T>
struct my_reduce : zr_boost_1_81::parallel::basic_reduce<T> {
...
void colored_test()
{
  ...
  typedef zr_boost_1_81::parallel::distributed_property_map<mpi_process_group,
  ...
  colors.set_consistency_model(zr_boost_1_81::parallel::cm_bidirectional);
...
void bool_test()
{
  ...
  values.set_consistency_model(zr_boost_1_81::parallel::cm_bidirectional);
...
void string_test()
{
  ...
  strings.set_consistency_model(zr_boost_1_81::parallel::cm_bidirectional);
...
{
  zr_boost_1_81::mpi::environment env(argc, argv);
  colored_test();
  bool_test();
  string_test();
