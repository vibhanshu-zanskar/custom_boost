...
using zr_boost_1_81::move_detail::cpu_timer;
using zr_boost_1_81::move_detail::cpu_times;
using zr_boost_1_81::move_detail::nanosecond_type;
...
zr_boost_1_81::container::vector<int> sorted_unique_range_int;
zr_boost_1_81::container::vector<int> sorted_range_int;
zr_boost_1_81::container::vector<int> random_unique_range_int;
zr_boost_1_81::container::vector<int> random_range_int;
...
zr_boost_1_81::container::vector<zr_boost_1_81::container::string> sorted_unique_range_string;
zr_boost_1_81::container::vector<zr_boost_1_81::container::string> sorted_range_string;
zr_boost_1_81::container::vector<zr_boost_1_81::container::string> random_unique_range_string;
zr_boost_1_81::container::vector<zr_boost_1_81::container::string> random_range_string;

void fill_range_strings()
{
   zr_boost_1_81::container::string model_s;
   model_s.append(sizeof(zr_boost_1_81::container::string), '*');
...
{
   typedef zr_boost_1_81::container::vector<int> type;
...
template<>
struct range_provider<zr_boost_1_81::container::string>
{
   typedef zr_boost_1_81::container::vector<zr_boost_1_81::container::string> type;
...
template<typename C>
cpu_times copy_destroy_time(zr_boost_1_81::container::vector<typename C::value_type> &unique_range)
{
...
template<typename C>
cpu_times construct_time( zr_boost_1_81::container::vector<typename C::value_type> &unique_range
                        , zr_boost_1_81::container::vector<typename C::value_type> &range
...
template<typename C>
cpu_times insert_time( zr_boost_1_81::container::vector<typename C::value_type> &unique_range
                     , zr_boost_1_81::container::vector<typename C::value_type> &range
                     , const char *RangeType)
{
...
bool check_not_end(zr_boost_1_81::container::vector<Iterator> &iterators, Iterator itend, std::size_t number_of_ends = 0)
{
...
template<typename Iterator>
bool check_all_not_empty(zr_boost_1_81::container::vector< std::pair<Iterator, Iterator > > &iterator_pairs)
{
...
template<typename C>
cpu_times search_time(zr_boost_1_81::container::vector<typename C::value_type> &unique_range, const char *RangeType)
{
   ...
   zr_boost_1_81::container::vector<typename C::iterator> v_it(NElements);
   zr_boost_1_81::container::vector< std::pair<typename C::iterator, typename C::iterator> > v_itp(NElements);
...
template<typename C>
void extensions_time(zr_boost_1_81::container::vector<typename C::value_type> &sorted_unique_range)
{
   ...
   for(std::size_t i = 0; i != NIter; ++i){
      ...
      }
      {
         ...
         C c(zr_boost_1_81::container::ordered_unique_range, sorted_unique_range.begin(), sorted_unique_range.end());
         sur_opt_timer.stop();
      }
