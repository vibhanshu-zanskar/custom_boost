...
*/
   ...
   typedef zr_boost_1_81::container::dtl::shared_node_pool
      < (2*sizeof(void*)+sizeof(int))
      , AdPoolAlignOnlyV2::nodes_per_block> shared_node_pool_t;
   zr_boost_1_81::container::dtl::singleton_default
      <shared_node_pool_t>::instance().purge_blocks();

   //Release adaptive_pool cache
   typedef zr_boost_1_81::container::dtl::shared_adaptive_node_pool
      < (2*sizeof(void*)+sizeof(int))
