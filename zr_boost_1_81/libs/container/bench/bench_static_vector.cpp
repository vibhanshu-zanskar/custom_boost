...
//
//  @brief  varray_benchmark.cpp compares the performance of zr_boost_1_81::container::varray to zr_boost_1_81::container::vector
...
#else
typedef zr_boost_1_81::container::test::copyable_int basic_type_t;
#endif
...
T &generate()
{
   ...
   for (std::size_t i = 0; i < N; ++i){
      ...
      v.push_back(zr_boost_1_81::move(r));
      delete &r;
   }
   return v;
}
...
int main()
{
   ...
   cpu_times time_varray = time_it<zr_boost_1_81::container::varray<zr_boost_1_81::container::varray<basic_type_t,N>,N > >();

   std::cout << "zr_boost_1_81::container::static_vector benchmark" << std::endl;
   cpu_times time_boost_static_vector = time_it<zr_boost_1_81::container::static_vector<zr_boost_1_81::container::static_vector<basic_type_t,N>,N > >();

   std::cout << "zr_boost_1_81::container::vector benchmark"  << std::endl;
   cpu_times time_boost_vector = time_it<zr_boost_1_81::container::vector<zr_boost_1_81::container::vector<basic_type_t> > >();

   std::cout << "std::vector benchmark" << std::endl;
   cpu_times time_standard_vector = time_it<std::vector<std::vector<basic_type_t> > >();

   std::cout << "varray/zr_boost_1_81::container::vector total time comparison:";
   compare_times(time_varray, time_boost_vector);

   std::cout << "varray/zr_boost_1_81::container::static_vector total time comparison:";
