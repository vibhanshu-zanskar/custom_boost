...
class varray
{
    ...
    typedef typename aligned_storage<
        ...
        zr_boost_1_81::container::dtl::alignment_of<Value[Capacity]>::value
...
public:
    ...
    typedef zr_boost_1_81::container::reverse_iterator<iterator> reverse_iterator;
    //! @brief The const reverse iterator.
    typedef zr_boost_1_81::container::reverse_iterator<const_iterator> const_reverse_iterator;
...
// TEMPORARY WORKAROUND
    ...
    varray & operator=(::zr_boost_1_81::rv< varray<value_type, C, S> > const& other)
#else
    ...
    {
        return this->priv_insert(position, zr_boost_1_81::move(value));
    }
    ...
    iterator insert(iterator position, size_type count, value_type const& value)
    {
        ...
        else
        {
            ...
            difference_type to_move = zr_boost_1_81::container::iterator_distance(position, this->end());
    ...
    iterator erase(iterator first, iterator last)
    {
        ...
        difference_type n = zr_boost_1_81::container::iterator_distance(first, last);
...
private:
    ...
    void move_assign_dispatch(varray<value_type, C, S> & other, true_type /*use_memop*/)
    {
        ...
        ::memcpy(this->data(), other.data(), sizeof(Value) * other.m_size);
        zr_boost_1_81::adl_move_swap(m_size, other.m_size);
    }
    ...
    {
        //BOOST_ASSERT_MSG(zr_boost_1_81::container::iterator_udistance(first_sm, last_sm) <= zr_boost_1_81::container::iterator_udistance(first_la, last_la));
        ...
        ::memcpy(first_sm, first_la, sizeof(value_type) * zr_boost_1_81::container::iterator_udistance(first_la, last_la));
    }
    ...
    void swap_dispatch_impl(iterator first_sm, iterator last_sm, iterator first_la, iterator last_la, false_type const& /*use_memop*/)
    {
        ...
        for (; first_sm != last_sm ; ++first_sm, ++first_la)
        {
            //zr_boost_1_81::adl_move_swap(*first_sm, *first_la);                                    // may throw
       ...
       insert_dispatch(iterator position, Iterator first, Iterator last)
    {
        ...
        size_type count = zr_boost_1_81::container::iterator_udistance(first, last);
        ...
        insert_dispatch(iterator position, Iterator first, Iterator last)
    {
        ...
        if ( position == this->end() )
        {
            ...
            std::size_t d = zr_boost_1_81::container::iterator_udistance(position, this->begin() + Capacity);
    ...
    void insert_in_the_middle(iterator position, Iterator first, Iterator last, difference_type count)
    {
        ...
        else
        {
            ...
            zr_boost_1_81::container::iterator_advance(middle_iter, to_move);
       ...
       assign_dispatch(Iterator first, Iterator last)
    {
        ...
        size_type s = zr_boost_1_81::container::iterator_udistance(first, last);
       ...
       assign_dispatch(Iterator first, Iterator last)
    {
        ...
        std::size_t d = zr_boost_1_81::container::iterator_udistance(it, this->begin() + Capacity);
...
public:
    ...
    varray(Iterator first, Iterator last)
    {
        errh::check_capacity(*this, zr_boost_1_81::container::iterator_distance(first, last));                    // may throw
    }
...
}}} // namespace zr_boost_1_81::container::dtl
