...
namespace zr_boost_1_81 { namespace container { namespace varray_detail {

namespace bcd = ::zr_boost_1_81::container::dtl;

template <typename I>
struct are_elements_contiguous : zr_boost_1_81::container::dtl::is_pointer<I>
{};
...
struct are_corresponding :
    bcd::bool_<
        bcd::is_same<
            bcd::remove_const<
                typename ::zr_boost_1_81::container::iterator_traits<I>::value_type
            >,
            bcd::remove_const<
...
struct is_corresponding_value :
   bcd::bool_<
         bcd::is_same<
            bcd::remove_const<typename ::zr_boost_1_81::container::iterator_traits<I>::value_type>,
            bcd::remove_const<V>
         >::value
      >
{};
...
{
    typedef typename ::zr_boost_1_81::container::iterator_traits<I>::value_type value_type;
...
{
   typedef typename ::zr_boost_1_81::container::iterator_traits<I>::value_type value_type;
   const std::size_t d = zr_boost_1_81::container::iterator_udistance(first, last);
   ::memmove(zr_boost_1_81::container::dtl::addressof(*dst), zr_boost_1_81::container::dtl::addressof(*first), sizeof(value_type) * d);
   return dst + d;
}
...
inline O copy(I first, I last, O dst)
{
   ...
   <  are_corresponding<I, O>::value &&
      bcd::is_trivially_copy_assignable<typename ::zr_boost_1_81::container::iterator_traits<O>::value_type>::value
   > use_memmove;
                              ...
                              bcd::true_type const& /*use_memcpy*/)
{
   typedef typename ::zr_boost_1_81::container::iterator_traits<I>::value_type value_type;
   const std::size_t d = zr_boost_1_81::container::iterator_udistance(first, last);
   ::memcpy(zr_boost_1_81::container::dtl::addressof(*dst), zr_boost_1_81::container::dtl::addressof(*first), sizeof(value_type) * d);
   return dst + d;
}
...
F uninitialized_copy(I first, I last, F dst)
{
   ...
   <  are_corresponding<I, F>::value &&
      bcd::is_trivially_copy_constructible<typename ::zr_boost_1_81::container::iterator_traits<F>::value_type>::value
   > use_memcpy;
...
O uninitialized_move_dispatch(I first, I last, O dst,
                              bcd::false_type const& /*use_memcpy*/)
{
    //return zr_boost_1_81::uninitialized_move(first, last, dst);                         // may throw
    ...
    BOOST_TRY
    {
        ...
        for (; first != last; ++first, ++o )
            new (zr_boost_1_81::container::dtl::addressof(*o)) value_type(zr_boost_1_81::move(*first));
    }
    BOOST_CATCH(...)
    {
        destroy(dst, o);
...
O uninitialized_move(I first, I last, O dst)
{
   typedef bcd::bool_
   <  are_corresponding<I, O>::value &&
      bcd::is_trivially_copy_constructible<typename ::zr_boost_1_81::container::iterator_traits<O>::value_type>::value
   > use_memcpy;
...
{
   return zr_boost_1_81::move(first, last, dst);                                         // may throw
}
...
BDO move_backward_dispatch(BDI first, BDI last, BDO dst,
                           bcd::true_type const& /*use_memmove*/)
{
    typedef typename ::zr_boost_1_81::container::iterator_traits<BDI>::value_type value_type;
    const std::size_t d = zr_boost_1_81::container::iterator_udistance(first, last);
    BDO foo(dst - d);
    ::memmove(zr_boost_1_81::container::dtl::addressof(*foo), zr_boost_1_81::container::dtl::addressof(*first), sizeof(value_type) * d);
    return foo;
}
...
BDO move_backward_dispatch(BDI first, BDI last, BDO dst,
                           bcd::false_type const& /*use_memmove*/)
{
    return zr_boost_1_81::move_backward(first, last, dst);                                // may throw
}
...
BDO move_backward(BDI first, BDI last, BDO dst)
{
   ...
   <  are_corresponding<BDI, BDO>::value &&
      bcd::is_trivially_copy_constructible<typename ::zr_boost_1_81::container::iterator_traits<BDO>::value_type>::value
   > use_memmove;
...
struct has_nothrow_move : public
    bcd::bool_<
         ::zr_boost_1_81::has_nothrow_move<
               typename bcd::remove_const<T>::type
         >::value
        ||
         ::zr_boost_1_81::has_nothrow_move<T>::value
    >
{};
                                 ...
                                 bcd::false_type const& /*disable_trivial_init*/)
{
    typedef typename ::zr_boost_1_81::container::iterator_traits<I>::value_type value_type;
    for ( ; first != last ; ++first )
        new (zr_boost_1_81::container::dtl::addressof(*first)) value_type();
}
                                 ...
                                 DisableTrivialInit const& /*not_used*/)
{
    ...
    {
        for ( ; it != last ; ++it )
            new (zr_boost_1_81::container::dtl::addressof(*it)) value_type();                           // may throw
    }
    BOOST_CATCH(...)
    {
        destroy(first, it);
...
{
    typedef typename ::zr_boost_1_81::container::iterator_traits<I>::value_type value_type;
    new (static_cast<void*>(::zr_boost_1_81::container::dtl::addressof(*pos))) value_type();                      // may throw
}
...
{
    ::memcpy(zr_boost_1_81::container::dtl::addressof(*pos), zr_boost_1_81::container::dtl::addressof(v), sizeof(V));
}
...
void construct_dispatch(I pos, P const& p,
                        bcd::false_type const& /*use_memcpy*/)
{
    typedef typename ::zr_boost_1_81::container::iterator_traits<I>::value_type V;
    new (static_cast<void*>(zr_boost_1_81::container::dtl::addressof(*pos))) V(p);                      // may throw
}
...
{
    typedef typename ::zr_boost_1_81::container::iterator_traits<I>::value_type V;
    new (static_cast<void*>(zr_boost_1_81::container::dtl::addressof(*pos))) V(::zr_boost_1_81::move(p));                      // may throw
}
...
{
    typedef typename ::zr_boost_1_81::container::iterator_traits<I>::value_type V;
    new (static_cast<void*>(zr_boost_1_81::container::dtl::addressof(*pos))) V(::zr_boost_1_81::forward<Args>(args)...);    // may throw
}
...
{\
    typedef typename ::zr_boost_1_81::container::iterator_traits<I>::value_type V;\
    new (static_cast<void*>(zr_boost_1_81::container::dtl::addressof(*pos)))\
    V(::zr_boost_1_81::forward<P>(p) BOOST_MOVE_I##N BOOST_MOVE_FWD##N); /*may throw*/\
}
...
{
    *pos = zr_boost_1_81::move(v);                                                        // may throw
}
...
}}} // namespace zr_boost_1_81::container::varray_detail
