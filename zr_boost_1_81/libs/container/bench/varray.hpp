...
// TEMPORARY WORKAROUND
    ...
    varray & operator=(::zr_boost_1_81::rv< varray<value_type, C> > const& other)
#else
    ...
    varray(BOOST_RV_REF(varray) other)
        : base_t(zr_boost_1_81::move(static_cast<base_t&>(other)))
    {}
    ...
    varray(BOOST_RV_REF_2_TEMPL_ARGS(varray, value_type, C) other)
        : base_t(zr_boost_1_81::move(static_cast<dtl::varray<value_type, C>&>(other)))
    {}
    ...
    {
        base_t::operator=(zr_boost_1_81::move(static_cast<base_t&>(other)));
        return *this;
    }
    ...
    {
        base_t::operator=(zr_boost_1_81::move(static_cast<dtl::varray<value_type, C>&>(other)));
        return *this;
    }
