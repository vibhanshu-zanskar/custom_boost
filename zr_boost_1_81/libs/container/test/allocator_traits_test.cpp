...
class ComplexAllocator
{
   ...
   {  construct_called_ = true;  ::new(p) U( ::zr_boost_1_81::forward<Args>(args)...); }

   #endif

   template<class U>
   void construct(U *p, zr_boost_1_81::container::default_init_t)
...
{
   zr_boost_1_81::container::allocator_traits<std::allocator<void>   > stdtraits; (void)stdtraits;
   zr_boost_1_81::container::allocator_traits<SimpleAllocator<void>  > simtraits; (void)simtraits;
   zr_boost_1_81::container::allocator_traits<ComplexAllocator<void> > comtraits; (void)comtraits;
}

int main()
{
   using namespace zr_boost_1_81::container::dtl;
   test_void_allocator();

   //SimpleAllocator
   BOOST_STATIC_ASSERT(( is_same<zr_boost_1_81::container::allocator_traits
   ...
   BOOST_STATIC_ASSERT(( zr_boost_1_81::container::allocator_traits
   ...
   typedef zr_boost_1_81::container::allocator_traits<CAlloc> CAllocTraits;
   typedef zr_boost_1_81::container::allocator_traits<SAlloc> SAllocTraits;
   CAlloc c_alloc;
   SAlloc s_alloc;
   ...
   {
      int i = 5;
      CAllocTraits::construct(c_alloc, &i, zr_boost_1_81::container::default_init);
   ...
   }
   {
      copymovable c;
      copymovable c2;
      CAllocTraits::construct(c_alloc, &c, ::zr_boost_1_81::move(c2));
      BOOST_TEST(c_alloc.construct_called() && c.copymoveconstructed() && c.moved());
   }
   {
      copymovable c;
   ...
   {
      int i = 4;
      SAllocTraits::construct(s_alloc, &i, zr_boost_1_81::container::default_init);
      BOOST_TEST(i == 4);
   }
   {
      copymovable c;
   ...
   }
   {
      copymovable c;
      copymovable c2;
      SAllocTraits::construct(s_alloc, &c, ::zr_boost_1_81::move(c2));
      BOOST_TEST(c.copymoveconstructed() && c.moved());
   }
   {
      copymovable c;
