...
bool list_copyable_only(V1 &, V2 &, zr_boost_1_81::container::dtl::false_type)
{
   return true;
}
...
template<class V1, class V2>
bool list_copyable_only(V1 &boostlist, V2 &stdlist, zr_boost_1_81::container::dtl::true_type)
{
   ...
   {
      IntType move_me(1);
      boostlist.insert(boostlist.begin(), 50u, zr_boost_1_81::move(move_me));
      stdlist.insert(stdlist.begin(), 50u, 1);
      if(!test::CheckEqualContainers(boostlist, stdlist)) return false;
   }
   {
      IntType move_me(2);
      boostlist.assign(boostlist.size()/2, zr_boost_1_81::move(move_me));
      stdlist.assign(stdlist.size()/2, 2);
      if(!test::CheckEqualContainers(boostlist, stdlist)) return false;
   }
   {
      IntType move_me(3);
      boostlist.assign(boostlist.size()*3-1, zr_boost_1_81::move(move_me));
   ...
   {  //List(const List &)
      ::zr_boost_1_81::movelib::unique_ptr<V1> const pv1 = ::zr_boost_1_81::movelib::make_unique<V1>(boostlist);
      ::zr_boost_1_81::movelib::unique_ptr<V2> const pv2 = ::zr_boost_1_81::movelib::make_unique<V2>(stdlist);
   ...
   {  //List(const List &, alloc)
      ::zr_boost_1_81::movelib::unique_ptr<V1> const pv1 = ::zr_boost_1_81::movelib::make_unique<V1>(boostlist, typename V1::allocator_type());
      ::zr_boost_1_81::movelib::unique_ptr<V2> const pv2 = ::zr_boost_1_81::movelib::make_unique<V2>(stdlist);
...
struct list_push_data_function
{
   ...
   static int execute(std::size_t max, MyBoostList &boostlist, MyStdList &stdlist)
   {
      ...
      for(std::size_t i = 0; i < max; ++i){
         ...
         boostlist.push_back(zr_boost_1_81::move(move_me));
...
struct list_push_data_function<false>
{
   ...
   static int execute(std::size_t max, MyBoostList &boostlist, MyStdList &stdlist)
   {
      ...
      for(std::size_t i = 0; i < max; ++i){
         IntType move_me((int)i);
         boostlist.push_front(zr_boost_1_81::move(move_me));
         stdlist.push_front((int)i);
         boostlist.push_front(IntType(int(i)));
         stdlist.push_front(int(i));
      }
...
int list_test (bool copied_allocators_equal = true)
{
   ...
   {  //List(n)
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostList> const pboostlist = ::zr_boost_1_81::movelib::make_unique<MyBoostList>(100u);
      ::zr_boost_1_81::movelib::unique_ptr<MyStdList> const pstdlist = ::zr_boost_1_81::movelib::make_unique<MyStdList>(100u);
      if(!test::CheckEqualContainers(*pboostlist, *pstdlist)) return 1;
   }
   {  //List(n, alloc)
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostList> const pboostlist = ::zr_boost_1_81::movelib::make_unique<MyBoostList>(100u, typename MyBoostList::allocator_type());
      ::zr_boost_1_81::movelib::unique_ptr<MyStdList> const pstdlist = ::zr_boost_1_81::movelib::make_unique<MyStdList>(100u);
      if(!test::CheckEqualContainers(*pboostlist, *pstdlist)) return 1;
   }
   {  //List(List &&)
      ::zr_boost_1_81::movelib::unique_ptr<MyStdList> const stdlistp = ::zr_boost_1_81::movelib::make_unique<MyStdList>(100u);
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostList> const boostlistp = ::zr_boost_1_81::movelib::make_unique<MyBoostList>(100u);
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostList> const boostlistp2 = ::zr_boost_1_81::movelib::make_unique<MyBoostList>(::zr_boost_1_81::move(*boostlistp));
      if(!test::CheckEqualContainers(*boostlistp2, *stdlistp)) return 1;
   }
   {  //List(List &&, alloc)
      ::zr_boost_1_81::movelib::unique_ptr<MyStdList> const stdlistp = ::zr_boost_1_81::movelib::make_unique<MyStdList>(100u);
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostList> const boostlistp = ::zr_boost_1_81::movelib::make_unique<MyBoostList>(100u);
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostList> const boostlistp2 = ::zr_boost_1_81::movelib::make_unique<MyBoostList>
         (::zr_boost_1_81::move(*boostlistp), typename MyBoostList::allocator_type());
      if(!test::CheckEqualContainers(*boostlistp2, *stdlistp)) return 1;
   }
   {  //List operator=(List &&)
      ::zr_boost_1_81::movelib::unique_ptr<MyStdList> const stdlistp = ::zr_boost_1_81::movelib::make_unique<MyStdList>(100u);
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostList> const boostlistp = ::zr_boost_1_81::movelib::make_unique<MyBoostList>(100u);
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostList> const boostlistp2 = ::zr_boost_1_81::movelib::make_unique<MyBoostList>();
      *boostlistp2 = ::zr_boost_1_81::move(*boostlistp);
      if(!test::CheckEqualContainers(*boostlistp2, *stdlistp)) return 1;
   }

   ::zr_boost_1_81::movelib::unique_ptr<MyBoostList> const pboostlist = ::zr_boost_1_81::movelib::make_unique<MyBoostList>();
   ::zr_boost_1_81::movelib::unique_ptr<MyStdList>   const pstdlist   = ::zr_boost_1_81::movelib::make_unique<MyStdList>();
...

   {
      ...
      boostlist.assign(zr_boost_1_81::make_move_iterator(&aux_vect[0])
      ...
      boostlist.assign(zr_boost_1_81::make_move_iterator(make_input_from_forward_iterator(&aux_vect[0]))
...

   {
      ...
      typename MyBoostList::iterator it_insert =
         boostlist.insert(boostlist.begin()
                     ...
                     ,zr_boost_1_81::make_move_iterator(&aux_vect[50]));
      if(it_insert != boostlist.begin() || zr_boost_1_81::container::iterator_distance(it_insert, old_begin) != 50)
         return 1;
      ...
      it_insert = boostlist.insert(boostlist.end()
                     ...
                     ,zr_boost_1_81::make_move_iterator(make_input_from_forward_iterator(&aux_vect[50])));
      if(zr_boost_1_81::container::iterator_distance(it_insert, boostlist.end()) != 50)
         return 1;
   ...
   for(std::size_t i = 0; i < max; ++i){
      ...
      boostlist.insert(boostlist.end(), zr_boost_1_81::move(new_int));
