...
int main()
{
   ...
   {
      zr_boost_1_81::container::vector<X> v;
      v.reserve(4);
      v.push_back(X(0,0));
      v.push_back(X(0,0));
      v.push_back(X(0,0));
   ...
   }
   {
      ...
      X::sp = X::special();
      v.insert(v.begin(), zr_boost_1_81::move(x));
      std::cout << X::sp;
      std::cout << "----\n";
      insert_results = X::sp;
   }
   {
      ...
      X::sp = X::special();
      v.emplace(v.begin(), zr_boost_1_81::move(x));
      std::cout << X::sp;
      std::cout << "----\n";
      emplace_results = X::sp;
   }
   ...
   BOOST_TEST_EQ(insert_results == emplace_results, true);
   {
      ...
      X::sp = X::special();
      v.push_back(zr_boost_1_81::move(x));
      std::cout << X::sp;
      std::cout << "----\n";
      insert_results = X::sp;
   }
   {
      ...
      X::sp = X::special();
      v.emplace_back(zr_boost_1_81::move(x));
      std::cout << X::sp;
      std::cout << "----\n";
      emplace_results = X::sp;
   }
