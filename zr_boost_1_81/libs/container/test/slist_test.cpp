...
struct alloc_propagate_base<boost_container_slist>
{
   ...
   struct apply
   {
      typedef zr_boost_1_81::container::slist<T, Allocator> type;
   };
};
...
int main ()
{
   recursive_slist_test();
   {
      ...
      slist<recursive_slist> move_ctor(zr_boost_1_81::move(original));
   ...
   ////////////////////////////////////
   if(!zr_boost_1_81::container::test::test_propagate_allocator<boost_container_slist>())
      return 1;
   ...
   ////////////////////////////////////
   {
      typedef zr_boost_1_81::container::slist<int> vector_int;
      vector_int a; a.push_front(2); a.push_front(1); a.push_front(0);
      zr_boost_1_81::intrusive::test::test_iterator_forward< zr_boost_1_81::container::slist<int> >(a);
   ...
   ////////////////////////////////////
   {
      ...
      auto test = zr_boost_1_81::container::slist(gold.begin(), gold.end());
      if (test.size() != 3) {
         return 1;
      }
      if (test.front() != 1)
   ...
   {
      auto gold = std::list{ 1, 2, 3 };
      auto test = zr_boost_1_81::container::slist(gold.begin(), gold.end(), new_allocator<int>());
      if (test.size() != 3) {
         return 1;
      }
      if (test.front() != 1)
   ...
   // default allocator
   {
      typedef zr_boost_1_81::container::slist<int> cont;
   ...
   // std::allocator
   {
      typedef zr_boost_1_81::container::slist<int, std::allocator<int> > cont;
      typedef cont::allocator_type allocator_type;
      typedef zr_boost_1_81::container::allocator_traits<allocator_type>::pointer pointer;
      BOOST_STATIC_ASSERT_MSG(
        !(zr_boost_1_81::has_trivial_destructor_after_move<cont>::value !=
