...
{
   StringEqual comp;
   return zr_boost_1_81::container::algo_equal(strvect1->begin(), strvect1->end(),
                     strvect2->begin(), comp);
}
...
int string_test()
{
...

   {
      ...
      for(std::size_t i = 0; i < MaxSize; ++i){
         ...
         auxBoostString += buffer;
         auxStdString += buffer;
         boostStringVect->push_back(zr_boost_1_81::move(auxBoostString));
         stdStringVect->push_back(auxStdString);
      }
      ...
      for(std::size_t i = 0; i < MaxSize; ++i){
         ...
         auxBoostString += buffer;
         auxStdString += buffer;
         boostStringVect->insert(boostStringVect->begin(), zr_boost_1_81::move(auxBoostString));
         stdStringVect->insert(stdStringVect->begin(), auxStdString);
      }
      ...
      //Check addition
      {
         ...
         bs4 = BoostString() + zr_boost_1_81::move(bs2);
         ss4 = StdString() + zr_boost_1_81::move(ss2);
         if(!StringEqual()(bs4, ss4)){
            return 1;
         }
         ...
         bs4 = zr_boost_1_81::move(bs2) + BoostString();
         ss4 = zr_boost_1_81::move(ss2) + StdString();
         if(!StringEqual()(bs4, ss4)){
            return 1;
         }
         ...
         bs2 = string_literals<CharType>::String();
         ss2 = string_literals<CharType>::String();
         bs4 = string_literals<CharType>::Prefix() + zr_boost_1_81::move(bs2);
         ss4 = string_literals<CharType>::Prefix() + zr_boost_1_81::move(ss2);
         if(!StringEqual()(bs4, ss4)){
            return 1;
         }
         ...
         bs2 = string_literals<CharType>::String();
         ss2 = string_literals<CharType>::String();
         bs4 = zr_boost_1_81::move(bs2) + string_literals<CharType>::Suffix();
         ss4 = zr_boost_1_81::move(ss2) + string_literals<CharType>::Suffix();
         if(!StringEqual()(bs4, ss4)){
            return 1;
         }
...
struct alloc_propagate_base<boost_container_string>
{
   ...
   struct apply
   {
      typedef zr_boost_1_81::container::basic_string<T, std::char_traits<T>, Allocator> type;
   };
};
...
{
   {
      zr_boost_1_81::container::string a = "abcdefghijklmnopqrstuvwxyz";
      zr_boost_1_81::container::hash_value(a);
   }
   ...
   ////////////////////////////////////
   if(!zr_boost_1_81::container::test::test_propagate_allocator<boost_container_string>())
      return 1;
   ...
   ////////////////////////////////////
   {
      typedef zr_boost_1_81::container::basic_string<char> cont_int;
   ...
   {
      typedef zr_boost_1_81::container::basic_string<wchar_t> cont_int;
   ...
   ////////////////////////////////////
   {
      if(!zr_boost_1_81::container::test::test_container_comparisons<string>())
         return 1;
      if(!zr_boost_1_81::container::test::test_container_comparisons<wstring>())
         return 1;
   }
   ...
   // default allocator
   {
      typedef zr_boost_1_81::container::basic_string<char> cont;
   ...
   // std::allocator
   {
      typedef zr_boost_1_81::container::basic_string<char, std::char_traits<char>, std::allocator<char> > cont;
      typedef cont::allocator_type allocator_type;
      typedef zr_boost_1_81::container::allocator_traits<allocator_type>::pointer pointer;
      BOOST_STATIC_ASSERT_MSG
      (  (zr_boost_1_81::has_trivial_destructor_after_move<cont>::value ==
