...
#define BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_NS_BEG namespace zr_boost_1_81 { namespace container { namespace test {
...
template<class C>
void set_test_rebalanceable(C &, zr_boost_1_81::container::dtl::false_type)
{}

template<class C>
void set_test_rebalanceable(C &c, zr_boost_1_81::container::dtl::true_type)
{
   c.rebalance();
}
...
template<class MyBoostSet
        ...
        ,class MyStdMultiSet>
int set_test_copyable(zr_boost_1_81::container::dtl::false_type)
{  return 0; }
...
template<class MyBoostSet
        ...
        ,class MyBoostMultiSet
        ,class MyStdMultiSet>
int set_test_copyable(zr_boost_1_81::container::dtl::true_type)
{
   typedef typename MyBoostSet::value_type IntType;

   ::zr_boost_1_81::movelib::unique_ptr<MyBoostSet> const pboostset = ::zr_boost_1_81::movelib::make_unique<MyBoostSet>();
   ::zr_boost_1_81::movelib::unique_ptr<MyStdSet>   const pstdset = ::zr_boost_1_81::movelib::make_unique<MyStdSet>();
   ::zr_boost_1_81::movelib::unique_ptr<MyBoostMultiSet> const pboostmultiset = ::zr_boost_1_81::movelib::make_unique<MyBoostMultiSet>();
   ::zr_boost_1_81::movelib::unique_ptr<MyStdMultiSet>   const pstdmultiset   = ::zr_boost_1_81::movelib::make_unique<MyStdMultiSet>();
   ...
   for(int i = 0; i < MaxElem; ++i){
      IntType move_me(i);
      boostset.insert(zr_boost_1_81::move(move_me));
      stdset.insert(i);
      IntType move_me2(i);
      boostmultiset.insert(zr_boost_1_81::move(move_me2));
...
int set_test ()
{
   ...
   {  //Set(beg, end, compare)
      ...
      for(int i = 0; i < 50; ++i){
         IntType move_me(i/2);
         aux_vect[i] = zr_boost_1_81::move(move_me);
      }
      int aux_vect2[50];
      for(int i = 0; i < 50; ++i){
         aux_vect2[i] = i/2;
      ...
      for(int i = 0; i < 50; ++i){
         IntType move_me(i/2);
         aux_vect3[i] = zr_boost_1_81::move(move_me);
      }
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostSet> const pboostset2 = ::zr_boost_1_81::movelib::make_unique<MyBoostSet>
         (zr_boost_1_81::make_move_iterator(&aux_vect[0]), zr_boost_1_81::make_move_iterator(&aux_vect[0]+50), typename MyBoostSet::key_compare());
      ::zr_boost_1_81::movelib::unique_ptr<MyStdSet> const pstdset2 = ::zr_boost_1_81::movelib::make_unique<MyStdSet>(&aux_vect2[0], &aux_vect2[0]+50);
      if(!test::CheckEqualContainers(*pboostset2, *pstdset2)) return 1;
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostMultiSet> const pboostmultiset2 = ::zr_boost_1_81::movelib::make_unique<MyBoostMultiSet>
         (zr_boost_1_81::make_move_iterator(&aux_vect3[0]), zr_boost_1_81::make_move_iterator(&aux_vect3[0]+50), typename MyBoostMultiSet::key_compare());
      ::zr_boost_1_81::movelib::unique_ptr<MyStdMultiSet> const pstdmultiset2 = ::zr_boost_1_81::movelib::make_unique<MyStdMultiSet>(&aux_vect2[0], &aux_vect2[0]+50);
   ...
   {  //Set(beg, end, alloc)
      ...
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostSet> const pboostset2 = ::zr_boost_1_81::movelib::make_unique<MyBoostSet>
         (zr_boost_1_81::make_move_iterator(&aux_vect[0]), zr_boost_1_81::make_move_iterator(&aux_vect[0]+50), typename MyBoostSet::allocator_type());
      ::zr_boost_1_81::movelib::unique_ptr<MyStdSet> const pstdset2 = ::zr_boost_1_81::movelib::make_unique<MyStdSet>(&aux_vect2[0], &aux_vect2[0]+50);
      if(!test::CheckEqualContainers(*pboostset2, *pstdset2)) return 1;
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostMultiSet> const pboostmultiset2 = ::zr_boost_1_81::movelib::make_unique<MyBoostMultiSet>
         (zr_boost_1_81::make_move_iterator(&aux_vect3[0]), zr_boost_1_81::make_move_iterator(&aux_vect3[0]+50), typename MyBoostMultiSet::allocator_type());
      ::zr_boost_1_81::movelib::unique_ptr<MyStdMultiSet> const pstdmultiset2 = ::zr_boost_1_81::movelib::make_unique<MyStdMultiSet>(&aux_vect2[0], &aux_vect2[0]+50);
      if(!test::CheckEqualContainers(*pboostmultiset2, *pstdmultiset2)) return 1;
   }
   {
      ...
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostSet> const pboostset2 = ::zr_boost_1_81::movelib::make_unique<MyBoostSet>
            ( zr_boost_1_81::make_move_iterator(&aux_vect[0])
            , zr_boost_1_81::make_move_iterator(aux_vect + 50));
      ::zr_boost_1_81::movelib::unique_ptr<MyStdSet>  const pstdset2 = ::zr_boost_1_81::movelib::make_unique<MyStdSet>
            (&aux_vect2[0], &aux_vect2[0] + 50);
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostMultiSet> const pboostmultiset2 = ::zr_boost_1_81::movelib::make_unique<MyBoostMultiSet>
            ( zr_boost_1_81::make_move_iterator(&aux_vect3[0])
            , zr_boost_1_81::make_move_iterator(aux_vect3 + 50));
      ::zr_boost_1_81::movelib::unique_ptr<MyStdMultiSet>   const pstdmultiset2   = ::zr_boost_1_81::movelib::make_unique<MyStdMultiSet>
            (&aux_vect2[0], &aux_vect2[0] + 50);
      ...
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostSet> const pboostset3 = ::zr_boost_1_81::movelib::make_unique<MyBoostSet>
            ( ordered_unique_range
            , zr_boost_1_81::make_move_iterator(&aux_vect[0])
            , zr_boost_1_81::make_move_iterator(&aux_vect[0] + 50));
      ::zr_boost_1_81::movelib::unique_ptr<MyStdSet>   const pstdset3 = ::zr_boost_1_81::movelib::make_unique<MyStdSet>
            (&aux_vect2[0], &aux_vect2[0] + 50);
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostMultiSet> const pboostmultiset3 = ::zr_boost_1_81::movelib::make_unique<MyBoostMultiSet>
            ( ordered_range
            , zr_boost_1_81::make_move_iterator(&aux_vect3[0])
            , zr_boost_1_81::make_move_iterator(aux_vect3 + 50));
      ::zr_boost_1_81::movelib::unique_ptr<MyStdMultiSet>   const pstdmultiset3   = ::zr_boost_1_81::movelib::make_unique<MyStdMultiSet>
            (&aux_vect2[0], &aux_vect2[0] + 50);
   ...
   if(!CheckEqualContainers(boostset, stdset)){
      std::cout << "Error in boostset.insert(zr_boost_1_81::move(move_me)" << std::endl;
      return 1;
   }

   if(!CheckEqualContainers(boostmultiset, stdmultiset)){
      std::cout << "Error in boostmultiset.insert(zr_boost_1_81::move(move_me)" << std::endl;
      return 1;
   }
   ...
   //Initialize values
   {
      ...
      boostset.insert(zr_boost_1_81::make_move_iterator(&aux_vect[0]), zr_boost_1_81::make_move_iterator(&aux_vect[0] + 50));
      stdset.insert(&aux_vect2[0], &aux_vect2[0] + 50);
      if(!CheckEqualContainers(boostset, stdset)){
         std::cout << "Error in boostset.insert(zr_boost_1_81::make_move_iterator(&aux_vect3[0])..." << std::endl;
         return 1;
      }
      boostmultiset.insert(zr_boost_1_81::make_move_iterator(&aux_vect3[0]), zr_boost_1_81::make_move_iterator(aux_vect3 + 50));
      stdmultiset.insert(&aux_vect2[0], &aux_vect2[0] + 50);
      if(!CheckEqualContainers(boostmultiset, stdmultiset)){
         std::cout << "Error in boostmultiset.insert(zr_boost_1_81::make_move_iterator(&aux_vect3[0]), ..." << std::endl;
         return 1;
      }
   ...
   }
   {
      ...
      for(int i = 0; i < 50; ++i){
         IntType move_me(-1);
         aux_vect4[i] = zr_boost_1_81::move(move_me);
      }

      IntType aux_vect5[50];
      for(int i = 0; i < 50; ++i){
         IntType move_me(-1);
         aux_vect5[i] = zr_boost_1_81::move(move_me);
      }

      boostset.insert(zr_boost_1_81::make_move_iterator(&aux_vect[0]), zr_boost_1_81::make_move_iterator(&aux_vect[0] + 50));
      boostset.insert(zr_boost_1_81::make_move_iterator(&aux_vect3[0]), zr_boost_1_81::make_move_iterator(&aux_vect3[0] + 50));
      stdset.insert(&aux_vect2[0], &aux_vect2[0] + 50);
      stdset.insert(&aux_vect2[0], &aux_vect2[0] + 50);
      if(!CheckEqualContainers(boostset, stdset)){
         std::cout << "Error in boostset.insert(zr_boost_1_81::make_move_iterator(&aux_vect3[0])..." << std::endl;
      ...
      boostmultiset.insert(zr_boost_1_81::make_move_iterator(&aux_vect4[0]), zr_boost_1_81::make_move_iterator(&aux_vect4[0] + 50));
      boostmultiset.insert(zr_boost_1_81::make_move_iterator(&aux_vect5[0]), zr_boost_1_81::make_move_iterator(&aux_vect5[0] + 50));
      stdmultiset.insert(&aux_vect2[0], &aux_vect2[0] + 50);
      stdmultiset.insert(&aux_vect2[0], &aux_vect2[0] + 50);
      if(!CheckEqualContainers(boostmultiset, stdmultiset)){
         std::cout << "Error in boostmultiset.insert(zr_boost_1_81::make_move_iterator(&aux_vect5[0])..." << std::endl;
         return 1;
      }
   ...
   if(!CheckEqualContainers(boostset, stdset)){
      std::cout << "Error in boostset.insert(zr_boost_1_81::move(move_me)) try 2" << std::endl;
      return 1;
   }
   if(!CheckEqualContainers(boostmultiset, stdmultiset)){
      std::cout << "Error in boostmultiset.insert(zr_boost_1_81::move(move_me2)) try 2" << std::endl;
      return 1;
   }
   ...
   for(int i = 0; i < MaxElem; ++i){
      {
         IntType move_me(i);
         boostset.insert(boostset.begin(), zr_boost_1_81::move(move_me));
         stdset.insert(stdset.begin(), i);
         //PrintContainers(boostset, stdset);
         IntType move_me2(i);
         boostmultiset.insert(boostmultiset.begin(), zr_boost_1_81::move(move_me2));
         stdmultiset.insert(stdmultiset.begin(), i);
         //PrintContainers(boostmultiset, stdmultiset);
         if(!CheckEqualContainers(boostset, stdset)){
            std::cout << "Error in boostset.insert(boostset.begin(), zr_boost_1_81::move(move_me))" << std::endl;
            return 1;
         }
         if(!CheckEqualContainers(boostmultiset, stdmultiset)){
            std::cout << "Error in boostmultiset.insert(boostmultiset.begin(), zr_boost_1_81::move(move_me2))" << std::endl;
            return 1;
         }

         IntType move_me3(i);
         boostset.insert(boostset.end(), zr_boost_1_81::move(move_me3));
         stdset.insert(stdset.end(), i);
         IntType move_me4(i);
         boostmultiset.insert(boostmultiset.end(), zr_boost_1_81::move(move_me4));
         stdmultiset.insert(stdmultiset.end(), i);
         if(!CheckEqualContainers(boostset, stdset)){
            std::cout << "Error in boostset.insert(boostset.end(), zr_boost_1_81::move(move_me3))" << std::endl;
            return 1;
         }
         if(!CheckEqualContainers(boostmultiset, stdmultiset)){
            std::cout << "Error in boostmultiset.insert(boostmultiset.end(), zr_boost_1_81::move(move_me4))" << std::endl;
            return 1;
         }
      }
      {
         IntType move_me(i);
         boostset.insert(boostset.upper_bound(move_me), zr_boost_1_81::move(move_me));
         stdset.insert(stdset.upper_bound(i), i);
         //PrintContainers(boostset, stdset);
         IntType move_me2(i);
         boostmultiset.insert(boostmultiset.upper_bound(move_me2), zr_boost_1_81::move(move_me2));
         stdmultiset.insert(stdmultiset.upper_bound(i), i);
         //PrintContainers(boostmultiset, stdmultiset);
         if(!CheckEqualContainers(boostset, stdset)){
            std::cout << "Error in boostset.insert(boostset.upper_bound(move_me), zr_boost_1_81::move(move_me))" << std::endl;
            return 1;
         }
         if(!CheckEqualContainers(boostmultiset, stdmultiset)){
            std::cout << "Error in boostmultiset.insert(boostmultiset.upper_bound(move_me2), zr_boost_1_81::move(move_me2))" << std::endl;
            return 1;
         }
      ...
      }
      {
         IntType move_me(i);
         IntType move_me2(i);
         boostset.insert(boostset.lower_bound(move_me), zr_boost_1_81::move(move_me2));
         stdset.insert(stdset.lower_bound(i), i);
         //PrintContainers(boostset, stdset);
         move_me2 = i;
         boostmultiset.insert(boostmultiset.lower_bound(move_me2), zr_boost_1_81::move(move_me2));
         stdmultiset.insert(stdmultiset.lower_bound(i), i);
         //PrintContainers(boostmultiset, stdmultiset);
         if(!CheckEqualContainers(boostset, stdset)){
            std::cout << "Error in boostset.insert(boostset.lower_bound(move_me), zr_boost_1_81::move(move_me2))" << std::endl;
            return 1;
         }
         if(!CheckEqualContainers(boostmultiset, stdmultiset)){
            std::cout << "Error in boostmultiset.insert(boostmultiset.lower_bound(move_me2), zr_boost_1_81::move(move_me2))" << std::endl;
            return 1;
         }
   ...
   {  //merge
...

      {
         ...
         boostset.insert(zr_boost_1_81::make_move_iterator(&aux_vect[0]), zr_boost_1_81::make_move_iterator(&aux_vect[0] + MaxElem));
         boostset2.insert(zr_boost_1_81::make_move_iterator(&aux_vect2[0]), zr_boost_1_81::make_move_iterator(&aux_vect2[0] + MaxElem));
         boostmultiset2.insert(zr_boost_1_81::make_move_iterator(&aux_vect3[0]), zr_boost_1_81::make_move_iterator(&aux_vect3[0] + MaxElem));
      }
      for(int i = 0; i < MaxElem; ++i){
         stdset.insert(i);
      }
      ...
      boostset.merge(zr_boost_1_81::move(boostset2));
      if(!CheckEqualContainers(boostset, stdset)) return 1;
      ...
      boostset.merge(zr_boost_1_81::move(boostmultiset2));
      if(!CheckEqualContainers(boostset, stdset)) return 1;
      ...
      stdmultiset.clear();
      {
         ...
         boostmultiset.insert(zr_boost_1_81::make_move_iterator(&aux_vect[0]), zr_boost_1_81::make_move_iterator(&aux_vect[0] + MaxElem));
         boostmultiset2.insert(zr_boost_1_81::make_move_iterator(&aux_vect2[0]), zr_boost_1_81::make_move_iterator(&aux_vect2[0] + MaxElem));
         boostset2.insert(zr_boost_1_81::make_move_iterator(&aux_vect3[0]), zr_boost_1_81::make_move_iterator(&aux_vect3[0] + MaxElem));
      }
      for(int i = 0; i < MaxElem; ++i){
         stdmultiset.insert(i);
      }
      ...
      boostmultiset.merge(zr_boost_1_81::move(boostmultiset2));
      if(!CheckEqualContainers(boostmultiset, stdmultiset)) return 1;
      ...
      boostmultiset.merge(zr_boost_1_81::move(boostset2));
      if(!CheckEqualContainers(boostmultiset, stdmultiset)) return 1;
   }

   if(set_test_copyable<MyBoostSet, MyStdSet, MyBoostMultiSet, MyStdMultiSet>
      (dtl::bool_<zr_boost_1_81::container::test::is_copyable<IntType>::value>())){
      return 1;
   }
