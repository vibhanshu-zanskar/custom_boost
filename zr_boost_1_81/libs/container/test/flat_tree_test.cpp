...
typedef zr_boost_1_81::container::dtl::pair<test::movable_and_copyable_int, test::movable_and_copyable_int> pair_t;
...
int main ()
{
   ...
   // default
   {
      typedef zr_boost_1_81::container::dtl::flat_tree<int, zr_boost_1_81::container::dtl::identity<int>,
              std::less<int>, void> tree;
      typedef tree::container_type container_type;
      typedef tree::key_compare key_compare;
      BOOST_STATIC_ASSERT_MSG ((zr_boost_1_81::has_trivial_destructor_after_move<tree>::value ==
          zr_boost_1_81::has_trivial_destructor_after_move<container_type>::value &&
