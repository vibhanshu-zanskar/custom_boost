...
class propagation_test_allocator
{
   ...
   typedef zr_boost_1_81::container::dtl::bool_<HasTrueTypes>  propagate_on_container_copy_assignment;
   typedef zr_boost_1_81::container::dtl::bool_<HasTrueTypes>  propagate_on_container_move_assignment;
   typedef zr_boost_1_81::container::dtl::bool_<HasTrueTypes>  propagate_on_container_swap;
   typedef zr_boost_1_81::container::dtl::bool_<HasTrueTypes>  is_always_equal;
...
struct uses_allocator_base<ConstructiblePrefix, AllocatorTag>
{
   typedef propagation_test_allocator<int, AllocatorTag> allocator_type;
   typedef allocator_type allocator_constructor_type;
   typedef zr_boost_1_81::container::allocator_arg_t allocator_arg_type;
};

template<unsigned int AllocatorTag>
struct uses_allocator_base<ErasedTypePrefix, AllocatorTag>
{
   typedef zr_boost_1_81::container::erased_type allocator_type;
   typedef zr_boost_1_81::container::pmr::polymorphic_allocator<int> allocator_constructor_type;
   typedef zr_boost_1_81::container::allocator_arg_t allocator_arg_type;
};
