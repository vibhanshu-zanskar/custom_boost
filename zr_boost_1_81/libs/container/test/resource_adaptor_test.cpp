...
using namespace zr_boost_1_81::container::pmr;

static const std::size_t max_alignment_value = zr_boost_1_81::move_detail::alignment_of<zr_boost_1_81::move_detail::max_align_t>::value;
...
void test_move_constructor()
{
   ...
   resource_adaptor<alloc_t> ra;
   BOOST_TEST(ra.get_allocator().m_default_contructed == true);
   resource_adaptor<alloc_t> rb(::zr_boost_1_81::move(ra));
   BOOST_TEST(rb.get_allocator().m_default_contructed == false);
...
void test_rvalue_alloc_constructor()
{
   typedef propagation_test_allocator<char, 0> alloc_t;
   alloc_t a;
   resource_adaptor<alloc_t> ra(::zr_boost_1_81::move(a));
   BOOST_TEST(ra.get_allocator().m_default_contructed == false);
...
void test_do_allocate_deallocate()
{
   ...
   {
      typedef resource_adaptor< zr_boost_1_81::container::new_allocator<int> > new_resource_alloc_t;
      new_resource_alloc_t ra;
      zr_boost_1_81::container::pmr::memory_resource &mr = ra;
