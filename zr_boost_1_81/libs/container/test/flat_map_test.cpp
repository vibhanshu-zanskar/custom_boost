...
{
   typedef typename zr_boost_1_81::container::iterator_traits<RandomIt>::difference_type difference_type;
   difference_type n = last - first;
   for (difference_type i = n-1; i > 0; --i) {
      difference_type j = std::rand() % (i+1);
      if(j != i) {
         zr_boost_1_81::adl_move_swap(first[i], first[j]);
      }
   }
}
...
bool flat_tree_extract_adopt_test()
{
   ...
   //extract/adopt map
   {
      ...
      zr_boost_1_81::container::test::random_shuffle(seq.begin(), seq.end());
      fmap.adopt_sequence(zr_boost_1_81::move(seq));
   ...
   //extract/adopt map, ordered_unique_range
   {
      ...
      fmap.adopt_sequence(ordered_unique_range, zr_boost_1_81::move(seq));
      if(!CheckEqualContainers(fmap, fmap_copy))
         return false;
      if (!CheckEqualContainers(fmap.sequence(), fmap_copy.sequence()))
         return false;
   ...
   //extract/adopt multimap
   {
      ...
      zr_boost_1_81::container::test::random_shuffle(seq.begin(), seq.end());
      fmmap.adopt_sequence(zr_boost_1_81::move(seq));
   ...
   //extract/adopt multimap, ordered_range
   {
      ...
      fmmap.adopt_sequence(ordered_range, zr_boost_1_81::move(seq));
      if(!CheckEqualContainers(fmmap, fmmap_copy))
         return false;
      if (!CheckEqualContainers(fmmap.sequence(), fmmap_copy.sequence()))
         return false;
...
struct GetMapContainer
{
   ...
   struct apply
   {
      ...
      typedef flat_map< ValueType
                 , ValueType
                 , std::less<ValueType>
                 , typename zr_boost_1_81::container::dtl::container_or_allocator_rebind<VoidAllocatorOrContainer, type_t>::type
                 > map_type;
...
struct alloc_propagate_base<boost_container_flat_map>
{
   ...
   struct apply
   {
      ...
      typedef zr_boost_1_81::container::flat_map<T, T, std::less<T>, TypeAllocator> type;
   };
};
...
struct alloc_propagate_base<boost_container_flat_multimap>
{
   ...
   struct apply
   {
      typedef typename zr_boost_1_81::container::allocator_traits<Allocator>::
         template portable_rebind_alloc<std::pair<T, T> >::type TypeAllocator;
      typedef zr_boost_1_81::container::flat_multimap<T, T, std::less<T>, TypeAllocator> type;
   };
};
...
int main()
{
   using namespace zr_boost_1_81::container::test;
   ...
   //Now test nth/index_of
   {
      ...
      if(!zr_boost_1_81::container::test::test_nth_index_of(map))
         return 1;
      if(!zr_boost_1_81::container::test::test_nth_index_of(mmap))
         return 1;
   }
   ...
   if (!zr_boost_1_81::container::test::instantiate_constructors<flat_map<int, int>, flat_multimap<int, int> >())
      return 1;
   ...
   if(!zr_boost_1_81::container::test::test_map_support_for_initialization_list_for<flat_map<int, int> >())
      return 1;

   if (!zr_boost_1_81::container::test::test_map_support_for_initialization_list_for<flat_multimap<int, int> >())
      return 1;
   ...
   if(!zr_boost_1_81::container::test::test_emplace<flat_map<test::EmplaceInt, test::EmplaceInt>, MapOptions>())
      return 1;
   if(!zr_boost_1_81::container::test::test_emplace<flat_multimap<test::EmplaceInt, test::EmplaceInt>, MapOptions>())
      return 1;

   ////////////////////////////////////
   //    Allocator propagation testing
   ////////////////////////////////////
   if(!zr_boost_1_81::container::test::test_propagate_allocator<boost_container_flat_map>())
      return 1;

   if(!zr_boost_1_81::container::test::test_propagate_allocator<boost_container_flat_multimap>())
      return 1;
   ...
   ////////////////////////////////////
   {
      typedef zr_boost_1_81::container::flat_map<int, int> cont_int;
   ...
   {
      typedef zr_boost_1_81::container::flat_multimap<int, int> cont_int;
      cont_int a; a.insert(cont_int::value_type(0, 9)); a.insert(cont_int::value_type(1, 9)); a.insert(cont_int::value_type(2, 9));
      zr_boost_1_81::intrusive::test::test_iterator_random< cont_int >(a);
      if(zr_boost_1_81::report_errors() != 0) {
         return 1;
   ...
   ////////////////////////////////////
   {
      typedef zr_boost_1_81::container::dtl::pair<int, int> value_t;
      typedef zr_boost_1_81::container::dtl::select1st<int> key_of_value_t;
      // flat_map, default
      {
         typedef zr_boost_1_81::container::new_allocator<value_t> alloc_or_cont_t;
         typedef zr_boost_1_81::container::flat_map<int, int> cont;
         typedef zr_boost_1_81::container::dtl::flat_tree<value_t, key_of_value_t, std::less<int>, alloc_or_cont_t> tree;
      ...
      // flat_map, vector
      {
         typedef zr_boost_1_81::container::vector<value_t> alloc_or_cont_t;
         typedef zr_boost_1_81::container::flat_map<int, int, std::less<int>, alloc_or_cont_t> cont;
         typedef zr_boost_1_81::container::dtl::flat_tree<value_t, key_of_value_t, std::less<int>, alloc_or_cont_t> tree;
         BOOST_STATIC_ASSERT_MSG( zr_boost_1_81::has_trivial_destructor_after_move<cont>::value ==
                                  zr_boost_1_81::has_trivial_destructor_after_move<tree>::value
      ...
      {
         typedef zr_boost_1_81::container::new_allocator<value_t> alloc_or_cont_t;
         typedef zr_boost_1_81::container::flat_multimap<int, int> cont;
         typedef zr_boost_1_81::container::dtl::flat_tree<value_t, key_of_value_t, std::less<int>, alloc_or_cont_t> tree;
         BOOST_STATIC_ASSERT_MSG( zr_boost_1_81::has_trivial_destructor_after_move<cont>::value ==
                                  zr_boost_1_81::has_trivial_destructor_after_move<tree>::value
      ...
      {
         typedef zr_boost_1_81::container::vector<value_t> alloc_or_cont_t;
         typedef zr_boost_1_81::container::flat_multimap<int, int, std::less<int>, alloc_or_cont_t> cont;
         typedef zr_boost_1_81::container::dtl::flat_tree<value_t, key_of_value_t, std::less<int>, alloc_or_cont_t> tree;
         BOOST_STATIC_ASSERT_MSG( zr_boost_1_81::has_trivial_destructor_after_move<cont>::value ==
                                  zr_boost_1_81::has_trivial_destructor_after_move<tree>::value
