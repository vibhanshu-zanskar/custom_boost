...
struct test_elem_base
{
   ...
   friend bool operator<(const test_elem_base& a, const test_elem_base& b)
   {
      return zr_boost_1_81::less_pointees(a._index, b._index);
   }
...
struct regular_elem : test_elem_base
{
   ...
   {
      regular_elem &r = rhs;
      static_cast<test_elem_base&>(*this) = zr_boost_1_81::move(r);
      return *this;
   }
};
...
struct only_movable : test_elem_base
{
   ...
   {
      static_cast<test_elem_base&>(*this) = zr_boost_1_81::move(rhs);
      return *this;
   }
};
