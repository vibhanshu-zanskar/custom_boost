...
{
   int err_count = zr_boost_1_81::report_errors();
   ...
   {
      std::deque<int> std_deque;
      ::zr_boost_1_81::movelib::unique_ptr<SeqContainer> const pseqcontainer = ::zr_boost_1_81::movelib::make_unique<SeqContainer>();
   ...
   return err_count == zr_boost_1_81::report_errors();
}
