...
struct alloc_propagate_base<boost_container_stable_vector>
{
   ...
   struct apply
   {
      typedef zr_boost_1_81::container::stable_vector<T, Allocator> type;
   };
};
...
int main()
{
   recursive_vector_test();
   {
      ...
      stable_vector<recursive_vector> move_ctor(zr_boost_1_81::move(original));
   ...
   ////////////////////////////////////
   if(!zr_boost_1_81::container::test::test_propagate_allocator<boost_container_stable_vector>())
      return 1;
   ...
   if(!zr_boost_1_81::container::test::test_vector_methods_with_initializer_list_as_argument_for
      < zr_boost_1_81::container::stable_vector<int> >())
   {
   ...
   ////////////////////////////////////
   {
      typedef zr_boost_1_81::container::stable_vector<int> cont_int;
   ...
   ////////////////////////////////////
   {
      ...
      auto test = zr_boost_1_81::container::stable_vector(gold.begin(), gold.end());
      if (test.size() != 3) {
         return 1;
      }
   ...
   // default allocator
   {
      typedef zr_boost_1_81::container::stable_vector<int> cont;
   ...
   // std::allocator
   {
      typedef zr_boost_1_81::container::stable_vector<int, std::allocator<int> > cont;
      typedef cont::allocator_type allocator_type;
      typedef zr_boost_1_81::container::allocator_traits<allocator_type>::pointer pointer;
      BOOST_STATIC_ASSERT_MSG(
        !(zr_boost_1_81::has_trivial_destructor_after_move<cont>::value !=
