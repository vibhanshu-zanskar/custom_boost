...
bool node_type_test()
{
   using namespace zr_boost_1_81::container;
   {
      ...
      set_type src;
      {
         ...
         src.emplace(zr_boost_1_81::move(mv_1)); 
         src.emplace(zr_boost_1_81::move(mv_2)); 
         src.emplace(zr_boost_1_81::move(mv_3)); 
      }
      if(src.size() != 3)
         return false;
      ...
      set_type dst;
      {
         ...
         dst.emplace(zr_boost_1_81::move(mv_3)); 
      }
...

   {
      ...
      multiset_type src;
      {
         ...
         src.emplace(zr_boost_1_81::move(mv_2));
         src.emplace(zr_boost_1_81::move(mv_3));
         src.emplace_hint(src.begin(), zr_boost_1_81::move(mv_3bis));
      }
      if(src.size() != 4)
         return false;
...
struct alloc_propagate_base<boost_container_set>
{
   ...
   struct apply
   {
      typedef zr_boost_1_81::container::set<T, std::less<T>, Allocator> type;
   };
};
...
struct alloc_propagate_base<boost_container_multiset>
{
   ...
   struct apply
   {
      typedef zr_boost_1_81::container::multiset<T, std::less<T>, Allocator> type;
   };
};
...
int main ()
{
   ...
   {
      zr_boost_1_81::container::set<std::pair<int,int> > s;
      std::pair<int,int> p(0, 0);
      s.insert(p);
      s.emplace(p);
   }

   if (!zr_boost_1_81::container::test::instantiate_constructors<set<int>, multiset<int> >())
      return 1;
   ...
   if(!zr_boost_1_81::container::test::test_emplace<set<test::EmplaceInt>, SetOptions>())
      return 1;
   if(!zr_boost_1_81::container::test::test_emplace<multiset<test::EmplaceInt>, SetOptions>())
      return 1;

   ////////////////////////////////////
   //    Allocator propagation testing
   ////////////////////////////////////
   if(!zr_boost_1_81::container::test::test_propagate_allocator<boost_container_set>())
      return 1;

   if(!zr_boost_1_81::container::test::test_propagate_allocator<boost_container_multiset>())
      return 1;

   if (!zr_boost_1_81::container::test::test_set_methods_with_initializer_list_as_argument_for<set<int> >())
      return 1;

   if (!zr_boost_1_81::container::test::test_set_methods_with_initializer_list_as_argument_for<multiset<int> >())
      return 1;
   ...
   ////////////////////////////////////
   {
      typedef zr_boost_1_81::container::set<int> cont_int;
   ...
   {
      typedef zr_boost_1_81::container::multiset<int> cont_int;
      cont_int a; a.insert(0); a.insert(1); a.insert(2);
      zr_boost_1_81::intrusive::test::test_iterator_bidirectional< cont_int >(a);
      if(zr_boost_1_81::report_errors() != 0) {
         return 1;
   ...
   {
      typedef zr_boost_1_81::container::set<int> cont;
      typedef zr_boost_1_81::container::dtl::tree<int, void, std::less<int>, void, void> tree;
   ...
   // set, std::allocator
   {
      typedef zr_boost_1_81::container::set<int, std::less<int>, std::allocator<int> > cont;
      typedef zr_boost_1_81::container::dtl::tree<int, void, std::less<int>, std::allocator<int>, void> tree;
      BOOST_STATIC_ASSERT_MSG(
        !(zr_boost_1_81::has_trivial_destructor_after_move<cont>::value !=
          zr_boost_1_81::has_trivial_destructor_after_move<tree>::value)
   ...
   {
      typedef zr_boost_1_81::container::multiset<int> cont;
      typedef zr_boost_1_81::container::dtl::tree<int, void, std::less<int>, void, void> tree;
      BOOST_STATIC_ASSERT_MSG(
        !(zr_boost_1_81::has_trivial_destructor_after_move<cont>::value !=
          zr_boost_1_81::has_trivial_destructor_after_move<tree>::value)
   ...
   {
      typedef zr_boost_1_81::container::multiset<int, std::less<int>, std::allocator<int> > cont;
      typedef zr_boost_1_81::container::dtl::tree<int, void, std::less<int>, std::allocator<int>, void> tree;
      BOOST_STATIC_ASSERT_MSG(
        !(zr_boost_1_81::has_trivial_destructor_after_move<cont>::value !=
          zr_boost_1_81::has_trivial_destructor_after_move<tree>::value)
