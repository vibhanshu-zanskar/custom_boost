...
class memory_resource_logger
   : public zr_boost_1_81::container::pmr::memory_resource
{
   public:
   ...
   zr_boost_1_81::container::vector<allocation_info> m_info;
   ...
   virtual void* do_allocate(std::size_t bytes, std::size_t alignment) BOOST_OVERRIDE
   {
      ...
      if(!addr){
         zr_boost_1_81::container::throw_bad_alloc();
      }
   ...
   virtual bool do_is_equal(const zr_boost_1_81::container::pmr::memory_resource& other) const BOOST_NOEXCEPT BOOST_OVERRIDE
   {
