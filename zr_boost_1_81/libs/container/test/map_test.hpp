...
namespace zr_boost_1_81 { namespace container { namespace test {
...
template<class C>
void map_test_rebalanceable(C &, zr_boost_1_81::container::dtl::false_type)
{}

template<class C>
void map_test_rebalanceable(C &c, zr_boost_1_81::container::dtl::true_type)
{
   c.rebalance();
}
...
template<class MyBoostMap
        ...
        ,class MyStdMultiMap>
int map_test_copyable(zr_boost_1_81::container::dtl::false_type)
{  return 0; }
...
template<class MyBoostMap
        ...
        ,class MyBoostMultiMap
        ,class MyStdMultiMap>
int map_test_copyable(zr_boost_1_81::container::dtl::true_type)
{
   typedef typename MyBoostMap::key_type    IntType;
   typedef dtl::pair<IntType, IntType>         IntPairType;
   typedef typename MyStdMap::value_type  StdPairType;

   ::zr_boost_1_81::movelib::unique_ptr<MyBoostMap> const pboostmap = ::zr_boost_1_81::movelib::make_unique<MyBoostMap>();
   ::zr_boost_1_81::movelib::unique_ptr<MyStdMap> const pstdmap = ::zr_boost_1_81::movelib::make_unique<MyStdMap>();
   ::zr_boost_1_81::movelib::unique_ptr<MyBoostMultiMap> const pboostmultimap = ::zr_boost_1_81::movelib::make_unique<MyBoostMultiMap>();
   ::zr_boost_1_81::movelib::unique_ptr<MyStdMultiMap> const pstdmultimap = ::zr_boost_1_81::movelib::make_unique<MyStdMultiMap>();
   ...
   for(i = 0; i < MaxElem; ++i){
      {
      IntType i1(i), i2(i);
      IntPairType intpair1(zr_boost_1_81::move(i1), zr_boost_1_81::move(i2));
      boostmap.insert(zr_boost_1_81::move(intpair1));
      stdmap.insert(StdPairType(i, i));
      }
      {
      IntType i1(i), i2(i);
      IntPairType intpair2(zr_boost_1_81::move(i1), zr_boost_1_81::move(i2));
      boostmultimap.insert(zr_boost_1_81::move(intpair2));
...
int map_test_range()
{
   ...
   //Test construction from a range
   {
      ...
      for(int i = 0; i < MaxElem; ++i){
         IntType i1(i/2);
         IntType i2(i/2);
         new(&aux_vect[i])IntPairType(zr_boost_1_81::move(i1), zr_boost_1_81::move(i2));
      }
      ...
      for(int i = 0; i < MaxElem; ++i){
         IntType i1(i/2);
         IntType i2(i/2);
         new(&aux_vect3[i])IntPairType(zr_boost_1_81::move(i1), zr_boost_1_81::move(i2));
      }

      ::zr_boost_1_81::movelib::unique_ptr<MyBoostMap> const pboostmap = ::zr_boost_1_81::movelib::make_unique<MyBoostMap>
               ( zr_boost_1_81::make_move_iterator(&aux_vect[0])
               , zr_boost_1_81::make_move_iterator(&aux_vect[0] + MaxElem), typename MyBoostMap::key_compare());
      ::zr_boost_1_81::movelib::unique_ptr<MyStdMap> const pstdmap = ::zr_boost_1_81::movelib::make_unique<MyStdMap>
      ...
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostMultiMap> const pboostmultimap = ::zr_boost_1_81::movelib::make_unique<MyBoostMultiMap>
               ...
               , zr_boost_1_81::make_move_iterator(&aux_vect3[0] + MaxElem), typename MyBoostMap::key_compare());
      ::zr_boost_1_81::movelib::unique_ptr<MyStdMultiMap> const pstdmultimap = ::zr_boost_1_81::movelib::make_unique<MyStdMultiMap>
         (&aux_vect2[0], &aux_vect2[0] + MaxElem, typename MyStdMap::key_compare());
   ...
   }
   {
      ...
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostMap> const pboostmap = ::zr_boost_1_81::movelib::make_unique<MyBoostMap>
               ( zr_boost_1_81::make_move_iterator(&aux_vect[0])
               , zr_boost_1_81::make_move_iterator(&aux_vect[0] + MaxElem), typename MyBoostMap::allocator_type());
      ::zr_boost_1_81::movelib::unique_ptr<MyStdMap> const pstdmap = ::zr_boost_1_81::movelib::make_unique<MyStdMap>
         (&aux_vect2[0], &aux_vect2[0] + MaxElem, typename MyStdMap::key_compare());
      if(!CheckEqualContainers(*pboostmap, *pstdmap)) return 1;
      ...
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostMultiMap> const pboostmultimap = ::zr_boost_1_81::movelib::make_unique<MyBoostMultiMap>
               ( zr_boost_1_81::make_move_iterator(&aux_vect3[0])
               , zr_boost_1_81::make_move_iterator(&aux_vect3[0] + MaxElem), typename MyBoostMap::allocator_type());
      ::zr_boost_1_81::movelib::unique_ptr<MyStdMultiMap> const pstdmultimap = ::zr_boost_1_81::movelib::make_unique<MyStdMultiMap>
         (&aux_vect2[0], &aux_vect2[0] + MaxElem, typename MyStdMap::key_compare());
      if(!CheckEqualContainers(*pboostmultimap, *pstdmultimap)) return 1;
   }
...
int map_test_step(MyBoostMap &, MyStdMap &, MyBoostMultiMap &, MyStdMultiMap &)
{
...

   {
      ...
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostMap> const pboostmap2 = ::zr_boost_1_81::movelib::make_unique<MyBoostMap>
               ( zr_boost_1_81::make_move_iterator(&aux_vect[0])
               , zr_boost_1_81::make_move_iterator(&aux_vect[0] + MaxElem));
      ::zr_boost_1_81::movelib::unique_ptr<MyStdMap> const pstdmap2 = ::zr_boost_1_81::movelib::make_unique<MyStdMap>
         (&aux_vect2[0], &aux_vect2[0] + MaxElem);
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostMultiMap> const pboostmultimap2 = ::zr_boost_1_81::movelib::make_unique<MyBoostMultiMap>
               ( zr_boost_1_81::make_move_iterator(&aux_vect3[0])
               , zr_boost_1_81::make_move_iterator(&aux_vect3[0] + MaxElem));
      ::zr_boost_1_81::movelib::unique_ptr<MyStdMultiMap> const pstdmultimap2 = ::zr_boost_1_81::movelib::make_unique<MyStdMultiMap>
         (&aux_vect2[0], &aux_vect2[0] + MaxElem);
      ...
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostMap> const pboostmap3 = ::zr_boost_1_81::movelib::make_unique<MyBoostMap>
               ( zr_boost_1_81::make_move_iterator(&aux_vect[0])
               , zr_boost_1_81::make_move_iterator(&aux_vect[0] + MaxElem));
      ::zr_boost_1_81::movelib::unique_ptr<MyStdMap> const pstdmap3 = ::zr_boost_1_81::movelib::make_unique<MyStdMap>
               (&aux_vect2[0], &aux_vect2[0] + MaxElem);
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostMultiMap> const pboostmultimap3 = ::zr_boost_1_81::movelib::make_unique<MyBoostMultiMap>
               ( zr_boost_1_81::make_move_iterator(&aux_vect3[0])
               , zr_boost_1_81::make_move_iterator(&aux_vect3[0] + MaxElem));
      ::zr_boost_1_81::movelib::unique_ptr<MyStdMultiMap> const pstdmultimap3 = ::zr_boost_1_81::movelib::make_unique<MyStdMultiMap>
               (&aux_vect2[0], &aux_vect2[0] + MaxElem);
      ...
      }
      {
         IntType i0(0);
         IntType i1(1);
         boostmap2[::zr_boost_1_81::move(i0)] = ::zr_boost_1_81::move(i1);
      }
      {
         IntType i1(1);
         boostmap2[IntType(0)] = ::zr_boost_1_81::move(i1);
      }
      stdmap2[0] = 1;
      if(!CheckEqualContainers(boostmap2, stdmap2)) return 1;
   }
...
int map_test_insert(MyBoostMap &boostmap, MyStdMap &stdmap, MyBoostMultiMap &boostmultimap, MyStdMultiMap &stdmultimap)
{
...

   {
      ...
      for(int i = 0; i < MaxElem; ++i){
         boostmap.insert(zr_boost_1_81::move(aux_vect[i]));
         stdmap.insert(StdPairType(i, i));
         boostmultimap.insert(zr_boost_1_81::move(aux_vect3[i]));
         stdmultimap.insert(StdPairType(i, i));
      }
...
int map_test_erase(MyBoostMap &boostmap, MyStdMap &stdmap, MyBoostMultiMap &boostmultimap, MyStdMultiMap &stdmultimap)
{
   ...
   //Initialize values
   {
      ...
      boostmap.insert(zr_boost_1_81::make_move_iterator(&aux_vect[0]), zr_boost_1_81::make_move_iterator(&aux_vect[0] + MaxElem));
      boostmultimap.insert(zr_boost_1_81::make_move_iterator(&aux_vect3[0]), zr_boost_1_81::make_move_iterator(&aux_vect3[0] + MaxElem));
      for(int i = 0; i != MaxElem; ++i){
   ...
   }
   {
      ...
      for(int i = 0; i < MaxElem; ++i){
         IntType i1(-1);
         IntType i2(-1);
         new(&aux_vect4[i])IntPairType(zr_boost_1_81::move(i1), zr_boost_1_81::move(i2));
      }
      ...
      for(int i = 0; i < MaxElem; ++i){
         IntType i1(-1);
         IntType i2(-1);
         new(&aux_vect5[i])IntPairType(zr_boost_1_81::move(i1), zr_boost_1_81::move(i2));
      }

      boostmap.insert(zr_boost_1_81::make_move_iterator(&aux_vect[0]), zr_boost_1_81::make_move_iterator(&aux_vect[0] + MaxElem));
      boostmap.insert(zr_boost_1_81::make_move_iterator(&aux_vect3[0]), zr_boost_1_81::make_move_iterator(&aux_vect3[0] + MaxElem));
      boostmultimap.insert(zr_boost_1_81::make_move_iterator(&aux_vect4[0]), zr_boost_1_81::make_move_iterator(aux_vect4 + MaxElem));
      boostmultimap.insert(zr_boost_1_81::make_move_iterator(&aux_vect5[0]), zr_boost_1_81::make_move_iterator(aux_vect5 + MaxElem));
...
int map_test_insert2(MyBoostMap &boostmap, MyStdMap &stdmap, MyBoostMultiMap &boostmultimap, MyStdMultiMap &stdmultimap)
{
   ...
   for(int i = 0; i < MaxElem; ++i){
      IntPairType intpair;
      {
         IntType i1(i);
         IntType i2(i);
         new(&intpair)IntPairType(zr_boost_1_81::move(i1), zr_boost_1_81::move(i2));
      }
      boostmap.insert(boostmap.begin(), zr_boost_1_81::move(intpair));
      ...
      boostmultimap.insert(boostmultimap.begin(), zr_boost_1_81::move(intpair));
      ...
      boostmap.insert(boostmap.end(), zr_boost_1_81::move(intpair));
      ...
      boostmultimap.insert(boostmultimap.end(), zr_boost_1_81::move(intpair));
      ...
      IntType k(i);
      boostmap.insert(boostmap.lower_bound(k), zr_boost_1_81::move(intpair));
      ...
      {
         IntType i1(i);
         boostmultimap.insert(boostmultimap.lower_bound(zr_boost_1_81::move(i1)), zr_boost_1_81::move(intpair));
      ...
      {  //Check equal_range
         ...
         if( zr_boost_1_81::container::iterator_udistance(bret.first, bret.second) !=
               zr_boost_1_81::container::iterator_udistance(sret.first, sret.second) ){
            return 1;
         }
      }
      {
         IntType i1(i);
         boostmap.insert(boostmap.upper_bound(zr_boost_1_81::move(i1)), zr_boost_1_81::move(intpair));
      ...
      {
         IntType i1(i);
         boostmultimap.insert(boostmultimap.upper_bound(zr_boost_1_81::move(i1)), zr_boost_1_81::move(intpair));
...
int map_test_search(MyBoostMap &boostmap, MyStdMap &stdmap, MyBoostMultiMap &boostmultimap, MyStdMultiMap &stdmultimap)
{
...

   {
      ...
      for(int i = 0; i < 100; ++i){
         ...
         boostmap.insert(zr_boost_1_81::move(intpair));
         {
            IntType i1(i), i2(i);
            new(&intpair)IntPairType(zr_boost_1_81::move(i1), zr_boost_1_81::move(i2));
         }
         boostmultimap.insert(zr_boost_1_81::move(intpair));
         IntType k(i);
...
int map_test_indexing(MyBoostMap &boostmap, MyStdMap &stdmap, MyBoostMultiMap &boostmultimap, MyStdMultiMap &stdmultimap)
{
   ...
   {  //operator[] test
      ...
      for(int i = 0; i < MaxElem; ++i){
         boostmap[zr_boost_1_81::move(aux_vect[i].first)] = zr_boost_1_81::move(aux_vect[i].second);
         stdmap[i] = i;
      }
...
int map_test_try_emplace(MyBoostMap &boostmap, MyStdMap &stdmap, MyBoostMultiMap &boostmultimap, MyStdMultiMap &stdmultimap)
{
   ...
   {  //try_emplace
      ...
      for(int i = 0; i < MaxElem; ++i){
         IntType i1(i);
         IntType i2(MaxElem-i);
         new(&aux_vect2[i])IntPairType(zr_boost_1_81::move(i1), zr_boost_1_81::move(i2));
      }
      ...
      for(int i = 0; i < MaxElem; ++i){
         ...
         if(i&1){
            std::pair<typename MyBoostMap::iterator, bool> ret =
               boostmap.try_emplace(zr_boost_1_81::move(aux_vect[i].first), zr_boost_1_81::move(aux_vect[i].second));
            if(!ret.second)
               return 1;
            it = ret.first;
         }
            ...
            it = boostmap.try_emplace
               (boostmap.upper_bound(aux_vect[i].first), zr_boost_1_81::move(aux_vect[i].first), zr_boost_1_81::move(aux_vect[i].second));
         }
      ...
      for(int i = 0; i < MaxElem; ++i){
         ...
         if(i&1){
            std::pair<typename MyBoostMap::iterator, bool> ret =
               boostmap.try_emplace(zr_boost_1_81::move(aux_vect2[i].first), zr_boost_1_81::move(aux_vect2[i].second));
            if(ret.second)
               return 1;
            it = ret.first;
         }
            ...
            it = boostmap.try_emplace
               (boostmap.upper_bound(aux_vect2[i].first), zr_boost_1_81::move(aux_vect2[i].first), zr_boost_1_81::move(aux_vect2[i].second));
         }
...
int map_test_merge(MyBoostMap &boostmap, MyStdMap &stdmap, MyBoostMultiMap &boostmultimap, MyStdMultiMap &stdmultimap)
{
   ...
   {  //merge
...

      {
         ...
         boostmap.insert(zr_boost_1_81::make_move_iterator(&aux_vect[0]), zr_boost_1_81::make_move_iterator(&aux_vect[0] + MaxElem));
         boostmap2.insert(zr_boost_1_81::make_move_iterator(&aux_vect2[0]), zr_boost_1_81::make_move_iterator(&aux_vect2[0] + MaxElem));
         boostmultimap2.insert(zr_boost_1_81::make_move_iterator(&aux_vect3[0]), zr_boost_1_81::make_move_iterator(&aux_vect3[0] + MaxElem));
      }
      for(int i = 0; i < MaxElem; ++i){
         stdmap.insert(StdPairType(i, i));
      }
      ...
      boostmap.merge(zr_boost_1_81::move(boostmap2));
      if(!CheckEqualPairContainers(boostmap, stdmap)) return 1;
      ...
      boostmap.merge(zr_boost_1_81::move(boostmultimap2));
      if(!CheckEqualPairContainers(boostmap, stdmap)) return 1;
      ...
      stdmultimap.clear();
      {
         ...
         boostmultimap.insert(zr_boost_1_81::make_move_iterator(&aux_vect[0]), zr_boost_1_81::make_move_iterator(&aux_vect[0] + MaxElem));
         boostmultimap2.insert(zr_boost_1_81::make_move_iterator(&aux_vect2[0]), zr_boost_1_81::make_move_iterator(&aux_vect2[0] + MaxElem));
         boostmap2.insert(zr_boost_1_81::make_move_iterator(&aux_vect3[0]), zr_boost_1_81::make_move_iterator(&aux_vect3[0] + MaxElem));
      }
      for(int i = 0; i < MaxElem; ++i){
         stdmultimap.insert(StdPairType(i, i));
      }
...
int map_test()
{
   ...
   MyBoostMultiMap &boostmultimap = *pboostmultimap;
   MyStdMultiMap   &stdmultimap   = *pstdmultimap;
   typedef dtl::bool_<zr_boost_1_81::container::test::is_copyable<IntType>::value> copyable_t;
