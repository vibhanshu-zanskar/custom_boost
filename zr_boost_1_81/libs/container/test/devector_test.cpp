...
}}}   //namespace zr_boost_1_81::container::test {
...
template <class Devector> void test_constructor_n()
{
   ...
   BOOST_IF_CONSTEXPR (! zr_boost_1_81::move_detail::is_nothrow_default_constructible<T>::value)
   {
...
template <class Devector> void test_constructor_n_copy()
{
   ...
   test_constructor_n_copy_throwing<Devector>
      (dtl::bool_<! zr_boost_1_81::move_detail::is_nothrow_copy_constructible<T>::value>());
...
/* //if move_if_noexcept is implemented
   #ifndef BOOST_NO_EXCEPTIONS
   if (! zr_boost_1_81::move_detail::is_nothrow_copy_constructible<T>::value)
   {
...
{
   typedef typename Devector::value_type T;
   zr_boost_1_81::container::list<T> ncx;
   ncx.emplace_back(1);
   ncx.emplace_back(2);
   ncx.emplace_back(3);
   ncx.emplace_back(4);
   ...
   ncx.emplace_back(7);
   ncx.emplace_back(8);
   const zr_boost_1_81::container::list<T> &x = ncx;
   ...
   #ifndef BOOST_NO_EXCEPTIONS
   BOOST_IF_CONSTEXPR (! zr_boost_1_81::move_detail::is_nothrow_copy_constructible<T>::value)
   {
      test_elem_throw::on_copy_after(4);
...
template <class Devector> void test_constructor_pointer_range()
{
   ...
   zr_boost_1_81::container::vector<T> x; get_range<zr_boost_1_81::container::vector<T> >(8, x);
   const T* xbeg = x.data();
...
template <class Devector> void test_move_constructor()
{
  { // empty
    Devector a;
    Devector b(zr_boost_1_81::move(a));
  ...
  { // big
    ...
    zr_boost_1_81::container::vector<int> expected; get_range<zr_boost_1_81::container::vector<int> >(32, expected);
    test_equal_range(b, expected);
...
template <class Devector> void test_assignment()
{
   const typename Devector::size_type alloc_count =
      zr_boost_1_81::container::allocator_traits
...
template <class Devector> void test_move_assignment()
{
  ...
  { // assign to non-empty
   ...
   test_move_assignment_throwing<Devector>
      (zr_boost_1_81::move_detail::bool_<! zr_boost_1_81::move_detail::is_nothrow_copy_constructible<T>::value>());
}
...
{
  typedef typename Devector::value_type T;
  typedef zr_boost_1_81::container::list<T> List;

  zr_boost_1_81::container::list<T> x;
...
template <class Devector> void test_assign_pointer_range()
{
   ...
   zr_boost_1_81::container::vector<T> x; get_range<zr_boost_1_81::container::vector<T> >(12, x);
   const T* one = x.data();
   const T* six = one + 6;
...
{
   zr_boost_1_81::container::vector<int> expected; get_range<zr_boost_1_81::container::vector<int> >(10, expected);
   {
      Devector actual; get_range<Devector>(10, actual);

      BOOST_TEST(zr_boost_1_81::algorithm::equal(expected.begin(), expected.end(), actual.begin(), actual.end()));
      BOOST_TEST(zr_boost_1_81::algorithm::equal(expected.rbegin(), expected.rend(), actual.rbegin(), actual.rend()));
      BOOST_TEST(zr_boost_1_81::algorithm::equal(expected.cbegin(), expected.cend(), actual.cbegin(), actual.cend()));
      BOOST_TEST(zr_boost_1_81::algorithm::equal(expected.crbegin(), expected.crend(), actual.crbegin(), actual.crend()));
   }

   {
      Devector cactual; get_range<Devector>(10, cactual);

      BOOST_TEST(zr_boost_1_81::algorithm::equal(expected.begin(), expected.end(), cactual.begin(), cactual.end()));
      BOOST_TEST(zr_boost_1_81::algorithm::equal(expected.rbegin(), expected.rend(), cactual.rbegin(), cactual.rend()));
   }
}
...
template <class Devector> void test_resize_front_throwing(dtl::true_)
{
   ...
   zr_boost_1_81::container::vector<int> d_origi; get_range<zr_boost_1_81::container::vector<int> >(5, d_origi);
...
template <class Devector> void test_resize_front()
{
   ...
   if (! zr_boost_1_81::is_nothrow_move_constructible<T>::value && std::is_copy_constructible<T>::value)
   {
   ...
   */
   ...
   test_resize_front_throwing<Devector>
      (dtl::bool_<! zr_boost_1_81::move_detail::is_nothrow_default_constructible<T>::value>());
   ...
   {
      zr_boost_1_81::container::vector<int> expected(128);
      Devector g;
      g.resize_front(128);
...
template <class Devector> void test_resize_front_copy_throwing(dtl::true_)
{
   ...
   {
      Devector c; get_range<Devector>(5, c);
      zr_boost_1_81::container::vector<int> c_origi; get_range<zr_boost_1_81::container::vector<int> >(5, c_origi);
...
template <class Devector> void test_resize_front_copy()
{
   ...
   // size < required, does not fit front small buffer
   {
      zr_boost_1_81::container::vector<int> expected(128, 9);
      Devector g;
...
void test_shrink_to_fit_always()
{
   ...
   zr_boost_1_81::container::vector<unsigned> expected;
...
template <class Devector> void test_emplace_front()
{
...

  {
    ...
    zr_boost_1_81::container::vector<int> expected; get_range<zr_boost_1_81::container::vector<int> >(3, expected);
...
template <class Devector> void test_push_front()
{
   typedef typename Devector::value_type T;
   {
      zr_boost_1_81::container::vector<int> expected; get_range<zr_boost_1_81::container::vector<int> >(16, expected);
...
template <class Devector> void test_push_front_rvalue()
{
...

  {
    ...
    {
      T elem(i);
      a.push_front(zr_boost_1_81::move(elem));
    }

    test_equal_range(a, expected);
  }

  //test_push_front_rvalue_throwing<Devector>(dtl::bool_<! zr_boost_1_81::is_nothrow_move_constructible<T>::value>());
}
...
template <class Devector> void test_push_back()
{
   ...
   //test_push_back_throwing<Devector>(dtl::bool_<! zr_boost_1_81::move_detail::is_nothrow_copy_constructible<T>::value>());
...
template <class Devector> void test_push_back_rvalue()
{
...

  {
    ...
    {
      T elem(i);
      a.push_back(zr_boost_1_81::move(elem));
    }

    test_equal_range(a, expected);
  }

  //test_push_back_rvalue_throwing<Devector>(dtl::bool_<! zr_boost_1_81::is_nothrow_move_constructible<T>::value>());
}
...
template <class Devector> void test_insert_range()
{
   typedef typename Devector::value_type T;
   typedef typename Devector::iterator iterator;
   typedef zr_boost_1_81::container::vector<T> Vector;
...
template <class Devector> void test_swap()
{
   ...
   // big-big does not copy or move
   {
      ...
      zr_boost_1_81::container::vector<int> c; get_range<zr_boost_1_81::container::vector<int> >(32, c);
...
void test_devector()
{
   test_devector_default_constructible<Devector>(dtl::bool_<zr_boost_1_81::is_default_constructible<typename Devector::value_type>::value>());
   test_devector_copy_constructible<Devector>(dtl::bool_<zr_boost_1_81::move_detail::is_copy_constructible<typename Devector::value_type>::value>());
...
void test_all()
{
   ...
   ////////////////////////////////////
   (void)zr_boost_1_81::container::test::test_propagate_allocator<boost_container_devector>();
}


zr_boost_1_81::container::vector<only_movable> getom()
{
   typedef zr_boost_1_81::container::vector<only_movable> V;
   V v;
   return BOOST_MOVE_RET(V, v);
}


zr_boost_1_81::container::vector<zr_boost_1_81::container::test::movable_int> get()
{
   typedef zr_boost_1_81::container::vector<zr_boost_1_81::container::test::movable_int> V;
   V v;
   return BOOST_MOVE_RET(V, v);
}
...
int main()
{
//   zr_boost_1_81::container::devector<zr_boost_1_81::container::test::movable_int>a(get());
   //zr_boost_1_81::container::devector<only_movable> b(getom());
   //zr_boost_1_81::container::devector<only_movable> c(get_range< zr_boost_1_81::container::devector<only_movable> >(1, 5, 5, 9));
   test_all();
   ...
   //       zr_boost_1_81::container::allocator
   ...
   if (!zr_boost_1_81::container::test::test_emplace< devector<test::EmplaceInt>, Options>())
      return 1;
   ////////////////////////////////////
   //    Allocator propagation testing
   ////////////////////////////////////
   if (!zr_boost_1_81::container::test::test_propagate_allocator<boost_container_devector>())
      return 1;

   ////////////////////////////////////
   //    Initializer lists testing
   ////////////////////////////////////
   if (!zr_boost_1_81::container::test::test_vector_methods_with_initializer_list_as_argument_for
      < zr_boost_1_81::container::devector<int> >()) {
      return 1;
   }
   ...
   ////////////////////////////////////
   {
      typedef zr_boost_1_81::container::devector<int> cont_int;
      cont_int a; a.push_back(0); a.push_back(1); a.push_back(2);
      zr_boost_1_81::intrusive::test::test_iterator_random< cont_int >(a);
      if (zr_boost_1_81::report_errors() != 0) {
         return 1;
      }
   }
   ...
   // default allocator
   {
      typedef zr_boost_1_81::container::devector<int> cont;
      typedef cont::allocator_type allocator_type;
      typedef zr_boost_1_81::container::allocator_traits<allocator_type>::pointer pointer;
      BOOST_STATIC_ASSERT_MSG(!(zr_boost_1_81::has_trivial_destructor_after_move<cont>::value !=
         zr_boost_1_81::has_trivial_destructor_after_move<allocator_type>::value &&
         zr_boost_1_81::has_trivial_destructor_after_move<pointer>::value)
         , "has_trivial_destructor_after_move(std::allocator) test failed");
   }
   // std::allocator
   {
      typedef zr_boost_1_81::container::devector<int, std::allocator<int> > cont;
      typedef cont::allocator_type allocator_type;
      typedef zr_boost_1_81::container::allocator_traits<allocator_type>::pointer pointer;
      BOOST_STATIC_ASSERT_MSG(!(zr_boost_1_81::has_trivial_destructor_after_move<cont>::value !=
         zr_boost_1_81::has_trivial_destructor_after_move<allocator_type>::value &&
