...
bool flat_tree_extract_adopt_test()
{
   ...
   //extract/adopt set
   {
      ...
      fset.adopt_sequence(zr_boost_1_81::move(seq));
   ...
   //extract/adopt set, ordered_unique_range
   {
      ...
      fset.adopt_sequence(ordered_unique_range, zr_boost_1_81::move(seq));
      if(!CheckEqualContainers(fset, fset_copy))
         return false;
      if (!CheckEqualContainers(fset.sequence(), fset_copy.sequence()))
         return false;
   ...
   //extract/adopt multiset
   {
      ...
      zr_boost_1_81::container::test::random_shuffle(seq.begin(), seq.end());
      fmset.adopt_sequence(zr_boost_1_81::move(seq));
   ...
   //extract/adopt multiset, ordered_range
   {
      ...
      fmset.adopt_sequence(ordered_range, zr_boost_1_81::move(seq));
      if(!CheckEqualContainers(fmset, fmset_copy))
         return false;
      if (!CheckEqualContainers(fmset.sequence(), fmset_copy.sequence()))
         return false;
...
struct GetSetContainer
{
   ...
   struct apply
   {
      typedef flat_set < ValueType
                       , std::less<ValueType>
                       , typename zr_boost_1_81::container::dtl::container_or_allocator_rebind<VoidAllocatorOrContainer, ValueType>::type
                        > set_type;
...
struct alloc_propagate_base<boost_container_flat_set>
{
   ...
   struct apply
   {
      typedef zr_boost_1_81::container::flat_set<T, std::less<T>, Allocator> type;
   };
};
...
struct alloc_propagate_base<boost_container_flat_multiset>
{
   ...
   struct apply
   {
      typedef zr_boost_1_81::container::flat_multiset<T, std::less<T>, Allocator> type;
   };
};

}}}   //zr_boost_1_81::container::test
...
int main()
{
   ...
   //Now test nth/index_of
   {
      ...
      mset.insert(1);
      mset.insert(2);
      if(!zr_boost_1_81::container::test::test_nth_index_of(set))
         return 1;
      if(!zr_boost_1_81::container::test::test_nth_index_of(mset))
         return 1;
   }
   ...
   if (!zr_boost_1_81::container::test::instantiate_constructors<flat_set<int>, flat_multiset<int> >())
      return 1;
   ...
   if(!zr_boost_1_81::container::test::test_emplace<flat_set<test::EmplaceInt>, SetOptions>())
      return 1;
   if(!zr_boost_1_81::container::test::test_emplace<flat_multiset<test::EmplaceInt>, SetOptions>())
      return 1;

   if (!zr_boost_1_81::container::test::test_set_methods_with_initializer_list_as_argument_for<flat_set<int> >())
      return 1;

   if (!zr_boost_1_81::container::test::test_set_methods_with_initializer_list_as_argument_for<flat_multiset<int> >())
      return 1;

   ////////////////////////////////////
   //    Allocator propagation testing
   ////////////////////////////////////
   if(!zr_boost_1_81::container::test::test_propagate_allocator<boost_container_flat_set>())
      return 1;

   if(!zr_boost_1_81::container::test::test_propagate_allocator<boost_container_flat_multiset>())
      return 1;
   ...
   ////////////////////////////////////
   {
      typedef zr_boost_1_81::container::flat_set<int> cont_int;
   ...
   {
      typedef zr_boost_1_81::container::flat_multiset<int> cont_int;
      cont_int a; a.insert(0); a.insert(1); a.insert(2);
      zr_boost_1_81::intrusive::test::test_iterator_random< cont_int >(a);
      if(zr_boost_1_81::report_errors() != 0) {
         return 1;
   ...
   ////////////////////////////////////
   {
      typedef zr_boost_1_81::container::dtl::identity<int> key_of_value_t;
      // flat_set, default
      {
         typedef zr_boost_1_81::container::flat_set<int> cont;
         typedef zr_boost_1_81::container::dtl::flat_tree<int, key_of_value_t, std::less<int>, void> tree;
      ...
      // flat_set, vector
      {
         typedef zr_boost_1_81::container::vector<int> alloc_or_cont_t;
         typedef zr_boost_1_81::container::flat_set<int, std::less<int>, alloc_or_cont_t> cont;
         typedef zr_boost_1_81::container::dtl::flat_tree<int, key_of_value_t, std::less<int>, alloc_or_cont_t> tree;
         BOOST_STATIC_ASSERT_MSG ( zr_boost_1_81::has_trivial_destructor_after_move<cont>::value ==
                                   zr_boost_1_81::has_trivial_destructor_after_move<tree>::value
      ...
      {
         typedef zr_boost_1_81::container::flat_multiset<int> cont;
         typedef zr_boost_1_81::container::dtl::flat_tree<int, key_of_value_t, std::less<int>, void> tree;
         BOOST_STATIC_ASSERT_MSG ( zr_boost_1_81::has_trivial_destructor_after_move<cont>::value ==
                                   zr_boost_1_81::has_trivial_destructor_after_move<tree>::value
      ...
      {
         typedef zr_boost_1_81::container::vector<int> alloc_or_cont_t;
         typedef zr_boost_1_81::container::flat_multiset<int, std::less<int>, alloc_or_cont_t> cont;
         typedef zr_boost_1_81::container::dtl::flat_tree<int, key_of_value_t, std::less<int>, alloc_or_cont_t> tree;
         BOOST_STATIC_ASSERT_MSG ( zr_boost_1_81::has_trivial_destructor_after_move<cont>::value ==
                                   zr_boost_1_81::has_trivial_destructor_after_move<tree>::value
