...
class alloc_int
{
   ...
   alloc_int(BOOST_RV_REF(alloc_int)other)
      : m_value(other.m_value), m_allocator(zr_boost_1_81::move(other.m_allocator))
   {
      other.m_value = -1;
   }
...
bool one_level_allocator_propagation_test()
{
   ...
   }
   {
      ...
      ContainerWrapper c(::zr_boost_1_81::move(c2), allocator_type(SimpleAllocator<value_type>(5)));
