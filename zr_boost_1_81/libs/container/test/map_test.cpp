...
void test_move()
{
   ...
   C original;
   original.emplace();
   C move_ctor(zr_boost_1_81::move(original));
   C move_assign;
   move_assign.emplace();
   move_assign = zr_boost_1_81::move(move_ctor);
...
bool node_type_test()
{
   using namespace zr_boost_1_81::container;
   {
      ...
      map_type src;
      {
         ...
         src.try_emplace(zr_boost_1_81::move(mv_1), zr_boost_1_81::move(mv_11)); 
         src.try_emplace(zr_boost_1_81::move(mv_2), zr_boost_1_81::move(mv_12)); 
         src.try_emplace(zr_boost_1_81::move(mv_3), zr_boost_1_81::move(mv_13)); 
      }
      if(src.size() != 3)
         return false;
      ...
      map_type dst;
      {
         ...
         dst.try_emplace(zr_boost_1_81::move(mv_3), zr_boost_1_81::move(mv_33)); 
      }
...

   {
      ...
      multimap_type src;
      {
         ...
         src.emplace(zr_boost_1_81::move(mv_1), zr_boost_1_81::move(mv_11));
         src.emplace(zr_boost_1_81::move(mv_2), zr_boost_1_81::move(mv_12));
         src.emplace(zr_boost_1_81::move(mv_3), zr_boost_1_81::move(mv_13));
         src.emplace_hint(src.begin(), zr_boost_1_81::move(mv_3bis), zr_boost_1_81::move(mv_23));
      }
      if(src.size() != 4)
         return false;
      ...
      {
         test::movable_int mv_3(3), mv_33(33);
         dst.emplace(zr_boost_1_81::move(mv_3), zr_boost_1_81::move(mv_33)); 
      }
      ...
      r = dst.insert(dst.begin(), zr_boost_1_81::move(nt));
      if(! (r->first == mv_3 && r->second == mv_23 && dst.find(mv_3) == r && nt.empty()) )
         return false;

      nt = src.extract(src.find(mv_1));
      r = dst.insert(zr_boost_1_81::move(nt)); // Iterator version, successful
      if(! (r->first == mv_1 && nt.empty()) )
         return false;

      nt = src.extract(mv_2);
      r = dst.insert(zr_boost_1_81::move(nt)); // Key type version, successful
...
template<class VoidAllocator, zr_boost_1_81::container::tree_type_enum tree_type_value>
   ...
   struct apply
   {
      typedef map< ValueType
                 ...
                 , typename allocator_traits<VoidAllocator>
                  ...
                  , typename zr_boost_1_81::container::tree_assoc_options
                        < zr_boost_1_81::container::tree_type<tree_type_value>
                        >::type
                 > map_type;
...
struct alloc_propagate_base<boost_container_map>
{
   ...
   struct apply
   {
      typedef typename zr_boost_1_81::container::allocator_traits<Allocator>::
         template portable_rebind_alloc<std::pair<const T, T> >::type TypeAllocator;
      typedef zr_boost_1_81::container::map<T, T, std::less<T>, TypeAllocator> type;
   };
};
...
struct alloc_propagate_base<boost_container_multimap>
{
   ...
   struct apply
   {
      typedef typename zr_boost_1_81::container::allocator_traits<Allocator>::
         template portable_rebind_alloc<std::pair<const T, T> >::type TypeAllocator;
      typedef zr_boost_1_81::container::multimap<T, T, std::less<T>, TypeAllocator> type;
   };
};
...
int main ()
{
   ...
   {
      zr_boost_1_81::container::map<pair_t, pair_t> s;
   ...
   if(!zr_boost_1_81::container::test::test_emplace<map<test::EmplaceInt, test::EmplaceInt>, MapOptions>())
      return 1;
   if(!zr_boost_1_81::container::test::test_emplace<multimap<test::EmplaceInt, test::EmplaceInt>, MapOptions>())
      return 1;

   ////////////////////////////////////
   //    Allocator propagation testing
   ////////////////////////////////////
   if(!zr_boost_1_81::container::test::test_propagate_allocator<boost_container_map>())
      return 1;

   if(!zr_boost_1_81::container::test::test_propagate_allocator<boost_container_multimap>())
      return 1;

   if (!zr_boost_1_81::container::test::test_map_support_for_initialization_list_for<map<int, int> >())
      return 1;

   if (!zr_boost_1_81::container::test::test_map_support_for_initialization_list_for<multimap<int, int> >())
      return 1;
   ...
   ////////////////////////////////////
   {
      typedef zr_boost_1_81::container::map<int, int> cont_int;
      cont_int a; a.insert(cont_int::value_type(0, 9)); a.insert(cont_int::value_type(1, 9)); a.insert(cont_int::value_type(2, 9));
      zr_boost_1_81::intrusive::test::test_iterator_bidirectional< cont_int >(a);
      if(zr_boost_1_81::report_errors() != 0) {
         return 1;
      }
   }
   {
      typedef zr_boost_1_81::container::multimap<int, int> cont_int;
      cont_int a; a.insert(cont_int::value_type(0, 9)); a.insert(cont_int::value_type(1, 9)); a.insert(cont_int::value_type(2, 9));
      zr_boost_1_81::intrusive::test::test_iterator_bidirectional< cont_int >(a);
      if(zr_boost_1_81::report_errors() != 0) {
         return 1;
   ...
   if (!zr_boost_1_81::container::test::instantiate_constructors<map<int, int>, multimap<int, int> >())
      return 1;
   ...
   ////////////////////////////////////
   {
      ...
      // default allocator
      {
         typedef zr_boost_1_81::container::map<int, int> cont;
         typedef zr_boost_1_81::container::dtl::tree<value_type, int, std::less<int>, void, void> tree;
         BOOST_STATIC_ASSERT_MSG(
           !(zr_boost_1_81::has_trivial_destructor_after_move<cont>::value !=
             zr_boost_1_81::has_trivial_destructor_after_move<tree>::value)
            , "has_trivial_destructor_after_move(map, default allocator) test failed");
      }
      // std::allocator
      {
         typedef zr_boost_1_81::container::map<int, int, std::less<int>, std::allocator<value_type> > cont;
         typedef zr_boost_1_81::container::dtl::tree<value_type, int, std::less<int>, std::allocator<value_type>, void> tree;
         BOOST_STATIC_ASSERT_MSG(
            !(zr_boost_1_81::has_trivial_destructor_after_move<cont>::value !=
             zr_boost_1_81::has_trivial_destructor_after_move<tree>::value)
      ...
      {
         //       default allocator
         typedef zr_boost_1_81::container::multimap<int, int> cont;
         typedef zr_boost_1_81::container::dtl::tree<value_type, int, std::less<int>, void, void> tree;
         BOOST_STATIC_ASSERT_MSG(
           !(zr_boost_1_81::has_trivial_destructor_after_move<cont>::value !=
             zr_boost_1_81::has_trivial_destructor_after_move<tree>::value)
      ...
      // std::allocator
      {
         typedef zr_boost_1_81::container::multimap<int, int, std::less<int>, std::allocator<value_type> > cont;
         typedef zr_boost_1_81::container::dtl::tree<value_type, int, std::less<int>, std::allocator<value_type>, void> tree;
         BOOST_STATIC_ASSERT_MSG(
           !(zr_boost_1_81::has_trivial_destructor_after_move<cont>::value !=
             zr_boost_1_81::has_trivial_destructor_after_move<tree>::value)
