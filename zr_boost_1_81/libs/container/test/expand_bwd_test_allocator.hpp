...
class expand_bwd_test_allocator
{
 private:
   ...
   typedef zr_boost_1_81::container::dtl::version_type<expand_bwd_test_allocator, 2>   version;
   ...
   pointer allocation_command(zr_boost_1_81::container::allocation_type command,
                         size_type limit_size,size_type &prefer_in_recvd_out_size,pointer &reuse)
   {
      (void)reuse;   (void)command;
      //This allocator only expands backwards!
      assert(m_allocations == 0 || (command & zr_boost_1_81::container::expand_bwd));
   ...
   //!Throws zr_boost_1_81::container::bad_alloc if there is no enough memory
