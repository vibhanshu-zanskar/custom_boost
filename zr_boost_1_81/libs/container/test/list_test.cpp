...
template class zr_boost_1_81::container::list
...
struct alloc_propagate_base<boost_container_list>
{
   ...
   struct apply
   {
      typedef zr_boost_1_81::container::list<T, Allocator> type;
   };
};
...
int main ()
{
   recursive_list_test();
   {
      ...
      list<recursive_list> move_ctor(zr_boost_1_81::move(original));
   ...
   if(!zr_boost_1_81::container::test::test_emplace<list<test::EmplaceInt>, Options>())
      return 1;

   ////////////////////////////////////
   //    Allocator propagation testing
   ////////////////////////////////////
   if(!zr_boost_1_81::container::test::test_propagate_allocator<boost_container_list>())
      return 1;
   ...
   ////////////////////////////////////
   {
      typedef zr_boost_1_81::container::list<int> cont_int;
   ...
   ////////////////////////////////////
   {
      ...
      auto test = zr_boost_1_81::container::list(gold.begin(), gold.end());
      if (test.size() != 3) {
         return 1;
      }
      if (test.front() != 1)
   ...
   {
      auto gold = std::list{ 1, 2, 3 };
      auto test = zr_boost_1_81::container::list(gold.begin(), gold.end(), new_allocator<int>());
      if (test.size() != 3) {
         return 1;
      }
      if (test.front() != 1)
   ...
   // default allocator
   {
      typedef zr_boost_1_81::container::list<int> cont;
   ...
   // std::allocator
   {
      typedef zr_boost_1_81::container::list<int, std::allocator<int> > cont;
      typedef cont::allocator_type allocator_type;
      typedef zr_boost_1_81::container::allocator_traits<allocator_type>::pointer pointer;
      BOOST_STATIC_ASSERT_MSG(
        !(zr_boost_1_81::has_trivial_destructor_after_move<cont>::value !=
