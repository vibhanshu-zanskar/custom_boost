...
{
   BOOST_TEST(zr_boost_1_81::container::iterator_udistance(first1, last1) == zr_boost_1_81::container::iterator_udistance(first2, last2));
...
void test_insert(SV const& s, C const& c)
{
   ...
   for ( size_t i = 0 ; i <= h ; ++i )
   {
      ...
      zr_boost_1_81::container::iterator_uadvance(it, n);
...
{
   {
      ...
      s1.swap(v1);
      s2 = zr_boost_1_81::move(v2);
      static_vector<T, N> s3(zr_boost_1_81::move(v3));
      s4.swap(v4);
   ...
   }
   {
      ...
      s3 = v2;
      s2 = zr_boost_1_81::move(v2);
      static_vector<T, N/2> s4(zr_boost_1_81::move(v3));
   ...
   }
   {
      ...
      v.resize(N, T(0));
      BOOST_TEST_THROWS(s = zr_boost_1_81::move(v), bad_alloc_t);
      BOOST_TEST_THROWS(s = v, bad_alloc_t);
      v.resize(N, T(0));
      BOOST_TEST_THROWS(small_vector_t s2(zr_boost_1_81::move(v)), bad_alloc_t);
   }
}
...
void test_sv_elem(T const& t)
{
   ...
   v.push_back(V(N/2, t));
   V vvv(N/2, t);
   v.push_back(zr_boost_1_81::move(vvv));
...
int main(int, char* [])
{
   using zr_boost_1_81::container::test::movable_and_copyable_int;
   using zr_boost_1_81::container::test::produce_movable_and_copyable_int;
   ...
   ////////////////////////////////////
   {
      typedef zr_boost_1_81::container::static_vector<int, 3> cont_int;
