...
{
   zr_boost_1_81::container::vector<X> x(5);
   return x.empty();
}
...
struct alloc_propagate_base<boost_container_vector>
{
   ...
   struct apply
   {
      typedef zr_boost_1_81::container::vector<T, Allocator> type;
   };
};
...
{
   zr_boost_1_81::container::vector myVec{1, 2, 3, 4, 5};
...
int main()
{
   ...
   recursive_vector_test();
   {
      ...
      vector<recursive_vector> move_ctor(zr_boost_1_81::move(original));
   ...
   {  //Test enum container
      ...
      Test t = Test();
      v.push_back(t);
      v.push_back(::zr_boost_1_81::move(t));
      v.push_back(Test());
   }
   ...
   if(!zr_boost_1_81::container::test::test_emplace< vector<test::EmplaceInt>, Options>()){
      return 1;
   }
   ...
   ////////////////////////////////////
   if(!zr_boost_1_81::container::test::test_propagate_allocator<boost_container_vector>()){
      return 1;
   }
   ...
   if(!zr_boost_1_81::container::test::test_vector_methods_with_initializer_list_as_argument_for<
       zr_boost_1_81::container::vector<int>
   >()) {
      return 1;
   }
   ...
   ////////////////////////////////////
   {
      typedef zr_boost_1_81::container::vector<int> cont_int;
   ...
   ////////////////////////////////////
   {
      ...
      auto test = zr_boost_1_81::container::vector(gold.begin(), gold.end());
      if (test.size() != 3) {
         return 1;
      }
   ...
   {
      auto gold = std::vector{ 1, 2, 3 };
      auto test = zr_boost_1_81::container::vector(gold.begin(), gold.end(), zr_boost_1_81::container::new_allocator<int>());
      if (test.size() != 3) {
         return 1;
      }
      if (!(test[0] == 1 && test[1] == 2 && test[2] == 3)) {
   ...
   // default allocator
   {
      typedef zr_boost_1_81::container::vector<int> cont;
   ...
   // std::allocator
   {
      typedef zr_boost_1_81::container::vector<int, std::allocator<int> > cont;
      typedef cont::allocator_type allocator_type;
      typedef zr_boost_1_81::container::allocator_traits<allocator_type>::pointer pointer;
      BOOST_STATIC_ASSERT_MSG
         ( !zr_boost_1_81::has_trivial_destructor_after_move<pointer>::value ||
