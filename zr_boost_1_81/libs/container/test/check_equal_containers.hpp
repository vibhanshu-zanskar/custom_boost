...
bool CheckEqual( const T1 &t1, const T2 &t2
               , typename zr_boost_1_81::container::dtl::enable_if_c
                  <!zr_boost_1_81::container::dtl::is_pair<T1>::value &&
                   !zr_boost_1_81::container::dtl::is_pair<T2>::value
                  >::type* = 0)
{  return t1 == t2;  }
...
bool CheckEqual( const Pair1 &pair1, const Pair2 &pair2
               , typename zr_boost_1_81::container::dtl::enable_if_c
                  <zr_boost_1_81::container::dtl::is_pair<Pair1>::value &&
                   zr_boost_1_81::container::dtl::is_pair<Pair2>::value
                  >::type* = 0)
{
...
bool CheckEqualContainers(const ContA &cont_a, const ContB &cont_b)
{
   ...
   typename ContB::size_type dist = zr_boost_1_81::container::iterator_udistance(itcont_a, itcont_a_end);
   if(dist != cont_a.size()){
      return false;
   }
   typename ContA::size_type dist2 = zr_boost_1_81::container::iterator_udistance(itcont_b, itcont_b_end);
...
{
   template<class T>
   typename zr_boost_1_81::move_detail::add_rvalue_reference<T>::type operator()(T &t)
   {
      return zr_boost_1_81::move(t);
   }
};
