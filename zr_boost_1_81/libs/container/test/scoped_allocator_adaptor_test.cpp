...
int main()
{
   ...
   //Default constructor
   {
      ...
      //Swap
      {
         Scoped0Inner s0i2;
         Scoped1Inner s1i2;
         zr_boost_1_81::adl_move_swap(s0i, s0i2);
         zr_boost_1_81::adl_move_swap(s1i, s1i2);
      }
   }
   ...
   //Copy/move constructor/assignment
   {
      ...
      Scoped0Inner s0i_b(::zr_boost_1_81::move(s0i));
      Scoped1Inner s1i_b(::zr_boost_1_81::move(s1i));
      Scoped2Inner s2i_b(::zr_boost_1_81::move(s2i));
      ...
      s0i_b = ::zr_boost_1_81::move(s0i);
      s1i_b = ::zr_boost_1_81::move(s1i);
      s2i_b = ::zr_boost_1_81::move(s2i);
   ...
   //Copy and move operations
   {
      //Construction
      {
         Scoped0Inner s0i_a, s0i_b(s0i_a), s0i_c(::zr_boost_1_81::move(s0i_b));
         Scoped1Inner s1i_a, s1i_b(s1i_a), s1i_c(::zr_boost_1_81::move(s1i_b));
         Scoped2Inner s2i_a, s2i_b(s2i_a), s2i_c(::zr_boost_1_81::move(s2i_b));
      }
      //Assignment
      {
         Scoped0Inner s0i_a, s0i_b;
         s0i_a = s0i_b;
         s0i_a = ::zr_boost_1_81::move(s0i_b);
         Scoped1Inner s1i_a, s1i_b;
         s1i_a = s1i_b;
         s1i_a = ::zr_boost_1_81::move(s1i_b);
         Scoped2Inner s2i_a, s2i_b;
         s2i_a = s2i_b;
         s2i_a = ::zr_boost_1_81::move(s2i_b);
      }
      ...
      //Move from outer
      {
         Scoped0Inner s0i(::zr_boost_1_81::move(oa));
         Scoped1Inner s1i(::zr_boost_1_81::move(oa), ia1);
         Scoped2Inner s2i(::zr_boost_1_81::move(oa), ia1, ia2);
      }
      ...
      {
         Scoped0Inner s0i(::zr_boost_1_81::move(roa));
         Scoped1Inner s1i(::zr_boost_1_81::move(roa), ia1);
         Scoped2Inner s2i(::zr_boost_1_81::move(roa), ia1, ia2);
      }
      ...
      {
         Scoped0Inner s0i(::zr_boost_1_81::move(rs0i));
         Scoped1Inner s1i(::zr_boost_1_81::move(rs1i));
         Scoped2Inner s2i(::zr_boost_1_81::move(rs2i));
      }
   }
   ...
   //construct
   {
      ...
      ////////////////////////////////////////////////////////////
      {
         ...
         //Check construction with 1 user arguments for each pair and Boost tuple
         {
            ...
            MarkTypePair dummy;
            dummy.~MarkTypePair();
            s0i.construct(&dummy, piecewise_construct, zr_boost_1_81::tuple<int>(1), zr_boost_1_81::tuple<int>(1));
            BOOST_TEST(dummy.first.construction_type  == NotUsesAllocator);
            BOOST_TEST(dummy.second.construction_type == NotUsesAllocator);
            BOOST_TEST(dummy.first.value  == 1);
            BOOST_TEST(dummy.second.value == 1);
         ...
         }
         {
            ...
            MarkTypePair dummy;
            dummy.~MarkTypePair();
            s0i.construct(&dummy, piecewise_construct, zr_boost_1_81::tuple<int>(2), zr_boost_1_81::tuple<int>(2));
            BOOST_TEST(dummy.first.construction_type  == ConstructiblePrefix);
            BOOST_TEST(dummy.second.construction_type == ConstructiblePrefix);
            BOOST_TEST(dummy.first.value  == 2);
            BOOST_TEST(dummy.second.value == 2);
         ...
         //Check construction with pair move construction
         {
            ...
            dummy.~MarkTypePair();
            s0i.construct(&dummy, ::zr_boost_1_81::move(dummy2));
            BOOST_TEST(dummy.first.construction_type  == NotUsesAllocator);
            BOOST_TEST(dummy.second.construction_type == NotUsesAllocator);
         ...
         //Check construction with 0/1 arguments for each pair and Boost tuple
         {
            ...
            MarkTypePair dummy;
            dummy.~MarkTypePair();
            s0i.construct(&dummy, piecewise_construct, zr_boost_1_81::tuple<>(), zr_boost_1_81::tuple<int>(1));
            BOOST_TEST(dummy.first.construction_type  == NotUsesAllocator);
            BOOST_TEST(dummy.second.construction_type == NotUsesAllocator);
            BOOST_TEST(dummy.first.value  == 0);
            BOOST_TEST(dummy.second.value == 1);
         ...
         }
         {
            ...
            MarkTypePair dummy;
            dummy.~MarkTypePair();
            s0i.construct(&dummy, piecewise_construct, zr_boost_1_81::tuple<int>(1), zr_boost_1_81::tuple<>());
            BOOST_TEST(dummy.first.construction_type  == ConstructibleSuffix);
            BOOST_TEST(dummy.second.construction_type == ConstructibleSuffix);
            BOOST_TEST(dummy.first.value  == 1);
            BOOST_TEST(dummy.second.value == 0);
         ...
         }
         {
            ...
            MarkTypePair dummy;
            dummy.~MarkTypePair();
            s0i.construct(&dummy, piecewise_construct, zr_boost_1_81::tuple<>(), zr_boost_1_81::tuple<int>(2));
            BOOST_TEST(dummy.first.construction_type  == ConstructiblePrefix);
            BOOST_TEST(dummy.second.construction_type == ConstructiblePrefix);
            BOOST_TEST(dummy.first.value  == 0);
            BOOST_TEST(dummy.second.value == 2);
