...
bool deque_copyable_only(V1 &cntdeque, V2 &stddeque, dtl::true_type)
{
   ...
   if(!test::CheckEqualContainers(cntdeque, stddeque)) return false;
   {
      ...
      cntdeque.insert(cntdeque.begin()+std::ptrdiff_t(size/2), 50u, zr_boost_1_81::move(move_me));
      if(!test::CheckEqualContainers(cntdeque, stddeque)) return false;
   }
   {
      IntType move_me(2);
      cntdeque.assign(cntdeque.size()/2, zr_boost_1_81::move(move_me));
   ...
   }
   {
      ...
      cntdeque.insert(cntdeque.begin(), 50u, zr_boost_1_81::move(move_me));
      if(!test::CheckEqualContainers(cntdeque, stddeque)) return false;
      stddeque.insert(stddeque.begin()+20, 50u, 1);
      cntdeque.insert(cntdeque.begin()+20, 50u, zr_boost_1_81::move(move_me));
      if(!test::CheckEqualContainers(cntdeque, stddeque)) return false;
      stddeque.insert(stddeque.begin()+20, 20u, 1);
      cntdeque.insert(cntdeque.begin()+20, 20u, zr_boost_1_81::move(move_me));
      if(!test::CheckEqualContainers(cntdeque, stddeque)) return false;
   }
   {
      IntType move_me(1);
      ...
      cntdeque.clear();
      stddeque.insert(stddeque.end(), 50u, 1);
      cntdeque.insert(cntdeque.end(), 50u, zr_boost_1_81::move(move_me));
      if(!test::CheckEqualContainers(cntdeque, stddeque)) return false;
      stddeque.insert(stddeque.end()-20, 50u, 1);
      cntdeque.insert(cntdeque.end()-20, 50u, zr_boost_1_81::move(move_me));
      if(!test::CheckEqualContainers(cntdeque, stddeque)) return false;
      stddeque.insert(stddeque.end()-20, 20u, 1);
      cntdeque.insert(cntdeque.end()-20, 20u, zr_boost_1_81::move(move_me));
      if(!test::CheckEqualContainers(cntdeque, stddeque)) return false;
   }
...
bool do_test()
{
...

   {
      ...
      deque<recursive_deque> move_ctor(zr_boost_1_81::move(original));
   ...
   const int max = 100;
   {
      ::zr_boost_1_81::movelib::unique_ptr<MyCntDeque> const pcntdeque = ::zr_boost_1_81::movelib::make_unique<MyCntDeque>();
      ::zr_boost_1_81::movelib::unique_ptr<MyStdDeque> const pstddeque = ::zr_boost_1_81::movelib::make_unique<MyStdDeque>();
      MyCntDeque &cntdeque = *pcntdeque;
      MyStdDeque &stddeque = *pstddeque;
      for(int i = 0; i < max*100; ++i){
         IntType move_me(i);
         cntdeque.insert(cntdeque.end(), zr_boost_1_81::move(move_me));
      ...
      for(int i = 0; i < max*100; ++i){
         IntType move_me(i);
         cntdeque.push_back(zr_boost_1_81::move(move_me));
      ...
      for(int i = 0; i < max*100; ++i){
         IntType move_me(i);
         cntdeque.push_front(zr_boost_1_81::move(move_me));
      ...
      for(int i = 0; i < max; ++i){
         IntType move_me(i);
         cntdeque.insert(cntdeque.begin(), zr_boost_1_81::move(move_me));
...
struct alloc_propagate_base<boost_container_deque>
{
   ...
   struct apply
   {
      typedef zr_boost_1_81::container::deque<T, Allocator> type;
   };
};
...
int main ()
{
   ...
   if(!zr_boost_1_81::container::test::test_emplace
      < deque<test::EmplaceInt>, Options>())
      return 1;
   ////////////////////////////////////
   //    Allocator propagation testing
   ////////////////////////////////////
   if(!zr_boost_1_81::container::test::test_propagate_allocator<boost_container_deque>())
      return 1;
   ...
   if(!zr_boost_1_81::container::test::test_vector_methods_with_initializer_list_as_argument_for
      < zr_boost_1_81::container::deque<int> >()) {
      return 1;
   }
   ...
   ////////////////////////////////////
   {
      typedef zr_boost_1_81::container::deque<int> cont_int;
   ...
   // default allocator
   {
      typedef zr_boost_1_81::container::deque<int> cont;
   ...
   // std::allocator
   {
      typedef zr_boost_1_81::container::deque<int, std::allocator<int> > cont;
      typedef cont::allocator_type allocator_type;
      typedef zr_boost_1_81::container::allocator_traits<allocator_type>::pointer pointer;
      BOOST_STATIC_ASSERT_MSG(!(zr_boost_1_81::has_trivial_destructor_after_move<cont>::value !=
                               zr_boost_1_81::has_trivial_destructor_after_move<allocator_type>::value &&
