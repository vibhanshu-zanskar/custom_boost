...
bool vector_capacity_test(V1&, V2&, zr_boost_1_81::container::dtl::false_type)
{
...
bool vector_capacity_test(MyBoostVector&boostvector, MyStdVector&stdvector, zr_boost_1_81::container::dtl::true_type)
{
   {
...
template<class V1, class V2>
bool vector_copyable_only(V1&, V2&, zr_boost_1_81::container::dtl::false_type)
{
   return true;
}
...
template<class MyBoostVector, class MyStdVector>
bool vector_copyable_only(MyBoostVector &boostvector, MyStdVector &stdvector, zr_boost_1_81::container::dtl::true_type)
{
   ...
   {
      IntType move_me(1);
      boostvector.insert(boostvector.begin()+difference_type(size/2), 50u, zr_boost_1_81::move(move_me));
      stdvector.insert(stdvector.begin()+difference_type(size/2), 50u, 1);
      if(!test::CheckEqualContainers(boostvector, stdvector)) return false;
   }
   {
      IntType move_me(2);
      boostvector.assign(boostvector.size()/2, zr_boost_1_81::move(move_me));
      stdvector.assign(stdvector.size()/2, 2);
      if(!test::CheckEqualContainers(boostvector, stdvector)) return false;
   }
   {
      IntType move_me(3);
      boostvector.assign(boostvector.size()*3-1, zr_boost_1_81::move(move_me));
   ...
   {  //Vector(const Vector &)
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostVector> const pv1 =
         ::zr_boost_1_81::movelib::make_unique<MyBoostVector>(boostvector);
      ::zr_boost_1_81::movelib::unique_ptr<MyStdVector> const pv2 =
         ::zr_boost_1_81::movelib::make_unique<MyStdVector>(stdvector);
   ...
   {  //Vector(const Vector &, alloc)
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostVector> const pv1 =
         ::zr_boost_1_81::movelib::make_unique<MyBoostVector>(boostvector, typename MyBoostVector::allocator_type());
      ::zr_boost_1_81::movelib::unique_ptr<MyStdVector> const pv2 =
         ::zr_boost_1_81::movelib::make_unique<MyStdVector>(stdvector);
   ...
   {  //Vector(n, T)
      ::zr_boost_1_81::movelib::unique_ptr<MyStdVector> const stdvectorp =
         ::zr_boost_1_81::movelib::make_unique<MyStdVector>(100u, int(5));
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostVector> const boostvectorp =
         ::zr_boost_1_81::movelib::make_unique<MyBoostVector>(100u, IntType(5));
   ...
   {  //Vector(n, T, alloc)
      ::zr_boost_1_81::movelib::unique_ptr<MyStdVector> const stdvectorp =
         ::zr_boost_1_81::movelib::make_unique<MyStdVector>(100u, int(5));
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostVector> const boostvectorp =
         ::zr_boost_1_81::movelib::make_unique<MyBoostVector>(100u, IntType(5), typename MyBoostVector::allocator_type());
      if(!test::CheckEqualContainers(*boostvectorp, *stdvectorp)) return false;
   }
   {  //Vector(It, It)
      ::zr_boost_1_81::movelib::unique_ptr<MyStdVector> const stdvectorp =
         ::zr_boost_1_81::movelib::make_unique<MyStdVector>(100u);
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostVector> const boostvectorp =
         ::zr_boost_1_81::movelib::make_unique<MyBoostVector>(100u);
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostVector> const boostvectorp2 =
         ::zr_boost_1_81::movelib::make_unique<MyBoostVector>(boostvectorp->begin(), boostvectorp->end());
   ...
   {  //Vector(It, It, alloc)
      ...
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostVector> const boostvectorp =
         ::zr_boost_1_81::movelib::make_unique<MyBoostVector>(100u);
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostVector> const boostvectorp2 =
         ::zr_boost_1_81::movelib::make_unique<MyBoostVector>(boostvectorp->begin(), boostvectorp->end(), typename MyBoostVector::allocator_type());
      if(!test::CheckEqualContainers(*boostvectorp2, *stdvectorp)) return false;
   }
   {  //resize(n, T)
      ::zr_boost_1_81::movelib::unique_ptr<MyStdVector> const stdvectorp =
         ::zr_boost_1_81::movelib::make_unique<MyStdVector>();
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostVector> const boostvectorp =
         ::zr_boost_1_81::movelib::make_unique<MyBoostVector>();
...
int vector_test()
{
   ...
   {  //Vector(n, alloc)
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostVector> const boostvectorp =
         ::zr_boost_1_81::movelib::make_unique<MyBoostVector>(100u, typename MyBoostVector::allocator_type());
      ::zr_boost_1_81::movelib::unique_ptr<MyStdVector> const stdvectorp =
         ::zr_boost_1_81::movelib::make_unique<MyStdVector>(100u);
      if(!test::CheckEqualContainers(*boostvectorp, *stdvectorp)) return 1;
   }
   {  //Vector(Vector &&)
      ...
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostVector> const boostvectorp =
         ::zr_boost_1_81::movelib::make_unique<MyBoostVector>(100u);
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostVector> const boostvectorp2 =
         ::zr_boost_1_81::movelib::make_unique<MyBoostVector>(::zr_boost_1_81::move(*boostvectorp));
   ...
   {  //Vector(Vector &&, alloc)
      ...
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostVector> const boostvectorp2 =
         ::zr_boost_1_81::movelib::make_unique<MyBoostVector>
            (::zr_boost_1_81::move(*boostvectorp), typename MyBoostVector::allocator_type());
      if(!test::CheckEqualContainers(*boostvectorp2, *stdvectorp)) return 1;
   }
   {  //Vector operator=(Vector &&)
      ...
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostVector> const boostvectorp2 =
         ::zr_boost_1_81::movelib::make_unique<MyBoostVector>();
      *boostvectorp2 = ::zr_boost_1_81::move(*boostvectorp);
      if(!test::CheckEqualContainers(*boostvectorp2, *stdvectorp)) return 1;
   }
   {
      ::zr_boost_1_81::movelib::unique_ptr<MyBoostVector> const boostvectorp = ::zr_boost_1_81::movelib::make_unique<MyBoostVector>();
      ::zr_boost_1_81::movelib::unique_ptr<MyStdVector> const stdvectorp = ::zr_boost_1_81::movelib::make_unique<MyStdVector>();
      ...
      for(int i = 0; i < max; ++i){
         IntType new_int(i);
         boostvector.insert(boostvector.end(), zr_boost_1_81::move(new_int));
...

      {
         ...
         for(int i = 0; i < 50; ++i){
            IntType new_int(-1);
            BOOST_STATIC_ASSERT((zr_boost_1_81::container::test::is_copyable<zr_boost_1_81::container::test::movable_int>::value == false));
            aux_vect[i] = zr_boost_1_81::move(new_int);
         }
         int aux_vect2[50];
         for(int i = 0; i < 50; ++i){
            aux_vect2[i] = -1;
         ...
         if(zr_boost_1_81::container::iterator_udistance(insert_it, boostvector.end()) != 50) return 1;
      ...
      }
      {
         ...
         insert_it = boostvector.insert(boostvector.begin() + difference_type(old_size/2)
                           ,zr_boost_1_81::make_move_iterator(make_input_from_forward_iterator(&aux_vect[0]))
                           ,zr_boost_1_81::make_move_iterator(make_input_from_forward_iterator(aux_vect + 50))
                        );
         if(boostvector.begin() + difference_type(old_size/2) != insert_it) return 1;
         stdvector.insert(stdvector.begin() + difference_type(old_size/2), aux_vect2, aux_vect2 + 50);
         if(!test::CheckEqualContainers(boostvector, stdvector)) return 1;
      ...
      boostvector.push_back(zr_boost_1_81::move(push_back_this));
      ...
      for(int i = 0; i < max; ++i){
         ...
         boostvector.insert(boostvector.begin(), zr_boost_1_81::move(insert_this));
