...
{
   return &zr_boost_1_81::container::dtl::singleton_default<new_delete_resource_imp>::instance();
}

BOOST_CONTAINER_DECL memory_resource* null_memory_resource() BOOST_NOEXCEPT
{
   return &zr_boost_1_81::container::dtl::singleton_default<null_memory_resource_imp>::instance();
}

#if defined(BOOST_NO_CXX11_HDR_ATOMIC)

static memory_resource *default_memory_resource =
   &zr_boost_1_81::container::dtl::singleton_default<new_delete_resource_imp>::instance();
...
static std::atomic<memory_resource*> default_memory_resource = 
   ATOMIC_VAR_INIT(&zr_boost_1_81::container::dtl::singleton_default<new_delete_resource_imp>::instance());
