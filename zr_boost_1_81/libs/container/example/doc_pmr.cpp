...
class ShoppingList
{
   ...
   zr_boost_1_81::container::pmr::vector_of
      <zr_boost_1_81::container::pmr::string>::type m_strvec;
   //Alternatively in compilers that support template aliases:
   //    zr_boost_1_81::container::pmr::vector<zr_boost_1_81::container::pmr::string> m_strvec;
   public:

   // This makes uses_allocator<ShoppingList, memory_resource*>::value true
   typedef zr_boost_1_81::container::pmr::memory_resource* allocator_type;
...
int main()
{
   ...
   //Alternatively in compilers that support template aliases:
   //    zr_boost_1_81::container::pmr::list<ShoppingList> folder;
   {
      char buffer[1024];
