...
namespace pyconv = zr_boost_1_81::python::converter;
...
void dtype::register_scalar_converters()
{
  ...
  // explicitely.
  array_scalar_converter<zr_boost_1_81::uint32_t>::declare();
  array_scalar_converter<zr_boost_1_81::int32_t>::declare();
#endif
