...
stl_input_iterator_impl::stl_input_iterator_impl(zr_boost_1_81::python::object const &ob)
...
{
    this->ob_ = zr_boost_1_81::python::handle<>(
        zr_boost_1_81::python::allow_null(PyIter_Next(this->it_.ptr())));
    if (PyErr_Occurred())
...
zr_boost_1_81::python::handle<> const &stl_input_iterator_impl::current() const
{
    return this->ob_;
}
