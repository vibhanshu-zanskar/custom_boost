...
# endif 
  ...
  //
  using zr_boost_1_81::python::objects::dynamic_id_function;
  ...
  inline type_index_t::iterator type_position(class_id type)
  {
      ...
      return std::lower_bound(
          ...
          , zr_boost_1_81::make_tuple(type, vertex_t(), dynamic_id_function(0))
          , zr_boost_1_81::bind<bool>(std::less<class_id>()
               , zr_boost_1_81::bind<class_id>(select1st<entry>(), _1)
               , zr_boost_1_81::bind<class_id>(select1st<entry>(), _2)));
  }
  ...
  inline type_index_t::iterator demand_type(class_id type)
  {
      ...
      unused_variable(v2);
      assert(v == v2);
      return type_index().insert(p, zr_boost_1_81::make_tuple(type, v, dynamic_id_function(0)));
  }
  ...
  inline void* convert_type(void* const p, class_id src_t, class_id dst_t, bool polymorphic)
  {
      ...
      // info
      zr_boost_1_81::python::objects::dynamic_id_t dynamic_id = polymorphic
      ...
      cache_element seek(zr_boost_1_81::make_tuple(src_t, dst_t, offset, dynamic_id.second));
      cache_t& c = cache();
