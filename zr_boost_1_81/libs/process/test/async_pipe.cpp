...
BOOST_AUTO_TEST_CASE(plain_async, *zr_boost_1_81::unit_test::timeout(5))
{
    asio::io_context ios;
    ...
    asio::async_write(pipe, asio::buffer(st), [](const zr_boost_1_81::system::error_code &, std::size_t){});
...
BOOST_AUTO_TEST_CASE(move_pipe)
{
    ...
    BOOST_CHECK_EQUAL(ap.native_source(), ::zr_boost_1_81::winapi::INVALID_HANDLE_VALUE_);
    BOOST_CHECK_EQUAL(ap.native_sink  (), ::zr_boost_1_81::winapi::INVALID_HANDLE_VALUE_);
