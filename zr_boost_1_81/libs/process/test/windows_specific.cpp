...
struct set_startup_info
{
    ...
    {
        cnt++;
        BOOST_CHECK_EQUAL(e.startup_info.cb, sizeof(::zr_boost_1_81::winapi::STARTUPINFOA_));
...
struct check_startup_info
{
    ...
    {
        cnt++;
        BOOST_CHECK(e.creation_flags &  ::zr_boost_1_81::winapi::EXTENDED_STARTUPINFO_PRESENT_);
        BOOST_CHECK_EQUAL(e.startup_info.cb, sizeof(::zr_boost_1_81::winapi::STARTUPINFOEXA_));
    }
