...
BOOST_AUTO_TEST_CASE(group_test, *zr_boost_1_81::unit_test::timeout(5))
{
...
BOOST_AUTO_TEST_CASE(attached, *zr_boost_1_81::unit_test::timeout(5))
{
...
#endif
    BOOST_CHECK_MESSAGE(!still_runs, zr_boost_1_81::process::detail::get_last_error().message());
...
BOOST_AUTO_TEST_CASE(detached, *zr_boost_1_81::unit_test::timeout(5))
{
