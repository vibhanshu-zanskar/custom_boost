...
BOOST_AUTO_TEST_CASE(empty,  *zr_boost_1_81::unit_test::timeout(5))
{
    bp::environment ev ;
...
BOOST_AUTO_TEST_CASE(wempty,  *zr_boost_1_81::unit_test::timeout(5))
{
    bp::wenvironment ev ;
    BOOST_CHECK(ev.empty());
    BOOST_CHECK_EQUAL(ev.size(), 0u);
...
BOOST_AUTO_TEST_CASE(compare,  *zr_boost_1_81::unit_test::timeout(5))
{
    auto nat = zr_boost_1_81::this_process::environment();
    ...
    auto wnat = zr_boost_1_81::this_process::wenvironment();
...
BOOST_AUTO_TEST_CASE(wcompare,  *zr_boost_1_81::unit_test::timeout(5))
{
    auto nat = zr_boost_1_81::this_process::wenvironment();
...
BOOST_AUTO_TEST_CASE(insert_remove,  *zr_boost_1_81::unit_test::timeout(5))
{
    bp::environment env(zr_boost_1_81::this_process::environment());
...
BOOST_AUTO_TEST_CASE(clear_empty_my,  *zr_boost_1_81::unit_test::timeout(5))
{
...
BOOST_AUTO_TEST_CASE(clear_empty,  *zr_boost_1_81::unit_test::timeout(5))
{
    bp::environment env;
