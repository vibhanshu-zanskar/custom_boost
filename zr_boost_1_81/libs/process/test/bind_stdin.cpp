...
BOOST_AUTO_TEST_CASE(sync_io, *zr_boost_1_81::unit_test::timeout(10))
{
...
BOOST_AUTO_TEST_CASE(async_io, *zr_boost_1_81::unit_test::timeout(2))
{
  ...
  //  std::string s = "hello\n";
    zr_boost_1_81::asio::async_write(p1, sb,
        write_handler(is));
...
BOOST_AUTO_TEST_CASE(file_io, *zr_boost_1_81::unit_test::timeout(2))
{
    ...
    {
        zr_boost_1_81::process::filesystem::ofstream fs(pth);
        fs << 321 << std::endl;
        fs << 1.2345 << std::endl;
...
BOOST_AUTO_TEST_CASE(file_io_C, *zr_boost_1_81::unit_test::timeout(2))
{
