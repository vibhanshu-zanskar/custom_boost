...
BOOST_AUTO_TEST_CASE(stackful, *zr_boost_1_81::unit_test::timeout(15))
{
    ...
    zr_boost_1_81::asio::spawn(ios, stackful);
    zr_boost_1_81::asio::post(ios.get_executor(), [&]{did_something_else = true;});

    ios.run();
    BOOST_CHECK(did_something_else);
}

BOOST_AUTO_TEST_CASE(stackful_except, *zr_boost_1_81::unit_test::timeout(15))
{
    using zr_boost_1_81::unit_test::framework::master_test_suite;
    ...
    auto stackful =
            [&](zr_boost_1_81::asio::yield_context yield_)
            {
                ...
                BOOST_CHECK_THROW(
                    bp::async_system(
                        ios, yield_,
                        "none-existing-exe"), zr_boost_1_81::system::system_error);
...
BOOST_AUTO_TEST_CASE(stackful_error, *zr_boost_1_81::unit_test::timeout(15))
{
    using zr_boost_1_81::unit_test::framework::master_test_suite;
