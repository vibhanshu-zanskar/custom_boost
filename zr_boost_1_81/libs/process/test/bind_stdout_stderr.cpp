...
BOOST_AUTO_TEST_CASE(async_io, *zr_boost_1_81::unit_test::timeout(2))
{
    ...
    zr_boost_1_81::asio::streambuf buffer1;
    zr_boost_1_81::asio::async_read_until(p1, buffer1, '\n',
        read_handler(buffer1));

    zr_boost_1_81::asio::streambuf buffer2;
    zr_boost_1_81::asio::async_read_until(p2, buffer2, '\n',
