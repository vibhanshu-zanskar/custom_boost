...
BOOST_AUTO_TEST_CASE(async_wait, *zr_boost_1_81::unit_test::timeout(5))
{
    ...
    zr_boost_1_81::asio::deadline_timer timeout{io_context, zr_boost_1_81::posix_time::seconds(2)};
    timeout.async_wait([&](zr_boost_1_81::system::error_code ec){if (!ec) io_context.stop();});
...
BOOST_AUTO_TEST_CASE(async_wait_sync_wait, *zr_boost_1_81::unit_test::timeout(5))
{
    using zr_boost_1_81::unit_test::framework::master_test_suite;
    using namespace zr_boost_1_81::asio;
    ...
    zr_boost_1_81::asio::deadline_timer timeout{io_context, zr_boost_1_81::posix_time::seconds(3)};
    timeout.async_wait([&](zr_boost_1_81::system::error_code ec){if (!ec) io_context.stop();});
...
BOOST_AUTO_TEST_CASE(async_wait_different_contexts, *zr_boost_1_81::unit_test::timeout(10))
{
    using zr_boost_1_81::unit_test::framework::master_test_suite;
    using namespace zr_boost_1_81::asio;
    ...
    zr_boost_1_81::asio::deadline_timer timeout1{io_context1, zr_boost_1_81::posix_time::seconds(2)};
    timeout1.async_wait([&](zr_boost_1_81::system::error_code ec){if (!ec) io_context1.stop();});

    zr_boost_1_81::asio::deadline_timer timeout2{io_context2, zr_boost_1_81::posix_time::seconds(7)};
    timeout2.async_wait([&](zr_boost_1_81::system::error_code ec){if (!ec) io_context2.stop();});
    std::error_code ec;
...
BOOST_AUTO_TEST_CASE(async_wait_abort, *zr_boost_1_81::unit_test::timeout(5))
{
    using zr_boost_1_81::unit_test::framework::master_test_suite;
    using namespace zr_boost_1_81::asio;
    ...
    zr_boost_1_81::asio::deadline_timer timeout{io_context, zr_boost_1_81::posix_time::seconds(5)};
    timeout.async_wait([&](zr_boost_1_81::system::error_code ec){if (!ec) io_context.stop();});
...
BOOST_AUTO_TEST_CASE(async_future, *zr_boost_1_81::unit_test::timeout(3))
{
    using zr_boost_1_81::unit_test::framework::master_test_suite;
    using namespace zr_boost_1_81::asio;
...
BOOST_AUTO_TEST_CASE(async_out_stream, *zr_boost_1_81::unit_test::timeout(5))
{
    using zr_boost_1_81::unit_test::framework::master_test_suite;
    ...
    zr_boost_1_81::asio::streambuf buf;
...
BOOST_AUTO_TEST_CASE(async_in_stream, *zr_boost_1_81::unit_test::timeout(5))
{
    ...
    zr_boost_1_81::asio::streambuf buf;
    zr_boost_1_81::asio::streambuf in_buf;
    ...
    if (line >= val)
        BOOST_CHECK(zr_boost_1_81::algorithm::starts_with(line, val));
...
BOOST_AUTO_TEST_CASE(async_error, *zr_boost_1_81::unit_test::timeout(3))
{
    using zr_boost_1_81::unit_test::framework::master_test_suite;
    using namespace zr_boost_1_81::asio;
...
/*
BOOST_AUTO_TEST_CASE(mixed_async, *zr_boost_1_81::unit_test::timeout(5))
{
    using zr_boost_1_81::unit_test::framework::master_test_suite;
    using namespace zr_boost_1_81::asio;
