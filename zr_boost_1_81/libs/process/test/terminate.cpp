...
BOOST_AUTO_TEST_CASE(terminate_set_on_error, *zr_boost_1_81::unit_test::timeout(5))
{
...
BOOST_AUTO_TEST_CASE(terminate_throw_on_error, *zr_boost_1_81::unit_test::timeout(5))
{
    std::atomic<bool> done{false};
    std::thread thr{
            [&]
