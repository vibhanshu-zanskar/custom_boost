...
BOOST_AUTO_TEST_CASE(plain, *zr_boost_1_81::unit_test::timeout(2))
{
    bp::pipe pipe;
...
BOOST_AUTO_TEST_CASE(named, *zr_boost_1_81::unit_test::timeout(2))
{
...
BOOST_AUTO_TEST_CASE(copy_pipe, *zr_boost_1_81::unit_test::timeout(2))
{
    bp::pipe pipe;
...
BOOST_AUTO_TEST_CASE(move_pipe, *zr_boost_1_81::unit_test::timeout(2))
{
    bp::pipe pipe;
...
BOOST_AUTO_TEST_CASE(stream, *zr_boost_1_81::unit_test::timeout(2))
{
...
BOOST_AUTO_TEST_CASE(stream_move, *zr_boost_1_81::unit_test::timeout(2))
{
...
BOOST_AUTO_TEST_CASE(ostream_move, *zr_boost_1_81::unit_test::timeout(2))
{
...
BOOST_AUTO_TEST_CASE(stream_move_assignment, *zr_boost_1_81::unit_test::timeout(2))
{
...
BOOST_AUTO_TEST_CASE(ostream_move_assignment, *zr_boost_1_81::unit_test::timeout(2))
{
...
BOOST_AUTO_TEST_CASE(stream_line, *zr_boost_1_81::unit_test::timeout(2))
{
...
BOOST_AUTO_TEST_CASE(large_data, *zr_boost_1_81::unit_test::timeout(20))
{
    bp::pipe pipe;
...
BOOST_AUTO_TEST_CASE(closed, *zr_boost_1_81::unit_test::timeout(2))
{
    bp::opstream os;
    bp::ipstream is;
...
BOOST_AUTO_TEST_CASE(coverage, *zr_boost_1_81::unit_test::timeout(5))
{
...
BOOST_AUTO_TEST_CASE(stream_close, *zr_boost_1_81::unit_test::timeout(5))
{
    bp::pipe p;
    int i = 1234, j = 0;
    bp::opstream op{p};
...
BOOST_AUTO_TEST_CASE(stream_close_scope, *zr_boost_1_81::unit_test::timeout(5))
{
    bp::pipe p;
    int i = 1234, j = 0;
    bp::ipstream ip;
