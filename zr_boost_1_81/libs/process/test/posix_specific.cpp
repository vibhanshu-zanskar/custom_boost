...
BOOST_AUTO_TEST_CASE(bind_fd, *zr_boost_1_81::unit_test::timeout(2))
{
...
BOOST_AUTO_TEST_CASE(bind_fds, *zr_boost_1_81::unit_test::timeout(2))
{
    using zr_boost_1_81::unit_test::framework::master_test_suite;
...
BOOST_AUTO_TEST_CASE(execve_set_on_error, *zr_boost_1_81::unit_test::timeout(2))
{
    std::error_code ec;
    bp::spawn(
        "doesnt-exist",
...
BOOST_AUTO_TEST_CASE(execve_throw_on_error, *zr_boost_1_81::unit_test::timeout(2))
{
    try
    {
...
BOOST_AUTO_TEST_CASE(leak_test, *zr_boost_1_81::unit_test::timeout(5))
{
    ...
    const auto pid = zr_boost_1_81::this_process::get_id();
