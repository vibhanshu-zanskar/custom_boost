...
namespace bt = zr_boost_1_81::this_process;

BOOST_AUTO_TEST_CASE(leak_test, *zr_boost_1_81::unit_test::timeout(5))
{
    ...
    const auto socket_to_handle = [](::zr_boost_1_81::winapi::UINT_PTR_ sock){return reinterpret_cast<::zr_boost_1_81::winapi::HANDLE_>(sock);};
#else
...
# if defined(EFD_CLOEXEC) && defined(EFD_NONBLOCK)
    ...
    zr_boost_1_81::asio::ip::tcp::socket tcp_socket(ioc);
    zr_boost_1_81::asio::ip::udp::socket udp_socket(ioc);
    bp::async_pipe ap(ioc);

    tcp_socket.open(zr_boost_1_81::asio::ip::tcp::v4());
    udp_socket.open(zr_boost_1_81::asio::ip::udp::v4());
...
BOOST_AUTO_TEST_CASE(iterate_handles, *zr_boost_1_81::unit_test::timeout(5))
{
    using zr_boost_1_81::unit_test::framework::master_test_suite;
...
BOOST_AUTO_TEST_CASE(limit_fd, *zr_boost_1_81::unit_test::timeout(5))
{
#if defined(BOOST_WINDOWS_API)
