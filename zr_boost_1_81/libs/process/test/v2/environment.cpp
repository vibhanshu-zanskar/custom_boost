...
namespace bp2 = zr_boost_1_81::process::v2;
namespace bpe = zr_boost_1_81::process::v2::environment;
...
BOOST_AUTO_TEST_CASE(environment)
{
    ...
    zr_boost_1_81::ignore_unused(env);

    bp2::process_environment env2{custom_env2};
    zr_boost_1_81::ignore_unused(env2);
}
