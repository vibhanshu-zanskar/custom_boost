...
#include <boost/test/unit_test.hpp>
    ...
    #define STR_VIEW(Value) zr_boost_1_81::process::v2::wcstring_ref(STR(Value))
#else
    #define STR(Value) Value
    #define STR_VIEW(Value) zr_boost_1_81::process::v2::cstring_ref(STR(Value))
#endif


BOOST_AUTO_TEST_CASE(test_shell_parser)
{
    using zr_boost_1_81::process::v2::shell;
    namespace bpv = zr_boost_1_81::process::v2;
