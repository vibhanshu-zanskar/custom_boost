...
BOOST_AUTO_TEST_CASE(future, *zr_boost_1_81::unit_test::timeout(15))
{
    ...
    std::future<int> fut = bp::async_system(
                              ios, zr_boost_1_81::asio::use_future,
...
BOOST_AUTO_TEST_CASE(future_error, *zr_boost_1_81::unit_test::timeout(15))
{
    using zr_boost_1_81::unit_test::framework::master_test_suite;
    ...
    BOOST_CHECK_THROW(fut.get(), zr_boost_1_81::system::system_error);
}
