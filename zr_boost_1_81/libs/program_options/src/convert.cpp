...
namespace zr_boost_1_81 { namespace detail {
    ...
    /* Internal function to actually perform conversion.
       ...
       function will pass functional objects created with zr_boost_1_81::bind.
    ...
    */
        ...
        
    {
        ...
        while(from != from_end) {
            ...
            // Need variable because zr_boost_1_81::bind doesn't work with rvalues.
...
namespace zr_boost_1_81 {
               ...
               const std::codecvt<wchar_t, char, std::mbstate_t>& cvt)
    {
        return detail::convert<wchar_t>(
            s,                 
            zr_boost_1_81::bind(&std::codecvt<wchar_t, char, mbstate_t>::in,
                        &cvt,
             ...
             const std::codecvt<wchar_t, char, std::mbstate_t>& cvt)
    {
        return detail::convert<char>(
            s,                 
            zr_boost_1_81::bind(&codecvt<wchar_t, char, mbstate_t>::out,
                        &cvt,
                        _1, _2, _3, _4, _5, _6, _7));
    }
    ...
    namespace {
        zr_boost_1_81::program_options::detail::utf8_codecvt_facet
            utf8_facet;
    }
