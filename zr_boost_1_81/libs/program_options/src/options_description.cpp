   ...
   namespace {
                                      ...
                                      bool short_ignore_case) const
    {
        ...
        if (full_matches.size() > 1) 
            zr_boost_1_81::throw_exception(ambiguous_option(full_matches));
        ...
        if (full_matches.empty() && approximate_matches.size() > 1)
            zr_boost_1_81::throw_exception(ambiguous_option(approximate_matches));
        ...
        */
        ...
        {                    
            ...
            else
            {
                ...
                {
                    zr_boost_1_81::throw_exception(program_options::error(
                                ...
                                unsigned line_length)
        {
            ...
            // zr_boost_1_81::tokenizer, not typedef.
            typedef zr_boost_1_81::tokenizer<zr_boost_1_81::char_separator<char> > tok;
          
            tok paragraphs(
                desc,
                char_separator<char>("\n", "", zr_boost_1_81::keep_empty_tokens));
