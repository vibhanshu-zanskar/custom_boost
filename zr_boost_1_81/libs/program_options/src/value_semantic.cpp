...
namespace zr_boost_1_81 { namespace program_options {
    ...
    parse(zr_boost_1_81::any& value_store, 
    ...
    void 
    untyped_value::xparse(zr_boost_1_81::any& value_store,
                          const std::vector<std::string>& new_tokens) const
    {
        ...
        if (new_tokens.size() > 1)
            zr_boost_1_81::throw_exception(multiple_values());
    ...
    */
                       ...
                       bool*, int)
    {
        ...
        if (s.empty() || s == "on" || s == "yes" || s == "1" || s == "true")
            ...
            zr_boost_1_81::throw_exception(invalid_bool_value(s));
    }
    ...
    void validate(any& v, const vector<wstring>& xs, bool*, int)
    {
        ...
        if (s.empty() || s == L"on" || s == L"yes" || s == L"1" || s == L"true")
            ...
            zr_boost_1_81::throw_exception(invalid_bool_value(convert_value(s)));
    }
#endif
    BOOST_PROGRAM_OPTIONS_DECL 
    ...
    namespace validators {
        ...
        BOOST_PROGRAM_OPTIONS_DECL 
        void check_first_occurrence(const zr_boost_1_81::any& value)
        {
            if (!value.empty())
                zr_boost_1_81::throw_exception(
                    multiple_occurrences());
