...
{
    zr_boost_1_81::program_options::detail::utf8_codecvt_facet facet;
    
    std::wstring output;
    { 
        zr_boost_1_81::progress_timer t;
        for (int i = 0; i < 10000; ++i)
            output = zr_boost_1_81::from_8_bit(
                input,
                facet);
    }
    ...
    string ref = zr_boost_1_81::to_8_bit(output, facet);
...
{       
    ...
    if (ac > 1) {
        ...
        std::wstring w = zr_boost_1_81::from_local_8_bit(av[1]);
