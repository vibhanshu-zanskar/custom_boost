...
zr_boost_1_81::mpi::group intercommunicator::local_group() const
{
  return this->group();
}
...
zr_boost_1_81::mpi::group intercommunicator::remote_group() const
{
  MPI_Group gr;
  BOOST_MPI_CHECK_RESULT(MPI_Comm_remote_group, ((MPI_Comm)*this, &gr));
  return zr_boost_1_81::mpi::group(gr, /*adopt=*/true);
}
