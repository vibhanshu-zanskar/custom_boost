...
namespace zr_boost_1_81 { namespace mpi { namespace python { namespace detail {

  zr_boost_1_81::python::object skeleton_proxy_base_type; 
...
} } } } // end namespace zr_boost_1_81::mpi::python::detail
