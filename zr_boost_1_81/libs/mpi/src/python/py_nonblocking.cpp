...
namespace
{
  ...
  class py_call_output_iterator :
    public zr_boost_1_81::output_iterator_helper< 
  ...
  zr_boost_1_81::shared_ptr<request_list> make_request_list_from_py_list(object iterable)
  {
    zr_boost_1_81::shared_ptr<request_list> result(new request_list);
    std::copy(
  ...
  object wrap_wait_any(request_list &requests)
  {
    ...
    return zr_boost_1_81::python::make_tuple(
  ...
  {
    check_request_list_not_empty(requests);
    ::zr_boost_1_81::optional<pair<status, request_list::iterator> > result = 
