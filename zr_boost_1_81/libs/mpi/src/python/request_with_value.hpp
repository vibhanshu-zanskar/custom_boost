...
namespace zr_boost_1_81 { namespace mpi { namespace python {
  ...
  /** This wrapper adds a @c zr_boost_1_81::python::object value to the @c
   * zr_boost_1_81::mpi::request structure, for the benefit of @c irecv() requests.
   *
   ...
   * python::object is part of a zr_boost_1_81::mpi::python::content object: the
  ...
  { 
    private:
      zr_boost_1_81::shared_ptr<zr_boost_1_81::python::object> m_internal_value;
      zr_boost_1_81::python::object *m_external_value;
    ...
    public:
      ...
      const zr_boost_1_81::python::object get_value() const;
      const zr_boost_1_81::python::object get_value_or_none() const;

      const zr_boost_1_81::python::object wrap_wait();
      const zr_boost_1_81::python::object wrap_test();
