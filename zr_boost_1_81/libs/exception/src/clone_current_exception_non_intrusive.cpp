...
namespace
    ...
    clone_msvc_exception( void * src, cpp_exception_type const & et, size_t image_base )
        ...
        if( void * dst = malloc(ti.size) )
            ...
            return zr_boost_1_81::shared_ptr<void>(dst,exception_object_deleter(et,image_base));
            }
        else
            throw std::bad_alloc();
        }
    ...
    class
    cloned_exception:
        public zr_boost_1_81::exception_detail::clone_base
        {
        ...
        cpp_exception_type const & et_;
        size_t image_base_;
        zr_boost_1_81::shared_ptr<void> exc_;
        ...
        zr_boost_1_81::exception_detail::clone_base const *
        clone() const
            {
    ...
    unsigned long
    exception_cloning_filter( int & result, zr_boost_1_81::exception_detail::clone_base const * & ptr, void * info_ )
        {
        ...
        if( is_cpp_exception(record) )
            ...
            if( is_cpp_exception(record) && record->ExceptionInformation[2] )
                try
                    ...
                    result = zr_boost_1_81::exception_detail::clone_current_exception_result::success;
                    }
                catch(
                std::bad_alloc & )
                    {
                    result = zr_boost_1_81::exception_detail::clone_current_exception_result::bad_alloc;
                    }
                catch(
                ... )
                    {
                    result = zr_boost_1_81::exception_detail::clone_current_exception_result::bad_exception;
                    }
            }
