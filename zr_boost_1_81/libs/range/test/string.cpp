...
namespace
{
    ...
    private:
        typedef zr_boost_1_81::array<value_type, Length + 1> buffer_t;
        buffer_t m_buffer;
    };
}

template< class T >
inline BOOST_DEDUCED_TYPENAME zr_boost_1_81::range_iterator<T>::type
str_begin( T& r )
{
    return zr_boost_1_81::begin( zr_boost_1_81::as_literal(r) );
}
...
str_end( T& r )
{
    return zr_boost_1_81::end( zr_boost_1_81::as_literal(r) );
}

template< class T >
inline BOOST_DEDUCED_TYPENAME zr_boost_1_81::range_difference<T>::type
str_size( const T& r )
{
    return zr_boost_1_81::size( zr_boost_1_81::as_literal(r) );
}
...
str_empty( T& r )
{
    return zr_boost_1_81::empty( zr_boost_1_81::as_literal(r) );
}
...
template< typename Container, typename T >
BOOST_DEDUCED_TYPENAME zr_boost_1_81::range_iterator<const Container>::type
...
void check_char()
{
    typedef zr_boost_1_81::range_difference<std::string>::type diff_t;
...
void check_string()
{
    ...
    typedef zr_boost_1_81::range_difference<std::wstring>::type diff_t;
    ...
    zr_boost_1_81::ignore_unused_variable_warning( my_wstring );
