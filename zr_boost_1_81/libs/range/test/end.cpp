...
namespace
{
    ...
    {
        zr_boost_1_81::MockTestEndCollection c;
        const zr_boost_1_81::MockTestEndCollection& const_c = c;
...
{
    zr_boost_1_81::unit_test::test_suite* test = BOOST_TEST_SUITE( "Range Test Suite - end() ADL namespace barrier" );
