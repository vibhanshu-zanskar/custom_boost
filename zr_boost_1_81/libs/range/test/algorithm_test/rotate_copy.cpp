...
namespace
{
    ...
    {
        typedef BOOST_DEDUCED_TYPENAME zr_boost_1_81::range_value<Container>::type
                                            value_type;

        std::vector<value_type> reference;
        std::vector<value_type> test;

        typedef BOOST_DEDUCED_TYPENAME zr_boost_1_81::range_iterator<Container>::type
        ...
        test_append(
            zr_boost_1_81::rotate_copy(cont, where_it, std::back_inserter(test)),
            value_type()
            );
        ...
        test_append(
            zr_boost_1_81::rotate_copy(zr_boost_1_81::make_iterator_range(cont), where_it,
    ...
    {
        typedef BOOST_DEDUCED_TYPENAME zr_boost_1_81::range_iterator<Container>::type iterator_t;
