...
namespace zr_boost_1_81
{
    namespace
    {
        ...
        void test_next_permutation_impl(const Container& cont)
        {
            ...
            const bool test_ret = zr_boost_1_81::next_permutation(test);
            ...
            BOOST_CHECK( test_ret == zr_boost_1_81::next_permutation(zr_boost_1_81::make_iterator_range(test)) );
                                             ...
                                             BinaryPredicate  pred)
        {
            ...
            const bool test_ret
                = zr_boost_1_81::next_permutation(test, pred);
            ...
            BOOST_CHECK( test_ret == zr_boost_1_81::next_permutation(zr_boost_1_81::make_iterator_range(test), pred) );
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &zr_boost_1_81::test_next_permutation ) );
