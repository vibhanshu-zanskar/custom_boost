...
namespace zr_boost_1_81_range_test_algorithm_min_element
{
    ...
    public:
        ...
        test_iter(Container& cont)
        {
            ...
            iter_t result = zr_boost_1_81::min_element(cont);
            BOOST_CHECK( result == zr_boost_1_81::min_element(zr_boost_1_81::make_iterator_range(cont)) );
            return result;
        }
        ...
        struct test_range
        {
            ...
            operator()(Policy&, Container& cont)
            {
                ...
                result_t result = zr_boost_1_81::min_element<return_type>(cont);
                BOOST_CHECK( result == zr_boost_1_81::min_element<return_type>(zr_boost_1_81::make_iterator_range(cont)) );
                return result;
            }
        };
    ...
    public:
        ...
        {
            typedef BOOST_DEDUCED_TYPENAME zr_boost_1_81::range_iterator<Container>::type iter_t;
            iter_t result = zr_boost_1_81::min_element(cont, Pred());
            BOOST_CHECK( result == zr_boost_1_81::min_element(
        ...
        struct test_range
        {
            ...
            {
                typedef BOOST_DEDUCED_TYPENAME zr_boost_1_81::range_return<Container,return_type>::type result_t;
                result_t result = zr_boost_1_81::min_element<return_type>(cont, policy.pred());
                BOOST_CHECK( result == zr_boost_1_81::min_element<return_type>(
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &zr_boost_1_81_range_test_algorithm_min_element::test_min_element ) );
