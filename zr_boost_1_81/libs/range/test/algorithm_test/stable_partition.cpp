...
namespace zr_boost_1_81_range_test_algorithm_stable_partition
{
    struct equal_to_5
    {
    ...
    public:
        ...
        test_iter(Container& cont)
        {
            ...
            iter_t result = zr_boost_1_81::stable_partition(cont, UnaryPredicate());

            iter_t temp_result = zr_boost_1_81::stable_partition(
                zr_boost_1_81::make_iterator_range(cont2), UnaryPredicate());
        ...
        struct test_range
        {
            ...
            operator()(Policy& policy, Container& cont)
            {
                ...
                Container cont2(cont);
                result_t result = zr_boost_1_81::stable_partition<return_type>(cont, policy.pred());

                result_t result2 = zr_boost_1_81::stable_partition<return_type>(
                                    zr_boost_1_81::make_iterator_range(cont2), policy.pred());
                                    
                zr_boost_1_81::ignore_unused_variable_warning(result2);
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &zr_boost_1_81_range_test_algorithm_stable_partition::test_stable_partition ) );
