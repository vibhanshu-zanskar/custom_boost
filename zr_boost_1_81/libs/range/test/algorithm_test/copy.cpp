...
namespace zr_boost_1_81
{
    namespace
    {
        ...
        void test_copy_impl()
        {
            ...
            iterator_t it = zr_boost_1_81::copy(source, target.begin());
            ...
            it = zr_boost_1_81::copy(zr_boost_1_81::make_iterator_range(source), target.begin());
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &zr_boost_1_81::test_copy ) );
