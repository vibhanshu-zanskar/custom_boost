...
namespace
{
    ...
    {
        typedef BOOST_DEDUCED_TYPENAME zr_boost_1_81::range_value<const Container>::type value_type;
        ...
        test_append(
            zr_boost_1_81::replace_copy_if(c, std::back_inserter(test), pred, replace_with),
            value_type()
            );
        ...
        test_append(
            zr_boost_1_81::replace_copy_if(zr_boost_1_81::make_iterator_range(c),
    ...
    void test_replace_copy_if_( const Container& c, int to_replace )
    {
        ...
        test_replace_copy_if_impl(c, zr_boost_1_81::bind(std::equal_to<int>(), _1, to_replace));
        test_replace_copy_if_impl(c, zr_boost_1_81::bind(std::not_equal_to<int>(), _1, to_replace));
    }
