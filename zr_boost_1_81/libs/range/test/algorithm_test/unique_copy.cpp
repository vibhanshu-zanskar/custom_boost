...
namespace
{
    ...
    {
        typedef BOOST_DEDUCED_TYPENAME zr_boost_1_81::range_value<Container>::type value_type;
        ...
        test_append(
            zr_boost_1_81::unique_copy(c, std::back_inserter(test)),
            value_type()
            );
        ...
        test_append(
            zr_boost_1_81::unique_copy(zr_boost_1_81::make_iterator_range(c),
    ...
    void test_unique_copy_impl(Container& c, Pred pred)
    {
        ...
        test_append(
            zr_boost_1_81::unique_copy(c, std::back_inserter(test), pred),
            value_type()
            );
