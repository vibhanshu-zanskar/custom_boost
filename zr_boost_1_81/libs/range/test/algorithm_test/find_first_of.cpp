...
namespace zr_boost_1_81_range_test_algorithm_find_first_of
{
    ...
    public:
        ...
        test_iter(Container& cont)
        {
            ...
            iter_t result = zr_boost_1_81::find_first_of(cont, m_cont);
            BOOST_CHECK( result == zr_boost_1_81::find_first_of(zr_boost_1_81::make_iterator_range(cont), m_cont) );
            BOOST_CHECK( result == zr_boost_1_81::find_first_of(cont, zr_boost_1_81::make_iterator_range(m_cont)) );
            BOOST_CHECK( result == zr_boost_1_81::find_first_of(zr_boost_1_81::make_iterator_range(cont), zr_boost_1_81::make_iterator_range(m_cont)) );
            return result;
        }
        ...
        struct test_range
        {
            ...
            operator()(Policy& policy, Container& cont)
            {
                ...
                result_t result = zr_boost_1_81::find_first_of<return_type>(cont, policy.cont());
                BOOST_CHECK( result == zr_boost_1_81::find_first_of<return_type>(zr_boost_1_81::make_iterator_range(cont), policy.cont()) );
                BOOST_CHECK( result == zr_boost_1_81::find_first_of<return_type>(cont, zr_boost_1_81::make_iterator_range(policy.cont())) );
                BOOST_CHECK( result == zr_boost_1_81::find_first_of<return_type>(zr_boost_1_81::make_iterator_range(cont), zr_boost_1_81::make_iterator_range(policy.cont())) );
                return result;
            }
        };
    ...
    public:
        ...
        {
            typedef BOOST_DEDUCED_TYPENAME zr_boost_1_81::range_iterator<Container>::type iter_t;
            iter_t result = zr_boost_1_81::find_first_of(cont, m_cont, m_pred);
            BOOST_CHECK( result == zr_boost_1_81::find_first_of(zr_boost_1_81::make_iterator_range(cont), m_cont, m_pred) );
            BOOST_CHECK( result == zr_boost_1_81::find_first_of(cont, zr_boost_1_81::make_iterator_range(m_cont), m_pred) );
            BOOST_CHECK( result == zr_boost_1_81::find_first_of(zr_boost_1_81::make_iterator_range(cont), zr_boost_1_81::make_iterator_range(m_cont), m_pred) );
            return result;
        }
        ...
        struct test_range
        {
            ...
            {
                typedef BOOST_DEDUCED_TYPENAME zr_boost_1_81::range_return<Container,return_type>::type result_t;
                result_t result = zr_boost_1_81::find_first_of<return_type>(cont, policy.cont(), policy.pred());
                BOOST_CHECK( result == zr_boost_1_81::find_first_of<return_type>(zr_boost_1_81::make_iterator_range(cont), policy.cont(), policy.pred()) );
                BOOST_CHECK( result == zr_boost_1_81::find_first_of<return_type>(cont, zr_boost_1_81::make_iterator_range(policy.cont()), policy.pred()) );
                BOOST_CHECK( result == zr_boost_1_81::find_first_of<return_type>(zr_boost_1_81::make_iterator_range(cont), zr_boost_1_81::make_iterator_range(policy.cont()), policy.pred()) );
                return result;
            }
        };
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &zr_boost_1_81_range_test_algorithm_find_first_of::test_find_first_of ) );
