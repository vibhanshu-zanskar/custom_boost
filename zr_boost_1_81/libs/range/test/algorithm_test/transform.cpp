...
namespace zr_boost_1_81
{
    namespace
    {
        ...
        void test_transform_impl1(Container& cont)
        {
            ...
            zr_boost_1_81::ignore_unused_variable_warning(reference_it);

            iterator_t test_it
                = zr_boost_1_81::transform(cont, target.begin(), fn);

            BOOST_CHECK( test_it == target.end() );
            BOOST_CHECK_EQUAL_COLLECTIONS( reference.begin(), reference.end(),
                                           target.begin(), target.end() );
                
            BOOST_CHECK( test_it == zr_boost_1_81::transform(zr_boost_1_81::make_iterator_range(cont), target.begin(), fn) );
            BOOST_CHECK_EQUAL_COLLECTIONS( reference.begin(), reference.end(),
                                           target.begin(), target.end() );
            ...
            test_it = zr_boost_1_81::transform(ccont, target.begin(), fn);
            
            BOOST_CHECK( test_it == target.end() );
            BOOST_CHECK_EQUAL_COLLECTIONS( reference.begin(), reference.end(),
                                           target.begin(), target.end() );
            BOOST_CHECK( test_it == zr_boost_1_81::transform(zr_boost_1_81::make_iterator_range(ccont), target.begin(), fn) );
            BOOST_CHECK_EQUAL_COLLECTIONS( reference.begin(), reference.end(),
                                           target.begin(), target.end() );
        }
        ...
        void test_transform_impl2(Container1& cont1, Container2& cont2)
        {
            ...
            iterator_t test_it
                = zr_boost_1_81::transform(cont1, cont2, target.begin(), fn);
                
            BOOST_CHECK( test_it == target.end() );
            BOOST_CHECK_EQUAL_COLLECTIONS( reference.begin(), reference.end(),
                                           target.begin(), target.end() );
                                           
            BOOST_CHECK( test_it == zr_boost_1_81::transform(zr_boost_1_81::make_iterator_range(cont1), cont2, target.begin(), fn) );
            BOOST_CHECK_EQUAL_COLLECTIONS( reference.begin(), reference.end(),
                                           target.begin(), target.end() );
                                           
            BOOST_CHECK( test_it == zr_boost_1_81::transform(cont1, zr_boost_1_81::make_iterator_range(cont2), target.begin(), fn) );
            BOOST_CHECK_EQUAL_COLLECTIONS( reference.begin(), reference.end(),
                                           target.begin(), target.end() );
                                           
            BOOST_CHECK( test_it == zr_boost_1_81::transform(zr_boost_1_81::make_iterator_range(cont1),
            ...
            test_it = zr_boost_1_81::transform(ccont1, ccont2, target.begin(), fn);
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &zr_boost_1_81::test_transform ) );
