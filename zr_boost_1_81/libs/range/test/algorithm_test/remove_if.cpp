...
namespace zr_boost_1_81
{
    namespace
    {
        ...
        void test_remove_if_impl( const Container& c, UnaryPredicate pred )
        {
            ...
            Container test(c);
            iterator_t test_it = zr_boost_1_81::remove_if(test, pred);
            ...
            Container test2(c);
            iterator_t test_it2 = zr_boost_1_81::remove_if(
                zr_boost_1_81::make_iterator_range(test2), pred);
        ...
        void test_remove_if_( const Container& c, int to_remove )
        {
            ...
            test_remove_if_impl(c, zr_boost_1_81::bind(std::equal_to<int>(), _1, to_remove));
            test_remove_if_impl(c, zr_boost_1_81::bind(std::not_equal_to<int>(), _1, to_remove));
        }
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &zr_boost_1_81::test_remove_if ) );
