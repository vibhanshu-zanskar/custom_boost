...
namespace zr_boost_1_81
{
    namespace
    {
        ...
        void test(Container& cont)
        {
            ...
            pair_t test_result = zr_boost_1_81::equal_range(test, 5);

            check_result(reference, reference_result, test, test_result);

            pair_t test_result2 = zr_boost_1_81::equal_range(zr_boost_1_81::make_iterator_range(test), 5);
        ...
        void test_pred(Container& cont, BinaryPredicate pred)
        {
            ...
            pair_t test_result = zr_boost_1_81::equal_range(test, 5, BinaryPredicate());

            check_result(reference, reference_result, test, test_result);

            pair_t test_result2 = zr_boost_1_81::equal_range(zr_boost_1_81::make_iterator_range(test), 5, BinaryPredicate());
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &zr_boost_1_81::test_equal_range ) );
