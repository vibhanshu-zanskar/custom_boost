...
namespace zr_boost_1_81
{
    namespace
    {
        ...
        void test_random_shuffle_nogen_impl(Container& cont)
        {
            ...
            {
                Container test(cont);
                zr_boost_1_81::random_shuffle(test);
                ...
                zr_boost_1_81::random_shuffle(zr_boost_1_81::make_iterator_range(test2));
        ...
        void test_random_shuffle_gen_impl(Container& cont)
        {
            ...
            zr_boost_1_81::random_shuffle(cont, gen);
            ...
            zr_boost_1_81::random_shuffle(zr_boost_1_81::make_iterator_range(cont2), gen2);
        ...
        {
            Container old_cont(cont);
            zr_boost_1_81::random_shuffle(cont);
            test_shuffle_result(cont, old_cont);
        }
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &zr_boost_1_81::test_random_shuffle ) );
