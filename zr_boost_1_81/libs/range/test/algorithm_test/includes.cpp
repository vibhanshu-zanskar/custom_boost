...
namespace zr_boost_1_81
{
    namespace
    {
        ...
        void test(Container1& cont1, Container2& cont2)
        {
            ...
            bool test_result = zr_boost_1_81::includes(cont1, cont2);
            ...
            BOOST_CHECK( test_result == zr_boost_1_81::includes(zr_boost_1_81::make_iterator_range(cont1), cont2) );
            BOOST_CHECK( test_result == zr_boost_1_81::includes(cont1, zr_boost_1_81::make_iterator_range(cont2)) );
            BOOST_CHECK( test_result == zr_boost_1_81::includes(zr_boost_1_81::make_iterator_range(cont1), zr_boost_1_81::make_iterator_range(cont2)) );
        }
                       ...
                       BinaryPredicate pred)
        {
            ...
            bool test_result = zr_boost_1_81::includes(cont1, cont2, pred);
            ...
            BOOST_CHECK( test_result == zr_boost_1_81::includes(zr_boost_1_81::make_iterator_range(cont1), cont2, pred) );
            BOOST_CHECK( test_result == zr_boost_1_81::includes(cont1, zr_boost_1_81::make_iterator_range(cont2), pred) );
            BOOST_CHECK( test_result == zr_boost_1_81::includes(zr_boost_1_81::make_iterator_range(cont1), zr_boost_1_81::make_iterator_range(cont2), pred) );
        }
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &zr_boost_1_81::test_includes ) );
