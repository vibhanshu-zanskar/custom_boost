...
namespace zr_boost_1_81
{
    namespace
    {
        ...
        void test(Container1& cont1, Container2& cont2)
        {
            ...
            zr_boost_1_81::inplace_merge(test_target,
            ...
            zr_boost_1_81::inplace_merge(zr_boost_1_81::make_iterator_range(test_target2),
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &zr_boost_1_81::test_inplace_merge ) );
