...
namespace zr_boost_1_81
{
    namespace
    {
        ...
        void test_remove_impl( const Container& c, Value to_remove )
        {
            ...
            Container test(c);
            iterator_t test_it = zr_boost_1_81::remove(test, to_remove);
            ...
            Container test2(c);
            iterator_t test_it2 = zr_boost_1_81::remove(test2, to_remove);
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &zr_boost_1_81::test_remove ) );
