...
namespace zr_boost_1_81
{
    namespace
    {
        ...
        void test_rotate_impl(Container& cont, Iterator where_it)
        {
            ...
            zr_boost_1_81::rotate(test, test_where_it);
            ...
            zr_boost_1_81::rotate(zr_boost_1_81::make_iterator_range(test), test_where_it);
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &zr_boost_1_81::test_rotate ) );
