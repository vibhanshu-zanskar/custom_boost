...
namespace zr_boost_1_81
{
    namespace
    {
        ...
        void test(Container& cont)
        {
            ...
            bool test_result = zr_boost_1_81::binary_search(test, 5);

            BOOST_CHECK( reference_result == test_result );

            BOOST_CHECK( test_result == zr_boost_1_81::binary_search(zr_boost_1_81::make_iterator_range(test), 5) );
        ...
        void test_pred(Container& cont, BinaryPredicate pred)
        {
            ...
            bool test_result = zr_boost_1_81::binary_search(test, 5, pred);

            BOOST_CHECK( test_result == zr_boost_1_81::binary_search(zr_boost_1_81::make_iterator_range(test), 5, pred) );
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &zr_boost_1_81::test_binary_search ) );
