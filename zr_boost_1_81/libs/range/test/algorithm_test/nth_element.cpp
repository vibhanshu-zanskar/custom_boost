    ...
    namespace
    {
        struct nth_element_policy
        {
            ...
            void test_nth_element(Container& cont, Iterator mid)
            {
                ...
                zr_boost_1_81::nth_element(cont, mid);
                ...
                zr_boost_1_81::nth_element(zr_boost_1_81::make_iterator_range(cont2), mid2);
        ...
        struct nth_element_pred_policy
        {
            ...
            void test_nth_element(Container& cont, Iterator mid)
            {
                ...
                zr_boost_1_81::nth_element(cont, mid, BinaryPredicate());
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &zr_boost_1_81::test_nth_element ) );
