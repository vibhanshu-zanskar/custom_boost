...
namespace zr_boost_1_81
{
    namespace
    {
        ...
        void test_sort_impl(Container& cont)
        {
            ...
            zr_boost_1_81::sort(zr_boost_1_81::make_iterator_range(test2));
            BOOST_CHECK_EQUAL_COLLECTIONS( reference.begin(), reference.end(),
        ...
        void test_sort_impl(Container& cont, BinaryPredicate pred)
        {
            ...
            Container test2(cont);
            zr_boost_1_81::sort(zr_boost_1_81::make_iterator_range(test2), pred);
            BOOST_CHECK_EQUAL_COLLECTIONS( reference.begin(), reference.end(),
                                           test2.begin(), test2.end() );
        }
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &zr_boost_1_81::test_sort ) );
