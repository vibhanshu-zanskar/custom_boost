...
namespace zr_boost_1_81
{
    namespace
    {
        ...
        void copied_test_impl( Container& c )
        {
            ...
            zr_boost_1_81::push_back(test_result1, c | copied(0u, c.size()));

            // This is the alternative syntax preferred by some.
            std::vector< int > test_result2;
            zr_boost_1_81::push_back(test_result2, adaptors::copy(c, 0u, c.size()));
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &zr_boost_1_81::copied_test ) );
