...
private:
    zr_boost_1_81::uint64_t m_value;
    bool m_valid;
};
...
void chained_adaptors_test()
{
    ...
    zr_boost_1_81::copy(sep
        | zr_boost_1_81::adaptors::transformed(zr_boost_1_81::bind(&foo::from_string, _1))
        | zr_boost_1_81::adaptors::filtered(zr_boost_1_81::bind(&foo::is_valid, _1)),
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add(BOOST_TEST_CASE( zr_boost_1_81_range_test::chained_adaptors_test));
