...
namespace zr_boost_1_81
{
    namespace
    {
        ...
        void replaced_if_test_impl( Container& c )
        {
            ...
            zr_boost_1_81::push_back(test_result1, c | replaced_if(pred, replacement_value));

            std::vector< int > test_result2;
            zr_boost_1_81::push_back(test_result2, zr_boost_1_81::adaptors::replace_if(c, pred, replacement_value));
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &zr_boost_1_81::replaced_if_test ) );
