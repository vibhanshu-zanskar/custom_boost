...
namespace zr_boost_1_81
{
    namespace
    {
        ...
        void transformed_test_impl_core( Container& c, TransformFn fn )
        {
            ...
            zr_boost_1_81::push_back(test_result1, c | transformed(fn));

            std::vector< int > test_result2;
            zr_boost_1_81::push_back(test_result2, adaptors::transform(c, fn));
        ...
        void transformed_bind()
        {
            ...
            zr_boost_1_81::range::push_back(
                    output,
                    input | transformed(zr_boost_1_81::bind(&foo_bind::foo, _1)));
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add(BOOST_TEST_CASE(&zr_boost_1_81::transformed_test));
    test->add(BOOST_TEST_CASE(&zr_boost_1_81::transformed_bind));
