...
namespace
{
    ...
    {
        using namespace zr_boost_1_81::zr_boost_1_81phoenix::arg_names;
        ...
        zr_boost_1_81::push_back(output1, v | transformed((&arg1)->*& test_struct::x));

        std::vector<double> output2;
        zr_boost_1_81::push_back(output2, v | transformed(get_x()));
