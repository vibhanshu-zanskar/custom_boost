...
namespace zr_boost_1_81
{
    ...
    void reversed_test_impl( Container& c )
    {
        ...
        zr_boost_1_81::push_back(test_result1, c | reversed);

        std::vector< int > test_result2;
        zr_boost_1_81::push_back(test_result2, adaptors::reverse(c));
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &zr_boost_1_81::reversed_test ) );
