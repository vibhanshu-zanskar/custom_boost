...
void mix_values()
{
    mix_values_driver<zr_boost_1_81::single_pass_traversal_tag >();
    mix_values_driver<zr_boost_1_81::forward_traversal_tag >();
    mix_values_driver<zr_boost_1_81::bidirectional_traversal_tag >();
    mix_values_driver<zr_boost_1_81::random_access_traversal_tag >();
}
...
init_unit_test_suite(int, char*[])
{
    ...
    test->add(BOOST_TEST_CASE(
            &zr_boost_1_81_range_adaptor_type_erased_test::mix_values));
