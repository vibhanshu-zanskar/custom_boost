...
namespace zr_boost_1_81
{
    namespace
    {
        ...
        void indirected_test_impl( Container& c )
        {
            ...
            zr_boost_1_81::push_back(test_result1, c | indirected);

            // This is an alternative syntax preferred by some.
            std::vector< int > test_result2;
            zr_boost_1_81::push_back(test_result2, adaptors::indirect(c));
        ...
        void indirected_test_impl()
        {
            ...
            c += zr_boost_1_81::shared_ptr<int>(new int(1));
            indirected_test_impl(c);
            ...
            {
                c += zr_boost_1_81::shared_ptr<int>(new int(*it));
            }
            indirected_test_impl(c);
        }
        ...
        {
            indirected_test_impl< std::vector< zr_boost_1_81::shared_ptr< int > > >();
        }
    }
}
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &zr_boost_1_81::indirected_test ) );
