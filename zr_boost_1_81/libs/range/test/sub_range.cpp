...
void check_sub_range()
{
    ...
    typedef zr_boost_1_81::sub_range<std::string>       srange;
    typedef zr_boost_1_81::sub_range<const std::string> csrange;
    srange s     = r;
    BOOST_CHECK( r == r );
    BOOST_CHECK( s == r );
    s            = zr_boost_1_81::make_iterator_range( str );
    csrange s2   = r;
    s2           = r2;
    s2           = zr_boost_1_81::make_iterator_range( cstr );
    BOOST_CHECK( r2 == r2 );
    BOOST_CHECK( s2 != r2 );
    s2           = zr_boost_1_81::make_iterator_range( str );
    BOOST_CHECK( !(s != s) );
...
//#endif
    ...
    srange rr = zr_boost_1_81::make_iterator_range( str );
    ...
    rrr.back()  = 'D';
    rrr[1]      = 'E';
    BOOST_CHECK( rrr == zr_boost_1_81::as_literal("HEllo worlD") );
}

template<class T>
void check_mutable_type(T&)
{
    BOOST_STATIC_ASSERT(!zr_boost_1_81::is_const<T>::value);
}
...
void check_is_const_iterator(Iterator it)
{
    BOOST_STATIC_ASSERT((
        zr_boost_1_81::is_same<
            BOOST_DEDUCED_TYPENAME zr_boost_1_81::range_iterator<
                BOOST_DEDUCED_TYPENAME zr_boost_1_81::add_const<Range>::type
            >::type,
            Iterator
        >::value));
}
...
void check_is_iterator(Iterator it)
{
    BOOST_STATIC_ASSERT((
        zr_boost_1_81::is_same<
            BOOST_DEDUCED_TYPENAME zr_boost_1_81::range_iterator<
                BOOST_DEDUCED_TYPENAME zr_boost_1_81::remove_const<Range>::type
            >::type,
            Iterator
        >::value));
}
...
void const_propagation_mutable_collection(void)
{
    ...
    typedef zr_boost_1_81::sub_range<coll_t> sub_range_t;
...
{
    typedef std::vector<int> coll_t;
    typedef zr_boost_1_81::sub_range<const coll_t> sub_range_t;
...
inline void test_advance()
{
    ...
    l.push_back(1);
    l.push_back(2);
    typedef zr_boost_1_81::sub_range<std::vector<int> > rng_t;
...
void ticket_10514()
{
    ...
    typedef zr_boost_1_81::sub_range<vec_t> range_t;
    vec_t v(10);
...
zr_boost_1_81::unit_test::test_suite* init_unit_test_suite(int, char*[])
{
    ...
    test->add(BOOST_TEST_CASE(&zr_boost_1_81_range_test::check_sub_range));

    test->add(BOOST_TEST_CASE(
                  &zr_boost_1_81_range_test::const_propagation_const_collection));

    test->add(BOOST_TEST_CASE(
                  &zr_boost_1_81_range_test::const_propagation_mutable_collection));

    test->add(BOOST_TEST_CASE(&zr_boost_1_81_range_test::test_advance));

    test->add(BOOST_TEST_CASE(&zr_boost_1_81_range_test::ticket_10514));
