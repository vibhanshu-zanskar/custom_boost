...
{
    BOOST_RANGE_CONCEPT_ASSERT(( zr_boost_1_81::RandomAccessRangeConcept<RandomAccessRng> ));
}

template <class BidirectionalRng>
void check_bidirectional_range_concept(const BidirectionalRng& rng)
{
    BOOST_RANGE_CONCEPT_ASSERT(( zr_boost_1_81::BidirectionalRangeConcept<BidirectionalRng> ));
}
