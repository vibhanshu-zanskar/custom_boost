...
namespace
{
    ...
    void test_variant_report()
    {
        typedef zr_boost_1_81::mpl::vector<
            E,
            std::string,
            zr_boost_1_81::iterator_range<std::string::iterator>
        >::type args;

        typedef zr_boost_1_81::make_variant_over<args>::type variant_t;

        variant_t v;
        std::string s;
        v = zr_boost_1_81::iterator_range<std::string::iterator>(s.begin(), s.end());
        v = e2;
        v = std::string();
