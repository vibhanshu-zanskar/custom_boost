...
{
    typedef typename zr_boost_1_81::range_iterator<MfcMapT>::type iter_t;
...
void test_CTypedPtrArray()
{
    ...
    zr_boost_1_81::function_requires< zr_boost_1_81::RandomAccessRangeConcept<rng_t> >();

    rng_t rng;
    int o1, o2, o3, o4, o5;
    int *data[] = { &o1, &o2, &o3, &o4, &o5 };
    BOOST_CHECK( brdm::test_init_array(rng, zr_boost_1_81::make_iterator_range(data, data+5)) );

    BOOST_CHECK( *(zr_boost_1_81::begin(rng) + 2) == &o3 );
    BOOST_CHECK( *(zr_boost_1_81::end(rng) - 1) == &o5 );        
...
void test_CTypedPtrList()
{
    ...
    zr_boost_1_81::range_iterator<rng_t>::type it = zr_boost_1_81::begin(rng);
    std::advance(it, 1);
    BOOST_CHECK( *it == &o2 );
    std::advance(it, 2);
    BOOST_CHECK( *it == &o4 );
...
void test_mfc()
{
    ...
    //
    {
        ...
        BOOST_FOREACH (CList<CString> *theList, myArray)
        {
            ...
            {
                zr_boost_1_81::to_upper(str);
                std::sort(zr_boost_1_81::begin(str), zr_boost_1_81::end(str));
                // ...
            }
        }
    }
    ...
    //
    {
        ...
        ::test_CByteArray(zr_boost_1_81::make_iterator_range(data, data+22));
    }

    {
        DWORD data[] = { 4,5,1,3,5,12,3,1,3,1,6,1,3,60,1,1,5,1,3,1,10 };

        test_CDWordArray(zr_boost_1_81::make_iterator_range(data, data+22));
    }

    {
        ...
        ::test_CObArray(zr_boost_1_81::make_iterator_range(data, data+5));
    }

    {
        ...
        ::test_CPtrArray(zr_boost_1_81::make_iterator_range(data, data+5));
    }

    {
        ...
        ::test_CStringArray(zr_boost_1_81::make_iterator_range(data, data+8));
    }

    {
        ...
        ::test_CUIntArray(zr_boost_1_81::make_iterator_range(data, data+22));
    }

    {
        ...
        ::test_CWordArray(zr_boost_1_81::make_iterator_range(data, data+22));
    }
    ...
    //
    {
        ...
        ::test_CObList(zr_boost_1_81::make_iterator_range(data, data+5));
    }

    {
        ...
        ::test_CPtrList(zr_boost_1_81::make_iterator_range(data, data+5));
    }

    {
        ...
        ::test_CStringList(zr_boost_1_81::make_iterator_range(data, data+8));
    }
