...
void test_result_iterator()
{
    ...
    BOOST_STATIC_ASSERT((
        zr_boost_1_81::is_same<
            cont::iterator,
            zr_boost_1_81::range_result_iterator<cont>::type
        >::value));

    BOOST_STATIC_ASSERT((
        zr_boost_1_81::is_same<
            cont::const_iterator,
            zr_boost_1_81::range_result_iterator<const cont>::type
        >::value));
...
zr_boost_1_81::unit_test::test_suite* init_unit_test_suite( int argc, char* argv[] )
{
    ...
    test->add(BOOST_TEST_CASE(&zr_boost_1_81_range_test::test_result_iterator));
