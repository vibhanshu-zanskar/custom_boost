...
namespace
{
    ...
    void test_is_sorted_impl()
    {
        ...
        BOOST_CHECK( zr_boost_1_81::is_sorted(ascending) );
        BOOST_CHECK( zr_boost_1_81::is_sorted(ascending, std::less<std::size_t>()) );
        BOOST_CHECK( zr_boost_1_81::is_sorted(ascending, std::greater<std::size_t>()) );
        ...
        BOOST_CHECK( zr_boost_1_81::is_sorted(ascending) );
        BOOST_CHECK( !zr_boost_1_81::is_sorted(descending) );
        BOOST_CHECK( !zr_boost_1_81::is_sorted(ascending, std::greater<std::size_t>()) );
        BOOST_CHECK( zr_boost_1_81::is_sorted(descending, std::greater<std::size_t>()) );
    }
