...
namespace
{
    ...
    void test_erase_impl()
    {
        ...
        zr_boost_1_81::iterator_range< iterator_t > test_range(test.begin(), test.end());

        reference.erase(first_ref, last_ref);
        zr_boost_1_81::erase(test, test_range);
    ...
    void test_remove_erase_impl()
    {
        ...
        zr_boost_1_81::remove_erase(test, 5);
    ...
    void test_remove_erase_if_impl()
    {
        ...
        Container test(source);
        zr_boost_1_81::remove_erase_if(test, is_even());
    ...
    void test_unique_erase_impl()
    {
        ...
        zr_boost_1_81::unique_erase(source);
    ...
    void test_unique_erase_pred_impl()
    {
        ...
        zr_boost_1_81::unique_erase(source, distance_smaller_2());
