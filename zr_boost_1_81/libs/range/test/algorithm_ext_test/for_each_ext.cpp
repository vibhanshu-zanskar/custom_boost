...
namespace
{
    ...
    {
        MockBinaryFn fn = zr_boost_1_81::range::for_each(rng1, rng2, MockBinaryFn());

        BOOST_CHECK_EQUAL_COLLECTIONS( ::zr_boost_1_81::begin(rng1), ::zr_boost_1_81::end(rng1),
            fn.xs.begin(), fn.xs.end() );

        BOOST_CHECK_EQUAL_COLLECTIONS( ::zr_boost_1_81::begin(rng2), ::zr_boost_1_81::end(rng2),
