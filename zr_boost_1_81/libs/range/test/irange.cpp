...
namespace zr_boost_1_81
{
    ...
    void test_irange_impl(Integer last)
    {
        ...
        zr_boost_1_81::push_back(test, zr_boost_1_81::irange(last));
    ...
    void test_irange_impl(Integer first, Integer last)
    {
        ...
        std::vector<Integer> test;
        zr_boost_1_81::push_back(test, zr_boost_1_81::irange(first, last));
    ...
    void test_irange_impl(IntegerInput first, IntegerInput last, int step)
    {
        ...
        std::vector<Integer> test;
        zr_boost_1_81::push_back(test, zr_boost_1_81::irange(first, last, step));
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add(BOOST_TEST_CASE( &zr_boost_1_81::irange_unit_test ));
