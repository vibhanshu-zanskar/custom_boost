...
void check_direct()
{
    ...
    Rng rng = zr_boost_1_81::assign::list_of(1)(2)(3)(4)(5).to_container( rng );
    Rng out;
    ...
    BOOST_CHECK_EQUAL( *zr_boost_1_81::next(out.begin()), 4 );
    BOOST_CHECK_EQUAL( *zr_boost_1_81::next(out.begin(),2), 6 );

    rng = zr_boost_1_81::assign::list_of(1)(1)(2)(2)(3)(3)(4)(5).to_container( rng );
    out.clear();
    /*
...
void check_indirect()
{
    ...
    std::vector< zr_boost_1_81::shared_ptr< int > > holder;
    
    for( unsigned i = 0u; i != 20u; ++i )
    {
        zr_boost_1_81::shared_ptr<int> v(new int(i));
        rng.push_back( v.get() );
    }
...
void check_map()
{
    ...
    std::vector<int> keys 
        = zr_boost_1_81::copy_range< std::vector<int> >( m | map_keys );
    std::vector<int> values 
       = zr_boost_1_81::copy_range< std::vector<int> >( m | map_values );
}
...
void check_regex()
{
    ...
    std::vector<std::string> tokens =
        zr_boost_1_81::copy_range< std::vector<std::string> >( s | tokenized( "\\s+", -1 ) );
}
