...
#include <boost/container_hash/hash.hpp> //zr_boost_1_81::hash

namespace bip = zr_boost_1_81::interprocess;

typedef bip::allocator<int, bip::managed_shared_memory::segment_manager> ShmemAllocator;
typedef zr_boost_1_81::unordered_set<int, zr_boost_1_81::hash<int>, std::equal_to<int>, ShmemAllocator> MyUnorderedSet;
typedef zr_boost_1_81::unordered_multiset<int, zr_boost_1_81::hash<int>, std::equal_to<int>, ShmemAllocator> MyUnorderedMultiSet;
