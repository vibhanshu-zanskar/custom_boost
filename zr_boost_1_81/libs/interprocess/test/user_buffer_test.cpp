...
int main ()
{
   ...
   const int size_aligner  = sizeof(::zr_boost_1_81::container::dtl::max_align_t);
   const int memsize       = 65536/size_aligner*size_aligner;
   static ::zr_boost_1_81::container::dtl::max_align_t static_buffer[memsize/size_aligner];

   {
      //Now test move semantics
      managed_heap_memory original(memsize);
      managed_heap_memory move_ctor(zr_boost_1_81::move(original));
   ...
   }
   {
      ...
      managed_external_buffer move_ctor(zr_boost_1_81::move(original));
   ...
   //Test move semantics
   {
      ...
      wmanaged_external_buffer temp_external(zr_boost_1_81::move(user_buffer));
      user_default = zr_boost_1_81::move(temp_external);
      user_buffer  = zr_boost_1_81::move(user_default);
      wmanaged_heap_memory heap_default;
      wmanaged_heap_memory temp_heap(zr_boost_1_81::move(heap_buffer));
      heap_default = zr_boost_1_81::move(temp_heap);
      heap_buffer  = zr_boost_1_81::move(heap_default);
   }
