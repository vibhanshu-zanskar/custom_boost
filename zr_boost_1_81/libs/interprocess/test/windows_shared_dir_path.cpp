...
#define BOOST_INTERPROCESS_SHARED_DIR_PATH zr_boost_1_81::interprocess::ipcdetail::get_temporary_path()
#define BOOST_INTERPROCESS_SHARED_DIR_WPATH zr_boost_1_81::interprocess::ipcdetail::get_temporary_wpath()
#include <string>
...
int main ()
{
   ...
   {
      std::string pname= zr_boost_1_81::interprocess::test::get_process_id_name();
   ...
   {
      std::wstring wpname= zr_boost_1_81::interprocess::test::get_process_id_wname();
