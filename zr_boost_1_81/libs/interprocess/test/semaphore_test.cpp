...
class semaphore_test_wrapper
   : public zr_boost_1_81::interprocess::interprocess_semaphore
{
   public:
   semaphore_test_wrapper()
      :  zr_boost_1_81::interprocess::interprocess_semaphore(SemCount)
   {}
   ...
   {  return this->timed_lock(zr_boost_1_81::interprocess::ipcdetail::duration_to_ustime(dur)); }
   ...
   semaphore_test_wrapper(std::size_t initial_count)
      :  zr_boost_1_81::interprocess::interprocess_semaphore(unsigned(initial_count))
   {}
};
