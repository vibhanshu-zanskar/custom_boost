...
int main()
{
   ...
   shared_memory_object::remove(process_name.c_str());
   {
      ...
      my_unique_ptr_class my_ptr4(zr_boost_1_81::move(my_ptr3));

      //Construct a list and fill
      MyList list(segment.get_segment_manager());

      //Insert from my_unique_ptr_class
      list.push_front(zr_boost_1_81::move(my_ptr));
      list.push_back(zr_boost_1_81::move(my_ptr2));
      ...
      set.insert(zr_boost_1_81::move(*list.begin()));
      set.insert(zr_boost_1_81::move(*list.rbegin()));
      ...
      //Insert from my_unique_ptr_class
      if(ptr1 < ptr2){
         vector.insert(vector.begin(), zr_boost_1_81::move(*set.begin()));
         vector.insert(vector.end(),   zr_boost_1_81::move(*set.rbegin()));
      }
      else{
         vector.insert(vector.begin(), zr_boost_1_81::move(*set.rbegin()));
         vector.insert(vector.end(),   zr_boost_1_81::move(*set.begin()));
      }
      ...
      MyVector vector2(zr_boost_1_81::move(vector));
      vector2.swap(vector);
