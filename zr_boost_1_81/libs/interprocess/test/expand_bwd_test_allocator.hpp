...
class expand_bwd_test_allocator
{
 private:
   ...
   typedef zr_boost_1_81::interprocess::version_type<expand_bwd_test_allocator, 2>   version;
   ...
   {
      ::zr_boost_1_81::adl_move_swap(alloc1.mp_buffer, alloc2.mp_buffer);
      ::zr_boost_1_81::adl_move_swap(alloc1.m_size,    alloc2.m_size);
      ::zr_boost_1_81::adl_move_swap(alloc1.m_offset,  alloc2.m_offset);
   }
                         ...
                         size_type limit_size, size_type &prefer_in_recvd_out_size, pointer &reuse)
   {
      ...
      assert(m_allocations == 0 || (command & zr_boost_1_81::interprocess::expand_bwd));
