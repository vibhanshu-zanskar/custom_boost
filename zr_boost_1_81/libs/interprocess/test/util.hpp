...
inline zr_boost_1_81::posix_time::ptime ptime_delay(int secs, int msecs=0, int nsecs = 0)
{
   (void)msecs;
   ...
   zr_boost_1_81::posix_time::ptime cur = zr_boost_1_81::posix_time::microsec_clock::universal_time();
   return cur +=  zr_boost_1_81::posix_time::time_duration(0, 0, secs, count);
}

inline zr_boost_1_81::posix_time::time_duration ptime_seconds(int secs)
{  return  zr_boost_1_81::posix_time::time_duration(0, 0, secs);  }

inline zr_boost_1_81::chrono::system_clock::time_point boost_systemclock_delay(int secs)
{  return zr_boost_1_81::chrono::system_clock::now() + zr_boost_1_81::chrono::seconds(secs);  }

inline zr_boost_1_81::chrono::seconds boost_systemclock_seconds(int secs)
{  return zr_boost_1_81::chrono::seconds(secs);  }
...
inline zr_boost_1_81::chrono::system_clock::time_point std_systemclock_delay(int secs)
{  return boost_systemclock_delay(secs);  }

inline zr_boost_1_81::chrono::seconds std_systemclock_seconds(int secs)
{  return zr_boost_1_81::chrono::seconds(secs);  }
