...
bool test_insert_with_expand_bwd()
{
   ...
   typedef typename zr_boost_1_81::interprocess::ipcdetail::remove_volatile<value_type>::type non_volatile_value_type;
...
bool test_assign_with_expand_bwd()
{
   ...
   for(std::size_t iteration = 0; iteration <Iterations; ++iteration)
   {
      ...
      BOOST_CATCH(...){
         delete [](const_cast<typename zr_boost_1_81::interprocess::ipcdetail::remove_volatile<value_type>::type*>(memory));
         BOOST_RETHROW
      } BOOST_CATCH_END
      delete [](const_cast<typename zr_boost_1_81::interprocess::ipcdetail::remove_volatile<value_type>::type*>(memory));
   }
