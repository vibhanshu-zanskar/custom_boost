...
bool test_pointer_traits()
{
   ...
   typedef zr_boost_1_81::intrusive::pointer_traits< OInt > PTOInt;
   ...
   int dummy;
   OInt oi(&dummy);
   if(zr_boost_1_81::intrusive::pointer_traits<OInt>::pointer_to(dummy) != oi){
      return false;
   }
   return true;
}
...
{
   BOOST_STATIC_ASSERT((zr_boost_1_81::intrusive::max_pointer_plus_bits< offset_ptr<void>, zr_boost_1_81::move_detail::alignment_of<node>::value >::value >= 1U));
   typedef zr_boost_1_81::intrusive::pointer_plus_bits< offset_ptr<node>, 1u > ptr_plus_bits;
