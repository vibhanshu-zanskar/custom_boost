...
int map_test ()
{
   ...
   typedef zr_boost_1_81::interprocess::pair<IntType, IntType>         IntPairType;
   ...
   BOOST_TRY{
      ...
      }
      {
         ...
         for(int i = 0; i < max; ++i){
            shmmap->insert(zr_boost_1_81::move(aux_vect[i]));
            stdmap->insert(StdPairType(i, i));
            shmmultimap->insert(zr_boost_1_81::move(aux_vect3[i]));
      ...
      //Initialize values
      {
         ...
         shmmap->insert(::zr_boost_1_81::make_move_iterator(&aux_vect[0]), ::zr_boost_1_81::make_move_iterator(aux_vect + 50));
         shmmultimap->insert(::zr_boost_1_81::make_move_iterator(&aux_vect3[0]), ::zr_boost_1_81::make_move_iterator(aux_vect3 + 50));
      ...
      }
      {
         ...
         shmmap->insert(::zr_boost_1_81::make_move_iterator(&aux_vect[0]), ::zr_boost_1_81::make_move_iterator(aux_vect + 50));
         shmmap->insert(::zr_boost_1_81::make_move_iterator(&aux_vect3[0]), ::zr_boost_1_81::make_move_iterator(aux_vect3 + 50));
         shmmultimap->insert(::zr_boost_1_81::make_move_iterator(&aux_vect4[0]), ::zr_boost_1_81::make_move_iterator(aux_vect4 + 50));
         shmmultimap->insert(::zr_boost_1_81::make_move_iterator(&aux_vect5[0]), ::zr_boost_1_81::make_move_iterator(aux_vect5 + 50));
...

      {
         ...
         for(int i = 0; i < max; ++i){
            ...
            shmmap->insert(shmmap->begin(), zr_boost_1_81::move(intpair));
            ...
            shmmultimap->insert(shmmultimap->begin(), zr_boost_1_81::move(intpair));
            ...
            shmmap->insert(shmmap->end(), zr_boost_1_81::move(intpair));
            ...
            shmmultimap->insert(shmmultimap->end(), zr_boost_1_81::move(intpair));
            ...
            shmmap->insert(shmmap->lower_bound(IntType(i)), zr_boost_1_81::move(intpair));
            ...
            {
               IntType i1(i);
               shmmultimap->insert(shmmultimap->lower_bound(zr_boost_1_81::move(i1)), zr_boost_1_81::move(intpair));
            ...
            {
               IntType i1(i);
               shmmap->insert(shmmap->upper_bound(zr_boost_1_81::move(i1)), zr_boost_1_81::move(intpair));
            ...
            {
               IntType i1(i);
               shmmultimap->insert(shmmultimap->upper_bound(zr_boost_1_81::move(i1)), zr_boost_1_81::move(intpair));
         ...
         for(int i = 0; i < 100; ++i){
            ...
            shmmap->insert(zr_boost_1_81::move(intpair));
            {
               IntType i1(i), i2(i);
               new(&intpair)IntPairType(zr_boost_1_81::move(i1), zr_boost_1_81::move(i2));
            }
            shmmultimap->insert(zr_boost_1_81::move(intpair));
...
int map_test_copyable ()
{
   ...
   for(i = 0; i < max; ++i){
      ...
      shmmap->insert(zr_boost_1_81::move(intpair1));
      stdmap->insert(StdPairType(i, i));
      }
      {
      IntType i1(i), i2(i);
      IntPairType intpair2(zr_boost_1_81::move(i1), zr_boost_1_81::move(i2));
      shmmultimap->insert(zr_boost_1_81::move(intpair2));
      stdmultimap->insert(StdPairType(i, i));
      }
   }
