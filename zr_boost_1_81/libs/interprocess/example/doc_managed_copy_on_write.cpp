...
int main()
{
   ...
   std::string managed_file_name(zr_boost_1_81::interprocess::ipcdetail::get_temporary_path());
   managed_file_name += "/"; managed_file_name += test::get_process_id_name();
   ManagedFile = managed_file_name.c_str();
   std::string managed_file2_name(zr_boost_1_81::interprocess::ipcdetail::get_temporary_path());
