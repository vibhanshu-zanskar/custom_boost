...
#include <boost/unordered_map.hpp>     //zr_boost_1_81::unordered_map
...
int main ()
{
   ...
   typedef zr_boost_1_81::unordered_map
      < KeyType               , MappedType
      , zr_boost_1_81::hash<KeyType>  ,std::equal_to<KeyType>
      , ShmemAllocator>
   MyHashMap;
   ...
   MyHashMap *myhashmap = segment.construct<MyHashMap>("MyHashMap")  //object name
      ( 3u, zr_boost_1_81::hash<int>(), std::equal_to<int>()                  //
