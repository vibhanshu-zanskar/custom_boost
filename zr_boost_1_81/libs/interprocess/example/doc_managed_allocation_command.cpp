...
int main()
{
   ...
   std::size_t *ptr = managed_shm.allocation_command<std::size_t>
      (zr_boost_1_81::interprocess::allocate_new, min_size, first_received_size, hint);
   ...
   std::size_t * ret = managed_shm.allocation_command
      (zr_boost_1_81::interprocess::expand_fwd, min_size, expanded_size, ptr);
   //<-
   (void)ret;
   //->
   //Check invariants
   ...
   ret = managed_shm.allocation_command
      (zr_boost_1_81::interprocess::shrink_in_place, min_size*2, shrunk_size, ptr);
