...
BOOST_STATIC_ASSERT(sizeof(LONG) == sizeof(zr_boost_1_81::int32_t));
...
void scoped_static_mutex_lock::lock()
{
   if(0 == m_have_lock)
   {
      ...
      while(0 != InterlockedCompareExchange(reinterpret_cast<void**>((zr_boost_1_81::uint_least16_t*)&(m_mutex.m_mutex)), (void*)1, 0))
#else
...
zr_boost_1_81::recursive_mutex* static_mutex::m_pmutex = 0;
zr_boost_1_81::once_flag static_mutex::m_once = BOOST_ONCE_INIT;

extern "C" BOOST_REGEX_DECL void zr_boost_1_81_regex_free_static_mutex()
{
...
{
   m_pmutex = new zr_boost_1_81::recursive_mutex();
   int r = atexit(zr_boost_1_81_regex_free_static_mutex);
   BOOST_ASSERT(0 == r);
}
...
void scoped_static_mutex_lock::lock()
{
   if(0 == m_have_lock)
   {
       zr_boost_1_81::call_once(static_mutex::m_once,&static_mutex::init);
      if(0 == m_plock)
         m_plock = new zr_boost_1_81::unique_lock<zr_boost_1_81::recursive_mutex>(*static_mutex::m_pmutex, zr_boost_1_81::defer_lock);
      m_plock->lock();
      m_have_lock = true;
   }
}
