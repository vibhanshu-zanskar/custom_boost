...
{
    QGuiApplication app(zr_boost_1_81::unit_test::framework::master_test_suite().argc,
                        zr_boost_1_81::unit_test::framework::master_test_suite().argv);
    QQuickView view;

    QString fileName(zr_boost_1_81::unit_test::framework::master_test_suite().argv[1]);
