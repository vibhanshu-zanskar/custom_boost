...
class move_iterator
{
   ...
   typedef typename zr_boost_1_81::movelib::iterator_traits<iterator_type>::value_type        value_type;
   #if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES) || defined(BOOST_MOVE_DOXYGEN_INVOKED)
   typedef value_type &&                                                   reference;
   #else
   typedef typename ::zr_boost_1_81::move_detail::if_
      < ::zr_boost_1_81::has_move_emulation_enabled<value_type>
      , ::zr_boost_1_81::rv<value_type>&
      , value_type & >::type                                               reference;
   #endif
   typedef It                                                              pointer;
   typedef typename zr_boost_1_81::movelib::iterator_traits<iterator_type>::difference_type   difference_type;
   typedef typename zr_boost_1_81::movelib::iterator_traits<iterator_type>::iterator_category iterator_category;
   ...
   BOOST_MOVE_FORCEINLINE reference operator*() const
   {
      ...
      return *m_it;
      #else
      return ::zr_boost_1_81::move(*m_it);
      #endif
   }
   ...
   BOOST_MOVE_FORCEINLINE reference operator[](difference_type n) const
   {
      ...
      return m_it[n];
      #else
      return ::zr_boost_1_81::move(m_it[n]);
      #endif
   }
...
template <class I>
struct is_move_iterator< ::zr_boost_1_81::move_iterator<I> >
{
...
class back_move_insert_iterator
{
   ...
   { container_m->push_back(zr_boost_1_81::move(x)); return *this; }
...
public:
   ...
   { container_m->push_front(zr_boost_1_81::move(x)); return *this; }
...
class move_insert_iterator
{
   ...
   {
      pos_ = container_m->insert(pos_, ::zr_boost_1_81::move(x));
      ++pos_;
      return *this;
   }
