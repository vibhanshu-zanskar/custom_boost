   ...
   (InputIt1 first1, InputIt1 last1, InputIt2 first2, InputIt2 last2, OutputIt result, Compare comp)
{
   while (first1 != last1) {
      if (first2 == last2)
         return zr_boost_1_81::move_detail::copy(first1, last1, result);
   ...
   while (first1 != last1) {
      ...
      if (first2 == last2){
         ...
         if (!comp(*first2, *first1)) {
            ...
            return zr_boost_1_81::movelib::set_difference
               ( zr_boost_1_81::make_move_iterator(++first1)
               , zr_boost_1_81::make_move_iterator(last1)
      ...
      if (first2 == last2){
         ...
         while (++first1 != last1) {
            if (comp(*result, *first1) && ++result != first1) {
               *result = zr_boost_1_81::move(*first1);
            }
         }
         return ++result;
      }
         ...
         if (++first1 != last1 && !comp(*result, *first1)) {
            ...
            return zr_boost_1_81::movelib::set_unique_difference
               ( zr_boost_1_81::make_move_iterator(first1)
               , zr_boost_1_81::make_move_iterator(last1)
               , first2, last2, ++result, comp);
         }
