...
// @endcond
   ...
   class BOOST_RV_ATTRIBUTE_MAY_ALIAS rv
      : public ::zr_boost_1_81::move_detail::if_c
         < ::zr_boost_1_81::move_detail::is_class<T>::value
         , T
         , ::zr_boost_1_81::move_detail::nat
         >::type
   {
      rv();
      ~rv() throw();
   ...
   struct is_rv
      ...
      : integral_constant<bool, ::zr_boost_1_81::move_detail::is_rv_impl<T>::value >
   {};
   ...
   struct has_move_emulation_enabled
      : ::zr_boost_1_81::move_detail::has_move_emulation_enabled_impl<T>
   {};

   template<class T>
   struct has_move_emulation_disabled
   {
      static const bool value = !::zr_boost_1_81::move_detail::has_move_emulation_enabled_impl<T>::value;
   };

   }  //namespace zr_boost_1_81 {

   #define BOOST_RV_REF(TYPE)\
      ::zr_boost_1_81::rv< TYPE >& \
   //

   #define BOOST_RV_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      ::zr_boost_1_81::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_RV_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      ::zr_boost_1_81::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   #define BOOST_COPY_ASSIGN_REF(TYPE)\
      const ::zr_boost_1_81::rv< TYPE >& \
   //

   #define BOOST_COPY_ASSIGN_REF_BEG \
      const ::zr_boost_1_81::rv<  \
   //
   ...
   #define BOOST_COPY_ASSIGN_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      const ::zr_boost_1_81::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_COPY_ASSIGN_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      const ::zr_boost_1_81::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   BOOST_MOVE_FORCEINLINE typename ::zr_boost_1_81::move_detail::enable_if_c
      <  ::zr_boost_1_81::move_detail::is_lvalue_reference<Ret>::value ||
        !::zr_boost_1_81::has_move_emulation_enabled<T>::value
      , T&>::type
   ...
   BOOST_MOVE_FORCEINLINE typename ::zr_boost_1_81::move_detail::enable_if_c
      < !::zr_boost_1_81::move_detail::is_lvalue_reference<Ret>::value &&
         ::zr_boost_1_81::has_move_emulation_enabled<T>::value
      , ::zr_boost_1_81::rv<T>&>::type
         move_return(::zr_boost_1_81::rv<T>& x) BOOST_NOEXCEPT
   {
      return x;
   }

   template <class T>
   BOOST_MOVE_FORCEINLINE T& unrv(::zr_boost_1_81::rv<T> &rv) BOOST_NOEXCEPT
   ...
   #define BOOST_MOVE_RET(RET_TYPE, REF)\
      zr_boost_1_81::move_detail::move_return< RET_TYPE >(REF)
   //

   #define BOOST_MOVE_BASE(BASE_TYPE, ARG) \
      ::zr_boost_1_81::move((BASE_TYPE&)(ARG))
   //

   #define BOOST_MOVE_TO_LV(ARG) \
      ::zr_boost_1_81::move_detail::unrv(ARG)
   //
   ...
   #define BOOST_MOVABLE_BUT_NOT_COPYABLE(TYPE)\
      ...
      public:\
      BOOST_MOVE_FORCEINLINE operator ::zr_boost_1_81::rv<TYPE>&() \
      {  return *BOOST_MOVE_TO_RV_CAST(::zr_boost_1_81::rv<TYPE>*, this);  }\
      BOOST_MOVE_FORCEINLINE operator const ::zr_boost_1_81::rv<TYPE>&() const \
      {  return *BOOST_MOVE_TO_RV_CAST(const ::zr_boost_1_81::rv<TYPE>*, this);  }\
      private:\
   //
   ...
   template< class T>
   struct forward_type< zr_boost_1_81::rv<T> >
   { typedef T type; };
   ...
   //!cast to the base type before calling `::zr_boost_1_81::move()` due to rvalue reference limitations.
   //!
