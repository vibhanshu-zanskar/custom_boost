...
#include <boost/move/traits.hpp>
   ...
   BOOST_MOVE_FORCEINLINE typename ::zr_boost_1_81::move_detail::enable_if_c
      ...
      , typename ::zr_boost_1_81::move_detail::add_const<T>::type &
      >::type
   ...
   BOOST_MOVE_FORCEINLINE typename ::zr_boost_1_81::move_detail::enable_if_c
      < enable_move_utility_emulation<T>::value && has_move_emulation_enabled<T>::value
            && ::zr_boost_1_81::move_detail::is_nothrow_move_constructible_or_uncopyable<T>::value, rv<T>&>::type
         move_if_noexcept(T& x) BOOST_NOEXCEPT
   {
      return *static_cast<rv<T>* >(::zr_boost_1_81::move_detail::addressof(x));
   }

   template <class T>
   BOOST_MOVE_FORCEINLINE typename ::zr_boost_1_81::move_detail::enable_if_c
      < enable_move_utility_emulation<T>::value && has_move_emulation_enabled<T>::value
            && ::zr_boost_1_81::move_detail::is_nothrow_move_constructible_or_uncopyable<T>::value
      , rv<T>&
      >::type
         ...
         move_if_noexcept(rv<T>& x) BOOST_NOEXCEPT
   {
      ...
      //////////////////////////////////////////////////////////////////////////////
         ...
         //! <i>::zr_boost_1_81::rv<T> &</i> so that move emulation is activated. Reference
         ...
         template <class T>
         BOOST_MOVE_FORCEINLINE typename ::zr_boost_1_81::move_detail::enable_if_c
            < ::zr_boost_1_81::move_detail::is_nothrow_move_constructible_or_uncopyable<T>::value, T&&>::type
               move_if_noexcept(T& x) BOOST_NOEXCEPT
         {  return ::zr_boost_1_81::move(x);   }

         template <class T>
         BOOST_MOVE_FORCEINLINE typename ::zr_boost_1_81::move_detail::enable_if_c
            < !::zr_boost_1_81::move_detail::is_nothrow_move_constructible_or_uncopyable<T>::value, const T&>::type
               move_if_noexcept(T& x) BOOST_NOEXCEPT
         {  return x;  }
