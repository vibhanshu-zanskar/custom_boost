...
{
   typedef typename zr_boost_1_81::movelib::detail::first_param<Ptr>::type type;
};
...
{
   typedef typename ::zr_boost_1_81::movelib::detail::pointer_element_impl<Ptr>::type type;
};
