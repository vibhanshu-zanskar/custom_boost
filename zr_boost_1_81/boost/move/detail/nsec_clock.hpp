...
//  Boost.Timer depends on Boost.Chorno wich uses zr_boost_1_81::throw_exception.
//  And Boost.Chrono DLLs don't build in Win32 as there is no 
//  zr_boost_1_81::throw_exception(std::exception const&) implementation
//  in Boost.Chrono:
//
...
namespace zr_boost_1_81 { namespace move_detail {
...
struct QPFHolder
{
   static inline double get_nsec_per_tic()
   {
      ...
      zr_boost_1_81::winapi::BOOL_ r = zr_boost_1_81::winapi::QueryPerformanceFrequency( &freq );
      zr_boost_1_81::ignore_unused(r);
...
inline zr_boost_1_81::uint64_t nsec_clock() BOOST_NOEXCEPT
{
   ...
   return static_cast<zr_boost_1_81::uint64_t>(nanosecs_per_tic * double(pcount.QuadPart));
}
...
inline zr_boost_1_81::uint64_t nsec_clock() BOOST_NOEXCEPT
{
   zr_boost_1_81::uint64_t count = ::mach_absolute_time();
...
inline zr_boost_1_81::uint64_t nsec_clock() BOOST_NOEXCEPT
{
   ...
   zr_boost_1_81::uint64_t r = static_cast<zr_boost_1_81::uint64_t>(count.tv_sec);
   r *= 1000000000U;
   r += static_cast<zr_boost_1_81::uint64_t>(count.tv_nsec);
   return r;
}
...
typedef zr_boost_1_81::uint64_t nanosecond_type;
...
inline void get_cpu_times(zr_boost_1_81::move_detail::cpu_times& current)
{
