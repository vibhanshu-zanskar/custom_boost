...
//Forward declare zr_boost_1_81::rv
...
struct has_move_emulation_enabled_impl
   : is_convertible< T, ::zr_boost_1_81::rv<T>& >
{};
...
template<class T>
struct has_move_emulation_enabled_impl< ::zr_boost_1_81::rv<T> >
{  static const bool value = false;  };
...
template< class T >
struct is_rvalue_reference< zr_boost_1_81::rv<T>& >
{  static const bool value = true;  };

template< class T >
struct is_rvalue_reference< const zr_boost_1_81::rv<T>& >
{  static const bool value = true;  };
...
namespace detail_add_rvalue_reference
{
   ...
   struct add_rvalue_reference_impl< T, true, rv > { typedef ::zr_boost_1_81::rv<T>& type; };
} // namespace detail_add_rvalue_reference
