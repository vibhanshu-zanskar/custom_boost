...
@code
class u {
    friend class zr_boost_1_81::contract::access;
...
public:
    static void f(...) {
        ...
        zr_boost_1_81::contract::check c = zr_boost_1_81::contract::public_function<u>()
...
specify_precondition_old_postcondition_except<> public_function() {
        ...
        return specify_precondition_old_postcondition_except<>(
            new zr_boost_1_81::contract::detail::static_public_function<Class>());
    #else
        return specify_precondition_old_postcondition_except<>();
    #endif
}
...
public:
    void f(...) {
        zr_boost_1_81::contract::old_ptr<old_type> old_var;
        zr_boost_1_81::contract::check c = zr_boost_1_81::contract::public_function(this)
            .precondition([&] { // Optional.
                BOOST_CONTRACT_ASSERT(...);
                ...
            })
...
specify_precondition_old_postcondition_except<> public_function(Class* obj) {
    #if BOOST_CONTRACT_PUBLIC_FUNCTIONS_IMPL_
        return specify_precondition_old_postcondition_except<>(
            new zr_boost_1_81::contract::detail::public_function<
                zr_boost_1_81::contract::detail::none,
                zr_boost_1_81::contract::detail::none,
                zr_boost_1_81::contract::detail::none,
                Class
            ...
            >(
                static_cast<zr_boost_1_81::contract::virtual_*>(0),
                obj,
                zr_boost_1_81::contract::detail::none::value()
                BOOST_CONTRACT_DETAIL_NO_TVARIADIC_COMMA(
                        BOOST_CONTRACT_MAX_ARGS)
                BOOST_CONTRACT_DETAIL_NO_TVARIADIC_ENUM_Z(1,
                    BOOST_CONTRACT_MAX_ARGS,
...
/** @endcond */
    ...
    public:
        void f(..., zr_boost_1_81::contract::virtual_* v = 0) {
            zr_boost_1_81::contract::old_ptr<old_type> old_var;
            zr_boost_1_81::contract::check c = zr_boost_1_81::contract::public_function(v, this)
                .precondition([&] { // Optional.
                    BOOST_CONTRACT_ASSERT(...);
                    ...
                })
    ...
    @RefFunc{zr_boost_1_81::contract::public_function} otherwise this library will not
    ...
    @param v    The trailing parameter of type
                @RefClass{zr_boost_1_81::contract::virtual_}<c>*</c> and default value
    ...
    */
    ...
    public:
        t f(..., zr_boost_1_81::contract::virtual_* v = 0) {
            t result;
            zr_boost_1_81::contract::old_ptr<old_type> old_var;
            zr_boost_1_81::contract::check c = zr_boost_1_81::contract::public_function(
                    v, result, this)
                .precondition([&] { // Optional.
                    BOOST_CONTRACT_ASSERT(...);
                    ...
    ...
    @tparam VirtualResult   This type must be the same as, or compatible with,
                            ...
                            Alternatively,
                            <c>zr_boost_1_81::optional<<i>return-type</i>></c> can also
                            be used (see
        ...
        BOOST_PP_IIF(BOOST_CONTRACT_PUBLIC_FUNCTIONS_IMPL_, \
            { /* extra scope paren to expand STATIC_STATIC emu on same line */ \
                ...
                BOOST_STATIC_ASSERT_MSG( \
                    ...
                    ( \
                        zr_boost_1_81::function_types::function_arity<F>::value - 2 \
                    == \
            ...
            { /* extra scope paren to expand STATIC_STATIC emu on same line */ \
                ...
                , \
                    ...
                    (zr_boost_1_81::is_same< \
                        typename zr_boost_1_81::remove_reference<typename zr_boost_1_81:: \
                                function_types::result_type<F>::type>::type, \
                        typename zr_boost_1_81::contract::detail:: \
            ...
            { /* extra scope paren to expand STATIC_STATIC emu on same line */ \
                ...
                BOOST_STATIC_ASSERT_MSG( \
                    zr_boost_1_81::contract::access::has_base_types<Class>::value, \
...
/** @endcond */
    ...
    @code
    class u
        #define BASES private zr_boost_1_81::contract::constructor_precondition<u>, \
                public b, private w
        : BASES
    {
        friend class zr_boost_1_81::contract::access;
    ...
    public:
        // Override from `b::f`.
        void f(t_1 a_1, ..., t_n a_n, zr_boost_1_81::contract::virtual_* v = 0) {
            zr_boost_1_81::contract::old_ptr<old_type> old_var;
            zr_boost_1_81::contract::check c = zr_boost_1_81::contract::public_function<
    ...
    @tparam Args    The types of all parameters passed to the enclosing public
                    ...
                    trailing parameter type <c>zr_boost_1_81::contract::virtual_*</c>.
    ...
    */
    ...
    public:
        // Override from `b::f`.
        t f(t_1 a_1, ..., t_n a_n, zr_boost_1_81::contract::virtual_* v = 0) {
            t result;
            zr_boost_1_81::contract::old_ptr<old_type> old_var;
            zr_boost_1_81::contract::check c = zr_boost_1_81::contract::public_function<
