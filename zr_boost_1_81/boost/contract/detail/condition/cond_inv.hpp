...
class cond_inv : public cond_post<VR> { // Non-copyable base.
        ...
        BOOST_STATIC_ASSERT_MSG(
            (!zr_boost_1_81::contract::access::has_static_invariant_f<
                C, void, zr_boost_1_81::mpl:: vector<>
            >::value),
        ...
        BOOST_STATIC_ASSERT_MSG(
            (!zr_boost_1_81::contract::access::has_invariant_s<
                C, void, zr_boost_1_81::mpl::vector<>
            >::value),
        ...
        BOOST_STATIC_ASSERT_MSG(
            (!zr_boost_1_81::contract::access::has_invariant_f<
                C, void, zr_boost_1_81::mpl::vector<>,
                        zr_boost_1_81::function_types::non_cv
            >::value),
...
public:
    ...
    explicit cond_inv(zr_boost_1_81::contract::from from, C* obj) :
        cond_post<VR>(from)
...
private:
            ...
            try {
                ...
                if(!static_only) {
                    if(const_and_cv) {
                        check_cv_inv<C>();
                        check_const_inv<C>();
                    } else if(zr_boost_1_81::is_volatile<C>::value) {
                        check_cv_inv<C>();
                    } else {
                        check_const_inv<C>();
                    }
                ...
                if(on_entry) {
                    this->fail(&zr_boost_1_81::contract::entry_invariant_failure);
                } else this->fail(&zr_boost_1_81::contract::exit_invariant_failure);
            }
        }
        
        template<class C_>
        typename zr_boost_1_81::disable_if<
                zr_boost_1_81::contract::access::has_const_invariant<C_> >::type
        check_const_inv() {}
        
        template<class C_>
        typename zr_boost_1_81::enable_if<
                zr_boost_1_81::contract::access::has_const_invariant<C_> >::type
        check_const_inv() { zr_boost_1_81::contract::access::const_invariant(obj_); }
        
        template<class C_>
        typename zr_boost_1_81::disable_if<
                zr_boost_1_81::contract::access::has_cv_invariant<C_> >::type
        check_cv_inv() {}

        template<class C_>
        typename zr_boost_1_81::enable_if<
                zr_boost_1_81::contract::access::has_cv_invariant<C_> >::type
        check_cv_inv() { zr_boost_1_81::contract::access::cv_invariant(obj_); }
        
        template<class C_>
        typename zr_boost_1_81::disable_if<
                zr_boost_1_81::contract::access::has_static_invariant<C_> >::type
        check_static_inv() {}
        ...
        check_static_inv() {
            ...
            if(!inherited<zr_boost_1_81::contract::access::has_static_invariant,
                    zr_boost_1_81::contract::access::static_invariant_addr>::apply()) {
                zr_boost_1_81::contract::access::static_invariant<C_>();
            }
        }
        ...
        struct inherited {
            static bool apply() {
                try {
                    zr_boost_1_81::mpl::for_each<
                        // For now, no reason to deeply search inheritance tree
                        // (SFINAE HAS_STATIC_... already fails in that case).
                        typename zr_boost_1_81::mpl::transform<
                            typename zr_boost_1_81::mpl::copy_if<
                                typename zr_boost_1_81::mpl::eval_if<zr_boost_1_81::contract::
                                        access::has_base_types<C>,
                                    typename zr_boost_1_81::contract::access::
                                            base_types_of<C>
                                ,
                                    zr_boost_1_81::mpl::vector<>
                                >::type,
                                HasFunc<zr_boost_1_81::mpl::_1>
                            >::type,
                            zr_boost_1_81::add_pointer<zr_boost_1_81::mpl::_1>
                        >::type
                    >(compare_func_addr());
