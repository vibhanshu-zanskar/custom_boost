...
{ // Non-copyable base.
    #ifndef BOOST_CONTRACT_NO_CONDITIONS
        template<class Class, typename Result = zr_boost_1_81::mpl::vector<> >
        class overridden_bases_of {
            struct search_bases {
                typedef typename zr_boost_1_81::mpl::fold<
                    typename zr_boost_1_81::contract::access::base_types_of<Class>::
                            type,
                    Result,
                    // Fold: _1 = result, _2 = current base from base_types.
                    zr_boost_1_81::mpl::eval_if<zr_boost_1_81::mpl::contains<zr_boost_1_81::mpl::_1,
                            zr_boost_1_81::add_pointer<zr_boost_1_81::mpl::_2> >,
                        zr_boost_1_81::mpl::_1 // Base in result, do not add it again.
                    ,
                        ...
                        ,
                            zr_boost_1_81::mpl::push_back<
                                overridden_bases_of<zr_boost_1_81::mpl::_2,
                                        zr_boost_1_81::mpl::_1>,
                                // Bases as * since for_each constructs them.
                                zr_boost_1_81::add_pointer<zr_boost_1_81::mpl::_2>
                            >
                        ,
                            overridden_bases_of<zr_boost_1_81::mpl::_2, zr_boost_1_81::mpl::_1>
                        >
                    >
                >::type type;
            };
        public:
            typedef typename zr_boost_1_81::mpl::eval_if<
                    zr_boost_1_81::contract::access::has_base_types<Class>,
                search_bases
            ,
                zr_boost_1_81::mpl::identity<Result> // Return result (stop recursion).
            >::type type;
        };
        
        typedef typename zr_boost_1_81::mpl::eval_if<zr_boost_1_81::is_same<O, none>,
        ...
        >::type overridden_bases;
            ...
            BOOST_STATIC_ASSERT_MSG(
                (zr_boost_1_81::mpl::or_<
                    zr_boost_1_81::is_same<O, none>,
                    zr_boost_1_81::mpl::not_<zr_boost_1_81::mpl::empty<overridden_bases> >
                >::value),
        ...
        #endif
    #else
        typedef zr_boost_1_81::mpl::vector<> overridden_bases;
    #endif

public:
    explicit cond_subcontracting(
        zr_boost_1_81::contract::from from,
        zr_boost_1_81::contract::virtual_* v,
        C* obj,
        VR&
        ...
        #endif
    {
            ...
            if(v) {
                ...
                base_call_ = false;
                if(!zr_boost_1_81::mpl::empty<overridden_bases>::value) {
                    v_ = new zr_boost_1_81::contract::virtual_(
                            zr_boost_1_81::contract::virtual_::no_action);
                    #ifndef BOOST_CONTRACT_NO_POSTCONDITIONS
                        v_->result_ptr_ = &r_;
...
protected:
        ...
        void init_subcontracted_old() {
            ...
            exec_and(zr_boost_1_81::contract::virtual_::push_old_init_copy);
        }
    #endif
    
    #ifndef BOOST_CONTRACT_NO_ENTRY_INVARIANTS
        void check_subcontracted_entry_inv() {
            exec_and(zr_boost_1_81::contract::virtual_::check_entry_inv,
        ...
        void check_subcontracted_pre() {
            exec_or(
                zr_boost_1_81::contract::virtual_::check_pre,
                &cond_subcontracting::check_pre,
                &zr_boost_1_81::contract::precondition_failure
            );
        }
    #endif
        ...
        void copy_subcontracted_old() {
            exec_and(zr_boost_1_81::contract::virtual_::call_old_ftor,
        ...
        void check_subcontracted_exit_inv() {
            exec_and(zr_boost_1_81::contract::virtual_::check_exit_inv,
        ...
        void check_subcontracted_post() {
            exec_and(zr_boost_1_81::contract::virtual_::check_post,
        ...
        void check_subcontracted_except() {
            exec_and(zr_boost_1_81::contract::virtual_::check_except,
...
private:
        ...
        void copy_virtual_old() {
            zr_boost_1_81::contract::virtual_::action_enum a;
            if(base_call_) {
                a = v_->action_;
        ...
        void pop_base_old() {
            if(base_call_) {
                zr_boost_1_81::contract::virtual_::action_enum a = v_->action_;
        ...
        void check_virtual_post() {
            pop_base_old();
            typedef typename zr_boost_1_81::remove_reference<typename
                    optional_value_type<VR>::type>::type r_type;
            zr_boost_1_81::optional<r_type const&> r; // No result copy in this code.
            if(!base_call_) r = optional_get(r_);
            else if(v_->result_optional_) {
                try {
                    r = **zr_boost_1_81::any_cast<zr_boost_1_81::optional<r_type>*>(
                            v_->result_ptr_);
                } catch(zr_boost_1_81::bad_any_cast const&) {
                    try { // Handle optional<...&>.
                        r = **zr_boost_1_81::any_cast<zr_boost_1_81::optional<r_type&>*>(
                                v_->result_ptr_);
                    } catch(zr_boost_1_81::bad_any_cast const&) {
                        try {
                            throw zr_boost_1_81::contract::bad_virtual_result_cast(v_->
                                    result_type_name_, typeid(r_type).name());
                        } catch(...) {
                            this->fail(&zr_boost_1_81::contract::postcondition_failure);
                        }
                    }
                }
            } else {
                try {
                    r = *zr_boost_1_81::any_cast<r_type*>(v_->result_ptr_);
                } catch(zr_boost_1_81::bad_any_cast const&) {
                    try {
                        throw zr_boost_1_81::contract::bad_virtual_result_cast(
        ...
        typename zr_boost_1_81::enable_if<is_optional<R_> >::type
        check_virtual_post_with_result(Result const& r) {
            this->check_post(r);
        }
        
        template<typename R_, typename Result>
        typename zr_boost_1_81::disable_if<is_optional<R_> >::type
        check_virtual_post_with_result(Result const& r) {
        ...
        void exec_and( // Execute action in short-circuit logic-and with bases.
            ...
            if(!base_call_ || v_->action_ == a) {
                if(!base_call_ && v_) {
                    v_->action_ = a;
                    zr_boost_1_81::mpl::for_each<overridden_bases>(call_base(*this));
                }
                if(f) (this->*f)();
                if(base_call_) {
        ...
        void exec_or( // Execute action in short-circuit logic-or with bases.
            ...
            void (*h)(zr_boost_1_81::contract::from) = 0
        ) {
            if(failed()) return;
            if(!base_call_ || v_->action_ == a) {
                if(!base_call_ && v_) {
        ...
        typename zr_boost_1_81::enable_if<zr_boost_1_81::mpl::empty<Bases>, bool>::type
        exec_or_bases() { return false; }

        template<typename Bases>
        typename zr_boost_1_81::disable_if<zr_boost_1_81::mpl::empty<Bases>, bool>::type
        exec_or_bases() {
            if(zr_boost_1_81::mpl::empty<Bases>::value) return false;
            try {
                call_base(*this)(typename zr_boost_1_81::mpl::front<Bases>::type());
            } catch(cond_subcontracting_::signal_not_checked const&) {
                return exec_or_bases<
                        typename zr_boost_1_81::mpl::pop_front<Bases>::type>();
            } catch(...) {
                bool checked = false;
                try {
    ...
    #endif
    #ifndef BOOST_CONTRACT_NO_CONDITIONS
        zr_boost_1_81::contract::virtual_* v_;
        bool base_call_;
