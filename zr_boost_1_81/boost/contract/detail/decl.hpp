...
#define BOOST_CONTRACT_DETAIL_DECL_OVERRIDING_PUBLIC_FUNCTION_Z(z, \
    ...
    zr_boost_1_81::contract::specify_precondition_old_postcondition_except< \
            BOOST_PP_EXPR_IIF(has_result, VR)> \
    /* no zr_boost_1_81::contract:: here for friends (otherwise need fwd decl) */ \
    public_function( \
...
#define BOOST_CONTRACT_DETAIL_DECL_DETAIL_COND_SUBCONTRACTING_Z( \
    ...
    BOOST_PP_IIF(is_friend, \
        friend class zr_boost_1_81::contract::detail:: \
    , \
        class \
    ) \
    cond_subcontracting
