...
#define BOOST_CONTRACT_DETAIL_MIRROR_END_(tparam) \
        template<typename> \
        static zr_boost_1_81::contract::detail::mirror::no& apply(...); \
    public: \
        static bool const value = sizeof(apply<tparam>(0)) == \
                sizeof(zr_boost_1_81::contract::detail::mirror::yes); \
...
#define BOOST_CONTRACT_DETAIL_MIRROR_HAS_MEMBER_FUNCTION_(is_static, \
    ...
    template< \
        ...
        class BOOST_CONTRACT_DETAIL_NAME1(G) = zr_boost_1_81::function_types::null_tag \
    > \
    class trait { \
        template<class BOOST_CONTRACT_DETAIL_NAME1(C)> \
        static zr_boost_1_81::contract::detail::mirror::yes& apply( \
            zr_boost_1_81::contract::detail::mirror::check_function< \
                typename \
                    BOOST_PP_IIF(is_static, \
                        zr_boost_1_81::function_types::function_pointer \
                    , \
                        zr_boost_1_81::function_types::member_function_pointer \
                    ) \
                < \
...
namespace zr_boost_1_81 { namespace contract { namespace detail { namespace mirror {
