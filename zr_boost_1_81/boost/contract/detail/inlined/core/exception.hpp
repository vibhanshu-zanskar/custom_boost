...
namespace exception_ {
    ...
    void default_handler() {
        ...
        try { throw; }
        catch(zr_boost_1_81::contract::assertion_failure const& error) {
            ...
            std::cerr << k << "threw following exception:" << std::endl
                    << zr_boost_1_81::current_exception_diagnostic_information();
        }
    ...
    typedef zr_boost_1_81::contract::detail::static_local_var<check_failure_mutex_tag,
            zr_boost_1_81::mutex> check_failure_mutex;

    struct check_failure_handler_tag;
    typedef zr_boost_1_81::contract::detail::static_local_var_init<
    ...
    failure_handler const& set_check_failure_locked(failure_handler const& f)
            BOOST_NOEXCEPT_OR_NOTHROW {
        zr_boost_1_81::lock_guard<zr_boost_1_81::mutex> lock(check_failure_mutex::ref());
    ...
    typedef zr_boost_1_81::contract::detail::static_local_var<pre_failure_mutex_tag,
            zr_boost_1_81::mutex> pre_failure_mutex;
    ...
    from_failure_handler const& set_pre_failure_locked(from_failure_handler
            const& f) BOOST_NOEXCEPT_OR_NOTHROW {
        zr_boost_1_81::lock_guard<zr_boost_1_81::mutex> lock(pre_failure_mutex::ref());
    ...
    typedef zr_boost_1_81::contract::detail::static_local_var<post_failure_mutex_tag,
            zr_boost_1_81::mutex> post_failure_mutex;
    ...
    from_failure_handler const& set_post_failure_locked(from_failure_handler
            const& f) BOOST_NOEXCEPT_OR_NOTHROW {
        zr_boost_1_81::lock_guard<zr_boost_1_81::mutex> lock(post_failure_mutex::ref());
    ...
    typedef zr_boost_1_81::contract::detail::static_local_var<except_failure_mutex_tag,
            zr_boost_1_81::mutex> except_failure_mutex;
    ...
    from_failure_handler const& set_except_failure_locked(from_failure_handler
            const& f) BOOST_NOEXCEPT_OR_NOTHROW {
        zr_boost_1_81::lock_guard<zr_boost_1_81::mutex> lock(except_failure_mutex::ref());
    ...
    typedef zr_boost_1_81::contract::detail::static_local_var<old_failure_mutex_tag,
            zr_boost_1_81::mutex> old_failure_mutex;
    ...
    from_failure_handler const& set_old_failure_locked(from_failure_handler
            const& f) BOOST_NOEXCEPT_OR_NOTHROW {
        zr_boost_1_81::lock_guard<zr_boost_1_81::mutex> lock(old_failure_mutex::ref());
    ...
    typedef zr_boost_1_81::contract::detail::static_local_var<
            entry_inv_failure_mutex_tag, zr_boost_1_81::mutex> entry_inv_failure_mutex;
    ...
    from_failure_handler const& set_entry_inv_failure_locked(
            from_failure_handler const& f) BOOST_NOEXCEPT_OR_NOTHROW {
        zr_boost_1_81::lock_guard<zr_boost_1_81::mutex> lock(entry_inv_failure_mutex::ref());
    ...
    typedef zr_boost_1_81::contract::detail::static_local_var<
            exit_inv_failure_mutex_tag, zr_boost_1_81::mutex> exit_inv_failure_mutex;
    ...
    from_failure_handler const& set_exit_inv_failure_locked(
            from_failure_handler const& f) BOOST_NOEXCEPT_OR_NOTHROW {
        zr_boost_1_81::lock_guard<zr_boost_1_81::mutex> lock(exit_inv_failure_mutex::ref());
