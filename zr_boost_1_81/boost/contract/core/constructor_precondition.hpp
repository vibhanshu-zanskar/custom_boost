...
@code
    ...
    public:
        explicit u(unsigned x) :
            zr_boost_1_81::contract::constructor_precondition<u>([&] {
...
constructor definition just before @RefFunc{zr_boost_1_81::contract::constructor} is
...
public:
    ...
    */
    ...
    explicit constructor_precondition(F const& f) {
            ...
            try {
                #ifndef BOOST_CONTRACT_ALL_DISABLE_NO_ASSERTION
                    if(zr_boost_1_81::contract::detail::checking::already()) return;
                    #ifndef BOOST_CONTRACT_PRECONDITIONS_DISABLE_NO_ASSERTION
                        zr_boost_1_81::contract::detail::checking k;
                    #endif
                #endif
                f();
