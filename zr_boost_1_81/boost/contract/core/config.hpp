...
// BOOST_ALL_NO_LIB
    ...
    */
    ...
    can have and pass to @RefFunc{zr_boost_1_81::contract::public_function} (users can
    ...
    */
    ...
    @li Derived classes that program contracts for one or more public function
        overrides via @RefFunc{zr_boost_1_81::contract::public_function} must also
    ...
    */
    ...
    @RefClass{zr_boost_1_81::contract::check} variable (undefined and executes
    ...
    @RefClass{zr_boost_1_81::contract::check} and without using C++11 @c auto
...
// Ctor pre checked separately and outside RAII so not part of this #define.
    ...
    @note   Constructor preconditions are checked separately by
            @RefClass{zr_boost_1_81::contract::constructor_precondition} so they are
