...
@see    @RefClass{zr_boost_1_81::contract::assertion_failure},
        @RefClass{zr_boost_1_81::contract::bad_virtual_result_cast},
        etc.
*/
...
class BOOST_CONTRACT_DETAIL_DECLSPEC bad_virtual_result_cast : // Copy (as str).
        public std::bad_cast, public zr_boost_1_81::contract::exception {
public:
    /**
...
(@RefFunc{zr_boost_1_81::contract::precondition_failure}, etc.) when this or any other
...
class BOOST_CONTRACT_DETAIL_DECLSPEC assertion_failure : // Copy (as str, etc.).
        public std::exception, public zr_boost_1_81::contract::exception {
public:
    /**
...
@RefEnum{zr_boost_1_81::contract::from}.
...
@see @RefSect{advanced.throw_on_failures__and__noexcept__, Throw on Failure}
*/
typedef zr_boost_1_81::function<void (from)> from_failure_handler;
...
@see @RefSect{advanced.throw_on_failures__and__noexcept__, Throw on Failure}
*/
typedef zr_boost_1_81::function<void ()> failure_handler;
...
@RefFunc{zr_boost_1_81::contract::set_entry_invariant_failure} and
@RefFunc{zr_boost_1_81::contract::set_exit_invariant_failure} with the same functor
parameter @p f.
