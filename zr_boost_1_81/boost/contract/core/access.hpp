...
private: // No public APIs (so users cannot use it directly by mistake).
    ...
    access& operator=(access&);
        ...
        template<class C>
        struct has_cv_invariant : has_invariant_f<C, void, zr_boost_1_81::mpl::vector<>,
                zr_boost_1_81::function_types::cv_qualified> {};
        
        template<class C>
        struct has_const_invariant : has_invariant_f<C, void, zr_boost_1_81::mpl::
                vector<>, zr_boost_1_81::function_types::const_qualified> {};
    ...
    #ifndef BOOST_CONTRACT_NO_INVARIANTS
        template<typename RR, class CC>
        friend class zr_boost_1_81::contract::detail::cond_inv;
    #endif
/** @endcond */
};
