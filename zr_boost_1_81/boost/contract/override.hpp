...
#include <boost/preprocessor/config/config.hpp>
    ...
    template parameter to @RefFunc{zr_boost_1_81::contract::public_function} for public
    function overrides.
    ...
    */
    ...
    #define BOOST_CONTRACT_OVERRIDE_CALL_BASE_(z, arity, arity_compl, \
        ...
        static void BOOST_CONTRACT_DETAIL_NAME1(call_base)( \
            zr_boost_1_81::contract::virtual_* BOOST_CONTRACT_DETAIL_NAME1(v), \
...
as an explicit template parameter to @RefFunc{zr_boost_1_81::contract::public_function}
