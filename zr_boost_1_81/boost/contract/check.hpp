...
value of one of the contract functions @RefFunc{zr_boost_1_81::contract::function},
@RefFunc{zr_boost_1_81::contract::constructor}, @RefFunc{zr_boost_1_81::contract::destructor},
or @RefFunc{zr_boost_1_81::contract::public_function}.
...
public:
    ...
    */
    ...
    @param contract Contract to be checked (usually the return value of
                    @RefFunc{zr_boost_1_81::contract::function} or
                    @RefFunc{zr_boost_1_81::contract::public_function}).
    ...
    */
    ...
    @param contract Contract to be checked (usually the return value of
                    @RefFunc{zr_boost_1_81::contract::function},
                    @RefFunc{zr_boost_1_81::contract::constructor},
                    @RefFunc{zr_boost_1_81::contract::destructor}, or
                    @RefFunc{zr_boost_1_81::contract::public_function}).
...
private:
    ...
    #if !defined(BOOST_CONTRACT_NO_CONDITIONS) || \
            defined(BOOST_CONTRACT_STATIC_LINK)
        zr_boost_1_81::contract::detail::auto_ptr<zr_boost_1_81::contract::detail::cond_base>
                cond_;
    #endif
/** @endcond */
};
