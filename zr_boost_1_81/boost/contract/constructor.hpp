...
@RefClass{zr_boost_1_81::contract::constructor_precondition} to specify preconditions
for constructors):
...
public:
    u(...) {
        ...
        zr_boost_1_81::contract::check c = zr_boost_1_81::contract::constructor(this)
...
specify_old_postcondition_except<> constructor(Class* obj) {
    // Must #if also on ..._PRECONDITIONS here because specify_... is generic.
        ...
        return specify_old_postcondition_except<>(
                new zr_boost_1_81::contract::detail::constructor<Class>(obj));
    #else
        return specify_old_postcondition_except<>();
    #endif
}
