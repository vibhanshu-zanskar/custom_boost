...
class const_multi_array_view :
    public zr_boost_1_81::detail::multi_array::multi_array_impl_base<T,NumDims>
{
  typedef zr_boost_1_81::detail::multi_array::multi_array_impl_base<T,NumDims> super_type;
public: 
  ...
  struct const_array_view {
    typedef zr_boost_1_81::detail::multi_array::const_multi_array_view<T,NDims> type;
  };

  template <std::size_t NDims>
  struct array_view {
    typedef zr_boost_1_81::detail::multi_array::multi_array_view<T,NDims> type;
  };
...
#else
  typename
  disable_if<typename zr_boost_1_81::is_integral<BaseList>::type,void >::type
#endif
  reindex(const BaseList& values) {
    zr_boost_1_81::function_requires<
      CollectionConcept<BaseList> >();
    zr_boost_1_81::detail::multi_array::
  ...
  const element& operator()(IndexList indices) const {
    ...
    return super_type::access_element(zr_boost_1_81::type<const element&>(),
                                      indices,origin(),
  ...
  const_reference operator[](index idx) const {
    return super_type::access(zr_boost_1_81::type<const_reference>(),
                              idx,origin(),
                              shape(),strides(),
                              index_bases());
  }
  ...
  operator[](const zr_boost_1_81::detail::multi_array::
             index_gen<NumDims,NDims>& indices)
    const {
    typedef typename const_array_view<NDims>::type return_type;
    return
      super_type::generate_array_view(zr_boost_1_81::type<return_type>(),
                                      indices,
                                      shape(),
                                      strides(),
                                      index_bases(),
...
public: // should be protected
  ...
  explicit const_multi_array_view(TPtr base,
                           ...
                           const zr_boost_1_81::array<Index,NumDims>& strides): 
  ...
  typedef zr_boost_1_81::array<size_type,NumDims> size_list;
  typedef zr_boost_1_81::array<index,NumDims> index_list;
...
public: 
  ...
  multi_array_view& operator=(const ConstMultiArray& other) {
    function_requires< 
      zr_boost_1_81::multi_array_concepts::
  ...
  element& operator()(const IndexList& indices) {
    zr_boost_1_81::function_requires<
      CollectionConcept<IndexList> >();
    return super_type::access_element(zr_boost_1_81::type<element&>(),
                                      indices,origin(),
  ...
  reference operator[](index idx) {
    return super_type::access(zr_boost_1_81::type<reference>(),
                              idx,origin(),
                              this->shape(),this->strides(),
                              this->index_bases());
  }
...
public:
  typedef zr_boost_1_81::detail::multi_array::multi_array_view<element,N> type;
};
...
class const_array_view_gen {
  typedef typename Array::element element;
public:
  typedef zr_boost_1_81::detail::multi_array::const_multi_array_view<element,N> type;  
};
