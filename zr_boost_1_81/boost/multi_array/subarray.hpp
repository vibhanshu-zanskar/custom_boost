...
public: 
  ...
  sub_array& operator=(const ConstMultiArray& other) {
    function_requires< zr_boost_1_81::multi_array_concepts::ConstMultiArrayConcept< 
...
public:
  typedef zr_boost_1_81::detail::multi_array::sub_array<element,N> type;
};
...
class const_subarray_gen {
  typedef typename Array::element element;
public:
  typedef zr_boost_1_81::detail::multi_array::const_sub_array<element,N> type;  
};
} // namespace zr_boost_1_81
