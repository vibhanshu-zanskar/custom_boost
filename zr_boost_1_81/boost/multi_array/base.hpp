...
// zr_boost_1_81::extents and zr_boost_1_81::indices are now a part of the public
...
public:
  ...
  //
  typedef T element;
  typedef zr_boost_1_81::multi_array<T,NumDims-1> value_type;
...
protected:
  ...
  Reference access(zr_boost_1_81::type<Reference>,index idx,TPtr base,
...
struct mutable_iterator_tag
 : zr_boost_1_81::random_access_traversal_tag, std::input_iterator_tag
{
...
public:
  ...
  struct subarray {
    typedef zr_boost_1_81::detail::multi_array::sub_array<T,NDims> type;
  };

  template <std::size_t NDims>
  struct const_subarray {
    typedef zr_boost_1_81::detail::multi_array::const_sub_array<T,NDims> type;
  };
...
#else
  typedef array_iterator<T,T*,mpl::size_t<NumDims>,reference,
                         zr_boost_1_81::random_access_traversal_tag> iterator;
#endif
  typedef array_iterator<T,T const*,mpl::size_t<NumDims>,const_reference,
                         zr_boost_1_81::random_access_traversal_tag> const_iterator;
...
protected:
  ...
  Reference access_element(zr_boost_1_81::type<Reference>,
  ...
  ArrayRef
  generate_array_view(zr_boost_1_81::type<ArrayRef>,
                      const zr_boost_1_81::detail::multi_array::
    ...
    zr_boost_1_81::array<index,NDims> new_strides;
    zr_boost_1_81::array<index,NDims> new_extents;
