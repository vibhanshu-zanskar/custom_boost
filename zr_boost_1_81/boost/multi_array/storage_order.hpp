...
namespace zr_boost_1_81 {
  ...
  public:
    ...
    general_storage_order(OrderingIter ordering,
      ...
      zr_boost_1_81::detail::multi_array::copy_n(ordering,NumDims,ordering_.begin());
      zr_boost_1_81::detail::multi_array::copy_n(ascending,NumDims,ascending_.begin());
    }
  ...
  protected:
    zr_boost_1_81::array<size_type,NumDims> ordering_;
    zr_boost_1_81::array<bool,NumDims> ascending_;
  };
  ...
  public:
    ...
    operator general_storage_order<NumDims>() const {
      zr_boost_1_81::array<size_type,NumDims> ordering;
      zr_boost_1_81::array<bool,NumDims> ascending;
