...
namespace detail {
  ...
  struct ConstMultiArrayConcept
  {
    ...
    function_requires< zr_boost_1_81_concepts::ForwardTraversalConcept<iterator> >();
    function_requires< zr_boost_1_81_concepts::ReadableIteratorConcept<iterator> >();
    function_requires< zr_boost_1_81_concepts::ForwardTraversalConcept<const_iterator> >();
    function_requires< zr_boost_1_81_concepts::ReadableIteratorConcept<const_iterator> >();
  ...
  struct MutableMultiArrayConcept
  {
    void constraints() {
      ...
      function_requires< zr_boost_1_81_concepts::ForwardTraversalConcept<iterator> >();
      function_requires< zr_boost_1_81_concepts::ReadableIteratorConcept<iterator> >();
      function_requires< zr_boost_1_81_concepts::WritableIteratorConcept<iterator> >();
      function_requires< zr_boost_1_81_concepts::ForwardTraversalConcept<const_iterator> >();
      function_requires< zr_boost_1_81_concepts::ReadableIteratorConcept<const_iterator> >();
      function_requires< zr_boost_1_81::OutputIterator<iterator,value_type> >();
...
namespace detail {
  namespace multi_array { // Old locations for these
    using zr_boost_1_81::multi_array_concepts::ConstMultiArrayConcept;
    using zr_boost_1_81::multi_array_concepts::MutableMultiArrayConcept;
  }
}
