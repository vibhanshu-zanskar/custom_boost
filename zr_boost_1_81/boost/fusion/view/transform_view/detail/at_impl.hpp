    ...
    namespace extension
    {
        ...
        struct at_impl<transform_view_tag>
        {
            ...
            struct apply
            {
                ...
                typedef typename zr_boost_1_81::result_of<F(value_type)>::type type;

                BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED
                static type call(Seq& seq)
                {
                    return seq.f(zr_boost_1_81::fusion::at<N>(seq.seq));
                }
            };
        };
        ...
        struct at_impl<transform_view2_tag>
        {
            ...
            struct apply
            {
                ...
                typedef typename zr_boost_1_81::result_of<F(value1_type, value2_type)>::type type;

                BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED
                static type call(Seq& seq)
                {
                    return seq.f(zr_boost_1_81::fusion::at<N>(seq.seq1), zr_boost_1_81::fusion::at<N>(seq.seq2));
                }
            };
        };
    }
