...
# endif
    ...
    explicit
    vector(U0 && arg0
        , typename zr_boost_1_81::disable_if_c<zr_boost_1_81::is_same<vector, typename zr_boost_1_81::remove_cv_ref<U0>::type>::value, detail::enabler_>::type = detail::enabler
        )
...
# if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES)
        ...
        typename zr_boost_1_81::disable_if_c<
            zr_boost_1_81::is_same<vector, typename zr_boost_1_81::remove_cv_ref<T>::type>::value
          , vector&
        >::type
        operator=(T&& rhs)
        {
