...
namespace zr_boost_1_81 
{
    ...
    struct result_of< zr_boost_1_81::fusion::unfused_typed<F,Seq> const () >
        : zr_boost_1_81::fusion::unfused_typed<F,Seq>::template result< 
            zr_boost_1_81::fusion::unfused_typed<F,Seq> const () >
    { };
    template<class F, class Seq>
    struct result_of< zr_boost_1_81::fusion::unfused_typed<F,Seq>() >
        : zr_boost_1_81::fusion::unfused_typed<F,Seq>::template result< 
            zr_boost_1_81::fusion::unfused_typed<F,Seq> () >
    { };
#endif
    template<class F, class Seq>
    struct tr1_result_of< zr_boost_1_81::fusion::unfused_typed<F,Seq> const () >
        : zr_boost_1_81::fusion::unfused_typed<F,Seq>::template result< 
            zr_boost_1_81::fusion::unfused_typed<F,Seq> const () >
    { };
    template<class F, class Seq>
    struct tr1_result_of< zr_boost_1_81::fusion::unfused_typed<F,Seq>() >
        : zr_boost_1_81::fusion::unfused_typed<F,Seq>::template result< 
            zr_boost_1_81::fusion::unfused_typed<F,Seq> () >
    { };
}
...
#define M(z,i,s)                                                                \
    typename call_param<typename result_of::value_at_c<s,i>::type>::type a##i
            ...
            inline typename zr_boost_1_81::result_of<
...
#undef M
            ...
            struct result< Self const (BOOST_PP_ENUM_PARAMS(N,T)) >
                : zr_boost_1_81::result_of< function_c(arg_vector_t &) > 
            { };

            template <class Self BOOST_PP_ENUM_TRAILING_PARAMS(N,typename T)>
            struct result< Self (BOOST_PP_ENUM_PARAMS(N,T)) >
                : zr_boost_1_81::result_of< function(arg_vector_t &) >
            { };
        };
