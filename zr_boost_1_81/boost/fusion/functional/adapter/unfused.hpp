...
namespace zr_boost_1_81 { namespace fusion
{
      ...
      : public unfused<Function,false>
    {
      ...
      public:
        ...
        typedef typename zr_boost_1_81::result_of<
...
namespace zr_boost_1_81 
{
    ...
    template<class F>
    struct result_of< zr_boost_1_81::fusion::unfused<F> const () >
    {
        typedef typename zr_boost_1_81::fusion::unfused<F>::call_const_0_result type;
    };
    template<class F>
    struct result_of< zr_boost_1_81::fusion::unfused<F>() >
    {
        typedef typename zr_boost_1_81::fusion::unfused<F>::call_0_result type;
    };
#endif
    template<class F>
    struct tr1_result_of< zr_boost_1_81::fusion::unfused<F> const () >
    {
        typedef typename zr_boost_1_81::fusion::unfused<F>::call_const_0_result type;
    };
    template<class F>
    struct tr1_result_of< zr_boost_1_81::fusion::unfused<F>() >
    {
        typedef typename zr_boost_1_81::fusion::unfused<F>::call_0_result type;
    };
}
...
#define N BOOST_PP_ITERATION()
        ...
        struct result< Self const (BOOST_PP_ENUM_PARAMS(N,T)) >
            : zr_boost_1_81::result_of< function_c(
        ...
        struct result< Self(BOOST_PP_ENUM_PARAMS(N,T)) >
            : zr_boost_1_81::result_of< function(
                BOOST_PP_CAT(fusion::vector,N)< BOOST_PP_ENUM_BINARY_PARAMS(N,
                    typename detail::mref<T,>::type BOOST_PP_INTERCEPT) > & )>
        { };
        ...
        BOOST_CXX14_CONSTEXPR BOOST_FUSION_GPU_ENABLED
        inline typename zr_boost_1_81::result_of<function_c(BOOST_PP_CAT(fusion::vector,N)
        ...
        template <BOOST_PP_ENUM_PARAMS(N,typename T)>
        BOOST_CXX14_CONSTEXPR BOOST_FUSION_GPU_ENABLED
        inline typename zr_boost_1_81::result_of<function(BOOST_PP_CAT(fusion::vector,N)
            <BOOST_PP_ENUM_BINARY_PARAMS(N,T,& BOOST_PP_INTERCEPT)> & )>::type
