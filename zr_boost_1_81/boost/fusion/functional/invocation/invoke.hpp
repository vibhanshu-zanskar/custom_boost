...
namespace zr_boost_1_81 { namespace fusion
{
    namespace detail
    {
        ...
        // use same implementation as for function objects but...
            : invoke_fn_ptr< // ...work around zr_boost_1_81::result_of bugs
                typename mpl::eval_if< ft::is_function<F>,
                    zr_boost_1_81::add_reference<F>, zr_boost_1_81::remove_cv<F> >::type,
        ...
        private:
            ...
            typedef mpl::or_< zr_boost_1_81::is_convertible<that,C*>,
                              zr_boost_1_81::is_convertible<that,C&>,
        ...
        public:
            ...
            typedef typename zr_boost_1_81::add_reference<qualified_type>::type
                result_type;
        ...
        struct invoke<Function, Sequence,
                      typename enable_if_has_type<
                          typename detail::invoke_impl<
                              typename zr_boost_1_81::remove_reference<Function>::type, Sequence
                          >::result_type
                      >::type>
        {
    ...
    {
        return detail::invoke_impl<
                typename zr_boost_1_81::remove_reference<Function>::type,Sequence const
            >::call(f,s);
    }
...
#define M(z,j,data) typename result_of::at_c<Sequence,j>::type
        ...
        struct invoke_impl<Function,Sequence,N,false,true,
            typename enable_if_has_type<
                typename zr_boost_1_81::result_of<Function(BOOST_PP_ENUM(N,M,~)) >::type
              >::type>
        {
        public:
...
#define L(z,j,data) typename invoke_param_types<Sequence,N>::BOOST_PP_CAT(T, j)
                typename zr_boost_1_81::result_of<Function(BOOST_PP_ENUM(N,L,~))>::type
              >::type>
#undef L
        {
        private:
