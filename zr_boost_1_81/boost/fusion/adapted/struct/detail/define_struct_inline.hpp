...
#define BOOST_FUSION_MAKE_ITERATOR_VALUE_OF_SPECS(Z, N, NAME)                   \
    ...
    struct value_of<                                                            \
        ...
        : zr_boost_1_81::mpl::identity<                                                 \
              typename zr_boost_1_81_fusion_detail_Sq::t##N##_type                      \
          >                                                                     \
    {                                                                           \
    };
...
#define BOOST_FUSION_MAKE_ITERATOR_DEREF_SPEC(                                  \
    ...
    {                                                                           \
        typedef typename zr_boost_1_81_fusion_detail_Sq::t##N##_type TYPE_QUAL& type;   \
...
#define BOOST_FUSION_MAKE_VALUE_AT_SPECS(Z, N, DATA)                            \
    template <typename boost_fusion_detail_Sq>                                  \
    struct value_at<boost_fusion_detail_Sq, zr_boost_1_81::mpl::int_<N> >               \
    {                                                                           \
        typedef typename zr_boost_1_81_fusion_detail_Sq::t##N##_type type;              \
    };

#define BOOST_FUSION_MAKE_AT_SPECS(R, DATA, N, ATTRIBUTE)                       \
    template <typename boost_fusion_detail_Sq>                                  \
    struct at<boost_fusion_detail_Sq, zr_boost_1_81::mpl::int_<N> >                     \
    {                                                                           \
        typedef typename zr_boost_1_81::mpl::if_<                                       \
            zr_boost_1_81::is_const<boost_fusion_detail_Sq>,                            \
            typename zr_boost_1_81_fusion_detail_Sq::t##N##_type const&,                \
            typename zr_boost_1_81_fusion_detail_Sq::t##N##_type&                       \
        >::type type;                                                           \
                                                                                \
        BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED                                \
...
#define BOOST_FUSION_DEFINE_ITERATOR_VALUE_OF(NAME, ATTRIBUTE_SEQ_SIZE)         \
        ...
        struct value_of : zr_boost_1_81::fusion::result_of::at_c<                       \
                              ref_vec_t,                                        \
                              zr_boost_1_81_fusion_detail_Iterator::index::value        \
                          >                                                     \
        {                                                                       \
        };
...
#define BOOST_FUSION_DEFINE_ITERATOR_DEREF(NAME, ATTRIBUTES_SEQ)                \
        ...
        {                                                                       \
            ...
            static const int index = iterator_raw_type::index::value;           \
                                                                                \
            typedef typename zr_boost_1_81::fusion::result_of::at_c<                    \
                ref_vec_t,                                                      \
                index                                                           \
            >::type result_raw_type;                                            \
                                                                                \
            typedef typename zr_boost_1_81::mpl::if_<                                   \
                zr_boost_1_81::is_const<typename iterator_raw_type::sequence_type>,     \
                typename zr_boost_1_81::add_const<result_raw_type>::type,               \
                result_raw_type                                                 \
            >::type type;                                                       \
                                                                                \
            BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED                            \
            ...
            {                                                                   \
                return zr_boost_1_81::fusion::at_c<index>(iter.ref_vec);                \
            }                                                                   \
        };
...
#define BOOST_FUSION_MAKE_ITERATOR_WKND_REF(Z, N, DATA)                         \
        ...
        typename zr_boost_1_81::mpl::if_<                                               \
                zr_boost_1_81::is_const<boost_fusion_detail_Seq>,                       \
                typename zr_boost_1_81::add_const<                                      \
                        typename zr_boost_1_81_fusion_detail_Seq::t##N##_type           \
                >::type,                                                        \
                typename zr_boost_1_81_fusion_detail_Seq::t##N##_type                   \
        >::type&

#define BOOST_FUSION_DEFINE_ITERATOR_WKND_MEMBERS(ATTRIBUTES_SEQ_SIZE)          \
        typedef zr_boost_1_81::fusion::vector<                                          \
            BOOST_PP_REPEAT(                                                    \
                    ATTRIBUTES_SEQ_SIZE,                                        \
...
#define BOOST_FUSION_DEFINE_STRUCT_INLINE_IMPL(NAME, ATTRIBUTES)                \
    ...
    struct NAME : zr_boost_1_81::fusion::sequence_facade<                               \
                      NAME,                                                     \
...
#define BOOST_FUSION_DEFINE_STRUCT_INLINE_ITERATOR_IMPL_IMPL(                   \
    ...
    struct BOOST_FUSION_ITERATOR_NAME(NAME)                                     \
        : zr_boost_1_81::fusion::iterator_facade<                                       \
    ...
    {                                                                           \
        ...
        {                                                                       \
            typedef BOOST_FUSION_ITERATOR_NAME(NAME)<                           \
                typename zr_boost_1_81_fusion_detail_It::sequence_type,                 \
                zr_boost_1_81_fusion_detail_It::index::value + 1                        \
            > type;                                                             \
                                                                                \
            BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED                            \
        ...
        {                                                                       \
            typedef typename zr_boost_1_81::mpl::minus<                                 \
                typename zr_boost_1_81_fusion_detail_It2::index,                        \
                typename zr_boost_1_81_fusion_detail_It1::index                         \
            >::type type;                                                       \
                                                                                \
            BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED                            \
        ...
        {                                                                       \
            typedef BOOST_FUSION_ITERATOR_NAME(NAME)<                           \
                typename zr_boost_1_81_fusion_detail_It::sequence_type,                 \
                zr_boost_1_81_fusion_detail_It::index::value                            \
                    + zr_boost_1_81_fusion_detail_M::value                              \
            > type;                                                             \
                                                                                \
            BOOST_CONSTEXPR BOOST_FUSION_GPU_ENABLED                            \
            static type call(boost_fusion_detail_It const& it)                  \
...
#define BOOST_FUSION_DEFINE_STRUCT_INLINE_MEMBERS_IMPL_IMPL(                    \
    ...
    {                                                                           \
        zr_boost_1_81::fusion::copy(rhs, *this);                                        \
    }                                                                           \
                                                                                \
    template <typename boost_fusion_detail_Seq>                                 \
    BOOST_CXX14_CONSTEXPR BOOST_FUSION_GPU_ENABLED                              \
    ...
    {                                                                           \
        ...
        {                                                                       \
            return type(sq);                                                    \
                                                                                ...
                                                                                \
    template <typename boost_fusion_detail_Sq>                                  \
    struct size : zr_boost_1_81::mpl::int_<ATTRIBUTES_SEQ_SIZE>                         \
    {                                                                           \
    };                                                                          \
                                                                                \
    template <typename boost_fusion_detail_Sq>                                  \
    struct empty : zr_boost_1_81::mpl::bool_<ATTRIBUTES_SEQ_SIZE == 0>                  \
    {                                                                           \
    };                                                                          \
                                                                                \
    template <                                                                  \
    ...
    struct value_at : value_at<                                                 \
                          boost_fusion_detail_Sq,                               \
                          zr_boost_1_81::mpl::int_<zr_boost_1_81_fusion_detail_N::value>        \
                      >                                                         \
    {                                                                           \
    };                                                                          \
                                                                                \
