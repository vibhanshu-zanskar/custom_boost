...
#define BOOST_FUSION_DEFINE_STRUCT_ASSIGN_FILLER_I(                             \
    ...
    BOOST_PP_EXPR_IF(                                                           \
        I_,                                                                     \
        typedef typename                                                        \
            zr_boost_1_81::fusion::result_of::next<                                     \
                BOOST_PP_CAT(I,BOOST_PP_DEC(I_))                                \
            >::type                                                             \
        BOOST_PP_CAT(I,I_);                                                     \
        BOOST_PP_CAT(I,I_) BOOST_PP_CAT(i,I_)=                                  \
                zr_boost_1_81::fusion::next(BOOST_PP_CAT(i,BOOST_PP_DEC(I_)));          \
    )                                                                           \
                                                                                \
    BOOST_PP_TUPLE_ELEM(ATTRIBUTE_TUPLE_SIZE,1,ATTRIBUTE)=                      \
        zr_boost_1_81::fusion::deref(BOOST_PP_CAT(i,I_));
...
#define BOOST_FUSION_DEFINE_STRUCT_ASSIGN_OP(                                   \
    ...
    {                                                                           \
        typedef typename                                                        \
            zr_boost_1_81::fusion::result_of::begin<Seq const>::type                    \
        I0;                                                                     \
        I0 i0=zr_boost_1_81::fusion::begin(seq);                                        \
                                                                                \
        BOOST_PP_SEQ_FOR_EACH_I_R(                                              \
            1,                                                                  \
...
#define BOOST_FUSION_DEFINE_STRUCT_SEQ_CTOR_FILLER_I(                           \
    ...
    BOOST_PP_COMMA_IF(I)                                                        \
    BOOST_PP_TUPLE_ELEM(ATTRIBUTE_TUPLE_SIZE,1,ATTRIBUTE)(                      \
        zr_boost_1_81::fusion::deref(zr_boost_1_81::fusion::advance_c<I>(zr_boost_1_81::fusion::begin(  \
            seq))))
...
#define BOOST_FUSION_DEFINE_STRUCT_CTOR_1(                                      \
        ...
        BOOST_FUSION_GPU_ENABLED                                                \
        explicit                                                                \
        NAME(zr_boost_1_81::call_traits<                                                \
                BOOST_PP_TUPLE_ELEM(                                            \
...
#define BOOST_FUSION_DEFINE_TPL_STRUCT_CTOR_1(                                  \
        ...
        BOOST_FUSION_GPU_ENABLED                                                \
        explicit                                                                \
        NAME(typename zr_boost_1_81::call_traits<                                       \
                typename zr_boost_1_81::fusion::detail::get_first_arg<                  \
                    BOOST_PP_TUPLE_ELEM(                                        \
                        ATTRIBUTE_TUPLE_SIZE,                                   \
                        0,                                                      \
                        BOOST_PP_SEQ_HEAD(ATTRIBUTES_SEQ))                      \
...
#define BOOST_FUSION_DEFINE_TPL_STRUCT_CTOR_ARG_I(R, DATA, I, ATTRIBUTE)        \
                                                                                \
        BOOST_PP_COMMA_IF(I)                                                    \
        typename zr_boost_1_81::call_traits<                                            \
            typename zr_boost_1_81::fusion::detail::get_first_arg<                      \
                BOOST_PP_TUPLE_ELEM(                                            \
