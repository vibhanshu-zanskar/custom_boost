...
#else
    zr_boost_1_81::stacktrace::detail::unwind_state state = { skip, out_frames, out_frames + max_frames_count };
    ::_Unwind_Backtrace(&zr_boost_1_81::stacktrace::detail::unwind_callback, &state);
