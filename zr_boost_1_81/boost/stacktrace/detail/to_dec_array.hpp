...
// We do not use zr_boost_1_81::lexical_cast in this function to reduce module dependencies
inline zr_boost_1_81::array<char, 40> to_dec_array(std::size_t value) BOOST_NOEXCEPT {
    zr_boost_1_81::array<char, 40> ret;
    if (!value) {
        ret[0] = '0';
        ret[1] = '\0';
        return ret;
