...
#include <boost/stacktrace/safe_dump_to.hpp> // zr_boost_1_81::stacktrace::detail::native_frame_ptr_t
...
/// @class zr_boost_1_81::stacktrace::frame boost/stacktrace/detail/frame_decl.hpp <boost/stacktrace/frame.hpp>
...
public:
    ...
    explicit frame(T* function_addr) BOOST_NOEXCEPT
        : addr_(zr_boost_1_81::stacktrace::detail::void_ptr_cast<native_frame_ptr_t>(function_addr))
    {}
