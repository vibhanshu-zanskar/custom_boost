...
std::size_t this_thread_frames::collect(native_frame_ptr_t* out_frames, std::size_t max_frames_count, std::size_t skip) BOOST_NOEXCEPT {
    return zr_boost_1_81::winapi::RtlCaptureStackBackTrace(
        static_cast<zr_boost_1_81::winapi::ULONG_>(skip),
        static_cast<zr_boost_1_81::winapi::ULONG_>(max_frames_count),
        const_cast<zr_boost_1_81::winapi::PVOID_*>(out_frames),
        0
    );
}
