...
inline Iterator is_sorted_until (Iterator first, Iterator last) {
  ...
  return ::zr_boost_1_81::detail::is_sorted_until(first, last, c());
}

template<class Iterator, class Comp>
inline bool is_sorted (Iterator first, Iterator last, Comp c) {
  return ::zr_boost_1_81::detail::is_sorted_until(first, last, c) == last;
}

template<class Iterator>
inline bool is_sorted (Iterator first, Iterator last) {
  return ::zr_boost_1_81::detail::is_sorted_until(first, last) == last;
}
