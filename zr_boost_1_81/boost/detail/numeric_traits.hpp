...
//      great as zr_boost_1_81::intmax_t can cause some differences to be
...
namespace zr_boost_1_81 { namespace detail {
  ...
  struct digit_traits<T, false>
  {
      BOOST_STATIC_CONSTANT(int, digits = (
          ...
          - (zr_boost_1_81::is_signed<T>::value ? 1 : 0))
          );
  };
#endif

  // Template class integer_traits<Integer> -- traits of various integer types
  // This should probably be rolled into zr_boost_1_81::integer_traits one day, but I
      ...
      typedef typename zr_boost_1_81::conditional<
        (int(x::is_signed)
          && (!int(x::is_bounded)
             ...
             || (int(x::digits) + 1 >= digit_traits<zr_boost_1_81::intmax_t>::digits))),
        Integer,
        ...
        typename zr_boost_1_81::conditional<
          ...
          typename zr_boost_1_81::conditional<
            ...
            signed long,
            zr_boost_1_81::intmax_t
          >::type
        >::type
      >::type difference_type;
#else
      BOOST_STATIC_ASSERT(zr_boost_1_81::is_integral<Integer>::value);

      typedef typename zr_boost_1_81::conditional<
        (sizeof(Integer) >= sizeof(intmax_t)),

        zr_boost_1_81::conditional<
          (zr_boost_1_81::is_signed<Integer>::value),
          Integer,
          zr_boost_1_81::intmax_t
        >,
