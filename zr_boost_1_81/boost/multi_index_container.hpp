...
class multi_index_container:
  private ::zr_boost_1_81::base_from_member<
...
private:
  ...
  typedef ::zr_boost_1_81::base_from_member<
...
public:
  ...
  multi_index_container(BOOST_RV_REF(multi_index_container) x):
    bfm_allocator(zr_boost_1_81::move(x.bfm_allocator::member)),
    bfm_header(),
    ...
    const multi_index_container<Value,IndexSpecifierList,Allocator>& x)
  {
    ...
    swap_(y,zr_boost_1_81::true_type() /* swap_allocators */);
    return *this;
  }
#endif
...
#include <boost/multi_index/detail/define_if_constexpr_macro.hpp>
    ...
    BOOST_MULTI_INDEX_IF_CONSTEXPR(
      ...
      swap_(x,zr_boost_1_81::true_type() /* swap_allocators */);
    }
    else if(this->get_allocator()==x.get_allocator()){
      swap_(x,zr_boost_1_81::false_type() /* swap_allocators */);
    }
    else{
      multi_index_container y(zr_boost_1_81::move(x),this->get_allocator());
      swap_(y,zr_boost_1_81::false_type() /* swap_allocators */);
    }
    return *this;
...
BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS:
  ...
  void construct_value(final_node_type* x,const Value& v)
  {
    node_alloc_traits::construct(
      bfm_allocator::member,zr_boost_1_81::addressof(x->value()),v);
  }

  void construct_value(final_node_type* x,BOOST_RV_REF(Value) v)
  {
    node_alloc_traits::construct(
      bfm_allocator::member,zr_boost_1_81::addressof(x->value()),zr_boost_1_81::move(v));
  }
  ...
  void destroy_value(final_node_type* x)
  {
    node_alloc_traits::destroy(
      bfm_allocator::member,zr_boost_1_81::addressof(x->value()));
  }
  ...
  void swap_(multi_index_container<Value,IndexSpecifierList,Allocator>& x)
  {
    swap_(
      x,
      zr_boost_1_81::integral_constant<
        bool,node_alloc_traits::propagate_on_container_swap::value>());
  }

  void swap_(
    multi_index_container<Value,IndexSpecifierList,Allocator>& x,
    zr_boost_1_81::true_type swap_allocators)
  {
  ...
  void swap_(
    multi_index_container<Value,IndexSpecifierList,Allocator>& x,
    zr_boost_1_81::false_type swap_allocators)
  {
    std::swap(bfm_header::member,x.bfm_header::member);
    super::swap_(x,swap_allocators);
    std::swap(node_count,x.node_count);
  ...
  void save(Archive& ar,const unsigned int version)const
  {
    ...
    for(iterator it=super::begin(),it_end=super::end();it!=it_end;++it){
      serialization::save_construct_data_adl(
        ar,zr_boost_1_81::addressof(*it),value_version);
  ...
  void load(Archive& ar,const unsigned int version)
  {
    ...
    for(std::size_t n=0;n<s;++n){
      ...
      ar.reset_object_address(
        zr_boost_1_81::addressof(p.first->value()),zr_boost_1_81::addressof(value.get()));
...
>
typename ::zr_boost_1_81::multi_index::index<
  ...
  multi_index_container<Value,IndexSpecifierList,Allocator>& m)BOOST_NOEXCEPT
{
  typedef multi_index_container<
    Value,IndexSpecifierList,Allocator>         multi_index_type;
  typedef typename ::zr_boost_1_81::multi_index::index<
    multi_index_container<
      Value,IndexSpecifierList,Allocator>,
    Tag
  >::type                                       index_type;
...
template<
  typename Tag,typename Value,typename IndexSpecifierList,typename Allocator
>
const typename ::zr_boost_1_81::multi_index::index<
  multi_index_container<Value,IndexSpecifierList,Allocator>,Tag>::type&
get(
  const multi_index_container<Value,IndexSpecifierList,Allocator>& m
)BOOST_NOEXCEPT
...
template<typename Value,typename IndexSpecifierList,typename Allocator>
struct version<
  zr_boost_1_81::multi_index_container<Value,IndexSpecifierList,Allocator>
>
{
...
/* Associated global functions are promoted to namespace zr_boost_1_81, except
