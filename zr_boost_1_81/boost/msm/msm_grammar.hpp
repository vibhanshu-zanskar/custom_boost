...
struct sm_domain
    : proto::domain< proto::generator<euml_terminal>, terminal_grammar, zr_boost_1_81::msm::msm_domain >
{};
...
{};
struct state_domain
    : proto::domain< proto::generator<euml_terminal>, zr_boost_1_81::msm::state_grammar,zr_boost_1_81::msm::sm_domain >
{};

template<typename Expr>
struct euml_terminal
    : proto::extends<Expr, euml_terminal<Expr>, zr_boost_1_81::msm::sm_domain>
{
    typedef
        proto::extends<Expr, euml_terminal<Expr>, zr_boost_1_81::msm::sm_domain>
        base_type;
