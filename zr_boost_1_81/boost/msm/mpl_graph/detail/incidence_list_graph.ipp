...
struct produce_out_map<incidence_list_tag, Source, ESTSequence> :
    mpl::fold<typename mpl::filter_view<ESTSequence, zr_boost_1_81::is_same<fetch_source<mpl::_1>,Source> >::type,
         mpl::map<>,
...
struct produce_in_map<incidence_list_tag, Target, ESTSequence> :
    mpl::fold<typename mpl::filter_view<ESTSequence, 
                                        zr_boost_1_81::is_same<fetch_target<mpl::_1>,Target> >::type,
         mpl::map<>,
