...
struct depth_first_search {
    ...
    typedef typename 
        mpl::fold<typename mpl_graph::out_edges<Vertex, Graph>::type, 
                  ...
                  mpl::if_<zr_boost_1_81::is_same<search_color_map_ops::get_color<mpl_graph::target<mpl::_2, Graph>, mpl::second<mpl::_1> >, 
                                          search_colors::White>,
                           ...
                           mpl::pair<mpl::if_<zr_boost_1_81::is_same<typename search_color_map_ops::template 
...
struct depth_first_search_all : // visit first then rest
    mpl::fold<typename mpl_graph::vertices<Graph>::type,
              typename depth_first_search<Graph, 
                                          ...
                                          FirstVertex, 
                                          ColorState>::type, 
              mpl::if_<zr_boost_1_81::is_same<search_color_map_ops::get_color<mpl::_2, mpl::second<mpl::_1> >,
