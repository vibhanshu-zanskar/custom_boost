...
struct state_machine_def :  public zr_boost_1_81::msm::front::detail::state_base<BaseState>
{
    // tags
    // default: no flag
    ...
    typedef ::zr_boost_1_81::mpl::vector0<>               configuration;
    ...
    struct a_row
    {
        ...
        static ::zr_boost_1_81::msm::back::HandledEnum action_call(FSM& fsm,Event const& evt,SourceState&,TargetState&, AllStates&)
        {
            // in this front-end, we don't need to know source and target states
            (fsm.*action)(evt);
            return ::zr_boost_1_81::msm::back::HANDLED_TRUE;
        }
    };
