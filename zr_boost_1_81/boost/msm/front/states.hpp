...
{
    // tags
    typedef ::zr_boost_1_81::mpl::bool_<false>   needs_sm;
};
struct sm_ptr 
{
    // tags
    typedef ::zr_boost_1_81::mpl::bool_<true>    needs_sm;
};
...
struct state :  public zr_boost_1_81::msm::front::detail::state_base<BASE>, SMPtrPolicy
{
    // tags
    // default: no flag
    typedef ::zr_boost_1_81::mpl::vector0<>       flag_list;
    typedef ::zr_boost_1_81::mpl::vector0<>       internal_flag_list;
    //default: no deferred events
    typedef ::zr_boost_1_81::mpl::vector0<>       deferred_events;
};

// terminate state simply defines the TerminateFlag flag
// template argument: pointer-to-fsm policy
template<class BASE = default_base_state,class SMPtrPolicy = no_sm_ptr>
struct terminate_state : public zr_boost_1_81::msm::front::detail::state_base<BASE>, SMPtrPolicy
{
    // tags
    typedef ::zr_boost_1_81::mpl::vector0<>                               flag_list;
    typedef ::zr_boost_1_81::mpl::vector< zr_boost_1_81::msm::TerminateFlag>      internal_flag_list;
    //default: no deferred events
    typedef ::zr_boost_1_81::mpl::vector0<>                               deferred_events;
};
...
struct interrupt_state : public zr_boost_1_81::msm::front::detail::state_base<BASE>, SMPtrPolicy
{
    // tags
    typedef ::zr_boost_1_81::mpl::vector0<>                           flag_list;
    typedef typename zr_boost_1_81::msm::back::build_interrupt_state_flag_list<
        typename zr_boost_1_81::msm::back::get_interrupt_events<EndInterruptEvent>::type
...
struct entry_pseudo_state
    :  public zr_boost_1_81::msm::front::detail::state_base<BASE>,SMPtrPolicy
{
    // tags
...
struct exit_pseudo_state : public zr_boost_1_81::msm::front::detail::state_base<BASE> , SMPtrPolicy
{
    typedef Event       event;
    typedef BASE        Base;
