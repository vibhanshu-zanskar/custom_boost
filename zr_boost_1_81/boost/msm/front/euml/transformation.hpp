...
struct BackInserter_Helper: proto::extends< proto::terminal<back_inserter_tag>::type, BackInserter_Helper, zr_boost_1_81::msm::sm_domain>
{
    BackInserter_Helper(){}
...
struct FrontInserter_Helper: proto::extends< proto::terminal<front_inserter_tag>::type, FrontInserter_Helper, zr_boost_1_81::msm::sm_domain>
{
...
struct inserter_tag {};
struct Inserter_Helper: proto::extends< proto::terminal<inserter_tag>::type, Inserter_Helper, zr_boost_1_81::msm::sm_domain>
{
    Inserter_Helper(){}
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
...
struct Transform_<Param1,Param2,Param3,Param4,Param5,
                  typename ::zr_boost_1_81::enable_if<typename ::zr_boost_1_81::is_same<Param5,void>::type >::type> 
...
struct Transform_Helper: proto::extends< proto::terminal<transform_tag>::type, Transform_Helper, zr_boost_1_81::msm::sm_domain>
{
    Transform_Helper(){}
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
