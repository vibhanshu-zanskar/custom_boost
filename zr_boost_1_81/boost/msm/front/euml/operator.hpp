...
struct If_Else_<Condition,Action1,Action2
    , typename ::zr_boost_1_81::enable_if<typename has_tag_type<Action1>::type >::type>
...
template <class Condition,class Action1,class Action2>
struct If_Else_<Condition,Action1,Action2
    , typename ::zr_boost_1_81::disable_if<typename has_tag_type<Action1>::type >::type>
    : euml_action<If_Else_<Condition,Action1,Action2> >
{
    template <class Event,class FSM,class STATE >
    struct state_action_result 
...
struct If : proto::extends<proto::terminal<if_tag>::type, If, zr_boost_1_81::msm::sm_domain>
{
    If(){}
    using proto::extends< proto::terminal<if_tag>::type, If, zr_boost_1_81::msm::sm_domain>::operator=;
...
struct If_Then : proto::extends< proto::terminal<if_then_tag>::type, If_Then, zr_boost_1_81::msm::sm_domain>
{
    If_Then(){}
    using proto::extends< proto::terminal<if_then_tag>::type, If_Then, zr_boost_1_81::msm::sm_domain>::operator=;
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
 ,class Arg6 
#endif
...
struct While_Do_Helper : proto::extends< proto::terminal<while_do_tag>::type, While_Do_Helper, zr_boost_1_81::msm::sm_domain>
{
    While_Do_Helper(){}
    using proto::extends< proto::terminal<while_do_tag>::type, While_Do_Helper, zr_boost_1_81::msm::sm_domain>::operator=;
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
 ,class Arg6 
#endif
...
struct Do_While_Helper : proto::extends< proto::terminal<do_while_tag>::type, Do_While_Helper, zr_boost_1_81::msm::sm_domain>
{
    Do_While_Helper(){}
    using proto::extends< proto::terminal<do_while_tag>::type, Do_While_Helper, zr_boost_1_81::msm::sm_domain>::operator=;
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
 ,class Arg6 
#endif
...
struct For_Loop_Helper : proto::extends< proto::terminal<for_loop_tag>::type, For_Loop_Helper, zr_boost_1_81::msm::sm_domain>
{
    For_Loop_Helper(){}
    using proto::extends< proto::terminal<for_loop_tag>::type, For_Loop_Helper, zr_boost_1_81::msm::sm_domain>::operator=;
    template <class Arg1,class Arg2,class Arg3,class Arg4,class Arg5 
#ifdef BOOST_MSVC 
 ,class Arg6 
#endif
...
struct Deref_ : euml_action<Deref_<T> >
{
    ...
    struct state_action_result 
    {
        typedef typename ::zr_boost_1_81::add_reference<
...
struct Post_inc_ : euml_action<Post_inc_<T> >
{
    ...
    struct state_action_result 
    {
        typedef typename ::zr_boost_1_81::remove_reference<
    ...
    struct state_action_result 
    {
        ...
        typedef typename ::zr_boost_1_81::mpl::eval_if<
            ...
            ::zr_boost_1_81::mpl::eval_if<
                typename ::zr_boost_1_81::is_pointer<container_type>::type,
                ::zr_boost_1_81::add_reference<typename ::zr_boost_1_81::remove_pointer<container_type>::type >,
