...
struct BuildStt
   : proto::or_<
        proto::when<
                    ...
                    zr_boost_1_81::mpl::push_back<BuildStt(proto::_left),BuildRow(proto::_right)>()
                >,
        proto::when <
                    BuildRow,
...
typename ::zr_boost_1_81::mpl::eval_if<
    ...
    zr_boost_1_81::result_of<BuildStt(Expr)>,
    make_invalid_type>::type
build_stt(Expr const&)
{
    return typename zr_boost_1_81::result_of<BuildStt(Expr)>::type();
}
...
struct BuildInternalStt
   : proto::or_<
        proto::when<
                    ...
                    zr_boost_1_81::mpl::push_back<BuildInternalStt(proto::_left),BuildInternalRow(proto::_right)>()
                >,
        proto::when <
                    BuildInternalRow,
...
typename ::zr_boost_1_81::mpl::eval_if<
    ...
    zr_boost_1_81::result_of<BuildInternalStt(Expr)>,
    make_invalid_type>::type
build_internal_stt(Expr const&)
{
    return typename zr_boost_1_81::result_of<BuildInternalStt(Expr)>::type();
}
