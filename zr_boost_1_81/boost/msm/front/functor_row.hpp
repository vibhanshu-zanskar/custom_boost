...
namespace zr_boost_1_81 { namespace msm { namespace front
{
    ...
    {
        static const ::zr_boost_1_81::msm::back::HandledEnum value = ::zr_boost_1_81::msm::back::HANDLED_TRUE;
    };
    template <class Func>
    ...
    > 
    {
        static const ::zr_boost_1_81::msm::back::HandledEnum value = ::zr_boost_1_81::msm::back::HANDLED_DEFERRED;
    };
    // for sequences
    template <class Func>
    struct get_functor_return_value<Func, 
    ...
    > 
    {
        static const ::zr_boost_1_81::msm::back::HandledEnum value = 
            (Func::some_deferring_actions::value ? ::zr_boost_1_81::msm::back::HANDLED_DEFERRED : ::zr_boost_1_81::msm::back::HANDLED_TRUE );
    };
    ...
    struct Row
    {
        ...
        static ::zr_boost_1_81::msm::back::HandledEnum action_call(FSM& fsm,EVT const& evt,SourceState& src,TargetState& tgt, AllStates&)
        {
    ...
    struct ActionSequence_
    {
        ...
        typedef ::zr_boost_1_81::mpl::bool_< 
            ::zr_boost_1_81::mpl::count_if<sequence, 
                                   has_deferring_action< ::zr_boost_1_81::mpl::placeholders::_1 > 
        ...
        template <class FCT>
        void operator()(::zr_boost_1_81::msm::wrap<FCT> const& )
        {
        ...
        {
            mpl::for_each<Sequence,zr_boost_1_81::msm::wrap< ::zr_boost_1_81::mpl::placeholders::_1> >
