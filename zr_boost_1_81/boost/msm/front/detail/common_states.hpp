...
namespace zr_boost_1_81 { namespace msm { namespace front {namespace detail
{
template <class Attributes= ::zr_boost_1_81::fusion::map<> >
struct inherit_attributes
{
    ...
    typename ::zr_boost_1_81::fusion::result_of::at_key<attributes_type, 
                                                Index>::type
    get_attribute(Index const&) 
    {
        return ::zr_boost_1_81::fusion::at_key<Index>(m_attributes);
    }
    ...
    get_attribute(Index const&)const 
    {
        return const_cast< 
            typename ::zr_boost_1_81::add_const< 
                typename ::zr_boost_1_81::fusion::result_of::at_key< attributes_type,
                                                             Index >::type>::type>
                                (::zr_boost_1_81::fusion::at_key<Index>(m_attributes));
    }
...
template<class USERBASE,class Attributes= ::zr_boost_1_81::fusion::map<> >
struct state_base : public inherit_attributes<Attributes>, USERBASE
{
    ...
    typedef ::zr_boost_1_81::mpl::vector0<>  internal_transition_table;
    typedef ::zr_boost_1_81::mpl::vector0<>  transition_table;
};
