...
namespace zr_boost_1_81 { namespace spirit { namespace repository { namespace qi
{
    ...
    struct keywords : spirit::qi::nary_parser<keywords<Elements,Modifiers> >
    {
        ...
        // build_parser_tags
        //
        // Builds a zr_boost_1_81::variant from an mpl::range_c in order to "mark" every
        ...
        typedef zr_boost_1_81::array<bool, fusion::result_of::size<Elements>::value> flags_type;
        typedef zr_boost_1_81::array<int, fusion::result_of::size<Elements>::value> counters_type;
