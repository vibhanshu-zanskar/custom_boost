...
namespace zr_boost_1_81 { namespace spirit { namespace repository { namespace qi
{
    struct iter_pos_parser 
      : zr_boost_1_81::spirit::qi::primitive_parser<iter_pos_parser>
    {
        ...
        {
            zr_boost_1_81::spirit::qi::skip_over(first, last, skipper);
            zr_boost_1_81::spirit::traits::assign_to(first, attr);
            return true;
        }
        ...
        zr_boost_1_81::spirit::info what(Context&) const
        {
            return zr_boost_1_81::spirit::info("iter_pos");
        }
    };
}}}}
