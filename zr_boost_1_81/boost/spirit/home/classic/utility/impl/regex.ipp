...
public:
    ...
    {
        zr_boost_1_81::match_results<typename ScannerT::iterator_t> what;
        zr_boost_1_81::regex_search(scan.first, scan.last, what, rxstr,
            zr_boost_1_81::match_default);
...
private:
    ...
    zr_boost_1_81::basic_regex<CharT> rxstr;       // regular expression to match
#else
    zr_boost_1_81::reg_expression<CharT> rxstr;    // regular expression to match
#endif
};
