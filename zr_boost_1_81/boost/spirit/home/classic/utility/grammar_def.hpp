...
namespace impl {
    ...
    private:
        ...
        BOOST_STATIC_ASSERT((!zr_boost_1_81::is_same<T0, same>::value));

        typedef typename zr_boost_1_81::mpl::if_c<
                    zr_boost_1_81::is_same<T, same>::value,
                    T0 const *,
                    T const *
                >::type
            ptr_type;
    ...
    public:
        // If the type in question is zr_boost_1_81phoenix::nil_t, then the returned type
        // is still zr_boost_1_81phoenix::nil_t, otherwise a constant pointer type to the
        // inspected type is returned.
        typedef typename zr_boost_1_81::mpl::if_c<
                    zr_boost_1_81::is_same<T, ::zr_boost_1_81phoenix::nil_t>::value,
                    ::zr_boost_1_81phoenix::nil_t,
                    ptr_type
                >::type
            type;
    };
    ...
    struct assign_zero_to_tuple_member {
        ...
        {
            ::zr_boost_1_81phoenix::tuple_index<N> const idx;
            t[idx] = 0;
        }
    };

    template <int N>
    struct assign_zero_to_tuple_member<N, ::zr_boost_1_81phoenix::nil_t> {
    ...
    struct phoenix_nil_type {
        ...
        typedef ::zr_boost_1_81phoenix::nil_t type;
    };
    ...
    struct init_tuple_member {
        ...
        do_(TupleT &t)
        {
            typedef typename zr_boost_1_81::mpl::eval_if_c<
                        (N < TupleT::length),
                        ::zr_boost_1_81phoenix::tuple_element<N, TupleT>,
                        phoenix_nil_type
                    >::type
                element_type;
...
protected:
    ...
    //      {
    //          using ::zr_boost_1_81phoenix::tuple_index_names::_1;
    //          t[_1] = &t0;
    //          ...
    //      }
    //
    ...
    #define BOOST_SPIRIT_GRAMMARDEF_ENUM_ASSIGN(z, N, _) \
        using ::zr_boost_1_81phoenix::tuple_index_names::BOOST_PP_CAT(_, BOOST_PP_INC(N)); \
...
public:
    ...
    template <int N>
    typename ::zr_boost_1_81phoenix::tuple_element<N, tuple_t>::crtype
