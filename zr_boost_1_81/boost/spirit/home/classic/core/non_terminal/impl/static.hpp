...
BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    //      T::T() MUST not throw!
    //          this is a requirement of zr_boost_1_81::call_once.
    //
    template <class T, class Tag>
    struct static_
        : zr_boost_1_81::noncopyable
    {
    private:
    ...
    public:
        ...
        static_(Tag = Tag())
        {
            zr_boost_1_81::call_once(&default_ctor::construct, constructed_);
        }
    ...
    private:
        typedef typename zr_boost_1_81::add_pointer<value_type>::type pointer;
        ...
        typedef zr_boost_1_81::aligned_storage<sizeof(value_type),
            zr_boost_1_81::alignment_of<value_type>::value> storage_type;
