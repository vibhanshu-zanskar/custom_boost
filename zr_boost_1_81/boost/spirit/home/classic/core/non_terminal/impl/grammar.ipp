...
struct grammar_definition
{
    ...
    struct grammar_helper : private grammar_helper_base<GrammarT>
    {
        ...
        typedef zr_boost_1_81::shared_ptr<helper_t> helper_ptr_t;
        typedef zr_boost_1_81::weak_ptr<helper_t>   helper_weak_ptr_t;
        ...
        define(grammar_t const* target_grammar)
        {
            ...
            zr_boost_1_81::movelib::unique_ptr<definition_t>
                result(new definition_t(target_grammar->derived()));

#ifdef BOOST_SPIRIT_THREADSAFE
            zr_boost_1_81::unique_lock<zr_boost_1_81::mutex> lock(helpers.mutex());
#endif
...
# ifdef BOOST_SPIRIT_THREADSAFE
        zr_boost_1_81::thread_specific_ptr<ptr_t> & tld_helper
            = static_<zr_boost_1_81::thread_specific_ptr<ptr_t>,
