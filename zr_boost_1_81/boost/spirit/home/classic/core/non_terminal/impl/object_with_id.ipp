...
BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    namespace impl {
        ...
        private:
#ifdef BOOST_SPIRIT_THREADSAFE
            static zr_boost_1_81::mutex &mutex_instance();
            static void mutex_init();
#endif

            zr_boost_1_81::shared_ptr<object_with_id_base_supply<IdT> > id_supply;
        };
        ...
        {
#ifdef BOOST_SPIRIT_THREADSAFE
            zr_boost_1_81::unique_lock<zr_boost_1_81::mutex> lock(mutex);
#endif
            if (!free_ids.empty())
            {
        ...
        {
            {
                ...
                static zr_boost_1_81::once_flag been_here = BOOST_ONCE_INIT;
#else
                static zr_boost_1_81::once_flag been_here;
#endif
                zr_boost_1_81::call_once(been_here, mutex_init);
                zr_boost_1_81::mutex &mutex = mutex_instance();
                zr_boost_1_81::unique_lock<zr_boost_1_81::mutex> lock(mutex);
#endif
                static zr_boost_1_81::shared_ptr<object_with_id_base_supply<IdT> >
                    static_supply;
...
#ifdef BOOST_SPIRIT_THREADSAFE
        template <typename TagT, typename IdT>
        inline zr_boost_1_81::mutex &
        object_with_id_base<TagT, IdT>::mutex_instance()
        {
            static zr_boost_1_81::mutex mutex;
            return mutex;
        }
#endif
...
}} // namespace zr_boost_1_81::spirit
