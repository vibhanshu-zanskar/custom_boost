...
struct tree_node
{
    ...
    typedef zr_boost_1_81::pool_allocator<tree_node<T> > allocator_type;
#else
    typedef zr_boost_1_81::fast_pool_allocator<tree_node<T> > allocator_type;
#endif
...
#elif !defined(BOOST_SPIRIT_USE_LIST_FOR_TREES)
    typedef zr_boost_1_81::pool_allocator<value_type> allocator_type;
#else
    typedef zr_boost_1_81::fast_pool_allocator<value_type> allocator_type;
#endif
...
public:
    ...
    typedef T attr_t;
    typedef typename zr_boost_1_81::call_traits<T>::param_type      param_type;
    typedef typename zr_boost_1_81::call_traits<T>::reference       reference;
    typedef typename zr_boost_1_81::call_traits<T>::const_reference const_reference;
