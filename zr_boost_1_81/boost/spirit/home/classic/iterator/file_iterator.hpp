...
//  of zr_boost_1_81::iterator_adaptor, that is inhering an object created with it.
...
//  with zr_boost_1_81::iterator_adaptor only 5 functions are needed to implement
...
namespace fileiter_impl {
    ...
    //  file_iter_generator
    //
    //  Template meta-function to invoke zr_boost_1_81::iterator_adaptor
...
public:
    ...
    // operator bool. This borrows a trick from zr_boost_1_81::shared_ptr to avoid
