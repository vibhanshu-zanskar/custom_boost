...
/* namespace zr_boost_1_81::spirit { */ namespace iterator_ { namespace impl {

template <typename T>
struct make_const : zr_boost_1_81::add_const<T>
{};

template <typename T>
struct make_const<T&>
{
    typedef typename zr_boost_1_81::add_const<T>::type& type;
};
...
//
//  Metafunction to generate the iterator type using zr_boost_1_81::iterator_adaptors,
...
private:
    ...
    typedef typename zr_boost_1_81::add_const<value_type>::type const_value_type;
...
public:
    ...
    typedef typename zr_boost_1_81::mpl::if_<
        typename zr_boost_1_81::is_same<MainIterT, nil_t>::type,
...
}} /* namespace zr_boost_1_81::spirit::iterator_::impl */
