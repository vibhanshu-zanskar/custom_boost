...
private:
    zr_boost_1_81::shared_ptr<std::FILE> m_file;
    long m_pos;
    CharT m_curChar;
    bool m_eof;
...
private:
    typedef zr_boost_1_81::remove_pointer<HANDLE>::type handle_t;

    zr_boost_1_81::shared_ptr<CharT> m_mem;
...
private:
    ...
    zr_boost_1_81::shared_ptr<mapping> m_mem;
...
///////////////////////////////////////////////////////////////////////////////
} /* namespace zr_boost_1_81::spirit::fileiter_impl */
