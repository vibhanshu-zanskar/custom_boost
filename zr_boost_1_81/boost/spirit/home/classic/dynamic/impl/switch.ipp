...
struct default_delegate_parse<N, true, HasDefault> {
        ...
        ScannerT const &scan, typename ScannerT::iterator_t const save)
    {
        ...
        BOOST_STATIC_ASSERT((!zr_boost_1_81::is_same<DefaultT, nothing_parser>::value));
        ...
        parser<compound_case_parser<LeftT, RightT, IsDefault> > >
{
    ...
    BOOST_STATIC_CONSTANT(bool, is_epsilon = (
        is_default &&
            zr_boost_1_81::is_same<typename RightT::subject_t, epsilon_parser>::value
    ));
...
struct cond_actor {
    ...
    struct result
    {
        typedef typename ::zr_boost_1_81phoenix::actor_result<ActorT, ::zr_boost_1_81phoenix::tuple<> >::type
            type;
    };
...
template <typename ActorT>
struct make_cond_functor< ::zr_boost_1_81phoenix::actor<ActorT> > {

    static cond_actor< ::zr_boost_1_81phoenix::actor<ActorT> >
    do_(::zr_boost_1_81phoenix::actor<ActorT> const &actor)
    {
        return cond_actor< ::zr_boost_1_81phoenix::actor<ActorT> >(actor);
    }
};
