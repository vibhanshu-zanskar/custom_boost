...
template <> struct rank< ::zr_boost_1_81::long_long_type>          { static int const value = 110; };
template <> struct rank< ::zr_boost_1_81::ulong_long_type> { static int const value = 120; };
#endif
