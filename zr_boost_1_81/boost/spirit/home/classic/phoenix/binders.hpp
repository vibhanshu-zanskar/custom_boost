...
struct member_var_ptr_action {
    ...
    struct result {
        typedef typename zr_boost_1_81::mpl::if_<zr_boost_1_81::is_const<CT>, T const&, T&
            >::type type;
    };
...
> {
    ...
    typedef typename zr_boost_1_81::mpl::if_<zr_boost_1_81::is_const<ClassT>, cmf, mf>::type
        mem_func_ptr_t;
