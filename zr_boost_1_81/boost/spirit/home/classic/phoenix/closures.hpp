...
namespace impl
{
    ...
    private:
        zr_boost_1_81::thread_specific_ptr<frame_ptr> tsp_frame;
...
#endif
} // namespace zr_boost_1_81phoenix::impl
...
#ifdef PHOENIX_THREADSAFE
    static zr_boost_1_81::thread_specific_ptr<holder_t*> &
    tsp_frame_instance()
    {
        static zr_boost_1_81::thread_specific_ptr<holder_t*> the_instance;
        return the_instance;
    }
...
#endif
        zr_boost_1_81::call_once(been_here, tsp_frame_instance_init);
        zr_boost_1_81::thread_specific_ptr<holder_t*> &tsp_frame = tsp_frame_instance();
        if (!tsp_frame.get())
