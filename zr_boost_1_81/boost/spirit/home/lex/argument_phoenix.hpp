...
BOOST_PHOENIX_DEFINE_EXPRESSION(
    (zr_boost_1_81)(spirit)(lex)(value_setter)
  , (zr_boost_1_81::zr_boost_1_81phoenix::meta_grammar)
)

BOOST_PHOENIX_DEFINE_EXPRESSION(
    (zr_boost_1_81)(spirit)(lex)(state_setter)
  , (zr_boost_1_81::zr_boost_1_81phoenix::meta_grammar)
)
...
namespace zr_boost_1_81 { namespace zr_boost_1_81phoenix
{
    ...
    {
        template <>
        struct is_nullary<custom_terminal<zr_boost_1_81::spirit::lex::value_context> >
          : mpl::false_
        {};
    }
    
    template <typename Dummy>
    struct is_custom_terminal<zr_boost_1_81::spirit::lex::value_context, Dummy>: mpl::true_ {};
    
    template <typename Dummy>
    struct custom_terminal<zr_boost_1_81::spirit::lex::value_context, Dummy>
      : proto::call<
            v2_eval(
                proto::make<zr_boost_1_81::spirit::lex::value_getter()>
    ...
    struct actor<spirit::lex::value_context>
      : zr_boost_1_81::zr_boost_1_81phoenix::actor<proto::terminal<spirit::lex::value_context>::type>
    {
        typedef zr_boost_1_81::zr_boost_1_81phoenix::actor<
        ...
        typename spirit::lex::expression::value_setter<
            typename zr_boost_1_81phoenix::as_actor<Expr>::type>::type const
        operator=(Expr const & expr) const
        {
            return
                spirit::lex::expression::value_setter<
                    typename zr_boost_1_81phoenix::as_actor<Expr>::type
                >::make(zr_boost_1_81phoenix::as_actor<Expr>::convert(expr));
        }
    };
    ...
    {
        template <>
        struct is_nullary<custom_terminal<zr_boost_1_81::spirit::lex::state_context> >
          : mpl::false_
        {};
    }
    
    template <typename Dummy>
    struct is_custom_terminal<zr_boost_1_81::spirit::lex::state_context, Dummy>: mpl::true_ {};
    
    template <typename Dummy>
    struct custom_terminal<zr_boost_1_81::spirit::lex::state_context, Dummy>
      : proto::call<
            v2_eval(
                proto::make<zr_boost_1_81::spirit::lex::state_getter()>
              , proto::call<functional::env(proto::_state)>
            )
        >
    {};
    ...
    struct actor<spirit::lex::state_context>
      : zr_boost_1_81::zr_boost_1_81phoenix::actor<proto::terminal<spirit::lex::state_context>::type>
    {
        typedef zr_boost_1_81::zr_boost_1_81phoenix::actor<
    ...
    {
        template <>
        struct is_nullary<custom_terminal<zr_boost_1_81::spirit::lex::eoi_getter> >
          : mpl::false_
        {};
    }
    
    template <typename Dummy>
    struct is_custom_terminal<zr_boost_1_81::spirit::lex::eoi_getter, Dummy>: mpl::true_ {};
    
    template <typename Dummy>
    struct custom_terminal<zr_boost_1_81::spirit::lex::eoi_getter, Dummy>
      : proto::call<
            v2_eval(
                proto::make<zr_boost_1_81::spirit::lex::eoi_getter()>
              , proto::call<functional::env(proto::_state)>
            )
        >
    {};
