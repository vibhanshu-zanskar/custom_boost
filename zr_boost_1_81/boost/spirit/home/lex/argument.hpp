...
namespace zr_boost_1_81 { namespace spirit { namespace lex
{
    ...
    typedef zr_boost_1_81phoenix::arg_names::_1_type _start_type;
    typedef zr_boost_1_81phoenix::arg_names::_2_type _end_type;
    ...
    // definition).
    // typedef zr_boost_1_81phoenix::arg_names::_3_type _pass_type;
    using zr_boost_1_81::spirit::_pass_type;
#ifndef BOOST_SPIRIT_NO_PREDEFINED_TERMINALS
    using zr_boost_1_81::spirit::_pass;
#endif

    // '_tokenid' may be used to access and change the tokenid of the current 
    // token
    typedef zr_boost_1_81phoenix::arg_names::_4_type _tokenid_type;
#ifndef BOOST_SPIRIT_NO_PREDEFINED_TERMINALS
    _tokenid_type const _tokenid = _tokenid_type();
#endif

    typedef zr_boost_1_81phoenix::actor<value_context> _val_type;
    typedef zr_boost_1_81phoenix::actor<state_context> _state_type;
    typedef zr_boost_1_81phoenix::actor<eoi_getter> _eoi_type;
#ifndef BOOST_SPIRIT_NO_PREDEFINED_TERMINALS
