...
namespace zr_boost_1_81 { namespace spirit { namespace lex
{
    ...
    inline typename expression::less<
        typename zr_boost_1_81phoenix::as_actor<T>::type
    >::type const
    less(T const& v)
    {
        return expression::less<T>::make(zr_boost_1_81phoenix::as_actor<T>::convert(v));
    }
    ...
    inline zr_boost_1_81phoenix::actor<more_type> more()
    {
        return zr_boost_1_81phoenix::actor<more_type>();
    }
    ...
    inline typename expression::lookahead<
        typename zr_boost_1_81phoenix::as_actor<T>::type
      , typename zr_boost_1_81phoenix::as_actor<std::size_t>::type
    >::type const
    lookahead(T const& id)
    {
        typedef typename zr_boost_1_81phoenix::as_actor<T>::type id_actor_type;
        typedef typename zr_boost_1_81phoenix::as_actor<std::size_t>::type state_actor_type;

        return expression::lookahead<id_actor_type, state_actor_type>::make(
            zr_boost_1_81phoenix::as_actor<T>::convert(id),
            zr_boost_1_81phoenix::as_actor<std::size_t>::convert(std::size_t(~0)));
    }

    template <typename Attribute, typename Char, typename Idtype>
    inline typename expression::lookahead<
        typename zr_boost_1_81phoenix::as_actor<Idtype>::type
      , typename zr_boost_1_81phoenix::as_actor<std::size_t>::type
    >::type const
    lookahead(token_def<Attribute, Char, Idtype> const& tok)
    {
        typedef typename zr_boost_1_81phoenix::as_actor<Idtype>::type id_actor_type;
        typedef typename zr_boost_1_81phoenix::as_actor<std::size_t>::type state_actor_type;
        ...
        return expression::lookahead<id_actor_type, state_actor_type>::make(
            zr_boost_1_81phoenix::as_actor<Idtype>::convert(tok.id()),
            zr_boost_1_81phoenix::as_actor<std::size_t>::convert(state));
    }
