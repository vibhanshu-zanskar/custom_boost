    ...
    namespace detail
    {
        ...
        public:
            ...
            { 
                ...
                // definition.
                BOOST_ASSERT(state_id != zr_boost_1_81::lexer::npos);

                if (state_id != zr_boost_1_81::lexer::npos)
                    state_ = state_id;
            }
        ...
        public:
            ...
            {
                Iterator end = end_;
                std::size_t unique_id = zr_boost_1_81::lexer::npos;
                bool bol = this->bol_;
        ...
        template <typename Iterator, typename HasState, typename TokenValue>
        class data<Iterator, mpl::true_, HasState, zr_boost_1_81::optional<TokenValue> > 
          : public data<Iterator, mpl::false_, HasState, TokenValue>
        {
        public:
            typedef semantic_actions<Iterator, HasState, data> 
        ...
        public:
            typedef Iterator base_iterator_type;
            typedef zr_boost_1_81::optional<TokenValue> token_value_type;
            typedef zr_boost_1_81::optional<TokenValue> const& get_value_type;
            typedef typename base_type::state_type state_type;
            typedef typename base_type::state_name_type state_name_type;
