...
{ 
    ...
    public:
          ...
          , Iterator const& end_, std::size_t& unique_id_)
        {
            ...
            {
                unique_id_ = zr_boost_1_81::lexer::npos;
                return 0;
            }

            bool bol = bol_;
            zr_boost_1_81::lexer::detail::internals const& internals_ =
                state_machine_.data();
        ...
        again:
            ...
            std::size_t id_ = *(ptr_ + zr_boost_1_81::lexer::id_index);
            std::size_t uid_ = *(ptr_ + zr_boost_1_81::lexer::unique_id_index);
            ...
            while (curr_ != end_)
            {
                std::size_t const BOL_state_ = ptr_[zr_boost_1_81::lexer::bol_index];
                std::size_t const EOL_state_ = ptr_[zr_boost_1_81::lexer::eol_index];
                ...
                else
                {
                    ...
                    value_type;
                    typedef typename 
                        zr_boost_1_81::lexer::char_traits<value_type>::index_type 
                    index_type;

                    index_type index = 
                        zr_boost_1_81::lexer::char_traits<value_type>::call(*curr_++);
                    bol = (index == '\n') ? true : false;
                ...
                {
                    end_state_ = true;
                    id_ = *(ptr_ + zr_boost_1_81::lexer::id_index);
                    uid_ = *(ptr_ + zr_boost_1_81::lexer::unique_id_index);
                    end_start_state_ = *(ptr_ + zr_boost_1_81::lexer::state_index);
                    end_bol_ = bol;
                    end_token_ = curr_;
                }
            }
            ...
            if (end_state_) {
                ...
                bol_ = (*start_token_ == '\n') ? true : false;
                id_ = zr_boost_1_81::lexer::npos;
                uid_ = zr_boost_1_81::lexer::npos;
            }
