...
{ 
    ...
    struct position_token<Iterator, lex::omit, mpl::false_, Idtype>
    {
        ...
        position_token() 
          : id_(id_type(zr_boost_1_81::lexer::npos)) {}
        ...
        bool is_valid() const 
        { 
            return 0 != id_ && id_type(zr_boost_1_81::lexer::npos) != id_; 
        }
    ...
    public:
        ...
        //  default constructed tokens correspond to EOI tokens
        position_token() : state_(zr_boost_1_81::lexer::npos) {}

        //  construct an invalid token
        explicit position_token(int) 
          : base_type(0), state_(zr_boost_1_81::lexer::npos) {}
    ...
    public:
        ...
        typedef typename base_type::iterpair_type iterpair_type;
        typedef HasState has_state;
        typedef zr_boost_1_81::optional<Attribute> token_value_type;
