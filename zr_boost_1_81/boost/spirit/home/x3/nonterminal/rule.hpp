...
namespace zr_boost_1_81 { namespace spirit { namespace x3
{
...
#define BOOST_SPIRIT_DECLARE_(r, data, rule_type)                               \
    template <typename Iterator, typename Context>                              \
    bool parse_rule(                                                            \
        ::zr_boost_1_81::spirit::x3::detail::rule_id<rule_type::id>                     \
      , Iterator& first, Iterator const& last                                   \
...
#define BOOST_SPIRIT_DEFINE_(r, data, rule_name)                                \
    template <typename Iterator, typename Context>                              \
    inline bool parse_rule(                                                     \
        ::zr_boost_1_81::spirit::x3::detail::rule_id<decltype(rule_name)::id>           \
      , Iterator& first, Iterator const& last                                   \
