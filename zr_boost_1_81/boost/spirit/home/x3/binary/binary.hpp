...
{
    template <typename T, zr_boost_1_81::endian::order endian, std::size_t bits>
      ...
      : parser<binary_lit_parser<T, endian, bits> >
    {
        ...
        zr_boost_1_81::endian::endian_arithmetic<endian, T, bits> n;
    };
...
#define BOOST_SPIRIT_MAKE_BINARY_PRIMITIVE(name, endiantype, attrtype, bits)                  \
    typedef any_binary_parser< attrtype, zr_boost_1_81::endian::order::endiantype, bits > name##type; \
