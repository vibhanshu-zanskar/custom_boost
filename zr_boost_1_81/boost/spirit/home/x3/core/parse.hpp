...
namespace zr_boost_1_81 { namespace spirit { namespace x3
{
      ...
      , Attribute& attr)
    {
        ...
        // iterator instead.
        BOOST_CONCEPT_ASSERT((zr_boost_1_81_concepts::ReadableIteratorConcept<Iterator>));
        BOOST_CONCEPT_ASSERT((zr_boost_1_81_concepts::ForwardTraversalConcept<Iterator>));
