...
namespace zr_boost_1_81 { namespace spirit { namespace x3
{
    ...
    public:
        ...
        ~forward_ast()
        {
            zr_boost_1_81::checked_delete(p_);
        }
...
# pragma warning(disable: 4521) // multiple copy constructors specified
    ...
    struct variant
    {
        ...
        using variant_type = zr_boost_1_81::variant<Types...>;
...
namespace zr_boost_1_81
{
    ...
    inline T const&
    get(zr_boost_1_81::spirit::x3::variant<Types...> const& x) BOOST_NOEXCEPT
    {
    ...
    template <typename T, typename ...Types>
    inline T&
    get(zr_boost_1_81::spirit::x3::variant<Types...>& x) BOOST_NOEXCEPT
    {
        return zr_boost_1_81::get<T>(x.get());
    }
