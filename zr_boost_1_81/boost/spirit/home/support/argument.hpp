...
#define SPIRIT_DECLARE_ARG(z, n, data)                                        \
    typedef zr_boost_1_81phoenix::actor<argument<n> >                                      \
        BOOST_PP_CAT(BOOST_PP_CAT(_, BOOST_PP_INC(n)), _type);                \
    zr_boost_1_81phoenix::actor<argument<n> > const                                        \
...
BOOST_PHOENIX_DEFINE_CUSTOM_TERMINAL(
    template <int N>
  , zr_boost_1_81::spirit::argument<N>
...
BOOST_PHOENIX_DEFINE_CUSTOM_TERMINAL(
    template <typename Dummy>
  , zr_boost_1_81::spirit::attribute_context<Dummy>
  , mpl::false_                 // is not nullary
  , v2_eval(
        proto::make<
            zr_boost_1_81::spirit::attribute_context<Dummy>()
...
namespace zr_boost_1_81 { namespace spirit
{
    ...
    typedef zr_boost_1_81phoenix::actor<attribute_context<void> > _0_type;
#ifndef BOOST_SPIRIT_NO_PREDEFINED_TERMINALS
    ...
    typedef zr_boost_1_81phoenix::actor<argument<0> > _1_type;
    typedef zr_boost_1_81phoenix::actor<argument<1> > _2_type;
    typedef zr_boost_1_81phoenix::actor<argument<2> > _3_type;
