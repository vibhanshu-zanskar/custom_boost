...
namespace zr_boost_1_81 { namespace spirit { namespace ucd { namespace detail
{
    static const ::zr_boost_1_81::uint8_t lowercase_stage1[] = {
    ...
    static const ::zr_boost_1_81::uint32_t lowercase_stage2[] = {
    ...
    inline ::zr_boost_1_81::uint32_t lowercase_lookup(::zr_boost_1_81::uint32_t ch)
    {
        ::zr_boost_1_81::uint32_t block_offset = lowercase_stage1[ch / 256] * 256;
        return lowercase_stage2[block_offset + ch % 256];
    }

}}}} // namespace zr_boost_1_81::spirit::unicode::detail
