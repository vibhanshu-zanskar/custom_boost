...
#define SPIRIT_DECLARE_ATTRIBUTE(z, n, data)                                   \
    typedef zr_boost_1_81phoenix::actor<attribute<n> >                                      \
        BOOST_PP_CAT(BOOST_PP_CAT(_r, n), _type);                              \
    zr_boost_1_81phoenix::actor<attribute<n> > const                                        \
...
BOOST_PHOENIX_DEFINE_CUSTOM_TERMINAL(
    template <int N>
  , zr_boost_1_81::spirit::attribute<N>
...
BOOST_PHOENIX_DEFINE_CUSTOM_TERMINAL(
    template <int N>
  , zr_boost_1_81::spirit::local_variable<N>
  , mpl::false_                 // is not nullary
  , v2_eval(
        proto::make<
            zr_boost_1_81::spirit::local_variable<N>()
...
namespace zr_boost_1_81 { namespace spirit
{
    ...
    typedef zr_boost_1_81phoenix::actor<attribute<0> > _val_type;
    typedef zr_boost_1_81phoenix::actor<attribute<0> > _r0_type;
    typedef zr_boost_1_81phoenix::actor<attribute<1> > _r1_type;
    typedef zr_boost_1_81phoenix::actor<attribute<2> > _r2_type;
    ...
    typedef zr_boost_1_81phoenix::actor<local_variable<0> > _a_type;
    typedef zr_boost_1_81phoenix::actor<local_variable<1> > _b_type;
    typedef zr_boost_1_81phoenix::actor<local_variable<2> > _c_type;
    typedef zr_boost_1_81phoenix::actor<local_variable<3> > _d_type;
    typedef zr_boost_1_81phoenix::actor<local_variable<4> > _e_type;
    typedef zr_boost_1_81phoenix::actor<local_variable<5> > _f_type;
    typedef zr_boost_1_81phoenix::actor<local_variable<6> > _g_type;
    typedef zr_boost_1_81phoenix::actor<local_variable<7> > _h_type;
    typedef zr_boost_1_81phoenix::actor<local_variable<8> > _i_type;
    typedef zr_boost_1_81phoenix::actor<local_variable<9> > _j_type;
