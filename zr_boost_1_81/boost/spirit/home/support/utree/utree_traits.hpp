...
{
    template <typename T>
    inline T get(zr_boost_1_81::spirit::utree const& x)
    {
        return x.get<T>();
    }
}
...
namespace zr_boost_1_81 { namespace spirit { namespace traits
{
    ...
    namespace detail
    {
        struct attribute_as_string_type
        {
            ...
            {
                return zr_boost_1_81::get<utf8_string_range_type>(attr);
            }
    ...
    namespace detail
    {
        struct attribute_as_symbol_type
        {
            ...
            static type call(utree const& attr)
            {
                return zr_boost_1_81::get<utf8_symbol_range_type>(attr);
            }
    ...
    namespace detail
    {
        struct attribute_as_binary_string_type
        {
            ...
            static type call(utree const& attr)
            {
                return zr_boost_1_81::get<binary_range_type>(attr);
            }
    ...
    namespace detail
    {
        ...
        template <typename Attribute>
        struct handles_utree_list_container<zr_boost_1_81::optional<Attribute> >
          : mpl::true_
        {};
    ...
    namespace detail
    {
        ...
        template <typename Attribute>
        struct handles_utree_container<zr_boost_1_81::optional<Attribute> >
          : mpl::true_
        {};
    ...
    struct symbols_lookup<utree, utf8_symbol_type>
    {
        ...
        {
            utf8_symbol_range_type r = zr_boost_1_81::get<utf8_symbol_range_type>(t);
    ...
    namespace detail
    {
        ...
        {
            if (detail::is_list(t))
                return zr_boost_1_81::get<T>(t.front());
            return zr_boost_1_81::get<T>(t);
        }
    }
        ...
        iterator_range<Iterator> const, utree, karma::domain>
    {
        ...
        static type pre(iterator_range<Iterator> const& t)
        {
            ...
            Iterator it = t.begin();
            utree result(zr_boost_1_81::ref(*it));
            ++it;
            return result;
        }
    };
