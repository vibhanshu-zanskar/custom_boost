...
namespace zr_boost_1_81 { namespace spirit { namespace detail
{
    ...
    struct list::node : zr_boost_1_81::noncopyable
    {
        template <typename T>
    ...
    private:
        ...
        friend class zr_boost_1_81::spirit::utree;
        friend struct zr_boost_1_81::spirit::detail::list;
    ...
    template <typename Value>
    class list::node_iterator<zr_boost_1_81::reference_wrapper<Value> >
      : public zr_boost_1_81::iterator_facade<
            node_iterator<zr_boost_1_81::reference_wrapper<Value> >
          , zr_boost_1_81::reference_wrapper<Value>
          , zr_boost_1_81::bidirectional_traversal_tag>
    {
    public:
    ...
    private:
        ...
        void increment()
        {
            if (node != 0) // not at end
            {
                prev = node;
                node = node->next;
                curr = zr_boost_1_81::ref(node ? node->val : nil_node);
            }
        }
        ...
        mutable zr_boost_1_81::reference_wrapper<Value> curr;
    };

    template <typename Value>
    Value list::node_iterator<zr_boost_1_81::reference_wrapper<Value> >::nil_node = Value();
    ...
    struct visit_impl
    {
        ...
        {
            typedef typename
                zr_boost_1_81::mpl::if_<zr_boost_1_81::is_const<UTreeX>,
                typename UTreeX::const_iterator,
                typename UTreeX::iterator>::type
            iterator;

            typedef zr_boost_1_81::iterator_range<iterator> list_range;
...
namespace zr_boost_1_81 { namespace spirit
{
    ...
    inline utree::utree(zr_boost_1_81::reference_wrapper<utree> ref)
    {
        s.initialize();
        p = ref.get_pointer();
    ...
    inline utree::utree(zr_boost_1_81::iterator_range<Iter> r)
    {
        s.initialize();
    ...
    inline utree& utree::operator=(zr_boost_1_81::reference_wrapper<utree> ref)
    {
        free();
        p = ref.get_pointer();
        set_type(type::reference_type);
    ...
    template <typename Iter>
    inline utree& utree::operator=(zr_boost_1_81::iterator_range<Iter> r)
    {
        free();
        assign(r.begin(), r.end());
        return *this;
    ...
    template <typename F>
    typename zr_boost_1_81::result_of<F(utree const&)>::type
    ...
    template <typename F>
    typename zr_boost_1_81::result_of<F(utree&)>::type
    ...
    template <typename F>
    typename zr_boost_1_81::result_of<F(utree const&, utree const&)>::type
    ...
    template <typename F>
    typename zr_boost_1_81::result_of<F(utree const&, utree&)>::type
    ...
    template <typename F>
    typename zr_boost_1_81::result_of<F(utree&, utree const&)>::type
    ...
    template <typename F>
    typename zr_boost_1_81::result_of<F(utree&, utree&)>::type
    ...
    template <typename Iterator>
    struct is_iterator_range<zr_boost_1_81::iterator_range<Iterator> >
    ...
    struct utree_cast
    {
        ...
        To dispatch(From const& val, zr_boost_1_81::mpl::true_) const
        {
            return To(val); // From is convertible to To
        }

        template <typename From>
        BOOST_NORETURN To dispatch(From const&, zr_boost_1_81::mpl::false_) const
        {
        ...
        {
            // zr_boost_1_81::iterator_range has a templated constructor, accepting
            // any argument and hence any type is 'convertible' to it.
            typedef typename zr_boost_1_81::mpl::eval_if<
                is_iterator_range<To>
              , zr_boost_1_81::is_same<From, To>, zr_boost_1_81::is_convertible<From, To>
            >::type is_convertible;
