...
namespace zr_boost_1_81 { namespace spirit
{
    ...
    */
    struct utree_type
    {
        ...
        typedef zr_boost_1_81::uint_t<sizeof(info)*8>::exact exact_integral_type; 
        typedef zr_boost_1_81::uint_t<sizeof(info)*8>::fast fast_integral_type; 
    };
    //]
    ...
    {
        zr_boost_1_81::io::ios_all_saver saver(out);
        switch (t) {
    ...
    */
    typedef basic_string<
        zr_boost_1_81::iterator_range<char const*>, utree_type::binary_type
    > binary_range_type;
    typedef basic_string<
    ...
    */
    typedef basic_string<
        zr_boost_1_81::iterator_range<char const*>, utree_type::string_type
    ...
    */
    typedef basic_string<
        zr_boost_1_81::iterator_range<char const*>, utree_type::symbol_type
    ...
    public:
        ...
        typename zr_boost_1_81::disable_if<
            zr_boost_1_81::is_polymorphic<
                typename zr_boost_1_81::remove_pointer<Ptr>::type>,
            Ptr>::type
        get() const
        {
            if (*i == typeid(Ptr))
            ...
            zr_boost_1_81::throw_exception(std::bad_cast());
        }
    ...
    public:
        ...
        typedef detail::list::node_iterator<zr_boost_1_81::reference_wrapper<utree> >
          ref_iterator;

        typedef zr_boost_1_81::iterator_range<iterator> range;
        typedef zr_boost_1_81::iterator_range<const_iterator> const_range;
        ...
        */
        ...
        // where a zr_boost_1_81::optional is expected (i.e. as an attribute for the 
        ...
        utree(zr_boost_1_81::reference_wrapper<utree>);
        reference operator=(zr_boost_1_81::reference_wrapper<utree>);
        ...
        utree(zr_boost_1_81::iterator_range<Iterator>);
        template <class Iterator>
        reference operator=(zr_boost_1_81::iterator_range<Iterator>);
