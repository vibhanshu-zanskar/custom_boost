...
namespace zr_boost_1_81 { namespace spirit 
{
    ...
    struct utree_is_equal
    {
        ...
        bool dispatch(const A&, const B&, zr_boost_1_81::mpl::false_) const
        {
            return false; // cannot compare different types by default
        }

        template <typename A, typename B>
        bool dispatch(const A& a, const B& b, zr_boost_1_81::mpl::true_) const
        {
        ...
        bool operator()(const A& a, const B& b) const
        {
            return dispatch(a, b,
                zr_boost_1_81::mpl::and_<
                    zr_boost_1_81::is_arithmetic<A>,
                    zr_boost_1_81::is_arithmetic<B> >());
        }
    ...
    struct utree_print
    {
        ...
        void operator()(zr_boost_1_81::iterator_range<Iterator> const& range) const
        {
            typedef typename zr_boost_1_81::iterator_range<Iterator>::const_iterator iterator;
            (*this)('(');
            for (iterator i = range.begin(); i != range.end(); ++i)
            {
                zr_boost_1_81::spirit::utree::visit(*i, *this);
            }
            (*this)(')');
        }
    ...
    struct logical_function
    {
        ...
        {
            return dispatch(a, zr_boost_1_81::is_arithmetic<A>());
        }
    ...
    struct arithmetic_function
    {
        ...
        template <typename A, typename B>
        utree dispatch(A const&, B const&, zr_boost_1_81::mpl::false_) const
        {
            return utree(); // cannot apply to non-arithmetic types
        }

        template <typename A, typename B>
        utree dispatch(A const& a, B const& b, zr_boost_1_81::mpl::true_) const
        {
            return Base::eval(a, b); // for arithmetic types
        }
        ...
        template <typename A>
        utree dispatch(A const&, zr_boost_1_81::mpl::false_) const
        {
            return utree(); // cannot apply to non-arithmetic types
        }

        template <typename A>
        utree dispatch(A const& a, zr_boost_1_81::mpl::true_) const
        {
    ...
    struct integral_function
    {
        ...
        utree operator()(A const& a, B const& b) const
        {
            return dispatch(a, b,
                zr_boost_1_81::mpl::and_<
                    zr_boost_1_81::is_integral<A>,
                    zr_boost_1_81::is_integral<B> >());
        }
        ...
        utree operator()(A const& a) const
        {
            return dispatch(a, zr_boost_1_81::is_integral<A>());
        }
    };
