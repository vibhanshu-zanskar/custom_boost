...
//        {};
    ...
    template <typename T, typename Expected>
    struct is_weak_substitute<zr_boost_1_81::variant<T>, Expected>
      : is_weak_substitute<T, Expected>
    {};

    template <typename T0, typename T1, typename ...TN, typename Expected>
    struct is_weak_substitute<zr_boost_1_81::variant<T0, T1, TN...>,
            Expected>
      : mpl::bool_<is_weak_substitute<T0, Expected>::type::value &&
            is_weak_substitute<zr_boost_1_81::variant<T1, TN...>, Expected>::type::value>
    {};
#else
#define BOOST_SPIRIT_IS_WEAK_SUBSTITUTE(z, N, _)                              \
    ...
    struct is_weak_substitute<zr_boost_1_81::detail::variant::void_, Expected>
      : mpl::true_
    {};

    template <BOOST_VARIANT_ENUM_PARAMS(typename T), typename Expected>
    struct is_weak_substitute<
            zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Expected>
...
#undef BOOST_SPIRIT_IS_WEAK_SUBSTITUTE
    ...
    struct not_is_variant<zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Domain>
      : mpl::false_
    {};
    ...
    template <typename T>
    struct variant_type<zr_boost_1_81::optional<T> >
      : variant_type<T>
    {};
    ...
    namespace detail
    {
        ...
        template <typename Expected, typename Attribute>
        struct attribute_is_compatible<Expected, zr_boost_1_81::optional<Attribute> >
          : is_convertible<Attribute, Expected>
        {};
    ...
    struct variant_which<zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
    {
        static int call(zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const& v)
        {
            return v.which();
        }
    };
    ...
    template <typename T, typename Domain>
    struct not_is_optional<zr_boost_1_81::optional<T>, Domain>
      : mpl::false_
    {};
    ...
    // build_optional
    //
    // Build a zr_boost_1_81::optional from T. Return unused_type if T is unused_type.
    ///////////////////////////////////////////////////////////////////////////
    template <typename T>
    struct build_optional
    {
        typedef zr_boost_1_81::optional<T> type;
    };

    template <typename T>
    struct build_optional<zr_boost_1_81::optional<T> >
    {
        typedef zr_boost_1_81::optional<T> type;
    };
    ...
    namespace detail
    {
        ...
        {
            typedef zr_boost_1_81::optional<
    ...
    // build_variant
    //
    // Build a zr_boost_1_81::variant from a fusion sequence. build_variant makes sure
    ...
    // optionals
    template <typename T>
    struct clear_value<zr_boost_1_81::optional<T> >
    {
        static void call(zr_boost_1_81::optional<T>& val)
        {
            if (val)
    ...
    struct print_attribute_debug<Out, zr_boost_1_81::optional<T> >
    {
        static void call(Out& out, zr_boost_1_81::optional<T> const& val)
        {
            if (val)
                spirit::traits::print_attribute(out, *val);
            else
