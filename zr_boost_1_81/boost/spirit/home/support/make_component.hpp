...
namespace zr_boost_1_81 { namespace spirit { namespace detail
{
    ...
    template <typename Expr, typename State, typename Data, typename Domain>
    struct make_terminal_impl<zr_boost_1_81phoenix::actor<Expr>, State, Data, Domain>
      : proto::transform_impl<zr_boost_1_81phoenix::actor<Expr>, State, Data>
    {
        typedef zr_boost_1_81phoenix::actor<Expr> value;
        typedef typename result_of::make_cons<value>::type elements;
    ...
    template <typename Expr, typename State, typename Data, typename Domain>
    struct make_terminal_impl<zr_boost_1_81phoenix::actor<Expr> &, State, Data, Domain>
        : make_terminal_impl<zr_boost_1_81phoenix::actor<Expr>, State, Data, Domain>
    {};

    template <typename Expr, typename State, typename Data, typename Domain>
    struct make_terminal_impl<zr_boost_1_81phoenix::actor<Expr> const &, State, Data, Domain>
        : make_terminal_impl<zr_boost_1_81phoenix::actor<Expr>, State, Data, Domain>
    {};
            ...
            ) const
            {
                return
                    (*this)(
                      ...
                      , state
                      , data
                      , typename zr_boost_1_81phoenix::is_actor<
                            typename proto::result_of::child_c<Expr, 1>::type
                        >::type()
                    );
            }
