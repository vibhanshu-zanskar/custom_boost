...
namespace zr_boost_1_81 { namespace spirit { namespace traits
{
    ...
    template <typename T>
    struct is_container<zr_boost_1_81::optional<T> >
      : is_container<T>
    {};

#if !defined(BOOST_VARIANT_DO_NOT_USE_VARIADIC_TEMPLATES)
    template<typename T>
    struct is_container<zr_boost_1_81::variant<T> >
      : is_container<T>
    {};

    template<typename T0, typename T1, typename ...TN>
    struct is_container<zr_boost_1_81::variant<T0, T1, TN...> >
      : mpl::bool_<is_container<T0>::value ||
            is_container<zr_boost_1_81::variant<T1, TN...> >::value>
    {};
...
#define BOOST_SPIRIT_IS_CONTAINER(z, N, data)                                 \
    ...
    template <>
    struct is_container<zr_boost_1_81::detail::variant::void_>
      : mpl::false_
    {};
...
#undef BOOST_SPIRIT_IS_CONTAINER
    ...
    template <typename T>
    struct container_value<zr_boost_1_81::optional<T> >
      : container_value<T>
    {};
    ...
    template <typename T>
    struct optional_attribute<zr_boost_1_81::optional<T> >
    {
        typedef T const& type;

        static type call(zr_boost_1_81::optional<T> const& val)
        {
            return zr_boost_1_81::get<T>(val);
        }

        static bool is_valid(zr_boost_1_81::optional<T> const& val)
        {
            return !!val;
        }
    };
    ...
    {
        static bool call(zr_boost_1_81::optional<Container>& c, T const& val)
        {
            if (!c)
                c = Container();
            return push_back(zr_boost_1_81::get<Container>(c), val);
        }
    };
...
///////////////////////////////////////////////////////////////////////////////
namespace zr_boost_1_81 { namespace spirit { namespace result_of
{
    ///////////////////////////////////////////////////////////////////////////
    template <typename T>
    ...
    template <typename T>
    struct optional_value<zr_boost_1_81::optional<T> >
    {
        typedef T type;
    };

    template <typename T>
    struct optional_value<zr_boost_1_81::optional<T> const>
    {
        typedef T const type;
    };
