...
#define BOOST_SPIRIT_DEFINE_CHAR_CODES(charset)                                 \
    namespace zr_boost_1_81 { namespace spirit { namespace tag { namespace charset      \
    {                                                                           \
        BOOST_SPIRIT_TAG_CHAR_SPEC(spirit::char_encoding::charset)              \
    }}}}                                                                        \
    namespace zr_boost_1_81 { namespace spirit { namespace charset                      \
    {                                                                           \
...
BOOST_SPIRIT_DEFINE_CHAR_CODES(unicode)
    ...
    namespace zr_boost_1_81 { namespace spirit { namespace tag { namespace unicode
    {
        BOOST_SPIRIT_TAG_CHAR_SPEC(spirit::char_encoding::unicode)
    }}}}

    namespace zr_boost_1_81 { namespace spirit { namespace unicode
    {
