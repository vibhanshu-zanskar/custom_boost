...
protected:
    ...
    typedef zr_boost_1_81::movelib::unique_ptr<charset> charset_ptr;
    typedef detail::equivset equivset;
    typedef detail::ptr_list<equivset> equivset_list;
    typedef zr_boost_1_81::movelib::unique_ptr<equivset> equivset_ptr;
        ...
        size_t_vector &dfa_)
    {
        ...
        std::size_t index_ = 0;
        zr_boost_1_81::movelib::unique_ptr<node_set> set_ptr_ (new node_set);
        zr_boost_1_81::movelib::unique_ptr<node_vector> vector_ptr_ (new node_vector);
