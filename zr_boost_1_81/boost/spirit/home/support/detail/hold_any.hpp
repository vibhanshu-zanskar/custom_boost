/*=============================================================================
    ...
    The class zr_boost_1_81::spirit::hold_any is built based on the any class
...
namespace zr_boost_1_81 { namespace spirit
{
    struct bad_any_cast
      : std::bad_cast
    {
        bad_any_cast(zr_boost_1_81::core::typeinfo const& src, zr_boost_1_81::core::typeinfo const& dest)
    ...
    namespace detail
    {
        ...
        {
            zr_boost_1_81::core::typeinfo const& (*get_type)();
        ...
        struct fxns<mpl::true_>
        {
            ...
            struct type
            {
                static zr_boost_1_81::core::typeinfo const& get_type()
                {
    ...
    public:
        ...
        zr_boost_1_81::core::typeinfo const& type() const
        {
...
// implicit casting is disabled by default for compatibility with zr_boost_1_81::any
    ...
    // zr_boost_1_81::any-like casting
    template <typename T, typename Char>
    ...
    T any_cast(basic_hold_any<Char>& operand)
    {
        ...
        if(!result)
            zr_boost_1_81::throw_exception(bad_any_cast(operand.type(), BOOST_CORE_TYPEID(T)));
        return *result;
    }
