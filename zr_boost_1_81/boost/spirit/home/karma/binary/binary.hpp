...
///////////////////////////////////////////////////////////////////////////////
namespace zr_boost_1_81 { namespace spirit { namespace karma
{
#ifndef BOOST_SPIRIT_NO_PREDEFINED_TERMINALS
    using zr_boost_1_81::spirit::byte_;
    using zr_boost_1_81::spirit::word;
    using zr_boost_1_81::spirit::big_word;
    using zr_boost_1_81::spirit::little_word;
    using zr_boost_1_81::spirit::dword;
    using zr_boost_1_81::spirit::big_dword;
    using zr_boost_1_81::spirit::little_dword;
#ifdef BOOST_HAS_LONG_LONG
    using zr_boost_1_81::spirit::qword;
    using zr_boost_1_81::spirit::big_qword;
    using zr_boost_1_81::spirit::little_qword;
#endif
    using zr_boost_1_81::spirit::bin_float;
    using zr_boost_1_81::spirit::big_bin_float;
    using zr_boost_1_81::spirit::little_bin_float;
    using zr_boost_1_81::spirit::bin_double;
    using zr_boost_1_81::spirit::big_bin_double;
    using zr_boost_1_81::spirit::little_bin_double;
#endif

    using zr_boost_1_81::spirit::byte_type;
    using zr_boost_1_81::spirit::word_type;
    using zr_boost_1_81::spirit::big_word_type;
    using zr_boost_1_81::spirit::little_word_type;
    using zr_boost_1_81::spirit::dword_type;
    using zr_boost_1_81::spirit::big_dword_type;
    using zr_boost_1_81::spirit::little_dword_type;
#ifdef BOOST_HAS_LONG_LONG
    using zr_boost_1_81::spirit::qword_type;
    using zr_boost_1_81::spirit::big_qword_type;
    using zr_boost_1_81::spirit::little_qword_type;
#endif
    using zr_boost_1_81::spirit::bin_float_type;
    using zr_boost_1_81::spirit::big_bin_float_type;
    using zr_boost_1_81::spirit::little_bin_float_type;
    using zr_boost_1_81::spirit::bin_double_type;
    using zr_boost_1_81::spirit::big_bin_double_type;
    using zr_boost_1_81::spirit::little_bin_double_type;
    ...
    namespace detail
    {
        ...
        ///////////////////////////////////////////////////////////////////////
        template <BOOST_SCOPED_ENUM(zr_boost_1_81::endian::order) bits>
        struct what;

        template <>
        struct what<zr_boost_1_81::endian::order::little>
        {
            static info is()
            {
        ...
        template <>
        struct what<zr_boost_1_81::endian::order::big>
        {
            static info is()
            {
    ...
    ///////////////////////////////////////////////////////////////////////////
    template <typename T, BOOST_SCOPED_ENUM(zr_boost_1_81::endian::order) endian, int bits>
      ...
      : primitive_generator<any_binary_generator<T, endian, bits> >
    {
          ...
          , Delimiter const& d, Attribute const& attr)
        {
            ...
            zr_boost_1_81::endian::endian_arithmetic<endian, typename T::type, bits> p;
...
#pragma warning(pop)
        ...
        typedef zr_boost_1_81::endian::endian_arithmetic<endian, typename T::type,
            bits> data_type;
    ...
    namespace detail
    {
        template <typename T, BOOST_SCOPED_ENUM(zr_boost_1_81::endian::order) endian
          , int bits>
        struct basic_binary
        {
        ...
        template <typename Modifiers, typename T
          , BOOST_SCOPED_ENUM(zr_boost_1_81::endian::order) endian, int bits>
...
#define BOOST_SPIRIT_MAKE_BINARY_PRIMITIVE(name, endiantype, bits)            \
    ...
    struct make_primitive<tag::name, Modifiers>                               \
      : detail::basic_binary<detail::integer<bits>,                           \
        zr_boost_1_81::endian::order::endiantype, bits> {};                           \
                                                                              \
