...
namespace zr_boost_1_81 { namespace spirit { namespace karma
{
    ...
    struct transform_attribute<zr_boost_1_81::optional<Exposed> const, Transformed
      , typename disable_if<is_same<zr_boost_1_81::optional<Exposed>, Transformed> >::type>
    {
        typedef Transformed const& type;
        static Transformed const& pre(zr_boost_1_81::optional<Exposed> const& val)
        {
            return zr_boost_1_81::get<Transformed>(val);
        }
    };
...
///////////////////////////////////////////////////////////////////////////////
namespace zr_boost_1_81 { namespace spirit { namespace traits { namespace detail
{
    template <typename Exposed, typename Transformed>
