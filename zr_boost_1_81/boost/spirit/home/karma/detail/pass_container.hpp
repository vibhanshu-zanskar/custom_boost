...
namespace zr_boost_1_81 { namespace spirit { namespace karma { namespace detail
{
    ...
    template <typename Container, typename ValueType, typename Attribute
      , typename Sequence>
    struct pass_through_container<
            Container, ValueType, zr_boost_1_81::optional<Attribute>, Sequence>
    ...
    template <typename Container, typename ValueType, typename Attribute
      , typename Sequence>
    struct pass_through_container<
            Container, zr_boost_1_81::optional<ValueType>, zr_boost_1_81::optional<Attribute>
          , Sequence>
    ...
    template <typename Container, typename ValueType, typename Sequence
      , typename T>
    struct pass_through_container<Container, ValueType, zr_boost_1_81::variant<T>
          , Sequence>
...
#define BOOST_SPIRIT_PASS_THROUGH_CONTAINER(z, N, _)                          \
    ...
    template <typename Container, typename ValueType, typename Sequence>
    struct pass_through_container<Container, ValueType
          , zr_boost_1_81::detail::variant::void_, Sequence>
      : mpl::false_
    {};
    ...
    struct pass_through_container<Container, ValueType
          , zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Sequence>
