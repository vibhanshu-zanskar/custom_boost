...
namespace zr_boost_1_81 { namespace spirit { namespace karma
{
    ...
    // optional
    template <typename T>
    struct meta_create<zr_boost_1_81::optional<T> >
    {
        typedef make_unary_proto_expr<
    ...
    struct meta_create<zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
    {
        typedef make_nary_proto_expr<
            typename zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)>::types
    ...
    template <>
    struct meta_create<zr_boost_1_81::long_long_type>
    {
        typedef spirit::long_long_type type;
        static type call() { return type(); }
    };
    template <>
    struct meta_create<zr_boost_1_81::ulong_long_type>
    {
