...
namespace zr_boost_1_81 { namespace spirit
{
    ...
    struct use_terminal<karma::domain, zr_boost_1_81phoenix::actor<Eval> >  // enables phoenix actors
        : mpl::true_ {};
...
namespace zr_boost_1_81 { namespace spirit { namespace karma
{
    ...
    struct lazy_generator : generator<lazy_generator<Function, Modifiers> >
    {
        ...
        {
            typedef typename
                zr_boost_1_81::result_of<karma_modify(tag::lazy_eval, Modifiers)>::type
            modifier;

            typedef typename
                remove_reference<
                    typename zr_boost_1_81::result_of<Function(unused_type, Context)>::type
                >::type
            expr_type;
    ...
    struct make_primitive<zr_boost_1_81phoenix::actor<Eval>, Modifiers>
    {
        typedef lazy_generator<zr_boost_1_81phoenix::actor<Eval>, Modifiers> result_type;
        result_type operator()(zr_boost_1_81phoenix::actor<Eval> const& f
