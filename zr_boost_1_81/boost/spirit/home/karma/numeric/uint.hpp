...
namespace zr_boost_1_81 { namespace spirit
{
    ...
    struct use_terminal<karma::domain, zr_boost_1_81::ulong_long_type>
      : mpl::true_ {};
#endif
...
namespace zr_boost_1_81 { namespace spirit { namespace karma
{
    ...
    struct make_primitive<tag::ulong_long, Modifiers>
      : detail::make_uint<zr_boost_1_81::ulong_long_type, Modifiers> {};
#endif
    ...
    struct make_primitive<
      ...
      : detail::make_uint_direct<zr_boost_1_81::ulong_long_type, Modifiers> {};
#endif
...
#ifdef BOOST_HAS_LONG_LONG
    template <typename Modifiers>
    struct make_primitive<zr_boost_1_81::ulong_long_type, Modifiers>
      : detail::basic_uint_literal<zr_boost_1_81::ulong_long_type, Modifiers> {};
#endif
