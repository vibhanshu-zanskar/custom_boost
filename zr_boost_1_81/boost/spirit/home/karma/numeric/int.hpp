...
#ifdef BOOST_HAS_LONG_LONG
    template <>
    struct use_terminal<karma::domain, zr_boost_1_81::long_long_type> // enables lit(0LL)
      : mpl::true_ {};
#endif
...
namespace zr_boost_1_81 { namespace spirit { namespace karma
{
    ...
    struct make_primitive<tag::long_long, Modifiers>
      : detail::make_int<zr_boost_1_81::long_long_type, Modifiers> {};
#endif
    ...
    struct make_primitive<
      ...
      : detail::make_int_direct<zr_boost_1_81::long_long_type, Modifiers> {};
#endif
...
#ifdef BOOST_HAS_LONG_LONG
    template <typename Modifiers>
    struct make_primitive<zr_boost_1_81::long_long_type, Modifiers>
      : detail::basic_int_literal<zr_boost_1_81::long_long_type, Modifiers> {};
#endif
