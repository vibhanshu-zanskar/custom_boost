...
# pragma warning(disable: 4146)
    ...
    BOOST_SPIRIT_ABSOLUTE_VALUE(zr_boost_1_81::long_long_type, zr_boost_1_81::ulong_long_type);
    BOOST_SPIRIT_ABSOLUTE_VALUE_UNSIGNED(zr_boost_1_81::ulong_long_type);
#endif
#if defined(BOOST_MSVC)
# pragma warning(pop)
#endif
...
#define BOOST_KARMA_NUMERICS_INNER_LOOP_SUFFIX(z, x, n_rolls_sub1)            \
    ...
    private:
        ...
        // a zr_boost_1_81::long_long_type (if this does exist) or in a plain long
        // otherwise
#if defined(BOOST_HAS_LONG_LONG)
        typedef zr_boost_1_81::long_long_type biggest_long_type;
#else
