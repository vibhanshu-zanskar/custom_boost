...
namespace zr_boost_1_81 { namespace spirit { namespace traits
{
    ...
    template <typename Iterator>
    struct assign_to_attribute_from_iterators<zr_boost_1_81::long_long_type, Iterator>
    {
        static void
        call(Iterator const& first, Iterator const& last, zr_boost_1_81::long_long_type& attr)
        {
            Iterator first_ = first;
    ...
    template <typename Iterator>
    struct assign_to_attribute_from_iterators<zr_boost_1_81::ulong_long_type, Iterator>
    {
        static void
        call(Iterator const& first, Iterator const& last, zr_boost_1_81::ulong_long_type& attr)
        {
            Iterator first_ = first;
