...
namespace zr_boost_1_81 { namespace spirit { namespace qi
{
    ...
    template <typename Exposed, typename Transformed>
    struct transform_attribute<zr_boost_1_81::optional<Exposed>, Transformed
      , typename disable_if<is_same<zr_boost_1_81::optional<Exposed>, Transformed> >::type>
    {
        typedef Transformed& type;
        static Transformed& pre(zr_boost_1_81::optional<Exposed>& val)
        {
            if (!val)
                val = Transformed();
            return zr_boost_1_81::get<Transformed>(val);
        }
        static void post(zr_boost_1_81::optional<Exposed>&, Transformed const&) {}
        static void fail(zr_boost_1_81::optional<Exposed>& val)
        {
