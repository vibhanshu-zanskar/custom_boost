...
namespace zr_boost_1_81 { namespace spirit { namespace traits
{
    ...
    namespace detail
    {
        ...
        template <typename I>
        struct is_iter_range<zr_boost_1_81::iterator_range<I> > : mpl::true_ {};
    ...
    template <typename Attribute, typename Iterator>
    struct assign_to_attribute_from_iterators<
        zr_boost_1_81::optional<Attribute>, Iterator>
    {
        static void
        call(Iterator const& first, Iterator const& last
          , zr_boost_1_81::optional<Attribute>& attr)
        {
            Attribute val;
    ...
    template <typename Attribute, typename T>
    struct assign_to_attribute_from_value<Attribute, zr_boost_1_81::optional<T>
      , typename disable_if<is_same<Attribute, zr_boost_1_81::optional<T> > >::type>
    {
        static void
        call(zr_boost_1_81::optional<T> const& val, Attribute& attr)
        {
            assign_to(val.get(), attr);
        }
    };
    ...
    template <typename Attribute, typename T>
    struct assign_to_container_from_value<Attribute, zr_boost_1_81::optional<T>
      , typename disable_if<is_same<Attribute, zr_boost_1_81::optional<T> > >::type>
    {
        static void
        call(zr_boost_1_81::optional<T> const& val, Attribute& attr)
