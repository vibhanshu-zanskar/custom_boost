...
namespace zr_boost_1_81 { namespace spirit
{
    ...
    struct use_terminal<qi::domain, zr_boost_1_81phoenix::actor<Eval> >  // enables phoenix actors
        : mpl::true_ {};
...
namespace zr_boost_1_81 { namespace spirit { namespace qi
{
    ...
    struct lazy_parser : parser<lazy_parser<Function, Modifiers> >
    {
        ...
        {
            typedef typename
                zr_boost_1_81::result_of<qi_modify(tag::lazy_eval, Modifiers)>::type
            modifier;
    ...
    {
        typedef lazy_parser<zr_boost_1_81phoenix::actor<Eval>, Modifiers> result_type;
