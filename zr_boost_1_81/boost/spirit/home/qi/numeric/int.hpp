...
namespace zr_boost_1_81 { namespace spirit
{
    ...
    struct use_terminal<qi::domain
        , terminal_ex<tag::lit, fusion::vector1<A0> >
        , typename enable_if<is_same<A0, zr_boost_1_81::long_long_type> >::type>
      : mpl::true_ {};
...
namespace zr_boost_1_81 { namespace spirit { namespace qi
{
    ...
    struct make_primitive<
          terminal_ex<tag::lit, fusion::vector1<A0> >
        , Modifiers, typename enable_if<is_same<A0, zr_boost_1_81::long_long_type> >::type>
      : make_literal_int<zr_boost_1_81::long_long_type> {};
#endif
    ...
    struct make_primitive<tag::long_long, Modifiers>
      : make_int<zr_boost_1_81::long_long_type> {};
    //]
    ...
    struct make_primitive<
      ...
      , fusion::vector1<A0> > , Modifiers>
      : make_direct_int<zr_boost_1_81::long_long_type> {};
#endif
}}}
