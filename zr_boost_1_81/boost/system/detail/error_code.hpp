...
private:
    ...
    zr_boost_1_81::uintptr_t lc_flags_;
...
public:
    ...
    error_code( int val, const error_category & cat, source_location const * loc ) BOOST_NOEXCEPT:
        d1_(), lc_flags_( ( loc? reinterpret_cast<zr_boost_1_81::uintptr_t>( loc ): 2 ) | +detail::failed_impl( val, cat ) )
    {
        d1_.val_ = val;
        d1_.cat_ = &cat;
    }
        ...
        d1_(), lc_flags_( 0 )
    {
        *this = ec;
        ...
        {
            lc_flags_ = ( loc? reinterpret_cast<zr_boost_1_81::uintptr_t>( loc ): 2 ) | ( ec.lc_flags_ & 1 );
        }
    }
        ...
        d1_(), lc_flags_( 0 )
    {
        ...
        {
            *this = zr_boost_1_81::system::error_code( ec.value(), pc2->original_category() );
        }
        else
    ...
    BOOST_SYSTEM_CONSTEXPR int value() const BOOST_NOEXCEPT
    {
        ...
        else
        {
            ...
            unsigned ch = static_cast<unsigned>( reinterpret_cast<zr_boost_1_81::uintptr_t>( &ec.category() ) % 2097143 ); // 2^21-9, prime
    ...
    source_location const & location() const BOOST_NOEXCEPT
    {
        ...
        return lc_flags_ >= 4? *reinterpret_cast<source_location const*>( lc_flags_ &~ static_cast<zr_boost_1_81::uintptr_t>( 1 ) ): loc;
    }
...
// This condition must be the same as the one in error_category_impl.hpp
            ...
            return std::error_code( 0, zr_boost_1_81::system::system_category() );
...
inline std::size_t hash_value( error_code const & ec )
{
    ...
    zr_boost_1_81::ulong_long_type id_ = cat.id_;

    if( id_ == 0 )
    {
        id_ = reinterpret_cast<zr_boost_1_81::uintptr_t>( &cat );
    }
