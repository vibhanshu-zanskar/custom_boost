...
inline zr_boost_1_81::winapi::UINT_ message_cp_win32()
{
#if defined(BOOST_SYSTEM_USE_UTF8)

    return zr_boost_1_81::winapi::CP_UTF8_;

#else

    return zr_boost_1_81::winapi::CP_ACP_;
...
inline char const * system_category_message_win32( int ev, char * buffer, std::size_t len ) BOOST_NOEXCEPT
{
    ...
    zr_boost_1_81::winapi::UINT_ const code_page = message_cp_win32();

    int r = 0;

#if !defined(BOOST_NO_ANSI_APIS)

    if( code_page == zr_boost_1_81::winapi::CP_ACP_ )
    {
        using namespace zr_boost_1_81::winapi;

        DWORD_ retval = zr_boost_1_81::winapi::FormatMessageA(
...

    {
        ...
        DWORD_ retval = zr_boost_1_81::winapi::FormatMessageW(
        ...
        if( retval != 0 )
        {
            r = zr_boost_1_81::winapi::WideCharToMultiByte( code_page, 0, lpMsgBuf, -1, buffer, static_cast<int>( len ), NULL, NULL );
            zr_boost_1_81::winapi::LocalFree( lpMsgBuf );
...
struct local_free
{
    ...
    ~local_free()
    {
        zr_boost_1_81::winapi::LocalFree( p_ );
    }
};
...
inline std::string system_category_message_win32( int ev )
{
    ...
    int r = zr_boost_1_81::winapi::WideCharToMultiByte( code_page, 0, lpMsgBuf, -1, 0, 0, NULL, NULL );
    ...
    r = zr_boost_1_81::winapi::WideCharToMultiByte( code_page, 0, lpMsgBuf, -1, &buffer[0], r, NULL, NULL );
