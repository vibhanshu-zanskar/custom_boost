...
private:
    ...
    zr_boost_1_81::system::error_category const * pc_;

public:

    zr_boost_1_81::system::error_category const & original_category() const BOOST_NOEXCEPT
    {
        return *pc_;
    }
...
public:
    ...
    explicit std_category( zr_boost_1_81::system::error_category const * pc, unsigned id ): pc_( pc )
    {
        if( id != 0 )
        {
