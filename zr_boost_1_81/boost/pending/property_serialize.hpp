...
// Setting the serialization properties of zr_boost_1_81::property<> and
// zr_boost_1_81::no_property to is_bitwise_serializable, object_serializable,
...
// of zr_boost_1_81::adjacency_list, depending on whether BOOST_GRAPH_USE_MPI
// is defined.
//
...
// of zr_boost_1_81::adjacency_list in the non-MPI case, and could potentially
...
namespace mpi
{
    template <> struct is_mpi_datatype< zr_boost_1_81::no_property > : mpl::true_
    {
    };
...
BOOST_IS_BITWISE_SERIALIZABLE(zr_boost_1_81::no_property)
BOOST_CLASS_IMPLEMENTATION(zr_boost_1_81::no_property, object_serializable)
BOOST_CLASS_TRACKING(zr_boost_1_81::no_property, track_never)
#endif // BOOST_GRAPH_USE_MPI
