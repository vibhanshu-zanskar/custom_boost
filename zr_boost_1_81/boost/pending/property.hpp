...
// property accesses
template < typename Tag, typename T, typename Base >
struct lookup_one_property_internal< zr_boost_1_81::property< Tag, T, Base >, Tag >
{
    BOOST_STATIC_CONSTANT(bool, found = true);
...
struct lookup_one_property_internal< zr_boost_1_81::property< Tag, T, Base >, PropName >
...
public:
    ...
    static
        typename lazy_enable_if< is_same< PL, zr_boost_1_81::property< Tag, T, Base > >,
            add_reference< typename base_type::type > >::type
...
template < class P > struct has_property : zr_boost_1_81::mpl::true_
{
};
template <> struct has_property< no_property > : zr_boost_1_81::mpl::false_
{
};
...
namespace detail
{
    ...
    struct remove_first_property
    {
        ...
        {
            typedef typename zr_boost_1_81::function_traits< F >::arg1_type a1;
            typedef typename zr_boost_1_81::remove_reference< a1 >::type non_ref;
            typedef typename non_ref::next_type nx;
            typedef typename zr_boost_1_81::mpl::if_< zr_boost_1_81::is_const< non_ref >,
                zr_boost_1_81::add_const< nx >, nx >::type with_const;
            typedef typename zr_boost_1_81::add_reference< with_const >::type type;
        };
