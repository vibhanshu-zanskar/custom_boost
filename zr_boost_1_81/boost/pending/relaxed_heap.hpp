...
private:
    ...
    struct group
    {
         ...
         *  element). Note that the use of zr_boost_1_81::optional increases the
         ...
         */
        ::zr_boost_1_81::optional< value_type > value;
...
private:
     ...
     *  smaller.
     */
    std::vector< ::zr_boost_1_81::optional< value_type > > groups;
