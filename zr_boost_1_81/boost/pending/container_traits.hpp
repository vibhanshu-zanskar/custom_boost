...
namespace graph_detail
{
    ...
    struct container_traits< zr_boost_1_81::unordered_set< Key, Eq, Hash, Alloc > >
    {
        typedef unordered_set_tag category;
        typedef unstable_tag iterator_stability;
    };
    template < class Key, class T, class Eq, class Hash, class Alloc >
    struct container_traits< zr_boost_1_81::unordered_map< Key, T, Eq, Hash, Alloc > >
    {
        typedef unordered_map_tag category;
        typedef unstable_tag iterator_stability;
    };
    template < class Key, class Eq, class Hash, class Alloc >
    struct container_traits< zr_boost_1_81::unordered_multiset< Key, Eq, Hash, Alloc > >
    {
    ...
    struct container_traits<
        zr_boost_1_81::unordered_multimap< Key, T, Eq, Hash, Alloc > >
    {
    ...
    unordered_set_tag container_category(
        const zr_boost_1_81::unordered_set< Key, Eq, Hash, Alloc >&)
    {
    ...
    unordered_map_tag container_category(
        const zr_boost_1_81::unordered_map< Key, T, Eq, Hash, Alloc >&)
    {
    ...
    unordered_multiset_tag container_category(
        const zr_boost_1_81::unordered_multiset< Key, Eq, Hash, Alloc >&)
    {
    ...
    unordered_multimap_tag container_category(
        const zr_boost_1_81::unordered_multimap< Key, T, Eq, Hash, Alloc >&)
    {
        ...
        Container& c, BOOST_PENDING_FWD_TYPE(T) v, back_insertion_sequence_tag)
    {
        ...
        return std::make_pair(zr_boost_1_81::prior(c.end()), true);
    }
...
} // namespace zr_boost_1_81::graph_detail
