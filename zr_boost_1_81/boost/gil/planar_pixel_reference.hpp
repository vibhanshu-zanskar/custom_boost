...
void swap(const zr_boost_1_81::gil::planar_pixel_reference<CR,CS> x, R& y) {
    zr_boost_1_81::gil::swap_proxy<typename zr_boost_1_81::gil::planar_pixel_reference<CR,CS>::value_type>(x,y);
}

/// \brief  swap for planar_pixel_reference
/// \ingroup PixelModelPlanarRef
template <typename CR, typename CS> inline
void swap(typename zr_boost_1_81::gil::planar_pixel_reference<CR,CS>::value_type& x, const zr_boost_1_81::gil::planar_pixel_reference<CR,CS> y) {
    zr_boost_1_81::gil::swap_proxy<typename zr_boost_1_81::gil::planar_pixel_reference<CR,CS>::value_type>(x,y);
}
...
/// \ingroup PixelModelPlanarRef
template <typename CR, typename CS> inline
void swap(const zr_boost_1_81::gil::planar_pixel_reference<CR,CS> x, const zr_boost_1_81::gil::planar_pixel_reference<CR,CS> y) {
    zr_boost_1_81::gil::swap_proxy<typename zr_boost_1_81::gil::planar_pixel_reference<CR,CS>::value_type>(x,y);
}
