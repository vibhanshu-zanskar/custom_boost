...
//  - Rename namespace zr_boost_1_81::geometry to zr_boost_1_81::gil
//  - Rename include guards
//  - Remove support for zr_boost_1_81::multiprecision types
...
{
    using current_type = zr_boost_1_81::mp11::mp_first<IntegralTypes>;
    using list_after_front = zr_boost_1_81::mp11::mp_rest<IntegralTypes>;
...
struct promote_to_larger<T, zr_boost_1_81::mp11::mp_list<>, MinSize>
{
...
/*!
    ...
    To do this, two times the bit size of T is tested against the bit sizes of:
         short, int, long, zr_boost_1_81::long_long_type, zr_boost_1_81::int128_t
    ...
    the bit sizes of
         ...
         zr_boost_1_81::ulong_long_type, zr_boost_1_81::uint128_t
    ...
    \note zr_boost_1_81::long_long_type and zr_boost_1_81::ulong_long_type are
...
private:
    ...
    // for promotion
    using signed_integral_types = zr_boost_1_81::mp11::mp_list
        <
            short, int, long
    ...
    // for promotion
    using unsigned_integral_types = zr_boost_1_81::mp11::mp_list
        <
            unsigned short, unsigned int, unsigned long, std::size_t
#if defined(BOOST_HAS_LONG_LONG)
