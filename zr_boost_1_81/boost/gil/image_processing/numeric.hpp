...
{
    return std::sin(x * zr_boost_1_81::gil::detail::pi) / (x * zr_boost_1_81::gil::detail::pi);
}
...
inline void compute_tensor_entries(
    zr_boost_1_81::gil::gray16s_view_t dx,
    zr_boost_1_81::gil::gray16s_view_t dy,
    zr_boost_1_81::gil::gray32f_view_t m11,
    zr_boost_1_81::gil::gray32f_view_t m12_21,
    zr_boost_1_81::gil::gray32f_view_t m22)
{
    ...
    -> detail::kernel_2d<T, Allocator>
{
    ...
    const double denominator = 2 * zr_boost_1_81::gil::detail::pi * sigma * sigma;
