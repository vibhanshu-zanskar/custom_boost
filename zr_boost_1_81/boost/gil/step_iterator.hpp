...
private:
    BOOST_GIL_CLASS_REQUIRE(Iterator, zr_boost_1_81::gil, MemoryBasedIteratorConcept)
...
struct iterator_add_deref<memory_based_step_iterator<Iterator>,Deref> {
    BOOST_GIL_CLASS_REQUIRE(Deref, zr_boost_1_81::gil, PixelDereferenceAdaptorConcept)
