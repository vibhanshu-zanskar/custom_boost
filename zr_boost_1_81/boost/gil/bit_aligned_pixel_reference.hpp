...
struct bit_aligned_pixel_reference
{
    ...
    using bit_range_t = zr_boost_1_81::gil::bit_range<bit_size,IsMutable>;
...
void swap(zr_boost_1_81::gil::bit_aligned_pixel_reference<B,C,L,true> const x, R& y) {
    zr_boost_1_81::gil::swap_proxy<typename zr_boost_1_81::gil::bit_aligned_pixel_reference<B,C,L,true>::value_type>(x,y);
}


template <typename B, typename C, typename L> inline
void swap(typename zr_boost_1_81::gil::bit_aligned_pixel_reference<B,C,L,true>::value_type& x, const zr_boost_1_81::gil::bit_aligned_pixel_reference<B,C,L,true> y) {
    zr_boost_1_81::gil::swap_proxy<typename zr_boost_1_81::gil::bit_aligned_pixel_reference<B,C,L,true>::value_type>(x,y);
}


template <typename B, typename C, typename L> inline
void swap(zr_boost_1_81::gil::bit_aligned_pixel_reference<B,C,L,true> const x, const zr_boost_1_81::gil::bit_aligned_pixel_reference<B,C,L,true> y) {
    zr_boost_1_81::gil::swap_proxy<typename zr_boost_1_81::gil::bit_aligned_pixel_reference<B,C,L,true>::value_type>(x,y);
}
