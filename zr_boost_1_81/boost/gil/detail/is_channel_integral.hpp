...
struct is_channel_integral<zr_boost_1_81::gil::packed_channel_value<NumBits>> : std::true_type {};

template <typename BitField, int FirstBit, int NumBits, bool IsMutable>
struct is_channel_integral
    <
        zr_boost_1_81::gil::packed_channel_reference<BitField, FirstBit, NumBits, IsMutable>
    > : std::true_type
{};
...
struct is_channel_integral
    <
        zr_boost_1_81::gil::packed_dynamic_channel_reference<BitField, NumBits, IsMutable>
    > : std::true_type
{};
...
struct is_channel_integral
    <
        zr_boost_1_81::gil::scoped_channel_value<BaseChannelValue, MinVal, MaxVal>
