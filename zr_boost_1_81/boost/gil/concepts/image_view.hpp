...
struct RandomAccessNDImageViewConcept
{
    void constraints()
    {
        ...
        gil_function_requires<zr_boost_1_81_concepts::RandomAccessTraversalConcept<reverse_iterator>>();

        using first_it_type = typename View::template axis<0>::iterator;
        using last_it_type = typename View::template axis<N-1>::iterator;
        gil_function_requires<zr_boost_1_81_concepts::RandomAccessTraversalConcept<first_it_type>>();
        gil_function_requires<zr_boost_1_81_concepts::RandomAccessTraversalConcept<last_it_type>>();
