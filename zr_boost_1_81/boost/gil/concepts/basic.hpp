...
struct DefaultConstructible
{
    void constraints()
    {
        function_requires<zr_boost_1_81::DefaultConstructibleConcept<T>>();
    }
};
...
struct CopyConstructible
{
    void constraints()
    {
        function_requires<zr_boost_1_81::CopyConstructibleConcept<T>>();
    }
};
...
struct Assignable
{
    void constraints()
    {
        function_requires<zr_boost_1_81::AssignableConcept<T>>();
    }
};
...
struct EqualityComparable
{
    void constraints()
    {
        function_requires<zr_boost_1_81::EqualityComparableConcept<T>>();
    }
};
...
struct Regular
{
    void constraints()
    {
        gil_function_requires< zr_boost_1_81::DefaultConstructibleConcept<T>>();
        gil_function_requires< zr_boost_1_81::CopyConstructibleConcept<T>>();
        gil_function_requires< zr_boost_1_81::EqualityComparableConcept<T>>(); // ==, !=
        gil_function_requires< zr_boost_1_81::AssignableConcept<T>>();
