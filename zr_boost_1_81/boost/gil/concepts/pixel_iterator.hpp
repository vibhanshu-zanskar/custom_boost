...
// Preconditions: TT Models zr_boost_1_81_concepts::ForwardTraversalConcept
template <class TT>
...
// Preconditions: TT Models zr_boost_1_81::BidirectionalIteratorConcept
template <class TT>
...
// Preconditions: TT Models zr_boost_1_81_concepts::RandomAccessTraversalConcept
template <class TT>
...
// \tparam Iterator Models zr_boost_1_81_concepts::RandomAccessTraversalConcept
...
///     : zr_boost_1_81_concepts::RandomAccessTraversalConcept<Iterator>, PixelBasedConcept<Iterator>
/// {
...
struct PixelIteratorConcept
{
    void constraints()
    {
        gil_function_requires<zr_boost_1_81_concepts::RandomAccessTraversalConcept<Iterator>>();
...
/// \code
/// concept MemoryBasedIteratorConcept<zr_boost_1_81_concepts::RandomAccessTraversalConcept Iterator>
/// {
...
/// \code
/// concept StepIteratorConcept<zr_boost_1_81_concepts::ForwardTraversalConcept Iterator>
/// {
///     template <Integral D>
...
struct StepIteratorConcept
{
    void constraints()
    {
        gil_function_requires<zr_boost_1_81_concepts::ForwardTraversalConcept<Iterator>>();
        it.set_step(0);
    }
    Iterator it;
};
...
///
/// \code
/// concept IteratorAdaptorConcept<zr_boost_1_81_concepts::ForwardTraversalConcept Iterator>
/// {
///     where SameType<is_iterator_adaptor<Iterator>::type, std::true_type>;
///
///     typename iterator_adaptor_get_base<Iterator>;
///         where Metafunction<iterator_adaptor_get_base<Iterator> >;
///         where zr_boost_1_81_concepts::ForwardTraversalConcept<iterator_adaptor_get_base<Iterator>::type>;
///
///     typename another_iterator;
///     typename iterator_adaptor_rebind<Iterator,another_iterator>::type;
///         where zr_boost_1_81_concepts::ForwardTraversalConcept<another_iterator>;
...
struct IteratorAdaptorConcept
{
    void constraints()
    {
        ...
        using base_t = typename iterator_adaptor_get_base<Iterator>::type;
        gil_function_requires<zr_boost_1_81_concepts::ForwardTraversalConcept<base_t>>();
