...
/// \code
/// concept PixelDereferenceAdaptorConcept<zr_boost_1_81::UnaryFunctionConcept D>
...
struct PixelDereferenceAdaptorConcept
{
    void constraints()
    {
        ...
        <
            ...
            >
        >();
        gil_function_requires<zr_boost_1_81::DefaultConstructibleConcept<D>>();
        gil_function_requires<zr_boost_1_81::CopyConstructibleConcept<D>>();
        gil_function_requires<zr_boost_1_81::AssignableConcept<D>>();
