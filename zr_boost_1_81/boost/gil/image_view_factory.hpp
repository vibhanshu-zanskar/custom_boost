...
struct color_converted_view_type : public detail::_color_converted_view_type<SrcView,
    ...
    BOOST_GIL_CLASS_REQUIRE(DstP, zr_boost_1_81::gil, MutablePixelConcept)//why does it have to be mutable???
};
...
private:
    BOOST_GIL_CLASS_REQUIRE(View, zr_boost_1_81::gil, ImageViewConcept)
