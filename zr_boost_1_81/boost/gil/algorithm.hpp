...
BOOST_FORCEINLINE
auto copy(
    zr_boost_1_81::gil::pixel<T, CS>* first,
    zr_boost_1_81::gil::pixel<T, CS>* last,
    zr_boost_1_81::gil::pixel<T, CS>* dst)
    ->  zr_boost_1_81::gil::pixel<T, CS>*
{
    auto p = std::copy((unsigned char*)first, (unsigned char*)last, (unsigned char*)dst);
    return reinterpret_cast<zr_boost_1_81::gil::pixel<T, CS>*>(p);
}
...
template<typename T, typename CS>
BOOST_FORCEINLINE
auto copy(const zr_boost_1_81::gil::pixel<T,CS>* first, const zr_boost_1_81::gil::pixel<T,CS>* last,
     zr_boost_1_81::gil::pixel<T,CS>* dst) -> zr_boost_1_81::gil::pixel<T,CS>*
{
    return (zr_boost_1_81::gil::pixel<T,CS>*)std::copy((unsigned char*)first,(unsigned char*)last, (unsigned char*)dst);
}
} // namespace std
...
auto copy(zr_boost_1_81::gil::planar_pixel_iterator<IC1,CS> first, zr_boost_1_81::gil::planar_pixel_iterator<IC1,CS> last, zr_boost_1_81::gil::planar_pixel_iterator<IC2,CS> dst) -> zr_boost_1_81::gil::planar_pixel_iterator<IC2,CS>
{
    zr_boost_1_81::gil::gil_function_requires<zr_boost_1_81::gil::ChannelsCompatibleConcept<typename std::iterator_traits<IC1>::value_type,typename std::iterator_traits<IC2>::value_type>>();
    static_for_each(first,last,dst,zr_boost_1_81::gil::detail::copy_fn<IC1,IC2>());
...
template <typename IL, typename OL>
BOOST_FORCEINLINE auto copy1(zr_boost_1_81::gil::iterator_from_2d<IL> first, zr_boost_1_81::gil::iterator_from_2d<IL> last, zr_boost_1_81::gil::iterator_from_2d<OL> dst) -> zr_boost_1_81::gil::iterator_from_2d<OL>
{
    return zr_boost_1_81::gil::detail::copy_with_2d_iterators(first,last,dst);
}
...
void fill(zr_boost_1_81::gil::iterator_from_2d<IL> first, zr_boost_1_81::gil::iterator_from_2d<IL> last, const V& val) {
    zr_boost_1_81::gil::gil_function_requires<zr_boost_1_81::gil::MutablePixelLocatorConcept<IL>>();
    if (first.is_1d_traversable()) {
...
struct equal_n_fn<zr_boost_1_81::gil::iterator_from_2d<Loc>, It>
{
    BOOST_FORCEINLINE
    bool operator()(zr_boost_1_81::gil::iterator_from_2d<Loc> i1, std::ptrdiff_t n, It i2) const
    {
        gil_function_requires<zr_boost_1_81::gil::PixelLocatorConcept<Loc>>();
        gil_function_requires<zr_boost_1_81::gil::PixelIteratorConcept<It>>();
        while (n > 0)
        {
...
struct equal_n_fn<It, zr_boost_1_81::gil::iterator_from_2d<Loc>>
{
    BOOST_FORCEINLINE
    bool operator()(It i1, std::ptrdiff_t n, zr_boost_1_81::gil::iterator_from_2d<Loc> i2) const
    {
        gil_function_requires<zr_boost_1_81::gil::PixelIteratorConcept<It>>();
        gil_function_requires<zr_boost_1_81::gil::PixelLocatorConcept<Loc>>();
        while (n > 0)
...
struct equal_n_fn<zr_boost_1_81::gil::iterator_from_2d<Loc1>,zr_boost_1_81::gil::iterator_from_2d<Loc2>> {
   BOOST_FORCEINLINE bool operator()(zr_boost_1_81::gil::iterator_from_2d<Loc1> i1, std::ptrdiff_t n, zr_boost_1_81::gil::iterator_from_2d<Loc2> i2) const {
        gil_function_requires<zr_boost_1_81::gil::PixelLocatorConcept<Loc1>>();
        gil_function_requires<zr_boost_1_81::gil::PixelLocatorConcept<Loc2>>();
...
bool equal(zr_boost_1_81::gil::iterator_from_2d<Loc1> first, zr_boost_1_81::gil::iterator_from_2d<Loc1> last, zr_boost_1_81::gil::iterator_from_2d<Loc2> first2) {
    zr_boost_1_81::gil::gil_function_requires<zr_boost_1_81::gil::PixelLocatorConcept<Loc1>>();
    zr_boost_1_81::gil::gil_function_requires<zr_boost_1_81::gil::PixelLocatorConcept<Loc2>>();
    std::ptrdiff_t n=last-first;
    if (first.is_1d_traversable()) {
        if (first2.is_1d_traversable())
            return zr_boost_1_81::gil::detail::equal_n_fn<typename Loc1::x_iterator,typename Loc2::x_iterator>()(first.x(),n, first2.x());
        else
            return zr_boost_1_81::gil::detail::equal_n_fn<typename Loc1::x_iterator,zr_boost_1_81::gil::iterator_from_2d<Loc2>>()(first.x(),n, first2);
    } else {
        if (first2.is_1d_traversable())
            return zr_boost_1_81::gil::detail::equal_n_fn<zr_boost_1_81::gil::iterator_from_2d<Loc1>,typename Loc2::x_iterator>()(first,n, first2.x());
        else
            return zr_boost_1_81::gil::detail::equal_n_fn<zr_boost_1_81::gil::iterator_from_2d<Loc1>,zr_boost_1_81::gil::iterator_from_2d<Loc2>>()(first,n,first2);
    }
}
} // namespace std
