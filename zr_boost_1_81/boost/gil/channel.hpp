...
inline
void swap(zr_boost_1_81::gil::packed_channel_reference<BF, FB, NB, M> const x, R& y)
{
    zr_boost_1_81::gil::swap_proxy
    <
        typename zr_boost_1_81::gil::packed_channel_reference<BF, FB, NB, M>::value_type
    >(x, y);
}
...
inline
void swap(
    typename zr_boost_1_81::gil::packed_channel_reference<BF, FB, NB, M>::value_type& x,
    zr_boost_1_81::gil::packed_channel_reference<BF, FB, NB, M> const y)
{
    zr_boost_1_81::gil::swap_proxy
    <
        typename zr_boost_1_81::gil::packed_channel_reference<BF, FB, NB, M>::value_type
...
void swap(
    zr_boost_1_81::gil::packed_channel_reference<BF, FB, NB, M> const x,
    zr_boost_1_81::gil::packed_channel_reference<BF, FB, NB, M> const y)
{
    zr_boost_1_81::gil::swap_proxy
    <
...
void swap(const zr_boost_1_81::gil::packed_dynamic_channel_reference<BF,NB,M> x, R& y) {
    zr_boost_1_81::gil::swap_proxy<typename zr_boost_1_81::gil::packed_dynamic_channel_reference<BF,NB,M>::value_type>(x,y);
}
...
void swap(typename zr_boost_1_81::gil::packed_dynamic_channel_reference<BF,NB,M>::value_type& x, const zr_boost_1_81::gil::packed_dynamic_channel_reference<BF,NB,M> y) {
    zr_boost_1_81::gil::swap_proxy<typename zr_boost_1_81::gil::packed_dynamic_channel_reference<BF,NB,M>::value_type>(x,y);
}
...
/// \brief swap for packed_dynamic_channel_reference
template <typename BF, int NB, bool M> inline
void swap(const zr_boost_1_81::gil::packed_dynamic_channel_reference<BF,NB,M> x, const zr_boost_1_81::gil::packed_dynamic_channel_reference<BF,NB,M> y) {
    zr_boost_1_81::gil::swap_proxy<typename zr_boost_1_81::gil::packed_dynamic_channel_reference<BF,NB,M>::value_type>(x,y);
}
}   // namespace std
