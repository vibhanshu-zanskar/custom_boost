...
public:
  ...
  private:
      ...
      {
          lhs._memory = zr_boost_1_81::exchange(rhs._memory, nullptr);
          lhs._align_in_bytes = zr_boost_1_81::exchange(rhs._align_in_bytes, 0);
          lhs._allocated_bytes = zr_boost_1_81::exchange(rhs._allocated_bytes, 0);
          lhs._view = zr_boost_1_81::exchange(rhs._view, image::view_t{});
      };
