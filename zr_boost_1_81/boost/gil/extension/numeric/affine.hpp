...
template <typename T>
zr_boost_1_81::gil::matrix3x2<T> inverse(zr_boost_1_81::gil::matrix3x2<T> m)
{
    T const determinant = m.a * m.d - m.b * m.c;

    zr_boost_1_81::gil::matrix3x2<T> res;
...
template<typename T, typename F>
zr_boost_1_81::gil::matrix3x2<F> center_rotate(zr_boost_1_81::gil::point<T> dims,F rads)
{
    ...
    zr_boost_1_81::gil::matrix3x2<F> rotate = zr_boost_1_81::gil::matrix3x2<F>::get_rotate(rads);

    // Find distance for translating the image into view
    zr_boost_1_81::gil::matrix3x2<F> translation(0,0,0,0,0,0);
    if(rads > 0)
    {
    ...
    zr_boost_1_81::gil::matrix3x2<F> translate =
        zr_boost_1_81::gil::matrix3x2<F>::get_translate(-1 * dims * translation);

    // To fit inside the source dimensions
    zr_boost_1_81::gil::matrix3x2<F> scale =
        zr_boost_1_81::gil::matrix3x2<F>::get_scale(
