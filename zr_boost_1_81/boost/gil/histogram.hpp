...
inline auto hash_tuple_impl(std::size_t& seed, std::tuple<T...> const& t)
    -> typename std::enable_if<Index != sizeof...(T), void>::type
{
    zr_boost_1_81::hash_combine(seed, std::get<Index>(t));
...
///        zr_boost_1_81::container_hash. Although there is a direct hashing
...
auto pixel_to_tuple(Pixel const& p, zr_boost_1_81::mp11::index_sequence<I...>)
...
auto tuple_to_tuple(Tuple const& t, zr_boost_1_81::mp11::index_sequence<I...>)
...
///
template <typename Tuple, std::size_t... I>
bool tuple_compare(Tuple const& t1, Tuple const& t2, zr_boost_1_81::mp11::index_sequence<I...>)
{
...
bool tuple_compare(Tuple const& t1, Tuple const& t2)
{
    ...
    auto index_list              = zr_boost_1_81::mp11::make_index_sequence<tuple_size>{};
...
struct tuple_limit
{
    ...
    {
        return min_impl(zr_boost_1_81::mp11::make_index_sequence<std::tuple_size<Tuple>::value>{});
    }
    static constexpr Tuple max()
    {
        return max_impl(zr_boost_1_81::mp11::make_index_sequence<std::tuple_size<Tuple>::value>{});
    }

private:
    template <std::size_t... I>
    static constexpr Tuple min_impl(zr_boost_1_81::mp11::index_sequence<I...>)
    {
    ...
    template <std::size_t... I>
    static constexpr Tuple max_impl(zr_boost_1_81::mp11::index_sequence<I...>)
    {
        return std::make_tuple(
...
///
/// \class zr_boost_1_81::gil::histogram
/// \ingroup Histogram
/// \brief Default histogram class provided by zr_boost_1_81::gil.
///
...
class histogram : public std::unordered_map<std::tuple<T...>, double, detail::hash_tuple<T...>>
{
    ...
    using bin_t    = zr_boost_1_81::mp11::mp_list<T...>;
...
public:
    ...
    {
        using bin_types = zr_boost_1_81::mp11::mp_list<T...>;
        return zr_boost_1_81::mp11::mp_all_of<bin_types, std::is_arithmetic>::value;
    }
    ...
    bool is_tuple_compatible(Tuple const&)
    {
        ...
        <
            ...
            zr_boost_1_81::mp11::make_index_sequence<histogram_size>,
            zr_boost_1_81::mp11::make_index_sequence<tuple_size>
        >::type;
    ...
    {
        using index_list                      = zr_boost_1_81::mp11::mp_list_c<std::size_t, Dimensions...>;
        std::size_t const index_list_size     = zr_boost_1_81::mp11::mp_size<index_list>::value;
        std::size_t const tuple_size          = std::tuple_size<Tuple>::value;
        std::size_t const histogram_dimension = dimension();
        ...
        <
            index_list_size == 0,
            zr_boost_1_81::mp11::mp_list_c<std::size_t, 0>,
            index_list
        >::type;

        std::size_t const min =
            zr_boost_1_81::mp11::mp_min_element<new_index_list, zr_boost_1_81::mp11::mp_less>::value;

        std::size_t const max =
            zr_boost_1_81::mp11::mp_max_element<new_index_list, zr_boost_1_81::mp11::mp_less>::value;

        static_assert((0 <= min && max < tuple_size) || index_list_size == 0, "Index out of Range");

        using seq1 = zr_boost_1_81::mp11::make_index_sequence<histogram_dimension>;
        using seq2 = zr_boost_1_81::mp11::index_sequence<Dimensions...>;
        // TODO : Explore consequence of using if-constexpr
    ...
    {
        using check_list = zr_boost_1_81::mp11::mp_list<zr_boost_1_81::has_less<T>...>;
        static_assert(
            zr_boost_1_81::mp11::mp_all_of<check_list, zr_boost_1_81::mp11::mp_to_bool>::value,
    ...
    histogram sub_histogram(Tuple const& t1, Tuple const& t2)
    {
        ...
        std::size_t const min =
            zr_boost_1_81::mp11::mp_min_element<index_list, zr_boost_1_81::mp11::mp_less>::value;

        std::size_t const max =
            zr_boost_1_81::mp11::mp_max_element<index_list, zr_boost_1_81::mp11::mp_less>::value;

        static_assert(
            (0 <= min && max < histogram_dimension) && index_list_size < histogram_dimension,
            "Index out of Range");

        using seq1 = zr_boost_1_81::mp11::make_index_sequence<dimension()>;
        using seq2 = zr_boost_1_81::mp11::index_sequence<Dimensions...>;
    ...
    histogram<zr_boost_1_81::mp11::mp_at<bin_t, zr_boost_1_81::mp11::mp_size_t<Dimensions>>...> sub_histogram()
    {
        using index_list                      = zr_boost_1_81::mp11::mp_list_c<std::size_t, Dimensions...>;
        std::size_t const index_list_size     = zr_boost_1_81::mp11::mp_size<index_list>::value;
        std::size_t const histogram_dimension = dimension();
        ...
        histogram<zr_boost_1_81::mp11::mp_at<bin_t, zr_boost_1_81::mp11::mp_size_t<Dimensions>>...> sub_h;

        std::for_each(base_t::begin(), base_t::end(), [&](value_t const& v) {
            auto sub_key =
                detail::tuple_to_tuple(v.first, zr_boost_1_81::mp11::index_sequence<Dimensions...>{});
...
private:
    template <typename Tuple, std::size_t... I>
    key_t make_histogram_key(Tuple const& t, zr_boost_1_81::mp11::index_sequence<I...>) const
    {
        return std::make_tuple(
            static_cast<typename zr_boost_1_81::mp11::mp_at<bin_t, zr_boost_1_81::mp11::mp_size_t<I>>>(
                std::get<I>(t))...);
    }

    template <typename Tuple, std::size_t... I>
    static constexpr bool is_tuple_type_compatible(zr_boost_1_81::mp11::index_sequence<I...>)
    {
        using tp = zr_boost_1_81::mp11::mp_list
        <
            typename std::is_convertible
            <
                zr_boost_1_81::mp11::mp_at<bin_t, zr_boost_1_81::mp11::mp_size_t<I>>,
                typename std::tuple_element<I, Tuple>::type
            >::type...
        >;
        return zr_boost_1_81::mp11::mp_all_of<tp, zr_boost_1_81::mp11::mp_to_bool>::value;
    }
...
/// \brief Overload this function to provide support for zr_boost_1_81::gil::histogram or
        ...
        std::for_each(hist.begin(), hist.end(), [&](value_t const& v1) {
            ...
            std::for_each(hist.begin(), hist.end(), [&](value_t const& v2) {
                bool comp = detail::tuple_compare(
                    v2.first, v1.first,
                    zr_boost_1_81::mp11::make_index_sequence<histogram_t::dimension()>{});
                if (comp)
