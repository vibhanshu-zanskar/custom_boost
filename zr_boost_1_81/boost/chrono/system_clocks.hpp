...
# define BOOST_SYSTEM_CLOCK_DURATION zr_boost_1_81::chrono::duration<zr_boost_1_81::int_least64_t, ratio<BOOST_RATIO_INTMAX_C(1), BOOST_RATIO_INTMAX_C(10000000)> >
#else
# define BOOST_SYSTEM_CLOCK_DURATION zr_boost_1_81::chrono::nanoseconds
#endif
