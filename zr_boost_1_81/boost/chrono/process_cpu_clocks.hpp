...
namespace zr_boost_1_81 { namespace chrono {
...
namespace chrono
{
  ...
  typedef process_times<nanoseconds::rep> process_cpu_clock_times;
    ...
    public:
        ...
        typedef zr_boost_1_81::chrono::duration<times,  nano>                duration;
        typedef duration::rep                       rep;
        typedef duration::period                    period;
...
namespace std {
    ...
    template <typename Rep>
    struct numeric_limits<zr_boost_1_81::chrono::process_times<Rep> >
    {
        typedef zr_boost_1_81::chrono::process_times<Rep> Res;
