...
process_user_cpu_clock::time_point process_user_cpu_clock::now() BOOST_NOEXCEPT
{
    ...
    if ( zr_boost_1_81::winapi::GetProcessTimes(
            zr_boost_1_81::winapi::GetCurrentProcess(), &creation, &exit,
        ...
        system::error_code & ec)
{
    ...
    {
        zr_boost_1_81::winapi::DWORD_ cause = zr_boost_1_81::winapi::GetLastError();
        if (::zr_boost_1_81::chrono::is_throws(ec))
        {
            zr_boost_1_81::throw_exception(
                    system::system_error(
