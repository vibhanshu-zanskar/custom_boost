...
public:
   BOOST_STATIC_CONSTANT(bool, value = (::zr_boost_1_81::is_convertible<cat*, std::random_access_iterator_tag*>::value));
#else
...
{
private:
   typedef detail::is_random_imp_selector< ::zr_boost_1_81::is_pointer<I>::value> selector;
