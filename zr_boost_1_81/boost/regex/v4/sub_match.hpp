...
struct sub_match : public std::pair<BidiIterator, BidiIterator>
{
   ...
   {
      difference_type n = matched ? ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::distance((BidiIterator)this->first, (BidiIterator)this->second) : 0;
      return n;
   }
   std::basic_string<value_type> str()const
   {
      ...
      if(matched)
      {
         std::size_t len = ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::distance((BidiIterator)this->first, (BidiIterator)this->second);
         result.reserve(len);
...
private:
   mutable zr_boost_1_81::scoped_ptr<capture_sequence_type> m_captures;
public:
