...
{
   typedef typename zr_boost_1_81::int_t<sizeof(way) * CHAR_BIT>::least cast_type;
...
public:
   ...
   typedef typename zr_boost_1_81::make_unsigned<native_mask_type>::type  unsigned_native_mask_type;
...
void cpp_regex_traits_implementation<charT>::init()
{
   ...
   if((int)cat >= 0)
   {
      ...
      static const char_class_type masks[16] = 
      {
         ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_alnum,
         ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_alpha,
         ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_cntrl,
         ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_digit,
         ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_graph,
         ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_horizontal_space,
         ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_lower,
         ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_print,
         ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_punct,
         ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_space,
         ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_upper,
         ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_vertical_space,
         ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_xdigit,
         ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_blank,
         ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_word,
         ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_unicode,
      };
#endif
   ...
   cpp_regex_traits_implementation<charT>::lookup_classname_imp(const charT* p1, const charT* p2) const
{
   ...
   static const char_class_type masks[22] = 
   {
      ...
      ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_upper,
      ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_vertical_space,
      ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_alnum | ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_word, 
      ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_alnum | ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_word, 
      ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_xdigit,
   };
#endif
...
{
   return
      ((mask & ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_space) && (this->m_pctype->is(std::ctype<charT>::space, c)))
      || ((mask & ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_print) && (this->m_pctype->is(std::ctype<charT>::print, c)))
      || ((mask & ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_cntrl) && (this->m_pctype->is(std::ctype<charT>::cntrl, c)))
      || ((mask & ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_upper) && (this->m_pctype->is(std::ctype<charT>::upper, c)))
      || ((mask & ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_lower) && (this->m_pctype->is(std::ctype<charT>::lower, c)))
      || ((mask & ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_alpha) && (this->m_pctype->is(std::ctype<charT>::alpha, c)))
      || ((mask & ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_digit) && (this->m_pctype->is(std::ctype<charT>::digit, c)))
      || ((mask & ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_punct) && (this->m_pctype->is(std::ctype<charT>::punct, c)))
      || ((mask & ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_xdigit) && (this->m_pctype->is(std::ctype<charT>::xdigit, c)))
      || ((mask & ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_blank) && (this->m_pctype->is(std::ctype<charT>::space, c)) && !::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::is_separator(c))
      || ((mask & ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_word) && (c == '_'))
      || ((mask & ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_unicode) && ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::is_extended(c))
      || ((mask & ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_vertical_space) && (is_separator(c) || (c == '\v')))
      || ((mask & ::zr_boost_1_81::BOOST_REGEX_DETAIL_NS::char_class_horizontal_space) && this->m_pctype->is(std::ctype<charT>::space, c) && !(is_separator(c) || (c == '\v')));
}
#endif


template <class charT>
inline zr_boost_1_81::shared_ptr<const cpp_regex_traits_implementation<charT> > create_cpp_regex_traits(const std::locale& l)
{
   cpp_regex_traits_base<charT> key(l);
   return ::zr_boost_1_81::object_cache<cpp_regex_traits_base<charT>, cpp_regex_traits_implementation<charT> >::get(key, 5);
}
...
public:
   ...
   zr_boost_1_81::intmax_t toi(const charT*& p1, const charT* p2, int radix)const;
...
private:
   zr_boost_1_81::shared_ptr<const BOOST_REGEX_DETAIL_NS::cpp_regex_traits_implementation<charT> > m_pimpl;
   //
...
template <class charT>
zr_boost_1_81::intmax_t cpp_regex_traits<charT>::toi(const charT*& first, const charT* last, int radix)const
{
