...
// error checking API:
//
inline void BOOST_REGEX_CALL verify_options(zr_boost_1_81::regex_constants::syntax_option_type, match_flag_type mf)
{
   //
...
{   
   ...
   const ::zr_boost_1_81::regex_traits_wrapper<traits_type>& traits_inst = *(e.m_ptraits);
...
private:
   ...
   {
      return ::zr_boost_1_81::is_random_access_iterator<BidiIterator>::value ? match_dot_repeat_fast() : match_dot_repeat_slow();
   }
   bool match_backstep();
...
private:
   ...
   const ::zr_boost_1_81::regex_traits_wrapper<traits>& traits_inst;
