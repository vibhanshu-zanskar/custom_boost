...
// because zr_boost_1_81::call_once doesn't alow us to pass instance information
...
public:
   typedef scoped_static_mutex_lock scoped_lock;
   static void init();
   static zr_boost_1_81::recursive_mutex* m_pmutex;
   static zr_boost_1_81::once_flag m_once;
};
...
public:
   ...
   void unlock();
private:
   zr_boost_1_81::unique_lock<zr_boost_1_81::recursive_mutex>* m_plock;
   bool m_have_lock;
};
