...
namespace assign_detail
{
    ...
    template< class T >
    struct is_repeater : zr_boost_1_81::false_type {};

    template< class T >
    struct is_repeater< zr_boost_1_81::assign_detail::repeater<T> > : zr_boost_1_81::true_type{};

    template< class Fun >
    struct is_repeater< zr_boost_1_81::assign_detail::fun_repeater<Fun> > : zr_boost_1_81::true_type{};
    ...
    public:
        ...
        void operator()(T&& r)
        {
            c_.push_back(zr_boost_1_81::forward<T>(r));
        }
#endif
    };
    ...
    public:
        ...
        void operator()(T&& r)
        {
            c_.push_front(zr_boost_1_81::forward<T>(r));
        }
#endif
    };
    ...
    public:
        ...
        void operator()(T&& r)
        {
            c_.push(zr_boost_1_81::forward<T>(r));
        }
#endif
    };
    ...
    public:
        ...
        void operator()(T&& r)
        {
            c_.insert(zr_boost_1_81::forward<T>(r));
        }
#endif
    };
...
namespace assign
{
    ...
    public:
        ...
        {
            return operator,(zr_boost_1_81::forward<T>(r));
        }
        ...
        list_inserter& operator,(T&& r)
        {
            ...
            insert(zr_boost_1_81::forward<T>(r), tag());
            return *this;
        }
#else
        ...
        list_inserter& operator,(T&& r)
        {
            ...
            insert(tag(), zr_boost_1_81::forward<T>(r));
            return *this;
        }
#endif
#endif
...
#include BOOST_PP_LOCAL_ITERATE()
        ...
        {
            insert(arg_type(), zr_boost_1_81::forward<Ts>(ts)...);
            return *this;
        }
        ...
        void insert(single_arg_type, T&& t)
        {
            ...
            insert_(zr_boost_1_81::forward<T>(t));
        }

        template< class T1, class T2, class... Ts >
        void insert(single_arg_type, T1&& t1, T2&& t2, Ts&&... ts)
        {
            insert_(Argument(zr_boost_1_81::forward<T1>(t1), zr_boost_1_81::forward<T2>(t2), zr_boost_1_81::forward<Ts>(ts)...));
        }

        template< class... Ts >
        void insert(n_arg_type, Ts&&... ts)
        {
            insert_(zr_boost_1_81::forward<Ts>(ts)...);
        }
        ...
        {
            insert_( zr_boost_1_81::forward<T>(r) );
        }
