...
// some gcc < 4.7 do not support all of the variadic features required for zr_boost_1_81::assign
...
namespace assign_detail
{
    ...
    struct assign_decay
    {
        ...
        typedef BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::conditional<
            ...
            ::zr_boost_1_81::decay<const T>,
            ::zr_boost_1_81::decay<T> >::type::type type;
    };
...
#ifndef BOOST_NO_CXX11_HDR_INITIALIZER_LIST
    template< class C >
    struct is_initializer_list : zr_boost_1_81::false_type {};

    template< class E >
    struct is_initializer_list< std::initializer_list<E> > : zr_boost_1_81::true_type {};
#endif
    ...
    public:
        ...
        Container convert_to_container() const
        {
            ...
            typedef BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::conditional< is_array_flag,
                                                      array_type_tag,
...
// old Dinkumware doesn't support iterator type as template
    ...
    {
        return ::zr_boost_1_81::iterator_range_detail::equal( l, r );
    }
    ...
    inline bool operator<( const converter<T,I>& l, const Range& r )
    {
        return ::zr_boost_1_81::iterator_range_detail::less_than( l, r );
    }
    ...
    {
        return Os << ::zr_boost_1_81::make_iterator_range( r.begin(), r.end() );
    }
    ...
    private:
        ...
        void push_back( value_type&& r ) { values_.push_back( zr_boost_1_81::move( r ) ); }
#endif
    public:
        ...
        {
            this->push_back( zr_boost_1_81::move(u) );
            return *this;
        }
#endif
        generic_list& operator()( const Ty& u )
...
#include BOOST_PP_LOCAL_ITERATE()
        ...
        {
            this->push_back(Ty(zr_boost_1_81::forward<U0>(u0), zr_boost_1_81::forward<U1>(u1), zr_boost_1_81::forward<Us>(us)...));
            return *this;
        }
#endif
        ...
        {
            return range( zr_boost_1_81::begin(r), zr_boost_1_81::end(r) );
        }
#if !defined(BOOST_NO_CXX11_DECLTYPE_N3276) && !defined(BOOST_NO_CXX11_FUNCTION_TEMPLATE_DEFAULT_ARGS)
        template< class Container,
            class = decltype(Container(
                zr_boost_1_81::declval<BOOST_DEDUCED_TYPENAME std::deque<BOOST_DEDUCED_TYPENAME assign_decay<T>::type>::iterator>(),
                zr_boost_1_81::declval<BOOST_DEDUCED_TYPENAME std::deque<BOOST_DEDUCED_TYPENAME assign_decay<T>::type>::iterator>()
                ))
        >
        ...
        template< class Container,
            class = typename zr_boost_1_81::enable_if< zr_boost_1_81::is_same< zr_boost_1_81::type_traits::yes_type, decltype(assign_is_array((Container*)0))> >::type,
            class = void
        >
        operator Container() const
        {
...
# if !defined(BOOST_NO_CXX11_HDR_INITIALIZER_LIST)
          , class = typename zr_boost_1_81::disable_if< is_initializer_list<Container> >::type
# endif
...
#if !defined(BOOST_NO_CXX11_DECLTYPE_N3276) && !defined(BOOST_NO_CXX11_FUNCTION_TEMPLATE_DEFAULT_ARGS)
        template< class Container,
            class = decltype(Container(zr_boost_1_81::declval<assign_reference<T>*>(), zr_boost_1_81::declval<assign_reference<T>*>()))
        >
        operator Container() const
        {
            return this-> BOOST_NESTED_TEMPLATE convert_to_container<Container>();
...
#include BOOST_PP_LOCAL_ITERATE()
    ...
    {
        assign_detail::generic_list<BOOST_DEDUCED_TYPENAME assign_detail::assign_decay<T>::type> gl;
        gl(zr_boost_1_81::forward<U>(u), zr_boost_1_81::forward<Us>(us)...);
        return gl;
    }
