...
struct common_type<zr_boost_1_81::histogram::accumulators::count<T, B1>,
                   zr_boost_1_81::histogram::accumulators::count<U, B2>> {
  using type = zr_boost_1_81::histogram::accumulators::count<common_type_t<T, U>, (B1 || B2)>;
};
} // namespace std
#endif
