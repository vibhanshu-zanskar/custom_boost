...
// version 1 for zr_boost_1_81::histogram::accumulators::mean<T>
template <class T>
struct version<zr_boost_1_81::histogram::accumulators::mean<T>> : std::integral_constant<int, 1> {
};
...
/// Specialization for zr_boost_1_81::histogram::accumulators::mean.
struct common_type<zr_boost_1_81::histogram::accumulators::mean<T>,
                   zr_boost_1_81::histogram::accumulators::mean<U>> {
  using type = zr_boost_1_81::histogram::accumulators::mean<common_type_t<T, U>>;
};
} // namespace std
