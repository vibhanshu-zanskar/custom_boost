...
/// Specialization for zr_boost_1_81::histogram::accumulators::fraction.
struct common_type<zr_boost_1_81::histogram::accumulators::fraction<T>,
                   zr_boost_1_81::histogram::accumulators::fraction<U>> {
  using type = zr_boost_1_81::histogram::accumulators::fraction<common_type_t<T, U>>;
};
} // namespace std
