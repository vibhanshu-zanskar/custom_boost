...
struct common_type<zr_boost_1_81::histogram::accumulators::sum<T>,
                   zr_boost_1_81::histogram::accumulators::sum<U>> {
  using type = zr_boost_1_81::histogram::accumulators::sum<common_type_t<T, U>>;
};
} // namespace std
#endif
