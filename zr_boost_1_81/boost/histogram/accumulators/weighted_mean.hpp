...
/// Specialization for zr_boost_1_81::histogram::accumulators::weighted_mean.
struct common_type<zr_boost_1_81::histogram::accumulators::weighted_mean<T>,
                   zr_boost_1_81::histogram::accumulators::weighted_mean<U>> {
  using type = zr_boost_1_81::histogram::accumulators::weighted_mean<common_type_t<T, U>>;
};
} // namespace std
#endif
