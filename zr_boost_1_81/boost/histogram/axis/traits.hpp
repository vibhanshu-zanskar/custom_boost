...
/** Meta-function to detect whether an axis is reducible.
  ...
  whether the axis can be reduced with zr_boost_1_81::histogram::algorithm::reduce().
...
/** Get axis options for axis type.
  ...
  Doxygen does not render this well. This is a meta-function (template alias), it accepts
  an axis type and returns the zr_boost_1_81::histogram::axis::option::bitset.

  If Axis::options() is valid and constexpr, get_options is the corresponding
  option type. Otherwise, it is zr_boost_1_81::histogram::axis::option::growth_t, if the
  axis has a method `update`, else zr_boost_1_81::histogram::axis::option::none_t.
...
/** Returns reference to metadata of an axis.
  ...
  zr_boost_1_81::histogram::axis::null_type.
...
/** Returns axis value for index if it is convertible to target type or throws.
  ...
  Like zr_boost_1_81::histogram::axis::traits::value, but converts the result into the requested
...
/** Returns pair of axis index and shift for the value argument.
  ...
  zr_boost_1_81::histogram::axis::traits::get_options<decltype(axis)> has the growth flag set,
...
/** Returns bin width at axis index.
  ...
  Like zr_boost_1_81::histogram::axis::traits::width, but converts the result into the requested
