...
class variant : public iterator_mixin<variant<Ts...>> {
  using impl_type = zr_boost_1_81::variant2::variant<Ts...>;
          ...
          return detail::static_if<std::is_same<M, metadata_type&>>(
              ...
              [](const auto&) -> metadata_type& {
                BOOST_THROW_EXCEPTION(std::runtime_error(
                    ...
                    "; use zr_boost_1_81::histogram::axis::get to obtain a reference "
                    "of this axis type"));
              },
              a);
        },
...
private:
  ...
  friend struct zr_boost_1_81::histogram::unsafe_access;
};
