...
void* buffer_create(Allocator& a, std::size_t n) {
  ...
  zr_boost_1_81::alloc_construct_n(a, ptr, n);
  guard.release();
...
auto buffer_create(Allocator& a, std::size_t n, Iterator iter) {
  ...
  zr_boost_1_81::alloc_construct_n(a, ptr, n, casting_iterator{iter});
  guard.release();
  return ptr;
}
...
void buffer_destroy(Allocator& a, typename std::allocator_traits<Allocator>::pointer p,
  ...
  assert(p);
  assert(n > 0u);
  zr_boost_1_81::alloc_destroy_n(a, p, n);
  a.deallocate(p, n);
}
...
public:
  ...
  struct buffer_type {
    ...
    buffer_type(buffer_type&& o) noexcept
        ...
        , size(zr_boost_1_81::exchange(o.size, 0))
        , type(zr_boost_1_81::exchange(o.type, 0))
        , ptr(zr_boost_1_81::exchange(o.ptr, nullptr)) {}
