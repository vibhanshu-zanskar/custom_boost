...
accumulator_traits_holder<true, Ts...> accumulator_traits_impl_call_op(
    R (T::*)(zr_boost_1_81::histogram::weight_type<U>, Ts...));
...
template <class R, class T, class U, class... Ts>
accumulator_traits_holder<true, Ts...> accumulator_traits_impl_call_op(
    R (T::*)(const zr_boost_1_81::histogram::weight_type<U>&, Ts...));
...
template <class T>
auto accumulator_traits_impl(T&, priority<2>)
    -> decltype(std::declval<T&>() += std::declval<zr_boost_1_81::histogram::weight_type<int>>(),
...
accumulator_traits_holder<false, S> accumulator_traits_impl(
    zr_boost_1_81::accumulators::accumulator_set<S, F, W>&, priority<2>) {
