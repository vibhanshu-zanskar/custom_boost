...
namespace zr_boost_1_81 { namespace property_tree
{
    ...
    template <class K, class D, class C>
    class basic_ptree<K, D, C>::iterator : public zr_boost_1_81::iterator_adaptor<
    ...
    template <class K, class D, class C>
    class basic_ptree<K, D, C>::const_iterator : public zr_boost_1_81::iterator_adaptor<
    ...
    class basic_ptree<K, D, C>::reverse_iterator
        : public zr_boost_1_81::reverse_iterator<iterator>
    {
    public:
        reverse_iterator() {}
        explicit reverse_iterator(iterator b)
            : zr_boost_1_81::reverse_iterator<iterator>(b)
        {}
    };
    template <class K, class D, class C>
    class basic_ptree<K, D, C>::const_reverse_iterator
        : public zr_boost_1_81::reverse_iterator<const_iterator>
    {
    public:
        const_reverse_iterator() {}
        explicit const_reverse_iterator(const_iterator b)
            : zr_boost_1_81::reverse_iterator<const_iterator>(b)
        {}
        const_reverse_iterator(
    ...
    class basic_ptree<K, D, C>::assoc_iterator
        : public zr_boost_1_81::iterator_adaptor<assoc_iterator,
                                         typename subs::by_name_index::iterator,
                                         value_type>
    {
        friend class zr_boost_1_81::iterator_core_access;
        typedef zr_boost_1_81::iterator_adaptor<assoc_iterator,
                                         typename subs::by_name_index::iterator,
                                         value_type>
            baset;
    public:
    ...
    class basic_ptree<K, D, C>::const_assoc_iterator
        : public zr_boost_1_81::iterator_adaptor<const_assoc_iterator,
    ...
    {
        zr_boost_1_81::swap(m_data, rhs.m_data);
    ...
    typename zr_boost_1_81::enable_if<detail::is_translator<Translator>, Type>::type
    basic_ptree<K, D, C>::get_value(Translator tr) const
    {
        if(zr_boost_1_81::optional<Type> o = get_value_optional<Type>(tr)) {
            return *o;
        }
    ...
    template<class K, class D, class C>
    template<class Type> inline
    typename zr_boost_1_81::disable_if<detail::is_translator<Type>, Type>::type
    ...
    void basic_ptree<K, D, C>::put_value(const Type &value, Translator tr)
    {
        if(optional<data_type> o = tr.put_value(value)) {
            ...
            BOOST_PROPERTY_TREE_THROW(ptree_bad_data(
                ...
                "\" to data failed", zr_boost_1_81::any()));
        }
    }
