...
namespace zr_boost_1_81 { namespace property_tree { namespace xml_parser
{

    template<class Ptree, class Ch>
    void read_xml_node(detail::zr_boost_1_81rapidxml::xml_node<Ch> *node,
                       Ptree &pt, int flags)
    {
        using namespace detail::zr_boost_1_81rapidxml;
        switch (node->type())
        {
            // Element nodes
            case node_element: 
