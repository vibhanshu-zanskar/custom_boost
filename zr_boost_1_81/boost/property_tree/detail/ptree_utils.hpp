...
namespace zr_boost_1_81 { namespace property_tree { namespace detail
{
    ...
    struct is_character : public zr_boost_1_81::false_type {};
    template <>
    struct is_character<char> : public zr_boost_1_81::true_type {};
    template <>
    struct is_character<wchar_t> : public zr_boost_1_81::true_type {};


    BOOST_MPL_HAS_XXX_TRAIT_DEF(internal_type)
    BOOST_MPL_HAS_XXX_TRAIT_DEF(external_type)
    template <typename T>
    struct is_translator : public zr_boost_1_81::mpl::and_<
