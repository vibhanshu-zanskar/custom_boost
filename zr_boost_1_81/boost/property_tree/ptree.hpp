...
namespace zr_boost_1_81 { namespace property_tree
{
    ...
    public:
        ...
        /** Equivalent to erase(zr_boost_1_81::prior(end())). */
        void pop_back();
        ...
        /** Get the child at the given path, or return zr_boost_1_81::null. */
        ...
        /** Take the value of this node and attempt to translate it to a
         * @c Type object using the supplied translator. Return zr_boost_1_81::null if
         * this fails.
         */
        template<class Type, class Translator>
        ...
        /** Take the value of this node and attempt to translate it to a
         * @c Type object using the default translator. Return zr_boost_1_81::null if
         * this fails.
         */
        template<class Type>
