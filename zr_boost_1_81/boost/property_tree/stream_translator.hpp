...
namespace zr_boost_1_81 { namespace property_tree
{
    ...
    namespace detail
    {
        ...
        struct is_inexact_impl<true>
        {
            ...
            struct test
            {
              typedef zr_boost_1_81::integral_constant<bool,
        ...
        struct is_inexact
        {
            typedef typename zr_boost_1_81::decay<F>::type decayed;
    ...
    struct customize_stream<Ch, Traits, F,
        typename zr_boost_1_81::enable_if< detail::is_inexact<F> >::type
    >
    {
    ...
    public:
        ...
        zr_boost_1_81::optional<internal_type> put_value(const E &v) {
            ...
            return zr_boost_1_81::optional<internal_type>();
        }
