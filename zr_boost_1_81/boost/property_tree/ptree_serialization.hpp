...
namespace zr_boost_1_81 { namespace property_tree
{
    ...
    ///////////////////////////////////////////////////////////////////////////
    // zr_boost_1_81::serialization support
     ...
     *       library's @c zr_boost_1_81::property_tree::xml_parser::write_xml.
    ...
    namespace detail
    {
        ...
        inline void load_children(Archive &ar,
                                  basic_ptree<K, D, C> &t)
        {
            namespace bsl = zr_boost_1_81::serialization;
            namespace bsa = zr_boost_1_81::archive;
     ...
     *       zr_boost_1_81::property_tree::save.
