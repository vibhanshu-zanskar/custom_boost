...
namespace zr_boost_1_81 {
  ...
  struct property_traits :
    zr_boost_1_81::mpl::if_<is_property_map<PA>,
  ...
  struct property_traits<T*> {
    // BOOST_STATIC_ASSERT(zr_boost_1_81::is_same<T, T*>::value && !"Using pointers as property maps is deprecated");
  ...
  // do zr_boost_1_81::get() anyways, and the using clause
...
namespace zr_boost_1_81 {
  ...
  struct ReadablePropertyMapConcept
  {
    ...
    typedef zr_boost_1_81::readable_property_map_tag ReadableTag;
    void constraints() {
  ...
  struct WritablePropertyMapConcept
  {
    typedef typename property_traits<PMap>::key_type key_type;
    typedef typename property_traits<PMap>::category Category;
    typedef zr_boost_1_81::writable_property_map_tag WritableTag;
    void constraints() {
  ...
  {
    typedef typename property_traits<PMap>::category Category;
    typedef zr_boost_1_81::read_write_property_map_tag ReadWriteTag;
    void constraints() {
  ...
  {
    typedef typename property_traits<PMap>::category Category;
    typedef zr_boost_1_81::lvalue_property_map_tag LvalueTag;
    typedef typename property_traits<PMap>::reference reference;
    ...
    void constraints() {
      ...
      BOOST_MPL_ASSERT((zr_boost_1_81::mpl::or_<
                          zr_boost_1_81::is_same<const value_type&, reference>,
                          zr_boost_1_81::is_same<value_type&, reference> >));
  ...
  struct Mutable_LvaluePropertyMapConcept
  {
    ...
    void constraints() {
      ...
      typedef typename property_traits<PMap>::value_type value_type;
      BOOST_MPL_ASSERT((zr_boost_1_81::is_same<value_type&, reference>));
  ...
  class iterator_property_map
    : public zr_boost_1_81::put_get_helper< R, 
  ...
  class associative_property_map
    : public zr_boost_1_81::put_get_helper<
  ...
  class static_property_map :
      public
  zr_boost_1_81::put_get_helper<ValueType,static_property_map<ValueType> >
  { 
    ValueType value;
  public:
  ...
  class ref_property_map :
    public
      zr_boost_1_81::put_get_helper<ValueType&,ref_property_map<KeyType,ValueType> >
  { 
    ValueType* value;
  public:
    typedef KeyType key_type;
  ...
  template <typename T>
  struct typed_identity_property_map
    : public zr_boost_1_81::put_get_helper<T, typed_identity_property_map<T> >
  {
    typedef T key_type;
    typedef T value_type;
    typedef T reference;
...
//=========================================================================
  ...
  class dummy_property_map 
    : public zr_boost_1_81::put_get_helper<detail::dummy_pmap_reference,
        dummy_property_map  > 
  {
  public:
    ...
    typedef zr_boost_1_81::read_write_property_map_tag category;
