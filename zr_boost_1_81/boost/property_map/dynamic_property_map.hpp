...
namespace detail {
  ...
  { return zr_boost_1_81::lexical_cast<Value>(value); }
...
public:
  ...
  virtual zr_boost_1_81::any get(const any& key) = 0;
...
typename zr_boost_1_81::property_traits<PMap>::reference
get_wrapper_xxx(const PMap& pmap, const Key& key) {
  using zr_boost_1_81::get;
  return get(pmap, key);
}
...
class dynamic_property_map_adaptor : public dynamic_property_map
{
  ...
  {
    using zr_boost_1_81::put;

    key_type key_ = any_cast<key_type>(in_key);
    if (in_value.type() == zr_boost_1_81::typeindex::type_id<value_type>()) {
...
public:
  ...
  zr_boost_1_81::any get(const any& key_) BOOST_OVERRIDE
  {
    return get_wrapper_xxx(property_map_, any_cast<typename zr_boost_1_81::property_traits<PropertyMap>::key_type>(key_));
  }

  std::string get_string(const any& key_) BOOST_OVERRIDE
  {
    std::ostringstream out;
    out << get_wrapper_xxx(property_map_, any_cast<typename zr_boost_1_81::property_traits<PropertyMap>::key_type>(key_));
    return out.str();
  }
...
{
  typedef std::multimap<std::string, zr_boost_1_81::shared_ptr<dynamic_property_map> >
    property_maps_type;
  typedef zr_boost_1_81::function3<zr_boost_1_81::shared_ptr<dynamic_property_map>,
                           const std::string&,
                           const zr_boost_1_81::any&,
                           const zr_boost_1_81::any&> generate_fn_type;
public:
  ...
  {
    zr_boost_1_81::shared_ptr<dynamic_property_map> pm(
      zr_boost_1_81::static_pointer_cast<dynamic_property_map>(
        zr_boost_1_81::make_shared<detail::dynamic_property_map_adaptor<PropertyMap> >(property_map_)));
  ...
  void
  insert(const std::string& name, zr_boost_1_81::shared_ptr<dynamic_property_map> pm)
  {
    property_maps.insert(property_maps_type::value_type(name, pm));
  }

  template<typename Key, typename Value>
  zr_boost_1_81::shared_ptr<dynamic_property_map>
    ...
    const Value& value)
{
  ...
  zr_boost_1_81::shared_ptr<dynamic_property_map> new_map = dp.generate(name, key, value);
  if (new_map.get()) {
...
inline
zr_boost_1_81::shared_ptr<zr_boost_1_81::dynamic_property_map>
ignore_other_properties(const std::string&,
                        const zr_boost_1_81::any&,
                        const zr_boost_1_81::any&) {
  return zr_boost_1_81::shared_ptr<zr_boost_1_81::dynamic_property_map>();
}
