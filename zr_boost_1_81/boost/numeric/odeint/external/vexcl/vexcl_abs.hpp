...
typename std::enable_if<
    ...
    typename zr_boost_1_81::proto::result_of::make_expr<
        zr_boost_1_81::proto::tag::function,
        abs_func,
        const vex::multivector<T, N>&
    >::type const
>::type
abs(const multivector<T, N> &arg) {
    return zr_boost_1_81::proto::make_expr<zr_boost_1_81::proto::tag::function>(
            abs_func(),
            zr_boost_1_81::ref(arg)
            );
}
