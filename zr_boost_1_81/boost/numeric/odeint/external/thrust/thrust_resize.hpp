...
{                                                             \
    static void resize( THRUST_VECTOR<T,A> &x ,               \
                        const Range &y )                      \
    {                                                         \
        x.resize( thrust::distance(zr_boost_1_81::begin(y),           \
                                   zr_boost_1_81::end(y)));           \
    }                                                         \
};                                                            \
...
{                                                                \
    static bool same_size( const THRUST_VECTOR<T,A> &x ,         \
                           const Range &y )                      \
    {                                                            \
        return x.size() == thrust::distance(zr_boost_1_81::begin(y),     \
                                            zr_boost_1_81::end(y));      \
    }                                                            \
};                                                               \
...
{                                                                       \
    ...
    {                                                                   \
        thrust::copy( zr_boost_1_81::begin( from ) , zr_boost_1_81::end( from ) ,       \
                      zr_boost_1_81::begin( to ) );                             \
    }                                                                   \
};                                                                      \
                                                                        \
