...
struct thrust_algebra
{
    ...
    {
        thrust::for_each( zr_boost_1_81::begin(s) , zr_boost_1_81::end(s) , op );
    }
    ...
    {
        thrust::for_each(
                thrust::make_zip_iterator( thrust::make_tuple( zr_boost_1_81::begin(s1) ,
                        zr_boost_1_81::begin(s2) ) ) ,
                        thrust::make_zip_iterator( thrust::make_tuple( zr_boost_1_81::end(s1) ,
                                zr_boost_1_81::end(s2) ) ) ,
                                op);
    }
    ...
    static void for_each3( StateType1 &s1 , StateType2 &s2 , StateType3 &s3 , Operation op )
    {
        thrust::for_each(
                thrust::make_zip_iterator( thrust::make_tuple( zr_boost_1_81::begin(s1) ,
                        zr_boost_1_81::begin(s2) ,
                        zr_boost_1_81::begin(s3) ) ) ,
                        thrust::make_zip_iterator( thrust::make_tuple( zr_boost_1_81::end(s1) ,
                                zr_boost_1_81::end(s2) ,
                                zr_boost_1_81::end(s3) ) ) ,
                                op);
    }
            ...
            Operation op )
    {
        thrust::for_each(
                thrust::make_zip_iterator( thrust::make_tuple( zr_boost_1_81::begin(s1) ,
                        zr_boost_1_81::begin(s2) ,
                        zr_boost_1_81::begin(s3) ,
                        zr_boost_1_81::begin(s4) ) ) ,
                        thrust::make_zip_iterator( thrust::make_tuple( zr_boost_1_81::end(s1) ,
                                zr_boost_1_81::end(s2) ,
                                zr_boost_1_81::end(s3) ,
                                zr_boost_1_81::end(s4) ) ) ,
                                op);
    }
            ...
            StateType5 &s5 , Operation op )
    {
        thrust::for_each(
                thrust::make_zip_iterator( thrust::make_tuple( zr_boost_1_81::begin(s1) ,
                        ...
                        zr_boost_1_81::begin(s3) ,
                        zr_boost_1_81::begin(s4) ,
                        zr_boost_1_81::begin(s5) ) ) ,
                        thrust::make_zip_iterator( thrust::make_tuple( zr_boost_1_81::end(s1) ,
                                zr_boost_1_81::end(s2) ,
                                zr_boost_1_81::end(s3) ,
                                zr_boost_1_81::end(s4) ,
                                zr_boost_1_81::end(s5) ) ) ,
                                op);
    }
            ...
            StateType5 &s5 , StateType6 &s6 , Operation op )
    {
        thrust::for_each(
                thrust::make_zip_iterator( thrust::make_tuple( zr_boost_1_81::begin(s1) ,
                        ...
                        zr_boost_1_81::begin(s4) ,
                        zr_boost_1_81::begin(s5) ,
                        zr_boost_1_81::begin(s6) ) ) ,
                        thrust::make_zip_iterator( thrust::make_tuple( zr_boost_1_81::end(s1) ,
                                zr_boost_1_81::end(s2) ,
                                zr_boost_1_81::end(s3) ,
                                zr_boost_1_81::end(s4) ,
                                zr_boost_1_81::end(s5) ,
                                zr_boost_1_81::end(s6) ) ) ,
                                op);
    }
    ...
    static typename S::value_type norm_inf( const S &s )
    {
        ...
        return thrust::reduce( zr_boost_1_81::begin( s ) , zr_boost_1_81::end( s ) ,
