...
#define BOOST_ODEINT_GEN_LOCAL(z, n, unused) \
    BOOST_ASSERT_MSG( len == zr_boost_1_81::size(s ## n), "All state ranges must have the same size." ); \
...
#undef BOOST_ODEINT_GEN_LOCAL
    ...
    static typename norm_result_type< S >::type norm_inf( const S &s )
    {
        ...
        typename zr_boost_1_81::range_iterator<const S>::type beg = zr_boost_1_81::begin(s);
