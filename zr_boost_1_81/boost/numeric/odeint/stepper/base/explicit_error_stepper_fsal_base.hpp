...
public:
    ...
    typename zr_boost_1_81::disable_if< zr_boost_1_81::is_same< StateInOut , time_type > , void >::type
    ...
    typename zr_boost_1_81::disable_if< zr_boost_1_81::is_same< StateIn , time_type > , void >::type
 ...
 *      case it can be used with `zr_boost_1_81::ref` or `std::ref`, for example `stepper.do_step( zr_boost_1_81::ref( sys ) , x , t , dt );`
 *
