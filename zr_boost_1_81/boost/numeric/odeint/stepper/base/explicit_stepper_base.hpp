...
public:
    ...
    typename zr_boost_1_81::disable_if< zr_boost_1_81::is_same< DerivIn , time_type > , void >::type
 ...
 *
 * \note The system is always passed as value, which might result in poor performance if it contains data. In this case it can be used with `zr_boost_1_81::ref`
 * or `std::ref`, for example `stepper.do_step( zr_boost_1_81::ref( sys ) , x , t , dt );`
 *
