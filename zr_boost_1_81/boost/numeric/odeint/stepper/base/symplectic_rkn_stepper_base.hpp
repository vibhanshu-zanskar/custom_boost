...
public:
    ...
    typedef zr_boost_1_81::array< value_type , num_of_stages > coef_type;
...
private:
    ...
    template< class System , class StateIn , class StateOut >
    void do_step_impl( System system , const StateIn &in , time_type /* t */ , StateOut &out , time_type dt , zr_boost_1_81::mpl::true_ )
    {
        typedef typename odeint::unwrap_reference< System >::type system_type;
    ...
    template< class System , class StateIn , class StateOut >
    void do_step_impl( System system , const StateIn &in , time_type  /* t */ , StateOut &out , time_type dt , zr_boost_1_81::mpl::false_ )
    {
 ...
 */
     ...
     * is updated in-place.
     *
     * \note zr_boost_1_81::ref or std::ref can be used for the system as well as for the state. So, it is correct
     ...
     * is updated in-place.
     *
     * \note zr_boost_1_81::ref or std::ref can be used for the system. So, it is correct
