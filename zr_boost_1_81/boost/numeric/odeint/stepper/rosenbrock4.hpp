...
public:
    ...
    typedef Value value_type;
    typedef zr_boost_1_81::numeric::ublas::vector< value_type > state_type;
    typedef state_type deriv_type;
    typedef value_type time_type;
    typedef zr_boost_1_81::numeric::ublas::matrix< value_type > matrix_type;
    typedef zr_boost_1_81::numeric::ublas::permutation_matrix< size_t > pmatrix_type;
    ...
    void do_step( System system , const state_type &x , time_type t , state_type &xout , time_type dt , state_type &xerr )
    {
        ...
        m_jac.m_v *= -1.0;
        m_jac.m_v += 1.0 / m_coef.gamma / dt * zr_boost_1_81::numeric::ublas::identity_matrix< value_type >( n );
        zr_boost_1_81::numeric::ublas::lu_factorize( m_jac.m_v , m_pm.m_v );

        for( size_t i=0 ; i<n ; ++i )
            m_g1.m_v[i] = m_dxdt.m_v[i] + dt * m_coef.d1 * m_dfdt.m_v[i];
        zr_boost_1_81::numeric::ublas::lu_substitute( m_jac.m_v , m_pm.m_v , m_g1.m_v );
        ...
        zr_boost_1_81::numeric::ublas::lu_substitute( m_jac.m_v , m_pm.m_v , m_g2.m_v );
        ...
        zr_boost_1_81::numeric::ublas::lu_substitute( m_jac.m_v , m_pm.m_v , m_g3.m_v );
        ...
        zr_boost_1_81::numeric::ublas::lu_substitute( m_jac.m_v , m_pm.m_v , m_g4.m_v );
        ...
        zr_boost_1_81::numeric::ublas::lu_substitute( m_jac.m_v , m_pm.m_v , m_g5.m_v );
        ...
        zr_boost_1_81::numeric::ublas::lu_substitute( m_jac.m_v , m_pm.m_v , xerr );
