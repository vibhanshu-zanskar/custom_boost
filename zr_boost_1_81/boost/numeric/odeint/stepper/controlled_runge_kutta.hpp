...
public:
    ...
    controlled_step_result try_step( System system , StateInOut &x , const DerivIn &dxdt , time_type &t , time_type &dt )
    {
        ...
        if( res == success )
        {
            zr_boost_1_81::numeric::odeint::copy( m_xnew.m_v , x );
        }
        return res;
    }
    ...
    typename zr_boost_1_81::disable_if< zr_boost_1_81::is_same< StateIn , time_type > , controlled_step_result >::type
...
public:
     ...
     *
     * This version does not solve the forwarding problem, zr_boost_1_81::range can not be used.
     * 
    ...
    controlled_step_result try_step( System system , StateInOut &x , DerivInOut &dxdt , time_type &t , time_type &dt )
    {
        ...
        {
            zr_boost_1_81::numeric::odeint::copy( m_xnew.m_v , x );
            zr_boost_1_81::numeric::odeint::copy( m_dxdtnew.m_v , dxdt );
        }
        return res;
    }
    ...
    {
        zr_boost_1_81::numeric::odeint::copy( deriv , m_dxdt.m_v );
        m_first_call = false;
    }
