...
public:
    ...
    size_t adjust_order(size_t order, size_t init, zr_boost_1_81::array<wrapped_state_type, 4> &xerr)
    {
        using std::abs;
...
public:
    ...
    typedef zr_boost_1_81::array< wrapped_state_type , 4 > error_storage_type;
    ...
    controlled_step_result try_step(System system, state_type & inOut, time_type &t, time_type &dt)
    {
        ...
        if(res == success)
        {
            zr_boost_1_81::numeric::odeint::copy( m_xnew.m_v , inOut);
        }
