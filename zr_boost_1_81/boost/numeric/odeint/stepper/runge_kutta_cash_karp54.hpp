...
struct rk54_ck_coefficients_a1 : zr_boost_1_81::array< Value , 1 >
{
...
template< class Value = double >
struct rk54_ck_coefficients_a2 : zr_boost_1_81::array< Value , 2 >
{
...
template< class Value = double >
struct rk54_ck_coefficients_a3 : zr_boost_1_81::array< Value , 3 >
{
...
template< class Value = double >
struct rk54_ck_coefficients_a4 : zr_boost_1_81::array< Value , 4 >
{
...
template< class Value = double >
struct rk54_ck_coefficients_a5 : zr_boost_1_81::array< Value , 5 >
{
...
template< class Value = double >
struct rk54_ck_coefficients_b : zr_boost_1_81::array< Value , 6 >
{
...
template< class Value = double >
struct rk54_ck_coefficients_db : zr_boost_1_81::array< Value , 6 >
{
...
template< class Value = double >
struct rk54_ck_coefficients_c : zr_boost_1_81::array< Value , 6 >
{
...
public:
    ...
    runge_kutta_cash_karp54( const algebra_type &algebra = algebra_type() ) : stepper_base_type(
        zr_boost_1_81::fusion::make_vector( rk54_ck_coefficients_a1<Value>() ,
