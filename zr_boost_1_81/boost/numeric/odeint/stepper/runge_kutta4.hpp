...
struct rk4_coefficients_a1 : zr_boost_1_81::array< Value , 1 >
{
...
template< class Value = double >
struct rk4_coefficients_a2 : zr_boost_1_81::array< Value , 2 >
{
...
template< class Value = double >
struct rk4_coefficients_a3 : zr_boost_1_81::array< Value , 3 >
{
...
template< class Value = double >
struct rk4_coefficients_b : zr_boost_1_81::array< Value , 4 >
{
...
template< class Value = double >
struct rk4_coefficients_c : zr_boost_1_81::array< Value , 4 >
{
...
public:
    ...
    runge_kutta4( const algebra_type &algebra = algebra_type() ) : stepper_base_type(
            zr_boost_1_81::fusion::make_vector( rk4_coefficients_a1<Value>() , rk4_coefficients_a2<Value>() , rk4_coefficients_a3<Value>() ) ,
