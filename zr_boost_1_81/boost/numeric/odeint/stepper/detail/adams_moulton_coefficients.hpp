...
class adams_moulton_coefficients< Value , 1 > : public zr_boost_1_81::array< Value , 1 >
{
public:
...
template< class Value >
class adams_moulton_coefficients< Value , 2 > : public zr_boost_1_81::array< Value , 2 >
{
public:
    adams_moulton_coefficients( void )
...
template< class Value >
class adams_moulton_coefficients< Value , 3 > : public zr_boost_1_81::array< Value , 3 >
{
public:
    adams_moulton_coefficients( void )
...
template< class Value >
class adams_moulton_coefficients< Value , 4 > : public zr_boost_1_81::array< Value , 4 >
{
public:
    adams_moulton_coefficients( void )
...
template< class Value >
class adams_moulton_coefficients< Value , 5 > : public zr_boost_1_81::array< Value , 5 >
{
public:
    adams_moulton_coefficients( void )
...
template< class Value >
class adams_moulton_coefficients< Value , 6 > : public zr_boost_1_81::array< Value , 6 >
{
public:
    adams_moulton_coefficients( void )
...
template< class Value >
class adams_moulton_coefficients< Value , 7 > : public zr_boost_1_81::array< Value , 7 >
{
public:
    adams_moulton_coefficients( void )
...
template< class Value >
class adams_moulton_coefficients< Value , 8 > : public zr_boost_1_81::array< Value , 8 >
{
public:
    adams_moulton_coefficients( void )
