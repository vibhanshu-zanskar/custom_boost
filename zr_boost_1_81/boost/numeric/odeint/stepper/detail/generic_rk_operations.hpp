...
{
    generic_rk_scale_sum( const zr_boost_1_81::array<Fac,1> &a , Time dt ) : Operations::template scale_sum2< Fac , Time >( 1.0 , a[0]*dt )
                { }
...
{
    generic_rk_scale_sum( const zr_boost_1_81::array<Fac,2> &a , Time dt )
...
{
    generic_rk_scale_sum( const zr_boost_1_81::array<Fac,3> &a , Time dt )
...
{
    generic_rk_scale_sum( const zr_boost_1_81::array<Fac,4> &a , Time dt )
...
{
    generic_rk_scale_sum( const zr_boost_1_81::array<Fac,5> &a , Time dt )
...
{
    generic_rk_scale_sum( const zr_boost_1_81::array<Fac,6> &a , Time dt )
...
{
    generic_rk_scale_sum( const zr_boost_1_81::array<Fac,7> &a , Time dt )
...
{
    generic_rk_scale_sum( const zr_boost_1_81::array<Fac,8> &a , Time dt )
...
{
    generic_rk_scale_sum( const zr_boost_1_81::array<Fac,9> &a , Time dt )
...
{
    generic_rk_scale_sum( const zr_boost_1_81::array<Fac,10> &a , Time dt )
...
{
    generic_rk_scale_sum( const zr_boost_1_81::array<Fac,11> &a , Time dt )
...
{
    generic_rk_scale_sum( const zr_boost_1_81::array<Fac,12> &a , Time dt )
...
{
    generic_rk_scale_sum( const zr_boost_1_81::array<Fac,13> &a , Time dt )
...
{
    generic_rk_scale_sum_err( const zr_boost_1_81::array<Fac,1> &a , Time dt ) : Operations::template scale_sum1< Time >( a[0]*dt )
                { }
...
{
    generic_rk_scale_sum_err( const zr_boost_1_81::array<Fac,2> &a , Time dt )
...
{
    generic_rk_scale_sum_err( const zr_boost_1_81::array<Fac,3> &a , Time dt )
...
{
    generic_rk_scale_sum_err( const zr_boost_1_81::array<Fac,4> &a , Time dt )
...
{
    generic_rk_scale_sum_err( const zr_boost_1_81::array<Fac,5> &a , Time dt )
...
{
    generic_rk_scale_sum_err( const zr_boost_1_81::array<Fac,6> &a , Time dt )
...
{
    generic_rk_scale_sum_err( const zr_boost_1_81::array<Fac,13> &a , Time dt )
