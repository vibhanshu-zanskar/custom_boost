...
public:
    ...
    rotating_buffer<zr_boost_1_81::array<value_type, order_value+1>, 2> beta; // beta[0] = beta(n)
    rotating_buffer<zr_boost_1_81::array<wrapped_deriv_type, order_value+2>, 3> phi; // phi[0] = phi(n+1)
    zr_boost_1_81::array<value_type, order_value + 2> g;
    zr_boost_1_81::array<value_type, 14> gs;
...
private:
    ...
    zr_boost_1_81::array<value_type, c_size*c_size> c;
