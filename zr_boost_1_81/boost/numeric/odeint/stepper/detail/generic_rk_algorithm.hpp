...
{
    typedef const typename zr_boost_1_81::array< T , Constant::value > type;
};
...
public:
    ...
    typedef typename zr_boost_1_81::fusion::result_of::as_vector
            <
            typename zr_boost_1_81::mpl::copy
            <
            stage_indices ,
            zr_boost_1_81::mpl::inserter
            <
            zr_boost_1_81::mpl::vector0< > ,
            zr_boost_1_81::mpl::push_back< zr_boost_1_81::mpl::_1 , array_wrapper< Value , zr_boost_1_81::mpl::_2 > >
    >
    >::type
    >::type coef_a_type;

    typedef zr_boost_1_81::array< Value , StageCount > coef_b_type;
    typedef zr_boost_1_81::array< Value , StageCount > coef_c_type;
    ...
    typedef typename zr_boost_1_81::fusion::result_of::as_vector
            ...
            <
            zr_boost_1_81::mpl::vector0<> ,
            zr_boost_1_81::mpl::push_back< zr_boost_1_81::mpl::_1 , stage_wrapper< Value , zr_boost_1_81::mpl::_2 > >
    >
    >::type ,
    ...
    struct stage_vector : public stage_vector_base
    {
        struct do_insertion
        {
            ...
            {
                //zr_boost_1_81::fusion::at< Index >( m_base ) = stage< double , Index::value+1 , intermediate_stage >( m_c[ Index::value ] , zr_boost_1_81::fusion::at< Index >( m_a ) );
                zr_boost_1_81::fusion::at< Index >( m_base ).c  = m_c[ Index::value ];
                zr_boost_1_81::fusion::at< Index >( m_base ).a = zr_boost_1_81::fusion::at< Index >( m_a );
            }
        };
        ...
        struct print_butcher
        {
            ...
            template<class Index>
            void operator()(Index) const {
                m_os << zr_boost_1_81::fusion::at<Index>(m_base).c << " | ";
                for( size_t i=0 ; i<Index::value ; ++i )
                    m_os << zr_boost_1_81::fusion::at<Index>(m_base).a[i] << " ";
                m_os << std::endl;
            }
        };
        ...
        {
            typedef zr_boost_1_81::mpl::range_c< size_t , 0 , StageCount-1 > indices;
            zr_boost_1_81::mpl::for_each< indices >( do_insertion( *this , a , c ) );
            zr_boost_1_81::fusion::at_c< StageCount - 1 >( *this ).c = c[ StageCount - 1 ];
            zr_boost_1_81::fusion::at_c< StageCount - 1 >( *this ).a = b;
        }

        void print( std::ostream &os ) const
        {
            typedef zr_boost_1_81::mpl::range_c< size_t , 0 , StageCount > indices;
            zr_boost_1_81::mpl::for_each< indices >( print_butcher( *this , os ) );
        }
    };
...
#pragma warning( default : 4307 34 )
            ...
            StateTemp &x_tmp , Deriv F[StageCount-1] ) const
    {
        ...
        zr_boost_1_81::fusion::for_each( m_stages , calculate_stage<
