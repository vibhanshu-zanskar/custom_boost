...
public:
    ...
    void do_step( System system , state_type &x , time_type t , time_type dt )
    {
        ...
        m_jacobi.m_v *= dt;
        m_jacobi.m_v -= zr_boost_1_81::numeric::ublas::identity_matrix< value_type >( x.size() );
        ...
        while( zr_boost_1_81::numeric::ublas::norm_2( m_b.m_v ) > m_epsilon )
        {
            ...
            //            m_jacobi *= dt;
            //            m_jacobi -= zr_boost_1_81::numeric::ublas::identity_matrix< value_type >( x.size() );
...
private:
    ...
    {
        int res = zr_boost_1_81::numeric::ublas::lu_factorize( m , m_pm.m_v );
        if( res != 0 ) std::exit(0);
        zr_boost_1_81::numeric::ublas::lu_substitute( m , m_pm.m_v , x );
    }
