...
struct algebra_dispatcher< zr_boost_1_81::array< T , N > >
{
...
template< typename T >
struct algebra_dispatcher_sfinae< T , typename zr_boost_1_81::enable_if< typename zr_boost_1_81::is_floating_point< T >::type >::type >
{
...
struct algebra_dispatcher< zr_boost_1_81::numeric::ublas::vector< T , A > >
{
    typedef vector_space_algebra algebra_type;
};

template< class T , class L , class A >
struct algebra_dispatcher< zr_boost_1_81::numeric::ublas::matrix< T , L , A > >
{
    typedef vector_space_algebra algebra_type;
};
//*/
