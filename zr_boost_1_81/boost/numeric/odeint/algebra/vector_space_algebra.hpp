...
struct vector_space_algebra
{
    ...
    template< class S >
    static typename zr_boost_1_81::numeric::odeint::vector_space_norm_inf< S >::result_type norm_inf( const S &s )
    {
        zr_boost_1_81::numeric::odeint::vector_space_norm_inf< S > n;
        return n( s );
    }
};
