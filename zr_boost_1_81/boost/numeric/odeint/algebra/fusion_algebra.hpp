/*
 ...
 [begin_description]
 Algebra for zr_boost_1_81::fusion sequences.
 [end_description]
...
struct fusion_algebra
{
    ...
    {
        zr_boost_1_81::fusion::for_each( s1 , op );
    };
    ...
    {
        typedef zr_boost_1_81::fusion::vector< S1& , S2& > Sequences;
        Sequences sequences( s1 , s2 );
        zr_boost_1_81::fusion::for_each( zr_boost_1_81::fusion::zip_view< Sequences >( sequences ) , zr_boost_1_81::fusion::make_fused( op ) );
    }
    ...
    {
        typedef zr_boost_1_81::fusion::vector< S1& , S2& , S3& > Sequences;
    ...
    {
        typedef zr_boost_1_81::fusion::vector< S1& , S2& , S3& , S4& > Sequences;
    ...
    {
        typedef zr_boost_1_81::fusion::vector< S1& , S2& , S3& , S4& , S5& > Sequences;
    ...
    {
        typedef zr_boost_1_81::fusion::vector< S1& , S2& , S3& , S4& , S5& , S6& > Sequences;
    ...
    {
        typedef zr_boost_1_81::fusion::vector< S1& , S2& , S3& , S4& , S5& , S6& , S7& > Sequences;
    ...
    static void for_each8( S1 &s1 , S2 &s2 , S3 &s3 , S4 &s4 , S5 &s5 , S6 &s6 , S7 &s7 , S8 &s8 , Op op )
    {
        ...
        typedef zr_boost_1_81::fusion::vector< S1& , S2& , S3& , S4& , S5& , S6& , S7& , S8& > Sequences;
    ...
    static void for_each9( S1 &s1 , S2 &s2 , S3 &s3 , S4 &s4 , S5 &s5 , S6 &s6 , S7 &s7 , S8 &s8 , S9 &s9 , Op op )
    {
        ...
        typedef zr_boost_1_81::fusion::vector< S1& , S2& , S3& , S4& , S5& , S6& , S7& , S8& , S9& > Sequences;
    ...
    static void for_each10( S1 &s1 , S2 &s2 , S3 &s3 , S4 &s4 , S5 &s5 , S6 &s6 , S7 &s7 , S8 &s8 , S9 &s9 , S10 &s10 , Op op )
    {
        ...
        typedef zr_boost_1_81::fusion::vector< S1& , S2& , S3& , S4& , S5& , S6& , S7& , S8& , S9& , S10& > Sequences;
    ...
    static void for_each11( S1 &s1 , S2 &s2 , S3 &s3 , S4 &s4 , S5 &s5 , S6 &s6 , S7 &s7 , S8 &s8 , S9 &s9 , S10 &s10 , S11 &s11 , Op op )
    {
        ...
        typedef zr_boost_1_81::fusion::vector< S1& , S2& , S3& , S4& , S5& , S6& , S7& , S8& , S9& , S10& , S11& > Sequences;
    ...
    static void for_each12( S1 &s1 , S2 &s2 , S3 &s3 , S4 &s4 , S5 &s5 , S6 &s6 , S7 &s7 , S8 &s8 , S9 &s9 , S10 &s10 , S11 &s11 , S12 &s12 , Op op )
    {
        ...
        typedef zr_boost_1_81::fusion::vector< S1& , S2& , S3& , S4& , S5& , S6& , S7& , S8& , S9& , S10& , S11& , S12& > Sequences;
    ...
    static void for_each13( S1 &s1 , S2 &s2 , S3 &s3 , S4 &s4 , S5 &s5 , S6 &s6 , S7 &s7 , S8 &s8 , S9 &s9 , S10 &s10 , S11 &s11 , S12 &s12 , S13 &s13 , Op op )
    {
        ...
        typedef zr_boost_1_81::fusion::vector< S1& , S2& , S3& , S4& , S5& , S6& , S7& , S8& , S9& , S10& , S11& , S12& , S13& > Sequences;
    ...
    static void for_each14( S1 &s1 , S2 &s2 , S3 &s3 , S4 &s4 , S5 &s5 , S6 &s6 , S7 &s7 , S8 &s8 , S9 &s9 , S10 &s10 , S11 &s11 , S12 &s12 , S13 &s13 , S14 &s14 , Op op )
    {
        ...
        typedef zr_boost_1_81::fusion::vector< S1& , S2& , S3& , S4& , S5& , S6& , S7& , S8& , S9& , S10& , S11& , S12& , S13& , S14& > Sequences;
    ...
    static void for_each15( S1 &s1 , S2 &s2 , S3 &s3 , S4 &s4 , S5 &s5 , S6 &s6 , S7 &s7 , S8 &s8 , S9 &s9 , S10 &s10 , S11 &s11 , S12 &s12 , S13 &s13 , S14 &s14 , S15 &s15 , Op op )
    {
        ...
        typedef zr_boost_1_81::fusion::vector< S1& , S2& , S3& , S4& , S5& , S6& , S7& , S8& , S9& , S10& , S11& , S12& , S13& , S14& , S15& > Sequences;
    ...
    static typename fusion_traits< S >::value_type norm_inf( const S &s )
    {
        ...
        return zr_boost_1_81::fusion::accumulate( s , static_cast<value_type>(0) ,
