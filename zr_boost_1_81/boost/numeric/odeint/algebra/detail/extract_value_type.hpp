...
template< typename S >
struct extract_value_type<S , typename zr_boost_1_81::disable_if< has_value_type<S> >::type >
{
...
template< typename S >
struct extract_value_type< S , typename zr_boost_1_81::enable_if< has_value_type<S> >::type >
{
