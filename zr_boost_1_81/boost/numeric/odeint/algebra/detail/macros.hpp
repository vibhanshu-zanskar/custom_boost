...
#define BOOST_ODEINT_CHECK_CONTAINER_TYPE( Type1 , Type2 ) \
        BOOST_STATIC_ASSERT(( zr_boost_1_81::is_same< typename zr_boost_1_81::remove_const< Type1 >::type , Type2 >::value ))
...
#define BOOST_ODEINT_CHECK_OPERATION_ARITY( Operation , Arity ) \
        BOOST_STATIC_ASSERT(( zr_boost_1_81::function_traits< Operation >::arity == Arity ))
 */
