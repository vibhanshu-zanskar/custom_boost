...
struct same_size_impl_sfinae
{
    ...
    {
        return ( zr_boost_1_81::size( x1 ) == zr_boost_1_81::size( x2 ) );
    }
...
struct same_size_fusion
{
    ...
    template< class S1 , class S2 >
    bool same_size_op( const S1 &x1 , const S2 &x2 , zr_boost_1_81::true_type ) const
    {
        return same_size( x1 , x2 );
    }

    template< class S1 , class S2 >
    bool same_size_op( const S1 &/*x1*/ , const S2 &/*x2*/ , zr_boost_1_81::false_type ) const
    {
        return true;
    }
};
...
struct same_size_impl_sfinae< FusionSeq , FusionSeq , typename zr_boost_1_81::enable_if< typename zr_boost_1_81::fusion::traits::is_sequence< FusionSeq >::type >::type >
{
    static bool same_size( const FusionSeq &x1 , const FusionSeq &x2 )
    {
        typedef zr_boost_1_81::fusion::vector< const FusionSeq& , const FusionSeq& > Sequences;
        Sequences sequences( x1 , x2 );
        return zr_boost_1_81::fusion::all( zr_boost_1_81::fusion::zip_view< Sequences >( sequences ) ,
                                   zr_boost_1_81::fusion::make_fused( detail::same_size_fusion() ) );
    }
};
