...
namespace zr_boost_1_81 { namespace numeric { namespace odeint {
    ...
    struct vector_space_norm_inf< zr_boost_1_81::numeric::ublas::vector<T,A> >
    {
        typedef T result_type;

        result_type operator()( const zr_boost_1_81::numeric::ublas::vector<T,A> &x ) const
        {
            return zr_boost_1_81::numeric::ublas::norm_inf( x );
        }
    };


    template< class T , class L , class A >
    struct vector_space_norm_inf< zr_boost_1_81::numeric::ublas::matrix<T,L,A> >
    {
        typedef T result_type;

        result_type operator()( const zr_boost_1_81::numeric::ublas::matrix<T,L,A> &x ) const
        {
            return zr_boost_1_81::numeric::ublas::norm_inf( x );
        }
    };
...
/*
 * resizeable specialization for zr_boost_1_81::numeric::ublas::vector
 */
template< class T , class A >
struct is_resizeable< zr_boost_1_81::numeric::ublas::vector< T , A > >
{
...
/*
 * resizeable specialization for zr_boost_1_81::numeric::ublas::matrix
 */
template< class T , class L , class A >
struct is_resizeable< zr_boost_1_81::numeric::ublas::matrix< T , L , A > >
{
    typedef zr_boost_1_81::true_type type;
    const static bool value = type::value;
};
...
/*
 * resizeable specialization for zr_boost_1_81::numeric::ublas::permutation_matrix
 */
template< class T , class A >
struct is_resizeable< zr_boost_1_81::numeric::ublas::permutation_matrix< T , A > >
{
    typedef zr_boost_1_81::true_type type;
    const static bool value = type::value;
};
...
struct same_size_impl< zr_boost_1_81::numeric::ublas::matrix< T , L , A > , zr_boost_1_81::numeric::ublas::matrix< T2 , L2 , A2 > >
{
    static bool same_size( const zr_boost_1_81::numeric::ublas::matrix< T , L , A > &m1 ,
                           const zr_boost_1_81::numeric::ublas::matrix< T2 , L2 , A2 > &m2 )
    {
...
template< class T , class L , class A , class T2 , class L2 , class A2 >
struct resize_impl< zr_boost_1_81::numeric::ublas::matrix< T , L , A > , zr_boost_1_81::numeric::ublas::matrix< T2 , L2 , A2 > >
{
    static void resize( zr_boost_1_81::numeric::ublas::matrix< T , L , A > &m1 ,
                        const zr_boost_1_81::numeric::ublas::matrix< T2 , L2 , A2 > &m2 )
    {
...
struct same_size_impl< zr_boost_1_81::numeric::ublas::matrix< T , L , A > , zr_boost_1_81::numeric::ublas::vector< T_V , A_V > >
{
    static bool same_size( const zr_boost_1_81::numeric::ublas::matrix< T , L , A > &m ,
                           const zr_boost_1_81::numeric::ublas::vector< T_V , A_V > &v )
    {
...
template< class T , class L , class A , class T_V , class A_V >
struct resize_impl< zr_boost_1_81::numeric::ublas::matrix< T , L , A > , zr_boost_1_81::numeric::ublas::vector< T_V , A_V > >
{
    static void resize( zr_boost_1_81::numeric::ublas::matrix< T , L , A > &m ,
                        const zr_boost_1_81::numeric::ublas::vector< T_V , A_V > &v )
    {
...
struct same_size_impl< zr_boost_1_81::numeric::ublas::permutation_matrix< T , A > ,
                       zr_boost_1_81::numeric::ublas::vector< T_V , A_V > >
{
    static bool same_size( const zr_boost_1_81::numeric::ublas::permutation_matrix< T , A > &m ,
                           const zr_boost_1_81::numeric::ublas::vector< T_V , A_V > &v )
    {
...
template< class T , class A , class T_V , class A_V >
struct resize_impl< zr_boost_1_81::numeric::ublas::vector< T_V , A_V > ,
                    zr_boost_1_81::numeric::ublas::permutation_matrix< T , A > >
{
    static void resize( const zr_boost_1_81::numeric::ublas::vector< T_V , A_V > &v,
                        zr_boost_1_81::numeric::ublas::permutation_matrix< T , A > &m )
    {
        m.resize( v.size() , v.size() );
    }
};
...
template< class T , class A >
struct state_wrapper< zr_boost_1_81::numeric::ublas::permutation_matrix< T , A > > // with resizing
{
    typedef zr_boost_1_81::numeric::ublas::permutation_matrix< T , A > state_type;
