...
namespace detail {
    ...
    struct resizer
    {
        ...
        template< class StateOut , class StateIn >
        void resize_op( StateOut &x1 , const StateIn &x2 , zr_boost_1_81::true_type ) const
        {
            resize( x1 , x2 );
        }

        template< class StateOut , class StateIn >
        void resize_op( StateOut &/*x1*/ , const StateIn &/*x2*/ , zr_boost_1_81::false_type ) const
        {
        }
...
struct resize_impl_sfinae< FusionSeq , FusionSeq ,
    typename zr_boost_1_81::enable_if< typename zr_boost_1_81::fusion::traits::is_sequence< FusionSeq >::type >::type >
{
    static void resize( FusionSeq &x1 , const FusionSeq &x2 )
    {
        typedef zr_boost_1_81::fusion::vector< FusionSeq& , const FusionSeq& > Sequences;
        Sequences sequences( x1 , x2 );
        zr_boost_1_81::fusion::for_each( zr_boost_1_81::fusion::zip_view< Sequences >( sequences ) , zr_boost_1_81::fusion::make_fused( detail::resizer() ) );
    }
};
