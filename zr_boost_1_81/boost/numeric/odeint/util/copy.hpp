...
namespace detail {
    ...
    void do_copying( const Container1 &from , Container2 &to , zr_boost_1_81::mpl::true_ )
    {
        zr_boost_1_81::range::copy( from , zr_boost_1_81::begin( to ) );
    }

    template< class Container1 , class Container2 >
    void do_copying( const Container1 &from , Container2 &to , zr_boost_1_81::mpl::false_ )
    {
        to = from;
    }
...
struct copy_impl_sfinae
{
    ...
    {
        typedef typename zr_boost_1_81::numeric::odeint::detail::is_range< Container1 >::type is_range_type;
