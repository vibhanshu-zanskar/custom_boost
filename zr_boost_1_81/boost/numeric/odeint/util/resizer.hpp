...
bool adjust_size_by_resizeability( ResizeWrappedState &x , const State &y , zr_boost_1_81::true_type )
{
...
template< class ResizeWrappedState , class State >
bool adjust_size_by_resizeability( ResizeWrappedState & /* x */ , const State & /* y */ , zr_boost_1_81::false_type )
{
    return false;
}
