...
namespace {
  template<class T>
    typename zr_boost_1_81::mpl::if_c<zr_boost_1_81::is_integral<T>::value,
                              double,
                              T>::type
...
template<typename T>
inline typename zr_boost_1_81::disable_if<
    zr_boost_1_81::is_unsigned<T>, T >::type
...
namespace zr_boost_1_81 { namespace numeric { namespace ublas {
    ...
    typename zr_boost_1_81::enable_if<
      mpl::and_<
        zr_boost_1_81::is_float<R>,
        zr_boost_1_81::is_integral<I>
        >,
    ...
    template<>
    struct type_traits<zr_boost_1_81::numeric::interval<float> > : scalar_traits<zr_boost_1_81::numeric::interval<float> > {
        typedef type_traits<zr_boost_1_81::numeric::interval<float> > self_type;
        typedef zr_boost_1_81::numeric::interval<float> value_type;
        typedef const value_type &const_reference;
        typedef value_type &reference;
        typedef value_type real_type;
        typedef zr_boost_1_81::numeric::interval<double> precision_type;

    };
    template<>
    struct type_traits<zr_boost_1_81::numeric::interval<double> > : scalar_traits<zr_boost_1_81::numeric::interval<double> > {
        typedef type_traits<zr_boost_1_81::numeric::interval<double> > self_type;
        typedef zr_boost_1_81::numeric::interval<double> value_type;
        typedef const value_type &const_reference;
        typedef value_type &reference;
        typedef value_type real_type;
        typedef zr_boost_1_81::numeric::interval<long double> precision_type;
    };
    template<>
    struct type_traits<zr_boost_1_81::numeric::interval<long double> > : scalar_traits<zr_boost_1_81::numeric::interval<long double> > {
        typedef type_traits<zr_boost_1_81::numeric::interval<long double> > self_type;
        typedef zr_boost_1_81::numeric::interval<long double> value_type;
        typedef const value_type &const_reference;
        typedef value_type &reference;
        typedef value_type real_type;
        typedef value_type precision_type;
    ...
    namespace detail {
        ...
        template<typename T>
        struct has_trivial_constructor : public zr_boost_1_81::has_trivial_constructor<T> {};

        template<typename T>
        struct has_trivial_destructor : public zr_boost_1_81::has_trivial_destructor<T> {};
