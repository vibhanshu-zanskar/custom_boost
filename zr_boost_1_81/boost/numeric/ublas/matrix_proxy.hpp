...
namespace zr_boost_1_81 { namespace numeric { namespace ublas {
    ...
    public:
        ...
        typedef typename zr_boost_1_81::mpl::if_<zr_boost_1_81::is_const<M>,
    ...
    public:
        ...
        public:
            ...
            BOOST_STATIC_ASSERT ((zr_boost_1_81::is_same<typename M::const_iterator1::iterator_category, typename M::const_iterator2::iterator_category>::value ));
     ...
     * - \c zr_boost_1_81::numeric::ublas::indirect_array<A> where \c A can be \c int, \c size_t, \c long, etc...
     * - \c zr_boost_1_81::numeric::ublas::matrix<int> can work too (\c int can be replaced by another integer type)
     * - etc...
     *
