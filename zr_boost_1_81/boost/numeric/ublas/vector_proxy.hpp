...
namespace zr_boost_1_81 { namespace numeric { namespace ublas {
    ...
    public:
        ...
        typedef typename zr_boost_1_81::mpl::if_<zr_boost_1_81::is_const<V>,
     ...
     * - \c zr_boost_1_81::numeric::ublas::vector<int> can work too (\c int can be replaced by another integer type)
     * - etc...
     *
