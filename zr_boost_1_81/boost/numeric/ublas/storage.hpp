...
#pragma warning(pop)
                  ...
                  for (pointer d = data_; d != data_ + size_; ++d)
                      zr_boost_1_81::allocator_construct(alloc_, d);
              }
          }
          else
              data_ = 0;
                    ...
                    if (preserve) {
                        ...
                        if (size < size_) {
                            for (; di != data_ + size; ++di) {
                                zr_boost_1_81::allocator_construct(alloc_, di, *si);
                                ++si;
                            }
                        }
                        else {
                            ...
                            for (; di != data_ + size; ++di) {
                                zr_boost_1_81::allocator_construct(alloc_, di, init);
                            }
                        }
                    }
                    else {
...
#pragma warning(pop)
                            ...
                            for (pointer di = data_; di != data_ + size; ++di)
                                zr_boost_1_81::allocator_construct(alloc_, di);
                        }
                    }
                }
...
#pragma warning(pop)
                        ...
                        for (pointer si = p_data; si != p_data + size_; ++si)
                            zr_boost_1_81::allocator_destroy(alloc_, si);
                    }
    ...
    public:
        ...
        size_type max_size () const {
            return zr_boost_1_81::allocator_max_size(alloc_);
        }
