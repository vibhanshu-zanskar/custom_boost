...
namespace zr_boost_1_81 { namespace numeric { namespace ublas { namespace opencl {

class storage;

namespace compute = zr_boost_1_81::compute;
...
{
  typedef typename zr_boost_1_81::compute::buffer_allocator<T>::size_type size_type;
