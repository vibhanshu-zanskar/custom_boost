...
namespace zr_boost_1_81 { namespace numeric { namespace ublas {
    ...
    public:
        ...
        typedef typename zr_boost_1_81::remove_cv<typename vector_view_traits<JA>::value_type>::type index_type;
    ...
    private:
        ...
        const_pointer find_element (index_type i, index_type j) const {
            ...
            const_subiterator_type it_start = zr_boost_1_81::next(vector_view_traits<index_array_type>::begin(index2_data_),itv);
            const_subiterator_type it_end = zr_boost_1_81::next(vector_view_traits<index_array_type>::begin(index2_data_),itv_next);
