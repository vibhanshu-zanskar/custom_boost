...
namespace zr_boost_1_81 { namespace numeric { 
	 ...
	 * \code namespace ublas = zr_boost_1_81::numeric::ublas; \endcode
	 *
	 * A common practice is to bring this namespace into the current scope with
	 * \code using namespace zr_boost_1_81::numeric::ublas; \endcode.
	 *
	 ...
	 * The solution is simply to prefix each ublas vector like \c zr_boost_1_81::numeric::ublas::vector<T>. If you think it's too long to 
	 * write, you can define a new namespace like \c namespace ublas = zr_boost_1_81::numeric::ublas and then just declare your vectors
