...
public:
  ...
  RET call(CALL_FORMAL_ARGS) const {
    for(detail::select(zr_boost_1_81::tuples::get<0>(args), CALL_ACTUAL_ARGS); 
      ...
      detail::select(zr_boost_1_81::tuples::get<3>(args), CALL_ACTUAL_ARGS);
  }
};
...
public:
  ...
  template<class RET, CALL_TEMPLATE_ARGS>
  RET call(CALL_FORMAL_ARGS) const {
    while(detail::select(zr_boost_1_81::tuples::get<0>(args), CALL_ACTUAL_ARGS))
...
public:
  ...
  template<class RET, CALL_TEMPLATE_ARGS>
  RET call(CALL_FORMAL_ARGS) const {
          do {} while (detail::select(zr_boost_1_81::tuples::get<0>(args), CALL_ACTUAL_ARGS) );
  }
};
