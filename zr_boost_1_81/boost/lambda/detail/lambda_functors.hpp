...
template<> struct placeholder<FIRST> {
  ...
  RET call(CALL_FORMAL_ARGS) const { 
    BOOST_STATIC_ASSERT(zr_boost_1_81::is_reference<RET>::value); 
...
public:
  ...
  // Support for zr_boost_1_81::result_of.
  ...
  const lambda_functor<lambda_functor_base<
                  ...
                  zr_boost_1_81::tuple<lambda_functor,
...
template<class T>
struct result_of<zr_boost_1_81::lambda::lambda_functor<T>()>
{
    typedef typename zr_boost_1_81::lambda::lambda_functor<T>::nullary_return_type type;
};

template<class T>
struct result_of<const zr_boost_1_81::lambda::lambda_functor<T>()>
{
    typedef typename zr_boost_1_81::lambda::lambda_functor<T>::nullary_return_type type;
};
...
template<class T>
struct tr1_result_of<zr_boost_1_81::lambda::lambda_functor<T>()>
{
    typedef typename zr_boost_1_81::lambda::lambda_functor<T>::nullary_return_type type;
};

template<class T>
struct tr1_result_of<const zr_boost_1_81::lambda::lambda_functor<T>()>
{
    typedef typename zr_boost_1_81::lambda::lambda_functor<T>::nullary_return_type type;
};
