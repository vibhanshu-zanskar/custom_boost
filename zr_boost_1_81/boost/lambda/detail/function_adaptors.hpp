...
struct remove_references_from_elements {
  typedef typename zr_boost_1_81::tuples::cons<
    typename zr_boost_1_81::remove_reference<typename Tuple::head_type>::type,
    typename remove_references_from_elements<typename Tuple::tail_type>::type
  > type;
};

template<>
struct remove_references_from_elements<zr_boost_1_81::tuples::null_type> {
...
template <class Func> struct function_adaptor {
  ...
  // Support functors that use the zr_boost_1_81::result_of return type convention.
...
struct function_adaptor<T Object::*> {
  ...
  template<class Args> class sig { 
    typedef typename zr_boost_1_81::tuples::element<1, Args>::type argument_type;
    typedef typename zr_boost_1_81::remove_reference<
      argument_type
    >::type unref_type;

    typedef typename detail::IF<zr_boost_1_81::is_const<unref_type>::value,
      typename zr_boost_1_81::add_const<T>::type,
      T
    >::RET properly_consted_return_type;

    typedef typename detail::IF<zr_boost_1_81::is_volatile<unref_type>::value,
      typename zr_boost_1_81::add_volatile<properly_consted_return_type>::type,
      properly_consted_return_type
    >::RET properly_cvd_return_type;


  public:
    typedef typename detail::IF<zr_boost_1_81::is_reference<argument_type>::value,
      typename zr_boost_1_81::add_reference<properly_cvd_return_type>::type,
