...
struct return_type_1<other_action<addressof_action>, A> { 
  ...
  typedef typename detail::IF<
    zr_boost_1_81::is_same<type1, detail::unspecified>::value, 
...
template <class A> struct contentsof_type {
  typedef typename zr_boost_1_81::indirect_reference<A>::type type; 
};
...
struct pointer_arithmetic_traits<plus_action, A, B> { 
  ...
  typedef typename 
    array_to_pointer<typename zr_boost_1_81::remove_reference<A>::type>::type AP;
  typedef typename 
    array_to_pointer<typename zr_boost_1_81::remove_reference<B>::type>::type BP;

  static const bool is_pointer_A = zr_boost_1_81::is_pointer<AP>::value;
  static const bool is_pointer_B = zr_boost_1_81::is_pointer<BP>::value;  
  ...
  static const bool same_pointer_type =
    ...
    zr_boost_1_81::is_same<
      typename zr_boost_1_81::remove_const<
        typename zr_boost_1_81::remove_pointer<
          typename zr_boost_1_81::remove_const<AP>::type
        >::type
      >::type,
      typename zr_boost_1_81::remove_const<
        typename zr_boost_1_81::remove_pointer<
          typename zr_boost_1_81::remove_const<BP>::type
        >::type
      >::type
    >::value;
...
struct return_type_2<bitwise_action<Act>, A, B>
{
  ...
  // the apply function
  BOOST_STATIC_ASSERT(!(zr_boost_1_81::is_float<plain_A>::value && zr_boost_1_81::is_float<plain_B>::value));
...
private:
  typedef typename zr_boost_1_81::remove_reference<A>::type plainA;
public:
...
struct return_type_2<arithmetic_assignment_action<Act>, A, B> { 
  ...
  typedef typename 
    detail::IF<
      zr_boost_1_81::is_same<type1, detail::unspecified>::value, 
      typename zr_boost_1_81::add_reference<A>::type,
      type1
    >::RET type;
};
...
struct return_type_2<other_action<subscript_action>, A, B> {
  ...
  typedef typename zr_boost_1_81::remove_reference<A>::type nonref_A;
  typedef typename zr_boost_1_81::remove_reference<B>::type nonref_B;
