...
namespace detail {
  ...
  class protect_conversion {
      typedef typename zr_boost_1_81::remove_reference<T>::type non_ref_T;
    public:

  // add const to rvalues, so that all rvalues are stored as const in 
  // the args tuple
    typedef typename detail::IF_type<
      zr_boost_1_81::is_reference<T>::value && !zr_boost_1_81::is_const<non_ref_T>::value,
...
// experimental feature
  ...
  typedef typename zr_boost_1_81::remove_reference<A>::type non_ref_A;
  typedef typename zr_boost_1_81::remove_reference<B>::type non_ref_B;
