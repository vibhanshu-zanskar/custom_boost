...
public:
    ...
    result_type operator()() {
        ...
        typedef typename zr_boost_1_81::random::traits::make_unsigned<result_type>::type base_unsigned;
        ...
        if(k == 1) {
            ...
            zr_boost_1_81::uintmax_t divisor =
                static_cast<zr_boost_1_81::uintmax_t>(brange) + 1;
