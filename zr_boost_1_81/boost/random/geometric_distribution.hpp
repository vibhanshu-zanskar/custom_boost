 ...
 * zr_boost_1_81::geometric_distribution.  A backwards compatible
 * wrapper is provided in namespace zr_boost_1_81.
 * @endxmlwarning
 */
...
public:
    ...
    result_type operator()(Engine& eng) const
    {
        using std::log;
        using std::floor;
        RealType x = RealType(1) - zr_boost_1_81::uniform_01<RealType>()(eng);
