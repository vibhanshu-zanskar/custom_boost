 ...
 * (to-be-invented) @c zr_boost_1_81::bigfloat class with random bits efficiently.
...
{
  typedef zr_boost_1_81::random::detail::ptr_helper<UniformRandomNumberGenerator> traits;
public:
