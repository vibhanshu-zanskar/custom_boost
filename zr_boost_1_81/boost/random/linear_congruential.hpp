...
public:
    ...
    void discard(zr_boost_1_81::uintmax_t z)
    {
        ...
        if(b_gcd == 1) {
            ...
            zr_boost_1_81::uintmax_t exponent = z;
            while(exponent != 0) {
                if(exponent % 2 == 1) {
                    a_zm1_over_gcd =
                        mod_type::mult_add(
...
{
public:
    typedef zr_boost_1_81::uint32_t result_type;
    ...
    /** Advances the state of the generator by @c z. */
    void discard(zr_boost_1_81::uintmax_t z) { lcf.discard(z); }
...
private:
    ...
    static zr_boost_1_81::uint64_t cnv(zr_boost_1_81::uint32_t x)
