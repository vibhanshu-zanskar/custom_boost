...
RealType generate_canonical_impl(URNG& g, zr_boost_1_81::true_type /*is_integral*/)
{
    using std::pow;
...
template<class RealType, std::size_t bits, class URNG>
RealType generate_canonical_impl(URNG& g, zr_boost_1_81::false_type /*is_integral*/)
{
    using std::pow;
    using std::floor;
...
RealType generate_canonical(URNG& g)
{
    RealType result = detail::generate_canonical_impl<RealType, bits>(
        g, zr_boost_1_81::random::traits::is_integral<typename URNG::result_type>());
