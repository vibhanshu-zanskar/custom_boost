...
public:
    ...
    public:
        ...
        explicit param_type(const Range& range)
          : _probabilities(zr_boost_1_81::begin(range), zr_boost_1_81::end(range))
        {
            normalize();
        }
    ...
    {
        init(zr_boost_1_81::begin(range), zr_boost_1_81::end(range));
    }
    /**
...
private:
    ...
    typedef typename detail::select_alias_table<
        (::zr_boost_1_81::is_integral<WeightType>::value)
