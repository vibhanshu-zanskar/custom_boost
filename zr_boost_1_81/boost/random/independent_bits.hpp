...
public:
    ...
    { return max_imp(zr_boost_1_81::is_integral<UIntType>()); }
    ...
    {
        for(zr_boost_1_81::uintmax_t i = 0; i < z; ++i) {
            (*this)();
        }
    }
...
private:
    ...
    /// \cond show_private
    typedef typename zr_boost_1_81::random::traits::make_unsigned<base_result_type>::type base_unsigned;

    static BOOST_CONSTEXPR UIntType max_imp(const zr_boost_1_81::true_type&)
    {
       return zr_boost_1_81::low_bits_mask_t<w>::sig_bits;
    }
    static UIntType max_imp(const zr_boost_1_81::false_type&)
    {
