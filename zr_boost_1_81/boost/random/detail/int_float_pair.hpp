...
inline typename zr_boost_1_81::make_unsigned<typename Engine::result_type>::type
generate_one_digit(Engine& eng, std::size_t bits)
{
    typedef typename Engine::result_type base_result;
    typedef typename zr_boost_1_81::make_unsigned<base_result>::type base_unsigned;
...
std::pair<RealType, int> generate_int_float_pair(Engine& eng, zr_boost_1_81::true_type)
{
    typedef typename Engine::result_type base_result;
    typedef typename zr_boost_1_81::make_unsigned<base_result>::type base_unsigned;
...
template<class RealType, std::size_t w, class Engine>
inline std::pair<RealType, int> generate_int_float_pair(Engine& eng, zr_boost_1_81::false_type)
{
...
inline std::pair<RealType, int> generate_int_float_pair(Engine& eng)
{
    ...
    return generate_int_float_pair<RealType, w>(eng,
        zr_boost_1_81::is_integral<base_result>());
}
