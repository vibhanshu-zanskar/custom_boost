...
public:
  ...
  static IntType pow(IntType a, zr_boost_1_81::uintmax_t exponent)
  {
      IntType result = 1;
      while(exponent != 0) {
          if(exponent % 2 == 1) {
...
private:
  ...
  static IntType mult_general(IntType a, IntType b)
  {
    ...
    if(::zr_boost_1_81::uintmax_t(modulus) <=
        (::std::numeric_limits< ::zr_boost_1_81::uintmax_t>::max)() / modulus)
    {
      return static_cast<IntType>(zr_boost_1_81::uintmax_t(a) * b % modulus);
    } else {
