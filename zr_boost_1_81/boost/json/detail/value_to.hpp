    ...
    bool_conversion_tag)
{
    ...
    return {zr_boost_1_81::system::in_place_error, ec};
}
    ...
    number_conversion_tag)
{
    ...
    if( ec.failed() )
        return {zr_boost_1_81::system::in_place_error, ec};
    return {zr_boost_1_81::system::in_place_value, n};
}
...
{
    if( jv.is_null() )
        return {zr_boost_1_81::system::in_place_value, T{}};
    error_code ec;
    ...
    string_like_conversion_tag)
{
    ...
    if( str )
        return {zr_boost_1_81::system::in_place_value, T(str->subview())};
    error_code ec;
    BOOST_JSON_FAIL(ec, error::not_string);
    return {zr_boost_1_81::system::in_place_error, ec};
}
    ...
    map_like_conversion_tag)
{
    ...
    for( key_value_pair const& kv: *obj )
    {
        ...
        if( elem_res.has_error() )
            return {zr_boost_1_81::system::in_place_error, elem_res.error()};
        *ins++ = value_type<T>{
            key_type<T>(kv.key()),
            std::move(*elem_res)};
    }
...
result<T>
try_make_tuple_like(array const& arr, zr_boost_1_81::mp11::index_sequence<Is...>)
{
    error_code ec;
    ...
    return {
        zr_boost_1_81::system::in_place_value, T(std::move(*std::get<Is>(items))...)};
}

template <class T, std::size_t... Is>
T
make_tuple_like(array const& arr, zr_boost_1_81::mp11::index_sequence<Is...>)
{
    ...
    tuple_conversion_tag)
{
    ...
    return try_make_tuple_like<T>(
        *arr, zr_boost_1_81::mp11::make_index_sequence<N>());
}
...
struct to_described_member
{
    ...
    operator()(I) const
    {
        ...
        if( found == obj.end() )
        {
            ...
            res = {zr_boost_1_81::system::in_place_error, ec};
            return;
        }
        ...
        if( member_res )
            ...
            res = {zr_boost_1_81::system::in_place_error, member_res.error()};
    }
};
    ...
    user_conversion_tag)
{
    ...
    {
        return {
            zr_boost_1_81::system::in_place_value, tag_invoke(value_to_tag<T>(), jv)};
    }
    ...
    {
        return {zr_boost_1_81::system::in_place_error, e.code()};
    }
    catch( ... )
    {
        error_code ec;
