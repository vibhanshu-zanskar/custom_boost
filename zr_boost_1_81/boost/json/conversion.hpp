...
/** Determine if `T` should be treated as a described class
    ...
    @li <tt>zr_boost_1_81::describe::has_members<T, zr_boost_1_81::describe::mod_public>::value</tt> is `true`; and

    @li `zr_boost_1_81::describe::describe_members<T, zr_boost_1_81::describe::mod_private | zr_boost_1_81::describe::mod_protected>` denotes `L<>`; and

    @li `zr_boost_1_81::describe::describe_bases<T, zr_boost_1_81::describe::mod_any_access>` denotes `L<>`; and
...
/** Determine if `T` should be treated as a described enum
    ...
    If <tt>zr_boost_1_81::describe::has_describe_enumerators<T>::value</tt> is `true`,
    then the trait provides the member constant `value`
    that is equal to `true`. Otherwise, `value` is equal to `false`.<br>
