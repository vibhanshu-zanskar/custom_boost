...
*/
template< class T >
using result = zr_boost_1_81::system::result<T>;
...
/**
   ...
   namespace mine
   {
       ...
       zr_boost_1_81::json::result_for<my_class, JsonValue>
       tag_invoke(zr_boost_1_81::json::try_value_to_tag<my_class>, const JsonValue& jv)
       { ... }
   }
   @endcode
...
/** Create @ref result storing a portable error code
    ...
    `zr_boost_1_81::system::generic_category()`. <br>
    ...
    tag_invoke(zr_boost_1_81::json::try_value_to_tag<my_class>, const JsonValue& jv)
    {
        ...
        if( !jv.is_null() )
            return zr_boost_1_81::json::result_from_errno<my_class>(EINVAL, &loc);
        return my_class();
    }
    ...
    to `zr_boost_1_81::system::generic_category()`.
