...
/** The type of memory resource used by the library.
    ...
    Alias for `zr_boost_1_81::container::pmr::memory_resource`.
*/
...
/** The type of polymorphic allocator used by the library.
    ...
    Alias template for `zr_boost_1_81::container::pmr::polymorphic_allocator`.
*/
template<class T>
...
#else
using memory_resource = zr_boost_1_81::container::pmr::memory_resource;

template<class T>
using polymorphic_allocator =
    zr_boost_1_81::container::pmr::polymorphic_allocator<T>;
#endif
