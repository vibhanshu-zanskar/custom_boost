...
*/
template<>
struct tuple_size< ::zr_boost_1_81::json::key_value_pair >
...
*/
template<>
struct tuple_element<0, ::zr_boost_1_81::json::key_value_pair>
{
    using type = ::zr_boost_1_81::json::string_view const;
};

/** Tuple-like access for the value type of key_value_pair
*/
template<>
struct tuple_element<1, ::zr_boost_1_81::json::key_value_pair>
{
    using type = ::zr_boost_1_81::json::value&;
};

/** Tuple-like access for the value type of key_value_pair
*/
template<>
struct tuple_element<1, ::zr_boost_1_81::json::key_value_pair const>
{
    using type = ::zr_boost_1_81::json::value const&;
};
...
namespace std {
template <>
struct hash< ::zr_boost_1_81::json::value > {
    BOOST_JSON_DECL
    std::size_t
    operator()(::zr_boost_1_81::json::value const& jv) const noexcept;
};
} // std
#endif
