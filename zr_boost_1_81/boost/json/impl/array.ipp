...
std::size_t
std::hash<::zr_boost_1_81::json::array>::operator()(
    ::zr_boost_1_81::json::array const& ja) const noexcept
{
  std::size_t seed = ja.size();
  for (const auto& jv : ja) {
    seed = ::zr_boost_1_81::json::detail::hash_combine(
        seed,
        std::hash<::zr_boost_1_81::json::value>{}(jv));
  }
  return seed;
}
