...
std::size_t
std::hash<::zr_boost_1_81::json::value>::operator()(
    ::zr_boost_1_81::json::value const& jv) const noexcept
{
  std::size_t seed = static_cast<std::size_t>(jv.kind());
  switch (jv.kind()) {
    default:
    case ::zr_boost_1_81::json::kind::null:
      return seed;
    case ::zr_boost_1_81::json::kind::bool_:
      return ::zr_boost_1_81::json::detail::hash_combine(
        seed,
        hash<bool>{}(jv.get_bool()));
    case ::zr_boost_1_81::json::kind::int64:
      return ::zr_boost_1_81::json::detail::hash_combine(
        static_cast<size_t>(::zr_boost_1_81::json::kind::uint64),
        hash<std::uint64_t>{}(jv.get_int64()));
    case ::zr_boost_1_81::json::kind::uint64:
      return ::zr_boost_1_81::json::detail::hash_combine(
        seed,
        hash<std::uint64_t>{}(jv.get_uint64()));
    case ::zr_boost_1_81::json::kind::double_:
      return ::zr_boost_1_81::json::detail::hash_combine(
        seed,
        hash<double>{}(jv.get_double()));
    case ::zr_boost_1_81::json::kind::string:
      return ::zr_boost_1_81::json::detail::hash_combine(
        seed,
        hash<::zr_boost_1_81::json::string>{}(jv.get_string()));
    case ::zr_boost_1_81::json::kind::array:
      return ::zr_boost_1_81::json::detail::hash_combine(
        seed,
        hash<::zr_boost_1_81::json::array>{}(jv.get_array()));
    case ::zr_boost_1_81::json::kind::object:
      return ::zr_boost_1_81::json::detail::hash_combine(
        seed,
        hash<::zr_boost_1_81::json::object>{}(jv.get_object()));
  }
}
