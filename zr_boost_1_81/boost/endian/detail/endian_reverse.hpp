...
template<class T> struct is_endian_reversible: zr_boost_1_81::integral_constant<bool,
    (zr_boost_1_81::is_integral<T>::value && !zr_boost_1_81::is_same<T, bool>::value) || is_scoped_enum<T>::value>
{
};

// is_endian_reversible_inplace

template<class T> struct is_endian_reversible_inplace: zr_boost_1_81::integral_constant<bool,
    zr_boost_1_81::is_integral<T>::value || zr_boost_1_81::is_enum<T>::value || zr_boost_1_81::is_same<T, float>::value || zr_boost_1_81::is_same<T, double>::value>
{
};
