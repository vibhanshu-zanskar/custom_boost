...
template<>
struct is_error_code_enum< zr_boost_1_81::fibers::future_errc > : public true_type {
};

inline
std::error_code make_error_code( zr_boost_1_81::fibers::future_errc e) noexcept {
    return std::error_code{ static_cast< int >( e), zr_boost_1_81::fibers::future_category() };
}

inline
std::error_condition make_error_condition( zr_boost_1_81::fibers::future_errc e) noexcept {
    return std::error_condition{ static_cast< int >( e), zr_boost_1_81::fibers::future_category() };
}
