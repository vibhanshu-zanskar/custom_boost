...
struct static_warning_test{
    typename zr_boost_1_81::mpl::eval_if_c<
        B,
        zr_boost_1_81::mpl::true_,
        typename zr_boost_1_81::mpl::identity<
            zr_boost_1_81::mpl::print<
...
#define BOOST_SERIALIZATION_BSW(B, L) \
    typedef zr_boost_1_81::serialization::BOOST_SERIALIZATION_SS< \
        sizeof( zr_boost_1_81::serialization::static_warning_test< B, L > ) \
