...
/**/
    ...
    BOOST_SERIALIZATION_COLLECTION_TRAITS_HELPER(zr_boost_1_81::long_long_type, C)  \
    BOOST_SERIALIZATION_COLLECTION_TRAITS_HELPER(zr_boost_1_81::ulong_long_type, C) \
    /**/
#else
    #define BOOST_SERIALIZATION_COLLECTION_TRAITS_HELPER_INT64(C)
#endif
