...
collection_load_impl(
    ...
    t.clear();
    zr_boost_1_81::serialization::detail::stack_construct<Archive, T> u(ar, item_version);
    ar >> zr_boost_1_81::serialization::make_nvp("item", u.reference());
    t.push_front(zr_boost_1_81::move(u.reference()));
    ...
    while(--count > 0){
        ...
        ar >> zr_boost_1_81::serialization::make_nvp("item", u.reference());
        last = t.insert_after(last, zr_boost_1_81::move(u.reference()));
...
inline void load(
    ...
    const zr_boost_1_81::serialization::library_version_type library_version(
    ...
    if(detail::is_default_constructible<U>()){
        ...
        hint = t.begin();
        while(count-- > 0){
            ar >> zr_boost_1_81::serialization::make_nvp("item", *hint++);
        }
    }
    else{
        t.clear();
        zr_boost_1_81::serialization::detail::stack_construct<Archive, U> u(ar, item_version);
        ar >> zr_boost_1_81::serialization::make_nvp("item", u.reference());
        t.push_front(zr_boost_1_81::move(u.reference()));
