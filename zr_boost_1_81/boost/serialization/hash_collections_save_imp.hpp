...
inline void save_hash_collection(Archive & ar, const Container &s)
{
    ...
    if(zr_boost_1_81::serialization::library_version_type(6) != library_version){
    ...
    while(count-- > 0){
        ...
        zr_boost_1_81::serialization::save_construct_data_adl(
            ar,
            &(*it),
            zr_boost_1_81::serialization::version<
                typename Container::value_type
            >::value
        );
        ar << zr_boost_1_81::serialization::make_nvp("item", *it++);
    }
}
