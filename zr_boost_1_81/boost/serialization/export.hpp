...
struct guid_initializer
{
    ...
    guid_initializer const & export_guid() const {
        ...
        //BOOST_STATIC_WARNING(! zr_boost_1_81::serialization::is_abstract< T >::value);
        export_guid(zr_boost_1_81::serialization::is_abstract< T >());
        return *this;
    }
};
...
template<>                                     \
struct guid_defined< T > : zr_boost_1_81::mpl::true_ {}; \
template<>                                     \
...
namespace {                                                                    \
  ...
  (::zr_boost_1_81::archive::detail::instantiate_ptr_serialization((Derived*)0,0), 3); \
  static int BOOST_PP_CAT(boost_serialization_mwerks_init2_, __LINE__) = (     \
      ::zr_boost_1_81::serialization::void_cast_register((Derived*)0,(Base*)0)         \
    , 3);                                                                      \
}
...
#define BOOST_CLASS_EXPORT_CHECK(T)                              \
    BOOST_STATIC_WARNING(                                        \
        zr_boost_1_81::is_polymorphic<U>::value                          \
    );                                                           \
    /**/
