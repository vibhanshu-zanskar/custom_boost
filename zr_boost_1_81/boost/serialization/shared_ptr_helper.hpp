...
public:
    ...
    friend void zr_boost_1_81::serialization::load(
        Archive & ar,
        SPT< U > &t,
        const unsigned int file_version
    );
    ...
    std::list<zr_boost_1_81_132::shared_ptr<const void> > * m_pointers_132;
    void
    append(const zr_boost_1_81_132::shared_ptr<const void> & t){
        if(NULL == m_pointers_132)
            m_pointers_132 = new std::list<zr_boost_1_81_132::shared_ptr<const void> >;
    ...
    struct non_polymorphic {
        template<class U>
        static const zr_boost_1_81::serialization::extended_type_info *
        get_object_type(U & ){
            return & zr_boost_1_81::serialization::singleton<
                typename
                zr_boost_1_81::serialization::type_info_implementation< U >::type
            >::get_const_instance();
        }
    };
    struct polymorphic {
...
public:
    ...
    void reset(SPT< T > & s, T * t){
        ...
        const zr_boost_1_81::serialization::extended_type_info * this_type
        ...
        if(NULL == true_type)
            zr_boost_1_81::serialization::throw_exception(
                zr_boost_1_81::archive::archive_exception(
                    zr_boost_1_81::archive::archive_exception::unregistered_class,
        ...
        if(NULL == oid)
            zr_boost_1_81::serialization::throw_exception(
                zr_boost_1_81::archive::archive_exception(
                    zr_boost_1_81::archive::archive_exception::unregistered_cast,
