...
struct archive_input_hash_map
{
    inline void operator()(
        ...
        ar >> zr_boost_1_81::serialization::make_nvp("item", t.reference());
        std::pair<typename Container::const_iterator, bool> result =
            s.insert(zr_boost_1_81::move(t.reference()));
...
inline void save(
    ...
    zr_boost_1_81::serialization::stl::save_hash_collection<
        Archive,
...
inline void load(
    ...
    zr_boost_1_81::serialization::stl::load_hash_collection<
        Archive,
        BOOST_STD_EXTENSION_NAMESPACE::hash_map<
            Key, T, HashFcn, EqualKey, Allocator
        >,
        zr_boost_1_81::serialization::stl::archive_input_hash_map<
            Archive,
            BOOST_STD_EXTENSION_NAMESPACE::hash_map<
                Key, T, HashFcn, EqualKey, Allocator
            >
...
inline void load(
    ...
    zr_boost_1_81::serialization::stl::load_hash_collection<
        ...
        BOOST_STD_EXTENSION_NAMESPACE::hash_multimap<
            Key, T, HashFcn, EqualKey, Allocator
        >,
        zr_boost_1_81::serialization::stl::archive_input_hash_multimap<
            Archive,
            BOOST_STD_EXTENSION_NAMESPACE::hash_multimap<
                Key, T, HashFcn, EqualKey, Allocator
            >
