...
#define BOOST_SERIALIZATION_NVP(name)                       \
    zr_boost_1_81::serialization::make_nvp(BOOST_PP_STRINGIZE(name), name)
/**/

#define BOOST_SERIALIZATION_BASE_OBJECT_NVP(name)           \
    zr_boost_1_81::serialization::make_nvp(                         \
        BOOST_PP_STRINGIZE(name),                           \
        zr_boost_1_81::serialization::base_object<name >(*this)     \
    )
/**/
