...
private:
    ...
    friend const zr_boost_1_81::serialization::array_wrapper<Tx> make_array(Tx * t, S s);
public:
...
public:
    ...
    void serialize_optimized(Archive &ar, const unsigned int, mpl::false_ ) const
    {
      ...
      T * t = address();
      while(0 < c--)
            ar & zr_boost_1_81::serialization::make_nvp("item", *t++);
    }
    ...
    {
      zr_boost_1_81::serialization::split_member(ar, *this, version);
    }
