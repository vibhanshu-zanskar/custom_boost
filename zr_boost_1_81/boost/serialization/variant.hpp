...
void save(
    Archive & ar,
    zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const & v,
    ...
    struct load_impl {
        ...
        static void invoke(
            ...
            if(which == 0){
                ...
                v = value;
                head_type * new_address = & zr_boost_1_81::get<head_type>(v);
...
void load(
    Archive & ar,
    zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)>& v,
    const unsigned int version
){
    int which;
    typedef typename zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)>::types types;
    ar >> BOOST_SERIALIZATION_NVP(which);
...
>{
    ...
    typedef mpl::int_< ::zr_boost_1_81::serialization::track_always> type;
