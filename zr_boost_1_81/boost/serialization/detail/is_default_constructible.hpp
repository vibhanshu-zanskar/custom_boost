...
#include <boost/config.hpp>
    ...
    // so we fake it by using zr_boost_1_81::has_trivial_construtor.  But this is not
    ...
    template<typename T>
    struct is_default_constructible : public zr_boost_1_81::has_trivial_constructor<T> {};
