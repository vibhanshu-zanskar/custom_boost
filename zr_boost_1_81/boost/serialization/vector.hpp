...
inline void save(
    ...
    zr_boost_1_81::serialization::stl::save_collection<Archive, STD::vector<U, Allocator> >(
        ar, t
    );
}
...
inline void save(
    ...
    typedef typename
    zr_boost_1_81::serialization::use_array_optimization<Archive>::template apply<
...
inline void load(
    ...
    if (ar.get_library_version()==zr_boost_1_81::serialization::library_version_type(5))
    {
      load(ar,t,file_version, zr_boost_1_81::is_arithmetic<U>());
      return;
    }
#endif
    typedef typename
...
inline void save(
    ...
    while(count-- > 0){
        bool tb = *it++;
        ar << zr_boost_1_81::serialization::make_nvp("item", tb);
    }
}
...
inline void load(
    ...
    for(collection_size_type i = collection_size_type(0); i < count; ++i){
        bool b;
        ar >> zr_boost_1_81::serialization::make_nvp("item", b);
        t[i] = b;
    }
}
