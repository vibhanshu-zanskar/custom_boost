    ...
    private zr_boost_1_81::noncopyable
{
    ...
    friend
    BOOST_SERIALIZATION_DECL void const *
    zr_boost_1_81::serialization::void_downcast(
        extended_type_info const & derived,
        extended_type_info const & base,
        void const * const
    );
    ...
    public void_caster
{
    void const * downcast(void const * const t) const BOOST_OVERRIDE {
        const Derived * d =
            zr_boost_1_81::serialization::smart_cast<const Derived *, const Base *>(
    ...
    void const * upcast(void const * const t) const BOOST_OVERRIDE {
        const Base * b =
            zr_boost_1_81::serialization::smart_cast<const Base *, const Derived *>(
...
private:
    static std::ptrdiff_t base_offset() {
        typename zr_boost_1_81::aligned_storage<sizeof(Derived)>::type data;
...
{
    typedef
        typename mpl::eval_if<zr_boost_1_81::is_virtual_base_of<Base,Derived>,
            mpl::identity<
