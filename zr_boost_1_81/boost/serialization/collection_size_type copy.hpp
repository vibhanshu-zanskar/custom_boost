...
struct cardinal_number : private
    zr_boost_1_81::totally_ordered<cardinal_number<T> >,
    zr_boost_1_81::additive<cardinal_number<T> >,
    zr_boost_1_81::unit_steppable<cardinal_number<T> >
{
private:
...
basic_ostream<CharType, Traits> & operator<<(
    ...
    const zr_boost_1_81::serialization::collection_size_type & rhs
){
    bos << rhs.m_t;
    return bos;
}
...
basic_istream<CharType, Traits> & operator>>(
    std::basic_istream<CharType, Traits> & bis,
    zr_boost_1_81::serialization::collection_size_type & rhs
){
    bis >> rhs.m_t;
    return bis;
}
...
BOOST_IS_BITWISE_SERIALIZABLE(zr_boost_1_81::serialization::collection_size_type)
