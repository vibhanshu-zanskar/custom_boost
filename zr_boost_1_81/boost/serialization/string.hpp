...
BOOST_CLASS_IMPLEMENTATION(std::string, zr_boost_1_81::serialization::primitive_type)
#ifndef BOOST_NO_STD_WSTRING
BOOST_CLASS_IMPLEMENTATION(std::wstring, zr_boost_1_81::serialization::primitive_type)
#endif
