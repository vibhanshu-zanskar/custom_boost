...
namespace smart_cast_impl {
    ...
    struct reference {
        ...
        static T cast(U & u){
            typedef typename mpl::eval_if<
                zr_boost_1_81::is_polymorphic<U>,
...
T smart_cast(U u) {
    typedef
        typename mpl::eval_if<
            typename mpl::or_<
                zr_boost_1_81::is_same<void *, U>,
                zr_boost_1_81::is_same<void *, T>,
                zr_boost_1_81::is_same<const void *, U>,
                zr_boost_1_81::is_same<const void *, T>
            >,
            mpl::identity<smart_cast_impl::void_pointer< T > >,
        // else
        typename mpl::eval_if<zr_boost_1_81::is_pointer<U>,
            mpl::identity<smart_cast_impl::pointer< T > >,
        // else
        typename mpl::eval_if<zr_boost_1_81::is_reference<U>,
