...
BOOST_NORETURN inline void throw_bad_variant_access()
{
    ...
    zr_boost_1_81::throw_exception( bad_variant_access() );
...
{
    zr_boost_1_81::ulong_long_type hv = ( zr_boost_1_81::ulong_long_type( 0xCBF29CE4 ) << 32 ) + 0x84222325;
    zr_boost_1_81::ulong_long_type const prime = ( zr_boost_1_81::ulong_long_type( 0x00000100 ) << 32 ) + 0x000001B3;
...
{
    return mp11::mp_with_index<sizeof...(T)>( v.index(), detail::hash_value_L< zr_boost_1_81::hash, variant<T...> >{ v } );
}
...
template<class... T> struct hash< ::zr_boost_1_81::variant2::variant<T...> >: public ::zr_boost_1_81::variant2::detail::std_hash_impl< ::zr_boost_1_81::variant2::variant<T...> >
{
};

template<> struct hash< ::zr_boost_1_81::variant2::monostate >
{
    std::size_t operator()( ::zr_boost_1_81::variant2::monostate const & v ) const
    {
        return hash_value( v );
    }
};
...
template<class T>
typename result_for<T, value>::type
result_from_errno( int e, zr_boost_1_81::source_location const* loc ) noexcept;
...
template<class... T>
    void tag_invoke( zr_boost_1_81::json::value_from_tag const&, zr_boost_1_81::json::value& v, variant<T...> const & w )
{
...
{
    zr_boost_1_81::json::value const& v;
    typename zr_boost_1_81::json::result_for<V, zr_boost_1_81::json::value>::type& r;
    ...
    template<class I> void operator()( I i ) const
    {
        if( !r )
        {
            ...
            auto r2 = zr_boost_1_81::json::try_value_to<Ti>( v );
...
template<class... T>
    typename zr_boost_1_81::json::result_for<variant<T...>, zr_boost_1_81::json::value>::type
    tag_invoke( zr_boost_1_81::json::try_value_to_tag<variant<T...>> const&, zr_boost_1_81::json::value const& v )
{
    static constexpr zr_boost_1_81::source_location loc = BOOST_CURRENT_LOCATION;
    auto r = zr_boost_1_81::json::result_from_errno< variant<T...> >( EINVAL, &loc );
