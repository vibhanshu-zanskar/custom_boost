...
private:
    ...
    using type_index = zr_boost_1_81::typeindex::type_index;
    std::unordered_set<type_index, zr_boost_1_81::hash<type_index>> classes_;
#endif
    ...
    bool manual)
{
...

    {
        auto const result(classes_.insert(
            zr_boost_1_81::typeindex::type_id<Suite>()));
