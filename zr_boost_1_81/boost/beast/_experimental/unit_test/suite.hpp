...
#ifndef BEAST_PASS
#define BEAST_PASS() ::zr_boost_1_81::beast::unit_test::suite::this_suite()->pass()
#endif

#ifndef BEAST_FAIL
#define BEAST_FAIL() ::zr_boost_1_81::beast::unit_test::suite::this_suite()->fail("", __FILE__, __LINE__)
#endif
...
*/
#define BEAST_EXPECT(cond) ::zr_boost_1_81::beast::unit_test::suite::this_suite()->expect(cond, __FILE__, __LINE__)
#endif
...
#define BEAST_EXPECTS(cond, reason) ((cond) ? \
    (::zr_boost_1_81::beast::unit_test::suite::this_suite()->pass(), true) : \
    (::zr_boost_1_81::beast::unit_test::suite::this_suite()->fail((reason), __FILE__, __LINE__), false))
#endif
...
#define BEAST_DEFINE_TESTSUITE_INSERT(Library,Module,Class,manual) \
    static ::zr_boost_1_81::beast::unit_test::detail::insert_suite <Class##_test>   \
