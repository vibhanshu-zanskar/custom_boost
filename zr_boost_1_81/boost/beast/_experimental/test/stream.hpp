...
/** A two-way socket useful for unit testing
    ...
    @ref zr_boost_1_81::beast::http::async_write for example.
...
private:
    ...
    zr_boost_1_81::shared_ptr<detail::stream_state> in_;
    zr_boost_1_81::weak_ptr<detail::stream_state> out_;
    ...
    void
    initiate_read(
        zr_boost_1_81::shared_ptr<detail::stream_state> const& in,
