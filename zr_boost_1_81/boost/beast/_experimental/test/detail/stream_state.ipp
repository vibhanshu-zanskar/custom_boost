...
stream_service(net::execution_context& ctx)
    ...
    , sp_(zr_boost_1_81::make_shared<stream_service_impl>())
{
}
...
make_impl(
    ...
    test::fail_count* fc) ->
    zr_boost_1_81::shared_ptr<detail::stream_state>
{
    ...
    auto sp = zr_boost_1_81::make_shared<detail::stream_state>(exec, svc.sp_, fc);
...
stream_state(
    ...
    zr_boost_1_81::weak_ptr<stream_service_impl> wp_,
    fail_count* fc_)
    : exec(std::move(exec_))
    , wp(std::move(wp_))
    , fc(fc_)
