...
// This include is necessary to work with `ssl::stream` and `zr_boost_1_81::beast::websocket::stream`
    ...
    : public net::ssl::stream_base
{
    ...
    using stream_type = zr_boost_1_81::beast::flat_stream<ssl_stream_type>;
...
public:
    ...
    */
    ...
    /** Get the underlying implementation in the native type.
        ...
        @code
        zr_boost_1_81::beast::ssl_stream<net::ip::tcp::socket> ss{ioc, ctx};
    ...
    */
    ...
    BOOST_ASIO_INITFN_RESULT_TYPE(HandshakeHandler, void(zr_boost_1_81::system::error_code))
    ...
    */
    ...
    BOOST_ASIO_INITFN_RESULT_TYPE(BufferedHandshakeHandler, void(zr_boost_1_81::system::error_code, std::size_t))
    ...
    */
    void
    shutdown(zr_boost_1_81::system::error_code& ec)
    {
    ...
    */
    ...
    BOOST_ASIO_INITFN_RESULT_TYPE(ShutdownHandler, void(zr_boost_1_81::system::error_code))
    ...
    */
    ...
    BOOST_ASIO_INITFN_RESULT_TYPE(WriteHandler, void(zr_boost_1_81::system::error_code, std::size_t))
    ...
    */
    ...
    BOOST_ASIO_INITFN_RESULT_TYPE(ReadHandler, void(zr_boost_1_81::system::error_code, std::size_t))
    ...
    // These hooks are used to inform zr_boost_1_81::beast::websocket::stream on
    ...
    void
    teardown(
        zr_boost_1_81::beast::role_type role,
    ...
    zr_boost_1_81::system::error_code& ec)
{
    ...
    using zr_boost_1_81::beast::websocket::teardown;
...
{
    // Just forward it to the underlying ssl::stream
    using zr_boost_1_81::beast::websocket::async_teardown;
