...
template<class T>
struct has_get_executor<T, zr_boost_1_81::void_t<decltype(
...
template<class T>
struct is_sync_read_stream<T, zr_boost_1_81::void_t<decltype(
    std::declval<std::size_t&>() = std::declval<T&>().read_some(
        std::declval<detail::MutableBufferSequence>()),
    std::declval<std::size_t&>() = std::declval<T&>().read_some(
        std::declval<detail::MutableBufferSequence>(),
        std::declval<zr_boost_1_81::system::error_code&>())
            )>> : std::true_type {};
#endif
...
template<class T>
struct is_sync_write_stream<T, zr_boost_1_81::void_t<decltype(
    (
...
template<class T>
struct is_async_read_stream<T, zr_boost_1_81::void_t<decltype(
...
template<class T>
struct is_async_write_stream<T, zr_boost_1_81::void_t<decltype(
