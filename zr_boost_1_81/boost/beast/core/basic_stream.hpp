...
private:
    ...
    struct impl_type
        : zr_boost_1_81::enable_shared_from_this<impl_type>
        , zr_boost_1_81::empty_value<RatePolicy>
    {
        ...
        policy() noexcept
        {
            return this->zr_boost_1_81::empty_value<RatePolicy>::get();
        }
...
#if ! BOOST_BEAST_DOXYGEN
    // zr_boost_1_81::asio::ssl::stream needs these
    // DEPRECATED
    template<class>
    friend class zr_boost_1_81::asio::ssl::stream;
    // DEPRECATED
