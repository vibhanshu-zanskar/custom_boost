...
class bind_wrapper
{
    ...
    typename std::enable_if<
        ...
        zr_boost_1_81::is_placeholder<typename
            std::decay<Arg>::type>::value == 0,
        Arg&&>::type
    extract(Arg&& arg, Vals&& vals)
    {
        zr_boost_1_81::ignore_unused(vals);
    ...
    typename std::enable_if<
        zr_boost_1_81::is_placeholder<typename
            std::decay<Arg>::type>::value != 0,
        tuple_element<zr_boost_1_81::is_placeholder<
            typename std::decay<Arg>::type>::value - 1,
        Vals>>::type&&
    extract(Arg&&, Vals&& vals)
    {
        return detail::get<zr_boost_1_81::is_placeholder<
            typename std::decay<Arg>::type>::value - 1>(
                std::forward<Vals>(vals));
    }
    ...
    {
        zr_boost_1_81::ignore_unused(args);
...
public:
    ...
    friend
    zr_boost_1_81::asio::asio_handler_invoke_is_deprecated
    asio_handler_invoke(
        Function&& f, bind_wrapper* op)
    {
        using zr_boost_1_81::asio::asio_handler_invoke;
    ...
    bool asio_handler_is_continuation(
        bind_wrapper* op)
    {
        using zr_boost_1_81::asio::asio_handler_is_continuation;
        return asio_handler_is_continuation(
                std::addressof(op->h_));
    }

    friend
    zr_boost_1_81::asio::asio_handler_allocate_is_deprecated
    ...
    friend
    zr_boost_1_81::asio::asio_handler_deallocate_is_deprecated
...
template<class Handler, class... Args>
void
bind(zr_boost_1_81::beast::detail::bind_wrapper<
    Handler, Args...>, ...) = delete;

template<class Handler, class... Args>
void
bind(zr_boost_1_81::beast::detail::bind_front_wrapper<
    Handler, Args...>, ...) = delete;
