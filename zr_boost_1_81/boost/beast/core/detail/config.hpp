...
namespace beast {
namespace net = zr_boost_1_81::asio;
} // beast
} // boost
...
#define BOOST_BEAST_ASYNC_RESULT1(type) \
    BOOST_ASIO_INITFN_AUTO_RESULT_TYPE(type, void(::zr_boost_1_81::beast::error_code))
#endif

#ifndef BOOST_BEAST_ASYNC_RESULT2
#define BOOST_BEAST_ASYNC_RESULT2(type) \
    BOOST_ASIO_INITFN_AUTO_RESULT_TYPE(type, void(::zr_boost_1_81::beast::error_code, ::std::size_t))
#endif

#ifndef BOOST_BEAST_ASYNC_TPARAM1
#define BOOST_BEAST_ASYNC_TPARAM1 BOOST_ASIO_COMPLETION_TOKEN_FOR(void(::zr_boost_1_81::beast::error_code))
#endif

#ifndef BOOST_BEAST_ASYNC_TPARAM2
#define BOOST_BEAST_ASYNC_TPARAM2 BOOST_ASIO_COMPLETION_TOKEN_FOR(void(::zr_boost_1_81::beast::error_code, ::std::size_t))
#endif
