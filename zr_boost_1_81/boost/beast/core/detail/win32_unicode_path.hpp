...
{
    using WCHAR_ = zr_boost_1_81::winapi::WCHAR_;
...
private:
    ...
    {
        return zr_boost_1_81::winapi::MultiByteToWideChar(
            zr_boost_1_81::winapi::CP_UTF8_,
            zr_boost_1_81::winapi::MB_ERR_INVALID_CHARS_,
            utf8_path, -1,
            buf, static_cast<int>(sz));
    }

    std::array<WCHAR_, zr_boost_1_81::winapi::MAX_PATH_> static_buf_;
