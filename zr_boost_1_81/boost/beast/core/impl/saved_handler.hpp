...
class saved_handler::impl final : public base
{
    ...
    struct ebo_pair : zr_boost_1_81::empty_value<alloc_type>
    {
        Handler h;
        ...
        ebo_pair(
            alloc_type const& a,
            Handler_&& h_)
            : zr_boost_1_81::empty_value<alloc_type>(
                zr_boost_1_81::empty_init_t{}, a)
        ...
        net::cancellation_type cancel_type)
{
    ...
    auto tmp = zr_boost_1_81::exchange(s.p, nullptr);
    p_ = tmp;
