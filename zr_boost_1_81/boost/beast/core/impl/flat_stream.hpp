...
{
    static_assert(zr_boost_1_81::beast::is_sync_read_stream<next_layer_type>::value,
    ...
    if(ec)
        BOOST_THROW_EXCEPTION(zr_boost_1_81::system::system_error{ec});
    return n;
}
...
async_read_some(
    ...
    ReadHandler&& handler)
{
    static_assert(zr_boost_1_81::beast::is_async_read_stream<next_layer_type>::value,
...
{
    static_assert(zr_boost_1_81::beast::is_sync_write_stream<next_layer_type>::value,
...
write_some(ConstBufferSequence const& buffers, error_code& ec)
{
    ...
    return stream_.write_some(
        zr_boost_1_81::beast::buffers_prefix(result.size, buffers), ec);
}
...
{
    static_assert(zr_boost_1_81::beast::is_async_write_stream<next_layer_type>::value,
