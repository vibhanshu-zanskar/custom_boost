...
basic_multi_buffer(
    ...
    , max_(other.max_)
    , in_size_(zr_boost_1_81::exchange(other.in_size_, 0))
    , in_pos_(zr_boost_1_81::exchange(other.in_pos_, 0))
    , out_pos_(zr_boost_1_81::exchange(other.out_pos_, 0))
    , out_end_(zr_boost_1_81::exchange(other.out_end_, 0))
{
    auto const at_end =
...
basic_multi_buffer(
    ...
    : zr_boost_1_81::empty_value<Allocator>(
        zr_boost_1_81::empty_init_t(), alloc_traits::
