...
basic_flat_buffer(Allocator const& alloc) noexcept
    : zr_boost_1_81::empty_value<base_alloc_type>(
...
basic_flat_buffer(basic_flat_buffer&& other) noexcept
    : zr_boost_1_81::empty_value<base_alloc_type>(
        zr_boost_1_81::empty_init_t{}, std::move(other.get()))
    , begin_(zr_boost_1_81::exchange(other.begin_, nullptr))
    , in_(zr_boost_1_81::exchange(other.in_, nullptr))
    , out_(zr_boost_1_81::exchange(other.out_, nullptr))
    , last_(zr_boost_1_81::exchange(other.last_, nullptr))
    , end_(zr_boost_1_81::exchange(other.end_, nullptr))
    , max_(other.max_)
{
}
...
basic_flat_buffer(basic_flat_buffer const& other)
    : zr_boost_1_81::empty_value<base_alloc_type>(zr_boost_1_81::empty_init_t{},
