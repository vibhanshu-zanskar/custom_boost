...
impl_type(std::true_type,
    ...
    : zr_boost_1_81::empty_value<RatePolicy>(
...
on_timer(Executor2 const& ex2)
{
    ...
    struct handler : zr_boost_1_81::empty_value<Executor2>
    {
        ...
        handler(
            Executor2 const& ex2,
            zr_boost_1_81::shared_ptr<impl_type> const& sp)
            : zr_boost_1_81::empty_value<Executor2>(
                zr_boost_1_81::empty_init_t{}, ex2)
            , wp(sp)
        {
        }
...
class transfer_op
    ...
    , public zr_boost_1_81::asio::coroutine
{
    zr_boost_1_81::shared_ptr<impl_type> impl_;
    pending_guard pg_;
    Buffers b_;
...
basic_stream(Arg0&& arg0, Args&&... args)
    : impl_(zr_boost_1_81::make_shared<impl_type>(
        std::false_type{},
...
basic_stream(basic_stream<Protocol, Executor_, RatePolicy> && other)
    : impl_(zr_boost_1_81::make_shared<impl_type>(std::false_type{}, std::move(other.impl_->socket)))
{
}
