...
/** Return `true` if the buffer contains a TLS Protocol client_hello message.
    ...
    @li `zr_boost_1_81::indeterminate` if the buffer contains an
    ...
    @return `zr_boost_1_81::tribool` indicating whether the buffer contains
...
*/
    ...
    if(n < 1)
        return zr_boost_1_81::indeterminate;
...
detect_ssl(
    ...
    error_code& ec)
{
    namespace beast = zr_boost_1_81::beast;
    ...
    for(;;)
    {
        ...
        if(! zr_boost_1_81::indeterminate(result))
        {
...
struct run_detect_ssl_op
{
    ...
    // signature, in this case `void(error_code, zr_boost_1_81::tri_bool)`.
        ...
        DetectHandler, executor_type<AsyncReadStream>>
{
    ...
    zr_boost_1_81::tribool result_ = false;
...
operator()(error_code ec, std::size_t bytes_transferred, bool cont)
{
    ...
    reenter(*this)
    {
        ...
        for(;;)
        {
            ...
            if(! zr_boost_1_81::indeterminate(result_))
                break;
