...
public:
    ...
    If a class derived from @ref zr_boost_1_81::beast::async_base is a completion
...
public:
    ...
    */
    ...
    async_base(
        ...
        : zr_boost_1_81::empty_value<Allocator>(
            zr_boost_1_81::empty_init_t{}, alloc)
        , h_(std::forward<Handler_>(handler))
        , wg1_(ex1)
    {
    }
    ...
    */
    ...
    get_allocator() const noexcept
    {
        return net::get_associated_allocator(h_,
            zr_boost_1_81::empty_value<Allocator>::get());
    }
    ...
    */
    ...
    /** Invoke the final completion handler, maybe using post.
        ...
        @ref zr_boost_1_81::beast::async_base::complete or
        @ref zr_boost_1_81::beast::async_base::complete_now more than once.

        Any temporary objects allocated with @ref zr_boost_1_81::beast::allocate_stable will
        ...
        @ref zr_boost_1_81::beast::async_base::complete_now.
    ...
    */
    ...
    /** Invoke the final completion handler.
        ...
        This invokes the final completion handler with the specified
        arguments forwarded. It is undefined to call either of
        @ref zr_boost_1_81::beast::async_base::complete or @ref zr_boost_1_81::beast::async_base::complete_now more than once.
...
/** Base class to provide completion handler boilerplate for composed operations.
                ...
                void(error_code)>::return_type
    {
        ...
        struct op : base_type, zr_boost_1_81::asio::coroutine
        {
    ...
    */
    ...
    stable_async_base(stable_async_base&& other)
        : async_base<Handler, Executor1, Allocator>(
            std::move(other))
        , list_(zr_boost_1_81::exchange(other.list_, nullptr))
    {
    }
