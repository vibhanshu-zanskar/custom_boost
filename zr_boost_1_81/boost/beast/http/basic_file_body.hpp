...
public:
    ...
    // retrieve buffers. A return value of `zr_boost_1_81::none`
...
public:
    ...
    //
    void
    init(zr_boost_1_81::optional<std::uint64_t> const&, error_code& ec);
...
reader::
init(
    zr_boost_1_81::optional<std::uint64_t> const& content_length,
    error_code& ec)
{
