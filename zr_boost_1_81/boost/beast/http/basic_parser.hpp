...
public:
    ...
    */
    ...
    /** Set the limit on the payload body.
        ...
        If this is equal to `zr_boost_1_81::none`, then the body limit is disabled.
    */
    void
    body_limit(zr_boost_1_81::optional<std::uint64_t> v)
    {
        body_limit_ = v;
    }
...
protected:
    ...
    */
    ...
    /** Called once before the body is processed.
        ...
        Otherwise, the value will be `zr_boost_1_81::none`.
