...
class basic_fields
    ...
    : private zr_boost_1_81::empty_value<Allocator>
#endif
{
...
public:
    ...
    public:
        ...
        /// Returns the field enum, which can be @ref zr_boost_1_81::beast::http::field::unknown
        field
        name() const;
...
private:
    struct element
        : public zr_boost_1_81::intrusive::list_base_hook<
            zr_boost_1_81::intrusive::link_mode<
                zr_boost_1_81::intrusive::normal_link>>
        , public zr_boost_1_81::intrusive::set_base_hook<
            zr_boost_1_81::intrusive::link_mode<
                zr_boost_1_81::intrusive::normal_link>>
        , public value_type
    {
    ...
    using list_t = typename zr_boost_1_81::intrusive::make_list<
        element,
        zr_boost_1_81::intrusive::constant_time_size<false>
            >::type;

    using set_t = typename zr_boost_1_81::intrusive::make_multiset<
        element,
        zr_boost_1_81::intrusive::constant_time_size<false>,
        zr_boost_1_81::intrusive::compare<key_compare>
            >::type;

    using align_type = typename
        zr_boost_1_81::type_with_alignment<alignof(element)>::type;
...
public:
    ...
    */
    ...
    /** Insert a field.
        ...
        @param value The value of the field, as a @ref zr_boost_1_81::beast::string_view
    */
    void
    ...
    */
    ...
    /// @copydoc zr_boost_1_81::beast::http::basic_fields::equal_range(zr_boost_1_81::beast::http::field) const
    std::pair<const_iterator, const_iterator>
...
protected:
    ...
    */
    ...
    set_content_length_impl(
        zr_boost_1_81::optional<std::uint64_t> const& value);
