...
public:
    ...
    */
    void
    content_length(zr_boost_1_81::optional<std::uint64_t> const& value);
    ...
    */
    ...
    /** Returns the payload size of the body in octets if possible.
        ...
        body exists but is not known ahead of time, `zr_boost_1_81::none`
        ...
        is not inspected.
    */
    zr_boost_1_81::optional<std::uint64_t>
    payload_size() const;
    ...
    */
    ...
    {
        return std::move(
            this->zr_boost_1_81::empty_value<
                typename Body::value_type>::get());
    }
...
private:
    ...
    message(
        ...
        : zr_boost_1_81::empty_value<
            typename Body::value_type>(zr_boost_1_81::empty_init_t(),
                std::forward<BodyArgs>(
                std::get<IBodyArgs>(body_args))...)
    {
        zr_boost_1_81::ignore_unused(body_args);
    }
    ...
    {
        zr_boost_1_81::ignore_unused(body_args);
        zr_boost_1_81::ignore_unused(fields_args);
    }
