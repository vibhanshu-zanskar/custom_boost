...
struct basic_file_body<file_win32>
{
    ...
    public:
        ...
        zr_boost_1_81::optional<std::pair<const_buffers_type, bool>>
        get(error_code& ec)
        {
...
error_code
make_win32_error(
    zr_boost_1_81::winapi::DWORD_ dwError) noexcept
{
    // from
    ...
    switch(dwError)
    {
    case zr_boost_1_81::winapi::ERROR_NETNAME_DELETED_:
        return net::error::connection_reset;
    case zr_boost_1_81::winapi::ERROR_PORT_UNREACHABLE_:
        return net::error::connection_refused;
    case zr_boost_1_81::winapi::WSAEMSGSIZE_:
    case zr_boost_1_81::winapi::ERROR_MORE_DATA_:
        return {};
    }
    return error_code(
    ...
    error_code ec) noexcept
{
    ...
    return make_win32_error(
        static_cast<zr_boost_1_81::winapi::DWORD_>(
            ec.value()));
}
...
public:
    ...
    operator()()
    {
        ...
        zr_boost_1_81::winapi::DWORD_ const nNumberOfBytesToWrite =
            static_cast<zr_boost_1_81::winapi::DWORD_>(
            (std::min<std::uint64_t>)(
                (std::min<std::uint64_t>)(w.body_.last_ - w.pos_, sr_.limit()),
                (std::numeric_limits<zr_boost_1_81::winapi::INT_>::max)() - 1));
        ...
        if(! bSuccess && dwError !=
            zr_boost_1_81::winapi::ERROR_IO_PENDING_)
        {
