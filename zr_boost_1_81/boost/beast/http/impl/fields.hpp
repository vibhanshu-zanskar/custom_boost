...
public:
    ...
    zr_boost_1_81::optional<view_type> view_;
    char buf_[13];
...
basic_fields(Allocator const& alloc) noexcept
    : zr_boost_1_81::empty_value<Allocator>(zr_boost_1_81::empty_init_t(), alloc)
{
}
...
basic_fields(basic_fields&& other) noexcept
    : zr_boost_1_81::empty_value<Allocator>(zr_boost_1_81::empty_init_t(),
        std::move(other.get()))
    , set_(std::move(other.set_))
    , list_(std::move(other.list_))
    , method_(zr_boost_1_81::exchange(other.method_, {}))
    , target_or_reason_(zr_boost_1_81::exchange(other.target_or_reason_, {}))
{
}
...
basic_fields(basic_fields const& other)
    : zr_boost_1_81::empty_value<Allocator>(zr_boost_1_81::empty_init_t(), alloc_traits::
