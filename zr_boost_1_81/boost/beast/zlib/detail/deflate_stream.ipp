...
// VFALCO zr_boost_1_81::optional param is a workaround for
//        gcc "maybe uninitialized" warning
//        https://github.com/boostorg/beast/issues/532
//
void
deflate_stream::
doWrite(z_params& zs, zr_boost_1_81::optional<Flush> flush, error_code& ec)
{
    maybe_init();
    ...
    auto old_flush = zr_boost_1_81::make_optional<Flush>(
    ...
    if(pending_ != 0)
    {
        ...
        if(zs.avail_out == 0)
        {
             ...
             */
            last_flush_ = zr_boost_1_81::none;
            return;
        }
    }
        ...
        (flush != Flush::none && status_ != FINISH_STATE))
    {
        ...
        if(bstate == need_more || bstate == finish_started)
        {
            if(zs.avail_out == 0)
            {
                last_flush_ = zr_boost_1_81::none; /* avoid BUF_ERROR next call, see above */
            }
            return;
        ...
        if(bstate == block_done)
        {
            ...
            if(zs.avail_out == 0)
            {
                last_flush_ = zr_boost_1_81::none; /* avoid BUF_ERROR at next call, see above */
                return;
            }
        }
    }
...
init()
{
    ...
    {
        buf_ = zr_boost_1_81::make_unique_noinit<
            std::uint8_t[]>(needed);
        buf_size_ = needed;
    }
