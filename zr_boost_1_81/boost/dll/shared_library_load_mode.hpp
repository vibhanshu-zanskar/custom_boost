...
/// \brief Contains only the zr_boost_1_81::dll::load_mode::type enum and operators related to it.

namespace zr_boost_1_81 { namespace dll { namespace load_mode {
...
enum type {
    ...
    * zr_boost_1_81::dll::shared_library lib("./my_plugins/plugin1", load_mode::append_decorations);
    * \endcode
    */
    append_decorations,
    /*!
    ...
    */
    ...
    default_mode                          = 0,
    dont_resolve_dll_references           = zr_boost_1_81::winapi::DONT_RESOLVE_DLL_REFERENCES_,
    load_ignore_code_authz_level          = zr_boost_1_81::winapi::LOAD_IGNORE_CODE_AUTHZ_LEVEL_,
    load_with_altered_search_path         = zr_boost_1_81::winapi::LOAD_WITH_ALTERED_SEARCH_PATH_,
    rtld_lazy                             = 0,
    rtld_now                              = 0,
    rtld_global                           = 0,
    rtld_local                            = 0,
