...
namespace zr_boost_1_81 { namespace dll { namespace detail {
    ...
    inline zr_boost_1_81::dll::fs::path path_from_handle(void* handle, zr_boost_1_81::dll::fs::error_code &ec) {
...
namespace zr_boost_1_81 { namespace dll { namespace detail {
    ...
    inline zr_boost_1_81::dll::fs::path path_from_handle(const void* handle, zr_boost_1_81::dll::fs::error_code &ec) {
        ...
        zr_boost_1_81::dll::fs::path ret = zr_boost_1_81::dll::symbol_location_ptr(si->base, ec);

        if (ec) {
            ec.clear();
            si = static_cast<const struct soinfo*>(handle);
            return zr_boost_1_81::dll::symbol_location_ptr(si->base, ec);
        }
...
namespace zr_boost_1_81 { namespace dll { namespace detail {
    ...
    inline zr_boost_1_81::dll::fs::path path_from_handle(void* handle, zr_boost_1_81::dll::fs::error_code &ec) {
        ...
        return zr_boost_1_81::dll::fs::path(link_map->l_name);
    }
