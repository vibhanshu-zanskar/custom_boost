...
const std::type_info& load_type_info(Lib & lib, Storage & storage)
{
    ...
    {
        zr_boost_1_81::winapi::DWORD_ signature; //always zero ?
        zr_boost_1_81::winapi::DWORD_ offset;    //offset of this vtable in the complete class
        zr_boost_1_81::winapi::DWORD_ cdOffset;  //constructor displacement offset
        zr_boost_1_81::winapi::DWORD_ pTypeDescriptorOffset; //TypeDescriptor of the complete class
        zr_boost_1_81::winapi::DWORD_ pClassDescriptorOffset; //describes inheritance hierarchy (ignored)
    };
