...
BOOST_FORCEINLINE typename zr_boost_1_81::disable_if_c<zr_boost_1_81::is_member_pointer<To>::value || zr_boost_1_81::is_reference<To>::value || zr_boost_1_81::is_member_pointer<From>::value, To>::type
    aggressive_ptr_cast(From v) BOOST_NOEXCEPT
{
    BOOST_STATIC_ASSERT_MSG(
        zr_boost_1_81::is_pointer<To>::value && zr_boost_1_81::is_pointer<From>::value,
        "`agressive_ptr_cast` function must be used only for pointer casting."
    );

    BOOST_STATIC_ASSERT_MSG(
        zr_boost_1_81::is_void< typename zr_boost_1_81::remove_pointer<To>::type >::value
        || zr_boost_1_81::is_void< typename zr_boost_1_81::remove_pointer<From>::type >::value,
...
template <class To, class From>
BOOST_FORCEINLINE typename zr_boost_1_81::disable_if_c<!zr_boost_1_81::is_reference<To>::value || zr_boost_1_81::is_member_pointer<From>::value, To>::type
    aggressive_ptr_cast(From v) BOOST_NOEXCEPT
{
    BOOST_STATIC_ASSERT_MSG(
        zr_boost_1_81::is_pointer<From>::value,
        "`agressive_ptr_cast` function must be used only for pointer casting."
    );
    ...
    BOOST_STATIC_ASSERT_MSG(
        sizeof(v) == sizeof(typename zr_boost_1_81::remove_reference<To>::type*),
        "Pointer to function and pointer to object differ in size on your platform."
    );
    return static_cast<To>(
        **reinterpret_cast<typename zr_boost_1_81::remove_reference<To>::type**>(
            v
        )
    );
}
...
template <class To, class From>
BOOST_FORCEINLINE typename zr_boost_1_81::disable_if_c<!zr_boost_1_81::is_member_pointer<To>::value || zr_boost_1_81::is_member_pointer<From>::value, To>::type
    aggressive_ptr_cast(From v) BOOST_NOEXCEPT
{
    BOOST_STATIC_ASSERT_MSG(
        zr_boost_1_81::is_pointer<From>::value,
