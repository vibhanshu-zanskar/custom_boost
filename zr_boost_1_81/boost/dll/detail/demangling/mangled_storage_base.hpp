...
protected:
    ...
    std::map<zr_boost_1_81::typeindex::ctti_type_index, std::string> aliases_;
public:
    ...
    {
        using zr_boost_1_81::typeindex::ctti_type_index;
    ...
    explicit mangled_storage_base(
            const zr_boost_1_81::dll::fs::path& library_path,
    ...
    void load(const zr_boost_1_81::dll::fs::path& library_path,
            bool throw_if_not_native_format = true)
    {
        storage_.clear();
    ...
    {
        aliases_.emplace(
            zr_boost_1_81::typeindex::ctti_type_index::type_id<Alias>(),
            name
            );
    }
