...
namespace zr_boost_1_81 { namespace dll { namespace experimental { namespace detail {
...
struct unqalified_is_same :
        zr_boost_1_81::is_same<
            typename zr_boost_1_81::remove_cv<Lhs>::type,
            typename zr_boost_1_81::remove_cv<Rhs>::type
        >
{
};
...
template<class Class, class...Args> struct is_function_seq<sequence<Class, Args...>>
            : zr_boost_1_81::conditional<
                zr_boost_1_81::is_function<Class>::value,
                is_function_seq<sequence<Args...>>,
                zr_boost_1_81::false_type>::type
{};

template<class Class>
struct is_function_seq<sequence<Class>> : zr_boost_1_81::is_function<Class>
{
};

template<>
struct is_function_seq<sequence<>> : zr_boost_1_81::false_type
{
};
...
struct mem_fn_def
{
    ...
    typedef typename zr_boost_1_81::dll::detail::get_mem_fn_type<Class, Func>::mem_fn mem_fn;
};
...
{
    typedef typename zr_boost_1_81::conditional<
                 zr_boost_1_81::is_function<U>::value || zr_boost_1_81::dll::experimental::detail::unqalified_is_same<T, U>::value,
                 typename is_mem_fn_seq_impl<T, Args...>::type,
                 zr_boost_1_81::false_type>::type type;
};
...
{
    typedef typename zr_boost_1_81::conditional<
                 zr_boost_1_81::is_function<U>::value && zr_boost_1_81::is_object<T>::value,
                 zr_boost_1_81::true_type, zr_boost_1_81::false_type>::type type;
};
...
struct is_mem_fn_seq_impl<T, U, Last>
{
    typedef typename zr_boost_1_81::conditional<
                 (zr_boost_1_81::is_function<U>::value || zr_boost_1_81::dll::experimental::detail::unqalified_is_same<T, U>::value)
                 && zr_boost_1_81::is_function<Last>::value,
                 zr_boost_1_81::true_type, zr_boost_1_81::false_type>::type type;
};

template<class T> struct is_mem_fn_seq : zr_boost_1_81::false_type {};

//If only two arguments are provided at all.
template<class T, class U>
struct is_mem_fn_seq<sequence<T, U>> : zr_boost_1_81::conditional<
                 zr_boost_1_81::is_object<T>::value && zr_boost_1_81::is_function<U>::value,
...
struct is_mem_fn_seq<sequence<T, Func, Args...>> :
        zr_boost_1_81::conditional<
            zr_boost_1_81::is_class<T>::value && zr_boost_1_81::is_function<Func>::value,
            typename is_mem_fn_seq_impl<T, Args...>::type,
            zr_boost_1_81::false_type>::type {};
...
struct mem_fn_tuple<mem_fn_def<Class, Return(Args...)>, T2, Ts...>
    : mem_fn_tuple<T2, Ts...>
{
    typedef typename zr_boost_1_81::dll::detail::get_mem_fn_type<Class, Return(Args...)>::mem_fn mem_fn;
    mem_fn f_;
