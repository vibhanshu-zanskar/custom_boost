...
/// \brief Contains the zr_boost_1_81::dll::experimental::smart_library class for loading mangled symbols.
...
using zr_boost_1_81::dll::detail::constructor;
using zr_boost_1_81::dll::detail::destructor;
...
public:
    ...
    */
    ...
    //! \copydoc shared_library::shared_library(const zr_boost_1_81::dll::fs::path& lib_path, load_mode::type mode = load_mode::default_mode)
    smart_library(const zr_boost_1_81::dll::fs::path& lib_path, load_mode::type mode = load_mode::default_mode) {
        _lib.load(lib_path, mode);
        _storage.load(lib_path);
    }

    //! \copydoc shared_library::shared_library(const zr_boost_1_81::dll::fs::path& lib_path, zr_boost_1_81::dll::fs::error_code& ec, load_mode::type mode = load_mode::default_mode)
    smart_library(const zr_boost_1_81::dll::fs::path& lib_path, zr_boost_1_81::dll::fs::error_code& ec, load_mode::type mode = load_mode::default_mode) {
        load(lib_path, mode, ec);
    }

    //! \copydoc shared_library::shared_library(const zr_boost_1_81::dll::fs::path& lib_path, load_mode::type mode, zr_boost_1_81::dll::fs::error_code& ec)
    smart_library(const zr_boost_1_81::dll::fs::path& lib_path, load_mode::type mode, zr_boost_1_81::dll::fs::error_code& ec) {
        load(lib_path, mode, ec);
    }
    /*!
    ...
    */
    smart_library(BOOST_RV_REF(smart_library) lib) BOOST_NOEXCEPT
        : _lib(zr_boost_1_81::move(lib._lib)), _storage(zr_boost_1_81::move(lib._storage))
    {}
     ...
     */
     explicit smart_library(BOOST_RV_REF(shared_library) lib) BOOST_NOEXCEPT
         : _lib(zr_boost_1_81::move(static_cast<shared_library&>(lib)))
     {
         _storage.load(lib.location());
     }
    ...
    */
    ...
    //! \copydoc shared_library::load(const zr_boost_1_81::dll::fs::path& lib_path, load_mode::type mode = load_mode::default_mode)
    void load(const zr_boost_1_81::dll::fs::path& lib_path, load_mode::type mode = load_mode::default_mode) {
        ...
        if (ec) {
            zr_boost_1_81::dll::detail::report_error(ec, "load() failed");
        }
    }

    //! \copydoc shared_library::load(const zr_boost_1_81::dll::fs::path& lib_path, zr_boost_1_81::dll::fs::error_code& ec, load_mode::type mode = load_mode::default_mode)
    ...
    //! \copydoc shared_library::load(const zr_boost_1_81::dll::fs::path& lib_path, load_mode::type mode, zr_boost_1_81::dll::fs::error_code& ec)
    ...
    typename zr_boost_1_81::dll::detail::get_mem_fn_type<Class, Func>::mem_fn get_mem_fn(const std::string& name) const {
        return _lib.get<typename zr_boost_1_81::dll::detail::get_mem_fn_type<Class, Func>::mem_fn>(
    ...
    constructor<Signature> get_constructor() const {
        return zr_boost_1_81::dll::detail::load_ctor<Signature>(_lib, _storage.get_constructor<Signature>());
    }
    ...
    destructor<Class> get_destructor() const {
        return zr_boost_1_81::dll::detail::load_dtor<Class>(_lib, _storage.get_destructor<Class>());
    }
    /*!
    ...
    {
        return zr_boost_1_81::dll::detail::load_type_info<Class>(_lib, _storage);
    }
    /**
...
template<class T>
typename zr_boost_1_81::enable_if<zr_boost_1_81::is_object<T>, T&>::type get(const smart_library& sm, const std::string &name)
...
template<class T>
typename zr_boost_1_81::enable_if<zr_boost_1_81::is_function<T>, T&>::type get(const smart_library& sm, const std::string &name)
{
