...
/// \brief Contains the zr_boost_1_81::dll::experimental::import_mangled function for importing mangled symbols.
...
namespace zr_boost_1_81 { namespace dll { namespace experimental {
...
class mangled_library_function {
    ...
    zr_boost_1_81::shared_ptr<shared_library> lib_;
    function_tuple<Ts...>   f_;
public:
    constexpr mangled_library_function(const zr_boost_1_81::shared_ptr<shared_library>& lib, Ts*... func_ptr) BOOST_NOEXCEPT
        : lib_(lib)
        , f_(func_ptr...)
    {}
...
public:
    constexpr mangled_library_mem_fn(const zr_boost_1_81::shared_ptr<shared_library>& lib, typename Ts::mem_fn... func_ptr) BOOST_NOEXCEPT
        : lib_(lib)
        , f_(func_ptr...)
    {}
...
template<class Seq>  struct is_variable : zr_boost_1_81::false_type {};
template<typename T> struct is_variable<sequence<T>> : zr_boost_1_81::is_object<T> {};
...
{
    typedef zr_boost_1_81::dll::experimental::detail::mangled_library_function<Args...> type;
    static type make(
           const zr_boost_1_81::dll::experimental::smart_library& p,
           const std::string& name)
    {
        return type(
                zr_boost_1_81::make_shared<shared_library>(p.shared_lib()),
                zr_boost_1_81::addressof(p.get_function<Args>(name))...);
    }
};
...
{
    typedef typename zr_boost_1_81::dll::experimental::detail::make_mem_fn_seq<Class, Args...>::type actual_sequence;
    typedef typename zr_boost_1_81::dll::experimental::detail::mangled_library_mem_fn<Class, actual_sequence> type;
    ...
    static type make_impl(
            ...
            sequence<ArgsIn...> * )
    {
        return type(zr_boost_1_81::make_shared<shared_library>(p.shared_lib()),
...
struct mangled_import_type<sequence<T>, false, false, true> //is variable
{
           ...
           const std::string& name)
    {
        return type(
                zr_boost_1_81::make_shared<shared_library>(p.shared_lib()),
                zr_boost_1_81::addressof(p.get_variable<T>(name)));
    }
...
#   define BOOST_DLL_MANGLED_IMPORT_RESULT_TYPE inline typename \
    zr_boost_1_81::dll::experimental::detail::mangled_import_type<zr_boost_1_81::dll::experimental::detail::sequence<Args...>>::type
#endif
...
*
* \code
* zr_boost_1_81::function<int(int)> f = import_mangled<int(int)>("test_lib.so", "integer_func_name");
*
* auto f_cpp11 = import_mangled<int(int)>("test_lib.so", "integer_func_name");
* \endcode
*
* \code
* zr_boost_1_81::shared_ptr<int> i = import_mangled<int>("test_lib.so", "integer_name");
* \endcode
*
...
template <class ...Args>
BOOST_DLL_MANGLED_IMPORT_RESULT_TYPE import_mangled(const zr_boost_1_81::dll::fs::path& lib, const char* name,
    load_mode::type mode = load_mode::default_mode)
{
    typedef typename zr_boost_1_81::dll::experimental::detail::mangled_import_type<
                     zr_boost_1_81::dll::experimental::detail::sequence<Args...>> type;

    zr_boost_1_81::dll::experimental::smart_library p(lib, mode);
    //the load
...
//! \overload zr_boost_1_81::dll::import(const zr_boost_1_81::dll::fs::path& lib, const char* name, load_mode::type mode)
template <class ...Args>
BOOST_DLL_MANGLED_IMPORT_RESULT_TYPE import_mangled(const zr_boost_1_81::dll::fs::path& lib, const std::string& name,
    load_mode::type mode = load_mode::default_mode)
{
...
BOOST_DLL_MANGLED_IMPORT_RESULT_TYPE import_mangled(const smart_library& lib, const char* name) {
    typedef typename zr_boost_1_81::dll::experimental::detail::mangled_import_type<detail::sequence<Args...>> type;
...
BOOST_DLL_MANGLED_IMPORT_RESULT_TYPE import_mangled(BOOST_RV_REF(smart_library) lib, const std::string& name) {
    return import_mangled<Args...>(zr_boost_1_81::move(lib), name.c_str());
}
...
BOOST_DLL_MANGLED_IMPORT_RESULT_TYPE import_mangled(const shared_library& lib, const char* name) {
    ...
    zr_boost_1_81::shared_ptr<zr_boost_1_81::dll::experimental::smart_library> p = zr_boost_1_81::make_shared<zr_boost_1_81::dll::experimental::smart_library>(lib);
    return type::make(p, name);
}
...
BOOST_DLL_MANGLED_IMPORT_RESULT_TYPE import_mangled(BOOST_RV_REF(shared_library) lib, const char* name) {
    ...
    zr_boost_1_81::dll::experimental::smart_library p(zr_boost_1_81::move(lib));
