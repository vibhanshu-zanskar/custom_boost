...
*
* This macro is useful in cases of long mangled C++ names. For example some `void zr_boost_1_81::foo(std::string)`
...
// Note: we can not use `zr_boost_1_81::addressof()` here, because in that case GCC 
