...
#define BOOST_FUNCTIONAL_base(z, n, unused) \
    ::zr_boost_1_81::overloaded_function_detail::base< \
...
#define BOOST_FUNCTIONAL_function_type(z, n, unused) \
    typename ::zr_boost_1_81::overloaded_function_detail::function_type< \
        BOOST_FUNCTIONAL_f_type(z, n, ~) \
    >::type
...
BOOST_TYPEOF_REGISTER_TEMPLATE(zr_boost_1_81::overloaded_function,
...
public:
    ...
    that can be converted to a <c>zr_boost_1_81::function</c> function object can be
    ...
    */
    overloaded_function(const zr_boost_1_81::function<F1>&,
            const zr_boost_1_81::function<F2>&, ...);
    ...
    the constructor.
    */
    typename zr_boost_1_81::function_traits<F1>::result_type operator()(
            typename zr_boost_1_81::function_traits<F1>::arg1_type,
            typename zr_boost_1_81::function_traits<F1>::arg2_type,
            ...) const;
    ...
    documentation).
    */
    typename zr_boost_1_81::function_traits<F2>::result_type operator()(
            typename zr_boost_1_81::function_traits<F2>::arg1_type,
            typename zr_boost_1_81::function_traits<F2>::arg2_type,
            ...) const;
};
