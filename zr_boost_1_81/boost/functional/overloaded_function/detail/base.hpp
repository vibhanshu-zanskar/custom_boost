...
public:
    /* implicit */ inline base(
            ...
            // a zr_boost_1_81::function<> functor.
            zr_boost_1_81::function< BOOST_FUNCTIONAL_DETAIL_f > const& f): f_(f)
    {}
...
private:
    zr_boost_1_81::function< BOOST_FUNCTIONAL_DETAIL_f > const f_;
};
