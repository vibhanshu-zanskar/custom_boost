...
namespace zr_boost_1_81 
{
    ...
    namespace detail
    {
        ...
        struct lightweight_forward_adapter_result
        {
            ...
            template< typename T > struct x< zr_boost_1_81::reference_wrapper<T> >
            { typedef T& t; };
...
#   define BOOST_TMP_MACRO(f,fn,fc) \
        zr_boost_1_81::detail::lightweight_forward_adapter_impl< \
    ...
    namespace detail
    {
        ...
        struct lightweight_forward_adapter_impl_zero<MD, F, FC,
            typename lightweight_forward_adapter_sfinae<typename zr_boost_1_81::result_of< FC() >::type>::type>
            : lightweight_forward_adapter_result
        {
...
#       include BOOST_PP_ITERATE()
    ...
    struct result_of<zr_boost_1_81::lightweight_forward_adapter<F,A0,A1> const ()>
        : zr_boost_1_81::detail::lightweight_forward_adapter_result::template apply<
            zr_boost_1_81::lightweight_forward_adapter<F,A0,A1> const () >
    { };
    template<class F, int A0, int A1>
    struct result_of<zr_boost_1_81::lightweight_forward_adapter<F,A0,A1>()>
        : zr_boost_1_81::detail::lightweight_forward_adapter_result::template apply<
            zr_boost_1_81::lightweight_forward_adapter<F,A0,A1>() >
    { };
    template<class F, int A0, int A1>
    struct result_of<zr_boost_1_81::lightweight_forward_adapter<F,A0,A1> const& ()>
        : zr_boost_1_81::detail::lightweight_forward_adapter_result::template apply<
...
#     define N BOOST_PP_ITERATION() 
            ...
            : lightweight_forward_adapter_result
        {
            ...
            inline typename zr_boost_1_81::result_of< F(BOOST_PP_ENUM_BINARY_PARAMS(N,
