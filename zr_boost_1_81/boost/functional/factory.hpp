...
template<class A>
class fc_delete
    : zr_boost_1_81::empty_value<A> {
    typedef zr_boost_1_81::empty_value<A> base;

public:
    explicit fc_delete(const A& a) BOOST_NOEXCEPT
        : base(zr_boost_1_81::empty_init_t(), a) { }

    void operator()(typename fc_pointer<A>::type p) {
        zr_boost_1_81::detail::fc_destroy(base::get(), zr_boost_1_81::to_address(p));
...
public:
    ...
    typename A::value_type* get() const BOOST_NOEXCEPT {
        return zr_boost_1_81::to_address(p_);
    }
