...
#   define BOOST_TMP_MACRO(f,fn,fc) \
        zr_boost_1_81::detail::forward_adapter_impl< \
    ...
    namespace detail
    {
        ...
        struct forward_adapter_result::apply< Self() >
            : zr_boost_1_81::result_of< BOOST_DEDUCED_TYPENAME c<Self>::t() >
        { };
        ...
        struct forward_adapter_impl_zero<MD, F, FC,
            typename forward_adapter_sfinae<typename zr_boost_1_81::result_of< FC() >::type>::type>
        {
            inline typename zr_boost_1_81::result_of< FC() >::type
            operator()() const
            {
                return static_cast<MD const*>(this)->target_function()();
            }

            inline typename zr_boost_1_81::result_of< F() >::type
            operator()()
            {
...
#       define BOOST_TMP_MACRO(tpl_params,arg_types,params,args)              \
            template< tpl_params >                                             \
            inline typename zr_boost_1_81::result_of< FC(arg_types) >::type            \
            operator()(params) const                                           \
            {                                                                  \
                return static_cast<MD const*>(this)->target_function()(args);  \
            }                                                                  \
            template< tpl_params >                                             \
            inline typename zr_boost_1_81::result_of< F(arg_types)>::type              \
            operator()(params)                                                 \
            {                                                                  \
...
#       undef BOOST_TMP_MACRO
    ...
    struct result_of<zr_boost_1_81::forward_adapter<F,A0,A1> const ()>
        : zr_boost_1_81::detail::forward_adapter_result::template apply<
            zr_boost_1_81::forward_adapter<F,A0,A1> const () >
    { };
    template<class F, int A0, int A1>
    struct result_of<zr_boost_1_81::forward_adapter<F,A0,A1>()>
        : zr_boost_1_81::detail::forward_adapter_result::template apply<
            zr_boost_1_81::forward_adapter<F,A0,A1>() >
    { };
    template<class F, int A0, int A1>
    struct result_of<zr_boost_1_81::forward_adapter<F,A0,A1> const& ()>
        : zr_boost_1_81::detail::forward_adapter_result::template apply<
...
#         endif
        ...
        struct forward_adapter_impl<MD,F,FC,BOOST_PP_DEC(N),N>
        {
            ...
            inline typename zr_boost_1_81::result_of< F(
...
#       if BOOST_WORKAROUND(BOOST_MSVC,BOOST_TESTED_AT(1400)) 
            template< BOOST_PP_ENUM_PARAMS(N,typename T) >
            inline typename zr_boost_1_81::result_of<  FC(BOOST_PP_ENUM_PARAMS(N,PT)) 
                >::type
            ...
            template< BOOST_PP_ENUM_PARAMS(N,typename T) >
            inline typename zr_boost_1_81::result_of<  F(BOOST_PP_ENUM_PARAMS(N,PT))
                >::type
