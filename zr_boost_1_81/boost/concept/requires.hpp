...
struct Requires_ : ::zr_boost_1_81::ccheck_aux::unaryfunptr_arg_type<Result>
{
};

# if BOOST_WORKAROUND(BOOST_INTEL_WIN, BOOST_TESTED_AT(1010))
#  define BOOST_CONCEPT_REQUIRES_(r,data,t) | (::zr_boost_1_81::_requires_<void(*)t>::value)
# else 
#  define BOOST_CONCEPT_REQUIRES_(r,data,t) + (::zr_boost_1_81::_requires_<void(*)t>::value)
# endif
...
# define BOOST_CONCEPT_REQUIRES(models, result)                                        \
    typename ::zr_boost_1_81::Requires_<                                                       \
      (0 BOOST_PP_SEQ_FOR_EACH(BOOST_CONCEPT_REQUIRES_, ~, models)),                   \
      void(*)result                                                                 \
    >::type
...
} // namespace zr_boost_1_81::concept_check
