...
#include  <memory>
namespace zr_boost_1_81 { namespace exception_detail { using std::shared_ptr; } }
#else
namespace zr_boost_1_81 { template <class T> class shared_ptr; }
namespace zr_boost_1_81 { namespace exception_detail { using zr_boost_1_81::shared_ptr; } }
#endif
...
zr_boost_1_81
    ...
    exception_detail
        ...
        zr_boost_1_81::source_location get_exception_throw_location( exception const & );
        }
    ...
    exception
...
#ifdef __HP_aCC
        //On HP aCC, this protected copy constructor prevents throwing zr_boost_1_81::exception.
        ...
        friend zr_boost_1_81::source_location exception_detail::get_exception_throw_location( exception const & );
    ...
    exception_detail
        ...
        inline zr_boost_1_81::source_location get_exception_throw_location( exception const & x )
            {
