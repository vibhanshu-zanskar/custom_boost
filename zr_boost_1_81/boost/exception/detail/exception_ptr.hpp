...
zr_boost_1_81
    ...
    exception_detail
        ...
        wrap_exception_ptr( std::exception_ptr const & e )
            ...
            exception_detail::clone_base const & base =
                zr_boost_1_81::enable_current_exception(std_exception_ptr_wrapper(std::current_exception()));
    ...
    exception_ptr
        {
        typedef zr_boost_1_81::shared_ptr<exception_detail::clone_base const> impl;
        impl ptr_;
    ...
    copy_exception( E const & e )
        ...
        return exception_ptr(zr_boost_1_81::make_shared<wrapexcept<E> >(cp));
        }
    ...
    make_exception_ptr( T const & e )
        {
        return zr_boost_1_81::copy_exception(e);
        }
...
# endif
    ...
    class
    unknown_exception:
        public zr_boost_1_81::exception,
        ...
        explicit
        unknown_exception( zr_boost_1_81::exception const & e ):
            zr_boost_1_81::exception(e)
            {
            add_original_type(e);
            }
...
# endif
    ...
    exception_detail
        ...
        current_exception_std_exception_wrapper:
            ...
            current_exception_std_exception_wrapper( T const & e1, zr_boost_1_81::exception const & e2 ):
                T(e1),
                zr_boost_1_81::exception(e2)
                {
                add_original_type(e1);
                }
        ...
        get_boost_exception( T const * x )
            {
            return dynamic_cast<zr_boost_1_81::exception const *>(x);
            }
#endif
        ...
        current_exception_std_exception( T const & e1 )
            {
            if( zr_boost_1_81::exception const * e2 = get_boost_exception(&e1) )
                return zr_boost_1_81::copy_exception(current_exception_std_exception_wrapper<T>(e1,*e2));
            else
                return zr_boost_1_81::copy_exception(current_exception_std_exception_wrapper<T>(e1));
            }
        ...
        current_exception_unknown_exception()
            {
            return zr_boost_1_81::copy_exception(unknown_exception());
            }

        inline
        exception_ptr
        current_exception_unknown_boost_exception( zr_boost_1_81::exception const & e )
            {
            return zr_boost_1_81::copy_exception(unknown_exception(e));
            }
        ...
        current_exception_unknown_std_exception( std::exception const & e )
            {
            if( zr_boost_1_81::exception const * be = get_boost_exception(&e) )
