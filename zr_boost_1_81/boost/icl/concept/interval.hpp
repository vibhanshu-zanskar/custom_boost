...
<
    mpl::and_< is_static_right_open<Type>
             , zr_boost_1_81::detail::is_incrementable<typename interval_traits<Type>::domain_type> >
  , Type
>::type
...
template<class Type>
typename zr_boost_1_81::enable_if<is_asymmetric_interval<Type>, bool>::type
...
template<class Type>
typename zr_boost_1_81::enable_if<is_static_closed<Type>, bool>::type
is_empty(const Type& object)
{
...
template<class Type>
typename zr_boost_1_81::enable_if<is_static_open<Type>, bool>::type
is_empty(const Type& object)
{
    return domain_less_equal<Type>(upper(object),                   lower(object) )
...
template<class Type>
typename zr_boost_1_81::enable_if<is_discrete_interval<Type>, bool>::type
is_empty(const Type& object)
{
...
template<class Type>
typename zr_boost_1_81::enable_if<is_continuous_interval<Type>, bool>::type
is_empty(const Type& object)
{
    return     domain_less<Type>(upper(object), lower(object))
...
/** Maximal element of <tt>left</tt> is less than the minimal element of
    <tt>right</tt> */
template<class Type>
inline typename zr_boost_1_81::enable_if<is_asymmetric_interval<Type>, bool>::type
...
template<class Type>
inline typename zr_boost_1_81::enable_if<is_discrete_interval<Type>, bool>::type
exclusive_less(const Type& left, const Type& right)
{
    return icl::is_empty(left) || icl::is_empty(right)
...
template<class Type>
inline typename zr_boost_1_81::enable_if<is_continuous_interval<Type>, bool>::type
exclusive_less(const Type& left, const Type& right)
{
    return     icl::is_empty(left) || icl::is_empty(right)
...
//------------------------------------------------------------------------------
template<class Type>
typename zr_boost_1_81::enable_if<has_static_bounds<Type>, bool>::type
...
//------------------------------------------------------------------------------
template<class Type>
typename zr_boost_1_81::enable_if<has_dynamic_bounds<Type>,
                          typename Type::bounded_domain_type   >::type
...
template<class Type>
typename zr_boost_1_81::enable_if<has_symmetric_bounds<Type>, bool>::type
lower_equal(const Type& left, const Type& right)
{
...
//------------------------------------------------------------------------------
template<class Type>
typename zr_boost_1_81::enable_if<is_interval<Type>, bool>::type
...
namespace non_empty
{
    ...
    template<class Type>
    inline typename zr_boost_1_81::enable_if<is_interval<Type>, bool>::type
...
template<class Type>
typename zr_boost_1_81::enable_if<is_discrete_static<Type>, bool>::type
...
template<class Type>
typename zr_boost_1_81::enable_if<is_continuous_left_open<Type>, bool>::type
contains(const Type& super, const typename interval_traits<Type>::domain_type& element)
{
...
template<class Type>
typename zr_boost_1_81::enable_if<is_continuous_right_open<Type>, bool>::type
contains(const Type& super, const typename interval_traits<Type>::domain_type& element)
{
...
template<class Type>
typename zr_boost_1_81::enable_if<has_dynamic_bounds<Type>, bool>::type
contains(const Type& super, const typename interval_traits<Type>::domain_type& element)
{
    return
...
template<class Type>
typename zr_boost_1_81::enable_if<is_continuous_interval<Type>,
...
template<class Type>
typename zr_boost_1_81::enable_if<is_discrete_interval<Type>,
    typename size_type_of<interval_traits<Type> >::type>::type
cardinality(const Type& object)
{
    typedef typename size_type_of<interval_traits<Type> >::type SizeT;
...
template<class Type>
typename zr_boost_1_81::enable_if<is_continuous_asymmetric<Type>,
    typename size_type_of<interval_traits<Type> >::type>::type
cardinality(const Type& object)
{
    typedef typename size_type_of<interval_traits<Type> >::type SizeT;
...
template<class Type>
typename zr_boost_1_81::enable_if<is_discrete_asymmetric<Type>,
    typename size_type_of<interval_traits<Type> >::type>::type
cardinality(const Type& object)
{
    typedef typename size_type_of<interval_traits<Type> >::type SizeT;
...
template<class Type>
typename zr_boost_1_81::enable_if<has_symmetric_bounds<Type>,
    typename size_type_of<interval_traits<Type> >::type>::type
cardinality(const Type& object)
{
    typedef typename size_type_of<interval_traits<Type> >::type SizeT;
...
//- length ---------------------------------------------------------------------
template<class Type>
inline typename zr_boost_1_81::enable_if<is_continuous_interval<Type>,
...
template<class Type>
inline typename zr_boost_1_81::enable_if<is_discrete_interval<Type>,
    typename difference_type_of<interval_traits<Type> >::type>::type
length(const Type& object)
{
    typedef typename difference_type_of<interval_traits<Type> >::type DiffT;
...
template<class Type>
inline typename zr_boost_1_81::enable_if<is_discrete_static<Type>,
    typename difference_type_of<interval_traits<Type> >::type>::type
length(const Type& object)
{
    typedef typename difference_type_of<interval_traits<Type> >::type DiffT;
...
template<class Type>
typename zr_boost_1_81::enable_if<has_static_bounds<Type>, Type>::type
...
template<class Type>
typename zr_boost_1_81::enable_if<has_dynamic_bounds<Type>, Type>::type
hull(Type left, const Type& right)
{
    if(icl::is_empty(right))
        return left;
...
*/
template<class Type>
typename zr_boost_1_81::enable_if<is_asymmetric_interval<Type>, Type>::type
...
template<class Type>
typename zr_boost_1_81::enable_if<is_static_closed<Type>, Type>::type
left_subtract(Type right, const Type& left_minuend)
{
    if(exclusive_less(left_minuend, right))
        return right;
...
template<class Type>
typename zr_boost_1_81::enable_if<is_static_open<Type>, Type>::type
left_subtract(Type right, const Type& left_minuend)
{
    if(exclusive_less(left_minuend, right))
        return right;
...
template<class Type>
typename zr_boost_1_81::enable_if<has_symmetric_bounds<Type>, Type>::type
operator & (Type left, const Type& right)
{
    typedef typename interval_traits<Type>::domain_compare domain_compare;
...
template<class Type>
typename zr_boost_1_81::enable_if<is_discrete_static_closed<Type>, Type>::type
inner_complement(const Type& left, const Type& right)
{
    if(icl::is_empty(left) || icl::is_empty(right))
        return  identity_element<Type>::value();
...
template<class Type>
typename zr_boost_1_81::enable_if<is_discrete_static_open<Type>, Type>::type
inner_complement(const Type& left, const Type& right)
{
    if(icl::is_empty(left) || icl::is_empty(right))
        return  identity_element<Type>::value();
...
template<class Type>
inline typename zr_boost_1_81::enable_if<is_interval<Type>, Type>::type
...
template<class Type>
typename zr_boost_1_81::enable_if<has_dynamic_bounds<Type>, std::string>::type
