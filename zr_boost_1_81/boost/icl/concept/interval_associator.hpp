...
{
    Type temp = object;
    return zr_boost_1_81::move(temp += operand); 
}
...
operator + (Type&& object, const OperandT& operand)
{
    return zr_boost_1_81::move(object += operand); 
}
...
typename enable_if<mpl::and_< is_interval_container<Type>
                            , zr_boost_1_81::is_same<CoType, typename domain_type_of<Type>::type> >, 
                   bool>::type
...
template<class Type, class CoType>
typename enable_if<mpl::and_< is_interval_container<Type>
                            , zr_boost_1_81::is_same<CoType, typename interval_type_of<Type>::type> >, 
                   bool>::type
intersects(const Type& left, const CoType& right)
{
