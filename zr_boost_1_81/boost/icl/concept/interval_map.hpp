...
typename enable_if<mpl::and_< is_interval_map<Type>
                            , is_total<Type>
                            , zr_boost_1_81::is_same< OperandT
...
typename enable_if<mpl::and_< is_interval_map<Type>
                            , mpl::not_<is_total<Type> >
                            , zr_boost_1_81::is_same<OperandT, typename segment_type_of<Type>::type> >, 
                   bool>::type
...
template<class Type, class OperandT>
typename enable_if<mpl::and_< is_interval_map<Type>
                            , zr_boost_1_81::is_same<OperandT, typename element_type_of<Type>::type> >, 
                   bool>::type
intersects(const Type& object, const OperandT& operand)
{
