...
struct is_overloadable
{
    ...
    BOOST_STATIC_CONSTANT(bool, value = 
        (zr_boost_1_81::is_same<Type, typename Type::overloadable_type>::value)
        );
};
...
struct is_codomain_equal
{
    ...
    BOOST_STATIC_CONSTANT(bool, value =
        (zr_boost_1_81::is_same<typename LeftT::codomain_type, 
...
struct is_key_compare_equal
{
    ...
    BOOST_STATIC_CONSTANT(bool, value =
        (zr_boost_1_81::is_same<typename LeftT::key_compare, 
