...
namespace zr_boost_1_81{namespace icl
{
    ...
    template <typename Type> struct identity_based_inplace_combine 
    {
        ...
        inline static Type identity_element() { return zr_boost_1_81::icl::identity_element<Type>::value(); }
    };
    ...
    template <typename Type> struct unit_element_based_inplace_combine 
    {
        ...
        typedef const Type& second_argument_type;
        typedef void result_type;
        inline static Type identity_element() { return zr_boost_1_81::icl::unit_element<Type>::value(); }
    };
