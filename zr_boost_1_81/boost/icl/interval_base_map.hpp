...
public:
    ...
    typedef typename zr_boost_1_81::call_traits<DomainT>::param_type domain_param;
    /// Domain type (type of the keys) of the map
    ...
    typedef zr_boost_1_81::icl::element_iterator<iterator> element_iterator; 
    /// const element iterator: Depreciated, see documentation.
    typedef zr_boost_1_81::icl::element_iterator<const_iterator> element_const_iterator; 
    /// element reverse iterator: Depreciated, see documentation.
    typedef zr_boost_1_81::icl::element_iterator<reverse_iterator> element_reverse_iterator; 
    /// element const reverse iterator: Depreciated, see documentation.
    typedef zr_boost_1_81::icl::element_iterator<const_reverse_iterator> element_const_reverse_iterator; 
...
#   ifndef BOOST_ICL_NO_CXX11_RVALUE_REFERENCES
    ...
    /** Move constructor */
    interval_base_map(interval_base_map&& src): _map(zr_boost_1_81::move(src._map))
    {
        BOOST_CONCEPT_ASSERT((DefaultConstructibleConcept<DomainT>));
        BOOST_CONCEPT_ASSERT((LessThanComparableConcept<DomainT>));
        BOOST_CONCEPT_ASSERT((DefaultConstructibleConcept<CodomainT>));
    ...
    {                           //call by value sice 'src' is a "sink value" 
        this->_map = zr_boost_1_81::move(src._map);
        return *this; 
    }
...
inline void interval_base_map<SubType,DomainT,CodomainT,Traits,Compare,Combine,Section,Interval,Alloc>
    ::insert_main(const interval_type& inter_val, const CodomainT& co_val, 
                  iterator& it_, const iterator& last_)
{
    iterator end_   = zr_boost_1_81::next(last_);
