...
#define BOOST_DECLARE_HAS_MEMBER(__trait_name__, __member_name__)                           \
    ...
    {                                                                                       \
        using check_type = typename zr_boost_1_81::remove_const<__boost_has_member_T__>::type;      \
        using   yes_type = ::zr_boost_1_81::type_traits::yes_type;                                  \
        using    no_type = ::zr_boost_1_81::type_traits:: no_type;                                  \
                                                                                            \
