...
namespace zr_boost_1_81 { namespace cnv
{
    namespace detail
    {
    ...
    template<typename T> struct is_range : detail::is_range<typename zr_boost_1_81::remove_const<T>::type, zr_boost_1_81::is_class<T>::value> {};
    ...
    {
        using       type = typename zr_boost_1_81::range_iterator<T>::type;
        using const_type = typename zr_boost_1_81::range_iterator<T const>::type;
        using value_type = typename zr_boost_1_81::iterator_value<type>::type;
    };
    template<typename T>
    struct iterator<T*, void>
    {
        using value_type = typename zr_boost_1_81::remove_const<T>::type;
        using       type = T*;
