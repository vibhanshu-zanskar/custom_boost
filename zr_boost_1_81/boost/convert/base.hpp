...
namespace zr_boost_1_81 { namespace cnv { template<typename> struct cnvbase; }}
...
struct zr_boost_1_81::cnv::cnvbase
{
    ...
    void
    operator()(type_in const& in, zr_boost_1_81::optional<type_out>& out) const
    {
        in >> out;
    }
    ...
    template<typename argument_pack>
    typename std::enable_if<zr_boost_1_81::parameter::is_argument_pack<argument_pack>::value, derived_type&>::type
...
//  BOOST_CNV_PARAM_SET(locale)    { locale_    = arg[cnv::parameter::   locale]; }
    ...
    int              width_ = 0;
    int               fill_ = ' ';
    cnv::base         base_ = zr_boost_1_81::cnv::base::dec;
    cnv::adjust     adjust_ = zr_boost_1_81::cnv::adjust::right;
    cnv::notation notation_ = zr_boost_1_81::cnv::notation::fixed;
//  std::locale     locale_;
};
