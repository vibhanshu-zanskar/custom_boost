...
struct prime_list_holder
{
   ...
   static const std::size_t *suggested_lower_bucket_count_ptr(std::size_t n)
   {
      ...
      std::size_t const* bound =
         zr_boost_1_81::movelib::lower_bound(primes, primes_end, n, value_less<std::size_t>());
   ...
   static const std::size_t *suggested_upper_bucket_count_ptr(std::size_t n)
   {
      ...
      const std::size_t *primes_end = primes + prime_list_size;
      std::size_t const* bound =
         zr_boost_1_81::movelib::upper_bound(primes, primes_end, n, value_less<std::size_t>());
      bound -= std::size_t(bound == primes_end);
      return bound;
   }
...
template<class InputIt, class T>
typename zr_boost_1_81::intrusive::iterator_traits<InputIt>::difference_type
   priv_algo_count(InputIt first, InputIt last, const T& value)
{
   typename zr_boost_1_81::intrusive::iterator_traits<InputIt>::difference_type ret = 0;
   for (; first != last; ++first) {
      if (*first == value) {
            ret++;
      }
...
{
   typedef typename
      zr_boost_1_81::intrusive::iterator_traits<ForwardIterator2>::difference_type
         distance_type;
   ...
   zr_boost_1_81::intrusive::iterator_advance(last2, zr_boost_1_81::intrusive::iterator_distance(first1, last1));
...
struct bucket_plus_vtraits
{
   ...
   BOOST_INTRUSIVE_FORCEINLINE bucket_plus_vtraits(BOOST_RV_REF(bucket_plus_vtraits) other)
      : m_data(zr_boost_1_81::move(((bucket_plus_vtraits&)other).m_data))
   {}
...
{
   typedef ::zr_boost_1_81::hash<T> type;
};
...
{
   typedef ::zr_boost_1_81::intrusive::detail::identity<T> type;
};
   ...
   , public hashtable_equal_holder<ValueTraits, BucketTraits, VoidOrKeyOfValue, VoidOrKeyEqual, LinearBuckets>::type
{
   ...
   {  ::zr_boost_1_81::adl_move_swap(this->cached_begin_, other.cached_begin_);  }
   ...
   : public DeriveFrom
{
   ...
   hashtable_size_wrapper( BOOST_FWD_REF(Base) base, BOOST_FWD_REF(Arg0) arg0
      ...
      :  DeriveFrom( ::zr_boost_1_81::forward<Base>(base)
                   , ::zr_boost_1_81::forward<Arg0>(arg0)
                   , ::zr_boost_1_81::forward<Arg1>(arg1)
                   , ::zr_boost_1_81::forward<Arg2>(arg2))
   {}
         ...
         <ValueTraits, VoidOrKeyOfValue, VoidOrKeyHash, VoidOrKeyEqual, BucketTraits, SizeType, BoolFlags>::type
{
   ...
   bool empty() const BOOST_NOEXCEPT
   {
      BOOST_IF_CONSTEXPR(constant_time_size){
         ...
         const bucket_type *b = zr_boost_1_81::movelib::to_raw_pointer(this->priv_bucket_pointer());
   ...
   {
      //These can throw
      ::zr_boost_1_81::adl_move_swap(this->priv_equal(),  other.priv_equal());
      ::zr_boost_1_81::adl_move_swap(this->priv_hasher(), other.priv_hasher());
      //These can't throw
      ::zr_boost_1_81::adl_move_swap(this->priv_bucket_traits(), other.priv_bucket_traits());
      ::zr_boost_1_81::adl_move_swap(this->priv_value_traits(), other.priv_value_traits());
   ...
   friend bool operator==(const hashtable_impl &x, const hashtable_impl &y)
   {
      ...
      if (zr_boost_1_81::intrusive::iterator_udistance(x.begin(), x.end()) != x.size())
         return false;
      ...
      for (const_iterator ix = x.cbegin(), ex = x.cend(); ix != ex; ++ix){
         ...
         if (zr_boost_1_81::intrusive::iterator_distance(eqx.first, eqx.second) !=
             zr_boost_1_81::intrusive::iterator_distance(eqy.first, eqy.second) ||
      ...
      , size_type &cnt) const
   {
      ...
      if(to_return.first != to_return.second){
         ...
         BOOST_IF_CONSTEXPR(optimize_multikey){
            ...
            internal_cnt += zr_boost_1_81::intrusive::iterator_udistance(++it, past_last_in_group_it) + 1u;
