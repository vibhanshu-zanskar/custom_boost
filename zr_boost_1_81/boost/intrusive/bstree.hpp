...
struct bstbase3
{
   ...
   typedef zr_boost_1_81::intrusive::reverse_iterator<iterator>                                         reverse_iterator;
   typedef zr_boost_1_81::intrusive::reverse_iterator<const_iterator>                                   const_reverse_iterator;
   ...
   typedef typename zr_boost_1_81::intrusive::value_traits_pointers
...
{
   typedef typename
      zr_boost_1_81::movelib::pointer_element<ValuePtr>::type value_type;
   ...
   :  public bstbase<ValueTraits, VoidOrKeyOfValue, VoidOrKeyComp, ConstantTimeSize, SizeType, AlgoType, HeaderHolder>
{
   ...
   typedef BOOST_INTRUSIVE_IMPDEF(zr_boost_1_81::intrusive::reverse_iterator<iterator>)                 reverse_iterator;
   typedef BOOST_INTRUSIVE_IMPDEF(zr_boost_1_81::intrusive::reverse_iterator<const_iterator>)           const_reverse_iterator;
   ...
   bstree_impl(BOOST_RV_REF(bstree_impl) x)
      : data_type(::zr_boost_1_81::move(x.get_comp()), ::zr_boost_1_81::move(x.get_value_traits()))
   {
      this->swap(x);
   }
   ...
   {
      //This can throw
      ::zr_boost_1_81::adl_move_swap(this->get_comp(), other.get_comp());
      //These can't throw
   ...
   //! @copydoc ::zr_boost_1_81::intrusive::bstree::upper_bound(const key_type &)
   ...
   friend bool operator==(const bstree_impl &x, const bstree_impl &y)
   {
      ...
      return zr_boost_1_81::intrusive::algo_equal(x.cbegin(), x.cend(), y.cbegin(), y.cend());
   }
