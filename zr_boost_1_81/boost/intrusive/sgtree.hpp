...
struct alpha_holder
{
   typedef zr_boost_1_81::intrusive::detail::h_alpha_t           h_alpha_t;
   typedef zr_boost_1_81::intrusive::detail::alpha_by_max_size_t multiply_by_alpha_t;
...
struct alpha_holder<false, SizeType>
{
   ...
   typedef zr_boost_1_81::intrusive::detail::h_alpha_sqrt2_t           h_alpha_t;
   typedef zr_boost_1_81::intrusive::detail::alpha_0_75_by_max_size_t  multiply_by_alpha_t;
   ...
   /// @endcond
{
   ...
   {  ::zr_boost_1_81::adl_move_swap(this->get_alpha_traits(), x.get_alpha_traits());   }
   ...
   void swap(sgtree_impl& other)
   {
      ...
      ::zr_boost_1_81::adl_move_swap(this->get_alpha_traits(), other.get_alpha_traits());
   }
   ...
   void clone_from(BOOST_RV_REF(sgtree_impl) src, Cloner cloner, Disposer disposer)
   {
      ...
      this->get_alpha_traits() = ::zr_boost_1_81::move(src.get_alpha_traits());
   }
   ...
   #if defined(BOOST_INTRUSIVE_DOXYGEN_INVOKED)
   //! @copydoc ::zr_boost_1_81::intrusive::bstree::merge_unique
   ...
   #if defined(BOOST_INTRUSIVE_DOXYGEN_INVOKED)
   //! @copydoc ::zr_boost_1_81::intrusive::bstree::merge_equal
   ...
   #ifdef BOOST_INTRUSIVE_DOXYGEN_INVOKED
   //! @copydoc ::zr_boost_1_81::intrusive::bstree::count(const key_type &)const
   ...
   //! @copydoc ::zr_boost_1_81::intrusive::bstree::rebalance
   void rebalance() BOOST_NOEXCEPT;

   //! @copydoc ::zr_boost_1_81::intrusive::bstree::rebalance_subtree
