...
struct value_traits_pointers
{
   typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_DEFAULT
      ...
      , typename zr_boost_1_81::intrusive::pointer_traits<typename ValueTraits::node_traits::node_ptr>::template
         rebind_pointer<ValueTraits>::type)   value_traits_ptr;

   typedef typename zr_boost_1_81::intrusive::pointer_traits<value_traits_ptr>::template
...
struct iiterator
{
   ...
   typedef ::zr_boost_1_81::intrusive::pointer_traits<node_ptr>        nodepointer_traits_t;
