...
class ebo_functor_holder
{
   ...
   BOOST_INTRUSIVE_FORCEINLINE ebo_functor_holder(BOOST_FWD_REF(Arg1) arg1, BOOST_FWD_REF(Arg2) arg2)
      : t_(::zr_boost_1_81::forward<Arg1>(arg1), ::zr_boost_1_81::forward<Arg2>(arg2))
   {}
   ...
   {
      this->get() = ::zr_boost_1_81::move(x.get());
      return *this;
   }
   ...
   :  public T
{
   ...
   BOOST_INTRUSIVE_FORCEINLINE explicit ebo_functor_holder(BOOST_RV_REF(T) t)
      : T(::zr_boost_1_81::move(t))
   {}

   template<class Arg1, class Arg2>
   BOOST_INTRUSIVE_FORCEINLINE ebo_functor_holder(BOOST_FWD_REF(Arg1) arg1, BOOST_FWD_REF(Arg2) arg2)
      : T(::zr_boost_1_81::forward<Arg1>(arg1), ::zr_boost_1_81::forward<Arg2>(arg2))
   {}
