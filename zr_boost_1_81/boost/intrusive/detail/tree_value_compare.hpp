      ...
      || detail::is_same
            <From, typename pointer_traits
                     < typename pointer_rebind
                           < ValuePtr
                           , const typename zr_boost_1_81::movelib::pointer_element<ValuePtr>::type>::type>
                  ::reference>::value
      >
{};
...
template< class ValuePtr, class KeyCompare, class KeyOfValue, class Ret = bool
        , bool = zr_boost_1_81::intrusive::detail::is_same
   <typename zr_boost_1_81::movelib::pointer_element<ValuePtr>::type, typename KeyOfValue::type>::value >
struct tree_value_compare
   :  public zr_boost_1_81::intrusive::detail::ebo_functor_holder<KeyCompare>
{
   typedef typename
   ...
   typedef zr_boost_1_81::intrusive::detail::ebo_functor_holder<KeyCompare> base_t;
