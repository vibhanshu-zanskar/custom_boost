...
struct mhtraits
{
   ...
   BOOST_INTRUSIVE_FORCEINLINE static pointer to_value_ptr(node_ptr n)
   {
      return pointer_traits<pointer>::pointer_to
         (*detail::parent_from_member<T, Hook>
            (static_cast<Hook*>(zr_boost_1_81::movelib::to_raw_pointer(n)), P));
   }
   ...
   BOOST_INTRUSIVE_FORCEINLINE static const_pointer to_value_ptr(const_node_ptr n)
   {
      return pointer_traits<const_pointer>::pointer_to
         (*detail::parent_from_member<T, Hook>
            (static_cast<const Hook*>(zr_boost_1_81::movelib::to_raw_pointer(n)), P));
   }
};
...
struct fhtraits
{
   ...
   {  return static_cast<node*>(zr_boost_1_81::movelib::to_raw_pointer(Functor::to_hook_ptr(value)));  }

   static const_node_ptr to_node_ptr(const_reference value)
   {  return static_cast<const node*>(zr_boost_1_81::movelib::to_raw_pointer(Functor::to_hook_ptr(value)));  }
