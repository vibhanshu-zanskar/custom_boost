...
using zr_boost_1_81::movelib::iterator_traits;
using zr_boost_1_81::movelib::iter_difference;
using zr_boost_1_81::movelib::iter_value;
using zr_boost_1_81::movelib::iter_category;
using zr_boost_1_81::movelib::iter_size;
...
////////////////////////////////////////////////////////////////////////////////
//    Conversion from zr_boost_1_81::iterator traversals to std tags
////////////////////////////////////////////////////////////////////////////////
...
struct get_std_category_from_tag
   <zr_boost_1_81::iterators::detail::iterator_category_with_traversal
      <Category, zr_boost_1_81::iterators::incrementable_traversal_tag> >
{
...
struct get_std_category_from_tag
   <zr_boost_1_81::iterators::detail::iterator_category_with_traversal
      <Category, zr_boost_1_81::iterators::single_pass_traversal_tag> >
{
   typedef std::input_iterator_tag type;
};
...
struct get_std_category_from_tag
   <zr_boost_1_81::iterators::detail::iterator_category_with_traversal
      <Category, zr_boost_1_81::iterators::forward_traversal_tag> >
{
   typedef std::input_iterator_tag type;
};
...
struct get_std_category_from_tag
   <zr_boost_1_81::iterators::detail::iterator_category_with_traversal
      <Category, zr_boost_1_81::iterators::bidirectional_traversal_tag> >
{
...
struct get_std_category_from_tag
   <zr_boost_1_81::iterators::detail::iterator_category_with_traversal
      <Category, zr_boost_1_81::iterators::random_access_traversal_tag> >
{
...
struct get_std_category_from_it
   : get_std_category_from_tag< typename zr_boost_1_81::intrusive::iter_category<It>::type >
{};
...
struct iterator_enable_if_tag
   : ::zr_boost_1_81::move_detail::enable_if_c
      < ::zr_boost_1_81::move_detail::is_same
...
struct iterator_enable_if_convertible_tag
   : ::zr_boost_1_81::move_detail::enable_if_c
      < ::zr_boost_1_81::move_detail::is_same_or_convertible
         < typename get_std_category_from_it<I>::type
         , Tag
         >::value &&
        !::zr_boost_1_81::move_detail::is_same_or_convertible
...
struct iterator_enable_if_tag_difference_type
   : iterator_enable_if_tag<I, Tag, typename zr_boost_1_81::intrusive::iter_difference<I>::type>
{};

template<class I, class Tag>
struct iterator_disable_if_tag_difference_type
   : iterator_disable_if_tag<I, Tag, typename zr_boost_1_81::intrusive::iter_difference<I>::type>
{};
