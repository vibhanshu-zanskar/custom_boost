   ...
   /// @endcond
{
   ...
   treap_impl(BOOST_RV_REF(treap_impl) x)
      ...
      , prio_base(::zr_boost_1_81::move(x.priv_pcomp()))
   {}
   ...
   {
      //This can throw
      ::zr_boost_1_81::adl_move_swap(this->priv_pcomp(), other.priv_pcomp());
   ...
   void clone_from(BOOST_RV_REF(treap_impl) src, Cloner cloner, Disposer disposer)
   {
      ...
      this->priv_pcomp() = ::zr_boost_1_81::move(src.priv_pcomp());
   }
   ...
   //! @copydoc ::zr_boost_1_81::intrusive::bstree::check(ExtraChecker)const
   ...
   //! @copydoc ::zr_boost_1_81::intrusive::bstree::check()const
   void check() const
