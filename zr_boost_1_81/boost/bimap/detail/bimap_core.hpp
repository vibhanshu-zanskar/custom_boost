...
class bimap_core
{
    ...
    typedef BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::bimaps::tags::support::default_tagged
    <
    ...
    typedef ::zr_boost_1_81::bimaps::relation::mutant_relation
    <

        ::zr_boost_1_81::bimaps::tags::tagged<
            ...
            // else
            // {
                    BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::add_const< left_key_type >::type
            // }
        ...
        ::zr_boost_1_81::bimaps::tags::tagged<
            ...
            // else
            // {
                    BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::add_const< right_key_type >::type
            // }
        ...
        // It is ::zr_boost_1_81::mpl::na if no info_hook was included
    ...
    typedef BOOST_DEDUCED_TYPENAME mpl::if_<
        ::zr_boost_1_81::bimaps::detail::is_unconstrained_set_of< left_set_type >,
    // {
            mpl::vector<>,
    // }
    // else
    ...
    typedef BOOST_DEDUCED_TYPENAME mpl::if_<
        ::zr_boost_1_81::bimaps::detail::is_unconstrained_set_of< right_set_type >,
    // {
            left_core_indices,
    // }
    // else
    ...
    // {
            ::zr_boost_1_81::bimaps::tags::tagged< left_set_type, left_tag >,
    // }
    /* else */ BOOST_DEDUCED_TYPENAME mpl::if_<
            is_same< BOOST_DEDUCED_TYPENAME parameters::set_type_of_relation, right_based >,
    // {
            ::zr_boost_1_81::bimaps::tags::tagged< right_set_type, right_tag >,
    // }
    // else
    // {
            tags::tagged
    ...
    // {
            ...
            <
                ...
                BOOST_NESTED_TEMPLATE index_bind
                <
                    ::zr_boost_1_81::bimaps::relation::support::both_keys_extractor<relation>,
                    independent_index_tag
    ...
    <
        relation,
        core_indices,
        BOOST_DEDUCED_TYPENAME zr_boost_1_81::allocator_rebind<BOOST_DEDUCED_TYPENAME
    ...
    typedef BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::multi_index::
    ...
    typedef BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::multi_index::index
    <
