...
/** \struct zr_boost_1_81::bimaps::left_based
...
/** \struct zr_boost_1_81::bimaps::right_based
...
struct left_based : ::zr_boost_1_81::bimaps::detail::side_based_tag
{
...
struct right_based : ::zr_boost_1_81::bimaps::detail::side_based_tag
{
    // I run into troubles if I do not define bind for side based tags.
    // Maybe a more coherent way of binding the relation can be developed.
    template< class Relation > struct bind_to { typedef void type; };
