...
template< class Type >
struct is_with_info : ::zr_boost_1_81::mpl::false_ {};

template< class ValueType >
struct is_with_info< with_info<ValueType> > : ::zr_boost_1_81::mpl::true_ {};

/** \struct zr_boost_1_81::bimaps::detail::manage_additional_parameters
\brief Utility class to extract the additional parameters from the template parameters.
...
struct manage_additional_parameters
{
    ...
    struct case_NNN
    {
        ...
        typedef ::zr_boost_1_81::mpl::na additional_info;
    };
    ...
    <
        ::zr_boost_1_81::mpl::is_na<AP1>,
        case_NNN, // (1)
        BOOST_DEDUCED_TYPENAME mpl::if_
        <
            ::zr_boost_1_81::mpl::is_na<AP2>,
            BOOST_DEDUCED_TYPENAME mpl::if_
            <
