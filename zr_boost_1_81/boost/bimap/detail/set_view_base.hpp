...
class set_view_key_to_base<MutantRelationStorage,MutantRelationStorage,KeyToBase>
{
    ...
    {
        return ::zr_boost_1_81::bimaps::relation::detail::mutate<MutantRelationStorage>(k);
    }
...
<                                                                             \
    ...
    <                                                                         \
        ::zr_boost_1_81::bimaps::detail::      set_view_iterator<                     \
            BOOST_DEDUCED_TYPENAME CORE_INDEX::iterator>,                     \
        ::zr_boost_1_81::bimaps::detail::const_set_view_iterator<                     \
            BOOST_DEDUCED_TYPENAME CORE_INDEX::const_iterator>                \
                                                                              \
    >,                                                                        \
    ...
    ::zr_boost_1_81::bimaps::relation::support::                                      \
        get_above_view_functor<                                               \
            BOOST_DEDUCED_TYPENAME CORE_INDEX::value_type >,                  \
    ::zr_boost_1_81::bimaps::detail::set_view_key_to_base<                            \
...
#define BOOST_BIMAP_SET_VIEW_BASE_FRIEND(TYPE,INDEX_TYPE)                     \
    typedef ::zr_boost_1_81::bimaps::detail::set_view_base<                           \
...
/*===========================================================================*/
#define BOOST_BIMAP_SET_VIEW_BASE_FRIEND(TYPE,INDEX_TYPE)                     \
    friend class ::zr_boost_1_81::bimaps::detail::set_view_base<                      \
...
class set_view_base
{
                      ...
                      const CompatibleLeftType & l)
    {
        return derived().base().replace(
            ...
            ::zr_boost_1_81::bimaps::relation::detail::copy_with_left_replaced(*position,l)
        );
    }
                       ...
                       const CompatibleRightType & r)
    {
        return derived().base().replace(
            derived().template functor<iterator_to_base_>()(position),
            ::zr_boost_1_81::bimaps::relation::detail::copy_with_right_replaced(*position,r)
        );
    }
                ...
                Modifier mod)
    {
        return derived().base().modify(
            ...
            <
                ...
                data_extractor
                <
                    ::zr_boost_1_81::bimaps::relation::member_at::left,
                    BOOST_DEDUCED_TYPENAME Index::value_type
                ...
                data_extractor
                <
                    ::zr_boost_1_81::bimaps::relation::member_at::right,
                    BOOST_DEDUCED_TYPENAME Index::value_type
    ...
    */
    ...
    bool modify_left(iterator_ position, Modifier mod)
    {
        ...
        data_extractor
        <
            BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::bimaps::relation::member_at::right,
            BOOST_DEDUCED_TYPENAME Index::value_type
