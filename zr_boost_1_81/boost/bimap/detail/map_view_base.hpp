...
::zr_boost_1_81::bimaps::container_adaptor::CONTAINER_ADAPTOR                         \
<                                                                             \
    BOOST_DEDUCED_TYPENAME BIMAP::core_type::                                 \
        BOOST_NESTED_TEMPLATE index<TAG>::type,                               \
    ::zr_boost_1_81::bimaps::detail::      map_view_iterator<TAG,BIMAP>,              \
    ::zr_boost_1_81::bimaps::detail::const_map_view_iterator<TAG,BIMAP>,              \
    ::zr_boost_1_81::bimaps::detail::      OTHER_ITER<TAG,BIMAP>,                     \
    ::zr_boost_1_81::bimaps::detail::CONST_OTHER_ITER<TAG,BIMAP>,                     \
    ::zr_boost_1_81::bimaps::container_adaptor::support::iterator_facade_to_base      \
    <                                                                         \
        ::zr_boost_1_81::bimaps::detail::      map_view_iterator<TAG,BIMAP>,          \
        ::zr_boost_1_81::bimaps::detail::const_map_view_iterator<TAG,BIMAP>           \
    >,                                                                        \
    ::zr_boost_1_81::mpl::na,                                                         \
    ::zr_boost_1_81::mpl::na,                                                         \
    ::zr_boost_1_81::bimaps::relation::detail::                                       \
        pair_to_relation_functor<TAG,BOOST_DEDUCED_TYPENAME BIMAP::relation>, \
    ::zr_boost_1_81::bimaps::relation::support::                                      \
...
#define BOOST_BIMAP_MAP_VIEW_BASE_FRIEND(TYPE,TAG,BIMAP)                      \
    typedef ::zr_boost_1_81::bimaps::detail::map_view_base<                           \
...
/*===========================================================================*/
#define BOOST_BIMAP_MAP_VIEW_BASE_FRIEND(TYPE,TAG,BIMAP)                      \
    friend class ::zr_boost_1_81::bimaps::detail::map_view_base<                      \
...
class map_view_base
{
    typedef ::zr_boost_1_81::bimaps::container_adaptor::support::
        iterator_facade_to_base<
            ::zr_boost_1_81::bimaps::detail::      map_view_iterator<Tag,BimapType>,
            ::zr_boost_1_81::bimaps::detail::const_map_view_iterator<Tag,BimapType>
        > iterator_to_base_;
    ...
    typedef BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::bimaps::relation::support::
           pair_type_by<Tag,
              BOOST_DEDUCED_TYPENAME BimapType::relation>::type value_type_;

    typedef 
        ::zr_boost_1_81::bimaps::detail::map_view_iterator<Tag,BimapType> iterator_;
    ...
    bool modify(iterator_ position, Modifier mod)
    {
        return derived().base().modify(
            ...
            ::zr_boost_1_81::bimaps::detail::relation_modifier_adaptor
            <
                Modifier,
    ...
    */
    ...
    bool modify_data(iterator_ position, Modifier mod)
    {
        ...
        return derived().base().modify(
            ...
            // ::zr_boost_1_81::bind( mod, ::zr_boost_1_81::bind(data_extractor_(),_1) )

            ::zr_boost_1_81::bimaps::detail::unary_modifier_adaptor
            <
                Modifier,
                BOOST_DEDUCED_TYPENAME BimapType::relation,
                data_extractor_
...
class mutable_data_unique_map_view_access
{
    ...
    {
        typedef ::zr_boost_1_81::bimaps::detail::
...
struct unique_map_view_access
{
    ...
    <
        typename ::zr_boost_1_81::is_const<
