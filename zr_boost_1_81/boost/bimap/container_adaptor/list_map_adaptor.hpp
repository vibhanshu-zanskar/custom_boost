...
struct list_map_adaptor_base
{
    ...
    <
        ...
        BOOST_DEDUCED_TYPENAME mpl::push_front<
            ...
            BOOST_DEDUCED_TYPENAME mpl::if_< ::zr_boost_1_81::mpl::is_na<KeyFromBaseValueConverter>,
            // {
...
<
    ...
    class KeyFromBaseValueConverter        = ::zr_boost_1_81::mpl::na,
    ...
    >::type
{
    ...
    typedef BOOST_DEDUCED_TYPENAME mpl::if_< ::zr_boost_1_81::mpl::is_na<KeyFromBaseValueConverter>,
    // {
