...
class container_adaptor
{
    ...
    typedef BOOST_DEDUCED_TYPENAME mpl::if_< ::zr_boost_1_81::mpl::is_na<IteratorToBaseConverter>,
        // {
                ::zr_boost_1_81::bimaps::container_adaptor::detail::
    ...
    typedef BOOST_DEDUCED_TYPENAME mpl::if_< ::zr_boost_1_81::mpl::is_na<IteratorFromBaseConverter>,
        // {
                ::zr_boost_1_81::bimaps::container_adaptor::detail::
    ...
    typedef BOOST_DEDUCED_TYPENAME mpl::if_< ::zr_boost_1_81::mpl::is_na<ValueToBaseConverter>,
        // {
                ::zr_boost_1_81::bimaps::container_adaptor::detail::
    ...
    typedef BOOST_DEDUCED_TYPENAME mpl::if_< ::zr_boost_1_81::mpl::is_na<ValueFromBaseConverter>,
        // {
                ::zr_boost_1_81::bimaps::container_adaptor::detail::
    ...
    std::pair<iterator, bool> insert(
        BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::call_traits< value_type >::param_type x)
    {
    ...
    ::zr_boost_1_81::bimaps::container_adaptor::detail::data_with_functor_bag
    <
        Base &,
