...
struct associative_container_adaptor_base
{
    ...
    <
        ...
        BOOST_DEDUCED_TYPENAME mpl::push_front<
            ...
            BOOST_DEDUCED_TYPENAME mpl::if_< ::zr_boost_1_81::mpl::is_na<KeyToBaseConverter>,
            // {
    ...
    >::type
{
    ...
    typedef BOOST_DEDUCED_TYPENAME mpl::if_< ::zr_boost_1_81::mpl::is_na<KeyToBaseConverter>,
    // {
            detail::key_to_base_identity
            <
                BOOST_DEDUCED_TYPENAME Base::key_type, KeyType
