                ...
                map_view_base< vector_map_view<Tag,BimapType>,Tag,BimapType >
{
    ...
    typedef BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::bimaps::relation::support::data_extractor
    <
        Tag,
    ...
    void remove(BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::call_traits< 
    ...
    {
        this->base().remove_if(
            ::zr_boost_1_81::bimaps::container_adaptor::detail::unary_check_adaptor
            <
                Predicate,
    ...
    {
        this->base().unique(
            ::zr_boost_1_81::bimaps::container_adaptor::detail::comparison_adaptor
            <
...
template< class Tag, class BimapType >
struct left_map_view_extra_typedefs< ::zr_boost_1_81::bimaps::views::vector_map_view<Tag,BimapType> >
{
    private: typedef ::zr_boost_1_81::bimaps::views::vector_map_view<Tag,BimapType> map_view_;
    public : BOOST_BIMAP_MAP_VIEW_EXTRA_TYPEDEFS_BODY(map_view_,left)
};

template< class Tag, class BimapType >
struct right_map_view_extra_typedefs< ::zr_boost_1_81::bimaps::views::vector_map_view<Tag,BimapType> >
{
    private: typedef ::zr_boost_1_81::bimaps::views::vector_map_view<Tag,BimapType> map_view_;
