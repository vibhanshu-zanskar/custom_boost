...
{
    typedef ::zr_boost_1_81::bimaps::container_adaptor::list_map_adaptor
    <
        ...
        ::zr_boost_1_81::bimaps::detail::      reverse_map_view_iterator<Tag,BimapType>,
        ::zr_boost_1_81::bimaps::detail::const_reverse_map_view_iterator<Tag,BimapType>,
        ...
        BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::bimaps::relation::support::data_extractor
        <
            Tag,
...
:
    ...
    public ::zr_boost_1_81::bimaps::detail::
...
template< class Tag, class BimapType >
struct left_map_view_extra_typedefs< ::zr_boost_1_81::bimaps::views::list_map_view<Tag,BimapType> >
{
    private: typedef ::zr_boost_1_81::bimaps::views::list_map_view<Tag,BimapType> map_view_;
    public : BOOST_BIMAP_MAP_VIEW_EXTRA_TYPEDEFS_BODY(map_view_,left)
};

template< class Tag, class BimapType >
struct right_map_view_extra_typedefs< ::zr_boost_1_81::bimaps::views::list_map_view<Tag,BimapType> >
{
    private: typedef ::zr_boost_1_81::bimaps::views::list_map_view<Tag,BimapType> map_view_;
