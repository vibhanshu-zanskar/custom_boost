...
template< class Tag, class BimapType >
struct left_map_view_extra_typedefs< ::zr_boost_1_81::bimaps::views::map_view<Tag,BimapType> >
{
    private: typedef ::zr_boost_1_81::bimaps::views::map_view<Tag,BimapType> map_view_;
    public : BOOST_BIMAP_MAP_VIEW_EXTRA_TYPEDEFS_BODY(map_view_,left)
};

template< class Tag, class BimapType >
struct right_map_view_extra_typedefs< ::zr_boost_1_81::bimaps::views::map_view<Tag,BimapType> >
{
    private: typedef ::zr_boost_1_81::bimaps::views::map_view<Tag,BimapType> map_view_;
