...
the next step will be:
    ...
    - Understand the tagged idiom. (zr_boost_1_81::bimaps::tags)
    - Understand the internals of the relation class (zr_boost_1_81::bimaps::relation)
    - Read the container_adaptor toolbox docs (zr_boost_1_81::bimaps::container_adaptor)
    - Understand the internals of the bimap class. (zr_boost_1_81::bimaps, zr_boost_1_81::bimaps::views
      and zr_boost_1_81::bimaps::detail)
...
<
    ...
    class AP1 = ::zr_boost_1_81::mpl::na,
    class AP2 = ::zr_boost_1_81::mpl::na,
    class AP3 = ::zr_boost_1_81::mpl::na
>
class bimap
:
    // Bimap Core, use mpl magic to find the desired bimap type

    public ::zr_boost_1_81::bimaps::detail::bimap_core<KeyTypeA,KeyTypeB,AP1,AP2,AP3>,
    ...
    public ::zr_boost_1_81::bimaps::detail:: left_map_view_extra_typedefs<
        BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::bimaps::detail::left_map_view_type<
            ::zr_boost_1_81::bimaps::detail::bimap_core<KeyTypeA,KeyTypeB,AP1,AP2,AP3>
        >::type
    >,
    public ::zr_boost_1_81::bimaps::detail::right_map_view_extra_typedefs< 
        BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::bimaps::detail::right_map_view_type<
            ::zr_boost_1_81::bimaps::detail::bimap_core<KeyTypeA,KeyTypeB,AP1,AP2,AP3>
        >::type
    >
{
    typedef BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::bimaps::detail::
   ...
   {}
    ...
    BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::bimaps::support::
    ...
    template< class Tag >
    struct map_by :
        public ::zr_boost_1_81::bimaps::support::map_type_by<Tag,bimap>::type
    {
        typedef BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::bimaps::support::
    ...
    {
        return ::zr_boost_1_81::bimaps::support::map_by<Tag>(*this);
    }

    template< class Tag >
    const BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::bimaps::support::
...
/** \namespace zr_boost_1_81::bimaps::support
\brief Metafunctions to help working with bimaps.
                                                            **/

/** \namespace zr_boost_1_81::bimaps::views
\brief Bimap views.
                                                            **/

/** \namespace zr_boost_1_81::bimaps::views::detail
...
using ::zr_boost_1_81::bimaps::tags::tagged;

namespace member_at = ::zr_boost_1_81::bimaps::relation::member_at;

using ::zr_boost_1_81::multi_index::unbounded;
