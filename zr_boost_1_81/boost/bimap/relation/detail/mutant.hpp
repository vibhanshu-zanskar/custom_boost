...
{
    BOOST_MPL_ASSERT((
        ::zr_boost_1_81::mpl::contains<BOOST_DEDUCED_TYPENAME Type::mutant_views,View>
    ));
    return *reinterpret_cast< View* >(zr_boost_1_81::addressof(m));
}
...
>::type mutate( Type & m )
{
    ...
    return *reinterpret_cast< const View* >(zr_boost_1_81::addressof(m));
}
