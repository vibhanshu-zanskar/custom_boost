...
{
    const Relation
        operator()(const BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::bimaps::relation::support::
...
struct pair_to_relation_functor<
    Tag,::zr_boost_1_81::bimaps::relation::mutant_relation<TA,TB,Info,true> >
{
    typedef ::zr_boost_1_81::bimaps::relation::mutant_relation<TA,TB,Info,true> Relation;

    Relation &
        operator()( BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::bimaps::relation::support::
            pair_type_by<Tag,Relation>::type & p ) const
    {
        return ::zr_boost_1_81::bimaps::relation::detail::mutate<Relation>(p);
    }
...
struct get_mutable_relation_functor< ::zr_boost_1_81::bimaps::relation::mutant_relation<TA,TB,Info,true> >
{
    typedef ::zr_boost_1_81::bimaps::relation::mutant_relation<TA,TB,Info,true> Relation;
    ...
    {
        return ::zr_boost_1_81::bimaps::relation::detail::mutate<Relation>(r);
    }
