    ...
    public symmetrical_base<FirstType,SecondType>
{
    ...
    normal_storage(BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::call_traits<
    ...
    public symmetrical_base<SecondType,FirstType>
{
    ...
    mirror_storage(BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::call_traits<first_type  >::param_type f,
                   BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::call_traits<second_type >::param_type s)
...
/** \struct zr_boost_1_81::bimaps::relation::storage_finder
...
class pair_info_hook :
    public ::zr_boost_1_81::bimaps::relation::detail::storage_finder<TA,TB,Layout>::type
{
    typedef BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::bimaps::relation::detail::storage_finder<TA,TB,Layout>::type base_;
    ...
    pair_info_hook( BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::call_traits<
...
class pair_info_hook<TA,TB,::zr_boost_1_81::mpl::na,Layout> :
    public ::zr_boost_1_81::bimaps::relation::detail::storage_finder<TA,TB,Layout>::type
{
    typedef BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::bimaps::relation::detail::storage_finder<TA,TB,Layout>::type base_;
...
class structured_pair :
    ...
    public ::zr_boost_1_81::bimaps::relation::detail::pair_info_hook
    <
...
{
    typedef BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::bimaps::relation::detail::pair_info_hook
    <
        FirstType, SecondType,
        Info,
        Layout
    ...
    typedef ::zr_boost_1_81::mpl::vector3<
        structured_pair< FirstType, SecondType, Info, normal_layout >,
        structured_pair< FirstType, SecondType, Info, mirror_layout >,
        BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::mpl::if_<
            BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::is_same<Layout, normal_layout>::type,
    ...
    structured_pair(BOOST_DEDUCED_TYPENAME zr_boost_1_81::call_traits<
...
template< class FirstType, class SecondType, class Layout>
structured_pair<FirstType,SecondType,::zr_boost_1_81::mpl::na,Layout> 
    copy_with_first_replaced(structured_pair<FirstType,SecondType,::zr_boost_1_81::mpl::na,Layout> const& p,
        BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::call_traits< BOOST_DEDUCED_TYPENAME 
            structured_pair<FirstType,SecondType,::zr_boost_1_81::mpl::na,Layout>::first_type>
                ::param_type f)
{
    return structured_pair<FirstType,SecondType,::zr_boost_1_81::mpl::na,Layout>(f,p.second);
}
...
template< class FirstType, class SecondType, class Layout>
structured_pair<FirstType,SecondType,::zr_boost_1_81::mpl::na,Layout> 
    copy_with_second_replaced(structured_pair<FirstType,SecondType,::zr_boost_1_81::mpl::na,Layout> const& p,
        BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::call_traits< BOOST_DEDUCED_TYPENAME 
            structured_pair<FirstType,SecondType,::zr_boost_1_81::mpl::na,Layout>::second_type>
                ::param_type s)
{
    return structured_pair<FirstType,SecondType,::zr_boost_1_81::mpl::na,Layout>(p.first,s);
}
