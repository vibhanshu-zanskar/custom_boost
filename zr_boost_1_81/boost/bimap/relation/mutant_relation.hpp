    ...
    public symmetrical_base<LeftType,RightType,force_mutable>
{
    ...
    typedef ::zr_boost_1_81::mpl::vector2
    <
    ...
    relation_storage(BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::call_traits<
                         BOOST_DEDUCED_TYPENAME base_::left_value_type
                     >::param_type l,
                     BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::call_traits<
...
class relation_info_hook : public
 ::zr_boost_1_81::bimaps::relation::detail::relation_storage<TA,TB,force_mutable>
{
    typedef ::zr_boost_1_81::bimaps::relation::detail::
                relation_storage<TA,TB,force_mutable> base_;

    typedef BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::bimaps::tags::support::
    ...
    relation_info_hook( BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::call_traits<
                           BOOST_DEDUCED_TYPENAME base_::left_value_type
                        >::param_type l,
                        BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::call_traits<
                            BOOST_DEDUCED_TYPENAME base_::right_value_type
    ...
    {
        ar & ::zr_boost_1_81::serialization::make_nvp("left" , base_::left );
        ar & ::zr_boost_1_81::serialization::make_nvp("right", base_::right);
        ar & ::zr_boost_1_81::serialization::make_nvp("info" , info        );
    }
    #endif // BOOST_BIMAP_DISABLE_SERIALIZATION
};

template< class TA, class TB, bool force_mutable>
class relation_info_hook<TA,TB,::zr_boost_1_81::mpl::na,force_mutable> :
    public ::zr_boost_1_81::bimaps::relation::detail::relation_storage<TA,TB,force_mutable>
{
    typedef ::zr_boost_1_81::bimaps::relation::detail::
                relation_storage<TA,TB,force_mutable> base_;

    public:
    typedef ::zr_boost_1_81::mpl::na info_type;
...
template< class TA, class TB, class Info = ::zr_boost_1_81::mpl::na, bool force_mutable = false >
class mutant_relation : public
    ::zr_boost_1_81::bimaps::relation::detail::
        relation_info_hook<TA,TB,Info,force_mutable>
{
    ...
    typedef ::zr_boost_1_81::mpl::vector4
    <
         left_pair,
        right_pair,
    ...
    mutant_relation(BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::call_traits<
                        BOOST_DEDUCED_TYPENAME base_:: left_value_type
                    >::param_type l,
                    BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::call_traits<
                        BOOST_DEDUCED_TYPENAME base_::right_value_type
    ...
    {
        return ::zr_boost_1_81::bimaps::relation::detail::mutate<left_pair>(*this);
    }
    ...
    {
        return ::zr_boost_1_81::bimaps::relation::detail::mutate<right_pair>(*this);
    }
    ...
    above_view & get_view()
    {
        return ::zr_boost_1_81::bimaps::relation::detail::mutate<above_view>(*this);
    }
    ...
    template< class Tag >
    const BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::bimaps::relation::support::
        result_of::get<Tag,const mutant_relation>::type
    get() const
    {
        return ::zr_boost_1_81::bimaps::relation::support::get<Tag>(*this);
    }

    template< class Tag >
    BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::bimaps::relation::support::
...
{
    std::size_t seed = 0;
    ::zr_boost_1_81::hash_combine(seed, r. left );
    ::zr_boost_1_81::hash_combine(seed, r.right );
...
mutant_relation<TA,TB,Info,force_mutable> 
    copy_with_left_replaced(mutant_relation<TA,TB,Info,force_mutable> const& rel,
        BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::call_traits< BOOST_DEDUCED_TYPENAME 
...
template< class TA, class TB, bool force_mutable>
mutant_relation<TA,TB,::zr_boost_1_81::mpl::na,force_mutable>
    copy_with_left_replaced(mutant_relation<TA,TB,::zr_boost_1_81::mpl::na,force_mutable> const& rel,
        BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::call_traits< BOOST_DEDUCED_TYPENAME 
            mutant_relation<TA,TB,::zr_boost_1_81::mpl::na,force_mutable>::left_value_type>
                ::param_type l)
{
    return mutant_relation<TA,TB,::zr_boost_1_81::mpl::na,force_mutable>(l,rel.right);  
}
...
template< class TA, class TB, bool force_mutable>
mutant_relation<TA,TB,::zr_boost_1_81::mpl::na,force_mutable>
    copy_with_right_replaced(mutant_relation<TA,TB,::zr_boost_1_81::mpl::na,force_mutable> const& rel,
        BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::call_traits< BOOST_DEDUCED_TYPENAME 
            mutant_relation<TA,TB,::zr_boost_1_81::mpl::na,force_mutable>::right_value_type>
                ::param_type r)
{
    return mutant_relation<TA,TB,::zr_boost_1_81::mpl::na,force_mutable>(rel.left,r);  
}
