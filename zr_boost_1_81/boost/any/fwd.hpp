...
template<std::size_t OptimizeForSize = sizeof(void*), std::size_t OptimizeForAlignment = zr_boost_1_81::alignment_of<void*>::value>
class basic_any;
...
namespace detail {
    ...
    struct is_basic_any<zr_boost_1_81::anys::basic_any<OptimizeForSize, OptimizeForAlignment> > : public true_type {};
} // namespace detail
