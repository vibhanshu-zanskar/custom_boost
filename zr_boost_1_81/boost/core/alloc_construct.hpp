...
{
    zr_boost_1_81::allocator_destroy_n(a, p, n);
}
...
{
    zr_boost_1_81::allocator_construct(a, p, std::forward<U>(u),
        std::forward<V>(v)...);
}
#else
...
{
    zr_boost_1_81::allocator_construct(a, p, u);
}
...
{
    zr_boost_1_81::allocator_construct_n(a, p, n);
}
...
{
    zr_boost_1_81::allocator_construct_n(a, p, n, l, m);
}
...
{
    zr_boost_1_81::allocator_construct_n(a, p, n, b);
}
