...
// std::string zr_boost_1_81::core::type_name<T>()
//
...
{
    std::string r = zr_boost_1_81::core::demangle( n );
...
template<> struct tn_holder<zr_boost_1_81::long_long_type>
{
    static std::string type_name( std::string const& suffix )
    {
...
template<> struct tn_holder<zr_boost_1_81::ulong_long_type>
{
    static std::string type_name( std::string const& suffix )
    {
...
template<> struct tn_holder<zr_boost_1_81::int128_type>
{
    static std::string type_name( std::string const& suffix )
    {
...
template<> struct tn_holder<zr_boost_1_81::uint128_type>
{
    static std::string type_name( std::string const& suffix )
    {
