...
{
    return zr_boost_1_81::core::isnormal( static_cast<double>( x ) );
}
...
inline int fpclassify( float x )
{
    ...
    default:
        ...
        return zr_boost_1_81::core::isnormal( x )? fp_normal: fp_subnormal;
    }
}
...
{
    return zr_boost_1_81::core::fpclassify( static_cast<double>( x ) );
}
...
template<class T> T copysign( T x, T y )
{
    return zr_boost_1_81::core::detail::copysign_impl( x, y );
}
