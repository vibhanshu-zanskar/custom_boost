...
{
    static zr_boost_1_81::core::typeinfo ti_;
...
template<class T> zr_boost_1_81::core::typeinfo core_typeid_< T >::ti_( core_typeid_< T >::name(), &core_typeid_lib_id );
...
#define BOOST_CORE_TYPEID(T) (zr_boost_1_81::detail::core_typeid_<T>::ti_)
