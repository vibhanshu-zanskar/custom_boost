...
addressof(T& o) BOOST_NOEXCEPT
{
    ...
    return zr_boost_1_81::detail::addrof<T>::get(o, 0);
#else
    return zr_boost_1_81::detail::addrof<T>::get(zr_boost_1_81::detail::addrof_ref<T>(o), 0);
#endif
}
...
BOOST_FORCEINLINE typename zr_boost_1_81::detail::addrof_result<T[N]>::type
...
addressof(T& o) BOOST_NOEXCEPT
{
    return zr_boost_1_81::detail::addressof(o);
}
#endif
