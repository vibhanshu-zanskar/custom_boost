...
struct add_alignment
{
    ...
    struct apply
        : mpl::size_t<
              ::zr_boost_1_81::integer::static_lcm<
                  BOOST_MPL_AUX_VALUE_WKND(State)::value
                , ::zr_boost_1_81::alignment_of<Item>::value
                >::value
            >
    {};
};
...
//
// This implementation is designed to prefer zr_boost_1_81::blank over other potential
...
private: // helpers, for metafunction result (below)
    ...
    // [...now search the rest of the sequence for zr_boost_1_81::blank...]

    typedef typename mpl::iter_fold_if<
          mpl::iterator_range< first_result_it,end_it >
        , first_result_index, mpl::protect< mpl::next<> >
        , mpl::protect< mpl::not_same_as<zr_boost_1_81::blank> >
        >::type second_result_;
...
struct is_variant_move_noexcept_constructible {
    typedef typename zr_boost_1_81::mpl::find_if<
        Types, mpl::not_<zr_boost_1_81::is_nothrow_move_constructible<zr_boost_1_81::mpl::_1> >
    >::type iterator_t;

    typedef typename zr_boost_1_81::mpl::end<Types>::type end_t;
...
struct is_variant_move_noexcept_assignable {
    typedef typename zr_boost_1_81::mpl::find_if<
        Types, mpl::not_<zr_boost_1_81::is_nothrow_move_assignable<zr_boost_1_81::mpl::_1> >
    >::type iterator_t;
...
struct is_constructible_ext:
    zr_boost_1_81::mpl::or_<
        zr_boost_1_81::is_constructible<
            T1,
            T2
        >,
        zr_boost_1_81::is_constructible<
            T1,
            typename zr_boost_1_81::add_lvalue_reference<T2>::type
        >
    >
{};
...
struct is_variant_constructible_from:
    zr_boost_1_81::mpl::not_< zr_boost_1_81::is_same<
        typename zr_boost_1_81::mpl::find_if<
            Types,
            is_constructible_ext<zr_boost_1_81::mpl::_1, T>
        >::type,
        typename zr_boost_1_81::mpl::end<Types>::type
    > >
{};

template <BOOST_VARIANT_ENUM_PARAMS(typename T), class Types>
struct is_variant_constructible_from< zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Types >:
    zr_boost_1_81::is_same<
        typename zr_boost_1_81::mpl::find_if<
            typename zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)>::recursive_enabled_types,
            mpl::not_< is_variant_constructible_from< zr_boost_1_81::mpl::_1, Types> >
        >::type,
        typename zr_boost_1_81::mpl::end< typename zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)>::recursive_enabled_types >::type
    >
{};

template <BOOST_VARIANT_ENUM_PARAMS(typename T), class Types>
struct is_variant_constructible_from< const zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)>& , Types >:
    is_variant_constructible_from<zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Types >
{};
...
template <BOOST_VARIANT_ENUM_PARAMS(typename T), class Types>
struct is_variant_constructible_from< zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const && , Types >:
    is_variant_constructible_from<zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Types >
{};
...
public: // metafunction result
    ...
    typedef ::zr_boost_1_81::aligned_storage<
...
public: // visitor interface
    ...
    T& operator()(U&) const
    {
        ...
        return ::zr_boost_1_81::detail::variant::forced_return< T& >();
    }
};
...
public: // internal visitor interface
    ...
    template <typename T>
    void internal_visit(zr_boost_1_81::detail::variant::backup_holder<T>& operand, long) const
    {
        new(storage_) T( operand.get() );
    }

    template <typename T>
    void internal_visit(const zr_boost_1_81::detail::variant::backup_holder<T>& operand, long) const
    {
        new(storage_) T( operand.get() );
    }
...
public: // internal visitor interface
    ...
    void internal_visit(zr_boost_1_81::detail::variant::backup_holder<T>& operand, long) const
    {
        new(storage_) T( ::zr_boost_1_81::detail::variant::move(operand.get()) );
    }

    template <typename T>
    void internal_visit(T& operand, int) const BOOST_NOEXCEPT_IF(BOOST_NOEXCEPT_EXPR(T(zr_boost_1_81::declval<T>())))
    {
        new(storage_) T(::zr_boost_1_81::detail::variant::move(operand));
    }
};
#endif
...
public: // internal visitor interfaces
    ...
    {
        lhs_content.get()
            = ::zr_boost_1_81::detail::variant::move(static_cast<backup_holder<T>* >(rhs_storage_)->get());
    }
    ...
    void internal_visit(T& lhs_content, int) const
    {
        ...
        // Hint: Are any of the bounded types const-qualified or references?
        //
        lhs_content = ::zr_boost_1_81::detail::variant::move(*static_cast<T* >(rhs_storage_));
    }
...
public: // visitor interface
    ...
    bool operator()(T& lhs)
    {
        lhs = ::zr_boost_1_81::detail::variant::move(rhs_);
        return true;
    }
...
private: // helpers, for visitor interface (below)
        ...
        )
    {
        ...
        LhsT backup_lhs_content(
              ::zr_boost_1_81::detail::variant::move(lhs_content)
            ); // nothrow
        ...
        BOOST_CATCH (...)
        {
            ...
            new(lhs_.storage_.address())
                LhsT(
                      ::zr_boost_1_81::detail::variant::move(backup_lhs_content)
                    ); // nothrow
...
public: // internal visitor interfaces
    ...
    void operator()(T& operand) const
    {
        ...
        // ...and swap:
        ::zr_boost_1_81::detail::variant::move_swap( operand, other );
    }
...
class reflect
    : public static_visitor<const zr_boost_1_81::typeindex::type_info&>
{
public: // visitor interfaces

    template <typename T>
    const zr_boost_1_81::typeindex::type_info& operator()(const T&) const BOOST_NOEXCEPT
    {
        return zr_boost_1_81::typeindex::type_id<T>().type_info();
    }
...
public: // internal visitor interfaces
    ...
    {
        return visitor_(::zr_boost_1_81::move(operand));
    }
...
public: // internal visitor interfaces, cont.
    ...
    template <typename T>
    result_type internal_visit(zr_boost_1_81::recursive_wrapper<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }

    template <typename T>
    result_type internal_visit(const zr_boost_1_81::recursive_wrapper<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }

    template <typename T>
    result_type internal_visit(zr_boost_1_81::detail::reference_content<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }

    template <typename T>
    result_type internal_visit(const zr_boost_1_81::detail::reference_content<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }

    template <typename T>
    result_type internal_visit(zr_boost_1_81::detail::variant::backup_holder<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }

    template <typename T>
    result_type internal_visit(const zr_boost_1_81::detail::variant::backup_holder<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
...
private: // helpers, for typedefs (below)
    ...
    BOOST_STATIC_ASSERT((
          ::zr_boost_1_81::mpl::not_< mpl::empty<specified_types> >::value
        ));
...
public: // structors
    ...
    variant()
              ...
              BOOST_NOEXCEPT_IF(zr_boost_1_81::has_nothrow_constructor<internal_T0>::value)
#endif
    {
#ifdef _MSC_VER
#pragma warning( push )
...
#   endif
        ...
        template <typename T>
        int internal_visit(zr_boost_1_81::detail::reference_content<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const zr_boost_1_81::detail::reference_content<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(zr_boost_1_81::detail::variant::backup_holder<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const zr_boost_1_81::detail::variant::backup_holder<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(zr_boost_1_81::recursive_wrapper<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const zr_boost_1_81::recursive_wrapper<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }
...
private: // helpers, for structors, below
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    template <typename T>
    typename zr_boost_1_81::enable_if<zr_boost_1_81::is_rvalue_reference<T&&> >::type convert_construct(
          T&& operand
        , int
        , mpl::false_ = mpl::false_() // is_foreign_variant
        )
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    template <typename Variant>
    typename zr_boost_1_81::enable_if<zr_boost_1_81::is_rvalue_reference<Variant&&> >::type convert_construct(
          Variant&& operand
        , long
        , mpl::true_// is_foreign_variant
        )
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    template <typename Variant>
    typename zr_boost_1_81::enable_if<zr_boost_1_81::is_rvalue_reference<Variant&&> >::type convert_construct_variant(Variant&& operand)
    {
        // [Determine if the given variant is itself a bounded type, or if its
        //  content needs to be converted (i.e., it is a 'foreign' variant):]
        //
    ...
    typename zr_boost_1_81::enable_if<mpl::or_<
        zr_boost_1_81::is_same<zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(U)>, variant>,
        zr_boost_1_81::detail::variant::is_variant_constructible_from<zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(U)>&, internal_types>
    > >::type convert_construct(
          zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(U)>& operand
        , long
        )
    {
    ...
    typename zr_boost_1_81::enable_if<mpl::or_<
        zr_boost_1_81::is_same<zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(U)>, variant>,
        zr_boost_1_81::detail::variant::is_variant_constructible_from<const zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(U)>&, internal_types>
    > >::type convert_construct(
          const zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(U)>& operand
        , long
        )
    {
        convert_construct_variant(operand);
...
public: // structors, cont.
    ...
    variant(const T& operand,
        typename zr_boost_1_81::enable_if<mpl::or_<
            mpl::and_<
                mpl::not_< zr_boost_1_81::is_same<T, variant> >,
                zr_boost_1_81::detail::variant::is_variant_constructible_from<const T&, internal_types>
            >,
            zr_boost_1_81::is_same<T, zr_boost_1_81::recursive_variant_> >,
            bool >::type = true)
    {
    ...
    variant(
        ...
        , typename zr_boost_1_81::enable_if<mpl::or_<
            mpl::and_<
                mpl::not_< is_const<T> >,
                mpl::not_< zr_boost_1_81::is_same<T, variant> >,
                zr_boost_1_81::detail::variant::is_variant_constructible_from<T&, internal_types>
            >,
            zr_boost_1_81::is_same<T, zr_boost_1_81::recursive_variant_> >,
            bool >::type = true
        )
    ...
    variant(T&& operand,
        typename zr_boost_1_81::enable_if<mpl::or_<
            mpl::and_<
                zr_boost_1_81::is_rvalue_reference<T&&>,
                mpl::not_< zr_boost_1_81::is_const<T> >,
                mpl::not_< zr_boost_1_81::is_same<T, variant> >,
                zr_boost_1_81::detail::variant::is_variant_constructible_from<T&&, internal_types>
            >,
            zr_boost_1_81::is_same<T, zr_boost_1_81::recursive_variant_> >,
...
public: // modifiers
    ...
    typename zr_boost_1_81::enable_if<
        mpl::or_<
            zr_boost_1_81::is_same<T, variant>,
            zr_boost_1_81::detail::variant::is_variant_constructible_from<const T&, internal_types>
        >,
        variant&
...
public: // queries
    ...
    const zr_boost_1_81::typeindex::type_info& type() const
    {
...
private: // precondition assertions
    ...
    BOOST_STATIC_ASSERT(( ::zr_boost_1_81::mpl::is_sequence<Types>::value ));
    typedef typename zr_boost_1_81::mpl::insert_range<
      zr_boost_1_81::mpl::list<>
    , zr_boost_1_81::mpl::end< zr_boost_1_81::mpl::list<> >::type
    , Types
