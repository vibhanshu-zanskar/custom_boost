...
struct make_initializer_node
{
    ...
    private: // helpers, for metafunction result (below)
        ...
        private: // helpers, for static functions (below)
            ...
            typedef zr_boost_1_81::is_reference<public_T> 
                is_reference_content_t;

            typedef typename zr_boost_1_81::mpl::if_<is_reference_content_t, public_T, const public_T& >::type 
                param_T;

            template <class T> struct disable_overload{};

            typedef typename zr_boost_1_81::mpl::if_<is_reference_content_t, disable_overload<public_T>, public_T&& >::type 
                param2_T;
#else
        ...
        public: // static functions
            ...
            {
                typedef typename zr_boost_1_81::detail::make_reference_content<
                      recursive_enabled_T
                    >::type internal_T;
            ...
            static int initialize(void* dest, param2_T operand)
            {
                ...
                typedef typename zr_boost_1_81::mpl::if_<is_reference_content_t, param2_T, recursive_enabled_T>::type value_T;
                new(dest) value_T( zr_boost_1_81::detail::variant::move(operand) );
                return BOOST_MPL_AUX_VALUE_WKND(index)::value; // which
            }
#endif
        };
...
#define BOOST_VARIANT_AUX_INITIALIZER_T( mpl_seq, typename_base ) \
    ::zr_boost_1_81::mpl::iter_fold< \
          mpl_seq \
        , ::zr_boost_1_81::mpl::pair< \
              ::zr_boost_1_81::detail::variant::initializer_root \
            , ::zr_boost_1_81::mpl::int_<0> \
            > \
        , ::zr_boost_1_81::mpl::protect< \
              ::zr_boost_1_81::detail::variant::make_initializer_node \
            > \
        >::type::first \
    /**/
...
#define BOOST_VARIANT_AUX_INITIALIZER_T( mpl_seq, typename_base ) \
    ::zr_boost_1_81::detail::variant::preprocessor_list_initializer< \
          BOOST_VARIANT_ENUM_PARAMS(typename_base) \
        > \
    /**/
