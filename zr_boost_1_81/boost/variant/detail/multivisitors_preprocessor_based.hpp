...
#define BOOST_VARIANT_OPERATOR_BEG()                            \
    ...
    ::zr_boost_1_81::bind<result_type>(zr_boost_1_81::ref(visitor_), _1, _2     \
    /**/
...
#define BOOST_VARANT_VISITORS_VARIABLES_PRINTER(z, n, data)     \
    BOOST_PP_COMMA() zr_boost_1_81::ref( BOOST_PP_CAT(vis, n) )         \
    /**/
...
#define BOOST_VARIANT_APPLY_VISITOR_BEG()                                               \
    return ::zr_boost_1_81::apply_visitor(                                                      \
            zr_boost_1_81::detail::variant::make_two_variables_holder(visitor, var0 , var1),    \
            var2                                                                        \
    /**/
