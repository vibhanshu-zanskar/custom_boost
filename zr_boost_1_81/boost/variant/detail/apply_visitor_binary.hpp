...
#   include <boost/move/utility_core.hpp> // for zr_boost_1_81::move, zr_boost_1_81::forward
#endif
...
public: // visitor interfaces
    ...
    {
        return visitor_(::zr_boost_1_81::move(value1_), ::zr_boost_1_81::forward<Value2>(value2));
    }
    ...
    operator()(Value2&& value2)
    {
        return visitor_(value1_, ::zr_boost_1_81::forward<Value2>(value2));
    }
...
public: // visitor interfaces
    ...
    operator()(Value1&& value1)
    {
        apply_visitor_binary_invoke<
              Visitor
            , Value1
            , ! ::zr_boost_1_81::is_lvalue_reference<Value1>::value
            > invoker(visitor_, value1);

        return zr_boost_1_81::apply_visitor(invoker, ::zr_boost_1_81::move(visitable2_));
    }
    ...
    operator()(Value1&& value1)
    {
        ...
        return zr_boost_1_81::apply_visitor(invoker, visitable2_);
    }
...
{
    ::zr_boost_1_81::detail::variant::apply_visitor_binary_unwrap<
          Visitor, Visitable2, ! ::zr_boost_1_81::is_lvalue_reference<Visitable2>::value
        > unwrapper(visitor, visitable2);

    return zr_boost_1_81::apply_visitor(unwrapper, ::zr_boost_1_81::forward<Visitable1>(visitable1));
}
...
apply_visitor( Visitor& visitor, Visitable1& visitable1, Visitable2& visitable2)
{
    ...
    return zr_boost_1_81::apply_visitor(unwrapper, visitable1);
}
...
{
    ::zr_boost_1_81::detail::variant::apply_visitor_binary_unwrap<
          const Visitor, Visitable2, ! ::zr_boost_1_81::is_lvalue_reference<Visitable2>::value
        > unwrapper(visitor, visitable2);
...
inline decltype(auto) apply_visitor(Visitor& visitor, Visitable1&& visitable1, Visitable2&& visitable2,
    ...
    >::type = true)
{
    ::zr_boost_1_81::detail::variant::apply_visitor_binary_unwrap_cpp14<
          Visitor, Visitable2, ! ::zr_boost_1_81::is_lvalue_reference<Visitable2>::value
        > unwrapper(visitor, visitable2);
