...
namespace detail { namespace variant {
    ...
    public: // visitor interfaces
        ...
        {
            return ::zr_boost_1_81::apply_visitor(
                make_one_by_one_visitor_and_value_referer(
                    visitor_,
                    tuple_tail(visitables_),
                    std::tuple_cat(values_, std::make_tuple(wrap<Value, ! ::zr_boost_1_81::is_lvalue_reference<Value>::value>(value)))
                )
    ...
    {
        return ::zr_boost_1_81::apply_visitor(
            ::zr_boost_1_81::detail::variant::make_one_by_one_visitor_and_value_referer(
                visitor,
                std::make_tuple(
                    ::zr_boost_1_81::detail::variant::wrap<T2, ! ::zr_boost_1_81::is_lvalue_reference<T2>::value>(v2),
                    ::zr_boost_1_81::detail::variant::wrap<T3, ! ::zr_boost_1_81::is_lvalue_reference<T3>::value>(v3),
                    ::zr_boost_1_81::detail::variant::wrap<TN, ! ::zr_boost_1_81::is_lvalue_reference<TN>::value>(vn)...
                    ),
                std::tuple<>()
                ),
                ::zr_boost_1_81::forward<T1>(v1)
            );
    }
