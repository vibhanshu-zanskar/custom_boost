...
struct substitute<
      ::zr_boost_1_81::variant<
        ...
        >
    , RecursiveVariant
    , ::zr_boost_1_81::recursive_variant_
...
struct substitute<
      ::zr_boost_1_81::variant<
          ::zr_boost_1_81::detail::variant::over_sequence< T0 >
        , BOOST_VARIANT_ENUM_SHIFTED_PARAMS(T)
        >
    , RecursiveVariant
    , ::zr_boost_1_81::recursive_variant_
...
public:
    ...
    typedef typename mpl::if_<
          mpl::equal<initial_types, types, ::zr_boost_1_81::is_same<mpl::_1, mpl::_2> >
        , ::zr_boost_1_81::variant<
              ::zr_boost_1_81::detail::variant::over_sequence< T0 >
            , BOOST_VARIANT_ENUM_SHIFTED_PARAMS(T)
            >
        , ::zr_boost_1_81::variant< over_sequence<types> >
        >::type type;
};
...
public: // metafunction result
    ...
    typedef ::zr_boost_1_81::variant< BOOST_VARIANT_ENUM_PARAMS(wknd_T) > type;
