...
//
template <class T>          struct is_constructible<recursive_wrapper<T>, T>                            : zr_boost_1_81::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, const T>                      : zr_boost_1_81::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, T&>                           : zr_boost_1_81::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, const T&>                     : zr_boost_1_81::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, recursive_wrapper<T> >        : zr_boost_1_81::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, const recursive_wrapper<T> >  : zr_boost_1_81::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, recursive_wrapper<T>& >       : zr_boost_1_81::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, const recursive_wrapper<T>& > : zr_boost_1_81::true_type{};

template <class T, class U> struct is_constructible<recursive_wrapper<T>, U >                           : zr_boost_1_81::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, const U >                     : zr_boost_1_81::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, U& >                          : zr_boost_1_81::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, const U& >                    : zr_boost_1_81::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, recursive_wrapper<U> >        : zr_boost_1_81::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, const recursive_wrapper<U> >  : zr_boost_1_81::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, recursive_wrapper<U>& >       : zr_boost_1_81::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, const recursive_wrapper<U>& > : zr_boost_1_81::false_type{};
...
template <class T> struct is_nothrow_move_constructible<recursive_wrapper<T> > : zr_boost_1_81::false_type{};
...
template< typename T > struct is_recursive_wrapper
    : public ::zr_boost_1_81::integral_constant<bool,(::zr_boost_1_81::detail::is_recursive_wrapper_impl<T>::value)>
{
public:
