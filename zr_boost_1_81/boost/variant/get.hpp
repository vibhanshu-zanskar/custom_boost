...
public: // std::exception implementation
    ...
    {
        return "zr_boost_1_81::bad_get: "
               "failed value get using zr_boost_1_81::get";
    }
...
public: // visitor interfaces
    ...
    {
        return zr_boost_1_81::addressof(operand);
    }
...
relaxed_get(
      zr_boost_1_81::variant< BOOST_VARIANT_ENUM_PARAMS(T) >* operand
...
relaxed_get(
      const zr_boost_1_81::variant< BOOST_VARIANT_ENUM_PARAMS(T) >* operand
      BOOST_VARIANT_AUX_GET_EXPLICIT_TEMPLATE_TYPE(U)
    ) BOOST_NOEXCEPT
{
...
{
    typedef typename add_pointer<U>::type U_ptr;
    U_ptr result = relaxed_get<U>(zr_boost_1_81::addressof(operand));

    if (!result)
        zr_boost_1_81::throw_exception(bad_get());
    return *result;
}
...
{
    typedef typename add_pointer<const U>::type U_ptr;
    U_ptr result = relaxed_get<const U>(zr_boost_1_81::addressof(operand));
    ...
    ) BOOST_NOEXCEPT
{
    BOOST_STATIC_ASSERT_MSG(
        (zr_boost_1_81::detail::variant::holds_element<zr_boost_1_81::variant< BOOST_VARIANT_ENUM_PARAMS(T) >, U >::value),
        "zr_boost_1_81::variant does not contain specified type U, "
        "call to zr_boost_1_81::get<U>(zr_boost_1_81::variant<T...>*) will always return NULL"
    );
...
{
    BOOST_STATIC_ASSERT_MSG(
        (zr_boost_1_81::detail::variant::holds_element<zr_boost_1_81::variant< BOOST_VARIANT_ENUM_PARAMS(T) >, const U >::value),
        "zr_boost_1_81::variant does not contain specified type U, "
        "call to zr_boost_1_81::get<U>(const zr_boost_1_81::variant<T...>*) will always return NULL"
    );
    ...
    )
{
    BOOST_STATIC_ASSERT_MSG(
        (zr_boost_1_81::detail::variant::holds_element<zr_boost_1_81::variant< BOOST_VARIANT_ENUM_PARAMS(T) >, U >::value),
        "zr_boost_1_81::variant does not contain specified type U, "
        "call to zr_boost_1_81::get<U>(zr_boost_1_81::variant<T...>&) will always throw zr_boost_1_81::bad_get exception"
    );
    ...
    )
{
    BOOST_STATIC_ASSERT_MSG(
        (zr_boost_1_81::detail::variant::holds_element<zr_boost_1_81::variant< BOOST_VARIANT_ENUM_PARAMS(T) >, const U >::value),
        "zr_boost_1_81::variant does not contain specified type U, "
        "call to zr_boost_1_81::get<U>(const zr_boost_1_81::variant<T...>&) will always throw zr_boost_1_81::bad_get exception"
    );
...
{
    BOOST_STATIC_ASSERT_MSG(
        (!zr_boost_1_81::is_lvalue_reference<U>::value),
        "remove ampersand '&' from template type U in zr_boost_1_81::get<U>(zr_boost_1_81::variant<T...>&&) "
    );
