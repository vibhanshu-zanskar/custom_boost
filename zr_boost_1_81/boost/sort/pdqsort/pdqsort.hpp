...
namespace pdqsort_detail {
    ...
    template<class T> struct is_default_compare : zr_boost_1_81::false_type { };
    template<class T> struct is_default_compare<std::less<T> > : zr_boost_1_81::true_type { };
    template<class T> struct is_default_compare<std::greater<T> > : zr_boost_1_81::true_type { };
...
inline void pdqsort(Iter first, Iter last, Compare comp) {
    ...
    pdqsort_detail::pdqsort_loop<Iter, Compare,
        pdqsort_detail::is_default_compare<typename zr_boost_1_81::decay<Compare>::type>::value &&
        zr_boost_1_81::is_arithmetic<typename std::iterator_traits<Iter>::value_type>::value>(
