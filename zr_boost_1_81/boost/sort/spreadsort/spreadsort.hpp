...
namespace spreadsort {
  ...
  */
  ...
  inline typename zr_boost_1_81::enable_if_c< std::numeric_limits<
  ...
  */
  ...
  spreadsort(RandomAccessIter first, RandomAccessIter last)
  {
    zr_boost_1_81::uint16_t unused = 0;
...
{
    spreadsort(zr_boost_1_81::begin(range), zr_boost_1_81::end(range));
}
