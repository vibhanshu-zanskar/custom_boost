...
/*! \brief String sort algorithm using random access iterators, allowing character-type overloads.\n
  (All variants fall back to @c zr_boost_1_81::sort::pdqsort if the data size is too small, < @c detail::min_sort_size).
...
{
  string_sort(zr_boost_1_81::begin(range), zr_boost_1_81::end(range), unused);
}
...
{
  string_sort(zr_boost_1_81::begin(range), zr_boost_1_81::end(range));
}

/*! \brief String sort algorithm using random access iterators, allowing character-type overloads.

  (All variants fall back to @c zr_boost_1_81::sort::pdqsort if the data size is too small, < detail::min_sort_size).
...
{
  reverse_string_sort(zr_boost_1_81::begin(range), zr_boost_1_81::end(range), comp, unused);
}
...
{
  reverse_string_sort(zr_boost_1_81::begin(range), zr_boost_1_81::end(range), comp);
}
...
{
  string_sort(zr_boost_1_81::begin(range), zr_boost_1_81::end(range), get_character, length);
}
...
inline void string_sort(Range& range,
                        Get_char get_character, Get_length length, Compare comp)
{
  string_sort(zr_boost_1_81::begin(range), zr_boost_1_81::end(range), get_character, length, comp);
}
...
{
    reverse_string_sort(zr_boost_1_81::begin(range), zr_boost_1_81::end(range), get_character, length, comp);
}
}
}
}
