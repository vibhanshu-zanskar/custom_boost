...
namespace spreadsort {
  namespace detail {
                            ...
                            size_t *bin_sizes)
    {
      ...
      *local_bin = next_bin_start;
      ...
      for (unsigned u = cache_offset; u <= cache_offset + last_bin;
        ...
        //using zr_boost_1_81::sort::pdqsort if its worst-case is better
        if (count < max_size)
          zr_boost_1_81::sort::pdqsort(lastPos, bin_cache[u], offset_greater_than<Data_type,
              ...
              Get_char get_character, Get_length length)
    {
      ...
      *local_bin = next_bin_start;
      ...
      for (unsigned u = cache_offset + 1; u < cache_offset + last_bin + 2;
        ...
        //using zr_boost_1_81::sort::pdqsort if its worst-case is better
        if (count < max_size)
          zr_boost_1_81::sort::pdqsort(lastPos, bin_cache[u], offset_char_less_than<Data_type,
    ...
    template <class RandomAccessIter, class Unsigned_char_type>
    inline typename zr_boost_1_81::enable_if_c< sizeof(Unsigned_char_type) <= 2, void
                                                                      >::type
    ...
    template <class RandomAccessIter, class Unsigned_char_type>
    inline typename zr_boost_1_81::disable_if_c< sizeof(Unsigned_char_type) <= 2, void
                                                                       >::type
    string_sort(RandomAccessIter first, RandomAccessIter last,
                Unsigned_char_type)
    {
      //Warning that we're using zr_boost_1_81::sort::pdqsort, even though string_sort was called
                ...
                Unsigned_char_type)
    {
      ...
      //Warning that we're using zr_boost_1_81::sort::pdqsort, even though string_sort was called
      BOOST_STATIC_ASSERT( sizeof(Unsigned_char_type) <= 2 );
      zr_boost_1_81::sort::pdqsort(first, last, std::greater<Data_type>());
    }
