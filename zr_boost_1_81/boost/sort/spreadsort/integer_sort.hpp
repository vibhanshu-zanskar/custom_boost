...
{
  integer_sort(zr_boost_1_81::begin(range), zr_boost_1_81::end(range));
}
...
{
  integer_sort(zr_boost_1_81::begin(range), zr_boost_1_81::end(range), shift, comp);
}
...
{
  integer_sort(zr_boost_1_81::begin(range), zr_boost_1_81::end(range), shift);
}
}
}
}
