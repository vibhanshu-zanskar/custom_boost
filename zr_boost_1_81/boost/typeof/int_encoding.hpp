...
namespace zr_boost_1_81 { namespace type_of {
    ...
    struct encode_size_t : push_back<
        V,
        zr_boost_1_81::type_of::constant<std::size_t,pack<n, false>::value>
    >
    {};
    ...
    struct encode_size_t<V, n, true> : push_back<typename push_back<
        V,
        zr_boost_1_81::type_of::constant<std::size_t,pack<n % 0x3ffffffe, true>::value> >::type,
        zr_boost_1_81::type_of::constant<std::size_t,n / 0x3ffffffe>
    >
    {};
