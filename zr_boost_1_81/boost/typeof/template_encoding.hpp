...
#define BOOST_TYPEOF_REGISTER_TEMPLATE_IMPL(Name, Params, Size, ID)\
    ...
    {\
        typedef typename zr_boost_1_81::type_of::push_back<V, zr_boost_1_81::type_of::constant<std::size_t,ID> >::type V0;\
    ...
    {\
        typedef decode_type_impl<zr_boost_1_81::type_of::constant<std::size_t,ID>, Iter> self_t;\
        typedef zr_boost_1_81::type_of::constant<std::size_t,ID> self_id;\
        typedef Iter iter0;\
