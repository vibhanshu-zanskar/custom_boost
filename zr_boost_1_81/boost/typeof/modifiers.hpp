...
#define BOOST_TYPEOF_modifier_support(ID, Fun)\
    ...
    {\
        typedef\
            typename zr_boost_1_81::type_of::encode_type<\
            typename zr_boost_1_81::type_of::push_back<\
            V\
            , zr_boost_1_81::type_of::constant<std::size_t,ID> >::type\
            , T>::type\
            type;\
    };\
    template<class Iter> struct decode_type_impl<zr_boost_1_81::type_of::constant<std::size_t,ID>, Iter>\
    {\
        typedef zr_boost_1_81::type_of::decode_type<Iter> d1;\
...
#define BOOST_TYPEOF_array_support(ID, Qualifier)\
    ...
    {\
        typedef\
            ...
            V\
            , zr_boost_1_81::type_of::constant<std::size_t,ID> >::type\
            , zr_boost_1_81::type_of::constant<std::size_t,N> >::type\
            , T>::type\
        type;\
    };\
    template<class Iter>\
    struct decode_type_impl<zr_boost_1_81::type_of::constant<std::size_t,ID>, Iter>\
    {\
        enum{n = Iter::type::value};\
        typedef zr_boost_1_81::type_of::decode_type<typename Iter::next> d;\
