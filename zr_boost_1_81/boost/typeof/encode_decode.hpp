...
#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace { namespace zr_boost_1_81_typeof {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER zr_boost_1_81_typeof

#else

#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace zr_boost_1_81 { namespace type_of {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER zr_boost_1_81::type_of
