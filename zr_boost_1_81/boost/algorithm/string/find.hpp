...
//  Generic find -----------------------------------------------//
        ...
        */
            ...
            const FinderT& Finder)
        {
            ...
            return Finder(::zr_boost_1_81::begin(lit_input),::zr_boost_1_81::end(lit_input));
        }
...
//  find_first  -----------------------------------------------//
        ...
        */
        ...
        {
            return ::zr_boost_1_81::algorithm::find(Input, ::zr_boost_1_81::algorithm::first_finder(Search));
        }
        ...
        */
        ...
        {
            return ::zr_boost_1_81::algorithm::find(Input, ::zr_boost_1_81::algorithm::first_finder(Search,is_iequal(Loc)));
        }
...
//  find_last  -----------------------------------------------//
        ...
        */
        ...
        find_last( 
            ...
            const Range2T& Search)
        {
            return ::zr_boost_1_81::algorithm::find(Input, ::zr_boost_1_81::algorithm::last_finder(Search));
        }
        ...
        */
        ...
        ifind_last( 
            ...
            const std::locale& Loc=std::locale())
        {
            return ::zr_boost_1_81::algorithm::find(Input, ::zr_boost_1_81::algorithm::last_finder(Search, is_iequal(Loc)));
        }
...
//  find_nth ----------------------------------------------------------------------//
        ...
        */
        ...
        find_nth( 
            ...
            int Nth)
        {
            return ::zr_boost_1_81::algorithm::find(Input, ::zr_boost_1_81::algorithm::nth_finder(Search,Nth));
        }
        ...
        */
        ...
        ifind_nth( 
            ...
            const std::locale& Loc=std::locale())
        {
            return ::zr_boost_1_81::algorithm::find(Input, ::zr_boost_1_81::algorithm::nth_finder(Search,Nth,is_iequal(Loc)));
        }
...
//  find_head ----------------------------------------------------------------------//
        ...
        */
        ...
        find_head( 
            ...
            int N)
        {
            return ::zr_boost_1_81::algorithm::find(Input, ::zr_boost_1_81::algorithm::head_finder(N));
        }
...
//  find_tail ----------------------------------------------------------------------//
        ...
        */
        ...
        find_tail( 
            ...
            int N)
        {
            return ::zr_boost_1_81::algorithm::find(Input, ::zr_boost_1_81::algorithm::tail_finder(N));
        }
...
//  find_token --------------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::zr_boost_1_81::algorithm::find(Input, ::zr_boost_1_81::algorithm::token_finder(Pred, eCompress));
        }
