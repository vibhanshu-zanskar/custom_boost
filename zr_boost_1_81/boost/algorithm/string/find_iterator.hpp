        ...
        public:
            ...
            */
            ...
            find_iterator(
                ...
                detail::find_iterator_base<IteratorT>(Finder,0)
            {
                iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::zr_boost_1_81::as_literal(Col));
                m_Match=::zr_boost_1_81::make_iterator_range(::zr_boost_1_81::begin(lit_col), ::zr_boost_1_81::begin(lit_col));
                m_End=::zr_boost_1_81::end(lit_col);
        ...
        */
        ...
        public:
            ...
            */
            ...
            {
                iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::zr_boost_1_81::as_literal(Col));
                m_Match=make_iterator_range(::zr_boost_1_81::begin(lit_col), ::zr_boost_1_81::begin(lit_col));
                m_Next=::zr_boost_1_81::begin(lit_col);
                m_End=::zr_boost_1_81::end(lit_col);
