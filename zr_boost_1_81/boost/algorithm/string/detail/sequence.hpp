...
//  insert helpers  -------------------------------------------------//
            ...
            {
                ::zr_boost_1_81::algorithm::detail::insert( Input, At, ::zr_boost_1_81::begin(Insert), ::zr_boost_1_81::end(Insert) );
            }
...
//  replace helper  -------------------------------------------------//
                ...
                const InsertT& Insert )
            {
                if(From!=To)
                {
                    ::zr_boost_1_81::algorithm::detail::replace( Input, From, To, ::zr_boost_1_81::begin(Insert), ::zr_boost_1_81::end(Insert) );
                }
                else
                {
                    ::zr_boost_1_81::algorithm::detail::insert( Input, From, ::zr_boost_1_81::begin(Insert), ::zr_boost_1_81::end(Insert) );
                }
            }
