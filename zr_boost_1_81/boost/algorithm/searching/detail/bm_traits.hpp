...
namespace zr_boost_1_81 { namespace algorithm { namespace detail {
...
//  General case for data searching other than bytes; use a map
    ...
    private:
#ifdef BOOST_NO_CXX11_HDR_UNORDERED_MAP
        typedef zr_boost_1_81::unordered_map<key_type, value_type> skip_map;
#else
...
//  Special case small numeric values; use an array
    ...
    private:
        typedef typename zr_boost_1_81::make_unsigned<key_type>::type unsigned_key_type;
        typedef zr_boost_1_81::array<value_type, 1U << (CHAR_BIT * sizeof(key_type))> skip_map;
        skip_map skip_;
        const value_type k_default_value;
    public:
    ...
    struct BM_traits {
        ...
        typedef zr_boost_1_81::algorithm::detail::skip_table<key_type, value_type, 
                zr_boost_1_81::is_integral<key_type>::value && (sizeof(key_type)==1)> skip_table_t;
        };
