...
//  2. Any common elements on the front have been removed (not necessary for correctness, just for performance)
    ...
    //  Skip the common prefix (if any)
        ...
        if ( first1 != last1 && first2 != last2 )
            return zr_boost_1_81::algorithm::detail::is_permutation_inner ( first1, last1, first2, last2,
...
//  Skip the common prefix (if any)
    ...
    //  Create last2
        ...
        return zr_boost_1_81::algorithm::detail::is_permutation_inner ( first1, last1, first2, last2, p );
        }
...
{
    return zr_boost_1_81::algorithm::is_permutation (zr_boost_1_81::begin (r), zr_boost_1_81::end (r), first2 );
}
...
typename zr_boost_1_81::disable_if_c<zr_boost_1_81::is_same<Range, ForwardIterator>::value, bool>::type
is_permutation ( const Range &r, ForwardIterator first2, BinaryPredicate pred )
{
    return zr_boost_1_81::algorithm::is_permutation (zr_boost_1_81::begin (r), zr_boost_1_81::end (r), first2, pred );
}
