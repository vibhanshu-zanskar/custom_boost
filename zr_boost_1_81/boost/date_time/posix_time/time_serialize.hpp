...
template<>
struct version<zr_boost_1_81::posix_time::time_duration>
...
BOOST_DATE_TIME_SPLIT_FREE(zr_boost_1_81::posix_time::ptime)
BOOST_DATE_TIME_SPLIT_FREE(zr_boost_1_81::posix_time::time_duration)
BOOST_DATE_TIME_SPLIT_FREE(zr_boost_1_81::posix_time::time_period)
...
{
    TimeResTraitsSize h = zr_boost_1_81::numeric_cast<TimeResTraitsSize>(td.hours());
    TimeResTraitsSize m = zr_boost_1_81::numeric_cast<TimeResTraitsSize>(td.minutes());
    TimeResTraitsSize s = zr_boost_1_81::numeric_cast<TimeResTraitsSize>(td.seconds());
          ...
          unsigned int version)
{
  ...
  if(is_special) {
    ...
    BOOST_STATIC_ASSERT(sizeof(posix_time::time_duration::hour_type) == sizeof(zr_boost_1_81::int64_t));
    BOOST_STATIC_ASSERT(sizeof(posix_time::time_duration::min_type) == sizeof(zr_boost_1_81::int64_t));
    BOOST_STATIC_ASSERT(sizeof(posix_time::time_duration::sec_type) == sizeof(zr_boost_1_81::int64_t));
    BOOST_STATIC_ASSERT(sizeof(posix_time::time_duration::fractional_seconds_type) == sizeof(zr_boost_1_81::int64_t));
          ...
          unsigned int /*version*/)
{
  ...
  if(!d.is_special()) {
    ar & make_nvp("ptime_time_duration", td);
    pt = zr_boost_1_81::posix_time::ptime(d,td);
  }
  else {
    pt = zr_boost_1_81::posix_time::ptime(d.as_special());
  }
                                ...
                                const unsigned int /*file_version*/)
{
  ...
  new(pt) zr_boost_1_81::posix_time::ptime(zr_boost_1_81::posix_time::not_a_date_time);
}
...
template<class Archive>
void load(Archive & ar, 
          zr_boost_1_81::posix_time::time_period & tp, 
          unsigned int /*version*/)
{
  ...
  ar & make_nvp("time_period_begin", beg);
  ar & make_nvp("time_period_end", end);
  tp = zr_boost_1_81::posix_time::time_period(beg, end);
}
                                ...
                                const unsigned int /*file_version*/)
{
  ...
  posix_time::ptime beg(d,td);
  posix_time::ptime end(d,td);
  new(tp) zr_boost_1_81::posix_time::time_period(beg,end);
}
