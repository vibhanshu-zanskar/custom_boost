...
namespace posix_time {
  ...
  inline
  std::tm to_tm(const zr_boost_1_81::posix_time::ptime& t) {
    std::tm timetm = zr_boost_1_81::gregorian::to_tm(t.date());
    zr_boost_1_81::posix_time::time_duration td = t.time_of_day();
  ...
  inline
  std::tm to_tm(const zr_boost_1_81::posix_time::time_duration& td) {
    std::tm timetm;
  ...
  ptime ptime_from_tm(const std::tm& timetm) {
    zr_boost_1_81::gregorian::date d = zr_boost_1_81::gregorian::date_from_tm(timetm);
   ...
   *       zr_boost_1_81::detail::winapi::FILETIME_ type.
   */
  template< typename TimeT, typename FileTimeT >
  inline
  TimeT from_ftime(const FileTimeT& ft)
  {
    return zr_boost_1_81::date_time::time_from_ftime<TimeT>(ft);
  }

#endif // BOOST_HAS_FTIME

} } //namespace zr_boost_1_81::posix_time
