...
namespace posix_time {
  ...
  ptime 
  operator+(const ptime& t, const zr_boost_1_81::gregorian::months& m)
  {
  ...
  inline BOOST_CXX14_CONSTEXPR
  ptime 
  operator+=(ptime& t, const zr_boost_1_81::gregorian::months& m)
  {
  ...
  inline BOOST_CXX14_CONSTEXPR
  ptime 
  operator+(const ptime& t, const zr_boost_1_81::gregorian::years& y)
  {
  ...
  inline BOOST_CXX14_CONSTEXPR
  ptime 
  operator+=(ptime& t, const zr_boost_1_81::gregorian::years& y)
  {
    return t += y.get_offset(t.date());
  }
