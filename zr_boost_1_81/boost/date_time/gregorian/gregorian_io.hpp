...
namespace gregorian {
  ...
  typedef zr_boost_1_81::date_time::period_formatter<wchar_t> wperiod_formatter;
  typedef zr_boost_1_81::date_time::period_formatter<char>    period_formatter;
  
  typedef zr_boost_1_81::date_time::date_facet<date,wchar_t> wdate_facet;
  typedef zr_boost_1_81::date_time::date_facet<date,char>    date_facet;

  typedef zr_boost_1_81::date_time::period_parser<date,char>       period_parser;
  typedef zr_boost_1_81::date_time::period_parser<date,wchar_t>    wperiod_parser;
    
  typedef zr_boost_1_81::date_time::special_values_formatter<char> special_values_formatter; 
  typedef zr_boost_1_81::date_time::special_values_formatter<wchar_t> wspecial_values_formatter; 
  
  typedef zr_boost_1_81::date_time::special_values_parser<date,char> special_values_parser; 
  typedef zr_boost_1_81::date_time::special_values_parser<date,wchar_t> wspecial_values_parser; 
  
  typedef zr_boost_1_81::date_time::date_input_facet<date,char>    date_input_facet;
  typedef zr_boost_1_81::date_time::date_input_facet<date,wchar_t> wdate_input_facet;

  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const zr_boost_1_81::gregorian::date& d) {
    zr_boost_1_81::io::ios_flags_saver iflags(os);
    typedef zr_boost_1_81::date_time::date_facet<date, CharT> custom_date_facet;
  ...
  {
    zr_boost_1_81::io::ios_flags_saver iflags(is);
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const zr_boost_1_81::gregorian::date_duration& dd) {
    zr_boost_1_81::io::ios_flags_saver iflags(os);
    typedef zr_boost_1_81::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const zr_boost_1_81::gregorian::date_period& dp) {
    zr_boost_1_81::io::ios_flags_saver iflags(os);
    typedef zr_boost_1_81::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const zr_boost_1_81::gregorian::greg_month& gm) {
    zr_boost_1_81::io::ios_flags_saver iflags(os);
    typedef zr_boost_1_81::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const zr_boost_1_81::gregorian::greg_weekday& gw) {
    zr_boost_1_81::io::ios_flags_saver iflags(os);
    typedef zr_boost_1_81::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const zr_boost_1_81::gregorian::partial_date& pd) {
    zr_boost_1_81::io::ios_flags_saver iflags(os);
    typedef zr_boost_1_81::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const zr_boost_1_81::gregorian::nth_day_of_the_week_in_month& nkd) {
    zr_boost_1_81::io::ios_flags_saver iflags(os);
    typedef zr_boost_1_81::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const zr_boost_1_81::gregorian::first_day_of_the_week_in_month& fkd) {
    zr_boost_1_81::io::ios_flags_saver iflags(os);
    typedef zr_boost_1_81::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const zr_boost_1_81::gregorian::last_day_of_the_week_in_month& lkd) {
    zr_boost_1_81::io::ios_flags_saver iflags(os);
    typedef zr_boost_1_81::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const zr_boost_1_81::gregorian::first_day_of_the_week_after& fda) {
    zr_boost_1_81::io::ios_flags_saver iflags(os);
    typedef zr_boost_1_81::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const zr_boost_1_81::gregorian::first_day_of_the_week_before& fdb) {
    zr_boost_1_81::io::ios_flags_saver iflags(os);
    typedef zr_boost_1_81::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
