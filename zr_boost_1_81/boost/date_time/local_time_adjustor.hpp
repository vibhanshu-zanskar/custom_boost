...
#include <boost/date_time/time_defs.hpp> // zr_boost_1_81::date_time::dst_flags
  ...
  namespace date_time {
    ...
    public:
      ...
      static time_duration_type utc_to_local_offset(const time_type& t)
      {
        ...
        zr_boost_1_81::throw_exception(std::out_of_range("Unreachable case"));
                                                    ...
                                                    date_time::dst_flags dst=date_time::calculate) 
      {
        ...
        zr_boost_1_81::throw_exception(std::out_of_range("Time label invalid"));
        BOOST_DATE_TIME_UNREACHABLE_EXPRESSION(return time_duration_type(not_a_date_time)); // should never reach
      }
