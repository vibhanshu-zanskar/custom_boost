...
namespace date_time {
  ...
  private:
    static time_type create_time(time_converter converter)
    {
      ...
      zr_boost_1_81::uint32_t sub_sec = tv.tv_usec;
      ...
      {
        zr_boost_1_81::winapi::FILETIME_ local_ft;
        zr_boost_1_81::winapi::FileTimeToLocalFileTime(&ft, &local_ft);
        ft = local_ft;
      }
#endif
...
#error Internal Boost.DateTime error: BOOST_DATE_TIME_HAS_HIGH_PRECISION_CLOCK is defined, however neither gettimeofday nor FILETIME support is detected.
     ...
     */
    static zr_boost_1_81::uint64_t file_time_to_microseconds(zr_boost_1_81::winapi::FILETIME_ const& ft)
    {
