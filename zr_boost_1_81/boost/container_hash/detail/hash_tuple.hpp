...
inline typename zr_boost_1_81::enable_if_<(I == std::tuple_size<T>::value),
        void>::type
...
{
    zr_boost_1_81::hash_combine(seed, std::get<I>(v));
    zr_boost_1_81::hash_detail::hash_combine_tuple<I + 1>(seed, v);
}
...
{
    std::size_t seed = 0;
    zr_boost_1_81::hash_detail::hash_combine_tuple<0>(seed, v);
    return seed;
}
...
{
    return zr_boost_1_81::hash_detail::hash_tuple(v);
}
