...
namespace detail
{
  ...
  public:
    ...
    inline underlying_queue_type underlying_queue() {
      ...
      return zr_boost_1_81::move(data_);
    }
  ...
  {
    cond_.wait(lk, zr_boost_1_81::bind(&sync_queue_base<ValueType, Queue>::not_empty_or_closed, zr_boost_1_81::ref(*this), zr_boost_1_81::ref(lk)));
  ...
  {
    if (! cond_.wait_until(lk, tp, zr_boost_1_81::bind(&sync_queue_base<ValueType, Queue>::not_empty_or_closed, zr_boost_1_81::ref(*this), zr_boost_1_81::ref(lk))))
