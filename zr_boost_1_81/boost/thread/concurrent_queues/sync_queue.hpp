...
namespace concurrent
{
  ...
  private:
    ...
    {
      elem = zr_boost_1_81::move(super::data_.front());
      super::data_.pop_front();
    }
    inline value_type pull(unique_lock<mutex>& )
    {
      value_type e = zr_boost_1_81::move(super::data_.front());
      super::data_.pop_front();
      return zr_boost_1_81::move(e);
    }
    ...
    {
      super::data_.push_back(zr_boost_1_81::move(elem));
      super::notify_elem_added(lk);
    }
  };
...
//      {
//        data_.push(zr_boost_1_81::move(*cur));;
//      }
...
//  }
  ...
  {
    if (super::closed(lk)) return queue_op_status::closed;
    push(zr_boost_1_81::move(elem), lk);
    return queue_op_status::success;
  }
  ...
  {
    unique_lock<mutex> lk(super::mtx_);
    return wait_push(zr_boost_1_81::move(elem), lk);
  }
  ...
  {
    sbq.push(zr_boost_1_81::move(elem));
    return sbq;
  }
