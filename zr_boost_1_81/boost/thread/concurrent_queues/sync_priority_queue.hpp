...
namespace detail {
  ...
  public:
      ...
      {
          _elements.push_back(zr_boost_1_81::move(element));
          std::push_heap(_elements.begin(), _elements.end(), _compare);
      }
      ...
      Type pull()
      {
          Type result = zr_boost_1_81::move(_elements.front());
          pop();
...
namespace concurrent
{
  ...
  class sync_priority_queue
    : public detail::sync_queue_base<ValueType, zr_boost_1_81::detail::priority_queue<ValueType,Container,Compare> >
  {
    typedef detail::sync_queue_base<ValueType, zr_boost_1_81::detail::priority_queue<ValueType,Container,Compare> >  super;
  ...
  {
    super::throw_if_closed(lk);
    super::data_.push(zr_boost_1_81::move(elem));
    super::notify_elem_added(lk);
  }
  template <class T, class Container,class Cmp>
  ...
  {
    lock_guard<mutex> lk(super::mtx_);
    push(lk, zr_boost_1_81::move(elem));
  }
