...
namespace zr_boost_1_81
{
    namespace detail
    {
        ...
        struct basic_recursive_mutex_impl
        {
            ...
            {
                long const current_thread_id=zr_boost_1_81::winapi::GetCurrentThreadId();
            ...
            bool timed_lock(::zr_boost_1_81::system_time const& target)
            {
                long const current_thread_id=zr_boost_1_81::winapi::GetCurrentThreadId();
        ...
        private:
            ...
            {
                if(::zr_boost_1_81::detail::interlocked_read_acquire(&locking_thread_id)==current_thread_id)
                {
                    ++recursion_count;
                    return true;
                }
...
#if defined BOOST_THREAD_USES_DATETIME
            bool try_timed_lock(long current_thread_id,::zr_boost_1_81::system_time const& target)
            {
