...
namespace zr_boost_1_81
{
    namespace detail
    {
        ...
        public:
            ...
            static bool no_waiters(zr_boost_1_81::intrusive_ptr<basic_cv_list_entry> const& entry)
            {
        ...
        {
            zr_boost_1_81::mutex internal_mutex;
            long total_count;
            unsigned active_generation_count;

            typedef basic_cv_list_entry list_entry;

            typedef zr_boost_1_81::intrusive_ptr<list_entry> entry_ptr;
            ...
            {
                zr_boost_1_81::lock_guard<zr_boost_1_81::mutex> lk(internal_mutex);
                if(!wake_sem)
                {
            ...
            struct entry_manager
            {
                ...
                entry_manager(entry_ptr&& entry_, zr_boost_1_81::mutex& mutex_):
                    entry(static_cast< entry_ptr&& >(entry_)), internal_mutex(mutex_)
                {}
#else
                entry_manager(entry_ptr const& entry_, zr_boost_1_81::mutex& mutex_):
                ...
                {
                  if (entry) {
                    zr_boost_1_81::lock_guard<zr_boost_1_81::mutex> internal_lock(internal_mutex);
                    entry->remove_waiter();
                    entry.reset();
                  }
                }
    ...
    public:
...
#if defined BOOST_THREAD_USES_DATETIME
        bool timed_wait(unique_lock<mutex>& m,zr_boost_1_81::system_time const& abs_time)
        {
        ...
        bool timed_wait(unique_lock<mutex>& m,zr_boost_1_81::xtime const& abs_time)
        {
        ...
        template<typename predicate_type>
        bool timed_wait(unique_lock<mutex>& m,zr_boost_1_81::system_time const& abs_time,predicate_type pred)
        {
        ...
        template<typename predicate_type>
        bool timed_wait(unique_lock<mutex>& m,zr_boost_1_81::xtime const& abs_time,predicate_type pred)
        {
