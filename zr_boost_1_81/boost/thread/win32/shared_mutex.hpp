...
namespace zr_boost_1_81
{
            ...
            for(;;)
            {
                ...
                for(;;)
                {
                    ...
                    if(new_state.exclusive || new_state.exclusive_waiting_blocked)
                    {
                        ...
                        {
                            zr_boost_1_81::throw_exception(zr_boost_1_81::lock_error());
                        }
                    }
                    else
                    {
                ...
                BOOST_VERIFY(winapi::WaitForSingleObjectEx(semaphores[unlock_sem],::zr_boost_1_81::detail::win32::infinite,0)==0);
            }
        }
    ...
    public:
        ...
        bool timed_lock_shared(zr_boost_1_81::system_time const& wait_until)
        {
        ...
        void lock()
        {
            for(;;)
            {
                ...
                #endif
                BOOST_VERIFY(winapi::WaitForMultipleObjectsEx(2,semaphores,wait_all,::zr_boost_1_81::detail::win32::infinite,0)<2);
            }
        }
...
#if defined BOOST_THREAD_USES_DATETIME
        bool timed_lock(zr_boost_1_81::system_time const& wait_until)
        {
            const detail::real_platform_timepoint t(wait_until);
