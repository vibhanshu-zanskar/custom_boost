...
#pragma warning(pop)
            ...
            void lock()
            {
                ...
                if(old_count&lock_flag_value)
                {
                    ...
                    do
                    {
                        if(winapi::WaitForSingleObjectEx(sem,::zr_boost_1_81::detail::win32::infinite,0)==0)
                        {
        ...
        public:
            ...
            bool timed_lock(zr_boost_1_81::xtime const& timeout)
            {
                return timed_lock(zr_boost_1_81::system_time(timeout));
            }
#endif
#ifdef BOOST_THREAD_USES_CHRONO
        ...
        private:
            ...
            void* get_event()
            {
                void* current_event=::zr_boost_1_81::detail::interlocked_read_acquire(&event);
