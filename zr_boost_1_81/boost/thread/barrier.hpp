...
namespace zr_boost_1_81
{
  namespace thread_detail
  {
    ...
    struct void_functor_barrier_reseter
    {
      ...
      : size_(size), fct_(zr_boost_1_81::move(funct))
      {}
      template <typename F>
      ...
      //size_(BOOST_THREAD_RV(other).size_), fct_(zr_boost_1_81::move(BOOST_THREAD_RV(other).fct_))
      {
      }
  ...
  class barrier
  {
    ...
    {
      if (count == 0) zr_boost_1_81::throw_exception(
