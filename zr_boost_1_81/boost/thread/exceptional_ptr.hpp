...
namespace zr_boost_1_81
{
  struct exceptional_ptr {
    ...
    template <class E>
    explicit exceptional_ptr(BOOST_FWD_REF(E) ex) : ptr_(zr_boost_1_81::copy_exception(zr_boost_1_81::forward<E>(ex))) {}
  };

  template <class E>
  inline exceptional_ptr make_exceptional(BOOST_FWD_REF(E) ex) {
    return exceptional_ptr(zr_boost_1_81::forward<E>(ex));
  }
