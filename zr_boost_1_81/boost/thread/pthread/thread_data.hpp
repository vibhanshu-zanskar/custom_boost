...
#define BOOST_THREAD_DEFINES_THREAD_ATTRIBUTES_NATIVE_HANDLE
    ...
    namespace detail
    {
        ...
        typedef zr_boost_1_81::shared_ptr<thread_data_base> thread_data_ptr;
            ...
            enable_shared_from_this<thread_data_base>
        {
            ...
            zr_boost_1_81::mutex data_mutex;
            zr_boost_1_81::condition_variable done_condition;
            bool done;
            bool join_started;
            bool joined;
            zr_boost_1_81::detail::thread_exit_callback_node* thread_exit_callbacks;
            std::map<void const*,zr_boost_1_81::detail::tss_data_node> tss_data;
