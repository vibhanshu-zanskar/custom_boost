...
public:
    ...
    template <class Rep, class Period>
        bool try_lock_for(const zr_boost_1_81::chrono::duration<Rep, Period>& rel_time);
    template <class Clock, class Duration>
        bool
        try_lock_until(
                      const zr_boost_1_81::chrono::time_point<Clock, Duration>& abs_time);
    void unlock();
    ...
    template <class Rep, class Period>
        bool
        try_lock_shared_for(const zr_boost_1_81::chrono::duration<Rep, Period>& rel_time);
    template <class Clock, class Duration>
        bool
...
public:
    ...
    template <class Rep, class Period>
        ...
        try_lock_upgrade_for(
                            const zr_boost_1_81::chrono::duration<Rep, Period>& rel_time);
    template <class Clock, class Duration>
        bool
...
namespace zr_boost_1_81 {
  namespace thread_v2 {
    ...
    class shared_mutex
    {
      typedef zr_boost_1_81::mutex              mutex_t;
      typedef zr_boost_1_81::condition_variable cond_t;
...
#ifdef BOOST_THREAD_USES_CHRONO
      template <class Rep, class Period>
      bool try_lock_shared_for(const zr_boost_1_81::chrono::duration<Rep, Period>& rel_time)
      {
    ...
    inline shared_mutex::~shared_mutex()
    {
      zr_boost_1_81::lock_guard<mutex_t> _(mut_);
    }
    ...
    {
      zr_boost_1_81::unique_lock<mutex_t> lk(mut_);
      gate1_.wait(lk, zr_boost_1_81::bind(&shared_mutex::no_writer, zr_boost_1_81::ref(*this)));
      state_ |= write_entered_;
      gate2_.wait(lk, zr_boost_1_81::bind(&shared_mutex::no_readers, zr_boost_1_81::ref(*this)));
    }
    ...
    {
      zr_boost_1_81::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.wait_until(lk, abs_time, zr_boost_1_81::bind(
            &shared_mutex::no_writer, zr_boost_1_81::ref(*this))))
      {
        return false;
      }
      state_ |= write_entered_;
      if (!gate2_.wait_until(lk, abs_time, zr_boost_1_81::bind(
            &shared_mutex::no_readers, zr_boost_1_81::ref(*this))))
      {
        state_ &= ~write_entered_;
        return false;
      }
    ...
    {
      zr_boost_1_81::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.timed_wait(lk, abs_or_rel_time, zr_boost_1_81::bind(
            &shared_mutex::no_writer, zr_boost_1_81::ref(*this))))
      {
        return false;
      }
      state_ |= write_entered_;
      if (!gate2_.timed_wait(lk, abs_or_rel_time, zr_boost_1_81::bind(
            &shared_mutex::no_readers, zr_boost_1_81::ref(*this))))
      {
        state_ &= ~write_entered_;
        return false;
    ...
    {
      zr_boost_1_81::unique_lock<mutex_t> lk(mut_);
      gate1_.wait(lk, zr_boost_1_81::bind(&shared_mutex::no_writer_no_max_readers, zr_boost_1_81::ref(*this)));
        ...
        const zr_boost_1_81::chrono::time_point<Clock, Duration>& abs_time)
    {
      zr_boost_1_81::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.wait_until(lk, abs_time, zr_boost_1_81::bind(
            &shared_mutex::no_writer_no_max_readers, zr_boost_1_81::ref(*this))))
      {
        return false;
      }
      count_t num_readers = (state_ & n_readers_) + 1;
...
namespace zr_boost_1_81 {
  namespace thread_v2 {
    ...
    {
      zr_boost_1_81::unique_lock<mutex_t> lk(mut_);
      gate1_.wait(lk, zr_boost_1_81::bind(&upgrade_mutex::no_writer_no_upgrader, zr_boost_1_81::ref(*this)));
      state_ |= write_entered_;
      gate2_.wait(lk, zr_boost_1_81::bind(&upgrade_mutex::no_readers, zr_boost_1_81::ref(*this)));
    }
        ...
        const zr_boost_1_81::chrono::time_point<Clock, Duration>& abs_time)
    {
      zr_boost_1_81::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.wait_until(lk, abs_time, zr_boost_1_81::bind(
            &upgrade_mutex::no_writer_no_upgrader, zr_boost_1_81::ref(*this))))
      {
        return false;
      }
      state_ |= write_entered_;
      if (!gate2_.wait_until(lk, abs_time, zr_boost_1_81::bind(
            &upgrade_mutex::no_readers, zr_boost_1_81::ref(*this))))
      {
        state_ &= ~write_entered_;
        return false;
      }
    ...
    {
      zr_boost_1_81::unique_lock<mutex_t> lk(mut_);
      gate1_.wait(lk, zr_boost_1_81::bind(&upgrade_mutex::no_writer_no_max_readers, zr_boost_1_81::ref(*this)));
      count_t num_readers = (state_ & n_readers_) + 1;
      state_ &= ~n_readers_;
      state_ |= num_readers;
    }
        ...
        const zr_boost_1_81::chrono::time_point<Clock, Duration>& abs_time)
    {
      zr_boost_1_81::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.wait_until(lk, abs_time, zr_boost_1_81::bind(
            &upgrade_mutex::no_writer_no_max_readers, zr_boost_1_81::ref(*this))))
      {
        return false;
      }
      count_t num_readers = (state_ & n_readers_) + 1;
    ...
    {
      zr_boost_1_81::unique_lock<mutex_t> lk(mut_);
      gate1_.wait(lk, zr_boost_1_81::bind(&upgrade_mutex::no_writer_no_upgrader_no_max_readers, zr_boost_1_81::ref(*this)));
      count_t num_readers = (state_ & n_readers_) + 1;
      state_ &= ~n_readers_;
        ...
        const zr_boost_1_81::chrono::time_point<Clock, Duration>& abs_time)
    {
      zr_boost_1_81::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.wait_until(lk, abs_time, zr_boost_1_81::bind(
            &upgrade_mutex::no_writer_no_upgrader_no_max_readers, zr_boost_1_81::ref(*this))))
      {
        return false;
      }
      count_t num_readers = (state_ & n_readers_) + 1;
