...
{
//typedef zr_boost_1_81::int_least64_t time_max_t;
typedef zr_boost_1_81::intmax_t time_max_t;
...
inline FP init_steady_clock(kern_return_t & err)
{
  ...
  namespace detail
  {
    ...
    inline timespec ns_to_timespec(zr_boost_1_81::time_max_t const& ns)
    {
      zr_boost_1_81::time_max_t s = ns / 1000000000l;
      timespec ts;
      ts.tv_sec = static_cast<long> (s);
      ts.tv_nsec = static_cast<long> (ns - s * 1000000000l);
      return ts;
    }
    inline zr_boost_1_81::time_max_t timespec_to_ns(timespec const& ts)
    {
      return static_cast<zr_boost_1_81::time_max_t>(ts.tv_sec) * 1000000000l + ts.tv_nsec;
    }
#endif
    ...
    struct platform_duration
    {
      ...
      explicit platform_duration(zr_boost_1_81::time_max_t const& ns = 0) : ts_val(ns_to_timespec(ns)) {}
      zr_boost_1_81::time_max_t getNs() const { return timespec_to_ns(ts_val); }
#else
      explicit platform_duration(zr_boost_1_81::time_max_t const& ns = 0) : ns_val(ns) {}
      zr_boost_1_81::time_max_t getNs() const { return ns_val; }
#endif

#if defined BOOST_THREAD_USES_DATETIME
      platform_duration(zr_boost_1_81::posix_time::time_duration const& rel_time)
      {
#if defined BOOST_THREAD_CHRONO_POSIX_API || defined BOOST_THREAD_CHRONO_MAC_API
...
#else
        ns_val = static_cast<zr_boost_1_81::time_max_t>(rel_time.total_seconds()) * 1000000000l;
      ...
      zr_boost_1_81::time_max_t getMs() const
      {
        const zr_boost_1_81::time_max_t ns = getNs();
    ...
    private:
      ...
      timespec ts_val;
#else
      zr_boost_1_81::time_max_t ns_val;
#endif
    };
    ...
    struct real_platform_timepoint
    {
      ...
      explicit real_platform_timepoint(zr_boost_1_81::time_max_t const& ns) : dur(ns) {}
      zr_boost_1_81::time_max_t getNs() const { return dur.getNs(); }

#if defined BOOST_THREAD_USES_DATETIME
      real_platform_timepoint(zr_boost_1_81::system_time const& abs_time)
        : dur(abs_time - zr_boost_1_81::posix_time::from_time_t(0)) {}
#endif
    ...
    struct real_platform_clock
    {
      static real_platform_timepoint now()
      {
        ...
        zr_boost_1_81::winapi::GetSystemTimeAsFileTime(&ft);  // never fails
        zr_boost_1_81::time_max_t ns = ((((static_cast<zr_boost_1_81::time_max_t>(ft.dwHighDateTime) << 32) | ft.dwLowDateTime) - 116444736000000000LL) * 100LL);
  ...
  struct mono_platform_timepoint
  {
    ...
    explicit mono_platform_timepoint(zr_boost_1_81::time_max_t const& ns) : dur(ns) {}
    zr_boost_1_81::time_max_t getNs() const { return dur.getNs(); }
...
#else
      zr_boost_1_81::time_max_t ns = (std::numeric_limits<zr_boost_1_81::time_max_t>::max)();
  ...
  struct mono_platform_clock
  {
    static mono_platform_timepoint now()
    {
      ...
      zr_boost_1_81::winapi::LARGE_INTEGER_ freq;
      if ( !zr_boost_1_81::winapi::QueryPerformanceFrequency( &freq ) )
      {
      ...
      zr_boost_1_81::winapi::LARGE_INTEGER_ pcount;
      unsigned times=0;
      while ( ! zr_boost_1_81::winapi::QueryPerformanceCounter( &pcount ) )
      {
        if ( ++times > 3 )
        {
      ...
      return mono_platform_timepoint(static_cast<zr_boost_1_81::time_max_t>(ns));
#else
