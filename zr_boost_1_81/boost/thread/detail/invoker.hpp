...
namespace zr_boost_1_81
{
  namespace detail
  {
    ...
    public:
      ...
      : f_(zr_boost_1_81::forward<F>(f), zr_boost_1_81::forward<As>(args)...)
      {}

      BOOST_SYMBOL_VISIBLE
      invoker(BOOST_THREAD_RV_REF(invoker) f) : f_(zr_boost_1_81::move(BOOST_THREAD_RV(f).f_))
      {}
      ...
      invoker& operator=(BOOST_THREAD_RV_REF(invoker) f)
      {
        if (this != &f)
        {
          f_ = zr_boost_1_81::move(BOOST_THREAD_RV(f).f_);
        }
        return *this;
      }
    ...
    private:
      ...
      {
        return detail::invoke(zr_boost_1_81::move(csbl::get<0>(f_)), zr_boost_1_81::move(csbl::get<Indices>(f_))...);
      }
    };
    ...
    public:
      ...
      BOOST_SYMBOL_VISIBLE
      invoker_ret(BOOST_THREAD_RV_REF(invoker_ret) f) : f_(zr_boost_1_81::move(BOOST_THREAD_RV(f).f_))
      {}
    ...
    private:
      ...
      execute(tuple_indices<Indices...>)
      {
        return detail::invoke<R>(zr_boost_1_81::move(csbl::get<0>(f_)), zr_boost_1_81::move(csbl::get<Indices>(f_))...);
      }
    };
...
#define BOOST_THREAD_FWD_PARAM(z, n, unused) , zr_boost_1_81::forward<Arg##n>(arg##n)
#define BOOST_THREAD_FWD_PARAM_A(z, n, unused) , zr_boost_1_81::forward<A##n>(arg##n)
#define BOOST_THREAD_DCL(z, n, unused) Arg##n v##n;
#define BOOST_THREAD_MOVE_PARAM(z, n, unused) , v##n(zr_boost_1_81::move(arg##n))
#define BOOST_THREAD_FORWARD_PARAM_A(z, n, unused) , v##n(zr_boost_1_81::forward<A##n>(arg##n))
#define BOOST_THREAD_MOVE_RHS_PARAM(z, n, unused) , v##n(zr_boost_1_81::move(x.v##n))
#define BOOST_THREAD_MOVE_DCL(z, n, unused) , zr_boost_1_81::move(v##n)
#define BOOST_THREAD_MOVE_DCL_T(z, n, unused) BOOST_PP_COMMA_IF(n) zr_boost_1_81::move(v##n)
...
#define BOOST_THREAD_ASYNC_FUNCT(z, n, unused) \
    ...
    class invoker<Fp, T0, T1, T2, T3, T4, T5, T6, T7, T8>
    {
      ...
      T7 v7_;
      T8 v8_;
      //::zr_boost_1_81::tuple<Fp, T0, T1, T2, T3, T4, T5, T6, T7, T8> f_;
    ...
    public:
      ...
      : fp_(zr_boost_1_81::move(f))
      , v0_(zr_boost_1_81::move(a0))
      , v1_(zr_boost_1_81::move(a1))
      , v2_(zr_boost_1_81::move(a2))
      , v3_(zr_boost_1_81::move(a3))
      , v4_(zr_boost_1_81::move(a4))
      , v5_(zr_boost_1_81::move(a5))
      , v6_(zr_boost_1_81::move(a6))
      , v7_(zr_boost_1_81::move(a7))
      , v8_(zr_boost_1_81::move(a8))
      {}

      BOOST_SYMBOL_VISIBLE
      invoker(BOOST_THREAD_RV_REF(invoker) f)
      : fp_(zr_boost_1_81::move(BOOST_THREAD_RV(f).fp))
      , v0_(zr_boost_1_81::move(BOOST_THREAD_RV(f).v0_))
      , v1_(zr_boost_1_81::move(BOOST_THREAD_RV(f).v1_))
      , v2_(zr_boost_1_81::move(BOOST_THREAD_RV(f).v2_))
      , v3_(zr_boost_1_81::move(BOOST_THREAD_RV(f).v3_))
      , v4_(zr_boost_1_81::move(BOOST_THREAD_RV(f).v4_))
      , v5_(zr_boost_1_81::move(BOOST_THREAD_RV(f).v5_))
      , v6_(zr_boost_1_81::move(BOOST_THREAD_RV(f).v6_))
      , v7_(zr_boost_1_81::move(BOOST_THREAD_RV(f).v7_))
      , v8_(zr_boost_1_81::move(BOOST_THREAD_RV(f).v8_))
      {}

      result_type operator()()
      {
        return detail::invoke(zr_boost_1_81::move(fp_)
            , zr_boost_1_81::move(v0_)
            , zr_boost_1_81::move(v1_)
            , zr_boost_1_81::move(v2_)
            , zr_boost_1_81::move(v3_)
            , zr_boost_1_81::move(v4_)
            , zr_boost_1_81::move(v5_)
            , zr_boost_1_81::move(v6_)
            , zr_boost_1_81::move(v7_)
            , zr_boost_1_81::move(v8_)
        );
      }
    };
