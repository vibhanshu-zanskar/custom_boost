...
namespace zr_boost_1_81 { namespace function_types { 
...
namespace detail 
{
  ...
  template<bits_t Value> struct constant 
    : zr_boost_1_81::integral_constant<bits_t,Value> 
  { };
  ...
  template<bits_t Bits, bits_t CCID> struct encode_bits
    : constant< 
        ::zr_boost_1_81::function_types::detail::encode_bits_impl<Bits,CCID>::value 
      >
  { };
  ...
  {
    typedef constant<
      ::zr_boost_1_81::function_types::detail::tag_ice
        < ::zr_boost_1_81::function_types::detail::bits<LHS>::value
        , ::zr_boost_1_81::function_types::detail::mask<LHS>::value
        , ::zr_boost_1_81::function_types::detail::bits<RHS>::value
        , ::zr_boost_1_81::function_types::detail::mask<RHS>::value
        >::combined_bits 
    > bits;
  ...
  template<class Tag, class QueryTag> struct represents_impl
    : zr_boost_1_81::integral_constant<bool,
        ::zr_boost_1_81::function_types::detail::tag_ice
          < ::zr_boost_1_81::function_types::detail::bits<Tag>::value
          , ::zr_boost_1_81::function_types::detail::mask<Tag>::value
          , ::zr_boost_1_81::function_types::detail::bits<QueryTag>::value
          , ::zr_boost_1_81::function_types::detail::mask<QueryTag>::value
          >::match
      >
  { };
...
} } // namespace ::zr_boost_1_81::function_types
...
template<class Tag> struct has_property_tag<Tag,null_tag>
  : ::zr_boost_1_81::is_same<Tag, null_tag>
{ };
