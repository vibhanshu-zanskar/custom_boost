...
struct cv_code
{
  ...
  BOOST_STATIC_CONSTANT(std::size_t, value = 
      sizeof(::zr_boost_1_81::function_types::detail::switch_cv(
         ::zr_boost_1_81::function_types::detail::ref_to_ptr(_t) ) ));
};

template<typename T> struct cv_traits 
{
  typedef typename zr_boost_1_81::function_types::detail::cv_tag_impl< 
    ::zr_boost_1_81::function_types::detail::cv_code<T>::value >::type
  tag;
