...
struct synthesize_impl
  : detail::synthesize_impl_o
    < ::zr_boost_1_81::function_types::detail::decode_bits<Bits>::flags
    , ::zr_boost_1_81::function_types::detail::decode_bits<Bits>::cc_id
    , ::zr_boost_1_81::mpl::size<Seq>::value
    >
...
struct synthesize_func
  : detail::synthesize_impl
    < Seq
    , ::zr_boost_1_81::function_types::detail::bits
