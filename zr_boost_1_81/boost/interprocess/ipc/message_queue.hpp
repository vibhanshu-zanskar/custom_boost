   ...
   : public ipcdetail::priority_functor<VoidPointer>
{
   ...
   {
      const size_type
       msg_hdr_align  = ::zr_boost_1_81::container::dtl::alignment_of<msg_header>::value,
       index_align    = ::zr_boost_1_81::container::dtl::alignment_of<msg_hdr_ptr_t>::value,
...
class msg_queue_initialization_func_t
{
   ...
   typedef typename zr_boost_1_81::intrusive::
      pointer_traits<VoidPointer>::template
         rebind_pointer<char>::type                               char_ptr;
   typedef typename zr_boost_1_81::intrusive::pointer_traits<char_ptr>::
      difference_type                                             difference_type;
   typedef typename zr_boost_1_81::container::dtl::
