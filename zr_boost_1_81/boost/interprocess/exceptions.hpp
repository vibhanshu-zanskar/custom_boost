...
//!thrown by zr_boost_1_81::interprocess
      ...
      :  m_err(err_info)
   {
      BOOST_TRY{
         if(m_err.get_native_error() != 0){
            ...
            m_str = "zr_boost_1_81::interprocess_exception::library_error";
         }
      }
      BOOST_CATCH(...){} BOOST_CATCH_END
   }
...
class BOOST_SYMBOL_VISIBLE lock_exception : public interprocess_exception
{
   ...
   const char* what() const BOOST_NOEXCEPT_OR_NOTHROW BOOST_OVERRIDE
   {  return "zr_boost_1_81::interprocess::lock_exception";  }
};
...
{
 public:
   bad_alloc() : interprocess_exception("::zr_boost_1_81::interprocess::bad_alloc") {}

   const char* what() const BOOST_NOEXCEPT_OR_NOTHROW BOOST_OVERRIDE
   {  return "zr_boost_1_81::interprocess::bad_alloc";  }
};
