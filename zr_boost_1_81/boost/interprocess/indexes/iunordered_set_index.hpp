...
//!\file
//!Describes index adaptor of zr_boost_1_81::intrusive::unordered_set container, to use it
   ...
   struct equal_function
   {
    ...
    struct hash_function
    {
        ...
        std::size_t operator()(const value_type &val) const
        {
            ...
            return zr_boost_1_81::hash_range(beg, end);
        }
...
//!Index type based in zr_boost_1_81::intrusive::set.
//!Just derives from zr_boost_1_81::intrusive::set
   ...
   ,  public iunordered_set_index_aux<MapConfig>::index_t
{
      ...
      , allocator_type &alloc, size_type new_size)
   {
      ...
      if(!alloc.allocation_command
         (zr_boost_1_81::interprocess::try_shrink_in_place | zr_boost_1_81::interprocess::nothrow_allocation, old_size, received_size, buckets)){
         return old_size;
      }
      ...
      bucket_ptr shunk_p = alloc.allocation_command
         (zr_boost_1_81::interprocess::shrink_in_place | zr_boost_1_81::interprocess::nothrow_allocation, received_size, received_size, buckets);
      ...
      , allocator_type &alloc,  const size_type new_num)
   {
      ...
      bucket_ptr ret = alloc.allocation_command
            (zr_boost_1_81::interprocess::expand_fwd | zr_boost_1_81::interprocess::allocate_new, new_num, received_size, reuse);
      if(ret == old_buckets){
...
struct is_intrusive_index
   <zr_boost_1_81::interprocess::iunordered_set_index<MapConfig> >
{
