...
class sync_id
{
   ...
   {  return zr_boost_1_81::hash_value(m.rand_);  }
...
class sync_handles
{
   ...
   typedef zr_boost_1_81::unordered_map<sync_id, void*> umap_type;
   //key: ordered address of the sync type -> iterator from umap_type. Ordered map to allow closing handles when unmapping
   typedef zr_boost_1_81::container::flat_map<const void*, umap_type::iterator> map_type;
