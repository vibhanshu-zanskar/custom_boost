...
class shm_named_condition_any
{
   ...
   friend class zr_boost_1_81::interprocess::ipcdetail::interprocess_tester;
   ...
   template <class T, class Arg> friend class zr_boost_1_81::interprocess::ipcdetail::named_creation_functor;
   typedef zr_boost_1_81::interprocess::ipcdetail::named_creation_functor<internal_condition> construct_func_t;
   #endif   //#ifndef BOOST_INTERPROCESS_DOXYGEN_INVOKED
};
