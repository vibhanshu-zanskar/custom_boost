...
//   int get_count() const;
   private:
   volatile zr_boost_1_81::uint32_t m_count;
};
...
{  ipcdetail::atomic_write32(&this->m_count, zr_boost_1_81::uint32_t(initialCount));  }
...
{
   return ipcdetail::atomic_add_unless32(&m_count, zr_boost_1_81::uint32_t(-1), zr_boost_1_81::uint32_t(0));
}
