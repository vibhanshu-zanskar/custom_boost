...
class spin_mutex
{
   ...
   void take_ownership(){}
   private:
   volatile zr_boost_1_81::uint32_t m_s;
...
{
   zr_boost_1_81::uint32_t prev_s = ipcdetail::atomic_cas32(const_cast<zr_boost_1_81::uint32_t*>(&m_s), 1, 0);
...
{  ipcdetail::atomic_cas32(const_cast<zr_boost_1_81::uint32_t*>(&m_s), 0, 1);   }
