...
class basic_managed_memory_impl
{
   ...
   bool  create_impl   (void *addr, size_type size)
   {
      ...
      BOOST_TRY{
         ...
         BOOST_ASSERT((0 == (std::size_t)addr % zr_boost_1_81::move_detail::alignment_of<segment_manager>::value));
   ...
   //!memory is available throws a zr_boost_1_81::interprocess::bad_alloc exception
   ...
   //!
   //!-> Throws zr_boost_1_81::interprocess::bad_alloc if there is no available memory
   //!
