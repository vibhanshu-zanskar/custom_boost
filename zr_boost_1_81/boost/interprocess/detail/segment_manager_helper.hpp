...
struct block_header
{
   ...
   size_type total_size_with_header() const
   {
      return get_rounded_size
            ...
            , size_type(::zr_boost_1_81::container::dtl::alignment_of<block_header<size_type> >::value))
           + total_size();
   }
   ...
   {  return block_header_from_value(value, sizeof(T), ::zr_boost_1_81::container::dtl::alignment_of<T>::value);  }
   ...
   :  public Hook
{
   ...
   enum  {  BlockHdrAlignment = ::zr_boost_1_81::container::dtl::alignment_of<block_header<size_type> >::value  };
...
struct index_key
{
   ...
   typedef CharT                                         char_type;
   typedef typename zr_boost_1_81::intrusive::pointer_traits<const_char_ptr_t>::difference_type difference_type;
   typedef typename zr_boost_1_81::move_detail::make_unsigned<difference_type>::type size_type;
