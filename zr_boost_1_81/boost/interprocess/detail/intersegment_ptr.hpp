   ...
   :  public intersegment_base
{
   ...
   typedef zr_boost_1_81::interprocess::flat_map
      <const void *
      ,segment_info_t
   ...
   {
      //------------------------------------------------------------------
      zr_boost_1_81::interprocess::scoped_lock<typename mappings_t::mutex_type> lock(s_map);
      //------------------------------------------------------------------
      base = 0;
...
//! swap specialization
template<class T> inline
void swap (zr_boost_1_81::interprocess::intersegment_ptr<T> &pt,
           zr_boost_1_81::interprocess::intersegment_ptr<T> &pt2)
{  pt.swap(pt2);  }

//!to_raw_pointer() enables zr_boost_1_81::mem_fn to recognize intersegment_ptr.
//!Never throws.
template<class T> inline
T * to_raw_pointer(zr_boost_1_81::interprocess::intersegment_ptr<T> const & p)
{  return p.get();   }

//!Simulation of static_cast between pointers.
//!Never throws.
template<class T, class U> inline
zr_boost_1_81::interprocess::intersegment_ptr<T> static_pointer_cast(const zr_boost_1_81::interprocess::intersegment_ptr<U> &r)
{  return zr_boost_1_81::interprocess::intersegment_ptr<T>(r, zr_boost_1_81::interprocess::ipcdetail::static_cast_tag());  }

//!Simulation of const_cast between pointers.
//!Never throws.
template<class T, class U> inline
zr_boost_1_81::interprocess::intersegment_ptr<T> const_pointer_cast(const zr_boost_1_81::interprocess::intersegment_ptr<U> &r)
{  return zr_boost_1_81::interprocess::intersegment_ptr<T>(r, zr_boost_1_81::interprocess::ipcdetail::const_cast_tag());  }

//!Simulation of dynamic_cast between pointers.
//!Never throws.
template<class T, class U> inline
zr_boost_1_81::interprocess::intersegment_ptr<T> dynamic_pointer_cast(const zr_boost_1_81::interprocess::intersegment_ptr<U> &r)
{  return zr_boost_1_81::interprocess::intersegment_ptr<T>(r, zr_boost_1_81::interprocess::ipcdetail::dynamic_cast_tag());  }

//!Simulation of reinterpret_cast between pointers.
//!Never throws.
template<class T, class U> inline
zr_boost_1_81::interprocess::intersegment_ptr<T> reinterpret_pointer_cast(const zr_boost_1_81::interprocess::intersegment_ptr<U> &r)
{  return zr_boost_1_81::interprocess::intersegment_ptr<T>(r, zr_boost_1_81::interprocess::ipcdetail::reinterpret_cast_tag());  }

//!Trait class to detect if an smart pointer has
//!multi-segment addressing capabilities.
template <class T>
struct is_multisegment_ptr
   <zr_boost_1_81::interprocess::intersegment_ptr<T> >
{
