...
//! Atomically increment an zr_boost_1_81::uint32_t by 1
//! "mem": pointer to the object
//! Returns the old value pointed to by mem
inline zr_boost_1_81::uint32_t atomic_inc32(volatile zr_boost_1_81::uint32_t *mem);

//! Atomically read an zr_boost_1_81::uint32_t from memory
inline zr_boost_1_81::uint32_t atomic_read32(volatile zr_boost_1_81::uint32_t *mem);

//! Atomically set an zr_boost_1_81::uint32_t in memory
//! "mem": pointer to the object
//! "param": val value that the object will assume
inline void atomic_write32(volatile zr_boost_1_81::uint32_t *mem, zr_boost_1_81::uint32_t val);

//! Compare an zr_boost_1_81::uint32_t's value with "cmp".
//! If they are the same swap the value with "with"
//! "mem": pointer to the value
//! "with": what to swap it with
//! "cmp": the value to compare it to
//! Returns the old value of *mem
inline zr_boost_1_81::uint32_t atomic_cas32
   (volatile zr_boost_1_81::uint32_t *mem, zr_boost_1_81::uint32_t with, zr_boost_1_81::uint32_t cmp);
...
//! Atomically decrement an zr_boost_1_81::uint32_t by 1
//! "mem": pointer to the atomic value
//! Returns the old value pointed to by mem
inline zr_boost_1_81::uint32_t atomic_dec32(volatile zr_boost_1_81::uint32_t *mem)
{  return (zr_boost_1_81::uint32_t)winapi::interlocked_decrement(reinterpret_cast<volatile long*>(mem)) + 1;  }

//! Atomically increment an apr_uint32_t by 1
//! "mem": pointer to the object
//! Returns the old value pointed to by mem
inline zr_boost_1_81::uint32_t atomic_inc32(volatile zr_boost_1_81::uint32_t *mem)
{  return (zr_boost_1_81::uint32_t)winapi::interlocked_increment(reinterpret_cast<volatile long*>(mem))-1;  }

//! Atomically read an zr_boost_1_81::uint32_t from memory
inline zr_boost_1_81::uint32_t atomic_read32(volatile zr_boost_1_81::uint32_t *mem)
{
    const zr_boost_1_81::uint32_t val = *mem;
...
inline zr_boost_1_81::uint32_t atomic_cas32
   (volatile zr_boost_1_81::uint32_t *mem, zr_boost_1_81::uint32_t with, zr_boost_1_81::uint32_t cmp)
{  return (zr_boost_1_81::uint32_t)winapi::interlocked_compare_exchange(reinterpret_cast<volatile long*>(mem), (long)with, (long)cmp);  }
...
inline zr_boost_1_81::uint32_t atomic_cas32
   (volatile zr_boost_1_81::uint32_t *mem, zr_boost_1_81::uint32_t with, zr_boost_1_81::uint32_t cmp)
{
   zr_boost_1_81::uint32_t prev = cmp;
...
//! Atomically add 'val' to an zr_boost_1_81::uint32_t
//! "mem": pointer to the object
//! "val": amount to add
//! Returns the old value pointed to by mem
inline zr_boost_1_81::uint32_t atomic_add32
   (volatile zr_boost_1_81::uint32_t *mem, zr_boost_1_81::uint32_t val)
{
   // int r = *pw;
   // *mem += val;
   // return r;
   zr_boost_1_81::uint32_t r;
...
//! Returns the old value pointed to by mem
inline zr_boost_1_81::uint32_t atomic_dec32(volatile zr_boost_1_81::uint32_t *mem)
{  return atomic_add32(mem, (zr_boost_1_81::uint32_t)-1);  }
...
//! "val": amount to add
//! Returns the old value pointed to by mem
inline zr_boost_1_81::uint32_t atomic_add32(volatile zr_boost_1_81::uint32_t *mem, zr_boost_1_81::uint32_t val)
{
   zr_boost_1_81::uint32_t prev, temp;
...
//! Returns the old value pointed to by mem
inline zr_boost_1_81::uint32_t atomic_dec32(volatile zr_boost_1_81::uint32_t *mem)
{  return atomic_add32(mem, zr_boost_1_81::uint32_t(-1u));  }
...
//! Returns the old value pointed to by mem
inline zr_boost_1_81::uint32_t atomic_dec32(volatile zr_boost_1_81::uint32_t *mem)
{  return atomic_add_32_nv(reinterpret_cast<volatile ::uint32_t*>(mem), (zr_boost_1_81::uint32_t)-1) + 1; }
...
inline zr_boost_1_81::uint32_t atomic_dec32(volatile zr_boost_1_81::uint32_t *mem)
{  zr_boost_1_81::uint32_t old_val = __ATOMIC_DECREMENT_LONG(mem); __MB(); return old_val; }
...
inline zr_boost_1_81::uint32_t atomic_read32(volatile zr_boost_1_81::uint32_t *mem)
{  zr_boost_1_81::uint32_t old_val = *mem; __MB(); return old_val;  }
...
//first define zr_boost_1_81::uint32_t versions of __lwarx and __stwcx to avoid poluting
...
inline zr_boost_1_81::uint32_t lwarxu(volatile zr_boost_1_81::uint32_t *mem)
{
   return static_cast<zr_boost_1_81::uint32_t>(__lwarx(reinterpret_cast<volatile int*>(mem)));
}
...
//!unsuccessful
inline bool stwcxu(volatile zr_boost_1_81::uint32_t* mem, zr_boost_1_81::uint32_t val)
{
...
inline zr_boost_1_81::uint32_t atomic_add32
   (volatile zr_boost_1_81::uint32_t *mem, zr_boost_1_81::uint32_t val)
{
   zr_boost_1_81::uint32_t oldValue;
   do
   {
      oldValue = lwarxu(mem);
...
{
   zr_boost_1_81::uint32_t oldValue;
   zr_boost_1_81::uint32_t valueToStore;
   do
   {
      oldValue = lwarxu(mem);
...
inline zr_boost_1_81::uint32_t atomic_add32
   (volatile zr_boost_1_81::uint32_t *mem, zr_boost_1_81::uint32_t val)
{  return __sync_fetch_and_add(const_cast<zr_boost_1_81::uint32_t *>(mem), val);   }
...
//! Atomically read an zr_boost_1_81::uint32_t from memory
inline zr_boost_1_81::uint32_t atomic_read32(volatile zr_boost_1_81::uint32_t *mem)
{  zr_boost_1_81::uint32_t old_val = *mem; __sync_synchronize(); return old_val;  }
...
inline zr_boost_1_81::uint32_t atomic_cas32
   (volatile zr_boost_1_81::uint32_t *mem, zr_boost_1_81::uint32_t with, zr_boost_1_81::uint32_t cmp)
{  return __sync_val_compare_and_swap(const_cast<zr_boost_1_81::uint32_t *>(mem), cmp, with);   }
...
#define vx_atomic_cast(_i)   (reinterpret_cast< ::atomic32_t *>( const_cast<zr_boost_1_81::uint32_t *>(_i)))
...
inline bool atomic_add_unless32
   (volatile zr_boost_1_81::uint32_t *mem, zr_boost_1_81::uint32_t value, zr_boost_1_81::uint32_t unless_this)
{
   zr_boost_1_81::uint32_t old, c(atomic_read32(mem));
