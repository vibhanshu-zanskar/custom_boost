 ...
 public:
                          ...
                          const permissions &perm)
   {
      BOOST_TRY{
         ...
         zr_boost_1_81::interprocess::basic_ovectorstream<zr_boost_1_81::interprocess::string> formatter;
         ...
         //This can throw.
         m_shmem_list.push_back(zr_boost_1_81::move(mshm));
         return true;
      }
      BOOST_CATCH(const std::bad_alloc&){
      }
