...
inline int thread_create( OS_thread_t * thread, zr_boost_1_81::ipwinapiext::LPTHREAD_START_ROUTINE_ start_routine, void* arg )
{
   void* h = zr_boost_1_81::ipwinapiext::CreateThread(0, 0, start_routine, arg, 0, 0);
...
inline zr_boost_1_81::winapi::DWORD_ __stdcall launch_thread_routine(zr_boost_1_81::winapi::LPVOID_ pv)
{
