...
{
   typedef zr_boost_1_81::interprocess::ipcdetail::spin_mutex              mutex_type;
   typedef zr_boost_1_81::interprocess::ipcdetail::spin_recursive_mutex    recursive_mutex_type;
};
