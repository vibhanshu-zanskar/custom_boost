   ...
   >
{
   ...
   typedef zr_boost_1_81::interprocess::version_type
   ...
   {  zr_boost_1_81::adl_move_swap(alloc1.m_node_pool, alloc2.m_node_pool);  }
   ...
   #endif   //#ifndef BOOST_INTERPROCESS_DOXYGEN_INVOKED
{
   ...
   public:
   typedef zr_boost_1_81::interprocess::version_type<private_node_allocator, 2>   version;
