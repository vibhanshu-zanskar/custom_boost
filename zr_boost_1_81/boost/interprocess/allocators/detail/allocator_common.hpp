...
#include <boost/utility/addressof.hpp> //zr_boost_1_81::addressof
#include <boost/assert.hpp>   //BOOST_ASSERT
#include <boost/interprocess/exceptions.hpp> //bad_alloc
#include <boost/interprocess/sync/scoped_lock.hpp> //scoped_lock
#include <boost/interprocess/containers/allocation_type.hpp> //zr_boost_1_81::interprocess::allocation_type
...
struct get_or_create_node_pool_func
{
   ...
   //!Can throw zr_boost_1_81::interprocess::bad_alloc
   void operator()()
   {
      //Find or create the node_pool_t
      mp_node_pool =    mp_segment_manager->template find_or_construct
                        <NodePool>(zr_boost_1_81::interprocess::unique_instance)(mp_segment_manager);
...
struct destroy_if_last_link_func
{
   ...
   void operator()()
   {
      ...
      mp_node_pool->get_segment_manager()->template destroy<NodePool>(zr_boost_1_81::interprocess::unique_instance);
   }
...
class cache_impl
{
   ...
   {
      ::zr_boost_1_81::adl_move_swap(mp_node_pool, other.mp_node_pool);
      ::zr_boost_1_81::adl_move_swap(m_cached_nodes, other.m_cached_nodes);
      ::zr_boost_1_81::adl_move_swap(m_max_cached_nodes, other.m_max_cached_nodes);
   }
};
...
class array_allocation_impl
{
   ...
   typedef zr_boost_1_81::container::dtl::transform_multiallocation_chain
   ...
   pointer allocation_command(zr_boost_1_81::interprocess::allocation_type command,
   ...
   {  return pointer(zr_boost_1_81::addressof(value));  }

   //!Returns address of non mutable object.
   //!Never throws
   const_pointer address(const_reference value) const
   {  return const_pointer(zr_boost_1_81::addressof(value));  }
   ...
   {  ::new((void*)ipcdetail::to_raw_pointer(ptr), boost_container_new_t()) value_type(::zr_boost_1_81::forward<P>(p));  }
      ...
      , SegmentManager>
{
   ...
   //!Throws zr_boost_1_81::interprocess::bad_alloc if there is no enough memory
         ...
         <cached_allocator_impl<T, NodePool, Version>, T, typename NodePool::segment_manager>
{
   ...
   {  ::zr_boost_1_81::adl_move_swap(alloc1.m_cache, alloc2.m_cache);   }
   ...
   : public private_node_allocator_t
{
 ...
 public:
   ...
   //!Allocates array of count elements. Can throw zr_boost_1_81::interprocess::bad_alloc
   void *allocate_node()
   {
      //-----------------------
