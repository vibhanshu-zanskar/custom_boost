...
class allocator
{
   ...
   typedef zr_boost_1_81::interprocess::version_type<allocator, 2>   version;
   ...
   {  zr_boost_1_81::adl_move_swap(alloc1.mp_mngr, alloc2.mp_mngr);   }
...
template<class T, class SegmentManager>
struct has_trivial_destructor
   <zr_boost_1_81::interprocess::allocator <T, SegmentManager> >
{
