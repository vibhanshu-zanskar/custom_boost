   ...
   >
{
   ...
   typedef zr_boost_1_81::interprocess::version_type<node_allocator_base, Version>   version;
   ...
   node_allocator_base& operator=(const node_allocator_base &other)
   {
      ...
      zr_boost_1_81::adl_move_swap(*this, c);
      return *this;
   }
   ...
   {  zr_boost_1_81::adl_move_swap(alloc1.mp_node_pool, alloc2.mp_node_pool);  }
   ...
   #endif   //#ifndef BOOST_INTERPROCESS_DOXYGEN_INVOKED
{
   ...
   public:
   typedef zr_boost_1_81::interprocess::version_type<node_allocator, 2>   version;
