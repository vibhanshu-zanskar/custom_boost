   ...
   >
{
   ...
   typedef zr_boost_1_81::interprocess::version_type<adaptive_pool_base, Version>   version;
   ...
   #endif   //#ifndef BOOST_INTERPROCESS_DOXYGEN_INVOKED
{
   ...
   public:
   typedef zr_boost_1_81::interprocess::version_type<adaptive_pool, 2>   version;
