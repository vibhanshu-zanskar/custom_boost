...
{
   static const std::size_t segment_manager_alignment = zr_boost_1_81::move_detail::alignment_of
         < segment_manager
               < CharType
               , AllocationAlgorithm
               , IndexType>
         ...
         <CharType, AllocationAlgorithm, IndexType>::type::ManagedOpenOrCreateUserOffset>
{
   ...
   {
      basic_managed_windows_shared_memory tmp(zr_boost_1_81::move(moved));
      this->swap(tmp);
      return *this;
   }
