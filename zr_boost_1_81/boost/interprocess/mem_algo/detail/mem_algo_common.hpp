...
class basic_multiallocation_chain
   : public zr_boost_1_81::container::dtl::
      basic_multiallocation_chain<VoidPointer>
{
   ...
   {
      this->base_t::operator=(::zr_boost_1_81::move(static_cast<base_t&>(other)));
      return *this;
   }

   void *pop_front()
   {
      return zr_boost_1_81::interprocess::ipcdetail::to_raw_pointer(this->base_t::pop_front());
   }
};
      ...
      (MemoryAlgorithm *memory_algo, size_type nbytes, size_type alignment)
   {
      ...
      if(alignment <= Alignment){
         ...
         return memory_algo->priv_allocate
            (zr_boost_1_81::interprocess::allocate_new, nbytes, real_size, ignore_reuse);
      }
      ...
      real_size = request;
      void *ignore_reuse = 0;
      void *buffer = memory_algo->priv_allocate(zr_boost_1_81::interprocess::allocate_new, request, real_size, ignore_reuse);
      if(!buffer){
         return 0;
      }
      ...
      if(total_request_units && !multiplication_overflows(total_request_units, Alignment)){
         ...
         while(low_idx < n_elements){
            ...
            void *ret = memory_algo->priv_allocate
               (zr_boost_1_81::interprocess::allocate_new, min_allocation, received_size, ignore_reuse);
            if(!ret){
               break;
            }
