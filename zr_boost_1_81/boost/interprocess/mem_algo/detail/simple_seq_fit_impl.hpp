...
class simple_seq_fit_impl
{
   ...
   {
      //-----------------------
      zr_boost_1_81::interprocess::scoped_lock<interprocess_mutex> guard(m_header);
      //-----------------------
   ...
   void * raw_allocation_command  (zr_boost_1_81::interprocess::allocation_type command,   size_type limit_size,
   ...
   void * priv_allocation_command(zr_boost_1_81::interprocess::allocation_type command
                                 ,size_type min_size
   ...
   public:
   static const size_type Alignment      = ::zr_boost_1_81::container::dtl::alignment_of
...
void simple_seq_fit_impl<MutexFamily, VoidPointer>::shrink_to_fit()
{
   ...
   if(!m_header.m_allocated){
      ...
      void *ignore_reuse = 0;
      unique_block = priv_allocate(zr_boost_1_81::interprocess::allocate_new, 0, ignore_recvd, ignore_reuse);
      if(!unique_block)
         return;
                       ...
                       size_type &prefer_in_recvd_out_size, void *&reuse_ptr, size_type sizeof_object)
{
   ...
   command &= ~zr_boost_1_81::interprocess::expand_bwd;
   if(!command){
      return reuse_ptr = 0, static_cast<void*>(0);
   }
