...
class mapped_region
{
   ...
   {
      mapped_region tmp(zr_boost_1_81::move(other));
      this->swap(tmp);
      return *this;
   }
   ...
   (offset_t mapping_size, offset_t offset, offset_t page_offset, std::size_t &size)
{
   ...
   if(mapping_size < offset ||
      zr_boost_1_81::uintmax_t(mapping_size - (offset - page_offset)) >
         zr_boost_1_81::uintmax_t(std::size_t(-1))){
   ...
   ,  m_file_or_mapping_hnd(ipcdetail::invalid_file())
{
   mapping_handle_t mhandle = mapping.get_mapping_handle();
   {
      ...
      void *base = winapi::map_view_of_file_ex
                                 ...
                                 map_access,
                                 ::zr_boost_1_81::ulong_long_type(offset - page_offset),
...
{
   ::zr_boost_1_81::adl_move_swap(this->m_base, other.m_base);
   ::zr_boost_1_81::adl_move_swap(this->m_size, other.m_size);
   ::zr_boost_1_81::adl_move_swap(this->m_page_offset, other.m_page_offset);
   ::zr_boost_1_81::adl_move_swap(this->m_mode,  other.m_mode);
   #if defined (BOOST_INTERPROCESS_WINDOWS)
   ::zr_boost_1_81::adl_move_swap(this->m_file_or_mapping_hnd, other.m_file_or_mapping_hnd);
   #else
   ::zr_boost_1_81::adl_move_swap(this->m_is_xsi, other.m_is_xsi);
   #endif
}
