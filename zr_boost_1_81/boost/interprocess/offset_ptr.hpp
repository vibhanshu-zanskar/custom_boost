...
namespace ipcdetail {
   ...
   union offset_ptr_internal
   {
      ...
      BOOST_STATIC_ASSERT(zr_boost_1_81::is_integral<OffsetType>::value && zr_boost_1_81::is_unsigned<OffsetType>::value);
      ...
      typename ::zr_boost_1_81::container::dtl::aligned_storage
   ...
   struct enable_if_convertible_equal_address
      : enable_if_c< ::zr_boost_1_81::is_convertible<From*, To*>::value
...
class offset_ptr
{
   ...
   BOOST_INTERPROCESS_FORCEINLINE offset_ptr( T *ptr
             , typename ipcdetail::enable_if< ::zr_boost_1_81::is_convertible<T*, PointedType*> >::type * = 0) BOOST_NOEXCEPT
   ...
   BOOST_INTERPROCESS_FORCEINLINE explicit offset_ptr(const offset_ptr<T2, DifferenceType, OffsetType, OffsetAlignment> &ptr
             ...
             , typename ipcdetail::enable_if_c<
                !::zr_boost_1_81::is_convertible<T2*, PointedType*>::value && ::zr_boost_1_81::is_constructible<T2*, PointedType*>::value
             >::type * = 0
             #endif
             ) BOOST_NOEXCEPT
      : internal(ipcdetail::offset_ptr_to_offset<OffsetType>(static_cast<PointedType*>(ptr.get()), this))
   ...
   #ifndef BOOST_INTERPROCESS_DOXYGEN_INVOKED
   typename ipcdetail::enable_if_c
      < ::zr_boost_1_81::is_convertible<T2*, PointedType*>::value, offset_ptr&>::type
   #else
   offset_ptr&
   #endif
...
BOOST_INTERPROCESS_FORCEINLINE zr_boost_1_81::interprocess::offset_ptr<T1, P1, O1, A1>
   static_pointer_cast(const zr_boost_1_81::interprocess::offset_ptr<T2, P2, O2, A2> & r) BOOST_NOEXCEPT
{
   return zr_boost_1_81::interprocess::offset_ptr<T1, P1, O1, A1>
            (r, zr_boost_1_81::interprocess::ipcdetail::static_cast_tag());
}

//!Simulation of const_cast between pointers. Never throws.
template<class T1, class P1, class O1, std::size_t A1, class T2, class P2, class O2, std::size_t A2>
BOOST_INTERPROCESS_FORCEINLINE zr_boost_1_81::interprocess::offset_ptr<T1, P1, O1, A1>
   const_pointer_cast(const zr_boost_1_81::interprocess::offset_ptr<T2, P2, O2, A2> & r) BOOST_NOEXCEPT
{
   return zr_boost_1_81::interprocess::offset_ptr<T1, P1, O1, A1>
            (r, zr_boost_1_81::interprocess::ipcdetail::const_cast_tag());
}

//!Simulation of dynamic_cast between pointers. Never throws.
template<class T1, class P1, class O1, std::size_t A1, class T2, class P2, class O2, std::size_t A2>
BOOST_INTERPROCESS_FORCEINLINE zr_boost_1_81::interprocess::offset_ptr<T1, P1, O1, A1>
   dynamic_pointer_cast(const zr_boost_1_81::interprocess::offset_ptr<T2, P2, O2, A2> & r) BOOST_NOEXCEPT
{
   return zr_boost_1_81::interprocess::offset_ptr<T1, P1, O1, A1>
            (r, zr_boost_1_81::interprocess::ipcdetail::dynamic_cast_tag());
}

//!Simulation of reinterpret_cast between pointers. Never throws.
template<class T1, class P1, class O1, std::size_t A1, class T2, class P2, class O2, std::size_t A2>
BOOST_INTERPROCESS_FORCEINLINE zr_boost_1_81::interprocess::offset_ptr<T1, P1, O1, A1>
   reinterpret_pointer_cast(const zr_boost_1_81::interprocess::offset_ptr<T2, P2, O2, A2> & r) BOOST_NOEXCEPT
{
   return zr_boost_1_81::interprocess::offset_ptr<T1, P1, O1, A1>
            (r, zr_boost_1_81::interprocess::ipcdetail::reinterpret_cast_tag());
}
...
struct has_trivial_destructor< ::zr_boost_1_81::interprocess::offset_ptr<T, P, O, A> >
{
...
///has_trivial_destructor<> == true_type specialization for optimizations
template <class T, class P, class O, std::size_t A>
struct is_trivially_destructible< ::zr_boost_1_81::interprocess::offset_ptr<T, P, O, A> >
{
   static const bool value = true;
};
...
//!to_raw_pointer() enables zr_boost_1_81::mem_fn to recognize offset_ptr.
//!Never throws.
template <class T, class P, class O, std::size_t A>
BOOST_INTERPROCESS_FORCEINLINE T * to_raw_pointer(zr_boost_1_81::interprocess::offset_ptr<T, P, O, A> const & p) BOOST_NOEXCEPT
...
struct max_pointer_plus_bits<zr_boost_1_81::interprocess::offset_ptr<void, P, O, A>, OffsetAlignment>
{
   //The offset ptr can embed one bit less than the alignment since it
   //uses offset == 1 to store the null pointer.
   static const std::size_t value = ::zr_boost_1_81::interprocess::ipcdetail::ls_zeros<OffsetAlignment>::value - 1;
};
...
struct pointer_plus_bits<zr_boost_1_81::interprocess::offset_ptr<T, P, O, A>, NumBits>
{
   typedef zr_boost_1_81::interprocess::offset_ptr<T, P, O, A>      pointer;
   ...
   BOOST_INTERPROCESS_FORCEINLINE static pointer get_pointer(const pointer &n) BOOST_NOEXCEPT
   {
      ...
      p.priv_offset() = zr_boost_1_81::interprocess::ipcdetail::offset_ptr_to_offset_from_other(&p, &n, tmp_off);
      return p;
   }
...
struct pointer_to_other
   < ::zr_boost_1_81::interprocess::offset_ptr<PointedType, DifferenceType, OffsetType, OffsetAlignment>, U >
{
   typedef ::zr_boost_1_81::interprocess::offset_ptr<U, DifferenceType, OffsetType, OffsetAlignment> type;
};
