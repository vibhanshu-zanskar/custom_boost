...
//!of type T with zr_boost_1_81::interprocess::deleter deleter
//!that can be constructed in the given managed segment type.
template<class T, class ManagedMemory>
struct managed_unique_ptr
{
   typedef zr_boost_1_81::movelib::unique_ptr
   < T
...
//!with zr_boost_1_81::interproces::deleter from a pointer
