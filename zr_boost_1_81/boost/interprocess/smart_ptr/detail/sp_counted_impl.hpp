...
struct scoped_ptr_dealloc_functor
{
   ...
   typedef ipcdetail::integral_constant<unsigned,
      zr_boost_1_81::interprocess::version<Allocator>::value>                   alloc_version;
...
class sp_counted_impl_pd
   ...
   ,  zr_boost_1_81::container::allocator_traits<A>::template
   ...
   ,  D  // copy constructor must not throw
{
   ...
   void destroy() // nothrow
   {
      ...
      this_allocator a_copy(::zr_boost_1_81::move(static_cast<this_allocator&>(*this)));
