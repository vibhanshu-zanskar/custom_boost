...
private:
    ...
    zr_boost_1_81::uint32_t use_count_;        // #shared
    zr_boost_1_81::uint32_t weak_count_;       // #weak + (#shared != 0)
...
public:
    ...
    bool add_ref_lock() // true on success
    {
        for( ;; )
        {
            zr_boost_1_81::uint32_t tmp = static_cast< zr_boost_1_81::uint32_t const volatile& >( use_count_ );
   ...
   { return (long)static_cast<zr_boost_1_81::uint32_t const volatile &>( use_count_ ); }
};
