...
class shared_count
{
   ...
   typedef zr_boost_1_81::container::allocator_traits<VoidAllocator>         vallocator_traits;
...
/*
      ...
      : m_pi( r.m_pi )
   {
      if( m_pi == 0 || !m_pi->add_ref_lock() ){
         zr_boost_1_81::throw_exception( zr_boost_1_81::interprocess::bad_weak_ptr() );
      }
   }
*/
   template<class Y>
   ...
   {
      if( m_pi == 0 || !m_pi->add_ref_lock() ){
         throw( zr_boost_1_81::interprocess::bad_weak_ptr() );
      }
   }
   ...
   {  ::zr_boost_1_81::adl_move_swap(m_px, r.m_px);  ::zr_boost_1_81::adl_move_swap(m_pi, r.m_pi);   }
