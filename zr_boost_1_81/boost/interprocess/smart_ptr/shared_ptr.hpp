...
// to_raw_pointer() enables zr_boost_1_81::mem_fn to recognize shared_ptr
template<class T, class VoidAllocator, class Deleter> inline
...
//!of type T with the allocator zr_boost_1_81::interprocess::allocator allocator
//!and zr_boost_1_81::interprocess::deleter deleter
...
// to_raw_pointer() enables zr_boost_1_81::mem_fn to recognize shared_ptr
template<class T, class VoidAllocator, class Deleter> inline
T * to_raw_pointer(zr_boost_1_81::interprocess::shared_ptr<T, VoidAllocator, Deleter> const & p)
{  return p.get();   }
#endif
