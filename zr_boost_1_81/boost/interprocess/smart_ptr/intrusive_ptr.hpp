...
class intrusive_ptr
{
   ...
   {  ::zr_boost_1_81::adl_move_swap(m_ptr, rhs.m_ptr);  }
...
inline typename zr_boost_1_81::interprocess::intrusive_ptr<T, VP>::pointer
...
inline zr_boost_1_81::interprocess::intrusive_ptr<T, VP> static_pointer_cast
   (zr_boost_1_81::interprocess::intrusive_ptr<U, VP> const & p) BOOST_NOEXCEPT
{  return do_static_cast<U>(p.get());  }
*/
/*Emulates const cast operator. Does not throw*/
/*
template<class T, class U, class VP>
inline zr_boost_1_81::interprocess::intrusive_ptr<T, VP> const_pointer_cast
   (zr_boost_1_81::interprocess::intrusive_ptr<U, VP> const & p) BOOST_NOEXCEPT
...
/*
template<class T, class U, class VP>
inline zr_boost_1_81::interprocess::intrusive_ptr<T, VP> dynamic_pointer_cast
   (zr_boost_1_81::interprocess::intrusive_ptr<U, VP> const & p) BOOST_NOEXCEPT
...
/*
template<class T, class U, class VP>
inline zr_boost_1_81::interprocess::intrusive_ptr<T, VP>reinterpret_pointer_cast
   (zr_boost_1_81::interprocess::intrusive_ptr<U, VP> const & p) BOOST_NOEXCEPT
...
//!Does not throw
template<class T, class VP>
inline T *to_raw_pointer(zr_boost_1_81::interprocess::intrusive_ptr<T, VP> p) BOOST_NOEXCEPT
{  return p.get();   }
#endif
