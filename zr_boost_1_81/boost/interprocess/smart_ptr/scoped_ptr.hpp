   ...
   : private Deleter
{
   ...
   {
      ::zr_boost_1_81::adl_move_swap(static_cast<Deleter&>(*this), static_cast<Deleter&>(b));
      ::zr_boost_1_81::adl_move_swap(m_ptr, b.m_ptr);
   }
...
template<class T, class D> inline
T *to_raw_pointer(zr_boost_1_81::interprocess::scoped_ptr<T, D> const & p)
{  return p.get();   }
#endif
