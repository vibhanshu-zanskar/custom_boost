...
#if defined(BOOST_LOCKFREE_NO_HDR_ATOMIC) || defined(BOOST_LOCKFREE_FORCE_BOOST_ATOMIC)
using zr_boost_1_81::atomic;
using zr_boost_1_81::memory_order_acquire;
using zr_boost_1_81::memory_order_consume;
using zr_boost_1_81::memory_order_relaxed;
using zr_boost_1_81::memory_order_release;
#else
using std::atomic;
