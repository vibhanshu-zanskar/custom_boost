...
{
public:
    typedef zr_boost_1_81::uint16_t tag_t;
    typedef zr_boost_1_81::uint16_t index_t;
...
struct BOOST_ALIGNMENT(BOOST_LOCKFREE_CACHELINE_BYTES) compiletime_sized_freelist_storage
{
    ...
    zr_boost_1_81::array<char, size * sizeof(T) + 64> data;
    ...
    T * nodes(void) const
    {
        ...
        return reinterpret_cast<T*>( zr_boost_1_81::alignment::align_up( data_pointer, BOOST_LOCKFREE_CACHELINE_BYTES ) );
    }
...
struct runtime_sized_freelist_storage:
    zr_boost_1_81::alignment::aligned_allocator_adaptor<Alloc, BOOST_LOCKFREE_CACHELINE_BYTES >
{
    typedef zr_boost_1_81::alignment::aligned_allocator_adaptor<Alloc, BOOST_LOCKFREE_CACHELINE_BYTES > allocator_type;
    T * nodes_;
    ...
    {
        if (count > 65535)
            zr_boost_1_81::throw_exception(std::runtime_error("boost.lockfree: freelist size is limited to a maximum of 65535 objects"));
