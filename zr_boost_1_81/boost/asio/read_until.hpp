...
struct is_match_condition
{
  ...
  enum
  {
    value = zr_boost_1_81::asio::is_function<
        typename zr_boost_1_81::asio::remove_pointer<T>::type>::value
...
/**
 * @defgroup read_until zr_boost_1_81::asio::read_until
 *
 ...
 * std::size_t n = zr_boost_1_81::asio::read_until(s,
 *     zr_boost_1_81::asio::dynamic_buffer(data), '\n');
...
std::size_t read_until(SyncReadStream& s,
    ...
    char delim, zr_boost_1_81::system::error_code& ec,
    typename constraint<
      is_dynamic_buffer_v1<typename decay<DynamicBuffer_v1>::type>::value
    >::type = 0,
    typename constraint<
 ...
 * @code std::string data;
 * std::size_t n = zr_boost_1_81::asio::read_until(s,
 *     zr_boost_1_81::asio::dynamic_buffer(data), zr_boost_1_81::regex("\r\n"));
 * std::string line = data.substr(0, n);
 * data.erase(0, n); @endcode
 * After the @c read_until operation completes successfully, the string @c data
 * contains the delimiter:
...
std::size_t read_until(SyncReadStream& s,
    BOOST_ASIO_MOVE_ARG(DynamicBuffer_v1) buffers,
    const zr_boost_1_81::regex& expr,
    typename constraint<
      is_dynamic_buffer_v1<typename decay<DynamicBuffer_v1>::type>::value
    >::type = 0,
    typename constraint<
...
std::size_t read_until(SyncReadStream& s,
    BOOST_ASIO_MOVE_ARG(DynamicBuffer_v1) buffers,
    const zr_boost_1_81::regex& expr, zr_boost_1_81::system::error_code& ec,
    typename constraint<
      is_dynamic_buffer_v1<typename decay<DynamicBuffer_v1>::type>::value
    >::type = 0,
    typename constraint<
 ...
 * @code typedef zr_boost_1_81::asio::buffers_iterator<
 *     zr_boost_1_81::asio::const_buffers_1> iterator;
 *
 ...
 * ...
 * std::string data;
 * zr_boost_1_81::asio::read_until(s, data, match_whitespace);
 * @endcode
 *
 ...
 * ...
 * std::string data;
 * zr_boost_1_81::asio::read_until(s, data, match_char('a'));
 * @endcode
 */
...
std::size_t read_until(SyncReadStream& s,
    BOOST_ASIO_MOVE_ARG(DynamicBuffer_v1) buffers,
    MatchCondition match_condition, zr_boost_1_81::system::error_code& ec,
    typename constraint<
      is_match_condition<MatchCondition>::value
    >::type = 0,
    typename constraint<
 ...
 * @code zr_boost_1_81::asio::streambuf b;
 * zr_boost_1_81::asio::read_until(s, b, '\n');
 * std::istream is(&b);
 * std::string line;
...
std::size_t read_until(SyncReadStream& s,
    zr_boost_1_81::asio::basic_streambuf<Allocator>& b, char delim);
...
template <typename SyncReadStream, typename Allocator>
std::size_t read_until(SyncReadStream& s,
    zr_boost_1_81::asio::basic_streambuf<Allocator>& b,
    BOOST_ASIO_STRING_VIEW_PARAM delim);
...
std::size_t read_until(SyncReadStream& s,
    zr_boost_1_81::asio::basic_streambuf<Allocator>& b,
    BOOST_ASIO_STRING_VIEW_PARAM delim, zr_boost_1_81::system::error_code& ec);
 ...
 * @code zr_boost_1_81::asio::streambuf b;
 * zr_boost_1_81::asio::read_until(s, b, zr_boost_1_81::regex("\r\n"));
 * std::istream is(&b);
 * std::string line;
 * std::getline(is, line); @endcode
 * After the @c read_until operation completes successfully, the buffer @c b
...
template <typename SyncReadStream, typename Allocator>
std::size_t read_until(SyncReadStream& s,
    zr_boost_1_81::asio::basic_streambuf<Allocator>& b, const zr_boost_1_81::regex& expr);
 ...
 * @code typedef zr_boost_1_81::asio::buffers_iterator<
 *     zr_boost_1_81::asio::streambuf::const_buffers_type> iterator;
 *
 * std::pair<iterator, bool>
 * match_whitespace(iterator begin, iterator end)
 * {
 ...
 * }
 * ...
 * zr_boost_1_81::asio::streambuf b;
 * zr_boost_1_81::asio::read_until(s, b, match_whitespace);
 * @endcode
 *
 ...
 * ...
 * zr_boost_1_81::asio::streambuf b;
 * zr_boost_1_81::asio::read_until(s, b, match_char('a'));
 * @endcode
 */
template <typename SyncReadStream, typename Allocator, typename MatchCondition>
std::size_t read_until(SyncReadStream& s,
    zr_boost_1_81::asio::basic_streambuf<Allocator>& b, MatchCondition match_condition,
...
/*@}*/
/**
 * @defgroup async_read_until zr_boost_1_81::asio::async_read_until
 *
 ...
 * @code void(zr_boost_1_81::system::error_code, std::size_t) @endcode
 *
 ...
 * @code std::string data;
 * ...
 * void handler(const zr_boost_1_81::system::error_code& e, std::size_t size)
 * {
 *   if (!e)
 *   {
 *     std::string line = data.substr(0, n);
 ...
 * }
 * ...
 * zr_boost_1_81::asio::async_read_until(s, data, '\n', handler); @endcode
...
BOOST_ASIO_INITFN_AUTO_RESULT_TYPE_PREFIX(ReadToken,
    void (zr_boost_1_81::system::error_code, std::size_t))
 ...
 * ...
 * std::string data;
 * zr_boost_1_81::asio::async_read_until(s, data, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * std::string data;
 * zr_boost_1_81::asio::async_read_until(s, data, match_char('a'), handler);
 * @endcode
 *
 * @par Per-Operation Cancellation
 * This asynchronous operation supports cancellation for the following
 ...
 * }
 * ...
 * zr_boost_1_81::asio::async_read_until(s, b, '\n', handler); @endcode
 * After the @c async_read_until operation completes successfully, the buffer
 ...
 * }
 * ...
 * zr_boost_1_81::asio::async_read_until(s, b, zr_boost_1_81::regex("\r\n"), handler); @endcode
 * After the @c async_read_until operation completes successfully, the buffer
 ...
 * ...
 * zr_boost_1_81::asio::streambuf b;
 * zr_boost_1_81::asio::async_read_until(s, b, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * zr_boost_1_81::asio::streambuf b;
 * zr_boost_1_81::asio::async_read_until(s, b, match_char('a'), handler);
 * @endcode
 *
 * @par Per-Operation Cancellation
 * This asynchronous operation supports cancellation for the following
