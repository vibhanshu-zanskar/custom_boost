...
public:
   ...
   * @par Example
   * @code
   * zr_boost_1_81::asio::stream_file file(my_context);
   * file.open("/path/to/my/file", zr_boost_1_81::asio::stream_file::read_only);
   * @endcode
   */
   ...
   * zr_boost_1_81::asio::stream_file file(my_context);
   * zr_boost_1_81::system::error_code ec;
   * file.open("/path/to/my/file", zr_boost_1_81::asio::stream_file::read_only, ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
  ...
  BOOST_ASIO_SYNC_OP_VOID open(const char* path,
      file_base::flags open_flags, zr_boost_1_81::system::error_code& ec)
  {
    impl_.get_service().open(impl_.get_implementation(), path, open_flags, ec);
   ...
   * operations will be passed the zr_boost_1_81::asio::error::operation_aborted error.
  ...
  uint64_t size() const
  {
    ...
    zr_boost_1_81::asio::detail::throw_error(ec, "size");
    return s;
  }
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  uint64_t size(zr_boost_1_81::system::error_code& ec) const
  {
  ...
  void resize(uint64_t n)
  {
    ...
    zr_boost_1_81::asio::detail::throw_error(ec, "resize");
  }
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  BOOST_ASIO_SYNC_OP_VOID resize(uint64_t n, zr_boost_1_81::system::error_code& ec)
  {
    impl_.get_service().resize(impl_.get_implementation(), n, ec);
    BOOST_ASIO_SYNC_OP_VOID_RETURN(ec);
  }
  ...
  void sync_all()
  {
    ...
    zr_boost_1_81::asio::detail::throw_error(ec, "sync_all");
  }
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  BOOST_ASIO_SYNC_OP_VOID sync_all(zr_boost_1_81::system::error_code& ec)
  {
    impl_.get_service().sync_all(impl_.get_implementation(), ec);
    BOOST_ASIO_SYNC_OP_VOID_RETURN(ec);
  }
  ...
  void sync_data()
  {
    ...
    zr_boost_1_81::asio::detail::throw_error(ec, "sync_data");
  }
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  BOOST_ASIO_SYNC_OP_VOID sync_data(zr_boost_1_81::system::error_code& ec)
  {
    impl_.get_service().sync_data(impl_.get_implementation(), ec);
    BOOST_ASIO_SYNC_OP_VOID_RETURN(ec);
  }
