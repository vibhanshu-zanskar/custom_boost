...
public:
   ...
   *
   * For example:
   * @code zr_boost_1_81::asio::strand<my_executor_type> ex = ...;
   ...
   *
   * For example:
   * @code zr_boost_1_81::asio::strand<my_executor_type> ex1 = ...;
      ...
      is_nothrow_require<const Executor&, Property>::value))
  {
    return strand<typename decay<
      typename require_result<const Executor&, Property>::type
        >::type>(zr_boost_1_81::asio::require(executor_, p), impl_);
  }
   ...
   * For example:
   * @code zr_boost_1_81::asio::strand<my_executor_type> ex1 = ...;
   * auto ex2 = zr_boost_1_81::asio::prefer(ex1,
   *     zr_boost_1_81::asio::execution::blocking.never); @endcode
   */
  template <typename Property>
  typename constraint<
      ...
      is_nothrow_prefer<const Executor&, Property>::value))
  {
    return strand<typename decay<
      typename prefer_result<const Executor&, Property>::type
        >::type>(zr_boost_1_81::asio::prefer(executor_, p), impl_);
  }
...
private:
      ...
      >::type = 0)
  {
    return use_service<detail::strand_executor_service>(
        zr_boost_1_81::asio::query(ex, execution::context)).create_implementation();
  }
  ...
  {
    return zr_boost_1_81::asio::query(executor_, property);
  }

  template <typename Property>
  execution::blocking_t query_helper(true_type, const Property& property) const
  {
    execution::blocking_t result = zr_boost_1_81::asio::query(executor_, property);
...
/** @defgroup make_strand zr_boost_1_81::asio::make_strand
 *
 * @brief The zr_boost_1_81::asio::make_strand function creates a @ref strand object for
