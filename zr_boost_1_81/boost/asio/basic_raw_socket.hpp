...
public:
   ...
   * @code socket.send(zr_boost_1_81::asio::buffer(data, size)); @endcode
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * zr_boost_1_81::asio::ip::udp::endpoint destination(
   *     zr_boost_1_81::asio::ip::address::from_string("1.2.3.4"), 12345);
   * socket.send_to(zr_boost_1_81::asio::buffer(data, size), destination);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, zr_boost_1_81::array or
   * std::vector.
      ...
      const endpoint_type& destination)
  {
    ...
    zr_boost_1_81::asio::detail::throw_error(ec, "send_to");
    return s;
  }
   ...
   *     zr_boost_1_81::asio::buffer(data, size), destination, handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, zr_boost_1_81::array or
   * std::vector.
   ...
   * follows:
   * @code socket.receive(zr_boost_1_81::asio::buffer(data, size)); @endcode
   ...
   * follows:
   * @code
   * zr_boost_1_81::asio::ip::udp::endpoint sender_endpoint;
   * socket.receive_from(
   *     zr_boost_1_81::asio::buffer(data, size), sender_endpoint);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, zr_boost_1_81::array or
   * std::vector.
      ...
      endpoint_type& sender_endpoint)
  {
    ...
    zr_boost_1_81::asio::detail::throw_error(ec, "receive_from");
    return s;
  }
   ...
   *     zr_boost_1_81::asio::buffer(data, size), 0, sender_endpoint, handler); @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, zr_boost_1_81::array or
   * std::vector.
   *
