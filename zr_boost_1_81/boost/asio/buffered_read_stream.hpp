...
public:
  ...
  std::size_t fill(zr_boost_1_81::system::error_code& ec);
  ...
  /// Determine the amount of data that may be read without blocking.
  std::size_t in_avail(zr_boost_1_81::system::error_code& ec)
  {
...
private:
  ...
  {
    std::size_t bytes_copied = zr_boost_1_81::asio::buffer_copy(
  ...
  {
    return zr_boost_1_81::asio::buffer_copy(buffers, storage_.data(), storage_.size());
  }
