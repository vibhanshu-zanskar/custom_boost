...
BOOST_ASIO_DECL int shutdown(socket_type s,
    int what, zr_boost_1_81::system::error_code& ec);
...
BOOST_ASIO_DECL bool sockatmark(socket_type s, zr_boost_1_81::system::error_code& ec);

BOOST_ASIO_DECL size_t available(socket_type s, zr_boost_1_81::system::error_code& ec);

BOOST_ASIO_DECL int listen(socket_type s,
    int backlog, zr_boost_1_81::system::error_code& ec);
...
BOOST_ASIO_DECL signed_size_type recv(socket_type s, buf* bufs,
    size_t count, int flags, zr_boost_1_81::system::error_code& ec);

BOOST_ASIO_DECL signed_size_type recv1(socket_type s,
    void* data, size_t size, int flags, zr_boost_1_81::system::error_code& ec);
...
BOOST_ASIO_DECL signed_size_type send1(socket_type s,
    const void* data, size_t size, int flags, zr_boost_1_81::system::error_code& ec);

BOOST_ASIO_DECL size_t sync_send(socket_type s, state_type state,
    const buf* bufs, size_t count, int flags,
    bool all_empty, zr_boost_1_81::system::error_code& ec);
...
BOOST_ASIO_DECL int poll_read(socket_type s,
    state_type state, int msec, zr_boost_1_81::system::error_code& ec);
...
BOOST_ASIO_DECL const char* inet_ntop(int af, const void* src, char* dest,
    size_t length, unsigned long scope_id, zr_boost_1_81::system::error_code& ec);
...
BOOST_ASIO_DECL int gethostname(char* name,
    int namelen, zr_boost_1_81::system::error_code& ec);

#if !defined(BOOST_ASIO_WINDOWS_RUNTIME)

BOOST_ASIO_DECL zr_boost_1_81::system::error_code getaddrinfo(const char* host,
    const char* service, const addrinfo_type& hints,
    addrinfo_type** result, zr_boost_1_81::system::error_code& ec);

BOOST_ASIO_DECL zr_boost_1_81::system::error_code background_getaddrinfo(
...
BOOST_ASIO_DECL zr_boost_1_81::system::error_code getnameinfo(const void* addr,
    std::size_t addrlen, char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int flags, zr_boost_1_81::system::error_code& ec);

BOOST_ASIO_DECL zr_boost_1_81::system::error_code sync_getnameinfo(const void* addr,
    std::size_t addrlen, char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, zr_boost_1_81::system::error_code& ec);

BOOST_ASIO_DECL zr_boost_1_81::system::error_code background_getnameinfo(
    const weak_cancel_token_type& cancel_token,
