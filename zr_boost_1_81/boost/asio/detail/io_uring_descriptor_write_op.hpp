...
{
public:
  io_uring_descriptor_write_op_base(const zr_boost_1_81::system::error_code& success_ec,
...
public:
  ...
  io_uring_descriptor_write_op(const zr_boost_1_81::system::error_code& success_ec,
      int descriptor, descriptor_ops::state_type state,
