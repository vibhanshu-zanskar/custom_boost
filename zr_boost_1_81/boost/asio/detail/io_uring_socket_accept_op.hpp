...
{
public:
  io_uring_socket_accept_op_base(const zr_boost_1_81::system::error_code& success_ec,
  ...
  static bool do_perform(io_uring_operation* base, bool after_completion)
  {
    ...
    if (o->ec_ && o->ec_ == zr_boost_1_81::asio::error::would_block)
    {
...
public:
  ...
  io_uring_socket_accept_op(const zr_boost_1_81::system::error_code& success_ec,
      socket_type socket, socket_ops::state_type state, Socket& peer,
      const Protocol& protocol, typename Protocol::endpoint* peer_endpoint,
      ...
      std::size_t /*bytes_transferred*/)
  {
    ...
    ptr p = { zr_boost_1_81::asio::detail::addressof(o->handler_), o, o };
    ...
    detail::binder1<Handler, zr_boost_1_81::system::error_code>
      handler(o->handler_, o->ec_);
    p.h = zr_boost_1_81::asio::detail::addressof(handler.handler_);
    p.reset();
...
public:
  ...
  io_uring_socket_move_accept_op(const zr_boost_1_81::system::error_code& success_ec,
      ...
      std::size_t /*bytes_transferred*/)
  {
    ...
    detail::move_binder2<Handler,
      zr_boost_1_81::system::error_code, peer_socket_type>
