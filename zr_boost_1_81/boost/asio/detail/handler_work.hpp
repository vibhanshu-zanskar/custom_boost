...
public:
  explicit handler_work_base(int, int, const Executor& ex) BOOST_ASIO_NOEXCEPT
    : executor_(zr_boost_1_81::asio::prefer(ex, execution::outstanding_work.tracked))
  {
  }
  ...
  void dispatch(Function& function, Handler& handler)
  {
    ...
    zr_boost_1_81::asio::prefer(executor_,
...
public:
  ...
  void dispatch(Function& function, Handler& handler)
  {
    executor_.dispatch(BOOST_ASIO_MOVE_CAST(Function)(function),
        zr_boost_1_81::asio::get_associated_allocator(handler));
  }
...
public:
  ...
  void dispatch(Function& function, Handler& handler)
  {
    ...
    zr_boost_1_81_asio_handler_invoke_helpers::invoke(function, handler);
  }
};
...
public:
  ...
  explicit handler_work_base(int, int,
    ...
    : executor_(
        ex.target_type() == typeid(typename IoContext::executor_type)
          ? executor_type()
          : zr_boost_1_81::asio::prefer(ex, execution::outstanding_work.tracked))
#else // !defined(BOOST_ASIO_NO_TYPEID)
    : executor_(zr_boost_1_81::asio::prefer(ex, execution::outstanding_work.tracked))
#endif // !defined(BOOST_ASIO_NO_TYPEID)
  {
  ...
  handler_work(Handler& handler, const IoExecutor& io_ex) BOOST_ASIO_NOEXCEPT
    : base1_type(0, 0, io_ex),
      base2_type(base1_type::owns_work(),
          zr_boost_1_81::asio::get_associated_executor(handler, io_ex), io_ex)
  {
  }
