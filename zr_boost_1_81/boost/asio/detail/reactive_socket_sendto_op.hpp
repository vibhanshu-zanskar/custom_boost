...
{
public:
  reactive_socket_sendto_op_base(const zr_boost_1_81::system::error_code& success_ec,
...
public:
  ...
  reactive_socket_sendto_op(const zr_boost_1_81::system::error_code& success_ec,
      socket_type socket, const ConstBufferSequence& buffers,
      const Endpoint& endpoint, socket_base::message_flags flags,
