...
public:
  ...
  zr_boost_1_81::system::error_code cancel(base_implementation_type&,
  ...
  zr_boost_1_81::system::error_code io_control(base_implementation_type&,
      IO_Control_Command&, zr_boost_1_81::system::error_code& ec)
  {
    ec = zr_boost_1_81::asio::error::operation_not_supported;
    return ec;
  }
  ...
  zr_boost_1_81::system::error_code non_blocking(base_implementation_type&,
      bool, zr_boost_1_81::system::error_code& ec)
  {
    ec = zr_boost_1_81::asio::error::operation_not_supported;
    return ec;
  }
  ...
  zr_boost_1_81::system::error_code native_non_blocking(base_implementation_type&,
      bool, zr_boost_1_81::system::error_code& ec)
  {
    ec = zr_boost_1_81::asio::error::operation_not_supported;
    return ec;
  ...
  {
    zr_boost_1_81::system::error_code ec = zr_boost_1_81::asio::error::operation_not_supported;
    const std::size_t bytes_transferred = 0;
    zr_boost_1_81::asio::post(io_ex,
...
protected:
  ...
  BOOST_ASIO_DECL std::size_t do_get_endpoint(
      ...
      void* addr, std::size_t addr_len, zr_boost_1_81::system::error_code& ec) const;

  // Helper function to set a socket option.
  BOOST_ASIO_DECL zr_boost_1_81::system::error_code do_set_option(
  ...
  BOOST_ASIO_DECL void do_get_option(
      ...
      std::size_t* optlen, zr_boost_1_81::system::error_code& ec) const;

  // Helper function to perform a synchronous connect.
  BOOST_ASIO_DECL zr_boost_1_81::system::error_code do_connect(
      base_implementation_type& impl,
      const void* addr, zr_boost_1_81::system::error_code& ec);
  ...
  BOOST_ASIO_DECL std::size_t do_send(
      base_implementation_type& impl, const zr_boost_1_81::asio::const_buffer& data,
      socket_base::message_flags flags, zr_boost_1_81::system::error_code& ec);

  // Helper function to start an asynchronous send.
  BOOST_ASIO_DECL void start_send_op(base_implementation_type& impl,
      const zr_boost_1_81::asio::const_buffer& data, socket_base::message_flags flags,
  ...
  BOOST_ASIO_DECL std::size_t do_receive(
      base_implementation_type& impl, const zr_boost_1_81::asio::mutable_buffer& data,
      socket_base::message_flags flags, zr_boost_1_81::system::error_code& ec);

  // Helper function to start an asynchronous receive.
  BOOST_ASIO_DECL void start_receive_op(base_implementation_type& impl,
      const zr_boost_1_81::asio::mutable_buffer& data, socket_base::message_flags flags,
  ...
  zr_boost_1_81::asio::detail::mutex mutex_;
