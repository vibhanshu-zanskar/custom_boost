...
public:
  ...
  BOOST_ASIO_DECL win_iocp_io_context(zr_boost_1_81::asio::execution_context& ctx,
  ...
  BOOST_ASIO_DECL zr_boost_1_81::system::error_code register_handle(
      HANDLE handle, zr_boost_1_81::system::error_code& ec);

  // Run the event loop until stopped or no more work.
  BOOST_ASIO_DECL size_t run(zr_boost_1_81::system::error_code& ec);

  // Run until stopped or one operation is performed.
  BOOST_ASIO_DECL size_t run_one(zr_boost_1_81::system::error_code& ec);

  // Run until timeout, interrupted, or one operation is performed.
  BOOST_ASIO_DECL size_t wait_one(long usec, zr_boost_1_81::system::error_code& ec);

  // Poll for operations without blocking.
  BOOST_ASIO_DECL size_t poll(zr_boost_1_81::system::error_code& ec);

  // Poll for one operation without blocking.
  BOOST_ASIO_DECL size_t poll_one(zr_boost_1_81::system::error_code& ec);
  ...
  // starting the operation.
  BOOST_ASIO_DECL void on_completion(win_iocp_operation* op,
      const zr_boost_1_81::system::error_code& ec, DWORD bytes_transferred = 0);
