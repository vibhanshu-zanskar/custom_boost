...
public:
  ...
  deadline_timer_service(execution_context& context)
    : execution_context_service_base<
      ...
      scheduler_(zr_boost_1_81::asio::use_service<timer_scheduler>(context))
  {
  ...
  std::size_t cancel(implementation_type& impl, zr_boost_1_81::system::error_code& ec)
  {
    if (!impl.might_have_pending_waits)
    {
  ...
  std::size_t expires_at(implementation_type& impl,
      const time_type& expiry_time, zr_boost_1_81::system::error_code& ec)
  {
  ...
  std::size_t expires_after(implementation_type& impl,
      const duration_type& expiry_time, zr_boost_1_81::system::error_code& ec)
  {
  ...
  void wait(implementation_type& impl, zr_boost_1_81::system::error_code& ec)
  {
...
private:
  ...
  // either be of type zr_boost_1_81::posix_time::time_duration, or implement the
  // required subset of its interface.
  template <typename Duration>
  void do_wait(const Duration& timeout, zr_boost_1_81::system::error_code& ec)
  {
#if defined(BOOST_ASIO_WINDOWS_RUNTIME)
