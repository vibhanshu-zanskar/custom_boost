...
public:
  ...
  work_dispatcher(BOOST_ASIO_MOVE_ARG(CompletionHandler) handler,
    ...
    : handler_(BOOST_ASIO_MOVE_CAST(CompletionHandler)(handler)),
      executor_(zr_boost_1_81::asio::prefer(handler_ex,
  ...
  void operator()()
  {
    ...
    zr_boost_1_81::asio::prefer(executor_, execution::allocator(alloc)).execute(
        zr_boost_1_81::asio::detail::bind_handler(
          BOOST_ASIO_MOVE_CAST(Handler)(handler_)));
#else // defined(BOOST_ASIO_NO_DEPRECATED)
    execution::execute(
        zr_boost_1_81::asio::prefer(executor_, execution::allocator(alloc)),
        zr_boost_1_81::asio::detail::bind_handler(
          BOOST_ASIO_MOVE_CAST(Handler)(handler_)));
