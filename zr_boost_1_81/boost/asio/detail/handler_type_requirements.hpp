...
#define BOOST_ASIO_LEGACY_COMPLETION_HANDLER_CHECK( \
  ...
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(zr_boost_1_81::asio::detail::zero_arg_copyable_handler_test( \
          zr_boost_1_81::asio::detail::clvref< \
            asio_true_handler_type>(), 0)) == 1, \
      "CompletionHandler type requirements not met") \
  \
  typedef zr_boost_1_81::asio::detail::handler_type_requirements< \
      sizeof( \
        zr_boost_1_81::asio::detail::argbyv( \
          zr_boost_1_81::asio::detail::clvref< \
            asio_true_handler_type>())) + \
      sizeof( \
        zr_boost_1_81::asio::detail::rorlvref< \
          asio_true_handler_type>()(), \
...
#define BOOST_ASIO_READ_HANDLER_CHECK( \
  ...
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(zr_boost_1_81::asio::detail::two_arg_handler_test( \
          zr_boost_1_81::asio::detail::rvref< \
            asio_true_handler_type>(), \
          static_cast<const zr_boost_1_81::system::error_code*>(0), \
  ...
  typedef zr_boost_1_81::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        zr_boost_1_81::asio::detail::rorlvref< \
          asio_true_handler_type>()( \
            zr_boost_1_81::asio::detail::lvref<const zr_boost_1_81::system::error_code>(), \
            zr_boost_1_81::asio::detail::lvref<const std::size_t>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
...
#define BOOST_ASIO_ACCEPT_HANDLER_CHECK( \
  ...
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(zr_boost_1_81::asio::detail::one_arg_handler_test( \
          zr_boost_1_81::asio::detail::rvref< \
            asio_true_handler_type>(), \
          static_cast<const zr_boost_1_81::system::error_code*>(0))) == 1, \
...
#define BOOST_ASIO_MOVE_ACCEPT_HANDLER_CHECK( \
  ...
  \
  typedef BOOST_ASIO_HANDLER_TYPE(handler_type, \
      void(zr_boost_1_81::system::error_code, socket_type)) \
    asio_true_handler_type; \
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(zr_boost_1_81::asio::detail::two_arg_move_handler_test( \
          zr_boost_1_81::asio::detail::rvref< \
            asio_true_handler_type>(), \
          static_cast<const zr_boost_1_81::system::error_code*>(0), \
  ...
  typedef zr_boost_1_81::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        zr_boost_1_81::asio::detail::rorlvref< \
          asio_true_handler_type>()( \
            zr_boost_1_81::asio::detail::lvref<const zr_boost_1_81::system::error_code>(), \
            zr_boost_1_81::asio::detail::rvref<socket_type>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
...
#define BOOST_ASIO_RANGE_CONNECT_HANDLER_CHECK( \
  ...
  \
  typedef BOOST_ASIO_HANDLER_TYPE(handler_type, \
      void(zr_boost_1_81::system::error_code, endpoint_type)) \
    asio_true_handler_type; \
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(zr_boost_1_81::asio::detail::two_arg_handler_test( \
  ...
  typedef zr_boost_1_81::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        zr_boost_1_81::asio::detail::rorlvref< \
          asio_true_handler_type>()( \
            zr_boost_1_81::asio::detail::lvref<const zr_boost_1_81::system::error_code>(), \
            zr_boost_1_81::asio::detail::lvref<const endpoint_type>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
...
#define BOOST_ASIO_ITERATOR_CONNECT_HANDLER_CHECK( \
  ...
  \
  typedef BOOST_ASIO_HANDLER_TYPE(handler_type, \
      void(zr_boost_1_81::system::error_code, iter_type)) \
    asio_true_handler_type; \
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(zr_boost_1_81::asio::detail::two_arg_handler_test( \
  ...
  typedef zr_boost_1_81::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        zr_boost_1_81::asio::detail::rorlvref< \
          asio_true_handler_type>()( \
            zr_boost_1_81::asio::detail::lvref<const zr_boost_1_81::system::error_code>(), \
            zr_boost_1_81::asio::detail::lvref<const iter_type>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
...
#define BOOST_ASIO_RESOLVE_HANDLER_CHECK( \
  ...
  \
  typedef BOOST_ASIO_HANDLER_TYPE(handler_type, \
      void(zr_boost_1_81::system::error_code, range_type)) \
    asio_true_handler_type; \
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(zr_boost_1_81::asio::detail::two_arg_handler_test( \
  ...
  typedef zr_boost_1_81::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        zr_boost_1_81::asio::detail::rorlvref< \
          asio_true_handler_type>()( \
            zr_boost_1_81::asio::detail::lvref<const zr_boost_1_81::system::error_code>(), \
            zr_boost_1_81::asio::detail::lvref<const range_type>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
  ...
  typedef zr_boost_1_81::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        zr_boost_1_81::asio::detail::rorlvref< \
          asio_true_handler_type>()( \
            zr_boost_1_81::asio::detail::lvref<const zr_boost_1_81::system::error_code>(), \
            zr_boost_1_81::asio::detail::lvref<const int>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
