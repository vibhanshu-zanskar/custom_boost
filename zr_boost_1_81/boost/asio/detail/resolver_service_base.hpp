...
protected:
  ...
  {
  public:
    explicit auto_addrinfo(zr_boost_1_81::asio::detail::addrinfo_type* ai)
      : ai_(ai)
    {
    }
    ...
    operator zr_boost_1_81::asio::detail::addrinfo_type*()
    {
      return ai_;
    }

  private:
    zr_boost_1_81::asio::detail::addrinfo_type* ai_;
  };
...
private:
  ...
  zr_boost_1_81::asio::detail::scoped_ptr<scheduler_impl> work_scheduler_;

  // Thread used for running the work io_context's run loop.
  zr_boost_1_81::asio::detail::scoped_ptr<zr_boost_1_81::asio::detail::thread> work_thread_;
};
