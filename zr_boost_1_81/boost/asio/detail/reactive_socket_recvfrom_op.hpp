...
{
public:
  reactive_socket_recvfrom_op_base(const zr_boost_1_81::system::error_code& success_ec,
...
public:
  ...
  reactive_socket_recvfrom_op(const zr_boost_1_81::system::error_code& success_ec,
      socket_type socket, int protocol_type,
      const MutableBufferSequence& buffers, Endpoint& endpoint,
