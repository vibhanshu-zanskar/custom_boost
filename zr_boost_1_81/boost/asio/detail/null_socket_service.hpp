...
public:
  ...
  zr_boost_1_81::system::error_code open(implementation_type&,
      const protocol_type&, zr_boost_1_81::system::error_code& ec)
  {
  ...
  zr_boost_1_81::system::error_code assign(implementation_type&, const protocol_type&,
      const native_handle_type&, zr_boost_1_81::system::error_code& ec)
  {
    ec = zr_boost_1_81::asio::error::operation_not_supported;
    return ec;
  }
  ...
  // Destroy a socket implementation.
  zr_boost_1_81::system::error_code close(implementation_type&,
  ...
  zr_boost_1_81::system::error_code cancel(implementation_type&,
      zr_boost_1_81::system::error_code& ec)
  {
    ec = zr_boost_1_81::asio::error::operation_not_supported;
    return ec;
  ...
  zr_boost_1_81::system::error_code listen(implementation_type&,
      int, zr_boost_1_81::system::error_code& ec)
  {
    ec = zr_boost_1_81::asio::error::operation_not_supported;
    return ec;
  }
  ...
  zr_boost_1_81::system::error_code io_control(implementation_type&,
  ...
  zr_boost_1_81::system::error_code non_blocking(implementation_type&,
  ...
  zr_boost_1_81::system::error_code native_non_blocking(implementation_type&,
      bool, zr_boost_1_81::system::error_code& ec)
  {
    ec = zr_boost_1_81::asio::error::operation_not_supported;
    return ec;
  ...
  zr_boost_1_81::system::error_code shutdown(implementation_type&,
      socket_base::shutdown_type, zr_boost_1_81::system::error_code& ec)
  {
    ec = zr_boost_1_81::asio::error::operation_not_supported;
    return ec;
  }
  ...
  zr_boost_1_81::system::error_code bind(implementation_type&,
      const endpoint_type&, zr_boost_1_81::system::error_code& ec)
  {
    ec = zr_boost_1_81::asio::error::operation_not_supported;
    return ec;
  }
  ...
  zr_boost_1_81::system::error_code set_option(implementation_type&,
      const Option&, zr_boost_1_81::system::error_code& ec)
  {
    ec = zr_boost_1_81::asio::error::operation_not_supported;
    return ec;
  }
  ...
  // Set a socket option.
  template <typename Option>
  zr_boost_1_81::system::error_code get_option(const implementation_type&,
      Option&, zr_boost_1_81::system::error_code& ec) const
  {
    ec = zr_boost_1_81::asio::error::operation_not_supported;
    return ec;
  }
      ...
      socket_base::message_flags, Handler& handler, const IoExecutor& io_ex)
  {
    ...
    zr_boost_1_81::asio::post(io_ex, detail::bind_handler(
  ...
  zr_boost_1_81::system::error_code accept(implementation_type&,
      Socket&, endpoint_type*, zr_boost_1_81::system::error_code& ec)
  {
    ec = zr_boost_1_81::asio::error::operation_not_supported;
    return ec;
  }
  ...
  {
    zr_boost_1_81::system::error_code ec = zr_boost_1_81::asio::error::operation_not_supported;
    zr_boost_1_81::asio::post(io_ex, detail::bind_handler(handler, ec));
  }

  // Connect the socket to the specified endpoint.
  zr_boost_1_81::system::error_code connect(implementation_type&,
      const endpoint_type&, zr_boost_1_81::system::error_code& ec)
  {
    ec = zr_boost_1_81::asio::error::operation_not_supported;
    return ec;
