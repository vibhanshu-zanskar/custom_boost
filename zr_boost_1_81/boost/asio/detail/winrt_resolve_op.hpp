...
public:
  ...
  static void do_complete(void* owner, operation* base,
      const zr_boost_1_81::system::error_code&, std::size_t)
  {
    ...
    if (!o->ec_)
    {
      ...
      {
        o->ec_ = zr_boost_1_81::system::error_code(e->HResult,
    ...
    detail::binder2<Handler, zr_boost_1_81::system::error_code, results_type>
