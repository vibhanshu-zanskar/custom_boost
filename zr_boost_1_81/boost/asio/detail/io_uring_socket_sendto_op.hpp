...
{
public:
  io_uring_socket_sendto_op_base(const zr_boost_1_81::system::error_code& success_ec,
...
private:
  ...
  buffer_sequence_adapter<zr_boost_1_81::asio::const_buffer, ConstBufferSequence> bufs_;
  msghdr msghdr_;
};
...
public:
  ...
  io_uring_socket_sendto_op(const zr_boost_1_81::system::error_code& success_ec,
