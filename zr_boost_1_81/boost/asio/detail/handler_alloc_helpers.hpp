...
namespace zr_boost_1_81_asio_handler_alloc_helpers {

#if defined(BOOST_ASIO_NO_DEPRECATED)
template <typename Handler>
inline void error_if_hooks_are_defined(Handler& h)
{
  using zr_boost_1_81::asio::asio_handler_allocate;
  ...
  (void)static_cast<zr_boost_1_81::asio::asio_handler_allocate_is_no_longer_used>(
    asio_handler_allocate(static_cast<std::size_t>(0),
      zr_boost_1_81::asio::detail::addressof(h)));

  using zr_boost_1_81::asio::asio_handler_deallocate;
  // If you get an error here it is because some of your handlers still
  // overload asio_handler_deallocate, but this hook is no longer used.
  (void)static_cast<zr_boost_1_81::asio::asio_handler_deallocate_is_no_longer_used>(
    asio_handler_deallocate(static_cast<void*>(0),
      static_cast<std::size_t>(0), zr_boost_1_81::asio::detail::addressof(h)));
}
    ...
    std::size_t align = BOOST_ASIO_DEFAULT_ALIGN)
{
  ...
  return zr_boost_1_81::asio::aligned_new(align, s);
...
# if !defined(BOOST_ASIO_DISABLE_SMALL_BLOCK_RECYCLING)
  return zr_boost_1_81::asio::detail::thread_info_base::allocate(
      zr_boost_1_81::asio::detail::thread_context::top_of_thread_call_stack(),
      s, align);
...
# endif // !defined(BOOST_ASIO_DISABLE_SMALL_BLOCK_RECYCLING)
  ...
  (void)align;
  using zr_boost_1_81::asio::asio_handler_allocate;
  return asio_handler_allocate(s, zr_boost_1_81::asio::detail::addressof(h));
#endif
}
...
{
#if !defined(BOOST_ASIO_HAS_HANDLER_HOOKS)
  zr_boost_1_81::asio::aligned_delete(p);
#elif defined(BOOST_ASIO_NO_DEPRECATED)
  // The asio_handler_allocate hook is no longer used to obtain memory.
  (void)&error_if_hooks_are_defined<Handler>;
  (void)h;
#if !defined(BOOST_ASIO_DISABLE_SMALL_BLOCK_RECYCLING)
  zr_boost_1_81::asio::detail::thread_info_base::deallocate(
      zr_boost_1_81::asio::detail::thread_context::top_of_thread_call_stack(), p, s);
#else // !defined(BOOST_ASIO_DISABLE_SMALL_BLOCK_RECYCLING)
  (void)s;
  zr_boost_1_81::asio::aligned_delete(p);
#endif // !defined(BOOST_ASIO_DISABLE_SMALL_BLOCK_RECYCLING)
#else
  using zr_boost_1_81::asio::asio_handler_deallocate;
  asio_handler_deallocate(p, s, zr_boost_1_81::asio::detail::addressof(h));
#endif
}
...
public:
  ...
  T* allocate(std::size_t n)
  {
    return static_cast<T*>(
        zr_boost_1_81_asio_handler_alloc_helpers::allocate(
          sizeof(T) * n, handler_, BOOST_ASIO_ALIGNOF(T)));
  }

  void deallocate(T* p, std::size_t n)
  {
    zr_boost_1_81_asio_handler_alloc_helpers::deallocate(p, sizeof(T) * n, handler_);
  }
...
#define BOOST_ASIO_DEFINE_HANDLER_PTR(op) \
  ...
  { \
    ...
    { \
      typedef typename ::zr_boost_1_81::asio::associated_allocator< \
        Handler>::type associated_allocator_type; \
      typedef typename ::zr_boost_1_81::asio::detail::get_hook_allocator< \
        Handler, associated_allocator_type>::type hook_allocator_type; \
      BOOST_ASIO_REBIND_ALLOC(hook_allocator_type, op) a( \
            ::zr_boost_1_81::asio::detail::get_hook_allocator< \
              Handler, associated_allocator_type>::get( \
                handler, ::zr_boost_1_81::asio::get_associated_allocator(handler))); \
      return a.allocate(1); \
    } \
    void reset() \
    { \
      ...
      { \
        ...
        BOOST_ASIO_REBIND_ALLOC(hook_allocator_type, op) a( \
              ::zr_boost_1_81::asio::detail::get_hook_allocator< \
                Handler, associated_allocator_type>::get( \
                  *h, ::zr_boost_1_81::asio::get_associated_allocator(*h))); \
...
#define BOOST_ASIO_DEFINE_TAGGED_HANDLER_ALLOCATOR_PTR(purpose, op) \
  ...
  { \
    ...
    { \
      typedef typename ::zr_boost_1_81::asio::detail::get_recycling_allocator< \
        Alloc, purpose>::type recycling_allocator_type; \
      BOOST_ASIO_REBIND_ALLOC(recycling_allocator_type, op) a1( \
            ::zr_boost_1_81::asio::detail::get_recycling_allocator< \
              Alloc, purpose>::get(a)); \
...
#define BOOST_ASIO_DEFINE_HANDLER_ALLOCATOR_PTR(op) \
  BOOST_ASIO_DEFINE_TAGGED_HANDLER_ALLOCATOR_PTR( \
      ::zr_boost_1_81::asio::detail::thread_info_base::default_tag, op ) \
  /**/
