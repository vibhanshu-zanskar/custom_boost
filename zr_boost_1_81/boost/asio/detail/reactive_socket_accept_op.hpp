...
{
public:
  reactive_socket_accept_op_base(const zr_boost_1_81::system::error_code& success_ec,
...
public:
  ...
  reactive_socket_accept_op(const zr_boost_1_81::system::error_code& success_ec,
      socket_type socket, socket_ops::state_type state, Socket& peer,
      const Protocol& protocol, typename Protocol::endpoint* peer_endpoint,
...
public:
  ...
  reactive_socket_move_accept_op(const zr_boost_1_81::system::error_code& success_ec,
