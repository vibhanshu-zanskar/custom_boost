...
{
public:
  io_uring_socket_connect_op_base(const zr_boost_1_81::system::error_code& success_ec,
...
public:
  ...
  io_uring_socket_connect_op(const zr_boost_1_81::system::error_code& success_ec,
      socket_type socket, const typename Protocol::endpoint& endpoint,
