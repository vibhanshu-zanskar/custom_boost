...
BOOST_ASIO_DECL bool non_blocking_read_at(int d, uint64_t offset,
    buf* bufs, std::size_t count, zr_boost_1_81::system::error_code& ec,
...
BOOST_ASIO_DECL int fcntl(int d, int cmd, zr_boost_1_81::system::error_code& ec);

BOOST_ASIO_DECL int fcntl(int d, int cmd,
    long arg, zr_boost_1_81::system::error_code& ec);

BOOST_ASIO_DECL int poll_read(int d,
    state_type state, zr_boost_1_81::system::error_code& ec);
