...
{
public:
  reactive_socket_recvmsg_op_base(const zr_boost_1_81::system::error_code& success_ec,
...
public:
  ...
  reactive_socket_recvmsg_op(const zr_boost_1_81::system::error_code& success_ec,
      socket_type socket, const MutableBufferSequence& buffers,
      socket_base::message_flags in_flags,
