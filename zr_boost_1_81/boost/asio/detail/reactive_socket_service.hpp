...
public:
  ...
  zr_boost_1_81::system::error_code open(implementation_type& impl,
      const protocol_type& protocol, zr_boost_1_81::system::error_code& ec)
  {
  ...
  zr_boost_1_81::system::error_code bind(implementation_type& impl,
      const endpoint_type& endpoint, zr_boost_1_81::system::error_code& ec)
  {
  ...
  zr_boost_1_81::system::error_code set_option(implementation_type& impl,
      const Option& option, zr_boost_1_81::system::error_code& ec)
  {
  ...
  zr_boost_1_81::system::error_code get_option(const implementation_type& impl,
      Option& option, zr_boost_1_81::system::error_code& ec) const
  {
  ...
  zr_boost_1_81::system::error_code shutdown(base_implementation_type& impl,
      socket_base::shutdown_type what, zr_boost_1_81::system::error_code& ec)
  {
  ...
  zr_boost_1_81::system::error_code accept(implementation_type& impl,
      Socket& peer, endpoint_type* peer_endpoint, zr_boost_1_81::system::error_code& ec)
  {
    // We cannot accept a socket that is already open.
    if (peer.is_open())
    {
      ec = zr_boost_1_81::asio::error::already_open;
      BOOST_ASIO_ERROR_LOCATION(ec);
      return ec;
    }
  ...
  zr_boost_1_81::system::error_code connect(implementation_type& impl,
      const endpoint_type& peer_endpoint, zr_boost_1_81::system::error_code& ec)
  {
