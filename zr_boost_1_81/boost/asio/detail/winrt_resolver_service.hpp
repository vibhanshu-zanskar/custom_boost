...
public:
  ...
  // The query type.
  typedef zr_boost_1_81::asio::ip::basic_resolver_query<Protocol> query_type;

  // The results type.
  typedef zr_boost_1_81::asio::ip::basic_resolver_results<Protocol> results_type;
  ...
  results_type resolve(implementation_type&,
      const query_type& query, zr_boost_1_81::system::error_code& ec)
  {
    try
    {
      ...
      Handler& handler, const IoExecutor& io_ex)
  {
    ...
    {
      p.p->ec_ = zr_boost_1_81::system::error_code(
      ...
      Handler& handler, const IoExecutor& io_ex)
  {
    ...
    zr_boost_1_81::asio::post(io_ex, detail::bind_handler(handler, ec, results));
  }
