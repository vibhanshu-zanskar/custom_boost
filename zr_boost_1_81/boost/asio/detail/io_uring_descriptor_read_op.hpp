...
{
public:
  io_uring_descriptor_read_op_base(const zr_boost_1_81::system::error_code& success_ec,
  ...
  static bool do_perform(io_uring_operation* base, bool after_completion)
  {
    ...
    else if (after_completion)
    {
      if (!o->ec_ && o->bytes_transferred_ == 0)
        o->ec_ = zr_boost_1_81::asio::error::eof;
    }
...
public:
  ...
  io_uring_descriptor_read_op(const zr_boost_1_81::system::error_code& success_ec,
      int descriptor, descriptor_ops::state_type state,
      ...
      std::size_t /*bytes_transferred*/)
  {
    ...
    detail::binder2<Handler, zr_boost_1_81::system::error_code, std::size_t>
