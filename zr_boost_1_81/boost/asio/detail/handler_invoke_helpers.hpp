...
namespace zr_boost_1_81_asio_handler_invoke_helpers {
...
inline void error_if_hook_is_defined(Function& function, Context& context)
{
  ...
  (void)static_cast<zr_boost_1_81::asio::asio_handler_invoke_is_no_longer_used>(
    asio_handler_invoke(function, zr_boost_1_81::asio::detail::addressof(context)));
}
