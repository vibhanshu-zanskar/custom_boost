...
public:
  ...
  BOOST_ASIO_DECL zr_boost_1_81::system::error_code resize(implementation_type& impl,
      uint64_t n, zr_boost_1_81::system::error_code& ec);

  // Synchronise the file to disk.
  BOOST_ASIO_DECL zr_boost_1_81::system::error_code sync_all(implementation_type& impl,
      zr_boost_1_81::system::error_code& ec);

  // Synchronise the file data to disk.
  BOOST_ASIO_DECL zr_boost_1_81::system::error_code sync_data(implementation_type& impl,
      zr_boost_1_81::system::error_code& ec);

  // Seek to a position in the file.
  BOOST_ASIO_DECL uint64_t seek(implementation_type& impl, int64_t offset,
      file_base::seek_basis whence, zr_boost_1_81::system::error_code& ec);
      ...
      const ConstBufferSequence& buffers, zr_boost_1_81::system::error_code& ec)
  {
    ...
    impl.offset_ += zr_boost_1_81::asio::buffer_size(buffers);
