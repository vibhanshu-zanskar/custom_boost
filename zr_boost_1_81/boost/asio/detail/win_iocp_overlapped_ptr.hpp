...
public:
  ...
  void complete(const zr_boost_1_81::system::error_code& ec,
...
private:
      ...
      >::type* = 0)
  {
    return &use_service<win_iocp_io_context>(
        zr_boost_1_81::asio::query(ex, execution::context));
  }
  ...
  {
    return &zr_boost_1_81::asio::query(ex, execution::context).impl_;
  }
