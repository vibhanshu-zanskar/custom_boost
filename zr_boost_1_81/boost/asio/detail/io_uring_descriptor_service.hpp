...
public:
  ...
  class implementation_type
    : private zr_boost_1_81::asio::detail::noncopyable
  {
  public:
    // Default constructor.
    implementation_type()
  ...
  BOOST_ASIO_DECL zr_boost_1_81::system::error_code assign(implementation_type& impl,
  ...
  // Destroy a descriptor implementation.
  BOOST_ASIO_DECL zr_boost_1_81::system::error_code close(implementation_type& impl,
      zr_boost_1_81::system::error_code& ec);
  ...
  BOOST_ASIO_DECL zr_boost_1_81::system::error_code cancel(implementation_type& impl,
      zr_boost_1_81::system::error_code& ec);

  // Perform an IO control command on the descriptor.
  template <typename IO_Control_Command>
  zr_boost_1_81::system::error_code io_control(implementation_type& impl,
  ...
  zr_boost_1_81::system::error_code non_blocking(implementation_type& impl,
  ...
  zr_boost_1_81::system::error_code native_non_blocking(implementation_type& impl,
      bool mode, zr_boost_1_81::system::error_code& ec)
  {
  ...
  zr_boost_1_81::system::error_code wait(implementation_type& impl,
      posix::descriptor_base::wait_type w, zr_boost_1_81::system::error_code& ec)
  {
    switch (w)
    {
  ...
  size_t write_some(implementation_type& impl,
      const null_buffers&, zr_boost_1_81::system::error_code& ec)
  {
  ...
  size_t write_some_at(implementation_type& impl, uint64_t,
      const null_buffers& buffers, zr_boost_1_81::system::error_code& ec)
  {
