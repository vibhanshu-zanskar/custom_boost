...
zr_boost_1_81::system::error_code reactive_socket_service_base::close(
    reactive_socket_service_base::base_implementation_type& impl,
...
zr_boost_1_81::system::error_code reactive_socket_service_base::cancel(
    reactive_socket_service_base::base_implementation_type& impl,
    zr_boost_1_81::system::error_code& ec)
{
  if (!is_open(impl))
...
zr_boost_1_81::system::error_code reactive_socket_service_base::do_open(
    reactive_socket_service_base::base_implementation_type& impl,
    int af, int type, int protocol, zr_boost_1_81::system::error_code& ec)
{
  if (is_open(impl))
  {
  ...
  {
    ec = zr_boost_1_81::system::error_code(err,
...
zr_boost_1_81::system::error_code reactive_socket_service_base::do_assign(
    ...
    reactor_op* op, bool is_continuation, bool peer_is_open)
{
  ...
  {
    op->ec_ = zr_boost_1_81::asio::error::already_open;
    reactor_.post_immediate_completion(op, is_continuation);
  }
}
