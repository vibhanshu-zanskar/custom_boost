...
dev_poll_reactor::dev_poll_reactor(zr_boost_1_81::asio::execution_context& ctx)
  : zr_boost_1_81::asio::detail::execution_context_service_base<dev_poll_reactor>(ctx),
...
int dev_poll_reactor::do_dev_poll_create()
{
  ...
  if (fd == -1)
  {
    zr_boost_1_81::system::error_code ec(errno,
        zr_boost_1_81::asio::error::get_system_category());
    zr_boost_1_81::asio::detail::throw_error(ec, "/dev/poll");
  }
  return fd;
}
