...
epoll_reactor::epoll_reactor(zr_boost_1_81::asio::execution_context& ctx)
  ...
  if (fork_ev == zr_boost_1_81::asio::execution_context::fork_child)
  {
        ...
        state != 0; state = state->next_)
    {
      ...
      if (result != 0)
      {
        ...
        zr_boost_1_81::asio::detail::throw_error(ec, "epoll re-registration");
      }
    }
  }
}
...
int epoll_reactor::do_epoll_create()
{
  ...
  if (fd == -1)
  {
    zr_boost_1_81::system::error_code ec(errno,
        zr_boost_1_81::asio::error::get_system_category());
    zr_boost_1_81::asio::detail::throw_error(ec, "epoll");
  }
