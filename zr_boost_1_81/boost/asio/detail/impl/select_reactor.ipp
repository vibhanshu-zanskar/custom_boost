...
select_reactor::select_reactor(zr_boost_1_81::asio::execution_context& ctx)
...
{
#if defined(BOOST_ASIO_HAS_IOCP)
  zr_boost_1_81::asio::detail::signal_blocker sb;
  thread_ = new zr_boost_1_81::asio::detail::thread(thread_function(this));
#endif // defined(BOOST_ASIO_HAS_IOCP)
}
...
{
  zr_boost_1_81::asio::detail::mutex::scoped_lock lock(mutex_);
  cancel_ops_unlocked(descriptor, zr_boost_1_81::asio::error::operation_aborted);
}
    ...
    int op_type, void* cancellation_key)
{
  ...
  bool need_interrupt = op_queue_[op_type].cancel_operations_by_key(
      descriptor, ops, cancellation_key, zr_boost_1_81::asio::error::operation_aborted);
    ...
    const zr_boost_1_81::system::error_code& /*ec*/, std::size_t /*bytes_transferred*/)
{
  if (owner)
  {
    ...
    zr_boost_1_81::asio::detail::mutex::scoped_lock lock(reactor->mutex_);
    ...
    zr_boost_1_81::asio::detail::signal_blocker sb;
    reactor->thread_ =
      new zr_boost_1_81::asio::detail::thread(thread_function(reactor));
  }
}
#endif // defined(BOOST_ASIO_HAS_IOCP)
