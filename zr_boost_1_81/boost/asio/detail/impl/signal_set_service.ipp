...
# if defined(BOOST_ASIO_HAS_IO_URING_AS_DEFAULT)
  pipe_read_op()
    : io_uring_operation(zr_boost_1_81::system::error_code(), &pipe_read_op::do_prepare,
...
signal_set_service::signal_set_service(execution_context& context)
  : execution_context_service_base<signal_set_service>(context),
    scheduler_(zr_boost_1_81::asio::use_service<scheduler_impl>(context)),
#if !defined(BOOST_ASIO_WINDOWS) \
  && !defined(BOOST_ASIO_WINDOWS_RUNTIME) \
  && !defined(__CYGWIN__)
# if defined(BOOST_ASIO_HAS_IO_URING_AS_DEFAULT)
    io_uring_service_(zr_boost_1_81::asio::use_service<io_uring_service>(context)),
# else // defined(BOOST_ASIO_HAS_IO_URING_AS_DEFAULT)
    reactor_(zr_boost_1_81::asio::use_service<reactor>(context)),
# endif // defined(BOOST_ASIO_HAS_IO_URING_AS_DEFAULT)
#endif // !defined(BOOST_ASIO_WINDOWS)
       //   && !defined(BOOST_ASIO_WINDOWS_RUNTIME)
       //   && !defined(__CYGWIN__)
...
# endif // defined(BOOST_ASIO_HAS_IO_URING_AS_DEFAULT)
  ...
  case execution_context::fork_child:
    if (state->fork_prepared_)
    {
      zr_boost_1_81::asio::detail::signal_blocker blocker;
      close_descriptors();
      open_descriptors();
      int read_descriptor = state->read_descriptor_;
      state->fork_prepared_ = false;
...
zr_boost_1_81::system::error_code signal_set_service::add(
    signal_set_service::implementation_type& impl,
    int signal_number, zr_boost_1_81::system::error_code& ec)
{
...
zr_boost_1_81::system::error_code signal_set_service::remove(
    signal_set_service::implementation_type& impl,
    int signal_number, zr_boost_1_81::system::error_code& ec)
{
  // Check that the signal number is valid.
...
zr_boost_1_81::system::error_code signal_set_service::clear(
    signal_set_service::implementation_type& impl,
...
zr_boost_1_81::system::error_code signal_set_service::cancel(
    signal_set_service::implementation_type& impl,
    zr_boost_1_81::system::error_code& ec)
{
...
void signal_set_service::open_descriptors()
{
  ...
  {
    zr_boost_1_81::system::error_code ec(errno,
        zr_boost_1_81::asio::error::get_system_category());
    zr_boost_1_81::asio::detail::throw_error(ec, "signal_set_service pipe");
  }
#endif // !defined(BOOST_ASIO_WINDOWS)
       //   && !defined(BOOST_ASIO_WINDOWS_RUNTIME)
       //   && !defined(__CYGWIN__)
