...
{
public:
  explicit overlapped_wrapper(zr_boost_1_81::system::error_code& ec)
  {
    Internal = 0;
    InternalHigh = 0;
    Offset = 0;
...
win_iocp_handle_service::win_iocp_handle_service(execution_context& context)
  : execution_context_service_base<win_iocp_handle_service>(context),
    iocp_service_(zr_boost_1_81::asio::use_service<win_iocp_io_context>(context)),
    nt_set_info_(0),
    mutex_(),
    impl_list_(0)
{
...
zr_boost_1_81::system::error_code win_iocp_handle_service::assign(
    win_iocp_handle_service::implementation_type& impl,
...
zr_boost_1_81::system::error_code win_iocp_handle_service::close(
    win_iocp_handle_service::implementation_type& impl,
...
zr_boost_1_81::system::error_code win_iocp_handle_service::cancel(
    win_iocp_handle_service::implementation_type& impl,
    zr_boost_1_81::system::error_code& ec)
{
  if (!is_open(impl))
...
size_t win_iocp_handle_service::do_write(
    ...
    const zr_boost_1_81::asio::const_buffer& buffer, zr_boost_1_81::system::error_code& ec)
{
  if (!is_open(impl))
  {
    ec = zr_boost_1_81::asio::error::bad_descriptor;
...
void win_iocp_handle_service::start_write_op(
    win_iocp_handle_service::implementation_type& impl, uint64_t offset,
    const zr_boost_1_81::asio::const_buffer& buffer, operation* op)
{
...
size_t win_iocp_handle_service::do_read(
    win_iocp_handle_service::implementation_type& impl, uint64_t offset,
    const zr_boost_1_81::asio::mutable_buffer& buffer, zr_boost_1_81::system::error_code& ec)
{
  if (!is_open(impl))
  {
    ec = zr_boost_1_81::asio::error::bad_descriptor;
...
void win_iocp_handle_service::start_read_op(
    win_iocp_handle_service::implementation_type& impl, uint64_t offset,
    const zr_boost_1_81::asio::mutable_buffer& buffer, operation* op)
{
  update_cancellation_thread_id(impl);
  iocp_service_.work_started();
