...
inline void get_last_error(
    zr_boost_1_81::system::error_code& ec, bool is_error_condition)
{
  if (!is_error_condition)
  {
    zr_boost_1_81::asio::error::clear(ec);
  }
  else
  {
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
    ec = zr_boost_1_81::system::error_code(WSAGetLastError(),
        zr_boost_1_81::asio::error::get_system_category());
#else
    ec = zr_boost_1_81::system::error_code(errno,
        zr_boost_1_81::asio::error::get_system_category());
#endif
  }
}
...
socket_type accept(socket_type s, void* addr,
    std::size_t* addrlen, zr_boost_1_81::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = zr_boost_1_81::asio::error::bad_descriptor;
...
socket_type sync_accept(socket_type s, state_type state,
    void* addr, std::size_t* addrlen, zr_boost_1_81::system::error_code& ec)
{
  // Accept a socket.
  for (;;)
  {
    ...
    else if (ec == zr_boost_1_81::asio::error::connection_aborted)
    {
...
void complete_iocp_accept(socket_type s, void* output_buffer,
    ...
    socket_type new_socket, zr_boost_1_81::system::error_code& ec)
{
  // Map non-portable errors to their portable counterparts.
  if (ec.value() == ERROR_NETNAME_DELETED)
    ec = zr_boost_1_81::asio::error::connection_aborted;
  ...
  if (!ec)
  {
    ...
    if (addr && addrlen)
    {
      ...
      {
        ec = zr_boost_1_81::asio::error::invalid_argument;
      }
      else
      {
...
bool non_blocking_accept(socket_type s,
    ...
    zr_boost_1_81::system::error_code& ec, socket_type& new_socket)
{
  for (;;)
  {
...
int close(socket_type s, state_type& state,
    bool destruction, zr_boost_1_81::system::error_code& ec)
{
  int result = 0;
  if (s != invalid_socket)
  {
    ...
    if (result != 0
        && (ec == zr_boost_1_81::asio::error::would_block
          || ec == zr_boost_1_81::asio::error::try_again))
    {
...
bool set_user_non_blocking(socket_type s,
    state_type& state, bool value, zr_boost_1_81::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = zr_boost_1_81::asio::error::bad_descriptor;
...
int shutdown(socket_type s, int what, zr_boost_1_81::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = zr_boost_1_81::asio::error::bad_descriptor;
    ...
    std::size_t addrlen, zr_boost_1_81::system::error_code& ec)
{
  ...
  if (result != 0 && ec == zr_boost_1_81::asio::error::try_again)
  {
    if (static_cast<const socket_addr_type*>(addr)->sa_family == AF_UNIX)
      ec = zr_boost_1_81::asio::error::in_progress;
    else
      ec = zr_boost_1_81::asio::error::no_buffer_space;
  }
    ...
    std::size_t addrlen, zr_boost_1_81::system::error_code& ec)
{
  ...
  if (ec != zr_boost_1_81::asio::error::in_progress
      && ec != zr_boost_1_81::asio::error::would_block)
  {
  ...
  ec = zr_boost_1_81::system::error_code(connect_error,
      zr_boost_1_81::asio::error::get_system_category());
}

#if defined(BOOST_ASIO_HAS_IOCP)

void complete_iocp_connect(socket_type s, zr_boost_1_81::system::error_code& ec)
{
  // Map non-portable errors to their portable counterparts.
  switch (ec.value())
  {
  case ERROR_CONNECTION_REFUSED:
    ec = zr_boost_1_81::asio::error::connection_refused;
    break;
  case ERROR_NETWORK_UNREACHABLE:
    ec = zr_boost_1_81::asio::error::network_unreachable;
    break;
  case ERROR_HOST_UNREACHABLE:
    ec = zr_boost_1_81::asio::error::host_unreachable;
    break;
  case ERROR_SEM_TIMEOUT:
    ec = zr_boost_1_81::asio::error::timed_out;
    break;
  default:
    break;
  }
...
bool non_blocking_connect(socket_type s, zr_boost_1_81::system::error_code& ec)
{
...
int socketpair(int af, int type, int protocol,
    socket_type sv[2], zr_boost_1_81::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  (void)(af);
  (void)(type);
  (void)(protocol);
  (void)(sv);
  ec = zr_boost_1_81::asio::error::operation_not_supported;
  return socket_error_retval;
#else
...
bool sockatmark(socket_type s, zr_boost_1_81::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = zr_boost_1_81::asio::error::bad_descriptor;
...
# if defined(ENOTTY)
  if (ec.value() == ENOTTY)
    ec = zr_boost_1_81::asio::error::not_socket;
...
size_t available(socket_type s, zr_boost_1_81::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = zr_boost_1_81::asio::error::bad_descriptor;
...
int listen(socket_type s, int backlog, zr_boost_1_81::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = zr_boost_1_81::asio::error::bad_descriptor;
...
signed_size_type recv(socket_type s, buf* bufs, size_t count,
    int flags, zr_boost_1_81::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  // Receive some data.
  ...
  if (ec.value() == ERROR_NETNAME_DELETED)
    ec = zr_boost_1_81::asio::error::connection_reset;
...
size_t sync_recv(socket_type s, state_type state, buf* bufs,
    size_t count, int flags, bool all_empty, zr_boost_1_81::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = zr_boost_1_81::asio::error::bad_descriptor;
  ...
  for (;;)
  {
    ...
    {
      ec = zr_boost_1_81::asio::error::eof;
      return 0;
    }
...
size_t sync_recv1(socket_type s, state_type state, void* data,
    size_t size, int flags, zr_boost_1_81::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = zr_boost_1_81::asio::error::bad_descriptor;
...
void complete_iocp_recv(state_type state,
    ...
    zr_boost_1_81::system::error_code& ec, size_t bytes_transferred)
{
  // Map non-portable errors to their portable counterparts.
  if (ec.value() == ERROR_NETNAME_DELETED)
  {
    if (cancel_token.expired())
      ec = zr_boost_1_81::asio::error::operation_aborted;
    else
      ec = zr_boost_1_81::asio::error::connection_reset;
  }
  else if (ec.value() == ERROR_PORT_UNREACHABLE)
...
signed_size_type recvfrom(socket_type s, buf* bufs, size_t count,
    int flags, void* addr, std::size_t* addrlen, zr_boost_1_81::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  // Receive some data.
  DWORD recv_buf_count = static_cast<DWORD>(count);
...
signed_size_type recvmsg(socket_type s, buf* bufs, size_t count,
    int in_flags, int& out_flags, zr_boost_1_81::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  out_flags = 0;
...
int setsockopt(socket_type s, state_type& state, int level, int optname,
    const void* optval, std::size_t optlen, zr_boost_1_81::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = zr_boost_1_81::asio::error::bad_descriptor;
  ...
  ec = zr_boost_1_81::asio::error::fault;
  return socket_error_retval;
...
int getsockopt(socket_type s, state_type state, int level, int optname,
    void* optval, size_t* optlen, zr_boost_1_81::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = zr_boost_1_81::asio::error::bad_descriptor;
...
int getpeername(socket_type s, void* addr, std::size_t* addrlen,
    bool cached, zr_boost_1_81::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = zr_boost_1_81::asio::error::bad_descriptor;
  ...
  if (cached)
  {
    ...
    {
      ec = zr_boost_1_81::asio::error::not_connected;
      return socket_error_retval;
    }
...
int ioctl(socket_type s, state_type& state, int cmd,
    ioctl_arg_type* arg, zr_boost_1_81::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = zr_boost_1_81::asio::error::bad_descriptor;
...
int select(int nfds, fd_set* readfds, fd_set* writefds,
    fd_set* exceptfds, timeval* timeout, zr_boost_1_81::system::error_code& ec)
{
  ...
  // system clock (as wrapped by zr_boost_1_81::posix_time::microsec_clock) typically
...
int poll_read(socket_type s, state_type state,
    int msec, zr_boost_1_81::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = zr_boost_1_81::asio::error::bad_descriptor;
...
int poll_connect(socket_type s, int msec, zr_boost_1_81::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = zr_boost_1_81::asio::error::bad_descriptor;
...
const char* inet_ntop(int af, const void* src, char* dest, size_t length,
    unsigned long scope_id, zr_boost_1_81::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_ASIO_WINDOWS_RUNTIME)
  ...
  {
    ec = zr_boost_1_81::asio::error::address_family_not_supported;
    return 0;
  }
#elif defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  using namespace std; // For memcpy.
...
int gethostname(char* name, int namelen, zr_boost_1_81::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS_RUNTIME)
  try
  {
  ...
  {
    ec = zr_boost_1_81::system::error_code(e->HResult,
...
inline zr_boost_1_81::system::error_code translate_netdb_error(int error)
{
  switch (error)
  {
  case 0:
  ...
  case HOST_NOT_FOUND:
    return zr_boost_1_81::asio::error::host_not_found;
  case TRY_AGAIN:
    return zr_boost_1_81::asio::error::host_not_found_try_again;
  case NO_RECOVERY:
    return zr_boost_1_81::asio::error::no_recovery;
  case NO_DATA:
    return zr_boost_1_81::asio::error::no_data;
  default:
    BOOST_ASIO_ASSERT(false);
    return zr_boost_1_81::asio::error::invalid_argument;
  }
}

inline hostent* gethostbyaddr(const char* addr, int length, int af,
    hostent* result, char* buffer, int buflength, zr_boost_1_81::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  (void)(buffer);
  (void)(buflength);
...
inline hostent* gethostbyname(const char* name, int af, struct hostent* result,
    char* buffer, int buflength, int ai_flags, zr_boost_1_81::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  (void)(buffer);
  (void)(buflength);
    ...
    const addrinfo_type* hintsp, addrinfo_type** result)
{
  ...
  for (gai_search* sptr = search; sptr < search + search_count; ++sptr)
  {
    ...
    if (hptr == 0)
    {
      ...
      freeaddrinfo_emulation(aihead);
      gai_free(canon);
      if (ec == zr_boost_1_81::asio::error::host_not_found)
        return EAI_NONAME;
      if (ec == zr_boost_1_81::asio::error::host_not_found_try_again)
        return EAI_AGAIN;
      if (ec == zr_boost_1_81::asio::error::no_recovery)
        return EAI_FAIL;
      if (ec == zr_boost_1_81::asio::error::no_data)
        return EAI_NONAME;
      return EAI_NONAME;
    }
...
inline zr_boost_1_81::system::error_code getnameinfo_emulation(
    ...
    zr_boost_1_81::system::error_code& ec)
{
  ...
  case BOOST_ASIO_OS_DEF(AF_INET):
    ...
    {
      return ec = zr_boost_1_81::asio::error::invalid_argument;
    }
  ...
  case BOOST_ASIO_OS_DEF(AF_INET6):
    ...
    break;
  default:
    return ec = zr_boost_1_81::asio::error::address_family_not_supported;
  }
  ...
  if (host && hostlen > 0)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          return ec = zr_boost_1_81::asio::error::host_not_found;
        }
  ...
  if (serv && servlen > 0)
  {
    if (flags & NI_NUMERICSERV)
    {
      if (servlen < 6)
      {
        return ec = zr_boost_1_81::asio::error::no_buffer_space;
      }
#if defined(BOOST_ASIO_HAS_SNPRINTF)
...
inline zr_boost_1_81::system::error_code translate_addrinfo_error(int error)
{
  switch (error)
  {
  case 0:
  ...
  case EAI_FAIL:
    return zr_boost_1_81::asio::error::no_recovery;
  case EAI_FAMILY:
    return zr_boost_1_81::asio::error::address_family_not_supported;
  case EAI_MEMORY:
    return zr_boost_1_81::asio::error::no_memory;
  case EAI_NONAME:
  ...
  case EAI_NODATA:
    ...
    return zr_boost_1_81::asio::error::host_not_found;
  case EAI_SERVICE:
    return zr_boost_1_81::asio::error::service_not_found;
  case EAI_SOCKTYPE:
    return zr_boost_1_81::asio::error::socket_type_not_supported;
  default: // Possibly the non-portable EAI_SYSTEM.
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
    return zr_boost_1_81::system::error_code(
        WSAGetLastError(), zr_boost_1_81::asio::error::get_system_category());
#else
    return zr_boost_1_81::system::error_code(
        errno, zr_boost_1_81::asio::error::get_system_category());
#endif
  }
}

zr_boost_1_81::system::error_code getaddrinfo(const char* host,
    const char* service, const addrinfo_type& hints,
    addrinfo_type** result, zr_boost_1_81::system::error_code& ec)
{
...
zr_boost_1_81::system::error_code background_getaddrinfo(
...
zr_boost_1_81::system::error_code getnameinfo(const void* addr,
    std::size_t addrlen, char* host, std::size_t hostlen,
    char* serv, std::size_t servlen, int flags, zr_boost_1_81::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
# if defined(BOOST_ASIO_HAS_GETADDRINFO)
  // Building for Windows XP, Windows Server 2003, or later.
...
zr_boost_1_81::system::error_code sync_getnameinfo(const void* addr,
    std::size_t addrlen, char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, zr_boost_1_81::system::error_code& ec)
{
...
zr_boost_1_81::system::error_code background_getnameinfo(
    const weak_cancel_token_type& cancel_token,
    const void* addr, std::size_t addrlen,
