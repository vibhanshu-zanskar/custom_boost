...
struct scheduler::task_cleanup
{
  ~task_cleanup()
  {
    ...
    {
      zr_boost_1_81::asio::detail::increment(
...
scheduler::scheduler(zr_boost_1_81::asio::execution_context& ctx,
    int concurrency_hint, bool own_thread, get_task_func_type get_task)
  : zr_boost_1_81::asio::detail::execution_context_service_base<scheduler>(ctx),
...
std::size_t scheduler::run(zr_boost_1_81::system::error_code& ec)
{
...
std::size_t scheduler::run_one(zr_boost_1_81::system::error_code& ec)
{
  ec = zr_boost_1_81::system::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t scheduler::wait_one(long usec, zr_boost_1_81::system::error_code& ec)
{
  ec = zr_boost_1_81::system::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t scheduler::poll(zr_boost_1_81::system::error_code& ec)
{
  ec = zr_boost_1_81::system::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t scheduler::poll_one(zr_boost_1_81::system::error_code& ec)
{
  ec = zr_boost_1_81::system::error_code();
  if (outstanding_work_ == 0)
  {
...
scheduler_task* scheduler::get_default_task(zr_boost_1_81::asio::execution_context& ctx)
{
#if defined(BOOST_ASIO_HAS_IO_URING_AS_DEFAULT)
