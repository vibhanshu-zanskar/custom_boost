...
void winrt_ssocket_service_base::base_shutdown()
{
  ...
  zr_boost_1_81::asio::detail::mutex::scoped_lock lock(mutex_);
    ...
    winrt_ssocket_service_base::base_implementation_type& other_impl)
{
  ...
  {
    // Insert implementation into linked list of all implementations.
    zr_boost_1_81::asio::detail::mutex::scoped_lock lock(other_service.mutex_);
...
zr_boost_1_81::system::error_code winrt_ssocket_service_base::close(
    winrt_ssocket_service_base::base_implementation_type& impl,
...
zr_boost_1_81::system::error_code winrt_ssocket_service_base::do_set_option(
    winrt_ssocket_service_base::base_implementation_type& impl,
...
zr_boost_1_81::system::error_code winrt_ssocket_service_base::do_connect(
    winrt_ssocket_service_base::base_implementation_type& impl,
    ...
    const void* addr, winrt_async_op<void>* op, bool is_continuation)
{
  if (!is_open(impl))
  {
    op->ec_ = zr_boost_1_81::asio::error::bad_descriptor;
  ...
  case BOOST_ASIO_OS_DEF(AF_INET6):
    ...
    break;
  default:
    op->ec_ = zr_boost_1_81::asio::error::address_family_not_supported;
    break;
  }
  ...
  {
    op->ec_ = zr_boost_1_81::system::error_code(
        e->HResult, zr_boost_1_81::system::system_category());
    scheduler_.post_immediate_completion(op, is_continuation);
  }
}
...
std::size_t winrt_ssocket_service_base::do_send(
    winrt_ssocket_service_base::base_implementation_type& impl,
    const zr_boost_1_81::asio::const_buffer& data,
    socket_base::message_flags flags, zr_boost_1_81::system::error_code& ec)
{
  ...
  try
  {
    buffer_sequence_adapter<zr_boost_1_81::asio::const_buffer,
      zr_boost_1_81::asio::const_buffer> bufs(zr_boost_1_81::asio::buffer(data));
      ...
      winrt_async_op<unsigned int>* op, bool is_continuation)
{
  if (flags)
  {
    op->ec_ = zr_boost_1_81::asio::error::operation_not_supported;
    scheduler_.post_immediate_completion(op, is_continuation);
    return;
  }
  ...
  {
    op->ec_ = zr_boost_1_81::system::error_code(e->HResult,
        zr_boost_1_81::system::system_category());
    scheduler_.post_immediate_completion(op, is_continuation);
  }
}
...
std::size_t winrt_ssocket_service_base::do_receive(
    winrt_ssocket_service_base::base_implementation_type& impl,
    const zr_boost_1_81::asio::mutable_buffer& data,
    socket_base::message_flags flags, zr_boost_1_81::system::error_code& ec)
{
  if (flags)
  {
  ...
  try
  {
    buffer_sequence_adapter<zr_boost_1_81::asio::mutable_buffer,
        zr_boost_1_81::asio::mutable_buffer> bufs(zr_boost_1_81::asio::buffer(data));
