...
zr_boost_1_81::system::error_code reactive_descriptor_service::assign(
    reactive_descriptor_service::implementation_type& impl,
    const native_handle_type& native_descriptor, zr_boost_1_81::system::error_code& ec)
{
  if (is_open(impl))
  {
...
zr_boost_1_81::system::error_code reactive_descriptor_service::close(
    reactive_descriptor_service::implementation_type& impl,
...
zr_boost_1_81::system::error_code reactive_descriptor_service::cancel(
    reactive_descriptor_service::implementation_type& impl,
    zr_boost_1_81::system::error_code& ec)
{
  if (!is_open(impl))
