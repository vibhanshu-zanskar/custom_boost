    ...
    >::type*)
{
  return strand_executor_service::do_execute(impl, ex,
      ...
      zr_boost_1_81::asio::query(ex, execution::allocator));
}
    ...
    Executor& ex, BOOST_ASIO_MOVE_ARG(Function) function, const Allocator& a)
{
  ...
  if (zr_boost_1_81::asio::query(ex, execution::blocking) != execution::blocking.never
    ...
    Executor& ex, BOOST_ASIO_MOVE_ARG(Function) function, const Allocator& a)
{
  ...
  if (first)
  {
    zr_boost_1_81::asio::dispatch(ex,
