...
void win_thread::start_thread(func_base* arg, unsigned int stack_size)
{
  ...
  if (!entry_event)
  {
    ...
    zr_boost_1_81::asio::detail::throw_error(ec, "thread.entry_event");
  }
  ...
  if (!exit_event_)
  {
    ...
    zr_boost_1_81::system::error_code ec(last_error,
        zr_boost_1_81::asio::error::get_system_category());
    zr_boost_1_81::asio::detail::throw_error(ec, "thread.exit_event");
  }
  ...
  if (!thread_)
  {
    ...
    zr_boost_1_81::system::error_code ec(last_error,
        zr_boost_1_81::asio::error::get_system_category());
    zr_boost_1_81::asio::detail::throw_error(ec, "thread");
  }
