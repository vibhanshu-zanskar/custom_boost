...
zr_boost_1_81::system::error_code win_iocp_file_service::open(
  ...
  if (handle != INVALID_HANDLE_VALUE)
  {
    if (disposition == OPEN_ALWAYS && (open_flags & file_base::truncate) != 0)
    {
      if (!::SetEndOfFile(handle))
      {
        ...
        ::CloseHandle(handle);
        ec.assign(last_error, zr_boost_1_81::asio::error::get_system_category());
        BOOST_ASIO_ERROR_LOCATION(ec);
        return ec;
      }
    }
...
zr_boost_1_81::system::error_code win_iocp_file_service::resize(
    win_iocp_file_service::implementation_type& impl,
...
zr_boost_1_81::system::error_code win_iocp_file_service::sync_all(
    win_iocp_file_service::implementation_type& impl,
    zr_boost_1_81::system::error_code& ec)
{
...
zr_boost_1_81::system::error_code win_iocp_file_service::sync_data(
    win_iocp_file_service::implementation_type& impl,
    zr_boost_1_81::system::error_code& ec)
{
