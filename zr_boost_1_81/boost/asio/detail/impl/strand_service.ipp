...
strand_service::strand_service(zr_boost_1_81::asio::io_context& io_context)
  : zr_boost_1_81::asio::detail::service_base<strand_service>(io_context),
    io_context_(io_context),
    io_context_impl_(zr_boost_1_81::asio::use_service<io_context_impl>(io_context)),
    mutex_(),
    salt_(0)
{
}
...
void strand_service::do_dispatch(implementation_type& impl, operation* op)
{
  ...
  if (can_dispatch && !impl->locked_)
  {
    ...
    op->complete(&io_context_impl_, zr_boost_1_81::system::error_code(), 0);
    return;
  }
