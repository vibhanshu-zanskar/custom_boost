...
struct handler_tracking_timestamp
{
  ...
  {
#if defined(BOOST_ASIO_HAS_BOOST_DATE_TIME)
    zr_boost_1_81::posix_time::ptime epoch(zr_boost_1_81::gregorian::date(1970, 1, 1));
    zr_boost_1_81::posix_time::time_duration now =
      zr_boost_1_81::posix_time::microsec_clock::universal_time() - epoch;
#elif defined(BOOST_ASIO_HAS_CHRONO)
    typedef chrono_time_traits<chrono::system_clock,
        zr_boost_1_81::asio::wait_traits<chrono::system_clock> > traits_helper;
