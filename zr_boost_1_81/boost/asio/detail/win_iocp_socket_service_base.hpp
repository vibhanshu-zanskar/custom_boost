...
protected:
  ...
  BOOST_ASIO_DECL zr_boost_1_81::system::error_code do_open(
      ...
      int protocol, zr_boost_1_81::system::error_code& ec);

  // Assign a native socket to a socket implementation.
  BOOST_ASIO_DECL zr_boost_1_81::system::error_code do_assign(
      base_implementation_type& impl, int type,
      socket_type native_socket, zr_boost_1_81::system::error_code& ec);
  ...
  public:
    ...
    static void do_complete(void* owner, operation* base,
        const zr_boost_1_81::system::error_code& result_ec,
