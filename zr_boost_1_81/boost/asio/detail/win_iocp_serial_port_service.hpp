...
public:
  ...
  BOOST_ASIO_DECL zr_boost_1_81::system::error_code open(implementation_type& impl,
      const std::string& device, zr_boost_1_81::system::error_code& ec);

  // Assign a native handle to a serial port implementation.
  zr_boost_1_81::system::error_code assign(implementation_type& impl,
      const native_handle_type& handle, zr_boost_1_81::system::error_code& ec)
  {
  ...
  // Destroy a serial port implementation.
  zr_boost_1_81::system::error_code close(implementation_type& impl,
  ...
  zr_boost_1_81::system::error_code cancel(implementation_type& impl,
      zr_boost_1_81::system::error_code& ec)
  {
  ...
  zr_boost_1_81::system::error_code set_option(implementation_type& impl,
      const SettableSerialPortOption& option, zr_boost_1_81::system::error_code& ec)
  {
  ...
  zr_boost_1_81::system::error_code get_option(const implementation_type& impl,
      GettableSerialPortOption& option, zr_boost_1_81::system::error_code& ec) const
  {
  ...
  zr_boost_1_81::system::error_code send_break(implementation_type&,
      zr_boost_1_81::system::error_code& ec)
  {
  ...
  size_t write_some(implementation_type& impl,
      const ConstBufferSequence& buffers, zr_boost_1_81::system::error_code& ec)
  {
  ...
  size_t read_some(implementation_type& impl,
      const MutableBufferSequence& buffers, zr_boost_1_81::system::error_code& ec)
  {
...
private:
  ...
  typedef zr_boost_1_81::system::error_code (*store_function_type)(
      const void*, ::DCB&, zr_boost_1_81::system::error_code&);

  // Helper function template to store a serial port option.
  template <typename SettableSerialPortOption>
  static zr_boost_1_81::system::error_code store_option(const void* option,
      ::DCB& storage, zr_boost_1_81::system::error_code& ec)
  {
  ...
  BOOST_ASIO_DECL zr_boost_1_81::system::error_code do_set_option(
      ...
      const void* option, zr_boost_1_81::system::error_code& ec);

  // Function pointer type for loading a serial port option.
  typedef zr_boost_1_81::system::error_code (*load_function_type)(
      void*, const ::DCB&, zr_boost_1_81::system::error_code&);

  // Helper function template to load a serial port option.
  template <typename GettableSerialPortOption>
  static zr_boost_1_81::system::error_code load_option(void* option,
      const ::DCB& storage, zr_boost_1_81::system::error_code& ec)
  {
  ...
  BOOST_ASIO_DECL zr_boost_1_81::system::error_code do_get_option(
      const implementation_type& impl, load_function_type load,
      void* option, zr_boost_1_81::system::error_code& ec) const;
