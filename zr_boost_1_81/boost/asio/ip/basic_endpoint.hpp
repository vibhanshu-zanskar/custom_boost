...
/**
 * The zr_boost_1_81::asio::ip::basic_endpoint class template describes an endpoint that
...
public:
...
#else
  typedef zr_boost_1_81::asio::detail::socket_addr_type data_type;
#endif
   ...
   * @code
   * zr_boost_1_81::asio::ip::tcp::endpoint ep(zr_boost_1_81::asio::ip::tcp::v4(), 1234);
   * @endcode
   *
   * To specify an IPv6 UDP endpoint for port 9876, use:
   * @code
   * zr_boost_1_81::asio::ip::udp::endpoint ep(zr_boost_1_81::asio::ip::udp::v6(), 9876);
   * @endcode
   */
  ...
  basic_endpoint(const zr_boost_1_81::asio::ip::address& addr,
      port_type port_num) BOOST_ASIO_NOEXCEPT
    : impl_(addr, port_num)
  {
  }
  ...
  zr_boost_1_81::asio::ip::address address() const BOOST_ASIO_NOEXCEPT
  {
    return impl_.address();
  }

  /// Set the IP address associated with the endpoint.
  void address(const zr_boost_1_81::asio::ip::address& addr) BOOST_ASIO_NOEXCEPT
  {
    impl_.address(addr);
  }
...
private:
  ...
  zr_boost_1_81::asio::ip::detail::endpoint impl_;
};
 ...
 *
 * @relates zr_boost_1_81::asio::ip::basic_endpoint
 */
...
template <typename InternetProtocol>
struct hash<zr_boost_1_81::asio::ip::basic_endpoint<InternetProtocol> >
{
  std::size_t operator()(
      const zr_boost_1_81::asio::ip::basic_endpoint<InternetProtocol>& ep)
    const BOOST_ASIO_NOEXCEPT
  {
    std::size_t hash1 = std::hash<zr_boost_1_81::asio::ip::address>()(ep.address());
