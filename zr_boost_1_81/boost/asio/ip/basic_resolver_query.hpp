...
/**
 * The zr_boost_1_81::asio::ip::basic_resolver_query class template describes a query
...
public:
  ...
  const zr_boost_1_81::asio::detail::addrinfo_type& hints() const
  {
    return hints_;
  }
...
private:
  zr_boost_1_81::asio::detail::addrinfo_type hints_;
