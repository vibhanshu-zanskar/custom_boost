...
/**
 * The zr_boost_1_81::asio::ip::address_v6 class provides the ability to use and
...
#else
  typedef zr_boost_1_81::asio::detail::array<unsigned char, 16> bytes_type;
#endif
...
private:
  ...
  zr_boost_1_81::asio::detail::in6_addr_type addr_;
 ...
 *
 * @relates zr_boost_1_81::asio::ip::address_v6
 */
...
template <>
struct hash<zr_boost_1_81::asio::ip::address_v6>
{
  std::size_t operator()(const zr_boost_1_81::asio::ip::address_v6& addr)
    const BOOST_ASIO_NOEXCEPT
  {
    const zr_boost_1_81::asio::ip::address_v6::bytes_type bytes = addr.to_bytes();
