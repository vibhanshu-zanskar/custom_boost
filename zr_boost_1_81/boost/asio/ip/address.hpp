...
/**
 * The zr_boost_1_81::asio::ip::address class provides the ability to use either IP
...
public:
  ...
  BOOST_ASIO_DECL address(
      const zr_boost_1_81::asio::ip::address_v4& ipv4_address) BOOST_ASIO_NOEXCEPT;

  /// Construct an address from an IPv6 address.
  BOOST_ASIO_DECL address(
      const zr_boost_1_81::asio::ip::address_v6& ipv6_address) BOOST_ASIO_NOEXCEPT;
  ...
  BOOST_ASIO_DECL zr_boost_1_81::asio::ip::address_v4 to_v4() const;

  /// Get the address as an IP version 6 address.
  BOOST_ASIO_DECL zr_boost_1_81::asio::ip::address_v6 to_v6() const;
  ...
  BOOST_ASIO_DECL std::string to_string(zr_boost_1_81::system::error_code& ec) const;
  ...
  /// string in dotted decimal form, or from an IPv6 address in hexadecimal
  /// notation.
  static address from_string(const char* str, zr_boost_1_81::system::error_code& ec);
...
private:
  ...
  zr_boost_1_81::asio::ip::address_v4 ipv4_address_;

  // The underlying IPv6 address.
  zr_boost_1_81::asio::ip::address_v6 ipv6_address_;
};
 ...
 */
BOOST_ASIO_DECL address make_address(const char* str,
    zr_boost_1_81::system::error_code& ec) BOOST_ASIO_NOEXCEPT;
 ...
 *
 * @relates zr_boost_1_81::asio::ip::address
 */
...
template <>
struct hash<zr_boost_1_81::asio::ip::address>
{
  std::size_t operator()(const zr_boost_1_81::asio::ip::address& addr)
    const BOOST_ASIO_NOEXCEPT
  {
    return addr.is_v4()
      ? std::hash<zr_boost_1_81::asio::ip::address_v4>()(addr.to_v4())
      : std::hash<zr_boost_1_81::asio::ip::address_v6>()(addr.to_v6());
  }
};
