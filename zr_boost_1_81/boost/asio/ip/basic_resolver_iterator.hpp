...
/**
 * The zr_boost_1_81::asio::ip::basic_resolver_iterator class template is used to define
...
protected:
  ...
  typedef zr_boost_1_81::asio::detail::shared_ptr<values_type> values_ptr_type;
