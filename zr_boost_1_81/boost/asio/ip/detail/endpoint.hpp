...
public:
  ...
  BOOST_ASIO_DECL endpoint(const zr_boost_1_81::asio::ip::address& addr,
      unsigned short port_num) BOOST_ASIO_NOEXCEPT;
  ...
  zr_boost_1_81::asio::detail::socket_addr_type* data() BOOST_ASIO_NOEXCEPT
  {
    return &data_.base;
  }

  // Get the underlying endpoint in the native type.
  const zr_boost_1_81::asio::detail::socket_addr_type* data() const BOOST_ASIO_NOEXCEPT
  {
    return &data_.base;
  }
  ...
  {
    if (is_v4())
      return sizeof(zr_boost_1_81::asio::detail::sockaddr_in4_type);
    else
      return sizeof(zr_boost_1_81::asio::detail::sockaddr_in6_type);
  }
  ...
  BOOST_ASIO_DECL zr_boost_1_81::asio::ip::address address() const BOOST_ASIO_NOEXCEPT;

  // Set the IP address associated with the endpoint.
  BOOST_ASIO_DECL void address(
      const zr_boost_1_81::asio::ip::address& addr) BOOST_ASIO_NOEXCEPT;
...
private:
  ...
  union data_union
  {
    zr_boost_1_81::asio::detail::socket_addr_type base;
    zr_boost_1_81::asio::detail::sockaddr_in4_type v4;
    zr_boost_1_81::asio::detail::sockaddr_in6_type v6;
  } data_;
};
