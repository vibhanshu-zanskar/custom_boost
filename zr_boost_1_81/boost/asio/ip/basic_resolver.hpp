...
public:
   ...
   * will be invoked with the zr_boost_1_81::asio::error::operation_aborted error code.
   */
  void cancel()
  {
  ...
  results_type resolve(const query& q)
  {
    ...
    zr_boost_1_81::asio::detail::throw_error(ec, "resolve");
    return r;
  }
   ...
   */
  results_type resolve(const query& q, zr_boost_1_81::system::error_code& ec)
  {
   ...
   */
  results_type resolve(BOOST_ASIO_STRING_VIEW_PARAM host,
      BOOST_ASIO_STRING_VIEW_PARAM service, zr_boost_1_81::system::error_code& ec)
  {
  ...
  results_type resolve(const protocol_type& protocol,
      BOOST_ASIO_STRING_VIEW_PARAM host, BOOST_ASIO_STRING_VIEW_PARAM service,
      resolver_base::flags resolve_flags, zr_boost_1_81::system::error_code& ec)
  {
    basic_resolver_query<protocol_type> q(
        protocol, static_cast<std::string>(host),
        static_cast<std::string>(service), resolve_flags);
   ...
   * @code void(zr_boost_1_81::system::error_code, results_type) @endcode
   */
  template <
  ...
  BOOST_ASIO_INITFN_AUTO_RESULT_TYPE_PREFIX(ResolveToken,
      void (zr_boost_1_81::system::error_code, results_type))
  async_resolve(const query& q,
      BOOST_ASIO_MOVE_ARG(ResolveToken) token
        BOOST_ASIO_DEFAULT_COMPLETION_TOKEN(executor_type))
    BOOST_ASIO_INITFN_AUTO_RESULT_TYPE_SUFFIX((
      zr_boost_1_81::asio::async_initiate<ResolveToken,
        void (zr_boost_1_81::system::error_code, results_type)>(
          declval<initiate_async_resolve>(), token, q)))
  {
    return zr_boost_1_81::asio::async_initiate<ResolveToken,
      void (zr_boost_1_81::system::error_code, results_type)>(
   ...
   * function is guaranteed to return a non-empty range.
   */
  results_type resolve(const endpoint_type& e, zr_boost_1_81::system::error_code& ec)
  {
...
private:
  ...
  public:
        ...
        const Query& q) const
    {
      ...
      zr_boost_1_81::asio::detail::non_const_lvalue<ResolveHandler> handler2(handler);
...
# if defined(BOOST_ASIO_WINDOWS_RUNTIME)
  zr_boost_1_81::asio::detail::io_object_impl<
    zr_boost_1_81::asio::detail::winrt_resolver_service<InternetProtocol>,
    Executor> impl_;
# else
  zr_boost_1_81::asio::detail::io_object_impl<
    zr_boost_1_81::asio::detail::resolver_service<InternetProtocol>,
    Executor> impl_;
# endif
};
