...
/**
 * The zr_boost_1_81::asio::ip::address_v4 class provides the ability to use and
...
#else
  typedef zr_boost_1_81::asio::detail::array<unsigned char, 4> bytes_type;
#endif
...
private:
  ...
  zr_boost_1_81::asio::detail::in4_addr_type addr_;
};
 ...
 *
 * @relates zr_boost_1_81::asio::ip::address_v4
 */
...
template <>
struct hash<zr_boost_1_81::asio::ip::address_v4>
{
  std::size_t operator()(const zr_boost_1_81::asio::ip::address_v4& addr)
