...
address_v4::address_v4(address_v4::uint_type addr)
{
  ...
  addr_.s_addr = zr_boost_1_81::asio::detail::socket_ops::host_to_network_long(
      static_cast<zr_boost_1_81::asio::detail::u_long_type>(addr));
}
...
{
  return zr_boost_1_81::asio::detail::socket_ops::network_to_host_long(addr_.s_addr);
}
...
std::string address_v4::to_string() const
{
  ...
  char addr_str[zr_boost_1_81::asio::detail::max_addr_v4_str_len];
  const char* addr =
    zr_boost_1_81::asio::detail::socket_ops::inet_ntop(
        BOOST_ASIO_OS_DEF(AF_INET), &addr_, addr_str,
        zr_boost_1_81::asio::detail::max_addr_v4_str_len, 0, ec);
  if (addr == 0)
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
std::string address_v4::to_string(zr_boost_1_81::system::error_code& ec) const
{
  char addr_str[zr_boost_1_81::asio::detail::max_addr_v4_str_len];
  const char* addr =
    zr_boost_1_81::asio::detail::socket_ops::inet_ntop(
    ...
    zr_boost_1_81::system::error_code& ec) BOOST_ASIO_NOEXCEPT
{
  ...
  if (zr_boost_1_81::asio::detail::socket_ops::inet_pton(
