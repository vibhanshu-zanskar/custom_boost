 ...
 * @c zr_boost_1_81::asio::detached. For example:
 *
 * @code my_socket.async_send(my_buffer, zr_boost_1_81::asio::detached);
 * @endcode
 */
class detached_t
{
...
/**
 * See the documentation for zr_boost_1_81::asio::detached_t for a usage example.
 */
