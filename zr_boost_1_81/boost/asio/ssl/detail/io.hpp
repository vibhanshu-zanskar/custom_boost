...
std::size_t io(Stream& next_layer, stream_core& core,
    const Operation& op, zr_boost_1_81::system::error_code& ec)
{
  zr_boost_1_81::system::error_code io_ec;
  ...
  case engine::want_input_and_retry:
    ...
    {
      core.input_ = zr_boost_1_81::asio::buffer(core.input_buffer_,
  ...
  case engine::want_output_and_retry:
    ...
    // transport.
    zr_boost_1_81::asio::write(next_layer,
...
class io_op
  : public zr_boost_1_81::asio::detail::base_from_cancellation_state<Handler>
{
public:
  io_op(Stream& next_layer, stream_core& core,
      const Operation& op, Handler& handler)
    : zr_boost_1_81::asio::detail::base_from_cancellation_state<Handler>(handler),
  ...
  io_op(const io_op& other)
    : zr_boost_1_81::asio::detail::base_from_cancellation_state<Handler>(other),
  ...
  io_op(io_op&& other)
    : zr_boost_1_81::asio::detail::base_from_cancellation_state<Handler>(
      ...
      do
      {
        ...
        case engine::want_input_and_retry:
          ...
          if (core_.expiry(core_.pending_read_) == core_.neg_infin())
          {
            ...
            next_layer_.async_read_some(
                zr_boost_1_81::asio::buffer(core_.input_buffer_),
        ...
        case engine::want_output:
          ...
          if (core_.expiry(core_.pending_write_) == core_.neg_infin())
          {
            ...
            zr_boost_1_81::asio::async_write(next_layer_,
        ...
        default:
          ...
          if (start)
          {
            ...
            next_layer_.async_read_some(
                zr_boost_1_81::asio::buffer(core_.input_buffer_, 0),
                BOOST_ASIO_MOVE_CAST(io_op)(*this));
        ...
        case engine::want_input_and_retry:
          ...
          core_.input_ = zr_boost_1_81::asio::buffer(
          ...
          {
            ec_ = zr_boost_1_81::asio::error::operation_aborted;
            break;
          }
    ...
    io_op<Stream, Operation, Handler>* this_handler)
{
  return this_handler->start_ == 0 ? true
    : zr_boost_1_81_asio_handler_cont_helpers::is_continuation(this_handler->handler_);
}
