...
public:
  ...
  buffered_handshake_op(stream_base::handshake_type type,
    ...
    : type_(type),
      buffers_(buffers),
      total_buffer_size_(zr_boost_1_81::asio::buffer_size(buffers_))
  {
  }
      ...
      std::size_t& bytes_transferred) const
  {
    return this->process(eng, ec, bytes_transferred,
        zr_boost_1_81::asio::buffer_sequence_begin(buffers_),
        zr_boost_1_81::asio::buffer_sequence_end(buffers_));
  }
