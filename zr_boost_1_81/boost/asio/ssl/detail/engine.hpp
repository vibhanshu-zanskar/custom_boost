...
public:
  ...
  BOOST_ASIO_DECL zr_boost_1_81::system::error_code set_verify_mode(
      verify_mode v, zr_boost_1_81::system::error_code& ec);

  // Set the peer verification depth.
  BOOST_ASIO_DECL zr_boost_1_81::system::error_code set_verify_depth(
      int depth, zr_boost_1_81::system::error_code& ec);

  // Set a peer certificate verification callback.
  BOOST_ASIO_DECL zr_boost_1_81::system::error_code set_verify_callback(
  ...
  BOOST_ASIO_DECL want shutdown(zr_boost_1_81::system::error_code& ec);

  // Write bytes to the SSL session.
  BOOST_ASIO_DECL want write(const zr_boost_1_81::asio::const_buffer& data,
      zr_boost_1_81::system::error_code& ec, std::size_t& bytes_transferred);

  // Read bytes from the SSL session.
  BOOST_ASIO_DECL want read(const zr_boost_1_81::asio::mutable_buffer& data,
      zr_boost_1_81::system::error_code& ec, std::size_t& bytes_transferred);

  // Get output data to be written to the transport.
  BOOST_ASIO_DECL zr_boost_1_81::asio::mutable_buffer get_output(
      const zr_boost_1_81::asio::mutable_buffer& data);

  // Put input data that was read from the transport.
  BOOST_ASIO_DECL zr_boost_1_81::asio::const_buffer put_input(
      const zr_boost_1_81::asio::const_buffer& data);

  // Map an error::eof code returned by the underlying transport according to
  // the type and state of the SSL session. Returns a const reference to the
  // error code object, suitable for passing to a completion handler.
  BOOST_ASIO_DECL const zr_boost_1_81::system::error_code& map_error_code(
...
private:
  ...
  BOOST_ASIO_DECL static zr_boost_1_81::asio::detail::static_mutex& accept_mutex();
