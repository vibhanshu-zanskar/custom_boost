...
public:
  do_init()
  {
    ...
    for (size_t i = 0; i < mutexes_.size(); ++i)
      mutexes_[i].reset(new zr_boost_1_81::asio::detail::mutex);
...
private:
  ...
  std::vector<zr_boost_1_81::asio::detail::shared_ptr<
        zr_boost_1_81::asio::detail::mutex> > mutexes_;
#endif // (OPENSSL_VERSION_NUMBER < 0x10100000L)
...
zr_boost_1_81::asio::detail::shared_ptr<openssl_init_base::do_init>
openssl_init_base::instance()
{
  static zr_boost_1_81::asio::detail::shared_ptr<do_init> init(new do_init);
  return init;
}
