...
const zr_boost_1_81::system::error_category& get_ssl_category();
...
extern BOOST_ASIO_DECL
const zr_boost_1_81::system::error_category& get_stream_category();

static const zr_boost_1_81::system::error_category&
  stream_category BOOST_ASIO_UNUSED_VARIABLE
  = zr_boost_1_81::asio::ssl::error::get_stream_category();
...
template<> struct is_error_code_enum<zr_boost_1_81::asio::error::ssl_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<zr_boost_1_81::asio::ssl::error::stream_errors>
{
  static const bool value = true;
};
...
inline zr_boost_1_81::system::error_code make_error_code(ssl_errors e)
{
...
inline zr_boost_1_81::system::error_code make_error_code(stream_errors e)
{
  return zr_boost_1_81::system::error_code(
