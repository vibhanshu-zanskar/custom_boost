 ...
 * @code
 * zr_boost_1_81::asio::io_context my_context;
 * zr_boost_1_81::asio::ssl::context ctx(zr_boost_1_81::asio::ssl::context::sslv23);
 * zr_boost_1_81::asio::ssl::stream<asio:ip::tcp::socket> sock(my_context, ctx);
 * @endcode
 *
 * @par Concepts:
...
public:
  ...
  void set_verify_callback(VerifyCallback callback)
  {
    ...
    zr_boost_1_81::asio::detail::throw_error(ec, "set_verify_callback");
  }
  ...
  void handshake(handshake_type type)
  {
    zr_boost_1_81::system::error_code ec;
    handshake(type, ec);
    zr_boost_1_81::asio::detail::throw_error(ec, "handshake");
  }
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  BOOST_ASIO_SYNC_OP_VOID shutdown(zr_boost_1_81::system::error_code& ec)
  {
...
private:
  ...
  public:
        ...
        handshake_type type) const
    {
      ...
      zr_boost_1_81::asio::detail::non_const_lvalue<HandshakeHandler> handler2(handler);
  ...
  public:
        ...
        handshake_type type, const ConstBufferSequence& buffers) const
    {
      ...
      zr_boost_1_81::asio::detail::non_const_lvalue<
  ...
  public:
    ...
    void operator()(BOOST_ASIO_MOVE_ARG(ShutdownHandler) handler) const
    {
      ...
      zr_boost_1_81::asio::detail::non_const_lvalue<ShutdownHandler> handler2(handler);
      detail::async_io(self_->next_layer_, self_->core_,
  ...
  public:
        ...
        const ConstBufferSequence& buffers) const
    {
      ...
      zr_boost_1_81::asio::detail::non_const_lvalue<WriteHandler> handler2(handler);
      detail::async_io(self_->next_layer_, self_->core_,
  ...
  public:
        ...
        const MutableBufferSequence& buffers) const
    {
      ...
      zr_boost_1_81::asio::detail::non_const_lvalue<ReadHandler> handler2(handler);
      detail::async_io(self_->next_layer_, self_->core_,
