...
class ssl_category : public zr_boost_1_81::system::error_category
{
public:
...
{
  return zr_boost_1_81::asio::error::get_ssl_category();
}
...
class stream_category : public zr_boost_1_81::system::error_category
{
public:
  const char* name() const BOOST_ASIO_ERROR_CATEGORY_NOEXCEPT
  {
