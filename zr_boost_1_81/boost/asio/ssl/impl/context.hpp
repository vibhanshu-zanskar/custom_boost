...
BOOST_ASIO_SYNC_OP_VOID context::set_verify_callback(
    VerifyCallback callback, zr_boost_1_81::system::error_code& ec)
{
...
void context::set_password_callback(PasswordCallback callback)
{
  ...
  zr_boost_1_81::asio::detail::throw_error(ec, "set_password_callback");
}

template <typename PasswordCallback>
BOOST_ASIO_SYNC_OP_VOID context::set_password_callback(
    PasswordCallback callback, zr_boost_1_81::system::error_code& ec)
{
