 ...
 *
 * To submit functions to the thread pool, use the @ref zr_boost_1_81::asio::dispatch,
 ...
 * zr_boost_1_81::asio::thread_pool pool(4);
 *
 * // Submit a function to the pool.
 * zr_boost_1_81::asio::post(pool, my_task);
 *
 * // Submit a lambda object to the pool.
 * zr_boost_1_81::asio::post(pool,
 *     []()
 *     {
 *       ...
 *     });
...
private:
   ...
   * @code auto ex1 = my_thread_pool.executor();
   * auto ex2 = zr_boost_1_81::asio::require(ex1,
   *     zr_boost_1_81::asio::execution::blocking.always); @endcode
   */
  BOOST_ASIO_CONSTEXPR basic_executor_type<Allocator,
...
private:
   ...
   * if (zr_boost_1_81::asio::query(ex, zr_boost_1_81::asio::execution::bulk_guarantee)
   ...
   * For example:
   * @code auto ex = my_thread_pool.executor();
   * zr_boost_1_81::asio::thread_pool& pool = zr_boost_1_81::asio::query(
   ...
   * For example:
   * @code auto ex = my_thread_pool.executor();
   * std::size_t occupancy = zr_boost_1_81::asio::query(
   *     ex, zr_boost_1_81::asio::execution::occupancy); @endcode
   */
...
struct equality_comparable<
    zr_boost_1_81::asio::thread_pool::basic_executor_type<Allocator, Bits>
  >
{
...
struct schedule_member<
    const zr_boost_1_81::asio::thread_pool::basic_executor_type<Allocator, Bits>
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef zr_boost_1_81::asio::thread_pool::basic_executor_type<
  ...
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef zr_boost_1_81::asio::execution::detail::as_operation<
      zr_boost_1_81::asio::thread_pool::basic_executor_type<Allocator, Bits>,
...
struct require_member<
  ...
  > : zr_boost_1_81::asio::detail::thread_pool_bits
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef zr_boost_1_81::asio::thread_pool::basic_executor_type<
...
struct require_member<
    zr_boost_1_81::asio::thread_pool::basic_executor_type<Allocator, Bits>,
    zr_boost_1_81::asio::execution::blocking_t::always_t
  > : zr_boost_1_81::asio::detail::thread_pool_bits
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef zr_boost_1_81::asio::thread_pool::basic_executor_type<Allocator,
...
struct query_static_constexpr_member<
    ...
    typename zr_boost_1_81::asio::enable_if<
      zr_boost_1_81::asio::is_convertible<
        Property,
        zr_boost_1_81::asio::execution::bulk_guarantee_t
      >::value
    >::type
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef zr_boost_1_81::asio::execution::bulk_guarantee_t::parallel_t result_type;
...
struct query_member<
    zr_boost_1_81::asio::thread_pool::basic_executor_type<Allocator, Bits>,
    zr_boost_1_81::asio::execution::occupancy_t
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  ...
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef zr_boost_1_81::asio::thread_pool& result_type;
};
