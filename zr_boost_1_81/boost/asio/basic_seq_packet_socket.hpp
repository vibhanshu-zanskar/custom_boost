...
public:
   ...
   * follows:
   * @code
   * socket.receive(zr_boost_1_81::asio::buffer(data, size), out_flags);
   * @endcode
   ...
   * follows:
   * @code
   * socket.receive(zr_boost_1_81::asio::buffer(data, size), 0, out_flags);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, zr_boost_1_81::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.async_receive(zr_boost_1_81::asio::buffer(data, size), out_flags, handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, zr_boost_1_81::array or
   * std::vector.
   ...
   *     zr_boost_1_81::asio::buffer(data, size),
   *     0, out_flags, handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, zr_boost_1_81::array or
