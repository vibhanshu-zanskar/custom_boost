...
public:
  ...
  zr_boost_1_81::asio::detail::socket_addr_type* data()
  {
    return &data_.base;
  }

  // Get the underlying endpoint in the native type.
  const zr_boost_1_81::asio::detail::socket_addr_type* data() const
  {
    return &data_.base;
  }
  ...
  {
    return sizeof(zr_boost_1_81::asio::detail::sockaddr_un_type);
  }
...
private:
  ...
  union data_union
  {
    ...
    zr_boost_1_81::asio::detail::sockaddr_un_type local;
  } data_;
