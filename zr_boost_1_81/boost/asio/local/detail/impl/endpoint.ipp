...
{
  if (new_size > sizeof(zr_boost_1_81::asio::detail::sockaddr_un_type))
  {
  ...
  else
  {
    path_length_ = new_size
      - offsetof(zr_boost_1_81::asio::detail::sockaddr_un_type, sun_path);
...
void endpoint::init(const char* path_name, std::size_t path_length)
{
  if (path_length > sizeof(data_.local.sun_path) - 1)
  {
    ...
    zr_boost_1_81::system::error_code ec(zr_boost_1_81::asio::error::name_too_long);
    zr_boost_1_81::asio::detail::throw_error(ec);
  }

  using namespace std; // For memset and memcpy.
  memset(&data_.local, 0, sizeof(zr_boost_1_81::asio::detail::sockaddr_un_type));
