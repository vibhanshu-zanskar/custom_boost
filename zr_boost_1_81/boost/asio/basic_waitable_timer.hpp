...
template <typename Clock,
    typename WaitTraits = zr_boost_1_81::asio::wait_traits<Clock>,
 ...
 *
 * Most applications will use one of the zr_boost_1_81::asio::steady_timer,
 * zr_boost_1_81::asio::system_timer or zr_boost_1_81::asio::high_resolution_timer typedefs.
 *
 ...
 * zr_boost_1_81::asio::steady_timer timer(my_context);
 *
 ...
 * @code
 * void handler(const zr_boost_1_81::system::error_code& error)
 * {
 *   if (!error)
 *   {
 *     // Timer expired.
 ...
 * }
 *
 * void on_timeout(const zr_boost_1_81::system::error_code& e)
 * {
 ...
 * @endcode
 *
 * @li The zr_boost_1_81::asio::basic_waitable_timer::expires_after() function
 * cancels any pending asynchronous waits, and returns the number of
 * asynchronous waits that were cancelled. If it returns 0 then you were too
 * late and the wait handler has already been executed, or will soon be
 * executed. If it returns 1 then the wait handler was successfully cancelled.
 *
 * @li If a wait handler is cancelled, the zr_boost_1_81::system::error_code passed to
 * it contains the value zr_boost_1_81::asio::error::operation_aborted.
 */
...
public:
    ...
    : impl_(0, ex)
  {
    ...
    zr_boost_1_81::asio::detail::throw_error(ec, "expires_at");
  }
    ...
    : impl_(0, ex)
  {
    ...
    zr_boost_1_81::asio::detail::throw_error(ec, "expires_after");
  }
   ...
   * be invoked with the zr_boost_1_81::asio::error::operation_aborted error code.
   *
   ...
   * error code that indicates the successful completion of the wait operation.
   */
  std::size_t cancel(zr_boost_1_81::system::error_code& ec)
  {
   ...
   * zr_boost_1_81::asio::error::operation_aborted error code.
   *
   * Cancelling the timer does not change the expiry time.
   *
  ...
  std::size_t cancel_one()
  {
    ...
    zr_boost_1_81::asio::detail::throw_error(ec, "cancel_one");
    return s;
  }
   ...
   * error code that indicates the successful completion of the wait operation.
   */
  std::size_t cancel_one(zr_boost_1_81::system::error_code& ec)
  {
  ...
  std::size_t expires_from_now(const duration& expiry_time)
  {
    ...
    std::size_t s = impl_.get_service().expires_from_now(
        impl_.get_implementation(), expiry_time, ec);
    zr_boost_1_81::asio::detail::throw_error(ec, "expires_from_now");
    return s;
  }
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  void wait(zr_boost_1_81::system::error_code& ec)
  {
    impl_.get_service().wait(impl_.get_implementation(), ec);
  }
   ...
   * code zr_boost_1_81::asio::error::operation_aborted.
   *
  ...
  BOOST_ASIO_INITFN_AUTO_RESULT_TYPE_PREFIX(
      WaitToken, void (zr_boost_1_81::system::error_code))
  async_wait(
