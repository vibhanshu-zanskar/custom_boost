...
public:
  ...
  void send_break()
  {
    ...
    zr_boost_1_81::asio::detail::throw_error(ec, "send_break");
  }
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  BOOST_ASIO_SYNC_OP_VOID send_break(zr_boost_1_81::system::error_code& ec)
  {
    impl_.get_service().send_break(impl_.get_implementation(), ec);
    BOOST_ASIO_SYNC_OP_VOID_RETURN(ec);
  }
   ...
   * zr_boost_1_81::asio::serial_port_base::baud_rate @n
   * zr_boost_1_81::asio::serial_port_base::flow_control @n
   * zr_boost_1_81::asio::serial_port_base::parity @n
   * zr_boost_1_81::asio::serial_port_base::stop_bits @n
   * zr_boost_1_81::asio::serial_port_base::character_size
   */
   ...
   *
   * @throws zr_boost_1_81::system::system_error Thrown on failure. An error code of
   * zr_boost_1_81::asio::error::eof indicates that the connection was closed by the
   * peer.
   *
   ...
   * @code
   * basic_serial_port.write_some(zr_boost_1_81::asio::buffer(data, size));
   * @endcode
   * See the @ref buffer documentation for information on writing multiple
   * buffers in one go, and how to use it with arrays, zr_boost_1_81::array or
   * std::vector.
   */
  ...
  std::size_t write_some(const ConstBufferSequence& buffers)
  {
    ...
    zr_boost_1_81::asio::detail::throw_error(ec, "write_some");
    return s;
  }
   ...
   *     zr_boost_1_81::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on writing multiple
   * buffers in one go, and how to use it with arrays, zr_boost_1_81::array or
   * std::vector.
   ...
   * @code
   * basic_serial_port.read_some(zr_boost_1_81::asio::buffer(data, size));
   * @endcode
  ...
  std::size_t read_some(const MutableBufferSequence& buffers)
  {
    ...
    std::size_t s = impl_.get_service().read_some(
        impl_.get_implementation(), buffers, ec);
    zr_boost_1_81::asio::detail::throw_error(ec, "read_some");
    return s;
  }
