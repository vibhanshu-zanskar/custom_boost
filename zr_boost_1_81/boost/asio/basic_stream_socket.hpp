...
public:
   ...
   * @code
   * socket.send(zr_boost_1_81::asio::buffer(data, size));
   * @endcode
  ...
  std::size_t send(const ConstBufferSequence& buffers)
  {
    ...
    zr_boost_1_81::asio::detail::throw_error(ec, "send");
    return s;
  }
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.send(zr_boost_1_81::asio::buffer(data, size), 0);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, zr_boost_1_81::array or
   * std::vector.
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_send(zr_boost_1_81::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, zr_boost_1_81::array or
   * std::vector.
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_send(zr_boost_1_81::asio::buffer(data, size), 0, handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, zr_boost_1_81::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.receive(zr_boost_1_81::asio::buffer(data, size));
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, zr_boost_1_81::array or
   * std::vector.
   */
  ...
  std::size_t receive(const MutableBufferSequence& buffers)
  {
    ...
    std::size_t s = this->impl_.get_service().receive(
        this->impl_.get_implementation(), buffers, 0, ec);
    zr_boost_1_81::asio::detail::throw_error(ec, "receive");
    return s;
  }
   ...
   * follows:
   * @code
   * socket.receive(zr_boost_1_81::asio::buffer(data, size), 0);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, zr_boost_1_81::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.async_receive(zr_boost_1_81::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, zr_boost_1_81::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.async_receive(zr_boost_1_81::asio::buffer(data, size), 0, handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, zr_boost_1_81::array or
   * std::vector.
   ...
   * @code
   * socket.write_some(zr_boost_1_81::asio::buffer(data, size));
   * @endcode
   ...
   * To write a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_write_some(zr_boost_1_81::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on writing multiple
   * buffers in one go, and how to use it with arrays, zr_boost_1_81::array or
   * std::vector.
   ...
   * @code
   * socket.read_some(zr_boost_1_81::asio::buffer(data, size));
   * @endcode
   ...
   * To read into a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_read_some(zr_boost_1_81::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on reading into multiple
   * buffers in one go, and how to use it with arrays, zr_boost_1_81::array or
   * std::vector.
