...
#define BOOST_ASIO_COMPLETION_SIGNATURE \
  ::zr_boost_1_81::asio::completion_signature
...
#define BOOST_ASIO_COMPLETION_HANDLER_FOR(sig) \
  ::zr_boost_1_81::asio::completion_handler_for<sig>
#define BOOST_ASIO_COMPLETION_HANDLER_FOR2(sig0, sig1) \
  ::zr_boost_1_81::asio::completion_handler_for<sig0, sig1>
#define BOOST_ASIO_COMPLETION_HANDLER_FOR3(sig0, sig1, sig2) \
  ::zr_boost_1_81::asio::completion_handler_for<sig0, sig1, sig2>
...
# define BOOST_ASIO_COMPLETION_SIGNATURES_TSIMPLEARGS \
    typename zr_boost_1_81::asio::detail::simple_completion_signature< \
      Signatures>::type...
...
# define BOOST_ASIO_COMPLETION_SIGNATURES_TSIMPLEARGS \
    typename ::zr_boost_1_81::asio::detail::simple_completion_signature<Sig0>::type, \
    typename ::zr_boost_1_81::asio::detail::simple_completion_signature<Sig1>::type, \
    typename ::zr_boost_1_81::asio::detail::simple_completion_signature<Sig2>::type
...
struct async_completion
{
  ...
  typedef typename zr_boost_1_81::asio::async_result<
...
# define BOOST_ASIO_INITFN_RESULT_TYPE(ct, sig) \
  typename ::zr_boost_1_81::asio::detail::async_result_helper< \
    ct, sig>::return_type
# define BOOST_ASIO_INITFN_RESULT_TYPE2(ct, sig0, sig1) \
  typename ::zr_boost_1_81::asio::detail::async_result_helper< \
...
#else
# define BOOST_ASIO_INITFN_RESULT_TYPE(ct, sig) \
  typename ::zr_boost_1_81::asio::async_result< \
    typename ::zr_boost_1_81::asio::decay<ct>::type, sig>::return_type
# define BOOST_ASIO_INITFN_RESULT_TYPE2(ct, sig0, sig1) \
  typename ::zr_boost_1_81::asio::async_result< \
    typename ::zr_boost_1_81::asio::decay<ct>::type, sig0, sig1>::return_type
# define BOOST_ASIO_INITFN_RESULT_TYPE3(ct, sig0, sig1, sig2) \
  typename ::zr_boost_1_81::asio::async_result< \
    typename ::zr_boost_1_81::asio::decay<ct>::type, sig0, sig1, sig2>::return_type
#define BOOST_ASIO_HANDLER_TYPE(ct, sig) \
  typename ::zr_boost_1_81::asio::async_result< \
    typename ::zr_boost_1_81::asio::decay<ct>::type, sig>::completion_handler_type
#define BOOST_ASIO_HANDLER_TYPE2(ct, sig0, sig1) \
  typename ::zr_boost_1_81::asio::async_result< \
    typename ::zr_boost_1_81::asio::decay<ct>::type, \
...
#define BOOST_ASIO_COMPLETION_TOKEN_FOR(sig) \
  ::zr_boost_1_81::asio::completion_token_for<sig>
#define BOOST_ASIO_COMPLETION_TOKEN_FOR2(sig0, sig1) \
  ::zr_boost_1_81::asio::completion_token_for<sig0, sig1>
#define BOOST_ASIO_COMPLETION_TOKEN_FOR3(sig0, sig1, sig2) \
  ::zr_boost_1_81::asio::completion_token_for<sig0, sig1, sig2>
...
#define BOOST_ASIO_ASYNC_OPERATION(t) \
  ::zr_boost_1_81::asio::async_operation<t>
#define BOOST_ASIO_ASYNC_OPERATION1(t, a0) \
  ::zr_boost_1_81::asio::async_operation<t, a0>
#define BOOST_ASIO_ASYNC_OPERATION2(t, a0, a1) \
  ::zr_boost_1_81::asio::async_operation<t, a0, a1>
#define BOOST_ASIO_ASYNC_OPERATION3(t, a0, a1, a2) \
  ::zr_boost_1_81::asio::async_operation<t, a0, a1, a2>
...
#define BOOST_ASIO_DEFAULT_COMPLETION_TOKEN_TYPE(e) \
  = typename ::zr_boost_1_81::asio::default_completion_token<e>::type
