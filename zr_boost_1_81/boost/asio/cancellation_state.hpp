...
public:
   ...
   * @code zr_boost_1_81::asio::cancellation_type_t filter(
   *     zr_boost_1_81::asio::cancellation_type_t); @endcode
   *
   * The library provides the following pre-defined cancellation filters:
   *
   * @li zr_boost_1_81::asio::disable_cancellation
   * @li zr_boost_1_81::asio::enable_terminal_cancellation
   * @li zr_boost_1_81::asio::enable_partial_cancellation
   * @li zr_boost_1_81::asio::enable_total_cancellation
   */
   ...
   * cancellation signals as they are received from the parent slot. This
   * function object must have the signature:
   * @code zr_boost_1_81::asio::cancellation_type_t in_filter(
   *     zr_boost_1_81::asio::cancellation_type_t); @endcode
   *
   ...
   * @code zr_boost_1_81::asio::cancellation_type_t out_filter(
   *     zr_boost_1_81::asio::cancellation_type_t); @endcode
   *
   * The library provides the following pre-defined cancellation filters:
   *
