...
/**
 * @defgroup read zr_boost_1_81::asio::read
 *
 ...
 * @code zr_boost_1_81::asio::read(s, zr_boost_1_81::asio::buffer(data, size)); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, zr_boost_1_81::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code zr_boost_1_81::asio::read(
 *     s, buffers,
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code zr_boost_1_81::asio::read(s, zr_boost_1_81::asio::buffer(data, size), ec); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, zr_boost_1_81::array or
 * std::vector.
 *
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code zr_boost_1_81::asio::read(s, zr_boost_1_81::asio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_read zr_boost_1_81::asio::async_read
 *
 ...
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code
 * zr_boost_1_81::asio::async_read(s, zr_boost_1_81::asio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, zr_boost_1_81::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code zr_boost_1_81::asio::async_read(
 *     s, buffers,
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code zr_boost_1_81::asio::async_read(s,
