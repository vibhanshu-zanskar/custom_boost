 ...
 * expression <tt>zr_boost_1_81::asio::require_concept(E, P)</tt> for some
 ...
 *   with value <tt>true</tt>, <tt>zr_boost_1_81::asio::require_concept(E, P)</tt> is
 *   ill-formed.
 *
 ...
 *
 * @li Otherwise, <tt>zr_boost_1_81::asio::require_concept(E, P)</tt> is ill-formed.
 */
 ...
 * <tt>zr_boost_1_81::asio::require_concept(std::declval<T>(),
...
namespace zr_boost_1_81_asio_require_concept_fn {
...
using zr_boost_1_81::asio::traits::require_concept_free;
using zr_boost_1_81::asio::traits::require_concept_member;
using zr_boost_1_81::asio::traits::static_require_concept;
...
static BOOST_ASIO_CONSTEXPR const zr_boost_1_81_asio_require_concept_fn::impl&
  require_concept = zr_boost_1_81_asio_require_concept_fn::static_instance<>::instance;

} // namespace

typedef zr_boost_1_81_asio_require_concept_fn::impl require_concept_t;

template <typename T, typename Property>
struct can_require_concept :
  integral_constant<bool,
    zr_boost_1_81_asio_require_concept_fn::call_traits<
      require_concept_t, T, void(Property)>::overload !=
        zr_boost_1_81_asio_require_concept_fn::ill_formed>
{
};
...
struct require_concept_result
{
  typedef typename zr_boost_1_81_asio_require_concept_fn::call_traits<
