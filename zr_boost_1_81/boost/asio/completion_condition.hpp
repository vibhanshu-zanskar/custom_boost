 ...
 * std::size_t n = zr_boost_1_81::asio::read(
 *     sock, zr_boost_1_81::asio::buffer(buf),
 *     zr_boost_1_81::asio::transfer_all(), ec);
 * if (ec)
 * {
 *   // An error occurred.
 * }
 ...
 * std::size_t n = zr_boost_1_81::asio::read(
 *     sock, zr_boost_1_81::asio::buffer(buf),
 *     zr_boost_1_81::asio::transfer_at_least(64), ec);
 * if (ec)
 * {
 *   // An error occurred.
 * }
 ...
 * std::size_t n = zr_boost_1_81::asio::read(
 *     sock, zr_boost_1_81::asio::buffer(buf),
 *     zr_boost_1_81::asio::transfer_exactly(64), ec);
 * if (ec)
 * {
 *   // An error occurred.
 * }
