 ...
 * expression <tt>zr_boost_1_81::asio::query(E, P)</tt> for some
 ...
 *   constant expression with value <tt>true</tt>, <tt>zr_boost_1_81::asio::query(E,
 *   P)</tt> is ill-formed.
 *
 ...
 *
 * @li Otherwise, <tt>zr_boost_1_81::asio::query(E, P)</tt> is ill-formed.
 */
 ...
 * @c true_type if the expression <tt>zr_boost_1_81::asio::query(std::declval<T>(),
 ...
 * type of the expression <tt>zr_boost_1_81::asio::query(std::declval<T>(),
...
namespace zr_boost_1_81_asio_query_fn {
...
using zr_boost_1_81::asio::traits::query_free;
using zr_boost_1_81::asio::traits::query_member;
using zr_boost_1_81::asio::traits::static_query;
...
static BOOST_ASIO_CONSTEXPR const zr_boost_1_81_asio_query_fn::impl&
  query = zr_boost_1_81_asio_query_fn::static_instance<>::instance;

} // namespace

typedef zr_boost_1_81_asio_query_fn::impl query_t;

template <typename T, typename Property>
struct can_query :
  integral_constant<bool,
    zr_boost_1_81_asio_query_fn::call_traits<query_t, T, void(Property)>::overload !=
      zr_boost_1_81_asio_query_fn::ill_formed>
{
};
...
struct is_nothrow_query :
  integral_constant<bool,
    zr_boost_1_81_asio_query_fn::call_traits<query_t, T, void(Property)>::is_noexcept>
{
};
...
struct query_result
{
  typedef typename zr_boost_1_81_asio_query_fn::call_traits<
