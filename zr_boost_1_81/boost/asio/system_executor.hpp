...
private:
   ...
   *
   * For example:
   * @code zr_boost_1_81::asio::system_executor ex1;
...
private:
  ...
  friend struct zr_boost_1_81::asio::execution::detail::blocking_t<0>;
  ...
  friend struct zr_boost_1_81::asio::execution::detail::relationship_t<0>;
#endif // !defined(GENERATING_DOCUMENTATION)
   ...
   *
   * For example:
   * @code zr_boost_1_81::asio::system_executor ex;
   ...
   * For example:
   * @code zr_boost_1_81::asio::system_executor ex;
   * zr_boost_1_81::asio::system_context& pool = zr_boost_1_81::asio::query(
...
struct equality_comparable<
    zr_boost_1_81::asio::basic_system_executor<Blocking, Relationship, Allocator>
  >
{
  ...
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef zr_boost_1_81::asio::basic_system_executor<
      zr_boost_1_81::asio::execution::blocking_t::possibly_t,
  ...
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef zr_boost_1_81::asio::basic_system_executor<Blocking,
      zr_boost_1_81::asio::execution::relationship_t::fork_t,
  ...
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef zr_boost_1_81::asio::system_context& result_type;
};
...
struct query_member<
    zr_boost_1_81::asio::basic_system_executor<Blocking, Relationship, Allocator>,
    zr_boost_1_81::asio::execution::allocator_t<Allocator>
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
