...
/**
 * @par Example
 * @code zr_boost_1_81::asio::awaitable<void> my_coroutine()
 * {
 *   zr_boost_1_81::asio::cancellation_state cs
 *     = co_await zr_boost_1_81::asio::this_coro::cancellation_state;
 *
 *   // ...
 *
 *   if (cs.cancelled() != zr_boost_1_81::asio::cancellation_type::none)
 *     // ...
 * } @endcode
 */
#if defined(BOOST_ASIO_HAS_CONSTEXPR) || defined(GENERATING_DOCUMENTATION)
 ...
 * @code zr_boost_1_81::asio::awaitable<void> my_coroutine()
 * {
 *   co_await zr_boost_1_81::asio::this_coro::reset_cancellation_state();
 *
 *   // ...
 * } @endcode
 *
 * @note The cancellation state is shared by all coroutines in the same "thread
 * of execution" that was created using zr_boost_1_81::asio::co_spawn.
 */
 ...
 * {
 *   co_await zr_boost_1_81::asio::this_coro::reset_cancellation_state(
 *       zr_boost_1_81::asio::enable_partial_cancellation());
 *
 *   // ...
 * } @endcode
 *
 ...
 *   co_await zr_boost_1_81::asio::this_coro::reset_cancellation_state(
 *       zr_boost_1_81::asio::enable_partial_cancellation(),
 *       zr_boost_1_81::asio::disable_cancellation());
 *
 *   // ...
 * } @endcode
 *
 ...
 * @code zr_boost_1_81::asio::awaitable<void> my_coroutine()
 * {
 *   if (co_await zr_boost_1_81::asio::this_coro::throw_if_cancelled)
 *     // ...
 *
 *   // ...
 * } @endcode
 ...
 * @code zr_boost_1_81::asio::awaitable<void> my_coroutine()
 * {
 *   co_await zr_boost_1_81::asio::this_coro::throw_if_cancelled(false);
 *
 *   // ...
 * } @endcode
 */
