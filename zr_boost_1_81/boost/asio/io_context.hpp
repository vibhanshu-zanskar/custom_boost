 ...
 *
 * @li zr_boost_1_81::asio::ip::tcp::socket
 * @li zr_boost_1_81::asio::ip::tcp::acceptor
 * @li zr_boost_1_81::asio::ip::udp::socket
 * @li zr_boost_1_81::asio::deadline_timer.
 *
 ...
 *
 * To submit functions to the io_context, use the @ref zr_boost_1_81::asio::dispatch,
 * @ref zr_boost_1_81::asio::post or @ref zr_boost_1_81::asio::defer free functions.
 *
 * For example:
 *
 * @code void my_task()
 ...
 * zr_boost_1_81::asio::post(io_context, my_task);
 *
 * // Submit a lambda object to the io_context.
 * zr_boost_1_81::asio::post(io_context,
 *     []()
 *     {
 *       ...
 *     });
 ...
 * zr_boost_1_81::asio::executor_work_guard<io_context::executor_type>:
 *
 * @code zr_boost_1_81::asio::io_context io_context;
 * zr_boost_1_81::asio::executor_work_guard<zr_boost_1_81::asio::io_context::executor_type>
 *   = zr_boost_1_81::asio::make_work_guard(io_context);
 * ... @endcode
 *
...
public:
   ...
   * without blocking.
   */
  BOOST_ASIO_DECL count_type run(zr_boost_1_81::system::error_code& ec);
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)
   ...
   * deadlock. It is the caller's reponsibility to avoid this.
   */
  BOOST_ASIO_DECL count_type run_one(zr_boost_1_81::system::error_code& ec);
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)
   ...
   * @return The number of handlers that were executed.
   */
  BOOST_ASIO_DECL count_type poll(zr_boost_1_81::system::error_code& ec);
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)
   ...
   * @return The number of handlers that were executed.
   */
  BOOST_ASIO_DECL count_type poll_one(zr_boost_1_81::system::error_code& ec);
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)
  ...
  /// (Deprecated: Use zr_boost_1_81::asio::dispatch().) Request the io_context to
  ...
  /// (Deprecated: Use zr_boost_1_81::asio::post().) Request the io_context to invoke
  ...
  /// (Deprecated: Use zr_boost_1_81::asio::bind_executor().) Create a new handler that
   ...
   * @code io_context.dispatch(zr_boost_1_81::bind(f, a1, ... an)); @endcode
   */
...
#if !defined(GENERATING_DOCUMENTATION)
private:
  friend struct zr_boost_1_81_asio_require_fn::impl;
  friend struct zr_boost_1_81_asio_prefer_fn::impl;
#endif // !defined(GENERATING_DOCUMENTATION)

  /// Obtain an executor with the @c blocking.possibly property.
  /**
   * Do not call this function directly. It is intended for use with the
   * zr_boost_1_81::asio::require customisation point.
   *
   * For example:
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = zr_boost_1_81::asio::require(ex1,
   *     zr_boost_1_81::asio::execution::blocking.possibly); @endcode
   */
   ...
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = zr_boost_1_81::asio::require(ex1,
   *     zr_boost_1_81::asio::execution::blocking.never); @endcode
   */
  BOOST_ASIO_CONSTEXPR basic_executor_type require(
   ...
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = zr_boost_1_81::asio::require(ex1,
   *     zr_boost_1_81::asio::execution::relationship.fork); @endcode
   */
  BOOST_ASIO_CONSTEXPR basic_executor_type require(
   ...
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = zr_boost_1_81::asio::require(ex1,
   *     zr_boost_1_81::asio::execution::relationship.continuation); @endcode
   */
  BOOST_ASIO_CONSTEXPR basic_executor_type require(
   ...
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = zr_boost_1_81::asio::require(ex1,
   *     zr_boost_1_81::asio::execution::outstanding_work.tracked); @endcode
   */
   ...
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = zr_boost_1_81::asio::require(ex1,
   *     zr_boost_1_81::asio::execution::outstanding_work.untracked); @endcode
   */
  BOOST_ASIO_CONSTEXPR basic_executor_type<Allocator,
      BOOST_ASIO_UNSPECIFIED(Bits & ~outstanding_work_tracked)>
   ...
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = zr_boost_1_81::asio::require(ex1,
   *     zr_boost_1_81::asio::execution::allocator(my_allocator)); @endcode
   */
   ...
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = zr_boost_1_81::asio::require(ex1,
   *     zr_boost_1_81::asio::execution::allocator); @endcode
   */
...
#if !defined(GENERATING_DOCUMENTATION)
private:
  friend struct zr_boost_1_81_asio_query_fn::impl;
  friend struct zr_boost_1_81::asio::execution::detail::mapping_t<0>;
  friend struct zr_boost_1_81::asio::execution::detail::outstanding_work_t<0>;
#endif // !defined(GENERATING_DOCUMENTATION)

  /// Query the current value of the @c mapping property.
  /**
   * Do not call this function directly. It is intended for use with the
   * zr_boost_1_81::asio::query customisation point.
   *
   * For example:
   * @code auto ex = my_io_context.get_executor();
   * if (zr_boost_1_81::asio::query(ex, zr_boost_1_81::asio::execution::mapping)
   ...
   * For example:
   * @code auto ex = my_io_context.get_executor();
   * zr_boost_1_81::asio::io_context& ctx = zr_boost_1_81::asio::query(
   *     ex, zr_boost_1_81::asio::execution::context); @endcode
   */
   ...
   * For example:
   * @code auto ex = my_io_context.get_executor();
   * if (zr_boost_1_81::asio::query(ex, zr_boost_1_81::asio::execution::blocking)
   ...
   * For example:
   * @code auto ex = my_io_context.get_executor();
   * if (zr_boost_1_81::asio::query(ex, zr_boost_1_81::asio::execution::relationship)
   ...
   * For example:
   * @code auto ex = my_io_context.get_executor();
   * if (zr_boost_1_81::asio::query(ex, zr_boost_1_81::asio::execution::outstanding_work)
   ...
   * For example:
   * @code auto ex = my_io_context.get_executor();
   * auto alloc = zr_boost_1_81::asio::query(ex,
   *     zr_boost_1_81::asio::execution::allocator); @endcode
   */
  template <typename OtherAllocator>
...
public:
   ...
   */
  explicit work(zr_boost_1_81::asio::io_context& io_context);
  ...
  zr_boost_1_81::asio::io_context& get_io_context();
...
protected:
   ...
   */
  BOOST_ASIO_DECL service(zr_boost_1_81::asio::io_context& owner);
...
class service_base
  : public zr_boost_1_81::asio::io_context::service
{
public:
  static zr_boost_1_81::asio::detail::service_id<Type> id;

  // Constructor.
  service_base(zr_boost_1_81::asio::io_context& io_context)
    : zr_boost_1_81::asio::io_context::service(io_context)
  {
  }
};

template <typename Type>
zr_boost_1_81::asio::detail::service_id<Type> service_base<Type>::id;
...
struct equality_comparable<
    zr_boost_1_81::asio::io_context::basic_executor_type<Allocator, Bits>
  >
{
...
struct require_member<
    zr_boost_1_81::asio::io_context::basic_executor_type<Allocator, Bits>,
    zr_boost_1_81::asio::execution::blocking_t::possibly_t
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef zr_boost_1_81::asio::io_context::basic_executor_type<
...
struct require_member<
    zr_boost_1_81::asio::io_context::basic_executor_type<Allocator, Bits>,
    zr_boost_1_81::asio::execution::blocking_t::never_t
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
...
struct require_member<
    zr_boost_1_81::asio::io_context::basic_executor_type<Allocator, Bits>,
    zr_boost_1_81::asio::execution::relationship_t::fork_t
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
...
struct require_member<
    zr_boost_1_81::asio::io_context::basic_executor_type<Allocator, Bits>,
    zr_boost_1_81::asio::execution::relationship_t::continuation_t
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
...
struct require_member<
    zr_boost_1_81::asio::io_context::basic_executor_type<Allocator, Bits>,
    zr_boost_1_81::asio::execution::outstanding_work_t::tracked_t
  > : zr_boost_1_81::asio::detail::io_context_bits
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef zr_boost_1_81::asio::io_context::basic_executor_type<
...
struct require_member<
    zr_boost_1_81::asio::io_context::basic_executor_type<Allocator, Bits>,
    zr_boost_1_81::asio::execution::outstanding_work_t::untracked_t
  > : zr_boost_1_81::asio::detail::io_context_bits
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
...
struct require_member<
    zr_boost_1_81::asio::io_context::basic_executor_type<Allocator, Bits>,
    zr_boost_1_81::asio::execution::allocator_t<void>
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
...
struct require_member<
    zr_boost_1_81::asio::io_context::basic_executor_type<Allocator, Bits>,
    zr_boost_1_81::asio::execution::allocator_t<OtherAllocator>
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
...
struct query_static_constexpr_member<
    zr_boost_1_81::asio::io_context::basic_executor_type<Allocator, Bits>,
    Property,
    typename zr_boost_1_81::asio::enable_if<
      zr_boost_1_81::asio::is_convertible<
        Property,
        zr_boost_1_81::asio::execution::outstanding_work_t
      >::value
    >::type
  > : zr_boost_1_81::asio::detail::io_context_bits
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef zr_boost_1_81::asio::execution::outstanding_work_t result_type;
...
struct query_static_constexpr_member<
    ...
    typename zr_boost_1_81::asio::enable_if<
      zr_boost_1_81::asio::is_convertible<
        Property,
        zr_boost_1_81::asio::execution::mapping_t
      >::value
    >::type
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef zr_boost_1_81::asio::execution::mapping_t::thread_t result_type;
...
struct query_member<
    ...
    typename zr_boost_1_81::asio::enable_if<
      zr_boost_1_81::asio::is_convertible<
        Property,
        zr_boost_1_81::asio::execution::blocking_t
      >::value
    >::type
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef zr_boost_1_81::asio::execution::blocking_t result_type;
};
...
struct query_member<
    ...
    typename zr_boost_1_81::asio::enable_if<
      zr_boost_1_81::asio::is_convertible<
        Property,
        zr_boost_1_81::asio::execution::relationship_t
      >::value
    >::type
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef zr_boost_1_81::asio::execution::relationship_t result_type;
};

template <typename Allocator, uintptr_t Bits>
struct query_member<
    zr_boost_1_81::asio::io_context::basic_executor_type<Allocator, Bits>,
    zr_boost_1_81::asio::execution::context_t
  >
{
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  BOOST_ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef zr_boost_1_81::asio::io_context& result_type;
};
