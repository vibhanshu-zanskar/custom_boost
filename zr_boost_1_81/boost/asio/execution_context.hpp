...
public:
   ...
   *
   * @throws zr_boost_1_81::system::system_error Thrown on failure. If the notification
   ...
   * constructor.
   *
   * @throws zr_boost_1_81::asio::service_already_exists Thrown if a service of the
...
#undef BOOST_ASIO_PRIVATE_MAKE_SERVICE_DEF
   ...
   * given type is already present in the execution_context.
   *
   * @throws zr_boost_1_81::asio::invalid_service_owner Thrown if the service's owning
...
private:
  ...
  zr_boost_1_81::asio::detail::service_registry* service_registry_;
};
...
private:
  ...
  friend class zr_boost_1_81::asio::detail::service_registry;
  struct key
  {
