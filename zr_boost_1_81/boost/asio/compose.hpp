 ...
 * {
 *   tcp::socket& socket_;
 *   zr_boost_1_81::asio::mutable_buffer buffer_;
 ...
 *       {
 *         state_ = writing;
 *         zr_boost_1_81::asio::async_write(socket_, buffer_,
 *             zr_boost_1_81::asio::transfer_exactly(n),
 *             std::move(self));
 *       }
 *       break;
 *     case writing:
 ...
 *   decltype(
 *     zr_boost_1_81::asio::async_compose<CompletionToken,
 *       void(zr_boost_1_81::system::error_code, std::size_t)>(
 *         std::declval<async_echo_implementation>(),
 *         token, socket))
 * {
 *   return zr_boost_1_81::asio::async_compose<CompletionToken,
 *     void(zr_boost_1_81::system::error_code, std::size_t)>(
