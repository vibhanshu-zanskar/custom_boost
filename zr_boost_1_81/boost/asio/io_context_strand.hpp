...
public:
   ...
   */
  explicit strand(zr_boost_1_81::asio::io_context& io_context)
    : service_(zr_boost_1_81::asio::use_service<
        zr_boost_1_81::asio::detail::strand_service>(io_context))
  {
  ...
  zr_boost_1_81::asio::io_context& context() const BOOST_ASIO_NOEXCEPT
  {
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
  /// (Deprecated: Use zr_boost_1_81::asio::dispatch().) Request the strand to invoke
  /// the given handler.
  /**
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
  /// (Deprecated: Use zr_boost_1_81::asio::post().) Request the strand to invoke the
   ...
   * @code strand.dispatch(zr_boost_1_81::bind(f, a1, ... an)); @endcode
   */
...
private:
  ...
  zr_boost_1_81::asio::detail::strand_service& service_;
  mutable zr_boost_1_81::asio::detail::strand_service::implementation_type impl_;
};
