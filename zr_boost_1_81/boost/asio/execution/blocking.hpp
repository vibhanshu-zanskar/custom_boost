...
# endif // defined(BOOST_ASIO_NO_DEPRECATED)
  ...
  {
    return zr_boost_1_81::asio::query(ex, possibly_t());
  }
...
#endif // !defined(__clang__)
  {
    return zr_boost_1_81::asio::query(ex, always_t());
  }
...
#endif // !defined(__clang__)
  {
    return zr_boost_1_81::asio::query(ex, never_t());
  }
...
public:
  ...
  {
    return zr_boost_1_81::asio::require(executor_, possibly_t<I>());
  }
  ...
  {
    return zr_boost_1_81::asio::require(executor_, never_t<I>());
  }
