...
public:
   ...
   * zr_boost_1_81::asio::require and zr_boost_1_81::asio::prefer customisation points.
   *
   * For example:
   * @code execution::any_executor<execution::blocking_t::possibly_t> ex = ...;
   * auto ex2 = zr_boost_1_81::asio::requre(ex, execution::blocking.possibly); @endcode
   */
  ...
  /**
   * Do not call this function directly. It is intended for use with the
   * zr_boost_1_81::asio::prefer customisation point.
   *
   * For example:
   * @code execution::any_executor<execution::blocking_t::possibly_t> ex = ...;
   * auto ex2 = zr_boost_1_81::asio::prefer(ex, execution::blocking.possibly); @endcode
   */
  template <typename Property>
   ...
   * size_t n = zr_boost_1_81::asio::query(ex, execution::occupancy); @endcode
   */
  template <typename Property>
  ...
  /**
   * Throws zr_boost_1_81::asio::bad_executor if the polymorphic wrapper has no target.
   */
...
public:
  ...
  {
    if (impl_)
      zr_boost_1_81::asio::detail::ref_count_up(impl_->ref_count_);
  }
  ...
  {
    if (impl_)
      if (zr_boost_1_81::asio::detail::ref_count_down(impl_->ref_count_))
        delete impl_;
  }
...
private:
  struct impl_base
  {
    ...
    virtual ~impl_base() {}
    virtual void* get() = 0;
    zr_boost_1_81::asio::detail::atomic_count ref_count_;
  };
...
public:
  ...
  void execute(BOOST_ASIO_MOVE_ARG(F) f) const
  {
    if (target_)
    {
      ...
      {
        zr_boost_1_81::asio::detail::non_const_lvalue<F> f2(f);
...
protected:
  ...
  typedef zr_boost_1_81::asio::detail::executor_function function;
  typedef zr_boost_1_81::asio::detail::executor_function_view function_view;
...
# pragma warning (disable:4702)
  ...
  static void query_fn_non_void(void*, const void* ex, const void* prop,
      typename enable_if<
        zr_boost_1_81::asio::can_query<const Ex&, const Prop&>::value
          && is_same<typename Prop::polymorphic_query_result_type, void>::value
      >::type*)
  {
    zr_boost_1_81::asio::query(*static_cast<const Ex*>(ex),
  ...
  static Poly require_fn_impl(const void* ex, const void* prop,
      ...
      >::type*)
  {
    return zr_boost_1_81::asio::require(*static_cast<const Ex*>(ex),
        *static_cast<const Prop*>(prop));
  }
  ...
  static Poly prefer_fn_impl(const void* ex, const void* prop,
      ...
      >::type*)
  {
    return zr_boost_1_81::asio::prefer(*static_cast<const Ex*>(ex),
        *static_cast<const Prop*>(prop));
  }
...
private:
  ...
  {
    return zr_boost_1_81::asio::query(ex, execution::blocking);
  }
...
//  template <typename...> friend class any_executor;
  ...
  typedef aligned_storage<
      sizeof(zr_boost_1_81::asio::detail::shared_ptr<void>) + sizeof(void*),
      alignment_of<zr_boost_1_81::asio::detail::shared_ptr<void> >::value
    >::type object_type;
...
public:
      ...
      >::type* = 0) const
  {
    ...
    prop_fns_[found::index].query(&result, object_fns_->target(*this),
        &static_cast<const typename found::type&>(p));
    return *zr_boost_1_81::asio::detail::scoped_ptr<
      typename found::query_result_type>(result);
  }
