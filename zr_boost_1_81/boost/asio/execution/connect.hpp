...
namespace zr_boost_1_81_asio_execution_connect_fn {

using zr_boost_1_81::asio::conditional;
using zr_boost_1_81::asio::declval;
using zr_boost_1_81::asio::enable_if;
using zr_boost_1_81::asio::execution::detail::as_invocable;
using zr_boost_1_81::asio::execution::detail::as_operation;
using zr_boost_1_81::asio::execution::detail::is_as_receiver;
using zr_boost_1_81::asio::execution::is_executor_of;
using zr_boost_1_81::asio::execution::is_operation_state;
using zr_boost_1_81::asio::execution::is_receiver;
using zr_boost_1_81::asio::execution::is_sender;
using zr_boost_1_81::asio::false_type;
using zr_boost_1_81::asio::remove_cvref;
using zr_boost_1_81::asio::traits::connect_free;
using zr_boost_1_81::asio::traits::connect_member;
...
static BOOST_ASIO_CONSTEXPR const zr_boost_1_81_asio_execution_connect_fn::impl&
  connect = zr_boost_1_81_asio_execution_connect_fn::static_instance<>::instance;
...
struct can_connect :
  integral_constant<bool,
    zr_boost_1_81_asio_execution_connect_fn::call_traits<S, void(R)>::overload !=
      zr_boost_1_81_asio_execution_connect_fn::ill_formed>
{
};
...
struct is_nothrow_connect :
  integral_constant<bool,
    zr_boost_1_81_asio_execution_connect_fn::call_traits<S, void(R)>::is_noexcept>
{
};
...
struct connect_result
{
  typedef typename zr_boost_1_81_asio_execution_connect_fn::call_traits<
