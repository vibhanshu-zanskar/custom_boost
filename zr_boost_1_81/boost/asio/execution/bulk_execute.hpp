 ...
 *   guarantee <tt>zr_boost_1_81::asio::query(S, execution::bulk_guarantee)</tt>, and
 ...
 *   progress guarantee <tt>zr_boost_1_81::asio::query(E,
 ...
 *   if <tt>zr_boost_1_81::asio::query(S, execution::bulk_guarantee)</tt> equals
...
namespace zr_boost_1_81_asio_execution_bulk_execute_fn {

using zr_boost_1_81::asio::declval;
using zr_boost_1_81::asio::enable_if;
using zr_boost_1_81::asio::execution::bulk_guarantee_t;
using zr_boost_1_81::asio::execution::detail::bulk_sender;
using zr_boost_1_81::asio::execution::executor_index;
using zr_boost_1_81::asio::execution::is_sender;
using zr_boost_1_81::asio::is_convertible;
using zr_boost_1_81::asio::is_same;
using zr_boost_1_81::asio::remove_cvref;
using zr_boost_1_81::asio::result_of;
using zr_boost_1_81::asio::traits::bulk_execute_free;
using zr_boost_1_81::asio::traits::bulk_execute_member;
...
static BOOST_ASIO_CONSTEXPR
  const zr_boost_1_81_asio_execution_bulk_execute_fn::impl& bulk_execute =
    zr_boost_1_81_asio_execution_bulk_execute_fn::static_instance<>::instance;
...
struct can_bulk_execute :
  integral_constant<bool,
    zr_boost_1_81_asio_execution_bulk_execute_fn::call_traits<
      S, void(F, N)>::overload !=
        zr_boost_1_81_asio_execution_bulk_execute_fn::ill_formed>
{
};
...
{
  typedef typename zr_boost_1_81_asio_execution_bulk_execute_fn::call_traits<
