...
namespace zr_boost_1_81_asio_execution_start_fn {

using zr_boost_1_81::asio::decay;
using zr_boost_1_81::asio::declval;
using zr_boost_1_81::asio::enable_if;
using zr_boost_1_81::asio::traits::start_free;
using zr_boost_1_81::asio::traits::start_member;
...
static BOOST_ASIO_CONSTEXPR const zr_boost_1_81_asio_execution_start_fn::impl&
  start = zr_boost_1_81_asio_execution_start_fn::static_instance<>::instance;
...
struct can_start :
  integral_constant<bool,
    zr_boost_1_81_asio_execution_start_fn::call_traits<R>::overload !=
      zr_boost_1_81_asio_execution_start_fn::ill_formed>
{
};
...
struct is_nothrow_start :
  integral_constant<bool,
    zr_boost_1_81_asio_execution_start_fn::call_traits<R>::is_noexcept>
{
};
