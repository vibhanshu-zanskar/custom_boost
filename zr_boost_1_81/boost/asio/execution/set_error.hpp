...
namespace zr_boost_1_81_asio_execution_set_error_fn {

using zr_boost_1_81::asio::decay;
using zr_boost_1_81::asio::declval;
using zr_boost_1_81::asio::enable_if;
using zr_boost_1_81::asio::traits::set_error_free;
using zr_boost_1_81::asio::traits::set_error_member;
...
static BOOST_ASIO_CONSTEXPR const zr_boost_1_81_asio_execution_set_error_fn::impl&
  set_error = zr_boost_1_81_asio_execution_set_error_fn::static_instance<>::instance;
...
struct can_set_error :
  integral_constant<bool,
    zr_boost_1_81_asio_execution_set_error_fn::call_traits<R, void(E)>::overload !=
      zr_boost_1_81_asio_execution_set_error_fn::ill_formed>
{
};
...
struct is_nothrow_set_error :
  integral_constant<bool,
    zr_boost_1_81_asio_execution_set_error_fn::call_traits<R, void(E)>::is_noexcept>
{
};
