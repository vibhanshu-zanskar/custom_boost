...
namespace zr_boost_1_81_asio_execution_submit_fn {

using zr_boost_1_81::asio::declval;
using zr_boost_1_81::asio::enable_if;
using zr_boost_1_81::asio::execution::is_sender_to;
using zr_boost_1_81::asio::traits::submit_free;
using zr_boost_1_81::asio::traits::submit_member;
...
struct impl
{
  ...
  operator()(S&& s, R&& r) const
    BOOST_ASIO_NOEXCEPT_IF((
      call_traits<S, void(R)>::is_noexcept))
  {
    return zr_boost_1_81::asio::execution::start(
        (new zr_boost_1_81::asio::execution::detail::submit_receiver<S, R>(
  ...
  {
    return zr_boost_1_81::asio::execution::start(
        (new zr_boost_1_81::asio::execution::detail::submit_receiver<
          S&, R&>(s, r))->state_);
  }
  ...
  operator()(const S& s, R& r) const
    BOOST_ASIO_NOEXCEPT_IF((
      call_traits<const S&, void(R&)>::is_noexcept))
  {
    zr_boost_1_81::asio::execution::start(
        (new zr_boost_1_81::asio::execution::detail::submit_receiver<
...
static BOOST_ASIO_CONSTEXPR const zr_boost_1_81_asio_execution_submit_fn::impl&
  submit = zr_boost_1_81_asio_execution_submit_fn::static_instance<>::instance;
...
struct can_submit :
  integral_constant<bool,
    zr_boost_1_81_asio_execution_submit_fn::call_traits<S, void(R)>::overload !=
      zr_boost_1_81_asio_execution_submit_fn::ill_formed>
{
};
...
struct is_nothrow_submit :
  integral_constant<bool,
    zr_boost_1_81_asio_execution_submit_fn::call_traits<S, void(R)>::is_noexcept>
{
};
...
{
  typedef typename zr_boost_1_81_asio_execution_submit_fn::call_traits<
