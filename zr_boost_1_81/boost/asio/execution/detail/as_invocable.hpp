...
struct as_invocable
{
  ...
  explicit as_invocable(Receiver& r) BOOST_ASIO_NOEXCEPT
    : receiver_(zr_boost_1_81::asio::detail::addressof(r))
  {
  }
...
{
  Receiver* receiver_;
  zr_boost_1_81::asio::detail::shared_ptr<zr_boost_1_81::asio::detail::atomic_count> ref_count_;

  explicit as_invocable(Receiver& r,
      const zr_boost_1_81::asio::detail::shared_ptr<
        zr_boost_1_81::asio::detail::atomic_count>& c) BOOST_ASIO_NOEXCEPT
    : receiver_(zr_boost_1_81::asio::detail::addressof(r)),
      ref_count_(c)
  {
  }
