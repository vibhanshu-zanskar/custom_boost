...
namespace zr_boost_1_81_asio_execution_execute_fn {
...
using zr_boost_1_81::asio::execution::detail::as_receiver;
using zr_boost_1_81::asio::execution::detail::is_as_invocable;
using zr_boost_1_81::asio::execution::is_sender_to;
using zr_boost_1_81::asio::false_type;
using zr_boost_1_81::asio::result_of;
using zr_boost_1_81::asio::traits::execute_free;
using zr_boost_1_81::asio::traits::execute_member;
using zr_boost_1_81::asio::true_type;
using zr_boost_1_81::asio::void_type;
...
struct impl
{
  ...
  operator()(
    ...
    BOOST_ASIO_NOEXCEPT_IF((
      call_traits<impl, T, void(F)>::is_noexcept))
  {
    return zr_boost_1_81::asio::execution::detail::submit_helper(
...
static BOOST_ASIO_CONSTEXPR const zr_boost_1_81_asio_execution_execute_fn::impl&
  execute = zr_boost_1_81_asio_execution_execute_fn::static_instance<>::instance;

} // namespace

typedef zr_boost_1_81_asio_execution_execute_fn::impl execute_t;

template <typename T, typename F>
struct can_execute :
  integral_constant<bool,
    zr_boost_1_81_asio_execution_execute_fn::call_traits<
      execute_t, T, void(F)>::overload !=
        zr_boost_1_81_asio_execution_execute_fn::ill_formed>
{
};
