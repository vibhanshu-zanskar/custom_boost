...
namespace zr_boost_1_81_asio_execution_set_value_fn {

using zr_boost_1_81::asio::decay;
using zr_boost_1_81::asio::declval;
using zr_boost_1_81::asio::enable_if;
using zr_boost_1_81::asio::traits::set_value_free;
using zr_boost_1_81::asio::traits::set_value_member;
...
static BOOST_ASIO_CONSTEXPR const zr_boost_1_81_asio_execution_set_value_fn::impl&
  set_value = zr_boost_1_81_asio_execution_set_value_fn::static_instance<>::instance;
...
struct can_set_value :
  integral_constant<bool,
    zr_boost_1_81_asio_execution_set_value_fn::call_traits<R, void(Vs...)>::overload !=
      zr_boost_1_81_asio_execution_set_value_fn::ill_formed>
{
};
...
struct is_nothrow_set_value :
  integral_constant<bool,
    zr_boost_1_81_asio_execution_set_value_fn::call_traits<R, void(Vs...)>::is_noexcept>
{
};
...
struct can_set_value<R> :
  integral_constant<bool,
    zr_boost_1_81_asio_execution_set_value_fn::call_traits<R, void()>::overload !=
      zr_boost_1_81_asio_execution_set_value_fn::ill_formed>
{
};
...
struct is_nothrow_set_value<R> :
  integral_constant<bool,
    zr_boost_1_81_asio_execution_set_value_fn::call_traits<R, void()>::is_noexcept>
{
};
...
#define BOOST_ASIO_PRIVATE_SET_VALUE_TRAITS_DEF(n) \
  ...
  struct can_set_value<R, BOOST_ASIO_VARIADIC_TARGS(n)> : \
    integral_constant<bool, \
      zr_boost_1_81_asio_execution_set_value_fn::call_traits<R, \
