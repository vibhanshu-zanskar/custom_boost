...
struct has_sender_traits<S,
    typename enable_if<
      is_same<
        typename zr_boost_1_81::asio::execution::sender_traits<
...
#define BOOST_ASIO_EXECUTION_SENDER ::zr_boost_1_81::asio::execution::sender
...
#define BOOST_ASIO_EXECUTION_SENDER_TO(r) \
  ::zr_boost_1_81::asio::execution::sender_to<r>
...
#define BOOST_ASIO_EXECUTION_TYPED_SENDER \
  ::zr_boost_1_81::asio::execution::typed_sender
