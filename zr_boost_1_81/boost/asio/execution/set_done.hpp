...
namespace zr_boost_1_81_asio_execution_set_done_fn {

using zr_boost_1_81::asio::decay;
using zr_boost_1_81::asio::declval;
using zr_boost_1_81::asio::enable_if;
using zr_boost_1_81::asio::traits::set_done_free;
using zr_boost_1_81::asio::traits::set_done_member;
...
static BOOST_ASIO_CONSTEXPR const zr_boost_1_81_asio_execution_set_done_fn::impl&
  set_done = zr_boost_1_81_asio_execution_set_done_fn::static_instance<>::instance;
...
struct can_set_done :
  integral_constant<bool,
    zr_boost_1_81_asio_execution_set_done_fn::call_traits<R>::overload !=
      zr_boost_1_81_asio_execution_set_done_fn::ill_formed>
{
};
...
struct is_nothrow_set_done :
  integral_constant<bool,
    zr_boost_1_81_asio_execution_set_done_fn::call_traits<R>::is_noexcept>
{
};
