...
# endif // defined(BOOST_ASIO_NO_DEPRECATED)
  ...
  {
    return zr_boost_1_81::asio::query(ex, disallowed_t());
  }
...
#endif // !defined(__clang__)
  {
    return zr_boost_1_81::asio::query(ex, allowed_t());
  }
...
public:
  ...
  {
    return zr_boost_1_81::asio::query(executor_, p);
  }
      ...
      is_nothrow_require<const Executor&, Property>::value))
  {
    return adapter<typename decay<
      typename require_result<const Executor&, Property>::type
        >::type>(0, zr_boost_1_81::asio::require(executor_, p));
  }
      ...
      is_nothrow_prefer<const Executor&, Property>::value))
  {
    return adapter<typename decay<
      typename prefer_result<const Executor&, Property>::type
        >::type>(0, zr_boost_1_81::asio::prefer(executor_, p));
  }
...
public:
  ...
  struct cleanup
  {
    ~cleanup()
    {
      zr_boost_1_81::asio::detail::mutex::scoped_lock lock(state_->mutex_);
  ...
  zr_boost_1_81::asio::detail::event event_;
  bool is_complete_;
};
