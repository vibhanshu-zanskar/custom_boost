...
namespace zr_boost_1_81_asio_execution_schedule_fn {

using zr_boost_1_81::asio::decay;
using zr_boost_1_81::asio::declval;
using zr_boost_1_81::asio::enable_if;
using zr_boost_1_81::asio::execution::is_executor;
using zr_boost_1_81::asio::traits::schedule_free;
using zr_boost_1_81::asio::traits::schedule_member;
...
static BOOST_ASIO_CONSTEXPR const zr_boost_1_81_asio_execution_schedule_fn::impl&
  schedule = zr_boost_1_81_asio_execution_schedule_fn::static_instance<>::instance;
...
struct can_schedule :
  integral_constant<bool,
    zr_boost_1_81_asio_execution_schedule_fn::call_traits<S>::overload !=
      zr_boost_1_81_asio_execution_schedule_fn::ill_formed>
{
};
...
struct is_nothrow_schedule :
  integral_constant<bool,
    zr_boost_1_81_asio_execution_schedule_fn::call_traits<S>::is_noexcept>
{
};
