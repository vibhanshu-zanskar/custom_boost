...
#else
  typedef zr_boost_1_81::asio::detail::win_object_handle_service::native_handle_type
    native_handle_type;
#endif
...
private:
  ...
  zr_boost_1_81::asio::detail::io_object_impl<
    zr_boost_1_81::asio::detail::win_object_handle_service, Executor> impl_;
};
