 ...
 * execution.
 *
 * @param a The zr_boost_1_81::asio::awaitable object that is the result of calling the
 ...
 * @par Example
 * @code
 * zr_boost_1_81::asio::awaitable<std::size_t> echo(tcp::socket socket)
 * {
 ...
 *           zr_boost_1_81::asio::buffer(data), zr_boost_1_81::asio::use_awaitable);
 *
 *       co_await zr_boost_1_81::asio::async_write(socket,
 *           zr_boost_1_81::asio::buffer(data, n), zr_boost_1_81::asio::use_awaitable);
 *
 *       bytes_transferred += n;
 *     }
 *   }
 ...
 * // ...
 *
 * zr_boost_1_81::asio::co_spawn(my_executor,
 ...
 * cancellation state, call zr_boost_1_81::asio::this_coro::reset_cancellation_state.
 */
 ...
 * @par Example
 * @code
 * zr_boost_1_81::asio::awaitable<void> echo(tcp::socket socket)
 * {
 *   try
 *   {
 *     char data[1024];
 ...
 * // ...
 *
 * zr_boost_1_81::asio::co_spawn(my_io_context,
 *   echo(std::move(my_tcp_socket)),
 *   [](std::exception_ptr e, std::size_t n)
 *   {
 *     std::cout << "transferred " << n << "\n";
 ...
 * @c zr_boost_1_81::asio::awaitable<R,E> that will be used as the coroutine's entry
 * point.
 *
 ...
 * @code zr_boost_1_81::asio::awaitable<R, AwaitableExecutor> F() @endcode
 *
 * @par Example
 * @code
 * zr_boost_1_81::asio::awaitable<std::size_t> echo(tcp::socket socket)
 ...
 *     -> zr_boost_1_81::asio::awaitable<void>
 *   {
 *     try
 *     {
 *       char data[1024];
