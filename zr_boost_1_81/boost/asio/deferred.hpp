...
private:
  ...
  auto invoke_helper(
    ...
    -> decltype(
        zr_boost_1_81::asio::async_initiate<CompletionToken, void(Values...)>(
          initiate(), token,
          std::get<I>(
            BOOST_ASIO_MOVE_CAST(std::tuple<Values...>)(this->values_))...))
  {
    return zr_boost_1_81::asio::async_initiate<CompletionToken, void(Values...)>(
        initiate(), token,
 ...
 * operation, typically using the special value @c zr_boost_1_81::asio::deferred. For
 * example:
 *
 * @code auto my_deferred_op
 *   = my_socket.async_read_some(my_buffer,
 *       zr_boost_1_81::asio::deferred); @endcode
 *
...
/**
 * See the documentation for zr_boost_1_81::asio::deferred_t for a usage example.
 */
