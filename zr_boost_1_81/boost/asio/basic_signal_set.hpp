 ...
 * zr_boost_1_81::asio::signal_set signals(my_context, SIGINT, SIGTERM);
 *
...
public:
   ...
   * @code zr_boost_1_81::asio::signal_set signals(ex);
    ...
    : impl_(0, ex)
  {
    ...
    zr_boost_1_81::asio::detail::throw_error(ec, "add");
  }
   ...
   *
   * @note This constructor is equivalent to performing:
   * @code zr_boost_1_81::asio::signal_set signals(context);
   * signals.add(signal_number_1); @endcode
   */
  template <typename ExecutionContext>
  ...
  void remove(int signal_number)
  {
    ...
    zr_boost_1_81::asio::detail::throw_error(ec, "remove");
  }
  ...
  void clear()
  {
    ...
    zr_boost_1_81::asio::detail::throw_error(ec, "clear");
  }
   ...
   * @note Removes all queued notifications.
   */
  BOOST_ASIO_SYNC_OP_VOID clear(zr_boost_1_81::system::error_code& ec)
  {
    impl_.get_service().clear(impl_.get_implementation(), ec);
    BOOST_ASIO_SYNC_OP_VOID_RETURN(ec);
  }
   ...
   * operation will be invoked with the zr_boost_1_81::asio::error::operation_aborted
   * error code.
   *
   ...
   * error code zr_boost_1_81::asio::error::operation_aborted.
   *
   ...
   * @code void(zr_boost_1_81::system::error_code, int) @endcode
   *
   ...
   */
  template <
    BOOST_ASIO_COMPLETION_TOKEN_FOR(void (zr_boost_1_81::system::error_code, int))
  ...
  async_wait(
    ...
    BOOST_ASIO_INITFN_AUTO_RESULT_TYPE_SUFFIX((
      async_initiate<SignalToken, void (zr_boost_1_81::system::error_code, int)>(
          declval<initiate_async_wait>(), token)))
  {
    return async_initiate<SignalToken, void (zr_boost_1_81::system::error_code, int)>(
