 ...
 * expression <tt>zr_boost_1_81::asio::require(E, P0, Pn...)</tt> for some
 ...
 *   <tt>zr_boost_1_81::asio::require(E, P0, Pn...)</tt> is ill-formed.
 *
 ...
 *
 * @li Otherwise,
 *   <tt>zr_boost_1_81::asio::require(zr_boost_1_81::asio::require(E, P0), Pn...)</tt>
 *   if <tt>N > 0</tt> and the expression
 *   <tt>zr_boost_1_81::asio::require(zr_boost_1_81::asio::require(E, P0), Pn...)</tt>
 *   is a valid expression.
 *
 * @li Otherwise, <tt>zr_boost_1_81::asio::require(E, P0, Pn...)</tt> is ill-formed.
 */
 ...
 * @c true_type if the expression <tt>zr_boost_1_81::asio::require(std::declval<T>(),
 ...
 * type of the expression <tt>zr_boost_1_81::asio::require(std::declval<T>(),
...
namespace zr_boost_1_81_asio_require_fn {

using zr_boost_1_81::asio::conditional;
using zr_boost_1_81::asio::decay;
using zr_boost_1_81::asio::declval;
using zr_boost_1_81::asio::enable_if;
using zr_boost_1_81::asio::is_applicable_property;
using zr_boost_1_81::asio::traits::require_free;
using zr_boost_1_81::asio::traits::require_member;
using zr_boost_1_81::asio::traits::static_require;
...
static BOOST_ASIO_CONSTEXPR const zr_boost_1_81_asio_require_fn::impl&
  require = zr_boost_1_81_asio_require_fn::static_instance<>::instance;

} // namespace

typedef zr_boost_1_81_asio_require_fn::impl require_t;
...
struct can_require :
  integral_constant<bool,
    zr_boost_1_81_asio_require_fn::call_traits<
      require_t, T, void(Properties...)>::overload
        != zr_boost_1_81_asio_require_fn::ill_formed>
{
};
...
struct can_require :
  integral_constant<bool,
    zr_boost_1_81_asio_require_fn::call_traits<require_t, T, void(P0, P1, P2)>::overload
      != zr_boost_1_81_asio_require_fn::ill_formed>
{
};
...
struct can_require<T, P0, P1> :
  integral_constant<bool,
    zr_boost_1_81_asio_require_fn::call_traits<require_t, T, void(P0, P1)>::overload
      != zr_boost_1_81_asio_require_fn::ill_formed>
{
};
...
struct can_require<T, P0> :
  integral_constant<bool,
    zr_boost_1_81_asio_require_fn::call_traits<require_t, T, void(P0)>::overload
      != zr_boost_1_81_asio_require_fn::ill_formed>
{
};
...
struct require_result
{
  typedef typename zr_boost_1_81_asio_require_fn::call_traits<
