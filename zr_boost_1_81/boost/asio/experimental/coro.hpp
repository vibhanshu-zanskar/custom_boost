...
struct coro
{
  /// The traits of the coroutine. See zr_boost_1_81::asio::experimental::coro_traits
  /// for details.
  ...
  ~coro()
  {
    if (coro_ != nullptr)
    {
      ...
      if (handle)
        zr_boost_1_81::asio::dispatch(coro_->get_executor(), destroyer{handle});
    }
  }
...
template<typename T, typename Executor = zr_boost_1_81::asio::any_io_executor,
    typename Allocator = std::allocator<void>>
