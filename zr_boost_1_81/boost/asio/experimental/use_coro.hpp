 ...
 * returned.
 *
 * Note that this token is not the most efficient (use @c zr_boost_1_81::asio::deferred
...
# if defined(BOOST_ASIO_HAS_SOURCE_LOCATION)
      , zr_boost_1_81::asio::detail::source_location location =
        zr_boost_1_81::asio::detail::source_location::current()
...
/// resumable coroutine.
/**
 * See the documentation for zr_boost_1_81::asio::use_coro_t for a usage example.
 */
