...
private:
  ...
  typedef detail::channel_service<zr_boost_1_81::asio::detail::null_mutex> service_type;
...
public:
  ...
  basic_channel(const executor_type& ex, std::size_t max_buffer_size = 0)
    : service_(&zr_boost_1_81::asio::use_service<service_type>(
  ...
  basic_channel(ExecutionContext& context, std::size_t max_buffer_size = 0,
    ...
    : service_(&zr_boost_1_81::asio::use_service<service_type>(context)),
      impl_(),
   ...
   * @c zr_boost_1_81::asio::experimental::error::channel_cancelled. Outstanding receive
...
private:
  ...
  {
    return zr_boost_1_81::asio::query(t, execution::context);
  }
  ...
  public:
    ...
    {
      zr_boost_1_81::asio::detail::non_const_lvalue<SendHandler> handler2(handler);
  ...
  public:
    ...
    {
      zr_boost_1_81::asio::detail::non_const_lvalue<ReceiveHandler> handler2(handler);
