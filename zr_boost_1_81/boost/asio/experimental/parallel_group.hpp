...
{
  typedef zr_boost_1_81::asio::detail::array<std::size_t, N> order_type;
...
/**
 * See the documentation for zr_boost_1_81::asio::experimental::make_parallel_group for
 * a usage example.
 */
  ...
  struct initiate_async_wait
  {
    ...
    void operator()(Handler&& h, Condition&& c, std::tuple<Ops...>&& ops) const
    {
      detail::parallel_group_launch(
          ...
          ops, zr_boost_1_81::asio::detail::index_sequence_for<Ops...>());
    }
  };
...
public:
   ...
   * operations, it must return a zr_boost_1_81::asio::cancellation_type value other
   * than <tt>zr_boost_1_81::asio::cancellation_type::none</tt>.
   *
   ...
   *
   * @li zr_boost_1_81::asio::experimental::wait_for_all
   * @li zr_boost_1_81::asio::experimental::wait_for_one
   * @li zr_boost_1_81::asio::experimental::wait_for_one_error
   * @li zr_boost_1_81::asio::experimental::wait_for_one_success
   */
  ...
  async_wait(CancellationCondition cancellation_condition,
    ...
    BOOST_ASIO_INITFN_AUTO_RESULT_TYPE_SUFFIX((
      zr_boost_1_81::asio::async_initiate<CompletionToken, signature>(
          declval<initiate_async_wait>(), token,
          std::move(cancellation_condition), std::move(ops_))))
  {
    return zr_boost_1_81::asio::async_initiate<CompletionToken, signature>(
...
/**
 * For example:
 * @code zr_boost_1_81::asio::experimental::make_parallel_group(
 *    [&](auto token)
 *    {
 *      return in.async_read_some(zr_boost_1_81::asio::buffer(data), token);
 *    },
 *    [&](auto token)
 *    {
 ...
 *       zr_boost_1_81::asio::buffer(data1),
 ...
 *       zr_boost_1_81::asio::buffer(data2),
 *       zr_boost_1_81::asio::deferred
 *     )
 *   );
 *
 ...
 *         std::vector<zr_boost_1_81::system::error_code> e,
