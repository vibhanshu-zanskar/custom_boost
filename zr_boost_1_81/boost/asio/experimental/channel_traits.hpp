...
template <typename R>
struct channel_traits<R(zr_boost_1_81::system::error_code)>
{
  template <typename... NewSignatures>
  struct rebind
  {
  ...
  typedef R receive_cancelled_signature(zr_boost_1_81::system::error_code);

  template <typename F>
  static void invoke_receive_cancelled(F f)
  {
    const zr_boost_1_81::system::error_code e = error::channel_cancelled;
    BOOST_ASIO_MOVE_OR_LVALUE(F)(f)(e);
  }

  typedef R receive_closed_signature(zr_boost_1_81::system::error_code);

  template <typename F>
  static void invoke_receive_closed(F f)
  {
    const zr_boost_1_81::system::error_code e = error::channel_closed;
    BOOST_ASIO_MOVE_OR_LVALUE(F)(f)(e);
  }
};

template <typename R, typename... Args, typename... Signatures>
struct channel_traits<R(zr_boost_1_81::system::error_code, Args...), Signatures...>
{
  template <typename... NewSignatures>
  struct rebind
  {
  ...
  typedef R receive_cancelled_signature(zr_boost_1_81::system::error_code, Args...);
  ...
  typedef R receive_closed_signature(zr_boost_1_81::system::error_code, Args...);
...
struct channel_traits<R(std::exception_ptr)>
{
  ...
  static void invoke_receive_cancelled(F f)
  {
    ...
    BOOST_ASIO_MOVE_OR_LVALUE(F)(f)(
        std::make_exception_ptr(zr_boost_1_81::system::system_error(e)));
  }
