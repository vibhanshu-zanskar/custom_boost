...
auto coro_interpret_result(
    std::tuple<zr_boost_1_81::system::error_code, Args...>&& args)
{
  if (std::get<0>(args))
    zr_boost_1_81::asio::detail::throw_exception(
        zr_boost_1_81::system::system_error(std::get<0>(args)));
...
inline auto coro_interpret_result(
    std::tuple<zr_boost_1_81::system::error_code>&& args)
{
  if (std::get<0>(args))
    zr_boost_1_81::asio::detail::throw_exception(
        zr_boost_1_81::system::system_error(std::get<0>(args)));
...
template <typename Arg>
auto coro_interpret_result(std::tuple<zr_boost_1_81::system::error_code, Arg>&& args)
{
  if (std::get<0>(args))
    zr_boost_1_81::asio::detail::throw_exception(
        zr_boost_1_81::system::system_error(std::get<0>(args)));
