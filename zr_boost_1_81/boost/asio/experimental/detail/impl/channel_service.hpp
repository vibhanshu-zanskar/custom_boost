...
inline channel_service<Mutex>::channel_service(execution_context& ctx)
  : zr_boost_1_81::asio::detail::execution_context_service_base<channel_service>(ctx),
    mutex_(),
    impl_list_(0)
{
}
...
inline void channel_service<Mutex>::shutdown()
{
  ...
  zr_boost_1_81::asio::detail::op_queue<channel_operation> ops;
    ...
    void* cancellation_key)
{
  ...
  zr_boost_1_81::asio::detail::op_queue<channel_operation> other_ops;
  while (channel_operation* op = impl.waiters_.front())
  {
  ...
  case buffer:
    {
      ...
      lock.unlock();
      zr_boost_1_81::asio::detail::non_const_lvalue<Handler> handler2(handler);
