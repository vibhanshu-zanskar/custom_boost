...
class channel_service
  : public zr_boost_1_81::asio::detail::execution_context_service_base<
...
public:
  ...
  struct base_implementation_type
  {
    ...
    zr_boost_1_81::asio::detail::op_queue<channel_operation> waiters_;
...
struct channel_service<Mutex>::implementation_type<
    Traits, R(zr_boost_1_81::system::error_code)>
  : channel_service::base_implementation_type
{
  // The traits type associated with the channel.
  typedef typename Traits::template rebind<R(zr_boost_1_81::system::error_code)>::other
    traits_type;
  ...
  typedef typename conditional<
      ...
      typename conditional<
        has_signature<
          ...
          R(zr_boost_1_81::system::error_code)
        >::value,
        channel_payload<R(zr_boost_1_81::system::error_code)>,
        channel_payload<
          R(zr_boost_1_81::system::error_code),
          typename traits_type::receive_closed_signature
        >
  ...
  void buffer_push(payload_type payload)
  {
    ...
    {
      zr_boost_1_81::system::error_code value{last.value_};
...
private:
  ...
  {
    zr_boost_1_81::system::error_code value_;
    std::size_t count_ = 0;
  };

  struct value_handler
  {
    zr_boost_1_81::system::error_code& target_;

    template <typename... Args>
    void operator()(const zr_boost_1_81::system::error_code& value, Args&&...)
    {
      target_ = value;
    }
  };
