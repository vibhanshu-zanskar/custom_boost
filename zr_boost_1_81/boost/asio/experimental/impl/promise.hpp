...
template<typename Signature = void(),
    typename Executor = zr_boost_1_81::asio::any_io_executor,
...
struct promise_impl<void(Ts...), Executor, Allocator>
{
  ...
  void apply_impl(Func f, zr_boost_1_81::asio::detail::index_sequence<Idx...>)
  {
  ...
  void apply(Func f)
  {
    apply_impl(std::forward<Func>(f),
        zr_boost_1_81::asio::detail::make_index_sequence<sizeof...(Ts)>{});
  }
  ...
  struct completion_impl final : completion_base
  {
    ...
    void invoke(Ts&&... ts)
    {
      ...
      using alloc_t = typename std::allocator_traits<
        typename zr_boost_1_81::asio::decay<Alloc>::type>::template
  ...
  typename zr_boost_1_81::asio::aligned_storage<sizeof(void*) * 4,
  ...
  void set_completion(Alloc&& alloc, Handler&& handler)
  {
    ...
    using impl_t = completion_impl<
      typename zr_boost_1_81::asio::decay<Alloc>::type, Handler>;
    using alloc_t = typename std::allocator_traits<
      typename zr_boost_1_81::asio::decay<Alloc>::type>::template rebind_alloc<impl_t>;
  ...
  template<typename... T_>
  void cancel_impl_(zr_boost_1_81::system::error_code*, T_*...)
  {
    complete(zr_boost_1_81::asio::error::operation_aborted, T_{}...);
  }
