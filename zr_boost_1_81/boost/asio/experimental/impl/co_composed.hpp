...
using zr_boost_1_81::asio::detail::composed_io_executors;
using zr_boost_1_81::asio::detail::composed_work;
using zr_boost_1_81::asio::detail::composed_work_guard;
using zr_boost_1_81::asio::detail::get_composed_io_executor;
using zr_boost_1_81::asio::detail::make_composed_io_executors;
using zr_boost_1_81::asio::detail::recycling_allocator;
using zr_boost_1_81::asio::detail::throw_error;
...
struct co_composed_state_default_cancellation_on_suspend_impl<Executors,
    Handler, Return, R(zr_boost_1_81::system::error_code, Args...), Signatures...>
{
  using promise_type = co_composed_promise<Executors, Handler, Return>;
  using return_type = std::tuple<zr_boost_1_81::system::error_code, Args...>;
        ...
        std::move(handler)(
            std::make_exception_ptr(
              zr_boost_1_81::system::system_error(
                zr_boost_1_81::asio::error::operation_aborted, "co_await")),
            Args{}...);
      };
    }
    else
...
class co_composed_handler<Executors, Handler,
    Return, R(zr_boost_1_81::system::error_code, Args...)>
  : public co_composed_handler_base<Executors, Handler, Return>
{
public:
  using co_composed_handler_base<Executors,
  ...
  using result_type = std::tuple<zr_boost_1_81::system::error_code, args_type>;

  template <typename... T>
  void operator()(const zr_boost_1_81::system::error_code& ec, T&&... args)
  {
...
struct coroutine_traits<void, C&,
    zr_boost_1_81::asio::experimental::detail::co_composed_state<
      Executors, Handler, Return>,
    Args...>
{
  using promise_type =
    zr_boost_1_81::asio::experimental::detail::co_composed_promise<
      Executors, Handler, Return>;
};
