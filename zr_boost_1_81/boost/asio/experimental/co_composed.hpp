 ...
 *             zr_boost_1_81::asio::enable_terminal_cancellation());
 *
 ...
 *                 zr_boost_1_81::asio::as_tuple(zr_boost_1_81::asio::deferred));
 *
 *             if (e1)
 ...
 *                 make_error_code(zr_boost_1_81::asio::error::operation_aborted));
 *
 *             auto [e2, n2] =
 *               co_await zr_boost_1_81::asio::async_write(socket,
 *                 zr_boost_1_81::asio::buffer(data, n1),
 *                 zr_boost_1_81::asio::as_tuple(zr_boost_1_81::asio::deferred));
 *
 *             if (e2)
 ...
 *                     zr_boost_1_81::asio::buffer(data), zr_boost_1_81::asio::deferred);
 *
 *                 co_await zr_boost_1_81::asio::async_write(socket,
 *                     zr_boost_1_81::asio::buffer(data, n), zr_boost_1_81::asio::deferred);
 *               }
 *             }
