 ...
 * expression <tt>zr_boost_1_81::asio::prefer(E, P0, Pn...)</tt> for some subexpressions
 ...
 *   <tt>zr_boost_1_81::asio::prefer(E, P0, Pn...)</tt> is ill-formed.
 *
 ...
 *
 * @li Otherwise,
 *   <tt>zr_boost_1_81::asio::prefer(zr_boost_1_81::asio::prefer(E, P0), Pn...)</tt>
 *   if <tt>N > 0</tt> and the expression
 *   <tt>zr_boost_1_81::asio::prefer(zr_boost_1_81::asio::prefer(E, P0), Pn...)</tt>
 *   is a valid expression.
 *
 * @li Otherwise, <tt>zr_boost_1_81::asio::prefer(E, P0, Pn...)</tt> is ill-formed.
 */
 ...
 * @c true_type if the expression <tt>zr_boost_1_81::asio::prefer(std::declval<T>(),
 ...
 * type of the expression <tt>zr_boost_1_81::asio::prefer(std::declval<T>(),
...
namespace zr_boost_1_81_asio_prefer_fn {
...
using zr_boost_1_81::asio::traits::prefer_free;
using zr_boost_1_81::asio::traits::prefer_member;
...
static BOOST_ASIO_CONSTEXPR const zr_boost_1_81_asio_prefer_fn::impl&
  prefer = zr_boost_1_81_asio_prefer_fn::static_instance<>::instance;

} // namespace

typedef zr_boost_1_81_asio_prefer_fn::impl prefer_t;
...
struct can_prefer :
  integral_constant<bool,
    zr_boost_1_81_asio_prefer_fn::call_traits<
      prefer_t, T, void(Properties...)>::overload
        != zr_boost_1_81_asio_prefer_fn::ill_formed>
{
};
...
struct prefer_result
{
  typedef typename zr_boost_1_81_asio_prefer_fn::call_traits<
