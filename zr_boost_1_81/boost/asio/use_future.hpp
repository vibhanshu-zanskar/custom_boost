 ...
 * operation, typically using the special value @c zr_boost_1_81::asio::use_future. For
 * example:
 *
 * @code std::future<std::size_t> my_future
 *   = my_socket.async_read_some(my_buffer, zr_boost_1_81::asio::use_future); @endcode
 *
...
public:
   ...
   *     use_future([](zr_boost_1_81::system::error_code ec, std::size_t n)
   *       {
   *         return ec ? 0 : n;
   *       }));
   * ...
...
/// return a future.
/**
 * See the documentation for zr_boost_1_81::asio::use_future_t for a usage example.
 */
