...
template <typename Executor>
class awaitable_handler<Executor, zr_boost_1_81::system::error_code>
  : public awaitable_handler_base<Executor, void>
{
public:
  using awaitable_handler_base<Executor, void>::awaitable_handler_base;
...
template <typename Executor, typename T>
class awaitable_handler<Executor, zr_boost_1_81::system::error_code, T>
  : public awaitable_handler_base<Executor, T>
{
public:
  using awaitable_handler_base<Executor, T>::awaitable_handler_base;
  ...
  template <typename Arg>
  void operator()(const zr_boost_1_81::system::error_code& ec, Arg&& arg)
  {
    this->frame()->attach_thread(this);
    if (ec)
      this->frame()->set_error(ec);
...
template <typename Executor, typename... Ts>
class awaitable_handler<Executor, zr_boost_1_81::system::error_code, Ts...>
  : public awaitable_handler_base<Executor, std::tuple<Ts...>>
{
public:
  using awaitable_handler_base<Executor,
  ...
  template <typename... Args>
  void operator()(const zr_boost_1_81::system::error_code& ec, Args&&... args)
  {
    this->frame()->attach_thread(this);
    if (ec)
      this->frame()->set_error(ec);
