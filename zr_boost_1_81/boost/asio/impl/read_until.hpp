    ...
    >::type)
{
  ...
  zr_boost_1_81::asio::detail::throw_error(ec, "read_until");
    ...
    >::type)
{
  ...
  for (;;)
  {
    ...
    // Look for a match.
    zr_boost_1_81::match_results<iterator,
      typename std::vector<zr_boost_1_81::sub_match<iterator> >::allocator_type>
        match_results;
    if (regex_search(start_pos, end, match_results, expr,
          zr_boost_1_81::match_default | zr_boost_1_81::match_partial))
    {
...
template <typename SyncReadStream, typename DynamicBuffer_v2>
inline std::size_t read_until(SyncReadStream& s,
    DynamicBuffer_v2 buffers, const zr_boost_1_81::regex& expr,
    typename constraint<
      is_dynamic_buffer_v2<DynamicBuffer_v2>::value
    >::type)
{
...
namespace detail
{
  ...
  public:
    ...
    void operator()(zr_boost_1_81::system::error_code ec,
        ...
        DynamicBuffer_v1, ReadHandler>* this_handler)
  {
    ...
    zr_boost_1_81_asio_handler_alloc_helpers::allocate(size, this_handler->handler_);
    return asio_handler_allocate_is_no_longer_used();
#else // defined(BOOST_ASIO_NO_DEPRECATED)
    return zr_boost_1_81_asio_handler_alloc_helpers::allocate(
  ...
  asio_handler_deallocate(void* pointer, std::size_t size,
      read_until_delim_op_v1<AsyncReadStream,
        DynamicBuffer_v1, ReadHandler>* this_handler)
  {
    zr_boost_1_81_asio_handler_alloc_helpers::deallocate(
        ...
        DynamicBuffer_v1, ReadHandler>* this_handler)
  {
    return this_handler->start_ == 0 ? true
      : zr_boost_1_81_asio_handler_cont_helpers::is_continuation(
  ...
  asio_handler_invoke(Function& function,
      read_until_delim_op_v1<AsyncReadStream,
        DynamicBuffer_v1, ReadHandler>* this_handler)
  {
    zr_boost_1_81_asio_handler_invoke_helpers::invoke(
      ...
      read_until_delim_op_v1<AsyncReadStream,
        typename decay<DynamicBuffer_v1>::type,
          typename decay<ReadHandler>::type>(
            ...
            delim, handler2.value)(zr_boost_1_81::system::error_code(), 0, 1);
    }
...
namespace detail
{
  ...
  public:
    ...
    read_until_expr_op_v1(AsyncReadStream& stream,
        BOOST_ASIO_MOVE_ARG(BufferSequence) buffers,
        const zr_boost_1_81::regex& expr, ReadHandler& handler)
      : base_from_cancellation_state<ReadHandler>(
          handler, enable_partial_cancellation()),
        stream_(stream),
        buffers_(BOOST_ASIO_MOVE_CAST(BufferSequence)(buffers)),
      ...
      read_until_expr_op_v1<AsyncReadStream,
        typename decay<DynamicBuffer_v1>::type,
          RegEx, typename decay<ReadHandler>::type>(
            stream_, BOOST_ASIO_MOVE_CAST(DynamicBuffer_v1)(buffers),
            expr, handler2.value)(zr_boost_1_81::system::error_code(), 0, 1);
    }
      ...
      read_until_match_op_v1<AsyncReadStream,
        typename decay<DynamicBuffer_v1>::type,
          MatchCondition, typename decay<ReadHandler>::type>(
            stream_, BOOST_ASIO_MOVE_CAST(DynamicBuffer_v1)(buffers),
            match_condition, handler2.value)(zr_boost_1_81::system::error_code(), 0, 1);
    }
...
BOOST_ASIO_INITFN_AUTO_RESULT_TYPE_PREFIX(ReadToken,
    void (zr_boost_1_81::system::error_code, std::size_t))
async_read_until(AsyncReadStream& s, DynamicBuffer_v2 buffers,
    const zr_boost_1_81::regex& expr, BOOST_ASIO_MOVE_ARG(ReadToken) token,
    typename constraint<
      is_dynamic_buffer_v2<DynamicBuffer_v2>::value
    >::type)
  BOOST_ASIO_INITFN_AUTO_RESULT_TYPE_SUFFIX((
