...
namespace detail
{
      ...
      zr_boost_1_81::system::error_code& ec)
  {
    ...
    zr_boost_1_81::asio::detail::consuming_buffers<const_buffer,
    ...
    CompletionCondition completion_condition, zr_boost_1_81::system::error_code& ec)
{
  return detail::write_at_buffer_sequence(d, offset, buffers,
      zr_boost_1_81::asio::buffer_sequence_begin(buffers),
    ...
    uint64_t offset, const ConstBufferSequence& buffers)
{
  ...
  zr_boost_1_81::asio::detail::throw_error(ec, "write_at");
...
template <typename SyncRandomAccessWriteDevice, typename Allocator,
    typename CompletionCondition>
std::size_t write_at(SyncRandomAccessWriteDevice& d,
    uint64_t offset, zr_boost_1_81::asio::basic_streambuf<Allocator>& b,
    CompletionCondition completion_condition, zr_boost_1_81::system::error_code& ec)
{
...
namespace detail
{
  ...
  //private:
    typedef zr_boost_1_81::asio::detail::consuming_buffers<const_buffer,
    ...
    detail::write_at_op<AsyncRandomAccessWriteDevice, ConstBufferSequence,
      ConstBufferIterator, CompletionCondition, WriteHandler>(
        d, offset, buffers, completion_condition, handler)(
          zr_boost_1_81::system::error_code(), 0, 1);
  }
...
namespace detail
{
  ...
  public:
    write_at_streambuf_op(
        zr_boost_1_81::asio::basic_streambuf<Allocator>& streambuf,
        WriteHandler& handler)
  ...
  //private:
    zr_boost_1_81::asio::basic_streambuf<Allocator>& streambuf_;
    WriteHandler handler_;
  };
