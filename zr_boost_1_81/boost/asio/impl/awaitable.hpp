...
public:
  ...
  void* operator new(std::size_t size)
  {
    return zr_boost_1_81::asio::detail::thread_info_base::allocate(
        zr_boost_1_81::asio::detail::thread_info_base::awaitable_frame_tag(),
  ...
  void set_error(const zr_boost_1_81::system::error_code& ec)
  {
    this->set_except(std::make_exception_ptr(zr_boost_1_81::system::system_error(ec)));
  }
  ...
  auto await_transform(awaitable<T, Executor> a) const
  {
    if (attached_thread_->entry_point()->throw_if_cancelled_)
      if (!!attached_thread_->get_cancellation_state().cancelled())
        throw_error(zr_boost_1_81::asio::error::operation_aborted, "co_await");
    return a;
  }
...
private:
  ...
  zr_boost_1_81::asio::cancellation_slot parent_cancellation_slot_;
  zr_boost_1_81::asio::cancellation_state cancellation_state_;
  bool has_executor_;
...
template <typename R, typename Executor>
class awaitable_async_op_handler<R(zr_boost_1_81::system::error_code), Executor>
  : public awaitable_thread<Executor>
{
public:
...
template <typename R, typename T, typename Executor>
class awaitable_async_op_handler<R(zr_boost_1_81::system::error_code, T), Executor>
  : public awaitable_thread<Executor>
{
public:
  struct result_type
...
template <typename R, typename... Ts, typename Executor>
class awaitable_async_op_handler<R(zr_boost_1_81::system::error_code, Ts...), Executor>
  : public awaitable_thread<Executor>
{
public:
  struct result_type
  ...
  template <typename... Args>
  void operator()(zr_boost_1_81::system::error_code ec, Args&&... args)
  {
    result_.ec_ = &ec;
...
struct coroutine_traits<zr_boost_1_81::asio::awaitable<T, Executor>, Args...>
{
  typedef zr_boost_1_81::asio::detail::awaitable_frame<T, Executor> promise_type;
};
