...
public:
  ...
  typedef zr_boost_1_81::coroutines::pull_coroutine<void> callee_type;
  typedef zr_boost_1_81::coroutines::push_coroutine<void> caller_type;
#else
  typedef zr_boost_1_81::coroutines::coroutine<void()> callee_type;
  typedef zr_boost_1_81::coroutines::coroutine<void()> caller_type;
#endif
  ...
  static spawned_thread_base* spawn(BOOST_ASIO_MOVE_ARG(F) f,
      const zr_boost_1_81::coroutines::attributes& attributes,
  ...
  static spawned_thread_base* spawn(BOOST_ASIO_MOVE_ARG(F) f,
      ...
      cancellation_state cancel_state = cancellation_state())
  {
    return spawn(BOOST_ASIO_MOVE_CAST(F)(f), zr_boost_1_81::coroutines::attributes(),
  ...
  void suspend_with(void (*fn)(void*), void* arg)
  {
    if (throw_if_cancelled_)
      if (!!cancellation_state_.cancelled())
        throw_error(zr_boost_1_81::asio::error::operation_aborted, "yield");
...
#if !defined(BOOST_ASIO_NO_EXCEPTIONS)
      catch (const zr_boost_1_81::coroutines::detail::forced_unwind&)
      {
        throw;
      }
      catch (...)
...
{
public:
  typedef zr_boost_1_81::context::fiber fiber_type;
  ...
  static spawned_thread_base* spawn(BOOST_ASIO_MOVE_ARG(F) f,
      ...
      cancellation_state cancel_state = cancellation_state())
  {
    return spawn(allocator_arg_t(), zr_boost_1_81::context::fixedsize_stack(),
...
#if !defined(BOOST_ASIO_NO_EXCEPTIONS)
      catch (const zr_boost_1_81::context::detail::forced_unwind&)
      {
        throw;
      }
      catch (...)
...
template <typename Executor, typename R>
class spawn_handler<Executor, R(zr_boost_1_81::system::error_code)>
  : public spawn_handler_base<Executor>
{
public:
  typedef void return_type;
  typedef zr_boost_1_81::system::error_code* result_type;
...
template <typename Executor, typename R, typename T>
class spawn_handler<Executor, R(zr_boost_1_81::system::error_code, T)>
  : public spawn_handler_base<Executor>
{
public:
  typedef T return_type;
  ...
  struct result_type
  {
    zr_boost_1_81::system::error_code* ec_;
    return_type* value_;
  };
  ...
  void operator()(zr_boost_1_81::system::error_code ec, T value)
  {
    if (this->yield_.ec_)
    {
      *this->yield_.ec_ = ec;
...
template <typename Executor, typename R, typename... Ts>
class spawn_handler<Executor, R(zr_boost_1_81::system::error_code, Ts...)>
  : public spawn_handler_base<Executor>
{
public:
  typedef std::tuple<Ts...> return_type;
...
spawn(const Executor& ex, BOOST_ASIO_MOVE_ARG(F) function,
    ...
    typename constraint<
      !is_same<
        ...
        zr_boost_1_81::coroutines::attributes
      >::value
    >::type,
#endif // defined(BOOST_ASIO_HAS_BOOST_COROUTINE)
    typename constraint<
    ...
    const zr_boost_1_81::coroutines::attributes& attributes)
{
  ...
  zr_boost_1_81::asio::spawn(ex, BOOST_ASIO_MOVE_CAST(Function)(function), attributes);
}
...
inline void spawn(const Executor& ex,
    ...
    >::type)
{
  zr_boost_1_81::asio::spawn(zr_boost_1_81::asio::strand<Executor>(ex),
...
inline void spawn(const strand<Executor>& ex,
    ...
    const zr_boost_1_81::coroutines::attributes& attributes)
{
  zr_boost_1_81::asio::spawn(zr_boost_1_81::asio::bind_executor(
...
template <typename Function>
inline void spawn(const zr_boost_1_81::asio::io_context::strand& s,
    BOOST_ASIO_MOVE_ARG(Function) function,
    const zr_boost_1_81::coroutines::attributes& attributes)
{
  zr_boost_1_81::asio::spawn(zr_boost_1_81::asio::bind_executor(
...
{
  zr_boost_1_81::asio::spawn(ctx.get_executor(),
      BOOST_ASIO_MOVE_CAST(Function)(function), attributes);
}
