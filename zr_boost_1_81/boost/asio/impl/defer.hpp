...
public:
      ...
      >::type* = 0) const
  {
    ...
    zr_boost_1_81::asio::prefer(
        zr_boost_1_81::asio::require(ex, execution::blocking.never),
      ...
      >::type* = 0) const
  {
    ...
    ex.defer(zr_boost_1_81::asio::detail::bind_handler(
...
public:
...
#if defined(BOOST_ASIO_NO_DEPRECATED)
    zr_boost_1_81::asio::prefer(
        zr_boost_1_81::asio::require(ex_, execution::blocking.never),
        execution::relationship.continuation,
        execution::allocator(alloc)
      ).execute(
        zr_boost_1_81::asio::detail::bind_handler(
      ...
      >::type* = 0) const
  {
    ...
    ex_.defer(zr_boost_1_81::asio::detail::bind_handler(
          BOOST_ASIO_MOVE_CAST(CompletionHandler)(handler)), alloc);
  }
