    ...
    basic_writable_pipe<Executor2>& write_end)
{
  ...
  zr_boost_1_81::asio::connect_pipe(read_end, write_end, ec);
  zr_boost_1_81::asio::detail::throw_error(ec, "connect_pipe");
}

template <typename Executor1, typename Executor2>
BOOST_ASIO_SYNC_OP_VOID connect_pipe(basic_readable_pipe<Executor1>& read_end,
    basic_writable_pipe<Executor2>& write_end, zr_boost_1_81::system::error_code& ec)
{
