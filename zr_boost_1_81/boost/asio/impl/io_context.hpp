...
struct io_context::initiate_post
{
      ...
      io_context* self) const
  {
    ...
    bool is_continuation =
      zr_boost_1_81_asio_handler_cont_helpers::is_continuation(handler2.value);
    ...
    BOOST_ASIO_MOVE_ARG(Function) f) const
{
  ...
  && !defined(BOOST_ASIO_NO_EXCEPTIONS)
    try
    {
       ...
       //   && !defined(BOOST_ASIO_NO_EXCEPTIONS)
      detail::fenced_block b(detail::fenced_block::full);
      zr_boost_1_81_asio_handler_invoke_helpers::invoke(tmp, tmp);
      return;
#if defined(BOOST_ASIO_HAS_STD_EXCEPTION_PTR) \
  && !defined(BOOST_ASIO_NO_EXCEPTIONS)
    }
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
inline io_context::work::work(zr_boost_1_81::asio::io_context& io_context)
...
inline zr_boost_1_81::asio::io_context& io_context::work::get_io_context()
{
  return static_cast<zr_boost_1_81::asio::io_context&>(io_context_impl_.context());
}
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)

inline zr_boost_1_81::asio::io_context& io_context::service::get_io_context()
{
  return static_cast<zr_boost_1_81::asio::io_context&>(context());
}
