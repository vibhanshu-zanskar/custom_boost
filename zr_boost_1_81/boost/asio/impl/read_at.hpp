...
namespace detail
{
      ...
      zr_boost_1_81::system::error_code& ec)
  {
    ...
    zr_boost_1_81::asio::detail::consuming_buffers<mutable_buffer,
    ...
    uint64_t offset, const MutableBufferSequence& buffers)
{
  ...
  zr_boost_1_81::asio::detail::throw_error(ec, "read_at");
...
namespace detail
{
  ...
  //private:
    typedef zr_boost_1_81::asio::detail::consuming_buffers<mutable_buffer,
