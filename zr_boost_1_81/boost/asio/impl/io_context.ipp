...
{
  zr_boost_1_81::asio::detail::scoped_ptr<impl_type> scoped_impl(impl);
  zr_boost_1_81::asio::add_service<impl_type>(*this, scoped_impl.get());
...
io_context::count_type io_context::run(zr_boost_1_81::system::error_code& ec)
{
  return impl_.run(ec);
}
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
io_context::count_type io_context::run_one(zr_boost_1_81::system::error_code& ec)
{
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
io_context::count_type io_context::poll(zr_boost_1_81::system::error_code& ec)
{
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
io_context::count_type io_context::poll_one(zr_boost_1_81::system::error_code& ec)
{
...
io_context::service::service(zr_boost_1_81::asio::io_context& owner)
