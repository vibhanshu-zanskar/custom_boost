...
public:
      ...
      >::type* = 0) const
  {
    ...
    zr_boost_1_81::asio::prefer(ex, execution::allocator(alloc)).execute(
        zr_boost_1_81::asio::detail::bind_handler(
          BOOST_ASIO_MOVE_CAST(CompletionHandler)(handler)));
#else // defined(BOOST_ASIO_NO_DEPRECATED)
    execution::execute(
        zr_boost_1_81::asio::prefer(ex, execution::allocator(alloc)),
        zr_boost_1_81::asio::detail::bind_handler(
          BOOST_ASIO_MOVE_CAST(CompletionHandler)(handler)));
      ...
      >::type* = 0) const
  {
    ...
    ex.dispatch(zr_boost_1_81::asio::detail::bind_handler(
...
public:
...
#if defined(BOOST_ASIO_NO_DEPRECATED)
    zr_boost_1_81::asio::prefer(ex_, execution::allocator(alloc)).execute(
        zr_boost_1_81::asio::detail::bind_handler(
          BOOST_ASIO_MOVE_CAST(CompletionHandler)(handler)));
#else // defined(BOOST_ASIO_NO_DEPRECATED)
    execution::execute(
        zr_boost_1_81::asio::prefer(ex_, execution::allocator(alloc)),
        zr_boost_1_81::asio::detail::bind_handler(
          BOOST_ASIO_MOVE_CAST(CompletionHandler)(handler)));
#endif // defined(BOOST_ASIO_NO_DEPRECATED)
  }
      ...
      >::type* = 0) const
  {
    ...
    ex_.dispatch(zr_boost_1_81::asio::detail::bind_handler(
          BOOST_ASIO_MOVE_CAST(CompletionHandler)(handler)), alloc);
  }
