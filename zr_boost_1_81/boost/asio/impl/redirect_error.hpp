...
public:
  ...
  redirect_error_handler(zr_boost_1_81::system::error_code& ec,
  ...
  typename enable_if<
    !is_same<typename decay<Arg>::type, zr_boost_1_81::system::error_code>::value
  >::type
  ...
  void operator()(const zr_boost_1_81::system::error_code& ec,
...
struct redirect_error_signature<R(zr_boost_1_81::system::error_code, Args...)>
{
  typedef R type(Args...);
};

template <typename R, typename... Args>
struct redirect_error_signature<R(const zr_boost_1_81::system::error_code&, Args...)>
{
  typedef R type(Args...);
};
...
template <typename R, typename... Args>
struct redirect_error_signature<
  R(zr_boost_1_81::system::error_code, Args...) noexcept>
{
...
template <typename R, typename... Args>
struct redirect_error_signature<
  R(const zr_boost_1_81::system::error_code&, Args...) noexcept>
{
  typedef R type(Args...) & noexcept;
};
...
template <typename R>
struct redirect_error_signature<R(zr_boost_1_81::system::error_code)>
{
  typedef R type();
};

template <typename R>
struct redirect_error_signature<R(const zr_boost_1_81::system::error_code&)>
{
  typedef R type();
};
...
#define BOOST_ASIO_PRIVATE_REDIRECT_ERROR_DEF(n) \
  ...
  struct redirect_error_signature< \
      R(zr_boost_1_81::system::error_code, BOOST_ASIO_VARIADIC_TARGS(n))> \
  { \
  ...
  template <typename R, BOOST_ASIO_VARIADIC_TPARAMS(n)> \
  struct redirect_error_signature< \
      R(const zr_boost_1_81::system::error_code&, BOOST_ASIO_VARIADIC_TARGS(n))> \
  { \
    typedef R type(BOOST_ASIO_VARIADIC_TARGS(n)); \
  }; \
  /**/
...
template <typename R>
struct redirect_error_signature<
  R(zr_boost_1_81::system::error_code) noexcept>
{
...
template <typename R>
struct redirect_error_signature<
  R(const zr_boost_1_81::system::error_code&) noexcept>
{
  typedef R type() noexcept;
};
...
#define BOOST_ASIO_PRIVATE_REDIRECT_ERROR_DEF(n) \
  template <typename R, BOOST_ASIO_VARIADIC_TPARAMS(n)> \
  struct redirect_error_signature< \
      R(zr_boost_1_81::system::error_code, BOOST_ASIO_VARIADIC_TARGS(n)) noexcept> \
  { \
  ...
  template <typename R, BOOST_ASIO_VARIADIC_TPARAMS(n)> \
  struct redirect_error_signature< \
      R(const zr_boost_1_81::system::error_code&, \
  ...
  template <typename R, BOOST_ASIO_VARIADIC_TPARAMS(n)> \
  struct redirect_error_signature< \
      R(zr_boost_1_81::system::error_code, \
        BOOST_ASIO_VARIADIC_TARGS(n)) & noexcept> \
  { \
    typedef R type(BOOST_ASIO_VARIADIC_TARGS(n)) & noexcept; \
  }; \
...
struct async_result<redirect_error_t<CompletionToken>, Signature>
{
  ...
  struct init_wrapper
  {
    ...
    init_wrapper(zr_boost_1_81::system::error_code& ec, BOOST_ASIO_MOVE_ARG(Init) init)
      : ec_(ec),
