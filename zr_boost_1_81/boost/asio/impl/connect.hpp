...
namespace detail
{
  struct default_connect_condition
  {
    ...
    bool operator()(const zr_boost_1_81::system::error_code&, const Endpoint&)
    {
      return true;
    }
  };
  ...
  inline typename Protocol::endpoint deref_connect_result(
      Iterator iter, zr_boost_1_81::system::error_code& ec)
  {
    ...
    static const bool value =
      sizeof(asio_connect_condition_check(
        (declval<legacy_connect_condition_helper<T, Iterator> >())(
          declval<const zr_boost_1_81::system::error_code>(),
  ...
  inline Iterator call_connect_condition(ConnectCondition& connect_condition,
      const zr_boost_1_81::system::error_code& ec, Iterator next, Iterator end,
    ...
    zr_boost_1_81::system::error_code& ec)
{
  ...
  if (!ec)
    ec = zr_boost_1_81::asio::error::not_found;
...
namespace detail
{
  ...
  protected:
    ...
    void check_condition(const zr_boost_1_81::system::error_code& ec,
  ...
  protected:
    ...
    template <typename Iterator>
    void check_condition(const zr_boost_1_81::system::error_code&, Iterator&, Iterator&)
    {
    }
  };
  ...
  public:
    ...
    void operator()(zr_boost_1_81::system::error_code ec, int start = 0)
    {
  ...
  //private:
    template <typename Iterator>
    void process(zr_boost_1_81::system::error_code ec,
      ...
      switch (start_ = start)
      {
        ...
        for (;;)
        {
          ...
          if (start)
          {
            ec = zr_boost_1_81::asio::error::not_found;
            BOOST_ASIO_HANDLER_LOCATION((__FILE__, __LINE__, "async_connect"));
            zr_boost_1_81::asio::post(socket_.get_executor(),
                detail::bind_handler(
        ...
        BOOST_ASIO_MOVE_OR_LVALUE(RangeConnectHandler)(handler_)(
            static_cast<const zr_boost_1_81::system::error_code&>(ec),
  ...
  inline bool asio_handler_is_continuation(
      range_connect_op<Protocol, Executor, EndpointSequence,
        ConnectCondition, RangeConnectHandler>* this_handler)
  {
    return zr_boost_1_81_asio_handler_cont_helpers::is_continuation(
        ...
        const ConnectCondition& connect_condition) const
    {
      ...
      range_connect_op<Protocol, Executor, EndpointSequence, ConnectCondition,
        typename decay<RangeConnectHandler>::type>(socket_, endpoints,
          connect_condition, handler2.value)(zr_boost_1_81::system::error_code(), 1);
    }
