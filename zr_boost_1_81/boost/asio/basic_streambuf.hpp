 ...
 * zr_boost_1_81::asio::streambuf::mutable_buffers_type bufs = b.prepare(512);
 *
...
public:
  ...
  {
    return zr_boost_1_81::asio::buffer(zr_boost_1_81::asio::const_buffer(gptr(),
  ...
  {
    reserve(n);
    return zr_boost_1_81::asio::buffer(zr_boost_1_81::asio::mutable_buffer(
...
protected:
  ...
  void reserve(std::size_t n)
  {
    ...
    if (n > pend - pnext)
    {
      ...
      {
        std::length_error ex("zr_boost_1_81::asio::streambuf too long");
