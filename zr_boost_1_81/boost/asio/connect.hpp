...
/**
 * @defgroup connect zr_boost_1_81::asio::connect
 *
 ...
 *
 * @throws zr_boost_1_81::system::system_error Thrown on failure. If the sequence is
 * empty, the associated @c error_code is zr_boost_1_81::asio::error::not_found.
 ...
 * zr_boost_1_81::asio::connect(s, r.resolve(q)); @endcode
 */
 ...
 * empty, set to zr_boost_1_81::asio::error::not_found. Otherwise, contains the error
 ...
 * zr_boost_1_81::asio::connect(s, r.resolve(q), ec);
 * if (ec)
 * {
 *   // An error occurred.
 * } @endcode
...
template <typename Protocol, typename Executor, typename EndpointSequence>
typename Protocol::endpoint connect(basic_socket<Protocol, Executor>& s,
    const EndpointSequence& endpoints, zr_boost_1_81::system::error_code& ec,
    typename constraint<is_endpoint_sequence<
        EndpointSequence>::value>::type = 0);
 ...
 * iterator types such as @c zr_boost_1_81::asio::ip::tcp::resolver::iterator.
 */
...
Iterator connect(basic_socket<Protocol, Executor>& s,
    Iterator begin, zr_boost_1_81::system::error_code& ec,
    typename constraint<!is_endpoint_sequence<Iterator>::value>::type = 0);
 ...
 * tcp::socket s(my_context);
 * zr_boost_1_81::asio::connect(s, e.begin(), e.end()); @endcode
 */
template <typename Protocol, typename Executor, typename Iterator>
Iterator connect(basic_socket<Protocol, Executor>& s,
 ...
 * tcp::socket s(my_context);
 * zr_boost_1_81::system::error_code ec;
 * zr_boost_1_81::asio::connect(s, e.begin(), e.end(), ec);
 * if (ec)
 * {
 *   // An error occurred.
 * } @endcode
...
template <typename Protocol, typename Executor, typename Iterator>
Iterator connect(basic_socket<Protocol, Executor>& s,
    Iterator begin, Iterator end, zr_boost_1_81::system::error_code& ec);
 ...
 *   }
 * }; @endcode
 * It would be used with the zr_boost_1_81::asio::connect function as follows:
 * @code tcp::resolver r(my_context);
 * tcp::resolver::query q("host", "service");
 * tcp::socket s(my_context);
 * tcp::endpoint e = zr_boost_1_81::asio::connect(s,
...
template <typename Protocol, typename Executor,
    typename Iterator, typename ConnectCondition>
Iterator connect(basic_socket<Protocol, Executor>& s, Iterator begin,
    ConnectCondition connect_condition, zr_boost_1_81::system::error_code& ec,
    typename constraint<!is_endpoint_sequence<Iterator>::value>::type = 0);
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)
 ...
 * tcp::resolver::results_type e = r.resolve(q);
 * tcp::socket s(my_context);
 * tcp::resolver::results_type::iterator i = zr_boost_1_81::asio::connect(
...
/**
 * @defgroup async_connect zr_boost_1_81::asio::async_connect
 *
 ...
 *   // zr_boost_1_81::asio::error::not_found. Otherwise, contains the
 ...
 * @code void(zr_boost_1_81::system::error_code, typename Protocol::endpoint) @endcode
 *
 * @par Example
 * @code tcp::resolver r(my_context);
 * tcp::resolver::query q("host", "service");
 ...
 *   if (!ec)
 *   {
 *     zr_boost_1_81::asio::async_connect(s, results, connect_handler);
 *   }
 * }
 *
 * // ...
...
BOOST_ASIO_INITFN_AUTO_RESULT_TYPE_PREFIX(RangeConnectToken,
    void (zr_boost_1_81::system::error_code, typename Protocol::endpoint))
 ...
 *
 * @par Completion Signature
 * @code void(zr_boost_1_81::system::error_code, Iterator) @endcode
 *
 * @note This overload assumes that a default constructed object of type @c
 * Iterator represents the end of the sequence. This is a valid assumption for
 * iterator types such as @c zr_boost_1_81::asio::ip::tcp::resolver::iterator.
...
BOOST_ASIO_INITFN_AUTO_RESULT_TYPE_PREFIX(IteratorConnectToken,
    void (zr_boost_1_81::system::error_code, Iterator))
 ...
 * tcp::socket s(my_context);
 * zr_boost_1_81::asio::async_connect(s,
 ...
 *   if (!ec)
 *   {
 *     zr_boost_1_81::asio::async_connect(s, results,
 ...
 *     zr_boost_1_81::asio::async_connect(s, i, end,
 *         my_connect_condition(),
 *         connect_handler);
 *   }
 * }
