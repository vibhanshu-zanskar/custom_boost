...
public:
   ...
   * zr_boost_1_81::asio::error::operation_aborted error.
   *
   ...
   * passed the zr_boost_1_81::asio::error::operation_aborted error.
   *
   * @throws zr_boost_1_81::system::system_error Thrown on failure.
   */
  void cancel()
   ...
   * zr_boost_1_81::asio::posix::descriptor_base::bytes_readable @n
   * zr_boost_1_81::asio::posix::descriptor_base::non_blocking_io
   *
   * @par Example
   * Getting the number of bytes ready to read:
   * @code
   * zr_boost_1_81::asio::posix::stream_descriptor descriptor(my_context);
   * ...
   * zr_boost_1_81::asio::posix::stream_descriptor::bytes_readable command;
   ...
   * zr_boost_1_81::asio::posix::stream_descriptor descriptor(my_context);
   * ...
   * descriptor.wait(zr_boost_1_81::asio::posix::stream_descriptor::wait_read);
   * @endcode
   */
   ...
   * ...
   * zr_boost_1_81::system::error_code ec;
   * descriptor.wait(zr_boost_1_81::asio::posix::stream_descriptor::wait_read, ec);
   * @endcode
   */
   ...
   *     zr_boost_1_81::asio::posix::stream_descriptor::wait_read,
   *     wait_handler);
   * @endcode
   *
   * @par Per-Operation Cancellation
   * This asynchronous operation supports cancellation for the following
   * zr_boost_1_81::asio::cancellation_type values:
   *
