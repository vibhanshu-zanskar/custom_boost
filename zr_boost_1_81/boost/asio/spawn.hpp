...
public:
   ...
   * zr_boost_1_81::asio::cancellation_state object <tt>S</tt>, constructed as
   ...
   * Let <tt>P</tt> be the cancellation slot associated with the current
   * coroutine's @ref spawn completion handler. Assigns a new
   * zr_boost_1_81::asio::cancellation_state object <tt>S</tt>, constructed as <tt>S(P,
   ...
   * } @endcode
   */
  basic_yield_context operator[](zr_boost_1_81::system::error_code& ec) const
  {
...
/**
 * @defgroup spawn zr_boost_1_81::asio::spawn
 *
 ...
 *
 * @code zr_boost_1_81::asio::spawn(my_strand, do_echo, zr_boost_1_81::asio::detached);
 *
 * // ...
 *
 * void do_echo(zr_boost_1_81::asio::yield_context yield)
 * {
 *   try
 *   {
 *     char data[128];
 ...
 *           zr_boost_1_81::asio::buffer(data), yield);
 *
 *       zr_boost_1_81::asio::async_write(my_socket,
 *           zr_boost_1_81::asio::buffer(data, length), yield);
 *     }
 *   }
 ...
 */
template <typename Function>
void spawn(const zr_boost_1_81::asio::io_context::strand& s,
    BOOST_ASIO_MOVE_ARG(Function) function,
    const zr_boost_1_81::coroutines::attributes& attributes
      = zr_boost_1_81::coroutines::attributes());
