...
public:
   ...
   * Setting the option:
   * @code
   * zr_boost_1_81::asio::ip::udp::socket socket(my_context);
   * ...
   * zr_boost_1_81::asio::socket_base::broadcast option(true);
   ...
   * zr_boost_1_81::asio::ip::udp::socket socket(my_context);
   * ...
   * zr_boost_1_81::asio::socket_base::broadcast option;
...
#else
  typedef zr_boost_1_81::asio::detail::socket_option::boolean<
   ...
   * ...
   * zr_boost_1_81::asio::socket_base::debug option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * zr_boost_1_81::asio::ip::tcp::socket socket(my_context);
   * ...
   * zr_boost_1_81::asio::socket_base::debug option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * zr_boost_1_81::asio::ip::udp::socket socket(my_context);
   * ...
   * zr_boost_1_81::asio::socket_base::do_not_route option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * zr_boost_1_81::asio::ip::udp::socket socket(my_context);
   * ...
   * zr_boost_1_81::asio::socket_base::do_not_route option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * zr_boost_1_81::asio::ip::tcp::socket socket(my_context);
   * ...
   * zr_boost_1_81::asio::socket_base::keep_alive option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * zr_boost_1_81::asio::ip::tcp::socket socket(my_context);
   * ...
   * zr_boost_1_81::asio::socket_base::keep_alive option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * zr_boost_1_81::asio::ip::tcp::socket socket(my_context);
   * ...
   * zr_boost_1_81::asio::socket_base::send_buffer_size option(8192);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * zr_boost_1_81::asio::ip::tcp::socket socket(my_context);
   * ...
   * zr_boost_1_81::asio::socket_base::send_buffer_size option;
   * socket.get_option(option);
...
#else
  typedef zr_boost_1_81::asio::detail::socket_option::integer<
   ...
   * zr_boost_1_81::asio::ip::tcp::socket socket(my_context);
   * ...
   * zr_boost_1_81::asio::socket_base::send_low_watermark option(1024);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * zr_boost_1_81::asio::ip::tcp::socket socket(my_context);
   * ...
   * zr_boost_1_81::asio::socket_base::send_low_watermark option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * zr_boost_1_81::asio::ip::tcp::socket socket(my_context);
   * ...
   * zr_boost_1_81::asio::socket_base::receive_buffer_size option(8192);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * zr_boost_1_81::asio::ip::tcp::socket socket(my_context);
   * ...
   * zr_boost_1_81::asio::socket_base::receive_buffer_size option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * zr_boost_1_81::asio::ip::tcp::socket socket(my_context);
   * ...
   * zr_boost_1_81::asio::socket_base::receive_low_watermark option(1024);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * zr_boost_1_81::asio::ip::tcp::socket socket(my_context);
   * ...
   * zr_boost_1_81::asio::socket_base::receive_low_watermark option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * ...
   * zr_boost_1_81::asio::socket_base::reuse_address option(true);
   ...
   * zr_boost_1_81::asio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * zr_boost_1_81::asio::socket_base::reuse_address option;
   ...
   * zr_boost_1_81::asio::ip::tcp::socket socket(my_context);
   * ...
   * zr_boost_1_81::asio::socket_base::linger option(true, 30);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * zr_boost_1_81::asio::ip::tcp::socket socket(my_context);
   * ...
   * zr_boost_1_81::asio::socket_base::linger option;
   * socket.get_option(option);
...
#else
  typedef zr_boost_1_81::asio::detail::socket_option::linger<
   ...
   * zr_boost_1_81::asio::ip::tcp::socket socket(my_context);
   * ...
   * zr_boost_1_81::asio::socket_base::out_of_band_inline option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * zr_boost_1_81::asio::ip::tcp::socket socket(my_context);
   * ...
   * zr_boost_1_81::asio::socket_base::out_of_band_inline option;
   * socket.get_option(option);
   ...
   * operation is permitted to fail with zr_boost_1_81::asio::error::connection_aborted.
   ...
   * zr_boost_1_81::asio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * zr_boost_1_81::asio::socket_base::enable_connection_aborted option(true);
   * acceptor.set_option(option);
   * @endcode
   *
   * @par
   ...
   * zr_boost_1_81::asio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * zr_boost_1_81::asio::socket_base::enable_connection_aborted option;
   * acceptor.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
...
#else
  typedef zr_boost_1_81::asio::detail::socket_option::boolean<
    zr_boost_1_81::asio::detail::custom_socket_option_level,
    zr_boost_1_81::asio::detail::enable_connection_aborted_option>
   ...
   * zr_boost_1_81::asio::ip::tcp::socket socket(my_context);
   * ...
   * zr_boost_1_81::asio::socket_base::bytes_readable command(true);
...
#else
  typedef zr_boost_1_81::asio::detail::io_control::bytes_readable bytes_readable;
#endif
