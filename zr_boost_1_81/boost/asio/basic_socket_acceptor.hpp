 ...
 * @code
 * zr_boost_1_81::asio::ip::tcp::acceptor acceptor(my_context);
 * zr_boost_1_81::asio::ip::tcp::endpoint endpoint(zr_boost_1_81::asio::ip::tcp::v4(), port);
 * acceptor.open(endpoint.protocol());
 * acceptor.set_option(zr_boost_1_81::asio::ip::tcp::acceptor::reuse_address(true));
...
public:
    ...
    : impl_(0, ex)
  {
    ...
    zr_boost_1_81::asio::detail::throw_error(ec, "listen");
  }
   ...
   * @code
   * zr_boost_1_81::asio::ip::tcp::acceptor acceptor(my_context);
   * acceptor.open(zr_boost_1_81::asio::ip::tcp::v4());
   * @endcode
   */
   ...
   * zr_boost_1_81::asio::ip::tcp::acceptor acceptor(my_context);
   * zr_boost_1_81::system::error_code ec;
   * acceptor.open(zr_boost_1_81::asio::ip::tcp::v4(), ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
  ...
  BOOST_ASIO_SYNC_OP_VOID assign(const protocol_type& protocol,
      const native_handle_type& native_acceptor, zr_boost_1_81::system::error_code& ec)
  {
    impl_.get_service().assign(impl_.get_implementation(),
        protocol, native_acceptor, ec);
    BOOST_ASIO_SYNC_OP_VOID_RETURN(ec);
   ...
   * @code
   * zr_boost_1_81::asio::ip::tcp::acceptor acceptor(my_context);
   * zr_boost_1_81::asio::ip::tcp::endpoint endpoint(zr_boost_1_81::asio::ip::tcp::v4(), 12345);
   * acceptor.open(endpoint.protocol());
   * acceptor.bind(endpoint);
   * @endcode
   */
   ...
   * ...
   * zr_boost_1_81::system::error_code ec;
   * acceptor.listen(zr_boost_1_81::asio::socket_base::max_listen_connections, ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   * @endcode
   */
  BOOST_ASIO_SYNC_OP_VOID listen(int backlog, zr_boost_1_81::system::error_code& ec)
  {
    impl_.get_service().listen(impl_.get_implementation(), backlog, ec);
    BOOST_ASIO_SYNC_OP_VOID_RETURN(ec);
  }
   ...
   * passed the zr_boost_1_81::asio::error::operation_aborted error. Ownership of the
   ...
   * zr_boost_1_81::asio::socket_base::reuse_address
   * zr_boost_1_81::asio::socket_base::enable_connection_aborted
   *
   * @par Example
   ...
   * zr_boost_1_81::asio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * zr_boost_1_81::asio::ip::tcp::acceptor::reuse_address option(true);
   ...
   * zr_boost_1_81::asio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * zr_boost_1_81::asio::ip::tcp::acceptor::reuse_address option;
   ...
   * zr_boost_1_81::asio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * zr_boost_1_81::asio::ip::tcp::acceptor::non_blocking_io command(true);
   ...
   * with zr_boost_1_81::asio::error::would_block if they are unable to perform the
   ...
   * zr_boost_1_81::asio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * zr_boost_1_81::asio::ip::tcp::endpoint endpoint = acceptor.local_endpoint();
   * @endcode
   */
   ...
   * ...
   * zr_boost_1_81::system::error_code ec;
   * zr_boost_1_81::asio::ip::tcp::endpoint endpoint = acceptor.local_endpoint(ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   * zr_boost_1_81::asio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * acceptor.wait(zr_boost_1_81::asio::ip::tcp::acceptor::wait_read);
   * @endcode
   */
   ...
   * ...
   * zr_boost_1_81::system::error_code ec;
   * acceptor.wait(zr_boost_1_81::asio::ip::tcp::acceptor::wait_read, ec);
   * @endcode
   */
   ...
   * ...
   * acceptor.async_wait(
   *     zr_boost_1_81::asio::ip::tcp::acceptor::wait_read,
   *     wait_handler);
   * @endcode
   *
      ...
      >::type = 0)
  {
    ...
    zr_boost_1_81::asio::detail::throw_error(ec, "accept");
  }
  ...
  BOOST_ASIO_SYNC_OP_VOID accept(
      basic_socket<Protocol1, Executor1>& peer, zr_boost_1_81::system::error_code& ec,
      typename constraint<
        is_convertible<Protocol, Protocol1>::value
      >::type = 0)
  {
   ...
   * @par Example
   * @code
   * void accept_handler(const zr_boost_1_81::system::error_code& error)
   * {
   *   if (!error)
   *   {
   *     // Accept succeeded.
  ...
  async_accept(basic_socket<Protocol1, Executor1>& peer,
      ...
      >::type = 0)
    BOOST_ASIO_INITFN_AUTO_RESULT_TYPE_SUFFIX((
      async_initiate<AcceptToken, void (zr_boost_1_81::system::error_code)>(
          declval<initiate_async_accept>(), token,
          &peer, static_cast<endpoint_type*>(0))))
  {
    return async_initiate<AcceptToken, void (zr_boost_1_81::system::error_code)>(
  ...
  BOOST_ASIO_SYNC_OP_VOID accept(basic_socket<protocol_type, Executor1>& peer,
      endpoint_type& peer_endpoint, zr_boost_1_81::system::error_code& ec)
  {
   ...
   * zr_boost_1_81::asio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * zr_boost_1_81::asio::ip::tcp::socket socket(acceptor.accept());
   * @endcode
   */
   ...
   * zr_boost_1_81::asio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * zr_boost_1_81::asio::ip::tcp::socket socket(acceptor.accept(ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   */
  typename Protocol::socket::template rebind_executor<executor_type>::other
  accept(zr_boost_1_81::system::error_code& ec)
  {
    typename Protocol::socket::template rebind_executor<
      executor_type>::other peer(impl_.get_executor());
    impl_.get_service().accept(impl_.get_implementation(), peer, 0, ec);
   ...
   *
   * @par Completion Signature
   * @code void(zr_boost_1_81::system::error_code,
   *    typename Protocol::socket::template
   ...
   * @code
   * void accept_handler(const zr_boost_1_81::system::error_code& error,
   *     zr_boost_1_81::asio::ip::tcp::socket peer)
   * {
   *   if (!error)
   *   {
   *     // Accept succeeded.
  ...
  async_accept(
    ...
    BOOST_ASIO_INITFN_AUTO_RESULT_TYPE_SUFFIX((
      async_initiate<MoveAcceptToken,
        void (zr_boost_1_81::system::error_code, typename Protocol::socket::template
          rebind_executor<executor_type>::other)>(
   ...
   * zr_boost_1_81::asio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * zr_boost_1_81::asio::ip::tcp::socket socket(acceptor.accept(my_context2, ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
  ...
  template <typename Executor1>
  typename Protocol::socket::template rebind_executor<Executor1>::other
  accept(const Executor1& ex, zr_boost_1_81::system::error_code& ec,
      typename constraint<
        is_executor<Executor1>::value
          || execution::is_executor<Executor1>::value
      >::type = 0)
  ...
  typename Protocol::socket::template rebind_executor<
      typename ExecutionContext::executor_type>::other
  accept(ExecutionContext& context, zr_boost_1_81::system::error_code& ec,
      typename constraint<
        is_convertible<ExecutionContext&, execution_context&>::value
      >::type = 0)
  {
   ...
   * ...
   * zr_boost_1_81::asio::ip::tcp::endpoint endpoint;
   * zr_boost_1_81::asio::ip::tcp::socket socket(acceptor.accept(endpoint));
   * @endcode
   */
  typename Protocol::socket::template rebind_executor<executor_type>::other
   ...
   * ...
   * zr_boost_1_81::asio::ip::tcp::endpoint endpoint;
   * zr_boost_1_81::asio::ip::tcp::socket socket(acceptor.accept(endpoint, ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   */
  typename Protocol::socket::template rebind_executor<executor_type>::other
  accept(endpoint_type& peer_endpoint, zr_boost_1_81::system::error_code& ec)
  {
    typename Protocol::socket::template rebind_executor<
      executor_type>::other peer(impl_.get_executor());
    impl_.get_service().accept(impl_.get_implementation(),
