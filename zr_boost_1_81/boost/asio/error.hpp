...
# define BOOST_ASIO_ERROR_LOCATION(e) \
  do { \
    BOOST_STATIC_CONSTEXPR zr_boost_1_81::source_location loc \
...
inline void clear(zr_boost_1_81::system::error_code& ec)
{
  ec = zr_boost_1_81::system::error_code();
}

inline const zr_boost_1_81::system::error_category& get_system_category()
{
  return zr_boost_1_81::system::system_category();
}

#if !defined(BOOST_ASIO_WINDOWS) && !defined(__CYGWIN__)

extern BOOST_ASIO_DECL
const zr_boost_1_81::system::error_category& get_netdb_category();

extern BOOST_ASIO_DECL
const zr_boost_1_81::system::error_category& get_addrinfo_category();

#else // !defined(BOOST_ASIO_WINDOWS) && !defined(__CYGWIN__)

inline const zr_boost_1_81::system::error_category& get_netdb_category()
{
  return get_system_category();
}

inline const zr_boost_1_81::system::error_category& get_addrinfo_category()
{
  return get_system_category();
}
...
extern BOOST_ASIO_DECL
const zr_boost_1_81::system::error_category& get_misc_category();

static const zr_boost_1_81::system::error_category&
...
static const zr_boost_1_81::system::error_category&
  ...
  = zr_boost_1_81::asio::error::get_netdb_category();
static const zr_boost_1_81::system::error_category&
  addrinfo_category BOOST_ASIO_UNUSED_VARIABLE
  = zr_boost_1_81::asio::error::get_addrinfo_category();
static const zr_boost_1_81::system::error_category&
  misc_category BOOST_ASIO_UNUSED_VARIABLE
  = zr_boost_1_81::asio::error::get_misc_category();
...
template<> struct is_error_code_enum<zr_boost_1_81::asio::error::basic_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<zr_boost_1_81::asio::error::netdb_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<zr_boost_1_81::asio::error::addrinfo_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<zr_boost_1_81::asio::error::misc_errors>
{
  static const bool value = true;
};
...
inline zr_boost_1_81::system::error_code make_error_code(basic_errors e)
{
  return zr_boost_1_81::system::error_code(
      static_cast<int>(e), get_system_category());
}

inline zr_boost_1_81::system::error_code make_error_code(netdb_errors e)
{
  return zr_boost_1_81::system::error_code(
      static_cast<int>(e), get_netdb_category());
}

inline zr_boost_1_81::system::error_code make_error_code(addrinfo_errors e)
{
  return zr_boost_1_81::system::error_code(
      static_cast<int>(e), get_addrinfo_category());
}

inline zr_boost_1_81::system::error_code make_error_code(misc_errors e)
{
  return zr_boost_1_81::system::error_code(
