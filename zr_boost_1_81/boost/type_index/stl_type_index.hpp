...
/// \brief Contains zr_boost_1_81::typeindex::stl_type_index class.
///
/// zr_boost_1_81::typeindex::stl_type_index class can be used as a drop-in replacement 
/// for std::type_index.
///
...
/// is defined zr_boost_1_81::typeindex::ctti is usually used instead of zr_boost_1_81::typeindex::stl_type_index.
...
inline std::string stl_type_index::pretty_name() const {
    static const char cvr_saver_name[] = "zr_boost_1_81::typeindex::detail::cvr_saver<";
    ...
    const zr_boost_1_81::core::scoped_demangled_name demangled_name(data_->name());

    const char* begin = demangled_name.get();
    if (!begin) {
        zr_boost_1_81::throw_exception(std::runtime_error("Type name demangling failed"));
    }
...
#else
    return zr_boost_1_81::hash_range(raw_name(), raw_name() + std::strlen(raw_name()));
#endif
}
...
inline stl_type_index stl_type_index::type_id() BOOST_NOEXCEPT {
    typedef BOOST_DEDUCED_TYPENAME zr_boost_1_81::remove_reference<T>::type no_ref_t;
    typedef BOOST_DEDUCED_TYPENAME zr_boost_1_81::remove_cv<no_ref_t>::type no_cvr_prefinal_t;
    ...
    #  if (defined(__EDG_VERSION__) && __EDG_VERSION__ < 245) \
        ...
        typedef BOOST_DEDUCED_TYPENAME zr_boost_1_81::conditional<
            zr_boost_1_81::is_signed<no_cvr_prefinal_t>::value,
            zr_boost_1_81::make_signed<no_cvr_prefinal_t>,
            zr_boost_1_81::type_identity<no_cvr_prefinal_t>
...
inline stl_type_index stl_type_index::type_id_with_cvr() BOOST_NOEXCEPT {
    typedef BOOST_DEDUCED_TYPENAME zr_boost_1_81::conditional<
        zr_boost_1_81::is_reference<T>::value ||  zr_boost_1_81::is_const<T>::value || zr_boost_1_81::is_volatile<T>::value,
        detail::cvr_saver<T>,
        T
    >::type type;
