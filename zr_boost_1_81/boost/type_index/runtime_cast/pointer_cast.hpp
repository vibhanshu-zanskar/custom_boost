...
/// \brief Contains the function overloads of zr_boost_1_81::typeindex::runtime_cast for
/// pointer types.
...
T runtime_cast(U* u) BOOST_NOEXCEPT {
    typedef typename zr_boost_1_81::remove_pointer<T>::type impl_type;
    return detail::runtime_cast_impl<impl_type>(u, zr_boost_1_81::is_base_and_derived<T, U>());
}
...
T* runtime_pointer_cast(U* u) BOOST_NOEXCEPT {
    return detail::runtime_cast_impl<T>(u, zr_boost_1_81::is_base_and_derived<T, U>());
}
