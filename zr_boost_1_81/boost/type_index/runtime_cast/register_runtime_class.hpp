...
/// \brief Macro used to make a class compatible with zr_boost_1_81::typeindex::runtime_cast
///
...
/// zr_boost_1_81::typeindex::runtime_cast to accurately convert between dynamic types of instances of
/// the current class.
///
/// BOOST_TYPE_INDEX_REGISTER_RUNTIME_CLASS also adds support for zr_boost_1_81::typeindex::type_id_runtime
...
/// if(derived2* pb2 = zr_boost_1_81::typeindex::runtime_cast<derived2*>(pb1)) {
///     assert(zr_boost_1_81::typeindex::type_id_runtime(*pb1)) == zr_boost_1_81::typeindex::type_id<derived2>());
/// }
/// \endcode
///
...
/// \brief Macro used to make a class compatible with zr_boost_1_81::typeindex::runtime_cast without including
/// support for zr_boost_1_81::typeindex::type_id_runtime.
///
/// BOOST_TYPE_INDEX_IMPLEMENT_RUNTIME_CAST is provided as an alternative to BOOST_TYPE_INDEX_REGISTER_RUNTIME_CLASS
/// in the event that support for zr_boost_1_81::typeindex::type_id_runtime is undesirable.
///
/// \b Example:
/// \code
/// struct base1 {
...
/// base1* pb1 = get_object();
/// if(derived2* pb2 = zr_boost_1_81::typeindex::runtime_cast<derived2*>(pb1))
/// { /* can't call zr_boost_1_81::typeindex::type_id_runtime(*pb1) here */ }
/// \endcode
///
/// \param base_class_seq A Boost.Preprocessor sequence of the current class' direct bases, or
/// BOOST_TYPE_INDEX_NO_BASE_CLASS if this class has no direct base classes.
#define BOOST_TYPE_INDEX_IMPLEMENT_RUNTIME_CAST(base_class_seq)                                                          \
    virtual void const* boost_type_index_find_instance_(zr_boost_1_81::typeindex::type_index const& idx) const BOOST_NOEXCEPT {  \
        if(idx == zr_boost_1_81::typeindex::detail::runtime_class_construct_type_id(this))                                       \
            return this;                                                                                                 \
