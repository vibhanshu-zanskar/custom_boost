...
#define BOOST_LEAF_ASSIGN(v,r)\
    ...
    static_assert(::zr_boost_1_81::leaf::is_result_type<typename std::decay<decltype(BOOST_LEAF_TMP)>::type>::value,\
...
#define BOOST_LEAF_NEW_ERROR ::zr_boost_1_81::leaf::leaf_detail::inject_loc{__FILE__,__LINE__,__FUNCTION__}+::zr_boost_1_81::leaf::new_error
