...
namespace leaf_detail
{
    ...
    {
        ::zr_boost_1_81::throw_exception(std::move(e));
    }
...
#define BOOST_LEAF_THROW_EXCEPTION ::zr_boost_1_81::leaf::leaf_detail::throw_with_loc{__FILE__,__LINE__,__FUNCTION__}+::zr_boost_1_81::leaf::leaf_detail::make_exception
...
namespace leaf_detail
{
    struct throw_with_loc
    {
        ...
        [[noreturn]] friend void operator+( throw_with_loc loc, Ex && ex )
        {
            ...
            ::zr_boost_1_81::leaf::leaf_detail::throw_exception_impl(std::move(ex));
        }
    };
}
...
[[noreturn]] void throw_exception( E && ... e )
{
    ...
    // set a breakpoint inside zr_boost_1_81::leaf::leaf_detail::throw_exception_impl.
