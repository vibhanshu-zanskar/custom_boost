...
// This file is based on zr_boost_1_81::core::demangle
//
...
char const * t =
    ...
    BOOST_LEAF_ASSERT(check_prefix(t,"const char *zr_boost_1_81::leaf::type() ")==t+32);
    return t+32;
#elif defined(__GNUC__)
    BOOST_LEAF_ASSERT(check_prefix(t,"const char* zr_boost_1_81::leaf::type() ")==t+32);
    return t+32;
#else
    char const * clang_style = check_prefix(t,"const char *zr_boost_1_81::leaf::type() ");
    if( clang_style!=t )
        return clang_style;
    char const * gcc_style = check_prefix(t,"const char* zr_boost_1_81::leaf::type() ");
    if( gcc_style!=t )
        return gcc_style;
#endif
    return t;
