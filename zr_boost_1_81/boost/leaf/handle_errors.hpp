...
namespace zr_boost_1_81 { namespace leaf {
...
namespace zr_boost_1_81 { class exception; }
namespace zr_boost_1_81 { template <class Tag,class T> class error_info; }
namespace zr_boost_1_81 { namespace exception_detail { template <class ErrorInfo> struct get_info; } }
...
namespace leaf_detail
{
    ...
    struct match_enum_type<zr_boost_1_81::error_info<Tag, T>>
    {
        using type = T;
    };
    ...
    template <class Tag, class T>
    struct handler_argument_traits<zr_boost_1_81::error_info<Tag, T>>
    {
        ...
        {
            using boost_exception = dependent_type_t<T, zr_boost_1_81::exception>;
            if( auto * be = get_exception<boost_exception>(ei) )
                return exception_detail::get_info<zr_boost_1_81::error_info<Tag, T>>::get(*be);
            else
                return nullptr;
        }

        template <class Tup>
        BOOST_LEAF_CONSTEXPR static zr_boost_1_81::error_info<Tag, T> get( Tup const & tup, error_info const & ei ) noexcept
        {
            return zr_boost_1_81::error_info<Tag, T>(*check(tup, ei));
        }
    };

    template <class Tag, class T> struct handler_argument_traits<zr_boost_1_81::error_info<Tag, T> const &>: handler_argument_traits_require_by_value<zr_boost_1_81::error_info<Tag, T>> { };
    template <class Tag, class T> struct handler_argument_traits<zr_boost_1_81::error_info<Tag, T> const *>: handler_argument_traits_require_by_value<zr_boost_1_81::error_info<Tag, T>> { };
    template <class Tag, class T> struct handler_argument_traits<zr_boost_1_81::error_info<Tag, T> &>: handler_argument_traits_require_by_value<zr_boost_1_81::error_info<Tag, T>> { };
    template <class Tag, class T> struct handler_argument_traits<zr_boost_1_81::error_info<Tag, T> *>: handler_argument_traits_require_by_value<zr_boost_1_81::error_info<Tag, T>> { };
}
