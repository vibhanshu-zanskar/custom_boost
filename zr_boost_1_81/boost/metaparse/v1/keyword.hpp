  ...
  namespace metaparse
  {
    namespace v1
    {
      ...
      private:
        ...
        {
        private:
          typedef lit<typename zr_boost_1_81::mpl::front<Kw>::type> next_char_parser;

          typedef
            keyword<typename zr_boost_1_81::mpl::pop_front<Kw>::type, ResultType>
            rest_parser;
