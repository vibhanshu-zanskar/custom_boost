  ...
  namespace metaparse
  {
    namespace v1
    {
      namespace grammar_util
      {
        ...
        {
          typedef
            typename zr_boost_1_81::mpl::at<typename G::rules, Name>::type
              ::template apply<G>
            p;
          ...
          typedef
            typename zr_boost_1_81::mpl::eval_if<
              typename zr_boost_1_81::mpl::has_key<typename G::actions, Name>::type,
              impl<zr_boost_1_81::mpl::at<typename G::actions, Name> >,
              p
            >::type
            type;
        };
          ...
          middle_of<
            ...
            one_of<
              last_of<
                lit_c<'\\'>,
                one_of<
                  always<lit_c<'n'>, zr_boost_1_81::mpl::char_<'\n'> >,
                  always<lit_c<'r'>, zr_boost_1_81::mpl::char_<'\r'> >,
                  always<lit_c<'t'>, zr_boost_1_81::mpl::char_<'\t'> >,
                  lit_c<'\\'>,
                  lit_c<'\''>
                >
              >,
        ...
        struct build_parsed_parser
        {
          ...
          typedef typename zr_boost_1_81::mpl::front<p>::type name;
          typedef typename zr_boost_1_81::mpl::back<p>::type exp;
          ...
          typedef zr_boost_1_81::mpl::pair<name, the_parser> type;
        };
        ...
        struct add_rule<grammar_builder<Start, Rules, Actions>, P, no_action> :
          grammar_builder<
            Start,
            typename zr_boost_1_81::mpl::insert<Rules, typename P::type>::type,
            Actions
          >
        {};
        ...
        struct add_rule<grammar_builder<Start, Rules, Actions>, P, F> :
          grammar_builder<
            Start,
            typename zr_boost_1_81::mpl::insert<Rules, typename P::type>::type,
            typename zr_boost_1_81::mpl::insert<
              Actions,
              zr_boost_1_81::mpl::pair<
                typename P::name,
                typename zr_boost_1_81::mpl::lambda<F>::type
              >
            >
            ::type
          >
        ...
        struct add_import<grammar_builder<Start, Rules, Actions>, Name, P> :
          grammar_builder<
            ...
            typename zr_boost_1_81::mpl::insert<
              Rules,
              zr_boost_1_81::mpl::pair<Name, build_native_parser<P> >
            >::type,
            Actions
          >
        {};
