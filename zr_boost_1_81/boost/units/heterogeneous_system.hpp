...
#define BOOST_UNITS_MAKE_HETEROGENEOUS_UNIT(BaseUnit, Dimensions)   \
    zr_boost_1_81::units::unit<                                             \
        Dimensions,                                                 \
        zr_boost_1_81::units::heterogeneous_system<                         \
            zr_boost_1_81::units::heterogeneous_system_impl<                \
                zr_boost_1_81::units::list<                       \
                    zr_boost_1_81::units::heterogeneous_system_dim<         \
                        BaseUnit,                                   \
                        zr_boost_1_81::units::static_rational<1>            \
                    >,                                              \
                    zr_boost_1_81::units::dimensionless_type                \
                >,                                                  \
                Dimensions,                                         \
                zr_boost_1_81::units::no_scale                              \
            >                                                       \
        >                                                           \
    >
...
BOOST_TYPEOF_REGISTER_TEMPLATE(zr_boost_1_81::units::heterogeneous_system_impl, (class)(class)(class))
BOOST_TYPEOF_REGISTER_TEMPLATE(zr_boost_1_81::units::heterogeneous_system, (class))
BOOST_TYPEOF_REGISTER_TEMPLATE(zr_boost_1_81::units::heterogeneous_system_dim, (class)(class))
...
/// INTERNAL ONLY
template<>
struct less_impl<zr_boost_1_81::units::heterogeneous_system_dim_tag, zr_boost_1_81::units::heterogeneous_system_dim_tag>
{
...
/// INTERNAL ONLY
template<>
struct plus_impl<zr_boost_1_81::units::heterogeneous_system_dim_tag, zr_boost_1_81::units::heterogeneous_system_dim_tag>
{
    template<class T0, class T1>
    struct apply
    {
        typedef zr_boost_1_81::units::heterogeneous_system_dim<
...
/// INTERNAL ONLY
template<>
struct times_impl<zr_boost_1_81::units::heterogeneous_system_dim_tag, zr_boost_1_81::units::detail::static_rational_tag>
{
    template<class T0, class T1>
    struct apply
    {
...
/// INTERNAL ONLY
template<>
struct divides_impl<zr_boost_1_81::units::heterogeneous_system_dim_tag, zr_boost_1_81::units::detail::static_rational_tag>
{
    template<class T0, class T1>
    struct apply
    {
...
/// INTERNAL ONLY
template<>
struct negate_impl<zr_boost_1_81::units::heterogeneous_system_dim_tag>
{
    template<class T>
    struct apply
    {
        typedef zr_boost_1_81::units::heterogeneous_system_dim<typename T::tag_type, typename mpl::negate<typename T::value_type>::type> type;
    };
};
...
struct make_heterogeneous_system
{
    ...
    BOOST_MPL_ASSERT_MSG((!zr_boost_1_81::is_same<exponents, inconsistent>::value), the_specified_dimension_is_not_representible_in_the_given_system, (types<Dimensions, System>));
