...
/// This must be in namespace zr_boost_1_81::units so that ADL
...
/// @code
/// struct my_dimension : zr_boost_1_81::units::base_dimension<my_dimension, 1> {};
/// @endcode
    ...
    public ordinal<N> 
{
    public:
        ...
        /// A convenience typedef.  Equivalent to zr_boost_1_81::units::derived_dimension<Derived,1>::type.
