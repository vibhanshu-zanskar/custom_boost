...
BOOST_UNITS_STATIC_CONSTANT(name, zr_boost_1_81::units::constant<zr_boost_1_81::units::physical_constant<name ## _t> >) = { }
...
{
    zr_boost_1_81::io::ios_precision_saver precision_saver(os);
    //zr_boost_1_81::io::ios_width_saver width_saver(os);
    zr_boost_1_81::io::ios_flags_saver flags_saver(os);
