...
struct is_non_narrowing_conversion :
    mpl::and_<
        zr_boost_1_81::is_convertible<Source, Destination>,
        mpl::not_<
            mpl::and_<
                zr_boost_1_81::is_arithmetic<Source>,
                zr_boost_1_81::is_arithmetic<Destination>,
                mpl::or_<
                    mpl::and_<
...
class quantity
{
    ...
    public:
        ...
        BOOST_CONSTEXPR quantity(const quantity<Unit,YY>& source,
            typename zr_boost_1_81::enable_if<detail::is_non_narrowing_conversion<YY, Y> >::type* = 0) :
            val_(source.value())
        { 
            BOOST_UNITS_CHECK_LAYOUT_COMPATIBILITY(this_type, Y);
        }
        ...
        explicit BOOST_CONSTEXPR quantity(const quantity<Unit,YY>& source,
            typename zr_boost_1_81::disable_if<detail::is_non_narrowing_conversion<YY, Y> >::type* = 0) :
        ...
        { 
            BOOST_UNITS_CHECK_LAYOUT_COMPATIBILITY(this_type, Y);
            BOOST_STATIC_ASSERT((zr_boost_1_81::is_convertible<YY, Y>::value == true));
        }
        ...
        BOOST_CXX14_CONSTEXPR this_type& operator+=(const quantity<Unit2, YY>& source)
        {
            BOOST_STATIC_ASSERT((zr_boost_1_81::is_same<typename add_typeof_helper<Unit, Unit2>::type, Unit>::value));
            val_ += source.value();
            return *this;
        }  
        ...
        BOOST_CXX14_CONSTEXPR this_type& operator-=(const quantity<Unit2, YY>& source)
        {
            BOOST_STATIC_ASSERT((zr_boost_1_81::is_same<typename subtract_typeof_helper<Unit, Unit2>::type, Unit>::value));
            val_ -= source.value();
            return *this;
        }  
        ...
        BOOST_CXX14_CONSTEXPR this_type& operator*=(const quantity<Unit2, YY>& source)
        {
            BOOST_STATIC_ASSERT((zr_boost_1_81::is_same<typename multiply_typeof_helper<Unit, Unit2>::type, Unit>::value));
            val_ *= source.value();
            return *this;
        }  
        ...
        BOOST_CXX14_CONSTEXPR this_type& operator/=(const quantity<Unit2, YY>& source)
        {
            BOOST_STATIC_ASSERT((zr_boost_1_81::is_same<typename divide_typeof_helper<Unit, Unit2>::type, Unit>::value));
            val_ /= source.value();
            return *this;
        }
...
class quantity<BOOST_UNITS_DIMENSIONLESS_UNIT(System),Y>
{
    public:
        ...
        BOOST_CONSTEXPR quantity(const quantity<unit<dimensionless_type, System2>,Y2>& source,
            ...
            >::type* = 0
        #else
            typename zr_boost_1_81::enable_if<detail::is_non_narrowing_conversion<Y2, Y> >::type* = 0,
            typename detail::disable_if_is_same<System, System2>::type* = 0,
            typename zr_boost_1_81::enable_if<detail::is_dimensionless_system<System2> >::type* = 0
        #endif
            ) :
            val_(source.value()) 
        {
        ...
        explicit BOOST_CONSTEXPR quantity(const quantity<unit<dimensionless_type, System2>,Y2>& source,
            ...
            typename zr_boost_1_81::enable_if<
                zr_boost_1_81::mpl::and_<
                    zr_boost_1_81::mpl::not_<detail::is_non_narrowing_conversion<Y2, Y> >,
                    detail::is_dimensionless_system<System2>
                > 
            >::type* = 0
        #else
            typename zr_boost_1_81::disable_if<detail::is_non_narrowing_conversion<Y2, Y> >::type* = 0,
            typename detail::disable_if_is_same<System, System2>::type* = 0,
            typename zr_boost_1_81::enable_if<detail::is_dimensionless_system<System2> >::type* = 0
        #endif
            ) :
        ...
        {
            BOOST_UNITS_CHECK_LAYOUT_COMPATIBILITY(this_type, Y);
            BOOST_STATIC_ASSERT((zr_boost_1_81::is_convertible<Y2, Y>::value == true));
        }
        ...
        template<class System2, class Y2> 
        explicit BOOST_CONSTEXPR quantity(const quantity<unit<dimensionless_type, System2>,Y2>& source,
            typename zr_boost_1_81::disable_if<detail::is_dimensionless_system<System2> >::type* = 0) :
...
BOOST_TYPEOF_REGISTER_TEMPLATE(zr_boost_1_81::units::quantity, 2)
