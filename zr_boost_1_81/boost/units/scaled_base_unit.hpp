...
BOOST_TYPEOF_REGISTER_TEMPLATE(zr_boost_1_81::units::scaled_base_unit, (class)(class))
...
/// INTERNAL ONLY
template<class Tag>
struct less_impl<zr_boost_1_81::units::scaled_base_unit_tag, Tag>
{
    template<class T0, class T1>
    struct apply : mpl::bool_<
        mpl::less<typename T0::system_type, T1>::value ||
    (zr_boost_1_81::is_same<typename T0::system_type, T1>::value && ((T0::scale_type::exponent::Numerator) < 0)) > {};
};

/// INTERNAL ONLY
template<class Tag>
struct less_impl<Tag, zr_boost_1_81::units::scaled_base_unit_tag>
{
    template<class T0, class T1>
    struct apply : mpl::bool_<
        mpl::less<T0, typename T1::system_type>::value ||
    (zr_boost_1_81::is_same<T0, typename T1::system_type>::value && ((T1::scale_type::exponent::Numerator) > 0)) > {};
};

/// INTERNAL ONLY
template<>
struct less_impl<zr_boost_1_81::units::scaled_base_unit_tag, zr_boost_1_81::units::scaled_base_unit_tag>
{
    template<class T0, class T1>
    struct apply : mpl::bool_<
        mpl::less<typename T0::system_type, typename T1::system_type>::value ||
    ((zr_boost_1_81::is_same<typename T0::system_type, typename T1::system_type>::value) &&
