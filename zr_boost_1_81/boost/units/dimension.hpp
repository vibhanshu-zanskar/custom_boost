...
template<>
struct plus_impl<zr_boost_1_81::units::detail::dimension_list_tag,zr_boost_1_81::units::detail::dimension_list_tag>
{
    template<class T0, class T1>
    struct apply
    {
        BOOST_STATIC_ASSERT((zr_boost_1_81::is_same<T0,T1>::value == true));
        typedef T0 type;
    };
};

template<>
struct minus_impl<zr_boost_1_81::units::detail::dimension_list_tag,zr_boost_1_81::units::detail::dimension_list_tag>
{
    template<class T0, class T1>
    struct apply
    {
...
template<>
struct times_impl<zr_boost_1_81::units::detail::dimension_list_tag,zr_boost_1_81::units::detail::dimension_list_tag>
{
    template<class T0, class T1>
    struct apply
    {
        typedef typename zr_boost_1_81::units::detail::merge_dimensions<T0,T1>::type type;
    };
};

template<>
struct divides_impl<zr_boost_1_81::units::detail::dimension_list_tag,zr_boost_1_81::units::detail::dimension_list_tag>
{
    template<class T0, class T1>
    struct apply
    {
        typedef typename zr_boost_1_81::units::detail::merge_dimensions<
            T0,
            typename zr_boost_1_81::units::detail::static_inverse_impl<
                T1::size::value
            >::template apply<
                T1
            >::type
...
template<>
struct negate_impl<zr_boost_1_81::units::detail::dimension_list_tag>
{
    template<class T0>
    struct apply
    {
