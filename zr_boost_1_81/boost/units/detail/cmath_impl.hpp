...
{
    if((zr_boost_1_81::math::isnan)(v1) || (zr_boost_1_81::math::isnan)(v2)) return false;
    else return v1 > v2;
}
...
{
    return (zr_boost_1_81::math::isnan)(v1) || (zr_boost_1_81::math::isnan)(v2);
}

template<class Y>
inline Y fdim BOOST_PREVENT_MACRO_SUBSTITUTION(const Y& v1,const Y& v2)
{
    if((zr_boost_1_81::math::isnan)(v1)) return v1;
    else if((zr_boost_1_81::math::isnan)(v2)) return v2;
...
{
    if((zr_boost_1_81::math::isnan)(v1)) return(v2);
    else if((zr_boost_1_81::math::isnan)(v2)) return(v1);
...
inline Y nearbyint(const Y& val)
{
    ...
    using zr_boost_1_81::math::round;
    return round(val);
}
