...
typedef zr_boost_1_81::units::heterogeneous_system<
...
template<class T>
struct void_if_dimensionless<zr_boost_1_81::units::homogeneous_system<T> > {
    typedef void type;
};
...
#define BOOST_UNITS_DIMENSIONLESS_UNIT(T)\
    zr_boost_1_81::units::unit<\
        zr_boost_1_81::units::dimensionless_type,\
        T,\
        typename ::zr_boost_1_81::units::detail::void_if_dimensionless<T>::type\
    >
...
#define BOOST_UNITS_HETEROGENEOUS_DIMENSIONLESS_UNIT(T)\
    zr_boost_1_81::units::unit<\
        zr_boost_1_81::units::dimensionless_type,\
        T,\
        typename ::zr_boost_1_81::units::detail::void_if_heterogeneous<T>::type\
    >
