...
/// INTERNAL ONLY
template<>
struct less_impl<zr_boost_1_81::units::scale_dim_tag, zr_boost_1_81::units::scale_dim_tag>
{
...
/// INTERNAL ONLY
template<>
struct plus_impl<zr_boost_1_81::units::scale_dim_tag, zr_boost_1_81::units::scale_dim_tag>
{
    template<class T0, class T1>
    struct apply
    {
        typedef zr_boost_1_81::units::scale_list_dim<
            zr_boost_1_81::units::scale<
                (T0::base),
...
/// INTERNAL ONLY
template<>
struct negate_impl<zr_boost_1_81::units::scale_dim_tag>
{
    template<class T0>
    struct apply
    {
...
/// INTERNAL ONLY
template<>
struct times_impl<zr_boost_1_81::units::scale_dim_tag, zr_boost_1_81::units::detail::static_rational_tag>
{
    template<class T0, class T1>
    struct apply
    {
...
/// INTERNAL ONLY
template<>
struct divides_impl<zr_boost_1_81::units::scale_dim_tag, zr_boost_1_81::units::detail::static_rational_tag>
{
    template<class T0, class T1>
    struct apply
    {
