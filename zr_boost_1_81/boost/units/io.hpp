...
inline void serialize(Archive& /*ar*/,zr_boost_1_81::units::unit<Dim,System>&,const unsigned int /*version*/)
{ }

/// Boost Serialization library support for quantities.
template<class Archive,class Unit,class Y>
inline void serialize(Archive& ar,zr_boost_1_81::units::quantity<Unit,Y>& q,const unsigned int /*version*/)
{
    ar & zr_boost_1_81::serialization::make_nvp("value", units::quantity_cast<Y&>(q));
}
...
template<class T, bool C = zr_boost_1_81::is_arithmetic<T>::value>
