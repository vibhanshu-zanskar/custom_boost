...
struct make_integral_c {
    typedef zr_boost_1_81::mpl::integral_c<integer_type, X> type;
};
...
class static_rational
{
    public:
        ...
        typedef zr_boost_1_81::mpl::integral_c<integer_type, N> N_type;
        typedef zr_boost_1_81::mpl::integral_c<integer_type, D> D_type;

        typedef typename make_integral_c<
            (::zr_boost_1_81::integer::static_gcd<
                ::zr_boost_1_81::units::static_abs<N>::value,
                ::zr_boost_1_81::units::static_abs<D>::value
            >::value)>::type gcd_type;
        typedef typename zr_boost_1_81::mpl::eval_if<
            zr_boost_1_81::mpl::less<
                D_type,
                zr_boost_1_81::mpl::integral_c<integer_type, 0>
            >,
            zr_boost_1_81::mpl::negate<gcd_type>,
            gcd_type
        >::type den_type;
    ...
    public: 
        ...
        BOOST_STATIC_CONSTANT(integer_type, Numerator =
            (::zr_boost_1_81::mpl::divides<N_type, den_type>::value));
        BOOST_STATIC_CONSTANT(integer_type, Denominator =
            (::zr_boost_1_81::mpl::divides<D_type, den_type>::value));
...
class static_rational
{
    private:
        ...
        BOOST_STATIC_CONSTEXPR integer_type den = 
            static_cast<integer_type>(zr_boost_1_81::integer::static_gcd<nabs,dabs>::value) * ((D < 0) ? -1 : 1);
...
BOOST_TYPEOF_REGISTER_TEMPLATE(zr_boost_1_81::units::static_rational, (long)(long))
...
template<>
struct plus_impl<zr_boost_1_81::units::detail::static_rational_tag, zr_boost_1_81::units::detail::static_rational_tag>
{
    template<class T0, class T1>
    struct apply {
        typedef typename zr_boost_1_81::units::static_rational<
            ::zr_boost_1_81::mpl::plus<
                zr_boost_1_81::mpl::times<typename T0::N_type, typename T1::D_type>,
                zr_boost_1_81::mpl::times<typename T1::N_type, typename T0::D_type>
            >::value,
            ::zr_boost_1_81::mpl::times<typename T0::D_type, typename T1::D_type>::value
        >::type type;
    };
};

template<>
struct minus_impl<zr_boost_1_81::units::detail::static_rational_tag, zr_boost_1_81::units::detail::static_rational_tag>
{
    template<class T0, class T1>
    struct apply {
        typedef typename zr_boost_1_81::units::static_rational<
            ::zr_boost_1_81::mpl::minus<
                zr_boost_1_81::mpl::times<typename T0::N_type, typename T1::D_type>,
                zr_boost_1_81::mpl::times<typename T1::N_type, typename T0::D_type>
            >::value,
            ::zr_boost_1_81::mpl::times<typename T0::D_type, typename T1::D_type>::value
...
template<>
struct times_impl<zr_boost_1_81::units::detail::static_rational_tag, zr_boost_1_81::units::detail::static_rational_tag>
{
    template<class T0, class T1>
    struct apply {
        typedef typename zr_boost_1_81::units::static_rational<
            ::zr_boost_1_81::mpl::times<typename T0::N_type, typename T1::N_type>::value,
            ::zr_boost_1_81::mpl::times<typename T0::D_type, typename T1::D_type>::value
        >::type type;
    };
};
...
template<>
struct divides_impl<zr_boost_1_81::units::detail::static_rational_tag, zr_boost_1_81::units::detail::static_rational_tag>
{
    template<class T0, class T1>
    struct apply {
        typedef typename zr_boost_1_81::units::static_rational<
            ::zr_boost_1_81::mpl::times<typename T0::N_type, typename T1::D_type>::value,
            ::zr_boost_1_81::mpl::times<typename T0::D_type, typename T1::N_type>::value
        >::type type;
    };
};

template<>
struct negate_impl<zr_boost_1_81::units::detail::static_rational_tag>
{
    template<class T0>
    struct apply {
        typedef typename zr_boost_1_81::units::static_rational<
            ::zr_boost_1_81::mpl::negate<typename T0::N_type>::value,
            ::zr_boost_1_81::mpl::identity<T0>::type::Denominator
        >::type type;
    };
};

template<>
struct less_impl<zr_boost_1_81::units::detail::static_rational_tag, zr_boost_1_81::units::detail::static_rational_tag>
{
    template<class T0, class T1>
    struct apply
    {
...
struct negate_impl<zr_boost_1_81::units::detail::static_rational_tag>
{
    template<class T0>
    struct apply {
        typedef typename zr_boost_1_81::units::static_rational<-T0::Numerator,T0::Denominator>::type type;
    };
};
