...
BOOST_TYPEOF_REGISTER_TEMPLATE(zr_boost_1_81::units::unit, 2)
...
struct is_implicitly_convertible :
    zr_boost_1_81::is_same<typename reduce_unit<S1>::type, typename reduce_unit<S2>::type>
{ };
...
{
    BOOST_STATIC_ASSERT((zr_boost_1_81::is_same<System1,System2>::value == true));
...
operator==(const unit<Dim1,System1>&,const unit<Dim2,System2>&)
{
    return zr_boost_1_81::is_same<typename reduce_unit<unit<Dim1,System1> >::type, typename reduce_unit<unit<Dim2,System2> >::type>::value;
}
