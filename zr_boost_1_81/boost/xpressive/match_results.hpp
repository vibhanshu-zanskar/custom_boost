...
public:
    ...
    {
        return this->format_(out, zr_boost_1_81::as_literal(fmt), flags, mpl::size_t<0>());
    }
...
private:
    ...
    {
        return std::copy(zr_boost_1_81::begin(result), zr_boost_1_81::end(result), out);
    }
    ...
    ) const
    {
        ...
        iterator cur = zr_boost_1_81::begin(format), end = zr_boost_1_81::end(format);
    ...
    ) const
    {
        ...
        typedef typename zr_boost_1_81::uint_t<CHAR_BIT * sizeof(char_type)>::least uchar_t;
    ...
    zr_boost_1_81::optional<BidiIter> base_;
    zr_boost_1_81::optional<sub_match<BidiIter> > prefix_;
    zr_boost_1_81::optional<sub_match<BidiIter> > suffix_;
...
namespace std
{
    ...
    concept_map OutputIterator<
        zr_boost_1_81::xpressive::detail::case_converting_iterator<Iter_, Char_>
      , Char_
    >
    {};
    ...
    concept_map OutputIterator<
        zr_boost_1_81::xpressive::detail::noop_output_iterator<Char_>
      , Char_
    >
    {};
}
