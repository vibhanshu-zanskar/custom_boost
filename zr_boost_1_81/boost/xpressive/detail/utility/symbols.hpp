...
namespace zr_boost_1_81 { namespace xpressive { namespace detail
{
    ...
    struct symbols
    {
        ...
        {
            iterator begin = zr_boost_1_81::begin(map);
            iterator end = zr_boost_1_81::end(map);
            node* root_p = this->root.get();
            for(; begin != end; ++begin)
            {
                key_iterator kbegin = zr_boost_1_81::begin(begin->first);
                key_iterator kend = zr_boost_1_81::end(begin->first);
    ...
    private:
        ...
        zr_boost_1_81::shared_ptr<node> root;
    };
