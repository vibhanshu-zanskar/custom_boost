...
namespace zr_boost_1_81 { namespace xpressive { namespace grammar_detail
{
    using proto::_;
    using proto::or_;
    using proto::if_;
...
namespace zr_boost_1_81 { namespace xpressive { namespace op
{
    struct push;
    struct push_back;
    struct pop;
    ...
    template<typename T>
    struct throw_;
}}} // namespace zr_boost_1_81::xpressive::op
