...
#else
  static rval_reference_type move(reference_type r) { return zr_boost_1_81::move(r); }
#endif
#endif
...
void prevent_binding_rvalue_ref_to_optional_lvalue_ref()
{
  ...
  BOOST_STATIC_ASSERT_MSG(
    !zr_boost_1_81::is_lvalue_reference<To>::value || !zr_boost_1_81::is_rvalue_reference<From>::value, 
...
class optional_base : public optional_tag
{
...
#endif
    ::zr_boost_1_81::detail::make_reference_content<T>::type internal_type ;
  ...
  protected:
    ...
    void assign ( optional_base&& rhs )
    {
      ...
      {
        if ( rhs.is_initialized() )
             assign_value(zr_boost_1_81::move(rhs.get_impl()), is_reference_predicate() );
        else destroy();
      }
      else
      {
    ...
    {
      if (is_initialized())
           assign_value( zr_boost_1_81::move(val), is_reference_predicate() );
  ...
  protected :
    ...
    void emplace_assign ( Args&&... args )
     {
       destroy();
       ::new (m_storage.address()) internal_type( zr_boost_1_81::forward<Args>(args)... );
       m_initialized = true ;
     }
    ...
    void emplace_assign ( Arg&& arg )
     {
       destroy();
       ::new (m_storage.address()) internal_type( zr_boost_1_81::forward<Arg>(arg) );
       m_initialized = true ;
     }
    ...
    {
      new (m_storage.address()) internal_type(zr_boost_1_81::forward<Expr>(expr)) ;
      m_initialized = true ;
    }
    ...
    {
      assign_value(zr_boost_1_81::forward<Expr>(expr), is_reference_predicate());
    }
#else
    // Constructs using any expression implicitly convertible to the single argument
    // of a one-argument T constructor.
...
class optional : public optional_detail::optional_base<T>
{
  ...
  public :
    ...
    // Can throw if T::T(T &&) does
    optional ( rval_reference_type val ) : base( zr_boost_1_81::forward<T>(val) ) 
  ...
  explicit optional ( Expr&& expr, 
                      BOOST_DEDUCED_TYPENAME zr_boost_1_81::disable_if_c<
                        (zr_boost_1_81::is_base_of<optional_detail::optional_tag, BOOST_DEDUCED_TYPENAME zr_boost_1_81::decay<Expr>::type>::value) || 
                        zr_boost_1_81::is_same<BOOST_DEDUCED_TYPENAME zr_boost_1_81::decay<Expr>::type, none_t>::value, bool >::type = true 
  ) 
   ...
   // No-throw (assuming T::~T() doesn't)
    ...
    BOOST_DEDUCED_TYPENAME zr_boost_1_81::disable_if_c<
      zr_boost_1_81::is_base_of<optional_detail::optional_tag, BOOST_DEDUCED_TYPENAME zr_boost_1_81::decay<Expr>::type>::value || 
        zr_boost_1_81::is_same<BOOST_DEDUCED_TYPENAME zr_boost_1_81::decay<Expr>::type, none_t>::value,
      optional&
    >::type 
    operator= ( Expr&& expr )
      {
