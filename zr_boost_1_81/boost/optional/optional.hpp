...
namespace zr_boost_1_81 { namespace optional_detail {
...
template <typename T>
struct optional_value_type< ::zr_boost_1_81::optional<T> >
{
  typedef T type;
};

}} // namespace zr_boost_1_81::optional_detail
...
class optional_base : public optional_tag
{
  ...
  protected :
    ...
    typedef typename zr_boost_1_81::remove_const<T>::type unqualified_value_type;
  ...
  protected:
    ...
    optional_base ( init_value_tag, rval_reference_type val )
      ...
      m_initialized(false)
    {
      construct( zr_boost_1_81::move(val) );
    }
#endif
    ...
    BOOST_NOEXCEPT_IF(::zr_boost_1_81::is_nothrow_move_constructible<T>::value)
      :
      m_initialized(false)
    {
      if ( rhs.is_initialized() )
        construct( zr_boost_1_81::move(rhs.get_impl()) );
    }
#endif
    ...
    explicit optional_base ( Expr&& expr, PtrExpr const* tag )
      ...
      m_initialized(false)
    {
      construct(zr_boost_1_81::forward<Expr>(expr),tag);
    }
    ...
    BOOST_NOEXCEPT_IF(::zr_boost_1_81::is_nothrow_move_constructible<T>::value && ::zr_boost_1_81::is_nothrow_move_assignable<T>::value)
    {
    ...
    void assign ( optional_base&& rhs )
    {
      ...
      {
        if ( rhs.is_initialized() )
             assign_value( zr_boost_1_81::move(rhs.get_impl()) );
        else destroy();
      }
      else
      {
    ...
    {
      if (is_initialized())
           assign_value( zr_boost_1_81::move(val) );
      else construct( zr_boost_1_81::move(val) );
    }
#endif
    ...
    {
      if (is_initialized())
        assign_expr_to_initialized(zr_boost_1_81::forward<Expr>(expr),tag);
      else construct(zr_boost_1_81::forward<Expr>(expr),tag);
    }
#else
    template<class Expr>
  ...
  protected :
    ...
    void construct ( rval_reference_type val )
     {
       ::new (m_storage.address()) unqualified_value_type( zr_boost_1_81::move(val) ) ;
       m_initialized = true ;
     }
#endif
    ...
    {
      ::new (m_storage.address()) unqualified_value_type( zr_boost_1_81::forward<Args>(args)... ) ;
      m_initialized = true ;
    }
    ...
    {
      destroy();
      construct(in_place_init, zr_boost_1_81::forward<Args>(args)...);
    }
    ...
    void construct ( in_place_init_t, Arg&& arg )
     {
       ::new (m_storage.address()) unqualified_value_type( zr_boost_1_81::forward<Arg>(arg) );
       m_initialized = true ;
     }
    ...
    void emplace_assign ( Arg&& arg )
     {
       destroy();
       construct(in_place_init, zr_boost_1_81::forward<Arg>(arg)) ;
     }
    ...
    void construct ( Expr&& factory, in_place_factory_base const* )
     {
       zr_boost_1_81_optional_detail::construct<value_type>(factory, m_storage.address());
       m_initialized = true ;
     }
    ...
    {
      new (m_storage.address()) unqualified_value_type(zr_boost_1_81::forward<Expr>(expr)) ;
      m_initialized = true ;
    }
    ...
    {
      assign_value( zr_boost_1_81::forward<Expr>(expr) );
    }
#else
    // Constructs using any expression implicitly convertible to the single argument
    // of a one-argument T constructor.
    ...
    void construct ( Expr&& expr, optional_tag const* )
     {
       if ( expr.is_initialized() )
       {
         ...
         new (m_storage.address()) unqualified_value_type(zr_boost_1_81::move(expr.get())) ;
         m_initialized = true ;
       }
     }
#else
...
struct is_optional_or_tag
  : zr_boost_1_81::conditional< zr_boost_1_81::is_base_of<optional_detail::optional_tag, BOOST_DEDUCED_TYPENAME zr_boost_1_81::decay<U>::type>::value
                     || zr_boost_1_81::is_same<BOOST_DEDUCED_TYPENAME zr_boost_1_81::decay<U>::type, none_t>::value
                     || zr_boost_1_81::is_same<BOOST_DEDUCED_TYPENAME zr_boost_1_81::decay<U>::type, in_place_init_t>::value
                     || zr_boost_1_81::is_same<BOOST_DEDUCED_TYPENAME zr_boost_1_81::decay<U>::type, in_place_init_if_t>::value,
    zr_boost_1_81::true_type, zr_boost_1_81::false_type>::type
{};

template <typename T, typename U>
struct has_dedicated_constructor
  : zr_boost_1_81::disjunction<is_optional_or_tag<U>, zr_boost_1_81::is_same<T, BOOST_DEDUCED_TYPENAME zr_boost_1_81::decay<U>::type> >
{};

template <typename U>
struct is_in_place_factory
  : zr_boost_1_81::disjunction< zr_boost_1_81::is_base_of<zr_boost_1_81::in_place_factory_base, BOOST_DEDUCED_TYPENAME zr_boost_1_81::decay<U>::type>,
                        zr_boost_1_81::is_base_of<zr_boost_1_81::typed_in_place_factory_base, BOOST_DEDUCED_TYPENAME zr_boost_1_81::decay<U>::type> >
{};
...
struct is_factory_or_constructible_to_T
  : zr_boost_1_81::disjunction< is_in_place_factory<U>, zr_boost_1_81::is_constructible<T, U&&> >
{};

template <typename T, typename U>
struct is_optional_constructible : zr_boost_1_81::is_constructible<T, U>
{};

#else

template <typename, typename>
struct is_factory_or_constructible_to_T : zr_boost_1_81::true_type
{};

template <typename T, typename U>
struct is_optional_constructible : zr_boost_1_81::true_type
{};
...
struct is_opt_assignable
  : zr_boost_1_81::conjunction<zr_boost_1_81::is_convertible<U&&, T>, zr_boost_1_81::is_assignable<T&, U&&> >
{};
...
template <typename T, typename U>
struct is_opt_assignable : zr_boost_1_81::is_convertible<U, T>
{};
...
struct is_factory_or_opt_assignable_to_T
  : zr_boost_1_81::disjunction< is_in_place_factory<U>, is_opt_assignable<T, U> >
{};
...
struct optional_uses_direct_storage_for
  : zr_boost_1_81::conditional<(zr_boost_1_81::is_scalar<T>::value && !zr_boost_1_81::is_const<T>::value && !zr_boost_1_81::is_volatile<T>::value)
                      , zr_boost_1_81::true_type, zr_boost_1_81::false_type>::type
{};
...
#  define BOOST_OPTIONAL_BASE_TYPE(T) zr_boost_1_81::conditional< optional_config::optional_uses_direct_storage_for<T>::value, \
  ...
  : public BOOST_OPTIONAL_BASE_TYPE(T)
{
  ...
  public :
    ...
    // Can throw if T::T(T &&) does
    optional ( rval_reference_type val ) : base(optional_detail::init_value_tag(), zr_boost_1_81::forward<T>(val))
      {}
#endif
    ...
    /// Creates an optional<T> initialized with 'val' IFF cond is true, otherwise creates an uninitialized optional.
    // Can throw if T::T(T &&) does
    optional ( bool cond, rval_reference_type val ) : base( cond, zr_boost_1_81::forward<T>(val) )
      {}
#endif
    ...
    explicit optional ( optional<U> const& rhs
                        ...
                        ,BOOST_DEDUCED_TYPENAME zr_boost_1_81::enable_if< optional_detail::is_optional_constructible<T, U const&>, bool>::type = true
#endif
                      )
      :
      base()
...
#ifndef BOOST_OPTIONAL_DETAIL_NO_SFINAE_FRIENDLY_CONSTRUCTORS
                        ,BOOST_DEDUCED_TYPENAME zr_boost_1_81::enable_if< optional_detail::is_optional_constructible<T, U>, bool>::type = true
#endif
                      )
      :
      base()
    {
      if ( rhs.is_initialized() )
        this->construct( zr_boost_1_81::move(rhs.get()) );
    }
#endif
  ...
  explicit optional ( Expr&& expr,
                      BOOST_DEDUCED_TYPENAME zr_boost_1_81::enable_if< optional_detail::is_optional_val_init_candidate<T, Expr>, bool>::type = true
  )
    : base(zr_boost_1_81::forward<Expr>(expr),zr_boost_1_81::addressof(expr))
    {}

#else
    template<class Expr>
    explicit optional ( Expr const& expr ) : base(expr,zr_boost_1_81::addressof(expr)) {}
    ...
    template<class Expr>
    BOOST_DEDUCED_TYPENAME zr_boost_1_81::enable_if<optional_detail::is_optional_val_assign_candidate<T, Expr>, optional&>::type
    operator= ( Expr&& expr )
      {
        this->assign_expr(zr_boost_1_81::forward<Expr>(expr),zr_boost_1_81::addressof(expr));
        return *this ;
      }
    ...
    optional& operator= ( Expr const& expr )
      {
        this->assign_expr(expr,zr_boost_1_81::addressof(expr));
        return *this ;
      }
#endif // !defined  BOOST_OPTIONAL_DETAIL_NO_RVALUE_REFERENCES
    ...
    optional& operator= ( optional<U> && rhs )
      {
        this->assign(zr_boost_1_81::move(rhs));
        return *this ;
      }
#endif
    ...
    BOOST_DEDUCED_TYPENAME zr_boost_1_81::enable_if<zr_boost_1_81::is_same<T, BOOST_DEDUCED_TYPENAME zr_boost_1_81::decay<T_>::type>, optional&>::type
    operator= ( T_&& val )
      {
        this->assign( zr_boost_1_81::forward<T_>(val) ) ;
        return *this ;
      }
    ...
    optional& operator= ( rval_reference_type val )
      {
        this->assign( zr_boost_1_81::move(val) ) ;
        return *this ;
      }
#endif
    ...
    {
      this->emplace_assign( zr_boost_1_81::forward<Args>(args)... );
    }

    template<class... Args>
    explicit optional ( in_place_init_t, Args&&... args )
    : base( in_place_init, zr_boost_1_81::forward<Args>(args)... )
    {}

    template<class... Args>
    explicit optional ( in_place_init_if_t, bool cond, Args&&... args )
    : base( in_place_init_if, cond, zr_boost_1_81::forward<Args>(args)... )
    {}
    ...
    void emplace ( Arg&& arg )
     {
       this->emplace_assign( zr_boost_1_81::forward<Arg>(arg) );
     }
    ...
    reference_type_of_temporary_wrapper operator *() && { return zr_boost_1_81::move(this->get()) ; }
#else
    reference_const_type operator *() const { return this->get() ; }
    reference_type       operator *()       { return this->get() ; }
    ...
    reference_type_of_temporary_wrapper value() &&
      {
        if (this->is_initialized())
          return zr_boost_1_81::move(this->get()) ;
        else
          throw_exception(bad_optional_access());
      }
    ...
    value_type value_or ( U&& v ) const&
      {
        if (this->is_initialized())
          ...
          return zr_boost_1_81::forward<U>(v);
      }
    ...
    template <typename F>
    optional<typename zr_boost_1_81::result_of<F(reference_type)>::type> map(F f) &
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename zr_boost_1_81::result_of<F(reference_const_type)>::type> map(F f) const&
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename zr_boost_1_81::result_of<F(reference_type_of_temporary_wrapper)>::type> map(F f) &&
      {
        if (this->has_value())
          return f(zr_boost_1_81::move(this->get()));
        else
          return none;
      }

    template <typename F>
    optional<typename optional_detail::optional_value_type<typename zr_boost_1_81::result_of<F(reference_type)>::type>::type> flat_map(F f) &
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename optional_detail::optional_value_type<typename zr_boost_1_81::result_of<F(reference_const_type)>::type>::type> flat_map(F f) const&
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename optional_detail::optional_value_type<typename zr_boost_1_81::result_of<F(reference_type_of_temporary_wrapper)>::type>::type> flat_map(F f) &&
      {
        if (this->has_value())
          return f(zr_boost_1_81::move(get()));
        else
          return none;
      }
...
template<class T>
inline
optional<BOOST_DEDUCED_TYPENAME zr_boost_1_81::decay<T>::type> make_optional ( T && v  )
{
  return optional<BOOST_DEDUCED_TYPENAME zr_boost_1_81::decay<T>::type>(zr_boost_1_81::forward<T>(v));
}

// Returns optional<T>(cond,v)
template<class T>
inline
optional<BOOST_DEDUCED_TYPENAME zr_boost_1_81::decay<T>::type> make_optional ( bool cond, T && v )
{
  return optional<BOOST_DEDUCED_TYPENAME zr_boost_1_81::decay<T>::type>(cond,zr_boost_1_81::forward<T>(v));
}
...
{
  BOOST_STATIC_ASSERT_MSG(sizeof(CharType) == 0, "If you want to output zr_boost_1_81::optional, include header <boost/optional/optional_io.hpp>");
  return os;
}
