...
private:
  Value                               x;
  mutable zr_boost_1_81::detail::atomic_count ref;
...
/* swap lookup by zr_boost_1_81::swap fails under obscure circumstances */

} /* namespace flyweights */

template<typename Handle,typename TrackingHelper>
void swap(
  ::zr_boost_1_81::flyweights::detail::refcounted_handle<Handle,TrackingHelper>& x,
  ::zr_boost_1_81::flyweights::detail::refcounted_handle<Handle,TrackingHelper>& y)
{
  ::zr_boost_1_81::flyweights::detail::swap(x,y);
}
