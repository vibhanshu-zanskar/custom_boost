...
struct flyweight_signature:
  parameter::parameters<
    parameter::optional<
      ...
      detail::is_tag<zr_boost_1_81::mpl::_>
    >,
    parameter::optional<
      parameter::deduced<tracking<> >,
      is_tracking<zr_boost_1_81::mpl::_>
    >,
    parameter::optional<
      parameter::deduced<factory<> >,
      is_factory<zr_boost_1_81::mpl::_>
    >,
    parameter::optional<
      parameter::deduced<locking<> >,
      is_locking<zr_boost_1_81::mpl::_>
    >,
    parameter::optional<
      parameter::deduced<holder<> >,
      is_holder<zr_boost_1_81::mpl::_>
    >
  >
{};
...
#undef BOOST_FLYWEIGHT_PERFECT_FWD_CTR_BODY
  ...
  flyweight(
    ...
    typename zr_boost_1_81::enable_if<
      zr_boost_1_81::is_convertible<std::initializer_list<V>,key_type> >::type* =0):
    h(core::insert(list)){} 
#endif
  ...
  template<typename V>
  typename zr_boost_1_81::enable_if<
    zr_boost_1_81::is_convertible<std::initializer_list<V>,key_type>,flyweight&>::type
  ...
  void swap(flyweight& x){zr_boost_1_81::swap(h,x.h);}
...
hash<zr_boost_1_81::flyweight<T,BOOST_FLYWEIGHT_TEMPL_ARGS(_)> >
{
public:
  typedef std::size_t                result_type;
  typedef zr_boost_1_81::flyweight<
...
std::size_t hash_value(const flyweight<T,BOOST_FLYWEIGHT_TEMPL_ARGS(_)>& x)
{
  ...
  zr_boost_1_81::hash<const value_type*> h;
  return h(&x.get());
}
