...
public:
    ...
    template<
        typename Source,
        typename = typename zr_boost_1_81::enable_if_c<
            zr_boost_1_81::conjunction<
                zr_boost_1_81::disjunction<
                    detail::path_traits::is_path_source< typename zr_boost_1_81::remove_cv< Source >::type >,
                    detail::path_traits::is_convertible_to_path_source< typename zr_boost_1_81::remove_cv< Source >::type >
                >,
                zr_boost_1_81::negation< detail::path_traits::is_native_path_source< typename zr_boost_1_81::remove_cv< Source >::type > >
            >::value
        >::type
    >
    ...
    path(Source const& source, typename zr_boost_1_81::enable_if_c<
        zr_boost_1_81::conjunction<
            zr_boost_1_81::disjunction<
                detail::path_traits::is_path_source< typename zr_boost_1_81::remove_cv< Source >::type >,
                detail::path_traits::is_convertible_to_path_source< typename zr_boost_1_81::remove_cv< Source >::type >
...
#else
    template< typename Source >
    path(Source const& source, codecvt_type const& cvt, typename zr_boost_1_81::enable_if_c<
        zr_boost_1_81::conjunction<
            zr_boost_1_81::disjunction<
                detail::path_traits::is_path_source< typename zr_boost_1_81::remove_cv< Source >::type >,
                detail::path_traits::is_convertible_to_path_source< typename zr_boost_1_81::remove_cv< Source >::type >
    ...
    template<
        ...
        typename = typename zr_boost_1_81::enable_if_c<
            zr_boost_1_81::conjunction<
                ...
                zr_boost_1_81::negation< detail::path_traits::is_native_char_ptr< InputIterator > >
            >::value
        >::type
    >
    ...
    path(InputIterator begin, InputIterator end, typename zr_boost_1_81::enable_if_c<
        zr_boost_1_81::conjunction<
            detail::path_traits::is_path_source_iterator< InputIterator >,
            zr_boost_1_81::negation< detail::path_traits::is_native_char_ptr< InputIterator > >
        >::value
...
#else
    template< typename InputIterator >
    path(InputIterator begin, InputIterator end, codecvt_type const& cvt, typename zr_boost_1_81::enable_if_c<
        zr_boost_1_81::conjunction<
            detail::path_traits::is_path_source_iterator< InputIterator >,
            zr_boost_1_81::negation< detail::path_traits::is_native_char_ptr< InputIterator > >
        >::value
    ...
    template< typename Source >
    typename zr_boost_1_81::enable_if_c<
        detail::path_traits::is_path_source< typename zr_boost_1_81::remove_cv< Source >::type >::value,
        path&
    ...
    typename zr_boost_1_81::enable_if_c<
        zr_boost_1_81::conjunction<
            detail::path_traits::is_convertible_to_path_source< typename zr_boost_1_81::remove_cv< Source >::type >,
            zr_boost_1_81::negation< detail::path_traits::is_path_source< typename zr_boost_1_81::remove_cv< Source >::type > >
        >::value,
        path&
    >::type assign(Source const& source)
    {
...
private:
    ...
    friend class zr_boost_1_81::filesystem::path;
    friend class zr_boost_1_81::filesystem::path::reverse_iterator;
...
inline typename zr_boost_1_81::enable_if_c<
    zr_boost_1_81::is_same< T, path >::value,
    std::size_t
...
//    use zr_boost_1_81::io::quoted() to handle spaces in paths
...
{
    return os << zr_boost_1_81::io::quoted(p.template string< std::basic_string< Char > >(), static_cast< Char >('&'));
}
...
operator>>(std::basic_istream< Char, Traits >& is, path& p)
{
    ...
    is >> zr_boost_1_81::io::quoted(str, static_cast< Char >('&'));
    p = str;
    return is;
}
