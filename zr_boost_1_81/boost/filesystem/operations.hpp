...
struct space_info
{
    ...
    zr_boost_1_81::uintmax_t capacity;
    zr_boost_1_81::uintmax_t free;      // <= capacity
    zr_boost_1_81::uintmax_t available; // <= free
};
...
BOOST_FILESYSTEM_DECL
zr_boost_1_81::uintmax_t file_size(path const& p, system::error_code* ec = NULL);
BOOST_FILESYSTEM_DECL
zr_boost_1_81::uintmax_t hard_link_count(path const& p, system::error_code* ec = NULL);
BOOST_FILESYSTEM_DECL
...
BOOST_FILESYSTEM_DECL
zr_boost_1_81::uintmax_t remove_all(path const& p, system::error_code* ec = NULL);
BOOST_FILESYSTEM_DECL
...
inline zr_boost_1_81::uintmax_t file_size(path const& p)
{
    return detail::file_size(p);
}

inline zr_boost_1_81::uintmax_t file_size(path const& p, system::error_code& ec) BOOST_NOEXCEPT
{
    return detail::file_size(p, &ec);
}

inline zr_boost_1_81::uintmax_t hard_link_count(path const& p)
{
    return detail::hard_link_count(p);
}

inline zr_boost_1_81::uintmax_t hard_link_count(path const& p, system::error_code& ec) BOOST_NOEXCEPT
{
...
inline zr_boost_1_81::uintmax_t remove_all(path const& p)
{
    return detail::remove_all(p);
}

inline zr_boost_1_81::uintmax_t remove_all(path const& p, system::error_code& ec) BOOST_NOEXCEPT
{
