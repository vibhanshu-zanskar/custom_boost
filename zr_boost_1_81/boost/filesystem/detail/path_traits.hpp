...
template< >
struct path_source_traits< zr_boost_1_81::container::basic_string< char, std::char_traits< char >, void > >
{
...
template< >
struct path_source_traits< zr_boost_1_81::container::basic_string< wchar_t, std::char_traits< wchar_t >, void > >
{
    typedef boost_container_string_tag tag_type;
    typedef wchar_t char_type;
    static BOOST_CONSTEXPR_OR_CONST bool is_native = false;
...
template< >
struct path_source_traits< zr_boost_1_81::basic_string_view< char, std::char_traits< char > > >
{
...
template< >
struct path_source_traits< zr_boost_1_81::basic_string_view< wchar_t, std::char_traits< wchar_t > > >
{
    typedef boost_string_view_tag tag_type;
    typedef wchar_t char_type;
    static BOOST_CONSTEXPR_OR_CONST bool is_native = false;
...
BOOST_FORCEINLINE void dispatch(Source const& source, Callback cb, const codecvt_type* cvt)
{
    path_traits::dispatch(source, cb, cvt,
        typename path_traits::path_source_traits< typename zr_boost_1_81::remove_cv< Source >::type >::tag_type());
}
...
struct is_convertible_to_path_source
{
    ...
    static yes_type _check_convertible_to_path_source(zr_boost_1_81::container::basic_string< char, std::char_traits< char >, void > const&);
    static yes_type _check_convertible_to_path_source(zr_boost_1_81::container::basic_string< wchar_t, std::char_traits< wchar_t >, void > const&);
#if !defined(BOOST_NO_CXX17_HDR_STRING_VIEW)
...
#endif
    static yes_type _check_convertible_to_path_source(zr_boost_1_81::basic_string_view< char, std::char_traits< char > > const&);
    static yes_type _check_convertible_to_path_source(zr_boost_1_81::basic_string_view< wchar_t, std::char_traits< wchar_t > > const&);
    static no_type _check_convertible_to_path_source(...);

    static BOOST_CONSTEXPR_OR_CONST bool value =
        sizeof(is_convertible_to_path_source< T >::_check_convertible_to_path_source(zr_boost_1_81::declval< T const& >())) == sizeof(yes_type);
};
...
struct is_convertible_to_std_string_view
{
    ...
    static BOOST_CONSTEXPR_OR_CONST bool value =
        sizeof(is_convertible_to_std_string_view< T >::_check_convertible_to_std_string_view(zr_boost_1_81::declval< T const& >())) == sizeof(yes_type);
};
...
struct is_convertible_to_path_source_non_std_string_view
{
    ...
    static BOOST_CONSTEXPR_OR_CONST bool value =
        sizeof(is_convertible_to_path_source_non_std_string_view< T >::_check_convertible_to_path_source(zr_boost_1_81::declval< T const& >())) == sizeof(yes_type);
};

//! The type trait indicates whether the type has a conversion path to one of the path source types
template< typename T >
struct is_convertible_to_path_source :
    public zr_boost_1_81::disjunction<
...
(
    zr_boost_1_81::container::basic_string< char, std::char_traits< char >, void > const& source,
    Callback cb,
    const codecvt_type* cvt
)
{
    typedef typename path_traits::make_dependent< zr_boost_1_81::container::basic_string< char, std::char_traits< char >, void >, Source >::type source_t;
    path_traits::dispatch(static_cast< source_t const& >(source), cb, cvt);
}
...
BOOST_FORCEINLINE void dispatch_convertible_impl
(
    zr_boost_1_81::container::basic_string< wchar_t, std::char_traits< wchar_t >, void > const& source,
    Callback cb,
    const codecvt_type* cvt
)
{
    typedef typename path_traits::make_dependent< zr_boost_1_81::container::basic_string< wchar_t, std::char_traits< wchar_t >, void >, Source >::type source_t;
    path_traits::dispatch(static_cast< source_t const& >(source), cb, cvt);
}
...
BOOST_FORCEINLINE void dispatch_convertible_impl
(
    zr_boost_1_81::basic_string_view< char, std::char_traits< char > > const& source,
    Callback cb,
    const codecvt_type* cvt
)
{
    typedef typename path_traits::make_dependent< zr_boost_1_81::basic_string_view< char, std::char_traits< char > >, Source >::type source_t;
    path_traits::dispatch(static_cast< source_t const& >(source), cb, cvt);
}
...
BOOST_FORCEINLINE void dispatch_convertible_impl
(
    zr_boost_1_81::basic_string_view< wchar_t, std::char_traits< wchar_t > > const& source,
    Callback cb,
    const codecvt_type* cvt
)
{
    typedef typename path_traits::make_dependent< zr_boost_1_81::basic_string_view< wchar_t, std::char_traits< wchar_t > >, Source >::type source_t;
    path_traits::dispatch(static_cast< source_t const& >(source), cb, cvt);
}
...
{
    typedef typename zr_boost_1_81::remove_cv< Source >::type source_t;
...
template< typename Source, typename Callback >
BOOST_FORCEINLINE typename zr_boost_1_81::disable_if_c<
    is_convertible_to_std_string_view< typename zr_boost_1_81::remove_cv< Source >::type >::value
...
template< typename Source, typename Callback >
BOOST_FORCEINLINE typename zr_boost_1_81::enable_if_c<
    is_convertible_to_std_string_view< typename zr_boost_1_81::remove_cv< Source >::type >::value
>::type dispatch_convertible(Source const& source, Callback cb, const codecvt_type* cvt = NULL)
{
    typedef typename zr_boost_1_81::remove_cv< Source >::type source_t;
