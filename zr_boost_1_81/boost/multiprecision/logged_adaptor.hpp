...
struct logged_adaptor
{
 ...
 public:
   ...
   template <class T>
   typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_arithmetic<T>::value || std::is_assignable<Backend, T>::value, logged_adaptor&>::type operator=(const T& i)
   {
   ...
   void serialize(Archive& ar, const unsigned int /*version*/)
   {
      ...
      ar& zr_boost_1_81::make_nvp("value", m_value);
...
class numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::logged_adaptor<Backend>, ExpressionTemplates> >
    : public std::numeric_limits<zr_boost_1_81::multiprecision::number<Backend, ExpressionTemplates> >
{
   using base_type = std::numeric_limits<zr_boost_1_81::multiprecision::number<Backend, ExpressionTemplates> >                           ;
   using number_type = zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::logged_adaptor<Backend>, ExpressionTemplates>;
...
template <class Backend, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates, class Policy>
struct precision<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::logged_adaptor<Backend>, ExpressionTemplates>, Policy>
    : public precision<zr_boost_1_81::multiprecision::number<Backend, ExpressionTemplates>, Policy>
{};
