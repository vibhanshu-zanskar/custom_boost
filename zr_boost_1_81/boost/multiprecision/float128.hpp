...
#define BOOST_MP_QUAD_MIN zr_boost_1_81::multiprecision::quad_constants::quad_min
#define BOOST_MP_QUAD_DENORM_MIN zr_boost_1_81::multiprecision::quad_constants::quad_denorm_min
#define BOOST_MP_QUAD_MAX zr_boost_1_81::multiprecision::quad_constants::quad_max
...
struct float128_backend
{
 ...
 public:
   ...
   constexpr float128_backend(const T& i, const typename std::enable_if<std::is_convertible<T, float128_type>::value>::type* = nullptr) noexcept(noexcept(std::declval<float128_type&>() = std::declval<const T&>()))
       : m_value(i) {}
   template <class T>
   BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_arithmetic<T>::value || std::is_convertible<T, float128_type>::value, float128_backend&>::type operator=(const T& i) noexcept(noexcept(std::declval<float128_type&>() = std::declval<const T&>()))
   {
      m_value = i;
      return *this;
   }
...
#else
      zr_boost_1_81::multiprecision::detail::convert_from_string(*this, s);
#endif
      return *this;
   }
   ...
   std::string str(std::streamsize digits, std::ios_base::fmtflags f) const
   {
      ...
      return buf;
#else
      return zr_boost_1_81::multiprecision::detail::convert_to_string(*this, digits ? digits : 36, f);
#endif
   }
...
inline void eval_round(float128_backend& result, const float128_backend& arg)
{
   ...
   {
      result = zr_boost_1_81::math::policies::raise_rounding_error(
            "zr_boost_1_81::multiprecision::trunc<%1%>(%1%)", nullptr,
            number<float128_backend, et_off>(arg),
            number<float128_backend, et_off>(arg),
            zr_boost_1_81::math::policies::policy<>()).backend();
      return;
   }
...
{
   return zr_boost_1_81::multiprecision::detail::hash_value(static_cast<double>(val.value()));
}

} // namespace backends

template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
inline zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates> asinh BOOST_PREVENT_MACRO_SUBSTITUTION(const zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates>& arg)
{
   return asinhq(arg.backend().value());
}
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
inline zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates> acosh BOOST_PREVENT_MACRO_SUBSTITUTION(const zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates>& arg)
{
   return acoshq(arg.backend().value());
}
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
inline zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates> atanh BOOST_PREVENT_MACRO_SUBSTITUTION(const zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates>& arg)
{
   return atanhq(arg.backend().value());
}
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
inline zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates> cbrt BOOST_PREVENT_MACRO_SUBSTITUTION(const zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates>& arg)
{
   return cbrtq(arg.backend().value());
}
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
inline zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates> erf BOOST_PREVENT_MACRO_SUBSTITUTION(const zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates>& arg)
{
   return erfq(arg.backend().value());
}
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
inline zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates> erfc BOOST_PREVENT_MACRO_SUBSTITUTION(const zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates>& arg)
{
   return erfcq(arg.backend().value());
}
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
inline zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates> expm1 BOOST_PREVENT_MACRO_SUBSTITUTION(const zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates>& arg)
{
   return expm1q(arg.backend().value());
}
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
inline zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates> lgamma BOOST_PREVENT_MACRO_SUBSTITUTION(const zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates>& arg)
{
   return lgammaq(arg.backend().value());
}
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
inline zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates> tgamma BOOST_PREVENT_MACRO_SUBSTITUTION(const zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates>& arg)
{
   if(eval_signbit(arg.backend()) != 0)
   {
      const bool result_is_neg = ((static_cast<unsigned long long>(floorq(-arg.backend().value())) % 2U) == 0U);

      const zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates> result_of_tgammaq = fabsq(tgammaq(arg.backend().value()));
...
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
inline zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates> log1p BOOST_PREVENT_MACRO_SUBSTITUTION(const zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates>& arg)
{
   return log1pq(arg.backend().value());
}
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
inline zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates> rsqrt BOOST_PREVENT_MACRO_SUBSTITUTION(const zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates>& arg)
{
   zr_boost_1_81::multiprecision::number<float128_backend, ExpressionTemplates> res;
...
void do_serialize(Archive& ar, zr_boost_1_81::multiprecision::backends::float128_backend& val, const std::integral_constant<bool, false>&, const std::integral_constant<bool, false>&)
{
   // saving
   // non-binary
   std::string s(val.str(0, std::ios_base::scientific));
   ar&         zr_boost_1_81::make_nvp("value", s);
}
template <class Archive>
void do_serialize(Archive& ar, zr_boost_1_81::multiprecision::backends::float128_backend& val, const std::integral_constant<bool, true>&, const std::integral_constant<bool, false>&)
{
   // loading
   // non-binary
   std::string s;
...
template <class Archive>
void do_serialize(Archive& ar, zr_boost_1_81::multiprecision::backends::float128_backend& val, const std::integral_constant<bool, false>&, const std::integral_constant<bool, true>&)
{
   // saving
   // binary
...
template <class Archive>
void do_serialize(Archive& ar, zr_boost_1_81::multiprecision::backends::float128_backend& val, const std::integral_constant<bool, true>&, const std::integral_constant<bool, true>&)
{
   // loading
   // binary
...
template <class Archive>
void serialize(Archive& ar, zr_boost_1_81::multiprecision::backends::float128_backend& val, unsigned int /*version*/)
{
   using load_tag = typename Archive::is_loading                                                                                                                                         ;
   using loading = std::integral_constant<bool, load_tag::value>                                                                                                                        ;
   using binary_tag = typename std::integral_constant<bool, std::is_same<Archive, zr_boost_1_81::archive::binary_oarchive>::value || std::is_same<Archive, zr_boost_1_81::archive::binary_iarchive>::value>;
...
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >
{
   using number_type = zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates>;
...
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >::is_specialized;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >::digits;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >::digits10;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >::max_digits10;

template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >::is_signed;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >::is_integer;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >::is_exact;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >::radix;

template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >::min_exponent;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >::max_exponent;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >::min_exponent10;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >::max_exponent10;

template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >::has_infinity;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >::has_quiet_NaN;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >::has_signaling_NaN;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >::has_denorm_loss;

template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >::is_iec559;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >::is_bounded;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >::is_modulo;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >::traps;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >::tinyness_before;

template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_round_style numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >::round_style;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_denorm_style numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::float128_backend, ExpressionTemplates> >::has_denorm;
