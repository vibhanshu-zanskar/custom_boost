...
struct gmp_float_imp
{
   ...
   gmp_float_imp(const gmp_float_imp& o)
   {
      ...
      //
      mpf_init2(m_data, preserve_source_precision() ? mpf_get_prec(o.data()) : zr_boost_1_81::multiprecision::detail::digits10_2_2(get_default_precision()));
      if (o.m_data[0]._mp_d)
   ...
   {
      if ((this->get_default_options() == variable_precision_options::preserve_target_precision) && (mpf_get_prec(o.data()) != zr_boost_1_81::multiprecision::detail::digits10_2_2(get_default_precision())))
      {
         mpf_init2(m_data, zr_boost_1_81::multiprecision::detail::digits10_2_2(get_default_precision()));
   ...
   gmp_float_imp& operator=(long long i)
   {
      ...
      bool neg = i < 0;
      *this    = static_cast<unsigned long long>(zr_boost_1_81::multiprecision::detail::unsigned_abs(i));
      if (neg)
   ...
   gmp_float_imp& operator=(int128_type i)
   {
      ...
      bool neg = i < 0;
      *this    = static_cast<uint128_type>(zr_boost_1_81::multiprecision::detail::unsigned_abs(i));
      if (neg)
         mpf_neg(m_data, m_data);
      return *this;
   }
   ...
   std::string str(std::streamsize digits, std::ios_base::fmtflags f) const
   {
      ...
      zr_boost_1_81::multiprecision::detail::format_float_string(result, e, org_digits, f, mpf_sgn(m_data) == 0);
      return result;
   }
   ~gmp_float_imp() noexcept
   {
   ...
   template <class V>
   typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_arithmetic<V>::value, int>::type compare(V v) const
   {
 ...
 protected:
   ...
   {
      static zr_boost_1_81::multiprecision::detail::precision_type val(50);
      return val;
   }
...
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_arithmetic<T>::value, bool>::type eval_eq(const gmp_float<digits10>& a, const T& b) noexcept
{
   return a.compare(b) == 0;
}
template <unsigned digits10, class T>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_arithmetic<T>::value, bool>::type eval_lt(const gmp_float<digits10>& a, const T& b) noexcept
{
   return a.compare(b) < 0;
}
template <unsigned digits10, class T>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_arithmetic<T>::value, bool>::type eval_gt(const gmp_float<digits10>& a, const T& b) noexcept
{
   return a.compare(b) > 0;
}
...
inline void eval_multiply(gmp_float<digits10>& result, long i)
{
   ...
   mpf_mul_ui(result.data(), result.data(), static_cast<local_uint_type>(zr_boost_1_81::multiprecision::detail::unsigned_abs(i)));
...
inline void eval_divide(gmp_float<digits10>& result, long i)
{
   ...
   mpf_div_ui(result.data(), result.data(), static_cast<local_uint_type>(zr_boost_1_81::multiprecision::detail::unsigned_abs(i)));
...
{
   if (y < 0)
      mpf_sub_ui(a.data(), x.data(), zr_boost_1_81::multiprecision::detail::unsigned_abs(y));
   else
      mpf_add_ui(a.data(), x.data(), y);
}
template <unsigned D1, unsigned D2>
...
inline void eval_divide(gmp_float<D1>& a, long x, const gmp_float<D2>& y)
{
   ...
   if (x < 0)
   {
      mpf_ui_div(a.data(), zr_boost_1_81::multiprecision::detail::unsigned_abs(x), y.data());
      mpf_neg(a.data(), a.data());
   }
   else
   {
...
inline std::size_t hash_value(const gmp_float<Digits10>& val)
{
   ...
   for (int i = 0; i < std::abs(val.data()[0]._mp_size); ++i)
      zr_boost_1_81::multiprecision::detail::hash_combine(result, val.data()[0]._mp_d[i]);
   zr_boost_1_81::multiprecision::detail::hash_combine(result, val.data()[0]._mp_exp, val.data()[0]._mp_size);
   return result;
}
...
template <class T>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_arithmetic<T>::value, bool>::type eval_eq(const gmp_int& a, const T& b)
{
   return a.compare(b) == 0;
}
template <class T>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_arithmetic<T>::value, bool>::type eval_lt(const gmp_int& a, const T& b)
{
   return a.compare(b) < 0;
}
template <class T>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_arithmetic<T>::value, bool>::type eval_gt(const gmp_int& a, const T& b)
{
   return a.compare(b) > 0;
}
...
inline void eval_multiply(gmp_int& t, long i)
{
   ...
   mpz_mul_ui(t.data(), t.data(), static_cast<local_uint_type>(zr_boost_1_81::multiprecision::detail::unsigned_abs(i)));
...
inline void eval_modulus(gmp_int& t, long i)
{
   ...
   mpz_tdiv_r_ui(t.data(), t.data(), static_cast<local_uint_type>(zr_boost_1_81::multiprecision::detail::unsigned_abs(i)));
}
inline void eval_divide(gmp_int& t, long i)
{
   ...
   mpz_tdiv_q_ui(t.data(), t.data(), static_cast<local_uint_type>(zr_boost_1_81::multiprecision::detail::unsigned_abs(i)));
...
{
   mpz_mul_ui(t.data(), p.data(), zr_boost_1_81::multiprecision::detail::unsigned_abs(i));
   if (i < 0)
      mpz_neg(t.data(), t.data());
}
inline void eval_modulus(gmp_int& t, const gmp_int& p, long i)
{
   mpz_tdiv_r_ui(t.data(), p.data(), zr_boost_1_81::multiprecision::detail::unsigned_abs(i));
}
inline void eval_divide(gmp_int& t, const gmp_int& p, long i)
{
   if (i == 0)
      BOOST_MP_THROW_EXCEPTION(std::overflow_error("Division by zero."));
   mpz_tdiv_q_ui(t.data(), p.data(), zr_boost_1_81::multiprecision::detail::unsigned_abs(i));
   if (i < 0)
      mpz_neg(t.data(), t.data());
}
...
template <class I>
inline typename std::enable_if<(zr_boost_1_81::multiprecision::detail::is_unsigned<I>::value && (sizeof(I) <= sizeof(unsigned long)))>::type eval_gcd(gmp_int& result, const gmp_int& a, const I b)
{
   mpz_gcd_ui(result.data(), a.data(), b);
}
template <class I>
inline typename std::enable_if<(zr_boost_1_81::multiprecision::detail::is_unsigned<I>::value && (sizeof(I) <= sizeof(unsigned long)))>::type eval_lcm(gmp_int& result, const gmp_int& a, const I b)
{
   mpz_lcm_ui(result.data(), a.data(), b);
}
template <class I>
inline typename std::enable_if<(zr_boost_1_81::multiprecision::detail::is_signed<I>::value && zr_boost_1_81::multiprecision::detail::is_integral<I>::value && (sizeof(I) <= sizeof(long)))>::type eval_gcd(gmp_int& result, const gmp_int& a, const I b)
{
   mpz_gcd_ui(result.data(), a.data(), zr_boost_1_81::multiprecision::detail::unsigned_abs(b));
}
template <class I>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_signed<I>::value && zr_boost_1_81::multiprecision::detail::is_integral<I>::value && ((sizeof(I) <= sizeof(long)))>::type eval_lcm(gmp_int& result, const gmp_int& a, const I b)
{
   mpz_lcm_ui(result.data(), a.data(), zr_boost_1_81::multiprecision::detail::unsigned_abs(b));
}
...
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_unsigned<Integer>::value, Integer>::type eval_integer_modulus(const gmp_int& x, Integer val)
{
...
template <class Integer>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_signed<Integer>::value && zr_boost_1_81::multiprecision::detail::is_integral<Integer>::value, Integer>::type eval_integer_modulus(const gmp_int& x, Integer val)
{
   return eval_integer_modulus(x, zr_boost_1_81::multiprecision::detail::unsigned_abs(val));
}
...
inline typename std::enable_if<
    zr_boost_1_81::multiprecision::detail::is_unsigned<Integer>::value && (sizeof(Integer) <= sizeof(unsigned long))>::type
eval_powm(gmp_int& result, const gmp_int& base, Integer p, const gmp_int& m)
{
   mpz_powm_ui(result.data(), base.data(), p, m.data());
}
template <class Integer>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_signed<Integer>::value && zr_boost_1_81::multiprecision::detail::is_integral<Integer>::value && (sizeof(Integer) <= sizeof(unsigned long))>::type
eval_powm(gmp_int& result, const gmp_int& base, Integer p, const gmp_int& m)
{
   if (p < 0)
   {
...
inline std::size_t hash_value(const gmp_int& val)
{
   ...
   for (int i = 0; i < std::abs(val.data()[0]._mp_size); ++i)
      zr_boost_1_81::multiprecision::detail::hash_combine(result, val.data()[0]._mp_d[i]);
   zr_boost_1_81::multiprecision::detail::hash_combine(result, val.data()[0]._mp_size);
   return result;
}
...
struct gmp_rational
{
   ...
   gmp_rational(const gmp_int& a, const U& b, typename std::enable_if<std::is_constructible<gmp_int, U>::value>::type* = nullptr)
   {
      ...
      m_data[0]._mp_den = j.data()[0];
      if (zr_boost_1_81::multiprecision::detail::unsigned_abs(b) > 1)
         mpq_canonicalize(m_data);
      j.data()[0]._mp_d = nullptr;
   }
   template <class U>
   ...
   gmp_rational(const T& a, const gmp_int& b, typename std::enable_if<std::is_constructible<gmp_int, T>::value>::type* = nullptr)
   {
      ...
      if(zr_boost_1_81::multiprecision::detail::unsigned_abs(a) > 1)
         mpq_canonicalize(m_data);
      i.data()[0]._mp_d = nullptr;
   }
   template <class T>
...
template <class T>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_integral<T>::value>::type eval_add(gmp_rational& result, gmp_rational const& a, const T& b)
{
   gmp_int t;
   t = b;
   eval_add(result, a, t);
...
template <class T>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_integral<T>::value>::type eval_add(gmp_rational& result, const T& b, gmp_rational const& a)
{
   eval_add(result, a, b);
}
template <class T>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_integral<T>::value>::type eval_add(gmp_rational& result, const T& b)
{
...
template <class T>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_integral<T>::value>::type eval_subtract(gmp_rational& result, gmp_rational const& a, const T& b)
{
   gmp_int t;
   t = b;
...
template <class T>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_integral<T>::value>::type eval_subtract(gmp_rational& result, const T& b, gmp_rational const& a)
{
   eval_subtract(result, a, b);
   result.negate();
}
template <class T>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_integral<T>::value>::type eval_subtract(gmp_rational& result, const T& b)
{
...
{
   eval_multiply(result, a, zr_boost_1_81::multiprecision::detail::unsigned_abs(b));
   if (b < 0)
      result.negate();
}
template <class T>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_integral<T>::value>::type eval_multiply(gmp_rational& result, gmp_rational const& a, const T& b)
{
   gmp_int t;
   t = b;
...
template <class T>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_integral<T>::value>::type eval_multiply(gmp_rational& result, const T& b, gmp_rational const& a)
{
   eval_multiply(result, a, b);
}
template <class T>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_integral<T>::value>::type eval_multiply(gmp_rational& result, const T& b)
{
...
inline typename std::enable_if<number_category<R>::value == number_kind_floating_point>::type eval_convert_to(R* result, const gmp_rational& backend)
{
   ...
   // This does:
   //
   ::zr_boost_1_81::multiprecision::detail::generic_convert_rational_to_float(*result, backend);
}
#ifdef BOOST_HAS_FLOAT128
...
inline std::size_t hash_value(const gmp_rational& val)
{
   ...
   for (int i = 0; i < std::abs(val.data()[0]._mp_num._mp_size); ++i)
      zr_boost_1_81::multiprecision::detail::hash_combine(result, val.data()[0]._mp_num._mp_d[i]);
   for (int i = 0; i < std::abs(val.data()[0]._mp_den._mp_size); ++i)
      zr_boost_1_81::multiprecision::detail::hash_combine(result, val.data()[0]._mp_den._mp_d[i]);
   zr_boost_1_81::multiprecision::detail::hash_combine(result, val.data()[0]._mp_num._mp_size);
   return result;
}
...
using zr_boost_1_81::multiprecision::backends::gmp_float;
using zr_boost_1_81::multiprecision::backends::gmp_int;
using zr_boost_1_81::multiprecision::backends::gmp_rational;
...
template <unsigned Digits10>
struct transcendental_reduction_type<zr_boost_1_81::multiprecision::backends::gmp_float<Digits10> >
{
   //
   ...
   //
   using type = zr_boost_1_81::multiprecision::backends::gmp_float<Digits10 * 3>;
};
...
inline void set_output_precision(const zr_boost_1_81::multiprecision::mpf_float& val, std::ostream& os)
{
...
template <>
inline int digits<zr_boost_1_81::multiprecision::mpf_float>()
#ifdef BOOST_MATH_NOEXCEPT
    noexcept
#endif
{
   return static_cast<int>(multiprecision::detail::digits10_2_2(zr_boost_1_81::multiprecision::mpf_float::thread_default_precision()));
}
template <>
inline int digits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, zr_boost_1_81::multiprecision::et_off> >()
#ifdef BOOST_MATH_NOEXCEPT
    noexcept
#endif
{
...
template <>
inline zr_boost_1_81::multiprecision::mpf_float
max_value<zr_boost_1_81::multiprecision::mpf_float>()
{
   zr_boost_1_81::multiprecision::mpf_float result(0.5);
...
template <>
inline zr_boost_1_81::multiprecision::mpf_float
min_value<zr_boost_1_81::multiprecision::mpf_float>()
{
   zr_boost_1_81::multiprecision::mpf_float result(0.5);
...
template <>
inline zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, zr_boost_1_81::multiprecision::et_off>
max_value<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, zr_boost_1_81::multiprecision::et_off> >()
{
   zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, zr_boost_1_81::multiprecision::et_off> result(0.5);
   mpf_mul_2exp(result.backend().data(), result.backend().data(), (std::numeric_limits<mp_exp_t>::max)() / 64 + 1);
   return result;
}
...
template <>
inline zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, zr_boost_1_81::multiprecision::et_off>
min_value<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, zr_boost_1_81::multiprecision::et_off> >()
{
   zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, zr_boost_1_81::multiprecision::et_off> result(0.5);
   mpf_div_2exp(result.backend().data(), result.backend().data(), (std::numeric_limits<mp_exp_t>::max)() / 64 + 1);
   return result;
...
template <>
inline int digits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::debug_adaptor<zr_boost_1_81::multiprecision::mpf_float::backend_type> > >()
#ifdef BOOST_MATH_NOEXCEPT
    noexcept
#endif
{
   return static_cast<int>(multiprecision::detail::digits10_2_2(zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::debug_adaptor<zr_boost_1_81::multiprecision::mpf_float::backend_type> >::thread_default_precision()));
}
template <>
inline int digits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::debug_adaptor<zr_boost_1_81::multiprecision::gmp_float<0> >, zr_boost_1_81::multiprecision::et_off> >()
#ifdef BOOST_MATH_NOEXCEPT
    noexcept
#endif
{
...
template <>
inline zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::debug_adaptor<zr_boost_1_81::multiprecision::mpf_float::backend_type> >
max_value<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::debug_adaptor<zr_boost_1_81::multiprecision::mpf_float::backend_type> > >()
{
   return max_value<zr_boost_1_81::multiprecision::mpf_float>().backend();
}

template <>
inline zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::debug_adaptor<zr_boost_1_81::multiprecision::mpf_float::backend_type> >
min_value<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::debug_adaptor<zr_boost_1_81::multiprecision::mpf_float::backend_type> > >()
{
   return min_value<zr_boost_1_81::multiprecision::mpf_float>().backend();
}

template <>
inline zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::debug_adaptor<zr_boost_1_81::multiprecision::gmp_float<0> >, zr_boost_1_81::multiprecision::et_off>
max_value<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::debug_adaptor<zr_boost_1_81::multiprecision::gmp_float<0> >, zr_boost_1_81::multiprecision::et_off> >()
{
   return max_value<zr_boost_1_81::multiprecision::mpf_float>().backend();
}
...
template <>
inline zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::debug_adaptor<zr_boost_1_81::multiprecision::gmp_float<0> >, zr_boost_1_81::multiprecision::et_off>
min_value<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::debug_adaptor<zr_boost_1_81::multiprecision::gmp_float<0> >, zr_boost_1_81::multiprecision::et_off> >()
{
   return min_value<zr_boost_1_81::multiprecision::mpf_float>().backend();
}
...
//
template <unsigned Digits10, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >
{
   using number_type = zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates>;
...
template <unsigned Digits10, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::digits;
template <unsigned Digits10, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::digits10;
template <unsigned Digits10, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::max_digits10;
template <unsigned Digits10, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::is_signed;
template <unsigned Digits10, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::is_integer;
template <unsigned Digits10, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::is_exact;
template <unsigned Digits10, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::radix;
template <unsigned Digits10, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr long numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::min_exponent;
template <unsigned Digits10, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr long numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::min_exponent10;
template <unsigned Digits10, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr long numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::max_exponent;
template <unsigned Digits10, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr long numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::max_exponent10;
template <unsigned Digits10, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::has_infinity;
template <unsigned Digits10, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::has_quiet_NaN;
template <unsigned Digits10, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::has_signaling_NaN;
template <unsigned Digits10, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_denorm_style numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::has_denorm;
template <unsigned Digits10, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::has_denorm_loss;
template <unsigned Digits10, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::is_iec559;
template <unsigned Digits10, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::is_bounded;
template <unsigned Digits10, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::is_modulo;
template <unsigned Digits10, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::traps;
template <unsigned Digits10, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::tinyness_before;
template <unsigned Digits10, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_round_style numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::round_style;

template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >
{
   using number_type = zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates>;
...
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >::digits;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >::digits10;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >::max_digits10;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >::is_signed;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >::is_integer;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >::is_exact;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >::radix;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >::min_exponent;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >::min_exponent10;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >::max_exponent;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >::max_exponent10;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >::has_infinity;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >::has_quiet_NaN;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >::has_signaling_NaN;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_denorm_style numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >::has_denorm;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >::has_denorm_loss;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >::is_iec559;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >::is_bounded;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >::is_modulo;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >::traps;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >::tinyness_before;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_round_style numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >::round_style;

template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates> >
{
   using number_type = zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates>;
...
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates> >::digits;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates> >::digits10;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates> >::max_digits10;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates> >::is_signed;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates> >::is_integer;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates> >::is_exact;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates> >::radix;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates> >::min_exponent;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates> >::min_exponent10;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates> >::max_exponent;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates> >::max_exponent10;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates> >::has_infinity;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates> >::has_quiet_NaN;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates> >::has_signaling_NaN;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_denorm_style numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates> >::has_denorm;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates> >::has_denorm_loss;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates> >::is_iec559;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates> >::is_bounded;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates> >::is_modulo;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates> >::traps;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates> >::tinyness_before;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_round_style numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_int, ExpressionTemplates> >::round_style;

template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates> >
{
   using number_type = zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates>;
...
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates> >::digits;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates> >::digits10;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates> >::max_digits10;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates> >::is_signed;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates> >::is_integer;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates> >::is_exact;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates> >::radix;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates> >::min_exponent;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates> >::min_exponent10;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates> >::max_exponent;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates> >::max_exponent10;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates> >::has_infinity;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates> >::has_quiet_NaN;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates> >::has_signaling_NaN;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_denorm_style numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates> >::has_denorm;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates> >::has_denorm_loss;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates> >::is_iec559;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates> >::is_bounded;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates> >::is_modulo;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates> >::traps;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates> >::tinyness_before;
template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_round_style numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_rational, ExpressionTemplates> >::round_style;
...
namespace Eigen
{
   ...
   template <zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
   struct NumTraitsImp<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates>, zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates> >
   {
      using self_type = zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::gmp_float<0>, ExpressionTemplates>;
      ...
      {
         return zr_boost_1_81::math::tools::max_value<Real>();
      }
      static Real lowest() noexcept
      {
         return zr_boost_1_81::math::tools::min_value<Real>();
      }
