...
template <typename T, unsigned N = 0, 
          bool E = zr_boost_1_81::multiprecision::detail::use_empty_value_base<T>::value>
class empty_value
{
private:
    T value_;
...
public:
    ...
    empty_value() = default;
    explicit empty_value(zr_boost_1_81::multiprecision::detail::empty_init_t) : value_ {} {}

    template <typename U, typename... Args>
    empty_value(zr_boost_1_81::multiprecision::detail::empty_init_t, U&& value, Args&&... args) :
...
public:
    ...
    empty_value() = default;
    explicit empty_value(zr_boost_1_81::multiprecision::detail::empty_init_t) : T{} {}
