...
{
   typename zr_boost_1_81::multiprecision::detail::number_from_backend<T, U>::type t(b);
...
{
   typename zr_boost_1_81::multiprecision::detail::number_from_backend<U, T>::type t(a);
   return eval_eq(t.backend(), b);
}
template <class T, class U>
inline BOOST_MP_CXX14_CONSTEXPR bool eval_eq(const T& a, const U& b)
{
   using tag_type = std::integral_constant<bool, zr_boost_1_81::multiprecision::detail::is_first_backend<T, U>::value>;
