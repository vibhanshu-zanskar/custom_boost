...
inline void pow_imp(T& result, const T& t, const U& p, const std::integral_constant<bool, false>&)
{
   ...
   using int_type = typename zr_boost_1_81::multiprecision::detail::canonical<U, T>::type;
...
inline void pow_imp(T& result, const T& t, const U& p, const std::integral_constant<bool, true>&)
{
   ...
   using int_type = typename zr_boost_1_81::multiprecision::detail::canonical<U, T>::type;
   using ui_type = typename zr_boost_1_81::multiprecision::detail::make_unsigned<U>::type                         ;
...
template <typename T, typename U>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_integral<U>::value>::type eval_pow(T& result, const T& t, const U& p)
{
   detail::pow_imp(result, t, p, zr_boost_1_81::multiprecision::detail::is_signed<U>());
}
...
void hyp0F0(T& H0F0, const T& x)
{
   ...
   long tol = zr_boost_1_81::multiprecision::detail::digits2<number<T, et_on> >::value();
   T    t;
   ...
   const unsigned series_limit =
       zr_boost_1_81::multiprecision::detail::digits2<number<T, et_on> >::value() < 100
           ? 100
           : zr_boost_1_81::multiprecision::detail::digits2<number<T, et_on> >::value();
...
void hyp1F0(T& H1F0, const T& a, const T& x)
{
   ...
   using si_type = typename zr_boost_1_81::multiprecision::detail::canonical<int, T>::type;
   ...
   T lim;
   eval_ldexp(lim, H1F0, 1 - zr_boost_1_81::multiprecision::detail::digits2<number<T, et_on> >::value());
   if (eval_get_sign(lim) < 0)
      lim.negate();
...
void eval_exp(T& result, const T& x)
{
   ...
   using canonical_exp_type = typename zr_boost_1_81::multiprecision::detail::canonical<exp_type, T>::type;
   ...
   if (xx.compare(si_type(1)) <= 0)
   {
      ...
      {
         result = ui_type(1);
         eval_ldexp(lim, result, 1 - zr_boost_1_81::multiprecision::detail::digits2<number<T, et_on> >::value());
      }
      unsigned k = 2;
      exp_series = xx;
      result     = si_type(1);
   ...
   typename zr_boost_1_81::multiprecision::detail::canonical<std::intmax_t, T>::type ll;
...
const T& get_constant_log10()
{
   ...
   if ((digits != zr_boost_1_81::multiprecision::detail::digits2<number<T> >::value()))
   {
      using ui_type = typename zr_boost_1_81::multiprecision::detail::canonical<unsigned, T>::type;
      T                                                                            ten;
      ten = ui_type(10u);
      eval_log(result, ten);
      digits = zr_boost_1_81::multiprecision::detail::digits2<number<T> >::value();
   }
...
inline void eval_pow(T& result, const T& x, const T& a)
{
   ...
   case FP_ZERO:
      ...
      case FP_NORMAL: {
         ...
         BOOST_MP_TRY
         {
            typename zr_boost_1_81::multiprecision::detail::canonical<std::intmax_t, T>::type i;
            eval_convert_to(&i, a);
            if (a.compare(i) == 0)
            {
               if (eval_signbit(a))
   ...
   typename zr_boost_1_81::multiprecision::detail::canonical<std::intmax_t, T>::type an;
   typename zr_boost_1_81::multiprecision::detail::canonical<std::intmax_t, T>::type max_an =
       std::numeric_limits<typename zr_boost_1_81::multiprecision::detail::canonical<std::intmax_t, T>::type>::is_specialized ? (std::numeric_limits<typename zr_boost_1_81::multiprecision::detail::canonical<std::intmax_t, T>::type>::max)() : static_cast<typename zr_boost_1_81::multiprecision::detail::canonical<std::intmax_t, T>::type>(1) << (sizeof(typename zr_boost_1_81::multiprecision::detail::canonical<std::intmax_t, T>::type) * CHAR_BIT - 2);
   typename zr_boost_1_81::multiprecision::detail::canonical<std::intmax_t, T>::type min_an =
       std::numeric_limits<typename zr_boost_1_81::multiprecision::detail::canonical<std::intmax_t, T>::type>::is_specialized ? (std::numeric_limits<typename zr_boost_1_81::multiprecision::detail::canonical<std::intmax_t, T>::type>::min)() : -min_an;
   ...
   {
      typename zr_boost_1_81::multiprecision::detail::canonical<std::uintmax_t, T>::type aun;
      BOOST_MP_TRY
      {
...
inline typename std::enable_if<!zr_boost_1_81::multiprecision::detail::is_integral<A>::value, void>::type
#else
inline typename std::enable_if<is_compatible_arithmetic_type<A, number<T> >::value && !zr_boost_1_81::multiprecision::detail::is_integral<A>::value, void>::type
#endif
...
void eval_exp2(T& result, const T& arg)
{
   ...
   // Check for pure-integer arguments which can be either signed or unsigned.
   typename zr_boost_1_81::multiprecision::detail::canonical<typename T::exponent_type, T>::type i;
   T                                                                                     temp;
   BOOST_MP_TRY
   {
      eval_trunc(temp, arg);
   ...
   BOOST_MP_CATCH(const zr_boost_1_81::math::rounding_error&)
   { /* Fallthrough */
   }
   #endif
...
void small_sinh_series(T x, T& result)
{
   ...
   T lim(x);
   eval_ldexp(lim, lim, 1 - zr_boost_1_81::multiprecision::detail::digits2<number<T, et_on> >::value());
