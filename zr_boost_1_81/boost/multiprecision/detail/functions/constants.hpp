...
const T& get_constant_ln2()
{
   ...
   {
      zr_boost_1_81::multiprecision::detail::maybe_promote_precision(&result);
      calc_log2(result, zr_boost_1_81::multiprecision::detail::digits2<number<T, et_on> >::value());
...
const T& get_constant_e()
{
   ...
   {
      zr_boost_1_81::multiprecision::detail::maybe_promote_precision(&result);
      calc_e(result, zr_boost_1_81::multiprecision::detail::digits2<number<T, et_on> >::value());
      digits = zr_boost_1_81::multiprecision::detail::digits2<number<T> >::value();
   }
...
const T& get_constant_pi()
{
   ...
   {
      zr_boost_1_81::multiprecision::detail::maybe_promote_precision(&result);
      calc_pi(result, zr_boost_1_81::multiprecision::detail::digits2<number<T, et_on> >::value());
      digits = zr_boost_1_81::multiprecision::detail::digits2<number<T> >::value();
   }
...
const T& get_constant_one_over_epsilon()
{
   ...
   if ((digits != zr_boost_1_81::multiprecision::detail::digits2<number<T> >::value()))
   {
      ...
      BOOST_IF_CONSTEXPR(std::numeric_limits<number<T> >::is_specialized)
         ...
         eval_ldexp(result, result, zr_boost_1_81::multiprecision::detail::digits2<number<T> >::value() - 1);
      digits = zr_boost_1_81::multiprecision::detail::digits2<number<T> >::value();
   }
