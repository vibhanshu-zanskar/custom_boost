...
{
    return zr_boost_1_81::math::lltrunc(arg);
}

template <typename T>
inline int itrunc BOOST_PREVENT_MACRO_SUBSTITUTION (const T arg)
{
    return zr_boost_1_81::math::itrunc(arg);
}
...
inline long long lltrunc BOOST_PREVENT_MACRO_SUBSTITUTION (const T arg)
{
    ...
    return static_cast<long long>(zr_boost_1_81::multiprecision::detail::impl::trunc(arg));
}
...
inline int itrunc BOOST_PREVENT_MACRO_SUBSTITUTION (const T arg)
{
    ...
    return static_cast<int>(zr_boost_1_81::multiprecision::detail::impl::trunc(arg));
}
