...
inline constexpr unsigned current_precision_of_last_chance_imp(const zr_boost_1_81::multiprecision::number<B, ET>&, const std::integral_constant<int, 0>&)
{
   return std::numeric_limits<zr_boost_1_81::multiprecision::number<B, ET> >::digits10;
}
template <class B, zr_boost_1_81::multiprecision::expression_template_option ET>
inline BOOST_MP_CXX14_CONSTEXPR unsigned current_precision_of_last_chance_imp(const zr_boost_1_81::multiprecision::number<B, ET>& val, const std::integral_constant<int, 1>&)
{
   //
...
template <class B, zr_boost_1_81::multiprecision::expression_template_option ET>
inline BOOST_MP_CXX14_CONSTEXPR unsigned current_precision_of_last_chance_imp(const zr_boost_1_81::multiprecision::number<B, ET>& val, const std::integral_constant<int, 2>&)
{
   //
...
template <class B, zr_boost_1_81::multiprecision::expression_template_option ET>
inline BOOST_MP_CXX14_CONSTEXPR unsigned current_precision_of_imp(const zr_boost_1_81::multiprecision::number<B, ET>& n, const std::integral_constant<bool, true>&)
{
   return n.precision();
}
template <class B, zr_boost_1_81::multiprecision::expression_template_option ET>
inline constexpr unsigned current_precision_of_imp(const zr_boost_1_81::multiprecision::number<B, ET>& val, const std::integral_constant<bool, false>&)
{
   using tag = std::integral_constant<int,
                                      std::numeric_limits<zr_boost_1_81::multiprecision::number<B, ET> >::is_specialized &&
                                              std::numeric_limits<zr_boost_1_81::multiprecision::number<B, ET> >::is_integer &&
                                              std::numeric_limits<zr_boost_1_81::multiprecision::number<B, ET> >::is_exact &&
                                              !std::numeric_limits<zr_boost_1_81::multiprecision::number<B, ET> >::is_modulo
                                          ? 1
                                      : zr_boost_1_81::multiprecision::number_category<zr_boost_1_81::multiprecision::number<B, ET> >::value == zr_boost_1_81::multiprecision::number_kind_rational ? 2
                                                                                                                                                                            : 0>;
...
inline constexpr unsigned current_precision_of_imp(const zr_boost_1_81::multiprecision::number<B, ET>& n, const std::true_type&)
{
   return std::is_same<R, zr_boost_1_81::multiprecision::number<B, ET> >::value 
      || (std::is_same<typename R::value_type, zr_boost_1_81::multiprecision::number<B, ET> >::value && (R::thread_default_variable_precision_options() >= variable_precision_options::preserve_component_precision))
      || (R::thread_default_variable_precision_options() >= variable_precision_options::preserve_all_precision) 
      ? current_precision_of_imp(n, zr_boost_1_81::multiprecision::detail::is_variable_precision<zr_boost_1_81::multiprecision::number<B, ET> >()) : 0;
}
template <class R, class B, zr_boost_1_81::multiprecision::expression_template_option ET>
inline constexpr unsigned current_precision_of_imp(const zr_boost_1_81::multiprecision::number<B, ET>& n, const std::false_type&)
{
   return std::is_same<R, zr_boost_1_81::multiprecision::number<B, ET> >::value 
      || std::is_same<typename R::value_type, zr_boost_1_81::multiprecision::number<B, ET> >::value
      ? current_precision_of_imp(n, zr_boost_1_81::multiprecision::detail::is_variable_precision<zr_boost_1_81::multiprecision::number<B, ET> >()) : 0;
}

template <class R, class B, zr_boost_1_81::multiprecision::expression_template_option ET>
inline constexpr unsigned current_precision_of(const zr_boost_1_81::multiprecision::number<B, ET>& n)
{
   return current_precision_of_imp<R>(n, zr_boost_1_81::multiprecision::detail::is_variable_precision<R>());
}
...
template <class R, bool = zr_boost_1_81::multiprecision::detail::is_variable_precision<R>::value>
...
struct scoped_default_precision<R, true>
{
   ...
   {
      return R::thread_default_variable_precision_options() <= zr_boost_1_81::multiprecision::variable_precision_options::assume_uniform_precision;
   }
...
{
   maybe_promote_precision(obj, std::integral_constant<bool, zr_boost_1_81::multiprecision::detail::is_variable_precision<T>::value>());
}

#ifndef BOOST_NO_CXX17_IF_CONSTEXPR
#define BOOST_MP_CONSTEXPR_IF_VARIABLE_PRECISION(T) \
   if                                               \
   constexpr(zr_boost_1_81::multiprecision::detail::is_variable_precision<T>::value)
#else
#define BOOST_MP_CONSTEXPR_IF_VARIABLE_PRECISION(T) if (zr_boost_1_81::multiprecision::detail::is_variable_precision<T>::value)
#endif

template <class T, bool = zr_boost_1_81::multiprecision::detail::is_variable_precision<T>::value>
...
struct scoped_precision_options
{
   ...
   zr_boost_1_81::multiprecision::variable_precision_options saved_options;
