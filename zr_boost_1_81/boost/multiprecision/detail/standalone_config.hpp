...
namespace zr_boost_1_81 { namespace multiprecision {
   using int128_type = zr_boost_1_81::int128_type;
   using uint128_type = zr_boost_1_81::uint128_type;
}}
#endif
#if defined(BOOST_HAS_FLOAT128) && defined(__cplusplus)
namespace zr_boost_1_81 { namespace multiprecision {
   using float128_type = zr_boost_1_81::float128_type;
}}
#endif
...
#  ifndef INT128_MAX
#    define INT128_MAX static_cast<zr_boost_1_81::multiprecision::int128_type>((static_cast<zr_boost_1_81::multiprecision::uint128_type>(1) << ((__SIZEOF_INT128__ * __CHAR_BIT__) - 1)) - 1)
#  endif
#  ifndef INT128_MIN
#    define INT128_MIN (-INT128_MAX - 1)
#  endif
#  ifndef UINT128_MAX
#    define UINT128_MAX ((2 * static_cast<zr_boost_1_81::multiprecision::uint128_type>(INT128_MAX)) + 1)
#  endif
#endif
