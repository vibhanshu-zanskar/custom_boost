...
{
    using type = typename zr_boost_1_81::multiprecision::detail::make_unsigned<T>::type;
};
...
{
    using type = typename make_unsigned_impl<T, zr_boost_1_81::multiprecision::detail::is_integral<T>::value>::type;
};

template <typename Engine, typename T>
T generate_uniform_int (Engine& eng, T min_value, T max_value)
{
    using range_type = typename zr_boost_1_81::multiprecision::detail::make_unsigned_mp<T>::type;
    using base_result = typename Engine::result_type;
    using base_unsigned = typename zr_boost_1_81::multiprecision::detail::make_unsigned_mp<base_result>::type;
