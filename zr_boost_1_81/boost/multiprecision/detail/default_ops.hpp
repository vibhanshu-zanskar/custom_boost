...
template <class T>
BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_backend<T>::value, int>::type eval_signbit(const T& val);

template <class T>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<!zr_boost_1_81::multiprecision::detail::is_backend<T>::value, int>::type eval_signbit(const T& val) { return val < 0; }
...
inline BOOST_MP_CXX14_CONSTEXPR void assign_components_imp2(T& result, const V& v1, const U& v2, const std::false_type&, const std::false_type&)
{
   ...
   zr_boost_1_81::multiprecision::detail::scoped_precision_options<component_number_type> sp(result);
   (void)sp;
...
{
   zr_boost_1_81::multiprecision::detail::scoped_source_precision<number<V>> scope;
   (void)scope;
...
{
   zr_boost_1_81::multiprecision::detail::scoped_source_precision<number<V>> scope1;
   zr_boost_1_81::multiprecision::detail::scoped_source_precision<number<U>> scope2;
   (void)scope1;
   (void)scope2;
...
{
   zr_boost_1_81::multiprecision::detail::scoped_source_precision<number<U>> scope;
   (void)scope;
...
{
   assign_components_imp2(result, v1, v2, zr_boost_1_81::multiprecision::detail::is_backend<V>(), zr_boost_1_81::multiprecision::detail::is_backend<U>());
}
...
struct calculate_next_larger_type
{
   ...
   using list_type = typename std::conditional<
       zr_boost_1_81::multiprecision::detail::is_signed<R>::value && zr_boost_1_81::multiprecision::detail::is_integral<R>::value,
       typename B::signed_types,
       typename std::conditional<
           zr_boost_1_81::multiprecision::detail::is_unsigned<R>::value,
   ...
   static constexpr int index_of_type = zr_boost_1_81::multiprecision::detail::find_index_of_large_enough_type<list_type, start == INT_MAX ? 0 : start + 1, zr_boost_1_81::multiprecision::detail::bits_of<R>::value> ::value;
   using type = typename zr_boost_1_81::multiprecision::detail::dereference_tuple<index_of_type, list_type, terminal<R> >::type;
};

template <class R, class T>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_integral<R>::value, bool>::type check_in_range(const T& t)
{
   // Can t fit in an R?
...
template <class R, class B>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_integral<R>::value>::type eval_convert_to(R* result, const B& backend)
{
   using next_type = typename calculate_next_larger_type<R, B>::type;
   next_type                                               n = next_type();
   eval_convert_to(&n, backend);
   BOOST_IF_CONSTEXPR(!zr_boost_1_81::multiprecision::detail::is_unsigned<R>::value && std::numeric_limits<R>::is_specialized && std::numeric_limits<R>::is_bounded)
   {
...
template <class R, class B>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if< !zr_boost_1_81::multiprecision::detail::is_integral<R>::value && !std::is_enum<R>::value>::type eval_convert_to(R* result, const B& backend)
{
   using next_type = typename calculate_next_larger_type<R, B>::type;
   next_type                                               n = next_type();
   eval_convert_to(&n, backend);
...
inline void last_chance_eval_convert_to(terminal<R>* result, const B& backend, const std::integral_constant<bool, false>&)
{
   ...
   BOOST_MP_TRY {
      result->value = zr_boost_1_81::lexical_cast<R>(backend.str(0, std::ios_base::fmtflags(0)));
   }
...
inline void last_chance_eval_convert_to(terminal<R>* result, const B& backend, const std::integral_constant<bool, true>&)
{
   ...
   BOOST_MP_TRY {
      ...
      result->value = zr_boost_1_81::lexical_cast<R>(t.str(0, std::ios_base::fmtflags(0)));
   }
   BOOST_MP_CATCH (const bad_lexical_cast&)
   {
...
{
   using tag_type = std::integral_constant<bool, zr_boost_1_81::multiprecision::detail::is_unsigned<R>::value && number_category<B>::value == number_kind_integer>;
...
inline BOOST_MP_CXX14_CONSTEXPR void eval_convert_to(terminal<number<B1, et> >* result, const B2& backend)
{
   ...
   //
   zr_boost_1_81::multiprecision::detail::generic_interconvert(result->value.backend(), backend, number_category<B1>(), number_category<B2>());
}
...
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_arithmetic<A>::value, void>::type eval_fmod(T& result, const T& x, const A& a)
{
   using canonical_type = typename zr_boost_1_81::multiprecision::detail::canonical<A, T>::type         ;
...
template <class T, class A>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_arithmetic<A>::value, void>::type eval_fmod(T& result, const A& x, const T& a)
{
   using canonical_type = typename zr_boost_1_81::multiprecision::detail::canonical<A, T>::type         ;
   using cast_type = typename std::conditional<std::is_same<A, canonical_type>::value, T, canonical_type>::type;
   cast_type                                                                      c;
...
template <class T, class A>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_arithmetic<A>::value, void>::type eval_remquo(T& result, const T& x, const A& a, int* pi)
{
   using canonical_type = typename zr_boost_1_81::multiprecision::detail::canonical<A, T>::type         ;
   using cast_type = typename std::conditional<std::is_same<A, canonical_type>::value, T, canonical_type>::type;
...
template <class T, class A>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_arithmetic<A>::value, void>::type eval_remquo(T& result, const A& x, const T& a, int* pi)
{
   using canonical_type = typename zr_boost_1_81::multiprecision::detail::canonical<A, T>::type         ;
   using cast_type = typename std::conditional<std::is_same<A, canonical_type>::value, T, canonical_type>::type;
   cast_type                                                                      c = cast_type();
...
{
   using ui_type = typename zr_boost_1_81::multiprecision::detail::canonical<unsigned, T>::type;
...
template <class T, class A>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_arithmetic<A>::value>::type eval_fdim(T& result, const T& a, const A& b)
{
   using ui_type = typename zr_boost_1_81::multiprecision::detail::canonical<unsigned, T>::type;
   using arithmetic_type = typename zr_boost_1_81::multiprecision::detail::canonical<A, T>::type       ;
   const ui_type                                                                zero        = 0u;
...
template <class T, class A>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_arithmetic<A>::value>::type eval_fdim(T& result, const A& a, const T& b)
{
   using ui_type = typename zr_boost_1_81::multiprecision::detail::canonical<unsigned, T>::type;
   using arithmetic_type = typename zr_boost_1_81::multiprecision::detail::canonical<A, T>::type       ;
   const ui_type                                                                zero        = 0u;
...
inline BOOST_MP_CXX14_CONSTEXPR void eval_round(T& result, const T& a)
{
   ...
   using fp_type = typename zr_boost_1_81::multiprecision::detail::canonical<float, T>::type;
...
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_integral<Arithmetic>::value >::type eval_gcd(T& result, const T& a, const Arithmetic& b)
{
   using si_type = typename zr_boost_1_81::multiprecision::detail::canonical<Arithmetic, T>::type;
...
template <class T, class Arithmetic>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_integral<Arithmetic>::value >::type eval_gcd(T& result, const Arithmetic& a, const T& b)
{
   eval_gcd(result, b, a);
}
template <class T, class Arithmetic>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_integral<Arithmetic>::value >::type eval_lcm(T& result, const T& a, const Arithmetic& b)
{
   using si_type = typename zr_boost_1_81::multiprecision::detail::canonical<Arithmetic, T>::type;
...
template <class T, class Arithmetic>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_integral<Arithmetic>::value >::type eval_lcm(T& result, const Arithmetic& a, const T& b)
{
   eval_lcm(result, b, a);
}
...
BOOST_MP_CXX14_CONSTEXPR void eval_karatsuba_sqrt(Backend& result, const Backend& x, Backend& r, Backend& t, size_t bits)
{
   ...
   if (bits <= 128)
   {
      uint128_type a{}, b{}, c{};
      eval_convert_to(&a, x);
      c = zr_boost_1_81::multiprecision::detail::karatsuba_sqrt(a, b, bits);
...
void BOOST_MP_CXX14_CONSTEXPR eval_integer_sqrt_bitwise(B& s, B& r, const B& x)
{
   ...
   // at some point.
   //
   using ui_type = typename zr_boost_1_81::multiprecision::detail::canonical<unsigned char, B>::type;
...
{
   return is_arg_nan(val, std::integral_constant<bool, zr_boost_1_81::multiprecision::detail::is_backend<T>::value>(), std::is_floating_point<T>());
}
...
template <class T>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_backend<T>::value, int>::type eval_signbit(const T& val)
{
...
{
   return (zr_boost_1_81::multiprecision::signbit)(a) != (zr_boost_1_81::multiprecision::signbit)(b) ? (zr_boost_1_81::multiprecision::changesign)(a) : a;
}
...
real(const multiprecision::number<Backend, ExpressionTemplates>& a)
{
   ...
   zr_boost_1_81::multiprecision::detail::scoped_default_precision<result_type>                                              precision_guard(a);
   result_type                                                                                                       result;
...
{
   return std::move(zr_boost_1_81::math::hypot(real(v), imag(v)));
}
template <class tag, class A1, class A2, class A3, class A4>
...
BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_arithmetic<Scalar>::value, typename complex_result_from_scalar<number<Backend, ExpressionTemplates> >::type>::type
...
BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_arithmetic<Scalar>::value,
                     typename complex_result_from_scalar<typename detail::expression<tag, A1, A2, A3, A4>::result_type>::type>::type
...
//
using zr_boost_1_81::multiprecision::changesign;
using zr_boost_1_81::multiprecision::copysign;
using zr_boost_1_81::multiprecision::fpclassify;
using zr_boost_1_81::multiprecision::isfinite;
using zr_boost_1_81::multiprecision::isinf;
using zr_boost_1_81::multiprecision::isnan;
using zr_boost_1_81::multiprecision::isnormal;
using zr_boost_1_81::multiprecision::sign;
...
namespace multiprecision {
#ifdef BOOST_MP_MATH_AVAILABLE
using c99_error_policy = ::zr_boost_1_81::math::policies::policy<
    ::zr_boost_1_81::math::policies::domain_error< ::zr_boost_1_81::math::policies::errno_on_error>,
    ::zr_boost_1_81::math::policies::pole_error< ::zr_boost_1_81::math::policies::errno_on_error>,
    ::zr_boost_1_81::math::policies::overflow_error< ::zr_boost_1_81::math::policies::errno_on_error>,
    ::zr_boost_1_81::math::policies::evaluation_error< ::zr_boost_1_81::math::policies::errno_on_error>,
    ::zr_boost_1_81::math::policies::rounding_error< ::zr_boost_1_81::math::policies::errno_on_error> >;
    ...
    BOOST_PREVENT_MACRO_SUBSTITUTION(const multiprecision::number<Backend, ExpressionTemplates>& arg)
{
   ...
   return zr_boost_1_81::math::asinh(arg, c99_error_policy());
}
template <class tag, class A1, class A2, class A3, class A4>
...
{
   detail::scoped_default_precision<multiprecision::number<Backend, ExpressionTemplates> > precision_guard(arg);
   return zr_boost_1_81::math::acosh(arg, c99_error_policy());
}
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<number_category<typename multiprecision::detail::expression<tag, A1, A2, A3, A4>::result_type>::value != number_kind_complex, typename multiprecision::detail::expression<tag, A1, A2, A3, A4>::result_type>::type
    acosh
...
{
   detail::scoped_default_precision<multiprecision::number<Backend, ExpressionTemplates> > precision_guard(arg);
   return zr_boost_1_81::math::atanh(arg, c99_error_policy());
}
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<number_category<typename multiprecision::detail::expression<tag, A1, A2, A3, A4>::result_type>::value != number_kind_complex, typename multiprecision::detail::expression<tag, A1, A2, A3, A4>::result_type>::type
    atanh
...
{
   detail::scoped_default_precision<multiprecision::number<Backend, ExpressionTemplates> > precision_guard(arg);
   return zr_boost_1_81::math::cbrt(arg, c99_error_policy());
}
template <class tag, class A1, class A2, class A3, class A4>
...
{
   detail::scoped_default_precision<multiprecision::number<Backend, ExpressionTemplates> > precision_guard(arg);
   return zr_boost_1_81::math::erf(arg, c99_error_policy());
}
template <class tag, class A1, class A2, class A3, class A4>
...
{
   detail::scoped_default_precision<multiprecision::number<Backend, ExpressionTemplates> > precision_guard(arg);
   return zr_boost_1_81::math::erfc(arg, c99_error_policy());
}
template <class tag, class A1, class A2, class A3, class A4>
...
{
   detail::scoped_default_precision<multiprecision::number<Backend, ExpressionTemplates> > precision_guard(arg);
   return zr_boost_1_81::math::expm1(arg, c99_error_policy());
}
template <class tag, class A1, class A2, class A3, class A4>
...
inline BOOST_MP_CXX14_CONSTEXPR multiprecision::number<Backend, ExpressionTemplates> lgamma BOOST_PREVENT_MACRO_SUBSTITUTION(const multiprecision::number<Backend, ExpressionTemplates>& arg)
{
   ...
   result = zr_boost_1_81::math::lgamma(arg, c99_error_policy());
   if ((zr_boost_1_81::multiprecision::isnan)(result) && !(zr_boost_1_81::multiprecision::isnan)(arg))
   {
...
inline BOOST_MP_CXX14_CONSTEXPR multiprecision::number<Backend, ExpressionTemplates> tgamma BOOST_PREVENT_MACRO_SUBSTITUTION(const multiprecision::number<Backend, ExpressionTemplates>& arg)
{
   ...
   return zr_boost_1_81::math::tgamma(arg, c99_error_policy());
}
template <class tag, class A1, class A2, class A3, class A4>
...
{
   detail::scoped_default_precision<multiprecision::number<Backend, ExpressionTemplates> > precision_guard(arg);
   return zr_boost_1_81::math::log1p(arg, c99_error_policy());
}
template <class tag, class A1, class A2, class A3, class A4>
...
inline BOOST_MP_CXX14_CONSTEXPR multiprecision::number<Backend, ExpressionTemplates> nextafter BOOST_PREVENT_MACRO_SUBSTITUTION(const multiprecision::number<Backend, ExpressionTemplates>& a, const multiprecision::number<Backend, ExpressionTemplates>& b)
{
   ...
   return zr_boost_1_81::math::nextafter(a, b, c99_error_policy());
}
template <class Backend, multiprecision::expression_template_option ExpressionTemplates, class tag, class A1, class A2, class A3, class A4>
...
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_integral<I>::value, number<B, ET>&>::type
...
inline BOOST_MP_CXX14_CONSTEXPR int itrunc(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   ...
   if ((r > (std::numeric_limits<int>::max)()) || r < (std::numeric_limits<int>::min)() || !BOOST_MP_ISFINITE(v))
      return zr_boost_1_81::math::policies::raise_rounding_error("zr_boost_1_81::multiprecision::itrunc<%1%>(%1%)", nullptr, number_type(v), 0, pol);
   return r.template convert_to<int>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR int itrunc(const detail::expression<tag, A1, A2, A3, A4>& v)
{
   return itrunc(v, zr_boost_1_81::math::policies::policy<>());
}
template <class Backend, expression_template_option ExpressionTemplates, class Policy>
inline BOOST_MP_CXX14_CONSTEXPR int itrunc(const number<Backend, ExpressionTemplates>& v, const Policy& pol)
{
   ...
   if ((r > (std::numeric_limits<int>::max)()) || r < (std::numeric_limits<int>::min)() || !BOOST_MP_ISFINITE(v))
      return zr_boost_1_81::math::policies::raise_rounding_error("zr_boost_1_81::multiprecision::itrunc<%1%>(%1%)", nullptr, v, 0, pol);
   return r.template convert_to<int>();
}
template <class Backend, expression_template_option ExpressionTemplates>
...
inline BOOST_MP_CXX14_CONSTEXPR long ltrunc(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   ...
   if ((r > (std::numeric_limits<long>::max)()) || r < (std::numeric_limits<long>::min)() || !BOOST_MP_ISFINITE(v))
      return zr_boost_1_81::math::policies::raise_rounding_error("zr_boost_1_81::multiprecision::ltrunc<%1%>(%1%)", nullptr, number_type(v), 0L, pol);
   return r.template convert_to<long>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR long ltrunc(const detail::expression<tag, A1, A2, A3, A4>& v)
{
   return ltrunc(v, zr_boost_1_81::math::policies::policy<>());
}
...
inline BOOST_MP_CXX14_CONSTEXPR long ltrunc(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   ...
   if ((r > (std::numeric_limits<long>::max)()) || r < (std::numeric_limits<long>::min)() || !BOOST_MP_ISFINITE(v))
      return zr_boost_1_81::math::policies::raise_rounding_error("zr_boost_1_81::multiprecision::ltrunc<%1%>(%1%)", nullptr, v, 0L, pol);
   return r.template convert_to<long>();
}
template <class T, expression_template_option ExpressionTemplates>
...
inline BOOST_MP_CXX14_CONSTEXPR long long lltrunc(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   ...
   if ((r > (std::numeric_limits<long long>::max)()) || r < (std::numeric_limits<long long>::min)() || !BOOST_MP_ISFINITE(v))
      return zr_boost_1_81::math::policies::raise_rounding_error("zr_boost_1_81::multiprecision::lltrunc<%1%>(%1%)", nullptr, number_type(v), 0LL, pol);
...
{
   return lltrunc(v, zr_boost_1_81::math::policies::policy<>());
}
template <class T, expression_template_option ExpressionTemplates, class Policy>
inline BOOST_MP_CXX14_CONSTEXPR long long lltrunc(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   number<T, ExpressionTemplates> r(trunc(v, pol));
   if ((r > (std::numeric_limits<long long>::max)()) || r < (std::numeric_limits<long long>::min)() || !BOOST_MP_ISFINITE(v))
      return zr_boost_1_81::math::policies::raise_rounding_error("zr_boost_1_81::multiprecision::lltrunc<%1%>(%1%)", nullptr, v, 0LL, pol);
   return r.template convert_to<long long>();
}
template <class T, expression_template_option ExpressionTemplates>
...
inline BOOST_MP_CXX14_CONSTEXPR int iround(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   ...
   if ((r > (std::numeric_limits<int>::max)()) || r < (std::numeric_limits<int>::min)() || !BOOST_MP_ISFINITE(v))
      return zr_boost_1_81::math::policies::raise_rounding_error("zr_boost_1_81::multiprecision::iround<%1%>(%1%)", nullptr, number_type(v), 0, pol);
   return r.template convert_to<int>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR int iround(const detail::expression<tag, A1, A2, A3, A4>& v)
{
   return iround(v, zr_boost_1_81::math::policies::policy<>());
}
template <class T, expression_template_option ExpressionTemplates, class Policy>
inline BOOST_MP_CXX14_CONSTEXPR int iround(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   ...
   if ((r > (std::numeric_limits<int>::max)()) || r < (std::numeric_limits<int>::min)() || !BOOST_MP_ISFINITE(v))
      return zr_boost_1_81::math::policies::raise_rounding_error("zr_boost_1_81::multiprecision::iround<%1%>(%1%)", nullptr, v, 0, pol);
   return r.template convert_to<int>();
}
template <class T, expression_template_option ExpressionTemplates>
...
inline BOOST_MP_CXX14_CONSTEXPR long lround(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   ...
   number_type                                                           r(round(v, pol));
   if ((r > (std::numeric_limits<long>::max)()) || r < (std::numeric_limits<long>::min)() || !BOOST_MP_ISFINITE(v))
      return zr_boost_1_81::math::policies::raise_rounding_error("zr_boost_1_81::multiprecision::lround<%1%>(%1%)", nullptr, number_type(v), 0L, pol);
   return r.template convert_to<long>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR long lround(const detail::expression<tag, A1, A2, A3, A4>& v)
{
   return lround(v, zr_boost_1_81::math::policies::policy<>());
}
template <class T, expression_template_option ExpressionTemplates, class Policy>
inline BOOST_MP_CXX14_CONSTEXPR long lround(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   number<T, ExpressionTemplates> r(round(v, pol));
   if ((r > (std::numeric_limits<long>::max)()) || r < (std::numeric_limits<long>::min)() || !BOOST_MP_ISFINITE(v))
      return zr_boost_1_81::math::policies::raise_rounding_error("zr_boost_1_81::multiprecision::lround<%1%>(%1%)", nullptr, v, 0L, pol);
   return r.template convert_to<long>();
}
template <class T, expression_template_option ExpressionTemplates>
...
inline BOOST_MP_CXX14_CONSTEXPR long long llround(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   ...
   number_type                                                           r(round(v, pol));
   if ((r > (std::numeric_limits<long long>::max)()) || r < (std::numeric_limits<long long>::min)() || !BOOST_MP_ISFINITE(v))
      return zr_boost_1_81::math::policies::raise_rounding_error("zr_boost_1_81::multiprecision::iround<%1%>(%1%)", nullptr, number_type(v), 0LL, pol);
   return r.template convert_to<long long>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR long long llround(const detail::expression<tag, A1, A2, A3, A4>& v)
{
   return llround(v, zr_boost_1_81::math::policies::policy<>());
}
template <class T, expression_template_option ExpressionTemplates, class Policy>
inline BOOST_MP_CXX14_CONSTEXPR long long llround(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   number<T, ExpressionTemplates> r(round(v, pol));
   if ((r > (std::numeric_limits<long long>::max)()) || r < (std::numeric_limits<long long>::min)() || !BOOST_MP_ISFINITE(v))
      return zr_boost_1_81::math::policies::raise_rounding_error("zr_boost_1_81::multiprecision::iround<%1%>(%1%)", nullptr, v, 0LL, pol);
   return r.template convert_to<long long>();
}
template <class T, expression_template_option ExpressionTemplates>
...
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<
        ...
        (is_number<U>::value || is_number_expression<U>::value || zr_boost_1_81::multiprecision::detail::is_arithmetic<U>::value) &&
        (is_number<V>::value || is_number_expression<V>::value || zr_boost_1_81::multiprecision::detail::is_arithmetic<V>::value),
...
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<
        (number_category<number<Backend, et_on> >::value == number_kind_floating_point) &&
        zr_boost_1_81::multiprecision::detail::is_arithmetic<U>::value &&
        (is_number<V>::value || is_number_expression<V>::value || zr_boost_1_81::multiprecision::detail::is_arithmetic<V>::value),
...
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<
        (number_category<number<Backend, et_on> >::value == number_kind_floating_point) &&
        zr_boost_1_81::multiprecision::detail::is_arithmetic<U>::value &&
        zr_boost_1_81::multiprecision::detail::is_arithmetic<V>::value,
...
#define UNARY_OP_FUNCTOR(func, category)                                                                                                                                                                  \
   ...
   template <class Backend>                                                                                                                                                                               \
   inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<                                                                                                                                                                    \
       zr_boost_1_81::multiprecision::number_category<Backend>::value == category,                                                                                                                                \
       number<Backend, et_off> >::type                                                                                                                                                                    \
...
{
   zr_boost_1_81::multiprecision::detail::scoped_default_precision<multiprecision::number<Backend, ExpressionTemplates> > precision_guard(x);
...
{
   zr_boost_1_81::multiprecision::detail::scoped_default_precision<multiprecision::number<Backend, ExpressionTemplates> > precision_guard(x);
   return std::move(zr_boost_1_81::math::sinhc_pi(x));
}

using zr_boost_1_81::multiprecision::gcd;
using zr_boost_1_81::multiprecision::lcm;
