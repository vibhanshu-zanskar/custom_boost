...
inline BOOST_MP_CXX14_CONSTEXPR Integer eval_integer_modulus(const Backend& x, Integer val)
{
   ...
   using int_type = typename zr_boost_1_81::multiprecision::detail::canonical<Integer, Backend>::type;
   Backend                                                                           t;
...
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_integral<Integer>::value && (number_category<Backend>::value == number_kind_integer), Integer>::type
...
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_integral<Integer>::value && (number_category<typename multiprecision::detail::expression<tag, A1, A2, A3, A4>::result_type>::value == number_kind_integer), Integer>::type
...
BOOST_MP_CXX14_CONSTEXPR void eval_powm(Backend& result, const Backend& a, const Backend& p, const Backend& c)
{
   ...
   using ui_type = typename zr_boost_1_81::multiprecision::detail::canonical<unsigned char, double_type>::type;
...
BOOST_MP_CXX14_CONSTEXPR void eval_powm(Backend& result, const Backend& a, const Backend& p, Integer c)
{
   using double_type = typename double_precision_type<Backend>::type                                      ;
   using ui_type = typename zr_boost_1_81::multiprecision::detail::canonical<unsigned char, double_type>::type;
   using i1_type = typename zr_boost_1_81::multiprecision::detail::canonical<Integer, double_type>::type      ;
   using i2_type = typename zr_boost_1_81::multiprecision::detail::canonical<Integer, Backend>::type          ;
...
template <class Backend, class Integer>
BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_unsigned<Integer>::value >::type eval_powm(Backend& result, const Backend& a, Integer b, const Backend& c)
{
   using double_type = typename double_precision_type<Backend>::type                                      ;
   using ui_type = typename zr_boost_1_81::multiprecision::detail::canonical<unsigned char, double_type>::type;
...
template <class Backend, class Integer>
BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_signed<Integer>::value && zr_boost_1_81::multiprecision::detail::is_integral<Integer>::value>::type eval_powm(Backend& result, const Backend& a, Integer b, const Backend& c)
{
   if (b < 0)
   {
      BOOST_MP_THROW_EXCEPTION(std::runtime_error("powm requires a positive exponent."));
   }
   eval_powm(result, a, static_cast<typename zr_boost_1_81::multiprecision::detail::make_unsigned<Integer>::type>(b), c);
}

template <class Backend, class Integer1, class Integer2>
BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_unsigned<Integer1>::value >::type eval_powm(Backend& result, const Backend& a, Integer1 b, Integer2 c)
{
   using double_type = typename double_precision_type<Backend>::type                                      ;
   using ui_type = typename zr_boost_1_81::multiprecision::detail::canonical<unsigned char, double_type>::type;
   using i1_type = typename zr_boost_1_81::multiprecision::detail::canonical<Integer1, double_type>::type     ;
   using i2_type = typename zr_boost_1_81::multiprecision::detail::canonical<Integer2, Backend>::type         ;
...
template <class Backend, class Integer1, class Integer2>
BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_signed<Integer1>::value && zr_boost_1_81::multiprecision::detail::is_integral<Integer1>::value>::type eval_powm(Backend& result, const Backend& a, Integer1 b, Integer2 c)
{
   if (b < 0)
   {
      BOOST_MP_THROW_EXCEPTION(std::runtime_error("powm requires a positive exponent."));
   }
   eval_powm(result, a, static_cast<typename zr_boost_1_81::multiprecision::detail::make_unsigned<Integer1>::type>(b), c);
}
...
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<
        ...
        (is_number<U>::value || is_number_expression<U>::value || zr_boost_1_81::multiprecision::detail::is_integral<U>::value) &&
        (is_number<V>::value || is_number_expression<V>::value || zr_boost_1_81::multiprecision::detail::is_integral<V>::value),
