...
class number
{
 ...
 public:
   ...
   BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR number(const V& v, 
      ...
      (zr_boost_1_81::multiprecision::detail::is_convertible_arithmetic<V, Backend>::value 
   ...
   BOOST_MP_FORCEINLINE constexpr number(const V& v, U digits10, 
      ...
      && (zr_boost_1_81::multiprecision::number_category<Backend>::value != zr_boost_1_81::multiprecision::number_kind_complex) 
      && (zr_boost_1_81::multiprecision::number_category<Backend>::value != zr_boost_1_81::multiprecision::number_kind_rational)
   ...
   explicit BOOST_MP_FORCEINLINE constexpr number(const V& v, typename std::enable_if<
       ...
       : m_backend(canonical_value(v)) {}
   template <class V>
   explicit BOOST_MP_FORCEINLINE constexpr number(const V& v, unsigned digits10, typename std::enable_if<(zr_boost_1_81::multiprecision::detail::is_arithmetic<V>::value || std::is_same<std::string, V>::value || std::is_convertible<V, const char*>::value) && detail::is_restricted_conversion<typename detail::canonical<V, Backend>::type, Backend>::value && (zr_boost_1_81::multiprecision::number_category<Backend>::value != zr_boost_1_81::multiprecision::number_kind_complex) && (zr_boost_1_81::multiprecision::number_category<Backend>::value != zr_boost_1_81::multiprecision::number_kind_rational)>::type* = nullptr)
                                                     ...
                                                     (!detail::is_explicitly_convertible<Other, Backend>::value)>::type* = nullptr)
   {
      ...
      {
         if (precision_guard_1.precision() != zr_boost_1_81::multiprecision::detail::current_precision_of<self_type>(*this))
         {
            self_type t;
   ...
   BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR number(const V& v1, const U& v2,
      typename std::enable_if<
         (std::is_convertible<V, value_type>::value
            ...
            && !zr_boost_1_81::multiprecision::detail::is_variable_precision<Backend>::value)>::type* = nullptr)
               ...
               || zr_boost_1_81::multiprecision::detail::is_variable_precision<Backend>::value))>::type* = nullptr)
   {
      ...
      zr_boost_1_81::multiprecision::detail::scoped_precision_options<value_type> scoped_opts(*this);
      // precision guards:
   ...
   BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<std::is_convertible<typename detail::expression<tag, Arg1, Arg2, Arg3, Arg4>::result_type, self_type>::value, number&>::type operator=(const detail::expression<tag, Arg1, Arg2, Arg3, Arg4>& e)
   {
      ...
      {
         BOOST_MP_CONSTEXPR_IF_VARIABLE_PRECISION(number)
            if (precision_guard.precision() != zr_boost_1_81::multiprecision::detail::current_precision_of<self_type>(*this))
            {
               number t(e);
      ...
      assign(const V& v1, const U& v2, unsigned Digits)
   {
      ...
      zr_boost_1_81::multiprecision::detail::scoped_source_precision<self_type> scope;
      return *this = r;
   }
   BOOST_MP_CXX14_CONSTEXPR number& assign(const value_type & a, const value_type & b, unsigned Digits)
   {
      this->precision(Digits);
      zr_boost_1_81::multiprecision::detail::scoped_target_precision<self_type> scoped;
   ...
   template <class Other, expression_template_option ET>
   BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<!zr_boost_1_81::multiprecision::detail::is_explicitly_convertible<Other, Backend>::value, number<Backend, ExpressionTemplates>&>::type
   ...
   explicit BOOST_MP_CXX14_CONSTEXPR number(const detail::expression<tag, Arg1, Arg2, Arg3, Arg4>& e,
                                            typename std::enable_if<!std::is_convertible<typename detail::expression<tag, Arg1, Arg2, Arg3, Arg4>::result_type, self_type>::value && zr_boost_1_81::multiprecision::detail::is_explicitly_convertible<typename detail::expression<tag, Arg1, Arg2, Arg3, Arg4>::result_type, self_type>::value>::type* = nullptr)
   {
      //
   ...
   template <class V>
   BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_integral<V>::value, number&>::type operator<<=(V val)
   {
      static_assert(number_category<Backend>::value == number_kind_integer, "The left-shift operation is only valid for integer types");
      detail::check_shift_range(val, std::integral_constant<bool, (sizeof(V) > sizeof(std::size_t))>(), std::integral_constant<bool, zr_boost_1_81::multiprecision::detail::is_signed<V>::value && zr_boost_1_81::multiprecision::detail::is_integral<V>::value > ());
   ...
   {
      ar& zr_boost_1_81::make_nvp("backend", m_backend);
   }
   #endif
 ...
 public:
   ...
   template <class T>
#else
   template <class T, class = typename std::enable_if<std::is_enum<T>::value || !(std::is_constructible<T, detail::convertible_to<self_type const&> >::value || !std::is_default_constructible<T>::value || (!zr_boost_1_81::multiprecision::detail::is_arithmetic<T>::value && !zr_boost_1_81::multiprecision::detail::is_complex<T>::value)), T>::type>
#endif
   ...
   template <class V>
   BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_arithmetic<V>::value && (number_category<Backend>::value != number_kind_complex), int>::type compare(const V& o) const
   {
      using default_ops::eval_get_sign;
      if (o == 0)
         return eval_get_sign(m_backend);
 ...
 private:
   ...
   {
      using default_ops::eval_add;
      zr_boost_1_81::multiprecision::detail::maybe_promote_precision(this);
   ...
   BOOST_MP_CXX14_CONSTEXPR void do_assign(const Exp& e, const detail::shift_left&)
   {
      ...
      static_assert(zr_boost_1_81::multiprecision::detail::is_integral<right_value_type>::value, "The left shift operator requires an integer value for the shift operand.");
   ...
   BOOST_MP_CXX14_CONSTEXPR void do_assign_right_shift(const Exp& e, const Val& val, const detail::terminal&)
   {
      ...
      detail::check_shift_range(val, std::integral_constant<bool, (sizeof(Val) > sizeof(std::size_t))>(), std::integral_constant<bool, zr_boost_1_81::multiprecision::detail::is_signed<Val>::value&& zr_boost_1_81::multiprecision::detail::is_integral<Val>::value>());
   ...
   //
   template <class Exp>
   BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<!(zr_boost_1_81::multiprecision::number_category<self_type>::value == zr_boost_1_81::multiprecision::number_kind_integer || sizeof(Exp) == 1)>::type
...
inline std::istream& operator>>(std::istream& is, number<Backend, ExpressionTemplates>& r)
{
   ...
   std::string s;
   switch (zr_boost_1_81::multiprecision::number_category<number<Backend, ExpressionTemplates> >::value)
   {
   case zr_boost_1_81::multiprecision::number_kind_integer:
      if (oct_format)
      ...
      break;
   case zr_boost_1_81::multiprecision::number_kind_rational:
      if (oct_format)
         s = detail::read_string_while(is, "+-01234567/");
      else if (hex_format)
         s = detail::read_string_while(is, "+-xXabcdefABCDEF0123456789/");
         ...
         s = detail::read_string_while(is, "+-0123456789/");
      break;
   case zr_boost_1_81::multiprecision::number_kind_floating_point:
      BOOST_IF_CONSTEXPR(std::is_same<number<Backend, ExpressionTemplates>, typename number<Backend, ExpressionTemplates>::value_type>::value)
         ...
         s = detail::read_string_while(is, "+-eE.0123456789infINFnanNANinfinityINFINITY{,}");
      break;
   case zr_boost_1_81::multiprecision::number_kind_complex:
      s = detail::read_string_while(is, "+-eE.0123456789infINFnanNANinfinityINFINITY,()");
      break;
   default:
      is >> s;
...
inline BOOST_MP_CXX14_CONSTEXPR std::size_t hash_value(const rational<multiprecision::number<T, ExpressionTemplates> >& val)
{
   ...
   zr_boost_1_81::multiprecision::detail::hash_combine(result, hash_value(val.denominator()));
   return result;
}
...
template <class I>
struct component_type<zr_boost_1_81::rational<I> >
{
   using type = I;
};
...
template <class Backend, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
struct hash<zr_boost_1_81::multiprecision::number<Backend, ExpressionTemplates> >
{
   BOOST_MP_CXX14_CONSTEXPR std::size_t operator()(const zr_boost_1_81::multiprecision::number<Backend, ExpressionTemplates>& val) const { return hash_value(val); }
};
template <class Backend, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
struct hash<zr_boost_1_81::rational<zr_boost_1_81::multiprecision::number<Backend, ExpressionTemplates> > >
{
   BOOST_MP_CXX14_CONSTEXPR std::size_t operator()(const zr_boost_1_81::rational<zr_boost_1_81::multiprecision::number<Backend, ExpressionTemplates> >& val) const
   {
      std::size_t result = hash_value(val.numerator());
      zr_boost_1_81::multiprecision::detail::hash_combine(result, hash_value(val.denominator()));
      return result;
