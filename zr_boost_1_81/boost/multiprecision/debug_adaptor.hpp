...
struct debug_adaptor
{
 ...
 public:
   ...
   template <class T>
   typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_arithmetic<T>::value || std::is_assignable<Backend, T>::value, debug_adaptor&>::type operator=(const T& i)
   {
      m_value = i;
      update_view();
      return *this;
...
class numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::debug_adaptor<Backend>, ExpressionTemplates> >
    : public std::numeric_limits<zr_boost_1_81::multiprecision::number<Backend, ExpressionTemplates> >
{
   ...
   using number_type = zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::debug_adaptor<Backend>, ExpressionTemplates>;
...
struct precision<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::debug_adaptor<Backend>, ExpressionTemplates>, Policy>
