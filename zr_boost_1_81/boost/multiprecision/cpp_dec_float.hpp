...
class cpp_dec_float
{
 private:
   ...
   static_assert(zr_boost_1_81::multiprecision::detail::is_signed<ExponentType>::value,
 ...
 public:
   ...
   template <class I>
   cpp_dec_float(I i,
                 typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_unsigned<I>::value && (sizeof(I) <= sizeof(long long))>::type* = nullptr)
      : data(),
        exp(static_cast<exponent_type>(0)),
        neg(false),
        fpclass(cpp_dec_float_finite),
   ...
   template <class I>
   cpp_dec_float(I i,
                 typename std::enable_if<(   zr_boost_1_81::multiprecision::detail::is_signed<I>::value
                                          && zr_boost_1_81::multiprecision::detail::is_integral<I>::value
        ...
        prec_elem(cpp_dec_float_elem_number)
   {
      if (i < 0)
      {
         from_unsigned_long_long(zr_boost_1_81::multiprecision::detail::unsigned_abs(i));
         negate();
      }
      else
   ...
   std::size_t hash() const
   {
      ...
      for (int i = 0; i < prec_elem; ++i)
         zr_boost_1_81::multiprecision::detail::hash_combine(result, data[i]);
      zr_boost_1_81::multiprecision::detail::hash_combine(result, exp, neg, static_cast<std::size_t>(fpclass));
      return result;
   }
   ...
   cpp_dec_float& operator=(long long v)
   {
      if (v < 0)
      {
         from_unsigned_long_long(zr_boost_1_81::multiprecision::detail::unsigned_abs(v));
         negate();
      }
      else
      {
         using local_ulonglong_type = typename zr_boost_1_81::multiprecision::detail::make_unsigned<long long>::type;
   ...
   {
      *this = zr_boost_1_81::multiprecision::detail::unsigned_abs(v);
      if (v < 0)
         negate();
      return *this;
   }
   ...
   void serialize(Archive& ar, const unsigned int /*version*/)
   {
      for (unsigned i = 0; i < data.size(); ++i)
         ar& zr_boost_1_81::make_nvp("digit", data[i]);
      ar& zr_boost_1_81::make_nvp("exponent", exp);
      ar& zr_boost_1_81::make_nvp("sign", neg);
      ar& zr_boost_1_81::make_nvp("class-type", fpclass);
      ar& zr_boost_1_81::make_nvp("precision", prec_elem);
   }
   #endif
...
std::string cpp_dec_float<Digits10, ExponentType, Allocator>::str(std::intmax_t number_of_digits, std::ios_base::fmtflags f) const
{
   ...
   if (number_of_digits < 0)
   {
      ...
      zr_boost_1_81::multiprecision::detail::format_float_string(str, 0, number_of_digits - my_exp - 1, f, this->iszero());
      return str;
   }
   else
   {
   ...
   zr_boost_1_81::multiprecision::detail::format_float_string(str, my_exp, org_digits, f, this->iszero());
   return str;
}
...
bool cpp_dec_float<Digits10, ExponentType, Allocator>::rd_string(const char* const s)
{
   ...
   try
   {
      ...
      if (((pos = str.find('e')) != std::string::npos) || ((pos = str.find('E')) != std::string::npos))
      {
         ...
         #ifndef BOOST_MP_STANDALONE
         exp = zr_boost_1_81::lexical_cast<exponent_type>(static_cast<const char*>(str.c_str() + (pos + 1u)));
         #else
...
{
   if (o < 0)
      result.sub_unsigned_long_long(zr_boost_1_81::multiprecision::detail::unsigned_abs(o));
   else
   {
      using local_ulonglong_type = typename zr_boost_1_81::multiprecision::detail::make_unsigned<long long>::type;
...
{
   if (o < 0)
      result.add_unsigned_long_long(zr_boost_1_81::multiprecision::detail::unsigned_abs(o));
   else
   {
      using local_ulonglong_type = typename zr_boost_1_81::multiprecision::detail::make_unsigned<long long>::type;
...
inline void eval_multiply(cpp_dec_float<Digits10, ExponentType, Allocator>& result, long long o)
{
   if (o < 0)
   {
      result.mul_unsigned_long_long(zr_boost_1_81::multiprecision::detail::unsigned_abs(o));
      result.negate();
   }
   else
   {
...
inline void eval_divide(cpp_dec_float<Digits10, ExponentType, Allocator>& result, long long o)
{
   if (o < 0)
   {
      result.div_unsigned_long_long(zr_boost_1_81::multiprecision::detail::unsigned_abs(o));
      result.negate();
   }
   else
   {
...
using zr_boost_1_81::multiprecision::backends::cpp_dec_float;
...
template <unsigned Digits10, class ExponentType, class Allocator>
struct transcendental_reduction_type<zr_boost_1_81::multiprecision::backends::cpp_dec_float<Digits10, ExponentType, Allocator> >
{
   //
   ...
   //
   using type = zr_boost_1_81::multiprecision::backends::cpp_dec_float<Digits10 * 3, ExponentType, Allocator>;
};

} // namespace detail


}} // namespace zr_boost_1_81::multiprecision

namespace std {
template <unsigned Digits10, class ExponentType, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >
{
 public:
   ...
   static constexpr int                     digits            = zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_digits10;
   static constexpr int                     digits10          = zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_digits10;
   static constexpr int                     max_digits10      = zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_max_digits10;
   static constexpr typename zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::exponent_type min_exponent                = zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_min_exp;   // Type differs from int.
   static constexpr typename zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::exponent_type min_exponent10              = zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_min_exp10; // Type differs from int.
   static constexpr typename zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::exponent_type max_exponent                = zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_max_exp;   // Type differs from int.
   static constexpr typename zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::exponent_type max_exponent10              = zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_max_exp10; // Type differs from int.
   static constexpr int                     radix             = zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_radix;
   ...
   static constexpr zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates>(min)() { return (zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::min)(); }
   static constexpr zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates>(max)() { return (zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::max)(); }
   static constexpr zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> lowest() { return zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::zero(); }
   static constexpr zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> epsilon() { return zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::eps(); }
   static constexpr zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> round_error() { return 0.5L; }
   static constexpr zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> infinity() { return zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::inf(); }
   static constexpr zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> quiet_NaN() { return zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::nan(); }
   static constexpr zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> signaling_NaN() { return zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::zero(); }
   static constexpr zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> denorm_min() { return zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::zero(); }
};

template <unsigned Digits10, class ExponentType, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::digits;
template <unsigned Digits10, class ExponentType, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::digits10;
template <unsigned Digits10, class ExponentType, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::max_digits10;
template <unsigned Digits10, class ExponentType, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::is_signed;
template <unsigned Digits10, class ExponentType, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::is_integer;
template <unsigned Digits10, class ExponentType, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::is_exact;
template <unsigned Digits10, class ExponentType, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::radix;
template <unsigned Digits10, class ExponentType, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr typename zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::exponent_type numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::min_exponent;
template <unsigned Digits10, class ExponentType, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr typename zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::exponent_type numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::min_exponent10;
template <unsigned Digits10, class ExponentType, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr typename zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::exponent_type numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::max_exponent;
template <unsigned Digits10, class ExponentType, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr typename zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::exponent_type numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::max_exponent10;
template <unsigned Digits10, class ExponentType, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::has_infinity;
template <unsigned Digits10, class ExponentType, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::has_quiet_NaN;
template <unsigned Digits10, class ExponentType, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::has_signaling_NaN;
template <unsigned Digits10, class ExponentType, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_denorm_style numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::has_denorm;
template <unsigned Digits10, class ExponentType, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::has_denorm_loss;
template <unsigned Digits10, class ExponentType, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::is_iec559;
template <unsigned Digits10, class ExponentType, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::is_bounded;
template <unsigned Digits10, class ExponentType, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::is_modulo;
template <unsigned Digits10, class ExponentType, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::traps;
template <unsigned Digits10, class ExponentType, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::tinyness_before;
template <unsigned Digits10, class ExponentType, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_round_style numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::round_style;
...
template <unsigned Digits10, class ExponentType, class Allocator, class Policy, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
struct precision<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates>, Policy>
{
   ...
   static constexpr std::int32_t cpp_dec_float_digits10 = zr_boost_1_81::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_digits10;
...
}} // namespace zr_boost_1_81::math::policies
#endif
