...
struct rational_adaptor
{
   ...
   //
   template <class A>
   typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_arithmetic<A>::value, int>::type compare(A i) const
   {
      rational_adaptor t;
   ...
   void serialize(Archive& ar, const std::integral_constant<bool, true>&)
   {
      ...
      ar& zr_boost_1_81::make_nvp("numerator", n);
      ar& zr_boost_1_81::make_nvp("denominator", d);
   }
   template <class Archive>
...
inline std::size_t hash_value(const rational_adaptor<Backend>& arg)
{
   ...
   zr_boost_1_81::multiprecision::detail::hash_combine(result, result2);
   return result;
}
//
// assign_components:
...
void eval_multiply_imp(Backend& result_num, Backend& result_denom, Arithmetic arg)
{
   ...
   arg /= integer_gcd;
   if (zr_boost_1_81::multiprecision::detail::unsigned_abs(arg) > 1)
   {
...
eval_divide(rational_adaptor<Backend>& result, Arithmetic arg)
{
   ...
   eval_multiply(t, result.denom(), zr_boost_1_81::multiprecision::detail::unsigned_abs(arg));
   ...
   eval_divide(rational_adaptor<Backend>& result, const rational_adaptor<Backend>& a, Arithmetic arg)
{
   ...
   eval_convert_to(&integer_gcd, gcd);
   arg /= integer_gcd;
   eval_multiply(result.denom(), a.denom(), zr_boost_1_81::multiprecision::detail::unsigned_abs(arg));
...
//
using zr_boost_1_81::multiprecision::backends::rational_adaptor;
//
...
namespace std {
   ...
   template <class IntBackend, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
   class numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::rational_adaptor<IntBackend>, ExpressionTemplates> > : public std::numeric_limits<zr_boost_1_81::multiprecision::number<IntBackend, ExpressionTemplates> >
   {
      using base_type = std::numeric_limits<zr_boost_1_81::multiprecision::number<IntBackend> >;
      using number_type = zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::rational_adaptor<IntBackend> >;
   ...
   template <class IntBackend, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
   constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::rational_adaptor<IntBackend>, ExpressionTemplates> >::is_integer;
   template <class IntBackend, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
   constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::rational_adaptor<IntBackend>, ExpressionTemplates> >::is_exact;
