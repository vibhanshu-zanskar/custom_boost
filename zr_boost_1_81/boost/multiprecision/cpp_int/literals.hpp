...
namespace zr_boost_1_81 { namespace multiprecision {
...
struct signed_cpp_int_literal_result_type
{
   ...
   using backend_type = zr_boost_1_81::multiprecision::backends::cpp_int_backend<bits, bits, signed_magnitude, unchecked, void>;
...
{
   static constexpr unsigned                                                                                 bits = Digits * 4;
   using backend_type = zr_boost_1_81::multiprecision::backends::cpp_int_backend<bits, bits, unsigned_magnitude, unchecked, void>;
   using number_type = number<backend_type, et_off>                                                                     ;
};
...
template <char... STR>
constexpr typename zr_boost_1_81::multiprecision::literals::detail::signed_cpp_int_literal_result_type<static_cast<unsigned>((sizeof...(STR)) - 2u)>::number_type operator"" _cppi()
{
   using pt = typename zr_boost_1_81::multiprecision::literals::detail::make_packed_value_from_str<STR...>::type;
   return zr_boost_1_81::multiprecision::literals::detail::make_backend_from_pack<pt, typename zr_boost_1_81::multiprecision::literals::detail::signed_cpp_int_literal_result_type<static_cast<unsigned>((sizeof...(STR)) - 2u)>::backend_type>::value;
}

template <char... STR>
constexpr typename zr_boost_1_81::multiprecision::literals::detail::unsigned_cpp_int_literal_result_type<static_cast<unsigned>((sizeof...(STR)) - 2u)>::number_type operator"" _cppui()
{
   using pt = typename zr_boost_1_81::multiprecision::literals::detail::make_packed_value_from_str<STR...>::type;
   return zr_boost_1_81::multiprecision::literals::detail::make_backend_from_pack<pt, typename zr_boost_1_81::multiprecision::literals::detail::unsigned_cpp_int_literal_result_type<static_cast<unsigned>((sizeof...(STR)) - 2u)>::backend_type>::value;
}

#define BOOST_MP_DEFINE_SIZED_CPP_INT_LITERAL(Bits)                                                                                                                                                                                \
   template <char... STR>                                                                                                                                                                                                          \
   constexpr zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::cpp_int_backend<Bits, Bits, zr_boost_1_81::multiprecision::signed_magnitude, zr_boost_1_81::multiprecision::unchecked, void> > operator"" BOOST_JOIN(_cppi, Bits)()    \
   {                                                                                                                                                                                                                               \
      using pt = typename zr_boost_1_81::multiprecision::literals::detail::make_packed_value_from_str<STR...>::type;                                                                                                                       \
      return zr_boost_1_81::multiprecision::literals::detail::make_backend_from_pack<                                                                                                                                                      \
          pt,                                                                                                                                                                                                                      \
          zr_boost_1_81::multiprecision::backends::cpp_int_backend<Bits, Bits, zr_boost_1_81::multiprecision::signed_magnitude, zr_boost_1_81::multiprecision::unchecked, void> >::value;                                                                  \
   }                                                                                                                                                                                                                               \
   template <char... STR>                                                                                                                                                                                                          \
   constexpr zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::cpp_int_backend<Bits, Bits, zr_boost_1_81::multiprecision::unsigned_magnitude, zr_boost_1_81::multiprecision::unchecked, void> > operator"" BOOST_JOIN(_cppui, Bits)() \
   {                                                                                                                                                                                                                               \
      using pt = typename zr_boost_1_81::multiprecision::literals::detail::make_packed_value_from_str<STR...>::type;                                                                                                                       \
      return zr_boost_1_81::multiprecision::literals::detail::make_backend_from_pack<                                                                                                                                                      \
          pt,                                                                                                                                                                                                                      \
          zr_boost_1_81::multiprecision::backends::cpp_int_backend<Bits, Bits, zr_boost_1_81::multiprecision::unsigned_magnitude, zr_boost_1_81::multiprecision::unchecked, void> >::value;                                                                \
   }
...
{
   return cpp_int_backend<MinBits, MinBits, signed_magnitude, Checked, void>(a.backend(), zr_boost_1_81::multiprecision::literals::detail::make_negate_tag());
}
template <std::size_t MinBits, cpp_int_check_type Checked>
constexpr number<cpp_int_backend<MinBits, MinBits, signed_magnitude, Checked, void>, et_off>
operator-(number<cpp_int_backend<MinBits, MinBits, signed_magnitude, Checked, void>, et_off>&& a)
{
   return cpp_int_backend<MinBits, MinBits, signed_magnitude, Checked, void>(static_cast<const number<cpp_int_backend<MinBits, MinBits, signed_magnitude, Checked, void>, et_off>&>(a).backend(), zr_boost_1_81::multiprecision::literals::detail::make_negate_tag());
}
