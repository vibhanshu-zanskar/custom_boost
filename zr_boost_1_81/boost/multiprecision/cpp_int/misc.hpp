...
namespace zr_boost_1_81 { namespace multiprecision { namespace backends {
...
{
   using cast_type = typename zr_boost_1_81::multiprecision::detail::canonical<R, CppInt>::type;

   if (val.sign())
   {
      BOOST_IF_CONSTEXPR (zr_boost_1_81::multiprecision::detail::is_signed<R>::value == false)
...
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_integral<R>::value && !is_trivial_cpp_int<cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1> >::value, void>::type
eval_convert_to(R* result, const cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>& backend)
{
   ...
   {
      if ((backend.sign() && zr_boost_1_81::multiprecision::detail::is_signed<R>::value && zr_boost_1_81::multiprecision::detail::is_integral<R>::value) && (1 + static_cast<zr_boost_1_81::multiprecision::limb_type>((std::numeric_limits<R>::max)()) <= backend.limbs()[0]))
      {
         *result = (numeric_limits_workaround<R>::min)();
         return;
      }
      else if (zr_boost_1_81::multiprecision::detail::is_signed<R>::value && zr_boost_1_81::multiprecision::detail::is_integral<R>::value && !backend.sign() && static_cast<zr_boost_1_81::multiprecision::limb_type>((std::numeric_limits<R>::max)()) <= backend.limbs()[0])
      {
      ...
      if (i < backend.size())
      {
         ...
         *result = static_cast<R>(*result + static_cast<R>(static_cast<R>(limb_at_index_masked) << shift));
         ...
         if ((backend.limbs()[i] & static_cast<limb_type>(~mask)) || (i + 1 < backend.size()))
         {
            ...
            if (backend.sign())
            {
               check_is_negative(zr_boost_1_81::multiprecision::detail::is_signed<R>());
               *result = (numeric_limits_workaround<R>::min)();
            }
            else if (zr_boost_1_81::multiprecision::detail::is_signed<R>::value)
               *result = (numeric_limits_workaround<R>::max)();
            return;
         }
      }
   ...
   if (backend.sign())
   {
      check_is_negative(std::integral_constant<bool, zr_boost_1_81::multiprecision::detail::is_signed<R>::value && zr_boost_1_81::multiprecision::detail::is_integral<R>::value>());
      *result = negate_integer(*result, std::integral_constant<bool, zr_boost_1_81::multiprecision::detail::is_signed<R>::value && zr_boost_1_81::multiprecision::detail::is_integral<R>::value>());
   }
}
...
eval_convert_to(R* result, const cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>& backend) noexcept(zr_boost_1_81::multiprecision::detail::is_arithmetic<R>::value)
{
   ...
   if (bits > bits_to_keep)
   {
      ...
      *result = 0.0f;
      ...
      if (eval_bit_test(backend, static_cast<unsigned>(bits)))
      {
         ...
         {
            #ifdef BOOST_MP_MATH_AVAILABLE
            *result = zr_boost_1_81::math::float_next(*result);
            #else
...
eval_lsb_imp(const cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>& a)
{
   ...
   //
   std::size_t result = zr_boost_1_81::multiprecision::detail::find_lsb(a.limbs()[index]);
...
eval_msb_imp(const cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>& a)
{
   ...
   //
   return (a.size() - 1) * cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>::limb_bits + zr_boost_1_81::multiprecision::detail::find_msb(a.limbs()[a.size() - 1]);
}
...
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_integral<U>::value>::type eval_qr(
    const cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>& x,
    U                                                                           y,
    cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>&       q,
    cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>&       r) noexcept((is_non_throwing_cpp_int<cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1> >::value))
...
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_unsigned<Integer>::value && !is_trivial_cpp_int<cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1> >::value, Integer>::type
...
template <std::size_t MinBits1, std::size_t MaxBits1, cpp_integer_type SignType1, cpp_int_check_type Checked1, class Allocator1, class Integer>
BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_signed<Integer>::value && zr_boost_1_81::multiprecision::detail::is_integral<Integer>::value && !is_trivial_cpp_int<cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1> >::value, Integer>::type
...
BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR limb_type eval_gcd(limb_type u, limb_type v)
{
   ...
   return std::gcd(u, v);
#else
   std::size_t shift = zr_boost_1_81::multiprecision::detail::find_lsb(u | v);
   u >>= zr_boost_1_81::multiprecision::detail::find_lsb(u);
   do
   {
      v >>= zr_boost_1_81::multiprecision::detail::find_lsb(v);
      if (u > v)
...
//
template <std::size_t MinBits1, std::size_t MaxBits1, cpp_integer_type SignType1, cpp_int_check_type Checked1, class Allocator1, class Integer>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_unsigned<Integer>::value && (sizeof(Integer) <= sizeof(limb_type)) && !is_trivial_cpp_int<cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1> >::value>::type
eval_gcd(
    cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>&       result,
    const cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>& a,
    const Integer&                                                              v)
...
template <std::size_t MinBits1, std::size_t MaxBits1, cpp_integer_type SignType1, cpp_int_check_type Checked1, class Allocator1, class Integer>
inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_signed<Integer>::value && zr_boost_1_81::multiprecision::detail::is_integral<Integer>::value && (sizeof(Integer) <= sizeof(limb_type)) && !is_trivial_cpp_int<cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1> >::value>::type
eval_gcd(
    cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>&       result,
    const cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>& a,
    const Integer&                                                              v)
...
{
   *result.limbs() = zr_boost_1_81::multiprecision::detail::constexpr_gcd(*a.limbs(), *b.limbs());
   result.sign(false);
}
...
{
   *result.limbs() = zr_boost_1_81::multiprecision::detail::constexpr_lcm(*a.limbs(), *b.limbs());
...
eval_convert_to(R* result, const cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>& val)
{
   BOOST_IF_CONSTEXPR(std::numeric_limits<R>::is_specialized)
   {
      ...
      if (static_cast<common_type>(*val.limbs()) > static_cast<common_type>((std::numeric_limits<R>::max)()))
      {
         if (val.isneg())
         {
            check_is_negative(std::integral_constant < bool, (zr_boost_1_81::multiprecision::detail::is_signed<R>::value && zr_boost_1_81::multiprecision::detail::is_integral<R>::value) || (number_category<R>::value == number_kind_floating_point) > ());
         ...
         {
            conversion_overflow(typename cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>::checked_type());
            *result = zr_boost_1_81::multiprecision::detail::is_signed<R>::value && zr_boost_1_81::multiprecision::detail::is_integral<R>::value ? (std::numeric_limits<R>::max)() : static_cast<R>(*val.limbs());
         }
      }
      else
      {
...
eval_lsb(const cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>& a)
{
   ...
   // Find the index of the least significant bit within that limb:
   //
   return zr_boost_1_81::multiprecision::detail::find_lsb(*a.limbs());
}
...
eval_msb_imp(const cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>& a)
{
   ...
   // Find the index of the least significant bit within that limb:
   //
   return zr_boost_1_81::multiprecision::detail::find_msb(*a.limbs());
}
...
inline BOOST_MP_CXX14_CONSTEXPR std::size_t hash_value(const cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>& val) noexcept
{
   ...
   {
      zr_boost_1_81::multiprecision::detail::hash_combine(result, val.limbs()[i]);
   }
   zr_boost_1_81::multiprecision::detail::hash_combine(result, val.sign());
   return result;
}
...
inline BOOST_CXX14_CONSTEXPR T constexpr_gcd(T a, T b) noexcept
{
   return zr_boost_1_81::integer::gcd(a, b);
}

template <typename T>
inline BOOST_CXX14_CONSTEXPR T constexpr_lcm(T a, T b) noexcept
{
   return zr_boost_1_81::integer::lcm(a, b);
}
...
inline BOOST_CXX14_CONSTEXPR T constexpr_gcd(T a, T b) noexcept
{
   return zr_boost_1_81::multiprecision::backends::eval_gcd(a, b);
}

template <typename T>
inline BOOST_CXX14_CONSTEXPR T constexpr_lcm(T a, T b) noexcept
{
   const T ab_gcd = zr_boost_1_81::multiprecision::detail::constexpr_gcd(a, b);
   return (a * b) / ab_gcd;
}
