...
{
   if (o < 0)
      eval_subtract(result, static_cast<limb_type>(zr_boost_1_81::multiprecision::detail::unsigned_abs(o)));
   else if (o > 0)
...
{
   if (o < 0)
      eval_subtract(result, a, static_cast<limb_type>(zr_boost_1_81::multiprecision::detail::unsigned_abs(o)));
   else if (o > 0)
    ...
    const signed_limb_type&                                               o) noexcept((is_non_throwing_cpp_int<cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1> >::value))
{
   ...
   {
      if (o < 0)
         eval_add(result, static_cast<limb_type>(zr_boost_1_81::multiprecision::detail::unsigned_abs(o)));
      else
    ...
    const signed_limb_type&                                                     o) noexcept((is_non_throwing_cpp_int<cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1> >::value))
{
   ...
   {
      if (o < 0)
         eval_add(result, a, static_cast<limb_type>(zr_boost_1_81::multiprecision::detail::unsigned_abs(o)));
      else
