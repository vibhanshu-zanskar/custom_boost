...
namespace mp = zr_boost_1_81::multiprecision;

namespace cpp_int_detail {

using namespace zr_boost_1_81::multiprecision;
using namespace zr_boost_1_81::multiprecision::backends;

template <class T>
struct is_binary_archive : public std::integral_constant<bool, false>
{};
template <>
struct is_binary_archive<zr_boost_1_81::archive::binary_oarchive> : public std::integral_constant<bool, true>
{};
template <>
struct is_binary_archive<zr_boost_1_81::archive::binary_iarchive> : public std::integral_constant<bool, true>
{};
