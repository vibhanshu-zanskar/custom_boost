...
namespace zr_boost_1_81 { namespace multiprecision { namespace backends { namespace detail {
...
inline constexpr T type_max() noexcept
{
   ...
   std::is_same<T, zr_boost_1_81::multiprecision::int128_type>::value ? INT128_MAX :
   std::is_same<T, zr_boost_1_81::multiprecision::uint128_type>::value ? UINT128_MAX :
   #endif
...
inline constexpr T type_min() noexcept
{
   return 
   #ifdef BOOST_HAS_INT128
   std::is_same<T, zr_boost_1_81::multiprecision::int128_type>::value ? INT128_MIN :
   std::is_same<T, zr_boost_1_81::multiprecision::uint128_type>::value ? T(0) :
   #endif
...
{
   return checked_add_imp(a, b, std::integral_constant<bool, zr_boost_1_81::multiprecision::detail::is_signed<A>::value && zr_boost_1_81::multiprecision::detail::is_integral<A>::value > ());
}
template <class A>
...
{
   return checked_subtract_imp(a, b, std::integral_constant<bool, zr_boost_1_81::multiprecision::detail::is_signed<A>::value && zr_boost_1_81::multiprecision::detail::is_integral<A>::value>());
}
template <class A>
...
}}}} // namespace zr_boost_1_81::multiprecision::backends::detail
