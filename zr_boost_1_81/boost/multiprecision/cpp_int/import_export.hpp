    ...
    number<cpp_int_backend<MinBits, MaxBits, SignType, Checked, Allocator>, ExpressionTemplates>& val, Iterator i, Iterator j, std::size_t chunk_size = 0, bool msv_first = true)
{
   ...
   using unsigned_value_type = typename zr_boost_1_81::multiprecision::detail::make_unsigned<value_type>::type                                        ;
   using difference_type = typename std::iterator_traits<Iterator>::difference_type                             ;
   using size_type = typename zr_boost_1_81::multiprecision::detail::make_unsigned<difference_type>::type                                   ;
...
inline typename std::enable_if< !zr_boost_1_81::multiprecision::backends::is_trivial_cpp_int<cpp_int_backend<MinBits, MaxBits, SignType, Checked, Allocator> >::value, number<cpp_int_backend<MinBits, MaxBits, SignType, Checked, Allocator>, ExpressionTemplates>&>::type
import_bits_fast(
...
#pragma warning(disable : 4244)
   ...
   std::size_t bitcount = zr_boost_1_81::multiprecision::backends::eval_msb_imp(val.backend()) + 1;
