...
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_arithmetic<T>::value, bool>::type eval_eq(const complex_adaptor<Backend>& a, const T& b) noexcept
{
...
inline typename std::enable_if< !zr_boost_1_81::multiprecision::detail::is_complex<Result>::value>::type eval_convert_to(Result* result, const complex_adaptor<Backend>& val)
{
...
using zr_boost_1_81::multiprecision::backends::complex_adaptor;

template <class Backend>
struct number_category<complex_adaptor<Backend> > : public std::integral_constant<int, zr_boost_1_81::multiprecision::number_kind_complex>
{};
