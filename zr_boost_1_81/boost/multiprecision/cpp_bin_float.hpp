...
template <class U>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_unsigned<U>::value, bool>::type is_negative(U) { return false; }
template <class S>
inline typename std::enable_if< !zr_boost_1_81::multiprecision::detail::is_unsigned<S>::value, bool>::type is_negative(S s) { return s < 0; }
...
class cpp_bin_float
{
 ...
 public:
   ...
   typename std::enable_if<std::is_same<Float, float128_type>::value, cpp_bin_float&>::type assign_float(Float f)
   {
      ...
      using bf_int_type = typename zr_boost_1_81::multiprecision::detail::canonical<int, cpp_bin_float>::type;
      if (f == 0)
      {
         m_data     = limb_type(0);
         m_sign     = (signbitq(f) > 0);
...
#endif
   {
      ...
      while (f != static_cast<Float>(0.0F))
      {
         ...
         int ipart = zr_boost_1_81::multiprecision::detail::itrunc(f);
   ...
   assign_float(Float f)
   {
      ...
      using f_int_type = typename zr_boost_1_81::multiprecision::detail::canonical<int, Float>::type        ;
      using bf_int_type = typename zr_boost_1_81::multiprecision::detail::canonical<int, cpp_bin_float>::type;
   ...
   template <class I>
   typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_integral<I>::value, cpp_bin_float&>::type operator=(const I& i)
   {
      ...
      {
         using ui_type = typename zr_boost_1_81::multiprecision::detail::make_unsigned<I>::type                                      ;
         ui_type                                                                            fi = static_cast<ui_type>(zr_boost_1_81::multiprecision::detail::unsigned_abs(i));
         using ar_type = typename zr_boost_1_81::multiprecision::detail::canonical<ui_type, rep_type>::type;
   ...
   {
      ar& zr_boost_1_81::make_nvp("data", m_data);
      ar& zr_boost_1_81::make_nvp("exponent", m_exponent);
      ar& zr_boost_1_81::make_nvp("sign", m_sign);
   }
   #endif
};
...
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_unsigned<U>::value>::type eval_multiply(cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>& res, 
   const cpp_bin_float<Digits, DigitBase, Allocator2, Exponent2, MinE2, MaxE2>& a, const U& b)
{
   ...
   typename cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>::double_rep_type                                                                     dt;
   using canon_ui_type = typename zr_boost_1_81::multiprecision::detail::canonical<U, typename cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>::double_rep_type>::type;
...
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_unsigned<U>::value>::type eval_multiply(cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>& res, const U& b)
{
...
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_signed<S>::value && zr_boost_1_81::multiprecision::detail::is_integral<S>::value>::type eval_multiply(cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>& res, 
   const cpp_bin_float<Digits, DigitBase, Allocator2, Exponent2, MinE2, MaxE2>& a, const S& b)
{
   using ui_type = typename zr_boost_1_81::multiprecision::detail::make_unsigned<S>::type;
   eval_multiply(res, a, static_cast<ui_type>(zr_boost_1_81::multiprecision::detail::unsigned_abs(b)));
   if (b < 0)
      res.negate();
}

template <unsigned Digits, digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, class S>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_signed<S>::value && zr_boost_1_81::multiprecision::detail::is_integral<S>::value>::type eval_multiply(cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>& res, const S& b)
{
   eval_multiply(res, res, b);
}
...
template <unsigned Digits, digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE,
   class Allocator2, class Exponent2, Exponent MinE2, Exponent MaxE2, class U>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_unsigned<U>::value>::type eval_divide(cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>& res, 
...
template <unsigned Digits, digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, class U>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_unsigned<U>::value>::type eval_divide(cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>& res, const U& v)
{
...
template <unsigned Digits, digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE,
   class Allocator2, class Exponent2, Exponent MinE2, Exponent MaxE2, class S>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_signed<S>::value && zr_boost_1_81::multiprecision::detail::is_integral<S>::value>::type eval_divide(cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>& res, 
   const cpp_bin_float<Digits, DigitBase, Allocator2, Exponent2, MinE2, MaxE2>& u, const S& v)
{
   using ui_type = typename zr_boost_1_81::multiprecision::detail::make_unsigned<S>::type;
   eval_divide(res, u, static_cast<ui_type>(zr_boost_1_81::multiprecision::detail::unsigned_abs(v)));
   if (v < 0)
      res.negate();
}

template <unsigned Digits, digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, class S>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_signed<S>::value && zr_boost_1_81::multiprecision::detail::is_integral<S>::value>::type eval_divide(cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>& res, const S& v)
{
   eval_divide(res, res, v);
}
...
inline typename std::enable_if<std::is_floating_point<Float>::value>::type eval_convert_to(Float* res, const cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>& original_arg)
{
   ...
   static constexpr int float_digits = zr_boost_1_81::multiprecision::detail::is_float128<Float>::value ? 113 : std::numeric_limits<Float>::digits;
   ...
   case cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>::exponent_zero:
      *res = 0;
      ...
      return;
   case cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>::exponent_nan:
      BOOST_IF_CONSTEXPR(zr_boost_1_81::multiprecision::detail::is_float128<Float>::value)
      {
   ...
   //
   if (original_arg.exponent() > (zr_boost_1_81::multiprecision::detail::is_float128<Float>::value ? 16384 : std::numeric_limits<Float>::max_exponent))
   {
      BOOST_IF_CONSTEXPR(zr_boost_1_81::multiprecision::detail::is_float128<Float>::value)
      {
         *res = static_cast<Float>(std::numeric_limits<double>::infinity());
   ...
   if (original_arg.exponent() < std::numeric_limits<Float>::min_exponent - 1)
   {
      ...
      diff -= zr_boost_1_81::multiprecision::detail::is_float128<Float>::value ? -16382 : std::numeric_limits<Float>::min_exponent - 1;
...
template <unsigned Digits, digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, class I>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_unsigned<I>::value>::type eval_ldexp(cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>& res, const cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>& arg, I e)
{
   using si_type = typename zr_boost_1_81::multiprecision::detail::make_signed<I>::type;
...
template <unsigned Digits, digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, class I>
inline typename std::enable_if<zr_boost_1_81::multiprecision::detail::is_signed<I>::value && zr_boost_1_81::multiprecision::detail::is_integral<I>::value>::type eval_ldexp(cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>& res, const cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>& arg, I e)
{
...
inline std::size_t hash_value(const cpp_bin_float<D1, B1, A1, E1, M1, M2>& val)
{
   ...
   zr_boost_1_81::multiprecision::detail::hash_combine(result, val.exponent(), val.sign());
   return result;
}
...
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinExponent, Exponent MaxExponent>
struct transcendental_reduction_type<zr_boost_1_81::multiprecision::backends::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinExponent, MaxExponent> >
{
   //
   ...
   //
   using type = zr_boost_1_81::multiprecision::backends::cpp_bin_float<
       zr_boost_1_81::multiprecision::backends::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinExponent, MaxExponent>::bit_count * 3, 
       zr_boost_1_81::multiprecision::backends::digit_base_2, 
       Allocator, Exponent, MinExponent, MaxExponent>;
};
#ifdef BOOST_HAS_INT128
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinExponent, Exponent MaxExponent>
struct is_convertible_arithmetic<int128_type, zr_boost_1_81::multiprecision::backends::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinExponent, MaxExponent> > : public std::true_type
{};
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinExponent, Exponent MaxExponent>
struct is_convertible_arithmetic<uint128_type, zr_boost_1_81::multiprecision::backends::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinExponent, MaxExponent> > : public std::true_type
{};
#endif

} // namespace detail

template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Exponent, Exponent MinE, Exponent MaxE, class Allocator, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
inline zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates>
    copysign BOOST_PREVENT_MACRO_SUBSTITUTION(
        const zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates>& a,
        const zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates>& b)
{
   zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::backends::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> res(a);
...
struct number_category<cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE> > : public std::integral_constant<int, zr_boost_1_81::multiprecision::number_kind_floating_point>
{};
...
//
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> >
{
   using number_type = zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates>;
 ...
 private:
    ...
    static number_type get_min()
    {
       ...
       value.backend().exponent() = zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>::min_exponent;
       return value;
    }
#ifdef BOOST_MSVC
#pragma warning(push)
#pragma warning(disable : 4127) // conditional expression is constant
    ...
    static number_type get_max()
    {
       ...
       else
       {
          ...
          using zr_boost_1_81::multiprecision::default_ops::eval_add;
          using zr_boost_1_81::multiprecision::default_ops::eval_decrement;
          using zr_boost_1_81::multiprecision::default_ops::eval_left_shift;
          ...
          int_backend_type                                                                    i;
          i = ui_type(1u);
          eval_left_shift(i, zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>::bit_count - 1);
          int_backend_type j(i);
          eval_decrement(i);
          eval_add(j, i);
          value.backend().bits() = j;
       }
       value.backend().exponent() = zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>::max_exponent;
       return value;
    }
#ifdef BOOST_MSVC
#pragma warning(pop)
    ...
    {
       number_type value;
       value.backend().exponent() = zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>::exponent_infinity;
       return value;
    }
    static number_type get_quiet_NaN()
    {
       number_type value;
       value.backend().exponent() = zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>::exponent_nan;
       return value;
    }
...
#pragma warning(pop)
   ...
   static constexpr int digits   = zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>::bit_count;
   static constexpr int digits10 = zr_boost_1_81::multiprecision::detail::calc_digits10<static_cast<unsigned>(digits)>::value;
   // Is this really correct???
   static constexpr int  max_digits10 = zr_boost_1_81::multiprecision::detail::calc_max_digits10<static_cast<unsigned>(digits)>::value;
   ...
   static constexpr typename zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>::exponent_type min_exponent      = zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>::min_exponent;
   static constexpr typename zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>::exponent_type min_exponent10    = (min_exponent / 1000) * 301L;
   static constexpr typename zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>::exponent_type max_exponent      = zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>::max_exponent;
   static constexpr typename zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>::exponent_type max_exponent10    = (max_exponent / 1000) * 301L;
...
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> >::digits;
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> >::digits10;
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> >::max_digits10;
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> >::is_signed;
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> >::is_integer;
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> >::is_exact;
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr int numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> >::radix;
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr typename zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>::exponent_type numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> >::min_exponent;
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr typename zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>::exponent_type numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> >::min_exponent10;
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr typename zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>::exponent_type numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> >::max_exponent;
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr typename zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>::exponent_type numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> >::max_exponent10;
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> >::has_infinity;
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> >::has_quiet_NaN;
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> >::has_signaling_NaN;
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_denorm_style numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> >::has_denorm;
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> >::has_denorm_loss;
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> >::is_iec559;
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> >::is_bounded;
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> >::is_modulo;
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> >::traps;
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr bool numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> >::tinyness_before;
template <unsigned Digits, zr_boost_1_81::multiprecision::backends::digit_base_type DigitBase, class Allocator, class Exponent, Exponent MinE, Exponent MaxE, zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates>
constexpr float_round_style numeric_limits<zr_boost_1_81::multiprecision::number<zr_boost_1_81::multiprecision::cpp_bin_float<Digits, DigitBase, Allocator, Exponent, MinE, MaxE>, ExpressionTemplates> >::round_style;
