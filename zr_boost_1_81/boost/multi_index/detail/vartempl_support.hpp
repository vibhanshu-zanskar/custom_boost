 ...
 *
 * which fill the extra args with zr_boost_1_81::multi_index::detail::noarg's.
 * zr_boost_1_81::multi_index::detail::vartempl_placement_new works the opposite
...
zr_boost_1_81::forward<BOOST_PP_CAT(T,n)>(BOOST_PP_CAT(t,n))
...
namespace zr_boost_1_81{namespace multi_index{namespace detail{
struct noarg{};
}}}
...
BOOST_PP_ENUM_PARAMS(                                                \
  BOOST_MULTI_INDEX_LIMIT_VARTEMPL_ARGS,                             \
  zr_boost_1_81::multi_index::detail::noarg() BOOST_PP_INTERCEPT)
