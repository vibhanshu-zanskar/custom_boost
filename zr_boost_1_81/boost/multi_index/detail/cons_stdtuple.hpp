...
/* std::tuple wrapper providing the cons-based interface of zr_boost_1_81::tuple for
...
{
  typedef zr_boost_1_81::tuples::null_type result_type;

  template<typename StdTuple>
  static result_type create(const StdTuple&)
  {
    return zr_boost_1_81::tuples::null_type();
  }
};
