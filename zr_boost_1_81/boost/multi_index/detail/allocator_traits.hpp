...
struct allocator_is_always_equal:zr_boost_1_81::is_empty<Allocator>{};
...
struct allocator_traits
{
  ...
  /* [const_]void_pointer not provided as zr_boost_1_81::pointer_traits's
   * rebind_to has been seen to fail with things like
   * zr_boost_1_81::interprocess::offset_ptr in relatively old environments.
   */

  typedef typename Allocator::difference_type difference_type;
  typedef typename Allocator::size_type       size_type;

  typedef zr_boost_1_81::false_type          propagate_on_container_copy_assignment;
  typedef zr_boost_1_81::false_type          propagate_on_container_move_assignment;
  typedef zr_boost_1_81::false_type          propagate_on_container_swap;
  typedef zr_boost_1_81::is_empty<Allocator> is_always_equal;
  ...
  static void      construct(Allocator&,T* p,BOOST_RV_REF(T) x)
                     {::new (static_cast<void*>(p)) T(zr_boost_1_81::move(x));}
