 ...
 * zr_boost_1_81::tuple. In Boost 1.32, the limit is 10.
 */
...
BOOST_MULTI_INDEX_CK_NTH_COMPOSITE_KEY_FUNCTOR(hash,zr_boost_1_81::hash)
...
struct hash_ckey_normal
{
  ...
  {
    /* same hashing formula as zr_boost_1_81::hash_combine */
...
public:
  ...
  bool operator()(
    ...
    const Value& y)const
  {
    return operator()(x,zr_boost_1_81::make_tuple(zr_boost_1_81::cref(y)));
  }
#endif
  ...
  bool operator()(
    ...
    const composite_key_result<CompositeKey>& y)const
  {
    return operator()(zr_boost_1_81::make_tuple(zr_boost_1_81::cref(x)),y);
  }
#endif
 ...
 * composite_key_result_hash     uses zr_boost_1_81::hash.
 */
...
/* Specializations of std::equal_to, std::less, std::greater and zr_boost_1_81::hash
...
template<typename CompositeKey>
struct equal_to<zr_boost_1_81::multi_index::composite_key_result<CompositeKey> >:
  zr_boost_1_81::multi_index::composite_key_result_equal_to<
    zr_boost_1_81::multi_index::composite_key_result<CompositeKey>
  >
{
};

template<typename CompositeKey>
struct less<zr_boost_1_81::multi_index::composite_key_result<CompositeKey> >:
  zr_boost_1_81::multi_index::composite_key_result_less<
    zr_boost_1_81::multi_index::composite_key_result<CompositeKey>
  >
{
};
...
template<typename CompositeKey>
struct greater<zr_boost_1_81::multi_index::composite_key_result<CompositeKey> >:
  zr_boost_1_81::multi_index::composite_key_result_greater<
    zr_boost_1_81::multi_index::composite_key_result<CompositeKey>
  >
{
};
...
template<typename CompositeKey>
struct hash<zr_boost_1_81::multi_index::composite_key_result<CompositeKey> >:
  zr_boost_1_81::multi_index::composite_key_result_hash<
    zr_boost_1_81::multi_index::composite_key_result<CompositeKey>
  >
{
};
