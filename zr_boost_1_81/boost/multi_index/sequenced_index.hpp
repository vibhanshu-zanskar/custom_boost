...
public:
  ...
  typedef typename
    zr_boost_1_81::reverse_iterator<iterator>            reverse_iterator;
  typedef typename
    zr_boost_1_81::reverse_iterator<const_iterator>      const_reverse_iterator;
...
public:
  ...
  reverse_iterator
    rbegin()BOOST_NOEXCEPT{return zr_boost_1_81::make_reverse_iterator(end());}
  const_reverse_iterator
    rbegin()const BOOST_NOEXCEPT{return zr_boost_1_81::make_reverse_iterator(end());}
  reverse_iterator
    rend()BOOST_NOEXCEPT{return zr_boost_1_81::make_reverse_iterator(begin());}
  const_reverse_iterator
    rend()const BOOST_NOEXCEPT{return zr_boost_1_81::make_reverse_iterator(begin());}
  const_iterator
  ...
  iterator iterator_to(const value_type& x)
  {
    return make_iterator(
      node_from_value<index_node_type>(zr_boost_1_81::addressof(x)));
  }
  ...
  std::pair<iterator,bool> push_front(BOOST_RV_REF(value_type) x)
                             {return insert(begin(),zr_boost_1_81::move(x));}
  ...
  std::pair<iterator,bool> push_back(BOOST_RV_REF(value_type) x)
                             {return insert(end(),zr_boost_1_81::move(x));}
  ...
  insert_return_type insert(const_iterator position,BOOST_RV_REF(node_type) nh)
  {
    ...
    return insert_return_type(make_iterator(p.first),p.second,zr_boost_1_81::move(nh));
  }
  ...
  splice(iterator position,Index& x)
  {
    ...
    if(x.end().get_node()==this->header()){ /* same container */
      ...
      external_splice(
        ...
        zr_boost_1_81::is_copy_constructible<value_type>());
    }
  }
    ...
    iterator position,Index& x,BOOST_DEDUCED_TYPENAME Index::iterator i)
  {
    ...
    if(x.end().get_node()==this->header()){ /* same container */
      ...
      std::pair<final_node_type*,bool> p=
        external_splice(
          position,x,i,zr_boost_1_81::is_copy_constructible<value_type>());
      return std::pair<iterator,bool>(make_iterator(p.first),p.second);
    }
  }
    ...
    BOOST_DEDUCED_TYPENAME Index::iterator last)
  {
    ...
    if(x.end().get_node()==this->header()){ /* same container */
      ...
      external_splice(
        position,x,first,last,zr_boost_1_81::is_copy_constructible<value_type>());
    }
  }
  ...
  void remove(value_param_type value)
  {
    sequenced_index_remove(
      *this,
      ::zr_boost_1_81::bind<bool>(
        std::equal_to<value_type>(),::zr_boost_1_81::arg<1>(),value));
  }
...
BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS:
    ...
    Archive& ar,const unsigned int version,const index_loader_type& lm)
  {
    lm.load(
      ::zr_boost_1_81::bind(
        &sequenced_index::rearranger,this,::zr_boost_1_81::arg<1>(),::zr_boost_1_81::arg<2>()),
      ar,version);
  ...
  /* This forwarding function eases things for the zr_boost_1_81::mem_fn construct
...
private:
  ...
  std::pair<final_node_type*,bool> external_splice(
    iterator position,Index& x,BOOST_DEDUCED_TYPENAME Index::iterator i,
    zr_boost_1_81::true_type /* copy-constructible value */)
  {
    if(get_allocator()==x.get_allocator()){
      return external_splice(position,x,i,zr_boost_1_81::false_type());
    }
    else{
  ...
  std::pair<final_node_type*,bool> external_splice(
    iterator position,Index& x,BOOST_DEDUCED_TYPENAME Index::iterator i,
    zr_boost_1_81::false_type /* copy-constructible value */)
  {
  ...
  {
    if(get_allocator()==x.get_allocator()){
      external_splice(position,x,first,last,zr_boost_1_81::false_type());
    }
    else{
      /* backwards compatibility with old, non-transfer-based splice */
...
template<typename SuperMeta,typename TagList>
inline zr_boost_1_81::mpl::true_* boost_foreach_is_noncopyable(
  zr_boost_1_81::multi_index::detail::sequenced_index<SuperMeta,TagList>*&,
