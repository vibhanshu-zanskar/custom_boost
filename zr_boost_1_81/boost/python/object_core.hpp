...
// attribute/item access or addition.
  ...
  //
  BOOST_PYTHON_IS_XXX_DEF(proxy, zr_boost_1_81::python::api::proxy, 1)
...
# endif
  ...
  struct is_derived
    : zr_boost_1_81::python::detail::is_convertible<
...
# define BOOST_PYTHON_FORWARD_OBJECT_CONSTRUCTORS(derived, base)               \
    inline explicit derived(::zr_boost_1_81::python::detail::borrowed_reference p)     \
        : base(p) {}                                                           \
    inline explicit derived(::zr_boost_1_81::python::detail::new_reference p)          \
        : base(p) {}                                                           \
    inline explicit derived(::zr_boost_1_81::python::detail::new_non_null_reference p) \
        : base(p) {}
  ...
  struct object_initializer_impl<false, true>
  {
      ...
      get(T const& x, U)
      {
          return python::incref(get_managed_object(x, zr_boost_1_81::python::tag));
      }
  };
...
{ 
  ...
  return zr_boost_1_81::python::detail::args_proxy(x); 
} 
...
{ 
  ...
  PyObject *result = PyObject_Call(get_managed_object(self, zr_boost_1_81::python::tag), 
                                   args.operator object().ptr(), 
                                   0); 
  return object(zr_boost_1_81::python::detail::new_reference(result)); 
