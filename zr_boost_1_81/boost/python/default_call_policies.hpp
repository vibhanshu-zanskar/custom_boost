...
struct default_result_converter
{
    ...
    struct apply
    {
        typedef typename mpl::if_<
          ...
          , zr_boost_1_81::python::to_python_value<
...
{
    typedef zr_boost_1_81::python::to_python_value<char const*const&> type;
};

template <>
struct default_result_converter::apply<PyObject*>
{
    typedef zr_boost_1_81::python::to_python_value<PyObject*const&> type;
};
