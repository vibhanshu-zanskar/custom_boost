...
namespace zr_boost_1_81 { namespace python { namespace container_utils {
    ...
    extend_container(Container& container, object l)
    {
        ...
        BOOST_FOREACH(object elem,
            std::make_pair(
              zr_boost_1_81::python::stl_input_iterator<object>(l),
              zr_boost_1_81::python::stl_input_iterator<object>()
              ))
        {
...
}}} // namespace zr_boost_1_81::python::container_utils
