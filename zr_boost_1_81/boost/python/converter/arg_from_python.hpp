...
struct back_reference_arg_from_python
    : zr_boost_1_81::python::arg_from_python<typename T::type>
{
    typedef T result_type;
    ...
    T operator()();
 private:
    typedef zr_boost_1_81::python::arg_from_python<typename T::type> base;
    PyObject* m_source;
};
          ...
          , if_2<
              ...
              , if_2<
                  ...
                  , if_2<
                      ...
                      , mpl::if_<
                            zr_boost_1_81::python::is_back_reference<T>
