...
struct rvalue_from_python_storage
{
    ...
    typename python::detail::referent_storage<
        typename zr_boost_1_81::python::detail::add_lvalue_reference<T>::type
    >::type storage;
};
...
# endif
 ...
 private:
    typedef typename zr_boost_1_81::python::detail::add_lvalue_reference<
                typename zr_boost_1_81::python::detail::add_cv<T>::type>::type ref_type;
};
...
inline rvalue_from_python_data<T>::~rvalue_from_python_data()
{
    if (this->stage1.convertible == this->storage.bytes)
    {
        ...
        void *aligned_storage =
            ::zr_boost_1_81::alignment::align(zr_boost_1_81::python::detail::alignment_of<T>::value, 0, ptr, allocated);
