...
namespace detail
{
  ...
  )
  {
      ...
      return objects::make_iterator_function<Target>(
          zr_boost_1_81::protect(zr_boost_1_81::bind(get_start, _1))
        , zr_boost_1_81::protect(zr_boost_1_81::bind(get_finish, _1))
        , next_policies
      );
  }
...
object range(Accessor1 start, Accessor2 finish, NextPolicies* = 0, zr_boost_1_81::type<Target>* = 0)
{
