...
template <class T>
inline typeinfo msvc_typeid(zr_boost_1_81::type<T>*)
{
    return detail::typeid_ref(
        (zr_boost_1_81::type<T>*)0, detail::is_ref_tester1(type<T>())
        );
}

template <>
inline typeinfo msvc_typeid<void>(zr_boost_1_81::type<void>*)
{
    return typeid(void);
}
...
{
    return msvc_typeid((zr_boost_1_81::type<char const[3]>*)0)
        , msvc_typeid((zr_boost_1_81::type<char[3]>*)0);
}
#  endif
