...
zr_boost_1_81::type<R>* result(R (T::*), int = 0) { return 0; }
...
{
    typedef zr_boost_1_81::type<typename T::result_type> type;
};
...
template <class X>
zr_boost_1_81::type<typename X::result_type>*
...
zr_boost_1_81::type<R>* result(R (*)(BOOST_PP_ENUM_PARAMS_Z(1, N, A)), int = 0)
{
    return 0;
}
...
zr_boost_1_81::type<R>* result(R (T::*)(BOOST_PP_ENUM_PARAMS_Z(1, N, A)) Q, int = 0)
{
    return 0;
}
