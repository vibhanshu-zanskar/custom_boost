...
# else
#  define BOOST_PYTHON_BEGIN_CONVERSION_NAMESPACE namespace zr_boost_1_81 { namespace python {
#  define BOOST_PYTHON_END_CONVERSION_NAMESPACE }} // namespace zr_boost_1_81::python
#  define BOOST_PYTHON_CONVERSION zr_boost_1_81::python
