...
namespace detail
{
    ...
    template<class T>
    struct test_get_pytype : zr_boost_1_81::mpl::bool_<test_get_pytype_base<T>::value> 
    {
    };
...
{
#ifndef BOOST_PYTHON_NO_PY_SIGNATURES
    typedef zr_boost_1_81::mpl::bool_<has_get_pytype> HasGetPytype;

    static PyTypeObject const* get_pytype_1(zr_boost_1_81::mpl::true_ *)
    {
        return Conversion::get_pytype();
    }

    static PyTypeObject const* get_pytype_1(zr_boost_1_81::mpl::false_ *)
    {
        return 0;
    }
