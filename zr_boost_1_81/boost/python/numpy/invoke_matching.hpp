...
namespace zr_boost_1_81 { namespace python { namespace numpy {
namespace detail 
{
...
struct BOOST_NUMPY_DECL add_pointer_meta
{
  ...
  struct apply 
  {
    typedef typename zr_boost_1_81::add_pointer<T>::type type;
  };
...
template <typename Function>
struct dtype_template_invoker< zr_boost_1_81::reference_wrapper<Function> > 
{
...
{    
  template <int N>
  void operator()(zr_boost_1_81::mpl::integral_c<int,N> *) const 
  {
    if (m_nd == N) 
    {
...
template <typename Function>
struct nd_template_invoker< zr_boost_1_81::reference_wrapper<Function> > 
{    
  template <int N>
  void operator()(zr_boost_1_81::mpl::integral_c<int,N> *) const 
  {
...
} // namespace zr_boost_1_81::python::numpy::detail
...
void invoke_matching_nd(int nd, Function f) 
{
  ...
  try { zr_boost_1_81::mpl::for_each< Sequence, detail::add_pointer_meta >(invoker);}
...
template <typename DimSequence, typename Function>
struct array_template_invoker_wrapper_1< DimSequence, zr_boost_1_81::reference_wrapper<Function> >
...
}}} // namespace zr_boost_1_81::python::numpy
