 ...
 *
 *  @todo This could have a lot more functionality (like zr_boost_1_81::python::numeric::array).
...
ndarray from_data_impl(void * data,
		       ...
		       object const & owner,
		       bool writeable,
		       typename zr_boost_1_81::enable_if< zr_boost_1_81::python::detail::is_integral<typename Container::value_type> >::type * enabled = NULL)
{
