...
struct make_instance_impl
{
    ...
    {
        BOOST_MPL_ASSERT((mpl::or_<zr_boost_1_81::python::detail::is_class<T>,
                zr_boost_1_81::python::detail::is_union<T> >));
    ...
    : make_instance_impl<T, Holder, make_instance<T,Holder> >
{
    ...
    static inline Holder* construct(void* storage, PyObject* instance, reference_wrapper<T const> x)
    {
        ...
        void* aligned_storage = ::zr_boost_1_81::alignment::align(zr_boost_1_81::python::detail::alignment_of<Holder>::value,
