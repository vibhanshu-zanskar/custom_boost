...
struct register_base_of
{
    ...
    {
        BOOST_MPL_ASSERT_NOT((zr_boost_1_81::python::detail::is_same<Base,Derived>));
        ...
        this->register_downcast((Base*)0, zr_boost_1_81::python::detail::is_polymorphic<Base>());
    }

 private:
    static inline void register_downcast(void*, zr_boost_1_81::python::detail::false_) {}
    
    template <class Base>
    static inline void register_downcast(Base*, zr_boost_1_81::python::detail::true_)
    {
...
inline void register_shared_ptr_from_python_and_casts(T*, Bases)
{
  ...
  python::detail::force_instantiate(converter::shared_ptr_from_python<T, zr_boost_1_81::shared_ptr>());
  ...
  mpl::for_each(register_base_of<T>(), (Bases*)0, (zr_boost_1_81::python::detail::add_pointer<mpl::_>*)0);
}
...
struct select_held_type
  : mpl::if_<
        mpl::or_<
          ...
          , zr_boost_1_81::python::detail::is_same<T,noncopyable>
        >
      , Prev
      , T
    >
...
struct class_metadata
{
    ...
    typedef mpl::or_<
        zr_boost_1_81::python::detail::is_same<X1,noncopyable>
      , zr_boost_1_81::python::detail::is_same<X2,noncopyable>
      , zr_boost_1_81::python::detail::is_same<X3,noncopyable>
    > is_noncopyable;
    ...
    typedef typename mpl::if_<
        zr_boost_1_81::python::detail::is_same<held_type_arg,python::detail::not_specified>, T, held_type_arg
    >::type held_type;

    // Determine if the object will be held by value
    typedef mpl::bool_<zr_boost_1_81::python::detail::is_convertible<held_type*,T*>::value> use_value_holder;
    ...
    typedef mpl::bool_<
        mpl::or_<
          ...
          , zr_boost_1_81::python::detail::is_same<held_type_arg,T>
 ...
 private:
    ...
    {
        typedef typename mpl::not_<zr_boost_1_81::python::detail::is_same<T2,wrapped> >::type use_callback;
