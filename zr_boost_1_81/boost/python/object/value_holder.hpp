...
{
    if (void* wrapped = holds_wrapped(dst_t, zr_boost_1_81::addressof(m_held), zr_boost_1_81::addressof(m_held)))
        return wrapped;
    
    type_info src_t = python::type_id<Value>();
    return src_t == dst_t ? zr_boost_1_81::addressof(m_held)
        : find_static_type(zr_boost_1_81::addressof(m_held), src_t, dst_t);
}
...
# endif
    ...
    {
        python::detail::initialize_wrapper(self, zr_boost_1_81::addressof(this->m_held));
    }
