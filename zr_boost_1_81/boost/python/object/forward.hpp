...
// Very much like zr_boost_1_81::reference_wrapper<T>, except that in this
// case T can be a reference already without causing a
// reference-to-reference error.
template <class T>
struct reference_to_value
{
    typedef typename zr_boost_1_81::python::detail::add_lvalue_reference<typename
        zr_boost_1_81::python::detail::add_const<T>::type>::type reference;
...
struct forward
    : mpl::if_<
          mpl::or_<python::detail::copy_ctor_mutates_rhs<T>, zr_boost_1_81::python::detail::is_scalar<T> >
        , T
...
struct unforward_cref<reference_to_value<T> >
  : zr_boost_1_81::python::detail::add_lvalue_reference<typename zr_boost_1_81::python::detail::add_const<T>::type>
{
};
