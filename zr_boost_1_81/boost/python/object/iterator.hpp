...
)
{
    ...
    typedef typename zr_boost_1_81::python::detail::add_const<iterator>::type iterator_const;
    typedef typename zr_boost_1_81::python::detail::add_lvalue_reference<iterator_const>::type iterator_cref;
