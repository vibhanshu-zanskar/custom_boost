...
struct dynamic_id_generator
  : mpl::if_<
        zr_boost_1_81::python::detail::is_polymorphic<T>
        , zr_boost_1_81::python::objects::polymorphic_id_generator<T>
        , zr_boost_1_81::python::objects::non_polymorphic_id_generator<T>
    >
{};
...
struct cast_generator
  : mpl::if_<
        zr_boost_1_81::python::detail::is_base_and_derived<Target,Source>
...
inline void register_conversion(
    bool is_downcast = ::zr_boost_1_81::is_base_and_derived<Source,Target>::value
