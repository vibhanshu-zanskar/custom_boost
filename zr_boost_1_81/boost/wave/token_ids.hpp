...
#undef TOKEN_FROM_ID
#define TOKEN_FROM_ID(id, cat)   zr_boost_1_81::wave::token_id((id) | (cat))

#undef ID_FROM_TOKEN
#define ID_FROM_TOKEN(tok)                                                    \
    zr_boost_1_81::wave::token_id((tok) &                                             \
        ~(zr_boost_1_81::wave::TokenTypeMask|zr_boost_1_81::wave::PPTokenFlag))               \
    /**/

#undef BASEID_FROM_TOKEN
#define BASEID_FROM_TOKEN(tok)                                                \
    zr_boost_1_81::wave::token_id((tok) &                                             \
         ~(zr_boost_1_81::wave::ExtTokenTypeMask|zr_boost_1_81::wave::PPTokenFlag))           \
    /**/
#define BASE_TOKEN(tok)                                                       \
    zr_boost_1_81::wave::token_id((tok) & zr_boost_1_81::wave::MainTokenMask)                 \
    /**/
#define CATEGORY_FROM_TOKEN(tok) ((tok) & zr_boost_1_81::wave::TokenTypeMask)
#define EXTCATEGORY_FROM_TOKEN(tok) ((tok) & zr_boost_1_81::wave::ExtTokenTypeMask)
...
inline bool is_pp_token(zr_boost_1_81::wave::token_id id)
{
    return (id & zr_boost_1_81::wave::PPTokenFlag) ? true : false;
}

template <typename TokenT>
inline bool is_pp_token(TokenT const& tok)
{
    return is_pp_token(zr_boost_1_81::wave::token_id(tok));
}
