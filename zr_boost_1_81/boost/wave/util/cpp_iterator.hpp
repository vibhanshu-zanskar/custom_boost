...
retrieve_macroname(ContextT& ctx, ParseNodeT const &node,
    zr_boost_1_81::spirit::classic::parser_id id, TokenT &macroname, PositionT& act_pos,
    bool update_position)
{
    ParseNodeT const* name_node = 0;

    using zr_boost_1_81::spirit::classic::find_node;
...
retrieve_macrodefinition(
    ParseNodeT const &node, zr_boost_1_81::spirit::classic::parser_id id,
    ContainerT &macrodefinition, PositionT& act_pos, bool update_position)
{
    using namespace zr_boost_1_81::wave;
    ...
    using zr_boost_1_81::spirit::classic::get_node_range;
...
bool add_macro_definition(ContextT &ctx, std::string macrostring,
    bool is_predefined, zr_boost_1_81::wave::language_support language)
{
    typedef typename ContextT::token_type token_type;
    typedef typename ContextT::lexer_type lexer_type;
    typedef typename token_type::position_type position_type;
    typedef zr_boost_1_81::wave::grammars::predefined_macros_grammar_gen<lexer_type>
        predef_macros_type;
    ...
    zr_boost_1_81::spirit::classic::tree_parse_info<lexer_type> hit =
    ...
    if (!zr_boost_1_81::wave::util::retrieve_macroname(ctx, *hit.trees.begin(),
            BOOST_WAVE_PLAIN_DEFINE_ID, macroname, act_pos, true))
        return false;
    has_parameters = zr_boost_1_81::wave::util::retrieve_macrodefinition(*hit.trees.begin(),
        BOOST_WAVE_MACRO_PARAMETERS_ID, macroparameters, act_pos, true);
    zr_boost_1_81::wave::util::retrieve_macrodefinition(*hit.trees.begin(),
...
public:
    // interface to the zr_boost_1_81::spirit::classic::iterator_policies::functor_input policy
...
private:
    ...
    typedef zr_boost_1_81::wave::grammars::cpp_grammar_gen<lexer_type, token_sequence_type>
        cpp_grammar_type;
    ...
    typedef zr_boost_1_81::spirit::classic::tree_parse_info<lexer_type, node_factory_type>
        tree_parse_info_type;
    typedef zr_boost_1_81::spirit::classic::tree_match<lexer_type, node_factory_type>
    ...
    :   ctx(ctx_),
        iter_ctx(new base_iteration_context_type(ctx,
                lexer_type(first_, last_, pos_,
                    zr_boost_1_81::wave::enable_prefer_pp_numbers(ctx.get_language())),
                lexer_type(),
                pos_.get_file().c_str()
            )),
        seen_newline(true), skipped_newline(false),
        must_emit_line_directive(false), act_pos(ctx_.get_main_pos()),
        whitespace(zr_boost_1_81::wave::need_insert_whitespace(ctx.get_language()))
    {
...
private:
    ...
    zr_boost_1_81::shared_ptr<base_iteration_context_type> iter_ctx;
    ...
    // re-tokenized
    zr_boost_1_81::wave::util::insert_whitespace_detection whitespace;
};
...
pp_iterator_functor<ContextT>::returned_from_include()
{
    ...
    // of the included file
        ...
        if (iter_ctx->if_block_depth != ctx.get_if_block_depth()) {
            using zr_boost_1_81::wave::util::impl::escape_lit;
...
pp_iterator_functor<ContextT>::operator()()
{
    ...
    catch (zr_boost_1_81::wave::cpplexer::lexing_exception const& e) {
...
//             whitespace.shift_tokens(T_NEWLINE);
            ...
            if (!ctx.get_hooks().emit_line_directive(ctx, pending, act_token))
            {
                ...
                std::string file("\"");
                zr_boost_1_81::filesystem::path filename(
    ...
    if (!impl::next_token_is_pp_directive(ctx, it, iter_ctx->last)) {
        ...
        if (it != iter_ctx->last && T_POUND == BASE_TOKEN(token_id(*it))) {
            if (impl::pp_is_last_on_line(ctx, it, iter_ctx->last)) {
                ...
                string_type str(zr_boost_1_81::wave::util::impl::as_string<string_type>(
                    iter_ctx->first, it));
...
// test, if this file is known through a #pragma once directive
...
#endif
    {
        ...
        zr_boost_1_81::shared_ptr<base_iteration_context_type> new_iter_ctx(
    ...
    typename parse_tree_type::const_iterator const &end, bool include_next)
{
    ...
    using namespace zr_boost_1_81::wave::util::impl;
...
pp_iterator_functor<ContextT>::on_define (parse_node_type const &node)
{
    ...
    if (!zr_boost_1_81::wave::util::retrieve_macroname(ctx, node,
            BOOST_WAVE_PLAIN_DEFINE_ID, macroname, pos, false))
        return;
    has_parameters = zr_boost_1_81::wave::util::retrieve_macrodefinition(node,
        BOOST_WAVE_MACRO_PARAMETERS_ID, macroparameters, pos, false);
    zr_boost_1_81::wave::util::retrieve_macrodefinition(node,
        BOOST_WAVE_MACRO_DEFINITION_ID, macrodefinition, pos, false);

    if (has_parameters) {
#if BOOST_WAVE_SUPPORT_VARIADICS_PLACEMARKERS != 0
        if (zr_boost_1_81::wave::need_variadics(ctx.get_language())) {
                ...
                pit != end; ++pit)
            {
                ...
                if (zr_boost_1_81::wave::need_va_opt(ctx.get_language()) &&
    ...
    typename parse_tree_type::const_iterator const &end)
{
    ...
    do {
        ...
        {
            string_type outstr(zr_boost_1_81::wave::util::impl::as_string(toexpand));
            outstr += "(" + zr_boost_1_81::wave::util::impl::as_string(expanded) + ")";
        ...
        catch (zr_boost_1_81::wave::preprocess_exception const& e) {
...
namespace impl {
    ...
    bool retrieve_line_info (IteratorT first, IteratorT const &last,
        ...
        zr_boost_1_81::wave::preprocess_exception::error_code& error)
    {
        using namespace zr_boost_1_81::wave;
        ...
        // re-extract line number with spirit to diagnose overflow
            using namespace zr_boost_1_81::spirit::classic;
    ...
    typename parse_tree_type::const_iterator const &end)
{
    ...
    if (!impl::retrieve_line_info(first, last, line, file_name, error)) {
            ...
            line, file_name, error))
        {
            typename ContextT::string_type msg(
                zr_boost_1_81::wave::util::impl::as_string(expanded));
    ...
    if (!file_name.empty()) {    // reuse current file name
        using zr_boost_1_81::wave::util::impl::unescape_lit;
    ...
    typename parse_tree_type::const_iterator const &end)
{
...
#endif
    {
        ...
        BOOST_WAVE_STRINGTYPE msg(zr_boost_1_81::wave::util::impl::as_string(expanded));
    ...
    typename parse_tree_type::const_iterator const &end)
{
    ...
    if (first != last) {
        if (T_IDENTIFIER == token_id(*first) &&
            zr_boost_1_81::wave::need_c99(ctx.get_language()) &&
    ...
    if (zr_boost_1_81::wave::need_emit_pragma_directives(ctx.get_language())) {
        pending_queue.splice(pending_queue.begin(), expanded);
    ...
    token_sequence_type const &pragma_body, token_sequence_type &result)
{
    ...
    return zr_boost_1_81::wave::util::interpret_pragma(
...
//  pp_iterator
//
//      The zr_boost_1_81::wave::pp_iterator template is the iterator, through which
...
template <typename ContextT>
class pp_iterator
:   public zr_boost_1_81::spirit::classic::multi_pass<
        zr_boost_1_81::wave::impl::pp_iterator_functor<ContextT>,
        zr_boost_1_81::wave::util::functor_input
    >
{
public:
    typedef zr_boost_1_81::wave::impl::pp_iterator_functor<ContextT> input_policy_type;

private:
    typedef
        zr_boost_1_81::spirit::classic::multi_pass<input_policy_type, zr_boost_1_81::wave::util::functor_input>
        base_type;
    typedef pp_iterator<ContextT> self_type;
    typedef zr_boost_1_81::wave::util::functor_input functor_input_type;
