...
//
// #HK030306:
//      - Moved into the namespace zr_boost_1_81::wave::util
...
public:
    ...
    pointer allocate(size_type n, const_pointer = 0)
    {
        ...
        if (!p) zr_boost_1_81::throw_exception(std::bad_alloc());
...
// 'operator delete(void*, unsigned long)' called on unallocated object 'zr_boost_1_81::wave::util::SimpleStringStorage<char, std::allocator<char> >::emptyString_' [-Wfree-nonheap-object]
...
public:
    ...
    typedef typename zr_boost_1_81::allocator_size_type<A>::type size_type;
...
private:
    ...
    void Init(size_type size, size_type capacity)
    {
        ...
        else
        {
            ...
            if (!pData_) zr_boost_1_81::throw_exception(std::bad_alloc());
...
class AllocatorStringStorage : public A
{
    ...
    {
        return zr_boost_1_81::allocator_allocate(static_cast<A&>(*this), 1 + (sz - 1) / sizeof(E),
            static_cast<const char*>(p));
    }

    void Free(void* p, size_type sz)
    {
        zr_boost_1_81::allocator_deallocate(static_cast<A&>(*this), static_cast<E*>(p), sz);
    }
...
public:
    ...
    size_type max_size() const
    { return zr_boost_1_81::allocator_max_size(static_cast<const A&>(*this)); }
...
public:
    ...
    typedef typename zr_boost_1_81::allocator_size_type<allocator_type>::type size_type;
...
public:
  SmallStringOpt(const SmallStringOpt& s)
    ...
    size_type max_size() const
    { return zr_boost_1_81::allocator_max_size(get_allocator()); }
...
class flex_string : private Storage
{
    ...
    { if (!condition) zr_boost_1_81::throw_exception(Exception(msg)); }
#else
    template <typename Exception>
...
public:
    ...
    typedef typename zr_boost_1_81::allocator_value_type<A>::type& reference;
    typedef typename zr_boost_1_81::allocator_value_type<A>::type const& const_reference;
    typedef typename zr_boost_1_81::allocator_pointer<A>::type pointer;
    typedef typename zr_boost_1_81::allocator_const_pointer<A>::type const_pointer;
    typedef typename zr_boost_1_81::allocator_size_type<A>::type size_type;
...
template <typename E, class T, class A, class S>
struct implementation_level<zr_boost_1_81::wave::util::flex_string<E, T, A, S> >
{
    typedef mpl::integral_c_tag tag;
    typedef mpl::int_<zr_boost_1_81::serialization::primitive_type> type;
...
inline void save(Archive & ar,
    zr_boost_1_81::wave::util::flex_string<E, T, A, S> const &t,
...
template<class Archive, typename E, class T, class A, class S>
inline void load(Archive & ar, zr_boost_1_81::wave::util::flex_string<E, T, A, S> &t,
    const unsigned int file_version)
{
    zr_boost_1_81::serialization::stl::load_collection<
        Archive, zr_boost_1_81::wave::util::flex_string<E, T, A, S>,
        zr_boost_1_81::serialization::stl::archive_input_seq<
            Archive, zr_boost_1_81::wave::util::flex_string<E, T, A, S> >,
        zr_boost_1_81::serialization::stl::reserve_imp<
            zr_boost_1_81::wave::util::flex_string<E, T, A, S> >
    >(ar, t);
}
...
template<class Archive, typename E, class T, class A, class S>
inline void serialize(Archive & ar, zr_boost_1_81::wave::util::flex_string<E, T, A, S> &t,
    const unsigned int file_version)
{
