...
//  specialization of the zr_boost_1_81::spirit::classic::position_policy class is
//  provided below.
//
///////////////////////////////////////////////////////////////////////////////
...
:   zr_boost_1_81::spirit::classic::position_iterator<IteratorT, PositionT>
{
    typedef zr_boost_1_81::spirit::classic::position_iterator<IteratorT, PositionT> base_type;
...
///////////////////////////////////////////////////////////////////////////////
//
//  The zr_boost_1_81::spirit::classic::position_policy has to be specialized for our
//  file_position class
//
///////////////////////////////////////////////////////////////////////////////

    template <>
    class position_policy<zr_boost_1_81::wave::util::file_position_type> {
    ...
    public:
        ...
        void next_line(zr_boost_1_81::wave::util::file_position_type &pos)
        {
        ...
        void next_char(zr_boost_1_81::wave::util::file_position_type &pos)
        {
            pos.set_column(pos.get_column() + 1);
        }

        void tabulation(zr_boost_1_81::wave::util::file_position_type &pos)
        {
