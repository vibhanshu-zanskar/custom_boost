...
namespace util {
    ...
    public:
        ...
        struct static_macros {
            char const *name;
            zr_boost_1_81::wave::token_id token_id;
            char const *value;
        };
    ...
    private:
        zr_boost_1_81::wave::util::time_conversion_helper compilation_time_;
    ...
    protected:
        void reset_datestr()
        {
            ...
            if (tt != (time_t)-1) {
                tb = localtime (&tt);
                datestr_ = strconv((zr_boost_1_81::format("\"%s %2d %4d\"")
        ...
        void reset_timestr()
        {
            ...
            if (tt != (time_t)-1) {
                tb = localtime (&tt);
                timestr_ = strconv((zr_boost_1_81::format("\"%02d:%02d:%02d\"")
                                    % tb->tm_hour
                                    % tb->tm_min
                                    % tb->tm_sec).str());
            }
        ...
        void reset_version()
        {
            ...
            version_ = strconv((zr_boost_1_81::format("0x%02d%1d%1d%04ld")
        ...
        void reset_versionstr()
        {
            ...
            versionstr_ = strconv((zr_boost_1_81::format("\"%d.%d.%d.%ld [%s/%s]\"")
                                   % BOOST_WAVE_VERSION_MAJOR
                                   % BOOST_WAVE_VERSION_MINOR
                                   % BOOST_WAVE_VERSION_SUBMINOR
                                   % (seconds/(3600*24))
        ...
        {
            return strconv((zr_boost_1_81::format("0x%02d%1d%1d")
                            % BOOST_WAVE_VERSION_MAJOR
                            % BOOST_WAVE_VERSION_MINOR
        ...
        {
            return strconv((zr_boost_1_81::format("0x%08x") % BOOST_WAVE_CONFIG).str());
        }
