...
// T_IDENTIFIER
    ...
    template <typename StringT>
    inline bool
    handle_identifier(zr_boost_1_81::wave::token_id prev,
        zr_boost_1_81::wave::token_id before, StringT const &value)
    {
...
// T_INTLIT
    inline bool
    handle_intlit(zr_boost_1_81::wave::token_id prev, zr_boost_1_81::wave::token_id /*before*/)
    {
        using namespace zr_boost_1_81::wave;
        switch (prev) {
        case T_IDENTIFIER:
...
// T_FLOATLIT
    inline bool
    handle_floatlit(zr_boost_1_81::wave::token_id prev,
        zr_boost_1_81::wave::token_id /*before*/)
    {
        using namespace zr_boost_1_81::wave;
        switch (prev) {
        case T_IDENTIFIER:
...
// <% T_LEFTBRACE
    inline bool
    handle_alt_leftbrace(zr_boost_1_81::wave::token_id prev,
        zr_boost_1_81::wave::token_id /*before*/)
    {
        using namespace zr_boost_1_81::wave;
        switch (prev) {
...
// <: T_LEFTBRACKET
    inline bool
    handle_alt_leftbracket(zr_boost_1_81::wave::token_id prev,
        zr_boost_1_81::wave::token_id /*before*/)
    {
        using namespace zr_boost_1_81::wave;
        switch (prev) {
...
// T_FIXEDPOINTLIT
    inline bool
    handle_fixedpointlit(zr_boost_1_81::wave::token_id prev,
        zr_boost_1_81::wave::token_id /*before*/)
    {
        using namespace zr_boost_1_81::wave;
        switch (prev) {
...
// T_DOT
    inline bool
    handle_dot(zr_boost_1_81::wave::token_id prev, zr_boost_1_81::wave::token_id before)
    {
        using namespace zr_boost_1_81::wave;
        switch (prev) {
        case T_DOT:
...
// T_QUESTION_MARK
    inline bool
    handle_questionmark(zr_boost_1_81::wave::token_id prev,
        zr_boost_1_81::wave::token_id /*before*/)
    {
        using namespace zr_boost_1_81::wave;
        switch(prev) {
...
// T_NEWLINE
    inline bool
    handle_newline(zr_boost_1_81::wave::token_id prev,
        zr_boost_1_81::wave::token_id before)
    {
        using namespace zr_boost_1_81::wave;
        switch(prev) {
    ...
    inline bool
    handle_parens(zr_boost_1_81::wave::token_id prev)
    {
        switch (prev) {
        case T_LEFTPAREN:
        case T_RIGHTPAREN:
...
public:
    ...
    :   insert_whitespace(insert_whitespace_),
        prev(zr_boost_1_81::wave::T_EOF), beforeprev(zr_boost_1_81::wave::T_EOF)
    {}

    template <typename StringT>
    bool must_insert(zr_boost_1_81::wave::token_id current, StringT const &value)
    {
...
//         }
    ...
    void shift_tokens (zr_boost_1_81::wave::token_id next_id)
    {
        if (insert_whitespace) {
            beforeprev = prev;
            prev = next_id;
...
private:
    ...
    zr_boost_1_81::wave::token_id prev;        // the previous analyzed token
    zr_boost_1_81::wave::token_id beforeprev;  // the token before the previous
};
