...
struct bidirectional_map
{
    ...
    typedef zr_boost_1_81::multi_index::multi_index_container<
        value_type,
        zr_boost_1_81::multi_index::indexed_by<
            zr_boost_1_81::multi_index::ordered_unique<
                zr_boost_1_81::multi_index::tag<from>,
                zr_boost_1_81::multi_index::member_offset<value_type, FromType, from_offset>
            >,
            zr_boost_1_81::multi_index::ordered_non_unique<
                zr_boost_1_81::multi_index::tag<to>,
                zr_boost_1_81::multi_index::member_offset<value_type, ToType, to_offset>
            >
        >
    > type;
  ...
  typedef zr_boost_1_81::multi_index::multi_index_container<
      ...
      zr_boost_1_81::multi_index::indexed_by<
          zr_boost_1_81::multi_index::ordered_unique<
              zr_boost_1_81::multi_index::tag<from>,
              zr_boost_1_81::multi_index::member<value_type, FromType, &value_type::first>
          >,
          zr_boost_1_81::multi_index::ordered_non_unique<
              zr_boost_1_81::multi_index::tag<to>,
              zr_boost_1_81::multi_index::member<value_type, ToType, &value_type::second>
          >
      >
  > type;
...
{
private:
    typedef std::list<std::pair<zr_boost_1_81::filesystem::path, std::string> >
        include_list_type;
...
public:
    ...
    zr_boost_1_81::filesystem::path get_current_directory() const
        { return current_dir; }
...
private:
    ...
    zr_boost_1_81::filesystem::path current_dir;
    zr_boost_1_81::filesystem::path current_rel_dir;

#if BOOST_WAVE_SUPPORT_PRAGMA_ONCE != 0
public:
    bool has_pragma_once(std::string const &filename)
    {
        using zr_boost_1_81::multi_index::get;
...
private:
    ...
    {
        using namespace zr_boost_1_81::serialization;
#if BOOST_WAVE_SUPPORT_PRAGMA_ONCE != 0
...
inline bool
as_relative_to(zr_boost_1_81::filesystem::path const& path,
    zr_boost_1_81::filesystem::path const& base, zr_boost_1_81::filesystem::path& result)
{
    if (path.has_root_path()) {
        ...
        if (base.has_root_path()) {
            ...
            typedef zr_boost_1_81::filesystem::path::const_iterator path_iterator;
...
///////////////////////////////////////////////////////////////////////////////
}}}   // namespace zr_boost_1_81::wave::util
...
///////////////////////////////////////////////////////////////////////////////
//  Serialization support for zr_boost_1_81::filesystem::path
template<class Archive>
inline void save (Archive & ar, zr_boost_1_81::filesystem::path const& p,
...
template<class Archive>
inline void load (Archive & ar, zr_boost_1_81::filesystem::path &p,
    const unsigned int /* file_version */)
{
    using namespace zr_boost_1_81::serialization;
    std::string path_str;
...
template<class Archive>
inline void serialize (Archive & ar, zr_boost_1_81::filesystem::path &p,
    const unsigned int file_version)
{
    zr_boost_1_81::serialization::split_free(ar, p, file_version);
}
...
inline void save (Archive & ar,
    const typename zr_boost_1_81::wave::util::bidirectional_map<
        std::string, std::string
    >::type &t,
    const unsigned int /* file_version */)
{
    zr_boost_1_81::serialization::stl::save_collection<
        Archive,
        typename zr_boost_1_81::wave::util::bidirectional_map<
            std::string, std::string
        >::type
    >(ar, t);
}
...
inline void load (Archive & ar,
    typename zr_boost_1_81::wave::util::bidirectional_map<std::string, std::string>::type &t,
    const unsigned int /* file_version */)
{
    typedef typename zr_boost_1_81::wave::util::bidirectional_map<
            std::string, std::string
        >::type map_type;
    zr_boost_1_81::serialization::stl::load_collection<
        Archive, map_type,
        zr_boost_1_81::serialization::stl::archive_input_unique<Archive, map_type>,
        zr_boost_1_81::serialization::stl::no_reserve_imp<map_type>
    >(ar, t);
}
...
BOOST_CLASS_VERSION(zr_boost_1_81::wave::util::include_paths,
    zr_boost_1_81::wave::util::include_paths::version);
