...
struct symbol_table
#if BOOST_WAVE_SERIALIZATION != 0
:   public std::map<StringT, zr_boost_1_81::shared_ptr<MacroDefT> >
#else
:   public std::map<StringT, zr_boost_1_81::intrusive_ptr<MacroDefT> >
#endif
{
#if BOOST_WAVE_SERIALIZATION != 0
    typedef std::map<StringT, zr_boost_1_81::shared_ptr<MacroDefT> > base_type;
#else
    typedef std::map<StringT, zr_boost_1_81::intrusive_ptr<MacroDefT> > base_type;
#endif
...
private:
    ...
    void serialize(Archive &ar, const unsigned int version)
    {
        ...
        ar & make_nvp("symbol_table",
            zr_boost_1_81::serialization::base_object<base_type>(*this));
    }
#endif
...
public:
    ...
    {
        return zr_boost_1_81::make_transform_iterator<unary_functor>(it);
    }
};
