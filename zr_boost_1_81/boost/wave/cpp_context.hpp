...
//
//      The zr_boost_1_81::wave::context template is the main interface class to
...
>
class context : private zr_boost_1_81::noncopyable
{
private:
...
public:
    ...
    BOOST_CLASS_REQUIRE(IteratorT, zr_boost_1_81, ForwardIteratorConcept);
    ...
    typedef std::list<token_type, zr_boost_1_81::fast_pool_allocator<token_type> >
        token_sequence_type;
...
private:
    ...
    typedef zr_boost_1_81::shared_ptr<base_iteration_context<context, lexer_type> >
        iteration_ptr_type;
    typedef zr_boost_1_81::wave::util::iteration_context_stack<iteration_ptr_type>
...
// maintain defined macros
    ...
    {
        return zr_boost_1_81::wave::util::add_macro_definition(*this,
    ...
    typedef zr_boost_1_81::wave::util::macromap<context> macromap_type;
    ...
    {
        zr_boost_1_81::wave::util::predefined_macros p;
    ...
    void set_language(zr_boost_1_81::wave::language_support language_,
    ...
    zr_boost_1_81::wave::language_support get_language() const { return language; }
...
protected:
    friend class zr_boost_1_81::wave::pp_iterator<context>;
    friend class zr_boost_1_81::wave::impl::pp_iterator_functor<context>;
    friend class zr_boost_1_81::wave::util::macromap<context>;
#endif
    ...
    typename zr_boost_1_81::wave::util::if_block_stack::size_type get_if_block_depth() const
        ...
        bool expand_has_include = true)
    {
        ...
        zr_boost_1_81::wave::util::impl::remove_placeholders(expanded);
    }
...
private:
    ...
    zr_boost_1_81::wave::util::if_block_stack ifblocks;   // conditional compilation contexts
    zr_boost_1_81::wave::util::include_paths includes;    // lists of include directories to search
    iteration_context_stack_type iter_ctxs;       // iteration contexts
    macromap_type macros;                         // map of defined macros
    zr_boost_1_81::wave::language_support language;       // supported language/extensions
...
>
struct tracking_level<zr_boost_1_81::wave::context<Iterator, LexIterator, InputPolicy, Hooks> >
{
...
template<
    ...
    typename InputPolicy, typename Hooks
>
struct version<zr_boost_1_81::wave::context<Iterator, LexIterator, InputPolicy, Hooks> >
{
    typedef zr_boost_1_81::wave::context<Iterator, LexIterator, InputPolicy, Hooks>
        target_type;
