...
struct BOOST_WAVE_DECL cpp_grammar_gen
{
    ...
    typedef zr_boost_1_81::spirit::classic::node_val_data_factory<
//             zr_boost_1_81::spirit::nil_t,
//             zr_boost_1_81::pool_allocator<zr_boost_1_81::spirit::nil_t>
        > node_factory_type;

    //  parse the cpp_grammar and return the resulting parse tree
    static zr_boost_1_81::spirit::classic::tree_parse_info<iterator_type, node_factory_type>
