...
///////////////////////////////////////////////////////////////////////////////
    ...
    :   public zr_boost_1_81::spirit::classic::parser<flush_underlying_parser>
    {
        typedef flush_underlying_parser this_t;

        template <typename ScannerT>
        typename zr_boost_1_81::spirit::classic::parser_result<this_t, ScannerT>::type
...
struct cpp_grammar :
    public zr_boost_1_81::spirit::classic::grammar<cpp_grammar<TokenT, ContainerT> >
{
    ...
    struct definition
    {
        ...
        typedef zr_boost_1_81::spirit::classic::match_policy match_policy_t;
        typedef typename ScannerT::action_policy_t action_policy_t;
        typedef
            zr_boost_1_81::spirit::classic::scanner_policies<
                iteration_policy_t, match_policy_t, action_policy_t>
            policies_t;
        typedef
            zr_boost_1_81::spirit::classic::scanner<typename ScannerT::iterator_t, policies_t>
            non_tree_scanner_t;
        typedef
            zr_boost_1_81::spirit::classic::rule<
                non_tree_scanner_t, zr_boost_1_81::spirit::classic::dynamic_parser_tag>
            no_tree_rule_type;

        // 'normal' (parse_tree generating) rule type
        typedef
            zr_boost_1_81::spirit::classic::rule<
                ScannerT, zr_boost_1_81::spirit::classic::dynamic_parser_tag>
            rule_type;
...
//         rule_type ppelse, ppendif;
        ...
        definition(cpp_grammar const &self)
        {
            ...
            using namespace zr_boost_1_81::wave::util;
...
//            BOOST_SPIRIT_DEBUG_TRACE_RULE(ppendif, TRACE_CPP_GRAMMAR);
    ...
    struct map_ruleid_to_name :
        public std::map<zr_boost_1_81::spirit::classic::parser_id, std::string>
    {
        typedef std::map<zr_boost_1_81::spirit::classic::parser_id, std::string> base_type;
...
//                 { BOOST_WAVE_ENDIF_ID, "ppendif" },
            ...
            for (int i = 0; 0 != init_ruleid_name_map[i].parser_id; ++i)
                base_type::insert(base_type::value_type(
                    zr_boost_1_81::spirit::classic::parser_id(init_ruleid_name_map[i].parser_id),
...
inline zr_boost_1_81::spirit::classic::tree_parse_info<IteratorT, NodeFactoryT>
parsetree_parse(IteratorT const& first_, IteratorT const& last,
    zr_boost_1_81::spirit::classic::parser<ParserT> const& p)
{
    using namespace zr_boost_1_81::spirit::classic;
...
zr_boost_1_81::spirit::classic::tree_parse_info<
    LexIteratorT,
