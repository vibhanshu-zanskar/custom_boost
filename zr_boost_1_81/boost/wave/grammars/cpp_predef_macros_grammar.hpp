...
struct predefined_macros_grammar :
    public zr_boost_1_81::spirit::classic::grammar<predefined_macros_grammar>
{
...
zr_boost_1_81::spirit::classic::tree_parse_info<LexIteratorT>
    ...
    LexIteratorT const &first, LexIteratorT const &last)
{
    ...
    return zr_boost_1_81::spirit::classic::pt_parse (first, last, g);
}
