...
namespace closures {
    ...
    :   zr_boost_1_81::spirit::classic::closure<intlit_closure, uint_literal_type>
    {
        member1 val;
    };
}
...
struct intlit_grammar :
    zr_boost_1_81::spirit::classic::grammar<intlit_grammar, closures::intlit_closure::context_t>
{
    ...
    struct definition
    {
        ...
        rule_t int_lit;
        zr_boost_1_81::spirit::classic::subrule<0> sub_int_lit;
        zr_boost_1_81::spirit::classic::subrule<1> oct_lit;
        zr_boost_1_81::spirit::classic::subrule<2> hex_lit;
        zr_boost_1_81::spirit::classic::subrule<3> dec_lit;

        definition(intlit_grammar const &self)
        {
            using namespace zr_boost_1_81::spirit::classic;
            namespace phx = zr_boost_1_81phoenix;
    ...
    bool &is_unsigned)
{
    ...
    using zr_boost_1_81::spirit::classic::parse_info;
