...
#define spirit_append_actor(actor) zr_boost_1_81::spirit::classic::push_back_a(actor)
#define spirit_assign_actor(actor) zr_boost_1_81::spirit::classic::assign_a(actor)
...
///////////////////////////////////////////////////////////////////////////////
    ...
    :   zr_boost_1_81::spirit::classic::closure<cpp_expr_closure, closure_value>
    {
        member1 val;
    };
...
///////////////////////////////////////////////////////////////////////////////
    struct convert_intlit {
        ...
        struct result {
            ...
            typedef zr_boost_1_81::wave::grammars::closures::closure_value type;
        };

        template <typename TokenT>
        zr_boost_1_81::wave::grammars::closures::closure_value
        operator()(TokenT const &token) const
        {
            typedef zr_boost_1_81::wave::grammars::closures::closure_value return_type;
    ...
    zr_boost_1_81phoenix::function<convert_intlit> const as_intlit;
...
///////////////////////////////////////////////////////////////////////////////
    ...
    zr_boost_1_81phoenix::function<convert_chlit> const as_chlit;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    zr_boost_1_81phoenix::function<operator_questionmark> const questionmark;
...
///////////////////////////////////////////////////////////////////////////////
    struct operator_to_bool {
        ...
        operator()(ArgT &val) const
        {
            typedef zr_boost_1_81::wave::grammars::closures::closure_value return_type;
            return return_type(
                zr_boost_1_81::wave::grammars::closures::as_bool(val), val.is_valid());
        }
    };
    zr_boost_1_81phoenix::function<operator_to_bool> const to_bool;
...
///////////////////////////////////////////////////////////////////////////////
    struct operator_as_bool {
        ...
        operator()(ArgT &val) const
        {
            return zr_boost_1_81::wave::grammars::closures::as_bool(val);
        }
    };
    zr_boost_1_81phoenix::function<operator_as_bool> const as_bool;
...
#define BOOST_WAVE_BINARYOP(op, optok)                                        \
    ...
    zr_boost_1_81phoenix::function<operator_binary_ ## op> const binary_ ## op             \
    /**/
...
#define BOOST_WAVE_UNARYOP(op, optok)                                         \
    ...
    zr_boost_1_81phoenix::function<operator_unary_ ## op> const unary_ ## op               \
    /**/
...
struct expression_grammar :
    public zr_boost_1_81::spirit::classic::grammar<
        expression_grammar,
    ...
    >
{
    ...
    struct definition
    {
        ...
        typedef zr_boost_1_81::spirit::classic::rule<ScannerT, closure_type::context_t> rule_t;
        typedef zr_boost_1_81::spirit::classic::rule<ScannerT> simple_rule_t;
        ...
        zr_boost_1_81::spirit::classic::subrule<0, closure_type::context_t> const_exp_subrule;
        ...
        definition(expression_grammar const &self)
        {
            ...
            using zr_boost_1_81::wave::util::pattern_p;
    ...
    bool if_block_status, value_error &status)
{
    using namespace zr_boost_1_81::spirit::classic;
    using namespace zr_boost_1_81::wave;
    using namespace zr_boost_1_81::wave::grammars::closures;

    using zr_boost_1_81::wave::util::impl::as_string;
