...
namespace closures {
    ...
    :   zr_boost_1_81::spirit::classic::closure<chlit_closure, zr_boost_1_81::uint32_t, bool>
    {
        member1 value;
        member2 long_lit;
    };
...
///////////////////////////////////////////////////////////////////////////////
    struct compose_character_literal {
        ...
        void
        operator()(zr_boost_1_81::uint32_t& value, bool long_lit, bool& overflow,
            zr_boost_1_81::uint32_t character) const
        {
            // The following assumes that wchar_t is max. 32 Bit
            BOOST_STATIC_ASSERT(sizeof(wchar_t) <= 4);

            static zr_boost_1_81::uint32_t masks[] = {
                0x000000ff, 0x0000ffff, 0x00ffffff, 0xffffffff
            };
            static zr_boost_1_81::uint32_t overflow_masks[] = {
    ...
    zr_boost_1_81phoenix::function<compose_character_literal> const compose;
...
struct chlit_grammar :
    public zr_boost_1_81::spirit::classic::grammar<chlit_grammar,
        closures::chlit_closure::context_t>
{
    ...
    struct definition
    {
        typedef zr_boost_1_81::spirit::classic::rule<
