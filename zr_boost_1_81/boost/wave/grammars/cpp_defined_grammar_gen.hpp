...
struct BOOST_WAVE_DECL defined_grammar_gen
{
    ...
    typedef zr_boost_1_81::wave::util::unput_queue_iterator<
    ...
    static zr_boost_1_81::spirit::classic::parse_info<iterator1_type>
    parse_operator_defined (iterator1_type const &first,
        iterator1_type const &last, token_sequence_type &found_qualified_name);

    static zr_boost_1_81::spirit::classic::parse_info<iterator2_type>
