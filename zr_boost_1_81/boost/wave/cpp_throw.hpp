...
namespace zr_boost_1_81 { namespace wave { namespace util
{
    ...
    void throw_(typename Exception::error_code code, S1 msg, Pos const& pos)
    {
        ...
        zr_boost_1_81::throw_exception(Exception(throwmsg.c_str(), code,
...
#define BOOST_WAVE_THROW(cls, code, msg, act_pos)                             \
    zr_boost_1_81::wave::util::throw_<cls>(cls::code, msg, act_pos)                   \
    /**/

#define BOOST_WAVE_THROW_CTX(ctx, cls, code, msg, act_pos)                    \
    zr_boost_1_81::wave::util::throw_<cls>(ctx, cls::code, msg, act_pos)              \
    /**/
...
#define BOOST_WAVE_THROW_NAME_CTX(ctx, cls, code, msg, act_pos, name)         \
    zr_boost_1_81::wave::util::throw_<cls>(ctx, cls::code, msg, act_pos, name)        \
    /**/
...
#define BOOST_WAVE_THROW_VAR_CTX(ctx, cls, code, msg, act_pos)                \
    zr_boost_1_81::wave::util::throw_<cls>(ctx, code, msg, act_pos)                   \
    /**/
