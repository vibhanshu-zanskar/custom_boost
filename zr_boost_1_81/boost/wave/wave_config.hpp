...
#define BOOST_WAVE_STRINGTYPE zr_boost_1_81::wave::util::flex_string<                 \
        char, std::char_traits<char>, std::allocator<char>,                   \
        zr_boost_1_81::wave::util::CowString<                                         \
            zr_boost_1_81::wave::util::AllocatorStringStorage<char>                   \
        >                                                                     \
    >                                                                         \
    /**/
...
namespace zr_boost_1_81 { namespace wave
{
#if defined(BOOST_HAS_LONG_LONG) && \
    BOOST_WAVE_SUPPORT_LONGLONG_INTEGER_LITERALS != 0
    typedef zr_boost_1_81::long_long_type int_literal_type;
    typedef zr_boost_1_81::ulong_long_type uint_literal_type;
#else
...
#define BOOST_LIB_NAME zr_boost_1_81_wave
