...
public:
    ...
    token_data(token_id id_, string_type const &value_,
               ...
               optional<position_type> const & expand_pos_ = zr_boost_1_81::none)
...
private:
    ...
    zr_boost_1_81::optional<position_type> expand_pos;    // where this token was expanded
    zr_boost_1_81::detail::atomic_count refcnt;
};
...
token_data<StringTypeT, PositionT>::operator new(std::size_t size)
{
    ...
    typedef zr_boost_1_81::singleton_pool<
...
template <typename PositionT = zr_boost_1_81::wave::util::file_position_type>
class lex_token;
