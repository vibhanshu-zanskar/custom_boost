...
//            and a 4th parameter of the type zr_boost_1_81::wave::language_support
...
struct make_multi_pass
{
    ...
    typedef zr_boost_1_81::spirit::iterator_policies::split_functor_input input_policy;
    typedef zr_boost_1_81::spirit::iterator_policies::ref_counted ownership_policy;
#if defined(BOOST_WAVE_DEBUG)
    typedef zr_boost_1_81::spirit::iterator_policies::buf_id_check check_policy;
#else
    typedef zr_boost_1_81::spirit::iterator_policies::no_check check_policy;
#endif
    typedef zr_boost_1_81::spirit::iterator_policies::split_std_deque storage_policy;

    typedef zr_boost_1_81::spirit::iterator_policies::default_policy<
            ownership_policy, check_policy, input_policy, storage_policy>
        policy_type;
    typedef zr_boost_1_81::spirit::multi_pass<functor_data_type, policy_type> type;
};
