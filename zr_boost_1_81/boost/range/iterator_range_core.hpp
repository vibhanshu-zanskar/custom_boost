...
namespace zr_boost_1_81
{
    namespace iterator_range_detail
    {
        ...
        struct iterator_range_impl {
            ...
            {
                return IteratorT( zr_boost_1_81::begin( r ) );
            }

            template< class ForwardRange >
            static IteratorT adl_end( ForwardRange& r )
            {
                return IteratorT( zr_boost_1_81::end( r ) );
            }
        };
        ...
        {
            return std::lexicographical_compare( zr_boost_1_81::begin(l),
                                                 zr_boost_1_81::end(l),
                                                 zr_boost_1_81::begin(r),
                                                 zr_boost_1_81::end(r) );
        }
        ...
        {
            return zr_boost_1_81::equal(l, r);
        }
...
incrementable_t test_traversal_tag(zr_boost_1_81::incrementable_traversal_tag);
bidirectional_t test_traversal_tag(zr_boost_1_81::bidirectional_traversal_tag);
random_access_t test_traversal_tag(zr_boost_1_81::random_access_traversal_tag);

template<std::size_t S>
struct pure_iterator_traversal_impl
{
    typedef zr_boost_1_81::incrementable_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(bidirectional_t)>
{
    typedef zr_boost_1_81::bidirectional_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(random_access_t)>
{
    typedef zr_boost_1_81::random_access_traversal_tag type;
};
...
public:
    ...
    reference back() const
    {
        ...
        return *zr_boost_1_81::prior(this->m_End);
    }
    ...
    typedef BOOST_DEDUCED_TYPENAME
        zr_boost_1_81::mpl::if_<
            zr_boost_1_81::mpl::or_<
                zr_boost_1_81::is_abstract<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                zr_boost_1_81::is_array<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                zr_boost_1_81::is_function<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >
            >,
...
//  iterator range template class -----------------------------------------//
        ...
        /*!
            ...
            \code
                zr_boost_1_81::tolower( find( s, "UPPERCASE STRING" ) );
            \endcode
        ...
        */
        ...
        public:
            ...
            iterator_range(
                ...
                BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::enable_if<
...
//  iterator range free-standing operators ---------------------------//
        ...
        inline BOOST_DEDUCED_TYPENAME zr_boost_1_81::enable_if<
        ...
        template< class IteratorT, class ForwardRange >
        inline BOOST_DEDUCED_TYPENAME zr_boost_1_81::enable_if<
            mpl::not_<zr_boost_1_81::is_base_and_derived<iterator_range_detail::iterator_range_tag, ForwardRange> >,
            bool
        >::type
        operator!=( const ForwardRange& l, const iterator_range<IteratorT>& r )
        {
...
//  iterator range utilities -----------------------------------------//
        ...
        */
        ...
        {
            return iterator_range<IteratorT>(first, zr_boost_1_81::next(first, n));
        }
        ...
        namespace iterator_range_detail
        {
                             ...
                             BOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_end )
            {
                ...
                BOOST_DEDUCED_TYPENAME range_iterator<Range>::type
                    new_begin = zr_boost_1_81::begin( r ),
                    new_end   = zr_boost_1_81::end( r );
        ...
        */
        ...
        {
            return SeqT( zr_boost_1_81::begin( r ), zr_boost_1_81::end( r ) );
        }
