    ...
    BOOST_DEDUCED_TYPENAME range_iterator<BidirectionalRange>::type middle)
{
    ...
    std::inplace_merge(zr_boost_1_81::begin(rng), middle, zr_boost_1_81::end(rng));
    return rng;
}
...
inline const BidirectionalRange& inplace_merge(const BidirectionalRange& rng,
    BOOST_DEDUCED_TYPENAME zr_boost_1_81::range_iterator<const BidirectionalRange>::type middle)
{
...
inline BidirectionalRange& inplace_merge(BidirectionalRange& rng,
    BOOST_DEDUCED_TYPENAME zr_boost_1_81::range_iterator<BidirectionalRange>::type middle,
    BinaryPredicate pred)
{
    BOOST_RANGE_CONCEPT_ASSERT(( BidirectionalRangeConcept<BidirectionalRange> ));
    std::inplace_merge(zr_boost_1_81::begin(rng), middle, zr_boost_1_81::end(rng), pred);
    return rng;
}
