...
upper_bound( ForwardRange& rng, const Value& val )
{
    ...
    return std::upper_bound(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng), val);
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return std::upper_bound(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng), val, pred);
}
...
upper_bound( ForwardRange& rng, const Value& val )
{
    ...
    return range_return<ForwardRange,re>::
        pack(std::upper_bound(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng), val),
             rng);
}
...
upper_bound( ForwardRange& rng, const Value& val, SortPredicate pred )
{
    BOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return range_return<ForwardRange,re>::
        pack(std::upper_bound(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng), val, pred),
             rng);
}
