                     ...
                     const SinglePassRange2& rng2)
{
    ...
    return std::includes(zr_boost_1_81::begin(rng1),zr_boost_1_81::end(rng1),
                     ...
                     BinaryPredicate         pred)
{
    ...
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange2> ));
    return std::includes(zr_boost_1_81::begin(rng1), zr_boost_1_81::end(rng1),
                         zr_boost_1_81::begin(rng2), zr_boost_1_81::end(rng2), pred);
}
                                ...
                                OutputIterator          out)
{
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange1> ));
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange2> ));
    return std::set_union(zr_boost_1_81::begin(rng1), zr_boost_1_81::end(rng1),
                          zr_boost_1_81::begin(rng2), zr_boost_1_81::end(rng2), out);
}
                                ...
                                BinaryPredicate         pred)
{
    ...
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange2> ));
    return std::set_union(zr_boost_1_81::begin(rng1), zr_boost_1_81::end(rng1),
                          zr_boost_1_81::begin(rng2), zr_boost_1_81::end(rng2), out, pred);
}
                                       ...
                                       OutputIterator          out)
{
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange1> ));
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange2> ));
    return std::set_intersection(zr_boost_1_81::begin(rng1), zr_boost_1_81::end(rng1),
                                 zr_boost_1_81::begin(rng2), zr_boost_1_81::end(rng2), out);
}
                                     ...
                                     OutputIterator out)
{
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange1> ));
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange2> ));
    return std::set_difference(zr_boost_1_81::begin(rng1), zr_boost_1_81::end(rng1),
                               zr_boost_1_81::begin(rng2), zr_boost_1_81::end(rng2), out);
}
                         ...
                         OutputIterator          out)
{
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange1> ));
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange2> ));
    return std::set_symmetric_difference(zr_boost_1_81::begin(rng1), zr_boost_1_81::end(rng1),
                                         zr_boost_1_81::begin(rng2), zr_boost_1_81::end(rng2), out);
}
