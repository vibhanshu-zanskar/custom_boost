...
max_element(ForwardRange& rng)
{
    ...
    return detail::max_element(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng), detail::less());
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return detail::max_element(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng), pred);
}
...
max_element(ForwardRange& rng)
{
    ...
    return range_return<ForwardRange,re>::pack(
        detail::max_element(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng), detail::less()),
        rng);
}
...
max_element(ForwardRange& rng, BinaryPredicate pred)
{
    BOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return range_return<ForwardRange,re>::pack(
        detail::max_element(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng), pred),
        rng);
}
