...
inline BOOST_DEDUCED_TYPENAME zr_boost_1_81::range_iterator<ForwardRange>::type
remove_if(ForwardRange& rng, UnaryPredicate pred)
{
    BOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return std::remove_if(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng), pred);
}

/// \overload
template< class ForwardRange, class UnaryPredicate >
inline BOOST_DEDUCED_TYPENAME zr_boost_1_81::range_iterator<const ForwardRange>::type
...
remove_if(ForwardRange& rng, UnaryPredicate pred)
{
    ...
    return range_return<ForwardRange,re>::pack(
        std::remove_if(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng), pred),
        rng);
}
