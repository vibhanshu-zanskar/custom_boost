...
inline BOOST_DEDUCED_TYPENAME zr_boost_1_81::range_difference<SinglePassRange>::type
count_if(SinglePassRange& rng, UnaryPredicate pred)
{
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<SinglePassRange> ));
    return std::count_if(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng), pred);
}

/// \overload
template< class SinglePassRange, class UnaryPredicate >
inline BOOST_DEDUCED_TYPENAME zr_boost_1_81::range_difference<const SinglePassRange>::type
