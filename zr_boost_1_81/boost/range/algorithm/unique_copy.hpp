...
unique_copy( const SinglePassRange& rng, OutputIterator out_it )
{
    ...
    return std::unique_copy(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng), out_it);
}
/// \overload
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange> ));
    return std::unique_copy(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng), out_it, pred);
}
