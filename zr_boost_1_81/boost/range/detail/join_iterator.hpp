...
public:
    ...
    join_iterator(Range1& r1, Range2& r2, join_iterator_begin_tag)
        : m_section(zr_boost_1_81::empty(r1) ? 1u : 0u)
        , m_it(zr_boost_1_81::empty(r1) ? 1u : 0u, zr_boost_1_81::begin(r1), zr_boost_1_81::begin(r2))
        , m_link(link_t(zr_boost_1_81::end(r1), zr_boost_1_81::begin(r2)))
    {
    }
    ...
    join_iterator(const Range1& r1, const Range2& r2, join_iterator_begin_tag)
        : m_section(zr_boost_1_81::empty(r1) ? 1u : 0u)
        , m_it(zr_boost_1_81::empty(r1) ? 1u : 0u, zr_boost_1_81::const_begin(r1), zr_boost_1_81::const_begin(r2))
        , m_link(link_t(zr_boost_1_81::const_end(r1), zr_boost_1_81::const_begin(r2)))
    {
    }
    ...
    join_iterator(Range1& r1, Range2& r2, join_iterator_end_tag)
        : m_section(1u)
        , m_it(1u, zr_boost_1_81::end(r1), zr_boost_1_81::end(r2))
        , m_link(link_t(zr_boost_1_81::end(r1), zr_boost_1_81::begin(r2)))
    {
    }
    ...
    join_iterator(const Range1& r1, const Range2& r2, join_iterator_end_tag)
        : m_section(1u)
        , m_it(1u, zr_boost_1_81::const_end(r1), zr_boost_1_81::const_end(r2))
        , m_link(link_t(zr_boost_1_81::const_end(r1), zr_boost_1_81::const_begin(r2)))
    {
    }
...
private:
    ...
    void decrement()
    {
        if (m_section)
        {
            ...
            {
                m_it.it1() = zr_boost_1_81::prior(m_link.last1);
                m_section = 0u;
            }
            else
                --m_it.it2();
