...
struct demote_iterator_traversal_tag
    : inner_demote_iterator_traversal_tag<
        typename zr_boost_1_81::iterators::pure_traversal_tag< IteratorTraversalTag1 >::type,
        typename zr_boost_1_81::iterators::pure_traversal_tag< IteratorTraversalTag2 >::type
      >
{
};
