...
// Default collection traits -----------------------------------------------------------------
            ...
            */
            ...
            struct default_container_traits
            {
                ...
                typedef typename
                    ::zr_boost_1_81::mpl::if_< ::zr_boost_1_81::is_const<ContainerT>,
                        const_iterator,
                        iterator 
...
// Array container traits ---------------------------------------------------------------
            ...
            */
            ...
            public:
                ...
                typedef typename
                    ::zr_boost_1_81::mpl::if_< ::zr_boost_1_81::is_const<T>,
                        const_iterator,
                        iterator 
                    >::type result_iterator;
            ...
            private:
                // resolve array size
                typedef typename
                    ::zr_boost_1_81::remove_cv<value_type>::type char_type;
                typedef typename
...
// Pointer container traits ---------------------------------------------------------------
            ...
            {
                typedef typename
                    ::zr_boost_1_81::remove_pointer<T>::type value_type;
