...
namespace zr_boost_1_81 { namespace range_detail_microsoft {
    ...
    size_of(T const& x)
    {
        return std::distance(zr_boost_1_81::begin(x), zr_boost_1_81::end(x));
    }
...
} } // namespace zr_boost_1_81::range_detail_microsoft
...
/**/
    ...
    #define BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE_begin(Fullname) \
        inline \
        zr_boost_1_81::range_detail_microsoft::mutable_iterator_of< Fullname >::type \
        BOOST_RANGE_DETAIL_MICROSOFT_range_begin(Fullname& x) \
        { \
            return zr_boost_1_81::range_detail_microsoft::begin_of(x); \
        } \
    /**/
    ...
    #define BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE_begin_const(Fullname) \
        inline \
        zr_boost_1_81::range_detail_microsoft::const_iterator_of< Fullname >::type \
    ...
    #define BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE_end(Fullname) \
        ...
        { \
            return zr_boost_1_81::range_detail_microsoft::end_of(x); \
        } \
    /**/
    ...
    /**/
        ...
        #define BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE_size(Fullname) \
            inline \
            zr_boost_1_81::range_detail_microsoft::size_type_of< Fullname >::type \
            boost_range_size(Fullname const& x) \
            { \
                return zr_boost_1_81::range_detail_microsoft::size_of(x); \
            } \
        /**/
...
/**/
    ...
    #define BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE_begin(Params, Fullname) \
        ...
        typename zr_boost_1_81::range_detail_microsoft::mutable_iterator_of< Fullname >::type \
        BOOST_RANGE_DETAIL_MICROSOFT_range_begin(Fullname& x) \
        { \
            return zr_boost_1_81::range_detail_microsoft::begin_of(x); \
        } \
    ...
    #define BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE_begin_const(Params, Fullname) \
        template< Params > inline \
        typename zr_boost_1_81::range_detail_microsoft::const_iterator_of< Fullname >::type \
        BOOST_RANGE_DETAIL_MICROSOFT_range_begin(Fullname const& x) \
        { \
            return zr_boost_1_81::range_detail_microsoft::begin_of(x); \
        } \
    ...
    /**/
        ...
        #define BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE_size(Params, Fullname) \
            template< Params > inline \
            typename zr_boost_1_81::range_detail_microsoft::size_type_of< Fullname >::type \
            boost_range_size(Fullname const& x) \
            { \
                return zr_boost_1_81::range_detail_microsoft::size_of(x); \
            } \
...
namespace zr_boost_1_81 { namespace range_detail_microsoft {
    ...
    public:
        ...
        explicit list_iterator(ListT& lst, POSITION pos) :
            m_plst(zr_boost_1_81::addressof(lst)), m_pos(pos)
        { }
...
namespace zr_boost_1_81 { namespace range_detail_microsoft {
    ...
    {
        return
            zr_boost_1_81::distance(rng1) == zr_boost_1_81::distance(rng2) &&
            std::equal(zr_boost_1_81::begin(rng1), zr_boost_1_81::end(rng1), zr_boost_1_81::begin(rng2))
        ;
    }
    ...
    {
        typedef typename zr_boost_1_81::range_const_iterator<AssocContainer>::type iter_t;
        for (iter_t it = zr_boost_1_81::const_begin(ac), last = zr_boost_1_81::const_end(ac); it != last; ++it) {
    ...
    bool test_emptiness(Range& )
    {
        ...
        Range emptyRng;
        result = result && zr_boost_1_81::empty(emptyRng);
    ...
    bool test_trivial(Range& rng)
    {
        ...
        citer_t cit = zr_boost_1_81::begin(rng);
        (void)cit; // unused

        // mutability check
        typedef typename range_value<Range>::type val_t;
        val_t v = *zr_boost_1_81::begin(rng);
        *zr_boost_1_81::begin(rng) = v;
        result = result && *zr_boost_1_81::begin(rng) == v;
    ...
    {
        zr_boost_1_81::function_requires< ForwardRangeConcept<Range> >();
        ...
        std::copy(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng), std::back_inserter(saved));
        std::rotate(zr_boost_1_81::begin(saved), zr_boost_1_81::next(zr_boost_1_81::begin(saved)), zr_boost_1_81::end(saved));

        std::rotate(zr_boost_1_81::begin(rng), zr_boost_1_81::next(zr_boost_1_81::begin(rng)), zr_boost_1_81::end(rng));
    ...
    {
        zr_boost_1_81::function_requires< BidirectionalRangeConcept<Range> >();
        ...
        result = result && (test_equals)(
            zr_boost_1_81::make_iterator_range(zr_boost_1_81::rbegin(saved), zr_boost_1_81::rend(saved)),
            zr_boost_1_81::make_iterator_range(zr_boost_1_81::rbegin(rng), zr_boost_1_81::rend(rng))
        );
    ...
    {
        zr_boost_1_81::function_requires< RandomAccessRangeConcept<Range> >();
        ...
        std::vector<val_t> saved;
        std::copy(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng), std::back_inserter(saved));
        std::sort(zr_boost_1_81::begin(saved), zr_boost_1_81::end(saved));

        std::random_shuffle(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng));
        std::sort(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng));
        result = result && (test_equals)(rng, saved);

        std::random_shuffle(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng));
        std::stable_sort(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng));
        result = result && (test_equals)(rng, saved);

        std::random_shuffle(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng));
        std::partial_sort(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng), zr_boost_1_81::end(rng));
        result = result && (test_equals)(rng, saved);
    ...
    bool test_init_array(ArrayT& arr, SampleRange const& sample)
    {
        ...
        for (iter_t it = zr_boost_1_81::const_begin(sample), last = zr_boost_1_81::const_end(sample); it != last; ++it) {
    ...
    bool test_init_map(MapT& map, SampleMap const& sample)
    {
        ...
        return zr_boost_1_81::distance(map) == zr_boost_1_81::distance(sample);
    }
    ...
    struct test_mutable_iter :
        zr_boost_1_81::is_same< typename zr_boost_1_81::BOOST_RANGE_DETAIL_MICROSOFT_range_mutable_iterator<Range>::type, Iter >
    { };


    template< class Range, class Iter >
    struct test_const_iter :
        zr_boost_1_81::is_same< typename zr_boost_1_81::range_const_iterator<Range>::type, Iter >
    { };
