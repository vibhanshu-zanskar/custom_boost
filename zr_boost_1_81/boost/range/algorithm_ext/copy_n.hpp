...
inline OutputIterator copy_n(const SinglePassRange& rng, Size n, OutputIterator out)
{
    ...
    BOOST_ASSERT( n <= static_cast<Size>(::zr_boost_1_81::distance(rng)) );
    BOOST_ASSERT( n >= static_cast<Size>(0) );

    BOOST_DEDUCED_TYPENAME range_iterator<const SinglePassRange>::type source = ::zr_boost_1_81::begin(rng);
    ...
    using ::zr_boost_1_81::range::copy_n;
} // namespace zr_boost_1_81
