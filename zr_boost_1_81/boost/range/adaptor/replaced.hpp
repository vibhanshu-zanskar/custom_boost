...
namespace zr_boost_1_81
{
    namespace range_detail
    {
        ...
        private:
            ...
            zr_boost_1_81::optional<data> m_impl;
        };

        template< class R >
        class replaced_range :
            public zr_boost_1_81::iterator_range<
                zr_boost_1_81::transform_iterator<
        ...
        public:
            ...
            replaced_range( R& r, value_type from, value_type to )
                : base_t( make_transform_iterator( zr_boost_1_81::begin(r), Fn(from, to) ),
                          make_transform_iterator( zr_boost_1_81::end(r), Fn(from, to) ) )
            { }
        };
