...
namespace zr_boost_1_81
{
    namespace adaptors
    {
        ...
        class sliced_range : public zr_boost_1_81::iterator_range< BOOST_DEDUCED_TYPENAME range_iterator<RandomAccessRange>::type >
        {
            typedef zr_boost_1_81::iterator_range< BOOST_DEDUCED_TYPENAME range_iterator<RandomAccessRange>::type > base_t;
        public:
            template<typename Rng, typename T, typename U>
            sliced_range(Rng& rng, T t, U u)
                : base_t(zr_boost_1_81::next(zr_boost_1_81::begin(rng), t),
                         zr_boost_1_81::next(zr_boost_1_81::begin(rng), u))
            {
            }
        };
        ...
        slice( RandomAccessRange& rng, std::size_t t, std::size_t u )
        {
            ...
            BOOST_ASSERT( static_cast<std::size_t>(zr_boost_1_81::size(rng)) >= u &&
