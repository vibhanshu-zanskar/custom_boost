...
public:
    ...
    index_type index()
    {
        return zr_boost_1_81::tuples::get<0>(*this);
    }
    ...
    value_type value()
    {
        return zr_boost_1_81::tuples::get<1>(*this);
    }
...
{
    typedef ::zr_boost_1_81::range::index_value<
    ...
    >
{
    ...
    BOOST_RANGE_CONCEPT_ASSERT((
        zr_boost_1_81::SinglePassRangeConcept<SinglePassRange>));
public:
    ...
    indexed_range(
        ...
        : base_t(iterator(zr_boost_1_81::begin(r), i),
                 iterator(zr_boost_1_81::end(r), i))
    {
    }
    ...
    indexed_range(
        ...
        : base_t(iterator(zr_boost_1_81::begin(r), i),
                 iterator(zr_boost_1_81::end(r), i + zr_boost_1_81::size(r)))
    {
    }
};
...
{
    BOOST_RANGE_CONCEPT_ASSERT((
        zr_boost_1_81::SinglePassRangeConcept<const SinglePassRange>
    ));
...
struct tuple_element<N, zr_boost_1_81::range::index_value<T, Indexable>>:
    zr_boost_1_81::tuples::element<N, zr_boost_1_81::range::index_value<T, Indexable>> {};

template<class T, class Indexable>
struct tuple_size<zr_boost_1_81::range::index_value<T, Indexable>>:
