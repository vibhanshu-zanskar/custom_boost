...
namespace zr_boost_1_81
{
    namespace range_detail
    {
        ...
        struct reversed_range : 
            public zr_boost_1_81::iterator_range< 
                      zr_boost_1_81::reverse_iterator<
        ...
        public:
            typedef zr_boost_1_81::reverse_iterator<BOOST_DEDUCED_TYPENAME range_iterator<R>::type> iterator;

            explicit reversed_range( R& r ) 
                : base( iterator(zr_boost_1_81::end(r)), iterator(zr_boost_1_81::begin(r)) )
            { }
        };
