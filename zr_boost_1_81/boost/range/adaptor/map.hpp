...
namespace zr_boost_1_81
{
    namespace range_detail
    {
        ...
        operator|( const StdPairRng& r, map_keys_forwarder )
        {
            ...
            return operator|( r,
                zr_boost_1_81::adaptors::transformed( select_first<StdPairRng>() ) );
        }
        ...
        operator|( StdPairRng& r, map_values_forwarder )
        {
            ...
            return operator|( r,
                zr_boost_1_81::adaptors::transformed( select_second_mutable<StdPairRng>() ) );
        }
        ...
        operator|( const StdPairRng& r, map_values_forwarder )
        {
            ...
            return operator|( r,
                zr_boost_1_81::adaptors::transformed( select_second_const<StdPairRng>() ) );
        }
