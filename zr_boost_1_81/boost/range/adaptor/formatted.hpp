...
struct formatted_holder
{
    typedef typename zr_boost_1_81::mpl::if_<
        zr_boost_1_81::is_array<Sep>,
        const typename zr_boost_1_81::remove_extent<Sep>::type*,
        Sep
    >::type separator_t;

    typedef typename zr_boost_1_81::mpl::if_<
        zr_boost_1_81::is_array<Prefix>,
        const typename zr_boost_1_81::remove_extent<Prefix>::type*,
        Prefix
    >::type prefix_t;

    typedef typename zr_boost_1_81::mpl::if_<
        zr_boost_1_81::is_array<Postfix>,
        const typename zr_boost_1_81::remove_extent<Postfix>::type*,
        Postfix
    >::type postfix_t;
...
)
{
    ...
    return range_detail::formatted_range<iterator, Sep, Prefix, Postfix>(
        zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng), holder);
}
...
template<typename SinglePassRange, typename Sep, typename Prefix,
         typename Postfix>
inline zr_boost_1_81::range_detail::formatted_range<
    typename zr_boost_1_81::range_iterator<const SinglePassRange>::type,
    Sep, Prefix, Postfix
>
format(
    const SinglePassRange& rng,
...
{
    typedef typename zr_boost_1_81::range_iterator<const SinglePassRange>::type
                iterator_t;

    typedef zr_boost_1_81::range_detail::formatted_range<
                iterator_t, Sep, Prefix, Postfix>       result_t;

    typedef zr_boost_1_81::range_detail::formatted_holder<Sep, Prefix, Postfix>
                holder_t;

    return result_t(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng),
...
format(const SinglePassRange& rng)
{
    ...
    namespace range
    {
        using zr_boost_1_81::range_detail::formatted_range;
    } // namespace range
} // namespace zr_boost_1_81
