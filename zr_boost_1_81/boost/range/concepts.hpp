...
// during the search for black listed compilers.
    ...
    #define BOOST_RANGE_CONCEPT_ASSERT( x )
        ...
        // use case is the combination of the zr_boost_1_81::adaptors::filtered
        // class with a zr_boost_1_81::lambda::bind generated functor.
            ...
            , EqualityComparable<Iterator>
        {
            ...
            {
                Iterator i2(++i);
                zr_boost_1_81::ignore_unused_variable_warning(i2);
                ...
                zr_boost_1_81::ignore_unused_variable_warning(r1);

                BOOST_DEDUCED_TYPENAME std::iterator_traits<Iterator>::reference r2(*(++i));
                zr_boost_1_81::ignore_unused_variable_warning(r2);
            }
        private:
            Iterator i;
#endif
    ...
    struct SinglePassRangeConcept
    {
        ...
        BOOST_CONCEPT_USAGE(SinglePassRangeConcept)
        {
            ...
            iterator i1 = zr_boost_1_81::begin(*m_range);
            iterator i2 = zr_boost_1_81::end(*m_range);

            zr_boost_1_81::ignore_unused_variable_warning(i1);
            zr_boost_1_81::ignore_unused_variable_warning(i2);
    ...
    private:
        ...
        {
            const_iterator ci1 = zr_boost_1_81::begin(const_range);
            const_iterator ci2 = zr_boost_1_81::end(const_range);

            zr_boost_1_81::ignore_unused_variable_warning(ci1);
            zr_boost_1_81::ignore_unused_variable_warning(ci2);
        }
