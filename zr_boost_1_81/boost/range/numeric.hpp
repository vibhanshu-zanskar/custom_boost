...
namespace zr_boost_1_81
{
    ...
    inline Value accumulate(const SinglePassRange& rng, Value init)
    {
        ...
        return std::accumulate(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng), init);
    }
                            ...
                            BinaryOperation op)
    {
        ...
        return std::accumulate(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng), init, op);
    }
    ...
    namespace range_detail
    {
        ...
        inline bool inner_product_precondition(
            ...
            std::forward_iterator_tag)
        {
            return zr_boost_1_81::size(rng2) >= zr_boost_1_81::size(rng1);
        }
        ...
        BinaryOperation2        op2)
    {
        ...
        return std::inner_product(
            zr_boost_1_81::begin(rng1), zr_boost_1_81::end(rng1),
            zr_boost_1_81::begin(rng2), init, op1, op2);
    }
                                      ...
                                      OutputIterator result)
    {
        ...
        return std::partial_sum(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng), result);
    }
        ...
        BinaryOperation         op)
    {
        ...
        return std::partial_sum(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng), result, op);
    }
        ...
        OutputIterator          result)
    {
        ...
        return std::adjacent_difference(zr_boost_1_81::begin(rng), zr_boost_1_81::end(rng),
                                        result);
    }
