...
namespace zr_boost_1_81
{
    namespace range_detail
    {
        ...
        // values when the user specified zr_boost_1_81::use_default as a template
        // parameter.
        template<
            class T,
            class Default
...
# endif
        ...
        public:
            ...
            : base_type(zr_boost_1_81::begin(wrapped_range),
                        zr_boost_1_81::end(wrapped_range))
            {
            }
            ...
            any_range(const any_range<
                              ...
                              , Buffer
                            >& other)
            : base_type(zr_boost_1_81::begin(other), zr_boost_1_81::end(other))
            {
            }
