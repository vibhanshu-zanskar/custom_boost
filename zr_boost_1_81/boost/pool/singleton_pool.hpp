...
// zr_boost_1_81::details::pool::guard
...
namespace zr_boost_1_81 {
 ...
 Can be any Boost.Thread Mutex type or <tt>zr_boost_1_81::details::pool::null_mutex</tt>.
 It is exposed so that users may declare some singleton pools normally (i.e., with synchronization), but 
 some singleton pools without synchronization (by specifying <tt>zr_boost_1_81::details::pool::null_mutex</tt>) for efficiency reasons.
 The member typedef <tt>mutex</tt> exposes the value of this template parameter.  The default for this
 parameter is zr_boost_1_81::details::pool::default_mutex which is a synonym for either <tt>zr_boost_1_81::details::pool::null_mutex</tt>
 ...
 or for <tt>zr_boost_1_81::mutex</tt> (when threading support is enabled in the compiler).
...
private:
   typedef zr_boost_1_81::aligned_storage<sizeof(pool_type), zr_boost_1_81::alignment_of<pool_type>::value> storage_type;
