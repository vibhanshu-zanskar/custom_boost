...
// zr_boost_1_81::simple_segregated_storage
#include <boost/pool/simple_segregated_storage.hpp>
// zr_boost_1_81::alignment_of
...
class pool: protected simple_segregated_storage < typename UserAllocator::size_type >
{
  ...
  private:
    BOOST_STATIC_CONSTANT(size_type, min_alloc_size =
        (::zr_boost_1_81::integer::static_lcm<sizeof(void *), sizeof(size_type)>::value) );
    BOOST_STATIC_CONSTANT(size_type, min_align =
        (::zr_boost_1_81::integer::static_lcm< ::zr_boost_1_81::alignment_of<void *>::value, ::zr_boost_1_81::alignment_of<size_type>::value>::value) );
