...
namespace zr_boost_1_81{ namespace details{ namespace pool{
...
}}} // namespace zr_boost_1_81::details::pool
...
private:
    ...
    zr_boost_1_81::winapi::CRITICAL_SECTION_ cs_;
...
public:
    ...
    cs_mutex()
    {
        zr_boost_1_81::winapi::InitializeCriticalSection( &cs_ );
    }

    ~cs_mutex()
    {
        zr_boost_1_81::winapi::DeleteCriticalSection( &cs_ );
    }

    void lock()
    {
        zr_boost_1_81::winapi::EnterCriticalSection( &cs_ );
    }

    void unlock()
    {
        zr_boost_1_81::winapi::LeaveCriticalSection( &cs_ );
    }
};
