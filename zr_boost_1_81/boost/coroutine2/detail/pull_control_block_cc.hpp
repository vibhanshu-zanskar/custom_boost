...
struct pull_coroutine< T >::control_block {
    ...
    control_block( typename push_coroutine< T >::control_block *, zr_boost_1_81::context::fiber &) noexcept;
...
struct pull_coroutine< void >::control_block {
    ...
    control_block( push_coroutine< void >::control_block *, zr_boost_1_81::context::fiber &) noexcept;
