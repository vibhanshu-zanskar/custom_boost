...
#define BOOST_NUMERIC_FUNCTIONAL_DEFINE_UNARY_OP(Name, Op)                                      \
    ...
    {                                                                                           \
        ...
        {                                                                                       \
            BOOST_TYPEOF_NESTED_TYPEDEF_TPL(                                                    \
                nested                                                                          \
              , Op zr_boost_1_81::numeric::functional::detail::lvalue_of<Arg>()                         \
            )                                                                                   \
    ...
    {                                                                                           \
        struct Name                                                                             \
          : zr_boost_1_81::detail::function1<functional::Name<_, functional::tag<_> > >                 \
        {};                                                                                     \
    }                                                                                           \
    namespace                                                                                   \
    {                                                                                           \
        op::Name const &Name = zr_boost_1_81::detail::pod_singleton<op::Name>::instance;                \
    }                                                                                           \
    /**/
...
#define BOOST_NUMERIC_FUNCTIONAL_DEFINE_BINARY_OP(Name, Op, RetType)                            \
    ...
    {                                                                                           \
        struct Name                                                                             \
          : zr_boost_1_81::detail::function2<                                                           \
...
#define BOOST_NUMERIC_FUNCTIONAL_DEDUCED(Left, Op, Right)                                       \
    BOOST_TYPEOF_NESTED_TYPEDEF_TPL(                                                            \
        nested                                                                                  \
      , zr_boost_1_81::numeric::functional::detail::lvalue_of<Left>() Op                                \
        zr_boost_1_81::numeric::functional::detail::lvalue_of<Right>()                                  \
    )                                                                                           \
    typedef typename nested::type type;                                                         \
    /**/
...
#undef BOOST_NUMERIC_FUNCTIONAL_DEFINE_BINARY_OP
    ...
    namespace op
    {
        ...
        struct promote
          : zr_boost_1_81::detail::function1<functional::promote<To, _, typename functional::tag<To>::type, functional::tag<_> > >
        {};

        struct min_assign
          : zr_boost_1_81::detail::function2<functional::min_assign<_1, _2, functional::tag<_1>, functional::tag<_2> > >
        {};

        struct max_assign
          : zr_boost_1_81::detail::function2<functional::max_assign<_1, _2, functional::tag<_1>, functional::tag<_2> > >
        {};

        struct fdiv
          : zr_boost_1_81::detail::function2<functional::fdiv<_1, _2, functional::tag<_1>, functional::tag<_2> > >
        {};
        ...
        struct as_min
          : zr_boost_1_81::detail::function1<functional::as_min<_, functional::tag<_> > >
        {};

        struct as_max
          : zr_boost_1_81::detail::function1<functional::as_max<_, functional::tag<_> > >
        {};

        struct as_zero
          : zr_boost_1_81::detail::function1<functional::as_zero<_, functional::tag<_> > >
        {};

        struct as_one
          : zr_boost_1_81::detail::function1<functional::as_one<_, functional::tag<_> > >
        {};
    }

    namespace
    {
        op::min_assign const &min_assign = zr_boost_1_81::detail::pod_singleton<op::min_assign>::instance;
        op::max_assign const &max_assign = zr_boost_1_81::detail::pod_singleton<op::max_assign>::instance;
        op::fdiv const &fdiv = zr_boost_1_81::detail::pod_singleton<op::fdiv>::instance;
        op::fdiv const &average = zr_boost_1_81::detail::pod_singleton<op::fdiv>::instance; ///< INTERNAL ONLY
        op::as_min const &as_min = zr_boost_1_81::detail::pod_singleton<op::as_min>::instance;
        op::as_max const &as_max = zr_boost_1_81::detail::pod_singleton<op::as_max>::instance;
        op::as_zero const &as_zero = zr_boost_1_81::detail::pod_singleton<op::as_zero>::instance;
        op::as_one const &as_one = zr_boost_1_81::detail::pod_singleton<op::as_one>::instance;
