    ...
    */
      ...
      : accumulator_base
    {
        ...
        extended_p_square_impl(Args const &args)
          : probabilities(
                zr_boost_1_81::begin(args[extended_p_square_probabilities])
              , zr_boost_1_81::end(args[extended_p_square_probabilities])
            )
...
namespace tag
{
      ...
      , extended_p_square_probabilities
    {
        ...
        static zr_boost_1_81::parameter::keyword<tag::probabilities> const probabilities;
        #endif
    };
}
