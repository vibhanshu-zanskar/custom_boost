...
namespace detail
{
    ...
    struct tail_range
    {
        typedef zr_boost_1_81::iterator_range<
            zr_boost_1_81::reverse_iterator<zr_boost_1_81::permutation_iterator<ElementIterator, IndexIterator> >
        > type;
    };
    ...
    {
        return zr_boost_1_81::make_iterator_range(
            zr_boost_1_81::make_reverse_iterator(
                zr_boost_1_81::make_permutation_iterator(elem_begin, index_end)
            )
          , zr_boost_1_81::make_reverse_iterator(
                zr_boost_1_81::make_permutation_iterator(elem_begin, index_begin)
            )
        );
    }
...
namespace tag
{
      ...
      , tail_cache_size_named_arg<LeftRight>
    {
        ...
        static zr_boost_1_81::parameter::keyword<tail_cache_size_named_arg<LeftRight> > const cache_size;
        #endif
    };
