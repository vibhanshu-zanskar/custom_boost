...
namespace zr_boost_1_81 { namespace numeric
{
    ...
    {
        struct outer_product
          : zr_boost_1_81::detail::function2<functional::outer_product<_1, _2, functional::tag<_1>, functional::tag<_2> > >
        {};
    }

    namespace
    {
        op::outer_product const &outer_product = zr_boost_1_81::detail::pod_singleton<op::outer_product>::instance;
    }
