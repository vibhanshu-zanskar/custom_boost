...
namespace zr_boost_1_81 { namespace accumulators
{
...
namespace detail
{
    ///////////////////////////////////////////////////////////////////////////////
    // accumulator_visitor
    //   wrap a zr_boost_1_81::parameter argument pack in a Fusion extractor object
    ...
    accumulator_set()
      : accumulators(
            detail::make_acc_list(
                accumulators_mpl_vector()
              , (zr_boost_1_81::accumulators::accumulator = *this)
            )
        )
    {
        // Add-ref the Features that the user has specified
        this->template visit_if<detail::contains_feature_of_<Features> >(
            detail::make_add_ref_visitor(zr_boost_1_81::accumulators::accumulator = *this)
        );
    }
    ...
    explicit accumulator_set(
      ...
      , typename zr_boost_1_81::enable_if<
        ...
        >::type = detail::_enabler()
            ...
            detail::make_acc_list(
                accumulators_mpl_vector()
              , (zr_boost_1_81::accumulators::accumulator = *this, a1)
            )
        )
    {
        // Add-ref the Features that the user has specified
      ...
      , typename zr_boost_1_81::disable_if<
        ...
        >::type = detail::_enabler()
            ...
            detail::make_acc_list(
              ...
              , (
                    zr_boost_1_81::accumulators::accumulator = *this
                  , zr_boost_1_81::accumulators::sample = a1
                )
            )
        )
    {
      ...
      , typename zr_boost_1_81::disable_if<                                                     \
        ...
        >::type = detail::_enabler()                                                    \
            ...
            detail::make_acc_list(                                                      \
              ...
              , (                                                                       \
                    zr_boost_1_81::accumulators::accumulator = *this                            \
                  , zr_boost_1_81::accumulators::sample = BOOST_PP_ENUM_PARAMS_Z(z, n, a)       \
                )                                                                       \
            )                                                                           \
        )                                                                               \
    {                                                                                   \
...
#define BOOST_ACCUMULATORS_ACCUMULATOR_SET_FUN_OP(z, n, _)                              \
    ...
    void drop()
    {
        ...
        (*fusion::find_if<detail::matches_feature<Feature> >(this->accumulators))
            .drop(zr_boost_1_81::accumulators::accumulator = *this);
        ...
        this->template visit_if<detail::contains_feature_of_<dependencies> >(
            detail::make_drop_visitor(zr_boost_1_81::accumulators::accumulator = *this)
        );
    }
...
extract_result(AccumulatorSet const &acc)
{
    return find_accumulator<Feature>(acc).result(
        zr_boost_1_81::accumulators::accumulator = acc
    );
}
...
}} // namespace zr_boost_1_81::accumulators
