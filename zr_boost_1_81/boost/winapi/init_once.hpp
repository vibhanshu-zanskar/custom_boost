...
typedef zr_boost_1_81::winapi::BOOL_
(BOOST_WINAPI_WINAPI_CC *PINIT_ONCE_FN) (
    ::_RTL_RUN_ONCE* InitOnce,
    zr_boost_1_81::winapi::PVOID_ Parameter,
    zr_boost_1_81::winapi::PVOID_ *Context);
...
InitOnceExecuteOnce(
    ...
    zr_boost_1_81::winapi::PVOID_ Parameter,
    zr_boost_1_81::winapi::LPVOID_ *Context);

BOOST_WINAPI_IMPORT zr_boost_1_81::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
InitOnceBeginInitialize(
    ::_RTL_RUN_ONCE* lpInitOnce,
    zr_boost_1_81::winapi::DWORD_ dwFlags,
    zr_boost_1_81::winapi::PBOOL_ fPending,
    zr_boost_1_81::winapi::LPVOID_ *lpContext);
