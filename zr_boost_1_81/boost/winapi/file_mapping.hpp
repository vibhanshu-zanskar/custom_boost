...
CreateFileMappingA(
    ...
    zr_boost_1_81::winapi::DWORD_ flProtect,
    zr_boost_1_81::winapi::DWORD_ dwMaximumSizeHigh,
    zr_boost_1_81::winapi::DWORD_ dwMaximumSizeLow,
...
MapViewOfFile(
    zr_boost_1_81::winapi::HANDLE_ hFileMappingObject,
    zr_boost_1_81::winapi::DWORD_ dwDesiredAccess,
    zr_boost_1_81::winapi::DWORD_ dwFileOffsetHigh,
    zr_boost_1_81::winapi::DWORD_ dwFileOffsetLow,
    zr_boost_1_81::winapi::SIZE_T_ dwNumberOfBytesToMap);

BOOST_WINAPI_IMPORT zr_boost_1_81::winapi::LPVOID_ BOOST_WINAPI_WINAPI_CC
MapViewOfFileEx(
    zr_boost_1_81::winapi::HANDLE_ hFileMappingObject,
    zr_boost_1_81::winapi::DWORD_ dwDesiredAccess,
    zr_boost_1_81::winapi::DWORD_ dwFileOffsetHigh,
    zr_boost_1_81::winapi::DWORD_ dwFileOffsetLow,
    zr_boost_1_81::winapi::SIZE_T_ dwNumberOfBytesToMap,
    zr_boost_1_81::winapi::LPVOID_ lpBaseAddress);
...
FlushViewOfFile(
    zr_boost_1_81::winapi::LPCVOID_ lpBaseAddress,
    zr_boost_1_81::winapi::SIZE_T_ dwNumberOfBytesToFlush);

BOOST_WINAPI_IMPORT_EXCEPT_WM zr_boost_1_81::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
UnmapViewOfFile(zr_boost_1_81::winapi::LPCVOID_ lpBaseAddress);
