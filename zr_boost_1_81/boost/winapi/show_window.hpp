...
BOOST_WINAPI_IMPORT_EXCEPT_WM zr_boost_1_81::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC ShowWindow(
    HWND hWnd,
    int nCmdShow);

BOOST_WINAPI_IMPORT zr_boost_1_81::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC ShowWindowAsync(
    HWND hWnd,
    int nCmdShow);
} // extern "C"
