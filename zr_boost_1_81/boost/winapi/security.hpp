...
#else
typedef zr_boost_1_81::winapi::PVOID_ PSECURITY_DESCRIPTOR;
#endif

BOOST_WINAPI_IMPORT zr_boost_1_81::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
InitializeSecurityDescriptor(
    PSECURITY_DESCRIPTOR pSecurityDescriptor,
    zr_boost_1_81::winapi::DWORD_ dwRevision);
BOOST_WINAPI_IMPORT zr_boost_1_81::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
SetSecurityDescriptorDacl(
    PSECURITY_DESCRIPTOR pSecurityDescriptor,
    zr_boost_1_81::winapi::BOOL_ bDaclPresent,
    ::_ACL* pDacl,
    zr_boost_1_81::winapi::BOOL_ bDaclDefaulted);
}
#endif
