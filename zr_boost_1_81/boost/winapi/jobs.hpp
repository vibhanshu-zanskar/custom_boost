...
BOOST_WINAPI_IMPORT zr_boost_1_81::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC CreateJobObjectA(
...
BOOST_WINAPI_IMPORT zr_boost_1_81::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC CreateJobObjectW(
    ::_SECURITY_ATTRIBUTES* lpJobAttributes,
    zr_boost_1_81::winapi::LPCWSTR_ lpName);

BOOST_WINAPI_IMPORT zr_boost_1_81::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC AssignProcessToJobObject(
    zr_boost_1_81::winapi::HANDLE_ hJob,
    zr_boost_1_81::winapi::HANDLE_ hProcess);

#if BOOST_USE_WINAPI_VERSION >= BOOST_WINAPI_VERSION_WINXP
BOOST_WINAPI_IMPORT zr_boost_1_81::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC IsProcessInJob(
    zr_boost_1_81::winapi::HANDLE_ ProcessHandle,
    zr_boost_1_81::winapi::HANDLE_ JobHandle,
    zr_boost_1_81::winapi::PBOOL_ Result);
#endif

BOOST_WINAPI_IMPORT zr_boost_1_81::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC TerminateJobObject(
    zr_boost_1_81::winapi::HANDLE_ hJob,
    zr_boost_1_81::winapi::UINT_ uExitCode);
...
#if !defined( BOOST_NO_ANSI_APIS )
#if BOOST_WINAPI_PARTITION_DESKTOP
BOOST_WINAPI_IMPORT zr_boost_1_81::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC OpenJobObjectA(
    zr_boost_1_81::winapi::DWORD_ dwDesiredAccess,
    zr_boost_1_81::winapi::BOOL_ bInheritHandles,
    zr_boost_1_81::winapi::LPCSTR_ lpName);
#endif
#endif

#if BOOST_WINAPI_PARTITION_DESKTOP || BOOST_WINAPI_PARTITION_SYSTEM
BOOST_WINAPI_IMPORT zr_boost_1_81::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC OpenJobObjectW(
    zr_boost_1_81::winapi::DWORD_ dwDesiredAccess,
    zr_boost_1_81::winapi::BOOL_ bInheritHandles,
    zr_boost_1_81::winapi::LPCWSTR_ lpName);
#endif
