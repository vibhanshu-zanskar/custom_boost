...
CryptEnumProvidersA(
    zr_boost_1_81::winapi::DWORD_ dwIndex,
    zr_boost_1_81::winapi::DWORD_ *pdwReserved,
    zr_boost_1_81::winapi::DWORD_ dwFlags,
    zr_boost_1_81::winapi::DWORD_ *pdwProvType,
    zr_boost_1_81::winapi::LPSTR_ szProvName,
    zr_boost_1_81::winapi::DWORD_ *pcbProvName);

BOOST_WINAPI_IMPORT zr_boost_1_81::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
CryptAcquireContextA(
    zr_boost_1_81::winapi::HCRYPTPROV_ *phProv,
    zr_boost_1_81::winapi::LPCSTR_ pszContainer,
    zr_boost_1_81::winapi::LPCSTR_ pszProvider,
    zr_boost_1_81::winapi::DWORD_ dwProvType,
    zr_boost_1_81::winapi::DWORD_ dwFlags);
...
CryptEnumProvidersW(
    ...
    zr_boost_1_81::winapi::DWORD_ dwFlags,
    zr_boost_1_81::winapi::DWORD_ *pdwProvType,
    zr_boost_1_81::winapi::LPWSTR_ szProvName,
    zr_boost_1_81::winapi::DWORD_ *pcbProvName);

BOOST_WINAPI_IMPORT zr_boost_1_81::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
CryptAcquireContextW(
    zr_boost_1_81::winapi::HCRYPTPROV_ *phProv,
    zr_boost_1_81::winapi::LPCWSTR_ szContainer,
    zr_boost_1_81::winapi::LPCWSTR_ szProvider,
    zr_boost_1_81::winapi::DWORD_ dwProvType,
    zr_boost_1_81::winapi::DWORD_ dwFlags);

BOOST_WINAPI_IMPORT zr_boost_1_81::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
CryptGenRandom(
    zr_boost_1_81::winapi::HCRYPTPROV_ hProv,
    zr_boost_1_81::winapi::DWORD_ dwLen,
    zr_boost_1_81::winapi::BYTE_ *pbBuffer);
...
CryptReleaseContext(
    zr_boost_1_81::winapi::HCRYPTPROV_ hProv,
    zr_boost_1_81::winapi::ULONG_PTR_ dwFlags);
#else
BOOST_WINAPI_IMPORT zr_boost_1_81::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
CryptReleaseContext(
    zr_boost_1_81::winapi::HCRYPTPROV_ hProv,
