...
#if !defined( BOOST_NO_ANSI_APIS )
BOOST_WINAPI_IMPORT zr_boost_1_81::winapi::DWORD_PTR_ BOOST_WINAPI_WINAPI_CC SHGetFileInfoA(
    zr_boost_1_81::winapi::LPCSTR_ pszPath,
    zr_boost_1_81::winapi::DWORD_ dwFileAttributes,
    ::_SHFILEINFOA *psfinsigned,
    zr_boost_1_81::winapi::UINT_ cbFileInfons,
    zr_boost_1_81::winapi::UINT_ uFlags);
#endif

BOOST_WINAPI_IMPORT zr_boost_1_81::winapi::DWORD_PTR_ BOOST_WINAPI_WINAPI_CC SHGetFileInfoW(
    zr_boost_1_81::winapi::LPCWSTR_ pszPath,
    zr_boost_1_81::winapi::DWORD_ dwFileAttributes,
