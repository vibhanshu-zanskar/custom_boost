...
BOOST_WINAPI_IMPORT_EXCEPT_WM zr_boost_1_81::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
InitializeCriticalSection(zr_boost_1_81::winapi::detail::winsdk_critical_section* lpCriticalSection);
#endif

BOOST_WINAPI_IMPORT_EXCEPT_WM zr_boost_1_81::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
EnterCriticalSection(zr_boost_1_81::winapi::detail::winsdk_critical_section* lpCriticalSection);

BOOST_WINAPI_IMPORT_EXCEPT_WM zr_boost_1_81::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
LeaveCriticalSection(zr_boost_1_81::winapi::detail::winsdk_critical_section* lpCriticalSection);

#if BOOST_USE_WINAPI_VERSION >= 0x0403
#if BOOST_WINAPI_PARTITION_APP_SYSTEM
BOOST_WINAPI_IMPORT zr_boost_1_81::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
InitializeCriticalSectionAndSpinCount(
    zr_boost_1_81::winapi::detail::winsdk_critical_section* lpCriticalSection,
    zr_boost_1_81::winapi::DWORD_ dwSpinCount);
...
InitializeCriticalSectionEx(
    zr_boost_1_81::winapi::detail::winsdk_critical_section* lpCriticalSection,
    zr_boost_1_81::winapi::DWORD_ dwSpinCount,
    zr_boost_1_81::winapi::DWORD_ Flags);
#endif
#endif

#if BOOST_USE_WINAPI_VERSION >= BOOST_WINAPI_VERSION_NT4
BOOST_WINAPI_IMPORT_EXCEPT_WM zr_boost_1_81::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
TryEnterCriticalSection(zr_boost_1_81::winapi::detail::winsdk_critical_section* lpCriticalSection);
#endif

BOOST_WINAPI_IMPORT_EXCEPT_WM zr_boost_1_81::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
DeleteCriticalSection(zr_boost_1_81::winapi::detail::winsdk_critical_section* lpCriticalSection);

#else // defined( BOOST_WINAPI_IS_MINGW )

BOOST_WINAPI_IMPORT_EXCEPT_WM zr_boost_1_81::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
InitializeCriticalSection(zr_boost_1_81::winapi::detail::winapi_critical_section* lpCriticalSection);

BOOST_WINAPI_IMPORT_EXCEPT_WM zr_boost_1_81::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
EnterCriticalSection(zr_boost_1_81::winapi::detail::winapi_critical_section* lpCriticalSection);

BOOST_WINAPI_IMPORT_EXCEPT_WM zr_boost_1_81::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
LeaveCriticalSection(zr_boost_1_81::winapi::detail::winapi_critical_section* lpCriticalSection);

#if BOOST_USE_WINAPI_VERSION >= 0x0403
BOOST_WINAPI_IMPORT zr_boost_1_81::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
InitializeCriticalSectionAndSpinCount(
    zr_boost_1_81::winapi::detail::winapi_critical_section* lpCriticalSection,
    zr_boost_1_81::winapi::DWORD_ dwSpinCount);
...
#if BOOST_USE_WINAPI_VERSION >= BOOST_WINAPI_VERSION_NT4
BOOST_WINAPI_IMPORT_EXCEPT_WM zr_boost_1_81::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
TryEnterCriticalSection(zr_boost_1_81::winapi::detail::winapi_critical_section* lpCriticalSection);
#endif

BOOST_WINAPI_IMPORT_EXCEPT_WM zr_boost_1_81::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
DeleteCriticalSection(zr_boost_1_81::winapi::detail::winapi_critical_section* lpCriticalSection);
