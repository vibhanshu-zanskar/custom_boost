...
BOOST_WINAPI_IMPORT zr_boost_1_81::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
LoadLibraryA(zr_boost_1_81::winapi::LPCSTR_ lpFileName);
...
BOOST_WINAPI_IMPORT zr_boost_1_81::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
GetModuleHandleA(zr_boost_1_81::winapi::LPCSTR_ lpFileName);

BOOST_WINAPI_IMPORT zr_boost_1_81::winapi::DWORD_ BOOST_WINAPI_WINAPI_CC
GetModuleFileNameA(
    zr_boost_1_81::winapi::HMODULE_ hModule,
    zr_boost_1_81::winapi::LPSTR_ lpFilename,
    zr_boost_1_81::winapi::DWORD_ nSize
);
#endif

BOOST_WINAPI_IMPORT_EXCEPT_WM zr_boost_1_81::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
LoadLibraryW(zr_boost_1_81::winapi::LPCWSTR_ lpFileName);
...
BOOST_WINAPI_IMPORT_EXCEPT_WM zr_boost_1_81::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
GetModuleHandleW(zr_boost_1_81::winapi::LPCWSTR_ lpFileName);

BOOST_WINAPI_IMPORT_EXCEPT_WM zr_boost_1_81::winapi::DWORD_ BOOST_WINAPI_WINAPI_CC
GetModuleFileNameW(
    zr_boost_1_81::winapi::HMODULE_ hModule,
    zr_boost_1_81::winapi::LPWSTR_ lpFilename,
    zr_boost_1_81::winapi::DWORD_ nSize
);
...
BOOST_WINAPI_IMPORT_EXCEPT_WM zr_boost_1_81::winapi::SIZE_T_ BOOST_WINAPI_WINAPI_CC
VirtualQuery(
    zr_boost_1_81::winapi::LPCVOID_ lpAddress,
    ::_MEMORY_BASIC_INFORMATION* lpBuffer,
    zr_boost_1_81::winapi::SIZE_T_ dwLength
);
...
VirtualQuery(
    zr_boost_1_81::winapi::LPCVOID_ lpAddress,
    ::_MEMORY_BASIC_INFORMATION* lpBuffer,
    zr_boost_1_81::winapi::DWORD_ dwLength
);
...
FreeLibrary(zr_boost_1_81::winapi::HMODULE_ hModule);
}
#endif
