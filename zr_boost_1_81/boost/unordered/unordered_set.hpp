...
#undef BOOST_UNORDERED_EMPLACE
  ...
  (BOOST_COMP_GNUC && BOOST_COMP_GNUC < BOOST_VERSION_NUMBER(4, 6, 0))
    ...
    public:
      ...
      void merge(zr_boost_1_81::unordered_set<T, H2, P2, A>& source);
      ...
      template <typename H2, typename P2>
      void merge(zr_boost_1_81::unordered_multiset<T, H2, P2, A>& source);
    ...
    template <class InputIterator,
      class Hash =
        zr_boost_1_81::hash<typename std::iterator_traits<InputIterator>::value_type>,
      class Pred =
    ...
    template <class T, class Hash = zr_boost_1_81::hash<T>,
    ...
    unordered_set(std::initializer_list<T>, std::size_t, Allocator)
      -> unordered_set<T, zr_boost_1_81::hash<T>, std::equal_to<T>, Allocator>;
...
#undef BOOST_UNORDERED_EMPLACE
  ...
  (BOOST_COMP_GNUC && BOOST_COMP_GNUC < BOOST_VERSION_NUMBER(4, 6, 0))
    ...
    unordered_multiset(std::initializer_list<T>, std::size_t, Allocator)
      -> unordered_multiset<T, zr_boost_1_81::hash<T>, std::equal_to<T>, Allocator>;
    ...
    void unordered_set<T, H, P, A>::merge(
      zr_boost_1_81::unordered_set<T, H2, P2, A>& source)
    {
    ...
    template <typename H2, typename P2>
    void unordered_set<T, H, P, A>::merge(
      zr_boost_1_81::unordered_multiset<T, H2, P2, A>& source)
    {
      table_.merge_unique(source.table_);
    }
    ...
    template <typename N, typename T, typename A> class node_handle_set
    {
      ...
      typedef typename zr_boost_1_81::unordered::detail::rebind_wrap<A, T>::type
        value_allocator;
      typedef zr_boost_1_81::unordered::detail::allocator_traits<value_allocator>
        value_allocator_traits;
      typedef N node;
      typedef typename zr_boost_1_81::unordered::detail::rebind_wrap<A, node>::type
        node_allocator;
      typedef zr_boost_1_81::unordered::detail::allocator_traits<node_allocator>
