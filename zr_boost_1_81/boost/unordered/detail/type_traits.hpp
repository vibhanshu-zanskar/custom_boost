...
namespace zr_boost_1_81 {
  namespace unordered {
    namespace detail {
      ...
      struct is_transparent : public zr_boost_1_81::false_type
      {
      };

      template <class T>
      struct is_transparent<T,
        typename zr_boost_1_81::make_void<typename T::is_transparent>::type>
      ...
      template <class Key, class UnorderedMap> struct transparent_non_iterable
      {
        ...
        static bool const value =
          ...
          !zr_boost_1_81::is_convertible<Key, iterator>::value &&
          !zr_boost_1_81::is_convertible<Key, const_iterator>::value;
      };
      ...
      constexpr bool const is_input_iterator_v =
        !zr_boost_1_81::is_integral<InputIterator>::value;
      ...
      struct is_allocator<A,
        zr_boost_1_81::void_t<typename A::value_type,
      ...
      constexpr bool const is_hash_v =
        !zr_boost_1_81::is_integral<H>::value && !is_allocator_v<H>;
