  ...
  namespace unordered {
    namespace detail {
      ...
      template <class ValueType, class VoidPtr> struct node
      {
        ...
        typedef typename zr_boost_1_81::pointer_traits<VoidPtr>::template rebind_to<
          node>::type node_pointer;

        node_pointer next;
        typename zr_boost_1_81::aligned_storage<sizeof(value_type),
          zr_boost_1_81::alignment_of<value_type>::value>::type buf;
      ...
      template <class Bucket> struct bucket_group
      {
        ...
        typedef
          typename zr_boost_1_81::pointer_traits<bucket_pointer>::template rebind_to<
      ...
      public:
        ...
        typedef typename zr_boost_1_81::pointer_traits<bucket_pointer>::difference_type
          difference_type;
      ...
      public:
        ...
        {
          return zr_boost_1_81::to_address(p);
        }
      ...
      private:
        ...
        void increment() BOOST_NOEXCEPT
        {
          ...
          std::size_t n = std::size_t(zr_boost_1_81::core::countr_zero(
          ...
          if (n < N) {
            ...
            std::ptrdiff_t x = zr_boost_1_81::core::countr_zero(pbg->bitmask);
            p = pbg->buckets + x;
          }
        }
      };
      ...
      class grouped_bucket_array
          : zr_boost_1_81::empty_value<typename zr_boost_1_81::allocator_rebind<Allocator,
              node<typename zr_boost_1_81::allocator_value_type<Allocator>::type,
                typename zr_boost_1_81::allocator_void_pointer<Allocator>::type> >::
                type>
      {
        BOOST_MOVABLE_BUT_NOT_COPYABLE(grouped_bucket_array)

        typedef typename zr_boost_1_81::allocator_value_type<Allocator>::type
          allocator_value_type;
        typedef
          typename zr_boost_1_81::allocator_void_pointer<Allocator>::type void_pointer;
        typedef typename zr_boost_1_81::allocator_difference_type<Allocator>::type
          difference_type;

      public:
        typedef typename zr_boost_1_81::allocator_rebind<Allocator,
          node<allocator_value_type, void_pointer> >::type node_allocator_type;

        typedef node<allocator_value_type, void_pointer> node_type;
        typedef typename zr_boost_1_81::allocator_pointer<node_allocator_type>::type
          node_pointer;
        typedef SizePolicy size_policy;

      private:
        typedef typename zr_boost_1_81::allocator_rebind<Allocator, Bucket>::type
          bucket_allocator_type;
        typedef typename zr_boost_1_81::allocator_pointer<bucket_allocator_type>::type
          bucket_pointer;
        typedef zr_boost_1_81::pointer_traits<bucket_pointer> bucket_pointer_traits;

        typedef bucket_group<Bucket> group;
        typedef typename zr_boost_1_81::allocator_rebind<Allocator, group>::type
          group_allocator_type;
        typedef typename zr_boost_1_81::allocator_pointer<group_allocator_type>::type
          group_pointer;
        typedef typename zr_boost_1_81::pointer_traits<group_pointer>
      ...
      public:
              ...
              size_(0), buckets(), groups()
        {
          ...
          buckets = zr_boost_1_81::allocator_allocate(bucket_alloc, num_buckets);
          BOOST_TRY
          {
            groups = zr_boost_1_81::allocator_allocate(group_alloc, num_groups);

            bucket_type* pb = zr_boost_1_81::to_address(buckets);
            for (size_type i = 0; i < num_buckets; ++i) {
              new (pb + i) bucket_type();
            }

            group* pg = zr_boost_1_81::to_address(groups);
          ...
          BOOST_CATCH(...)
          {
            zr_boost_1_81::allocator_deallocate(bucket_alloc, buckets, num_buckets);
            BOOST_RETHROW
          }
          BOOST_CATCH_END
          ...
          BOOST_RV_REF(grouped_bucket_array) other) BOOST_NOEXCEPT
        {
          ...
          if (this == zr_boost_1_81::addressof(other)) {
            return *this;
          }
        ...
        void deallocate() BOOST_NOEXCEPT
        {
          if (buckets) {
            bucket_allocator_type bucket_alloc = this->get_bucket_allocator();
            zr_boost_1_81::allocator_deallocate(
        ...
        void swap(grouped_bucket_array& other)
        {
          ...
          bool b = zr_boost_1_81::allocator_propagate_on_container_swap<
            allocator_type>::type::value;
          if (b) {
            zr_boost_1_81::swap(get_node_allocator(), other.get_node_allocator());
          }
        }
        ...
        span<Bucket> raw()
        {
          ...
          return span<Bucket>(zr_boost_1_81::to_address(buckets), size_);
        }
        ...
        void append_bucket_group(iterator itb) BOOST_NOEXCEPT
        {
          ...
          if (is_empty_bucket) {
            ...
            std::size_t n =
              static_cast<std::size_t>(zr_boost_1_81::to_address(pb) - &buckets[0]);
