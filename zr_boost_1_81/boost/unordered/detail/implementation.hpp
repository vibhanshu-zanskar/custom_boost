...
namespace zr_boost_1_81 {
  namespace unordered {
    namespace detail {
      ...
      template <typename I>
      struct is_forward : zr_boost_1_81::is_base_of<std::forward_iterator_tag,
      ...
      struct enable_if_forward
        : zr_boost_1_81::enable_if_c<zr_boost_1_81::unordered::detail::is_forward<I>::value,
            ReturnType>
      {
      };
      ...
      struct disable_if_forward
        : zr_boost_1_81::disable_if_c<zr_boost_1_81::unordered::detail::is_forward<I>::value,
            ReturnType>
      {
      };
    }
...
namespace zr_boost_1_81 {
  namespace unordered {
    namespace detail {
      ...
      template <class I>
      inline typename zr_boost_1_81::unordered::detail::enable_if_forward<I,
        std::size_t>::type
      insert_size(I i, I j)
      {
      ...
      template <class I>
      inline typename zr_boost_1_81::unordered::detail::disable_if_forward<I,
      ...
      inline std::size_t initial_size(I i, I j,
        std::size_t num_buckets =
          zr_boost_1_81::unordered::detail::default_bucket_count)
      {
        return (std::max)(
          zr_boost_1_81::unordered::detail::insert_size(i, j), num_buckets);
      }
      ...
      struct compressed_base : zr_boost_1_81::empty_value<T>
      {
        compressed_base(T const& x) : empty_value<T>(zr_boost_1_81::empty_init_t(), x)
        {
        }
        compressed_base(T& x, move_tag)
            : empty_value<T>(zr_boost_1_81::empty_init_t(), zr_boost_1_81::move(x))
        {
        }
      ...
      template <typename T, int Index>
      struct generate_base : zr_boost_1_81::unordered::detail::compressed_base<T, Index>
      {
      ...
      struct compressed
        : private zr_boost_1_81::unordered::detail::generate_base<T1, 1>::type,
          private zr_boost_1_81::unordered::detail::generate_base<T2, 2>::type
      {
        ...
        {
          first() = zr_boost_1_81::move(x.first());
          second() = zr_boost_1_81::move(x.second());
        }

        void swap(compressed& x)
        {
          zr_boost_1_81::swap(first(), x.first());
          zr_boost_1_81::swap(second(), x.second());
        }
...
// will be default-initialized.
      ...
      template <typename T>
      typename zr_boost_1_81::add_lvalue_reference<T>::type make();
      struct choice9
      {
        typedef char (&type)[9];
      };
...
#define BOOST_UNORDERED_EMPLACE_FORWARD zr_boost_1_81::forward<Args>(args)...
...
#define BOOST_UNORDERED_EARGS_MEMBER(z, n, _)                                  \
  typedef typename zr_boost_1_81::add_lvalue_reference<BOOST_PP_CAT(A, n)>::type       \
    BOOST_PP_CAT(Arg, n);                                                      \
  BOOST_PP_CAT(Arg, n) BOOST_PP_CAT(a, n);
...
#define BOOST_UNORDERED_CALL_FORWARD(z, i, a)                                  \
  zr_boost_1_81::forward<BOOST_PP_CAT(A, i)>(BOOST_PP_CAT(a, i))
...
// Uses the standard versions if available.
      ...
      typedef zr_boost_1_81::unordered::detail::integral_constant<bool, true> true_type;
      typedef zr_boost_1_81::unordered::detail::integral_constant<bool, false>
        false_type;
...
#pragma warning(pop)
      ...
      template <typename ValueType> struct value_base
      {
        ...
        typename zr_boost_1_81::aligned_storage<sizeof(value_type),
          zr_boost_1_81::alignment_of<value_type>::value>::type data_;
      ...
      template <typename T> class optional
      {
        ...
        zr_boost_1_81::unordered::detail::value_base<T> value_;
        bool has_value_;

        void destroy()
        {
          if (has_value_) {
            zr_boost_1_81::unordered::detail::func::destroy(value_.value_ptr());
            has_value_ = false;
          }
        }
        ...
        void move(optional<T>& x)
        {
          ...
          new (value_.value_ptr()) T(zr_boost_1_81::move(x.value_.value()));
          zr_boost_1_81::unordered::detail::func::destroy(x.value_.value_ptr());
          has_value_ = true;
          x.has_value_ = false;
        }
      ...
      public:
        ...
        void swap(optional<T>& x)
        {
          if (has_value_ != x.has_value_) {
            ...
            zr_boost_1_81::swap(value_.value(), x.value_.value());
          }
        }
...
namespace zr_boost_1_81 {
  namespace unordered {
    namespace detail {
      ...
      struct allocator_traits : zr_boost_1_81::allocator_traits<Alloc>
      {
      };

      template <typename Alloc, typename T>
      struct rebind_wrap : zr_boost_1_81::allocator_rebind<Alloc, T>
      {
      };
    }
  }
  ...
  namespace unordered {
    namespace detail {
      namespace func {
        ...
        {
          new ((void*)address) T(zr_boost_1_81::forward<Args>(args)...);
        }
      }
    }
  }
  ...
  namespace unordered {
    namespace detail {
      namespace func {
        ...
        {
          new ((void*)address) T(zr_boost_1_81::forward<A0>(a0));
        }
      }
    }
  }
...
// construct_from_tuple for zr_boost_1_81::tuple
...
namespace zr_boost_1_81 {
  namespace unordered {
    namespace detail {
      namespace func {
        template <typename Alloc, typename T>
        void construct_from_tuple(Alloc&, T* ptr, zr_boost_1_81::tuple<>)
        {
          new ((void*)ptr) T();
        }

        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 1, zr_boost_1_81)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 2, zr_boost_1_81)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 3, zr_boost_1_81)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 4, zr_boost_1_81)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 5, zr_boost_1_81)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 6, zr_boost_1_81)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 7, zr_boost_1_81)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 8, zr_boost_1_81)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 9, zr_boost_1_81)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 10, zr_boost_1_81)
      }
    }
  }
}
...
// construct_from_tuple for zr_boost_1_81::tuple on old versions of sunpro.
//
// Old versions of Sun C++ had problems with template overloads of
// zr_boost_1_81::tuple, so to fix it I added a distinct type for each length to
...
#define BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(z, n, namespace_)                 \
  template <typename Alloc, typename T,                                        \
    BOOST_PP_ENUM_PARAMS_Z(z, n, typename A)>                                  \
  void construct_from_tuple_impl(zr_boost_1_81::unordered::detail::func::length<n>,    \
    Alloc&, T* ptr,                                                            \
    namespace_::tuple<BOOST_PP_ENUM_PARAMS_Z(z, n, A)> const& x)               \
  {                                                                            \
    new ((void*)ptr)                                                           \
    ...
    namespace detail {
      namespace func {
        ...
        void construct_from_tuple_impl(
          zr_boost_1_81::unordered::detail::func::length<0>, Alloc&, T* ptr,
          zr_boost_1_81::tuple<>)
        {
          new ((void*)ptr) T();
        }
        ...
        {
          construct_from_tuple_impl(zr_boost_1_81::unordered::detail::func::length<
                                      zr_boost_1_81::tuples::length<Tuple>::value>(),
            alloc, ptr, x);
        }
      }
    }
      ...
      namespace func {
        ...
        template <typename A0> struct use_piecewise
        {
          static choice1::type test(
            choice1, zr_boost_1_81::unordered::piecewise_construct_t);
          ...
          enum
          {
            value = sizeof(choice1::type) ==
                    sizeof(test(choose(), zr_boost_1_81::unordered::detail::make<A0>()))
          };
        };
        ...
        {
          zr_boost_1_81::allocator_construct(
            alloc, address, zr_boost_1_81::forward<Args>(args)...);
        }

        // For backwards compatibility, implement a special case for
        // piecewise_construct with zr_boost_1_81::tuple
        ...
        template <typename A0> struct detect_boost_tuple
        {
          ...
          static choice1::type test(choice1,
            zr_boost_1_81::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> const&);
        ...
        to_std_tuple_impl(zr_boost_1_81::mp11::mp_list<Args...>,
          zr_boost_1_81::tuple<TupleArgs...>& tuple, zr_boost_1_81::mp11::index_sequence<Is...>)
        {
          (void) tuple;
          return std::tuple<typename std::add_lvalue_reference<Args>::type...>(
            zr_boost_1_81::get<Is>(tuple)...);
        }
        ...
        template <class... Args>
        zr_boost_1_81::mp11::mp_transform<add_lvalue_reference_t,
          zr_boost_1_81::mp11::mp_remove<std::tuple<Args...>,
            zr_boost_1_81::tuples::null_type> >
        to_std_tuple(zr_boost_1_81::tuple<Args...>& tuple)
        {
          using list = zr_boost_1_81::mp11::mp_remove<zr_boost_1_81::mp11::mp_list<Args...>,
            zr_boost_1_81::tuples::null_type>;
          using list_size = zr_boost_1_81::mp11::mp_size<list>;
          using index_seq = zr_boost_1_81::mp11::make_index_sequence<list_size::value>;
        ...
        inline typename zr_boost_1_81::enable_if_c<use_piecewise<A0>::value &&
        ...
        {
          zr_boost_1_81::allocator_construct(alloc, address, std::piecewise_construct,
        ...
        construct_from_args(Alloc& alloc, std::pair<A, B>* address,
          BOOST_FWD_REF(A0), BOOST_FWD_REF(A1) a1, BOOST_FWD_REF(A2) a2)
        {
          zr_boost_1_81::unordered::detail::func::construct_from_tuple(
            alloc, zr_boost_1_81::addressof(address->first), zr_boost_1_81::forward<A1>(a1));
          BOOST_TRY
          {
            zr_boost_1_81::unordered::detail::func::construct_from_tuple(
              alloc, zr_boost_1_81::addressof(address->second), zr_boost_1_81::forward<A2>(a2));
          }
          BOOST_CATCH(...)
          {
            zr_boost_1_81::unordered::detail::func::destroy(
              zr_boost_1_81::addressof(address->first));
            BOOST_RETHROW
          }
          BOOST_CATCH_END
        }
        ...
        {
          new ((void*)address) T(zr_boost_1_81::forward<A0>(args.a0));
        }
        ...
        {
          new ((void*)address)
            T(zr_boost_1_81::forward<A0>(args.a0), zr_boost_1_81::forward<A1>(args.a1));
        }
        ...
        {
          new ((void*)address) T(zr_boost_1_81::forward<A0>(args.a0),
            zr_boost_1_81::forward<A1>(args.a1), zr_boost_1_81::forward<A2>(args.a2));
        }
...
#define BOOST_UNORDERED_CONSTRUCT_IMPL(z, num_params, _)                       \
  ...
  inline void construct_from_args(Alloc&, T* address,                          \
    zr_boost_1_81::unordered::detail::BOOST_PP_CAT(emplace_args, num_params) <         \
...
#undef BOOST_UNORDERED_CONSTRUCT_IMPL
        ...
        inline typename enable_if<use_piecewise<A0>, void>::type
        construct_from_args(Alloc& alloc, std::pair<A, B>* address,
          zr_boost_1_81::unordered::detail::emplace_args3<A0, A1, A2> const& args)
        {
          zr_boost_1_81::unordered::detail::func::construct_from_tuple(
            alloc, zr_boost_1_81::addressof(address->first), args.a1);
          BOOST_TRY
          {
            zr_boost_1_81::unordered::detail::func::construct_from_tuple(
              alloc, zr_boost_1_81::addressof(address->second), args.a2);
          }
          BOOST_CATCH(...)
          {
            zr_boost_1_81::unordered::detail::func::destroy(
  ...
  namespace unordered {
    namespace detail {
      ...
      template <typename NodeAlloc> struct node_constructor
      {
        ...
        typedef zr_boost_1_81::unordered::detail::allocator_traits<NodeAlloc>
      ...
      {
        if (node_) {
          zr_boost_1_81::unordered::detail::func::destroy(zr_boost_1_81::to_address(node_));
      ...
      template <typename Alloc> void node_constructor<Alloc>::create_node()
      {
        ...
        new ((void*)zr_boost_1_81::to_address(node_)) node();
      }

      template <typename NodeAlloc> struct node_tmp
      {
        typedef typename zr_boost_1_81::allocator_value_type<NodeAlloc>::type node;
        typedef typename zr_boost_1_81::allocator_pointer<NodeAlloc>::type node_pointer;
        typedef typename node::value_type value_type;
        typedef typename zr_boost_1_81::allocator_rebind<NodeAlloc, value_type>::type
          value_allocator;
      ...
      template <typename Alloc> node_tmp<Alloc>::~node_tmp()
      {
        if (node_) {
          ...
          zr_boost_1_81::allocator_destroy(val_alloc, node_->value_ptr());
          zr_boost_1_81::allocator_deallocate(alloc_, node_, 1);
        }
      }
    }
  }
  ...
  namespace unordered {
    namespace detail {
      namespace func {
        ...
        inline typename zr_boost_1_81::allocator_pointer<Alloc>::type
        construct_node_from_args(Alloc& alloc, BOOST_UNORDERED_EMPLACE_ARGS)
        {
          typedef typename zr_boost_1_81::allocator_value_type<Alloc>::type node;
          typedef typename node::value_type value_type;
          typedef typename zr_boost_1_81::allocator_rebind<Alloc, value_type>::type
            value_allocator;
        ...
        inline typename zr_boost_1_81::allocator_pointer<Alloc>::type construct_node(
          Alloc& alloc, BOOST_FWD_REF(U) x)
        {
          ...
          zr_boost_1_81::allocator_construct(
            val_alloc, a.node_->value_ptr(), zr_boost_1_81::forward<U>(x));
          return a.release();
        }
        ...
        construct_node_pair(Alloc& alloc, BOOST_FWD_REF(Key) k)
        {
          ...
          zr_boost_1_81::allocator_construct(
            ...
            std::forward_as_tuple(zr_boost_1_81::forward<Key>(k)),
          ...
          Alloc& alloc, BOOST_FWD_REF(Key) k, BOOST_FWD_REF(Mapped) m)
        {
          ...
          zr_boost_1_81::allocator_construct(val_alloc, a.node_->value_ptr(),
            std::piecewise_construct,
            std::forward_as_tuple(zr_boost_1_81::forward<Key>(k)),
            std::forward_as_tuple(zr_boost_1_81::forward<Mapped>(m)));
          return a.release();
        }
      ...
      defined(BOOST_LIBSTDCXX11))
          zr_boost_1_81::allocator_construct(val_alloc, a.node_->value_ptr(),
            std::piecewise_construct,
            std::forward_as_tuple(zr_boost_1_81::forward<Key>(k)),
            std::forward_as_tuple(zr_boost_1_81::forward<Args>(args)...));
#else
          ...
          zr_boost_1_81::allocator_construct(val_alloc, a.node_->value_ptr(),
            std::piecewise_construct,
            std::forward_as_tuple(zr_boost_1_81::forward<Key>(k)),
            std::make_tuple(zr_boost_1_81::forward<Args>(args)...));
#endif
          return a.release();
        }
        ...
        template <typename Alloc, typename Key>
        inline
          typename zr_boost_1_81::unordered::detail::allocator_traits<Alloc>::pointer
          construct_node_pair(Alloc& alloc, BOOST_FWD_REF(Key) k)
        {
          node_constructor<Alloc> a(alloc);
          a.create_node();
          zr_boost_1_81::unordered::detail::func::construct_value(
            zr_boost_1_81::addressof(a.node_->value_ptr()->first),
            zr_boost_1_81::forward<Key>(k));
          BOOST_TRY
          {
            zr_boost_1_81::unordered::detail::func::construct_value(
              zr_boost_1_81::addressof(a.node_->value_ptr()->second));
          }
          BOOST_CATCH(...)
          {
            zr_boost_1_81::unordered::detail::func::destroy(
            ...
            Alloc& alloc, BOOST_FWD_REF(Key) k, BOOST_FWD_REF(Mapped) m)
        {
          ...
          BOOST_TRY
          {
            zr_boost_1_81::unordered::detail::func::construct_value(
              zr_boost_1_81::addressof(a.node_->value_ptr()->second),
              zr_boost_1_81::forward<Mapped>(m));
          }
          BOOST_CATCH(...)
          {
            zr_boost_1_81::unordered::detail::func::destroy(
            ...
            Alloc& alloc, BOOST_FWD_REF(Key) k, BOOST_UNORDERED_EMPLACE_ARGS)
        {
          ...
          BOOST_TRY
          {
            zr_boost_1_81::unordered::detail::func::construct_from_args(alloc,
              zr_boost_1_81::addressof(a.node_->value_ptr()->second),
    ...
    namespace detail {
      ...
      public:
        static const bool nothrow_move_assignable =
          zr_boost_1_81::is_nothrow_move_assignable<H>::value &&
          zr_boost_1_81::is_nothrow_move_assignable<P>::value;
        static const bool nothrow_move_constructible =
          zr_boost_1_81::is_nothrow_move_constructible<H>::value &&
          zr_boost_1_81::is_nothrow_move_constructible<P>::value;
        static const bool nothrow_swappable =
          zr_boost_1_81::is_nothrow_swappable<H>::value &&
          zr_boost_1_81::is_nothrow_swappable<P>::value;
      ...
      private:
        ...
        typedef typename zr_boost_1_81::aligned_storage<sizeof(function_pair),
          zr_boost_1_81::alignment_of<function_pair>::value>::type aligned_function;
      ...
      public:
        ...
        functions(functions& bf, zr_boost_1_81::unordered::detail::move_tag)
            : current_(0)
        {
          construct_functions(current_, bf.current_functions(),
            zr_boost_1_81::unordered::detail::integral_constant<bool,
        ...
        {
          return *::zr_boost_1_81::unordered::detail::launder(
      ...
      private:
        ...
        void construct_functions(unsigned char which, function_pair const& f,
          zr_boost_1_81::unordered::detail::false_type =
            zr_boost_1_81::unordered::detail::false_type())
        {
          BOOST_ASSERT(!(which & 2));
        ...
        void construct_functions(unsigned char which, function_pair& f,
          zr_boost_1_81::unordered::detail::true_type)
        {
          BOOST_ASSERT(!(which & 2));
          new ((void*)&funcs_[which])
            function_pair(f, zr_boost_1_81::unordered::detail::move_tag());
        }
...
#define BOOST_UNORDERED_RV_REF(T) BOOST_RV_REF(T)
      ...
      template <typename T>
      struct rv_ref : zr_boost_1_81::conditional<zr_boost_1_81::is_class<T>::value,
                        zr_boost_1_81::unordered::detail::rv_ref_impl<T>,
                        please_ignore_this_overload>::type
      {
      };

#define BOOST_UNORDERED_RV_REF(T)                                              \
  typename zr_boost_1_81::unordered::detail::rv_ref<T>::type
#endif
...
#pragma warning(disable : 4127) // conditional expression is constant
      ...
      namespace iterator_detail {
        ...
        public:
          ...
          {
            pointer x = zr_boost_1_81::addressof(p->value());
            return x;
          }
          ...
          bool operator==(
            zr_boost_1_81::unordered::detail::iterator_detail::c_iterator<Node,
        ...
        private:
          ...
          template <class Types> friend struct zr_boost_1_81::unordered::detail::table;
          ...
          bool equal(
            const zr_boost_1_81::unordered::detail::iterator_detail::c_iterator<Node,
        ...
        public:
          ...
          bool operator==(
            zr_boost_1_81::unordered::detail::iterator_detail::iterator<Node,
              Bucket> const& other) const BOOST_NOEXCEPT
          {
            return equal(other);
          }
      ...
      struct table : zr_boost_1_81::unordered::detail::functions<typename Types::hasher,
      ...
      public:
        ...
        typedef zr_boost_1_81::unordered::detail::functions<typename Types::hasher,
          typename Types::key_equal>
          functions;

        typedef typename Types::value_allocator value_allocator;
        typedef typename zr_boost_1_81::allocator_void_pointer<value_allocator>::type void_pointer;
        typedef node<value_type, void_pointer> node_type;

        typedef zr_boost_1_81::unordered::detail::grouped_bucket_array<
          bucket<node_type, void_pointer>, value_allocator, prime_fmod_size<> >
          bucket_array_type;

        typedef typename bucket_array_type::node_allocator_type
          node_allocator_type;
        typedef typename zr_boost_1_81::allocator_pointer<node_allocator_type>::type node_pointer;

        typedef zr_boost_1_81::unordered::detail::node_constructor<node_allocator_type>
          node_constructor;
        typedef zr_boost_1_81::unordered::detail::node_tmp<node_allocator_type> node_tmp;
      ...
      public:
        ...
        std::size_t max_bucket_count() const
        {
          ...
          return size_policy::size(size_policy::size_index(
            zr_boost_1_81::allocator_max_size(this->node_alloc())));
        }
        ...
        void recalculate_max_load()
        {
          ...
          max_load_ =
            bc == 0 ? 0
                    : zr_boost_1_81::unordered::detail::double_to_size(
        ...
        table(table& x, zr_boost_1_81::unordered::detail::move_tag m)
            : functions(x, m), size_(x.size_), mlf_(x.mlf_),
              max_load_(x.max_load_), buckets_(zr_boost_1_81::move(x.buckets_))
        {
          x.size_ = 0;
          x.max_load_ = 0;
        }
        ...
        table(table& x, node_allocator_type const& a,
          zr_boost_1_81::unordered::detail::move_tag m)
        ...
        {
          zr_boost_1_81::unordered::detail::func::ignore_unused_variable_warning(other);
        ...
        void swap(table& x, false_type)
        {
          ...
          zr_boost_1_81::swap(size_, x.size_);
        ...
        void swap(table& x)
        {
          BOOST_ASSERT(zr_boost_1_81::allocator_propagate_on_container_swap<
                         node_allocator_type>::type::value ||
                       node_alloc() == x.node_alloc());
          swap(x, zr_boost_1_81::unordered::detail::integral_constant<bool,
        ...
        {
          buckets_ = zr_boost_1_81::move(other.buckets_);
        ...
        void move_construct_buckets(table& src)
        {
          ...
          for (iterator pos = src.begin(); pos != src.end(); ++pos) {
            node_tmp b(detail::func::construct_node(
                         this->node_alloc(), zr_boost_1_81::move(pos.p->value())),
              this->node_alloc());
        ...
        void delete_node(node_pointer p)
        {
          ...
          value_allocator val_alloc(alloc);
          zr_boost_1_81::allocator_destroy(val_alloc, p->value_ptr());
          zr_boost_1_81::allocator_deallocate(alloc, p, 1);
        }
        ...
        {
          typedef typename zr_boost_1_81::allocator_propagate_on_container_copy_assignment<node_allocator_type>::type pocca;
        ...
        void assign(table const &x, UniqueType is_unique, true_type)
        {
          ...
          else
          {
            ...
            delete_buckets();
            buckets_.reset_allocator(x.node_alloc());
            buckets_ = zr_boost_1_81::move(new_buckets);
        ...
        void move_assign(table& x, UniqueType is_unique)
        {
          if (this != &x) {
            move_assign(x, is_unique,
              zr_boost_1_81::unordered::detail::integral_constant<bool,
                zr_boost_1_81::allocator_propagate_on_container_move_assignment<
                  node_allocator_type>::type::value>());
          }
        }
        ...
        node_pointer* find_prev(Key const& key, bucket_iterator itb)
        {
          if (size_ > 0) {
            ...
            for (node_pointer* pp = zr_boost_1_81::addressof(itb->next); *pp;
                pp = zr_boost_1_81::addressof((*pp)->next)) {
          ...
          const_key_type& k, BOOST_UNORDERED_EMPLACE_ARGS)
        {
          ...
          if (pos) {
            ...
            node_tmp b(zr_boost_1_81::unordered::detail::func::construct_node_from_args(
        ...
        emplace_return try_emplace_unique(BOOST_FWD_REF(Key) k)
        {
          ...
          if (pos) {
            ...
            node_tmp tmp(
              detail::func::construct_node_pair(alloc, zr_boost_1_81::forward<Key>(k)),
              alloc);
          ...
          BOOST_FWD_REF(Key) k, BOOST_UNORDERED_EMPLACE_ARGS)
        {
          ...
          node_tmp b(
            zr_boost_1_81::unordered::detail::func::construct_node_pair_from_args(
          ...
          BOOST_FWD_REF(Key) k, BOOST_FWD_REF(M) obj)
        {
          ...
          node_pointer p = this->find_node_impl(k, itb);
          if (p) {
            p->value().second = zr_boost_1_81::forward<M>(obj);
            return emplace_return(iterator(p, itb), false);
          }

          node_tmp b(zr_boost_1_81::unordered::detail::func::construct_node_pair(
                       this->node_alloc(), zr_boost_1_81::forward<Key>(k),
                       zr_boost_1_81::forward<M>(obj)),
            node_alloc());
          ...
          NodeType& np, InsertReturnType& result)
        {
          ...
          if (p) {
            iterator pos(p, itb);
            result.node = zr_boost_1_81::move(np);
            result.position = pos;
            result.inserted = false;
            return;
          }
        ...
        void merge_unique(zr_boost_1_81::unordered::detail::table<Types2>& other)
        {
          typedef zr_boost_1_81::unordered::detail::table<Types2> other_table;
          BOOST_STATIC_ASSERT((zr_boost_1_81::is_same<node_type,
        ...
        iterator erase_node(c_iterator pos) {
          ...
          bucket_iterator itb = pos.itb;
          node_pointer* pp = zr_boost_1_81::addressof(itb->next);
          while (*pp != pos.p) {
            pp = zr_boost_1_81::addressof((*pp)->next);
          }
          ...
          while (*pp != last.p) {
            ...
            *pp = (*pp)->next;
            ...
            if (at_end) {
              ...
              pp = zr_boost_1_81::addressof(itb->next);
            }
          }
        ...
        void move_assign_buckets(table& src, true_type)
        {
          ...
          for (iterator pos = src.begin(); pos != last; ++pos) {
            value_type value = zr_boost_1_81::move(*pos);
            const_key_type& key = extractor::extract(value);
            std::size_t const key_hash = this->hash(key);
            ...
            node_tmp tmp(
              detail::func::construct_node(alloc, zr_boost_1_81::move(value)), alloc);
        ...
        // safety. Strong otherwise
        template <class I>
        typename zr_boost_1_81::unordered::detail::enable_if_forward<I, void>::type
        insert_range_equiv(I i, I j)
        {
          ...
          if (distance == 1) {
            emplace_equiv(zr_boost_1_81::unordered::detail::func::construct_node(
              this->node_alloc(), *i));
          } else {
            ...
            for (; i != j; ++i) {
              emplace_no_rehash_equiv(
                zr_boost_1_81::unordered::detail::func::construct_node(
                  this->node_alloc(), *i));
            }
          }
        }
        ...
        template <class I>
        typename zr_boost_1_81::unordered::detail::disable_if_forward<I, void>::type
        insert_range_equiv(I i, I j)
        {
          for (; i != j; ++i) {
            emplace_equiv(zr_boost_1_81::unordered::detail::func::construct_node(
      ...
      inline void table<Types>::rehash_impl(std::size_t num_buckets)
      {
        ...
        BOOST_TRY
        {
          zr_boost_1_81::unordered::detail::span<bucket_type> bspan = buckets_.raw();
...
#pragma warning(pop)
      ...
      template <typename Key, typename T> struct is_key
      {
        ...
        enum
        {
          value = sizeof(test(zr_boost_1_81::unordered::detail::make<T>())) ==
                  sizeof(choice2::type)
        };

        typedef
          typename zr_boost_1_81::conditional<value, Key const&, no_key>::type type;
      };
      ...
      {
        typedef ValueType value_type;
        typedef typename zr_boost_1_81::remove_const<typename zr_boost_1_81::unordered::detail::
        ...
        template <class Second>
        static key_type const& extract(
          zr_boost_1_81::rv<std::pair<key_type, Second> > const& v)
        {
          return v.first;
        }
        ...
        template <class Second>
        static key_type const& extract(
          zr_boost_1_81::rv<std::pair<key_type const, Second> > const& v)
        {
          return v.first;
        }
#endif
...
#define BOOST_UNORDERED_KEY_FROM_TUPLE(namespace_)                             \
  ...
  static no_key extract(zr_boost_1_81::unordered::piecewise_construct_t,               \
  ...
  static typename is_key<key_type, T>::type extract(                           \
    zr_boost_1_81::unordered::piecewise_construct_t, namespace_ tuple<T> const& k,     \
    T2 const&)                                                                 \
  {                                                                            \
...
#define BOOST_UNORDERED_KEY_FROM_TUPLE(namespace_)                             \
  static no_key extract(                                                       \
    zr_boost_1_81::unordered::piecewise_construct_t, namespace_ tuple<> const&)        \
  {                                                                            \
    return no_key();                                                           \
  }                                                                            \
                                                                               \
  ...
  {                                                                            \
    return typename is_key<key_type, T>::type(namespace_ get<0>(k));           \
        ...
        BOOST_UNORDERED_KEY_FROM_TUPLE(zr_boost_1_81::)
