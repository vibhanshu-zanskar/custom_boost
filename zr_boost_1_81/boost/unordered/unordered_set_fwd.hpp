...
namespace zr_boost_1_81 {
  namespace unordered {
    template <class T, class H = zr_boost_1_81::hash<T>, class P = std::equal_to<T>,
  ...
  using zr_boost_1_81::unordered::unordered_set;
  using zr_boost_1_81::unordered::unordered_multiset;
