...
int maybe_get_table(const T& arg, const Table*& table, zr_boost_1_81::mpl::true_)
{
    if(table == 0) {
...
template<class T, class Table>
int maybe_get_table(const T&, const Table*&, zr_boost_1_81::mpl::false_) { return 0; }

template<class T>
::zr_boost_1_81::type_erasure::detail::storage& convert_arg(any_base<T>& arg, zr_boost_1_81::mpl::true_)
{
    return ::zr_boost_1_81::type_erasure::detail::access::data(arg);
}

template<class Concept, class T>
const ::zr_boost_1_81::type_erasure::detail::storage&
convert_arg(any_base<any<Concept, const T&> >& arg, zr_boost_1_81::mpl::true_)
{
    return ::zr_boost_1_81::type_erasure::detail::access::data(arg);
}
...
template<class T>
const ::zr_boost_1_81::type_erasure::detail::storage&
convert_arg(const any_base<T>& arg, zr_boost_1_81::mpl::true_)
{
    return ::zr_boost_1_81::type_erasure::detail::access::data(arg);
}

template<class Concept, class T>
::zr_boost_1_81::type_erasure::detail::storage&
convert_arg(const any_base<any<Concept, T&> >& arg, zr_boost_1_81::mpl::true_)
{
    return ::zr_boost_1_81::type_erasure::detail::access::data(arg);
}
...
template<class Concept, class T>
const ::zr_boost_1_81::type_erasure::detail::storage&
convert_arg(const any_base<any<Concept, const T&> >& arg, zr_boost_1_81::mpl::true_)
{
    return ::zr_boost_1_81::type_erasure::detail::access::data(arg);
}
...
template<class Concept, class T>
::zr_boost_1_81::type_erasure::detail::storage&
convert_arg(param<Concept, T>& arg, zr_boost_1_81::mpl::true_)
{
    return ::zr_boost_1_81::type_erasure::detail::access::data(arg);
}
...
template<class Concept, class T>
const ::zr_boost_1_81::type_erasure::detail::storage&
convert_arg(param<Concept, const T&>& arg, zr_boost_1_81::mpl::true_)
{
    return ::zr_boost_1_81::type_erasure::detail::access::data(arg);
}
...
template<class Concept, class T>
const ::zr_boost_1_81::type_erasure::detail::storage&
convert_arg(const param<Concept, T>& arg, zr_boost_1_81::mpl::true_)
{
    return ::zr_boost_1_81::type_erasure::detail::access::data(arg);
}
...
template<class Concept, class T>
::zr_boost_1_81::type_erasure::detail::storage&
convert_arg(any_base<any<Concept, T&> >&& arg, zr_boost_1_81::mpl::true_)
{
    return ::zr_boost_1_81::type_erasure::detail::access::data(arg);
}
...
convert_arg(any_base<any<Concept, T> >&& arg, zr_boost_1_81::mpl::true_)
{
    return ::zr_boost_1_81::type_erasure::detail::access::data(std::move(arg));
}
...
template<class T>
T&& convert_arg(T&& arg, zr_boost_1_81::mpl::false_) { return std::forward<T>(arg); }

#else

template<class T>
T& convert_arg(T& arg, zr_boost_1_81::mpl::false_) { return arg; }
...
typename ::zr_boost_1_81::type_erasure::detail::call_impl<Sig, U..., Concept>::type
...
typename ::zr_boost_1_81::type_erasure::detail::call_impl<Sig, U...>::type
...
template<class Sig, class Args, class Concept = void,
    bool Check = ::zr_boost_1_81::type_erasure::detail::check_call<Sig, Args>::type::value>
struct call_impl {};
...
struct call_result<
    ::zr_boost_1_81::type_erasure::binding<C1>,
    Args,
    Concept
>
{};
...
const ::zr_boost_1_81::type_erasure::binding<
    typename ::zr_boost_1_81::type_erasure::detail::extract_concept<void(T...), U...>::type>*
extract_table(R(*)(T...), const U&... arg)
{
    ...
    ignore(::zr_boost_1_81::type_erasure::detail::maybe_get_table(
        arg,
        result,
        ::zr_boost_1_81::type_erasure::detail::is_placeholder_arg<T>())...);
...
template<class R, class... T, class... U>
const ::zr_boost_1_81::type_erasure::binding<
    ::zr_boost_1_81::type_erasure::detail::extract_concept_t< ::zr_boost_1_81::mp11::mp_list<T...>, ::zr_boost_1_81::mp11::mp_list<U...> > >*
extract_table(R(*)(T...), const U&... arg)
{
    const ::zr_boost_1_81::type_erasure::binding<
        ::zr_boost_1_81::type_erasure::detail::extract_concept_t<
            ::zr_boost_1_81::mp11::mp_list<T...>, ::zr_boost_1_81::mp11::mp_list<U...> > >* result = 0;
...
struct call_impl_dispatch<R(T...), void(U...), Concept, false>
{
    typedef R type;
    template<class F>
    static R apply(const ::zr_boost_1_81::type_erasure::binding<Concept>* table, U... arg)
    {
        return table->template find<F>()(
            ::zr_boost_1_81::type_erasure::detail::convert_arg(
                ::std::forward<U>(arg),
                ::zr_boost_1_81::type_erasure::detail::is_placeholder_arg<T>())...);
    }
};
...
{
    typedef ::zr_boost_1_81::type_erasure::any<Concept, R> type;
    template<class F>
    static type apply(const ::zr_boost_1_81::type_erasure::binding<Concept>* table, U... arg)
    {
        return type(table->template find<F>()(
            ::zr_boost_1_81::type_erasure::detail::convert_arg(
                ::std::forward<U>(arg),
                ::zr_boost_1_81::type_erasure::detail::is_placeholder_arg<T>())...), *table);
    }
};

template<class R, class... T, class... U, class Concept>
struct call_impl<R(T...), void(U...), Concept, true> :
    ::zr_boost_1_81::type_erasure::detail::call_impl_dispatch<
        R(T...),
        void(U...),
        Concept,
        ::zr_boost_1_81::type_erasure::detail::is_placeholder_arg<R>::value
    >
{
};
...
struct call_impl<R(T...), void(U...), void, true> :
    ::zr_boost_1_81::type_erasure::detail::call_impl_dispatch<
        ...
        typename ::zr_boost_1_81::type_erasure::detail::extract_concept<
            void(T...),
            typename ::zr_boost_1_81::remove_reference<U>::type...
        >::type,
        ::zr_boost_1_81::type_erasure::detail::is_placeholder_arg<R>::value
    >
{
...
template<
    ...
    class... U
>
typename ::zr_boost_1_81::type_erasure::detail::call_result<
    Op,
    void(U&&...),
    Concept
>::type
unchecked_call(
    ...
    U&&... arg)
{
    return ::zr_boost_1_81::type_erasure::detail::call_impl<
        typename ::zr_boost_1_81::type_erasure::detail::get_signature<Op>::type,
        void(U&&...),
        Concept
    >::template apply<
        typename ::zr_boost_1_81::type_erasure::detail::adapt_to_vtable<Op>::type
...
call(
    ...
    U&&... arg)
{
    ::zr_boost_1_81::type_erasure::require_match(table, f, std::forward<U>(arg)...);
    return ::zr_boost_1_81::type_erasure::unchecked_call(table, f, std::forward<U>(arg)...);
}
    ...
    U&&... arg)
{
    ...
    >::template apply<
        typename ::zr_boost_1_81::type_erasure::detail::adapt_to_vtable<Op>::type
    >(::zr_boost_1_81::type_erasure::detail::extract_table(
        static_cast<typename ::zr_boost_1_81::type_erasure::detail::get_signature<Op>::type*>(0), arg...),
        std::forward<U>(arg)...);
}
...
call(
    ...
    U&&... arg)
{
    ::zr_boost_1_81::type_erasure::require_match(f, std::forward<U>(arg)...);
    return ::zr_boost_1_81::type_erasure::unchecked_call(f, std::forward<U>(arg)...);
}
...
#define BOOST_TYPE_ERASURE_CONVERT_ARG(z, n, data)                      \
    ::zr_boost_1_81::type_erasure::detail::convert_arg(                         \
        ...
        ::zr_boost_1_81::type_erasure::detail::is_placeholder_arg<BOOST_PP_CAT(T, n)>())
...
#define BOOST_TYPE_ERASURE_GET_TABLE(z, n, data)                        \
    ::zr_boost_1_81::type_erasure::detail::maybe_get_table(                     \
        BOOST_PP_CAT(arg, n),                                           \
        result,                                                         \
        ::zr_boost_1_81::type_erasure::detail::is_placeholder_arg<BOOST_PP_CAT(T, n)>());
...
const ::zr_boost_1_81::type_erasure::binding<
    typename ::zr_boost_1_81::type_erasure::detail::BOOST_PP_CAT(extract_concept, N)<
...
#endif
    ,
    bool ReturnsAny = ::zr_boost_1_81::type_erasure::detail::is_placeholder_arg<R>::value>
...
>
{
    typedef R type;
    template<class F>
    static R apply(const ::zr_boost_1_81::type_erasure::binding<Concept>* table
...
>
{
    typedef ::zr_boost_1_81::type_erasure::any<Concept, R> type;
    template<class F>
    static type apply(const ::zr_boost_1_81::type_erasure::binding<Concept>* table
        BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, U, arg))
    {
        return type(table->template find<F>()(
...
call(
    ...
    BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, U, RREF arg))
{
    ::zr_boost_1_81::type_erasure::require_match(table, f BOOST_TYPE_ERASURE_FORWARD_ARGS(N, U, arg));
    return ::zr_boost_1_81::type_erasure::unchecked_call(table, f BOOST_TYPE_ERASURE_FORWARD_ARGS(N, U, arg));
}
    ...
    BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, U, RREF arg))
{
    ...
    >::template apply<
        typename ::zr_boost_1_81::type_erasure::detail::adapt_to_vtable<Op>::type
    >(
        ::zr_boost_1_81::type_erasure::detail::BOOST_PP_CAT(extract_table, N)(
...
call(
    ...
    BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, U, RREF arg))
{
    ::zr_boost_1_81::type_erasure::require_match(f BOOST_TYPE_ERASURE_FORWARD_ARGS(N, U, arg));
    return ::zr_boost_1_81::type_erasure::unchecked_call(f BOOST_TYPE_ERASURE_FORWARD_ARGS(N, U, arg));
}
