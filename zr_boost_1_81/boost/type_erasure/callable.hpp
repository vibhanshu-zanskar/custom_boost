 ...
 * support @c zr_boost_1_81::result_of.
 */
template<class Sig, class F = _self>
struct callable
{
  ...
  : Base
{
    template<class Sig>
    struct result :
        ::zr_boost_1_81::type_erasure::detail::result_of_callable<Sig>
    {};
    typedef void _boost_type_erasure_is_callable;
    typedef ::zr_boost_1_81::mpl::vector<R> _boost_type_erasure_callable_results;
    typedef char (&_boost_type_erasure_callable_size)[1];
    _boost_type_erasure_callable_size
    _boost_type_erasure_deduce_callable(
        typename ::zr_boost_1_81::type_erasure::as_param<Base, T>::type...);
    typename ::zr_boost_1_81::type_erasure::rebind_any<Base, R>::type
    operator()(typename ::zr_boost_1_81::type_erasure::as_param<Base, T>::type... arg)
    {
        return ::zr_boost_1_81::type_erasure::call(callable<R(T...), F>(), *this,
            ::std::forward<typename ::zr_boost_1_81::type_erasure::as_param<Base, T>::type>(arg)...);
    }
};
  ...
  : Base
{
    ...
    _boost_type_erasure_callable_size
    _boost_type_erasure_deduce_callable(
        typename ::zr_boost_1_81::type_erasure::as_param<Base, T>::type...) const;
    typename ::zr_boost_1_81::type_erasure::rebind_any<Base, R>::type operator()(
        typename ::zr_boost_1_81::type_erasure::as_param<Base, T>::type... arg) const
    {
        return ::zr_boost_1_81::type_erasure::call(callable<R(T...), const F>(), *this,
            ::std::forward<typename ::zr_boost_1_81::type_erasure::as_param<Base, T>::type>(arg)...);
    }
};
  ...
  : Base
{
    ...
    typedef char (&_boost_type_erasure_callable_size)[
        ::zr_boost_1_81::mpl::size<_boost_type_erasure_callable_results>::value];
  ...
  : Base
{
    ...
    using Base::operator();
    typename ::zr_boost_1_81::type_erasure::rebind_any<Base, R>::type
    operator()(typename ::zr_boost_1_81::type_erasure::as_param<Base, T>::type... arg) const
    {
        return ::zr_boost_1_81::type_erasure::call(callable<R(T...), const F>(), *this,
            ::std::forward<typename ::zr_boost_1_81::type_erasure::as_param<Base, T>::type>(arg)...);
    }
...
{
    typedef typename ::zr_boost_1_81::mpl::at_c<
        typename This::_boost_type_erasure_callable_results,
        sizeof(::zr_boost_1_81::declval<This>().
            _boost_type_erasure_deduce_callable(::zr_boost_1_81::declval<T>()...)) - 1
    >::type type;
};
...
#define BOOST_TYPE_ERASURE_DECLVAL(z, n, data) ::zr_boost_1_81::declval<BOOST_PP_CAT(T, n)>()

#define BOOST_TYPE_ERASURE_REBIND(z, n, data)\
    typename ::zr_boost_1_81::type_erasure::as_param<Base, BOOST_PP_CAT(T, n)>::type BOOST_PP_CAT(arg, n)
...
#define BOOST_TYPE_ERASURE_FORWARD_REBIND(z, n, data) ::std::forward<typename ::zr_boost_1_81::type_erasure::as_param<Base, BOOST_PP_CAT(T, n)>::type>(BOOST_PP_CAT(arg, n))
#endif
  ...
  : Base
{
    ...
    {
        return ::zr_boost_1_81::type_erasure::call(
            callable<R(BOOST_PP_ENUM_PARAMS(N, T)), F>(),
