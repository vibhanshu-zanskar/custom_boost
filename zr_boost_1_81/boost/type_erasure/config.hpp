...
/** The maximum number of functions that an @ref zr_boost_1_81::type_erasure::any "any" can have. */
...
/** The maximum number of elements in a @ref zr_boost_1_81::type_erasure::tuple "tuple". */
