...
struct concept_interface<
    ::zr_boost_1_81::type_erasure::constructible<Tag(T...)>,
    Base,
    Tag
> : Base
{
...
#define BOOST_TYPE_ERASURE_ARG_DECL(z, n, data)     \
    typename ::zr_boost_1_81::type_erasure::as_param<          \
        Base,                                       \
        BOOST_PP_CAT(T, n)                          \
    >::type
...
struct concept_interface<
    ::zr_boost_1_81::type_erasure::constructible<Tag(BOOST_PP_ENUM_PARAMS(N, T))>,
    Base,
    Tag
> : Base
{
