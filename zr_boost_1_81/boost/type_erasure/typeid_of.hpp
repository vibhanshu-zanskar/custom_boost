...
{
    return ::zr_boost_1_81::type_erasure::detail::access::table(arg).template find<
        ::zr_boost_1_81::type_erasure::typeid_<
...
{
    return binding_arg.template find< ::zr_boost_1_81::type_erasure::typeid_<T> >()();
}
