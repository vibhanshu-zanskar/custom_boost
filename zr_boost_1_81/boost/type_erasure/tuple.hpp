...
struct make_map<T0, T...>
{
    typedef typename ::zr_boost_1_81::mpl::insert<
        typename ::zr_boost_1_81::type_erasure::detail::make_map<T...>::type,
        T0
    >::type type;
};
...
struct make_map<>
{
    typedef ::zr_boost_1_81::mpl::map0<> type;
};
...
class tuple_iterator :
    public ::zr_boost_1_81::fusion::iterator_facade<
        tuple_iterator<Tuple, N>,
        ::zr_boost_1_81::fusion::random_access_traversal_tag
    >
{
public:
    typedef ::zr_boost_1_81::mpl::int_<N> index;
    ...
    template<class It>
    struct next : advance<It, ::zr_boost_1_81::mpl::int_<1> > {};
    template<class It>
    struct prior : advance<It, ::zr_boost_1_81::mpl::int_<-1> > {};
    template<class It1, class It2>
    struct distance
    {
        typedef typename ::zr_boost_1_81::mpl::minus<
            typename It2::index,
            typename It1::index
        >::type type;
...
template<class Concept, class... T>
class tuple :
    public ::zr_boost_1_81::fusion::sequence_facade<
        ::zr_boost_1_81::type_erasure::tuple<Concept, T...>,
        ::zr_boost_1_81::fusion::forward_traversal_tag
    >
{
public:
    template<class... U>
    explicit tuple(U&&... args)
      : impl(
            ::zr_boost_1_81::type_erasure::make_binding<
                typename ::zr_boost_1_81::type_erasure::detail::make_map<
    ...
    struct begin
    {
        typedef ::zr_boost_1_81::type_erasure::tuple_iterator<
            Seq,
            0
        > type;
    ...
    struct size
    {
        typedef ::zr_boost_1_81::mpl::int_<sizeof...(T)> type;
        static type call(Seq& seq) { return type(); }
    };
    template<class Seq>
    struct empty
    {
        typedef ::zr_boost_1_81::mpl::bool_<sizeof...(T) == 0> type;
        static type call(Seq& seq) { return type(); }
    };
    template<class Seq, class N>
    struct at
    {
        typedef typename ::zr_boost_1_81::type_erasure::detail::cons_advance<
            N::value,
            ::zr_boost_1_81::type_erasure::cons<Concept, T...>
        >::type::value_type value_type;
        typedef typename ::zr_boost_1_81::mpl::if_< ::zr_boost_1_81::is_const<Seq>,
            const value_type&,
            value_type&
        >::type type;
        static type call(Seq& seq)
        {
            return const_cast<type>(
                ::zr_boost_1_81::type_erasure::detail::cons_advance<
                    N::value,
                    ::zr_boost_1_81::type_erasure::cons<Concept, T...>
                >::call(seq.impl).value
            );
    ...
    ::zr_boost_1_81::type_erasure::cons<Concept, T...> impl;
};

template<int N, class Concept, class... T>
typename ::zr_boost_1_81::type_erasure::detail::cons_advance<
    N,
    ::zr_boost_1_81::type_erasure::cons<Concept, T...>
>::type::value_type& get(::zr_boost_1_81::type_erasure::tuple<Concept, T...>& t)
{
    return const_cast<
        typename ::zr_boost_1_81::type_erasure::detail::cons_advance<
            N,
        ...
        >::type::value_type&
    >(
        ::zr_boost_1_81::type_erasure::detail::cons_advance<N,
            ::zr_boost_1_81::type_erasure::cons<Concept, T...>
        >::call(t.impl).value
    );
}
...
template<int N, class Concept, class... T>
const typename ::zr_boost_1_81::type_erasure::detail::cons_advance<
    N,
    ::zr_boost_1_81::type_erasure::cons<Concept, T...>
>::type::value_type& get(const ::zr_boost_1_81::type_erasure::tuple<Concept, T...>& t)
{
    return ::zr_boost_1_81::type_erasure::detail::cons_advance<
        N,
        ::zr_boost_1_81::type_erasure::cons<Concept, T...>
    >::call(t.impl).value;
}
...
template<class Concept,
    BOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(
        BOOST_TYPE_ERASURE_MAX_TUPLE_SIZE, class T, ::zr_boost_1_81::type_erasure::na)>
...
public:
    ...
    struct value_of
    {
        typedef typename ::zr_boost_1_81::type_erasure::detail::get_impl<
            It::index::value,
            Tuple
        >::value_type type;
    };
    template<class It>
    struct deref :
        ::zr_boost_1_81::type_erasure::detail::get_impl<It::index::value, Tuple>
    {
        typedef typename ::zr_boost_1_81::type_erasure::detail::get_impl<
            It::index::value,
            Tuple
        ...
        static type call(It it)
        {
            return ::zr_boost_1_81::type_erasure::detail::get_impl<
                It::index::value,
                Tuple
            >::call(*it.t);
        }
...
struct tuple_base :
    ::zr_boost_1_81::fusion::sequence_facade<
        Derived,
        ::zr_boost_1_81::fusion::random_access_traversal_tag
    >
{
    ...
    struct begin
    {
        typedef ::zr_boost_1_81::type_erasure::tuple_iterator<Seq, 0> type;
        static type call(Seq& seq) { return type(seq); }
    };
    template<class Seq>
    struct end
    ...
    struct empty
    {
        typedef typename zr_boost_1_81::mpl::equal_to<
    ...
    template<class Seq, class N>
    struct at : ::zr_boost_1_81::type_erasure::detail::get_impl<N::value, Seq> {};
    template<class Seq, class N>
    struct value_at
    {
        typedef typename ::zr_boost_1_81::type_erasure::detail::get_impl<
...
#define BOOST_TYPE_ERASURE_TAG_TYPEDEF(z, n, data)                          \
    ...
    typedef typename ::zr_boost_1_81::remove_reference<BOOST_PP_CAT(T, n)>::type    \
        BOOST_PP_CAT(tag, n);

#define BOOST_TYPE_ERASURE_PAIR(z, n, data) \
    ::zr_boost_1_81::mpl::pair<BOOST_PP_CAT(tag, n), BOOST_PP_CAT(U, n)>
...
#define BOOST_TYPE_ERASURE_TUPLE_MEMBER(z, n, data)\
    ::zr_boost_1_81::type_erasure::any<Concept, BOOST_PP_CAT(T, n)> BOOST_PP_CAT(t, n);
...
public:
    typedef ::zr_boost_1_81::mpl::int_<N> tuple_size;
#if N
...
private:
    ...
    friend struct ::zr_boost_1_81::type_erasure::detail::get_impl;
    ::zr_boost_1_81::type_erasure::detail::tuple_storage<
        Concept
