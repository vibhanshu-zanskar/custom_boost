...
#else
    typedef typename ::zr_boost_1_81::type_erasure::placeholder_of<
...
/** INTERNAL ONLY */
template<class Concept, class T>
struct placeholder_of< ::zr_boost_1_81::type_erasure::any<Concept, T> >
{
    typedef T type;
};
...
/** INTERNAL ONLY */
template<class Concept, class T>
struct placeholder_of< ::zr_boost_1_81::type_erasure::param<Concept, T> >
{
    typedef T type;
};
...
template<class T>
using placeholder_of_t = typename ::zr_boost_1_81::type_erasure::placeholder_of<T>::type;
