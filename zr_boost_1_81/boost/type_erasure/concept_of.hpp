...
#else
    typedef typename ::zr_boost_1_81::type_erasure::concept_of<
...
/** INTERNAL ONLY */
template<class Concept, class T>
struct concept_of< ::zr_boost_1_81::type_erasure::any<Concept, T> >
{
...
/** INTERNAL ONLY */
template<class Concept, class T>
struct concept_of< ::zr_boost_1_81::type_erasure::param<Concept, T> >
{
    typedef Concept type;
};
...
template<class T>
using concept_of_t = typename ::zr_boost_1_81::type_erasure::concept_of<T>::type;
