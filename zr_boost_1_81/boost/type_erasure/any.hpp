...
{
    typedef ::zr_boost_1_81::type_erasure::concept_interface<Concept, Base, ID> type;
};
...
{
    template<class Concept, class Base, class ID>
    using apply = ::zr_boost_1_81::type_erasure::concept_interface<Concept, Base, ID>;
};
...
struct choose_concept_interface
{
    typedef decltype(boost_type_erasure_find_interface(::zr_boost_1_81::declval<Concept>())) finder;
...
struct compute_bases
{
    typedef typename ::zr_boost_1_81::mpl::reverse_fold<
        typename ::zr_boost_1_81::type_erasure::detail::collect_concepts<
            Concept
        >::type,
        ::zr_boost_1_81::type_erasure::any_base<Derived>,
        ::zr_boost_1_81::type_erasure::detail::choose_concept_interface<
...
struct compute_bases_f
{
    ...
    using apply = typename ::zr_boost_1_81::type_erasure::detail::choose_concept_interface<Concept, Base, ID>::type;
};

template<class Derived, class Concept, class T>
using compute_bases_t =
    ::zr_boost_1_81::mp11::mp_reverse_fold<
        typename ::zr_boost_1_81::type_erasure::detail::collect_concepts_t<
            Concept
        >,
        ::zr_boost_1_81::type_erasure::any_base<Derived>,
        ::zr_boost_1_81::type_erasure::detail::compute_bases_f<T>::template apply
    >;

template<class Derived, class Concept, class T>
using compute_bases = ::zr_boost_1_81::mpl::identity< ::zr_boost_1_81::type_erasure::detail::compute_bases_t<Derived, Concept, T> >;
...
template<class T>
fallback make_fallback(T&&, zr_boost_1_81::mpl::false_)
{
    return fallback();
}

template<class T>
T&& make_fallback(T&& arg, zr_boost_1_81::mpl::true_)
{
...
template<class T>
fallback make_fallback(const T&, zr_boost_1_81::mpl::false_)
{
    return fallback();
}

template<class T>
const T& make_fallback(const T& arg, zr_boost_1_81::mpl::true_)
{
    return arg;
}
...
template<class T>
struct is_any : ::zr_boost_1_81::mpl::false_ {};

template<class Concept, class T>
struct is_any<any<Concept, T> > : ::zr_boost_1_81::mpl::true_ {};
...
struct has_constructor :
    ::zr_boost_1_81::mpl::bool_<
        sizeof(
            ::zr_boost_1_81::type_erasure::detail::check_overload(
                ::zr_boost_1_81::declval<Any&>().
                    _boost_type_erasure_deduce_constructor(::zr_boost_1_81::declval<U>()...)
            )
        ) == sizeof(::zr_boost_1_81::type_erasure::detail::yes)
    >
{};

template<class Any>
using has_copy_constructor =
    ::zr_boost_1_81::type_erasure::is_subconcept<
        ::zr_boost_1_81::type_erasure::constructible<
            typename ::zr_boost_1_81::type_erasure::placeholder_of<Any>::type(typename ::zr_boost_1_81::type_erasure::placeholder_of<Any>::type const&)
        >,
        typename ::zr_boost_1_81::type_erasure::concept_of<Any>::type
    >;
...
using has_move_constructor =
    ::zr_boost_1_81::type_erasure::is_subconcept<
        ::zr_boost_1_81::type_erasure::constructible<
            typename ::zr_boost_1_81::type_erasure::placeholder_of<Any>::type(typename ::zr_boost_1_81::type_erasure::placeholder_of<Any>::type &&)
        >,
        typename ::zr_boost_1_81::type_erasure::concept_of<Any>::type
    >;
...
template<class T>
struct is_binding_arg : ::zr_boost_1_81::mpl::false_ {};
template<class T>
struct is_binding_arg<binding<T> > : ::zr_boost_1_81::mpl::true_ {};
template<class T>
struct is_binding_arg<binding<T>&&> : ::zr_boost_1_81::mpl::true_ {};
template<class T>
struct is_binding_arg<binding<T>&> : ::zr_boost_1_81::mpl::true_ {};
template<class T>
struct is_binding_arg<binding<T> const&> : ::zr_boost_1_81::mpl::true_ {};

template<class T>
struct is_static_binding_arg : ::zr_boost_1_81::mpl::false_ {};
template<class T>
struct is_static_binding_arg<static_binding<T> > : ::zr_boost_1_81::mpl::true_ {};
template<class T>
struct is_static_binding_arg<static_binding<T>&&> : ::zr_boost_1_81::mpl::true_ {};
template<class T>
struct is_static_binding_arg<static_binding<T>&> : ::zr_boost_1_81::mpl::true_ {};
template<class T>
struct is_static_binding_arg<static_binding<T> const&> : ::zr_boost_1_81::mpl::true_ {};

template<class T>
struct is_any_arg : ::zr_boost_1_81::mpl::false_ {};
template<class Concept, class T>
struct is_any_arg<any<Concept, T> > : ::zr_boost_1_81::mpl::true_ {};
template<class Concept, class T>
struct is_any_arg<any<Concept, T>&&> : ::zr_boost_1_81::mpl::true_ {};
template<class Concept, class T>
struct is_any_arg<any<Concept, T>&> : ::zr_boost_1_81::mpl::true_ {};
template<class Concept, class T>
struct is_any_arg<any<Concept, T> const&> : ::zr_boost_1_81::mpl::true_ {};
...
template<class T>
using safe_placeholder_t = ::zr_boost_1_81::remove_cv_t< ::zr_boost_1_81::remove_reference_t<typename safe_placeholder_of<T>::type> >;
...
struct any_constructor_control<
    ...
    typename zr_boost_1_81::enable_if_c<
        !::zr_boost_1_81::type_erasure::detail::has_copy_constructor<Base>::value &&
        ::zr_boost_1_81::type_erasure::detail::has_move_constructor<Base>::value &&
        ::zr_boost_1_81::type_erasure::detail::has_mutable_copy_constructor<Base>::value
    >::type
> : Base
{
    using Base::Base;
...
struct any_constructor_impl :
    ::zr_boost_1_81::type_erasure::detail::compute_bases<
        ::zr_boost_1_81::type_erasure::any<Concept, T>,
        Concept,
        T
    >::type
{
    typedef typename ::zr_boost_1_81::type_erasure::detail::compute_bases<
        ::zr_boost_1_81::type_erasure::any<Concept, T>,
        Concept,
        T
    >::type _boost_type_erasure_base;
    // Internal constructors
    typedef ::zr_boost_1_81::type_erasure::binding<Concept> _boost_type_erasure_table_type;
    any_constructor_impl(const ::zr_boost_1_81::type_erasure::detail::storage& data_arg, const _boost_type_erasure_table_type& table_arg)
      : _boost_type_erasure_table(table_arg),
        _boost_type_erasure_data(data_arg)
    {}
    any_constructor_impl(::zr_boost_1_81::type_erasure::detail::storage&& data_arg, const _boost_type_erasure_table_type& table_arg)
      : _boost_type_erasure_table(table_arg),
        _boost_type_erasure_data(data_arg)
    {}
    // default constructor
    ...
    {
        BOOST_MPL_ASSERT((::zr_boost_1_81::type_erasure::is_relaxed<Concept>));
        _boost_type_erasure_data.data = 0;
    }
    // capturing constructor
    template<class U,
        typename ::zr_boost_1_81::enable_if_c<
            !::zr_boost_1_81::type_erasure::detail::is_any_arg<U>::value &&
            !::zr_boost_1_81::type_erasure::detail::is_binding_arg<U>::value &&
            !::zr_boost_1_81::type_erasure::detail::is_static_binding_arg<U>::value
        >::type* = nullptr
    >
    any_constructor_impl(U&& data_arg)
      : _boost_type_erasure_table((
            BOOST_TYPE_ERASURE_INSTANTIATE1(Concept, T, ::zr_boost_1_81::decay_t<U>),
            ::zr_boost_1_81::type_erasure::make_binding<
                ::zr_boost_1_81::mpl::map1< ::zr_boost_1_81::mpl::pair<T, ::zr_boost_1_81::decay_t<U> > >
            >()
        )),
    ...
    any_constructor_impl(U&& data_arg, const static_binding<Map>& b)
      : _boost_type_erasure_table((
        ...
        _boost_type_erasure_data(std::forward<U>(data_arg))
    {
        BOOST_MPL_ASSERT((::zr_boost_1_81::is_same<
            typename ::zr_boost_1_81::mpl::at<Map, T>::type, ::zr_boost_1_81::decay_t<U> >));
    }
    // converting constructor
    template<class U,
        typename ::zr_boost_1_81::enable_if_c<
            ::zr_boost_1_81::type_erasure::is_subconcept<
                Concept, typename ::zr_boost_1_81::type_erasure::detail::safe_concept_of<U>::type,
                typename ::zr_boost_1_81::mpl::if_c< ::zr_boost_1_81::is_same<T, ::zr_boost_1_81::type_erasure::detail::safe_placeholder_t<U> >::value,
                    void,
                    ::zr_boost_1_81::mpl::map1<
                        ::zr_boost_1_81::mpl::pair<T, ::zr_boost_1_81::type_erasure::detail::safe_placeholder_t<U> >
                    >
                >::type
            >::value
        >::type* = nullptr
    ...
    any_constructor_impl(U&& other)
      : _boost_type_erasure_table(
            ::zr_boost_1_81::type_erasure::detail::access::table(other),
            typename ::zr_boost_1_81::mpl::if_c< ::zr_boost_1_81::is_same<T, ::zr_boost_1_81::type_erasure::detail::safe_placeholder_t<U> >::value,
#ifndef BOOST_TYPE_ERASURE_USE_MP11
                ::zr_boost_1_81::type_erasure::detail::substitution_map< ::zr_boost_1_81::mpl::map0<> >,
#else
                ::zr_boost_1_81::type_erasure::detail::make_identity_placeholder_map<Concept>,
#endif
                ::zr_boost_1_81::mpl::map1<
                    ::zr_boost_1_81::mpl::pair<
                        T,
                        ::zr_boost_1_81::type_erasure::detail::safe_placeholder_t<U>
                    >
                >
            >::type()
        ),
        _boost_type_erasure_data(::zr_boost_1_81::type_erasure::call(
            ::zr_boost_1_81::type_erasure::detail::make(
    ...
    any_constructor_impl(U&& other, const static_binding<Map>& binding_arg)
      : _boost_type_erasure_table(::zr_boost_1_81::type_erasure::detail::access::table(other), binding_arg),
        _boost_type_erasure_data(::zr_boost_1_81::type_erasure::call(
            ::zr_boost_1_81::type_erasure::detail::make(
                false? other._boost_type_erasure_deduce_constructor(std::forward<U>(other)) : 0
            ), std::forward<U>(other))
    ...
    const _boost_type_erasure_table_type& _boost_type_erasure_extract_table(
        ::zr_boost_1_81::type_erasure::constructible<R(A...)>*,
        U&&... u)
    {
        return *::zr_boost_1_81::type_erasure::detail::extract_table(static_cast<void(*)(A...)>(0), u...);
    }
    // forwarding constructor
    template<class... U,
        typename ::zr_boost_1_81::enable_if_c<
            ::zr_boost_1_81::type_erasure::detail::has_constructor<any_constructor_impl, U...>::value
        >::type* = nullptr
    >
    explicit any_constructor_impl(U&&... u)
      : _boost_type_erasure_table(
        ...
        _boost_type_erasure_data(
            ::zr_boost_1_81::type_erasure::call(
                ::zr_boost_1_81::type_erasure::detail::make(
                    false? this->_boost_type_erasure_deduce_constructor(std::forward<U>(u)...) : 0
                ),
                std::forward<U>(u)...
    ...
    ~any_constructor_impl()
    {
        _boost_type_erasure_table.template find<
            ::zr_boost_1_81::type_erasure::destructible<T>
        >()(_boost_type_erasure_data);
    }

protected:
    friend struct ::zr_boost_1_81::type_erasure::detail::access;

    _boost_type_erasure_table_type _boost_type_erasure_table;
    ::zr_boost_1_81::type_erasure::detail::storage _boost_type_erasure_data;
};
...
struct is_rvalue_for_any<any<C, P> > :
    ::zr_boost_1_81::mpl::not_<
        ::zr_boost_1_81::is_lvalue_reference<P>
    >
{};
...
class any :
#ifdef BOOST_TYPE_ERASURE_SFINAE_FRIENDLY_CONSTRUCTORS
    public ::zr_boost_1_81::type_erasure::any_constructor_control<
        ::zr_boost_1_81::type_erasure::any_constructor_impl<
    ...
    >
#else
    public ::zr_boost_1_81::type_erasure::detail::compute_bases<
        ::zr_boost_1_81::type_erasure::any<Concept, T>,
        Concept,
        T
    >::type
#endif
{
    typedef ::zr_boost_1_81::type_erasure::binding<Concept> table_type;
public:
    /** INTERNAL ONLY */
    typedef Concept _boost_type_erasure_concept_type;

#if defined(BOOST_TYPE_ERASURE_SFINAE_FRIENDLY_CONSTRUCTORS)
    using _boost_type_erasure_base = ::zr_boost_1_81::type_erasure::any_constructor_control<
        ::zr_boost_1_81::type_erasure::any_constructor_impl<
            Concept,
            T
        >
    ...
    /** INTERNAL ONLY */
    any(const ::zr_boost_1_81::type_erasure::detail::storage& data_arg, const table_type& table_arg)
      : table(table_arg),
        data(data_arg)
    {}
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    /** INTERNAL ONLY */
    any(::zr_boost_1_81::type_erasure::detail::storage&& data_arg, const table_type& table_arg)
      : table(table_arg),
        data(data_arg)
    {}
#endif
    ...
    any(const U& data_arg)
      : table((
            ...
            ::zr_boost_1_81::type_erasure::make_binding<
                ::zr_boost_1_81::mpl::map1< ::zr_boost_1_81::mpl::pair<T, U> >
            >()
        )),
        data(data_arg)
    {}
    ...
    {
        BOOST_MPL_ASSERT((::zr_boost_1_81::is_same<
            typename ::zr_boost_1_81::mpl::at<Map, T>::type, U>));
    }
    ...
    any(U&& data_arg)
      : table((
            BOOST_TYPE_ERASURE_INSTANTIATE1(Concept, T, typename ::zr_boost_1_81::remove_cv<typename ::zr_boost_1_81::remove_reference<U>::type>::type),
            ::zr_boost_1_81::type_erasure::make_binding<
                ::zr_boost_1_81::mpl::map1< ::zr_boost_1_81::mpl::pair<T, typename ::zr_boost_1_81::remove_cv<typename ::zr_boost_1_81::remove_reference<U>::type>::type> >
            >()
        )),
    ...
    {
        BOOST_MPL_ASSERT((::zr_boost_1_81::is_same<
            typename ::zr_boost_1_81::mpl::at<Map, T>::type, typename ::zr_boost_1_81::remove_cv<typename ::zr_boost_1_81::remove_reference<U>::type>::type>));
    }
    ...
    any(const any& other)
      : table(other.table),
        data(::zr_boost_1_81::type_erasure::call(constructible<T(const T&)>(), other))
    {}
    /**
            ...
            ::zr_boost_1_81::mpl::map1<
                ::zr_boost_1_81::mpl::pair<
                    ...
                    typename ::zr_boost_1_81::remove_const<
                        typename ::zr_boost_1_81::remove_reference<Tag2>::type
                    >::type
                >
            >()
        ),
        data(::zr_boost_1_81::type_erasure::call(
            constructible<
                typename ::zr_boost_1_81::remove_const<
                    typename zr_boost_1_81::remove_reference<Tag2>::type
                >::type(const typename zr_boost_1_81::remove_reference<Tag2>::type&)
            >(), other)
        )
    {}
    /**
    ...
    any(const any<Concept2, Tag2>& other, const static_binding<Map>& binding_arg)
      : table(::zr_boost_1_81::type_erasure::detail::access::table(other), binding_arg),
        data(::zr_boost_1_81::type_erasure::call(
            constructible<
                typename ::zr_boost_1_81::remove_const<
                    typename zr_boost_1_81::remove_reference<Tag2>::type
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    any(any&& other)
      : table(::zr_boost_1_81::type_erasure::detail::access::table(other)),
        data(::zr_boost_1_81::type_erasure::call(
            ::zr_boost_1_81::type_erasure::detail::make(
    ...
    explicit any(const binding<Concept>& binding_arg)
      : table(binding_arg),
        data(
            ::zr_boost_1_81::type_erasure::call(
                binding_arg,
                ::zr_boost_1_81::type_erasure::constructible<T()>()
            )
        )
    {}
...
#include <boost/type_erasure/detail/construct.hpp>
    ...
    ~any()
    {
        ::zr_boost_1_81::type_erasure::detail::access::table(*this).template find<
            ::zr_boost_1_81::type_erasure::destructible<T>
        >()(::zr_boost_1_81::type_erasure::detail::access::data(*this));
    }
#endif
    ...
    operator param<Concept, T&>() &
    {
        return param<Concept, T&>(
            zr_boost_1_81::type_erasure::detail::access::data(*this),
            zr_boost_1_81::type_erasure::detail::access::table(*this));
    }
    /** INTERNAL ONLY */
    operator param<Concept, T&&>() && {
        return param<Concept, T&&>(
...
private:
    ...
    void _boost_type_erasure_resolve_assign(Other&& other)
    {
        _boost_type_erasure_assign_impl(
            ...
            false? this->_boost_type_erasure_deduce_assign(
                ::zr_boost_1_81::type_erasure::detail::make_fallback(
                    std::forward<Other>(other),
                    ::zr_boost_1_81::mpl::bool_<
                        sizeof(
                            ::zr_boost_1_81::type_erasure::detail::check_overload(
    ...
    {
        ::zr_boost_1_81::type_erasure::call(assignable<T, U>(), *this, std::forward<Other>(other));
    }
    /** INTERNAL ONLY */
    template<class Other, class U>
    void _boost_type_erasure_assign_impl(
    ...
    void _boost_type_erasure_assign_impl(
        ...
        ::zr_boost_1_81::mpl::false_)
    {
        ::zr_boost_1_81::type_erasure::call(assignable<T, U>(), *this, other);
    }
    /** INTERNAL ONLY */
    template<class Other, class U>
    void _boost_type_erasure_assign_impl(
    ...
    void _boost_type_erasure_assign_impl(
        ...
        ::zr_boost_1_81::mpl::true_)
    {
        if(::zr_boost_1_81::type_erasure::check_match(assignable<T, U>(), *this, other))  // const reference to other is enough!
        {
            ::zr_boost_1_81::type_erasure::unchecked_call(assignable<T, U>(), *this, std::forward<Other>(other));
        }
        else
        {
            any temp(std::forward<Other>(other));
    ...
    void _boost_type_erasure_assign_impl(
        ...
        ::zr_boost_1_81::mpl::true_)
    {
        if(::zr_boost_1_81::type_erasure::check_match(assignable<T, U>(), *this, other))
        {
            ::zr_boost_1_81::type_erasure::unchecked_call(assignable<T, U>(), *this, other);
        }
        else
        {
            any temp(other);
    ...
    table_type table;
    ::zr_boost_1_81::type_erasure::detail::storage data;
#else
    template<class Concept2, class T2>
    friend struct ::zr_boost_1_81::type_erasure::any_constructor_impl;
#endif
};
...
public:
    ...
    typedef Concept _boost_type_erasure_concept_type;
    /** INTERNAL ONLY */
    any(const ::zr_boost_1_81::type_erasure::detail::storage& data_arg,
    ...
    any(U& arg
        ...
        ,  typename ::zr_boost_1_81::disable_if<
            ::zr_boost_1_81::mpl::or_<
                ::zr_boost_1_81::is_const<U>,
                ::zr_boost_1_81::type_erasure::detail::is_any<U>
            >
        >::type* = 0
#endif
        )
    ...
    {
        data.data = ::zr_boost_1_81::addressof(arg);
    }
    /**
     * Constructs an @ref any from a reference.
     *
     ...
     */
    any(any<Concept, T>& other)
      : data(::zr_boost_1_81::type_erasure::detail::access::data(other)),
        table(::zr_boost_1_81::type_erasure::detail::access::table(other))
    {}
    /**
     * Constructs an @ref any from another reference.
    ...
    any(const any<Concept2, Tag2&>& other
        ...
        , typename ::zr_boost_1_81::disable_if<
            ::zr_boost_1_81::mpl::or_<
                ::zr_boost_1_81::is_same<Concept, Concept2>,
                ::zr_boost_1_81::is_const<Tag2>
            >
        >::type* = 0
#endif
        )
    ...
    any(any<Concept2, Tag2>& other
        ...
        , typename ::zr_boost_1_81::disable_if<
            ::zr_boost_1_81::mpl::or_<
                ::zr_boost_1_81::is_same<Concept, Concept2>,
                ::zr_boost_1_81::is_const<typename ::zr_boost_1_81::remove_reference<Tag2>::type>
            >
        >::type* = 0
#endif
        )
    ...
    any(const any<Concept2, Tag2&>& other, const static_binding<Map>& binding_arg
#ifndef BOOST_TYPE_ERASURE_DOXYGEN
        , typename ::zr_boost_1_81::disable_if< ::zr_boost_1_81::is_const<Tag2> >::type* = 0
#endif
        )
      : data(::zr_boost_1_81::type_erasure::detail::access::data(other)),
        table(::zr_boost_1_81::type_erasure::detail::access::table(other), binding_arg)
    ...
    void _boost_type_erasure_resolve_assign(Other&& other)
    {
        _boost_type_erasure_assign_impl(
            ...
            ::zr_boost_1_81::mpl::and_<
                ::zr_boost_1_81::type_erasure::is_relaxed<Concept>,
                ::zr_boost_1_81::is_convertible<Other, any>
#if BOOST_WORKAROUND(BOOST_MSVC, BOOST_TESTED_AT(1900))
              , ::zr_boost_1_81::mpl::not_<
                    ::zr_boost_1_81::type_erasure::detail::is_rvalue_for_any<Other>
                >
#endif
            >()
        );
...
class any<Concept, const T&> :
    public ::zr_boost_1_81::type_erasure::detail::compute_bases<
        ::zr_boost_1_81::type_erasure::any<Concept, const T&>,
        Concept,
        T
    >::type
{
...
public:
    ...
    {
        data.data = const_cast<void*>(static_cast<const void*>(::zr_boost_1_81::addressof(arg)));
    }
    /**
     * Constructs an @ref any from a reference.
     *
    ...
    any(const any<Concept2, Tag2>& other
#ifndef BOOST_TYPE_ERASURE_DOXYGEN
        , typename ::zr_boost_1_81::disable_if< ::zr_boost_1_81::is_same<Concept, Concept2> >::type* = 0
#endif
        )
      : data(::zr_boost_1_81::type_erasure::detail::access::data(other)),
        table(
...
public:
    ...
    any(any<Concept, T>&& other)
      : data(::zr_boost_1_81::type_erasure::detail::access::data(other)),
        table(std::move(::zr_boost_1_81::type_erasure::detail::access::table(other)))
    {}
    /**
     * Constructs an @ref any from another rvalue reference.
     *
    ...
    any(any<Concept2, Tag2&&>&& other
        ...
        , typename ::zr_boost_1_81::disable_if<
            ::zr_boost_1_81::mpl::or_<
                ::zr_boost_1_81::is_reference<Tag2>,
                ::zr_boost_1_81::is_same<Concept, Concept2>,
                ::zr_boost_1_81::is_const<Tag2>
            >
        >::type* = 0
      ...
      : data(::zr_boost_1_81::type_erasure::detail::access::data(other)),
        table(
            std::move(::zr_boost_1_81::type_erasure::detail::access::table(other)),
            ::zr_boost_1_81::mpl::map1<
                ::zr_boost_1_81::mpl::pair<
                    T,
                    Tag2
    ...
    any(const any<Concept2, Tag2&&>& other, const static_binding<Map>& binding_arg
      ...
      : data(::zr_boost_1_81::type_erasure::detail::access::data(other)),
        table(std::move(::zr_boost_1_81::type_erasure::detail::access::table(other)), binding_arg)
    {}
    /**
     * Constructs an @ref any from another @ref any.
     *
...
private:
        ...
        ::zr_boost_1_81::mpl::false_)
    {
        ::zr_boost_1_81::type_erasure::call(
            ...
            ::zr_boost_1_81::type_erasure::param<Concept, T&>(data, table),
            std::forward<Other>(other));
    }
    /** INTERNAL ONLY */
    template<class Other, class U>
    ...
    {
        if(::zr_boost_1_81::type_erasure::check_match(assignable<T, U>(), *this, other)) {
            ::zr_boost_1_81::type_erasure::unchecked_call(
                assignable<T, U>(),
                // lose rvalueness of this
                ::zr_boost_1_81::type_erasure::param<Concept, T&>(data, table),
                std::forward<Other>(other));
