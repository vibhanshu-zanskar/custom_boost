...
#define BOOST_TYPE_ERASURE_UNARY_INPLACE_OPERATOR(name, op)                         \
    ...
    > : Base                                                                        \
    {                                                                               \
        typedef typename ::zr_boost_1_81::type_erasure::derived<Base>::type _derived;       \
        _derived& operator op()                                                     \
        {                                                                           \
            ::zr_boost_1_81::type_erasure::call(name<T>(), *this);                          \
            return static_cast<_derived&>(*this);                                   \
        }                                                                           \
        typename ::zr_boost_1_81::type_erasure::rebind_any<Base, T>::type operator op(int)  \
        {                                                                           \
            typename ::zr_boost_1_81::type_erasure::rebind_any<Base, T>::type result(       \
    ...
    {                                                                               \
        ...
        typename ::zr_boost_1_81::type_erasure::rebind_any<Base, T>::type operator op(int) const \
        {                                                                           \
            typename ::zr_boost_1_81::type_erasure::rebind_any<Base, T>::type result(       \
...
#define BOOST_TYPE_ERASURE_UNARY_OPERATOR(name, op)                                     \
    ...
    {                                                                                   \
        typename ::zr_boost_1_81::type_erasure::rebind_any<Base, R>::type operator op() const   \
        {                                                                               \
            return ::zr_boost_1_81::type_erasure::call(name<T, R>(), *this);                    \
        }                                                                               \
    };
...
{
    typename ::zr_boost_1_81::type_erasure::rebind_any<Base, R>::type operator*() const
    {
        return ::zr_boost_1_81::type_erasure::call(dereferenceable<R, T>(), *this);
    }
};
...
#define BOOST_TYPE_ERASURE_BINARY_OPERATOR(name, op)                        \
    ...
    {                                                                       \
        ...
        {                                                                   \
            return ::zr_boost_1_81::type_erasure::call(name<T, U, R>(), lhs, rhs);  \
        }                                                                   \
    };                                                                      \
                                                                            \
    template<class T, class U, class R, class Base>                         \
    struct concept_interface<                                               \
        ...
        typename ::zr_boost_1_81::disable_if<                                       \
            ::zr_boost_1_81::type_erasure::is_placeholder<T> >::type                \
    > : Base                                                                \
    {                                                                       \
        friend typename rebind_any<Base, R>::type                           \
...
#define BOOST_TYPE_ERASURE_ASSIGNMENT_OPERATOR(name, op)                    \
    ...
    {                                                                       \
        ...
        operator op(typename detail::non_const_this_param<Base>::type& lhs, \
                    typename as_param<Base, const U&>::type rhs)            \
        {                                                                   \
            ::zr_boost_1_81::type_erasure::call(name<T, U>(),lhs, rhs);             \
            return lhs;                                                     \
        }                                                                   \
    };                                                                      \
                                                                            \
...
struct concept_interface<equality_comparable<T, U>, Base, T> : Base
{
    friend bool operator==(const typename derived<Base>::type& lhs,
                           typename as_param<Base, const U&>::type rhs)
    {
        if(::zr_boost_1_81::type_erasure::check_match(equality_comparable<T, U>(), lhs, rhs)) {
            return ::zr_boost_1_81::type_erasure::unchecked_call(equality_comparable<T, U>(), lhs, rhs);
        } else {
            return false;
        }
    }
...
struct concept_interface<
    ...
    Base,
    U,
    typename ::zr_boost_1_81::disable_if< ::zr_boost_1_81::type_erasure::is_placeholder<T> >::type
> : Base
{
    friend bool operator==(const T& lhs, const typename derived<Base>::type& rhs)
    {
        return ::zr_boost_1_81::type_erasure::call(equality_comparable<T, U>(), lhs, rhs);
    }
    friend bool operator!=(const T& lhs, const typename derived<Base>::type& rhs)
    {
        return !(lhs == rhs);
...
bool less_impl(const F& f, const T& lhs, const U& rhs, ::zr_boost_1_81::mpl::true_)
{
    if(::zr_boost_1_81::type_erasure::check_match(f, lhs, rhs)) {
        return ::zr_boost_1_81::type_erasure::unchecked_call(f, lhs, rhs);
    } else {
        return ::zr_boost_1_81::type_erasure::typeid_of(
            static_cast<const typename derived<T>::type&>(lhs)
        ).before(
            ::zr_boost_1_81::type_erasure::typeid_of(
...
template<class F, class T, class U>
bool less_impl(const F& f, const T& lhs, const U& rhs, ::zr_boost_1_81::mpl::false_)
{
    return ::zr_boost_1_81::type_erasure::call(f, lhs, rhs);
}
...
struct concept_interface<less_than_comparable<T, T>, Base, T> : Base
{
    ...
    {
        return ::zr_boost_1_81::type_erasure::detail::less_impl(
            less_than_comparable<T, T>(),
            lhs, rhs,
            ::zr_boost_1_81::type_erasure::is_relaxed<
                typename ::zr_boost_1_81::type_erasure::concept_of<Base>::type>());
    }
    friend bool operator>=(const typename derived<Base>::type& lhs,
                           typename as_param<Base, const T&>::type rhs)
    {
...
struct concept_interface<less_than_comparable<T, U>, Base, T> : Base
{
    friend bool operator<(const typename derived<Base>::type& lhs,
                          typename as_param<Base, const U&>::type rhs)
    {
        return ::zr_boost_1_81::type_erasure::call(less_than_comparable<T, U>(), lhs, rhs);
    }
    friend bool operator>=(const typename derived<Base>::type& lhs,
                           typename as_param<Base, const U&>::type rhs)
    {
...
struct concept_interface<subscriptable<R, T, N>, Base, typename ::zr_boost_1_81::remove_const<T>::type,
    typename ::zr_boost_1_81::enable_if<
        ::zr_boost_1_81::type_erasure::detail::should_be_non_const<T, Base>
    >::type
> : Base
{
    typename ::zr_boost_1_81::type_erasure::rebind_any<Base, R>::type operator[](
        typename ::zr_boost_1_81::type_erasure::as_param<Base, const N&>::type index)
    {
        return ::zr_boost_1_81::type_erasure::call(subscriptable<R, T, N>(), *this, index);
    }
};
...
struct concept_interface<subscriptable<R, T, N>, Base, typename ::zr_boost_1_81::remove_const<T>::type,
    typename ::zr_boost_1_81::enable_if<
        ::zr_boost_1_81::type_erasure::detail::should_be_const<T, Base>
    >::type
> : Base
{
    typename ::zr_boost_1_81::type_erasure::rebind_any<Base, R>::type operator[](
        typename ::zr_boost_1_81::type_erasure::as_param<Base, const N&>::type index) const
    {
        return ::zr_boost_1_81::type_erasure::call(subscriptable<R, const T, N>(), *this, index);
    }
};
...
struct concept_interface<ostreamable<Os, T>, Base, Os> : Base
{
    ...
    operator<<(typename detail::non_const_this_param<Base>::type& lhs,
               typename ::zr_boost_1_81::type_erasure::as_param<Base, const T&>::type rhs)
    {
        ::zr_boost_1_81::type_erasure::call(ostreamable<Os, T>(), lhs, rhs);
        return lhs;
    }
};
...
struct concept_interface<
    ...
    Base,
    T,
    typename ::zr_boost_1_81::disable_if< ::zr_boost_1_81::type_erasure::is_placeholder<Os> >::type
> : Base
{
    friend Os&
    operator<<(Os& lhs,
               const typename ::zr_boost_1_81::type_erasure::derived<Base>::type& rhs)
    {
        ::zr_boost_1_81::type_erasure::call(ostreamable<Os, T>(), lhs, rhs);
        return lhs;
    }
...
struct concept_interface<istreamable<Is, T>, Base, Is> : Base
{
    friend typename detail::non_const_this_param<Base>::type&
    operator>>(typename detail::non_const_this_param<Base>::type& lhs,
               typename ::zr_boost_1_81::type_erasure::as_param<Base, T&>::type rhs)
    {
        ::zr_boost_1_81::type_erasure::call(istreamable<Is, T>(), lhs, rhs);
        return lhs;
    }
};
...
struct concept_interface<
    ...
    Base,
    T,
    typename ::zr_boost_1_81::disable_if< ::zr_boost_1_81::type_erasure::is_placeholder<Is> >::type
> : Base
{
    friend Is&
    operator>>(Is& lhs,
               typename ::zr_boost_1_81::type_erasure::derived<Base>::type& rhs)
    {
        ::zr_boost_1_81::type_erasure::call(istreamable<Is, T>(), lhs, rhs);
        return lhs;
    }
