...
struct copy_constructible :
    ::zr_boost_1_81::mpl::vector<constructible<T(const T&)>, destructible<T> >
{};
...
template<class T = _self, class U = const T&>
struct assignable :
    ::zr_boost_1_81::mpl::vector<assignable<T, const U&> >
{};
...
struct concept_interface<assignable<T, U>, Base, T,
        typename ::zr_boost_1_81::enable_if_c< ::zr_boost_1_81::is_reference<U>::value>::type> : Base
{
    using Base::_boost_type_erasure_deduce_assign;
    assignable<T, U>* _boost_type_erasure_deduce_assign(
        typename ::zr_boost_1_81::type_erasure::as_param<Base, U>::type)
    {
        return 0;
    }
};
...
template<class T>
struct get_null_vtable_entry< ::zr_boost_1_81::type_erasure::typeid_<T> >
{
    typedef typeid_<void> type;
};

struct null_destroy {
    static void value(::zr_boost_1_81::type_erasure::detail::storage&) {}
};

template<class T>
struct get_null_vtable_entry< ::zr_boost_1_81::type_erasure::destructible<T> >
{
    typedef ::zr_boost_1_81::type_erasure::detail::null_destroy type;
};
