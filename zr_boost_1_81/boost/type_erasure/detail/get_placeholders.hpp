...
struct get_placeholders_in_argument_impl
{
    ...
    using apply = ::zr_boost_1_81::type_erasure::detail::eval_if<
        ::zr_boost_1_81::type_erasure::is_placeholder<T>::value,
        ::zr_boost_1_81::mp11::mp_set_push_back,
...
{
    template<class Out>
    using apply = typename ::zr_boost_1_81::type_erasure::detail::get_placeholders_in_argument_impl<T>::template apply<Out>;
};
...
using get_placeholders_impl =
    ::zr_boost_1_81::mp11::mp_fold<
        ...
        Out,
        ::zr_boost_1_81::type_erasure::detail::get_placeholders_f
    >;
...
{
    template<class Out>
    using apply = ::zr_boost_1_81::type_erasure::detail::get_placeholders_impl<Out, R, T...>;
};
...
{
    template<class Out>
    using apply = ::zr_boost_1_81::type_erasure::detail::get_placeholders_impl<Out, R, C, T...>;
};
...
{
    using type = ::zr_boost_1_81::type_erasure::detail::get_placeholders_impl<Out, T...>;
};

template<class T, class Out>
using get_placeholders_t = typename ::zr_boost_1_81::type_erasure::detail::get_placeholders<T, Out>::type;
...
struct get_placeholders_in_argument
{
    typedef typename ::zr_boost_1_81::mpl::eval_if<
        ...
        ::zr_boost_1_81::mpl::insert<Out, T>,
...
{
    typedef typename ::zr_boost_1_81::type_erasure::detail::get_placeholders_in_argument<
        T,
        Out
    >::type type;
};
