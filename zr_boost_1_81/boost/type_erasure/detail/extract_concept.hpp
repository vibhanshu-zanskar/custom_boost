...
template<class T, class U>
using combine_concepts_t = typename ::zr_boost_1_81::type_erasure::detail::combine_concepts<T, U>::type;

template<class T, class U>
using extract_concept_or_void =
    ::zr_boost_1_81::mp11::mp_eval_if_c<
        !::zr_boost_1_81::type_erasure::is_placeholder<
            ::zr_boost_1_81::remove_cv_t<
                ::zr_boost_1_81::remove_reference_t<T>
            >
        >::value,
        void,
        ::zr_boost_1_81::type_erasure::concept_of_t, U
    >;

template<class L1, class L2>
using extract_concept_t =
    ::zr_boost_1_81::mp11::mp_fold<
        ::zr_boost_1_81::mp11::mp_transform< ::zr_boost_1_81::type_erasure::detail::extract_concept_or_void, L1, L2>,
        void,
        ::zr_boost_1_81::type_erasure::detail::combine_concepts_t
    >;
...
struct maybe_extract_concept
{
    typedef typename ::zr_boost_1_81::mpl::eval_if<
        ::zr_boost_1_81::type_erasure::is_placeholder<
            ...
            >::type
        >,
        ::zr_boost_1_81::type_erasure::concept_of<typename ::zr_boost_1_81::remove_reference<U>::type>,
...
{
    typedef typename ::zr_boost_1_81::type_erasure::detail::combine_concepts<
        typename ::zr_boost_1_81::type_erasure::detail::maybe_extract_concept<
            T0, U0
        >::type,
