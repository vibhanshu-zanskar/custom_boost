...
using choose_member_interface = typename ::zr_boost_1_81::mpl::if_c< ::zr_boost_1_81::is_reference<P>::value,
    typename ::zr_boost_1_81::mpl::if_c< ::zr_boost_1_81::type_erasure::detail::is_non_const_ref<P>::value,
...
struct choose_member_impl<R (C::*)(T...) const>
{
    ...
    using apply = ::zr_boost_1_81::mpl::vector1<S<R(T...), const P> >;
};
...
using choose_member_impl_t =
    typename ::zr_boost_1_81::type_erasure::detail::choose_member_impl<
        Sig (::zr_boost_1_81::type_erasure::detail::dummy::*)
...
{
    template<class Base, template<class, class> class C, template<class...> class M>
    using apply = ::zr_boost_1_81::type_erasure::detail::choose_member_interface<
        ::zr_boost_1_81::type_erasure::placeholder_of_t<Base>,
        M,
        R(A...), C<R(A...), T>, Base, T>;
};
...
struct member_choose_interface
{
    ...
    using apply = typename ::zr_boost_1_81::type_erasure::detail::member_interface_chooser<Sig, T, ID>::template apply<Base, C, M>;
};
...
template<class Sig, class T = ::zr_boost_1_81::type_erasure::_self>                 \
struct concept_name;                                                        \
                                                                            \
namespace zr_boost_1_81_type_erasure_impl {                                         \
                                                                            \
...
{                                                                           \
    ...
    ::zr_boost_1_81::type_erasure::rebind_any_t<Base, R> function_name(::zr_boost_1_81::type_erasure::as_param_t<Base, A>... a)\
    { return ::zr_boost_1_81::type_erasure::call(Concept(), *this, std::forward<A>(a)...); }\
};                                                                          \
                                                                            \
...
{                                                                           \
    typedef void _boost_type_erasure_has_member ## function_name;           \
    ::zr_boost_1_81::type_erasure::rebind_any_t<Base, R> function_name(::zr_boost_1_81::type_erasure::as_param_t<Base, A>... a) const\
    { return ::zr_boost_1_81::type_erasure::call(Concept(), *this, std::forward<A>(a)...); }\
};                                                                          \
                                                                            \
template<class R, class... A, class Concept, class Base, class ID>          \
...
template<class Sig, class T>                                                \
struct concept_name :                                                       \
    ::zr_boost_1_81::type_erasure::detail::choose_member_impl_t<Sig, T,             \
        zr_boost_1_81_type_erasure_impl::concept_name##member,                      \
        zr_boost_1_81_type_erasure_impl::concept_name##self                         \
    >                                                                       \
{};                                                                         \
                                                                            \
template<class Sig, class T>                                                \
::zr_boost_1_81::type_erasure::detail::member_choose_interface<Sig, T, concept_name,\
    zr_boost_1_81_type_erasure_impl::concept_name ## _member_interface>             \
