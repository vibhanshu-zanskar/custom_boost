...
struct replace_param_for_vtable
{
    typedef typename ::zr_boost_1_81::mpl::if_<
        ::zr_boost_1_81::type_erasure::is_placeholder<typename ::zr_boost_1_81::remove_cv<T>::type>,
...
struct is_internal_concept :
    ::zr_boost_1_81::type_erasure::detail::has_type<T>
{};

template<class PrimitiveConcept>
struct adapt_to_vtable
{
    typedef ::zr_boost_1_81::type_erasure::detail::vtable_adapter<
        PrimitiveConcept,
        typename ::zr_boost_1_81::type_erasure::detail::get_vtable_signature<
            typename ::zr_boost_1_81::type_erasure::detail::get_signature<
                PrimitiveConcept
            >::type
        >::type
    > type;
...
struct maybe_adapt_to_vtable
{
    typedef typename ::zr_boost_1_81::mpl::eval_if<
        ::zr_boost_1_81::type_erasure::detail::is_internal_concept<Concept>,
        ::zr_boost_1_81::mpl::identity<Concept>,
        ::zr_boost_1_81::type_erasure::detail::adapt_to_vtable<Concept>
    >::type type;
};
...
struct vtable_adapter_impl<PrimitiveConcept, R(T...), R2(U...)>
{
    ...
    static R value(T... arg)
    {
        return PrimitiveConcept::apply(
            ::zr_boost_1_81::type_erasure::detail::extract<U>(std::forward<T>(arg))...);
    }
};

template<class PrimitiveConcept, class... T, class R2, class... U>
struct vtable_adapter_impl<PrimitiveConcept, ::zr_boost_1_81::type_erasure::detail::storage(T...), R2(U...)>
{
    typedef ::zr_boost_1_81::type_erasure::detail::storage (*type)(T...);
    static ::zr_boost_1_81::type_erasure::detail::storage value(T... arg)
    {
        return ::zr_boost_1_81::type_erasure::detail::storage(
            PrimitiveConcept::apply(::zr_boost_1_81::type_erasure::detail::extract<U>(std::forward<T>(arg))...));
    }
};
...
struct vtable_adapter_impl<PrimitiveConcept, ::zr_boost_1_81::type_erasure::detail::storage&(T...), R2(U...)>
{
    ...
    static ::zr_boost_1_81::type_erasure::detail::storage value(T... arg)
    {
        ::zr_boost_1_81::type_erasure::detail::storage result;
        typename ::zr_boost_1_81::remove_reference<R2>::type* p =
            ::zr_boost_1_81::addressof(
                PrimitiveConcept::apply(::zr_boost_1_81::type_erasure::detail::extract<U>(std::forward<T>(arg))...));
...
struct vtable_adapter_impl<PrimitiveConcept, ::zr_boost_1_81::type_erasure::detail::storage&&(T...), R2(U...)>
{
    ...
    {
        ::zr_boost_1_81::type_erasure::detail::storage result;
        R2 tmp = PrimitiveConcept::apply(::zr_boost_1_81::type_erasure::detail::extract<U>(std::forward<T>(arg))...);
        typename ::zr_boost_1_81::remove_reference<R2>::type* p = ::zr_boost_1_81::addressof(tmp);
        result.data = const_cast<void*>(static_cast<const void*>(p));
        return result;
    }
};
...
{
    typedef typename ::zr_boost_1_81::type_erasure::detail::replace_result_for_vtable<
        R
    >::type type(typename ::zr_boost_1_81::type_erasure::detail::replace_param_for_vtable<T>::type...);
};
...
#define BOOST_TYPE_ERASURE_EXTRACT(z, n, data)                  \
    ::zr_boost_1_81::type_erasure::detail::extract<                     \
        typename traits::                                       \
...
#define BOOST_TYPE_ERASURE_REPLACE_PARAM(z, n, data)                    \
    typename ::zr_boost_1_81::type_erasure::detail::replace_param_for_vtable<   \
...
struct vtable_adapter<PrimitiveConcept, R(BOOST_PP_ENUM_PARAMS(N, T))>
{
    ...
    {
#if N > 0
        typedef typename ::zr_boost_1_81::function_traits<
            typename ::zr_boost_1_81::type_erasure::detail::get_signature<
                PrimitiveConcept
            >::type
        > traits;
...
template<class PrimitiveConcept
    BOOST_PP_ENUM_TRAILING_PARAMS(N, class T)>
struct vtable_adapter<PrimitiveConcept, ::zr_boost_1_81::type_erasure::detail::storage(BOOST_PP_ENUM_PARAMS(N, T))>
{
    typedef ::zr_boost_1_81::type_erasure::detail::storage (*type)(BOOST_PP_ENUM_PARAMS(N, T));
    static ::zr_boost_1_81::type_erasure::detail::storage value(BOOST_PP_ENUM_BINARY_PARAMS(N, T, arg))
    {
#if N > 0
        typedef typename ::zr_boost_1_81::function_traits<
            typename ::zr_boost_1_81::type_erasure::detail::get_signature<
...
struct vtable_adapter<PrimitiveConcept, ::zr_boost_1_81::type_erasure::detail::storage&(BOOST_PP_ENUM_PARAMS(N, T))>
{
    ...
    static ::zr_boost_1_81::type_erasure::detail::storage value(BOOST_PP_ENUM_BINARY_PARAMS(N, T, arg))
    {
        ...
        > traits;
        ::zr_boost_1_81::type_erasure::detail::storage result;
        typename ::zr_boost_1_81::remove_reference<typename traits::result_type>::type* p =
            ::zr_boost_1_81::addressof(
