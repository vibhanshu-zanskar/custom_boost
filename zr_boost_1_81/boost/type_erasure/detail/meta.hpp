...
struct mp11_list_inserter
{
    ...
    using apply = ::zr_boost_1_81::mpl::identity< ::zr_boost_1_81::mp11::mp_push_back<L, T> >;
};
...
struct make_mp_list_impl
{
    typedef typename ::zr_boost_1_81::mpl::fold<
        ...
        ::zr_boost_1_81::type_erasure::detail::mp11_list_inserter
    >::type type;
};

template<class... T>
struct make_mp_list_impl< ::zr_boost_1_81::mp11::mp_list<T...> >
{
    typedef ::zr_boost_1_81::mp11::mp_list<T...> type;
};
...
using eval_if = typename ::zr_boost_1_81::type_erasure::detail::eval_if_impl<B>::template apply<T, F, A...>;
