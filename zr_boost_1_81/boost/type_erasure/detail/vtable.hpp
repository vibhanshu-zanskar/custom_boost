...
struct make_arg_pack_impl
{
    typedef typename make_arg_pack_impl<
        typename ::zr_boost_1_81::mpl::next<It>::type,
        End,
        T...,
        typename ::zr_boost_1_81::mpl::deref<It>::type
    >::type type;
};
...
{
    typedef typename make_arg_pack_impl<
        typename ::zr_boost_1_81::mpl::begin<Seq>::type,
        typename ::zr_boost_1_81::mpl::end<Seq>::type
    >::type type;
};
...
struct make_vtable
{
    typedef typename ::zr_boost_1_81::type_erasure::detail::make_vtable_impl<
        typename ::zr_boost_1_81::type_erasure::detail::make_arg_pack<Seq>::type
    >::type type;
};
...
struct make_vtable
{
    typedef typename make_vtable_impl<
        (::zr_boost_1_81::mpl::size<Seq>::value)>::template apply<Seq>::type type;
};
...
{
    typedef typename make_vtable_init_impl<
        (::zr_boost_1_81::mpl::size<Seq>::value)>::template apply<Seq, Table>::type type;
};
...
#define BOOST_TYPE_ERASURE_AT(z, n, data)       \
    typename ::zr_boost_1_81::mpl::at_c<data, n>::type
...
struct make_vtable_impl<N>
{
    ...
    struct apply
    {
        typedef ::zr_boost_1_81::type_erasure::detail::BOOST_PP_CAT(vtable_storage, N)<
...
struct make_vtable_init_impl<N>
{
    ...
    struct apply
    {
        typedef ::zr_boost_1_81::type_erasure::detail::BOOST_PP_CAT(vtable_init, N)<
            Table
