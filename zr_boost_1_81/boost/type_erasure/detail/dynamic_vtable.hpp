...
struct dynamic_vtable : dynamic_binding_impl<P>... {
    ...
    typename F::type lookup(F*) const {
        ...
        ::zr_boost_1_81::mpl::for_each<placeholders>(append_to_key<dynamic_vtable>{this, &key});
        return reinterpret_cast<typename F::type>(lookup_function_impl(key));
    }
    template<class Bindings>
    void init() {
        *this = dynamic_vtable(&typeid(typename zr_boost_1_81::mpl::at<Bindings, P>::type)...);
    }
    template<class Bindings, class Src>
    void convert_from(const Src& src) {
#ifndef BOOST_TYPE_ERASURE_USE_MP11
        *this = dynamic_vtable(
            (&src.lookup((::zr_boost_1_81::type_erasure::typeid_<typename ::zr_boost_1_81::mpl::at<Bindings, P>::type>*)0)())...);
#else
        *this = dynamic_vtable(
            (&src.lookup((::zr_boost_1_81::type_erasure::typeid_< ::zr_boost_1_81::mp11::mp_second< ::zr_boost_1_81::mp11::mp_map_find<Bindings, P> > >*)0)())...);
#endif
    }
};
...
struct dynamic_vtable_initializer
{
    ...
    void operator()(P)
    {
        *(*types)++ = &typeid(typename ::zr_boost_1_81::mpl::at<Bindings, P>::type);
    }
...
{
    const ::std::type_info * types[(::zr_boost_1_81::mpl::size<Placeholders>::value)];
    struct append_to_key
    {
        ...
        void operator()(P)
        {
            key->push_back(types[(::zr_boost_1_81::mpl::index_of<Placeholders, P>::type::value)]);
        }
    ...
    typename F::type lookup(F*) const {
        ...
        >::type placeholder_map;
        key.push_back(&typeid(typename ::zr_boost_1_81::type_erasure::detail::rebind_placeholders<F, placeholder_map>::type));
        ::zr_boost_1_81::mpl::for_each<placeholders>(append_to_key(types, &key));
        return reinterpret_cast<typename F::type>(lookup_function_impl(key));
    }
    template<class Bindings>
    void init()
    {
        ...
        ::zr_boost_1_81::mpl::for_each<Placeholders>(dynamic_vtable_initializer<Bindings>(ptr));
    }
    template<class Bindings, class Src>
    struct converter
    {
        ...
        void operator()(P)
        {
            *(*types)++ = &src->lookup((::zr_boost_1_81::type_erasure::typeid_<typename ::zr_boost_1_81::mpl::at<Bindings, P>::type>*)0)();
        }
        const std::type_info*** types;
        const Src * src;
    };
    ...
    void convert_from(const Src& src) {
        const ::std::type_info** ptr = types;
        ::zr_boost_1_81::mpl::for_each<Placeholders>(converter<Bindings, Src>(ptr, src));
    }
};
