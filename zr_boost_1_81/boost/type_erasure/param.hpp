...
struct placeholder_conversion : zr_boost_1_81::mpl::false_ {};
template<class T>
struct placeholder_conversion<T, T> : zr_boost_1_81::mpl::true_ {};
template<class T>
struct placeholder_conversion<T, T&> : zr_boost_1_81::mpl::true_ {};
template<class T>
struct placeholder_conversion<T, const T&> : zr_boost_1_81::mpl::true_ {};
template<class T>
struct placeholder_conversion<const T, T> : zr_boost_1_81::mpl::true_ {};
template<class T>
struct placeholder_conversion<const T, const T&> : zr_boost_1_81::mpl::true_ {};
template<class T>
struct placeholder_conversion<T&, T> : zr_boost_1_81::mpl::true_ {};
template<class T>
struct placeholder_conversion<T&, T&> : zr_boost_1_81::mpl::true_ {};
...
public:
    ...
    param(any<Concept, U>& a
        ...
        , typename zr_boost_1_81::enable_if<
            ::zr_boost_1_81::type_erasure::detail::placeholder_conversion<U, T>
        >::type* = 0
#endif
        )
      : _impl(a)
...
#ifndef BOOST_TYPE_ERASURE_DOXYGEN
        , typename zr_boost_1_81::enable_if<
            ::zr_boost_1_81::type_erasure::detail::placeholder_conversion<
                typename ::zr_boost_1_81::add_const<U>::type,
                T
            >
        >::type* = 0
#endif
    ...
    /** INTERNAL ONLY */
    param(const ::zr_boost_1_81::type_erasure::detail::storage& data,
...
public:
    ...
    {}
    template<class U>
    param(U& u, typename zr_boost_1_81::enable_if< ::zr_boost_1_81::is_same<U, const any<Concept, T> > >::type* = 0) : _impl(u) {}
    any<Concept, const T&> get() const { return _impl; }
protected:
    struct _impl_t {
        _impl_t(const ::zr_boost_1_81::type_erasure::detail::storage& data_,
              const ::zr_boost_1_81::type_erasure::binding<Concept>& table_)
          : table(table_), data(data_)
        {}
        _impl_t(const any<Concept, T>& u)
          : table(::zr_boost_1_81::type_erasure::detail::access::table(u)),
            data(::zr_boost_1_81::type_erasure::detail::access::data(u))
        {}
...
public:
    ...
    any<Concept, T&> get() const
    {
        return any<Concept, T&>(
            ::zr_boost_1_81::type_erasure::detail::access::data(this->_impl),
            ::zr_boost_1_81::type_erasure::detail::access::table(this->_impl));
    }
};
    ...
    typedef typename ::zr_boost_1_81::mpl::if_<
        ::zr_boost_1_81::type_erasure::is_placeholder<
            typename ::zr_boost_1_81::remove_cv<
                typename ::zr_boost_1_81::remove_reference<T>::type>::type>,
        param<typename ::zr_boost_1_81::type_erasure::concept_of<Any>::type, T>,
        T
    >::type type;
#endif
};
...
template<class Any, class T>
using as_param_t = typename ::zr_boost_1_81::type_erasure::as_param<Any, T>::type;
