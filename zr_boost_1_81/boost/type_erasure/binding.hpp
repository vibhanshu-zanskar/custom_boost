...
struct can_optimize_conversion : ::zr_boost_1_81::mpl::and_<
    ::zr_boost_1_81::is_same<Source, Dest>,
        ::zr_boost_1_81::is_same<
            typename ::zr_boost_1_81::mpl::find_if<
                Map,
                ::zr_boost_1_81::mpl::not_<
                    ::zr_boost_1_81::is_same<
                        ::zr_boost_1_81::mpl::first< ::zr_boost_1_81::mpl::_1>,
                        ::zr_boost_1_81::mpl::second< ::zr_boost_1_81::mpl::_1>
                    >
                >
            >::type,
            typename ::zr_boost_1_81::mpl::end<Map>::type
        >
    >::type
{};
...
class binding
{
    ...
    >::type actual_concept;
    typedef typename ::zr_boost_1_81::type_erasure::detail::make_vtable<
...
public:
     ...
     * \throws Nothing.
     */
    binding() { BOOST_MPL_ASSERT((::zr_boost_1_81::type_erasure::is_relaxed<Concept>)); }
    ...
    binding(const binding<Concept2>& other, const Map&
        ...
        , typename ::zr_boost_1_81::enable_if<
            ::zr_boost_1_81::mpl::and_<
                ::zr_boost_1_81::type_erasure::detail::check_map<Concept, Map>,
                ::zr_boost_1_81::type_erasure::is_subconcept<Concept, Concept2, Map>
            >
        >::type* = 0
#endif
        )
      : impl(
            other,
            static_binding<Map>(),
            ::zr_boost_1_81::type_erasure::detail::can_optimize_conversion<Concept2, Concept, Map>()
        )
    {}
...
private:
    ...
    {
        impl_type() {
            table = &::zr_boost_1_81::type_erasure::detail::make_vtable_init<
                typename ::zr_boost_1_81::mpl::transform<
                    actual_concept,
                    ::zr_boost_1_81::type_erasure::detail::get_null_vtable_entry<
        ...
        template<class Concept2, class Map>
        impl_type(const binding<Concept2>& other, const static_binding<Map>&, zr_boost_1_81::mpl::false_)
          : manager(new table_type)
        {
            manager->template convert_from<
                typename ::zr_boost_1_81::type_erasure::detail::convert_deductions<
                    Map,
                    placeholder_subs,
        ...
        template<class Concept2, class Map>
        impl_type(const binding<Concept2>& other, const static_binding<Map>&, zr_boost_1_81::mpl::true_)
          : table(other.impl.table),
            manager(other.impl.manager)
        {}
        const table_type* table;
        ::zr_boost_1_81::shared_ptr<table_type> manager;
    } impl;
};
