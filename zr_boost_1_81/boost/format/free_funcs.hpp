// ----------------------------------------------------------------------------
// free_funcs.hpp :  implementation of the free functions of zr_boost_1_81::format
// ----------------------------------------------------------------------------
...
namespace zr_boost_1_81 {
    ...
    namespace io {
         using ::zr_boost_1_81::str; // keep compatibility with when it was defined in this N.S.
    }   // - namespace io
    ...
    {
        typedef zr_boost_1_81::basic_format<Ch, Tr, Alloc>   format_t;
        if(f.items_.size()==0) 
            os << f.prefix_;
        else {
            if(f.cur_arg_ < f.num_args_)
                if( f.exceptions() & io::too_few_args_bit )
                    ...
                    zr_boost_1_81::throw_exception(io::too_few_args(f.cur_arg_, f.num_args_)); 
