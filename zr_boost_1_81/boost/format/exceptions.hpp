...
// **** exceptions -----------------------------------------------
        ...
        public:
            ...
            virtual const char *what() const BOOST_NOEXCEPT_OR_NOTHROW BOOST_OVERRIDE {
                return "zr_boost_1_81::format_error: "
        ...
        public:
            ...
            virtual const char *what() const BOOST_NOEXCEPT_OR_NOTHROW BOOST_OVERRIDE {
                return "zr_boost_1_81::bad_format_string: format-string is ill-formed";
            }
        };
        ...
        public:
            ...
            virtual const char *what() const BOOST_NOEXCEPT_OR_NOTHROW BOOST_OVERRIDE {
                return "zr_boost_1_81::too_few_args: "
        ...
        public:
            ...
            std::size_t get_expected() const { return expected_; }
            virtual const char *what() const BOOST_NOEXCEPT_OR_NOTHROW BOOST_OVERRIDE {
                return "zr_boost_1_81::too_many_args: "
        ...
        public:
            ...
            virtual const char *what() const BOOST_NOEXCEPT_OR_NOTHROW BOOST_OVERRIDE {
                return "zr_boost_1_81::out_of_range: "
