...
#include <boost/polymorphic_cast.hpp> // zr_boost_1_81::polymorphic_downcast
  ...
  typename Context::inner_context_type, InnerInitial >::type
{
  ...
  public:
    ...
    // If you receive a
    // "use of undefined type 'zr_boost_1_81::STATIC_ASSERTION_FAILURE<x>'" or similar
  ...
  private:
    ...
    result transit_impl( const TransitionAction & transitionAction )
    {
      ...
      // If you receive a
      // "use of undefined type 'zr_boost_1_81::STATIC_ASSERTION_FAILURE<x>'" or
...
inline void intrusive_ptr_release( const ::zr_boost_1_81::statechart::simple_state<
