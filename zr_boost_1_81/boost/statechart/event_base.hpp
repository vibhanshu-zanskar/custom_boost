...
inline void intrusive_ptr_add_ref( const ::zr_boost_1_81::statechart::event_base * pBase )
{
  pBase->add_ref();
}

inline void intrusive_ptr_release( const ::zr_boost_1_81::statechart::event_base * pBase )
{
  if ( pBase->release() )
  {
    ::zr_boost_1_81::statechart::detail::delete_helper::delete_object( pBase );
  }
}
