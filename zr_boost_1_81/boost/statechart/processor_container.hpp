...
class processor_container : noncopyable
{
  ...
  public:
    ...
    WorkItem create_processor( processor_handle & handle, Scheduler & scheduler )
    {
      ...
      return WorkItem(
        zr_boost_1_81::bind( pImpl, this, pProcessor,
      ...
      processor_handle & handle, Scheduler & scheduler, Arg1 arg1 )
    {
      ...
      impl_fun_ptr pImpl =
        &processor_container::template create_processor_impl1<
          Processor, arg1_type >;
      return WorkItem(
        zr_boost_1_81::bind( pImpl, this, pProcessor, processor_context( scheduler, handle ),
          arg1 ),
        Allocator() );
    }
    ...
    {
      return WorkItem(
        zr_boost_1_81::bind( &processor_container::destroy_processor_impl, this, processor ),
        Allocator() );
    }
    ...
    {
      return WorkItem(
        zr_boost_1_81::bind( &processor_container::initiate_processor_impl, this,
          processor ),
        Allocator() );
    }
    ...
    {
      return WorkItem(
        zr_boost_1_81::bind( &processor_container::terminate_processor_impl, this,
          processor ),
        Allocator() );
    }
      ...
      const processor_handle & processor, const event_ptr_type & pEvent )
    {
      ...
      return WorkItem(
        zr_boost_1_81::bind( &processor_container::queue_event_impl, this, processor,
          pEvent ),
        Allocator() );
    }
  ...
  private:
    ...
    typedef std::set< 
      ...
      typename zr_boost_1_81::detail::allocator::rebind_to<
