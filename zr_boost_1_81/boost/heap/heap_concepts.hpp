...
struct PriorityQueue:
    zr_boost_1_81::ForwardContainer<C>
{
    ...
    {
        BOOST_CONCEPT_ASSERT((zr_boost_1_81::Assignable<value_type>));
        BOOST_CONCEPT_ASSERT((zr_boost_1_81::Container<C>));
        BOOST_CONCEPT_ASSERT((zr_boost_1_81::EqualityComparable<C>));
        BOOST_CONCEPT_ASSERT((zr_boost_1_81::Comparable<C>));

        BOOST_CONCEPT_ASSERT((zr_boost_1_81::Const_BinaryPredicate<value_compare, value_type, value_type>));
    ...
    PriorityQueue<C>
{
    ...
    {
        BOOST_CONCEPT_ASSERT((zr_boost_1_81::Assignable<typename MutablePriorityQueue::handle_type>));
