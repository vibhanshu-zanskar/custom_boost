...
struct heap_merge_emulate
{
    ...
    typedef typename zr_boost_1_81::conditional<Heap1::has_reserve,
                                      reserver,
...
struct heap_merge_same
{
    ...
    typedef typename zr_boost_1_81::conditional<is_mergable,
...
{
    BOOST_CONCEPT_ASSERT((zr_boost_1_81::heap::PriorityQueue<Heap1>));
    BOOST_CONCEPT_ASSERT((zr_boost_1_81::heap::PriorityQueue<Heap2>));

    // if this assertion is triggered, the value_compare types are incompatible
    BOOST_STATIC_ASSERT((zr_boost_1_81::is_same<typename Heap1::value_compare, typename Heap2::value_compare>::value));

    const bool same_heaps = zr_boost_1_81::is_same<Heap1, Heap2>::value;

    typedef typename zr_boost_1_81::conditional<same_heaps,
