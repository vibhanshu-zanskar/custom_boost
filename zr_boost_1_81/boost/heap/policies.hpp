...
template <bool T>
struct stable:
    zr_boost_1_81::parameter::template_keyword<tag::stable, zr_boost_1_81::integral_constant<bool, T> >
{};
...
template <bool T>
struct mutable_:
    zr_boost_1_81::parameter::template_keyword<tag::mutable_, zr_boost_1_81::integral_constant<bool, T> >
{};
...
struct constant_time_size:
    zr_boost_1_81::parameter::template_keyword<tag::constant_time_size, zr_boost_1_81::integral_constant<bool, T> >
{};
...
struct store_parent_pointer:
    zr_boost_1_81::parameter::template_keyword<tag::store_parent_pointer, zr_boost_1_81::integral_constant<bool, T> >
{};
...
struct arity:
    zr_boost_1_81::parameter::template_keyword<tag::arity, zr_boost_1_81::integral_constant<int, T> >
{};
...
struct objects_per_page:
    zr_boost_1_81::parameter::template_keyword<tag::objects_per_page, zr_boost_1_81::integral_constant<int, T> >
{};
...
struct has_arg
{
    typedef typename zr_boost_1_81::parameter::binding<bound_args, tag_type, void>::type type;
    static const bool value = !zr_boost_1_81::is_void<type>::value;
};
...
struct extract_stable
{
    ...
    typedef typename zr_boost_1_81::conditional<has_stable,
...
struct extract_mutable
{
    ...
    typedef typename zr_boost_1_81::conditional<has_mutable,
