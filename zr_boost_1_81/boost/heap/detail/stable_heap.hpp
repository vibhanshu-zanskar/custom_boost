...
template <typename T,
          ...
          typename StabilityCounterType = zr_boost_1_81::uintmax_t,
          bool stable = false
         >
struct heap_base:
#ifndef BOOST_MSVC
    ...
    size_holder<constant_time_size, size_t>
{
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    heap_base(heap_base && rhs) BOOST_NOEXCEPT_IF(zr_boost_1_81::is_nothrow_move_constructible<Cmp>::value):
#ifndef BOOST_MSVC
    ...
    heap_base & operator=(heap_base && rhs) BOOST_NOEXCEPT_IF(zr_boost_1_81::is_nothrow_move_assignable<Cmp>::value)
    {
    ...
    void swap(heap_base & rhs) BOOST_NOEXCEPT_IF(zr_boost_1_81::is_nothrow_move_constructible<Cmp>::value && zr_boost_1_81::is_nothrow_move_assignable<Cmp>::value)
    {
    ...
    size_holder<constant_time_size, size_t>
{
    ...
    internal_type make_node(T const & val)
    {
        ...
        if (counter_ == (std::numeric_limits<stability_counter_type>::max)())
            BOOST_THROW_EXCEPTION(std::runtime_error("zr_boost_1_81::heap counter overflow"));
...
class stable_heap_iterator:
    public zr_boost_1_81::iterator_adaptor<stable_heap_iterator<T, ContainerIterator, Extractor>,
                                   ContainerIterator,
                                   T const,
                                   zr_boost_1_81::random_access_traversal_tag>
{
    typedef zr_boost_1_81::iterator_adaptor<stable_heap_iterator,
                                    ContainerIterator,
                                    T const,
                                    zr_boost_1_81::random_access_traversal_tag> super_t;
...
struct make_heap_base
{
    ...
    typedef typename parameter::binding<Parspec, tag::stability_counter_type, zr_boost_1_81::uintmax_t >::type stability_counter_type;
...
{
    typedef typename zr_boost_1_81::allocator_size_type<Alloc>::type size_type;
    typedef typename zr_boost_1_81::allocator_difference_type<Alloc>::type difference_type;
    typedef typename Alloc::value_type& reference;
    typedef typename Alloc::value_type const& const_reference;
    typedef typename zr_boost_1_81::allocator_pointer<Alloc>::type pointer;
    typedef typename zr_boost_1_81::allocator_const_pointer<Alloc>::type const_pointer;
};
