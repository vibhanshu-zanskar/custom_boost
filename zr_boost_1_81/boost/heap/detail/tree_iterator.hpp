...
struct unordered_tree_iterator_storage
{
    ...
    std::vector<HandleType, typename zr_boost_1_81::allocator_rebind<Alloc, HandleType>::type> data_;
};
    ...
    ValueExtractor
{
    ...
    std::priority_queue<HandleType,
                        std::vector<HandleType, typename zr_boost_1_81::allocator_rebind<Alloc, HandleType>::type>,
...
template <typename Node,
         ...
         >
class tree_iterator:
    public zr_boost_1_81::iterator_adaptor<tree_iterator<Node,
                                                 ValueType,
                                                 Alloc,
                                                 ValueExtractor,
                                                 PointerExtractor,
    ...
    PointerExtractor
{
    typedef zr_boost_1_81::iterator_adaptor<tree_iterator<Node,
                                                  ValueType,
                                                  Alloc,
                                                  ValueExtractor,
                                                  PointerExtractor,
    ...
    typedef typename zr_boost_1_81::conditional< ordered_iterator,
...
class recursive_tree_iterator:
    public zr_boost_1_81::iterator_adaptor<recursive_tree_iterator<Node,
                                                           NodeIterator,
                                                           ValueType,
                                                           ValueExtractor,
                                                           IteratorCoverter
...
{
    typedef zr_boost_1_81::iterator_adaptor<recursive_tree_iterator<Node,
                                                            NodeIterator,
                                                            ValueType,
                                                            ValueExtractor,
                                                            IteratorCoverter
                                    ...
                                    NodeIterator,
                                    ValueType const,
                                    zr_boost_1_81::bidirectional_traversal_tag> adaptor_type;
