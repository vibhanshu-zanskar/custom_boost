...
struct heap_node_base:
    bi::list_base_hook<typename zr_boost_1_81::conditional<auto_unlink,
...
{
    typedef typename zr_boost_1_81::allocator_pointer<Alloc>::type node_pointer;
    ...
    void operator()(NodeBase * base)
    {
        ...
        zr_boost_1_81::heap::detail::destroy_node(*n);
