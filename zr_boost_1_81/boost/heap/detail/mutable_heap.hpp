...
private:
    ...
    typedef std::list<node_type, typename zr_boost_1_81::allocator_rebind<allocator_type, node_type>::type> object_list;
...
public:
    ...
    class iterator_base:
        public zr_boost_1_81::iterator_adaptor<iterator_base<iterator_type>,
                                       iterator_type,
                                       value_type const,
                                       zr_boost_1_81::bidirectional_traversal_tag>
    {
        typedef zr_boost_1_81::iterator_adaptor<iterator_base<iterator_type>,
                                       iterator_type,
                                       value_type const,
                                       zr_boost_1_81::bidirectional_traversal_tag> super_t;
    ...
    class ordered_iterator:
        public zr_boost_1_81::iterator_adaptor<ordered_iterator,
                                       const_list_iterator,
                                       value_type const,
    ...
    {
        typedef zr_boost_1_81::iterator_adaptor<ordered_iterator,
                                        const_list_iterator,
                                        value_type const,
                                        zr_boost_1_81::forward_traversal_tag
                                      > adaptor_type;
    ...
    private:
        ...
        std::priority_queue<iterator,
                            std::vector<iterator, typename zr_boost_1_81::allocator_rebind<allocator_type, iterator>::type>,
                            indirect_cmp
                           > unvisited_nodes;
