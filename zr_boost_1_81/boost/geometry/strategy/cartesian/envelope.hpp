...
public:
    ...
    static inline typename zr_boost_1_81::range_iterator<Range const>::type begin(Range const& range)
    {
        return zr_boost_1_81::begin(range);
    }

    template <typename Range>
    static inline typename zr_boost_1_81::range_iterator<Range const>::type end(Range const& range)
    {
        return zr_boost_1_81::end(range);
    }
