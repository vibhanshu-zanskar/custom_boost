...
public:
    ...
    {
        return zr_boost_1_81::geometry::math::detail::equals_by_policy(a, b, policy);
    }
};
...
struct side_robust
{
    ...
    {
        using Policy = zr_boost_1_81::geometry::math::detail::equals_factor_policy<CT>;
...
public:
    ...
    {
        using vec2d = ::zr_boost_1_81::geometry::detail::precise_math::vec2d<PromotedType>;
        vec2d pa;
        pa.x = get<0>(p1);
        pa.y = get<1>(p1);
        vec2d pb;
        ...
        pc.x = get<0>(p);
        pc.y = get<1>(p);
        return ::zr_boost_1_81::geometry::detail::precise_math::orient2d
