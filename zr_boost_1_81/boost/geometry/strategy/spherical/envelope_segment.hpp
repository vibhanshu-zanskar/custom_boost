...
namespace zr_boost_1_81 { namespace geometry { namespace strategy { namespace envelope
{
...
private:
                                           ...
                                           Strategy const& strategy)
    {
        ...
        zr_boost_1_81::ignore_unused(lon1, lon2);
                                  ...
                                  Box& mbr)
    {
        ...
        geometry::set
            <
                min_corner, 0
            >(helper_mbr, zr_boost_1_81::numeric_cast<box_coordinate_type>(lon1));

        geometry::set
            <
                min_corner, 1
            >(helper_mbr, zr_boost_1_81::numeric_cast<box_coordinate_type>(lat1));

        geometry::set
            <
                max_corner, 0
            >(helper_mbr, zr_boost_1_81::numeric_cast<box_coordinate_type>(lon2));

        geometry::set
            <
                max_corner, 1
            >(helper_mbr, zr_boost_1_81::numeric_cast<box_coordinate_type>(lat2));
