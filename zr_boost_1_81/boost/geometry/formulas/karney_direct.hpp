...
public:
                                    ...
                                    Spheroid const& spheroid)
    {
        ...
        CT const cos_alpha0 = zr_boost_1_81::math::hypot(cos_alpha1, sin_alpha1 * sin_beta1);
        ...
        if (BOOST_GEOMETRY_CONDITION(CalcCoordinates))
        {
            ...
            CT const cos_beta2 = zr_boost_1_81::math::hypot(sin_alpha0, cos_alpha0 * cos_sigma2);
