...
namespace zr_boost_1_81 { namespace geometry { namespace math {
...
{
    auto res1 = zr_boost_1_81::geometry::detail::precise_math::two_sum(
    ...
    auto res2 = zr_boost_1_81::geometry::detail::precise_math::two_sum(
        res1[0] == 180 && res1[1] > 0 ? -180 : res1[0], res1[1]);
    e = res2[1];
    return res2[0];
}

}}} // namespace zr_boost_1_81::geometry::math
...
public:
    ...
    */
                                  ...
                                  CT const& f)
    {
        ...
        CT sin_sigma12 = zr_boost_1_81::math::hypot(sin_alpha1, cos_alpha1);
    ...
    */
                              ...
                              CoeffsC1 const& coeffs_C1)
    {
        ...
        CT cos_alpha0 = zr_boost_1_81::math::hypot(cos_alpha1, sin_alpha1 * sin_beta1);
