...
struct point_range
{
                             ...
                             Strategies const& strategies)
    {
        ...
        typedef typename zr_boost_1_81::range_size<Range>::type size_type;

        zr_boost_1_81::geometry::detail::throw_on_empty_input(rng);

        auto const strategy = strategies.distance(dummy_point(), dummy_point());

        size_type const n = zr_boost_1_81::size(rng);
...
struct range_range
{
                             ...
                             Strategies const& strategies)
    {
        ...
        zr_boost_1_81::geometry::detail::throw_on_empty_input(r1);
        zr_boost_1_81::geometry::detail::throw_on_empty_input(r2);

        size_type const n = zr_boost_1_81::size(r1);
        result_type dis_max = 0;

#ifdef BOOST_GEOMETRY_ENABLE_SIMILARITY_RTREE
        namespace bgi = zr_boost_1_81::geometry::index;
        typedef typename point_type<Range1>::type point_t;
        typedef bgi::rtree<point_t, bgi::linear<4> > rtree_type;
        rtree_type rtree(zr_boost_1_81::begin(r2), zr_boost_1_81::end(r2));
        point_t res;
#endif
                             ...
                             Strategies const& strategies)
    {
        typedef typename distance_result
            <
                ...
                Strategies
            >::type result_type;
        typedef typename zr_boost_1_81::range_size<Multi_range>::type size_type;

        zr_boost_1_81::geometry::detail::throw_on_empty_input(rng);
        zr_boost_1_81::geometry::detail::throw_on_empty_input(mrng);

        size_type b = zr_boost_1_81::size(mrng);
                             ...
                             Strategies const& strategies)
    {
        typedef typename distance_result
            <
                ...
                Strategies
            >::type result_type;
        typedef typename zr_boost_1_81::range_size<Multi_Range1>::type size_type;

        zr_boost_1_81::geometry::detail::throw_on_empty_input(mrng1);
        zr_boost_1_81::geometry::detail::throw_on_empty_input(mrng2);
        
        size_type n = zr_boost_1_81::size(mrng1);
        result_type haus_dis = 0;
