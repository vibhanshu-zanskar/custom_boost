...
{
    PointOut point_out;
    for(typename zr_boost_1_81::range_iterator<Range const>::type
        it = zr_boost_1_81::begin(range);
        it != zr_boost_1_81::end(range);
        ++it)
    {
...
struct transform_polygon
{
                ...
                Strategy const& strategy)
    {
        ...
        typename detail::interior_iterator<Polygon1 const>::type
            it1 = zr_boost_1_81::begin(rings1);
        typename detail::interior_iterator<Polygon2>::type
            it2 = zr_boost_1_81::begin(rings2);
        for ( ; it1 != zr_boost_1_81::end(rings1); ++it1, ++it2)
        {
...
struct transform<zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Geometry2>
{
    template <typename Strategy>
    ...
    {
        return zr_boost_1_81::apply_visitor(visitor<Strategy>(geometry2, strategy), geometry1);
    }
};
