...
struct num_interior_rings<Polygon, polygon_tag>
{
    ...
    {
        return zr_boost_1_81::size(geometry::interior_rings(polygon));
    }
...
struct num_interior_rings<zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
{
    struct visitor: zr_boost_1_81::static_visitor<std::size_t>
    {
        template <typename Geometry>
    ...
    {
        return zr_boost_1_81::apply_visitor(visitor(), geometry);
    }
};
