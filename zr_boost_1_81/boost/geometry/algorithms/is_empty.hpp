...
struct range_is_empty
{
    ...
    {
        return zr_boost_1_81::empty(range);
    }
};
...
class polygon_is_empty
{
    ...
    {
        return std::all_of(zr_boost_1_81::begin(interior_rings), zr_boost_1_81::end(interior_rings),
                           []( auto const& range ){ return zr_boost_1_81::empty(range); });
    }
...
public:
    ...
    {
        return zr_boost_1_81::empty(exterior_ring(polygon))
...
struct multi_is_empty
{
    ...
    {
        return std::all_of(zr_boost_1_81::begin(multigeometry), 
                           zr_boost_1_81::end(multigeometry), 
