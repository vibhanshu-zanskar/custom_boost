...
struct sectionalize_part
{
    ...
    {
        zr_boost_1_81::ignore_unused(robust_policy);

        using section_type = typename zr_boost_1_81::range_value<Sections>::type;
...
struct sectionalize_range
{
                             ...
                             std::size_t max_count)
    {
        ...
        std::size_t const n = zr_boost_1_81::size(view);
        if (n == 0)
        {
        ...
        sectionalize_part<DimensionVector>::apply(sections,
            zr_boost_1_81::begin(view), zr_boost_1_81::end(view),
...
struct sectionalize_polygon
{
                ...
                std::size_t max_count)
    {
        ...
        for (auto it = zr_boost_1_81::begin(rings); it != zr_boost_1_81::end(rings);
                         ...
                         std::size_t max_count = 10)
{
    ...
    zr_boost_1_81::geometry::sectionalize
        <
            Reverse, DimensionVector
