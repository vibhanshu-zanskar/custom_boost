...
class get_turns_in_sections
{
    ...
    using range1_iterator = typename zr_boost_1_81::range_iterator<range1_view const>::type;
    using range2_iterator = typename zr_boost_1_81::range_iterator<range2_view const>::type;
            ...
            signed_size_type index1, signed_size_type index2)
    {
        ...
        zr_boost_1_81::ignore_unused(n, index1, index2);
...
public :
    ...
    {
        zr_boost_1_81::ignore_unused(interrupt_policy);
        ...
        range1_iterator begin_range_1 = zr_boost_1_81::begin(view1);
        range1_iterator end_range_1 = zr_boost_1_81::end(view1);

        range2_iterator begin_range_2 = zr_boost_1_81::begin(view2);
        range2_iterator end_range_2 = zr_boost_1_81::end(view2);
            ...
            ++prev1, ++it1, ++index1, ++next1, ++ndi1)
        {
                ...
                ++prev2, ++it2, ++index2, ++next2, ++ndi2)
            {
                ...
                if (! skip)
                {
                    ...
                    typedef typename zr_boost_1_81::range_value<Turns>::type turn_info;
                    ...
                    std::size_t const size_before = zr_boost_1_81::size(turns);
...
private :
    ...
    static inline void get_start_point_iterator(Section const& section,
            Range const& range,
            typename zr_boost_1_81::range_iterator<Range const>::type& it,
            typename zr_boost_1_81::range_iterator<Range const>::type& prev,
            typename zr_boost_1_81::range_iterator<Range const>::type& end,
            signed_size_type& index, signed_size_type& ndi,
            int dir, Box const& other_bounding_box, RobustPolicy const& robust_policy)
    {
        it = zr_boost_1_81::begin(range) + section.begin_index;
        end = zr_boost_1_81::begin(range) + section.end_index + 1;
...
public:
            ...
            InterruptPolicy& interrupt_policy)
    {
        ...
        typedef typename zr_boost_1_81::range_value<Turns>::type ip_type;
...
struct get_turns_cs
{
    ...
    typedef zr_boost_1_81::array<box_point_type, 4> box_array;
    ...
    using iterator_type = typename zr_boost_1_81::range_iterator<view_type const>::type;
    ...
    struct unique_sub_range_from_view_policy
    {
        ...
        unique_sub_range_from_view_policy(view_type const& view, point_type const& pi, point_type const& pj, iterator_type it)
          ...
          , m_pi(pi)
          , m_pj(pj)
          , m_circular_iterator(zr_boost_1_81::begin(view), zr_boost_1_81::end(view), it, true)
        {
            ++m_circular_iterator;
        }
                ...
                signed_size_type ring_index = -1)
    {
        ...
        iterator_type it = zr_boost_1_81::begin(view);
...
struct get_turns_polygon_cs
{
            ...
            signed_size_type multi_index = -1)
    {
        ...
        for (typename detail::interior_iterator<Polygon const>::type
                it = zr_boost_1_81::begin(rings); it != zr_boost_1_81::end(rings); ++it, ++i)
        {
            intersector_type::apply(
                    source_id1, *it,
                    source_id2, box,
...
struct get_turns_multi_polygon_cs
{
            ...
            InterruptPolicy& interrupt_policy)
    {
        ...
        signed_size_type i = 0;
        for (iterator_type it = zr_boost_1_81::begin(multi);
             it != zr_boost_1_81::end(multi);
             ++it, ++i)
        {
            // Call its single version
            get_turns_polygon_cs
                <
                    typename zr_boost_1_81::range_value<Multi>::type, Box,
                    Reverse, ReverseBox,
                    TurnPolicy
