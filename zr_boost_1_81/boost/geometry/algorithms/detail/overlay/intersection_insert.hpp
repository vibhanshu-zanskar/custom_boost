...
struct intersection_linestring_linestring_point
{
            ...
            Strategy const& strategy)
    {
        ...
        for (typename zr_boost_1_81::range_iterator<std::deque<turn_info> const>::type
            it = zr_boost_1_81::begin(turns); it != zr_boost_1_81::end(turns); ++it)
        {
            PointOut p;
...
struct intersection_of_linestring_with_areal
{
            ...
            Strategy const& strategy)
    {
        ...
        if (zr_boost_1_81::size(linestring) == 0)
        {
            return out;
        }
    ...
    : detail::expect_output<PointLike1, PointLike2, TupledOut, point_tag>
{
    ...
    static inline OutputIterators apply(PointLike1 const& pointlike1,
                                        ...
                                        Strategy const& strategy)
    {
        namespace bgt = zr_boost_1_81::geometry::tuples;
