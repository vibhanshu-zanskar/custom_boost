...
namespace dispatch
{
    ...
    struct select_rings<multi_polygon_tag, Multi>
    {
                    ...
                    Strategy const& strategy)
        {
            ...
            typedef select_rings<polygon_tag, typename zr_boost_1_81::range_value<Multi>::type> per_polygon;

            id.multi_index = 0;
            for (iterator_type it = zr_boost_1_81::begin(multi); it != zr_boost_1_81::end(multi); ++it)
            {
                id.ring_index = -1;
            ...
            Strategy const& strategy)
{
    ...
    for (typename RingPropertyMap::const_iterator it = zr_boost_1_81::begin(all_ring_properties);
        it != zr_boost_1_81::end(all_ring_properties);
        ++it)
    {
