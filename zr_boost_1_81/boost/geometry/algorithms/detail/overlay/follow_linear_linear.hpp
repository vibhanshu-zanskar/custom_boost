                ...
                SideStrategy const& strategy)
    {
        if ( action::is_entered(entered) )
        {
            ...
            detail::copy_segments::copy_segments_linestring
                ...
                >::apply(linestring,
                         current_segment_id,
                         static_cast<signed_size_type>(zr_boost_1_81::size(linestring) - 1),
                         strategy,
                         robust_policy,
                         current_piece);
        }
        ...
        if (::zr_boost_1_81::size(current_piece) > 1)
        {
...
public:
          ...
          SideStrategy const& strategy)
    {
        ...
        {
            oit = process_turn(it, zr_boost_1_81::begin(it->operations),
                               entered, enter_count, 
                               linestring,
...
{
protected:
    typedef typename zr_boost_1_81::range_value<MultiLinestring>::type Linestring;
    ...
    {
        return zr_boost_1_81::begin(it->operations)->seg_id.multi_index;
    }
    ...
    public:
        ...
        {
            return zr_boost_1_81::begin(turn.operations)->seg_id.multi_index
                != m_multi_id;
        }
    };
...
public:
          ...
          SideStrategy const& strategy)
    {
        ...
        linestring_iterator ls_first = zr_boost_1_81::begin(multilinestring);
        linestring_iterator ls_beyond = zr_boost_1_81::end(multilinestring);
