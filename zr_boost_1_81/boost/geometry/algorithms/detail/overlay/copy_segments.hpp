...
struct copy_segments_ring
{
            ...
            RangeOut& current_output)
    {
        ...
        using iterator = typename zr_boost_1_81::range_iterator<view_type const>::type;
        ...
        // Sanity check
        BOOST_GEOMETRY_ASSERT(from_index < static_cast<signed_size_type>(zr_boost_1_81::size(view)));

        ec_iterator it(zr_boost_1_81::begin(view), zr_boost_1_81::end(view),
                    zr_boost_1_81::begin(view) + from_index);
        ...
        signed_size_type const count = from_index <= to_index
            ...
            : static_cast<signed_size_type>(zr_boost_1_81::size(view))
...
public:
            ...
            RangeOut& current_output)
    {
        ...
        if ( from_index > to_index
          || from_index < 0
          || to_index >= static_cast<signed_size_type>(zr_boost_1_81::size(ls)) )
        {
            return;
        }
        ...
        typename zr_boost_1_81::range_iterator<LineString const>::type
            it = zr_boost_1_81::begin(ls) + from_index;
...
struct copy_segments_box
{
            ...
            RangeOut& current_output)
    {
        ...
        zr_boost_1_81::array<typename point_type<Box>::type, 5> bp;
            ...
            RangeOut& current_output)
    {
        ...
        BOOST_GEOMETRY_ASSERT
            (
                ...
                && static_cast<std::size_t>(seg_id.multi_index) < zr_boost_1_81::size(multi_geometry)
            );
