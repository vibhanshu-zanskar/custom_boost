            ...
            Strategy const& strategy)
{
...

    {
        ...
        typedef typename zr_boost_1_81::range_iterator<vector_type const>::type vector_iterator_type;
        ...
        for (map_iterator_type it = zr_boost_1_81::begin(ring_map);
            it != zr_boost_1_81::end(ring_map); ++it, ++index)
        {
        ...
        if (! check_for_orientation)
        {
            ...
            if (count_positive == 1 && ! is_difference && ! is_dissolve)
            {
                ...
                index = 0;
                for (vector_iterator_type it = zr_boost_1_81::begin(vector);
                    it != zr_boost_1_81::end(vector); ++it, ++index)
                {
    ...
    {
        for (map_iterator_type it = zr_boost_1_81::begin(ring_map);
            it != zr_boost_1_81::end(ring_map); ++it)
        {
