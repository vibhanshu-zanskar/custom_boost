...
{
    typedef typename zr_boost_1_81::range_value<Turns>::type tp_type;
    ...
    for (typename zr_boost_1_81::range_iterator<Turns>::type
        ...
        ++it)
    {
        for (typename zr_boost_1_81::range_iterator
            <
                typename tp_type::container_type
            >::type op_it = zr_boost_1_81::begin(it->operations);
            op_it != zr_boost_1_81::end(it->operations);
            ++op_it)
        {
            op_it->visited.clear();
        }
...
public :
    ...
    static inline void apply(std::size_t size_at_start,
                             ...
                             Ring& ring,
                             Turns& turns,
                             typename zr_boost_1_81::range_value<Turns>::type const& turn,
                             Operation& operation,
                             ...
                             Visitor& visitor)
    {
        ...
        geometry::traits::clear<typename zr_boost_1_81::range_value<Rings>::type>::apply(ring);
...
public :
    ...
    static inline void apply(std::size_t size_at_start,
                Rings& rings, typename zr_boost_1_81::range_value<Rings>::type& ring,
