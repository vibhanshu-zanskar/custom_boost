...
public :
    ...
    static inline OutputIterator apply(LineString const& linestring, Polygon const& polygon,
                ...
                Strategy const& strategy)
    {
        typedef typename zr_boost_1_81::range_iterator<Turns>::type turn_iterator;
        ...
        typedef relate::turns::less
            ...
            > turn_less;
        std::sort(zr_boost_1_81::begin(turns), zr_boost_1_81::end(turns), turn_less());
        ...
        bool entered = false;
        bool first = true;
        for (turn_iterator it = zr_boost_1_81::begin(turns); it != zr_boost_1_81::end(turns); ++it)
        {
            turn_operation_iterator_type iit = zr_boost_1_81::begin(it->operations);
        ...
        std::size_t current_piece_size = ::zr_boost_1_81::size(current_piece);
