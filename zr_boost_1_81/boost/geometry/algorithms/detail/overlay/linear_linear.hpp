    ...
    >
{
    ...
    static inline OutputIterator apply(MultiLineString const& multilinestring,
                                       OutputIterator oit)
    {
        for (typename zr_boost_1_81::range_iterator<MultiLineString const>::type
                 it = zr_boost_1_81::begin(multilinestring);
             it != zr_boost_1_81::end(multilinestring); ++it)
        {
            LineStringOut ls_out;
...
protected:
                          ...
                          Strategy const& strategy)
    {
        ...
        std::sort(zr_boost_1_81::begin(turns), zr_boost_1_81::end(turns),
        ...
        return detail::overlay::following::linear::follow
            <
                ...
                !EnableFilterContinueTurns || OverlayType == overlay_intersection
            >::apply(linear1, linear2, zr_boost_1_81::begin(turns), zr_boost_1_81::end(turns),
                     oit, strategy);
    }
