                   ...
                   OtherBoundaryChecker const& /*other_boundary_checker*/)
        {
                ...
                || m_degenerated_turn_ptr )
            {
                ...
                if ( turn_ptr )
                {
                    ...
                    //BOOST_GEOMETRY_ASSERT(!zr_boost_1_81::empty(sub_range(geometry, prev_seg_id)));
                                ...
                                bool first_in_range)
        {
            ...
            if ( turn.operations[op_id].position == overlay::position_front )
            {
                ...
                if ( zr_boost_1_81::size(ls2) == 2 )
                {
                    ...
                    m_degenerated_turn_ptr = zr_boost_1_81::addressof(turn);
                }
            }
            else if ( turn.operations[op_id].position == overlay::position_back )
            {
                ...
                if ( zr_boost_1_81::size(ls2) == 2 )
                {
                    ...
                    if ( first_in_range )
                    {
                        //BOOST_GEOMETRY_ASSERT(!zr_boost_1_81::empty(ls1));
                        bool const front_b = boundary_checker.is_endpoint_boundary(
                                                range::front(ls1));
                        if ( front_b )
                        {
                   ...
                   && turn.operations[other_op_id].position == overlay::position_middle )
            {
                ...
                bool const is_point1 = zr_boost_1_81::size(ls1) == 2
                                    && equals::equals_point_point(range::front(ls1),
                                                                  range::back(ls1),
                                                                  boundary_checker.strategy());
                bool const is_point2 = zr_boost_1_81::size(ls2) == 2
