                                             ...
                                             EqPPStrategy const& strategy)
{
    ...
    typedef typename zr_boost_1_81::range_iterator<MultiPoint const>::type iterator;
    iterator it = zr_boost_1_81::begin(multi_point);
    iterator last = zr_boost_1_81::end(multi_point);
    for ( ; it != last ; ++it )
    {
...
struct point_multipoint
{
    ...
    static inline void apply(Point const& point, MultiPoint const& multi_point,
                             ...
                             Strategy const& strategy)
    {
        if ( zr_boost_1_81::empty(multi_point) )
        {
...
struct multipoint_multipoint
{
                             ...
                             Strategy const& /*strategy*/)
    {
        ...
        {
            // TODO: throw on empty input?
            bool empty1 = zr_boost_1_81::empty(multi_point1);
            bool empty2 = zr_boost_1_81::empty(multi_point2);
            if ( empty1 && empty2 )
            {
                return;
            }
        ...
        if ( zr_boost_1_81::size(multi_point1) < zr_boost_1_81::size(multi_point2) )
        {
                              ...
                              Result & result)
    {
        ...
        std::vector<point_type> points(zr_boost_1_81::begin(sorted_mpt), zr_boost_1_81::end(sorted_mpt));
        ...
        typedef typename zr_boost_1_81::range_iterator<IteratedMultiPoint const>::type iterator;
        for ( iterator it = zr_boost_1_81::begin(iterated_mpt) ;
              it != zr_boost_1_81::end(iterated_mpt) ; ++it )
        {
            bool ii =
