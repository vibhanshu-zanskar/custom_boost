...
struct multi_point_geometry_eb<Geometry, multi_linestring_tag>
{
                             ...
                             detail::relate::topology_check<Geometry, Strategy> const& tc)
    {
        ...
        points_type points(zr_boost_1_81::begin(multi_point), zr_boost_1_81::end(multi_point));        
...
class multi_point_multi_geometry_ii_ib
{
    ...
    public:
        ...
        inline bool apply(Point const& point, BoxPair const& box_pair)
        {
            ...
            {
                typename zr_boost_1_81::range_value<MultiGeometry>::type const&
...
struct multi_point_multi_geometry_ii_ib_ie
{
                             ...
                             Strategy const& strategy)
    {
        ...
        for ( iterator it = zr_boost_1_81::begin(multi_point) ; it != zr_boost_1_81::end(multi_point) ; ++it )
        {
            ...
            typename zr_boost_1_81::range_value<MultiPoint>::type const& point = *it;
