...
struct initialization_visitor
{
                             ...
                             EventVisitor&)
    {
        ...
        PriorityQueue pq(zr_boost_1_81::begin(range), zr_boost_1_81::end(range));
        std::swap(pq, queue);
    }
};
...
inline typename zr_boost_1_81::range_value<RangeOfIntervals>::type::difference_type
maximum_gap(RangeOfIntervals const& range_of_intervals,
            T& max_gap_left, T& max_gap_right)
{
    typedef typename zr_boost_1_81::range_value<RangeOfIntervals>::type interval_type;
