...
struct convex_hull_out<OutputGeometry, multi_polygon_tag>
{
    ...
    static inline void apply(Geometry const& geometry,
                             ...
                             Strategies const& strategies)
    {
        typename zr_boost_1_81::range_value<OutputGeometry>::type polygon;
...
struct convex_hull_out<OutputGeometry, geometry_collection_tag>
{
                             ...
                             Strategies const& strategies)
    {
        ...
        if (zr_boost_1_81::size(out_ring) == detail::minimum_ring_size<polygonal_t>::value)
        {
...
private:
    ...
    {
        std::move(zr_boost_1_81::begin(out_range), zr_boost_1_81::begin(out_range) + 2, range::back_inserter(ls));
    }
    ...
    {
        typename zr_boost_1_81::range_value<Linear>::type ls;
        std::move(zr_boost_1_81::begin(out_range), zr_boost_1_81::begin(out_range) + 2, range::back_inserter(ls));
