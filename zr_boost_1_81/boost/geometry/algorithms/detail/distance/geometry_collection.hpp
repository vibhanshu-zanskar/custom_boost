                                     ...
                                     Strategies const& strategies)
{
    ...
    using rtree_value_t = std::pair<box1_t, typename zr_boost_1_81::range_iterator<GeometryCollection1 const>::type>;
    ...
    >
{
                             ...
                             Strategies const& strategies)
    {
        ...
        return zr_boost_1_81::size(collection1) <= zr_boost_1_81::size(collection2)
