...
public:
                                    ...
                                    bool check_intersection = true)
    {
        ...
        typedef typename zr_boost_1_81::range_const_iterator
            <
                std::vector<segment_or_box_point>
        ...
        seg_or_box_const_iterator it_min1 = zr_boost_1_81::const_begin(seg_or_box_points);
             ...
             pit != points_end(geometry); ++pit, first = false)
        {
            ...
            std::pair
                ...
                = point_to_point_range::apply(*pit,
                                              zr_boost_1_81::const_begin(seg_or_box_points),
                                              zr_boost_1_81::const_end(seg_or_box_points),
                                              cstrategy,
                                              cd);
        ...
        first = true;
        for (seg_or_box_const_iterator it = zr_boost_1_81::const_begin(seg_or_box_points);
             it != zr_boost_1_81::const_end(seg_or_box_points); ++it, first = false)
        {
            comparable_return_type cd;
                                    ...
                                    Strategies const& strategies)
    {
        ...
        iterator_type it_min
            = geometry_to_range::apply(segment_or_box,
                                       zr_boost_1_81::begin(multipoint),
