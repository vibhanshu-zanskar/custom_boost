                                    ...
                                    Strategies const& strategies)
    {
        if (zr_boost_1_81::size(multipoint2) < zr_boost_1_81::size(multipoint1))
        {
            return point_or_segment_range_to_geometry_rtree
                <
                    typename zr_boost_1_81::range_iterator<MultiPoint2 const>::type,
                    MultiPoint1,
                    Strategies
                >::apply(zr_boost_1_81::begin(multipoint2),
        ...
        return point_or_segment_range_to_geometry_rtree
            <
                typename zr_boost_1_81::range_iterator<MultiPoint1 const>::type,
                MultiPoint2,
                Strategies
            >::apply(zr_boost_1_81::begin(multipoint1),
...
struct multipoint_to_linear
{
                             ...
                             Strategies const& strategies)
    {
        return detail::distance::point_or_segment_range_to_geometry_rtree
            <
                typename zr_boost_1_81::range_iterator<MultiPoint const>::type,
                Linear,
                Strategies
            >::apply(zr_boost_1_81::begin(multipoint),
                     zr_boost_1_81::end(multipoint),
                     linear,
                     strategies);
    }
...
public:
                                    ...
                                    Strategies const& strategies)
    {
        ...
        if (! zr_boost_1_81::empty(multipoint) && 
            std::none_of(zr_boost_1_81::begin(multipoint), zr_boost_1_81::end(multipoint), predicate))
        {
            return detail::distance::point_or_segment_range_to_geometry_rtree
                <
                    typename zr_boost_1_81::range_iterator<MultiPoint const>::type,
