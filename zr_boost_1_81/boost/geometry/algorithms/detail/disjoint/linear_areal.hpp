...
struct disjoint_no_intersections_policy<Geometry1, Geometry2, Tag1, multi_tag>
{
    ...
    */
    ...
    static inline bool apply(Geometry1 const& g1, Geometry2 const& g2, Strategy const& strategy)
    {
        ...
        typedef typename zr_boost_1_81::range_iterator<Geometry1 const>::type iterator;
        for ( iterator it = zr_boost_1_81::begin(g1) ; it != zr_boost_1_81::end(g1) ; ++it )
        {
            typedef typename zr_boost_1_81::range_value<Geometry1 const>::type value_type;
...
class disjoint_segment_areal<Segment, Polygon, polygon_tag>
{
    ...
    {
        using ring_type = typename zr_boost_1_81::range_value<InteriorRings>::type;
        ...
        return std::all_of(zr_boost_1_81::begin(interior_rings),
                           zr_boost_1_81::end(interior_rings),
