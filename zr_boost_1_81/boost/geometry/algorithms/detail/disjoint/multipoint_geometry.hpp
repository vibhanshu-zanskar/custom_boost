...
public:
    ...
    static inline bool apply(MultiPoint1 const& multipoint1,
                             ...
                             Strategy const&)
    {
        BOOST_GEOMETRY_ASSERT( zr_boost_1_81::size(multipoint1) <= zr_boost_1_81::size(multipoint2) );

        using cs_tag = typename Strategy::cs_tag;
        using less_type = geometry::less<void, -1, cs_tag>;
        using point1_type = typename zr_boost_1_81::range_value<MultiPoint1>::type;

        std::vector<point1_type> points1(zr_boost_1_81::begin(multipoint1),
                                         zr_boost_1_81::end(multipoint1));
        ...
        return none_of(zr_boost_1_81::begin(multipoint2),
                       zr_boost_1_81::end(multipoint2),
...
public:
                             ...
                             Strategy const& strategy)
    {
        ...
        typedef typename zr_boost_1_81::range_const_iterator<MultiPoint>::type iterator;
        for ( iterator it = zr_boost_1_81::begin(multi_point) ; it != zr_boost_1_81::end(multi_point) ; ++it )
        {
...
private:
    ...
    public:
        ...
        {
            typedef typename zr_boost_1_81::range_value<MultiGeometry>::type single_type;
...
public:
    ...
    static inline bool apply(MultiPoint const& multi_point, MultiGeometry const& multi_geometry, Strategy const& strategy)
    {
        ...
        std::size_t count2 = zr_boost_1_81::size(multi_geometry);
    ...
    >
{
    ...
    static inline bool apply(MultiPoint1 const& multipoint1,
                             ...
                             Strategy const& strategy)
    {
        if ( zr_boost_1_81::size(multipoint2) < zr_boost_1_81::size(multipoint1) )
        {
