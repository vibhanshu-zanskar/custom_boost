...
struct range_to_range
{
            ...
            Strategy const& strategy)
    {
        ...
        for (typename zr_boost_1_81::range_iterator<Range2 const>::type it
                = zr_boost_1_81::begin(source);
            it != zr_boost_1_81::end(source);
            ++it)
        {
            point_type p;
...
private:
                    ...
                    Strategy const& strategy)
    {
        traits::resize<InteriorRingsOut>::apply(interior_rings_out,
            zr_boost_1_81::size(interior_rings_in));

        iterate(
            zr_boost_1_81::begin(interior_rings_in), zr_boost_1_81::end(interior_rings_in),
            zr_boost_1_81::begin(interior_rings_out),
            strategy);
    }
