...
public:
    ...
    {
        BOOST_GEOMETRY_ASSERT(zr_boost_1_81::size(m_linestring) > 1);
        return m_is_closed
            && turn.method == overlay::method_none
            && check_segment_indices(turn, zr_boost_1_81::size(m_linestring) - 2)
...
private:
    ...
    {
        BOOST_GEOMETRY_ASSERT(zr_boost_1_81::size(linestring) > 1);
    ...
    inline bool is_closing_point_of(Turn const& turn, Linestring const& linestring) const
    {
        ...
        return turn.method == overlay::method_none
            && check_segment_indices(turn, zr_boost_1_81::size(linestring) - 2)
...
public:
    ...
    inline bool apply(Turn const& turn) const
    {
        typedef typename zr_boost_1_81::range_value<MultiLinestring>::type linestring_type;
        ...
        return
            ...
            &&
            ( zr_boost_1_81::size(ls1) != 2
              || zr_boost_1_81::size(ls2) != 2
...
struct is_simple_linestring
{
                             ...
                             Strategy const& strategy)
    {
        ...
        return ! zr_boost_1_81::empty(linestring)
...
public:
                             ...
                             Strategy const& strategy)
    {
        ...
        if (std::any_of(zr_boost_1_81::begin(multilinestring),
