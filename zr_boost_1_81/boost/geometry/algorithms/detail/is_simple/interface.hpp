...
struct is_simple<zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
{
    template <typename Strategy>
    struct visitor : zr_boost_1_81::static_visitor<bool>
    {
    ...
    apply(zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const& geometry,
          Strategy const& strategy)
    {
        return zr_boost_1_81::apply_visitor(visitor<Strategy>(strategy), geometry);
    }
};
