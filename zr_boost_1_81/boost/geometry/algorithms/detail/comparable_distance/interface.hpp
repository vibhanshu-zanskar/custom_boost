...
struct comparable_distance
    <
        zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)>,
        Geometry2
    >
{
    template <typename Strategy>
    ...
    static inline typename comparable_distance_result
        <
            ...
            Strategy
        >::type
    apply(zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const& geometry1,
          Geometry2 const& geometry2,
          Strategy const& strategy)
    {
    ...
    >
{
    ...
    static inline typename comparable_distance_result
        ...
        >::type
    apply(Geometry1 const& geometry1,
          zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const& geometry2,
          Strategy const& strategy)
    {
        return zr_boost_1_81::apply_visitor(visitor<Strategy>(geometry1, strategy), geometry2);
    }
};
...
struct comparable_distance
    <
        zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T1)>,
        zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T2)>
    >
{
    template <typename Strategy>
    struct visitor: static_visitor
    ...
    static inline typename comparable_distance_result
        <
            ...
            Strategy
        >::type
    apply(zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T1)> const& geometry1,
          zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T2)> const& geometry2,
          Strategy const& strategy)
    {
        return zr_boost_1_81::apply_visitor(visitor<Strategy>(strategy), geometry1, geometry2);
    }
};
