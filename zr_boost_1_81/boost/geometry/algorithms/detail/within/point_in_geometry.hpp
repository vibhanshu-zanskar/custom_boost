...
int point_in_range(Point const& point, Range const& range, Strategy const& strategy)
{
    ...
    typedef typename zr_boost_1_81::range_iterator<Range const>::type iterator_type;
    iterator_type it = zr_boost_1_81::begin(range);
    iterator_type end = zr_boost_1_81::end(range);
...
struct point_in_geometry<Linestring, linestring_tag>
{
    ...
    {
        std::size_t count = zr_boost_1_81::size(linestring);
        if ( count > 1 )
        {
...
struct point_in_geometry<Ring, ring_tag>
{
    ...
    {
        if ( zr_boost_1_81::size(ring) < core_detail::closure::minimum_ring_size
                                    <
                            ...
                            Strategy const& strategy)
    {
        ...
        if (code == 1)
        {
            ...
            for (typename detail::interior_iterator<Polygon const>::type
                 it = zr_boost_1_81::begin(rings);
                 it != zr_boost_1_81::end(rings);
                 ++it)
            {
...
struct point_in_geometry<Geometry, multi_point_tag>
{
    ...
    {
        typedef typename zr_boost_1_81::range_value<Geometry>::type point_type;
        typedef typename zr_boost_1_81::range_const_iterator<Geometry>::type iterator;
...
struct point_in_geometry<Geometry, multi_linestring_tag>
{
    ...
    int apply(Point const& point, Geometry const& geometry, Strategy const& strategy)
    {
        ...
        typedef typename zr_boost_1_81::range_value<Geometry>::type linestring_type;
        typedef typename zr_boost_1_81::range_value<linestring_type>::type point_type;
        typedef typename zr_boost_1_81::range_iterator<Geometry const>::type iterator;
        iterator it = zr_boost_1_81::begin(geometry);
        for ( ; it != zr_boost_1_81::end(geometry) ; ++it )
        {
...
struct point_in_geometry<Geometry, multi_polygon_tag>
{
    ...
    int apply(Point const& point, Geometry const& geometry, Strategy const& strategy)
    {
        ...
        typedef typename zr_boost_1_81::range_value<Geometry>::type polygon_type;
        typedef typename zr_boost_1_81::range_const_iterator<Geometry>::type iterator;
        for ( iterator it = zr_boost_1_81::begin(geometry) ; it != zr_boost_1_81::end(geometry) ; ++it )
        {
