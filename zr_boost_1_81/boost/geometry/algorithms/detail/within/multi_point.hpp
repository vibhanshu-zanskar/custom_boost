...
struct multi_point_multi_point
{
                             ...
                             Strategy const& /*strategy*/)
    {
        ...
        std::vector<point2_type> points2(zr_boost_1_81::begin(multi_point2), zr_boost_1_81::end(multi_point2));
        std::sort(points2.begin(), points2.end(), less);

        bool result = false;

        typedef typename zr_boost_1_81::range_const_iterator<MultiPoint1>::type iterator;
        for ( iterator it = zr_boost_1_81::begin(multi_point1) ; it != zr_boost_1_81::end(multi_point1) ; ++it )
        {
...
struct multi_point_single_geometry
{
    ...
    static inline bool apply(MultiPoint const& multi_point,
                             ...
                             Strategy const& strategy)
    {
        //typedef typename zr_boost_1_81::range_value<MultiPoint>::type point1_type;
...
struct multi_point_multi_geometry
{
                             ...
                             Strategy const& strategy)
    {
        ...
        std::size_t count2 = zr_boost_1_81::size(linear_or_areal);
