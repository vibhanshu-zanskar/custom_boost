                              ...
                              bool const group_self = false)
{
    ...
    {
        for (std::size_t i = 0; i < zr_boost_1_81::size(gc1_view); ++i)
        {
            ...
            }, zr_boost_1_81::begin(gc1_view) + i);
        }
    }
    ...
    std::array<std::vector<bool>, 2> visited = {
        std::vector<bool>(zr_boost_1_81::size(gc1_view), false),
        std::vector<bool>(zr_boost_1_81::size(gc2_view), false)
    };        
