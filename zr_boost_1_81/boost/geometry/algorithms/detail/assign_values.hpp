...
inline void assign_box_2d_corner(Box const& box, Point& point)
{
    ...
    geometry::set<0>(point, zr_boost_1_81::numeric_cast<coordinate_type>(get<Corner1, 0>(box)));
    geometry::set<1>(point, zr_boost_1_81::numeric_cast<coordinate_type>(get<Corner2, 1>(box)));
}
...
struct assign_2d_box_or_segment
{
    ...
    {
        geometry::set<0, 0>(geometry, zr_boost_1_81::numeric_cast<coordinate_type>(x1));
        geometry::set<0, 1>(geometry, zr_boost_1_81::numeric_cast<coordinate_type>(y1));
        geometry::set<1, 0>(geometry, zr_boost_1_81::numeric_cast<coordinate_type>(x2));
        geometry::set<1, 1>(geometry, zr_boost_1_81::numeric_cast<coordinate_type>(y2));
    }
};
...
struct assign<point_tag, Point, 2>
{
    ...
    {
        set<0>(point, zr_boost_1_81::numeric_cast<coordinate_type>(c1));
        set<1>(point, zr_boost_1_81::numeric_cast<coordinate_type>(c2));
    }
};
...
struct assign<point_tag, Point, 3>
{
    ...
    static inline void apply(Point& point, T const& c1, T const& c2, T const& c3)
    {
        set<0>(point, zr_boost_1_81::numeric_cast<coordinate_type>(c1));
        set<1>(point, zr_boost_1_81::numeric_cast<coordinate_type>(c2));
        set<2>(point, zr_boost_1_81::numeric_cast<coordinate_type>(c3));
    }
};
