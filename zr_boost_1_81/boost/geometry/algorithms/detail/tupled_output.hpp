            ...
            (util::is_multi<T>::value
                ...
                (util::is_not_geometry<T>::value
                    ...
                    util::is_multi_element
                        <
                            typename zr_boost_1_81::range_value<T>::type
                        >::value))
        >
{};
...
// true if Output is zr_boost_1_81::tuple, zr_boost_1_81::tuples::cons, std::pair or std::tuple
...
// true if T is zr_boost_1_81::tuple, zr_boost_1_81::tuples::cons, std::pair or std::tuple
...
{
    typedef std::tuple<typename zr_boost_1_81::range_value<Ts>::type...> type;
};
...
struct tupled_range_values<std::pair<F, S> >
{
    typedef std::pair
        <
            typename zr_boost_1_81::range_value<F>::type,
            typename zr_boost_1_81::range_value<S>::type
        > type;
};
...
<
    typename Tuple,
    size_t I = 0,
    size_t N = zr_boost_1_81::tuples::length<Tuple>::value
>
struct tupled_range_values_bt
{
    typedef zr_boost_1_81::tuples::cons
        <
            typename zr_boost_1_81::range_value
                <
                    typename zr_boost_1_81::tuples::element<I, Tuple>::type
                >::type,
...
{
    typedef zr_boost_1_81::tuples::null_type type;
};

template <typename ...Ts>
struct tupled_range_values<zr_boost_1_81::tuples::tuple<Ts...>>
    : tupled_range_values_bt<zr_boost_1_81::tuples::tuple<Ts...>>
{};

template <typename HT, typename TT>
struct tupled_range_values<zr_boost_1_81::tuples::cons<HT, TT>>
    : tupled_range_values_bt<zr_boost_1_81::tuples::cons<HT, TT>>
{};
...
struct tupled_back_inserters_bt
{
    ...
    {
        return type(geometry::range::back_inserter(zr_boost_1_81::get<I>(tup)),
...
template <typename ...Ts>
struct tupled_back_inserters<zr_boost_1_81::tuples::tuple<Ts...>>
    : tupled_back_inserters_bt<zr_boost_1_81::tuples::tuple<Ts...>>
{};

template <typename HT, typename TT>
struct tupled_back_inserters<zr_boost_1_81::tuples::cons<HT, TT>>
    : tupled_back_inserters_bt<zr_boost_1_81::tuples::cons<HT, TT>>
{};
...
struct output_geometry_value
    : zr_boost_1_81::range_value<GeometryOut>
{};
...
template <typename ...Ts>
struct output_geometry_concept_check<zr_boost_1_81::tuple<Ts...> >
    : output_geometry_concept_check_t<zr_boost_1_81::tuple<Ts...> >
{};

template <typename HT, typename TT>
struct output_geometry_concept_check<zr_boost_1_81::tuples::cons<HT, TT> >
    : output_geometry_concept_check_t<zr_boost_1_81::tuples::cons<HT, TT> >
{};
...
struct convert_to_output<Geometry, SingleOut, true>
{
    ...
    static OutputIterator apply(Geometry const& geometry,
                                OutputIterator oit)
    {
        typedef typename zr_boost_1_81::range_iterator<Geometry const>::type iterator;
        for (iterator it = zr_boost_1_81::begin(geometry); it != zr_boost_1_81::end(geometry); ++it)
        {
            SingleOut single_out;
