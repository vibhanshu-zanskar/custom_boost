    ...
    struct has_property_per_polygon
    {
                                 ...
                                 Strategy const& strategy)
        {
                 ...
                 ++it, ++multi_index)
            {
                ...
                typedef zr_boost_1_81::filter_iterator
                    <
...
public:
                             ...
                             Strategy const& strategy)
    {
        ...
        if (BOOST_GEOMETRY_CONDITION(AllowEmptyMultiGeometries)
            && zr_boost_1_81::empty(multipolygon))
        {
            return visitor.template apply<no_failure>();
        }
        ...
        if (std::any_of(zr_boost_1_81::begin(multipolygon), zr_boost_1_81::end(multipolygon),
        ...
        if (! have_holes_inside(zr_boost_1_81::begin(multipolygon),
        ...
        if (! have_connected_interior(zr_boost_1_81::begin(multipolygon),
                                      zr_boost_1_81::end(multipolygon),
                                      turns.begin(),
                                      turns.end(),
                                      visitor,
        ...
        debug_phase::apply(5);
        return are_polygon_interiors_disjoint(zr_boost_1_81::begin(multipolygon),
                                              zr_boost_1_81::end(multipolygon),
                                              turns.begin(),
                                              turns.end(),
                                              visitor,
