                                ...
                                OverlapsPolicy const& overlaps_policy)
{
    ...
    for(it_type it = zr_boost_1_81::begin(input); it != zr_boost_1_81::end(input); ++it)
    {
...
{
    typedef typename zr_boost_1_81::range_iterator<IteratorVector const>::type it_type;
    for(it_type it = zr_boost_1_81::begin(input); it != zr_boost_1_81::end(input); ++it)
    {
...
inline bool handle_one(IteratorVector const& input, VisitPolicy& visitor)
{
    ...
    for (it_type it1 = zr_boost_1_81::begin(input); it1 != zr_boost_1_81::end(input); ++it1)
    {
        it_type it2 = it1;
        for (++it2; it2 != zr_boost_1_81::end(input); ++it2)
        {
                       ...
                       VisitPolicy& visitor)
{
    ...
    if (zr_boost_1_81::empty(input1) || zr_boost_1_81::empty(input2))
    {
        return true;
    }

    for(iterator_type1 it1 = zr_boost_1_81::begin(input1);
        it1 != zr_boost_1_81::end(input1);
        ++it1)
    {
        for(iterator_type2 it2 = zr_boost_1_81::begin(input2);
            it2 != zr_boost_1_81::end(input2);
            ++it2)
        {
            if (! visitor.apply(**it1, **it2))
            {
...
{
    return zr_boost_1_81::size(input) >= min_elements
        && level < 100;
}
...
inline bool recurse_ok(IteratorVector1 const& input1,
                       ...
                       std::size_t min_elements, std::size_t level)
{
    return zr_boost_1_81::size(input1) >= min_elements
...
public :
                             ...
                             VisitBoxPolicy& box_policy)
    {
        ...
        if (! zr_boost_1_81::empty(exceeding))
        {
...
public :
                             ...
                             VisitBoxPolicy& box_policy)
    {
        ...
        if (! zr_boost_1_81::empty(exceeding1))
        {
        ...
        if (! zr_boost_1_81::empty(exceeding2))
        {
...
class partition
{
    ...
    static inline void expand_to_range(ForwardRange const& forward_range,
                                       ...
                                       ExpandPolicy const& expand_policy)
    {
        for(typename zr_boost_1_81::range_iterator<ForwardRange const>::type
                it = zr_boost_1_81::begin(forward_range);
            it != zr_boost_1_81::end(forward_range);
            ++it)
        {
...
public:
                             ...
                             VisitBoxPolicy box_visitor)
    {
        ...
        if (std::size_t(zr_boost_1_81::size(forward_range)) > min_elements)
        {
        ...
        {
            for(iterator_type it1 = zr_boost_1_81::begin(forward_range);
                it1 != zr_boost_1_81::end(forward_range);
                ++it1)
            {
                iterator_type it2 = it1;
                for(++it2; it2 != zr_boost_1_81::end(forward_range); ++it2)
                {
                    if (! visitor.apply(*it1, *it2))
                    {
                        return false; // interrupt
                             ...
                             VisitBoxPolicy box_visitor)
    {
        ...
        if (std::size_t(zr_boost_1_81::size(forward_range1)) > min_elements
            && std::size_t(zr_boost_1_81::size(forward_range2)) > min_elements)
        {
        ...
        {
            for(iterator_type1 it1 = zr_boost_1_81::begin(forward_range1);
                it1 != zr_boost_1_81::end(forward_range1);
                ++it1)
            {
                for(iterator_type2 it2 = zr_boost_1_81::begin(forward_range2);
                    it2 != zr_boost_1_81::end(forward_range2);
                    ++it2)
                {
                    if (! visitor.apply(*it1, *it2))
                    {
