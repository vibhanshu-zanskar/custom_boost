...
struct intersection_multi_linestring_multi_linestring_point
{
            ...
            Strategy const& strategy)
    {
        ...
        for (typename zr_boost_1_81::range_iterator
                ...
                >::type it1 = zr_boost_1_81::begin(ml1);
            it1 != zr_boost_1_81::end(ml1);
            ++it1)
        {
            for (typename zr_boost_1_81::range_iterator
                    <
                        MultiLinestring2 const
                    >::type it2 = zr_boost_1_81::begin(ml2);
                it2 != zr_boost_1_81::end(ml2);
                ++it2)
            {
...
struct intersection_linestring_multi_linestring_point
{
            ...
            Strategy const& strategy)
    {
        for (typename zr_boost_1_81::range_iterator
                ...
                >::type it = zr_boost_1_81::begin(ml);
            it != zr_boost_1_81::end(ml);
            ++it)
        {
            out = intersection_linestring_linestring_point<PointOut>
...
struct clip_multi_linestring
{
            ...
            OutputIterator out, Strategy const& )
    {
        ...
        for (typename zr_boost_1_81::range_iterator<MultiLinestring const>::type it
            = zr_boost_1_81::begin(multi_linestring);
            it != zr_boost_1_81::end(multi_linestring); ++it)
        {
