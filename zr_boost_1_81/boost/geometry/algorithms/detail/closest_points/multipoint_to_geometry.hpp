...
struct multipoint_to_multipoint
{
    ...
    {
        if (zr_boost_1_81::size(multipoint1) < zr_boost_1_81::size(multipoint2))
        {
            point_or_segment_range_to_geometry_rtree::apply(
                zr_boost_1_81::begin(multipoint2),
        ...
        point_or_segment_range_to_geometry_rtree::apply(
            zr_boost_1_81::begin(multipoint1),
...
public:
                             ...
                             Strategies const& strategies)
    {
        ...
        if (it != zr_boost_1_81::end(multipoint))
        {
