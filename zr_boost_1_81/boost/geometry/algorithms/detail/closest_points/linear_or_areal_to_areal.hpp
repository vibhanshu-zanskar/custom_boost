...
struct linear_to_areal
{
                             ...
                             Strategies const& strategies)
    {
        ...
        */
        ...
        if (! zr_boost_1_81::empty(mp_out))
        {
            set_segment_from_points::apply(*zr_boost_1_81::begin(mp_out), 
                                           *zr_boost_1_81::begin(mp_out), 
                                           shortest_seg);
            return;
        }
        ...
        if (! zr_boost_1_81::empty(ln_out))
        {
            set_segment_from_points::apply(*zr_boost_1_81::begin(*zr_boost_1_81::begin(ln_out)), 
                                           *zr_boost_1_81::begin(*zr_boost_1_81::begin(ln_out)), 
                                           shortest_seg); 
            return;
        }
...
struct areal_to_areal
{
                             ...
                             Strategies const& strategies)
    {
        ...
        */
        ...
        if (! zr_boost_1_81::empty(pl_out))
        {
            set_segment_from_points::apply(
                *zr_boost_1_81::begin(zr_boost_1_81::geometry::exterior_ring(*zr_boost_1_81::begin(pl_out))), 
                *zr_boost_1_81::begin(zr_boost_1_81::geometry::exterior_ring(*zr_boost_1_81::begin(pl_out))), 
                shortest_seg); 
            return;
        }
