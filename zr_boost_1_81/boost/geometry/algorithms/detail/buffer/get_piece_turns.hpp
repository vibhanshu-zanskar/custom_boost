...
{
    typedef typename zr_boost_1_81::range_iterator<Ring const>::type iterator_type;
...
private :
    ...
    {
        ++next;
        if (next == zr_boost_1_81::end(m_ring))
        {
            next = zr_boost_1_81::begin(m_ring) + 1;
        }
    }
...
class piece_turn_visitor
{
    ...
    {
        typedef typename zr_boost_1_81::range_value<Rings const>::type ring_type;
        typedef typename zr_boost_1_81::range_value<Turns const>::type turn_type;
        typedef typename zr_boost_1_81::range_iterator<ring_type const>::type iterator;
        ...
        iterator it1_first = zr_boost_1_81::begin(ring1) + sec1_first_index;
        iterator it1_beyond = zr_boost_1_81::begin(ring1) + sec1_last_index + 1;

        ring_type const& ring2 = m_rings[piece2.first_seg_id.multi_index];
        iterator it2_first = zr_boost_1_81::begin(ring2) + sec2_first_index;
        iterator it2_beyond = zr_boost_1_81::begin(ring2) + sec2_last_index + 1;
...
public:
    ...
    inline bool apply(Section const& section1, Section const& section2,
                    bool first = true)
    {
        zr_boost_1_81::ignore_unused(first);

        typedef typename zr_boost_1_81::range_value<Pieces const>::type piece_type;
