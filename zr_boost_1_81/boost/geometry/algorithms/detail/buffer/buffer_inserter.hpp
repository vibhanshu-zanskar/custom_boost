...
struct buffer_range
{
    ...
    {
        zr_boost_1_81::ignore_unused(segment_strategy);
...
struct buffer_inserter_ring
{
            ...
            Strategies const& strategies)
    {
        ...
        std::size_t n = zr_boost_1_81::size(simplified);
        ...
        if (n >= min_points)
        {
            ...
            if (distance.negative())
            {
                ...
                code = iterate(collection, zr_boost_1_81::rbegin(view), zr_boost_1_81::rend(view),
            ...
            {
                code = iterate(collection, zr_boost_1_81::begin(view), zr_boost_1_81::end(view),
            ...
            Strategies const& strategies)
    {
        ...
        if (n > 1)
        {
            ...
            code = iterate(collection,
                    zr_boost_1_81::begin(simplified), zr_boost_1_81::end(simplified),
                    geometry::strategy::buffer::buffer_side_left,
                    distance, segment_strategy, join_strategy, end_strategy,
                    robust_policy, strategies,
                    first_p1);
            ...
            {
                code = iterate(collection,
                        zr_boost_1_81::rbegin(simplified), zr_boost_1_81::rend(simplified),
                        geometry::strategy::buffer::buffer_side_right,
                        distance, segment_strategy, join_strategy, end_strategy,
                        robust_policy, strategies,
                        first_p1);
...
private:
    ...
    void apply_interior_rings(InteriorRings const& interior_rings,
            ...
            Strategies const& strategies)
    {
        iterate(zr_boost_1_81::begin(interior_rings), zr_boost_1_81::end(interior_rings),
             ...
             <
                ...
                <
                    typename single_tag_of
                                ...
                                >::type,
                    typename zr_boost_1_81::range_value<Multi const>::type,
...
{
    zr_boost_1_81::ignore_unused(visit_pieces_policy);
