...
struct piece_border
{
    ...
    zr_boost_1_81::array<Point, 2> m_originals;
    ...
    void set_offsetted(Ring const& ring, std::size_t begin, std::size_t end)
    {
        ...
        BOOST_GEOMETRY_ASSERT(begin < zr_boost_1_81::size(ring));
        BOOST_GEOMETRY_ASSERT(end <= zr_boost_1_81::size(ring));

        m_ring = zr_boost_1_81::addressof(ring);
        m_begin = begin;
        m_end = end;
    }
