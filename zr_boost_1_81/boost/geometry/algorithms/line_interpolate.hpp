...
struct interpolate_range
{
    ...
    {
        typedef typename zr_boost_1_81::range_iterator<Range const>::type iterator_t;
        typedef typename zr_boost_1_81::range_value<Range const>::type point_t;

        iterator_t it = zr_boost_1_81::begin(range);
...
struct line_interpolate<zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
{
    ...
    template <typename Distance, typename Pointlike, typename Strategy>
    static inline void
    apply(zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const& geometry,
          Distance const& max_distance,
          Pointlike & pointlike,
          Strategy const& strategy)
    {
        zr_boost_1_81::apply_visitor(
