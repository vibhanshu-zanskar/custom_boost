                             ...
                             Strategies const& strategies)
    {
        typedef typename distance_result
            <
                ...
                Strategies
            >::type result_type;
        typedef typename zr_boost_1_81::range_size<Linestring1>::type size_type1;
        typedef typename zr_boost_1_81::range_size<Linestring2>::type size_type2;

        zr_boost_1_81::geometry::detail::throw_on_empty_input(ls1);
        zr_boost_1_81::geometry::detail::throw_on_empty_input(ls2);

        // We can assume the inputs are not empty
        auto const strategy = strategies.distance(dummy_point(), dummy_point());

        size_type1 const a = zr_boost_1_81::size(ls1);
        size_type2 const b = zr_boost_1_81::size(ls2);
