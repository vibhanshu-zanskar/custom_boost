...
struct point_to_box
{
    static inline void apply(Point const& point, Box& box)
    {
        ...
        set<Index, Dimension>(box,
                zr_boost_1_81::numeric_cast<coordinate_type>(get<Dimension>(point)));
        point_to_box
            <
                Point, Box,
...
struct segment_to_range
{
    static inline void apply(Segment const& segment, Range& range)
    {
        ...
        typename zr_boost_1_81::range_iterator<Range>::type it = zr_boost_1_81::begin(range);
...
struct range_to_range
{
                                           ...
                                           ConvertPointPolicy convert_point)
    {
        ...
        typedef typename zr_boost_1_81::range_size<Range1>::type size_type;
        size_type n = zr_boost_1_81::size(view);
        ...
        size_type i = 0;
        for (typename zr_boost_1_81::range_iterator<view_type const>::type it
            = zr_boost_1_81::begin(view);
            it != zr_boost_1_81::end(view) && i < n;
            ++it, ++i)
        {
            typename zr_boost_1_81::range_value<Range2>::type point;
...
struct polygon_to_polygon
{
    ...
    static inline void apply(Polygon1 const& source, Polygon2& destination)
    {
        ...
        typename detail::interior_iterator<Polygon1 const>::type
            it_source = zr_boost_1_81::begin(rings_source);
        typename detail::interior_iterator<Polygon2>::type
            it_dest = zr_boost_1_81::begin(rings_dest);

        for ( ; it_source != zr_boost_1_81::end(rings_source); ++it_source, ++it_dest)
        {
...
struct single_to_multi: private Policy
{
    static inline void apply(Single const& single, Multi& multi)
    {
        ...
        Policy::apply(single, *zr_boost_1_81::begin(multi));
    }
};
...
struct multi_to_multi: private Policy
{
    ...
    {
        traits::resize<Multi2>::apply(multi2, zr_boost_1_81::size(multi1));

        typename zr_boost_1_81::range_iterator<Multi1 const>::type it1
                = zr_boost_1_81::begin(multi1);
        typename zr_boost_1_81::range_iterator<Multi2>::type it2
                = zr_boost_1_81::begin(multi2);

        for (; it1 != zr_boost_1_81::end(multi1); ++it1, ++it2)
        {
...
struct convert<Multi1, Multi2, multi_tag, multi_tag, DimensionCount, false>
    : detail::conversion::multi_to_multi
        <
            ...
            convert
                <
                    typename zr_boost_1_81::range_value<Multi1>::type,
                    typename zr_boost_1_81::range_value<Multi2>::type,
    ...
    : detail::conversion::single_to_multi
        <
            ...
            convert
                <
                    Single,
                    typename zr_boost_1_81::range_value<Multi>::type,
...
struct convert<zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Geometry2>
{
    ...
    static inline void apply(
        zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const& geometry1,
        Geometry2& geometry2
    )
    {
        zr_boost_1_81::apply_visitor(visitor(geometry2), geometry1);
    }
};
