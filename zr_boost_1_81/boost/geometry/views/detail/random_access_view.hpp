...
struct is_random_access_range
    : std::is_convertible
        <
            typename zr_boost_1_81::iterator_traversal
                <
...
class random_access_view
    : public std::vector<typename zr_boost_1_81::range_iterator<GeometryCollection>::type>
{
    ...
    using base_t = std::vector<typename zr_boost_1_81::range_iterator<GeometryCollection>::type>;

public:
    random_access_view(GeometryCollection & geometry)
    {
        this->reserve(zr_boost_1_81::size(geometry));
...
{
public:
    using iterator = typename zr_boost_1_81::range_iterator<GeometryCollection>::type;
    using const_iterator = typename zr_boost_1_81::range_const_iterator<GeometryCollection>::type;

    random_access_view(GeometryCollection & geometry)
        : m_begin(zr_boost_1_81::begin(geometry))
        , m_end(zr_boost_1_81::end(geometry))
    {}
