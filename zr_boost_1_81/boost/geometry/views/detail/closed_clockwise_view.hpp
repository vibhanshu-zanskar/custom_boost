...
struct closed_clockwise_view
{
    ...
    using iterator = typename zr_boost_1_81::range_iterator<view const>::type;
    using const_iterator = typename zr_boost_1_81::range_iterator<view const>::type;

    inline const_iterator begin() const { return zr_boost_1_81::begin(m_view); }
    inline const_iterator end() const { return zr_boost_1_81::end(m_view); }
