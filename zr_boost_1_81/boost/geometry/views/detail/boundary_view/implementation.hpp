...
<
    ...
    typename Difference = typename zr_boost_1_81::range_difference
        <
...
public:
    ...
    polygon_rings_iterator(Polygon& polygon)
        : m_polygon(zr_boost_1_81::addressof(polygon))
        , m_index(0)
    {}
...
struct num_rings<MultiPolygon, multi_polygon_tag>
{
    static inline std::size_t apply(MultiPolygon const& multipolygon)
    {
        return geometry::num_interior_rings(multipolygon)
            + static_cast<std::size_t>(zr_boost_1_81::size(multipolygon));
    }
};
...
class views_container_initializer<MultiPolygon, multi_polygon_tag>
{
    typedef std::conditional_t
        <
            ...
            typename zr_boost_1_81::range_value<MultiPolygon>::type const,
    ...
    typedef flatten_iterator
        <
            typename zr_boost_1_81::range_iterator<MultiPolygon>::type,
            inner_iterator_type,
...
public:
    ...
    static inline void apply(MultiPolygon const& multipolygon,
                             BoundaryView* views)
    {
        rings_iterator_type first(zr_boost_1_81::begin(multipolygon),
                                  zr_boost_1_81::end(multipolygon));
        rings_iterator_type last(zr_boost_1_81::end(multipolygon));
