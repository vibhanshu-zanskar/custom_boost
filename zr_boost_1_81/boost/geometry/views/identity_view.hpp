...
{
    using const_iterator = typename zr_boost_1_81::range_iterator<Range const>::type;
    using iterator = typename zr_boost_1_81::range_iterator<Range>::type;

    explicit inline identity_view(Range& r)
        : m_begin(zr_boost_1_81::begin(r))
        , m_end(zr_boost_1_81::end(r))
    {}
