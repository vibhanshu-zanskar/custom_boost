...
struct set_point_from_vec
{
    ...
    static inline void apply(Point & p, Vector const& v)
    {
        ...
        set<Dimension>(p, zr_boost_1_81::numeric_cast<coord_t>(qvm::A<Dimension>(v)));
...
protected :
    ...
    typedef zr_boost_1_81::qvm::mat<ct, Dimension2 + 1, Dimension1 + 1> matrix_type;
...
public :
    ...
    inline bool apply(P1 const& p1, P2& p2) const
    {
        ...
        set<0>(p2, zr_boost_1_81::numeric_cast<ct2>(c1 * qvm::A<0,0>(this->m_matrix) + c2 * qvm::A<0,1>(this->m_matrix) + qvm::A<0,2>(this->m_matrix)));
        set<1>(p2, zr_boost_1_81::numeric_cast<ct2>(c1 * qvm::A<1,0>(this->m_matrix) + c2 * qvm::A<1,1>(this->m_matrix) + qvm::A<1,2>(this->m_matrix)));
...
public :
    ...
    inline bool apply(P1 const& p1, P2& p2) const
    {
        ...
        set<1>(p2, zr_boost_1_81::numeric_cast<ct2>(
            c1 * qvm::A<1,0>(this->m_matrix) + c2 * qvm::A<1,1>(this->m_matrix) + c3 * qvm::A<1,2>(this->m_matrix) + qvm::A<1,3>(this->m_matrix)));
        set<2>(p2, zr_boost_1_81::numeric_cast<ct2>(
...
public:
    ...
    {
        zr_boost_1_81::qvm::set_identity(this->m_matrix);
        this->m_matrix*=scale;
