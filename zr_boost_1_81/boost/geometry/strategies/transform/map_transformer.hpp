...
{
    typedef zr_boost_1_81::qvm::mat<CalculationType, Dimension1 + 1, Dimension2 + 1> M;
    typedef zr_boost_1_81::qvm::mat<CalculationType, 3, 3> matrix33;
...
private :
                    ...
                    D const& width, D const& height)
    {
        ...
        W wdx = wx2 - wx1;
        W wdy = wy2 - wy1;
        type sx = (px2 - px1) / zr_boost_1_81::numeric_cast<type>(wdx);
        type sy = (py2 - py1) / zr_boost_1_81::numeric_cast<type>(wdy);
