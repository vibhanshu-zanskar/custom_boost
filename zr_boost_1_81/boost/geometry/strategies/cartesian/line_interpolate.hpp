...
public:
                      ...
                      Distance const&) const
    {
        ...
        geometry::detail::for_each_dimension<Point>([&](auto dimension)
        {
            ...
            calc_t coord0 = zr_boost_1_81::numeric_cast<calc_t>(get<dimension>(p0));
            calc_t coord1 = zr_boost_1_81::numeric_cast<calc_t>(get<dimension>(p1));
            calc_t result = calc_t(coord1 * fraction) + calc_t(coord0 * one_minus_fraction);
            set<dimension>(p, zr_boost_1_81::numeric_cast<coord_t>(result));
        });
    }
};
