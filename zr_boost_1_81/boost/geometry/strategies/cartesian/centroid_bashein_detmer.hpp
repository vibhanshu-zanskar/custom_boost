...
public :
                             ...
                             sums<GeometryPoint, ResultPoint>& state)
    {
        ...
        */
        ...
        calc_type const x1 = zr_boost_1_81::numeric_cast<calc_type>(get<0>(p1));
        calc_type const y1 = zr_boost_1_81::numeric_cast<calc_type>(get<1>(p1));
        calc_type const x2 = zr_boost_1_81::numeric_cast<calc_type>(get<0>(p2));
        calc_type const y2 = zr_boost_1_81::numeric_cast<calc_type>(get<1>(p2));
                              ...
                              ResultPoint& centroid)
    {
        ...
        if (state.count > 0 && ! math::equals(state.sum_a2, zero))
        {
            ...
            if (zr_boost_1_81::math::isfinite(a3))
            {
                ...
                set<0>(centroid,
                    zr_boost_1_81::numeric_cast<coordinate_type>(state.sum_x / a3));
                set<1>(centroid,
                    zr_boost_1_81::numeric_cast<coordinate_type>(state.sum_y / a3));
                return true;
            }
        }
