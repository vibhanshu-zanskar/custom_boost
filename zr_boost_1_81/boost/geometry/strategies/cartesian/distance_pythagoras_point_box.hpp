...
struct compute_pythagoras_point_box
{
    ...
    {
        T const p_coord = zr_boost_1_81::numeric_cast<T>(geometry::get<I-1>(point));
        T const b_min_coord =
            zr_boost_1_81::numeric_cast<T>(geometry::get<min_corner, I-1>(box));
        T const b_max_coord =
            zr_boost_1_81::numeric_cast<T>(geometry::get<max_corner, I-1>(box));
