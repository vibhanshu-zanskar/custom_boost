...
namespace zr_boost_1_81 { namespace geometry { namespace strategy { namespace disjoint
{
...
struct compute_tmin_tmax_per_dim
{
                             ...
                             RelativeDistance& diff)
    {
        ...
        RelativeDistance c_p0 = zr_boost_1_81::numeric_cast
            <
                point_coordinate_type
            >( geometry::get<I>(p0) );

        RelativeDistance c_p1 = zr_boost_1_81::numeric_cast
            <
                point_coordinate_type
            >( geometry::get<I>(p1) );

        RelativeDistance c_b_min = zr_boost_1_81::numeric_cast
            <
                box_coordinate_type
            >( geometry::get<geometry::min_corner, I>(box) );

        RelativeDistance c_b_max = zr_boost_1_81::numeric_cast
            <
                box_coordinate_type
...
}}}} // namespace zr_boost_1_81::geometry::strategy::disjoint
