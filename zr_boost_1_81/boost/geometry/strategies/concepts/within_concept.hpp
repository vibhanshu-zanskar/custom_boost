...
namespace zr_boost_1_81 { namespace geometry { namespace concepts
{
        ...
        static void apply(ApplyMethod, ResultMethod)
        {
            ...
            BOOST_GEOMETRY_STATIC_ASSERT
                (
                    (std::is_same
                        <
                            bool, typename zr_boost_1_81::function_types::result_type<ApplyMethod>::type
                        >::value),
            ...
            BOOST_GEOMETRY_STATIC_ASSERT
                (
                    (std::is_same
                        <
                            int, typename zr_boost_1_81::function_types::result_type<ResultMethod>::type
                        >::value),
            ...
            zr_boost_1_81::ignore_unused(r, b, str);
        }
    };
...
class WithinStrategyPointBox
{
    ...
    struct checker
    {
        ...
        static void apply(ApplyMethod)
        {
            ...
            BOOST_GEOMETRY_STATIC_ASSERT
                (
                    (std::is_same
                        <
                            bool,
                            typename zr_boost_1_81::function_types::result_type<ApplyMethod>::type
                        >::value),
                    "Wrong return type of apply().",
                    bool, ApplyMethod
                );
            ...
            zr_boost_1_81::ignore_unused(b, str);
        }
    };
...
// So now: zr_boost_1_81::geometry::concepts::within
namespace within
{
...
}}}} // namespace zr_boost_1_81::geometry::concepts::within
