...
struct degree_radian_converter
{
    ...
    {
        return zr_boost_1_81::numeric_cast
            <
                coordinate_type
    ...
    {
        geometry::set<Dimension>(geometry, zr_boost_1_81::numeric_cast
            <
                coordinate_type
...
struct degree_radian_converter_box_segment
{
    ...
    static inline void set(Geometry& geometry, coordinate_type const& radians)
    {
        geometry::set<Index, Dimension>(geometry, zr_boost_1_81::numeric_cast
            <
                coordinate_type
            >(radians * math::r2d<coordinate_type>()));
    }
