...
namespace zr_boost_1_81 { namespace geometry { namespace traits
{
...
struct iter_visit
{
    ...
    {
        using value_t = typename zr_boost_1_81::range_value<GeometryCollection>::type;
...
}}} // namespace zr_boost_1_81::geometry::traits
