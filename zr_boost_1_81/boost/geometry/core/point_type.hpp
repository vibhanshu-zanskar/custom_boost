...
// Specializations for linestring/ring, via zr_boost_1_81::range
template <typename Linestring>
struct point_type<linestring_tag, Linestring>
{
    typedef typename zr_boost_1_81::range_value<Linestring>::type type;
};
...
{
    typedef typename zr_boost_1_81::range_value<Ring>::type type;
};
...
{
    typedef typename zr_boost_1_81::range_value
        <
            MultiPoint
        >::type type;
};
