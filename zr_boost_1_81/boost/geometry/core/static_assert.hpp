...
namespace zr_boost_1_81 { namespace geometry { namespace detail
{
...
static_assert(zr_boost_1_81::geometry::detail::static_assert_check<(CHECK), __VA_ARGS__>::value, MESSAGE)


#define BOOST_GEOMETRY_STATIC_ASSERT_FALSE(MESSAGE, ...) \
static_assert(zr_boost_1_81::geometry::detail::static_assert_check<false, __VA_ARGS__>::value, MESSAGE)


}}} // namespace zr_boost_1_81::geometry::detail
