...
template <typename T>
struct promoted_to_floating_point<zr_boost_1_81::rational<T>>
{
    using type = double;
};
...
struct promoted_to_floating_point<zr_boost_1_81::multiprecision::number<Backend>>
{
    using type = double;
};
...
struct promoted_to_floating_point
    <
        zr_boost_1_81::multiprecision::number
            <
                zr_boost_1_81::multiprecision::cpp_bin_float<Digits>
            >
    >
{
    using type = zr_boost_1_81::multiprecision::number
        <
            zr_boost_1_81::multiprecision::cpp_bin_float<Digits>
        >;
};
