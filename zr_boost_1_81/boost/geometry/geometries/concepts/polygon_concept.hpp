...
class Polygon
{
    ...
    //BOOST_CONCEPT_ASSERT( (zr_boost_1_81::RandomAccessRangeConcept<interior_type>) );
    ...
    struct checker
    {
        static inline void apply()
        {
            ...
            zr_boost_1_81::ignore_unused(poly, cpoly);
            zr_boost_1_81::ignore_unused(e, i, ce, ci);
        }
    };
...
class ConstPolygon
{
    ...
    struct checker
    {
        static inline void apply()
        {
            ...
            zr_boost_1_81::ignore_unused(ce, ci, cpoly);
        }
    };
...
}}} // namespace zr_boost_1_81::geometry::concepts
