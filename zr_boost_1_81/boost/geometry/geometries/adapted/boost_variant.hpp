...
struct boost_variant_types<util::type_sequence<zr_boost_1_81::detail::variant::void_, Ts...>, util::type_sequence<Rs...>>
{
...
struct point_type<zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
    : point_type
        <
...
template <BOOST_VARIANT_ENUM_PARAMS(typename T)>
struct tag<zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)>>
{
    using type = dynamic_geometry_tag;
};

template <BOOST_VARIANT_ENUM_PARAMS(typename T)>
struct visit<zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)>>
{
    template <typename Function>
    struct visitor
        : zr_boost_1_81::static_visitor<>
    {
    ...
    static void apply(Function function, Variant && variant)
    {
        ...
        zr_boost_1_81::apply_visitor(visitor, std::forward<Variant>(variant));
    }
};

template <BOOST_VARIANT_ENUM_PARAMS(typename T), BOOST_VARIANT_ENUM_PARAMS(typename U)>
struct visit<zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(U)>>
{
    template <typename Function>
    struct visitor
        : zr_boost_1_81::static_visitor<>
    ...
    {
        visitor<Function> visitor(function);
        zr_boost_1_81::apply_visitor(visitor,
...
template <BOOST_VARIANT_ENUM_PARAMS(typename T)>
struct geometry_types<zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)>>
{
