...
/*!
\defgroup rtree_functions R-tree free functions (zr_boost_1_81::geometry::index::)
*/
...
Predefined algorithms with compile-time parameters are:
 \li <tt>zr_boost_1_81::geometry::index::linear</tt>,
 \li <tt>zr_boost_1_81::geometry::index::quadratic</tt>,
 \li <tt>zr_boost_1_81::geometry::index::rstar</tt>.

\par
Predefined algorithms with run-time parameters are:
 \li \c zr_boost_1_81::geometry::index::dynamic_linear,
 \li \c zr_boost_1_81::geometry::index::dynamic_quadratic,
 \li \c zr_boost_1_81::geometry::index::dynamic_rstar.
...
and <tt>zr_boost_1_81::tuple<Indexable, ...></tt>. For example, for Value
...
returns the result of <tt>zr_boost_1_81::geometry::equals()</tt> for types adapted to
...
<
    ...
    typename Allocator = zr_boost_1_81::container::new_allocator<Value>
>
class rtree
{
...
private:
            ...
            >
    {
        ...
        typedef ::zr_boost_1_81::container::allocator_traits<Allocator> allocator_traits_type;
    ...
    public:
        ...
        members_holder(IndGet const& ind_get,
            ...
            , allocators_type(zr_boost_1_81::forward<Alloc>(alloc))
            , values_count(0)
            , leafs_level(0)
            , root(0)
        {}
...
public:
    ...
    */
    ...
    inline rtree(Iterator first, Iterator last,
        ...
        : m_members(getter, equal, parameters, allocator)
    {
        pack_construct(first, last, zr_boost_1_81::container::new_allocator<void>());
    }
    ...
    */
    ...
    inline explicit rtree(Range const& rng,
        ...
        : m_members(getter, equal, parameters, allocator)
    {
        pack_construct(::zr_boost_1_81::begin(rng), ::zr_boost_1_81::end(rng), zr_boost_1_81::container::new_allocator<void>());
    }
    ...
    */
    ...
    inline explicit rtree(Range const& rng,
        ...
        : m_members(getter, equal, parameters, allocator)
    {
        pack_construct(::zr_boost_1_81::begin(rng), ::zr_boost_1_81::end(rng), temp_allocator);
    }
    ...
    */
    inline rtree(BOOST_RV_REF(rtree) src)
        : m_members(src.m_members.indexable_getter(),
                    src.m_members.equal_to(),
                    src.m_members.parameters(),
                    zr_boost_1_81::move(src.m_members.allocators()))
    {
        zr_boost_1_81::swap(m_members.values_count, src.m_members.values_count);
        zr_boost_1_81::swap(m_members.leafs_level, src.m_members.leafs_level);
        zr_boost_1_81::swap(m_members.root, src.m_members.root);
    }
...
// TODO - shouldn't here propagate_on_container_copy_assignment be checked like in operator=(const&)?
    ...
    */
    ...
    {
        zr_boost_1_81::swap(m_members.indexable_getter(), other.m_members.indexable_getter());
        zr_boost_1_81::swap(m_members.equal_to(), other.m_members.equal_to());
        zr_boost_1_81::swap(m_members.parameters(), other.m_members.parameters());
        ...
        zr_boost_1_81::swap(m_members.values_count, other.m_members.values_count);
        zr_boost_1_81::swap(m_members.leafs_level, other.m_members.leafs_level);
        zr_boost_1_81::swap(m_members.root, other.m_members.root);
    }
    ...
    */
    ...
    \li \c zr_boost_1_81::geometry::index::contains(),
    \li \c zr_boost_1_81::geometry::index::covered_by(),
    \li \c zr_boost_1_81::geometry::index::covers(),
    \li \c zr_boost_1_81::geometry::index::disjoint(),
    \li \c zr_boost_1_81::geometry::index::intersects(),
    \li \c zr_boost_1_81::geometry::index::overlaps(),
    \li \c zr_boost_1_81::geometry::index::within(),

    It is possible to negate spatial predicates:
    \li <tt>! zr_boost_1_81::geometry::index::contains()</tt>,
    \li <tt>! zr_boost_1_81::geometry::index::covered_by()</tt>,
    \li <tt>! zr_boost_1_81::geometry::index::covers()</tt>,
    \li <tt>! zr_boost_1_81::geometry::index::disjoint()</tt>,
    \li <tt>! zr_boost_1_81::geometry::index::intersects()</tt>,
    \li <tt>! zr_boost_1_81::geometry::index::overlaps()</tt>,
    \li <tt>! zr_boost_1_81::geometry::index::within()</tt>
    ...
    \li \c zr_boost_1_81::geometry::index::satisfies().
    ...
    \li \c zr_boost_1_81::geometry::index::nearest().
    ...
    tree.query(bgi::intersects(box),
               zr_boost_1_81::make_function_output_iterator(do_something()));
    ...
    tree.query(bgi::intersects(box),
               zr_boost_1_81::make_function_output_iterator([](value_type const& val){
                   // do something
               }));

    // C++14 (generic lambda expression)
    tree.query(bgi::intersects(box),
               zr_boost_1_81::make_function_output_iterator([](auto const& val){
                   // do something
               }));
    \endverbatim
...
// If exception is thrown, m_values_count may be invalid
    ...
    */
    ...
    {
        typedef typename zr_boost_1_81::range_const_iterator<Range>::type It;
        for ( It it = zr_boost_1_81::const_begin(rng); it != zr_boost_1_81::const_end(rng) ; ++it )
            this->raw_insert(*it);
    }
...
// the same as
std::for_each(zr_boost_1_81::begin(tree), zr_boost_1_81::end(tree), do_something());
\endverbatim
...
struct range_mutable_iterator
    <
        zr_boost_1_81::geometry::index::rtree<Value, Parameters, IndexableGetter, EqualTo, Allocator>
    >
{
    typedef typename zr_boost_1_81::geometry::index::rtree
        <
