...
struct tuple_equals
{
    ...
    {
        typedef typename zr_boost_1_81::tuples::element<I, Tuple>::type T;

        return equals<T>::apply(zr_boost_1_81::get<I>(t1), zr_boost_1_81::get<I>(t2), strategy)
...
This template is also specialized for std::pair<T1, T2> and zr_boost_1_81::tuple<...>.

\tparam Value       The type of objects which are compared by this function object.
\tparam IsIndexable If true, Values are compared using zr_boost_1_81::geometry::equals() functions.
*/
...
This specialization compares values of type zr_boost_1_81::tuple<...>.
It compares all members of the tuple from the first one to the last one.
*/
template <typename T0, typename T1, typename T2, typename T3, typename T4,
          typename T5, typename T6, typename T7, typename T8, typename T9>
struct equal_to<zr_boost_1_81::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>, false>
{
    typedef zr_boost_1_81::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> value_type;
    ...
    */
                           ...
                           Strategy const& strategy) const
    {
        return detail::tuple_equals<
            value_type, 0, zr_boost_1_81::tuples::length<value_type>::value
        >::apply(l, r, strategy);
    }
};
...
The default version handles Values which are Indexables, std::pair<T1, T2>, zr_boost_1_81::tuple<...>
and std::tuple<...> if STD tuples and variadic templates are supported.
All members are compared from left to right, Geometries using zr_boost_1_81::geometry::equals() function,
