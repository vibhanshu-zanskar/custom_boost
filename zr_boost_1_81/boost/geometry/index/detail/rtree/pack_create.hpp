...
public:
                       ...
                       allocators_type & allocators)
    {
        return apply(first, last, values_count, leafs_level, parameters, translator,
                     allocators, zr_boost_1_81::container::new_allocator<void>());
    }
                       ...
                       TmpAlloc const& temp_allocator)
    {
        ...
        typedef typename zr_boost_1_81::container::allocator_traits<TmpAlloc>::
            template rebind_alloc<entry_type> temp_entry_allocator_type;

        temp_entry_allocator_type temp_entry_allocator(temp_allocator);
        zr_boost_1_81::container::vector<entry_type, temp_entry_allocator_type> entries(temp_entry_allocator);
...
private:
                               ...
                               allocators_type & allocators)
    {
        ...
        if ( subtree_counts.maxc <= 1 )
        {
            ...
            for ( ++first ; first != last ; ++first )
            {
                ...
                //       non-true reference types and move_iterator without zr_boost_1_81::forward<>.
    ...
    {
        zr_boost_1_81::ignore_unused(parameters);
