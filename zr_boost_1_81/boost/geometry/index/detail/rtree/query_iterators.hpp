...
namespace zr_boost_1_81 { namespace geometry { namespace index { namespace detail { namespace rtree { namespace iterators {
...
public:
    ...
    const value_type * operator->() const
    {
        return zr_boost_1_81::addressof(m_impl.dereference());
    }
...
public:
    ...
    {
        const query_iterator_wrapper * p = dynamic_cast<const query_iterator_wrapper *>(zr_boost_1_81::addressof(r));
...
class query_iterator
{
    ...
    typedef zr_boost_1_81::scoped_ptr<iterator_base> iterator_ptr;
...
public:
    ...
    {
        if ( this != zr_boost_1_81::addressof(o) )
        {
    ...
    const value_type * operator->() const
    {
        return zr_boost_1_81::addressof(m_ptr->dereference());
    }
...
}}}}}} // namespace zr_boost_1_81::geometry::index::detail::rtree::iterators
