...
struct node_alloc
{
    ...
    typedef zr_boost_1_81::container::allocator_traits<type> traits;
};
...
public:
    ...
    inline allocators(BOOST_FWD_REF(allocators) a)
        : node_allocator_type(zr_boost_1_81::move(a.node_allocator()))
    {}

    inline allocators & operator=(BOOST_FWD_REF(allocators) a)
    {
        node_allocator() = zr_boost_1_81::move(a.node_allocator());
        return *this;
    }
    ...
    {
        zr_boost_1_81::swap(node_allocator(), a.node_allocator());
    }
...
struct create_variant_node
{
    ...
    static inline VariantPtr apply(AllocNode & alloc_node)
    {
        ...
        Al::construct(alloc_node, zr_boost_1_81::to_address(p), Node(alloc_node)); // implicit cast to Variant
...
struct destroy_variant_node
{
    ...
    static inline void apply(AllocNode & alloc_node, VariantPtr n)
    {
        ...
        Al::destroy(alloc_node, zr_boost_1_81::addressof(*n));
