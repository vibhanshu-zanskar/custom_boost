    ...
    : public weak_node<Value, Parameters, Box, Allocators, Tag>
{
    ...
    typedef typename zr_boost_1_81::container::allocator_traits
        <
            typename Allocators::internal_node_allocator_type
        >::template rebind_alloc<element_type> allocator_type;

    typedef zr_boost_1_81::container::vector<element_type, allocator_type> elements_type;
    ...
    : public weak_node<Value, Parameters, Box, Allocators, Tag>
{
    ...
    typedef zr_boost_1_81::container::vector<Value, allocator_type> elements_type;
...
private:
    ...
    typedef zr_boost_1_81::container::allocator_traits<value_allocator_type> value_allocator_traits;
...
public:
    ...
    inline allocators(BOOST_FWD_REF(allocators) a)
        : internal_node_allocator_type(zr_boost_1_81::move(a.internal_node_allocator()))
        , leaf_allocator_type(zr_boost_1_81::move(a.leaf_allocator()))
    {}

    inline allocators & operator=(BOOST_FWD_REF(allocators) a)
    {
        internal_node_allocator() = ::zr_boost_1_81::move(a.internal_node_allocator());
        leaf_allocator() = ::zr_boost_1_81::move(a.leaf_allocator());
        return *this;
    }
    ...
    {
        zr_boost_1_81::swap(internal_node_allocator(), a.internal_node_allocator());
        zr_boost_1_81::swap(leaf_allocator(), a.leaf_allocator());
    }
...
struct create_weak_node
{
    ...
    {
        typedef zr_boost_1_81::container::allocator_traits<AllocNode> Al;
        typedef typename Al::pointer P;

        P p = Al::allocate(alloc_node, 1);

        if ( 0 == p )
            throw_runtime_error("zr_boost_1_81::geometry::index::rtree node creation failed");

        scoped_deallocator<AllocNode> deallocator(p, alloc_node);

        Al::construct(alloc_node, zr_boost_1_81::to_address(p), alloc_node);
...
struct destroy_weak_node
{
    ...
    static inline void apply(AllocNode & alloc_node, BaseNodePtr n)
    {
        ...
        Al::destroy(alloc_node, zr_boost_1_81::addressof(*p));
