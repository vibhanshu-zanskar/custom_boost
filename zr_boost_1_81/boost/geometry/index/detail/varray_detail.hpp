...
namespace zr_boost_1_81 { namespace geometry { namespace index { namespace detail { namespace varray_detail
{
...
struct are_elements_contiguous<
    zr_boost_1_81::container::container_detail::vector_const_iterator<Pointer>
> : std::true_type
{};

template <typename Pointer>
struct are_elements_contiguous<
    zr_boost_1_81::container::container_detail::vector_iterator<Pointer>
> : std::true_type
{};
        ...
        <
            ...
            std::is_same
                <
                    std::remove_const_t
                        <
                            typename ::zr_boost_1_81::iterator_value<I>::type
                        >,
                    std::remove_const_t
                        <
                            typename ::zr_boost_1_81::iterator_value<O>::type
                        >
                >::value
            &&
...
{
    typedef typename zr_boost_1_81::iterator_value<I>::type value_type;
...
{
    typedef typename zr_boost_1_81::iterator_value<I>::type value_type;
    typename zr_boost_1_81::iterator_difference<I>::type d = std::distance(first, last);

    ::memmove(zr_boost_1_81::addressof(*dst), zr_boost_1_81::addressof(*first), sizeof(value_type) * d);
    return dst + d;
}
                              ...
                              std::true_type /*use_memcpy*/)
{
    ...
    ::memcpy(zr_boost_1_81::addressof(*dst), zr_boost_1_81::addressof(*first), sizeof(value_type) * d);
    return dst + d;
}
                              ...
                              std::false_type /*use_memcpy*/)
{
    ...
    BOOST_TRY
    {
        ...
        for (; first != last; ++first, ++o )
            new (zr_boost_1_81::addressof(*o)) value_type(zr_boost_1_81::move(*first));
    }
    BOOST_CATCH(...)
    {
...
BDO move_backward_dispatch(BDI first, BDI last, BDO dst,
                           std::true_type /*use_memmove*/)
{
    typedef typename zr_boost_1_81::iterator_value<BDI>::type value_type;
    typename zr_boost_1_81::iterator_difference<BDI>::type d = std::distance(first, last);

    BDO foo(dst - d);
    ::memmove(zr_boost_1_81::addressof(*foo), zr_boost_1_81::addressof(*first), sizeof(value_type) * d);
    return foo;
}
...
struct has_nothrow_move
    : std::integral_constant
        <
            bool,
            ::zr_boost_1_81::has_nothrow_move<std::remove_const_t<T> >::value
            ||
                                 ...
                                 std::false_type const& /*disable_trivial_init*/)
{
    typedef typename zr_boost_1_81::iterator_value<I>::type value_type;
    for ( ; first != last ; ++first )
        new (zr_boost_1_81::addressof(*first)) value_type();
}
                                 ...
                                 DisableTrivialInit const& /*not_used*/)
{
    ...
    {
        for ( ; it != last ; ++it )
            new (zr_boost_1_81::addressof(*it)) value_type();                           // may throw
    }
    BOOST_CATCH(...)
    {
...
{
    typedef typename ::zr_boost_1_81::iterator_value<I>::type value_type;
    new (static_cast<void*>(::zr_boost_1_81::addressof(*pos))) value_type();                      // may throw
}
...
void construct_copy_dispatch(I pos, V const& v,
                             std::true_type /*use_memcpy*/)
{
    ::memcpy(zr_boost_1_81::addressof(*pos), zr_boost_1_81::addressof(v), sizeof(V));
}
...
{
    typedef typename zr_boost_1_81::iterator_value<I>::type V;
    new (static_cast<void*>(zr_boost_1_81::addressof(*pos))) V(p);                      // may throw
}
...
{
    typedef typename zr_boost_1_81::iterator_value<I>::type V;
    new (static_cast<void*>(zr_boost_1_81::addressof(*pos))) V(::zr_boost_1_81::move(p));       // may throw
}
...
{
    construct_move_dispatch(pos, ::zr_boost_1_81::move(p), is_memop_safe_for_value<I, P>()); // may throw
}
...
{
    typedef typename zr_boost_1_81::iterator_value<I>::type V;
    new (static_cast<void*>(zr_boost_1_81::addressof(*pos))) V(::zr_boost_1_81::forward<Args>(args)...);    // may throw
}
...
{                                                                                                   \
    typedef typename zr_boost_1_81::iterator_value<I>::type V;                                              \
    new                                                                                             \
    (static_cast<void*>(zr_boost_1_81::addressof(*pos)))                                                    \
...
{
    assign_move_dispatch(pos, ::zr_boost_1_81::move(v), is_memop_safe_for_value<I, V>());
}
...
}}}}} // namespace zr_boost_1_81::geometry::index::detail::varray_detail
