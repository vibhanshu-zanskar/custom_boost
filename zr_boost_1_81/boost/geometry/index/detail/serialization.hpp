...
public:
    ...
    {
        zr_boost_1_81::serialization::load_construct_data_adl(ar, this->address(), version);
    }
...
private:
    zr_boost_1_81::aligned_storage<sizeof(T), zr_boost_1_81::alignment_of<T>::value> m_storage;
};
...
{
    namespace bs = zr_boost_1_81::serialization;    
    serialization_storage<T> storage(ar, bs::version<T>::value);        // load_construct_data
    ar >> zr_boost_1_81::serialization::make_nvp(name, *storage.address());   // serialize
...
{
    namespace bs = zr_boost_1_81::serialization;
    bs::save_construct_data_adl(ar, zr_boost_1_81::addressof(t), bs::version<T>::value);  // save_construct_data
    ar << zr_boost_1_81::serialization::make_nvp(name, t);                                // serialize
    //ar << t;                                                                      // serialize
}
...
// zr_boost_1_81::geometry::index::linear

template<class Archive, size_t Max, size_t Min>
void save_construct_data(Archive & ar, const zr_boost_1_81::geometry::index::linear<Max, Min> * params, unsigned int )
{
    size_t max = params->get_max_elements(), min = params->get_min_elements();
    ar << zr_boost_1_81::serialization::make_nvp("max", max);
    ar << zr_boost_1_81::serialization::make_nvp("min", min);
}
template<class Archive, size_t Max, size_t Min>
void load_construct_data(Archive & ar, zr_boost_1_81::geometry::index::linear<Max, Min> * params, unsigned int )
{
    size_t max, min;
    ar >> zr_boost_1_81::serialization::make_nvp("max", max);
    ar >> zr_boost_1_81::serialization::make_nvp("min", min);
    ...
    //::new(params)zr_boost_1_81::geometry::index::linear<Max, Min>();
}
template<class Archive, size_t Max, size_t Min> void serialize(Archive &, zr_boost_1_81::geometry::index::linear<Max, Min> &, unsigned int) {}

// zr_boost_1_81::geometry::index::quadratic

template<class Archive, size_t Max, size_t Min>
void save_construct_data(Archive & ar, const zr_boost_1_81::geometry::index::quadratic<Max, Min> * params, unsigned int )
{
    size_t max = params->get_max_elements(), min = params->get_min_elements();
    ar << zr_boost_1_81::serialization::make_nvp("max", max);
    ar << zr_boost_1_81::serialization::make_nvp("min", min);
...
template<class Archive, size_t Max, size_t Min>
void load_construct_data(Archive & ar, zr_boost_1_81::geometry::index::quadratic<Max, Min> * params, unsigned int )
{
    size_t max, min;
    ar >> zr_boost_1_81::serialization::make_nvp("max", max);
    ar >> zr_boost_1_81::serialization::make_nvp("min", min);
    if ( max != params->get_max_elements() || min != params->get_min_elements() )
        ...
        BOOST_THROW_EXCEPTION(std::runtime_error("parameters not compatible"));
    // the constructor musn't be called for this type
    //::new(params)zr_boost_1_81::geometry::index::quadratic<Max, Min>();
}
template<class Archive, size_t Max, size_t Min> void serialize(Archive &, zr_boost_1_81::geometry::index::quadratic<Max, Min> &, unsigned int) {}

// zr_boost_1_81::geometry::index::rstar

template<class Archive, size_t Max, size_t Min, size_t RE, size_t OCT>
void save_construct_data(Archive & ar, const zr_boost_1_81::geometry::index::rstar<Max, Min, RE, OCT> * params, unsigned int )
{
    ...
    ar << zr_boost_1_81::serialization::make_nvp("max", max);
    ar << zr_boost_1_81::serialization::make_nvp("min", min);
    ar << zr_boost_1_81::serialization::make_nvp("re", re);
    ar << zr_boost_1_81::serialization::make_nvp("oct", oct);
}
template<class Archive, size_t Max, size_t Min, size_t RE, size_t OCT>
void load_construct_data(Archive & ar, zr_boost_1_81::geometry::index::rstar<Max, Min, RE, OCT> * params, unsigned int )
{
    ...
    if ( max != params->get_max_elements() || min != params->get_min_elements() ||
        ...
        BOOST_THROW_EXCEPTION(std::runtime_error("parameters not compatible"));
    // the constructor musn't be called for this type
    //::new(params)zr_boost_1_81::geometry::index::rstar<Max, Min, RE, OCT>();
}
template<class Archive, size_t Max, size_t Min, size_t RE, size_t OCT>
void serialize(Archive &, zr_boost_1_81::geometry::index::rstar<Max, Min, RE, OCT> &, unsigned int) {}

// zr_boost_1_81::geometry::index::dynamic_linear

template<class Archive>
inline void save_construct_data(Archive & ar, const zr_boost_1_81::geometry::index::dynamic_linear * params, unsigned int )
{
    size_t max = params->get_max_elements(), min = params->get_min_elements();
    ar << zr_boost_1_81::serialization::make_nvp("max", max);
    ar << zr_boost_1_81::serialization::make_nvp("min", min);
...
template<class Archive>
inline void load_construct_data(Archive & ar, zr_boost_1_81::geometry::index::dynamic_linear * params, unsigned int )
{
    size_t max, min;
    ar >> zr_boost_1_81::serialization::make_nvp("max", max);
    ar >> zr_boost_1_81::serialization::make_nvp("min", min);
    ::new(params)zr_boost_1_81::geometry::index::dynamic_linear(max, min);
}
template<class Archive> void serialize(Archive &, zr_boost_1_81::geometry::index::dynamic_linear &, unsigned int) {}

// zr_boost_1_81::geometry::index::dynamic_quadratic

template<class Archive>
inline void save_construct_data(Archive & ar, const zr_boost_1_81::geometry::index::dynamic_quadratic * params, unsigned int )
{
    size_t max = params->get_max_elements(), min = params->get_min_elements();
    ar << zr_boost_1_81::serialization::make_nvp("max", max);
    ar << zr_boost_1_81::serialization::make_nvp("min", min);
...
template<class Archive>
inline void load_construct_data(Archive & ar, zr_boost_1_81::geometry::index::dynamic_quadratic * params, unsigned int )
{
    size_t max, min;
    ar >> zr_boost_1_81::serialization::make_nvp("max", max);
    ar >> zr_boost_1_81::serialization::make_nvp("min", min);
    ::new(params)zr_boost_1_81::geometry::index::dynamic_quadratic(max, min);
}
template<class Archive> void serialize(Archive &, zr_boost_1_81::geometry::index::dynamic_quadratic &, unsigned int) {}

// zr_boost_1_81::geometry::index::dynamic_rstar

template<class Archive>
inline void save_construct_data(Archive & ar, const zr_boost_1_81::geometry::index::dynamic_rstar * params, unsigned int )
{
    size_t max = params->get_max_elements()
         , min = params->get_min_elements()
         , re = params->get_reinserted_elements()
...
template<class Archive>
inline void load_construct_data(Archive & ar, zr_boost_1_81::geometry::index::dynamic_rstar * params, unsigned int )
{
    size_t max, min, re, oct;
    ar >> zr_boost_1_81::serialization::make_nvp("max", max);
    ar >> zr_boost_1_81::serialization::make_nvp("min", min);
    ar >> zr_boost_1_81::serialization::make_nvp("re", re);
    ar >> zr_boost_1_81::serialization::make_nvp("oct", oct);
    ::new(params)zr_boost_1_81::geometry::index::dynamic_rstar(max, min, re, oct);
}
template<class Archive> void serialize(Archive &, zr_boost_1_81::geometry::index::dynamic_rstar &, unsigned int) {}

}} // zr_boost_1_81::serialization
...
struct serialize_point
{
    ...
    static inline void save(Archive & ar, P const& p, unsigned int version)
    {
        ...
        ar << zr_boost_1_81::serialization::make_nvp("c", c);
...
void save(Archive & ar, zr_boost_1_81::geometry::model::point<T, D, C> const& p, unsigned int version)
{
    zr_boost_1_81::geometry::index::detail::serialize_point< zr_boost_1_81::geometry::model::point<T, D, C> >::save(ar, p, version);
}
template<class Archive, typename T, size_t D, typename C>
void load(Archive & ar, zr_boost_1_81::geometry::model::point<T, D, C> & p, unsigned int version)
{
    zr_boost_1_81::geometry::index::detail::serialize_point< zr_boost_1_81::geometry::model::point<T, D, C> >::load(ar, p, version);
}
template<class Archive, typename T, size_t D, typename C>
inline void serialize(Archive & ar, zr_boost_1_81::geometry::model::point<T, D, C> & o, const unsigned int version) { split_free(ar, o, version); }

template<class Archive, typename P>
inline void serialize(Archive & ar, zr_boost_1_81::geometry::model::box<P> & b, const unsigned int)
{
    ar & zr_boost_1_81::serialization::make_nvp("min", b.min_corner());
    ar & zr_boost_1_81::serialization::make_nvp("max", b.max_corner());
}

}} // zr_boost_1_81::serialization

// TODO - move to index/detail/rtree/visitors/save.hpp
namespace zr_boost_1_81 { namespace geometry { namespace index { namespace detail { namespace rtree { namespace visitors {
...
public:
    ...
    inline void operator()(internal_node const& n)
    {
        ...
        m_archive << zr_boost_1_81::serialization::make_nvp("s", s);
...
}}}}}} // zr_boost_1_81::geometry::index::detail::rtree::visitors

// TODO - move to index/detail/rtree/load.hpp
namespace zr_boost_1_81 { namespace geometry { namespace index { namespace detail { namespace rtree {
...
private:
                           ...
                           size_type current_level = 0)
    {
        ...
        ar >> zr_boost_1_81::serialization::make_nvp("s", elements_count);
...
}}}}} // zr_boost_1_81::geometry::index::detail::rtree
...
}}}}} // namespace zr_boost_1_81::geometry::index::detail::rtree

// TODO - move to index/serialization/rtree.hpp
namespace zr_boost_1_81 { namespace serialization {

template<class Archive, typename V, typename P, typename I, typename E, typename A>
void save(Archive & ar, zr_boost_1_81::geometry::index::rtree<V, P, I, E, A> const& rt, unsigned int version)
{
    namespace detail = zr_boost_1_81::geometry::index::detail;

    typedef zr_boost_1_81::geometry::index::rtree<V, P, I, E, A> rtree;
    ...
    ar << zr_boost_1_81::serialization::make_nvp("values_count", tree.members().values_count);
    ar << zr_boost_1_81::serialization::make_nvp("leafs_level", tree.members().leafs_level);
...
template<class Archive, typename V, typename P, typename I, typename E, typename A>
void load(Archive & ar, zr_boost_1_81::geometry::index::rtree<V, P, I, E, A> & rt, unsigned int version)
{
    namespace detail = zr_boost_1_81::geometry::index::detail;
    ...
    ar >> zr_boost_1_81::serialization::make_nvp("values_count", values_count);
    ar >> zr_boost_1_81::serialization::make_nvp("leafs_level", leafs_level);
...
void serialize(Archive & ar, zr_boost_1_81::geometry::index::rtree<V, P, I, E, A> & rt, unsigned int version)
{
    split_free(ar, rt, version);
}

template<class Archive, typename V, typename P, typename I, typename E, typename A> inline
void serialize(Archive & ar, zr_boost_1_81::geometry::index::rtree<V, P, I, E, A> const& rt, unsigned int version)
{
    split_free(ar, rt, version);
}
