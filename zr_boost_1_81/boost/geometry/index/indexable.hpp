...
This template is also specialized for std::pair<Indexable, T2>, zr_boost_1_81::tuple<Indexable, ...>
...
This specialization translates from zr_boost_1_81::tuple<Indexable, ...>
  or zr_boost_1_81::tuples::cons<Indexable, ...>.
...
struct indexable_boost_tuple
{
    ...
    BOOST_GEOMETRY_STATIC_ASSERT(
        (detail::is_indexable<Indexable>::value),
        "The first type of zr_boost_1_81::tuple has to be an Indexable.",
        Indexable);
    ...
    */
    ...
    inline result_type operator()(zr_boost_1_81::tuple<I, U1, U2, U3, U4, U5, U6, U7, U8, U9> const& v) const
    {
        BOOST_GEOMETRY_STATIC_ASSERT(
            (is_referencable<I, result_type>::value),
            "Unexpected type.",
            zr_boost_1_81::tuple<I, U1, U2, U3, U4, U5, U6, U7, U8, U9>);
        return zr_boost_1_81::get<0>(v);
    }
    ...
    */
    ...
    inline result_type operator()(zr_boost_1_81::tuples::cons<I, T> const& v) const
    {
        BOOST_GEOMETRY_STATIC_ASSERT(
            (is_referencable<I, result_type>::value),
            "Unexpected type.",
            zr_boost_1_81::tuples::cons<I, T>);
        return zr_boost_1_81::get<0>(v);
    }
...
struct indexable<zr_boost_1_81::tuple<Indexable, T1, T2, T3, T4, T5, T6, T7, T8, T9>, false>
    : indexable_boost_tuple
        <
            zr_boost_1_81::tuple<Indexable, T1, T2, T3, T4, T5, T6, T7, T8, T9>,
            Indexable
        >
{};
...
This specialization translates from zr_boost_1_81::tuples::cons<Indexable, ...>.

\tparam Indexable   The Indexable type.
*/
template <typename Indexable, typename Tail>
struct indexable<zr_boost_1_81::tuples::cons<Indexable, Tail>, false>
    : indexable_boost_tuple
        <
            zr_boost_1_81::tuples::cons<Indexable, Tail>,
            Indexable
        >
{};
...
std::pair<Indexable, T2>, zr_boost_1_81::tuple<Indexable, ...> and std::tuple<Indexable, ...> if STD tuples
