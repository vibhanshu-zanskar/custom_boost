...
struct svg_map<multi_tag, Multi, SvgPoint>
{
    ...
    {
        for (typename zr_boost_1_81::range_iterator<Multi const>::type it
            = zr_boost_1_81::begin(multi);
...
struct devarianted_svg_map<SvgPoint, variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
{
    ...
    static inline void apply(std::ostream& stream,
                             ...
                             TransformStrategy const& strategy)
    {
        zr_boost_1_81::apply_visitor(visitor<TransformStrategy>(stream, style, size, strategy), geometry);
    }
};
...
>
class svg_mapper : zr_boost_1_81::noncopyable
{
    ...
    zr_boost_1_81::scoped_ptr<transformer_type> m_matrix;
    ...
    */
                ...
                double lineheight = 10.0)
    {
        ...
        else
        {
            ...
            zr_boost_1_81::split(splitted, s, zr_boost_1_81::is_any_of("\n"));
