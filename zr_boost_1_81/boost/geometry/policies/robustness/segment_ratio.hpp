...
struct less<Type, true>
{
    ...
    {
        return zr_boost_1_81::rational<Type>(lhs.numerator(), lhs.denominator())
             < zr_boost_1_81::rational<Type>(rhs.numerator(), rhs.denominator());
    }
};
...
public:
    ...
    inline void initialize()
    {
        ...
        m_approximation =
            ...
            : (
                zr_boost_1_81::numeric_cast<floating_point_type>(m_numerator) * scale()
                / zr_boost_1_81::numeric_cast<floating_point_type>(m_denominator)
            );
    }
