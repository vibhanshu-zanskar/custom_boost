                                       ...
                                       Factor& factor)
{
    ...
    typedef typename promote_floating_point
        ...
        >::type num_type;
    num_type const diff = zr_boost_1_81::numeric_cast<num_type>(detail::get_max_size(box));
    ...
    if (math::equals(diff, num_type())
        || diff >= range
        || ! zr_boost_1_81::math::isfinite(diff))
    {
        factor = 1;
    }
    else
    {
        factor = zr_boost_1_81::numeric_cast<num_type>(
            zr_boost_1_81::numeric_cast<zr_boost_1_81::long_long_type>(half + range / diff));
    ...
    zr_boost_1_81::long_long_type const min_coordinate
        = zr_boost_1_81::numeric_cast<zr_boost_1_81::long_long_type>(-range / two);
