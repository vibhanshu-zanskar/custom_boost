...
struct equals<Type, true>
{
    ...
    {
        zr_boost_1_81::ignore_unused(policy);
        ...
        if (zr_boost_1_81::math::isfinite(a) && zr_boost_1_81::math::isfinite(b))
        {
...
struct square_root_for_fundamental_fp
{
    ...
    static inline FundamentalFP apply(FundamentalFP const& value)
    {
        ...
        if (zr_boost_1_81::math::isfinite(value))
        {
            return std::sqrt(value);
        }
        else if (zr_boost_1_81::math::isinf(value) && value < 0)
        {
...
struct square_root<T, true>
{
    ...
    static inline double apply(T const& value)
    {
        ...
        return square_root_for_fundamental_fp
            <
                double
            >::apply(zr_boost_1_81::numeric_cast<double>(value));
    }
};
...
struct define_pi
{
    static inline T apply()
    {
        ...
        return zr_boost_1_81::math::constants::pi<T>();
    }
};
...
struct define_two_pi
{
    ...
    {
        // Default calls Boost.Math
        return zr_boost_1_81::math::constants::two_pi<T>();
    }
};
...
struct define_half_pi
{
    ...
    {
        // Default calls Boost.Math
        return zr_boost_1_81::math::constants::half_pi<T>();
    }
};
...
struct rounding_cast
{
    ...
    {
        return zr_boost_1_81::numeric_cast<Result>(v);
    }
};
...
struct rounding_cast<Result, Source, true, false>
{
    static inline Result apply(Source const& v)
    {
        return zr_boost_1_81::numeric_cast<Result>(v < Source(0) ?
                                            v - Source(0.5) :
                                            v + Source(0.5));
    }
};
