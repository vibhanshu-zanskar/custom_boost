...
namespace zr_boost_1_81 { namespace geometry { namespace tuples
{
...
template <typename ...Ts>
struct is_tuple<zr_boost_1_81::tuples::tuple<Ts...>>
    : std::integral_constant<bool, true>
{};

template <typename HT, typename TT>
struct is_tuple<zr_boost_1_81::tuples::cons<HT, TT>>
    : std::integral_constant<bool, true>
{};
...
template <std::size_t I, typename ...Ts>
struct element<I, zr_boost_1_81::tuples::tuple<Ts...>>
{
    typedef typename zr_boost_1_81::tuples::element
        <
            I, zr_boost_1_81::tuples::tuple<Ts...>
        >::type type;
};

template <std::size_t I, typename HT, typename TT>
struct element<I, zr_boost_1_81::tuples::cons<HT, TT>>
{
    typedef typename zr_boost_1_81::tuples::element
        <
            I, zr_boost_1_81::tuples::cons<HT, TT>
        >::type type;
};
...
template <typename ...Ts>
struct size<zr_boost_1_81::tuples::tuple<Ts...>>
    : std::integral_constant
        <
            std::size_t,
            zr_boost_1_81::tuples::length<zr_boost_1_81::tuples::tuple<Ts...>>::value
        >
{};

template <typename HT, typename TT>
struct size<zr_boost_1_81::tuples::cons<HT, TT>>
    : std::integral_constant
        <
            std::size_t,
            zr_boost_1_81::tuples::length<zr_boost_1_81::tuples::cons<HT, TT>>::value
        >
{};
...
template <std::size_t I, typename ...Ts>
inline typename zr_boost_1_81::tuples::access_traits
    <
        typename zr_boost_1_81::tuples::element<I, zr_boost_1_81::tuples::tuple<Ts...>>::type
    >::non_const_type
get(zr_boost_1_81::tuples::tuple<Ts...> & t)
{
    return zr_boost_1_81::tuples::get<I>(t);
}
...
inline typename zr_boost_1_81::tuples::access_traits
    <
        typename zr_boost_1_81::tuples::element<I, zr_boost_1_81::tuples::tuple<Ts...>>::type
    >::const_type
get(zr_boost_1_81::tuples::tuple<Ts...> const& t)
{
    return zr_boost_1_81::tuples::get<I>(t);
}
...
inline typename zr_boost_1_81::tuples::access_traits
    <
        typename zr_boost_1_81::tuples::element<I, zr_boost_1_81::tuples::cons<HT, TT> >::type
    >::non_const_type
get(zr_boost_1_81::tuples::cons<HT, TT> & tup)
{
    return zr_boost_1_81::tuples::get<I>(tup);
}
...
inline typename zr_boost_1_81::tuples::access_traits
    <
        typename zr_boost_1_81::tuples::element<I, zr_boost_1_81::tuples::cons<HT, TT> >::type
    >::const_type
get(zr_boost_1_81::tuples::cons<HT, TT> const& tup)
{
    return zr_boost_1_81::tuples::get<I>(tup);
}
...
{
    typedef zr_boost_1_81::tuples::cons<T, zr_boost_1_81::tuples::null_type> type;

    static type apply(Tuple const&, T const& t)
    {
        return type(t, zr_boost_1_81::tuples::null_type());
    }
};
...
}}} // namespace zr_boost_1_81::geometry::tuples
