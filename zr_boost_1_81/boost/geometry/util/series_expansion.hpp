...
namespace zr_boost_1_81 { namespace geometry { namespace series_expansion {
    ...
    */
    template <size_t SeriesOrder, typename CT>
    struct coeffs_C1 : zr_boost_1_81::array<CT, SeriesOrder + 1>
    {
    ...
    template <size_t SeriesOrder, typename CT>
    struct coeffs_C1p : zr_boost_1_81::array<CT, SeriesOrder + 1>
    {
    ...
    template <size_t SeriesOrder, typename CT>
    struct coeffs_C2 : zr_boost_1_81::array<CT, SeriesOrder + 1>
    {
    ...
    template <size_t SeriesOrder, typename CT>
    struct coeffs_C3x : zr_boost_1_81::array<CT, (SeriesOrder * (SeriesOrder - 1)) / 2>
    {
    ...
    template <size_t SeriesOrder, typename CT>
    struct coeffs_C3 : zr_boost_1_81::array<CT, SeriesOrder>
    {
    ...
    template <size_t SeriesOrder, typename CT>
    struct coeffs_A3 : zr_boost_1_81::array<CT, SeriesOrder>
    {
...
}}} // namespace zr_boost_1_81::geometry::series_expansion
