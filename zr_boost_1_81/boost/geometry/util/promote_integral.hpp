...
<
    unsigned MinSize,
    unsigned MaxSize,
    zr_boost_1_81::multiprecision::cpp_integer_type SignType,
    zr_boost_1_81::multiprecision::cpp_int_check_type Checked,
    typename Allocator,
    zr_boost_1_81::multiprecision::expression_template_option ExpressionTemplates
>
struct bit_size
    <
        zr_boost_1_81::multiprecision::number
            <
                zr_boost_1_81::multiprecision::cpp_int_backend
                    <
...
/*!
    ...
    To do this, two times the bit size of T is tested against the bit sizes of:
         short, int, long, long long, zr_boost_1_81::int128_t
    ...
    the bit sizes of
         ...
         unsigned long long, zr_boost_1_81::uint128_t
    ...
    \note zr_boost_1_81::int128_type and zr_boost_1_81::uint128_type are considered
...
private:
    ...
    typedef std::conditional_t
        <
            ...
            std::integral_constant
                <
                    zr_boost_1_81::multiprecision::cpp_int_check_type,
                    zr_boost_1_81::multiprecision::checked
                >,
            std::integral_constant
                <
                    zr_boost_1_81::multiprecision::cpp_int_check_type,
                    zr_boost_1_81::multiprecision::unchecked
                >
        > check_policy_type;
    ...
    typedef detail::promote_integral::integral_types
        <
            ...
            , zr_boost_1_81::int128_type
#endif
#if !defined(BOOST_GEOMETRY_NO_MULTIPRECISION_INTEGER)
            , typename multiprecision_integer_type
                <
                    min_bit_size_type::value,
                    zr_boost_1_81::multiprecision::signed_magnitude
                >::type
#endif
    ...
    typedef detail::promote_integral::integral_types
        <
            ...
            , typename multiprecision_integer_type
                <
                    min_bit_size_type::value,
                    zr_boost_1_81::multiprecision::unsigned_magnitude
                >::type
#endif
