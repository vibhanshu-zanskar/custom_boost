...
{
    typedef typename zr_boost_1_81::function_types::parameter_types
        <
            Method
    ...
    typedef std::conditional_t
        <
            zr_boost_1_81::function_types::is_member_function_pointer<Method>::value,
