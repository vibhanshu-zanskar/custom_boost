...
struct points_begin<Linestring, linestring_tag>
{
    ...
    {
        return zr_boost_1_81::begin(linestring);
    }
};
...
struct points_begin<Ring, ring_tag>
{
    ...
    apply(Ring& ring)
    {
        return zr_boost_1_81::begin(ring);
    }
};
...
struct points_begin<Polygon, polygon_tag>
{
    ...
    static inline return_type apply(Polygon& polygon)
    {
        ...
        return return_type
            (zr_boost_1_81::begin(geometry::exterior_ring(polygon)),
             zr_boost_1_81::end(geometry::exterior_ring(polygon)),
             flatten_iterator(zr_boost_1_81::begin(geometry::interior_rings(polygon)),
                              zr_boost_1_81::end(geometry::interior_rings(polygon))
                              ),
             flatten_iterator(zr_boost_1_81::begin(geometry::interior_rings(polygon)),
                              zr_boost_1_81::end(geometry::interior_rings(polygon))
                              )
...
struct points_begin<MultiPoint, multi_point_tag>
{
    ...
    {
        return zr_boost_1_81::begin(multipoint);
    }
};
...
struct points_begin<MultiLinestring, multi_linestring_tag>
{
    ...
    {
        return return_type(zr_boost_1_81::begin(multilinestring),
                           zr_boost_1_81::end(multilinestring));
    }
};
...
struct points_begin<MultiPolygon, multi_polygon_tag>
{
    ...
    {
        return return_type(zr_boost_1_81::begin(multipolygon),
                           zr_boost_1_81::end(multipolygon));
    }
};
...
struct points_end<Linestring, linestring_tag>
{
    ...
    apply(Linestring& linestring)
    {
        return zr_boost_1_81::end(linestring);
    }
};
    ...
    static inline return_type apply(Polygon& polygon)
    {
        ...
        return return_type
            (zr_boost_1_81::end(geometry::exterior_ring(polygon)),
             ...
             flatten_iterator( zr_boost_1_81::end(geometry::interior_rings(polygon)) )
             );
    }
};
...
struct points_end<MultiPoint, multi_point_tag>
{
    ...
    apply(MultiPoint& multipoint)
    {
        return zr_boost_1_81::end(multipoint);
    }
};
...
struct points_end<MultiLinestring, multi_linestring_tag>
{
    ...
    static inline return_type apply(MultiLinestring& multilinestring)
    {
        return return_type(zr_boost_1_81::end(multilinestring));
    }
};
...
struct points_end<MultiPolygon, multi_polygon_tag>
{
    ...
    static inline return_type apply(MultiPolygon& multipolygon)
    {
        return return_type(zr_boost_1_81::end(multipolygon));
    }
};
