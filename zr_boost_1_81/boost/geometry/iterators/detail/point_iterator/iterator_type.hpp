...
{
    typedef typename zr_boost_1_81::range_iterator<Linestring>::type type;
};
...
{
    typedef typename zr_boost_1_81::range_iterator<Ring>::type type;
};
...
public:
    typedef concatenate_iterator
        <
            typename zr_boost_1_81::range_iterator<inner_range>::type,
            flatten_iterator
                <
                    typename zr_boost_1_81::range_iterator
                        <
...
{
    typedef typename zr_boost_1_81::range_iterator<MultiPoint>::type type;
};
...
public:
    typedef flatten_iterator
        <
            typename zr_boost_1_81::range_iterator<MultiLinestring>::type,
            typename iterator_type<inner_range>::type,
