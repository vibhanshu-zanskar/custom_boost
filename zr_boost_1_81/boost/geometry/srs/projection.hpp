...
struct project_multi
{
    ...
    {
        range::resize(g2, zr_boost_1_81::size(g1));
        return apply(zr_boost_1_81::begin(g1), zr_boost_1_81::end(g1),
                     zr_boost_1_81::begin(g2),
                     proj);
    }
...
private:
    ...
    zr_boost_1_81::shared_ptr<vprj_t> m_ptr;
};
