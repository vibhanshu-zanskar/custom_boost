...
namespace zr_boost_1_81 { namespace geometry { namespace srs
{
...
struct find_type_index<zr_boost_1_81::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, T>
...
struct parameter
{
    ...
    parameter(name_nadgrids id, Range const& v)
        : m_id(id)
        , m_value(srs::detail::nadgrids(zr_boost_1_81::begin(v), zr_boost_1_81::end(v)))
    {}
    ...
    parameter(name_towgs84 id, Range const& v)
        : m_id(id)
        , m_value(srs::detail::towgs84<T>(zr_boost_1_81::begin(v), zr_boost_1_81::end(v)))
    {
        std::size_t n = zr_boost_1_81::size(v);
        if (n != 3 && n != 7)
        {
...
public:
    ...
    {
        return zr_boost_1_81::get<V>(m_value);
    }
...
}}} // namespace zr_boost_1_81::geometry::srs
