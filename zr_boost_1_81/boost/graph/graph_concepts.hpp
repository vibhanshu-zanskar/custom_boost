...
//
// It is needed in order to allow us to write using zr_boost_1_81::vertices as
...
BOOST_concept(IncidenceGraph, (G)) : Graph< G >
{
    ...
    BOOST_STATIC_ASSERT(
        (zr_boost_1_81::mpl::not_< zr_boost_1_81::is_same< out_edge_iterator, void > >::value));
    BOOST_STATIC_ASSERT(
        (zr_boost_1_81::mpl::not_< zr_boost_1_81::is_same< degree_size_type, void > >::value));
...
BOOST_concept(BidirectionalGraph, (G)) : IncidenceGraph< G >
{
    ...
    BOOST_CONCEPT_USAGE(BidirectionalGraph)
    {
        ...
        BOOST_STATIC_ASSERT((zr_boost_1_81::mpl::not_<
            zr_boost_1_81::is_same< in_edge_iterator, void > >::value));
...
BOOST_concept(AdjacencyGraph, (G)) : Graph< G >
{
    ...
    BOOST_CONCEPT_USAGE(AdjacencyGraph)
    {
        ...
        BOOST_STATIC_ASSERT((zr_boost_1_81::mpl::not_<
            zr_boost_1_81::is_same< adjacency_iterator, void > >::value));
...
BOOST_concept(VertexListGraph, (G)) : Graph< G >
{
    ...
    BOOST_CONCEPT_USAGE(VertexListGraph)
    {
        ...
        BOOST_STATIC_ASSERT((zr_boost_1_81::mpl::not_<
            zr_boost_1_81::is_same< vertex_iterator, void > >::value));
        BOOST_STATIC_ASSERT((zr_boost_1_81::mpl::not_<
            zr_boost_1_81::is_same< vertices_size_type, void > >::value));
...
BOOST_concept(EdgeListGraph, (G)) : Graph< G >
{
    ...
    BOOST_CONCEPT_USAGE(EdgeListGraph)
    {
        ...
        BOOST_STATIC_ASSERT(
            (zr_boost_1_81::mpl::not_< zr_boost_1_81::is_same< edge_iterator, void > >::value));
        BOOST_STATIC_ASSERT((zr_boost_1_81::mpl::not_<
            zr_boost_1_81::is_same< edges_size_type, void > >::value));
...
BOOST_concept(MutableIncidenceGraph, (G)) : MutableGraph< G >
{
    ...
    typename zr_boost_1_81::graph_traits< G >::vertex_descriptor u;
    typename zr_boost_1_81::graph_traits< G >::out_edge_iterator iter;
};
...
using zr_boost_1_81::concepts::MultiPassInputIteratorConcept;

// Graph concepts
using zr_boost_1_81::concepts::AdjacencyGraphConcept;
using zr_boost_1_81::concepts::AdjacencyMatrixConcept;
using zr_boost_1_81::concepts::BidirectionalGraphConcept;
using zr_boost_1_81::concepts::EdgeIndexGraphConcept;
using zr_boost_1_81::concepts::EdgeListGraphConcept;
using zr_boost_1_81::concepts::EdgeMutableGraphConcept;
using zr_boost_1_81::concepts::EdgeMutablePropertyGraphConcept;
using zr_boost_1_81::concepts::GraphConcept;
using zr_boost_1_81::concepts::IncidenceGraphConcept;
using zr_boost_1_81::concepts::LvaluePropertyGraphConcept;
using zr_boost_1_81::concepts::MutableBidirectionalGraphConcept;
using zr_boost_1_81::concepts::MutableEdgeListGraphConcept;
using zr_boost_1_81::concepts::MutableGraphConcept;
using zr_boost_1_81::concepts::MutableIncidenceGraphConcept;
using zr_boost_1_81::concepts::PropertyGraphConcept;
using zr_boost_1_81::concepts::ReadablePropertyGraphConcept;
using zr_boost_1_81::concepts::VertexAndEdgeListGraphConcept;
using zr_boost_1_81::concepts::VertexIndexGraphConcept;
using zr_boost_1_81::concepts::VertexListGraphConcept;
using zr_boost_1_81::concepts::VertexMutableGraphConcept;
using zr_boost_1_81::concepts::VertexMutablePropertyGraphConcept;

// Utility concepts
using zr_boost_1_81::concepts::BasicMatrixConcept;
using zr_boost_1_81::concepts::ColorValueConcept;
using zr_boost_1_81::concepts::DegreeMeasureConcept;
using zr_boost_1_81::concepts::DistanceMeasureConcept;
using zr_boost_1_81::concepts::NumericValueConcept;
