    ...
    typename graph_traits< Graph >::vertex_descriptor src, RandomNumGen& gen)
{
    ...
    typedef zr_boost_1_81::uniform_int< degree_size_type > ui_type;
    ui_type ui(0, out_degree(src, g) - 1);
    zr_boost_1_81::variate_generator< RandomNumGen&, ui_type > variate(gen, ui);
    ...
    WeightMap weight, RandomNumGen& gen)
{
    ...
    typedef zr_boost_1_81::uniform_real<> ur_type;
    ur_type ur(0, weight_sum);
    zr_boost_1_81::variate_generator< RandomNumGen&, ur_type > variate(gen, ur);
    ...
    RandNumGen& gen, bool allow_parallel = true, bool self_edges = false)
{
    ...
    if (!allow_parallel)
    {
        ...
        typedef
            typename zr_boost_1_81::graph_traits< MutableGraph >::directed_category dir;
    ...
    else
    {
        ...
        for (e_size_t j = 0; j < E; /* Increment in body */)
        {
            ...
            edge_t e;
            bool inserted;
            zr_boost_1_81::tie(e, inserted) = add_edge(a, b, g);
            if (inserted)
            {
                ++j;
            }
...
namespace detail
{
        ...
        G& g, RandomGenerator& rg, Property, vertex_property_tag)
    {
        ...
        for (zr_boost_1_81::tie(vi, ve) = vertices(g); vi != ve; ++vi)
        {
            pm[*vi] = rg();
        }
    }
        ...
        G& g, RandomGenerator& rg, Property, edge_property_tag)
    {
        ...
        for (zr_boost_1_81::tie(ei, ee) = edges(g); ei != ee; ++ei)
        {
            pm[*ei] = rg();
        }
    }
