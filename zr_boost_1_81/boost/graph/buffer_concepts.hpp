...
BOOST_concept(Buffer, (B))
{
    ...
    {
        typedef typename zr_boost_1_81::add_reference< value_type >::type reference;
        ...
        buf.pop();
        reference t = buf.top();
        zr_boost_1_81::ignore_unused_variable_warning(t);
    }

    void const_constraints(const B& cbuf)
    {
        typedef typename zr_boost_1_81::add_const<
            typename zr_boost_1_81::remove_reference< value_type >::type >::type&
            const_reference;
...
BOOST_concept(KeyedUpdatableQueue, (Q)) : UpdatableQueue< Q >
{
    ...
    {
        BOOST_CONCEPT_ASSERT((zr_boost_1_81::ReadWritePropertyMapConcept< key_map,
