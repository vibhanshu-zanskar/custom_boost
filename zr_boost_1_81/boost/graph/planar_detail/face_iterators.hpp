...
class face_iterator : public zr_boost_1_81::iterator_facade<
                          face_iterator< Graph, FaceHandlesMap, ValueType,
                              TraversalType, VisitorType, Time >,
                          ValueType, zr_boost_1_81::forward_traversal_tag, ValueType >
{
public:
...
private:
    ...
    vertex_t m_lead;
    vertex_t m_follow;
    edge_storage< Graph, zr_boost_1_81::is_same< ValueType, edge_t >::value > m_edge;
...
class face_iterator< Graph, FaceHandlesMap, ValueType, both_sides, VisitorType,
    Time >
: public zr_boost_1_81::iterator_facade< face_iterator< Graph, FaceHandlesMap,
