...
vertices(const filtered_graph< G, EP, VP >& g)
{
    ...
    zr_boost_1_81::tie(f, l) = vertices(g.m_g);
...
edges(const filtered_graph< G, EP, VP >& g)
{
    ...
    zr_boost_1_81::tie(f, l) = edges(g.m_g);
...
// zr_boost_1_81::tie(vi, viend) = vertices(g);
    ...
    const filtered_graph< G, EP, VP >& g)
{
    ...
    zr_boost_1_81::tie(f, l) = out_edges(u, g.m_g);
    return std::make_pair(iter(pred, f, l), iter(pred, l, l));
}
    ...
    const filtered_graph< G, EP, VP >& g)
{
    ...
    for (zr_boost_1_81::tie(f, l) = out_edges(u, g); f != l; ++f)
        ++n;
    return n;
}
    ...
    const filtered_graph< G, EP, VP >& g)
{
    ...
    zr_boost_1_81::tie(f, l) = out_edges(u, g);
    ...
    const filtered_graph< G, EP, VP >& g)
{
    ...
    zr_boost_1_81::tie(f, l) = in_edges(u, g.m_g);
    return std::make_pair(iter(pred, f, l), iter(pred, l, l));
}
    ...
    const filtered_graph< G, EP, VP >& g)
{
    ...
    for (zr_boost_1_81::tie(f, l) = in_edges(u, g); f != l; ++f)
        ++n;
    return n;
}
    ...
    const filtered_graph< G, EP, VP >& g)
{
    ...
    bool exists;
    zr_boost_1_81::tie(e, exists) = edge(u, v, g.m_g);
    ...
    const filtered_graph< G, EP, VP >& g)
{
    ...
    typedef typename Graph::out_edge_iterator iter;
    typename graph_traits< G >::out_edge_iterator f, l;
    zr_boost_1_81::tie(f, l) = edge_range(u, v, g.m_g);
    return std::make_pair(iter(pred, f, l), iter(pred, l, l));
}
