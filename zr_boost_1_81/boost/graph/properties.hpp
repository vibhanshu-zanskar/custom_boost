...
namespace detail
{
    ...
    struct property_kind_from_graph< G, R T::* >
    {
        typedef typename zr_boost_1_81::mpl::if_<
            zr_boost_1_81::is_base_of< T, typename vertex_bundle_type< G >::type >,
            vertex_property_tag,
            typename zr_boost_1_81::mpl::if_<
                zr_boost_1_81::is_base_of< T, typename edge_bundle_type< G >::type >,
                edge_property_tag,
                typename zr_boost_1_81::mpl::if_<
                    zr_boost_1_81::is_base_of< T,
...
public:
    typedef typename property_value<
        typename zr_boost_1_81::graph_property_type< Graph >::type, Property >::type
        type;
};
