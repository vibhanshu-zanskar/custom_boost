...
template < class Visitor, class Graph > struct MASVisitorConcept
{
    void constraints()
    {
        zr_boost_1_81::function_requires<
            zr_boost_1_81::CopyConstructibleConcept< Visitor > >();
    ...
    Visitor vis;
    Graph g;
    typename zr_boost_1_81::graph_traits< Graph >::vertex_descriptor u;
    typename zr_boost_1_81::graph_traits< Graph >::edge_descriptor e;
};
...
public:
    ...
    {
        invoke_visitors(m_vis, u, g, ::zr_boost_1_81::on_start_vertex());
    }
...
namespace detail
{
    ...
    void maximum_adjacency_search(const Graph& g, WeightMap weights,
        MASVisitor vis,
        const typename zr_boost_1_81::graph_traits< Graph >::vertex_descriptor start,
        VertexAssignmentMap assignments, KeyedUpdatablePriorityQueue pq)
    {
        typedef typename zr_boost_1_81::graph_traits< Graph >::vertex_descriptor
            vertex_descriptor;
        typedef typename zr_boost_1_81::property_traits< WeightMap >::value_type
            weight_type;
...
void maximum_adjacency_search(const Graph& g, WeightMap weights, MASVisitor vis,
    ...
    VertexAssignmentMap assignments, KeyedUpdatablePriorityQueue pq)
{
    BOOST_CONCEPT_ASSERT((zr_boost_1_81::IncidenceGraphConcept< Graph >));
    BOOST_CONCEPT_ASSERT((zr_boost_1_81::VertexListGraphConcept< Graph >));
    typedef typename zr_boost_1_81::graph_traits< Graph >::vertex_descriptor
        vertex_descriptor;
    typedef typename zr_boost_1_81::graph_traits< Graph >::vertices_size_type
        vertices_size_type;
    typedef
        typename zr_boost_1_81::graph_traits< Graph >::edge_descriptor edge_descriptor;
    BOOST_CONCEPT_ASSERT((zr_boost_1_81::Convertible<
        typename zr_boost_1_81::graph_traits< Graph >::directed_category,
        zr_boost_1_81::undirected_tag >));
    BOOST_CONCEPT_ASSERT(
        (zr_boost_1_81::ReadablePropertyMapConcept< WeightMap, edge_descriptor >));
    // typedef typename zr_boost_1_81::property_traits<WeightMap>::value_type
    // weight_type;
    zr_boost_1_81::function_requires< MASVisitorConcept< MASVisitor, Graph > >();
    BOOST_CONCEPT_ASSERT(
        (zr_boost_1_81::ReadWritePropertyMapConcept< VertexAssignmentMap,
            vertex_descriptor >));
    BOOST_CONCEPT_ASSERT((zr_boost_1_81::Convertible< vertex_descriptor,
        typename zr_boost_1_81::property_traits< VertexAssignmentMap >::value_type >));
    BOOST_CONCEPT_ASSERT(
        (zr_boost_1_81::KeyedUpdatableQueueConcept< KeyedUpdatablePriorityQueue >));

    vertices_size_type n = num_vertices(g);
    if (n < 2)
        throw zr_boost_1_81::bad_graph(
    ...
    namespace detail
    {
        template < typename WeightMap > struct mas_dispatch
        {
                ...
                const ArgPack& params, WeightMap w)
            {
                ...
                typedef zr_boost_1_81::detail::make_priority_queue_from_arg_pack_gen<
                    zr_boost_1_81::graph::keywords::tag::max_priority_queue,
                    weight_type, vertex_descriptor,
                    std::greater< weight_type > >
                    default_pq_gen_type;

                default_pq_gen_type pq_gen(
                    choose_param(get_param(params, zr_boost_1_81::distance_zero_t()),
                        weight_type(0)));

                typename zr_boost_1_81::result_of< default_pq_gen_type(
                    const Graph&, const ArgPack&) >::type pq
                    = pq_gen(g, params);

                zr_boost_1_81::null_visitor null_vis;
                zr_boost_1_81::mas_visitor< zr_boost_1_81::null_visitor > default_visitor(
                    null_vis);
                vertex_descriptor v = vertex_descriptor();
                zr_boost_1_81::detail::make_property_map_from_arg_pack_gen<
                    zr_boost_1_81::graph::keywords::tag::vertex_assignment_map,
                    vertex_descriptor >
                    map_gen(v);
                typename zr_boost_1_81::detail::map_maker< Graph, ArgPack,
                    zr_boost_1_81::graph::keywords::tag::vertex_assignment_map,
                    vertex_descriptor >::map_type default_map
                    = map_gen(g, params);
                zr_boost_1_81::maximum_adjacency_search(g, w,
        ...
        template <> struct mas_dispatch< zr_boost_1_81::param_not_found >
        {
            typedef void result_type;
                ...
                const Graph& g, const ArgPack& params, param_not_found)
            {
                ...
                typedef typename zr_boost_1_81::property_map< Graph, edge_weight_t >
                    WeightMap;
                typedef typename WeightMap::value_type weight_type;
                ...
                typename zr_boost_1_81::detail::map_maker< Graph, ArgPack,
                    ...
                    vertex_descriptor >::map_type default_map
                    = map_gen(g, params);
                zr_boost_1_81::maximum_adjacency_search(g, get(edge_weight, g),
                    params[_visitor | default_visitor],
                    params[_root_vertex | *vertices(g).first],
                    params[_vertex_assignment_map | default_map], pq);
            }
