...
#define BOOST_BGL_ONE_PARAM_REF(name, key)                           \
    ...
    bgl_named_params< zr_boost_1_81::reference_wrapper< PType >,             \
        BOOST_PP_CAT(key, _t), self >                                \
    name(PType& p) const                                             \
    {                                                                \
        typedef bgl_named_params< zr_boost_1_81::reference_wrapper< PType >, \
            BOOST_PP_CAT(key, _t), self >                            \
            Params;                                                  \
        return Params(zr_boost_1_81::ref(p), *this);                         \
    }
...
#define BOOST_BGL_ONE_PARAM_REF(name, key)                           \
    ...
    {                                                                \
        typedef bgl_named_params< zr_boost_1_81::reference_wrapper< PType >, \
            BOOST_PP_CAT(key, _t) >                                  \
            Params;                                                  \
        return Params(zr_boost_1_81::ref(p));                                \
    }
...
namespace detail
{
    ...
    : zr_boost_1_81::mpl::eval_if< zr_boost_1_81::is_same< Param, param_not_found >,
          zr_boost_1_81::mpl::eval_if< GraphIsConst,
              detail::const_type_as_type< property_map< Graph, Tag > >,
              property_map< Graph, Tag > >,
          zr_boost_1_81::mpl::identity< Param > >
    {
    };
    ...
    template <> struct choose_impl_helper< false >
    {
        ...
        static
            typename property_map< typename zr_boost_1_81::remove_const< Graph >::type,
                PropertyTag >::const_type
            f(zr_boost_1_81::mpl::true_, const Graph& g, const Param&, PropertyTag tag)
        {
            return get(tag, g);
        }
        ...
        static
            typename property_map< typename zr_boost_1_81::remove_const< Graph >::type,
                PropertyTag >::type
            f(zr_boost_1_81::mpl::false_, Graph& g, const Param&, PropertyTag tag)
        {
            return get(tag, g);
        }
    };
...
template < typename Param, typename Graph, typename PropertyTag >
typename detail::choose_impl_result< zr_boost_1_81::mpl::true_, Graph, Param,
    PropertyTag >::type
choose_const_pmap(const Param& p, const Graph& g, PropertyTag tag)
{
    return detail::choose_impl_helper< !zr_boost_1_81::is_same< Param,
        param_not_found >::value >::f(zr_boost_1_81::mpl::true_(), g, p, tag);
}

template < typename Param, typename Graph, typename PropertyTag >
typename detail::choose_impl_result< zr_boost_1_81::mpl::false_, Graph, Param,
    PropertyTag >::type
choose_pmap(const Param& p, Graph& g, PropertyTag tag)
{
    return detail::choose_impl_helper< !zr_boost_1_81::is_same< Param,
        param_not_found >::value >::f(zr_boost_1_81::mpl::false_(), g, p, tag);
}
...
namespace detail
{
    ...
    struct edge_capacity_value
    {
        ...
        typedef typename detail::choose_impl_result< zr_boost_1_81::mpl::true_, Graph,
...
#define BOOST_BGL_ONE_PARAM_REF(name, key)                          \
    ...
    {                                                               \
        typedef zr_boost_1_81::graph::keywords::tag::name type;             \
    };
...
#undef BOOST_BGL_ONE_PARAM_CREF
    ...
    template < typename T > struct convert_bgl_params_to_boost_parameter
    {
        ...
        typedef zr_boost_1_81::parameter::aux::tagged_argument< new_kw,
            const typename T::value_type >
            tagged_arg_type;
        typedef convert_bgl_params_to_boost_parameter< typename T::next_type >
            rest_conv;
        typedef zr_boost_1_81::parameter::aux::arg_list< tagged_arg_type,
    ...
    template <>
    struct convert_bgl_params_to_boost_parameter< zr_boost_1_81::no_property >
    {
        typedef zr_boost_1_81::parameter::aux::empty_arg_list type;
        static type conv(const zr_boost_1_81::no_property&) { return type(); }
    };

    template <>
    struct convert_bgl_params_to_boost_parameter< zr_boost_1_81::no_named_parameters >
    {
        typedef zr_boost_1_81::parameter::aux::empty_arg_list type;
        static type conv(const zr_boost_1_81::no_named_parameters&) { return type(); }
    };
...
#define BOOST_GRAPH_DECLARE_CONVERTED_PARAMETERS(old_type, old_var)        \
    typedef typename zr_boost_1_81::detail::convert_bgl_params_to_boost_parameter< \
        old_type >::type arg_pack_type;                                    \
    arg_pack_type arg_pack                                                 \
        = zr_boost_1_81::detail::convert_bgl_params_to_boost_parameter<            \
...
namespace detail
{
    ...
    {
        typedef typename zr_boost_1_81::remove_const< ArgType >::type result_type;
    ...
    {
        typedef
            typename zr_boost_1_81::property_map< Graph, Prop >::const_type result_type;
    ...
    {
        typedef typename zr_boost_1_81::mpl::has_key< ArgPack, Tag >::type
            _parameter_exists;
        typedef typename override_const_property_t<
            typename zr_boost_1_81::parameter::value_type< ArgPack, Tag, int >::type,
    ...
    override_const_property(const ArgPack& ap,
        const zr_boost_1_81::parameter::keyword< Tag >& t, const Graph& g, Prop)
    {
        typedef typename zr_boost_1_81::mpl::has_key< ArgPack, Tag >::type
            _parameter_exists;
    ...
    struct override_property_t
    {
        ...
        result_type operator()(const Graph&,
            typename zr_boost_1_81::add_lvalue_reference< ArgType >::type a) const
        {
            return a;
        }
    };
    ...
    {
        typedef typename zr_boost_1_81::property_map< Graph, Prop >::type result_type;
        result_type operator()(const Graph& g, const ArgType&) const
        {
            return get(Prop(), g);
        }
    ...
    {
        typedef zr_boost_1_81::parameter::aux::tagged_argument< K, A > type;
    };

#define BOOST_GRAPH_OPENING_PART_OF_PAIR(z, i, n)                          \
    zr_boost_1_81::parameter::aux::arg_list                                        \
        < zr_boost_1_81::parameter::aux::tagged_argument< BOOST_PP_CAT(Keyword,    \
                                                      BOOST_PP_SUB(n, i)), \
            BOOST_PP_CAT(Arg, BOOST_PP_SUB(n, i)) >,
#define BOOST_GRAPH_MAKE_PAIR_PARAM(z, i, _)                                \
    const zr_boost_1_81::parameter::aux::tagged_argument< BOOST_PP_CAT(Keyword, i), \
...
#define BOOST_GRAPH_MAKE_AP_TYPE_SPECIALIZATION(z, i, _)                  \
    ...
    {                                                                     \
        typedef BOOST_PP_REPEAT(i, BOOST_GRAPH_OPENING_PART_OF_PAIR,      \
            BOOST_PP_DEC(i)) zr_boost_1_81::parameter::aux::empty_arg_list        \
...
#define BOOST_GRAPH_MAKE_FORWARDING_FUNCTION(name, nfixed, nnamed_max)        \
    ...
    template < BOOST_PP_ENUM_PARAMS(nfixed, typename Param)                   \
        ...
        typename zr_boost_1_81::result_of< detail::BOOST_PP_CAT(name, _impl)          \
...
#define BOOST_GRAPH_MAKE_FORWARDING_FUNCTION_ONEX(z, nnamed, name, nfixed)     \
    ...
    typename BOOST_PP_EXPR_IF(nnamed,                                          \
        zr_boost_1_81::lazy_enable_if                                                  \
            < zr_boost_1_81::parameter::is_argument_pack< ArgumentPack0 >)             \
        BOOST_PP_COMMA_IF(nnamed)::zr_boost_1_81::graph::detail::BOOST_PP_CAT(         \
    ...
    {                                                                          \
        return ::zr_boost_1_81::graph::BOOST_PP_CAT(name, _with_named_params)(         \
...
#define BOOST_GRAPH_MAKE_OLD_STYLE_PARAMETER_FUNCTION(name, nfixed)            \
    template < BOOST_PP_ENUM_PARAMS(nfixed, typename Param)                    \
        ...
        class T, class R >                                                     \
    typename zr_boost_1_81::result_of< ::zr_boost_1_81::graph::detail::BOOST_PP_CAT(           \
        ...
        Param) BOOST_PP_EXPR_IF(nfixed, >)(BOOST_PP_ENUM_PARAMS(nfixed, Param) \
            BOOST_PP_COMMA_IF(nfixed) const typename zr_boost_1_81::detail::           \
                convert_bgl_params_to_boost_parameter<                         \
                    zr_boost_1_81::bgl_named_params< P, T, R > >::type&) >::type       \
    name(BOOST_PP_ENUM_BINARY_PARAMS(nfixed, const Param, &param)              \
            BOOST_PP_COMMA_IF(nfixed)                                          \
                const zr_boost_1_81::bgl_named_params< P, T, R >& old_style_params)    \
    {                                                                          \
        typedef zr_boost_1_81::bgl_named_params< P, T, R > old_style_params_type;      \
    ...
    BOOST_PP_EXPR_IF(nfixed, typename)                                         \
        zr_boost_1_81::result_of< ::zr_boost_1_81::graph::detail::BOOST_PP_CAT(                \
            name, _impl) BOOST_PP_EXPR_IF(nfixed,                              \
            <) BOOST_PP_ENUM_PARAMS(nfixed, Param) BOOST_PP_EXPR_IF(nfixed,    \
            >)(BOOST_PP_ENUM_PARAMS(nfixed, Param) BOOST_PP_COMMA_IF(nfixed)   \
                const zr_boost_1_81::parameter::aux::empty_arg_list&) >::type          \
            name(BOOST_PP_ENUM_BINARY_PARAMS(nfixed, const Param, &param))     \
    {                                                                          \
        BOOST_GRAPH_DECLARE_CONVERTED_PARAMETERS(                              \
            zr_boost_1_81::no_named_parameters, zr_boost_1_81::no_named_parameters())          \
        return ::zr_boost_1_81::graph::BOOST_PP_CAT(name, _with_named_params)(         \
            BOOST_PP_ENUM_PARAMS(nfixed, param) BOOST_PP_COMMA_IF(nfixed)      \
                arg_pack);                                                     \
    }
...
namespace detail
{
    ...
    {
        typedef typename zr_boost_1_81::mpl::has_key< ArgPack,
            zr_boost_1_81::graph::keywords::tag::vertex_index_map >::type
            _parameter_exists;
        typedef
            typename zr_boost_1_81::remove_const< typename override_const_property_t<
                typename zr_boost_1_81::parameter::value_type< ArgPack,
                    zr_boost_1_81::graph::keywords::tag::vertex_index_map, int >::type,
                zr_boost_1_81::vertex_index_t, Graph,
                _parameter_exists::value >::result_type >::type vi_map_type;
        typedef zr_boost_1_81::shared_array_property_map< Value, vi_map_type > map_type;
            ...
            const Graph& g, Value v, const PM&, const ArgPack& ap)
        {
            return make_shared_array_property_map(num_vertices(g), v,
                override_const_property(ap,
                    zr_boost_1_81::graph::keywords::_vertex_index_map, g,
                    vertex_index));
        }
    };
    ...
    struct map_maker
    {
        typedef typename zr_boost_1_81::mpl::has_key< ArgPack, MapTag >::type
            _parameter_exists;
        BOOST_STATIC_CONSTANT(bool, has_map = (_parameter_exists::value));
        typedef map_maker_helper< has_map, Graph, ArgPack, ValueType,
            typename zr_boost_1_81::remove_const< typename zr_boost_1_81::parameter::value_type<
            ...
            const Graph& g, const ArgPack& ap, ValueType default_value)
        {
            return helper::make_map(g, default_value,
                ap[::zr_boost_1_81::parameter::keyword< MapTag >::instance | 0], ap);
        }
    };
    ...
    static const make_property_map_from_arg_pack_gen<
        zr_boost_1_81::graph::keywords::tag::color_map, default_color_type >
        ...
        KeyMapTag, IndexInHeapMapTag, Compare, Q >
    {
        ...
        typedef zr_boost_1_81::d_ary_heap_indirect< ValueT, 4, index_in_heap_map,
            ...
            const Graph& g, const ArgPack& ap, KeyT defaultKey, const Q&)
        {
            return priority_queue_type(
                ...
                map_maker< Graph, ArgPack, IndexInHeapMapTag,
                    ...
                    typename zr_boost_1_81::property_traits<
    ...
    {
        typedef typename zr_boost_1_81::mpl::has_key< ArgPack, PriorityQueueTag >::type
            _parameter_exists;
        BOOST_STATIC_CONSTANT(bool, g_hasQ = (_parameter_exists::value));
        typedef zr_boost_1_81::reference_wrapper< int > int_refw;
        typedef typename zr_boost_1_81::parameter::value_type< ArgPack,
            PriorityQueueTag, int_refw >::type param_value_type_wrapper;
        typedef typename param_value_type_wrapper::type param_value_type;
        typedef typename zr_boost_1_81::remove_const< param_value_type >::type
            ...
            const Graph& g, const ArgPack& ap, KeyT defaultKey)
        {
            return helper::make_queue(g, ap, defaultKey,
                ap[::zr_boost_1_81::parameter::keyword< PriorityQueueTag >::instance
                    | 0]);
        }
    };
    ...
    template < class PriorityQueueTag, class KeyT, class ValueT,
        ...
        class KeyMapTag = zr_boost_1_81::graph::keywords::tag::distance_map,
        class IndexInHeapMapTag
        = zr_boost_1_81::graph::keywords::tag::index_in_heap_map >
    ...
    template < typename G >
    typename zr_boost_1_81::graph_traits< G >::vertex_descriptor get_null_vertex(
        const G&)
    {
        return zr_boost_1_81::graph_traits< G >::null_vertex();
    }

    template < typename G >
    typename zr_boost_1_81::graph_traits< G >::vertex_descriptor
    get_default_starting_vertex(const G& g)
    {
        std::pair< typename zr_boost_1_81::graph_traits< G >::vertex_iterator,
            typename zr_boost_1_81::graph_traits< G >::vertex_iterator >
            iters = vertices(g);
        return (iters.first == iters.second)
            ? zr_boost_1_81::graph_traits< G >::null_vertex()
            : *iters.first;
    }
    ...
    {
        typedef
            typename zr_boost_1_81::graph_traits< G >::vertex_descriptor result_type;
        const G& g;
