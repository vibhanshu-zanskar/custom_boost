...
std::basic_ostream< Char, Traits >& operator<<(
    ...
    const zr_boost_1_81::detail::edge_desc_impl< D, V >& e)
{
...
struct hash< zr_boost_1_81::detail::edge_desc_impl< D, V > >
{
    std::size_t operator()(const zr_boost_1_81::detail::edge_desc_impl< D, V >& x) const
    {
