...
inline void property_map_swap(PropMap prop_map,
    const typename zr_boost_1_81::property_traits< PropMap >::key_type& ka,
    const typename zr_boost_1_81::property_traits< PropMap >::key_type& kb)
{
    typename zr_boost_1_81::property_traits< PropMap >::value_type va
        = get(prop_map, ka);
...
namespace detail
{
    ...
    {
        zr_boost_1_81::shared_array< Value > m_data;
        std::size_t m_size;
...
public:
    ...
    typedef typename zr_boost_1_81::property_traits< DistanceMap >::value_type key_type;
...
private:
    ...
    // distance map
    typedef typename zr_boost_1_81::property_traits< DistanceMap >::value_type
        distance_type;
