...
namespace detail
{
    namespace graph
    {
        ...
        typedef zr_boost_1_81::function2< void, id_t const&, id_t const& > actor_t;
        ...
        /////////////////////////////////////////////////////////////////////////////
        struct id_closure
        : zr_boost_1_81::spirit::classic::closure< id_closure, node_t >
        {
            member1 name;
        };

        struct node_id_closure
        : zr_boost_1_81::spirit::classic::closure< node_id_closure, node_t >
        {
            member1 name;
        };

        struct attr_list_closure
        : zr_boost_1_81::spirit::classic::closure< attr_list_closure, actor_t >
        {
            member1 prop_actor;
        };

        struct property_closure
        : zr_boost_1_81::spirit::classic::closure< property_closure, id_t, id_t >
        {
            member1 key;
            member2 value;
        };
        ...
        : zr_boost_1_81::spirit::classic::closure< data_stmt_closure, nodes_t, nodes_t,
        ...
        : zr_boost_1_81::spirit::classic::closure< subgraph_closure, nodes_t, edges_t,
              node_t >
        {
            member1 nodes;
            member2 edges;
        ...
        struct dot_grammar
        : public zr_boost_1_81::spirit::classic::grammar< dot_grammar >
        {
            mutate_graph& graph_;
            ...
            template < class ScannerT > struct definition
            {
                ...
                : self(self), subgraph_depth(0), keyword_p("0-9a-zA-Z_")
                {
                    ...
                    using namespace zr_boost_1_81phoenix;
                    ...
                    a_list = list_p(
                        ID[(a_list.key = arg1), (a_list.value = "true")] >> !(
                            ch_p('=') >> ID[a_list.value = arg1])[zr_boost_1_81phoenix::bind(
                    ...
                    node_id
                        = (ID[node_id.name = arg1] >> (!port))[zr_boost_1_81phoenix::bind(
                            &definition::memoize_node)(var(*this))];

                    graph_stmt = (ID[graph_stmt.key = arg1] >> ch_p('=')
                        >> ID[graph_stmt.value = arg1])[zr_boost_1_81phoenix::bind(
                    ...
                    attr_stmt
                        = (as_lower_d[keyword_p("graph")] >> attr_list(actor_t(
                               zr_boost_1_81phoenix::bind(&definition::default_graph_prop)(
                                   var(*this), arg1, arg2))))
                        | (as_lower_d[keyword_p("node")] >> attr_list(actor_t(
                               zr_boost_1_81phoenix::bind(&definition::default_node_prop)(
                                   var(*this), arg1, arg2))))
                        | (as_lower_d[keyword_p("edge")] >> attr_list(actor_t(
                               zr_boost_1_81phoenix::bind(&definition::default_edge_prop)(
                                   var(*this), arg1, arg2))));

                    // edge_head is set depending on the graph type
                    // (directed/undirected)
                    edgeop = ch_p('-') >> ch_p(zr_boost_1_81::ref(edge_head));

                    edgeRHS = +(edgeop[(data_stmt.sources = data_stmt.dests),
                                    (data_stmt.dests = construct_< nodes_t >())]
                        >> (subgraph[data_stmt.dests = arg1]
                            | node_id[zr_boost_1_81phoenix::bind(&definition::insert_node)(
                                var(*this), data_stmt.dests, arg1)])
                            [zr_boost_1_81phoenix::bind(&definition::activate_edge)(
                    ...
                    data_stmt
                        = (subgraph[(data_stmt.dests
                              ...
                              | node_id[(zr_boost_1_81phoenix::bind(
                        ...
                        >> if_p(edgeRHS)[!attr_list(actor_t(zr_boost_1_81phoenix::bind(
                                             &definition::edge_prop)(
                                             var(*this), arg1, arg2)))]
                               .else_p[if_p(data_stmt.saw_node)[!attr_list(
                                   actor_t(zr_boost_1_81phoenix::bind(
                    ...
                    the_grammar = (!as_lower_d[keyword_p("strict")])
                        >> (as_lower_d[keyword_p(
                                "graph")][(var(edge_head) = '-'),
                                (zr_boost_1_81phoenix::bind(&definition::check_undirected)(
                                    var(*this)))]
                            | as_lower_d[keyword_p(
                                "digraph")][(var(edge_head) = '>'),
                                (zr_boost_1_81phoenix::bind(&definition::check_directed)(
                                    var(*this)))])
                        >> (!ID) >> ch_p('{') >> stmt_list >> ch_p('}');

                } // definition()

                typedef zr_boost_1_81::spirit::classic::rule< ScannerT > rule_t;
                ...
                void check_undirected()
                {
                    if (self.graph_.is_directed())
                        zr_boost_1_81::throw_exception(zr_boost_1_81::undirected_graph_error());
                }

                void check_directed()
                {
                    if (!self.graph_.is_directed())
                        zr_boost_1_81::throw_exception(zr_boost_1_81::directed_graph_error());
                }
       ...
       // RG: Here I  would actually set the properties
            ...
            std::cout << "(" << edge.first << "," << edge.second << "): "
                ...
                // Keywords;
                const zr_boost_1_81::spirit::classic::distinct_parser<> keyword_p;
                //
                // rules that make up the grammar
                //
                zr_boost_1_81::spirit::classic::rule< ScannerT, id_closure::context_t >
                    ID;
                zr_boost_1_81::spirit::classic::rule< ScannerT,
        ...
        //
        struct dot_skipper
        : public zr_boost_1_81::spirit::classic::grammar< dot_skipper >
        {
            dot_skipper() {}
            ...
            template < typename ScannerT > struct definition
            {
                ...
                zr_boost_1_81::spirit::classic::rule< ScannerT > skip;
                zr_boost_1_81::spirit::classic::rule< ScannerT > const& start() const
                {
                    return skip;
                }
            }; // definition
    ...
    std::string const& node_id = "node_id")
{
    ...
    typedef skip_parser_iteration_policy< zr_boost_1_81::detail::graph::dot_skipper >
        iter_policy_t;
    typedef scanner_policies< iter_policy_t > scanner_policies_t;
    typedef scanner< iterator_t, scanner_policies_t > scanner_t;

    ::zr_boost_1_81::detail::graph::mutate_graph_impl< MutableGraph > m_graph(
        graph, dp, node_id);

    ::zr_boost_1_81::detail::graph::dot_grammar p(m_graph);
    ::zr_boost_1_81::detail::graph::dot_skipper skip_p;
