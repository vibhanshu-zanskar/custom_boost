...
namespace detail
{
    ...
    public:
            ...
            const GlobalToLocal& global_to_local, const SourcePred& source_pred)
        {
            ...
            typedef std::pair< vertices_size_type, vertices_size_type >
                edge_type;
            typedef zr_boost_1_81::transform_iterator<
                zr_boost_1_81::graph::detail::project1st< edge_type >,
                MultiPassInputIterator >
                source_iterator;
            typedef zr_boost_1_81::transform_iterator<
                zr_boost_1_81::graph::detail::project2nd< edge_type >,
                MultiPassInputIterator >
                target_iterator;
            source_iterator sources_begin(
                edge_begin, zr_boost_1_81::graph::detail::project1st< edge_type >());
            source_iterator sources_end(
                edge_end, zr_boost_1_81::graph::detail::project1st< edge_type >());
            target_iterator targets_begin(
                edge_begin, zr_boost_1_81::graph::detail::project2nd< edge_type >());
            target_iterator targets_end(
                edge_end, zr_boost_1_81::graph::detail::project2nd< edge_type >());

            zr_boost_1_81::graph::detail::count_starts(sources_begin, sources_end,
                m_rowstart.begin(), numlocalverts, source_pred,
                zr_boost_1_81::make_property_map_function(global_to_local));

            m_column.resize(m_rowstart.back());
            inherited_edge_properties::resize(m_rowstart.back());

            zr_boost_1_81::graph::detail::histogram_sort(sources_begin, sources_end,
            ...
            vertices_size_type numlocalverts, edges_size_type numedges_or_zero)
        {
            ...
            if (numedges == 0)
            {
                numedges = zr_boost_1_81::graph::detail::reserve_count_for_single_pass(
                    edge_begin, edge_end);
            }
            m_column.clear();
            m_column.reserve(numedges_or_zero);
            ...
            vertices_size_type numverts, GlobalToLocal global_to_local)
        {
            ...
            zr_boost_1_81::graph::detail::count_starts(sources.begin(), sources.end(),
                m_rowstart.begin(), numverts, keep_all(),
                zr_boost_1_81::make_property_map_function(global_to_local));
            zr_boost_1_81::graph::detail::histogram_sort_inplace(sources.begin(),
            ...
            vertices_size_type numverts, edges_size_type numedges)
        {
            ...
            typedef typename zr_boost_1_81::graph_traits< Graph >::vertex_descriptor
                g_vertex;
            typedef typename zr_boost_1_81::graph_traits< Graph >::out_edge_iterator
                g_out_edge_iter;
            ...
            for (Vertex i = 0; i != numverts; ++i)
            {
                ...
                for (zr_boost_1_81::tie(ei, ei_end) = out_edges(v, g); ei != ei_end;
                     ++ei)
                {
        ...
        {
            typedef zr_boost_1_81::reverse_iterator< BidirectionalIteratorOrig >
                BidirectionalIterator;
            typedef zr_boost_1_81::reverse_iterator< EPIterOrig > EPIter;
            // Flip sequence
    ...
    : public iterator_facade< csr_edge_iterator< CSRGraph >,
          typename CSRGraph::edge_descriptor, zr_boost_1_81::forward_traversal_tag,
    ...
    template < typename Iter > struct transpose_iterator_gen
    {
        ...
        typedef zr_boost_1_81::transform_iterator< transpose, Iter > type;
    ...
    {
        typedef typename zr_boost_1_81::graph_traits< GraphT >::vertices_size_type
            vertices_size_type;
        typedef typename zr_boost_1_81::graph_traits< GraphT >::edge_descriptor
            edge_descriptor;
    ...
    edge_to_index_pair< GraphT,
        typename zr_boost_1_81::property_map< GraphT,
            zr_boost_1_81::vertex_index_t >::const_type >
    make_edge_to_index_pair(const GraphT& g)
    {
        typedef typename zr_boost_1_81::property_map< GraphT,
            zr_boost_1_81::vertex_index_t >::const_type VertexIndexMap;
        return edge_to_index_pair< GraphT, VertexIndexMap >(
            g, get(zr_boost_1_81::vertex_index, g));
    }

    template < typename GraphT, typename VertexIndexMap, typename Iter >
    zr_boost_1_81::transform_iterator< edge_to_index_pair< GraphT, VertexIndexMap >,
        Iter >
    make_edge_to_index_pair_iter(
        const GraphT& g, const VertexIndexMap& index, Iter it)
    {
        return zr_boost_1_81::transform_iterator<
