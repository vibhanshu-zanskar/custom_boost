...
namespace detail
{
    ...
    {
        zr_boost_1_81::graph_detail::erase_if(
    ...
    class stored_edge
    : public zr_boost_1_81::equality_comparable1< stored_edge< Vertex >,
          zr_boost_1_81::less_than_comparable1< stored_edge< Vertex > > >
    {
    public:
...
namespace detail
{
    ...
    inline void remove_directed_edge_if_dispatch(incidence_iterator first,
        ...
        zr_boost_1_81::allow_parallel_edge_tag)
    {
        // remove_if
    ...
    inline void remove_directed_edge_if_dispatch(incidence_iterator first,
        incidence_iterator last, EdgeList& el, Predicate pred,
        zr_boost_1_81::disallow_parallel_edge_tag)
    {
    ...
    inline void undirected_remove_out_edge_if_dispatch(Graph& g,
        ...
        Predicate pred, zr_boost_1_81::allow_parallel_edge_tag)
    {
    ...
    inline void undirected_remove_out_edge_if_dispatch(Graph& g,
        incidence_iterator first, incidence_iterator last, EdgeList& el,
        Predicate pred, zr_boost_1_81::disallow_parallel_edge_tag)
    {
        typedef typename Graph::global_edgelist_selector EdgeListS;
        BOOST_STATIC_ASSERT((!is_same< EdgeListS, vecS >::value));
    ...
    Predicate pred, directed_graph_helper< Config >& g_)
{
    ...
    zr_boost_1_81::tie(first, last) = out_edges(u, g);
...
inline void remove_edge_if(Predicate pred, directed_graph_helper< Config >& g_)
{
    ...
    for (zr_boost_1_81::tie(vi, vi_end) = vertices(g); vi != vi_end; ++vi)
    ...
    typename Config::vertex_descriptor u, directed_graph_helper< Config >& g_)
{
    ...
    for (zr_boost_1_81::tie(vi, viend) = vertices(g); vi != viend; ++vi)
    ...
    directed_graph_helper< Config >& g_)
{
    ...
    bool inserted;
    zr_boost_1_81::tie(i, inserted)
        = zr_boost_1_81::graph_detail::push(g.out_edge_list(u), StoredEdge(v, p));
...
namespace detail
{
    ...
    inline void remove_edge_and_property(
        Graph& g, EdgeList& el, Vertex v, zr_boost_1_81::allow_parallel_edge_tag cat)
    {
        typedef typename Graph::global_edgelist_selector EdgeListS;
        BOOST_STATIC_ASSERT((!is_same< EdgeListS, vecS >::value));
        ...
        for (; i != end; ++i)
        {
            if ((*i).get_target() == v)
            {
                ...
                // for multisets also.
                bool skip = (zr_boost_1_81::next(i) != end
                    && i->get_iter() == zr_boost_1_81::next(i)->get_iter());
    ...
    template < class Graph, class EdgeList, class Vertex >
    inline void remove_edge_and_property(
        Graph& g, EdgeList& el, Vertex v, zr_boost_1_81::disallow_parallel_edge_tag)
    {
        typedef typename Graph::global_edgelist_selector EdgeListS;
        BOOST_STATIC_ASSERT((!is_same< EdgeListS, vecS >::value));
...
: public zr_boost_1_81::detail::edge_base< zr_boost_1_81::undirected_tag, Vertex >
{
    typedef EdgeProperty property_type;
    typedef zr_boost_1_81::detail::edge_base< zr_boost_1_81::undirected_tag, Vertex > Base;
...
void remove_edge_if(Predicate pred, undirected_graph_helper< Config >& g_)
{
    ...
    zr_boost_1_81::tie(ei, ei_end) = edges(g);
    ...
    typename Config::vertex_descriptor u, undirected_graph_helper< Config >& g_)
{
    ...
    while (true)
    {
        ...
        zr_boost_1_81::tie(ei, ei_end) = out_edges(u, g);
        if (ei == ei_end)
            break;
        remove_edge(*ei, g);
    }
    ...
    undirected_graph_helper< Config >& g_)
{
    ...
    typename Config::OutEdgeList::iterator i;
    zr_boost_1_81::tie(i, inserted) = zr_boost_1_81::graph_detail::push(
        g.out_edge_list(u), StoredEdge(v, p_iter, &g.m_edges));
    if (inserted)
    {
        zr_boost_1_81::graph_detail::push(
    ...
    Predicate pred, bidirectional_graph_helper_with_property< Config >& g_)
{
    ...
    for (zr_boost_1_81::tie(out_i, out_end) = out_edges(u, g); out_i != out_end;
         ++out_i)
        if (pred(*out_i))
        {
    ...
    Predicate pred, bidirectional_graph_helper_with_property< Config >& g_)
{
    ...
    for (zr_boost_1_81::tie(in_i, in_end) = in_edges(v, g); in_i != in_end; ++in_i)
        if (pred(*in_i))
        {
    ...
    zr_boost_1_81::tie(first, last) = in_edges(v, g);
    typedef typename Config::edge_parallel_category Cat;
    detail::remove_directed_edge_if_dispatch(
    ...
    const adj_list_helper< Config, Base >& g_)
{
    ...
    typedef typename Config::inv_adjacency_iterator inv_adjacency_iterator;
    typename Config::in_edge_iterator first, last;
    zr_boost_1_81::tie(first, last) = in_edges(u, g);
    return std::make_pair(
    ...
    const adj_list_helper< Config, Base >& g_)
{
    ...
    zr_boost_1_81::tie(first, last) = graph_detail::equal_range(el, StoredEdge(v));
    return std::make_pair(
...
namespace detail
{
    ...
    inline typename zr_boost_1_81::property_map< typename Config::graph_type,
        Property >::type
    get_dispatch(
        adj_list_helper< Config, Base >&, Property p, zr_boost_1_81::edge_property_tag)
    {
        typedef typename Config::graph_type Graph;
        typedef typename zr_boost_1_81::property_map< Graph, Property >::type PA;
        return PA(p);
    }
    template < class Config, class Base, class Property >
    inline typename zr_boost_1_81::property_map< typename Config::graph_type,
    ...
    get_dispatch(const adj_list_helper< Config, Base >&, Property p,
        zr_boost_1_81::edge_property_tag)
    {
        typedef typename Config::graph_type Graph;
        typedef typename zr_boost_1_81::property_map< Graph, Property >::const_type PA;
        return PA(p);
    }
    ...
    get_dispatch(adj_list_helper< Config, Base >& g, Property p,
        zr_boost_1_81::vertex_property_tag)
    {
        typedef typename Config::graph_type Graph;
        typedef typename zr_boost_1_81::property_map< Graph, Property >::type PA;
...
template < class Config, class Base, class Property >
inline
    typename zr_boost_1_81::property_map< typename Config::graph_type, Property >::type
...
inline typename zr_boost_1_81::property_traits< typename zr_boost_1_81::property_map<
...
{
    typedef typename Config::graph_type Graph;
    typedef typename zr_boost_1_81::property_map< Graph, Property >::type Map;
...
public:
    ...
    inline void copy_impl(const adj_list_impl& x_)
    {
        ...
        for (zr_boost_1_81::tie(vi, vi_end) = vertices(x); vi != vi_end; ++vi)
        {
        ...
        for (zr_boost_1_81::tie(ei, ei_end) = edges(x); ei != ei_end; ++ei)
        {
            edge_descriptor e;
            bool inserted;
            vertex_descriptor s = source(*ei, x), t = target(*ei, x);
            zr_boost_1_81::tie(e, inserted) = add_edge(vertex_map[(stored_vertex*)s],
    ...
    adj_list_impl< Derived, Config, Base >& g_)
{
    ...
    bool inserted;
    zr_boost_1_81::tie(pos, inserted) = zr_boost_1_81::graph_detail::push(g.m_vertices, v);
    v->m_position = pos;
    g.added_vertex(v);
    return v;
}
    ...
    adj_list_impl< Derived, Config, Base >& g_)
{
    ...
    Derived& g = static_cast< Derived& >(g_);
    g.removing_vertex(
        u, zr_boost_1_81::graph_detail::iterator_stability(g_.m_vertices));
...
namespace detail
{
    ...
    inline void remove_vertex_dispatch(
        Graph& g, vertex_descriptor u, zr_boost_1_81::directed_tag)
    {
    ...
    template < class Graph, class vertex_descriptor >
    inline void remove_vertex_dispatch(
        Graph& g, vertex_descriptor u, zr_boost_1_81::undirected_tag)
    {
        typedef typename Graph::global_edgelist_selector EdgeListS;
        BOOST_STATIC_ASSERT((!is_same< EdgeListS, vecS >::value));
    ...
    template < class Graph, class vertex_descriptor >
    inline void remove_vertex_dispatch(
        Graph& g, vertex_descriptor u, zr_boost_1_81::bidirectional_tag)
    {
        typedef typename Graph::global_edgelist_selector EdgeListS;
        BOOST_STATIC_ASSERT((!is_same< EdgeListS, vecS >::value));
    ...
    inline void reindex_edge_list(
        EdgeList& el, vertex_descriptor u, zr_boost_1_81::allow_parallel_edge_tag)
    {
    ...
    template < class EdgeList, class vertex_descriptor >
    inline void reindex_edge_list(
        EdgeList& el, vertex_descriptor u, zr_boost_1_81::disallow_parallel_edge_tag)
    {
        typename EdgeList::iterator ei = el.begin(), e_end = el.end();
        while (ei != e_end)
        {
...
public:
    ...
    //    protected:
    inline zr_boost_1_81::integer_range< vertex_descriptor > vertex_set() const
    {
        return zr_boost_1_81::integer_range< vertex_descriptor >(0, m_vertices.size());
    }
    inline OutEdgeList& out_edge_list(vertex_descriptor v)
    {
    ...
    vec_adj_list_impl< Graph, Config, Base >& g_)
{
    ...
    Graph& g = static_cast< Graph& >(g_);
    g.removing_vertex(
        v, zr_boost_1_81::graph_detail::iterator_stability(g_.m_vertices));
    ...
    struct adj_list_gen
    {
        ...
        struct config
        {
            ...
            typedef typename container_gen< VertexListS, vertex_ptr >::type
                SeqVertexList;
            typedef zr_boost_1_81::integer_range< vertex_descriptor > RandVertexList;
...
: public zr_boost_1_81::put_get_helper< Reference,
      adj_list_vertex_property_map< Graph, ValueType, Reference, Tag > >
{
    ...
    typedef zr_boost_1_81::lvalue_property_map_tag category;
...
: public zr_boost_1_81::put_get_helper< PropRef,
          ...
          Tag > >
{
    typedef ValueType value_type;
    typedef Reference reference;
    typedef typename zr_boost_1_81::graph_traits< Graph >::vertex_descriptor key_type;
    typedef zr_boost_1_81::lvalue_property_map_tag category;
...
: public zr_boost_1_81::put_get_helper< PropertyRef,
...
: public zr_boost_1_81::put_get_helper< Vertex,
      vec_adj_list_vertex_id_map< Property, Vertex > >
{
    typedef Vertex value_type;
    typedef Vertex key_type;
    typedef Vertex reference;
    typedef zr_boost_1_81::readable_property_map_tag category;
...
namespace detail
{
    ...
    : zr_boost_1_81::mpl::if_< zr_boost_1_81::is_same< Tag, vertex_all_t >,
...
template < typename V > struct hash< zr_boost_1_81::detail::stored_edge< V > >
{
    std::size_t operator()(const zr_boost_1_81::detail::stored_edge< V >& e) const
    {
...
struct hash< zr_boost_1_81::detail::stored_edge_property< V, P > >
{
    std::size_t operator()(
        const zr_boost_1_81::detail::stored_edge_property< V, P >& e) const
    {
        return hash< V >()(e.m_target);
    }
};
...
struct hash< zr_boost_1_81::detail::stored_edge_iter< V, I, P > >
{
    std::size_t operator()(
        const zr_boost_1_81::detail::stored_edge_iter< V, I, P >& e) const
    {
        return hash< V >()(e.m_target);
    }
};
