...
namespace detail
{
    ...
    class shadow_proxy : zr_boost_1_81::operators< shadow_proxy< A, B, D > >
    {
...
void swap(zr_boost_1_81::detail::shadow_proxy< A1&, B1&, D1 > x,
    zr_boost_1_81::detail::shadow_proxy< A2&, B2&, D2 > y)
{
    std::swap(x.a, y.a);
    std::swap(x.b, y.b);
}
