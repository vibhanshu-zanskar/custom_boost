    ...
    struct dijkstra_bfs_visitor
    {
        ...
        template < class Edge, class Graph > void examine_edge(Edge e, Graph& g)
        {
            ...
            if (m_compare(m_combine(m_zero, get(m_weight, e)), m_zero))
                zr_boost_1_81::throw_exception(negative_edge());
...
namespace detail
{
    ...
    {
        typedef zr_boost_1_81::iterator_property_map< Value*, IndexMap > type;
        static type build(const Graph& g, const IndexMap& index,
            zr_boost_1_81::scoped_array< Value >& array_holder)
        {
    ...
    {
        typedef zr_boost_1_81::vector_property_map< Value, IndexMap > type;
        static type build(const Graph& g, const IndexMap& index,
            zr_boost_1_81::scoped_array< Value >& array_holder)
        {
            return zr_boost_1_81::make_vector_property_map< Value >(index);
        }
    };
    ...
    {
        typedef zr_boost_1_81::is_base_and_derived< zr_boost_1_81::vertex_list_graph_tag,
            typename zr_boost_1_81::graph_traits< Graph >::traversal_category >
            known_num_vertices;
...
namespace detail
{
    ...
    {
        typedef zr_boost_1_81::two_bit_color_map< IndexMap > type;
        static type build(const Graph& g, const IndexMap& index)
        {
            size_t nv = num_vertices(g);
            return zr_boost_1_81::two_bit_color_map< IndexMap >(nv, index);
        }
    };
    ...
    {
        typedef zr_boost_1_81::vector_property_map< zr_boost_1_81::two_bit_color_type,
            IndexMap >
            type;
        static type build(const Graph& g, const IndexMap& index)
        {
            return zr_boost_1_81::make_vector_property_map< zr_boost_1_81::two_bit_color_type >(
                index);
        }
    };
    ...
    Combine combine, DistZero zero, DijkstraVisitor vis, ColorMap color)
{
    ...
    zr_boost_1_81::scoped_array< std::size_t > index_in_heap_map_holder;
...
{
    zr_boost_1_81::two_bit_color_map< IndexMap > color(num_vertices(g), index_map);
