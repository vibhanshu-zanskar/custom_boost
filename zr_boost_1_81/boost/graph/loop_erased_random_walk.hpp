...
void loop_erased_random_walk(const Graph& g,
    typename zr_boost_1_81::graph_traits< Graph >::vertex_descriptor s,
    NextEdge next_edge, ColorMap color,
    std::vector< typename zr_boost_1_81::graph_traits< Graph >::vertex_descriptor >&
        path)
{
    ...
    typedef typename zr_boost_1_81::property_traits< ColorMap >::value_type color_t;
    typedef zr_boost_1_81::color_traits< color_t > color_gen;
...
template < typename Graph, typename Gen > class unweighted_random_out_edge_gen
{
    ...
    typedef zr_boost_1_81::graph_traits< Graph > gt;
...
public:
        ...
        typename gt::vertex_descriptor src, const Graph& g) const
    {
        ...
        return zr_boost_1_81::random_out_edge(g, src, gen);
    }
};
...
public:
        ...
        typename gt::vertex_descriptor src, const Graph& g) const
    {
        if (out_degree(src, g) == 0)
            throw loop_erased_random_walk_stuck();
        return zr_boost_1_81::weighted_random_out_edge(g, src, weight, gen);
    }
};
}
