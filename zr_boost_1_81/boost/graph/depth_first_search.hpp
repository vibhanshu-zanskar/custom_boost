...
namespace detail
{
    ...
    || (defined(__INTEL_COMPILER) && (__INTEL_COMPILER >= 1200)))
        do_call_finish_edge< has_member_function_finish_edge< Vis, void,
            zr_boost_1_81::mpl::vector< E, const G& > >::value >::call_finish_edge(vis,
            e, g);
#else
...
// comparison.
        ...
        DFSVisitor& vis, ColorMap color, TerminatorFunc func = TerminatorFunc())
    {
        ...
        typedef std::pair< Vertex,
            std::pair< zr_boost_1_81::optional< Edge >, std::pair< Iter, Iter > > >
            VertexInfo;

        zr_boost_1_81::optional< Edge > src_e;
        Iter ei, ei_end;
        ...
        if (func(u, g))
        {
            ...
            stack.push_back(std::make_pair(u,
                std::make_pair(zr_boost_1_81::optional< Edge >(),
        ...
        else
        {
            stack.push_back(std::make_pair(u,
                std::make_pair(
                    zr_boost_1_81::optional< Edge >(), std::make_pair(ei, ei_end))));
        }
        while (!stack.empty())
        {
            ...
            zr_boost_1_81::tie(ei, ei_end) = back.second.second;
            stack.pop_back();
    ...
    typename graph_traits< VertexListGraph >::vertex_descriptor start_vertex)
{
    ...
    for (zr_boost_1_81::tie(ui, ui_end) = vertices(g); ui != ui_end; ++ui)
    {
...
{
    typedef typename zr_boost_1_81::graph_traits< VertexListGraph >::vertex_iterator vi;
...
public:
    ...
    {
        invoke_visitors(m_vis, u, g, ::zr_boost_1_81::on_examine_edge());
    }
    template < class Edge, class Graph > void tree_edge(Edge u, const Graph& g)
    {
        invoke_visitors(m_vis, u, g, ::zr_boost_1_81::on_tree_edge());
    }
    template < class Edge, class Graph > void back_edge(Edge u, const Graph& g)
    {
        invoke_visitors(m_vis, u, g, ::zr_boost_1_81::on_back_edge());
    }
    template < class Edge, class Graph >
    void forward_or_cross_edge(Edge u, const Graph& g)
    {
        invoke_visitors(m_vis, u, g, ::zr_boost_1_81::on_forward_or_cross_edge());
    }
    template < class Edge, class Graph >
    void finish_edge(Edge u, const Graph& g)
    {
        invoke_visitors(m_vis, u, g, ::zr_boost_1_81::on_finish_edge());
    }
    template < class Vertex, class Graph >
    ...
    namespace detail
    {
        template < typename Graph > struct depth_first_search_impl
        {
            ...
            void operator()(const Graph& g, const ArgPack& arg_pack) const
            {
                ...
                zr_boost_1_81::depth_first_search(g,
                    ...
                    arg_pack[_root_vertex
                        || zr_boost_1_81::detail::get_default_starting_vertex_t<
                            Graph >(g)]);
            }
        };
    }
