...
public:
    ...
    virtual zr_boost_1_81::any do_add_vertex() = 0;
    virtual std::pair< zr_boost_1_81::any, bool > do_add_edge(
        zr_boost_1_81::any source, zr_boost_1_81::any target)
        = 0;
    ...
    virtual void set_vertex_property(const std::string& name, zr_boost_1_81::any vertex,
        const std::string& value, const std::string& value_type)
        = 0;

    virtual void set_edge_property(const std::string& name, zr_boost_1_81::any edge,
        const std::string& value, const std::string& value_type)
        = 0;
};
    ...
    bool ordered_vertices = false)
{
    ...
    using zr_boost_1_81::property_tree::xml_parser::encode_char_entities;
    ...
    for (zr_boost_1_81::tie(e, e_end) = edges(g); e != e_end; ++e)
    {
