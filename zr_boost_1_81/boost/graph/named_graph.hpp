...
#include <boost/pending/property.hpp> // for zr_boost_1_81::lookup_one_property
#include <boost/pending/container_traits.hpp>
#include <boost/throw_exception.hpp>
#include <boost/tuple/tuple.hpp> // for zr_boost_1_81::make_tuple
...
#define BGL_NAMED_GRAPH named_graph< Graph, Vertex, VertexProperty >
    ...
    : named_vertices(typename named_vertices_type::ctor_args_list(
        zr_boost_1_81::make_tuple(zr_boost_1_81::make_tuple(0, // initial number of buckets
            extract_name_from_vertex(derived(), extract),
            zr_boost_1_81::hash< vertex_name_type >(),
        ...
        Vertex vertex, VertexIterStability)
    {
        BOOST_STATIC_ASSERT_MSG(
            (zr_boost_1_81::is_base_of< zr_boost_1_81::graph_detail::stable_tag,
