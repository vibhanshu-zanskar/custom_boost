...
namespace detail
{
    ...
    : public zr_boost_1_81::iterator_facade< default_construct_iterator< T >, T,
          zr_boost_1_81::random_access_traversal_tag, const T& >
    {
        typedef zr_boost_1_81::iterator_facade< default_construct_iterator< T >, T,
...
public:
    ...
    : inherited_vertex_properties(numverts), m_property(prop)
    {
        m_forward.assign_sources_and_targets_global(sources, targets, numverts,
            zr_boost_1_81::typed_identity_property_map< vertices_size_type >());
    }
    ...
    : inherited_vertex_properties(numverts), m_property(prop)
    {
        ...
        zr_boost_1_81::graph::detail::split_into_separate_coords(
    ...
    {
        std::vector< vertex_descriptor > sources, targets;
        zr_boost_1_81::graph::detail::split_into_separate_coords_filtered(
    ...
    : inherited_vertex_properties(numlocalverts), m_property(prop)
    {
        ...
        zr_boost_1_81::graph::detail::split_into_separate_coords_filtered(edge_begin,
        ...
        const GlobalToLocal& global_to_local)
    {
        ...
        typedef
            typename zr_boost_1_81::graph_traits< Graph >::vertex_descriptor vertex_t;
        ...
        const GlobalToLocal& global_to_local)
    {
        ...
        typedef std::vector< zr_boost_1_81::tuple< vertex_pair, edge_bundled > >
            edge_vector_t;
        edge_vector_t new_edges(
            zr_boost_1_81::make_zip_iterator(zr_boost_1_81::make_tuple(first, ep_iter)),
            zr_boost_1_81::make_zip_iterator(zr_boost_1_81::make_tuple(last, ep_iter_end)));
        if (new_edges.empty())
            return;
        std::sort(new_edges.begin(), new_edges.end(),
            zr_boost_1_81::detail::compare_first< std::less< vertex_pair > >());
        m_forward.add_edges_sorted_internal(
            zr_boost_1_81::make_transform_iterator(new_edges.begin(),
                zr_boost_1_81::detail::my_tuple_get_class< 0, vertex_pair >()),
            zr_boost_1_81::make_transform_iterator(new_edges.end(),
                zr_boost_1_81::detail::my_tuple_get_class< 0, vertex_pair >()),
            zr_boost_1_81::make_transform_iterator(new_edges.begin(),
                zr_boost_1_81::detail::my_tuple_get_class< 1, edge_bundled >()),
            global_to_local);
    }
...
public:
    ...
    typedef detail::compressed_sparse_row_structure< EdgeProperty, Vertex,
        EdgeIndex >
        forward_type;
    typedef EdgeIndex /* typename zr_boost_1_81::mpl::if_c<zr_boost_1_81::is_same<EdgeProperty,
                         zr_boost_1_81::no_property>, zr_boost_1_81::no_property, EdgeIndex> */
...
private:
    void set_up_backward_property_links()
    {
        ...
        m_backward.assign_unsorted_multi_pass_edges(
            ...
            zr_boost_1_81::counting_iterator< EdgeIndex >(0),
...
struct property_map< BOOST_CSR_GRAPH_TYPE, graph_all_t,
    typename disable_if< detail::is_distributed_selector< Vertex > >::type >
{
    typedef zr_boost_1_81::ref_property_map< BOOST_CSR_GRAPH_TYPE*,
