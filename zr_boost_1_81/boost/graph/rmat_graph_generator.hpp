...
using zr_boost_1_81::uniform_01;
...
{
    using zr_boost_1_81::uniform_int;
...
public:
...

    {
        ...
        // BOOST_ASSERT(zr_boost_1_81::test_tools::check_is_close(a + b + c +
        // d, 1., 1.e-5));
        ...
        zr_boost_1_81::tie(u, v) = generate_edge(this->gen, n, SCALE, a, b, c, d);
