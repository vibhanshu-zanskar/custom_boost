...
{
    typedef
        typename zr_boost_1_81::vertex_property_type< BidirectionalGraph >::type type;
};

template < class BidirectionalGraph, class GraphRef >
struct edge_property_type< reverse_graph< BidirectionalGraph, GraphRef > >
{
    typedef typename zr_boost_1_81::edge_property_type< BidirectionalGraph >::type type;
};
...
{
    typedef
        typename zr_boost_1_81::graph_property_type< BidirectionalGraph >::type type;
};
...
{
    typedef zr_boost_1_81::is_same<
        typename detail::property_kind_from_graph< BidirGraph, Property >::type,
        edge_property_tag >
        is_edge_prop;
    typedef zr_boost_1_81::is_const< typename zr_boost_1_81::remove_reference< GRef >::type >
        is_ref_const;
    typedef typename zr_boost_1_81::mpl::if_< is_ref_const,
    ...
    typedef typename property_map< BidirGraph, Property >::const_type
        orig_const_type;
    typedef typename zr_boost_1_81::mpl::if_< is_edge_prop,
...
template < typename T > struct is_reverse_graph : zr_boost_1_81::mpl::false_
{
};
template < typename G, typename R >
struct is_reverse_graph< reverse_graph< G, R > > : zr_boost_1_81::mpl::true_
{
};
...
template < typename BidirectionalGraph, typename GRef, typename Tag >
inline typename zr_boost_1_81::mpl::if_<
    zr_boost_1_81::is_const< typename zr_boost_1_81::remove_reference< GRef >::type >,
