  ...
  namespace cc_detail {
                          ...
                          RootIterator r_end, AdjacencyMap& adj)
    {
      ...
      if (id == 0) {
        ...
        typedef zr_boost_1_81::adjacency_list<vecS, vecS, undirectedS, 
    ...
    {
      typedef typename zr_boost_1_81::graph::parallel::process_group_type<Graph>
    ...
    {
      using zr_boost_1_81::connected_components;
      ...
      typedef typename zr_boost_1_81::graph::parallel::process_group_type<DistributedGraph>
        ::type process_group_type;
      typedef typename process_group_type::process_id_type process_id_type;
      ...
      BGL_FORALL_VERTICES_T(v, g, DistributedGraph) {
        ...
        for (zr_boost_1_81::tie(av1, av2) = adjacent_vertices(v, g);
             av1 != av2; ++av1) {
            ...
            if ( get(owner, new_parent) == id )
              {
                ...
                BOOST_ASSERT(::zr_boost_1_81::detail::is_sorted(my_adj.begin(),
                                                  my_adj.end() - adj[*liter].size(),
                                                  std::less<vertex_descriptor>()));
                BOOST_ASSERT(::zr_boost_1_81::detail::is_sorted(my_adj.end() - adj[*liter].size(),
                                                  my_adj.end(),
                                                  std::less<vertex_descriptor>()));
#endif
        ...
        while (optional<std::pair<process_id_type, int> > m
               = probe(pg))
          {
            ...
            BOOST_ASSERT(::zr_boost_1_81::detail::is_sorted(my_adj.begin(),
                                              ...
                                              std::less<vertex_descriptor>()));
            BOOST_ASSERT(::zr_boost_1_81::detail::is_sorted(my_adj.end() - (num_incoming_edges-1),
                                              my_adj.end(),
                                              std::less<vertex_descriptor>()));
#endif
            std::inplace_merge(my_adj.begin(),
