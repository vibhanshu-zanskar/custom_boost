...
namespace detail {
  ...
  class crauser_et_al_dijkstra_queue
    : public graph::detail::remote_update_set<
               ...
               typename zr_boost_1_81::graph::parallel::process_group_type<Graph>::type,
  ...
  public:
    ...
    crauser_et_al_dijkstra_queue(const Graph& g,
      ...
      : inherited(zr_boost_1_81::graph::parallel::process_group(g), get(vertex_owner, g)),
                            ...
                            directed_tag, bidirectional_graph_tag)
  {
    ...
    BGL_FORALL_VERTICES_T(v, g, Graph) {
      if (in_edges(v, g).first != in_edges(v, g).second) {
        ...
        std::cerr << std::endl;
        put(min_in_weight, v,
            *zr_boost_1_81::first_min_element
   ...
   DijkstraVisitor vis)
{
  ...
  ::zr_boost_1_81::detail::dijkstra_bfs_visitor<
      DijkstraVisitor, Queue, WeightMap,
      zr_boost_1_81::parallel::caching_property_map<PredecessorMap>,
      zr_boost_1_81::parallel::caching_property_map<DistanceMap>, Combine, Compare
    > bfs_vis(vis, Q, weight,
              zr_boost_1_81::parallel::make_caching_property_map(predecessor),
              zr_boost_1_81::parallel::make_caching_property_map(distance),
...
} } // end namespace zr_boost_1_81::graph
