...
// Process group tags
struct mpi_process_group_tag : virtual zr_boost_1_81::parallel::linear_process_group_tag { };
...
class mpi_process_group
{
 ...
 public:
  ...
  typedef zr_boost_1_81::mpi::packed_oprimitive::buffer_type buffer_type;
  ...
  typedef zr_boost_1_81::mpi::communicator communicator_type;

  /// Classification of the capabilities of this process group
  struct communication_category
    : virtual zr_boost_1_81::parallel::bsp_process_group_tag, 
...
private:
   ...
   */
  class trigger_base : zr_boost_1_81::noncopyable
  {
  public:
...
public:
  ...
  std::pair<zr_boost_1_81::mpi::communicator, int> 
...
private:
  ...
  void receive_batch(zr_boost_1_81::mpi::status& status) const;
...
send_oob(const mpi_process_group& pg, mpi_process_group::process_id_type dest,
         int tag, const T& value, int block=-1)
{
  using zr_boost_1_81::mpi::packed_oarchive;
...
BOOST_IS_BITWISE_SERIALIZABLE(zr_boost_1_81::graph::distributed::mpi_process_group::message_header)
namespace zr_boost_1_81 { namespace mpi {
    template<>
    struct is_mpi_datatype<zr_boost_1_81::graph::distributed::mpi_process_group::message_header> : mpl::true_ { };
} } // end namespace zr_boost_1_81::mpi

BOOST_CLASS_IMPLEMENTATION(zr_boost_1_81::graph::distributed::mpi_process_group::outgoing_messages,object_serializable)
BOOST_CLASS_TRACKING(zr_boost_1_81::graph::distributed::mpi_process_group::outgoing_messages,track_never)
