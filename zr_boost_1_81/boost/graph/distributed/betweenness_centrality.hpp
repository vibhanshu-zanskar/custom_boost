...
namespace zr_boost_1_81 {
  ...
  namespace serialization {
    ...
    void serialize(Archive & ar,
                   zr_boost_1_81::tuple<T1,T2,T3, T4>& t,
                   const unsigned int)
    {
      ar & zr_boost_1_81::tuples::get<0>(t);
      ar & zr_boost_1_81::tuples::get<1>(t);
      ar & zr_boost_1_81::tuples::get<2>(t);
      ar & zr_boost_1_81::tuples::get<3>(t);
    }
  ...
  public:
    ...
    owner_type get_owner(Tuple t) { return get(owner, zr_boost_1_81::tuples::get<0>(t)); }
  ...
  class betweenness_centrality_delta_stepping_impl { 
    ...
    typedef typename zr_boost_1_81::graph::parallel::process_group_type<Graph>::type 
      ProcessGroup;
  ...
  private:
    ...
    void synchronize()
    {
      using zr_boost_1_81::parallel::synchronize;
      synchronize(pg);
    }
    ...
    void setup_triggers()
    {
      using zr_boost_1_81::parallel::simple_trigger;
    ...
    void handle_msg_relax(int /*source*/, int /*tag*/,
                          ...
                          zr_boost_1_81::parallel::trigger_receive_context)
...
#endif
      delta(delta),
      pg(zr_boost_1_81::graph::parallel::process_group_adl(g), zr_boost_1_81::parallel::attach_distributed_object()),
  ...
  run(Vertex s)
  {
    ...
    do {
      ...
      using zr_boost_1_81::parallel::all_reduce;
      using zr_boost_1_81::parallel::minimum;
      ...
      typedef zr_boost_1_81::queue<queue_value_type> local_queue_type;
      typedef zr_boost_1_81::graph::distributed::distributed_queue<process_group_type,
                                                           IndirectOwnerMap,
  ...
  private:
    ...
    {
      using zr_boost_1_81::parallel::all_reduce;
      using zr_boost_1_81::parallel::maximum;
      using std::max;
  ...
  do_brandes_sssp(const Graph& g, 
                  ...
                  typename graph_traits<Graph>::vertex_descriptor s)
  {
    using zr_boost_1_81::detail::graph::update_centrality;      
    using zr_boost_1_81::graph::parallel::process_group;
    ...
    typedef zr_boost_1_81::tuple<vertex_descriptor, vertex_descriptor, dependency_type, path_count_type>
      queue_value_type;
    ...
    dependency_count.set_reduce(zr_boost_1_81::graph::distributed::additive_reducer<dependency_type>());
    ...
    BGL_FORALL_VERTICES_T(v, g, Graph) {
      if (get(distance, v) < (std::numeric_limits<distance_type>::max)()
        ...
        Q.push(zr_boost_1_81::make_tuple(v, v, get(dependency, v), get(path_count, v)));
    }
    ...
    while(!Q.empty()) {
      ...
      vertex_descriptor w = zr_boost_1_81::tuples::get<0>(x);
      vertex_descriptor source = zr_boost_1_81::tuples::get<1>(x);
      dependency_type dep = zr_boost_1_81::tuples::get<2>(x);
      path_count_type pc = zr_boost_1_81::tuples::get<3>(x);
      ...
      if (get(dependency_count, w) == 0) { 
        ...
        for (incoming_iterator vw = el.begin(); vw != el.end(); ++vw)
          Q.push(zr_boost_1_81::make_tuple(*vw, w, get(dependency, w), get(path_count, w)));
      }
    }
  }
  ...
  brandes_betweenness_centrality_impl(const Graph& g, 
                                      ...
                                      Buffer sources)
  {
    using zr_boost_1_81::detail::graph::init_centrality_map;
    using zr_boost_1_81::detail::graph::divide_centrality_by_two;       
    using zr_boost_1_81::graph::parallel::process_group;
    ...
    dependency.set_reduce(zr_boost_1_81::graph::distributed::additive_reducer<dependency_type>()); 
    distance.set_reduce(zr_boost_1_81::graph::distributed::choose_min_reducer<distance_type>());
    ...
    if (!sources.empty()) {
      ...
      n = zr_boost_1_81::parallel::all_reduce(pg, n, std::plus<vertices_size_type>());
...
namespace graph { namespace parallel { namespace detail {
  ...
  struct brandes_betweenness_centrality_dispatch1
  {
    ...
    {
      zr_boost_1_81::graph::parallel::detail::brandes_betweenness_centrality_dispatch2(
       g, centrality, edge_centrality_map, weight_map, vertex_index, sources, delta);
    }
  };

  template<>
  struct brandes_betweenness_centrality_dispatch1<zr_boost_1_81::param_not_found> 
  {
    template<typename Graph, typename CentralityMap, typename EdgeCentralityMap, 
             typename VertexIndexMap, typename Buffer>
    static void 
                               ...
                               BOOST_GRAPH_ENABLE_IF_MODELS_PARM(Graph,distributed_graph_tag))
{
  ...
  zr_boost_1_81::graph::parallel::detail::brandes_betweenness_centrality_dispatch2(
    g, centrality, dummy_property_map(), get(vertex_index, g), zr_boost_1_81::ref(q), 0);
}
                               ...
                               BOOST_GRAPH_ENABLE_IF_MODELS_PARM(Graph,distributed_graph_tag))
{
  ...
  zr_boost_1_81::graph::parallel::detail::brandes_betweenness_centrality_dispatch2(
    g, centrality, edge_centrality_map, get(vertex_index, g), zr_boost_1_81::ref(q), 0);
}
                                               ...
                                               CentralityMap centrality)
{
  ...
  detail::graph::non_distributed_brandes_betweenness_centrality_dispatch2(
    pg, g, centrality, dummy_property_map(), get(vertex_index, g), zr_boost_1_81::ref(q));
}
                        ...
                        BOOST_GRAPH_ENABLE_IF_MODELS_PARM(Graph,distributed_graph_tag))
{
  ...
  typedef typename zr_boost_1_81::graph::parallel::process_group_type<Graph>::type 
    process_group_type;
  process_group_type pg = zr_boost_1_81::graph::parallel::process_group(g);
  ...
  for (zr_boost_1_81::tie(v, v_end) = vertices(g); v != v_end; ++v) {
    max_centrality = (max)(max_centrality, get(centrality, *v));
  }

  // All reduce to get global max centrality
  max_centrality = all_reduce(pg, max_centrality, zr_boost_1_81::parallel::maximum<centrality_type>());
