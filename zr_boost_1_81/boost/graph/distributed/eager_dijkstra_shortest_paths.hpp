 ...
 struct parallel_dijkstra_bfs_visitor : bfs_visitor<>
{
  ...
  void examine_edge(Edge e, Graph& g) {
    ...
    zr_boost_1_81::parallel::caching_property_map<PredecessorMap> c_pred(m_predecessor);
    zr_boost_1_81::parallel::caching_property_map<DistanceMap> c_dist(m_distance);
