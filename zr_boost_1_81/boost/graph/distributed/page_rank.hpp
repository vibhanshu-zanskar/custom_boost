               ...
               RankMap2 rank_map2)
{
  ...
  synchronize(zr_boost_1_81::graph::parallel::process_group(g));
  ...
  rank_map.set_consistency_model(zr_boost_1_81::parallel::cm_flush | zr_boost_1_81::parallel::cm_reset);
  rank_map2.set_consistency_model(zr_boost_1_81::parallel::cm_flush | zr_boost_1_81::parallel::cm_reset);
                                                        ...
                                                        distributed_graph_tag))
{
  ...
  do {
    ...
    for (zr_boost_1_81::tie(vi, vi_end) = vertices(g); vi != vi_end; /* in loop */) {
