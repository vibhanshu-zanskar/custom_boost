...
namespace zr_boost_1_81 {
  ...
  namespace detail {
    ...
    serialize(Archiver& ar, edge_desc_impl<Directed, Vertex>& e,
              const unsigned int /*version*/)
    {
      ar & zr_boost_1_81::serialization::base_object<edge_base<Directed, Vertex> >(e)
  ...
  namespace detail { namespace parallel {
    ...
    struct edge_descriptor
    {
      ...
      public:
        typedef typename zr_boost_1_81::mpl::if_<is_same<DirectedS, bidirectionalS>,
                                         stored_in_edge<Edge>,
    ...
    struct adjacency_list_config
    {
      ...
      typedef typename zr_boost_1_81::mpl::if_<is_same<DirectedS, undirectedS>,
      ...
      typedef typename inherited::vertices_size_type vertices_size_type;
          ...
          typedef typename ::zr_boost_1_81::graph::distributed::select_distribution<
              in_distribution_type, VertexProperty, vertices_size_type, 
              ProcessGroup>::type 
        base_distribution_type;

          typedef ::zr_boost_1_81::graph::distributed::shuffled_distribution<
    ...
    maybe_initialize_vertex_indices(IteratorPair p,
                                    ::zr_boost_1_81::detail::error_property_not_found)
    { }
    ...
    public:
      ...
      void serialize(Archiver& ar, const unsigned int /*version*/)
      {
        ar & zr_boost_1_81::serialization::base_object<inherited_data>(*this) 
           & zr_boost_1_81::serialization::base_object<inherited_property>(*this);
      }
    };
    ...
    struct get_adj_list_pmap
    {
      ...
      public:
        typedef ::zr_boost_1_81::parallel::distributed_property_map<
    ...
    struct get_adj_list_pmap<vertex_local_index_t>
    {
      template<typename Graph>
      struct apply
        : ::zr_boost_1_81::property_map<typename Graph::inherited, vertex_index_t>
      { };
    };
    ...
    remove_in_edge(typename Graph::edge_descriptor e, Graph& g, undirectedS)
    {
      ...
      for (zr_boost_1_81::tie(ei, ei_end) = out_edges(v.local, bg); ei != ei_end; ++ei)
      {
    ...
    add_local_edge(typename Config::vertex_descriptor u,
                   typename Config::vertex_descriptor v,
                   const typename Config::edge_property_type& p,
                   zr_boost_1_81::adj_list_impl<Graph, Config, Base>& g)
    {
      return add_edge(u, v, p, g);
    }
      ...
      : public detail::parallel::maybe_store_property<EdgeProperty>
    {
      ...
      void serialize(Archiver& ar, const unsigned int /*version*/)
      {
        ar & zr_boost_1_81::serialization::base_object<inherited>(*this) & e;
      }
    };
  ...
  public:
    ...
    typedef typename zr_boost_1_81::mpl::if_<typename DirectedS::is_bidir_t,
      bidirectional_tag,
      typename zr_boost_1_81::mpl::if_<typename DirectedS::is_directed_t,
...
//    typedef typename inherited::edge_descriptor   edge_descriptor;
    ...
    typedef typename zr_boost_1_81::mpl::if_<
              ...
              typename zr_boost_1_81::mpl::if_<is_same<DirectedS, bidirectionalS>,
  ...
  public:
    ...
    typedef zr_boost_1_81::adjacency_iterator<
  ...
  public:
    adjacency_list(const ProcessGroup& pg = ProcessGroup())
      : named_graph_mixin(pg, default_distribution_type(pg, 0)),
        ...
        process_group_(pg, zr_boost_1_81::parallel::attach_distributed_object())
    {
      setup_triggers();
    }
    ...
    zr_boost_1_81::function<void(vertex_descriptor, adjacency_list&)> on_add_vertex;

    // Callback that will be invoked whenever a new edge is added locally
    zr_boost_1_81::function<void(edge_descriptor, adjacency_list&)> on_add_edge;
  ...
  public:
    ...
    typedef  zr_boost_1_81::detail::parallel::msg_nonlocal_edge_data<
      edge_property_type,local_edge_descriptor> msg_nonlocal_edge_data;

    typedef zr_boost_1_81::detail::parallel::msg_remove_edge_data<edge_descriptor>
      msg_remove_edge_data;
    ...
    zr_boost_1_81::parallel::detail::untracked_pair<edge_descriptor, bool>
  ...
  protected:
                    ...
                    processor_id_type other_proc, bidirectionalS)
    {
      ...
      zr_boost_1_81::graph_detail::push(get(vertex_in_edges, base())[v], edge);
    }
                      ...
                      processor_id_type other_proc, bidirectionalS)
    {
      ...
      if (src.owner == process_id(process_group_)) {
        ...
        for (zr_boost_1_81::tie(ei, ei_end) = out_edges(src.local, base());
             ei != ei_end; ++ei) {
        ...
        if (ei != ei_end) zr_boost_1_81::remove_edge(ei, base());
                      ...
                      processor_id_type other_proc, undirectedS)
    {
      ...
      {
        base_out_edge_iterator ei, ei_end;
        for (zr_boost_1_81::tie(ei, ei_end) = out_edges(local_vertex.local, base());
             ei != ei_end; ++ei) {
          // TBD: can't check the descriptor here, because it could
          // have changed if we're allowing the removal of
          // edges. Egads!
  ...
  ~lazy_add_vertex_with_property()
  {
    ...
    if (committed || zr_boost_1_81::core::uncaught_exceptions() > 0)
      return;
  ...
  PBGL_DISTRIB_ADJLIST_TYPE::lazy_add_edge::commit() const
  {
    ...
    if (source.owner == self.processor())
      ...
      zr_boost_1_81::parallel::detail::untracked_pair<edge_descriptor, bool> result;
  ...
  add_local_edge(const edge_property_type& property, bidirectionalS) const
  {
    ...
    if (result.second) {
      if (target.owner == self.processor()) {
        ...
        zr_boost_1_81::graph_detail::push(get(vertex_in_edges, 
                                      self.base())[target.local], e);
      } 
      else {
        // Edge is remote, so notify the target's owner that an edge
        // has been added.
        if (self.process_group_.trigger_context() == zr_boost_1_81::parallel::trc_out_of_band)
  ...
  ~lazy_add_edge_with_property()
  {
    ...
    /// someone else, or if someone threw an exception, we will not
    /// create the edge now.
    if (this->committed || zr_boost_1_81::core::uncaught_exceptions() > 0)
      return;
       ...
       const PBGL_DISTRIB_ADJLIST_TYPE& g)
  {
    ...
    if (u.owner == process_id(g.process_group())) {
      ...
      for (zr_boost_1_81::tie(ei, ei_end) = in_edges(v, g); ei != ei_end; ++ei) {
      ...
      bool operator()(const argument_type& le)
      {
        ...
        if (predicate(e)) {
          if (source(e, g).owner != target(e, g).owner
            ...
            ::zr_boost_1_81::detail::parallel::remove_in_edge(e, g,
                                                      directed_selector());
      ...
      bool operator()(const argument_type& e)
      {
        if (predicate(e)) {
          if (source(e, g).owner != target(e, g).owner)
            g.send_remove_edge_request(e);
          if (target(e, g).owner == g.processor())
            ::zr_boost_1_81::detail::parallel::remove_in_edge(e, g, undirectedS());
          if (source(e, g).owner == g.processor())
            remove_edge(e.local, g.base());
          return true;
        } else return false;
                ...
                PBGL_DISTRIB_ADJLIST_TYPE& g)
  {
    ...
    static_cast<named_graph_mixin&>(static_cast<graph_type&>(g))
      .removing_vertex(u, zr_boost_1_81::graph_detail::iterator_stability(g.base().m_vertices));
  ...
  struct property_map<PBGL_DISTRIB_ADJLIST_TYPE const, Property>
          : zr_boost_1_81::detail::parallel::get_adj_list_pmap<Property>
// FIXME: in the original code the following was not const
  ...
  namespace mpi {
    ...
    struct is_mpi_datatype<zr_boost_1_81::detail::edge_base<Directed, Vertex> >
      : is_mpi_datatype<Vertex> { };

    template<typename Directed, typename Vertex>
    struct is_mpi_datatype<zr_boost_1_81::detail::edge_desc_impl<Directed, Vertex> >
      : is_mpi_datatype<zr_boost_1_81::detail::edge_base<Directed, Vertex> > { };

    template<typename LocalDescriptor>
    struct is_mpi_datatype<zr_boost_1_81::detail::parallel::global_descriptor<LocalDescriptor> >
      : is_mpi_datatype<LocalDescriptor> { };

    template<typename Edge>
    struct is_mpi_datatype<zr_boost_1_81::detail::parallel::edge_descriptor<Edge> >
      : is_mpi_datatype<Edge> { };

    template<typename Vertex, typename LocalVertex>
    struct is_mpi_datatype<zr_boost_1_81::detail::parallel::
                             msg_add_edge_data<Vertex, LocalVertex> >
      : is_mpi_datatype<Vertex> { };
   ...
   struct is_mpi_datatype<zr_boost_1_81::detail::parallel::msg_nonlocal_edge_data<
                          EdgeProperty,EdgeDescriptor> >
           : mpl::and_<
               is_mpi_datatype<zr_boost_1_81::detail::parallel::maybe_store_property<
                           EdgeProperty> >,
  ...
  {};
   ...
   struct is_mpi_datatype<
            zr_boost_1_81::detail::parallel::msg_remove_edge_data<EdgeDescriptor> >
           : is_mpi_datatype<EdgeDescriptor> {};
  }
  ...
  namespace serialization {
    template<typename Directed, typename Vertex>
    struct is_bitwise_serializable<zr_boost_1_81::detail::edge_base<Directed, Vertex> >
      : is_bitwise_serializable<Vertex> { };

    template<typename Directed, typename Vertex>
    struct is_bitwise_serializable<zr_boost_1_81::detail::edge_desc_impl<Directed, Vertex> >
      : is_bitwise_serializable<zr_boost_1_81::detail::edge_base<Directed, Vertex> > { };

    template<typename LocalDescriptor>
    struct is_bitwise_serializable<zr_boost_1_81::detail::parallel::global_descriptor<LocalDescriptor> >
      : is_bitwise_serializable<LocalDescriptor> { };

    template<typename Edge>
    struct is_bitwise_serializable<zr_boost_1_81::detail::parallel::edge_descriptor<Edge> >
      : is_bitwise_serializable<Edge> { };

    template<typename Vertex, typename LocalVertex>
    struct is_bitwise_serializable<zr_boost_1_81::detail::parallel::
                             msg_add_edge_data<Vertex, LocalVertex> >
      : is_bitwise_serializable<Vertex> { };
   ...
   template<typename EdgeProperty, typename EdgeDescriptor>
   struct is_bitwise_serializable<zr_boost_1_81::detail::parallel::msg_nonlocal_edge_data<
                                  EdgeProperty,EdgeDescriptor> >
           : mpl::and_<
               is_bitwise_serializable<
                zr_boost_1_81::detail::parallel::maybe_store_property<EdgeProperty> >,
  ...
  {};
   ...
   struct is_bitwise_serializable<
    ...
    template<typename Directed, typename Vertex>
    struct implementation_level<zr_boost_1_81::detail::edge_base<Directed, Vertex> >
      : mpl::int_<object_serializable> {};

    template<typename Directed, typename Vertex>
    struct implementation_level<zr_boost_1_81::detail::edge_desc_impl<Directed, Vertex> >
      : mpl::int_<object_serializable> {};

    template<typename LocalDescriptor>
    struct implementation_level<zr_boost_1_81::detail::parallel::global_descriptor<LocalDescriptor> >
      : mpl::int_<object_serializable> {};

    template<typename Edge>
    struct implementation_level<zr_boost_1_81::detail::parallel::edge_descriptor<Edge> >
      : mpl::int_<object_serializable> {};

    template<typename Vertex, typename LocalVertex>
    struct implementation_level<zr_boost_1_81::detail::parallel::
                             msg_add_edge_data<Vertex, LocalVertex> >
      : mpl::int_<object_serializable> {};
   ...
   template<typename EdgeProperty, typename EdgeDescriptor>
   struct implementation_level<zr_boost_1_81::detail::parallel::msg_nonlocal_edge_data<
                               EdgeProperty,EdgeDescriptor> >
           : mpl::int_<object_serializable> {};
   ...
   struct implementation_level<
    ...
    template<typename Directed, typename Vertex>
    struct tracking_level<zr_boost_1_81::detail::edge_base<Directed, Vertex> >
      : mpl::int_<track_never> {};

    template<typename Directed, typename Vertex>
    struct tracking_level<zr_boost_1_81::detail::edge_desc_impl<Directed, Vertex> >
      : mpl::int_<track_never> {};

    template<typename LocalDescriptor>
    struct tracking_level<zr_boost_1_81::detail::parallel::global_descriptor<LocalDescriptor> >
      : mpl::int_<track_never> {};

    template<typename Edge>
    struct tracking_level<zr_boost_1_81::detail::parallel::edge_descriptor<Edge> >
      : mpl::int_<track_never> {};

    template<typename Vertex, typename LocalVertex>
    struct tracking_level<zr_boost_1_81::detail::parallel::
                             msg_add_edge_data<Vertex, LocalVertex> >
      : mpl::int_<track_never> {};
   ...
   template<typename EdgeProperty, typename EdgeDescriptor>
   struct tracking_level<zr_boost_1_81::detail::parallel::msg_nonlocal_edge_data<
                         EdgeProperty,EdgeDescriptor> >
           : mpl::int_<track_never> {};
