         ...
         InEdgeIndex>
{
 ...
 public:
  ...
  typedef zr_boost_1_81::parallel::variant_distribution<process_group_type, Vertex>
    distribution_type;
  ...
  vertex_descriptor add_vertex()
  {
    typename graph_traits<base_type>::vertex_descriptor v 
      = zr_boost_1_81::add_vertex(m_base);
  ...
  {
    typename graph_traits<base_type>::vertex_descriptor v 
      = zr_boost_1_81::add_vertex(m_base, p);
  ...
  {
    typename graph_traits<base_type>::vertex_descriptor v 
      = zr_boost_1_81::add_vertices(count, m_base);
  ...
  { zr_boost_1_81::add_edges_global(first, last, get(vertex_local, *this), m_base); }
  ...
  { zr_boost_1_81::add_edges_global(first, last, ep_iter, ep_iter_end, 
                            get(vertex_local, *this), m_base); }

  template <typename InputIterator>
  void 
  add_edges_sorted(InputIterator first, InputIterator last)
  { zr_boost_1_81::add_edges_sorted_global(first, last, 
                                   get(vertex_local, *this), m_base); }
  ...
  { zr_boost_1_81::add_edges_sorted_global(first_sorted, last_sorted, ep_iter_sorted, 
                                   get(vertex_local, *this), m_base); }
...
struct index_to_vertex_func {
  ...
  typedef typename zr_boost_1_81::graph_traits<Graph>::vertex_descriptor vertex_descriptor;
  typedef typename zr_boost_1_81::graph_traits<Graph>::vertices_size_type vertices_size_type;
...
zr_boost_1_81::transform_iterator<index_to_vertex_func<Distribution, Graph>, IndexIterator>
make_index_to_vertex_iterator(IndexIterator it, const Distribution& dist, 
                              const Graph& g) {
  return zr_boost_1_81::make_transform_iterator(
...
namespace mpi {
  ...
  struct is_mpi_datatype<zr_boost_1_81::detail::csr_edge_descriptor<Vertex, EdgeIndex> >
    : mpl::true_ { };
}

namespace serialization {
  template<typename Vertex, typename EdgeIndex>
  struct is_bitwise_serializable<zr_boost_1_81::detail::csr_edge_descriptor<Vertex, EdgeIndex> >
    : mpl::true_ { };

  template<typename Vertex, typename EdgeIndex>
  struct implementation_level<zr_boost_1_81::detail::csr_edge_descriptor<Vertex, EdgeIndex> >
   : mpl::int_<object_serializable> {} ;

  template<typename Vertex, typename EdgeIndex>
  struct tracking_level<zr_boost_1_81::detail::csr_edge_descriptor<Vertex, EdgeIndex> >
