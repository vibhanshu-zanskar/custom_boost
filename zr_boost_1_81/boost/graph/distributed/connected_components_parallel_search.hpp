...
namespace zr_boost_1_81 { namespace graph { namespace distributed {
  namespace cc_ps_detail {
    ...
    private:
      ...
      zr_boost_1_81::processor_id_type pg_id;
    };
  ...
  connected_components_ps(const Graph& g, ComponentMap c)
  {
    ...
    zr_boost_1_81::tie(current, end) = vertices(g);
    ...
    while (!global_done) {
      ...
      synchronize(pg);
      global_done = all_reduce(pg, (q.empty() && (current == end)), zr_boost_1_81::parallel::minimum<bool>());
