...
{
  using namespace zr_boost_1_81::graph::parallel;
  ...
  static const bool asynchronous = 
    is_convertible<communication_category, zr_boost_1_81::parallel::immediate_process_group_tag>::value;
  ...
  rounds = all_reduce(pg, rounds, zr_boost_1_81::parallel::maximum<std::size_t>());
  ...
  num_colors = 
    all_reduce(pg, num_colors, zr_boost_1_81::parallel::maximum<color_type>());
...
namespace zr_boost_1_81 { namespace graph {
