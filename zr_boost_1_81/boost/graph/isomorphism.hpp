...
namespace detail
{
    ...
    template < typename G, typename Index > struct make_degree_invariant
    {
        ...
        typedef typename zr_boost_1_81::graph_traits< G >::degree_size_type
            degree_size_type;
    ...
    namespace detail
    {
        template < typename Graph1, typename Graph2 > struct isomorphism_impl
        {
                ...
                const ArgPack& arg_pack) const
            {
                ...
                typedef typename zr_boost_1_81::detail::override_const_property_result<
                    ArgPack, tag::vertex_index1_map, zr_boost_1_81::vertex_index_t,
                    Graph1 >::type index1_map_type;
                typedef typename zr_boost_1_81::detail::override_const_property_result<
                    ArgPack, tag::vertex_index2_map, zr_boost_1_81::vertex_index_t,
                    Graph2 >::type index2_map_type;
                index1_map_type index1_map
                    = zr_boost_1_81::detail::override_const_property(
                        arg_pack, _vertex_index1_map, g1, zr_boost_1_81::vertex_index);
                index2_map_type index2_map
                    = zr_boost_1_81::detail::override_const_property(
                        arg_pack, _vertex_index2_map, g2, zr_boost_1_81::vertex_index);
                ...
                typename zr_boost_1_81::parameter::lazy_binding< ArgPack,
                    tag::vertex_invariant1,
                    zr_boost_1_81::detail::make_degree_invariant< Graph1,
                ...
                typename zr_boost_1_81::parameter::lazy_binding< ArgPack,
                    ...
                    zr_boost_1_81::detail::make_degree_invariant< Graph2,
                        index2_map_type > >::type invariant2
                    = arg_pack[_vertex_invariant2
                        || zr_boost_1_81::detail::make_degree_invariant< Graph2,
                            index2_map_type >(g2, index2_map)];
                return zr_boost_1_81::isomorphism(g1, g2,
                    choose_param(
                        arg_pack[_isomorphism_map | zr_boost_1_81::param_not_found()],
