...
namespace zr_boost_1_81 { namespace pfr { namespace detail { namespace sequence_tuple {
...
using tuple_element = std::remove_reference< decltype(
        ::zr_boost_1_81::pfr::detail::sequence_tuple::get<I>( std::declval<T>() )
    ) >;


}}}} // namespace zr_boost_1_81::pfr::detail::sequence_tuple
