...
namespace zr_boost_1_81 { namespace pfr { namespace detail {
    ...
    struct equal_impl {
        ...
        constexpr static bool cmp(const T& v1, const U& v2) noexcept {
            return ::zr_boost_1_81::pfr::detail::sequence_tuple::get<I>(v1) == ::zr_boost_1_81::pfr::detail::sequence_tuple::get<I>(v2)
    ...
    struct hash_impl {
        ...
        constexpr static std::size_t compute(const T& val) noexcept {
            std::size_t h = detail::compute_hash( ::zr_boost_1_81::pfr::detail::sequence_tuple::get<I>(val), 1L );
