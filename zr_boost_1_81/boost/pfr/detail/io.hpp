...
struct print_impl {
    ...
    static void print (Stream& out, const T& value) {
        if (!!I) out << ", ";
        out << detail::quoted_helper(zr_boost_1_81::pfr::detail::sequence_tuple::get<I>(value));
...
struct read_impl {
    ...
    static void read (Stream& in, const T& value) {
        ...
        in >> detail::quoted_helper( zr_boost_1_81::pfr::detail::sequence_tuple::get<I>(value) );
