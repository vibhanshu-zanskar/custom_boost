...
/// \b Example:
/// \code
///     std::array<int, zr_boost_1_81::pfr::tuple_size<my_structure>::value > a;
/// \endcode
template <class T>
using tuple_size = detail::size_t_< zr_boost_1_81::pfr::detail::fields_count<T>() >;
...
/// \b Example:
/// \code
///     std::array<int, zr_boost_1_81::pfr::tuple_size_v<my_structure> > a;
/// \endcode
template <class T>
