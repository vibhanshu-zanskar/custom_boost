...
///     std::unordered_set<
///         my_struct,
///         zr_boost_1_81::pfr::hash<>,
///         zr_boost_1_81::pfr::equal_to<>
///     > my_set;
/// \endcode
///
/// \b Synopsis:
...
template <class T = void> struct equal_to {
    ...
    bool operator()(const T& x, const T& y) const {
        return zr_boost_1_81::pfr::eq(x, y);
    }
...
template <class T = void> struct not_equal {
    ...
    bool operator()(const T& x, const T& y) const {
        return zr_boost_1_81::pfr::ne(x, y);
    }
...
template <class T = void> struct greater {
    ...
    bool operator()(const T& x, const T& y) const {
        return zr_boost_1_81::pfr::gt(x, y);
    }
...
template <class T = void> struct less {
    ...
    bool operator()(const T& x, const T& y) const {
        return zr_boost_1_81::pfr::lt(x, y);
    }
...
template <class T = void> struct greater_equal {
    ...
    bool operator()(const T& x, const T& y) const {
        return zr_boost_1_81::pfr::ge(x, y);
    }
...
template <class T = void> struct less_equal {
    ...
    /// or if each field of \b x equals the field with same index of \b y.
    bool operator()(const T& x, const T& y) const {
        return zr_boost_1_81::pfr::le(x, y);
    }
...
template <class T> struct hash {
    ...
    std::size_t operator()(const T& x) const {
        return zr_boost_1_81::pfr::hash_value(x);
    }
};
