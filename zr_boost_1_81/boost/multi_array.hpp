...
{
  typedef zr_boost_1_81::empty_value<Allocator> alloc_base;
...
public:
  ...
  explicit multi_array(const Allocator& alloc = Allocator()) :
    ...
    alloc_base(zr_boost_1_81::empty_init_t(),alloc) {
    allocate_space(); 
  }
  ...
  explicit multi_array(ExtentList const& extents,
    ...
    alloc_base(zr_boost_1_81::empty_init_t()) {
    zr_boost_1_81::function_requires<
      detail::multi_array::CollectionConcept<ExtentList> >();
    allocate_space();
  }
  ...
  alloc_base(static_cast<const alloc_base&>(rhs)) {
    allocate_space();
    zr_boost_1_81::detail::multi_array::copy_n(rhs.base_,rhs.num_elements(),base_);
  }
  ...
  multi_array& resize(const detail::multi_array
    ...
    zr_boost_1_81::array<size_type,NumDims> min_extents;
...
private:
  ...
  void allocate_space() {
    ...
    zr_boost_1_81::alloc_construct_n(allocator(),base_,allocated_elements_);
  }

  void deallocate_space() {
    if(base_) {
      zr_boost_1_81::alloc_destroy_n(allocator(),base_,allocated_elements_);
