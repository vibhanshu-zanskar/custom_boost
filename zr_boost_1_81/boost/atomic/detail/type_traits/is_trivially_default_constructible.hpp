...
template< typename T >
using is_trivially_default_constructible = zr_boost_1_81::has_trivial_constructor< T >;
#else
template< typename T >
struct is_trivially_default_constructible : public zr_boost_1_81::has_trivial_constructor< T > {};
#endif
