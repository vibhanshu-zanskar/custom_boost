...
template< typename T >
using is_nothrow_default_constructible = zr_boost_1_81::has_nothrow_constructor< T >;
#else
template< typename T >
struct is_nothrow_default_constructible : public zr_boost_1_81::has_nothrow_constructor< T > {};
#endif
