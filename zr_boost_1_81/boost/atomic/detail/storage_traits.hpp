...
{
    typedef zr_boost_1_81::uint8_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;
...
{
    typedef zr_boost_1_81::uint16_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;

    static BOOST_CONSTEXPR_OR_CONST std::size_t native_alignment = atomics::detail::alignment_of< zr_boost_1_81::uint16_t >::value;
...
{
    typedef zr_boost_1_81::uint32_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;

    static BOOST_CONSTEXPR_OR_CONST std::size_t native_alignment = atomics::detail::alignment_of< zr_boost_1_81::uint32_t >::value;
...
{
    typedef zr_boost_1_81::uint64_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;

    static BOOST_CONSTEXPR_OR_CONST std::size_t native_alignment = atomics::detail::alignment_of< zr_boost_1_81::uint64_t >::value;
...
{
    typedef zr_boost_1_81::uint128_type BOOST_ATOMIC_DETAIL_MAY_ALIAS type;

    static BOOST_CONSTEXPR_OR_CONST std::size_t native_alignment = atomics::detail::alignment_of< zr_boost_1_81::uint128_type >::value;
    static BOOST_CONSTEXPR_OR_CONST std::size_t alignment = 16u;
};
...
union max_align_t
{
    ...
    zr_boost_1_81::float128_type f128;
#endif
};
