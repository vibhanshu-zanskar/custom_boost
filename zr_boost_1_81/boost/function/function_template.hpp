...
#else
#  define BOOST_FUNCTION_VOID_RETURN_TYPE zr_boost_1_81::detail::function::unusable
...
namespace zr_boost_1_81 {
    ...
    namespace function {
      ...
      struct BOOST_FUNCTION_MEMBER_INVOKER
      {
...

        {
          ...
          return zr_boost_1_81::mem_fn(*f)(BOOST_FUNCTION_ARGS);
        }
      };
      ...
      struct BOOST_FUNCTION_VOID_MEMBER_INVOKER
      {
...

        {
          MemberPtr* f =
            reinterpret_cast<MemberPtr*>(function_obj_ptr.data);
          BOOST_FUNCTION_RETURN(zr_boost_1_81::mem_fn(*f)(BOOST_FUNCTION_ARGS));
        }
      };
#endif
      ...
      /**
       * vtable for a specific zr_boost_1_81::function instance. This
       * structure must be an aggregate so that we can use static
       * initialization in zr_boost_1_81::function's assign_to and assign_to_a
      ...
      private:
        ...
        bool assign_to(MemberPtr f, function_buffer& functor, member_ptr_tag) const
        {
          ...
          if (f) {
            this->assign_to(zr_boost_1_81::mem_fn(f), functor);
            return true;
          } else {
            return false;
          }
        ...
        bool assign_to_a(MemberPtr f, function_buffer& functor, Allocator a, member_ptr_tag) const
        {
          ...
          // right target_type() values.
          if (f) {
            this->assign_to_a(zr_boost_1_81::mem_fn(f), functor, a);
            return true;
          } else {
            return false;
          }
        ...
        {
          if (!zr_boost_1_81::detail::function::has_empty_target(zr_boost_1_81::addressof(f))) {
  ...
  public:
    ...
    typedef R         result_type;
#else
    typedef  typename zr_boost_1_81::detail::function::function_return_type<R>::type
      result_type;
#endif // BOOST_NO_VOID_RETURNS

  private:
    typedef zr_boost_1_81::detail::function::BOOST_FUNCTION_VTABLE<
  ...
  public:
    ...
    // add signature for zr_boost_1_81::lambda
    ...
    BOOST_FUNCTION_FUNCTION(Functor BOOST_FUNCTION_TARGET_FIX(const &) f
                            ...
                            ,typename zr_boost_1_81::enable_if_<
    ...
    {
      if (this->empty())
        zr_boost_1_81::throw_exception(bad_function_call());
...
#           endif
#         endif
          std::memcpy(this->functor.data, f.functor.data, sizeof(zr_boost_1_81::detail::function::function_buffer));
#         if defined(BOOST_GCC) && (BOOST_GCC >= 40700)
#           pragma GCC diagnostic pop
#         endif
        } else
          get_vtable()->base.manager(f.functor, this->functor,
                                     zr_boost_1_81::detail::function::clone_functor_tag);
      }
    }
    ...
    {
      using zr_boost_1_81::detail::function::vtable_base;

      typedef typename zr_boost_1_81::detail::function::get_function_tag<Functor>::type tag;
      typedef zr_boost_1_81::detail::function::BOOST_FUNCTION_GET_INVOKER<tag> get_invoker;
      ...
      if (stored_vtable.assign_to(f, functor)) {
        ...
        if (zr_boost_1_81::has_trivial_copy_constructor<Functor>::value &&
            zr_boost_1_81::has_trivial_destructor<Functor>::value &&
            zr_boost_1_81::detail::function::function_allows_small_object_optimization<Functor>::value)
          value |= static_cast<std::size_t>(0x01);
        vtable = reinterpret_cast<zr_boost_1_81::detail::function::vtable_base *>(value);
      } else
        vtable = 0;
    }
...
#endif
            get_vtable()->base.manager(f.functor, this->functor,
                                     zr_boost_1_81::detail::function::move_functor_tag);
#if defined(BOOST_GCC) && (__GNUC__ >= 11)
# pragma GCC diagnostic pop
#endif
          f.vtable = 0;
...
// Poison comparisons between zr_boost_1_81::function objects of the same type.
template<typename R BOOST_FUNCTION_COMMA BOOST_FUNCTION_TEMPLATE_PARMS>
