...
#  define BOOST_FUNCTION_ENABLE_IF_NOT_INTEGRAL(Functor,Type)              \
      typename ::zr_boost_1_81::enable_if_<          \
                           !(::zr_boost_1_81::is_integral<Functor>::value), \
                           Type>::type
...
namespace zr_boost_1_81 {
  namespace detail {
    namespace function {
       ...
       * zr_boost_1_81::function. It is a union containing function pointers,
      ...
      union function_buffer_members
      {
        ...
        struct type_t {
          ...
          const zr_boost_1_81::typeindex::type_info* type;
...
# pragma warning(pop)
      ...
      struct reference_manager
      {
               ...
               functor_manager_operation_type op)
        {
          ...
          case check_functor_type_tag:
            {
              ...
              if (*out_buffer.members.type.type == zr_boost_1_81::typeindex::type_id<F>()
          ...
          case get_functor_type_tag:
            out_buffer.members.type.type = &zr_boost_1_81::typeindex::type_id<F>().type_info();
      ...
      /**
       * Determine if zr_boost_1_81::function can use the small-object
      ...
      struct functor_manager_common
      {
                ...
                functor_manager_operation_type op)
        {
          if (op == clone_functor_tag)
            ...
            if (*out_buffer.members.type.type == zr_boost_1_81::typeindex::type_id<Functor>())
              out_buffer.members.obj_ptr = &in_buffer.members.func_ptr;
            else
              out_buffer.members.obj_ptr = 0;
          } else /* op == get_functor_type_tag */ {
            out_buffer.members.type.type = &zr_boost_1_81::typeindex::type_id<Functor>().type_info();
      ...
      public:
               ...
               functor_manager_operation_type op)
        {
          ...
          if (op == get_functor_type_tag) {
            out_buffer.members.type.type = &zr_boost_1_81::typeindex::type_id<functor_type>().type_info();
            out_buffer.members.type.const_qualified = false;
            out_buffer.members.type.volatile_qualified = false;
          } else {
...
public:
  ...
  /** Retrieve the type of the stored function object, or type_id<void>()
      if this is empty. */
  const zr_boost_1_81::typeindex::type_info& target_type() const
  {
    if (!vtable) return zr_boost_1_81::typeindex::type_id<void>().type_info();
  ...
  template<typename Functor>
    Functor* target()
    {
      ...
      type_result.members.type.type = &zr_boost_1_81::typeindex::type_id<Functor>().type_info();
...
#endif
/**
 * The bad_function_call exception class is thrown when a zr_boost_1_81::function
 * object is invoked
 */
class BOOST_SYMBOL_VISIBLE bad_function_call : public std::runtime_error
{
public:
  bad_function_call() : std::runtime_error("call to empty zr_boost_1_81::function") {}
};
#if defined(BOOST_CLANG)
...
#ifdef BOOST_NO_SFINAE
// Comparisons between zr_boost_1_81::function objects and arbitrary function objects
template<typename Functor>
...
#  if !(defined(__GNUC__) && __GNUC__ == 3 && __GNUC_MINOR__ <= 3)
// Comparisons between zr_boost_1_81::function objects and arbitrary function
