...
namespace zr_boost_1_81 { namespace locale { namespace boundary {
    ///
    ...
    namespace detail {
        ...
        template<typename BaseIterator>
        class segment_index_iterator : public zr_boost_1_81::iterator_facade<segment_index_iterator<BaseIterator>,
        ...
        template<typename BaseIterator>
        class boundary_point_index_iterator : public zr_boost_1_81::iterator_facade<boundary_point_index_iterator<BaseIterator>,
...
}}} // namespace zr_boost_1_81::locale::boundary
