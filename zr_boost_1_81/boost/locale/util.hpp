...
namespace zr_boost_1_81 { namespace locale {
    ...
    namespace util {
        ...
        ///
        /// This function installs zr_boost_1_81::locale::info facet into the locale \a in and returns
        ...
        /// character encodings like ISO-8859-1, koi8-r, windows-1255 and Unicode code points,
        ///
        /// Throws zr_boost_1_81::locale::conv::invalid_charset_error if the character set is not supported or isn't single byte
        /// character set
        BOOST_LOCALE_DECL
