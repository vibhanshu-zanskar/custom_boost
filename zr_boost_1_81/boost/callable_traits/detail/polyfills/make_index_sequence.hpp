...
#define BOOST_CLBL_TRTS_IX_SEQ(...) \
    ::zr_boost_1_81::callable_traits::detail::index_sequence<__VA_ARGS__>

#undef BOOST_CLBL_TRTS_MAKE_IX_SEQ
#define BOOST_CLBL_TRTS_MAKE_IX_SEQ(...) \
    ::zr_boost_1_81::callable_traits::detail::make_index_sequence<__VA_ARGS__>

namespace zr_boost_1_81 { namespace callable_traits { namespace detail { 
...
}}} // namespace zr_boost_1_81::callable_traits::detail
