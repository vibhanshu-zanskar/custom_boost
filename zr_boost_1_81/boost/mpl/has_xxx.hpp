...
namespace zr_boost_1_81 { namespace mpl { namespace aux {
...
template< typename T, typename name = ::zr_boost_1_81::mpl::aux::has_xxx_tag > \
struct BOOST_PP_CAT(trait,_impl) : T \
{ \
    static zr_boost_1_81::mpl::aux::no_tag \
    test(void(*)(::zr_boost_1_81::mpl::aux::has_xxx_tag)); \
    \
    static zr_boost_1_81::mpl::aux::yes_tag test(...); \
    \
    BOOST_STATIC_CONSTANT(bool, value = \
          sizeof(test(static_cast<void(*)(name)>(0))) \
            != sizeof(zr_boost_1_81::mpl::aux::no_tag) \
        ); \
    typedef zr_boost_1_81::mpl::bool_<value> type; \
}; \
\
template< typename T, typename fallback_ = zr_boost_1_81::mpl::bool_<default_> > \
struct trait \
    : zr_boost_1_81::mpl::if_c< \
          zr_boost_1_81::mpl::aux::msvc_is_incomplete<T>::value \
...
{ \
    BOOST_STATIC_CONSTANT(bool, value = false); \
    typedef zr_boost_1_81::mpl::bool_<false> type; \
}; \
/**/
...
{ \
    ...
    { \
        template < class U > \
        static int  resolve( zr_boost_1_81::mpl::aux::type_wrapper<U> const volatile * \
                           , zr_boost_1_81::mpl::aux::type_wrapper<typename U::name >* = 0 ); \
        static char resolve( ... ); \
    }; \
    typedef zr_boost_1_81::mpl::aux::type_wrapper<T> t_; \
    BOOST_STATIC_CONSTANT( bool, value = ( sizeof( trait_tester_impl::resolve( static_cast< t_ * >(0) ) ) == sizeof(int) ) ); \
}; \
template< typename T, typename fallback_ = zr_boost_1_81::mpl::bool_<default_> > \
struct trait           \
{                      \
    BOOST_STATIC_CONSTANT( bool, value = (trait_tester< T, zr_boost_1_81::is_class< T >::value >::value) );     \
    typedef zr_boost_1_81::mpl::bool_< trait< T, fallback_ >::value > type; \
};
...
{ \
    ...
    { \
        template< typename U > \
        static zr_boost_1_81::mpl::aux::yes_tag test( \
              zr_boost_1_81::mpl::aux::type_wrapper<U> const volatile* \
            , zr_boost_1_81::mpl::aux::type_wrapper<BOOST_MSVC_TYPENAME U::name>* = 0 \
            ); \
    \
        static zr_boost_1_81::mpl::aux::no_tag test(...); \
    }; \
    \
    typedef zr_boost_1_81::mpl::aux::type_wrapper<T> t_; \
    BOOST_STATIC_CONSTANT(bool, value = \
          sizeof(gcc_3_2_wknd::test(static_cast<t_*>(0))) \
            == sizeof(zr_boost_1_81::mpl::aux::yes_tag) \
        ); \
    typedef zr_boost_1_81::mpl::bool_<value> type; \
}; \
/**/
...
#     define BOOST_MPL_HAS_MEMBER_MULTI_ACCEPT(z, n, args) \
        template< typename V > \
        static zr_boost_1_81::mpl::aux::yes_tag \
        BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)( \
            zr_boost_1_81::mpl::aux::type_wrapper< V > const volatile* \
...
#       define BOOST_MPL_HAS_MEMBER_TEST(args) \
          sizeof( \
              BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)( \
                  static_cast< zr_boost_1_81::mpl::aux::type_wrapper< U >* >(0) \
              ) \
          ) == sizeof(zr_boost_1_81::mpl::aux::yes_tag) \
        /**/
#     else
...
#   define BOOST_MPL_HAS_MEMBER_IMPLEMENTATION( \
      ...
      template< \
          typename T \
        , typename fallback_ \
              = zr_boost_1_81::mpl::bool_< BOOST_PP_ARRAY_ELEM(3, args) > \
      > \
...
#   define BOOST_MPL_HAS_XXX_TEMPLATE_NAMED_DEF(trait, name, default_) \
      template< typename T \
              , typename fallback_ = zr_boost_1_81::mpl::bool_< default_ > > \
      struct trait { \
          BOOST_STATIC_CONSTANT(bool, value = fallback_::value); \
          typedef fallback_ type; \
      }; \
