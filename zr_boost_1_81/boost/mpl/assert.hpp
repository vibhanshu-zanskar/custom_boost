...
zr_boost_1_81::mpl::aux::weighted_tag<1>::type operator==( assert_, assert_ );
zr_boost_1_81::mpl::aux::weighted_tag<2>::type operator!=( assert_, assert_ );
zr_boost_1_81::mpl::aux::weighted_tag<3>::type operator>(  assert_, assert_ );
zr_boost_1_81::mpl::aux::weighted_tag<4>::type operator>=( assert_, assert_ );
zr_boost_1_81::mpl::aux::weighted_tag<5>::type operator<( assert_, assert_ );
zr_boost_1_81::mpl::aux::weighted_tag<6>::type operator<=( assert_, assert_ );
...
struct eval_assert {
    ...
    typedef typename ::zr_boost_1_81::mpl::if_c<p_type::value,
...
struct eval_assert_not {
    ...
    typedef typename ::zr_boost_1_81::mpl::if_c<!p_type::value,
        AUX778076_ASSERT_ARG(assert<false>),
        failed ************ ::zr_boost_1_81::mpl::not_<P>::************
    >::type type;
};
...
template< typename Pred >
failed ************ (zr_boost_1_81::mpl::not_<Pred>::************
...
template< typename Pred >
typename assert_arg_type< zr_boost_1_81::mpl::not_<Pred> >::type 
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          zr_boost_1_81::mpl::assertion_failed<false>( \
              zr_boost_1_81::mpl::make_assert_arg< \
                  typename zr_boost_1_81::mpl::eval_assert<void pred>::type \
                >() \
            ) \
        ) \
    ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          zr_boost_1_81::mpl::assertion_failed<false>( \
              zr_boost_1_81::mpl::make_assert_arg< \
                  typename zr_boost_1_81::mpl::eval_assert_not<void pred>::type \
                >() \
            ) \
        ) \
    ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          zr_boost_1_81::mpl::assertion_failed<false>( \
              zr_boost_1_81::mpl::assert_arg( (void (*) pred)0, 1 ) \
            ) \
        ) \
    ) \
/**/
...
enum { \
      BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          zr_boost_1_81::mpl::assertion<false>::failed( \
              zr_boost_1_81::mpl::assert_not_arg( (void (*) pred)0, 1 ) \
            ) \
        ) \
}\
/**/
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        zr_boost_1_81::mpl::assertion_failed<BOOST_PP_CAT(mpl_assert_rel_value,counter)>( \
            (zr_boost_1_81::mpl::failed ************ ( zr_boost_1_81::mpl::assert_relation< \
                  zr_boost_1_81::mpl::assert_::relations( sizeof( \
                      zr_boost_1_81::mpl::assert_::arg rel zr_boost_1_81::mpl::assert_::arg \
                    ) ) \
                , x \
                , y \
                >::************)) 0 ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        zr_boost_1_81::mpl::assertion_failed<BOOST_PP_CAT(mpl_assert_rel_value,counter)>( \
              zr_boost_1_81::mpl::assert_rel_arg( zr_boost_1_81::mpl::assert_relation< \
                  zr_boost_1_81::mpl::assert_::relations(BOOST_PP_CAT(mpl_assert_rel,counter)) \
                , x \
                , y \
                >() ) \
            ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
        zr_boost_1_81::mpl::assertion_failed<(x rel y)>( zr_boost_1_81::mpl::assert_rel_arg( \
              zr_boost_1_81::mpl::BOOST_MPL_AUX_ASSERT_RELATION(x,y,(&zr_boost_1_81::mpl::operator rel))() \
            ) ) \
        ) \
    ) \
/**/
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
        zr_boost_1_81::mpl::assertion_failed<(x rel y)>( (zr_boost_1_81::mpl::failed ************ ( \
            zr_boost_1_81::mpl::BOOST_MPL_AUX_ASSERT_RELATION(x,y,(&zr_boost_1_81::mpl::operator rel))::************))0 ) \
        ) \
    ) \
/**/
#   endif
...
struct msg; \
typedef struct BOOST_PP_CAT(msg,counter) : zr_boost_1_81::mpl::assert_ \
{ \
    using zr_boost_1_81::mpl::assert_::types; \
    static zr_boost_1_81::mpl::failed ************ (msg::************ assert_arg()) types_ \
    { return 0; } \
} BOOST_PP_CAT(mpl_assert_arg,counter); \
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        zr_boost_1_81::mpl::assertion<(c)>::failed( BOOST_PP_CAT(mpl_assert_arg,counter)::assert_arg() ) \
        ) \
    ) \
/**/
#else
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        zr_boost_1_81::mpl::assertion_failed<(c)>( BOOST_PP_CAT(mpl_assert_arg,counter)::assert_arg() ) \
        ) \
    ) \
/**/
#endif
