...
template< BOOST_MPL_PP_PARAMS(i,typename T) > \
::zr_boost_1_81::mpl::aux::yes_tag operator|( \
      ::zr_boost_1_81::mpl::aux::has_rebind_tag<int> \
    , name<BOOST_MPL_PP_PARAMS(i,T)>* \
    ); \
::zr_boost_1_81::mpl::aux::no_tag operator|( \
      ::zr_boost_1_81::mpl::aux::has_rebind_tag<int> \
    , name< BOOST_MPL_PP_ENUM(i,::zr_boost_1_81::mpl::na) >* \
    ); \
/**/
...
::zr_boost_1_81::mpl::aux::yes_tag operator|( \
      ::zr_boost_1_81::mpl::aux::has_rebind_tag<int> \
    , ::zr_boost_1_81::mpl::aux::has_rebind_tag< name<BOOST_MPL_PP_PARAMS(i,T)> >* \
    ); \
/**/
#else
#   define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params) /**/
