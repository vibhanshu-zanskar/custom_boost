...
#   pragma warning (push)
#   pragma warning (disable:4251) // 'zr_boost_1_81::program_options::variable_value::v' : class 'zr_boost_1_81::any' needs to have dll-interface to be used by clients of class 'zr_boost_1_81::program_options::variable_value
#endif
...
namespace zr_boost_1_81 { namespace program_options {
    ...
    */
    ...
    public:
        ...
        variable_value(const zr_boost_1_81::any& xv, bool xdefaulted)
        : v(xv), m_defaulted(xdefaulted)
        {}

        /** If stored value if of type T, returns that value. Otherwise,
            throws zr_boost_1_81::bad_any_cast exception. */
       template<class T>
       const T& as() const {
           return zr_boost_1_81::any_cast<const T&>(v);
       }
       /** @overload */
       template<class T>
       T& as() {
           return zr_boost_1_81::any_cast<T&>(v);
       }
        ...
        const zr_boost_1_81::any& value() const;

        /** Returns the contained value. */
        zr_boost_1_81::any& value();
    private:
        zr_boost_1_81::any v;
        bool m_defaulted;
