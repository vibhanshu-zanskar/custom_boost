...
//  polymorphic_cast  --------------------------------------------------------//
    ...
    inline Target polymorphic_cast(Source* x)
    {
        ...
        if ( tmp == 0 ) zr_boost_1_81::throw_exception( std::bad_cast() );
        return tmp;
    }
...
//  polymorphic_downcast  ----------------------------------------------------//
    ...
    inline typename zr_boost_1_81::enable_if_c<
        zr_boost_1_81::is_reference<Target>::value, Target
    >::type polymorphic_downcast(Source& x)
    {
        typedef typename zr_boost_1_81::remove_reference<Target>::type* target_pointer_type;
        return *zr_boost_1_81::polymorphic_downcast<target_pointer_type>(
            zr_boost_1_81::addressof(x)
        );
    }
