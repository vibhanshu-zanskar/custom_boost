...
template<typename T> using is_final=zr_boost_1_81::is_final<T>;
...
template<>
struct is_void< ::zr_boost_1_81::poly_collection::detail::is_final_fallback::hook>:
  std::false_type
{      
  template<typename T>
  static constexpr bool is_final_f()
  {
    using namespace ::zr_boost_1_81::poly_collection::detail::is_final_fallback;
