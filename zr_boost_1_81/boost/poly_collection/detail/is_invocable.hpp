...
template<>
struct is_void< ::zr_boost_1_81::poly_collection::detail::is_invocable_fallback::hook>:
  std::false_type
{      
  template<typename F,typename... Args>
  static constexpr bool is_invocable_f()
  {
    using namespace ::zr_boost_1_81::poly_collection::detail::is_invocable_fallback;
