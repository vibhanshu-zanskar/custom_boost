...
namespace zr_boost_1_81 { namespace stl_interfaces {
...
namespace zr_boost_1_81 { namespace stl_interfaces { BOOST_STL_INTERFACES_NAMESPACE_V1 {
...
namespace zr_boost_1_81 { namespace stl_interfaces { BOOST_STL_INTERFACES_NAMESPACE_V2 {
...
#define BOOST_STL_INTERFACES_STATIC_ASSERT_ITERATOR_TRAITS(                    \
    ...
    static_assert(                                                             \
        std::is_same_v<                                                        \
            zr_boost_1_81::stl_interfaces::v2::v2_dtl::iter_concept_t<iter>,           \
            concept>,                                                          \
        "");                                                                   \
