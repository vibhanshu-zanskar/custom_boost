...
namespace zr_boost_1_81 {
  namespace process {
    <emphasis>unspecified</emphasis> <globalname alt="zr_boost_1_81::process::exe">exe</globalname>;
  }
}
</programlisting>
\endxmlonly
...
struct exe_
{
    ...
    inline exe_setter_<typename zr_boost_1_81::process::filesystem::path::value_type> operator()(const zr_boost_1_81::process::filesystem::path & pth) const
    {
        return exe_setter_<typename zr_boost_1_81::process::filesystem::path::value_type>(pth.native());
    }
...
a `std::basic_string` with `char` or `wchar_t` or a `zr_boost_1_81::process::filesystem::path`.
 ...
 */
constexpr zr_boost_1_81::process::detail::exe_ exe{};
