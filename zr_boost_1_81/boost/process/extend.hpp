...
using windows_executor = ::zr_boost_1_81::process::detail::windows::executor<Char, Sequence>;
...
template<typename Sequence>
using posix_executor = ::zr_boost_1_81::process::detail::posix::executor<Sequence>;
template<typename Char, typename Sequence>
struct windows_executor;

#endif

using ::zr_boost_1_81::process::detail::handler;
using ::zr_boost_1_81::process::detail::api::require_io_context;
using ::zr_boost_1_81::process::detail::api::async_handler;
using ::zr_boost_1_81::process::detail::get_io_context;
using ::zr_boost_1_81::process::detail::get_last_error;
using ::zr_boost_1_81::process::detail::throw_last_error;
using ::zr_boost_1_81::process::detail::uses_handles;
using ::zr_boost_1_81::process::detail::foreach_used_handle;
using ::zr_boost_1_81::process::detail::get_used_handles;
...
constexpr zr_boost_1_81::process::detail::make_handler_t<zr_boost_1_81::process::detail::on_setup_>   on_setup;
...
constexpr zr_boost_1_81::process::detail::make_handler_t<zr_boost_1_81::process::detail::on_error_>   on_error;
...
constexpr zr_boost_1_81::process::detail::make_handler_t<zr_boost_1_81::process::detail::on_success_> on_success;
...
constexpr ::zr_boost_1_81::process::detail::make_handler_t<::zr_boost_1_81::process::detail::posix::on_fork_error_  >   on_fork_error;
///This handler is invoked if the fork succeeded. The required signature is `void(Exec &)`, where `Exec` is a template parameter. \note Only available on posix.
constexpr ::zr_boost_1_81::process::detail::make_handler_t<::zr_boost_1_81::process::detail::posix::on_exec_setup_  >   on_exec_setup;
...
constexpr ::zr_boost_1_81::process::detail::make_handler_t<::zr_boost_1_81::process::detail::posix::on_exec_error_  >   on_exec_error;
#endif
...
/// \throws zr_boost_1_81::process::process_error
 ...
 *
 * \warning Cannot be used with \ref zr_boost_1_81::process::spawn
 */
...
struct windows_executor
{
    ///A reference to the actual initializer-sequence
     ...
     ::zr_boost_1_81::detail::winapi::LPSECURITY_ATTRIBUTES_ proc_attrs   = nullptr;
     ...
     ::zr_boost_1_81::detail::winapi::LPSECURITY_ATTRIBUTES_ thread_attrs = nullptr;
     ///A logical bool value setting whether handles shall be inherited or not.
     ::zr_boost_1_81::detail::winapi::BOOL_ inherit_handles = false;
     ...
     ::zr_boost_1_81::detail::winapi::PROCESS_INFORMATION_ proc_info{nullptr, nullptr, 0,0};
    ...
    ::zr_boost_1_81::detail::winapi::DWORD_ creation_flags;
