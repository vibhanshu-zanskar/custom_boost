...
namespace zr_boost_1_81 {
  namespace process {
    <emphasis>unspecified</emphasis> <globalname alt="zr_boost_1_81::process::shell">shell</globalname>;
  }
}
</programlisting>
\endxmlonly
...
struct shell_
{
    ...
    zr_boost_1_81::process::filesystem::path operator()() const
    {
        return zr_boost_1_81::process::detail::api::shell_path();
    }
    zr_boost_1_81::process::filesystem::path operator()(std::error_code & ec) const noexcept
    {
        return zr_boost_1_81::process::detail::api::shell_path(ec);
    }
};

template<>
struct is_wchar_t<shell_> : is_wchar_t<zr_boost_1_81::process::filesystem::path>
{
};
...
*/
constexpr ::zr_boost_1_81::process::detail::shell_ shell;
