...
namespace zr_boost_1_81 {
  namespace process {
    <emphasis>unspecified</emphasis> <globalname alt="zr_boost_1_81::process::ignore_error">ignore_error</globalname>;
    <emphasis>unspecified</emphasis> <globalname alt="zr_boost_1_81::process::throw_on_error">throw_on_error</globalname>;
    <emphasis>unspecified</emphasis> <globalname alt="zr_boost_1_81::process::error">error</globalname>;
    <emphasis>unspecified</emphasis> <globalname alt="zr_boost_1_81::process::error_ref">error_ref</globalname>;
    <emphasis>unspecified</emphasis> <globalname alt="zr_boost_1_81::process::error_code">error_code</globalname>;
  }
}
</programlisting>
\endxmlonly
...
struct throw_on_error_ : ::zr_boost_1_81::process::detail::api::handler_base_ext
{
...
struct ignore_error_ : ::zr_boost_1_81::process::detail::api::handler_base_ext
{
    constexpr ignore_error_() = default;
};

struct set_on_error : ::zr_boost_1_81::process::detail::api::handler_base_ext
{
...
struct has_error_handler_impl
{
    ...
    typedef typename zr_boost_1_81::mpl::or_<cond, next>::type type;
};
...
{
    typedef typename zr_boost_1_81::fusion::result_of::as_vector<Sequence>::type vector_type;

    typedef typename has_error_handler_impl<
            typename zr_boost_1_81::fusion::result_of::begin<vector_type>::type,
            typename zr_boost_1_81::fusion::result_of::end<  vector_type>::type
            >::type type;
};
...
{
    typedef typename zr_boost_1_81::fusion::result_of::as_set<Sequence>::type set_type;
    typedef typename zr_boost_1_81::fusion::result_of::has_key<set_type, ignore_error_>::type  type1;
    typedef typename zr_boost_1_81::fusion::result_of::has_key<set_type, ignore_error_&>::type type2;
    typedef typename zr_boost_1_81::fusion::result_of::has_key<set_type, const ignore_error_&>::type type3;
    typedef typename zr_boost_1_81::mpl::or_<type1,type2, type3>::type type;
};
...
constexpr zr_boost_1_81::process::detail::ignore_error_ ignore_error;
 ...
 */
constexpr zr_boost_1_81::process::detail::error_ error;
///Alias for \xmlonly <globalname alt="zr_boost_1_81::process::error">error</globalname> \endxmlonly .
constexpr zr_boost_1_81::process::detail::error_ error_ref;
///Alias for \xmlonly <globalname alt="zr_boost_1_81::process::error">error</globalname> \endxmlonly .
constexpr zr_boost_1_81::process::detail::error_ error_code;
