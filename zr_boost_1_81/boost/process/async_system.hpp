...
struct async_system_handler : ::zr_boost_1_81::process::detail::api::async_handler
{
    ...
    void on_error(Exec&, const std::error_code & ec)
    {
        ...
        zr_boost_1_81::asio::post(
            ...
            [h, ec]() mutable
            {
                (*h)(zr_boost_1_81::system::error_code(ec.value(), zr_boost_1_81::system::system_category()), -1);
            });
    }
    ...
    std::function<void(int, const std::error_code&)> on_exit_handler(Executor&)
    {
        ...
        return [h](int exit_code, const std::error_code & ec) mutable
               {
                    (*h)(zr_boost_1_81::system::error_code(ec.value(), zr_boost_1_81::system::system_category()), exit_code);
               };
    }
};
...
\param exit_handler The exit-handler for the signature `void(zr_boost_1_81::system::error_code, int)`
...
inline zr_boost_1_81::process::detail::dummy
    async_system(zr_boost_1_81::asio::io_context & ios, ExitHandler && exit_handler, Args && ...args);
#endif
...
template<typename ExitHandler, typename ...Args>
inline BOOST_ASIO_INITFN_RESULT_TYPE(ExitHandler, void (zr_boost_1_81::system::error_code, int))
    async_system(zr_boost_1_81::asio::io_context & ios, ExitHandler && exit_handler, Args && ...args)
{
    
    typedef typename ::zr_boost_1_81::process::detail::has_error_handler<zr_boost_1_81::fusion::tuple<Args...>>::type
            has_err_handling;

    static_assert(!has_err_handling::value, "async_system cannot have custom error handling");

    return zr_boost_1_81::asio::async_initiate<ExitHandler, void (zr_boost_1_81::system::error_code, int)>(
