 ...
 *
 *    This header provides the \xmlonly <globalname alt="zr_boost_1_81::process::args">args</globalname>\endxmlonly property. It also provides the
 *    alternative name \xmlonly <globalname alt="zr_boost_1_81::process::argv">argv</globalname>\endxmlonly .
 *
 *
\xmlonly
<programlisting>
namespace zr_boost_1_81 {
  namespace process {
    <emphasis>unspecified</emphasis> <globalname alt="zr_boost_1_81::process::args">args</globalname>;
    <emphasis>unspecified</emphasis> <globalname alt="zr_boost_1_81::process::argv">argv</globalname>;
  }
}
</programlisting>
\endxmlonly
 ...
 */
constexpr zr_boost_1_81::process::detail::args_ args{};

///Alias for \xmlonly <globalname alt="zr_boost_1_81::process::args">args</globalname> \endxmlonly .
constexpr zr_boost_1_81::process::detail::args_ argv{};
