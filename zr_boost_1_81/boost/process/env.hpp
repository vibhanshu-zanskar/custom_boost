...
namespace zr_boost_1_81 {
  namespace process {
    <emphasis>unspecified</emphasis> <globalname alt="zr_boost_1_81::process::env">env</globalname>;
  }
}
</programlisting>
 *  \endxmlonly
...
struct char_converter<char, env_set<wchar_t>>
{
    ...
    {
        return {::zr_boost_1_81::process::detail::convert(in.key),
                ::zr_boost_1_81::process::detail::convert(in.value)};
    }
};
...
struct env_proxy
{
    ...
    env_reset<Char> operator=(zr_boost_1_81::none_t)
    {
        return {std::move(key)};
    }
};
...
struct env_
{
    ...
    template<typename Char>
    env_reset<Char> operator()(const std::basic_string<Char> & key, zr_boost_1_81::none_t)
    {
        return {key};
    }
    template<typename Char>
...
\xmlonly <classname>zr_boost_1_81::process::environment</classname> \endxmlonly
...
\paragraph env_init_var_value value
 ...
 - `zr_boost_1_81::process::basic_environment<char_type>`

\subsection env_example Example

\code{.cpp}
spawn("b2", env["PATH"]+="F:/boost", env["SOME_VAR"]=zr_boost_1_81::none, env["NEW_VAR"]="VALUE");
\endcode
 ...
 */
constexpr zr_boost_1_81::process::detail::env_ env{};
