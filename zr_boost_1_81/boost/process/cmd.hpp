 ...
 *
 *    This header provides the \xmlonly <globalname alt="zr_boost_1_81::process::cmd">cmd</globalname>\endxmlonly property.
 *
\xmlonly
<programlisting>
namespace zr_boost_1_81 {
  namespace process {
    <emphasis>unspecified</emphasis> <globalname alt="zr_boost_1_81::process::cmd">cmd</globalname>;
  }
}
</programlisting>
\endxmlonly
...
struct char_converter<char, api::cmd_setter_<wchar_t>>
{
    ...
    {
        return { ::zr_boost_1_81::process::detail::convert(in.str()) };
    }
};
 ...
 */
constexpr static ::zr_boost_1_81::process::detail::cmd_ cmd;
