...
struct const_entry
{
    ...
    using range         = zr_boost_1_81::iterator_range<pointer> ;
    ...
    std::vector<string_type> to_vector() const
    {
        ...
        zr_boost_1_81::split(data, _data, s);
        return data;
    }
...
public:
    ...
    using iterator        = zr_boost_1_81::transform_iterator<      entry_maker, Char**,       entry_type,       entry_type>;
    using const_iterator  = zr_boost_1_81::transform_iterator<const_entry_maker, Char**, const_entry_type, const_entry_type>;
    ...
    {
        auto p = this->_env_impl;
        auto st1 = key + ::zr_boost_1_81::process::detail::equal_sign<Char>();
        while (*p != nullptr)
        {
    ...
    {
        auto p = this->_env_impl;
        auto st1 = st + ::zr_boost_1_81::process::detail::equal_sign<Char>();
        while (*p != nullptr)
        {
            const int len = std::char_traits<Char>::length(*p);
            if ((std::distance(st1.begin(), st1.end()) < len)
...
public:
    ...
    typedef zr_boost_1_81::transform_iterator<      entry_maker, Char**> iterator       ;
    typedef zr_boost_1_81::transform_iterator<const_entry_maker, Char**> const_iterator ;
    ...
    struct const_entry_type
    {
        ...
        typedef zr_boost_1_81::iterator_range<pointer> range;
...
typedef ::zr_boost_1_81::process::detail::api::native_handle_t native_handle_type;

#if !defined(BOOST_NO_ANSI_APIS)
///Definition of the environment for this process.
using ::zr_boost_1_81::process::native_environment;
#endif
///Definition of the environment for this process.
using ::zr_boost_1_81::process::wnative_environment;

///Get the process id of the current process.
inline int get_id()                     { return ::zr_boost_1_81::process::detail::api::get_id();}
///Get the native handle of the current process.
inline native_handle_type native_handle()  { return ::zr_boost_1_81::process::detail::api::native_handle();}
#if !defined(BOOST_NO_ANSI_APIS)
///Get the enviroment of the current process.
inline native_environment   environment() { return ::zr_boost_1_81::process:: native_environment(); }
#endif
///Get the enviroment of the current process.
inline wnative_environment wenvironment() { return ::zr_boost_1_81::process::wnative_environment(); }
///Get the path environment variable of the current process runs.
inline std::vector<zr_boost_1_81::process::filesystem::path> path()
{
...
#else
    const ::zr_boost_1_81::process::native_environment ne{};
    typedef typename ::zr_boost_1_81::process::native_environment::const_entry_type value_type;
    ...
    std::vector<zr_boost_1_81::process::filesystem::path> val;
    val.resize(vec.size());
