...
namespace zr_boost_1_81 { namespace this_process
{

///The native type for handles
using native_handle_type = ::zr_boost_1_81::process::detail::api::native_handle_type;
...
{
    return ::zr_boost_1_81::process::detail::api::get_handles();
}
...
{
    return ::zr_boost_1_81::process::detail::api::get_handles(ec);
}
...
{
    return ::zr_boost_1_81::process::detail::api::is_stream_handle(handle);
}
...
{
    return ::zr_boost_1_81::process::detail::api::is_stream_handle(handle, ec);
}
...
using limit_handles_ = ::zr_boost_1_81::process::detail::api::limit_handles_;
 ...
 *
*/
const static ::zr_boost_1_81::process::detail::api::limit_handles_ limit_handles;
