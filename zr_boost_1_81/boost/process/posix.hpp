...
namespace zr_boost_1_81 {
  namespace process {
    namespace posix {
      <emphasis>unspecified</emphasis> <globalname alt="zr_boost_1_81::process::posix::fd">fd</globalname>;
      <emphasis>unspecified</emphasis> <globalname alt="zr_boost_1_81::process::posix::sig">sig</globalname>;
      <emphasis>unspecified</emphasis> <globalname alt="zr_boost_1_81::process::posix::use_vfork">use_vfork</globalname>;
    }
  }
}
</programlisting>
 ...
 *
 */
constexpr ::zr_boost_1_81::process::detail::posix::fd_ fd;
 ...
 */
constexpr ::zr_boost_1_81::process::detail::posix::sig_       sig;
 ...
 */
constexpr ::zr_boost_1_81::process::detail::posix::use_vfork_ use_vfork;


using ::zr_boost_1_81::process::detail::posix::sighandler_t;
