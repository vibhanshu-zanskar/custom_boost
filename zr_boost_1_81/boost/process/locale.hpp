...
{
    static const ::zr_boost_1_81::process::detail::codecvt_category_t cat;
    return cat;
}
...
# if defined(BOOST_WINDOWS_API)
    ...
    return std::locale(global_loc, new zr_boost_1_81::process::detail::windows::windows_file_codecvt);
# elif defined(macintosh) || defined(__APPLE__) || defined(__APPLE_CC__) \
|| defined(__FreeBSD__) || defined(__OpenBSD__) || defined(__HAIKU__)
    std::locale global_loc = std::locale();
...
inline std::size_t convert(const char* from,
                    ...
                    const ::zr_boost_1_81::process::codecvt_type & cvt =
                                 ::zr_boost_1_81::process::codecvt())
{
    ...
    if (res != std::codecvt_base::ok)
         throw process_error(res, ::zr_boost_1_81::process::codecvt_category(),
             "zr_boost_1_81::process codecvt to wchar_t");
                                 ...
                                 ::zr_boost_1_81::process::codecvt())
{
    ...
    if ((res=cvt.out(state, from, from_end, from_next,
           to, to_end, to_next)) != std::codecvt_base::ok)
               throw process_error(res, ::zr_boost_1_81::process::codecvt_category(),
                   "zr_boost_1_81::process codecvt to char");
