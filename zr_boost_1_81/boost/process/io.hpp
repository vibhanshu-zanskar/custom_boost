...
namespace zr_boost_1_81 {
  namespace process {
    <emphasis>unspecified</emphasis> <globalname alt="zr_boost_1_81::process::close">close</globalname>;
    <emphasis>unspecified</emphasis> <globalname alt="zr_boost_1_81::process::null">null</globalname>;
    <emphasis>unspecified</emphasis> <globalname alt="zr_boost_1_81::process::std_in">std_in</globalname>;
    <emphasis>unspecified</emphasis> <globalname alt="zr_boost_1_81::process::std_out">std_out</globalname>;
    <emphasis>unspecified</emphasis> <globalname alt="zr_boost_1_81::process::std_err">std_err</globalname>;
  }
}
</programlisting>
\endxmlonly
...
\code{.cpp}
zr_boost_1_81::process::filesystem::path log    = "my_log_file.txt";
zr_boost_1_81::process::filesystem::path input  = "input.txt";
zr_boost_1_81::process::filesystem::path output = "output.txt";
...
template<typename T> using is_streambuf    = typename std::is_same<T, zr_boost_1_81::asio::streambuf>::type;
template<typename T> using is_const_buffer =
        std::integral_constant<bool,
            std::is_same<   zr_boost_1_81::asio::const_buffer, T>::value |
            std::is_base_of<zr_boost_1_81::asio::const_buffer, T>::value
        >;
template<typename T> using is_mutable_buffer =
        std::integral_constant<bool,
            std::is_same<   zr_boost_1_81::asio::mutable_buffer, T>::value |
            std::is_base_of<zr_boost_1_81::asio::mutable_buffer, T>::value
        >;
...
struct std_in_
{
    ...
    api::file_in operator=(const zr_boost_1_81::process::filesystem::path &p) const {return p;}
...
struct std_out_
{
    ...
    api::file_out<p1,p2> operator=(const zr_boost_1_81::process::filesystem::path &p) const {return api::file_out<p1,p2>(p);}
...
constexpr zr_boost_1_81::process::detail::close_t close;
///This constant is a utility to redirect streams to the null-device.
constexpr zr_boost_1_81::process::detail::null_t  null;
...
The file I/O simple redirects the stream to a file, for which the possible types are
 ...
 - `zr_boost_1_81::process::filesystem::path`
...
@ref zr_boost_1_81::process::async_pipe "async_pipe" class which can be
used to communicate with child processes.

\note Technically the @ref zr_boost_1_81::process::async_pipe "async_pipe"
...
Valid types for pipe I/O are the following:
 ...
 - `zr_boost_1_81::asio::const_buffer`   \xmlonly <footnote><para> Constructed with <code>zr_boost_1_81::asio::buffer</code></para></footnote> \endxmlonly
 - `zr_boost_1_81::asio::mutable_buffer` \xmlonly <footnote><para> Constructed with <code>zr_boost_1_81::asio::buffer</code></para></footnote> \endxmlonly
 - `zr_boost_1_81::asio::streambuf`
...
\note `zr_boost_1_81::asio::buffer` is also available in the `zr_boost_1_81::process` namespace.

\warning This feature requires `boost/process/async.hpp` to be included and a reference to `zr_boost_1_81::asio::io_context` to be passed to the launching function.
...
constexpr zr_boost_1_81::process::detail::std_in_<void>   std_in;

/**
This property allows to set the output stream for the child process.

\note The Semantic is the same as for \xmlonly <globalname alt="zr_boost_1_81::process::std_err">std_err</globalname> \endxmlonly
...
constexpr zr_boost_1_81::process::detail::std_out_<1> std_out;
/**This property allows setting the `stderr` stream. The semantic and syntax is the same as for
 * \xmlonly <globalname alt="zr_boost_1_81::process::std_out">std_out</globalname> \endxmlonly .
 */
constexpr zr_boost_1_81::process::detail::std_out_<2> std_err;
