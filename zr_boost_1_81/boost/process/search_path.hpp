 ...
 */
inline zr_boost_1_81::process::filesystem::path search_path(const zr_boost_1_81::process::filesystem::path &filename,
                                    const std::vector<zr_boost_1_81::process::filesystem::path> path = ::zr_boost_1_81::this_process::path())
{
    return ::zr_boost_1_81::process::detail::api::search_path(filename, path);
}
}}
