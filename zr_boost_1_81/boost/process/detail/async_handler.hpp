...
#if defined(BOOST_POSIX_API)
using ::zr_boost_1_81::process::detail::posix::is_async_handler;
using ::zr_boost_1_81::process::detail::posix::does_require_io_context;
#else
using ::zr_boost_1_81::process::detail::windows::is_async_handler;
using ::zr_boost_1_81::process::detail::windows::does_require_io_context;
#endif
...
struct has_io_context<T, Args...>
{
    ...
    typedef typename std::is_same<
                ...
                zr_boost_1_81::asio::io_context>::type is_ios;
...
struct has_io_context<T>
{
    typedef typename std::is_same<
            typename std::remove_reference<T>::type,
            zr_boost_1_81::asio::io_context>::type type;
};
...
template<typename ...Args>
zr_boost_1_81::asio::io_context &get_io_context_var(zr_boost_1_81::asio::io_context & f, Args&...)
{
    return f;
}

template<typename First, typename ...Args>
zr_boost_1_81::asio::io_context &get_io_context_var(First&, Args&...args)
{
