...
template<typename Char>  struct initializer_tag<::zr_boost_1_81::process::basic_environment<Char>>           { typedef env_tag<Char> type; };
template<typename Char>  struct initializer_tag<::zr_boost_1_81::process::basic_native_environment<Char>> { typedef env_tag<Char> type; };
