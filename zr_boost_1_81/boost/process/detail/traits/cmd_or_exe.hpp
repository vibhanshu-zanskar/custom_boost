...
{
    typedef cmd_or_exe_tag<typename zr_boost_1_81::process::filesystem::path::value_type> type;
};

template<> struct initializer_tag<zr_boost_1_81::process::filesystem::path>
{
    typedef cmd_or_exe_tag<typename zr_boost_1_81::process::filesystem::path::value_type> type;
};
