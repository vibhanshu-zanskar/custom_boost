...
template<> struct is_wchar_t<zr_boost_1_81::process::filesystem::path> : std::is_same<typename zr_boost_1_81::process::filesystem::path::value_type, wchar_t>
{
};
...
struct char_converter<char, const wchar_t*>
{
    static std::string conv(const wchar_t* in)
    {
        ...
        return ::zr_boost_1_81::process::detail::convert(in, in + size);
    }
};
...
struct char_converter<char, wchar_t[Size]>
{
    ...
    {
        return ::zr_boost_1_81::process::detail::convert(in, in + Size -1);
    }
};
...
struct char_converter<wchar_t, std::string>
{
    ...
    {
        return ::zr_boost_1_81::process::detail::convert(in);
    }
};
