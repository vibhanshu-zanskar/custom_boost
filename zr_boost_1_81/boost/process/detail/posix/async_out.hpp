...
struct async_out_buffer : ::zr_boost_1_81::process::detail::posix::handler_base_ext,
                          ...
                          ::zr_boost_1_81::process::detail::uses_handles
{
    ...
    {
        auto  pipe              = this->pipe;
        zr_boost_1_81::asio::async_read(*pipe, buf,
                [pipe](const zr_boost_1_81::system::error_code&, std::size_t){});
...
struct async_out_future : ::zr_boost_1_81::process::detail::posix::handler_base_ext,
                          ::zr_boost_1_81::process::detail::posix::require_io_context
{
    std::shared_ptr<std::promise<Type>> promise = std::make_shared<std::promise<Type>>();

    std::shared_ptr<zr_boost_1_81::asio::streambuf> buffer = std::make_shared<zr_boost_1_81::asio::streambuf>();
    ...
    inline void on_success(Executor &)
    {
        ...
        zr_boost_1_81::asio::async_read(*pipe_, *buffer_,
                [pipe_, buffer_, promise_](const zr_boost_1_81::system::error_code& ec, std::size_t)
                {
