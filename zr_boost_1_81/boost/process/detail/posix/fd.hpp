...
struct close_fd_ : handler_base_ext, ::zr_boost_1_81::process::detail::uses_handles
{
...
struct close_fds_ : handler_base_ext, ::zr_boost_1_81::process::detail::uses_handles
{
public:
...
struct bind_fd_ : handler_base_ext, ::zr_boost_1_81::process::detail::uses_handles
{
public:
