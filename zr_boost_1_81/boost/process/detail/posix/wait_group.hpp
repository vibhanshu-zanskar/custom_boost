...
inline void wait(const group_handle &p) noexcept
{
    std::error_code ec;
    wait(p, ec);
    zr_boost_1_81::process::detail::throw_error(ec, "waitpid(2) failed in wait");
}
        ...
        const std::chrono::time_point<Clock, Duration>& time_out) noexcept
{
    ...
    zr_boost_1_81::process::detail::throw_error(ec, "waitpid(2) failed in wait_until");
    return b;
}
        ...
        const std::chrono::duration<Rep, Period>& rel_time) noexcept
{
    ...
    zr_boost_1_81::process::detail::throw_error(ec, "waitpid(2) failed in wait_for");
    return b;
}
