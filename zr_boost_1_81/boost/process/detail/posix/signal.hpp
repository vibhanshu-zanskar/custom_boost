...
private:
    bool _reset = false;
    ::zr_boost_1_81::process::detail::posix::sighandler_t _old{0};
    ::zr_boost_1_81::process::detail::posix::sighandler_t _handler{0};
};
...
struct sig_
{
    ...
    sig_init_ operator()(::zr_boost_1_81::process::detail::posix::sighandler_t h) const {return h;}
    sig_init_ operator= (::zr_boost_1_81::process::detail::posix::sighandler_t h) const {return h;}
