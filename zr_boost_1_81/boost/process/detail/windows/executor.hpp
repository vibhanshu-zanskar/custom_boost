...
{
    typedef ::zr_boost_1_81::winapi::STARTUPINFOA_ type;
};
#endif

template<> struct startup_info<wchar_t>
{
    typedef ::zr_boost_1_81::winapi::STARTUPINFOW_ type;
};
...
{
    typedef ::zr_boost_1_81::winapi::STARTUPINFOEXA_ type;
};
#endif

template<> struct startup_info_ex<wchar_t>
{
    typedef ::zr_boost_1_81::winapi::STARTUPINFOEXW_ type;
};
...
{
    ::zr_boost_1_81::winapi::DWORD_ creation_flags = 0;
    ...
    startup_info_ex_t  startup_info_ex
            {startup_info_t {sizeof(startup_info_t), nullptr, nullptr, nullptr,
                               ...
                               ::zr_boost_1_81::winapi::invalid_handle_value,
                               ::zr_boost_1_81::winapi::invalid_handle_value,
                               ::zr_boost_1_81::winapi::invalid_handle_value},
                nullptr
    };
    ...
    void set_startup_info_ex()
    {
       ...
       creation_flags |= ::zr_boost_1_81::winapi::EXTENDED_STARTUPINFO_PRESENT_;
    }
};
...
class executor : public startup_info_impl<Char>
{
    ...
    void internal_error_handle(const std::error_code &, const char*, zr_boost_1_81::mpl::false_, zr_boost_1_81::mpl::true_) {}
    void internal_error_handle(const std::error_code &, const char*, zr_boost_1_81::mpl::true_,  zr_boost_1_81::mpl::true_) {}

    void internal_error_handle(const std::error_code &ec, const char*, zr_boost_1_81::mpl::true_,  zr_boost_1_81::mpl::false_ )
    {
        this->_ec = ec;
    }
    void internal_error_handle(const std::error_code &ec, const char* msg, zr_boost_1_81::mpl::false_, zr_boost_1_81::mpl::false_ )
    {
...
public:
    ...
    child operator()()
    {
        ...
        zr_boost_1_81::fusion::for_each(seq, on_setup_fn);

        if (_ec)
        {
            on_error_t on_error_fn(*this, _ec);
            zr_boost_1_81::fusion::for_each(seq, on_error_fn);
            return child();
        }

        //NOTE: The non-cast cmd-line string can only be modified by the wchar_t variant which is currently disabled.
        int err_code = ::zr_boost_1_81::winapi::create_process(
        ...
        if (err_code != 0)
        {
            ...
            zr_boost_1_81::fusion::for_each(seq, on_success_fn);
        }
        else
            set_error(::zr_boost_1_81::process::detail::get_last_error(),
                    " CreateProcess failed");

        if ( _ec)
        {
            on_error_t on_err(*this, _ec);
            zr_boost_1_81::fusion::for_each(seq, on_err);
            return child();
        }
        else
            return c;
    ...
    ::zr_boost_1_81::winapi::LPSECURITY_ATTRIBUTES_ proc_attrs   = nullptr;
    ::zr_boost_1_81::winapi::LPSECURITY_ATTRIBUTES_ thread_attrs = nullptr;
    ::zr_boost_1_81::winapi::BOOL_ inherit_handles = false;
