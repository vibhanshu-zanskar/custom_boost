...
class windows_file_codecvt
 ...
 protected:
   ...
   {
     zr_boost_1_81::ignore_unused(state);

       auto codepage =
#if !defined(BOOST_NO_ANSI_APIS)
               ::zr_boost_1_81::winapi::AreFileApisANSI() ?
               ::zr_boost_1_81::winapi::CP_ACP_ :
#endif
               ::zr_boost_1_81::winapi::CP_OEMCP_;

     int count = 0;
     if ((count = ::zr_boost_1_81::winapi::MultiByteToWideChar(codepage,
             ::zr_boost_1_81::winapi::MB_PRECOMPOSED_, from,
     ...
     char* to, char* to_end, char*& to_next) const override
   {
     ...
     if ((count = ::zr_boost_1_81::winapi::WideCharToMultiByte(codepage,
                   ::zr_boost_1_81::winapi::WC_NO_BEST_FIT_CHARS_, from,
