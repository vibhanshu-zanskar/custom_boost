...
constexpr static ::zr_boost_1_81::winapi::DWORD_ still_active = 259;
...
inline bool is_running(const child_handle &p, int & exit_code, std::error_code &ec) noexcept
{
    ...
    if (!::zr_boost_1_81::winapi::GetExitCodeProcess(p.process_handle(), &code))
...
inline bool is_running(const child_handle &p, int & exit_code)
{
    ...
    zr_boost_1_81::process::detail::throw_error(ec, "GetExitCodeProcess() failed in is_running");
    return b;
}
