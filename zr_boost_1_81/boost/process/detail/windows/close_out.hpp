...
struct close_out : public ::zr_boost_1_81::process::detail::handler_base
{
...
{
    e.startup_info.hStdOutput = ::zr_boost_1_81::winapi::INVALID_HANDLE_VALUE_;
...
{
    e.startup_info.hStdError = ::zr_boost_1_81::winapi::INVALID_HANDLE_VALUE_;
    e.startup_info.dwFlags  |= ::zr_boost_1_81::winapi::STARTF_USESTDHANDLES_;
}
