...
struct pipe_out : public ::zr_boost_1_81::process::detail::handler_base, ::zr_boost_1_81::process::detail::uses_handles
{
    ::zr_boost_1_81::winapi::HANDLE_ handle;

    ::zr_boost_1_81::winapi::HANDLE_ get_used_handles() const { return handle; }

    pipe_out(::zr_boost_1_81::winapi::HANDLE_ handle) : handle(handle) {}
    template<typename T>
    pipe_out(T & p) : handle(p.native_sink())
    {
        p.assign_sink(::zr_boost_1_81::winapi::INVALID_HANDLE_VALUE_);
    }
