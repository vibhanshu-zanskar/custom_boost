...
namespace zr_boost_1_81 {
  namespace process {
    <emphasis>unspecified</emphasis> <globalname alt="zr_boost_1_81::process::start_dir">start_dir</globalname>;
  }
}
</programlisting>
\endxmlonly
...
struct start_dir_
{
    ...
    api::start_dir_init<typename zr_boost_1_81::process::filesystem::path::value_type>
                              operator()(const zr_boost_1_81::process::filesystem::path & st) const {return {st.native()}; }
...
struct char_converter<char, api::start_dir_init<wchar_t>>
{
    ...
    {
        return api::start_dir_init<char>{::zr_boost_1_81::process::detail::convert(in.str())};
    }
};
...
struct char_converter<wchar_t, api::start_dir_init<char>>
{
    ...
    {
        return api::start_dir_init<wchar_t>{::zr_boost_1_81::process::detail::convert(in.str())};
    }
};
...
It can be used with `std::string`, `std::wstring` and `zr_boost_1_81::process::filesystem::path`.


 */
constexpr ::zr_boost_1_81::process::detail::start_dir_ start_dir;
