...
class group
{
    ::zr_boost_1_81::process::detail::api::group_handle _group_handle;
    bool _attached = true;
public:
    typedef ::zr_boost_1_81::process::detail::api::group_handle group_handle;
    ...
    void wait()
    {
        zr_boost_1_81::process::detail::api::wait(_group_handle);
    }
    ///\overload void wait()
    void wait(std::error_code & ec) noexcept
    {
        zr_boost_1_81::process::detail::api::wait(_group_handle, ec);
    }
    ...
    {
        return zr_boost_1_81::process::detail::api::wait_for(_group_handle, rel_time);
    }
    ...
    {
        return zr_boost_1_81::process::detail::api::wait_for(_group_handle, rel_time, ec);
    }
    ...
    {
        return zr_boost_1_81::process::detail::api::wait_until(_group_handle, timeout_time);
    }
    ...
    {
        return zr_boost_1_81::process::detail::api::wait_until(_group_handle, timeout_time, ec);
    }
    ...
    void terminate()
    {
        ::zr_boost_1_81::process::detail::api::terminate(_group_handle);
    }
    ///\overload void terminate()
    void terminate(std::error_code & ec) noexcept
    {
        ::zr_boost_1_81::process::detail::api::terminate(_group_handle, ec);
    }
