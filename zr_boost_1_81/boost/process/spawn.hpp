...
It will fail to compile if a reference to `zr_boost_1_81::asio::io_context` is passed.

 */
template<typename ...Args>
inline void spawn(Args && ...args)
{
    typedef typename ::zr_boost_1_81::process::detail::has_async_handler<Args...>::type
            has_async;
    ...
    auto c = ::zr_boost_1_81::process::detail::execute_impl(
#if defined(BOOST_POSIX_API)
            ::zr_boost_1_81::process::posix::sig.ign(),
#endif
