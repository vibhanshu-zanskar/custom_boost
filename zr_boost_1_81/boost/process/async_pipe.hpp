 ...
 *  It is based on the corresponding I/O Object, that is either zr_boost_1_81::asio::windows::stream_handle or
 *  zr_boost_1_81::asio::posix::stream_descriptor.
 *
 *  It can be used directly with zr_boost_1_81::asio::async_read or async_write.
 *
...
public:
     ...
     */
    inline async_pipe(zr_boost_1_81::asio::io_context & ios);
     ...
     */
    inline async_pipe(zr_boost_1_81::asio::io_context & ios_source,
                      zr_boost_1_81::asio::io_context & ios_sink, const std::string & name);
    ...
    native_handle native_source() const {return const_cast<zr_boost_1_81::asio::windows::stream_handle&>(_source).native();}
    /** Get the native handle of the sink. */
    native_handle native_sink  () const {return const_cast<zr_boost_1_81::asio::windows::stream_handle&>(_sink  ).native();}
...
#else
using ::zr_boost_1_81::process::detail::api::async_pipe;
#endif
