...
public:
    ...
    explicit sp_reference_wrapper( T & t): t_( zr_boost_1_81::addressof( t ) )
    {
    }
...
{
    zr_boost_1_81::uintptr_t v = reinterpret_cast<zr_boost_1_81::uintptr_t>( p );

    // match zr_boost_1_81::hash<T*>
...
public:
...
#endif
    {
        ...
        {
            zr_boost_1_81::checked_delete( p );
            throw;
        }
        ...
        {
            zr_boost_1_81::checked_delete( p );
            zr_boost_1_81::throw_exception( std::bad_alloc() );
        }
    ...
    template<class Y, class D>
    explicit shared_count( zr_boost_1_81::movelib::unique_ptr<Y, D> & r ): pi_( 0 )
#if defined(BOOST_SP_ENABLE_DEBUG_HOOKS)
        , id_(shared_count_id)
#endif
    {
        ...
        D2 d2( r.get_deleter() );
        pi_ = new sp_counted_impl_pd< typename zr_boost_1_81::movelib::unique_ptr<Y, D>::pointer, D2 >( r.get(), d2 );
...
#endif
{
    ...
    {
        zr_boost_1_81::throw_exception( zr_boost_1_81::bad_weak_ptr() );
    }
}
