...
public:
    ...
    {
#if defined(BOOST_SP_ENABLE_DEBUG_HOOKS)
        zr_boost_1_81::sp_scalar_constructor_hook( px, sizeof(X), this );
#endif
    }
    ...
    {
#if defined(BOOST_SP_ENABLE_DEBUG_HOOKS)
        zr_boost_1_81::sp_scalar_destructor_hook( px_, sizeof(X), this );
#endif
        zr_boost_1_81::checked_delete( px_ );
    }
...
public:
    ...
    {
        return ti == BOOST_SP_TYPEID_(D)? zr_boost_1_81::detail::get_local_deleter( zr_boost_1_81::addressof( del ) ): 0;
    }
...
public:
    ...
    void * get_local_deleter( sp_typeinfo_ const & ti ) BOOST_SP_NOEXCEPT BOOST_OVERRIDE
    {
        return ti == BOOST_SP_TYPEID_( D )? zr_boost_1_81::detail::get_local_deleter( zr_boost_1_81::addressof( d_ ) ): 0;
    }
