...
{
    typedef zr_boost_1_81::detail::atomic_count type;

    static unsigned int load(zr_boost_1_81::detail::atomic_count const& counter) BOOST_SP_NOEXCEPT
    {
        return static_cast< unsigned int >(static_cast< long >(counter));
    }

    static void increment(zr_boost_1_81::detail::atomic_count& counter) BOOST_SP_NOEXCEPT
    {
        ++counter;
    }

    static unsigned int decrement(zr_boost_1_81::detail::atomic_count& counter) BOOST_SP_NOEXCEPT
    {
