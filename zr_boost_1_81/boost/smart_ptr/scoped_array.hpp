...
#endif
        zr_boost_1_81::checked_array_delete( px );
    }
...
template<class T> inline bool operator==( scoped_array<T> const & p, zr_boost_1_81::detail::sp_nullptr_t ) BOOST_SP_NOEXCEPT
{
    return p.get() == 0;
}

template<class T> inline bool operator==( zr_boost_1_81::detail::sp_nullptr_t, scoped_array<T> const & p ) BOOST_SP_NOEXCEPT
{
    return p.get() == 0;
}
