...
public:
    ...
    intrusive_ptr( intrusive_ptr<U> const & rhs, typename zr_boost_1_81::detail::sp_enable_if_convertible<U,T>::type = zr_boost_1_81::detail::sp_empty() )
...
// Move support
    ...
    intrusive_ptr(intrusive_ptr<U> && rhs, typename zr_boost_1_81::detail::sp_enable_if_convertible<U,T>::type = zr_boost_1_81::detail::sp_empty())
...
template<class T> inline bool operator==( intrusive_ptr<T> const & p, zr_boost_1_81::detail::sp_nullptr_t ) BOOST_SP_NOEXCEPT
{
    return p.get() == 0;
}

template<class T> inline bool operator==( zr_boost_1_81::detail::sp_nullptr_t, intrusive_ptr<T> const & p ) BOOST_SP_NOEXCEPT
{
    return p.get() == 0;
}
...
template< class T > std::size_t hash_value( zr_boost_1_81::intrusive_ptr<T> const & p ) BOOST_SP_NOEXCEPT
{
    return zr_boost_1_81::hash< T* >()( p.get() );
}
...
template<class T> struct hash< ::zr_boost_1_81::intrusive_ptr<T> >
{
    std::size_t operator()( ::zr_boost_1_81::intrusive_ptr<T> const & p ) const BOOST_SP_NOEXCEPT
    {
