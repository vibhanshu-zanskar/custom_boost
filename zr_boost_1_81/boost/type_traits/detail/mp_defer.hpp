...
struct mp_valid_impl
{
    ...
    static zr_boost_1_81::true_type check_s(int);

    template<template<class...> class>
    static zr_boost_1_81::false_type check_s(...);
...
template<template<class...> class F, class... T> using mp_defer = typename zr_boost_1_81::conditional<mp_valid<F, T...>::value, mp_defer_impl<F, T...>, mp_empty>::type;
