...
template<class C1, class C2> struct common_member_class
{
    typedef typename zr_boost_1_81::conditional<
        ...
        zr_boost_1_81::is_base_of<C1, C2>::value,
        C2,
        typename zr_boost_1_81::conditional<zr_boost_1_81::is_base_of<C2, C1>::value, C1, void>::type
...
private:
    ...
    typedef typename zr_boost_1_81::remove_pointer<CPT>::type CT;
