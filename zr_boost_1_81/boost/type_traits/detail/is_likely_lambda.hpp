...
//
namespace zr_boost_1_81{ namespace type_traits_detail{
...
{
  template<typename Q> static zr_boost_1_81::true_type  test(decltype(&Q::operator())*);
  template<typename>   static zr_boost_1_81::false_type test(...);
...
struct is_likely_stateless_lambda<
  T,
  typename zr_boost_1_81::enable_if_<has_one_operator_call<T>::value>::type> :
     zr_boost_1_81::is_convertible<T, typename equivalent_function_pointer<T>::type
>{};
...
namespace zr_boost_1_81 {
   namespace type_traits_detail {
      ...
      template<typename T>
      struct is_likely_stateless_lambda : public zr_boost_1_81::integral_constant<bool, false> {};
}}
