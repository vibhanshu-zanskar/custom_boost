...
private:
    ...
    typedef typename zr_boost_1_81::remove_cv<T>::type T2;
    typedef typename zr_boost_1_81::remove_cv<U>::type U2;

public:

    BOOST_STATIC_CONSTANT( bool, value =
        (zr_boost_1_81::is_same<T2, U2>::value)
        || zr_boost_1_81::is_void<T2>::value
        || zr_boost_1_81::is_void<U2>::value
        || (zr_boost_1_81::is_base_of<T2, U2>::value)
        || (zr_boost_1_81::is_base_of<U2, T2>::value) );
};
...
public:
    ...
    typedef typename zr_boost_1_81::conditional<
        ...
        zr_boost_1_81::is_same<T2, U2>::value || zr_boost_1_81::is_void<T2>::value || zr_boost_1_81::is_base_of<T2, U2>::value,
        typename zr_boost_1_81::copy_cv<T, U>::type,
        typename zr_boost_1_81::copy_cv<U, T>::type
...
public:
    ...
    typedef typename zr_boost_1_81::copy_cv<typename zr_boost_1_81::copy_cv<typename composite_pointer_type<T2, U2>::type const, T>::type, U>::type type;
};

//Old compilers like MSVC-7.1 have problems using zr_boost_1_81::conditional in
