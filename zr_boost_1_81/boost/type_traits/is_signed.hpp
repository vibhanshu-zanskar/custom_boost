...
{
   typedef typename remove_cv<T>::type no_cv_t;
   BOOST_STATIC_CONSTANT(bool, value = (!(::zr_boost_1_81::detail::is_signed_values<T>::minus_one  > zr_boost_1_81::detail::is_signed_values<T>::zero)));
};
...
{
   typedef ::zr_boost_1_81::detail::is_signed_select_helper< ::zr_boost_1_81::is_integral<T>::value || ::zr_boost_1_81::is_enum<T>::value> selector;
...
template <class T> struct is_signed : public integral_constant<bool, zr_boost_1_81::detail::is_signed_impl<T>::value> {};
...
template <> struct is_signed< ::zr_boost_1_81::long_long_type> : public true_type{};
template <> struct is_signed<const ::zr_boost_1_81::long_long_type> : public true_type{};
template <> struct is_signed<volatile ::zr_boost_1_81::long_long_type> : public true_type{};
template <> struct is_signed<const volatile ::zr_boost_1_81::long_long_type> : public true_type{};

template <> struct is_signed< ::zr_boost_1_81::ulong_long_type> : public false_type{};
template <> struct is_signed<const ::zr_boost_1_81::ulong_long_type> : public false_type{};
template <> struct is_signed<volatile ::zr_boost_1_81::ulong_long_type> : public false_type{};
template <> struct is_signed<const volatile ::zr_boost_1_81::ulong_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN != 0
