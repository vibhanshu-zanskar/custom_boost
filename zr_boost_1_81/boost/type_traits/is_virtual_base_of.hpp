...
#pragma GCC system_header
      ...
      template<class T, class U,
         typename zr_boost_1_81::make_void<decltype((U*)(std::declval<T*>()))>::type* =
         nullptr>
   ...
   struct is_virtual_base_of : public
      ...
      bool,
      zr_boost_1_81::is_base_of<T, U>::value &&
   ...
   {
      typedef zr_boost_1_81::integral_constant<bool, (zr_boost_1_81::is_base_of<Base, Derived>::value && !zr_boost_1_81::is_same<Base, Derived>::value)> tag_type;
...
template <class Base, class Derived> struct is_virtual_base_of : public integral_constant<bool, (::zr_boost_1_81::detail::is_virtual_base_of_impl2<Base, Derived>::value)> {};
