...
//
//  is_noncopyable<T> returns whether T is derived from zr_boost_1_81::noncopyable
//
...
// zr_boost_1_81::noncopyable derives from noncopyable_::base_token to enable us
