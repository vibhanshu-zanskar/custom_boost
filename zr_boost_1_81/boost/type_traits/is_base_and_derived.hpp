...
{
    BOOST_STATIC_CONSTANT(bool, value =
        (::zr_boost_1_81::is_convertible<D*,B*>::value));
};
...
struct is_base_and_derived_impl
{
    ...
    typedef is_base_and_derived_select<
       ::zr_boost_1_81::is_class<B>::value,
       ::zr_boost_1_81::is_class<D>::value,
       ::zr_boost_1_81::is_same<ncvB,ncvD>::value> selector;
...
struct is_base_and_derived_impl
{
    ...
    BOOST_STATIC_CONSTANT(bool, value = (BOOST_IS_BASE_OF(B,D) && ! ::zr_boost_1_81::is_same<ncvB,ncvD>::value));
};
#endif
} // namespace detail

template <class Base, class Derived> struct is_base_and_derived
   : public integral_constant<bool, (::zr_boost_1_81::detail::is_base_and_derived_impl<Base, Derived>::value)> {};
