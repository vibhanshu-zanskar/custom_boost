...
namespace zr_boost_1_81 {
   ...
   namespace detail
   {
      ...
      template <class T>          struct has_nothrow_assign_imp<T, false, true>{ static const bool value = noexcept(zr_boost_1_81::declval<typename add_reference<T>::type>() = zr_boost_1_81::declval<typename add_reference<T const>::type>()); };
   ...
   struct has_nothrow_assign : public integral_constant < bool,
      ...
      >::value
#else
      ::zr_boost_1_81::has_trivial_assign<T>::value
#endif
#else
