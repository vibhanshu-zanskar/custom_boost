...
{
   BOOST_STATIC_CONSTANT(bool, value = (::zr_boost_1_81::detail::is_unsigned_values<T>::minus_one > ::zr_boost_1_81::detail::is_unsigned_values<T>::zero));
};
...
struct is_unsigned
{
   typedef ::zr_boost_1_81::detail::is_unsigned_select_helper< ::zr_boost_1_81::is_integral<T>::value || ::zr_boost_1_81::is_enum<T>::value > selector;
...
template <class T> struct is_unsigned : public integral_constant<bool, zr_boost_1_81::detail::is_unsigned<T>::value> {};
...
template <> struct is_unsigned< ::zr_boost_1_81::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const ::zr_boost_1_81::ulong_long_type> : public true_type{};
template <> struct is_unsigned<volatile ::zr_boost_1_81::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const volatile ::zr_boost_1_81::ulong_long_type> : public true_type{};

template <> struct is_unsigned< ::zr_boost_1_81::long_long_type> : public false_type{};
template <> struct is_unsigned<const ::zr_boost_1_81::long_long_type> : public false_type{};
template <> struct is_unsigned<volatile ::zr_boost_1_81::long_long_type> : public false_type{};
template <> struct is_unsigned<const volatile ::zr_boost_1_81::long_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN == 0
