...
{
   BOOST_STATIC_CONSTANT(std::size_t, value = (::zr_boost_1_81::detail::rank_imp<T, N+1>::value));
};
...
#else
template <class T> struct rank : public integral_constant<std::size_t, (::zr_boost_1_81::detail::rank_imp<T, 0>::value)>{};
#endif
