...
{
   BOOST_STATIC_CONSTANT(std::size_t, value = (::zr_boost_1_81::detail::extent_imp<T, N-1>::value));
};
...
struct extent
   : public ::zr_boost_1_81::integral_constant<std::size_t, ::zr_boost_1_81::detail::extent_imp<T,N>::value>
{
};
