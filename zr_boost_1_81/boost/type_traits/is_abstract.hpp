...
struct is_abstract_imp
{
   typedef is_abstract_select< ::zr_boost_1_81::is_class<T>::value> selector;
...
template <class T> struct is_abstract : public integral_constant<bool, ::zr_boost_1_81::detail::is_abstract_imp<T>::value> {};
#else
template <class T> struct is_abstract : public integral_constant<bool, ::zr_boost_1_81::detail::is_polymorphic_imp<T>::value> {};
#endif
