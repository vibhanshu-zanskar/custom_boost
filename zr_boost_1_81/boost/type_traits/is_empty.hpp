...
struct is_empty_impl
{
    ...
    BOOST_STATIC_CONSTANT(
        bool, 
        value = ( ::zr_boost_1_81::detail::empty_helper<cvt,::zr_boost_1_81::is_class<T>::value>::value || BOOST_INTERNAL_IS_EMPTY(cvt)));
};
...
struct is_empty_impl
{
   ...
   BOOST_STATIC_CONSTANT(
       bool, value = (
              ::zr_boost_1_81::detail::empty_helper<
                  cvt
                , ::zr_boost_1_81::is_class<T>::value
                , ::zr_boost_1_81::is_convertible< r_type,int>::value
...
template <class T> struct is_empty : integral_constant<bool, ::zr_boost_1_81::detail::is_empty_impl<T>::value> {};
