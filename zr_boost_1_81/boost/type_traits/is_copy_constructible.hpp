...
template <class T> struct is_copy_constructible : public zr_boost_1_81::is_constructible<T, const T&>{};
...
// zr_boost_1_81::non_copyable as a base class as a special case:
//
...
namespace zr_boost_1_81 {
   ...
   namespace detail
   {
      ...
      template <class T, bool b> struct is_copy_constructible_imp : public zr_boost_1_81::is_constructible<T, const T&>{};
...
namespace zr_boost_1_81 {
   ...
   namespace detail{
      ...
      struct is_copy_constructible_impl2 {
         ...
         template <class T1>
         static zr_boost_1_81::type_traits::yes_type test(const T1&, zr_boost_1_81::mpl::int_<sizeof(T1(zr_boost_1_81::declval<const T1&>()))>* = 0);
#else
         template <class T1>
         static zr_boost_1_81::type_traits::yes_type test(const T1&, decltype(T1(zr_boost_1_81::declval<const T1&>()))* = 0);
#endif

         static zr_boost_1_81::type_traits::no_type test(...);
#else
         template <class T1>
         static zr_boost_1_81::type_traits::no_type test(const T1&, typename T1::boost_move_no_copy_constructor_or_assign* = 0);
         static zr_boost_1_81::type_traits::yes_type test(...);
#endif
         ...
         //      struct T: private zr_boost_1_81::noncopyable {
         //          ...
         //      private:
         //          T(const T &);
         //          ...
         ...
         BOOST_STATIC_CONSTANT(bool, value = (
            sizeof(test(
            zr_boost_1_81::declval<BOOST_DEDUCED_TYPENAME zr_boost_1_81::add_reference<T const>::type>()
            )) == sizeof(zr_boost_1_81::type_traits::yes_type)
            &&
            !zr_boost_1_81::is_rvalue_reference<T>::value
      ...
      struct is_copy_constructible_impl {
         ...
         BOOST_STATIC_CONSTANT(bool, value = (
            zr_boost_1_81::detail::is_copy_constructible_impl2<
            zr_boost_1_81::is_noncopyable<T>::value,
            T
            >::value
            ));
      };
   ...
   template <class T> struct is_copy_constructible : public integral_constant<bool, ::zr_boost_1_81::detail::is_copy_constructible_impl<T>::value>{};
   template <> struct is_copy_constructible<void> : public false_type{};
