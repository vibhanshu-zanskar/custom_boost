...
{
   typedef is_polymorphic_selector< ::zr_boost_1_81::is_class<T>::value> selector;
...
template <class T> struct is_polymorphic : public integral_constant<bool, ::zr_boost_1_81::detail::is_polymorphic_imp<T>::value> {};
