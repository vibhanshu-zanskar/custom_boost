...
#define BOOST_TT_FORBIDDEN_IF\
   (\
      ...
      (\
         ...
         (! \
            ( \
               ::zr_boost_1_81::is_base_of< Lhs_noptr, Rhs_noptr >::value || \
               ::zr_boost_1_81::is_base_of< Rhs_noptr, Lhs_noptr >::value || \
               ::zr_boost_1_81::is_same< Lhs_noptr, Rhs_noptr >::value || \
      ...
      (\
         ::zr_boost_1_81::type_traits_detail::is_likely_stateless_lambda<Lhs_noref>::value\
      )\
      )
