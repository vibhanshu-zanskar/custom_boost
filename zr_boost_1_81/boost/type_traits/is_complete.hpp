...
#define BOOST_TT_HAS_WORKING_IS_COMPLETE
   ...
   template <class T> struct is_complete
      : public integral_constant<bool, ::zr_boost_1_81::is_function<typename zr_boost_1_81::remove_reference<T>::type>::value || (sizeof(zr_boost_1_81::detail::check_is_complete<T>(0)) != sizeof(char))> {};
   ...
   namespace detail
   {
      ...
      {
         template <class U, class = decltype(sizeof(zr_boost_1_81::declval< U >())) >
   ...
   template <class T>
   struct is_complete : zr_boost_1_81::integral_constant<bool, ::zr_boost_1_81::is_function<typename zr_boost_1_81::remove_reference<T>::type>::value || ::zr_boost_1_81::detail::is_complete_imp<T>::value>
   {};
   template <class T>
   struct is_complete<T&> : zr_boost_1_81::is_complete<T> {};
   
#else

      template <class T> struct is_complete
         : public zr_boost_1_81::integral_constant<bool, true> {};
