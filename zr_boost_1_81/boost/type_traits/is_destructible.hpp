...
namespace zr_boost_1_81{
   ...
   namespace detail{
      ...
      {
         template<typename T, typename = decltype(zr_boost_1_81::declval<T&>().~T())>
   ...
   template <class T> struct is_destructible : public integral_constant<bool, sizeof(zr_boost_1_81::detail::is_destructible_imp::test<T>(0)) == sizeof(zr_boost_1_81::type_traits::yes_type)>
   {
      BOOST_STATIC_ASSERT_MSG(zr_boost_1_81::is_complete<T>::value, "Arguments to is_destructible must be complete types");
   };
