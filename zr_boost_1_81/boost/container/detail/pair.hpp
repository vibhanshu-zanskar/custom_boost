...
template <
  ...
  class T9>
struct is_boost_tuple< zr_boost_1_81::tuples::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> >
{
...
struct disable_if_boost_tuple
   : zr_boost_1_81::container::dtl::disable_if< is_boost_tuple<Tuple> >
{};
...
template<>
struct is_tuple_null<zr_boost_1_81::tuples::null_type>
{
   static const bool value = true;
};
...
struct piecewise_construct_use
{
   ...
   {  (void)&::zr_boost_1_81::container::piecewise_construct;   }
};
...
#endif
{
   ...
   pair(BOOST_RV_REF(pair) p)
      : first(::zr_boost_1_81::move(BOOST_MOVE_TO_LV(p).first)), second(::zr_boost_1_81::move(BOOST_MOVE_TO_LV(p).second))
   {
      BOOST_STATIC_ASSERT((sizeof(std::pair<T1, T2>) == sizeof(pair<T1, T2>)));
   }
   ...
   pair(BOOST_FWD_REF(U) u, BOOST_FWD_REF(V) v)
      : first(::zr_boost_1_81::forward<U>(u))
      , second(::zr_boost_1_81::forward<V>(v))
   {
      BOOST_STATIC_ASSERT((sizeof(std::pair<T1, T2>) == sizeof(pair<T1, T2>)));
   }
   ...
   pair(try_emplace_t, BOOST_FWD_REF(KeyType) k, Args && ...args)
      : first(zr_boost_1_81::forward<KeyType>(k)), second(::zr_boost_1_81::forward<Args>(args)...)\
   {
      BOOST_STATIC_ASSERT((sizeof(std::pair<T1, T2>) == sizeof(pair<T1, T2>)));
   }
   #else

   //piecewise construction from zr_boost_1_81::tuple
   ...
   pair( try_emplace_t, BOOST_FWD_REF(KeyType) k BOOST_MOVE_I##N BOOST_MOVE_UREF##N )\
      : first(zr_boost_1_81::forward<KeyType>(k)), second(BOOST_MOVE_FWD##N)\
   {\
      BOOST_STATIC_ASSERT((sizeof(std::pair<T1, T2>) == sizeof(pair<T1, T2>)));\
   }\
   //
   ...
   pair( piecewise_construct_t\
       , BoostTuple<BOOST_MOVE_TARG##N  BOOST_MOVE_I##N BOOST_MOVE_REPEAT(BOOST_MOVE_SUB(10,N),::zr_boost_1_81::tuples::null_type)> p\
       , BoostTuple<BOOST_MOVE_TARGQ##M BOOST_MOVE_I##M BOOST_MOVE_REPEAT(BOOST_MOVE_SUB(10,M),::zr_boost_1_81::tuples::null_type)> q\
       , typename dtl::enable_if_c\
         < pair_impl::is_boost_tuple< BoostTuple<BOOST_MOVE_TARG##N  BOOST_MOVE_I##N BOOST_MOVE_REPEAT(BOOST_MOVE_SUB(10,N),::zr_boost_1_81::tuples::null_type)> >::value &&\
   ...
   #  if !defined(BOOST_CONTAINER_NO_CXX11_DELEGATING_CONSTRUCTORS)
      ...
      pair(Tuple<Args1...>& t1, Tuple<Args2...>& t2, index_tuple<Indexes1...>, index_tuple<Indexes2...>)
         : first (::zr_boost_1_81::forward<Args1>(get<Indexes1>(t1))...)
         , second(::zr_boost_1_81::forward<Args2>(get<Indexes2>(t2))...)
      {  (void) t1; (void)t2; }
   ...
   #  else
      ...
      {  return do_build_from_args<T>(::zr_boost_1_81::move(t), typename build_number_seq<sizeof...(Args)>::type());   }
      ...
      {  (void)t; return T(::zr_boost_1_81::forward<Args>(get<Indexes>(t))...);  }

      public:
      template< template<class ...> class Tuple, class... Args1, class... Args2
              , class = typename pair_impl::disable_if_boost_tuple< Tuple<Args1...> >::type>
      pair(piecewise_construct_t, Tuple<Args1...> t1, Tuple<Args2...> t2)
         : first  (build_from_args<first_type> (::zr_boost_1_81::move(t1)))
         , second (build_from_args<second_type>(::zr_boost_1_81::move(t2)))
      {
         BOOST_STATIC_ASSERT((sizeof(std::pair<T1, T2>) == sizeof(pair<T1, T2>)));
      }
   #  endif   //BOOST_NO_CXX11_VARIADIC_TEMPLATES
   ...
   {
      first  = ::zr_boost_1_81::move(BOOST_MOVE_TO_LV(p).first);
      second = ::zr_boost_1_81::move(BOOST_MOVE_TO_LV(p).second);
      return *this;
   }

   template <class D, class S>
   typename ::zr_boost_1_81::container::dtl::disable_if_or
      < pair &
      , ::zr_boost_1_81::container::dtl::is_same<T1, D>
      , ::zr_boost_1_81::container::dtl::is_same<T2, S>
      >::type
...
//std::pair copy assignment
   ...
   {
      first  = ::zr_boost_1_81::move(p.first);
      second = ::zr_boost_1_81::move(p.second);
      return *this;
   }
   ...
   void swap(pair& p)
   {
      ::zr_boost_1_81::adl_move_swap(this->first, p.first);
      ::zr_boost_1_81::adl_move_swap(this->second, p.second);
   }
};
...
template<class T1, class T2>
struct has_move_emulation_enabled< ::zr_boost_1_81::container::dtl::pair<T1, T2> >
{
   static const bool value = true;
};
...
template <class T1, class T2>
struct is_class_or_union< ::zr_boost_1_81::container::dtl::pair<T1, T2> >
...
template <class T1, class T2>
struct is_union< ::zr_boost_1_81::container::dtl::pair<T1, T2> >
//This specialization is needed to avoid instantiation of pair in
//is_class, and allow recursive maps.
{
   static const bool value = false;
...
template <class T1, class T2>
struct is_class< ::zr_boost_1_81::container::dtl::pair<T1, T2> >
//This specialization is needed to avoid instantiation of pair in
//is_class, and allow recursive maps.
{
   static const bool value = true;
...
struct is_trivially_copy_assignable
   <zr_boost_1_81::container::dtl::pair<A,B> >
{
   static const bool value = false ;
};
...
template<class A, class B>
struct is_trivially_copy_constructible<zr_boost_1_81::container::dtl::pair<A,B> >
{
   static const bool value = false;
};
...
template<class A, class B>
struct is_trivially_move_constructible<zr_boost_1_81::container::dtl::pair<A,B> >
{
   static const bool value = false;
};
...
template<class A, class B>
struct is_trivially_destructible<zr_boost_1_81::container::dtl::pair<A,B> >
{
   static const bool value = zr_boost_1_81::move_detail::is_trivially_destructible<A>::value &&
                             zr_boost_1_81::move_detail::is_trivially_destructible<B>::value ;
};
