...
#define BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_NS_BEG namespace zr_boost_1_81 { namespace container { namespace dtl {
   ...
   (SequenceContainer& dest, typename SequenceContainer::iterator it, Compare comp , dtl::true_)
{
   ...
   value_type *const braw = zr_boost_1_81::movelib::iterator_to_raw_pointer(dest.begin());
   value_type *const iraw = zr_boost_1_81::movelib::iterator_to_raw_pointer(it);
   value_type *const eraw = zr_boost_1_81::movelib::iterator_to_raw_pointer(dest.end());
   zr_boost_1_81::movelib::adaptive_merge
...
{
   zr_boost_1_81::movelib::adaptive_merge(dest.begin(), it, dest.end(), comp);
}
   ...
   (SequenceContainer& dest, typename SequenceContainer::iterator it, Compare comp, dtl::true_)
{
   ...
   value_type *const iraw = zr_boost_1_81::movelib::iterator_to_raw_pointer(it);
   value_type *const eraw = zr_boost_1_81::movelib::iterator_to_raw_pointer(dest.end());
   zr_boost_1_81::movelib::adaptive_sort
...
BOOST_CONTAINER_FORCEINLINE void flat_tree_container_inplace_sort_ending //is_contiguous_container == false
   (SequenceContainer& dest, typename SequenceContainer::iterator it, Compare comp , dtl::false_)
{
   zr_boost_1_81::movelib::adaptive_sort(it, dest.end(), comp);
}
   ...
   (SequenceContainer& dest, Iterator first, Iterator last, Compare comp, dtl::false_)
{
   ...
   iterator e = zr_boost_1_81::movelib::inplace_set_unique_difference(first_new, dest.end(), dest.begin(), first_new, comp);
   ...
   (SequenceContainer &tseq, BOOST_RV_REF(SequenceContainer) seq, Compare comp)
{
   if(tseq.capacity() >= (seq.capacity() - seq.size())) {
      tseq.clear();
      zr_boost_1_81::movelib::adaptive_sort
      (zr_boost_1_81::movelib::iterator_to_raw_pointer(seq.begin())
         , zr_boost_1_81::movelib::iterator_to_raw_pointer(seq.end())
         , comp
         , zr_boost_1_81::movelib::iterator_to_raw_pointer(tseq.begin())
         , tseq.capacity());
   }
   else{
      zr_boost_1_81::movelib::adaptive_sort
...
{
   flat_tree_sort_contiguous_to_adopt(tseq, zr_boost_1_81::move(seq), comp);
   tseq = zr_boost_1_81::move(seq);
}
...
{
   zr_boost_1_81::movelib::adaptive_sort(seq.begin(), seq.end(), comp);
   tseq = zr_boost_1_81::move(seq);
}
...
void flat_tree_adopt_sequence_unique// is_contiguous_container == true
   (SequenceContainer &tseq, BOOST_RV_REF(SequenceContainer) seq, Compare comp, dtl::true_)
{
   zr_boost_1_81::movelib::pdqsort
      ( zr_boost_1_81::movelib::iterator_to_raw_pointer(seq.begin())
      , zr_boost_1_81::movelib::iterator_to_raw_pointer(seq.end())
      , comp);
   seq.erase(zr_boost_1_81::movelib::unique
      (seq.begin(), seq.end(), zr_boost_1_81::movelib::negate<Compare>(comp)), seq.cend());
   tseq = zr_boost_1_81::move(seq);
}
...
void flat_tree_adopt_sequence_unique// is_contiguous_container == false
   (SequenceContainer &tseq, BOOST_RV_REF(SequenceContainer) seq, Compare comp, dtl::false_)
{
   zr_boost_1_81::movelib::pdqsort(seq.begin(), seq.end(), comp);
   seq.erase(zr_boost_1_81::movelib::unique
      (seq.begin(), seq.end(), zr_boost_1_81::movelib::negate<Compare>(comp)), seq.cend());
   tseq = zr_boost_1_81::move(seq);
}
...
template < class Value, class AllocatorOrContainer
         , bool = zr_boost_1_81::container::dtl::is_container<AllocatorOrContainer>::value
         >
...
{
   typedef zr_boost_1_81::container::vector<Value, typename real_allocator<Value, AllocatorOrContainer>::type> type;
};
...
class flat_tree
{
      ...
      : public value_compare
   {
      ...
      BOOST_CONTAINER_FORCEINLINE Data(BOOST_RV_REF(Data) d)
         : value_compare(zr_boost_1_81::move(static_cast<value_compare&>(d))), m_seq(zr_boost_1_81::move(d.m_seq))
      {}
      ...
      BOOST_CONTAINER_FORCEINLINE Data(BOOST_RV_REF(Data) d, const allocator_t &a)
         : value_compare(zr_boost_1_81::move(static_cast<value_compare&>(d))), m_seq(zr_boost_1_81::move(d.m_seq), a)
      {}
      ...
      {
         this->value_compare::operator=(zr_boost_1_81::move(static_cast<value_compare &>(d)));
         m_seq = zr_boost_1_81::move(d.m_seq);
         return *this;
      }
      ...
      void swap(Data &d)
      {
         ...
         zr_boost_1_81::adl_move_swap(mycomp, othercomp);
   ...
   typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_DEFAULT
      (zr_boost_1_81::container::dtl::, container_type
      ,stored_allocator_type, allocator_type)               stored_allocator_type;

   static const bool has_stored_allocator_type =
      BOOST_INTRUSIVE_HAS_TYPE(zr_boost_1_81::container::dtl::, container_type, stored_allocator_type);
   ...
   BOOST_CONTAINER_FORCEINLINE flat_tree(BOOST_RV_REF(flat_tree) x)
      ...
      :  m_data(zr_boost_1_81::move(x.m_data))
   { }
   ...
   BOOST_CONTAINER_FORCEINLINE flat_tree(BOOST_RV_REF(flat_tree) x, const allocator_type &a)
      :  m_data(zr_boost_1_81::move(x.m_data), a)
   { }
   ...
   {  m_data = zr_boost_1_81::move(x.m_data); return *this;  }
   ...
   std::pair<iterator,bool> insert_unique(BOOST_RV_REF(value_type) val)
   {
      ...
      insert_commit_data data;
      ret.second = this->priv_insert_unique_prepare(KeyOfValue()(val), data);
      ret.first = ret.second ? this->priv_insert_commit(data, zr_boost_1_81::move(val))
                             : this->begin() + (data.position - this->cbegin());
                             //: iterator(vector_iterator_get_ptr(data.position));
      return ret;
   }
   ...
   iterator insert_equal(BOOST_RV_REF(value_type) mval)
   {
      ...
      i = this->m_data.m_seq.insert(i, zr_boost_1_81::move(mval));
      return i;
   }
   ...
   iterator insert_unique(const_iterator hint, BOOST_RV_REF(value_type) val)
   {
      ...
      insert_commit_data data;
      return this->priv_insert_unique_prepare(hint, KeyOfValue()(val), data)
         ? this->priv_insert_commit(data, zr_boost_1_81::move(val))
         : this->begin() + (data.position - this->cbegin());
         //: iterator(vector_iterator_get_ptr(data.position));
   }
   ...
   iterator insert_equal(const_iterator hint, BOOST_RV_REF(value_type) mval)
   {
      ...
      return this->priv_insert_commit(data, zr_boost_1_81::move(mval));
   }
   ...
   void insert_unique(InIt first, InIt last)
   {
      ...
      //Step 2: sort them
      zr_boost_1_81::movelib::pdqsort(it, seq.end(), val_cmp);

      //Step 3: only left unique values from the back not already present in the original range
      typename container_type::iterator const e = zr_boost_1_81::movelib::inplace_set_unique_difference
   ...
   {
      const bool value = zr_boost_1_81::container::dtl::
   ...
   std::pair<iterator, bool> emplace_unique(BOOST_FWD_REF(Args)... args)
   {
      ...
      stored_allocator_traits::construct(a, move_detail::force_ptr<value_type *>(&v), ::zr_boost_1_81::forward<Args>(args)... );
      value_type *pval = move_detail::force_ptr<value_type *>(&v);
      value_destructor<stored_allocator_type, value_type> d(a, *pval);
      return this->insert_unique(::zr_boost_1_81::move(*pval));
   }
   ...
   iterator emplace_hint_unique(const_iterator hint, BOOST_FWD_REF(Args)... args)
   {
      ...
      value_type *pval = move_detail::force_ptr<value_type *>(&v);
      value_destructor<stored_allocator_type, value_type> d(a, *pval);
      return this->insert_unique(hint, ::zr_boost_1_81::move(*pval));
   }
   ...
   iterator emplace_equal(BOOST_FWD_REF(Args)... args)
   {
      ...
      value_type *pval = move_detail::force_ptr<value_type *>(&v);
      value_destructor<stored_allocator_type, value_type> d(a, *pval);
      return this->insert_equal(::zr_boost_1_81::move(*pval));
   }
   ...
   iterator emplace_hint_equal(const_iterator hint, BOOST_FWD_REF(Args)... args)
   {
      ...
      value_type *pval = move_detail::force_ptr<value_type *>(&v);
      value_destructor<stored_allocator_type, value_type> d(a, *pval);
      return this->insert_equal(hint, ::zr_boost_1_81::move(*pval));
   }
      ...
      (const_iterator hint, BOOST_FWD_REF(KeyType) key, BOOST_FWD_REF(Args)... args)
   {
      ...
      if(!ret.second){
         ...
         ret.first = this->m_data.m_seq.emplace(data.position, try_emplace_t(), ::zr_boost_1_81::forward<KeyType>(key), ::zr_boost_1_81::forward<Args>(args)...);
      }
      return ret;
   }
   ...
   {\
      ...
      if(!ret.second){\
         ...
         ret.first = this->m_data.m_seq.emplace(data.position, try_emplace_t(), ::zr_boost_1_81::forward<KeyType>(key) BOOST_MOVE_I##N BOOST_MOVE_FWD##N);\
      }\
      return ret;\
   }\
   //
   ...
   std::pair<iterator, bool> insert_or_assign(const_iterator hint, BOOST_FWD_REF(KeyType) key, BOOST_FWD_REF(M) obj)
   {
      ...
      if(!ret.second){
         ret.first  = this->nth(size_type(data.position - this->cbegin()));
         ret.first->second = zr_boost_1_81::forward<M>(obj);
      }
      else{
         ret.first = this->m_data.m_seq.emplace(data.position, zr_boost_1_81::forward<KeyType>(key), zr_boost_1_81::forward<M>(obj));
      }
      return ret;
   }
   ...
   {
      this->insert_unique( zr_boost_1_81::make_move_iterator(source.begin())
                         , zr_boost_1_81::make_move_iterator(source.end()));
   }

   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge_equal(flat_tree<Value, KeyOfValue, C2, AllocatorOrContainer>& source)
   {
      this->insert_equal( zr_boost_1_81::make_move_iterator(source.begin())
                        , zr_boost_1_81::make_move_iterator(source.end()));
   }
   ...
   BOOST_CONTAINER_FORCEINLINE void merge_unique(flat_tree& source)
   {
      ...
      (flat_tree_merge_unique)
         ( this->m_data.m_seq
         , zr_boost_1_81::make_move_iterator(source.m_data.m_seq.begin())
         , zr_boost_1_81::make_move_iterator(source.m_data.m_seq.end())
   ...
   {  return zr_boost_1_81::move(m_data.m_seq);   }
   ...
   {
      (flat_tree_adopt_sequence_equal)( m_data.m_seq, zr_boost_1_81::move(seq), this->priv_value_comp()
   ...
   {
      (flat_tree_adopt_sequence_unique)(m_data.m_seq, zr_boost_1_81::move(seq), this->priv_value_comp()
         , dtl::bool_<is_contiguous_container<container_type>::value>());
   }
   ...
   void adopt_sequence_equal(ordered_range_t, BOOST_RV_REF(container_type) seq)
   {
      ...
      m_data.m_seq = zr_boost_1_81::move(seq);
   }
      ...
      (insert_commit_data &commit_data, BOOST_FWD_REF(Convertible) convertible)
   {
      return this->m_data.m_seq.insert
         ...
         , zr_boost_1_81::forward<Convertible>(convertible));
   }
...
class Compare, class AllocatorOrContainer>
struct has_trivial_destructor_after_move<zr_boost_1_81::container::dtl::flat_tree<T, KeyOfValue, Compare, AllocatorOrContainer> >
{
   typedef zr_boost_1_81::container::dtl::flat_tree<T, KeyOfValue, Compare, AllocatorOrContainer> flat_tree;
   typedef typename flat_tree::container_type container_type;
   typedef typename flat_tree::key_compare key_compare;
   static const bool value = ::zr_boost_1_81::has_trivial_destructor_after_move<container_type>::value &&
                             ::zr_boost_1_81::has_trivial_destructor_after_move<key_compare>::value;
};
