...
template<class Allocator, unsigned Version = zr_boost_1_81::container::dtl::version<Allocator>::value>
struct allocator_version_traits
{
   ...
   typedef typename zr_boost_1_81::container::allocator_traits<Allocator>::size_type  size_type;
...
struct allocator_version_traits<Allocator, 1>
{
   ...
   static void deallocate_individual(Allocator &a, multiallocation_chain &holder)
   {
      ...
      while(n){
         --n;
         pointer p = zr_boost_1_81::intrusive::pointer_traits<pointer>::pointer_to(*it);
         ++it;
         a.deallocate(p, 1);
      }
   }
