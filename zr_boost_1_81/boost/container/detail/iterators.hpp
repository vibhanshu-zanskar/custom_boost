...
class constant_iterator
  : public ::zr_boost_1_81::container::iterator
      ...
      <std::random_access_iterator_tag, T, std::ptrdiff_t, const T*, const T &>
{
   ...
   //constructed until ::zr_boost_1_81::container::construct_in_place is called.
...
struct emplace_functor
{
   ...
   BOOST_CONTAINER_FORCEINLINE void inplace_impl(Allocator &a, T* ptr, const dtl::index_tuple<IdxPack...>&)
   {
      allocator_traits<Allocator>::construct
         (a, ptr, ::zr_boost_1_81::forward<Args>(dtl::get<IdxPack>(args_))...);
   }
   ...
   {
      typedef typename zr_boost_1_81::container::iterator_traits<DestIt>::value_type value_type;
      value_type && tmp= value_type(::zr_boost_1_81::forward<Args>(dtl::get<IdxPack>(args_))...);
      *dest = ::zr_boost_1_81::move(tmp);
   }
...
{\
   ...
   {\
      ...
      *dest = ::zr_boost_1_81::move(const_cast<value_type &>(BOOST_MOVE_IF(N, tmp, tmp.get())));\
   }\
   \
   BOOST_MOVE_MREF##N\
};\
...
struct iiterator_types
{
   ...
   typedef typename zr_boost_1_81::container::iterator_traits<IIterator>::pointer         it_pointer;
   typedef typename zr_boost_1_81::container::iterator_traits<IIterator>::difference_type difference_type;
   typedef typename ::zr_boost_1_81::intrusive::pointer_traits<it_pointer>::
...
{
   typedef typename ::zr_boost_1_81::container::iterator
...
class iterator_from_iiterator
{
   ...
   {  return ::zr_boost_1_81::intrusive::pointer_traits<pointer>::pointer_to(this->operator*());  }
...
using ::zr_boost_1_81::intrusive::reverse_iterator;
