...
using zr_boost_1_81::intrusive::algo_equal;
using zr_boost_1_81::intrusive::algo_lexicographical_compare;
...
{	return zr_boost_1_81::container::binder1st<Func>(func, arg);  }
...
{
   return (zr_boost_1_81::container::binder2nd<Func>(func, arg));
}
...
{
   return zr_boost_1_81::container::unary_negate<Func>(func);
}
