...
#define BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_NS_BEG namespace zr_boost_1_81 { namespace container { namespace is_container_detail {
...
struct is_container
{
   static const bool value =
      zr_boost_1_81::container::is_container_detail::
