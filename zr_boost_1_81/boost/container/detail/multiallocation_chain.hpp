...
class basic_multiallocation_chain
{
   ...
   typedef bi::slist< node
                    , bi::linear<true>
                    , bi::cache_last<true>
                    , bi::size_type<typename zr_boost_1_81::container::dtl::make_unsigned<difference_type>::type>
                    > slist_impl_t;
   ...
   {  return *static_cast<node*>(static_cast<void*>(zr_boost_1_81::movelib::to_raw_pointer(p)));  }
   ...
   typedef zr_boost_1_81::intrusive::twin<void_pointer> pointer_pair;
   ...
   basic_multiallocation_chain(BOOST_RV_REF(basic_multiallocation_chain) other)
      :  slist_impl_(::zr_boost_1_81::move(other.slist_impl_))
   {}
   ...
   {
      typedef typename zr_boost_1_81::intrusive::pointer_traits<char_ptr> char_pointer_traits;
      ...
      if(num_units){
         ...
         for(size_type i = 0; i != num_units-1u; ++i, elem += difference_type(unit_bytes)){
            ::new (zr_boost_1_81::movelib::to_raw_pointer(prev_elem), boost_container_new_t()) void_pointer(elem);
            prev_elem = elem;
         }
   ...
   : public MultiallocationChain
{
   ...
   typedef zr_boost_1_81::intrusive::twin<pointer>               pointer_pair;
   ...
   transform_multiallocation_chain(BOOST_RV_REF(transform_multiallocation_chain) other)
      : MultiallocationChain(::zr_boost_1_81::move(static_cast<MultiallocationChain&>(other)))
   {}
   ...
   transform_multiallocation_chain& operator=(BOOST_RV_REF(transform_multiallocation_chain) other)
   {
      return static_cast<MultiallocationChain&>
         (this->MultiallocationChain::operator=(::zr_boost_1_81::move(static_cast<MultiallocationChain&>(other))));
   }
