...
template<class T1, class T2>
struct hash_key_of_value<zr_boost_1_81::container::dtl::pair<T1, T2>, int>
{
   typedef dtl::select1st<T1> type;
};
   ...
   , public hash_table_types<KeyOfValue, KeyHash, KeyEqual, Allocator, Options>::AllocHolder
{
   ...
   BOOST_CONTAINER_FORCEINLINE hash_table(BOOST_RV_REF(hash_table) x)
      BOOST_NOEXCEPT_IF(zr_boost_1_81::container::dtl::is_nothrow_move_constructible<KeyEqual>::value &&
                        zr_boost_1_81::container::dtl::is_nothrow_move_constructible<KeyHash>::value)
   ...
   hash_table& operator=(BOOST_COPY_ASSIGN_REF(hash_table) x)
   {
      if (&x != this){
         ...
         //automatically
         Icont other_hash_table(::zr_boost_1_81::move(this->m_icont));
   ...
   hash_table& operator=(BOOST_RV_REF(hash_table) x)
      BOOST_NOEXCEPT_IF( (allocator_traits_type::propagate_on_container_move_assignment::value ||
                          allocator_traits_type::is_always_equal::value) &&
                           zr_boost_1_81::container::dtl::is_nothrow_move_assignable<KeyEqual>::value &&
                           zr_boost_1_81::container::dtl::is_nothrow_move_assignable<KeyHash>::value)
   {
      BOOST_ASSERT(this != &x);
      ...
      if(propagate_alloc || allocators_equal){
         ...
         //Obtain resources
         this->m_icont = zr_boost_1_81::move(x.icont());
      }
   ...
   BOOST_CONTAINER_FORCEINLINE void swap(ThisType& x)
      BOOST_NOEXCEPT_IF(  allocator_traits_type::is_always_equal::value
                                 && zr_boost_1_81::container::dtl::is_nothrow_swappable<KeyEqual>::value 
                                 && zr_boost_1_81::container::dtl::is_nothrow_swappable<KeyHash>::value )
   {  AllocHolder::swap(x);   }
   ...
   {  return this->emplace_unique_impl(AllocHolder::create_node(zr_boost_1_81::forward<Args>(args)...));   }

   template <class... Args>
   BOOST_CONTAINER_FORCEINLINE iterator emplace_hint_unique(const_iterator hint, BOOST_FWD_REF(Args)... args)
   {  return this->emplace_unique_hint_impl(hint, AllocHolder::create_node(zr_boost_1_81::forward<Args>(args)...));   }
...
*/
   ...
   {  return zr_boost_1_81::hash_range(x.cbegin(), x.end());   }
...
struct has_trivial_destructor_after_move
   < 
      ::zr_boost_1_81::container::dtl::hash_table
         <T, KeyOfValue, KeyHash, KeyEqual, Allocator, Options>
   >
{
   typedef typename ::zr_boost_1_81::container::allocator_traits<Allocator>::pointer pointer;
   static const bool value = ::zr_boost_1_81::has_trivial_destructor_after_move<Allocator>::value &&
                             ::zr_boost_1_81::has_trivial_destructor_after_move<pointer>::value &&
                             ::zr_boost_1_81::has_trivial_destructor_after_move<KeyHash>::value &&
                             ::zr_boost_1_81::has_trivial_destructor_after_move<KeyEqual>::value;
};
