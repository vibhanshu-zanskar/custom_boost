...
using zr_boost_1_81::intrusive::tree_value_compare;

template<class VoidPointer, zr_boost_1_81::container::tree_type_enum tree_type_value, bool OptimizeSize>
struct intrusive_tree_hook;

template<class VoidPointer, bool OptimizeSize>
struct intrusive_tree_hook<VoidPointer, zr_boost_1_81::container::red_black_tree, OptimizeSize>
{
...
template<class VoidPointer, bool OptimizeSize>
struct intrusive_tree_hook<VoidPointer, zr_boost_1_81::container::avl_tree, OptimizeSize>
{
...
template<class VoidPointer, bool OptimizeSize>
struct intrusive_tree_hook<VoidPointer, zr_boost_1_81::container::scapegoat_tree, OptimizeSize>
{
...
template<class VoidPointer, bool OptimizeSize>
struct intrusive_tree_hook<VoidPointer, zr_boost_1_81::container::splay_tree, OptimizeSize>
{
   typedef typename dtl::bi::make_bs_set_base_hook
      < dtl::bi::void_pointer<VoidPointer>
      , dtl::bi::link_mode<dtl::bi::normal_link>
...
{
   typedef pair<typename zr_boost_1_81::move_detail::remove_const<T1>::type, T2> type;
};

template <class T, class VoidPointer, zr_boost_1_81::container::tree_type_enum tree_type_value, bool OptimizeSize>
...
template< class NodeType
        ...
        , class KeyCompare
        , class HookType
        , zr_boost_1_81::container::tree_type_enum tree_type_value>
struct intrusive_tree_dispatch;

template<class NodeType, class KeyOfNode, class KeyCompare, class HookType>
struct intrusive_tree_dispatch
   <NodeType, KeyOfNode, KeyCompare, HookType, zr_boost_1_81::container::red_black_tree>
{
...
template<class NodeType, class KeyOfNode, class KeyCompare, class HookType>
struct intrusive_tree_dispatch
   <NodeType, KeyOfNode, KeyCompare, HookType, zr_boost_1_81::container::avl_tree>
{
...
template<class NodeType, class KeyOfNode, class KeyCompare, class HookType>
struct intrusive_tree_dispatch
   <NodeType, KeyOfNode, KeyCompare, HookType, zr_boost_1_81::container::scapegoat_tree>
{
...
template<class NodeType, class KeyOfNode, class KeyCompare, class HookType>
struct intrusive_tree_dispatch
   <NodeType, KeyOfNode, KeyCompare, HookType, zr_boost_1_81::container::splay_tree>
{
...
template<zr_boost_1_81::container::tree_type_enum tree_type_value>
...
class RecyclingCloner
{
      ...
      (typename dtl::if_c<DoMove, node_t &, const node_t&>::type other) const
   {
      if(node_ptr_type p = m_icont.unlink_leftmost_without_rebalance()){
         ...
         return m_holder.create_node(zr_boost_1_81::move(other.get_real_data()));
      }
   }
...
template<class T1, class T2>
struct tree_key_of_value<zr_boost_1_81::container::dtl::pair<T1, T2>, int>
{
   typedef dtl::select1st<T1> type;
};
      ...
      >
{
   ...
   typedef zr_boost_1_81::container::reverse_iterator
         ...
         )
   {
      ...
      this->allocate_many_and_construct
         ( first, zr_boost_1_81::container::iterator_udistance(first, last)
      ...
      :  AllocHolder(x.value_comp(), a)
   {
      if(this->node_alloc() == x.node_alloc()){
         ...
         this->icont().clone_from
            (zr_boost_1_81::move(x.icont()), typename AllocHolder::move_cloner(*this), Destroyer(this->node_alloc()));
      }
      //AllocHolder clears in case of exception
   }
   ...
   tree& operator=(BOOST_COPY_ASSIGN_REF(tree) x)
   {
      if (BOOST_LIKELY(this != &x)) {
         ...
         //automatically
         Icont other_tree(::zr_boost_1_81::move(this->icont()));
                           ...
                           zr_boost_1_81::container::dtl::is_nothrow_move_assignable<Compare>::value)
   {
      if (BOOST_LIKELY(this != &x)) {
         ...
         if(propagate_alloc || allocators_equal){
            ...
            //Obtain resources
            this->icont() = zr_boost_1_81::move(x.icont());
         }
   ...
   {
      NodePtr tmp = AllocHolder::create_node(zr_boost_1_81::forward<MovableConvertible>(v));
   ...
   std::pair<iterator,bool> insert_unique_convertible(BOOST_FWD_REF(MovableConvertible) v)
   {
      ...
      if(ret.second){
         ret.first = this->insert_unique_commit(zr_boost_1_81::forward<MovableConvertible>(v), data);
      }
      return ret;
   }
   ...
   iterator insert_unique_hint_convertible(const_iterator hint, BOOST_FWD_REF(MovableConvertible) v)
   {
      ...
      if(!ret.second)
         return ret.first;
      return this->insert_unique_commit(zr_boost_1_81::forward<MovableConvertible>(v), data);
   }
   ...
   {
      NodePtr tmp = AllocHolder::create_node(zr_boost_1_81::forward<KeyConvertible>(key), zr_boost_1_81::forward<M>(obj));
      scoped_node_destroy_deallocator<NodeAlloc> destroy_deallocator(tmp, this->node_alloc());
   ...
   {  return this->emplace_unique_node(AllocHolder::create_node(zr_boost_1_81::forward<Args>(args)...));   }

   template <class... Args>
   BOOST_CONTAINER_FORCEINLINE iterator emplace_hint_unique(const_iterator hint, BOOST_FWD_REF(Args)... args)
   {  return this->emplace_hint_unique_node(hint, AllocHolder::create_node(zr_boost_1_81::forward<Args>(args)...));   }

   template <class... Args>
   iterator emplace_equal(BOOST_FWD_REF(Args)... args)
   {
      NodePtr tmp(AllocHolder::create_node(zr_boost_1_81::forward<Args>(args)...));
      scoped_node_destroy_deallocator<NodeAlloc> destroy_deallocator(tmp, this->node_alloc());
      ...
      (const_iterator hint, BOOST_FWD_REF(KeyType) key, BOOST_FWD_REF(Args)... args)
   {
      ...
      if(ret.second){
         ret.first = this->icont().insert_unique_commit
            (*AllocHolder::create_node(try_emplace_t(), zr_boost_1_81::forward<KeyType>(key), zr_boost_1_81::forward<Args>(args)...), data);
      }
      return std::pair<iterator, bool>(iterator(ret.first), ret.second);
   }
   ...
   {\
      ...
      if(ret.second){\
         ret.first = this->icont().insert_unique_commit\
            (*AllocHolder::create_node(try_emplace_t(), zr_boost_1_81::forward<KeyType>(key) BOOST_MOVE_I##N BOOST_MOVE_FWD##N), data);\
      }\
      return std::pair<iterator, bool>(iterator(ret.first), ret.second);\
   }\
   //
   ...
   std::pair<iterator, bool> insert_or_assign(const_iterator hint, BOOST_FWD_REF(KeyType) key, BOOST_FWD_REF(M) obj)
   {
      ...
      std::pair<iiterator, bool> ret =
         hint == const_iterator() ? this->icont().insert_unique_check(k, data)
                                  : this->icont().insert_unique_check(hint.get(), k, data);
      if(ret.second){
         ret.first = this->priv_insert_or_assign_commit(zr_boost_1_81::forward<KeyType>(key), zr_boost_1_81::forward<M>(obj), data);
      }
      else{
         ret.first->get_data().second = zr_boost_1_81::forward<M>(obj);
      }
      return std::pair<iterator, bool>(iterator(ret.first), ret.second);
   }
   ...
   {
      return this->insert_unique_node(this->end(), zr_boost_1_81::move(nh));
   }
   ...
   insert_return_type insert_unique_node(const_iterator hint, BOOST_RV_REF_BEG_IF_CXX11 node_type BOOST_RV_REF_END_IF_CXX11 nh)
   {
      ...
      if(!nh.empty()){
         ...
         if(ret.second){
            ...
            irt.node = zr_boost_1_81::move(nh);
         }
      }
      else{
...
struct has_trivial_destructor_after_move
   < 
      ::zr_boost_1_81::container::dtl::tree
         <T, KeyOfValue, Compare, Allocator, Options>
   >
{
   typedef typename ::zr_boost_1_81::container::dtl::tree<T, KeyOfValue, Compare, Allocator, Options>::allocator_type allocator_type;
   ...
   static const bool value = ::zr_boost_1_81::has_trivial_destructor_after_move<allocator_type>::value &&
                             ...
                             ::zr_boost_1_81::has_trivial_destructor_after_move<Compare>::value;
};
