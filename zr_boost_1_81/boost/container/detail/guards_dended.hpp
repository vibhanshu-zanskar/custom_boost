...
public:
  ...
  ~construction_guard()
  {
    while (_elem_count) {
      --_elem_count;
      zr_boost_1_81::container::allocator_traits<Allocator>::destroy(*_allocator, _alloc_ptr++);
    }
  }
...
public:
  ...
  ~allocation_guard()
  {
    if (_alloc_ptr)
    {
      zr_boost_1_81::container::allocator_traits<Allocator>::deallocate(_allocator, _alloc_ptr, _alloc_size);
    }
  }
...
}}} // namespace zr_boost_1_81::container::detail
