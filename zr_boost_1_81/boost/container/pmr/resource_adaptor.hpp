...
template<class T>
struct max_allocator_alignment< ::zr_boost_1_81::container::new_allocator<T> >
{
   static const std::size_t value = zr_boost_1_81::move_detail::alignment_of<zr_boost_1_81::move_detail::max_align_t>::value;
};
...
class resource_adaptor_imp
   ...
   , private ::zr_boost_1_81::intrusive::detail::ebo_functor_holder<Allocator>
   #endif
{
   ...
   typedef ::zr_boost_1_81::intrusive::detail::ebo_functor_holder<Allocator> ebo_alloc_t;
   void static_assert_if_not_char_allocator() const
   {
      //This class can only be used with allocators type char
      BOOST_STATIC_ASSERT((zr_boost_1_81::container::dtl::is_same<typename Allocator::value_type, char>::value));
   }
   #endif
   ...
   resource_adaptor_imp(BOOST_RV_REF(resource_adaptor_imp) other)
      : ebo_alloc_t(::zr_boost_1_81::move(other.get()))
   {}
   ...
   explicit resource_adaptor_imp(BOOST_RV_REF(Allocator) a2)
      : ebo_alloc_t(::zr_boost_1_81::move(a2))
   {  this->static_assert_if_not_char_allocator(); }
   ...
   {  this->ebo_alloc_t::get() = ::zr_boost_1_81::move(other.ebo_alloc_t::get()); return *this;  }
