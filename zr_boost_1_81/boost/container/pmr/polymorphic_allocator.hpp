...
class polymorphic_allocator
{
   ...
   polymorphic_allocator() BOOST_NOEXCEPT
      : m_resource(::zr_boost_1_81::container::pmr::get_default_resource())
   {}
   ...
   T* allocate(size_t n)
   {  return static_cast<T*>(m_resource->allocate(n*sizeof(T), ::zr_boost_1_81::move_detail::alignment_of<T>::value));  }
   ...
   {  m_resource->deallocate(p, n*sizeof(T), ::zr_boost_1_81::move_detail::alignment_of<T>::value);  }
   ...
   void construct(U* p, BOOST_FWD_REF(Args)...args)
   {
      ...
      dtl::dispatch_uses_allocator
         (na, *this, p, ::zr_boost_1_81::forward<Args>(args)...);
   }
