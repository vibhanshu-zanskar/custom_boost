...
class flat_map
{
   ...
   BOOST_CONTAINER_FORCEINLINE flat_map(BOOST_RV_REF(flat_map) x)
      ...
      : m_flat_tree(zr_boost_1_81::move(x.m_flat_tree))
   {}
   ...
   BOOST_CONTAINER_FORCEINLINE flat_map(BOOST_RV_REF(flat_map) x, const allocator_type &a)
      : m_flat_tree(zr_boost_1_81::move(x.m_flat_tree), dtl::force<const impl_allocator_type>(a))
   {}
   ...
   {  m_flat_tree = zr_boost_1_81::move(x.m_flat_tree);   return *this;  }
   ...
   BOOST_CONTAINER_FORCEINLINE std::pair<iterator, bool> insert_or_assign(const key_type& k, BOOST_FWD_REF(M) obj)
   {
      return dtl::force_copy< std::pair<iterator, bool> >
         (this->m_flat_tree.insert_or_assign
            ( impl_const_iterator(), k, ::zr_boost_1_81::forward<M>(obj))
         );
   }
   ...
   BOOST_CONTAINER_FORCEINLINE std::pair<iterator, bool> insert_or_assign(BOOST_RV_REF(key_type) k, BOOST_FWD_REF(M) obj)
   {
      return dtl::force_copy< std::pair<iterator, bool> >
         (this->m_flat_tree.insert_or_assign
            ( impl_const_iterator(), ::zr_boost_1_81::move(k), ::zr_boost_1_81::forward<M>(obj))
         );
   }
   ...
   BOOST_CONTAINER_FORCEINLINE iterator insert_or_assign(const_iterator hint, const key_type& k, BOOST_FWD_REF(M) obj)
   {
      return dtl::force_copy<iterator>
         (this->m_flat_tree.insert_or_assign
            ...
            , k, ::zr_boost_1_81::forward<M>(obj)).first
         );
   }
   ...
   BOOST_CONTAINER_FORCEINLINE iterator insert_or_assign(const_iterator hint, BOOST_RV_REF(key_type) k, BOOST_FWD_REF(M) obj)
   {
      return dtl::force_copy<iterator>
         (this->m_flat_tree.insert_or_assign
            ( dtl::force_copy<impl_const_iterator>(hint)
            , ::zr_boost_1_81::move(k), ::zr_boost_1_81::forward<M>(obj)).first
         );
   }
   ...
   {  return dtl::force_copy< std::pair<iterator, bool> >(m_flat_tree.emplace_unique(zr_boost_1_81::forward<Args>(args)...)); }
   ...
   {
      return dtl::force_copy< std::pair<iterator, bool> >(
         m_flat_tree.try_emplace(impl_const_iterator(), k, zr_boost_1_81::forward<Args>(args)...));
   }
   ...
   BOOST_CONTAINER_FORCEINLINE iterator try_emplace(const_iterator hint, const key_type &k, BOOST_FWD_REF(Args)... args)
   {
      return dtl::force_copy<iterator>(m_flat_tree.try_emplace
         (dtl::force_copy<impl_const_iterator>(hint), k, zr_boost_1_81::forward<Args>(args)...).first);
   }
   ...
   {
      return dtl::force_copy< std::pair<iterator, bool> >
         (m_flat_tree.try_emplace(impl_const_iterator(), zr_boost_1_81::move(k), zr_boost_1_81::forward<Args>(args)...));
   }
   ...
   BOOST_CONTAINER_FORCEINLINE iterator try_emplace(const_iterator hint, BOOST_RV_REF(key_type) k, BOOST_FWD_REF(Args)... args)
   {
      return dtl::force_copy<iterator>
         (m_flat_tree.try_emplace(dtl::force_copy
            <impl_const_iterator>(hint), zr_boost_1_81::move(k), zr_boost_1_81::forward<Args>(args)...).first);
   }
   ...
   {\
      return dtl::force_copy< std::pair<iterator, bool> >\
         (m_flat_tree.try_emplace(impl_const_iterator(), zr_boost_1_81::move(k) BOOST_MOVE_I##N BOOST_MOVE_FWD##N));\
   }\
   \
   BOOST_MOVE_TMPL_LT##N BOOST_MOVE_CLASS##N BOOST_MOVE_GT##N \
   ...
   {  return dtl::force_copy<iterator>(m_flat_tree.try_emplace\
      (dtl::force_copy<impl_const_iterator>(hint), zr_boost_1_81::move(k) BOOST_MOVE_I##N BOOST_MOVE_FWD##N).first); }\
   //
   ...
   {
      return dtl::force_copy<std::pair<iterator,bool> >(
         m_flat_tree.insert_unique(zr_boost_1_81::move(dtl::force<impl_value_type>(x))));
   }
   ...
   {
      return dtl::force_copy<std::pair<iterator,bool> >
         (m_flat_tree.emplace_unique(zr_boost_1_81::forward<Pair>(x)));
   }
   ...
   BOOST_CONTAINER_FORCEINLINE iterator insert(const_iterator p, BOOST_RV_REF(value_type) x)
   {
      return dtl::force_copy<iterator>
         (m_flat_tree.insert_unique( dtl::force_copy<impl_const_iterator>(p)
                                   , zr_boost_1_81::move(dtl::force<impl_value_type>(x))));
   }
   ...
   {
      return dtl::force_copy<iterator>(
         m_flat_tree.emplace_hint_unique(dtl::force_copy<impl_const_iterator>(p), zr_boost_1_81::forward<Pair>(x)));
   }
   ...
   {
      return zr_boost_1_81::move(dtl::force<sequence_type>(m_flat_tree.get_sequence_ref()));
   }
   ...
   {  this->m_flat_tree.adopt_sequence_unique(zr_boost_1_81::move(dtl::force<impl_sequence_type>(seq)));  }
   ...
   {  this->m_flat_tree.adopt_sequence_unique(ordered_unique_range_t(), zr_boost_1_81::move(dtl::force<impl_sequence_type>(seq)));  }
   ...
   mapped_type &priv_subscript(const key_type& k)
   {
      ...
      if (i == end() || key_comp()(k, (*i).first)){
         ...
         impl_value_type v(k, ::zr_boost_1_81::move(m.m_t));
         i = this->insert(i, ::zr_boost_1_81::move(v));
      }
      return (*i).second;
   }
   mapped_type &priv_subscript(BOOST_RV_REF(key_type) mk)
   {
      ...
      if (i == end() || key_comp()(k, (*i).first)){
         dtl::value_init<mapped_type> m;
         impl_value_type v(::zr_boost_1_81::move(k), ::zr_boost_1_81::move(m.m_t));
         i = this->insert(i, ::zr_boost_1_81::move(v));
      }
      return (*i).second;
   }
...
template <class Key, class T, class Compare, class AllocatorOrContainer>
struct has_trivial_destructor_after_move<zr_boost_1_81::container::flat_map<Key, T, Compare, AllocatorOrContainer> >
{
   typedef ::zr_boost_1_81::container::dtl::pair<Key, T> value_t;
   typedef typename ::zr_boost_1_81::container::dtl::container_or_allocator_rebind<AllocatorOrContainer, value_t>::type alloc_or_cont_t;
   typedef ::zr_boost_1_81::container::dtl::flat_tree<value_t,::zr_boost_1_81::container::dtl::select1st<Key>, Compare, alloc_or_cont_t> tree;
...
class flat_multimap
{
   ...
   {  return dtl::force_copy<iterator>(m_flat_tree.emplace_equal(zr_boost_1_81::forward<Args>(args)...)); }
   ...
   iterator emplace_hint(const_iterator hint, BOOST_FWD_REF(Args)... args)
   {
      return dtl::force_copy<iterator>(m_flat_tree.emplace_hint_equal
         (dtl::force_copy<impl_const_iterator>(hint), zr_boost_1_81::forward<Args>(args)...));
   }
   ...
   BOOST_CONTAINER_FORCEINLINE BOOST_CONTAINER_DOC1ST
         ...
         , typename dtl::enable_if_c<dtl::is_convertible<Pair BOOST_MOVE_I impl_value_type>::value
            BOOST_MOVE_I iterator >::type)
      insert(BOOST_FWD_REF(Pair) x)
   { return dtl::force_copy<iterator>(m_flat_tree.emplace_equal(zr_boost_1_81::forward<Pair>(x))); }
   ...
   {
      return dtl::force_copy<iterator>(
         m_flat_tree.emplace_hint_equal(dtl::force_copy<impl_const_iterator>(p), zr_boost_1_81::forward<Pair>(x)));
   }
   ...
   //! <b>Throws</b>: If the comparison or the move constructor throws
   BOOST_CONTAINER_FORCEINLINE void adopt_sequence(BOOST_RV_REF(sequence_type) seq)
   {  this->m_flat_tree.adopt_sequence_equal(zr_boost_1_81::move(dtl::force<impl_sequence_type>(seq)));  }
   ...
   {  this->m_flat_tree.adopt_sequence_equal(ordered_range_t(), zr_boost_1_81::move(dtl::force<impl_sequence_type>(seq)));  }
...
//!specialization for optimizations
template <class Key, class T, class Compare, class AllocatorOrContainer>
struct has_trivial_destructor_after_move< zr_boost_1_81::container::flat_multimap<Key, T, Compare, AllocatorOrContainer> >
{
   typedef ::zr_boost_1_81::container::dtl::pair<Key, T> value_t;
   typedef typename ::zr_boost_1_81::container::dtl::container_or_allocator_rebind<AllocatorOrContainer, value_t>::type alloc_or_cont_t;
   typedef ::zr_boost_1_81::container::dtl::flat_tree<value_t,::zr_boost_1_81::container::dtl::select1st<Key>, Compare, alloc_or_cont_t> tree;
