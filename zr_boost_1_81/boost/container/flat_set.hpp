   ...
   ///@endcond
{
   ...
   {  return this->tree_t::emplace_unique(zr_boost_1_81::forward<Args>(args)...); }
   ...
   {  return this->tree_t::emplace_hint_unique(p, zr_boost_1_81::forward<Args>(args)...); }
   ...
   //! @copydoc ::zr_boost_1_81::container::flat_map::merge(flat_map<Key, T, C2, AllocatorOrContainer>&)
   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge(flat_set<Key, C2, AllocatorOrContainer>& source)
   {  this->tree_t::merge_unique(source.tree());   }

   //! @copydoc ::zr_boost_1_81::container::flat_set::merge(flat_set<Key, C2, AllocatorOrContainer>&)
   template<class C2>
   ...
   //! @copydoc ::zr_boost_1_81::container::flat_map::merge(flat_multimap<Key, T, C2, AllocatorOrContainer>&)
   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge(flat_multiset<Key, C2, AllocatorOrContainer>& source)
   {  this->tree_t::merge_unique(source.tree());   }

   //! @copydoc ::zr_boost_1_81::container::flat_set::merge(flat_multiset<Key, C2, AllocatorOrContainer>&)
   template<class C2>
   ...
   {  this->tree_t::adopt_sequence_unique(zr_boost_1_81::move(seq));  }
   ...
   {  this->tree_t::adopt_sequence_unique(ordered_unique_range_t(), zr_boost_1_81::move(seq));  }
...
template <class Key, class Compare, class AllocatorOrContainer>
struct has_trivial_destructor_after_move<zr_boost_1_81::container::flat_set<Key, Compare, AllocatorOrContainer> >
{
   typedef ::zr_boost_1_81::container::dtl::flat_tree<Key, ::zr_boost_1_81::container::dtl::identity<Key>, Compare, AllocatorOrContainer> tree;
   ...
   ///@endcond
{
   ...
   //! @copydoc ::zr_boost_1_81::container::flat_set::flat_set()
   ...
   //! @copydoc ::zr_boost_1_81::container::flat_set::flat_set(const Compare&)
   BOOST_CONTAINER_FORCEINLINE explicit flat_multiset(const Compare& comp)
      : tree_t(comp)
   {}

   //! @copydoc ::zr_boost_1_81::container::flat_set::flat_set(const allocator_type&)
   BOOST_CONTAINER_FORCEINLINE explicit flat_multiset(const allocator_type& a)
      : tree_t(a)
   {}

   //! @copydoc ::zr_boost_1_81::container::flat_set::flat_set(const Compare&, const allocator_type&)
   BOOST_CONTAINER_FORCEINLINE flat_multiset(const Compare& comp, const allocator_type& a)
      : tree_t(comp, a)
   {}

   //! @copydoc ::zr_boost_1_81::container::flat_set::flat_set(InputIterator, InputIterator)
   template <class InputIterator>
   BOOST_CONTAINER_FORCEINLINE flat_multiset(InputIterator first, InputIterator last)
      : tree_t(false, first, last)
   {}

   //! @copydoc ::zr_boost_1_81::container::flat_set::flat_set(InputIterator, InputIterator, const allocator_type&)
   template <class InputIterator>
   ...
   //! @copydoc ::zr_boost_1_81::container::flat_set::flat_set(InputIterator, InputIterator, const Compare& comp)
   template <class InputIterator>
   ...
   //! @copydoc ::zr_boost_1_81::container::flat_set::flat_set(InputIterator, InputIterator, const Compare& comp, const allocator_type&)
   template <class InputIterator>
...
#if !defined(BOOST_NO_CXX11_HDR_INITIALIZER_LIST)
   //! @copydoc ::zr_boost_1_81::container::flat_set::flat_set(std::initializer_list<value_type)
   BOOST_CONTAINER_FORCEINLINE flat_multiset(std::initializer_list<value_type> il)
      : tree_t(false, il.begin(), il.end())
   {}

   //! @copydoc ::zr_boost_1_81::container::flat_set::flat_set(std::initializer_list<value_type>, const allocator_type&)
   ...
   //! @copydoc ::zr_boost_1_81::container::flat_set::flat_set(std::initializer_list<value_type>, const Compare& comp)
   ...
   //! @copydoc ::zr_boost_1_81::container::flat_set::flat_set(std::initializer_list<value_type>, const Compare& comp, const allocator_type&)
   ...
   //! @copydoc ::zr_boost_1_81::container::flat_set::flat_set(const flat_set &)
   BOOST_CONTAINER_FORCEINLINE flat_multiset(const flat_multiset& x)
      : tree_t(static_cast<const tree_t&>(x))
   {}

   //! @copydoc ::zr_boost_1_81::container::flat_set::flat_set(flat_set &&)
   BOOST_CONTAINER_FORCEINLINE flat_multiset(BOOST_RV_REF(flat_multiset) x)
      BOOST_NOEXCEPT_IF(zr_boost_1_81::container::dtl::is_nothrow_move_constructible<Compare>::value)
      : tree_t(zr_boost_1_81::move(static_cast<tree_t&>(x)))
   {}

   //! @copydoc ::zr_boost_1_81::container::flat_set::flat_set(const flat_set &, const allocator_type &)
   BOOST_CONTAINER_FORCEINLINE flat_multiset(const flat_multiset& x, const allocator_type &a)
      : tree_t(static_cast<const tree_t&>(x), a)
   {}

   //! @copydoc ::zr_boost_1_81::container::flat_set::flat_set(flat_set &&, const allocator_type &)
   BOOST_CONTAINER_FORCEINLINE flat_multiset(BOOST_RV_REF(flat_multiset) x, const allocator_type &a)
      : tree_t(BOOST_MOVE_BASE(tree_t, x), a)
   {}

   //! @copydoc ::zr_boost_1_81::container::flat_set::operator=(const flat_set &)
   ...
   //! @copydoc ::zr_boost_1_81::container::flat_set::operator=(flat_set &&)
...
#if !defined(BOOST_NO_CXX11_HDR_INITIALIZER_LIST)
   //! @copydoc ::zr_boost_1_81::container::flat_set::operator=(std::initializer_list<value_type>)
   ...
   //! @copydoc ::zr_boost_1_81::container::flat_set::get_allocator()
   allocator_type get_allocator() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::flat_set::get_stored_allocator()
   stored_allocator_type &get_stored_allocator() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::flat_set::get_stored_allocator() const
   const stored_allocator_type &get_stored_allocator() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::flat_set::begin()
   iterator begin() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::flat_set::begin() const
   const_iterator begin() const;

   //! @copydoc ::zr_boost_1_81::container::flat_set::cbegin() const
   const_iterator cbegin() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::flat_set::end()
   iterator end() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::flat_set::end() const
   const_iterator end() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::flat_set::cend() const
   const_iterator cend() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::flat_set::rbegin()
   reverse_iterator rbegin() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::flat_set::rbegin() const
   const_reverse_iterator rbegin() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::flat_set::crbegin() const
   const_reverse_iterator crbegin() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::flat_set::rend()
   reverse_iterator rend() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::flat_set::rend() const
   const_reverse_iterator rend() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::flat_set::crend() const
   const_reverse_iterator crend() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::flat_set::empty() const
   bool empty() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::flat_set::size() const
   size_type size() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::flat_set::max_size() const
   size_type max_size() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::flat_set::capacity() const
   size_type capacity() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::flat_set::reserve(size_type)
   void reserve(size_type cnt);

   //! @copydoc ::zr_boost_1_81::container::flat_set::shrink_to_fit()
   void shrink_to_fit();
   ...
   {  return this->tree_t::emplace_equal(zr_boost_1_81::forward<Args>(args)...); }
   ...
   template <class... Args>
   BOOST_CONTAINER_FORCEINLINE iterator emplace_hint(const_iterator p, BOOST_FWD_REF(Args)... args)
   {  return this->tree_t::emplace_hint_equal(p, zr_boost_1_81::forward<Args>(args)...); }
   ...
   //! @copydoc ::zr_boost_1_81::container::flat_multimap::merge(flat_multimap<Key, T, C2, AllocatorOrContainer>&)
   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge(flat_multiset<Key, C2, AllocatorOrContainer>& source)
   {  this->tree_t::merge_equal(source.tree());   }

   //! @copydoc ::zr_boost_1_81::container::flat_multiset::merge(flat_multiset<Key, C2, AllocatorOrContainer>&)
   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge(BOOST_RV_REF_BEG flat_multiset<Key, C2, AllocatorOrContainer> BOOST_RV_REF_END source)
   {  return this->merge(static_cast<flat_multiset<Key, C2, AllocatorOrContainer>&>(source));   }

   //! @copydoc ::zr_boost_1_81::container::flat_multimap::merge(flat_map<Key, T, C2, AllocatorOrContainer>&)
   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge(flat_set<Key, C2, AllocatorOrContainer>& source)
   {  this->tree_t::merge_equal(source.tree());   }

   //! @copydoc ::zr_boost_1_81::container::flat_multiset::merge(flat_set<Key, C2, AllocatorOrContainer>&)
   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge(BOOST_RV_REF_BEG flat_set<Key, C2, AllocatorOrContainer> BOOST_RV_REF_END source)
   {  return this->merge(static_cast<flat_set<Key, C2, AllocatorOrContainer>&>(source));   }
   ...
   //! @copydoc ::zr_boost_1_81::container::flat_set::erase(const_iterator)
   iterator erase(const_iterator p);

   //! @copydoc ::zr_boost_1_81::container::flat_set::erase(const key_type&)
   size_type erase(const key_type& x);

   //! @copydoc ::zr_boost_1_81::container::flat_set::erase(const_iterator,const_iterator)
   iterator erase(const_iterator first, const_iterator last);

   //! @copydoc ::zr_boost_1_81::container::flat_set::swap
   void swap(flat_multiset& x)
      BOOST_NOEXCEPT_IF(  allocator_traits_type::is_always_equal::value
                                 && zr_boost_1_81::container::dtl::is_nothrow_swappable<Compare>::value );

   //! @copydoc ::zr_boost_1_81::container::flat_set::clear
   void clear() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::flat_set::key_comp
   key_compare key_comp() const;

   //! @copydoc ::zr_boost_1_81::container::flat_set::value_comp
   value_compare value_comp() const;

   //! @copydoc ::zr_boost_1_81::container::flat_set::find(const key_type& )
   iterator find(const key_type& x);

   //! @copydoc ::zr_boost_1_81::container::flat_set::find(const key_type& ) const
   const_iterator find(const key_type& x) const;

   //! @copydoc ::zr_boost_1_81::container::flat_set::nth(size_type)
   iterator nth(size_type n) BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::flat_set::nth(size_type) const
   const_iterator nth(size_type n) const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::flat_set::index_of(iterator)
   size_type index_of(iterator p) BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::flat_set::index_of(const_iterator) const
   size_type index_of(const_iterator p) const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::flat_set::count(const key_type& ) const
   size_type count(const key_type& x) const;

   //! @copydoc ::zr_boost_1_81::container::flat_set::contains(const key_type& ) const
   bool contains(const key_type& x) const;

   //! @copydoc ::zr_boost_1_81::container::flat_set::contains(const K& ) const
   template<typename K>
   bool contains(const K& x) const;

   //! @copydoc ::zr_boost_1_81::container::flat_set::lower_bound(const key_type& )
   iterator lower_bound(const key_type& x);

   //! @copydoc ::zr_boost_1_81::container::flat_set::lower_bound(const key_type& ) const
   const_iterator lower_bound(const key_type& x) const;

   //! @copydoc ::zr_boost_1_81::container::flat_set::upper_bound(const key_type& )
   iterator upper_bound(const key_type& x);

   //! @copydoc ::zr_boost_1_81::container::flat_set::upper_bound(const key_type& ) const
   const_iterator upper_bound(const key_type& x) const;

   //! @copydoc ::zr_boost_1_81::container::flat_set::equal_range(const key_type& ) const
   std::pair<const_iterator, const_iterator> equal_range(const key_type& x) const;

   //! @copydoc ::zr_boost_1_81::container::flat_set::equal_range(const key_type& )
   ...
   //! <b>Throws</b>: If the comparison or the move constructor throws
   BOOST_CONTAINER_FORCEINLINE void adopt_sequence(BOOST_RV_REF(sequence_type) seq)
   {  this->tree_t::adopt_sequence_equal(zr_boost_1_81::move(seq));  }
   ...
   {  this->tree_t::adopt_sequence_equal(ordered_range_t(), zr_boost_1_81::move(seq));  }
...
//!specialization for optimizations
template <class Key, class Compare, class AllocatorOrContainer>
struct has_trivial_destructor_after_move<zr_boost_1_81::container::flat_multiset<Key, Compare, AllocatorOrContainer> >
{
   typedef ::zr_boost_1_81::container::dtl::flat_tree<Key, ::zr_boost_1_81::container::dtl::identity<Key>, Compare, AllocatorOrContainer> tree;
   static const bool value = ::zr_boost_1_81::has_trivial_destructor_after_move<tree>::value;
};
