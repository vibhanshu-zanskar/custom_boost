...
//!
//! `zr_boost_1_81::container::vector` supports partially propagable allocators
...
//! `zr_boost_1_81::container::vector< T, small_vector_allocator<T, Allocator> >`
   ...
   : public allocator_traits<VoidAlloc>::template portable_rebind_alloc<T>::type
{
   ...
   BOOST_CONTAINER_FORCEINLINE small_vector_allocator
      ...
      : allocator_type(::zr_boost_1_81::move(other.as_base()))
   {}
   ...
   {  return static_cast<small_vector_allocator&>(this->allocator_type::operator=(::zr_boost_1_81::move(other.as_base())));  }
   ...
   {  zr_boost_1_81::adl_move_swap(l.as_base(), r.as_base());  }
...
//! </pre>
//!
//! All `zr_boost_1_81::container:vector` member functions are inherited. See `vector` documentation for details.
//!
template <class T, class SecAlloc, class Options>
   ...
   : public dtl::vector_for_small_vector<T, SecAlloc, Options>::type
{
   ...
   BOOST_CONTAINER_FORCEINLINE explicit small_vector_base(initial_capacity_t, std::size_t capacity, BOOST_FWD_REF(AllocFwd) a)
      : base_type(initial_capacity_t(), this->internal_storage(), capacity, ::zr_boost_1_81::forward<AllocFwd>(a))
   {}
   ...
   small_vector_allocator<T, VoidAlloc, Options>::internal_storage() const BOOST_NOEXCEPT_OR_NOTHROW
{
   ...
   return zr_boost_1_81::intrusive::pointer_traits<const_pointer>::pointer_to(*((const T*)stor.m_storage.data));
   #if defined(BOOST_GCC) && (BOOST_GCC >= 40600)
   ...
   small_vector_allocator<T, VoidAlloc, Options>::internal_storage() BOOST_NOEXCEPT_OR_NOTHROW
{
   ...
   return zr_boost_1_81::intrusive::pointer_traits<pointer>::pointer_to(*((T*)stor.m_storage.data));
   #if defined(BOOST_GCC) && (BOOST_GCC >= 40600)
   #pragma GCC diagnostic pop
   #endif
}
...
//! \tparam Options A type produced from \c zr_boost_1_81::container::small_vector_options.
   ...
   #endif
{
   ...
   BOOST_CONTAINER_FORCEINLINE explicit small_vector(BOOST_RV_REF(base_type) other)
      : base_type(initial_capacity_t(), internal_capacity(), ::zr_boost_1_81::move(other.get_stored_allocator()))
   ...
   BOOST_CONTAINER_FORCEINLINE small_vector(BOOST_RV_REF(small_vector) other)
      BOOST_NOEXCEPT_IF(zr_boost_1_81::container::dtl::is_nothrow_move_constructible<value_type>::value)
      : base_type(initial_capacity_t(), internal_capacity(), ::zr_boost_1_81::move(other.get_stored_allocator()))
   {  this->move_construct_impl(other, other.get_stored_allocator());   }
   ...
   BOOST_CONTAINER_FORCEINLINE small_vector& operator=(BOOST_RV_REF(small_vector) other)
      BOOST_NOEXCEPT_IF(zr_boost_1_81::container::dtl::is_nothrow_move_assignable<value_type>::value
   ...
   {  return static_cast<small_vector&>(this->base_type::operator=(zr_boost_1_81::move(other))); }
...
struct has_trivial_destructor_after_move<zr_boost_1_81::container::vector<T, Allocator> >
{
