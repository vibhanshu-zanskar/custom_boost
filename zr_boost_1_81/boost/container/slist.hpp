      ...
      , typename dtl::intrusive_slist_type<typename real_allocator<T, Allocator>::type>::type>
{
      ...
      : AllocHolder(a)
   {
      ...
      if(this->node_alloc() == sr.node_alloc()){
         ...
         this->insert_after(this->cbefore_begin(), zr_boost_1_81::make_move_iterator(sr.begin()), zr_boost_1_81::make_move_iterator(sr.end()));
      }
   }
                                  ...
                                  || allocator_traits_type::is_always_equal::value)
   {
      ...
      if (BOOST_LIKELY(this != &sr)) {
         ...
         if(propagate_alloc || allocators_equal){
            ...
            //Obtain resources
            this->icont() = zr_boost_1_81::move(sr.icont());
         }
         //Else do a one by one move
         else{
            this->assign( zr_boost_1_81::make_move_iterator(sr.begin())
                        , zr_boost_1_81::make_move_iterator(sr.end()));
         }
      }
      return *this;
   }
   ...
   {  return *this->emplace_after(this->cbefore_begin(), zr_boost_1_81::forward<Args>(args)...); }
   ...
   {  return this->emplace_after(this->previous(p), zr_boost_1_81::forward<Args>(args)...);  }
   ...
   {  return this->insert_after(previous(p), ::zr_boost_1_81::forward<U>(x)); }

   template<class U>
   iterator priv_insert_after(const_iterator prev_p, BOOST_FWD_REF(U) x)
   {  return iterator(this->icont().insert_after(prev_p.get(), *this->create_node(::zr_boost_1_81::forward<U>(x)))); }
...
template <class T, class Allocator>
struct has_trivial_destructor_after_move<zr_boost_1_81::container::slist<T, Allocator> >
{
   typedef typename zr_boost_1_81::container::slist<T, Allocator>::allocator_type allocator_type;
...
class insert_iterator<zr_boost_1_81::container::slist<T, ValueAllocator> >
{
   private:
   typedef zr_boost_1_81::container::slist<T, ValueAllocator> Container;
   Container* container;
