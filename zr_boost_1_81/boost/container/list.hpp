...
struct intrusive_list_type
{
   ...
   typedef typename zr_boost_1_81::intrusive::pointer_traits
      ...
      , typename dtl::intrusive_list_type<typename real_allocator<T, Allocator>::type>::type>
{
   ...
   typedef zr_boost_1_81::container::allocator_traits<ValueAllocator>     allocator_traits_type;
   typedef zr_boost_1_81::container::equal_to_value
      ...
      : AllocHolder(a)
   {
      if(this->node_alloc() == x.node_alloc()){
         ...
         this->insert(this->cbegin(), zr_boost_1_81::make_move_iterator(x.begin()), zr_boost_1_81::make_move_iterator(x.end()));
      }
   }
   ...
   {  return *this->emplace(this->cend(), zr_boost_1_81::forward<Args>(args)...); }
   ...
   {  return *this->emplace(this->cbegin(), zr_boost_1_81::forward<Args>(args)...);  }
   ...
   iterator emplace(const_iterator position, BOOST_FWD_REF(Args)... args)
   {
      ...
      NodePtr pnode(AllocHolder::create_node(zr_boost_1_81::forward<Args>(args)...));
      ...
      )
   {
      ...
      --before_p;
      this->allocate_many_and_construct(first, zr_boost_1_81::container::iterator_udistance(first, last), func);
      return ++before_p;
   }
   #endif
   ...
   {
      BOOST_ASSERT((priv_is_linked)(p));
      NodePtr tmp = AllocHolder::create_node(zr_boost_1_81::move(x));
      return iterator(this->icont().insert(p.get(), *tmp));
   }

   template<class U>
   void priv_push_back(BOOST_FWD_REF(U) x)
   {  this->icont().push_back(*this->create_node(::zr_boost_1_81::forward<U>(x))); }

   template<class U>
   void priv_push_front(BOOST_FWD_REF(U) x)
   {  this->icont().push_front(*this->create_node(::zr_boost_1_81::forward<U>(x))); }
...
template <class T, class Allocator>
struct has_trivial_destructor_after_move<zr_boost_1_81::container::list<T, Allocator> >
{
   typedef typename zr_boost_1_81::container::list<T, Allocator>::allocator_type allocator_type;
