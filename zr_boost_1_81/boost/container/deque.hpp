...
struct deque_value_traits
{
   ...
   static const bool trivial_dctr_after_move = ::zr_boost_1_81::has_trivial_destructor_after_move<value_type>::value;
};
...
class deque_iterator
{
   ...
   typedef typename zr_boost_1_81::intrusive::pointer_traits<Pointer>::
...
class deque_base
{
   ...
   BOOST_CONTAINER_FORCEINLINE explicit deque_base(BOOST_RV_REF(deque_base) x)
      :  members_( zr_boost_1_81::move(x.ptr_alloc())
                 , zr_boost_1_81::move(x.alloc()) )
   {}
   ...
   {
      ::zr_boost_1_81::adl_move_swap(this->members_.m_start, x.members_.m_start);
      ::zr_boost_1_81::adl_move_swap(this->members_.m_finish, x.members_.m_finish);
      ::zr_boost_1_81::adl_move_swap(this->members_.m_map, x.members_.m_map);
      ::zr_boost_1_81::adl_move_swap(this->members_.m_map_size, x.members_.m_map_size);
   }
...
//      }
      ...
      ,  public allocator_type
   {
      ...
      members_holder(BOOST_FWD_REF(PtrAllocConvertible) pa, BOOST_FWD_REF(ValAllocConvertible) va)
         : map_allocator_type(zr_boost_1_81::forward<PtrAllocConvertible>(pa))
         , allocator_type    (zr_boost_1_81::forward<ValAllocConvertible>(va))
         , m_map(0), m_map_size(0)
         , m_start(), m_finish(m_start)
      {}
...
//! \tparam Options A type produced from \c zr_boost_1_81::container::deque_options.
...
class deque : protected deque_base<typename real_allocator<T, Allocator>::type, Options>
{
   ...
   typedef typename ::zr_boost_1_81::container::allocator_traits<ValAllocator>::pointer           pointer;
   typedef typename ::zr_boost_1_81::container::allocator_traits<ValAllocator>::const_pointer     const_pointer;
   typedef typename ::zr_boost_1_81::container::allocator_traits<ValAllocator>::reference         reference;
   typedef typename ::zr_boost_1_81::container::allocator_traits<ValAllocator>::const_reference   const_reference;
   typedef typename ::zr_boost_1_81::container::allocator_traits<ValAllocator>::size_type         size_type;
   typedef typename ::zr_boost_1_81::container::allocator_traits<ValAllocator>::difference_type   difference_type;
      ...
      :  Base(allocator_traits_type::select_on_container_copy_construction(x.alloc()))
   {
      if(x.size()){
         ...
         zr_boost_1_81::container::uninitialized_copy_alloc
      ...
      :  Base(a)
   {
      if(x.alloc() == a){
         ...
         if(x.size()){
            this->priv_initialize_map(x.size());
            zr_boost_1_81::container::uninitialized_copy_alloc
               ( this->alloc(), zr_boost_1_81::make_move_iterator(x.begin())
               , zr_boost_1_81::make_move_iterator(x.end()), this->members_.m_start);
         }
      }
   }
                                  ...
                                  || allocator_traits_type::is_always_equal::value)
   {
      if (BOOST_LIKELY(this != &x)) {
         ...
         //Else do a one by one move
            ...
            this->assign( zr_boost_1_81::make_move_iterator(x.begin())
                        , zr_boost_1_81::make_move_iterator(x.end()));
         }
      }
      return *this;
   }
   ...
   {
      const size_type len = zr_boost_1_81::container::iterator_udistance(first, last);
      if (len > size()) {
         FwdIt mid = first;
         zr_boost_1_81::container::iterator_uadvance(mid, this->size());
         zr_boost_1_81::container::copy(first, mid, begin());
         this->insert(this->cend(), mid, last);
      }
      else{
         this->erase(zr_boost_1_81::container::copy(first, last, this->begin()), cend());
      }
   }
   #endif
   ...
   reference emplace_front(BOOST_FWD_REF(Args)... args)
   {
      if(this->priv_push_front_simple_available()){
         ...
         return *this->priv_insert_front_aux_impl(1, type(zr_boost_1_81::forward<Args>(args)...));
      }
   }
   ...
   reference emplace_back(BOOST_FWD_REF(Args)... args)
   {
      if(this->priv_push_back_simple_available()){
         ...
         typedef dtl::insert_nonmovable_emplace_proxy<ValAllocator, Args...> type;
         return *this->priv_insert_back_aux_impl(1, type(zr_boost_1_81::forward<Args>(args)...));
      }
   }
   ...
   iterator emplace(const_iterator p, BOOST_FWD_REF(Args)... args)
   {
      ...
      if(p == this->cbegin()){
         this->emplace_front(zr_boost_1_81::forward<Args>(args)...);
         return this->begin();
      }
      else if(p == this->cend()){
         this->emplace_back(zr_boost_1_81::forward<Args>(args)...);
         return (this->end()-1);
      }
      else{
         typedef dtl::insert_emplace_proxy<ValAllocator, Args...> type;
         return this->priv_insert_aux_impl(p, 1, type(zr_boost_1_81::forward<Args>(args)...));
      }
   }
      ...
      )
   {
      ...
      return priv_insert_aux_impl(p, zr_boost_1_81::container::iterator_udistance(first, last), proxy);
   }
   #endif
   ...
   void pop_front() BOOST_NOEXCEPT_OR_NOTHROW
   {
      ...
      if (this->members_.m_start.m_cur != this->members_.m_start.m_last - 1) {
         allocator_traits_type::destroy
            ( this->alloc()
            , zr_boost_1_81::movelib::to_raw_pointer(this->members_.m_start.m_cur)
            );
   ...
   void pop_back() BOOST_NOEXCEPT_OR_NOTHROW
   {
      ...
      if (this->members_.m_finish.m_cur != this->members_.m_finish.m_first) {
         ...
         allocator_traits_type::destroy
            ( this->alloc()
            , zr_boost_1_81::movelib::to_raw_pointer(this->members_.m_finish.m_cur)
            );
      }
      else
   ...
   iterator erase(const_iterator pos) BOOST_NOEXCEPT_OR_NOTHROW
   {
      ...
      if (index < (this->size()/2)) {
         zr_boost_1_81::container::move_backward(this->begin(), pos.unconst(), next);
         pop_front();
      }
      else {
         zr_boost_1_81::container::move(next, this->end(), pos.unconst());
         pop_back();
      }
   ...
   iterator erase(const_iterator first, const_iterator last) BOOST_NOEXCEPT_OR_NOTHROW
   {
      ...
      if (first == this->members_.m_start && last == this->members_.m_finish) {
         ...
         if (elems_before < (this->size() - n) - elems_before) {
            zr_boost_1_81::container::move_backward(begin(), first.unconst(), last.unconst());
            ...
            zr_boost_1_81::container::move(last.unconst(), end(), first.unconst());
   ...
   iterator priv_insert(const_iterator p, BOOST_FWD_REF(U) x)
   {
      BOOST_ASSERT(this->priv_in_range_or_end(p));
      if (p == cbegin()){
         this->push_front(::zr_boost_1_81::forward<U>(x));
         return begin();
      }
      else if (p == cend()){
         this->push_back(::zr_boost_1_81::forward<U>(x));
         return --end();
      }
      else {
         return priv_insert_aux_impl
            ( p, (size_type)1
            , dtl::get_insert_value_proxy<iterator, ValAllocator>(::zr_boost_1_81::forward<U>(x)));
      }
   }
   ...
   void priv_push_front(BOOST_FWD_REF(U) x)
   {
      if(this->priv_push_front_simple_available()){
         allocator_traits_type::construct
            ( this->alloc(), this->priv_push_front_simple_pos(), ::zr_boost_1_81::forward<U>(x));
         this->priv_push_front_simple_commit();
      }
      else{
   ...
   void priv_push_back(BOOST_FWD_REF(U) x)
   {
      if(this->priv_push_back_simple_available()){
         allocator_traits_type::construct
            ( this->alloc(), this->priv_push_back_simple_pos(), ::zr_boost_1_81::forward<U>(x));
         this->priv_push_back_simple_commit();
      }
      else{
         priv_insert_aux_impl
   ...
   {
      return zr_boost_1_81::movelib::to_raw_pointer(this->members_.m_finish.m_cur);
   }
   ...
   {  return zr_boost_1_81::movelib::to_raw_pointer(this->members_.m_start.m_cur) - 1;  }
   ...
   void priv_destroy_range(iterator p, iterator p2)
   {
      if(!Base::traits_t::trivial_dctr){
         for(;p != p2; ++p){
            allocator_traits_type::destroy(this->alloc(), zr_boost_1_81::movelib::iterator_to_raw_pointer(p));
         }
      }
   }
      ...
      if (elemsbefore < length / 2) {
         ...
         if(!elemsbefore){
            ...
            if (elemsbefore >= n) {
               ...
               this->members_.m_start = new_start;
               zr_boost_1_81::container::move(start_n, pos, old_start);
         ...
         if(!elemsafter){
            ...
            if (elemsafter >= n) {
               ...
               this->members_.m_finish = new_finish;
               zr_boost_1_81::container::move_backward(pos, finish_n, old_finish);
   ...
   void priv_fill_initialize(const value_type& value)
   {
      ...
      BOOST_TRY {
         for ( ; cur < this->members_.m_finish.m_node; ++cur){
            zr_boost_1_81::container::uninitialized_fill_alloc
   ...
   {
      size_type n = 0;
      n = zr_boost_1_81::container::iterator_udistance(first, last);
      ...
      BOOST_TRY {
         for (; cur_node < this->members_.m_finish.m_node; ++cur_node) {
            FwdIt mid = first;
            zr_boost_1_81::container::iterator_uadvance(mid, get_block_size());
            ::zr_boost_1_81::container::uninitialized_copy_alloc(this->alloc(), first, mid, *cur_node);
            first = mid;
         }
         ::zr_boost_1_81::container::uninitialized_copy_alloc(this->alloc(), first, last, this->members_.m_finish.m_first);
      }
      BOOST_CATCH(...){
   ...
   void priv_reallocate_map(size_type nodes_to_add, bool add_at_front)
   {
      ...
      if (this->members_.m_map_size > 2 * new_num_nodes) {
         ...
         if (new_nstart < this->members_.m_start.m_node)
            zr_boost_1_81::container::move(this->members_.m_start.m_node, this->members_.m_finish.m_node + 1, new_nstart);
         else
            zr_boost_1_81::container::move_backward
...
template <class T, class Allocator, class Options>
struct has_trivial_destructor_after_move<zr_boost_1_81::container::deque<T, Allocator, Options> >
{
   typedef typename zr_boost_1_81::container::deque<T, Allocator, Options>::allocator_type allocator_type;
