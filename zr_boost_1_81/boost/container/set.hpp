...
//! \tparam Options is an packed option type generated using using zr_boost_1_81::container::tree_assoc_options.
   ...
   ///@endcond
{
   ...
   typedef typename ::zr_boost_1_81::container::allocator_traits<allocator_type>::const_pointer   const_pointer;
   typedef typename ::zr_boost_1_81::container::allocator_traits<allocator_type>::reference       reference;
   typedef typename ::zr_boost_1_81::container::allocator_traits<allocator_type>::const_reference const_reference;
   typedef typename ::zr_boost_1_81::container::allocator_traits<allocator_type>::size_type       size_type;
   typedef typename ::zr_boost_1_81::container::allocator_traits<allocator_type>::difference_type difference_type;
   ...
   BOOST_CONTAINER_FORCEINLINE set(BOOST_RV_REF(set) x)
      BOOST_NOEXCEPT_IF(zr_boost_1_81::container::dtl::is_nothrow_move_constructible<Compare>::value)
   ...
   BOOST_CONTAINER_FORCEINLINE set& operator=(BOOST_RV_REF(set) x)
      BOOST_NOEXCEPT_IF( (allocator_traits_type::propagate_on_container_move_assignment::value ||
                          allocator_traits_type::is_always_equal::value) &&
                           zr_boost_1_81::container::dtl::is_nothrow_move_assignable<Compare>::value)
   ...
   {  return this->base_t::emplace_unique(zr_boost_1_81::forward<Args>(args)...); }
   ...
   {  return this->base_t::emplace_hint_unique(p, zr_boost_1_81::forward<Args>(args)...); }
   ...
   //! @copydoc ::zr_boost_1_81::container::map::insert(node_type&&)
   BOOST_CONTAINER_FORCEINLINE insert_return_type insert(BOOST_RV_REF_BEG_IF_CXX11 node_type BOOST_RV_REF_END_IF_CXX11 nh)
   {  return this->base_t::insert_unique_node(zr_boost_1_81::move(nh));  }

   //! @copydoc ::zr_boost_1_81::container::map::insert(const_iterator, node_type&&)
   ...
   {  return this->base_t::insert_unique_node(hint, zr_boost_1_81::move(nh));  }

   //! @copydoc ::zr_boost_1_81::container::map::merge(map<Key, T, C2, Allocator, Options>&)
   template<class C2>
   ...
   //! @copydoc ::zr_boost_1_81::container::set::merge(set<Key, C2, Allocator, Options>&)
   template<class C2>
   ...
   //! @copydoc ::zr_boost_1_81::container::map::merge(multimap<Key, T, C2, Allocator, Options>&)
   template<class C2>
   ...
   //! @copydoc ::zr_boost_1_81::container::set::merge(multiset<Key, C2, Allocator, Options>&)
   template<class C2>
   ...
   //! @copydoc ::zr_boost_1_81::container::map::extract(const_iterator)
   node_type extract(const_iterator p);

   //! @copydoc ::zr_boost_1_81::container::map::extract(const key_type&)
   ...
   void swap(set& x)
      BOOST_NOEXCEPT_IF(  allocator_traits_type::is_always_equal::value
                                 && zr_boost_1_81::container::dtl::is_nothrow_swappable<Compare>::value );
...
template <class Key, class Compare, class Allocator, class Options>
struct has_trivial_destructor_after_move<zr_boost_1_81::container::set<Key, Compare, Allocator, Options> >
{
   typedef ::zr_boost_1_81::container::dtl::tree<Key, void, Compare, Allocator, Options> tree;
   static const bool value = ::zr_boost_1_81::has_trivial_destructor_after_move<tree>::value;
};
   ...
   /// @endcond
{
   ...
   //! @copydoc ::zr_boost_1_81::container::set::set()
   ...
   //! @copydoc ::zr_boost_1_81::container::set::set(const allocator_type&)
   BOOST_CONTAINER_FORCEINLINE explicit multiset(const allocator_type& a)
      : base_t(a)
   {}

   //! @copydoc ::zr_boost_1_81::container::set::set(const Compare&)
   BOOST_CONTAINER_FORCEINLINE explicit multiset(const Compare& comp)
      : base_t(comp)
   {}

   //! @copydoc ::zr_boost_1_81::container::set::set(const Compare&, const allocator_type&)
   BOOST_CONTAINER_FORCEINLINE multiset(const Compare& comp, const allocator_type& a)
      : base_t(comp, a)
   {}

   //! @copydoc ::zr_boost_1_81::container::set::set(InputIterator, InputIterator)
   template <class InputIterator>
   BOOST_CONTAINER_FORCEINLINE multiset(InputIterator first, InputIterator last)
      : base_t(false, first, last)
   {}

   //! @copydoc ::zr_boost_1_81::container::set::set(InputIterator, InputIterator, const allocator_type&)
   template <class InputIterator>
   ...
   //! @copydoc ::zr_boost_1_81::container::set::set(InputIterator, InputIterator, const Compare&)
   template <class InputIterator>
   ...
   //! @copydoc ::zr_boost_1_81::container::set::set(InputIterator, InputIterator, const Compare&, const allocator_type&)
   template <class InputIterator>
...
#if !defined(BOOST_NO_CXX11_HDR_INITIALIZER_LIST)
   //! @copydoc ::zr_boost_1_81::container::set::set(std::initializer_list<value_type>)
   BOOST_CONTAINER_FORCEINLINE multiset(std::initializer_list<value_type> il)
      : base_t(false, il.begin(), il.end())
   {}

   //! @copydoc ::zr_boost_1_81::container::set::set(std::initializer_list<value_type>, const allocator_type&)
   ...
   //! @copydoc ::zr_boost_1_81::container::set::set(std::initializer_list<value_type>, const Compare&)
   ...
   //! @copydoc ::zr_boost_1_81::container::set::set(std::initializer_list<value_type>, const Compare&, const allocator_type&)
   BOOST_CONTAINER_FORCEINLINE multiset(std::initializer_list<value_type> il, const Compare& comp, const allocator_type& a)
      : base_t(false, il.begin(), il.end(), comp, a)
   {}

   //! @copydoc ::zr_boost_1_81::container::set::set(ordered_unique_range_t, std::initializer_list<value_type>)
   BOOST_CONTAINER_FORCEINLINE multiset(ordered_range_t, std::initializer_list<value_type> il)
      : base_t(ordered_range, il.begin(), il.end())
   {}

   //! @copydoc ::zr_boost_1_81::container::set::set(ordered_unique_range_t, std::initializer_list<value_type>, const Compare&)
   BOOST_CONTAINER_FORCEINLINE multiset(ordered_range_t, std::initializer_list<value_type> il, const Compare& comp)
      : base_t(ordered_range, il.begin(), il.end(), comp)
   {}

   //! @copydoc ::zr_boost_1_81::container::set::set(ordered_unique_range_t, std::initializer_list<value_type>, const Compare&, const allocator_type&)
   ...
   //! @copydoc ::zr_boost_1_81::container::set::set(const set &)
   BOOST_CONTAINER_FORCEINLINE multiset(const multiset& x)
      : base_t(static_cast<const base_t&>(x))
   {}

   //! @copydoc ::zr_boost_1_81::container::set::set(set &&)
   BOOST_CONTAINER_FORCEINLINE multiset(BOOST_RV_REF(multiset) x)
      BOOST_NOEXCEPT_IF(zr_boost_1_81::container::dtl::is_nothrow_move_constructible<Compare>::value)
      : base_t(BOOST_MOVE_BASE(base_t, x))
   {}

   //! @copydoc ::zr_boost_1_81::container::set::set(const set &, const allocator_type &)
   BOOST_CONTAINER_FORCEINLINE multiset(const multiset& x, const allocator_type &a)
      : base_t(static_cast<const base_t&>(x), a)
   {}

   //! @copydoc ::zr_boost_1_81::container::set::set(set &&, const allocator_type &)
   BOOST_CONTAINER_FORCEINLINE multiset(BOOST_RV_REF(multiset) x, const allocator_type &a)
      : base_t(BOOST_MOVE_BASE(base_t, x), a)
   {}

   //! @copydoc ::zr_boost_1_81::container::set::operator=(const set &)
   ...
   //! @copydoc ::zr_boost_1_81::container::set::operator=(set &&)
...
#if !defined(BOOST_NO_CXX11_HDR_INITIALIZER_LIST)
   //! @copydoc ::zr_boost_1_81::container::set::operator=(std::initializer_list<value_type>)
   ...
   //! @copydoc ::zr_boost_1_81::container::set::get_allocator()
   allocator_type get_allocator() const;

   //! @copydoc ::zr_boost_1_81::container::set::get_stored_allocator()
   stored_allocator_type &get_stored_allocator();

   //! @copydoc ::zr_boost_1_81::container::set::get_stored_allocator() const
   const stored_allocator_type &get_stored_allocator() const;

   //! @copydoc ::zr_boost_1_81::container::set::begin()
   iterator begin();

   //! @copydoc ::zr_boost_1_81::container::set::begin() const
   const_iterator begin() const;

   //! @copydoc ::zr_boost_1_81::container::set::cbegin() const
   const_iterator cbegin() const;

   //! @copydoc ::zr_boost_1_81::container::set::end()
   iterator end() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::set::end() const
   const_iterator end() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::set::cend() const
   const_iterator cend() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::set::rbegin()
   reverse_iterator rbegin() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::set::rbegin() const
   const_reverse_iterator rbegin() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::set::crbegin() const
   const_reverse_iterator crbegin() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::set::rend()
   reverse_iterator rend() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::set::rend() const
   const_reverse_iterator rend() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::set::crend() const
   const_reverse_iterator crend() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::set::empty() const
   bool empty() const;

   //! @copydoc ::zr_boost_1_81::container::set::size() const
   size_type size() const;

   //! @copydoc ::zr_boost_1_81::container::set::max_size() const
   size_type max_size() const;
   ...
   {  return this->base_t::emplace_equal(zr_boost_1_81::forward<Args>(args)...); }
   ...
   template <class... Args>
   BOOST_CONTAINER_FORCEINLINE iterator emplace_hint(const_iterator p, BOOST_FWD_REF(Args)... args)
   {  return this->base_t::emplace_hint_equal(p, zr_boost_1_81::forward<Args>(args)...); }
...
#if !defined(BOOST_NO_CXX11_HDR_INITIALIZER_LIST)
   //! @copydoc ::zr_boost_1_81::container::set::insert(std::initializer_list<value_type>)
   BOOST_CONTAINER_FORCEINLINE void insert(std::initializer_list<value_type> il)
   {  this->base_t::insert_equal_range(il.begin(), il.end());  }
#endif

   //! @copydoc ::zr_boost_1_81::container::multimap::insert(node_type&&)
   BOOST_CONTAINER_FORCEINLINE iterator insert(BOOST_RV_REF_BEG_IF_CXX11 node_type BOOST_RV_REF_END_IF_CXX11 nh)
   {  return this->base_t::insert_equal_node(zr_boost_1_81::move(nh));  }

   //! @copydoc ::zr_boost_1_81::container::multimap::insert(const_iterator, node_type&&)
   ...
   {  return this->base_t::insert_equal_node(hint, zr_boost_1_81::move(nh));  }

   //! @copydoc ::zr_boost_1_81::container::multimap::merge(multimap<Key, T, C2, Allocator, Options>&)
   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge(multiset<Key, C2, Allocator, Options>& source)
   {
      typedef dtl::tree
   ...
   //! @copydoc ::zr_boost_1_81::container::multiset::merge(multiset<Key, C2, Allocator, Options>&)
   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge(BOOST_RV_REF_BEG multiset<Key, C2, Allocator, Options> BOOST_RV_REF_END source)
   {  return this->merge(static_cast<multiset<Key, C2, Allocator, Options>&>(source));   }

   //! @copydoc ::zr_boost_1_81::container::multimap::merge(map<Key, T, C2, Allocator, Options>&)
   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge(set<Key, C2, Allocator, Options>& source)
   {
      typedef dtl::tree
   ...
   //! @copydoc ::zr_boost_1_81::container::multiset::merge(set<Key, C2, Allocator, Options>&)
   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge(BOOST_RV_REF_BEG set<Key, C2, Allocator, Options> BOOST_RV_REF_END source)
   {  return this->merge(static_cast<set<Key, C2, Allocator, Options>&>(source));   }
   ...
   //! @copydoc ::zr_boost_1_81::container::set::erase(const_iterator)
   iterator erase(const_iterator p);

   //! @copydoc ::zr_boost_1_81::container::set::erase(const key_type&)
   size_type erase(const key_type& x);

   //! @copydoc ::zr_boost_1_81::container::set::erase(const_iterator,const_iterator)
   iterator erase(const_iterator first, const_iterator last);

   //! @copydoc ::zr_boost_1_81::container::multimap::extract(const_iterator)
   node_type extract(const_iterator p);

   //! @copydoc ::zr_boost_1_81::container::multimap::extract(const key_type&)
   node_type extract(const key_type& x);

   //! @copydoc ::zr_boost_1_81::container::set::swap
   void swap(multiset& x)
      BOOST_NOEXCEPT_IF(  allocator_traits_type::is_always_equal::value
                                 && zr_boost_1_81::container::dtl::is_nothrow_swappable<Compare>::value );

   //! @copydoc ::zr_boost_1_81::container::set::clear
   void clear() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::zr_boost_1_81::container::set::key_comp
   key_compare key_comp() const;

   //! @copydoc ::zr_boost_1_81::container::set::value_comp
   value_compare value_comp() const;

   //! @copydoc ::zr_boost_1_81::container::set::find(const key_type& )
   iterator find(const key_type& x);

   //! @copydoc ::zr_boost_1_81::container::set::find(const key_type& ) const
   const_iterator find(const key_type& x) const;

   //! @copydoc ::zr_boost_1_81::container::set::find(const K& )
   template<typename K>
   iterator find(const K& x);
   ...
   //! @copydoc ::zr_boost_1_81::container::set::count(const key_type& ) const
   size_type count(const key_type& x) const;

   //! @copydoc ::zr_boost_1_81::container::set::count(const K& ) const
   template<typename K>
   size_type count(const K& x) const;

   //! @copydoc ::zr_boost_1_81::container::set::contains(const key_type& ) const
   bool contains(const key_type& x) const;

   //! @copydoc ::zr_boost_1_81::container::set::contains(const K& ) const
   template<typename K>
   bool contains(const K& x) const;

   //! @copydoc ::zr_boost_1_81::container::set::lower_bound(const key_type& )
   iterator lower_bound(const key_type& x);

   //! @copydoc ::zr_boost_1_81::container::set::lower_bound(const key_type& ) const
   const_iterator lower_bound(const key_type& x) const;

   //! @copydoc ::zr_boost_1_81::container::set::lower_bound(const K& )
   template<typename K>
   iterator lower_bound(const K& x);

   //! @copydoc ::zr_boost_1_81::container::set::lower_bound(const K& ) const
   template<typename K>
   const_iterator lower_bound(const K& x) const;

   //! @copydoc ::zr_boost_1_81::container::set::upper_bound(const key_type& )
   iterator upper_bound(const key_type& x);

   //! @copydoc ::zr_boost_1_81::container::set::upper_bound(const key_type& ) const
   const_iterator upper_bound(const key_type& x) const;

   //! @copydoc ::zr_boost_1_81::container::set::upper_bound(const K& )
   template<typename K>
   iterator upper_bound(const K& x);

   //! @copydoc ::zr_boost_1_81::container::set::upper_bound(const K& ) const
   template<typename K>
   const_iterator upper_bound(const K& x) const;

   //! @copydoc ::zr_boost_1_81::container::set::equal_range(const key_type& ) const
   std::pair<const_iterator, const_iterator> equal_range(const key_type& x) const;

   //! @copydoc ::zr_boost_1_81::container::set::equal_range(const key_type& )
   std::pair<iterator,iterator> equal_range(const key_type& x);

   //! @copydoc ::zr_boost_1_81::container::set::equal_range(const K& ) const
   template<typename K>
   std::pair<const_iterator, const_iterator> equal_range(const K& x) const;

   //! @copydoc ::zr_boost_1_81::container::set::equal_range(const K& )
   template<typename K>
   std::pair<iterator,iterator> equal_range(const K& x);

   //! @copydoc ::zr_boost_1_81::container::set::rebalance()
   void rebalance();
...
//!specialization for optimizations
template <class Key, class Compare, class Allocator, class Options>
struct has_trivial_destructor_after_move<zr_boost_1_81::container::multiset<Key, Compare, Allocator, Options> >
{
   typedef ::zr_boost_1_81::container::dtl::tree<Key, void, Compare, Allocator, Options> tree;
   static const bool value = ::zr_boost_1_81::has_trivial_destructor_after_move<tree>::value;
};
