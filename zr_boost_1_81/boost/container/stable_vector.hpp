...
{
   private:
   typedef typename zr_boost_1_81::intrusive::
...
{
   public:
   typedef typename ::zr_boost_1_81::intrusive::pointer_traits<Pointer>::element_type T;
   typedef node_base
      <typename ::zr_boost_1_81::intrusive::pointer_traits<Pointer>::template
         rebind_pointer<void>::type
      > hook_type;

   typedef typename zr_boost_1_81::container::dtl::aligned_storage
      <sizeof(T), zr_boost_1_81::container::dtl::alignment_of<T>::value>::type storage_t;
   storage_t m_storage;
   ...
   {  return *zr_boost_1_81::move_detail::force_ptr<T*>(this->m_storage.data);   }

   BOOST_CONTAINER_FORCEINLINE const T &get_data() const
   {  return *zr_boost_1_81::move_detail::force_ptr<const T*>(this->m_storage.data);  }
   ...
   BOOST_CONTAINER_FORCEINLINE ~node()
   {  zr_boost_1_81::move_detail::force_ptr<T*>(this->m_storage.data)->~T();   }
...
struct index_traits
{
   typedef zr_boost_1_81::intrusive::
      pointer_traits
...
{
   typedef zr_boost_1_81::intrusive::pointer_traits<Pointer>                                non_const_ptr_traits;
   public:
   ...
   typedef typename ::zr_boost_1_81::container::dtl::if_c
      < IsConst
      , typename non_const_ptr_traits::template
         rebind_pointer<const value_type>::type
      , Pointer
      >::type                                                                       pointer;
   typedef zr_boost_1_81::intrusive::pointer_traits<pointer>                                ptr_traits;
...
class stable_vector
{
   ...
   typedef ::zr_boost_1_81::container::dtl::integral_constant
      <unsigned, zr_boost_1_81::container::dtl::
      version<ValueAllocator>::value>                              alloc_version;
   typedef typename allocator_traits_type::
      template portable_rebind_alloc
         <node_type>::type                            node_allocator_type;

   typedef ::zr_boost_1_81::container::dtl::
   ...
   typedef typename ::zr_boost_1_81::container::allocator_traits<ValueAllocator>::pointer           pointer;
   typedef typename ::zr_boost_1_81::container::allocator_traits<ValueAllocator>::const_pointer     const_pointer;
   typedef typename ::zr_boost_1_81::container::allocator_traits<ValueAllocator>::reference         reference;
   typedef typename ::zr_boost_1_81::container::allocator_traits<ValueAllocator>::const_reference   const_reference;
   typedef typename ::zr_boost_1_81::container::allocator_traits<ValueAllocator>::size_type         size_type;
   typedef typename ::zr_boost_1_81::container::allocator_traits<ValueAllocator>::difference_type   difference_type;
   ...
   BOOST_CONTAINER_FORCEINLINE stable_vector(BOOST_RV_REF(stable_vector) x) BOOST_NOEXCEPT_OR_NOTHROW
      : internal_data(zr_boost_1_81::move(x.priv_node_alloc())), index(zr_boost_1_81::move(x.index))
   {
      ...
      : internal_data(a), index(a)
   {
      if(this->priv_node_alloc() == x.priv_node_alloc()){
         ...
         stable_vector_detail::clear_on_destroy<stable_vector> cod(*this);
         this->insert(this->cend(), zr_boost_1_81::make_move_iterator(x.begin()), zr_boost_1_81::make_move_iterator(x.end()));
         BOOST_CONTAINER_STABLE_VECTOR_CHECK_INVARIANT;
         cod.release();
      }
   }
   ...
   reference emplace_back(Args &&...args)
   {
      ...
      EmplaceFunctor &&ef = EmplaceFunctor(zr_boost_1_81::forward<Args>(args)...);
   ...
   {
      BOOST_ASSERT(this->priv_in_range_or_end(p));
      const size_type num_new = zr_boost_1_81::container::iterator_udistance(first, last);
   ...
   void priv_push_back(BOOST_MOVE_CATCH_FWD(U) x)
   {
      if(BOOST_LIKELY(this->priv_capacity_bigger_than_size())){
         ...
         BOOST_ASSERT(!!p);
         {
            ...
            //This might throw
            this->priv_build_node_from_convertible(p, ::zr_boost_1_81::forward<U>(x));
            rollback.release();
         }
         ...
         this->insert(this->cend(), ::zr_boost_1_81::forward<U>(x));
      }
   }
   ...
   iterator priv_insert(const_iterator p, BOOST_RV_REF(T) x)
   {
      ...
      typedef zr_boost_1_81::move_iterator<repeat_it>      repeat_move_it;
   ...
   {
      node_type *praw = ::new(zr_boost_1_81::movelib::iterator_to_raw_pointer(p), boost_container_new_t())
         node_type(index_traits_type::ptr_to_node_base_ptr(*up_index));
      BOOST_TRY{
         //This can throw
         zr_boost_1_81::container::construct_in_place
   ...
   {
      node_type *praw = ::new(zr_boost_1_81::movelib::iterator_to_raw_pointer(p), boost_container_new_t()) node_type;
      BOOST_TRY{
         //This can throw
         zr_boost_1_81::container::allocator_traits<node_allocator_type>::construct
            ( this->priv_node_alloc()
            , p->get_data_ptr()
            , ::zr_boost_1_81::forward<ValueConvertible>(value_convertible));
      }
      BOOST_CATCH(...) {
         praw->destroy_header();
         this->priv_node_alloc().deallocate(p, 1);
   ...
   {
      zr_boost_1_81::adl_move_swap(this->internal_data.pool_size, x.internal_data.pool_size);
      ...
      : public node_allocator_type
   {
      ...
      explicit ebo_holder(BOOST_FWD_REF(AllocatorRLValue) a)
         : node_allocator_type(zr_boost_1_81::forward<AllocatorRLValue>(a))
         , pool_size(0)
         , end_node()
      {}
...
template <class T, class Allocator>
struct has_trivial_destructor_after_move<zr_boost_1_81::container::stable_vector<T, Allocator> >
{
   typedef typename zr_boost_1_81::container::stable_vector<T, Allocator>::allocator_type allocator_type;
