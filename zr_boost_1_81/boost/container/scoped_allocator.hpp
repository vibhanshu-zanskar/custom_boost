   ...
   : public OuterAlloc
{
   ...
   BOOST_CONTAINER_FORCEINLINE scoped_allocator_adaptor_base(BOOST_FWD_REF(OuterA2) outerAlloc, const InnerAllocs &...args)
      : outer_allocator_type(::zr_boost_1_81::forward<OuterA2>(outerAlloc))
      , m_inner(args...)
      {}
   ...
   BOOST_CONTAINER_FORCEINLINE scoped_allocator_adaptor_base(BOOST_RV_REF(scoped_allocator_adaptor_base) other)
      : outer_allocator_type(::zr_boost_1_81::move(other.outer_allocator()))
      , m_inner(::zr_boost_1_81::move(other.inner_allocator()))
      {}
   ...
   {
      outer_allocator_type::operator=(zr_boost_1_81::move(other.outer_allocator()));
      m_inner = ::zr_boost_1_81::move(other.inner_allocator());
      return *this;
   }
   ...
   {
      zr_boost_1_81::adl_move_swap(this->outer_allocator(), r.outer_allocator());
      zr_boost_1_81::adl_move_swap(this->m_inner, r.inner_allocator());
   }
         ...
         <OuterAlloc BOOST_CONTAINER_SCOPEDALLOC_DUMMYTRUE, BOOST_CONTAINER_SCOPEDALLOC_ALLINNER>
{
   ...
   BOOST_CONTAINER_FORCEINLINE scoped_allocator_adaptor(BOOST_RV_REF(scoped_allocator_adaptor) other)
      : base_type(::zr_boost_1_81::move(other.base()))
      {}
   ...
   //!
   //! <b>Effects</b>: initializes the OuterAlloc base class with zr_boost_1_81::forward<OuterA2>(outerAlloc) and inner
   ...
   BOOST_CONTAINER_FORCEINLINE scoped_allocator_adaptor(BOOST_FWD_REF(OuterA2) outerAlloc, const InnerAllocs & ...innerAllocs)
      : base_type(::zr_boost_1_81::forward<OuterA2>(outerAlloc), innerAllocs...)
      {}
   #else // #if !defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES) || defined(BOOST_CONTAINER_DOXYGEN_INVOKED)
   ...
   BOOST_CONTAINER_FORCEINLINE scoped_allocator_adaptor(BOOST_FWD_REF(OuterA2) outerAlloc BOOST_MOVE_I##N BOOST_MOVE_CREF##N)\
      : base_type(::zr_boost_1_81::forward<OuterA2>(outerAlloc) BOOST_MOVE_I##N BOOST_MOVE_ARG##N)\
      {}\
   //
   ...
   {  return static_cast<scoped_allocator_adaptor&>(base_type::operator=(zr_boost_1_81::move(other.base()))); }
   ...
   BOOST_CONTAINER_FORCEINLINE void construct(T* p, BOOST_FWD_REF(Args)...args)
   {
      dtl::dispatch_uses_allocator
         ...
         , this->inner_allocator(), p, ::zr_boost_1_81::forward<Args>(args)...);
   }
   ...
   BOOST_CONTAINER_FORCEINLINE scoped_allocator_adaptor(internal_type_t, BOOST_FWD_REF(OuterA2) outer, const inner_allocator_type& inner)
      : base_type(internal_type_t(), ::zr_boost_1_81::forward<OuterA2>(outer), inner)
   {}
                      ...
                      ,const scoped_allocator_adaptor<OuterA2, BOOST_CONTAINER_SCOPEDALLOC_ALLINNER>& b)
{
   ...
   #else
   const bool has_zero_inner = zr_boost_1_81::container::dtl::is_same<P0, void>::value;
   #endif
