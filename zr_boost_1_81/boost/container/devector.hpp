 ...
 *
 *! \tparam Options A type produced from \c zr_boost_1_81::container::devector_options.
 *
...
class devector
{
   ...
   typedef zr_boost_1_81::container::allocator_traits
   ...
   typedef BOOST_CONTAINER_IMPDEF
      (zr_boost_1_81::container::reverse_iterator<iterator>)                             reverse_iterator;
   typedef BOOST_CONTAINER_IMPDEF
      (zr_boost_1_81::container::reverse_iterator<const_iterator>)                       const_reverse_iterator;
   ...
   */
      ...
      : m_(reserve_uninitialized_t(), allocator, n)
   {
      ...
      zr_boost_1_81::container::uninitialized_value_init_alloc_n(get_allocator_ref(), n, this->priv_raw_begin());
   ...
   */
   ...
   {
      allocation_guard buffer_guard(m_.buffer, m_.capacity, get_allocator_ref());
      zr_boost_1_81::container::uninitialized_default_init_alloc_n(get_allocator_ref(), n, this->priv_raw_begin());
      buffer_guard.release();
      BOOST_ASSERT(invariants_ok());
   }
   ...
   * into `*this`.
   *
   * **Postcondition**: `size() == zr_boost_1_81::container::iterator_distance(first, last)
   *
   * **Exceptions**: Strong exception guarantee.
   *
   ...
   */
   ...
   devector(ForwardIterator first, ForwardIterator last, const allocator_type& allocator = allocator_type()
      ...
      : m_(reserve_uninitialized_t(), allocator, zr_boost_1_81::container::iterator_udistance(first, last))
   {
...
/**
   ...
   */
                                 ...
                                 || allocator_traits_type::is_always_equal::value)
   {
      ...
      BOOST_IF_CONSTEXPR (copy_alloc || get_allocator_ref() == x.get_allocator_ref())
      {
         ...
         if (copy_alloc)
         {
            this->get_allocator_ref() = zr_boost_1_81::move(x.get_allocator_ref());
         }
      ...
      else
      {
         ...
         move_iterator<iterator> xbegin = zr_boost_1_81::make_move_iterator(x.begin());
         move_iterator<iterator> xend = zr_boost_1_81::make_move_iterator(x.end());

         if (copy_alloc)
         {
            get_allocator_ref() = zr_boost_1_81::move(x.get_allocator_ref());
         }
   ...
   */
   ...
   {
      const size_type n = zr_boost_1_81::container::iterator_udistance(first, last);
   ...
   */
   ...
   {
      return zr_boost_1_81::movelib::to_raw_pointer(m_.buffer) + m_.front_idx;
   }
   ...
   */
   ...
   reference emplace_front(Args&&... args)
   {
      if (BOOST_LIKELY(front_free_capacity() != 0)) // fast path
      {
         ...
         this->alloc_construct(p, zr_boost_1_81::forward<Args>(args)...);
         --m_.front_idx;
         BOOST_ASSERT(invariants_ok());
         return *p;
      }
      else
      {
         ...
         return *this->insert_range_slow_path(this->begin(), 1, proxy_t(::zr_boost_1_81::forward<Args>(args)...));
      }
   }
   ...
   */
   ...
   {
      BOOST_ASSERT(!empty());
      allocator_traits_type::destroy(get_allocator_ref(), zr_boost_1_81::movelib::to_raw_pointer(m_.buffer + m_.front_idx));
      ++m_.front_idx;
      BOOST_ASSERT(invariants_ok());
   }
   ...
   */
   ...
   BOOST_CONTAINER_FORCEINLINE reference emplace_back(Args&&... args)
   {
      if (BOOST_LIKELY(this->back_free_capacity() != 0)){
         ...
         typedef dtl::insert_emplace_proxy<allocator_type, Args...> proxy_t;
         return *this->insert_range_slow_path(this->end(), 1, proxy_t(::zr_boost_1_81::forward<Args>(args)...));
      }
   }
   ...
   */
   void pop_back() BOOST_NOEXCEPT
   {
      BOOST_ASSERT(! empty());
      --m_.back_idx;
      allocator_traits_type::destroy(get_allocator_ref(), zr_boost_1_81::movelib::to_raw_pointer(m_.buffer + m_.back_idx));
      BOOST_ASSERT(invariants_ok());
   }
   ...
   */
   ...
   iterator emplace(const_iterator position, Args&&... args)
   {
      ...
      if (position == end()){
         ...
         if(prefer_move_back){
            if(back_free_capacity()){
               zr_boost_1_81::container::expand_forward_and_insert_nonempty_middle_alloc
                  ( get_allocator_ref()
                  , zr_boost_1_81::movelib::to_raw_pointer(nonconst_pos)
                  , this->priv_raw_end()
                  , 1, proxy_t(::zr_boost_1_81::forward<Args>(args)...));
               ++m_.back_idx;
               return nonconst_pos;
            }
         }
            ...
            if (front_free_capacity()){
               zr_boost_1_81::container::expand_backward_and_insert_nonempty_middle_alloc
               (get_allocator_ref()
                  , this->priv_raw_begin()
                  , zr_boost_1_81::movelib::to_raw_pointer(nonconst_pos)
                  , 1, proxy_t(::zr_boost_1_81::forward<Args>(args)...));
      ...
      return this->insert_range_slow_path(position, 1, proxy_t(::zr_boost_1_81::forward<Args>(args)...));
   }
   ...
   */
      ...
      )
   {
      ...
      else
      {
         ...
         zr_boost_1_81::movelib::rotate_gcd(rit, this->begin() + old_size, this->begin() + this->size());
         return rit;
      }
   }
   ...
   */
   iterator erase(iterator first, iterator last)
   {
      ...
      size_type n = zr_boost_1_81::container::iterator_udistance(first, last);

      if (front_distance < back_distance)
      {
            // move n to the right
            zr_boost_1_81::container::move_backward(begin(), first, last);

            for (iterator i = begin(); i != begin() + n; ++i)
            {
               allocator_traits_type::destroy(get_allocator_ref(), zr_boost_1_81::movelib::to_raw_pointer(i));
            }
            ...
            // move n to the left
            zr_boost_1_81::container::move(last, end(), first);
   ...
   */
                                 ...
                                 || allocator_traits_type::is_always_equal::value)
   {
      ...
      // swap indices
      zr_boost_1_81::adl_move_swap(m_.front_idx, b.m_.front_idx);
      zr_boost_1_81::adl_move_swap(m_.back_idx, b.m_.back_idx);
   ...
   */
   ...
   {
      return zr_boost_1_81::intrusive::pointer_traits<pointer>::const_cast_from(i);
   }
   ...
   {   return zr_boost_1_81::movelib::to_raw_pointer(m_.buffer) + m_.back_idx;    }


   template <class U>
   BOOST_CONTAINER_FORCEINLINE void priv_push_front(BOOST_FWD_REF(U) u)
   {
      this->emplace_front(zr_boost_1_81::forward<U>(u));
   }
   ...
   {
      return this->emplace(pos, zr_boost_1_81::forward<U>(u));
   }
   ...
   void destroy_elements(pointer begin, pointer end)
   {
      for (; begin != end; ++begin)
      {
         allocator_traits_type::destroy(get_allocator_ref(), zr_boost_1_81::movelib::to_raw_pointer(begin));
      }
   }
   ...
   BOOST_CONTAINER_FORCEINLINE void alloc_construct(pointer dst, Args&&... args)
   {
      allocator_traits_type::construct(
            get_allocator_ref(),
            zr_boost_1_81::movelib::to_raw_pointer(dst),
   ...
   void construct_n(pointer buffer, size_type n, Args&&... args)
   {
      ...
      guarded_construct_n(buffer, n, ctr_guard, zr_boost_1_81::forward<Args>(args)...);
      ctr_guard.release();
   }
   ...
   void guarded_construct_n(pointer buffer, size_type n, detail::construction_guard<allocator_type>& ctr_guard, Args&&... args)
   {
      for (size_type i = 0; i < n; ++i) {
         this->alloc_construct(buffer + i, zr_boost_1_81::forward<Args>(args)...);
         ctr_guard.extend();
      }
   }
   ...
   {\
      allocator_traits_type::construct(\
            get_allocator_ref(), zr_boost_1_81::movelib::to_raw_pointer(dst) BOOST_MOVE_I##N BOOST_MOVE_FWD##N );\
   }\
   \
   BOOST_MOVE_TMPL_LT##N BOOST_MOVE_CLASS##N BOOST_MOVE_GT##N \
   ...
   size_type calculate_new_capacity(size_type requested_capacity)
   {
      ...
      if ( remaining_additional_cap < min_additional_cap )
            zr_boost_1_81::container::throw_length_error("devector: get_next_capacity, max size exceeded");
   ...
   void opt_move_or_copy(pointer begin, pointer end, pointer dst, Guard& guard)
   {
      ...
      zr_boost_1_81::container::uninitialized_move_alloc(get_allocator_ref(), begin, end, dst);
      guard.extend();
   }
   ...
   void resize_impl(size_type sz, Args&&... args)
   {
      ...
      if (sz > old_sz)
      {
         ...
         if (sz <= m_.capacity)
         {
            ...
            construct_n(m_.buffer + m_.back_idx, b, zr_boost_1_81::forward<Args>(args)...);
            m_.set_back_idx(m_.back_idx + b);

            //Construct remaining at front
            const size_type f = n - b;
            construct_n(m_.buffer + m_.front_idx - f, f, zr_boost_1_81::forward<Args>(args)...);
            m_.set_front_idx(m_.front_idx - f);
         }
         else
         {
            resize_back_slow_path(sz, n, zr_boost_1_81::forward<Args>(args)...);
         }
      }
      else
      {
   ...
   void resize_front_impl(size_type sz , Args&&... args)
   {
      ...
      if (sz > old_sz)
      {
         ...
         {
            construct_n(m_.buffer + m_.front_idx - n, n, zr_boost_1_81::forward<Args>(args)...);
            m_.set_front_idx(m_.front_idx - n);
         }
         else
         {
            resize_front_slow_path(sz, n, zr_boost_1_81::forward<Args>(args)...);
         }
      }
      else {
         const size_type n = old_sz - sz;
   ...
   void resize_front_slow_path(size_type sz, size_type n, Args&&... args)
   {
      ...
      guarded_construct_n(new_buffer + new_elem_index, n, guard, zr_boost_1_81::forward<Args>(args)...);
   ...
   void resize_back_impl(size_type sz, Args&&... args)
   {
      ...
      if (sz > old_sz)
      {
         ...
         {
            construct_n(m_.buffer + m_.back_idx, n, zr_boost_1_81::forward<Args>(args)...);
            m_.set_back_idx(m_.back_idx + n);
         }
         else
         {
   ...
   void resize_back_slow_path(size_type sz, size_type n, Args&&... args)
   {
      ...
      guarded_construct_n(new_buffer + m_.back_idx, n, guard, zr_boost_1_81::forward<Args>(args)...);
   ...
   void reallocate_at(size_type new_capacity, size_type buffer_offset)
   {
      ...
      {
         allocation_guard new_buffer_guard(new_buffer, new_capacity, get_allocator_ref());
         zr_boost_1_81::container::uninitialized_move_alloc(get_allocator_ref(), this->begin(), this->end(), new_buffer + buffer_offset);
         new_buffer_guard.release();
      }
      destroy_elements(m_.buffer + m_.front_idx, m_.buffer + m_.back_idx);
      deallocate_buffer();
   ...
   iterator insert_range(const_iterator position, ForwardIterator first, ForwardIterator last)
   {
      ...
      size_type const n = zr_boost_1_81::container::iterator_udistance(first, last);
      bool prefer_move_back;
      if (BOOST_UNLIKELY(!n)) {
         ...
         {
            iterator r(this->end());
            zr_boost_1_81::container::uninitialized_copy_alloc(get_allocator_ref(), first, last, this->priv_raw_end());
            m_.set_back_idx(m_.back_idx + n);
            return r;
         }
         prefer_move_back = true;
         ...
         if(front_free_capacity() >= n) {// secondary fast path
            zr_boost_1_81::container::uninitialized_copy_alloc(get_allocator_ref(), first, last, this->priv_raw_begin() - n);
            m_.set_front_idx(m_.front_idx - n);
            return begin();
         }
         prefer_move_back = false;
      ...
      (const_iterator p, const size_type n, const InsertionProxy proxy)
   {
      ...
      if (free_cap >= n && (free_cap - n) >= cap/devector_min_free_fraction) {
         ...
         T* const raw_pos = const_cast<T*>(zr_boost_1_81::movelib::to_raw_pointer(p));
         ...
         m_.back_idx = 0u;
         m_.front_idx = 0u;
         zr_boost_1_81::container::expand_backward_forward_and_insert_alloc
         ...
         T* const raw_pos = const_cast<T*>(zr_boost_1_81::movelib::to_raw_pointer(p));
         T* const raw_new_start = const_cast<T*>(zr_boost_1_81::movelib::to_raw_pointer(new_buffer)) + new_front_index;
   ...
   {
      allocation_guard buffer_guard(m_.buffer, m_.capacity, get_allocator_ref());
      zr_boost_1_81::container::uninitialized_copy_alloc(get_allocator_ref(), begin, end, m_.buffer);
      buffer_guard.release();
   }
   ...
   void allocate_and_copy_range(ForwardIterator first, ForwardIterator last)
   {
      ...
      zr_boost_1_81::container::uninitialized_copy_alloc(get_allocator_ref(), first, last, new_buffer);
      destroy_elements(begin(), end());
      deallocate_buffer();
   ...
   {
      zr_boost_1_81::adl_move_swap(a.m_.capacity, b.m_.capacity);
      zr_boost_1_81::adl_move_swap(a.m_.buffer, b.m_.buffer);
   }
   ...
   void overwrite_buffer_impl(ForwardIterator first, ForwardIterator last, dtl::true_)
   {
      ...
      zr_boost_1_81::container::uninitialized_copy_alloc_n
            ...
            , n, zr_boost_1_81::movelib::to_raw_pointer(m_.buffer));
      m_.front_idx = 0;
      m_.set_back_idx(n);
   }
...
struct has_trivial_destructor_after_move<zr_boost_1_81::container::devector<T, Allocator, Options> >
{
    typedef typename zr_boost_1_81::container::devector<T, Allocator, Options>::allocator_type allocator_type;
