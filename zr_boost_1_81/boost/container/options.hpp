...
struct tree_opt
{
   static const zr_boost_1_81::container::tree_type_enum tree_type = TreeType;
...
//! by \c zr_boost_1_81::container::set, \c zr_boost_1_81::container::multiset
//! \c zr_boost_1_81::container::map and \c zr_boost_1_81::container::multimap.
//! Supported options are: \c zr_boost_1_81::container::optimize_size and \c zr_boost_1_81::container::tree_type
...
{
   /// @cond
   typedef typename ::zr_boost_1_81::intrusive::pack_options
      < tree_assoc_defaults,
...
template<class ...Options>
using tree_assoc_options_t = typename zr_boost_1_81::container::tree_assoc_options<Options...>::type;
...
//! Helper metafunction to combine options into a single type to be used
//! by \c zr_boost_1_81::container::hash_set, \c zr_boost_1_81::container::hash_multiset
//! \c zr_boost_1_81::container::hash_map and \c zr_boost_1_81::container::hash_multimap.
//! Supported options are: \c zr_boost_1_81::container::store_hash
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
template<class ...Options>
using hash_assoc_options_t = typename zr_boost_1_81::container::hash_assoc_options<Options...>::type;
...
//!\c zr_boost_1_81::container::growth_factor_50
//!\c zr_boost_1_81::container::growth_factor_60
//!\c zr_boost_1_81::container::growth_factor_100
//!
...
//! Helper metafunction to combine options into a single type to be used
//! by \c zr_boost_1_81::container::vector.
//! Supported options are: \c zr_boost_1_81::container::growth_factor and \c zr_boost_1_81::container::stored_size
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
//! Supported options are: \c zr_boost_1_81::container::growth_factor and \c zr_boost_1_81::container::stored_size
template<class ...Options>
using vector_options_t = typename zr_boost_1_81::container::vector_options<Options...>::type;
...
//! Helper metafunction to combine options into a single type to be used
//! by \c zr_boost_1_81::container::small_vector.
//! Supported options are: \c zr_boost_1_81::container::growth_factor and \c zr_boost_1_81::container::inplace_alignment
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
//! Supported options are: \c zr_boost_1_81::container::growth_factor and \c zr_boost_1_81::container::stored_size
template<class ...Options>
using small_vector_options_t = typename zr_boost_1_81::container::small_vector_options<Options...>::type;
...
//! Helper metafunction to combine options into a single type to be used
//! by \c zr_boost_1_81::container::static_vector.
//! Supported options are: \c zr_boost_1_81::container::throw_on_overflow and \c zr_boost_1_81::container::inplace_alignment
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
//! Supported options are: \c zr_boost_1_81::container::growth_factor and \c zr_boost_1_81::container::stored_size
template<class ...Options>
using static_vector_options_t = typename zr_boost_1_81::container::static_vector_options<Options...>::type;
...
//!\c zr_boost_1_81::container::relocate_on_66
//!\c zr_boost_1_81::container::relocate_on_75
//!\c zr_boost_1_81::container::relocate_on_80
//!\c zr_boost_1_81::container::relocate_on_85
//!\c zr_boost_1_81::container::relocate_on_90
//!
//!If this option is not specified, a default will be used by the container.
//!
...
//! Helper metafunction to combine options into a single type to be used
//! by \c zr_boost_1_81::container::devector.
//! Supported options are: \c zr_boost_1_81::container::growth_factor, \c zr_boost_1_81::container::stored_size
//! and \c zr_boost_1_81::container::relocate_on
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
//! Supported options are: \c zr_boost_1_81::container::growth_factor and \c zr_boost_1_81::container::stored_size
template<class ...Options>
using devector_options_t = typename zr_boost_1_81::container::devector_options<Options...>::type;
...
//! Helper metafunction to combine options into a single type to be used
//! by \c zr_boost_1_81::container::deque.
//! Supported options are: \c zr_boost_1_81::container::block_bytes
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
//! Supported options are: \c zr_boost_1_81::container::block_bytes
template<class ...Options>
using deque_options_t = typename zr_boost_1_81::container::deque_options<Options...>::type;
