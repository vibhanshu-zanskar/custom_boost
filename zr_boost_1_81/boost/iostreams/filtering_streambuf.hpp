...
#define BOOST_IOSTREAMS_DEFINE_FILTER_STREAMBUF(name_, chain_type_, default_char_) \
    ...
    class name_ : public zr_boost_1_81::iostreams::detail::chainbuf< \
    ...
    /**/ 
BOOST_IOSTREAMS_DEFINE_FILTER_STREAMBUF(filtering_streambuf, zr_boost_1_81::iostreams::chain, char)
BOOST_IOSTREAMS_DEFINE_FILTER_STREAMBUF(filtering_wstreambuf, zr_boost_1_81::iostreams::chain, wchar_t)
