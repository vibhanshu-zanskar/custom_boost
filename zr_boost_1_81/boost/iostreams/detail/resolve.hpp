...
struct resolve_traits {
    typedef typename 
            mpl::if_<
                zr_boost_1_81::detail::is_incrementable<T>,
...
range_adapter< Mode, zr_boost_1_81::iterator_range<Iter> >
resolve(const zr_boost_1_81::iterator_range<Iter>& rng)
{ return range_adapter< Mode, zr_boost_1_81::iterator_range<Iter> >(rng); }
