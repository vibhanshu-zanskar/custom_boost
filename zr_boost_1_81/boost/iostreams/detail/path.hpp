 ...
 *
 * Defines the class zr_boost_1_81::iostreams::detail::path, for storing a 
...
namespace zr_boost_1_81 { namespace iostreams { namespace detail {
...
public:
    ...
    // Constructor taking a zr_boost_1_81::filesystem2::path or
    // zr_boost_1_81::filesystem2::wpath
    ...
    // Constructor taking a zr_boost_1_81::filesystem3::path (boost filesystem v3)
    template<typename Path>
    ...
    // Assignment operator taking a zr_boost_1_81::filesystem2::path or
    // zr_boost_1_81::filesystem2::wpath
    ...
    // Assignment operator taking a zr_boost_1_81::filesystem3::path
    template<typename Path>
...
private:
    ...
    // For wide-character paths, use a zr_boost_1_81::filesystem::wpath instead of a
    // std::wstring
