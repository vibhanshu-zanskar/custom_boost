...
# define BOOST_IOSTREAMS_ENABLE_IF_STREAM(T) \
    , typename zr_boost_1_81::enable_if< zr_boost_1_81::iostreams::is_std_io<T> >::type* = 0 \
    /**/
# define BOOST_IOSTREAMS_DISABLE_IF_STREAM(T) \
    , typename zr_boost_1_81::disable_if< zr_boost_1_81::iostreams::is_std_io<T> >::type* = 0 \
    /**/
#else 
# define BOOST_IOSTREAMS_ENABLE_IF_STREAM(T)
# define BOOST_IOSTREAMS_DISABLE_IF_STREAM(T)
