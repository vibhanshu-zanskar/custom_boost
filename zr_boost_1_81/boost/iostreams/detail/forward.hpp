...
#define BOOST_IOSTREAMS_FORWARD(class, impl, device, params, args) \
    ...
    { this->impl(::zr_boost_1_81::iostreams::detail::wrap(t) args()); } \
    class(device& t params()) \
    { this->impl(::zr_boost_1_81::iostreams::detail::wrap(t) args()); } \
    class(const ::zr_boost_1_81::reference_wrapper<device>& ref params()) \
    { this->impl(ref args()); } \
    void open(const device& t params()) \
    { this->impl(::zr_boost_1_81::iostreams::detail::wrap(t) args()); } \
    void open(device& t params()) \
    { this->impl(::zr_boost_1_81::iostreams::detail::wrap(t) args()); } \
    void open(const ::zr_boost_1_81::reference_wrapper<device>& ref params()) \
    { this->impl(ref args()); } \
...
# define BOOST_IOSTREAMS_DISABLE_IF_SAME(device, param) \
    , typename zr_boost_1_81::disable_if< zr_boost_1_81::is_same<device, param> >::type* = 0 \
    /**/
#else 
# define BOOST_IOSTREAMS_DISABLE_IF_SAME(device, param)
#endif
