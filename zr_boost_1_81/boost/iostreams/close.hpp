...
{ 
    try {
        zr_boost_1_81::iostreams::close(t, BOOST_IOS::in);
    } catch (...) {
        try {
            zr_boost_1_81::iostreams::close(t, BOOST_IOS::out);
        } catch (...) { }
        throw;
    }
    zr_boost_1_81::iostreams::close(t, BOOST_IOS::out);
...
{ 
    try {
        zr_boost_1_81::iostreams::close(t, snk, BOOST_IOS::in);
    } catch (...) {
        try {
            zr_boost_1_81::iostreams::close(t, snk, BOOST_IOS::out);
        } catch (...) { }
        throw;
    }
    zr_boost_1_81::iostreams::close(t, snk, BOOST_IOS::out);
