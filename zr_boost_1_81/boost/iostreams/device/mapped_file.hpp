...
// zr_boost_1_81::filesystem::path, zr_boost_1_81::filesystem::wpath, 
// and zr_boost_1_81::iostreams::detail::path (used to store either a std::string or a
// std::wstring).
    ...
    : detail::mapped_file_params_base 
{
    ...
    // with zr_boost_1_81::filesystem::wpath
...
private:
    ...
    friend struct zr_boost_1_81::iostreams::operations<mapped_file_source>;
public:
    ...
    explicit mapped_file_source( const Path& path,
                                 ...
                                 zr_boost_1_81::intmax_t offset = 0 );
...
private:
    ...
    zr_boost_1_81::shared_ptr<impl_type> pimpl_;
};
...
private:
    ...
    typedef basic_mapped_file_params<detail::path>  param_type;
    friend struct zr_boost_1_81::iostreams::operations<mapped_file >;
...
public:
    friend struct zr_boost_1_81::iostreams::operations<mapped_file_sink>;
...
mapped_file_source::mapped_file_source( 
    const Path& path, size_type length, zr_boost_1_81::intmax_t offset)
...
void mapped_file_source::open(const basic_mapped_file_params<Path>& p)
{
    ...
    if (params.flags) {
        if (params.flags != mapped_file::readonly)
            zr_boost_1_81::throw_exception(BOOST_IOSTREAMS_FAILURE("invalid flags"));
    } else {
        if (params.mode & BOOST_IOS::out)
            zr_boost_1_81::throw_exception(BOOST_IOSTREAMS_FAILURE("invalid mode"));
...
mapped_file_sink::mapped_file_sink(
    ...
    zr_boost_1_81::intmax_t offset, mapmode flags )
...
struct operations<mapped_file_source>
    : zr_boost_1_81::iostreams::detail::close_impl<closable_tag>
{
