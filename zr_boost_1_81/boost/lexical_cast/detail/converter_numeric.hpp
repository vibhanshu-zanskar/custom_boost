...
struct detect_precision_loss
{
    ...
    typedef zr_boost_1_81::numeric::Trunc<Source> Rounder;
    typedef BOOST_DEDUCED_TYPENAME conditional<
        zr_boost_1_81::is_arithmetic<Source>::value, Source, Source const&
    >::type argument_type ;
...
{
    inline bool operator() ( zr_boost_1_81::numeric::range_check_result r ) const BOOST_NOEXCEPT {
        return (r == zr_boost_1_81::numeric::cInRange);
    }
};

template <typename Target, typename Source>
inline bool noexcept_numeric_convert(const Source& arg, Target& result) BOOST_NOEXCEPT {
    typedef zr_boost_1_81::numeric::converter<
            Target,
            Source,
            zr_boost_1_81::numeric::conversion_traits<Target, Source >,
            nothrow_overflow_handler,
            detect_precision_loss<Source >
    > converter_orig_t;

    typedef BOOST_DEDUCED_TYPENAME zr_boost_1_81::conditional<
        zr_boost_1_81::is_base_of< detect_precision_loss<Source >, converter_orig_t >::value,
        converter_orig_t,
...
struct lexical_cast_dynamic_num_ignoring_minus
{
    static inline bool try_convert(const Source &arg, Target& result) BOOST_NOEXCEPT {
        typedef BOOST_DEDUCED_TYPENAME zr_boost_1_81::conditional<
                zr_boost_1_81::is_float<Source>::value,
                zr_boost_1_81::type_identity<Source>,
                zr_boost_1_81::make_unsigned<Source>
        >::type usource_lazy_t;
 ...
 *
 *
 * Rule 2) required because zr_boost_1_81::lexical_cast has the behavior of
...
{
    typedef BOOST_DEDUCED_TYPENAME zr_boost_1_81::remove_volatile<Source>::type source_type;

    static inline bool try_convert(source_type arg, Target& result) BOOST_NOEXCEPT {
        typedef BOOST_DEDUCED_TYPENAME zr_boost_1_81::conditional<
            zr_boost_1_81::is_unsigned<Target>::value &&
            (zr_boost_1_81::is_signed<source_type>::value || zr_boost_1_81::is_float<source_type>::value) &&
            !(zr_boost_1_81::is_same<source_type, bool>::value) &&
            !(zr_boost_1_81::is_same<Target, bool>::value),
