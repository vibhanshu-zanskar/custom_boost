...
#       error "zr_boost_1_81::lexical_cast to use only 'C' locale during conversions."
#   endif
#endif
...
namespace zr_boost_1_81 {
    ...
    namespace detail // optimized stream wrappers
    {
        template< class CharT // a result of widest_char transformation
                ...
                >
        class lexical_istream_limited_src: zr_boost_1_81::noncopyable {
...
/************************************ HELPER FUNCTIONS FOR OPERATORS << ( ... ) ********************************/
            ...
            bool shl_char(T ch) {
                BOOST_STATIC_ASSERT_MSG(( sizeof(T) <= sizeof(CharT)) ,
                    "zr_boost_1_81::lexical_cast does not support narrowing of char types."
                    "Use zr_boost_1_81::locale instead" );
#ifndef BOOST_LEXICAL_CAST_ASSUME_C_LOCALE
                std::locale loc;
            ...
            bool shl_input_streamable(InputStreamable& input) {
                ...
                BOOST_STATIC_ASSERT((zr_boost_1_81::is_same<char, CharT>::value));
#endif
            ...
            inline bool shl_signed(const T n) {
                CharT* tmp_finish = buffer + CharacterBufferSize;
                typedef BOOST_DEDUCED_TYPENAME zr_boost_1_81::make_unsigned<T>::type utype;
            ...
            bool shl_real_type(float val, char* begin) {
                ...
                finish = start +
                    ...
                    sprintf(begin,
#endif
                    "%.*g", static_cast<int>(zr_boost_1_81::detail::lcast_get_precision<float>()), val_as_double);
                return finish > start;
            }
            ...
            bool shl_real_type(double val, char* begin) {
                ...
                finish = start +
                    ...
                    sprintf(begin,
#endif
                    "%.*g", static_cast<int>(zr_boost_1_81::detail::lcast_get_precision<double>()), val);
                return finish > start;
            }
            ...
            bool shl_real_type(long double val, char* begin) {
                ...
                finish = start +
                    ...
                    sprintf(begin,
#endif
                    "%.*Lg", static_cast<int>(zr_boost_1_81::detail::lcast_get_precision<long double>()), val );
                return finish > start;
            }
#endif
            ...
            bool shl_real_type(float val, wchar_t* begin) {
                ...
                finish = start + swprintf(begin, CharacterBufferSize,
                                       L"%.*g",
                                       static_cast<int>(zr_boost_1_81::detail::lcast_get_precision<float >()),
                                       val_as_double );
                return finish > start;
            }
            ...
            bool shl_real_type(double val, wchar_t* begin) {
                using namespace std;
                finish = start + swprintf(begin, CharacterBufferSize,
                                          L"%.*g", static_cast<int>(zr_boost_1_81::detail::lcast_get_precision<double >()), val );
                return finish > start;
            }
            ...
            bool shl_real_type(long double val, wchar_t* begin) {
                using namespace std;
                finish = start + swprintf(begin, CharacterBufferSize,
                                          L"%.*Lg", static_cast<int>(zr_boost_1_81::detail::lcast_get_precision<long double >()), val );
                return finish > start;
            }
#endif
            template <class T>
...
/************************************ OPERATORS << ( ... ) ********************************/
        public:
            ...
            template<class Alloc>
            bool operator<<(zr_boost_1_81::container::basic_string<CharT,Traits,Alloc> const& str) BOOST_NOEXCEPT {
                start = str.data();
                finish = start + str.length();
                return true;
            }
            ...
            template <class C>
            BOOST_DEDUCED_TYPENAME zr_boost_1_81::disable_if<zr_boost_1_81::is_const<C>, bool>::type
            ...
            bool operator<<(zr_boost_1_81::ulong_long_type n)   { return shl_unsigned(n); }
            bool operator<<(zr_boost_1_81::long_long_type n)    { return shl_signed(n); }
            ...
            bool operator<<(const zr_boost_1_81::uint128_type& n)   { return shl_unsigned(n); }
            bool operator<<(const zr_boost_1_81::int128_type& n)    { return shl_signed(n); }
#endif
            ...
            BOOST_DEDUCED_TYPENAME zr_boost_1_81::disable_if<zr_boost_1_81::is_const<C>, bool>::type
            operator<<(zr_boost_1_81::array<C, N> const& input) BOOST_NOEXCEPT {
                BOOST_STATIC_ASSERT_MSG(
                    (sizeof(zr_boost_1_81::array<const C, N>) == sizeof(zr_boost_1_81::array<C, N>)),
                    "zr_boost_1_81::array<C, N> and zr_boost_1_81::array<const C, N> must have exactly the same layout."
                );
                return ((*this) << reinterpret_cast<zr_boost_1_81::array<const C, N> const& >(input));
            }

            template <std::size_t N>
            bool operator<<(zr_boost_1_81::array<const CharT, N> const& input) BOOST_NOEXCEPT {
                return shl_char_array_limited(input.data(), N);
            }

            template <std::size_t N>
            bool operator<<(zr_boost_1_81::array<const unsigned char, N> const& input) BOOST_NOEXCEPT {
                return ((*this) << reinterpret_cast<zr_boost_1_81::array<const char, N> const& >(input));
            }

            template <std::size_t N>
            bool operator<<(zr_boost_1_81::array<const signed char, N> const& input) BOOST_NOEXCEPT {
                return ((*this) << reinterpret_cast<zr_boost_1_81::array<const char, N> const& >(input));
            }
            ...
            bool operator<<(std::array<C, N> const& input) BOOST_NOEXCEPT {
                BOOST_STATIC_ASSERT_MSG(
                    (sizeof(std::array<C, N>) == sizeof(zr_boost_1_81::array<C, N>)),
                    "std::array and zr_boost_1_81::array must have exactly the same layout. "
                    "Bug in implementation of std::array or zr_boost_1_81::array."
                );
                return ((*this) << reinterpret_cast<zr_boost_1_81::array<C, N> const& >(input));
            }
#endif
        ...
        template <class CharT, class Traits>
        class lexical_ostream_limited_src: zr_boost_1_81::noncopyable {
...
/************************************ HELPER FUNCTIONS FOR OPERATORS >> ( ... ) ********************************/
        private:
            ...
            {
                BOOST_STATIC_ASSERT_MSG(
                    (!zr_boost_1_81::is_pointer<InputStreamable>::value),
                    "zr_boost_1_81::lexical_cast can not convert to pointers"
                );

#if defined(BOOST_NO_STRINGSTREAM) || defined(BOOST_NO_STD_LOCALE)
                BOOST_STATIC_ASSERT_MSG((zr_boost_1_81::is_same<char, CharT>::value),
                    "zr_boost_1_81::lexical_cast can not convert, because your STL library does not "
            ...
            inline bool shr_xchar(T& output) BOOST_NOEXCEPT {
                BOOST_STATIC_ASSERT_MSG(( sizeof(CharT) == sizeof(T) ),
                    "zr_boost_1_81::lexical_cast does not support narrowing of character types."
                    "Use zr_boost_1_81::locale instead" );
...
/************************************ OPERATORS >> ( ... ) ********************************/
        public:
...
#if defined(BOOST_HAS_LONG_LONG)
            bool operator>>(zr_boost_1_81::ulong_long_type& output)     { return shr_unsigned(output); }
            bool operator>>(zr_boost_1_81::long_long_type& output)      { return shr_signed(output); }
#elif defined(BOOST_HAS_MS_INT64)
...
#ifdef BOOST_HAS_INT128
            bool operator>>(zr_boost_1_81::uint128_type& output)        { return shr_unsigned(output); }
            bool operator>>(zr_boost_1_81::int128_type& output)         { return shr_signed(output); }
#endif
            ...
            template<class Alloc>
            bool operator>>(zr_boost_1_81::container::basic_string<CharT,Traits,Alloc>& str) {
                str.assign(start, finish); return true;
            }

            template <std::size_t N>
            bool operator>>(zr_boost_1_81::array<CharT, N>& output) BOOST_NOEXCEPT {
                return shr_std_array<N>(output);
            }

            template <std::size_t N>
            bool operator>>(zr_boost_1_81::array<unsigned char, N>& output) BOOST_NOEXCEPT {
                return ((*this) >> reinterpret_cast<zr_boost_1_81::array<char, N>& >(output));
            }

            template <std::size_t N>
            bool operator>>(zr_boost_1_81::array<signed char, N>& output) BOOST_NOEXCEPT {
                return ((*this) >> reinterpret_cast<zr_boost_1_81::array<char, N>& >(output));
            }
            ...
            bool operator>>(std::array<C, N>& output) BOOST_NOEXCEPT {
                BOOST_STATIC_ASSERT_MSG(
                    (sizeof(std::array<C, N>) == sizeof(zr_boost_1_81::array<C, N>)),
                    "std::array<C, N> and zr_boost_1_81::array<C, N> must have exactly the same layout."
                );
                return ((*this) >> reinterpret_cast<zr_boost_1_81::array<C, N>& >(output));
            }
#endif
