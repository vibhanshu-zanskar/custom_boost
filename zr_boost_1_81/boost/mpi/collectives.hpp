...
/**
 *  @brief Similar to zr_boost_1_81::mpi::gather with the difference that the number
...
/**
 *  @brief Similar to zr_boost_1_81::mpi::scatter with the difference that the number
