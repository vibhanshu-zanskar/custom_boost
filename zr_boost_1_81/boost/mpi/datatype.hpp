...
struct is_mpi_integer_datatype
  : public zr_boost_1_81::mpl::false_ { };
...
struct is_mpi_builtin_datatype
  : zr_boost_1_81::mpl::or_<is_mpi_integer_datatype<T>,
...
BOOST_MPI_DATATYPE(zr_boost_1_81::archive::library_version_type, get_mpi_datatype(uint_least16_t()), integer);
BOOST_MPI_DATATYPE(zr_boost_1_81::archive::version_type, get_mpi_datatype(uint_least8_t()), integer);
BOOST_MPI_DATATYPE(zr_boost_1_81::archive::class_id_type, get_mpi_datatype(int_least16_t()), integer);
BOOST_MPI_DATATYPE(zr_boost_1_81::archive::class_id_reference_type, get_mpi_datatype(int_least16_t()), integer);
BOOST_MPI_DATATYPE(zr_boost_1_81::archive::class_id_optional_type, get_mpi_datatype(int_least16_t()), integer);
BOOST_MPI_DATATYPE(zr_boost_1_81::archive::object_id_type, get_mpi_datatype(uint_least32_t()), integer);
BOOST_MPI_DATATYPE(zr_boost_1_81::archive::object_reference_type, get_mpi_datatype(uint_least32_t()), integer);
BOOST_MPI_DATATYPE(zr_boost_1_81::archive::tracking_type, get_mpi_datatype(bool()), builtin);
BOOST_MPI_DATATYPE(zr_boost_1_81::serialization::collection_size_type, get_mpi_datatype(std::size_t()), integer);
BOOST_MPI_DATATYPE(zr_boost_1_81::serialization::item_version_type, get_mpi_datatype(uint_least8_t()), integer);
#endif // Doxygen
