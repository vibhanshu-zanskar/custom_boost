...
namespace zr_boost_1_81 { namespace python { namespace api {    \
...
namespace detail {
  ...
  {
  public:
    typedef zr_boost_1_81::function3<void, OArchiver&, const object&, const unsigned int>
      saver_t;
    typedef zr_boost_1_81::function3<void, IArchiver&, object&, const unsigned int>
      loader_t;
...
void 
save_impl(Archiver& ar, const zr_boost_1_81::python::object& obj, 
          const unsigned int /*version*/,
          mpl::false_ /*has_direct_serialization*/)
{
  zr_boost_1_81::python::object bytes = zr_boost_1_81::python::pickle::dumps(obj);
  int   sz    = PyBytes_Size(bytes.ptr());
  char *data  = PyBytes_AsString(bytes.ptr());  
  ar << sz << zr_boost_1_81::serialization::make_array(data, sz);
}
...
template<typename Archiver>
void 
load_impl(Archiver& ar, zr_boost_1_81::python::object& obj, 
          const unsigned int /*version*/, 
          mpl::false_ /*has_direct_serialization*/)
{
  int len;
  ar >> len;
  zr_boost_1_81::scoped_array<char> data(new char[len]);
  ar >> zr_boost_1_81::serialization::make_array(data.get(), len);
  zr_boost_1_81::python::object bytes(zr_boost_1_81::python::handle<>(PyBytes_FromStringAndSize(data.get(), len)));
  obj = zr_boost_1_81::python::pickle::loads(bytes);
}
...
template<typename Archiver>
void 
save(Archiver& ar, const zr_boost_1_81::python::object& obj, 
     const unsigned int version)
{
  typedef Archiver OArchiver;
  typedef typename input_archiver<OArchiver>::type IArchiver;
...
template<typename Archiver>
void 
load(Archiver& ar, zr_boost_1_81::python::object& obj, 
     const unsigned int version)
{
  typedef Archiver IArchiver;
  typedef typename output_archiver<IArchiver>::type OArchiver;
...
inline void 
serialize(Archive& ar, zr_boost_1_81::python::object& obj, const unsigned int version)
{
  zr_boost_1_81::serialization::split_free(ar, obj, version);
}

} } // end namespace zr_boost_1_81::python
...
BOOST_PYTHON_DIRECT_SERIALIZATION_ARCHIVE(
  ::zr_boost_1_81::mpi::packed_iarchive,
  ::zr_boost_1_81::mpi::packed_oarchive)
...
{
  using zr_boost_1_81::python::register_serialized;
