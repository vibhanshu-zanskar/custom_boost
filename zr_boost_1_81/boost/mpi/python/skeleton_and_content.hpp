 ...
 */
class content : public zr_boost_1_81::mpi::content
{
  typedef zr_boost_1_81::mpi::content inherited;

 public:
  content(const inherited& base, zr_boost_1_81::python::object object) 
    : inherited(base), object(object) { }

  inherited&       base()       { return *this; }
  const inherited& base() const { return *this; }

  zr_boost_1_81::python::object object;
};
...
{
public:
  skeleton_proxy_base(const zr_boost_1_81::python::object& object) : object(object) { }
...
{
 public:
  skeleton_proxy(const zr_boost_1_81::python::object& object) 
    : skeleton_proxy_base(object) { }
};

namespace detail {
  using zr_boost_1_81::python::object;
  using zr_boost_1_81::python::extract;
   
  extern BOOST_MPI_DECL zr_boost_1_81::python::object skeleton_proxy_base_type;
  ...
  struct do_get_content
  {
    content operator()(object value_obj) {
      ...
      return content(zr_boost_1_81::mpi::get_content(value), value_obj);
    }
  };
...
{
  using zr_boost_1_81::python::detail::direct_serialization_table;
  using zr_boost_1_81::python::detail::get_direct_serialization_table;
  ...
  {
    zr_boost_1_81::python::scope proxy_scope(detail::skeleton_proxy_base_type);
