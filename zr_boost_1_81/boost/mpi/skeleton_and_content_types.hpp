...
namespace detail {
  ...
  class BOOST_MPI_DECL mpi_datatype_holder : public zr_boost_1_81::noncopyable
  {
  public:
    mpi_datatype_holder()
     : is_committed(false)
...
private:
  zr_boost_1_81::shared_ptr<detail::mpi_datatype_holder> holder;
};
...
public:
  ...
  explicit packed_skeleton_iarchive(packed_iarchive & archive)
         ...
         , skeleton_archive_(MPI_COMM_WORLD, zr_boost_1_81::archive::no_header)
        {}
