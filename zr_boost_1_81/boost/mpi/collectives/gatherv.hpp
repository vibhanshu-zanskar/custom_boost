...
gatherv(const communicator& comm, const std::vector<T>& in_values,
        ...
        int root)
{
  ::zr_boost_1_81::mpi::gatherv(comm, detail::c_data(in_values), in_values.size(), out_values, sizes, displs, root);
}
        ...
        T* out_values, const std::vector<int>& sizes, int root)
{
  ...
  ::zr_boost_1_81::mpi::gatherv(comm, in_values, in_size, out_values, sizes, displs, root);
}
...
gatherv(const communicator& comm, const std::vector<T>& in_values,
        T* out_values, const std::vector<int>& sizes, int root)
{
  ::zr_boost_1_81::mpi::gatherv(comm, detail::c_data(in_values), in_values.size(), out_values, sizes, root);
}
