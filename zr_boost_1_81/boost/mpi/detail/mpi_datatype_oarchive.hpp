...
namespace zr_boost_1_81 { namespace mpi { namespace detail {
...
public:
    ...
    {
      save_enum(t,zr_boost_1_81::is_enum<T>());
    }
    ...
    void save_enum(T const& t, mpl::true_)
    {
      ...
      typedef typename zr_boost_1_81::uint_t<8*sizeof(T)>::least int_type;
...
} } } // end namespace zr_boost_1_81::mpi::detail

// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(zr_boost_1_81::mpi::detail::mpi_datatype_oarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(zr_boost_1_81::mpi::detail::ignore_skeleton_oarchive<zr_boost_1_81::mpi::detail::mpi_datatype_oarchive>)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(zr_boost_1_81::mpi::detail::mpi_datatype_oarchive)
