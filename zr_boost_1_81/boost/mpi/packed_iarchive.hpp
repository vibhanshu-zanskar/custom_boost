...
public:
  ...
  packed_iarchive(MPI_Comm const & comm, buffer_type & b, unsigned int flags = zr_boost_1_81::archive::no_header, int position = 0)
  ...
  packed_iarchive
          ( MPI_Comm const & comm , std::size_t s=0,
           unsigned int flags = zr_boost_1_81::archive::no_header)
...
BOOST_SERIALIZATION_REGISTER_ARCHIVE(zr_boost_1_81::mpi::packed_iarchive)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(zr_boost_1_81::mpi::packed_iarchive)
