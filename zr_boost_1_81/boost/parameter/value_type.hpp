...
namespace zr_boost_1_81 { namespace parameter { 
    ...
    struct value_type0
    {
        ...
        using type = ::zr_boost_1_81::mp11::mp_apply_q<
          ...
          , ::zr_boost_1_81::mp11::mp_list<Keyword,Default,::zr_boost_1_81::mp11::mp_false>
        >;

        static_assert(
            ::zr_boost_1_81::mp11::mp_if<
                ::std::is_same<Default,::zr_boost_1_81::parameter::void_>
              , ::zr_boost_1_81::mp11::mp_if<
                    ::std::is_same<type,::zr_boost_1_81::parameter::void_>
        ...
        BOOST_MPL_ASSERT((
            typename ::zr_boost_1_81::mpl::eval_if<
                ::zr_boost_1_81::is_same<Default,::zr_boost_1_81::parameter::void_>
              , ::zr_boost_1_81::mpl::if_<
                    ::zr_boost_1_81::is_same<type,::zr_boost_1_81::parameter::void_>
                  , ::zr_boost_1_81::mpl::false_
...
namespace zr_boost_1_81 { namespace parameter { 
    ...
    template <
        typename Parameters
      , typename Keyword
      , typename Default = ::zr_boost_1_81::parameter::void_
    >
    struct value_type
#if !defined(BOOST_PARAMETER_CAN_USE_MP11)
      : ::zr_boost_1_81::mpl::eval_if<
            ::zr_boost_1_81::parameter::aux::is_mpl_placeholder<Parameters>
          , ::zr_boost_1_81::mpl::identity<int>
          , ::zr_boost_1_81::parameter::value_type0<Parameters,Keyword,Default>
        >
#endif
    {
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using type = typename ::zr_boost_1_81::mp11::mp_if<
            ::zr_boost_1_81::parameter::aux::is_mpl_placeholder<Parameters>
          , ::zr_boost_1_81::mp11::mp_identity<int>
          , ::zr_boost_1_81::mp11::mp_if<
                ::zr_boost_1_81::parameter::aux::is_mp11_placeholder<Parameters>
              , ::zr_boost_1_81::parameter::value_type1<Parameters,Keyword,Default>
              , ::zr_boost_1_81::parameter::value_type0<Parameters,Keyword,Default>
            >
        >::type;
#endif
    ...
    struct lazy_value_type
    {
        ...
        using type = ::zr_boost_1_81::mp11::mp_apply_q<
          ...
          , ::zr_boost_1_81::mp11::mp_list<
                Keyword
              , typename ::zr_boost_1_81::parameter::aux::result_of0<DefaultFn>::type
              , ::zr_boost_1_81::mp11::mp_false
            >
        >;
#else
