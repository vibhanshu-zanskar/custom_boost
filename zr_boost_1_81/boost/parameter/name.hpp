...
#define BOOST_PARAMETER_NAME_TAG(tag_namespace, tag, q)                      \
    ...
    {                                                                        \
        ...
        {                                                                    \
            ...
            using qualifier = ::zr_boost_1_81::parameter::q;                         \
        };                                                                   \
    }
/**/
...
#define BOOST_PARAMETER_NAME_TAG(tag_namespace, tag, q)                      \
    ...
    {                                                                        \
        ...
        {                                                                    \
            ...
            typedef ::zr_boost_1_81::parameter::q qualifier;                         \
        };                                                                   \
    }
/**/
...
#define BOOST_PARAMETER_NAME_KEYWORD(tag_namespace, tag, name)               \
    namespace                                                                \
    {                                                                        \
        ::zr_boost_1_81::parameter::keyword<tag_namespace::tag> const& name          \
            = ::zr_boost_1_81::parameter::keyword<tag_namespace::tag>::instance;     \
    }
/**/
