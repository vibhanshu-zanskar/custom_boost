...
namespace zr_boost_1_81 { namespace parameter { namespace python { namespace aux {
...
struct member_invoker<0, M, R, T, Args>
{
    ...
    {
        return M()(zr_boost_1_81::type<R>(), self);
    }
};
...
}}}} // namespace zr_boost_1_81::parameter::python::aux
