...
//
// 2009.10.21 TDS remove depenency on zr_boost_1_81::python::detail::referent_storage
//
...
namespace zr_boost_1_81 { namespace parameter { namespace aux {
    ...
    struct referent_storage
      : ::zr_boost_1_81::aligned_storage<
            ::zr_boost_1_81::parameter::aux::referent_size<T>::value
        >
    {
    };
}}} // namespace zr_boost_1_81::parameter::aux
...
namespace zr_boost_1_81 { namespace parameter { namespace aux {
    ...
    template <typename T>
    struct maybe : ::zr_boost_1_81::parameter::aux::maybe_base
    {
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        ...
        typedef typename ::zr_boost_1_81::remove_cv<
            BOOST_DEDUCED_TYPENAME ::zr_boost_1_81::remove_reference<reference>::type
#endif
        >::type non_cv_value;
        ...
        typedef reference(
            ::zr_boost_1_81::parameter::aux::maybe<T>::*safe_bool
        )() const;

        inline operator safe_bool() const
        {
            return this->value ? &::zr_boost_1_81::parameter::aux::maybe<T>::get : 0;
        }
     ...
     private:
        ::zr_boost_1_81::optional<T> value;
        mutable bool constructed;
        mutable typename ::zr_boost_1_81::parameter::aux
