...
namespace zr_boost_1_81 { namespace parameter { namespace aux {
    ...
    struct empty_arg_list
    {
        struct tagged_arg
        {
            typedef ::zr_boost_1_81::parameter::void_ value_type;
        };
        ...
        static ::zr_boost_1_81::parameter::aux::no_tag has_key(KW*);
        ...
        inline BOOST_CONSTEXPR Default&
            operator[](::zr_boost_1_81::parameter::aux::default_<K,Default> x) const
        {
            return x.value;
        }
        ...
        template <typename K, typename Default>
        inline BOOST_CONSTEXPR Default&&
            operator[](::zr_boost_1_81::parameter::aux::default_r_<K,Default> x) const
        {
        ...
        // MPL sequence support
        typedef ::zr_boost_1_81::parameter::aux::empty_arg_list type; // convenience
...
namespace zr_boost_1_81 { namespace parameter { namespace aux {
    ...
    template <
        typename TaggedArg
      , typename Next = ::zr_boost_1_81::parameter::aux::empty_arg_list
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
    ...
    {
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using _holds_maybe = typename ::zr_boost_1_81::parameter::aux
     ...
     public:
        ...
        typedef ::zr_boost_1_81::parameter::aux::arg_list<TaggedArg,Next> self;
        typedef typename TaggedArg::key_type key_type;

#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using reference = typename ::zr_boost_1_81::mp11::mp_if<
            _holds_maybe
          , ::zr_boost_1_81::parameter::aux
            ::get_reference<typename TaggedArg::value_type>
          , ::zr_boost_1_81::parameter::aux::get_reference<TaggedArg>
        >::type;

        using value_type = ::zr_boost_1_81::mp11
        ...
        inline BOOST_CONSTEXPR arg_list(
          ...
          , arg(::zr_boost_1_81::parameter::aux::void_reference())
        {
        }
        ...
        struct binding
        {
            ...
            using fn = ::zr_boost_1_81::mp11::mp_if<
              ...
              , ::zr_boost_1_81::mp11::mp_apply_q<
                    next_binding
                  , ::zr_boost_1_81::mp11::mp_list<KW,Default,Reference>
                >
            >;
#endif
        };
        ...
        static ::zr_boost_1_81::parameter::aux::yes_tag has_key(key_type*);
        using Next::has_key;

     private:
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using _has_unique_key = ::zr_boost_1_81::mp11::mp_bool<
#else
        typedef ::zr_boost_1_81::mpl::bool_<
            ...
            ) == sizeof(::zr_boost_1_81::parameter::aux::no_tag)
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        >;
#else
        > _has_unique_key;
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            get_default(D const&, ::zr_boost_1_81::mp11::mp_false) const
#else
            get_default(D const&, ::zr_boost_1_81::mpl::false_) const
#endif
        {
        ...
        inline BOOST_CONSTEXPR reference
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            get_default(D const& d, ::zr_boost_1_81::mp11::mp_true) const
#else
            get_default(D const& d, ::zr_boost_1_81::mpl::true_) const
#endif
        {
            return (
                this->arg.get_value()
     ...
     public:
        inline BOOST_CONSTEXPR reference
            operator[](::zr_boost_1_81::parameter::keyword<key_type> const&) const
        {
    ...
    !BOOST_WORKAROUND(BOOST_MSVC, < 1910)
        ...
        inline BOOST_CONSTEXPR reference
            operator[](
                ::zr_boost_1_81::parameter::aux::default_<key_type,Default> const& d
            ) const
        {
        ...
        inline BOOST_CONSTEXPR reference
            operator[](
                ::zr_boost_1_81::parameter::aux::default_r_<key_type,Default> const& d
            ) const
        {
            return this->get_default(d, _holds_maybe());
        }
    ...
    !BOOST_WORKAROUND(BOOST_MSVC, < 1910)
        ...
        static typename ::zr_boost_1_81::lazy_enable_if<
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            ::zr_boost_1_81::mp11::mp_if<
                EmitsErrors
              ...
              , _has_unique_key
            >
          , ::zr_boost_1_81::parameter::aux::augment_predicate_mp11<
#else
            typename ::zr_boost_1_81::mpl::if_<
                EmitsErrors
        ...
        inline BOOST_CONSTEXPR ::zr_boost_1_81::parameter::aux::arg_list<
            ::zr_boost_1_81::parameter::aux::tagged_argument<KW,T2>
          , self
        >
            operator,(
                ::zr_boost_1_81::parameter::aux::tagged_argument<KW,T2> const& x
            ) const
        {
        ...
        template <typename KW, typename T2>
        inline BOOST_CONSTEXPR ::zr_boost_1_81::parameter::aux::arg_list<
            ::zr_boost_1_81::parameter::aux::tagged_argument_rref<KW,T2>
          , self
        >
            operator,(
                ::zr_boost_1_81::parameter::aux::tagged_argument_rref<KW,T2> const& x
            ) const
        {
            return ::zr_boost_1_81::parameter::aux::arg_list<
                ::zr_boost_1_81::parameter::aux::tagged_argument_rref<KW,T2>
    ...
    class arg_list : public Next
    {
     ...
     public:
        ...
        inline BOOST_CONSTEXPR arg_list(
            ...
            BOOST_PP_ENUM_BINARY_PARAMS(
              ...
              , ::zr_boost_1_81::parameter::aux::void_reference()
            )
          , arg(a0)
        {
        }
     ...
     public:
            ...
            struct apply
            {
                typedef typename ::zr_boost_1_81::mpl::eval_if<
                  ...
                  , ::zr_boost_1_81::mpl::identity<
                        ::zr_boost_1_81::parameter::aux::arg_list<TaggedArg,Next>
                    >
                  , ::zr_boost_1_81::mpl::apply_wrap1<next_key_owner,KW>
                >::type type;
            };
        };
        ...
        inline BOOST_CONSTEXPR typename ::zr_boost_1_81::mpl::apply_wrap3<
          ...
          , ::zr_boost_1_81::mpl::true_
        >::type
            operator[](::zr_boost_1_81::parameter::keyword<KW> const& x) const
        {
            typename ::zr_boost_1_81::mpl::apply_wrap1<key_owner,KW>::type const&
                sublist = *this;
        ...
        // fails.
        inline BOOST_CONSTEXPR reference
            get(::zr_boost_1_81::parameter::keyword<key_type> const&) const
        {
            BOOST_MPL_ASSERT_NOT((_holds_maybe));
            return this->arg.get_value();
        }
...
namespace zr_boost_1_81 { namespace parameter { namespace aux {
    ...
    struct arg_list_cons<>
    {
        using type = ::zr_boost_1_81::parameter::aux::empty_arg_list;
    };

    template <typename ArgTuple0, typename ...Tuples>
    struct arg_list_cons<ArgTuple0,Tuples...>
    {
        using type = ::zr_boost_1_81::parameter::aux::arg_list<
            typename ArgTuple0::tagged_arg
          , typename ::zr_boost_1_81::parameter::aux::arg_list_cons<Tuples...>::type
    ...
    class flat_like_arg_list
      : public ::zr_boost_1_81::parameter::aux::arg_list_cons<ArgTuples...>::type
    {
        using _base_type = typename ::zr_boost_1_81::parameter::aux
    ...
    template <>
    class flat_like_arg_list<>
      : public ::zr_boost_1_81::parameter::aux::empty_arg_list
    {
        using _base_type = ::zr_boost_1_81::parameter::aux::empty_arg_list;
...
namespace zr_boost_1_81 { namespace parameter { namespace aux {
    ...
    {
        typedef ::zr_boost_1_81::mpl::forward_iterator_tag category;
    ...
    template <>
    struct arg_list_iterator< ::zr_boost_1_81::parameter::aux::empty_arg_list>
    {
    };
}}} // namespace zr_boost_1_81::parameter::aux
...
namespace zr_boost_1_81 { namespace mpl {
    ...
    template <>
    struct begin_impl< ::zr_boost_1_81::parameter::aux::arg_list_tag>
    {
        template <typename S>
        struct apply
        {
            typedef ::zr_boost_1_81::parameter::aux::arg_list_iterator<S> type;
        };
    };

    template <>
    struct end_impl< ::zr_boost_1_81::parameter::aux::arg_list_tag>
    {
        template <typename>
        struct apply
        {
            typedef ::zr_boost_1_81::parameter::aux::arg_list_iterator<
...
namespace zr_boost_1_81 { namespace mpl {
    ...
    template <>
    struct has_key_impl< ::zr_boost_1_81::parameter::aux::arg_list_tag>
    {
        template <typename ArgList, typename Keyword>
        struct apply
        {
            typedef typename ::zr_boost_1_81::mpl::if_<
                ::zr_boost_1_81::is_void<
                    typename ::zr_boost_1_81::parameter
...
namespace zr_boost_1_81 { namespace mpl {
    ...
    template <>
    struct count_impl< ::zr_boost_1_81::parameter::aux::arg_list_tag>
    {
        template <typename ArgList, typename Keyword>
        struct apply
        {
...
namespace zr_boost_1_81 { namespace mpl {
    ...
    template <>
    struct key_type_impl< ::zr_boost_1_81::parameter::aux::arg_list_tag>
    {
        template <typename ArgList, typename Keyword>
        struct apply
        {
...
namespace zr_boost_1_81 { namespace mpl {
    ...
    template <>
    struct value_type_impl< ::zr_boost_1_81::parameter::aux::arg_list_tag>
      : ::zr_boost_1_81::mpl::key_type_impl< ::zr_boost_1_81::parameter::aux::arg_list_tag>
    {
    };
}} // namespace zr_boost_1_81::mpl
...
namespace zr_boost_1_81 { namespace mpl {
    ...
    template <>
    struct at_impl< ::zr_boost_1_81::parameter::aux::arg_list_tag>
      : ::zr_boost_1_81::mpl::key_type_impl< ::zr_boost_1_81::parameter::aux::arg_list_tag>
    {
    };
}} // namespace zr_boost_1_81::mpl
...
namespace zr_boost_1_81 { namespace mpl {
    ...
    template <>
    struct order_impl< ::zr_boost_1_81::parameter::aux::arg_list_tag>
    {
        template <typename ArgList, typename Keyword>
        struct apply
        {
            typedef typename ::zr_boost_1_81::mpl::find<ArgList,Keyword>::type Itr;
            typedef typename ::zr_boost_1_81::mpl::eval_if<
                ::zr_boost_1_81::is_void<
                    typename ::zr_boost_1_81::parameter
                    ::value_type<ArgList,Keyword,void>::type
                >
              , ::zr_boost_1_81::mpl::identity< ::zr_boost_1_81::mpl::void_>
              , ::zr_boost_1_81::mpl::distance<
                    Itr
                  , ::zr_boost_1_81::parameter::aux::arg_list_iterator<
                        ::zr_boost_1_81::parameter::aux::empty_arg_list
                    >
                >
            >::type type;
