...
namespace zr_boost_1_81 { namespace parameter { 
    ...
    struct binding0
    {
        ...
        using type = ::zr_boost_1_81::mp11::mp_apply_q<
          ...
          , ::zr_boost_1_81::mp11::mp_list<Keyword,Default,::zr_boost_1_81::mp11::mp_true>
        >;
...
namespace zr_boost_1_81 { namespace parameter { 
    ...
    struct binding
      ...
      : ::zr_boost_1_81::mpl::eval_if<
          ...
          , ::zr_boost_1_81::parameter::binding0<Parameters,Keyword,Default>
        >
#endif
    {
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using type = typename ::zr_boost_1_81::mp11::mp_if<
          ...
          , ::zr_boost_1_81::mp11::mp_if<
              ...
              , ::zr_boost_1_81::parameter::binding1<Parameters,Keyword,Default>
              , ::zr_boost_1_81::parameter::binding0<Parameters,Keyword,Default>
            >
        >::type;
#endif
