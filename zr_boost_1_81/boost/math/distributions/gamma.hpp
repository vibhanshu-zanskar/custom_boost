...
public:
   ...
   {
      RealType result;
      detail::check_gamma("zr_boost_1_81::math::gamma_distribution<%1%>::gamma_distribution", l_scale, l_shape, &result, Policy());
   }
...
gamma_distribution(RealType)->gamma_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
template <class RealType>
gamma_distribution(RealType,RealType)->gamma_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
#endif
...
inline RealType pdf(const gamma_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "zr_boost_1_81::math::pdf(const gamma_distribution<%1%>&, %1%)";
...
inline RealType logpdf(const gamma_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "zr_boost_1_81::math::logpdf(const gamma_distribution<%1%>&, %1%)";
...
inline RealType cdf(const gamma_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "zr_boost_1_81::math::cdf(const gamma_distribution<%1%>&, %1%)";
   ...
   result = zr_boost_1_81::math::gamma_p(shape, x / scale, Policy());
   return result;
} // cdf
...
inline RealType mean(const gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "zr_boost_1_81::math::mean(const gamma_distribution<%1%>&)";
...
inline RealType variance(const gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "zr_boost_1_81::math::variance(const gamma_distribution<%1%>&)";
...
inline RealType mode(const gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "zr_boost_1_81::math::mode(const gamma_distribution<%1%>&)";
...
inline RealType skewness(const gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "zr_boost_1_81::math::skewness(const gamma_distribution<%1%>&)";
...
inline RealType kurtosis_excess(const gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "zr_boost_1_81::math::kurtosis_excess(const gamma_distribution<%1%>&)";
