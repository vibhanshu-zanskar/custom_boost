...
namespace zr_boost_1_81 { namespace math { 
    ...
    public:
      ...
      {
        static const char* function = "zr_boost_1_81::math::logistic_distribution<%1%>::logistic_distribution";
    ...
    logistic_distribution(RealType)->logistic_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
    template <class RealType>
    logistic_distribution(RealType,RealType)->logistic_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
    #endif
    ...
    {
       static const char* function = "zr_boost_1_81::math::pdf(const logistic_distribution<%1%>&, %1%)";
    ...
    inline RealType cdf(const logistic_distribution<RealType, Policy>& dist, const RealType& x)
    {
       ...
       static const char* function = "zr_boost_1_81::math::cdf(const logistic_distribution<%1%>&, %1%)";
       if(false == detail::check_scale(function, scale, &result, Policy()))
       {
          return result;
       }
    ...
    inline RealType quantile(const logistic_distribution<RealType, Policy>& dist, const RealType& p)
    {
       ...
       static const char* function = "zr_boost_1_81::math::quantile(const logistic_distribution<%1%>&, %1%)";
    ...
    inline RealType cdf(const complemented2_type<logistic_distribution<RealType, Policy>, RealType>& c)
    {
       ...
       RealType x = c.param;
       static const char* function = "zr_boost_1_81::math::cdf(const complement(logistic_distribution<%1%>&), %1%)";
    ...
    inline RealType quantile(const complemented2_type<logistic_distribution<RealType, Policy>, RealType>& c)
    {
       ...
       RealType scale = c.dist.scale();
       RealType location = c.dist.location();
       static const char* function = "zr_boost_1_81::math::quantile(const complement(logistic_distribution<%1%>&), %1%)";
       RealType result = 0;
       if(false == detail::check_scale(function, scale, &result, Policy()))
          return result;
       if(false == detail::check_location(function, location, &result, Policy()))
    ...
    inline RealType variance(const logistic_distribution<RealType, Policy>& dist)
    {
      BOOST_MATH_STD_USING
      RealType scale = dist.scale();
      return zr_boost_1_81::math::constants::pi<RealType>()*zr_boost_1_81::math::constants::pi<RealType>()*scale*scale/3;
