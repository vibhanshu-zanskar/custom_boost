...
namespace zr_boost_1_81{ namespace math{
  ...
  namespace detail
  {
    ...
    inline bool check_skew_normal_shape(
      ...
      const Policy& pol)
    {
      if(!(zr_boost_1_81::math::isfinite)(shape))
      {
        *result =
  ...
  public:
    ...
    { // Default is a 'standard' normal distribution N01. (shape=0 results in the normal distribution with no skew)
      static const char* function = "zr_boost_1_81::math::skew_normal_distribution<%1%>::skew_normal_distribution";
  ...
  skew_normal_distribution(RealType)->skew_normal_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
  template <class RealType>
  skew_normal_distribution(RealType,RealType)->skew_normal_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
  template <class RealType>
  skew_normal_distribution(RealType,RealType,RealType)->skew_normal_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
  #endif
  ...
  inline RealType pdf(const skew_normal_distribution<RealType, Policy>& dist, const RealType& x)
  {
    ...
    static const char* function = "zr_boost_1_81::math::pdf(const skew_normal_distribution<%1%>&, %1%)";
  ...
  inline RealType cdf(const skew_normal_distribution<RealType, Policy>& dist, const RealType& x)
  {
    ...
    static const char* function = "zr_boost_1_81::math::cdf(const skew_normal_distribution<%1%>&, %1%)";
    RealType result = 0;
    if(false == detail::check_scale(function, scale, &result, Policy()))
    {
      return result;
  ...
  inline RealType cdf(const complemented2_type<skew_normal_distribution<RealType, Policy>, RealType>& c)
  {
    ...
    static const char* function = "zr_boost_1_81::math::cdf(const complement(skew_normal_distribution<%1%>&), %1%)";
  ...
  namespace detail
  {
    ...
    */
    ...
    {
      skew_normal_mode_functor(const zr_boost_1_81::math::skew_normal_distribution<RealType, Policy> dist)
        : distribution(dist)
      {
      }
    ...
    private:
      const zr_boost_1_81::math::skew_normal_distribution<RealType, Policy> distribution;
    };
  ...
  inline RealType mode(const skew_normal_distribution<RealType, Policy>& dist)
  {
    ...
    static const char* function = "zr_boost_1_81::math::mode(const skew_normal_distribution<%1%>&, %1%)";
  ...
  namespace detail
  {
    ...
    {
      skew_normal_quantile_functor(const zr_boost_1_81::math::skew_normal_distribution<RealType, Policy> dist, RealType const& p)
  ...
  inline RealType quantile(const skew_normal_distribution<RealType, Policy>& dist, const RealType& p)
  {
    ...
    static const char* function = "zr_boost_1_81::math::quantile(const skew_normal_distribution<%1%>&, %1%)";
    ...
    RealType x = -zr_boost_1_81::math::erfc_inv(2 * p, Policy()) * constants::root_two<RealType>();
  ...
  inline RealType quantile(const complemented2_type<skew_normal_distribution<RealType, Policy>, RealType>& c)
  {
    ...
    static const char* function = "zr_boost_1_81::math::quantile(const complement(skew_normal_distribution<%1%>&), %1%)";
    RealType result = 0;
    if(false == detail::check_scale(function, scale, &result, Policy()))
      return result;
    if(false == detail::check_location(function, location, &result, Policy()))
