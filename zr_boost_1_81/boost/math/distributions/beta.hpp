...
namespace zr_boost_1_81
{
  namespace math
  {
    namespace beta_detail
    {
      ...
      {
        if(!(zr_boost_1_81::math::isfinite)(alpha) || (alpha <= 0))
        {
      ...
      {
        if(!(zr_boost_1_81::math::isfinite)(beta) || (beta <= 0))
        {
          *result = policies::raise_domain_error<RealType>(
            function,
      ...
      {
        if(!(zr_boost_1_81::math::isfinite)(x) || (x < 0) || (x > 1))
        {
          *result = policies::raise_domain_error<RealType>(
            function,
      ...
      {
        if(!(zr_boost_1_81::math::isfinite)(mean) || (mean <= 0))
        {
          *result = policies::raise_domain_error<RealType>(
            function,
      ...
      {
        if(!(zr_boost_1_81::math::isfinite)(variance) || (variance <= 0))
        {
          *result = policies::raise_domain_error<RealType>(
            function,
    ...
    public:
      ...
      beta_distribution(RealType l_alpha = 1, RealType l_beta = 1) : m_alpha(l_alpha), m_beta(l_beta)
      {
        ...
        beta_detail::check_dist(
           "zr_boost_1_81::math::beta_distribution<%1%>::beta_distribution",
          m_alpha,
          m_beta,
          &result, Policy());
      ...
      {
        static const char* function = "zr_boost_1_81::math::beta_distribution<%1%>::find_alpha";
      ...
      static RealType find_beta(
        ...
        RealType variance) // Expected value of variance.
      {
        static const char* function = "zr_boost_1_81::math::beta_distribution<%1%>::find_beta";
        RealType result = 0; // of error checks.
        if(false ==
            (
              beta_detail::check_mean(function, mean, &result, Policy())
    ...
    beta_distribution(RealType)->beta_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
    template <class RealType>
    beta_distribution(RealType, RealType)->beta_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
    #endif
    ...
    {
      static const char* function = "zr_boost_1_81::math::mode(beta_distribution<%1%> const&)";
    ...
    { // Probability Density/Mass Function.
      ...
      static const char* function = "zr_boost_1_81::math::pdf(beta_distribution<%1%> const&, %1%)";
    ...
    { // Cumulative Distribution Function beta.
      ...
      static const char* function = "zr_boost_1_81::math::cdf(beta_distribution<%1%> const&, %1%)";
    ...
    { // Quantile or Percent Point beta function or
      ...
      static const char* function = "zr_boost_1_81::math::quantile(beta_distribution<%1%> const&, %1%)";
