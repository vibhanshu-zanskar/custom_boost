...
namespace zr_boost_1_81
{
  namespace math
  {
    ...
    { // Parameter checking.
      ...
      {
        if((zr_boost_1_81::math::isfinite)(scale))
    ...
    public:
      ...
      { // Constructor.
        RealType result = 0;
        detail::check_pareto("zr_boost_1_81::math::pareto_distribution<%1%>::pareto_distribution", l_scale, l_shape, &result, Policy());
      }
    ...
    pareto_distribution(RealType)->pareto_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
    template <class RealType>
    pareto_distribution(RealType,RealType)->pareto_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
    #endif
    ...
    inline RealType pdf(const pareto_distribution<RealType, Policy>& dist, const RealType& x)
    {
      ...
      static const char* function = "zr_boost_1_81::math::pdf(const pareto_distribution<%1%>&, %1%)";
    ...
    {
      BOOST_MATH_STD_USING  // for ADL of std function pow.
      static const char* function = "zr_boost_1_81::math::cdf(const pareto_distribution<%1%>&, %1%)";
      RealType scale = dist.scale();
      RealType shape = dist.shape();
      RealType result = 0;
      ...
      result = -zr_boost_1_81::math::powm1(scale/x, shape, Policy()); // should be more accurate.
      return result;
    } // cdf
    ...
    {
      BOOST_MATH_STD_USING  // for ADL of std function pow.
      static const char* function = "zr_boost_1_81::math::quantile(const pareto_distribution<%1%>&, %1%)";
      RealType result = 0;
      RealType scale = dist.scale();
      RealType shape = dist.shape();
    ...
    {
      RealType result = 0;
      static const char* function = "zr_boost_1_81::math::mean(const pareto_distribution<%1%>&, %1%)";
    ...
    {
      RealType result = 0;
      static const char* function = "zr_boost_1_81::math::median(const pareto_distribution<%1%>&, %1%)";
      if(false == detail::check_pareto(function, dist.scale(), dist.shape(), &result, Policy()))
      {
        return result;
      }
    ...
    inline RealType variance(const pareto_distribution<RealType, Policy>& dist)
    {
      ...
      RealType scale = dist.scale();
      RealType shape = dist.shape();
      static const char* function = "zr_boost_1_81::math::variance(const pareto_distribution<%1%>&, %1%)";
