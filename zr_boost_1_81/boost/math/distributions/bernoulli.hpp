  ...
  namespace math
  {
    namespace bernoulli_detail
    {
      ...
      inline bool check_dist_and_k(const char* function, const RealType& p, RealType k, RealType* result, const Policy& pol)
      {
        ...
        if(!(zr_boost_1_81::math::isfinite)(k) || !((k == 0) || (k == 1)))
        {
          *result = policies::raise_domain_error<RealType>(
            function,
    ...
    public:
      ...
      { // Default probability = half suits 'fair' coin tossing
        ...
        bernoulli_detail::check_dist(
           "zr_boost_1_81::math::bernoulli_distribution<%1%>::bernoulli_distribution",
          m_p,
          &result, Policy());
    ...
    bernoulli_distribution(RealType)->bernoulli_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
    #endif
    ...
    { // Probability Density/Mass Function.
      ...
      if(false == bernoulli_detail::check_dist_and_k(
        "zr_boost_1_81::math::pdf(bernoulli_distribution<%1%>, %1%)",
    ...
    { // Cumulative Distribution Function Bernoulli.
      ...
      RealType result = 0;
      if(false == bernoulli_detail::check_dist_and_k(
        "zr_boost_1_81::math::cdf(bernoulli_distribution<%1%>, %1%)",
        p,
        k,
        &result, Policy()))
      {
    ...
    { // Quantile or Percent Point Bernoulli function.
      ...
      if(false == bernoulli_detail::check_dist_and_prob(
        "zr_boost_1_81::math::quantile(bernoulli_distribution<%1%>, %1%)",
