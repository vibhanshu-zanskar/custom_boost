...
namespace zr_boost_1_81{ namespace math
{
  namespace detail
  {
    ...
    inline bool check_triangular_mode(
      ...
      RealType* result, const Policy& pol)
    {
      if((zr_boost_1_81::math::isfinite)(mode))
      { // any finite value is OK.
        return true;
      }
      else
  ...
  public:
    ...
    { // Evans says 'standard triangular' is lower 0, mode 1/2, upper 1,
      ...
      RealType result;
      detail::check_triangular("zr_boost_1_81::math::triangular_distribution<%1%>::triangular_distribution",l_lower, l_mode, l_upper, &result, Policy());
    }
    // Accessor functions.
  ...
  triangular_distribution(RealType)->triangular_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
  template <class RealType>
  triangular_distribution(RealType,RealType)->triangular_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
  template <class RealType>
  triangular_distribution(RealType,RealType,RealType)->triangular_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
  #endif
  ...
  {
    static const char* function = "zr_boost_1_81::math::pdf(const triangular_distribution<%1%>&, %1%)";
  ...
  {
    static const char* function = "zr_boost_1_81::math::cdf(const triangular_distribution<%1%>&, %1%)";
    RealType lower = dist.lower();
    RealType mode = dist.mode();
    RealType upper = dist.upper();
    RealType result = 0; // of checks.
  ...
  RealType quantile(const triangular_distribution<RealType, Policy>& dist, const RealType& p)
  {
    ...
    static const char* function = "zr_boost_1_81::math::quantile(const triangular_distribution<%1%>&, %1%)";
    RealType lower = dist.lower();
    RealType mode = dist.mode();
    RealType upper = dist.upper();
    RealType result = 0; // of checks
  ...
  {
    static const char* function = "zr_boost_1_81::math::mean(const triangular_distribution<%1%>&)";
    RealType lower = dist.lower();
    RealType mode = dist.mode();
    RealType upper = dist.upper();
    RealType result = 0;  // of checks.
  ...
  {
    static const char* function = "zr_boost_1_81::math::mode(const triangular_distribution<%1%>&)";
    RealType mode = dist.mode();
    RealType result = 0; // of checks.
  ...
  inline RealType median(const triangular_distribution<RealType, Policy>& dist)
  {
    ...
    static const char* function = "zr_boost_1_81::math::median(const triangular_distribution<%1%>&)";
    RealType mode = dist.mode();
    RealType result = 0; // of checks.
    if(false == detail::check_triangular_mode(function, mode, &result, Policy()))
    { // This should never happen!
  ...
  inline RealType skewness(const triangular_distribution<RealType, Policy>& dist)
  {
    ...
    using namespace zr_boost_1_81::math::constants; // for root_two
    static const char* function = "zr_boost_1_81::math::skewness(const triangular_distribution<%1%>&)";

    RealType lower = dist.lower();
    RealType mode = dist.mode();
    RealType upper = dist.upper();
    RealType result = 0; // of checks.
    if(false == zr_boost_1_81::math::detail::check_triangular(function,lower, mode, upper, &result, Policy()))
    {
      return result;
    }
  ...
  { // These checks may be belt and braces as should have been checked on construction?
    static const char* function = "zr_boost_1_81::math::kurtosis(const triangular_distribution<%1%>&)";
    RealType lower = dist.lower();
    RealType upper = dist.upper();
    RealType mode = dist.mode();
    RealType result = 0;  // of checks.
  ...
  { // These checks may be belt and braces as should have been checked on construction?
    static const char* function = "zr_boost_1_81::math::kurtosis_excess(const triangular_distribution<%1%>&)";
    RealType lower = dist.lower();
    RealType upper = dist.upper();
    RealType mode = dist.mode();
    RealType result = 0;  // of checks.
