...
namespace zr_boost_1_81{ namespace math
{
  namespace detail
  {
    ...
    {
      if((zr_boost_1_81::math::isfinite)(lower))
    ...
    inline bool check_uniform_upper(
      ...
      RealType* result, const Policy& pol)
    {
      if((zr_boost_1_81::math::isfinite)(upper))
      { // Any finite value is OK.
        return true;
      }
      else
    ...
    inline bool check_uniform_x(
      ...
      RealType* result, const Policy& pol)
    {
      if((zr_boost_1_81::math::isfinite)(x))
      { // Any finite value is OK
        return true;
      }
      else
  ...
  public:
    ...
    {
      RealType result;
      detail::check_uniform("zr_boost_1_81::math::uniform_distribution<%1%>::uniform_distribution", l_lower, l_upper, &result, Policy());
    }
    // Accessor functions.
  ...
  uniform_distribution(RealType)->uniform_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
  template <class RealType>
  uniform_distribution(RealType,RealType)->uniform_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
  #endif
  ...
  inline RealType pdf(const uniform_distribution<RealType, Policy>& dist, const RealType& x)
  {
    ...
    if(false == detail::check_uniform("zr_boost_1_81::math::pdf(const uniform_distribution<%1%>&, %1%)", lower, upper, &result, Policy()))
    {
      return result;
    }
    if(false == detail::check_uniform_x("zr_boost_1_81::math::pdf(const uniform_distribution<%1%>&, %1%)", x, &result, Policy()))
    {
      return result;
    }
  ...
  inline RealType cdf(const uniform_distribution<RealType, Policy>& dist, const RealType& x)
  {
    ...
    RealType upper = dist.upper();
    RealType result = 0; // of checks.
    if(false == detail::check_uniform("zr_boost_1_81::math::cdf(const uniform_distribution<%1%>&, %1%)",lower, upper, &result, Policy()))
    {
      return result;
    }
    if(false == detail::check_uniform_x("zr_boost_1_81::math::cdf(const uniform_distribution<%1%>&, %1%)", x, &result, Policy()))
    {
      return result;
    }
    if (x < lower)
  ...
  inline RealType quantile(const uniform_distribution<RealType, Policy>& dist, const RealType& p)
  {
    ...
    RealType upper = dist.upper();
    RealType result = 0; // of checks
    if(false == detail::check_uniform("zr_boost_1_81::math::quantile(const uniform_distribution<%1%>&, %1%)",lower, upper, &result, Policy()))
    {
      return result;
    }
    if(false == detail::check_probability("zr_boost_1_81::math::quantile(const uniform_distribution<%1%>&, %1%)", p, &result, Policy()))
    {
      return result;
    }
    if(p == 0)
  ...
  inline RealType quantile(const complemented2_type<uniform_distribution<RealType, Policy>, RealType>& c)
  {
    ...
    if(false == detail::check_probability("zr_boost_1_81::math::quantile(const uniform_distribution<%1%>&, %1%)", q, &result, Policy()))
    {
       return result;
    }
    if(q == 0)
  ...
  inline RealType mean(const uniform_distribution<RealType, Policy>& dist)
  {
    ...
    RealType upper = dist.upper();
    RealType result = 0;  // of checks.
    if(false == detail::check_uniform("zr_boost_1_81::math::mean(const uniform_distribution<%1%>&)", lower, upper, &result, Policy()))
    {
      return result;
    }
  ...
  inline RealType variance(const uniform_distribution<RealType, Policy>& dist)
  {
    ...
    RealType upper = dist.upper();
    RealType result = 0; // of checks.
    if(false == detail::check_uniform("zr_boost_1_81::math::variance(const uniform_distribution<%1%>&)", lower, upper, &result, Policy()))
    {
      return result;
    }
  ...
  inline RealType mode(const uniform_distribution<RealType, Policy>& dist)
  {
    ...
    RealType upper = dist.upper();
    RealType result = 0; // of checks.
    if(false == detail::check_uniform("zr_boost_1_81::math::mode(const uniform_distribution<%1%>&)", lower, upper, &result, Policy()))
    {
      return result;
    }
  ...
  inline RealType median(const uniform_distribution<RealType, Policy>& dist)
  {
    ...
    RealType upper = dist.upper();
    RealType result = 0; // of checks.
    if(false == detail::check_uniform("zr_boost_1_81::math::median(const uniform_distribution<%1%>&)", lower, upper, &result, Policy()))
    {
      return result;
    }
    return (lower + upper) / 2; //
  ...
  inline RealType skewness(const uniform_distribution<RealType, Policy>& dist)
  {
    ...
    RealType upper = dist.upper();
    RealType result = 0; // of checks.
    if(false == detail::check_uniform("zr_boost_1_81::math::skewness(const uniform_distribution<%1%>&)",lower, upper, &result, Policy()))
    {
      return result;
    }
    return 0;
  ...
  inline RealType kurtosis_excess(const uniform_distribution<RealType, Policy>& dist)
  {
    ...
    RealType upper = dist.upper();
    RealType result = 0;  // of checks.
    if(false == detail::check_uniform("zr_boost_1_81::math::kurtosis_execess(const uniform_distribution<%1%>&)", lower, upper, &result, Policy()))
    {
      return result;
    }
