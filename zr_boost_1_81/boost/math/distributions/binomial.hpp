...
namespace zr_boost_1_81
{
  namespace math
  {
     ...
     namespace binomial_detail{
        ...
        {
           if((N < 0) || !(zr_boost_1_81::math::isfinite)(N))
           {
        ...
        inline bool check_dist_and_k(const char* function, const RealType& N, const RealType& p, RealType k, RealType* result, const Policy& pol)
        {
           if(check_dist(function, N, p, result, pol) == false)
              return false;
           if((k < 0) || !(zr_boost_1_81::math::isfinite)(k))
           {
               *result = policies::raise_domain_error<RealType>(
                  function,
        ...
        inline bool check_dist_and_prob(const char* function, const RealType& N, RealType p, RealType prob, RealType* result, const Policy& pol)
        {
         ...
         T inverse_binomial_cornish_fisher(T n, T sf, T p, T q, const Policy& pol)
         {
            ...
            T x = zr_boost_1_81::math::erfc_inv(p > q ? 2 * q : 2 * p, pol) * constants::root_two<T>();
            // Set the sign:
            if(p < 0.5)
               x = -x;
            T x2 = x * x;
      ...
      { // Quantile or Percent Point Binomial function.
        ...
        if(false == binomial_detail::check_dist_and_prob(
           "zr_boost_1_81::math::quantile(binomial_distribution<%1%> const&, %1%)",
           trials,
           success_fraction,
           p,
           &result, Policy()))
    ...
    public:
      ...
      { // Default n = 1 is the Bernoulli distribution
        // with equal probability of 'heads' or 'tails.
         ...
         binomial_detail::check_dist(
            "zr_boost_1_81::math::binomial_distribution<%1%>::binomial_distribution",
            m_n,
            m_p,
            &r, Policy());
      ...
      {
        static const char* function = "zr_boost_1_81::math::binomial_distribution<%1%>::find_lower_bound_on_p";
        // Error checks:
        RealType result = 0;
      ...
      static RealType find_upper_bound_on_p(
         ...
         interval_type t = clopper_pearson_exact_interval)
      {
        static const char* function = "zr_boost_1_81::math::binomial_distribution<%1%>::find_upper_bound_on_p";
        // Error checks:
        RealType result = 0;
        if(false == binomial_detail::check_dist_and_k(
           function, trials, RealType(0), successes, &result, Policy())
      ...
      {
        static const char* function = "zr_boost_1_81::math::binomial_distribution<%1%>::find_minimum_number_of_trials";
        // Error checks:
        RealType result = 0;
        if(false == binomial_detail::check_dist_and_k(
      ...
      static RealType find_maximum_number_of_trials(
         ...
         RealType alpha) // risk level
      {
        static const char* function = "zr_boost_1_81::math::binomial_distribution<%1%>::find_maximum_number_of_trials";
        // Error checks:
        RealType result = 0;
        if(false == binomial_detail::check_dist_and_k(
           function, k, p, k, &result, Policy())
    ...
    private:
      ...
      binomial_distribution(RealType)->binomial_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
      template <class RealType>
      binomial_distribution(RealType,RealType)->binomial_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
      #endif
      ...
      { // Probability Density/Mass Function.
        ...
        if(false == binomial_detail::check_dist_and_k(
           "zr_boost_1_81::math::pdf(binomial_distribution<%1%> const&, %1%)",
           n,
        ...
        //
        using zr_boost_1_81::math::ibeta_derivative; // a, b, x
      ...
      { // Cumulative Distribution Function Binomial.
        ...
        RealType result = 0;
        if(false == binomial_detail::check_dist_and_k(
           "zr_boost_1_81::math::cdf(binomial_distribution<%1%> const&, %1%)",
           n,
           p,
           k,
           &result, Policy()))
