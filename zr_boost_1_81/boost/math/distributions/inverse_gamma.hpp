...
public:
      ...
      : m_shape(l_shape), m_scale(l_scale)
   {
      ...
      detail::check_inverse_gamma(
        "zr_boost_1_81::math::inverse_gamma_distribution<%1%>::inverse_gamma_distribution",
...
inverse_gamma_distribution(RealType)->inverse_gamma_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
template <class RealType>
inverse_gamma_distribution(RealType,RealType)->inverse_gamma_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
#endif
...
inline RealType pdf(const inverse_gamma_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "zr_boost_1_81::math::pdf(const inverse_gamma_distribution<%1%>&, %1%)";
...
{
   BOOST_MATH_STD_USING  // for ADL of std functions
   using zr_boost_1_81::math::lgamma;

   static const char* function = "zr_boost_1_81::math::logpdf(const inverse_gamma_distribution<%1%>&, %1%)";
   ...
   // x * x may under or overflow, likewise our result
   if (!(zr_boost_1_81::math::isfinite)(x*x))
   {
      return policies::raise_overflow_error<RealType, Policy>(function, "PDF is infinite.", Policy());
   }
...
inline RealType cdf(const inverse_gamma_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "zr_boost_1_81::math::cdf(const inverse_gamma_distribution<%1%>&, %1%)";
   ...
   result = zr_boost_1_81::math::gamma_q(shape, scale / x, Policy());
...
{
   BOOST_MATH_STD_USING  // for ADL of std functions
   using zr_boost_1_81::math::gamma_q_inv;

   static const char* function = "zr_boost_1_81::math::quantile(const inverse_gamma_distribution<%1%>&, %1%)";
...
inline RealType cdf(const complemented2_type<inverse_gamma_distribution<RealType, Policy>, RealType>& c)
{
   ...
   static const char* function = "zr_boost_1_81::math::quantile(const gamma_distribution<%1%>&, %1%)";
...
inline RealType mean(const inverse_gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "zr_boost_1_81::math::mean(const inverse_gamma_distribution<%1%>&)";
   ...
   if((shape <= 1) || !(zr_boost_1_81::math::isfinite)(shape))
   {
     result = policies::raise_domain_error<RealType>(
       function,
...
inline RealType variance(const inverse_gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "zr_boost_1_81::math::variance(const inverse_gamma_distribution<%1%>&)";
   ...
   if((shape <= 2) || !(zr_boost_1_81::math::isfinite)(shape))
   {
     result = policies::raise_domain_error<RealType>(
       function,
...
inline RealType mode(const inverse_gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "zr_boost_1_81::math::mode(const inverse_gamma_distribution<%1%>&)";
...
inline RealType skewness(const inverse_gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "zr_boost_1_81::math::skewness(const inverse_gamma_distribution<%1%>&)";
   ...
   if((shape <= 3) || !(zr_boost_1_81::math::isfinite)(shape))
   {
     result = policies::raise_domain_error<RealType>(
       function,
...
inline RealType kurtosis_excess(const inverse_gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "zr_boost_1_81::math::kurtosis_excess(const inverse_gamma_distribution<%1%>&)";
   ...
   if((shape <= 4) || !(zr_boost_1_81::math::isfinite)(shape))
   {
     result = policies::raise_domain_error<RealType>(
       function,
...
{
  static const char* function = "zr_boost_1_81::math::kurtosis(const inverse_gamma_distribution<%1%>&)";
   RealType shape = dist.shape();
   RealType scale = dist.scale();
