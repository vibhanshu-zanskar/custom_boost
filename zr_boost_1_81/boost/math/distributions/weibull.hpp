...
{
   if((shape <= 0) || !(zr_boost_1_81::math::isfinite)(shape))
   {
...
public:
   ...
   {
      RealType result;
      detail::check_weibull("zr_boost_1_81::math::weibull_distribution<%1%>::weibull_distribution", l_scale, l_shape, &result, Policy());
   }
...
weibull_distribution(RealType)->weibull_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
template <class RealType>
weibull_distribution(RealType,RealType)->weibull_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
#endif
...
{ // Range of supported values for random variable x.
   ...
   using zr_boost_1_81::math::tools::max_value;
   using zr_boost_1_81::math::tools::min_value;
...
inline RealType pdf(const weibull_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "zr_boost_1_81::math::pdf(const weibull_distribution<%1%>, %1%)";
...
inline RealType logpdf(const weibull_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "zr_boost_1_81::math::logpdf(const weibull_distribution<%1%>, %1%)";
...
inline RealType cdf(const weibull_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "zr_boost_1_81::math::cdf(const weibull_distribution<%1%>, %1%)";
   ...
   result = -zr_boost_1_81::math::expm1(-pow(x / scale, shape), Policy());
...
inline RealType quantile(const weibull_distribution<RealType, Policy>& dist, const RealType& p)
{
   ...
   static const char* function = "zr_boost_1_81::math::quantile(const weibull_distribution<%1%>, %1%)";
   ...
   result = scale * pow(-zr_boost_1_81::math::log1p(-p, Policy()), 1 / shape);
...
inline RealType mean(const weibull_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "zr_boost_1_81::math::mean(const weibull_distribution<%1%>)";
   ...
   result = scale * zr_boost_1_81::math::tgamma(1 + 1 / shape, Policy());
   return result;
}
...
inline RealType variance(const weibull_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "zr_boost_1_81::math::variance(const weibull_distribution<%1%>)";
   ...
   result = zr_boost_1_81::math::tgamma(1 + 1 / shape, Policy());
   result *= -result;
   result += zr_boost_1_81::math::tgamma(1 + 2 / shape, Policy());
   result *= scale * scale;
   return result;
}
...
inline RealType mode(const weibull_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "zr_boost_1_81::math::mode(const weibull_distribution<%1%>)";
...
inline RealType median(const weibull_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "zr_boost_1_81::math::median(const weibull_distribution<%1%>)";
   ...
   using zr_boost_1_81::math::constants::ln_two;
...
inline RealType skewness(const weibull_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "zr_boost_1_81::math::skewness(const weibull_distribution<%1%>)";
   ...
   RealType g1 = zr_boost_1_81::math::tgamma(1 + 1 / shape, Policy());
   RealType g2 = zr_boost_1_81::math::tgamma(1 + 2 / shape, Policy());
   RealType g3 = zr_boost_1_81::math::tgamma(1 + 3 / shape, Policy());
...
inline RealType kurtosis_excess(const weibull_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "zr_boost_1_81::math::kurtosis_excess(const weibull_distribution<%1%>)";
   ...
   RealType g2 = zr_boost_1_81::math::tgamma(1 + 2 / shape, Policy());
   RealType g3 = zr_boost_1_81::math::tgamma(1 + 3 / shape, Policy());
   RealType g4 = zr_boost_1_81::math::tgamma(1 + 4 / shape, Policy());
   RealType g1_2 = g1 * g1;
