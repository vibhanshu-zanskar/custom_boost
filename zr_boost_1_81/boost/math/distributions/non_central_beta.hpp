...
namespace zr_boost_1_81
{
   namespace math
   {
      ...
      namespace detail{
         ...
         T non_central_beta_p(T a, T b, T lam, T x, T y, const Policy& pol, T init_val = 0)
         {
            BOOST_MATH_STD_USING
               using namespace zr_boost_1_81::math;
            //
         ...
         inline RealType non_central_beta_cdf(RealType x, RealType y, RealType a, RealType b, RealType l, bool invert, const Policy&)
         {
            ...
            if(l == 0)
               result = cdf(zr_boost_1_81::math::beta_distribution<RealType, Policy>(a, b), x);
            else if(x > cross)
            {
            ...
            return policies::checked_narrowing_cast<RealType, forwarding_policy>(
               result,
               "zr_boost_1_81::math::non_central_beta_cdf<%1%>(%1%, %1%, %1%)");
         }
         ...
         {
            BOOST_MATH_STD_USING
               static const char* function = "zr_boost_1_81::math::tools::bracket_and_solve_root_01<%1%>";
            //
            ...
            if((fa < 0) == (guess < 0 ? !rising : rising))
            {
               ...
               // until we find it:
               //
               while((zr_boost_1_81::math::sign)(fb) == (zr_boost_1_81::math::sign)(fa))
               {
                  if(count == 0)
                  {
         ...
         RealType nc_beta_pdf(const non_central_beta_distribution<RealType, Policy>& dist, const RealType& x)
         {
            ...
            if(l == 0)
               return pdf(zr_boost_1_81::math::beta_distribution<RealType, Policy>(dist.alpha(), dist.beta()), x);
            return policies::checked_narrowing_cast<RealType, forwarding_policy>(
         ...
         T hypergeometric_2F2(T a1, T a2, T b1, T b2, T z, const Policy& pol)
         {
            ...
            const char* function = "zr_boost_1_81::math::detail::hypergeometric_2F2<%1%>(%1%,%1%,%1%,%1%,%1%)";

            hypergeometric_2F2_sum<value_type> s(a1, a2, b1, b2, z);
            std::uintmax_t max_iter = policies::get_max_series_iterations<Policy>();

            value_type result = zr_boost_1_81::math::tools::sum_series(s, zr_boost_1_81::math::policies::get_epsilon<value_type, Policy>(), max_iter);
      ...
      public:
         ...
         {
            const char* function = "zr_boost_1_81::math::non_central_beta_distribution<%1%>::non_central_beta_distribution(%1%,%1%)";
            RealType r;
      ...
      non_central_beta_distribution(RealType,RealType,RealType)->non_central_beta_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
      #endif
      ...
      { // skewness = sqrt(l).
         const char* function = "zr_boost_1_81::math::non_central_beta_distribution<%1%>::skewness()";
      ...
      {
         const char* function = "zr_boost_1_81::math::non_central_beta_distribution<%1%>::kurtosis_excess()";
         typedef typename Policy::assert_undefined_type assert_type;
         static_assert(assert_type::value == 0, "Assert type is undefined.");
      ...
      {
         const char* function = "zr_boost_1_81::math::non_central_beta_distribution<%1%>::cdf(%1%)";
            RealType a = dist.alpha();
            RealType b = dist.beta();
            RealType l = dist.non_centrality();
            RealType r;
