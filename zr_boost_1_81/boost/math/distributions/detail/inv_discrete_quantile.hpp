      ...
      std::uintmax_t& max_iter)
{
   ...
   static const char* function = "zr_boost_1_81::math::do_inverse_discrete_quantile<%1%>";
   ...
   zr_boost_1_81::math::tie(min_bound, max_bound) = support(dist);
   ...
   //
   if((zr_boost_1_81::math::sign)(fb) == (zr_boost_1_81::math::sign)(fa))
   {
      if(fa < 0)
      {
         //
         ...
         // until we find it:
         //
         while(((zr_boost_1_81::math::sign)(fb) == (zr_boost_1_81::math::sign)(fa)) && (a != b))
         {
            if(count == 0)
