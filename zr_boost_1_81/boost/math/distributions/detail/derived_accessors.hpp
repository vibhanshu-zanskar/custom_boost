...
{ // hazard function
  // http://www.itl.nist.gov/div898/handbook/eda/section3/eda362.htm#HAZ
   ...
   if(d > p * tools::max_value<value_type>())
      ...
      "zr_boost_1_81::math::hazard(const Distribution&, %1%)", nullptr, policy_type());
   if(d == 0)
   {
...
inline typename Distribution::value_type coefficient_of_variation(const Distribution& dist)
{
   ...
   { // Checks too that m is not zero,
      return policies::raise_overflow_error<value_type>("zr_boost_1_81::math::coefficient_of_variation(const Distribution&, %1%)", nullptr, policy_type());
   }
