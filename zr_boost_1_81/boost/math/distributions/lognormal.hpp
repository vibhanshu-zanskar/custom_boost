...
namespace detail
{
  ...
  {
     if((x < 0) || !(zr_boost_1_81::math::isfinite)(x))
     {
...
public:
   ...
   {
      RealType result;
      detail::check_scale("zr_boost_1_81::math::lognormal_distribution<%1%>::lognormal_distribution", l_scale, &result, Policy());
      detail::check_location("zr_boost_1_81::math::lognormal_distribution<%1%>::lognormal_distribution", l_location, &result, Policy());
   }
...
lognormal_distribution(RealType)->lognormal_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
template <class RealType>
lognormal_distribution(RealType,RealType)->lognormal_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
#endif
...
{ // Range of permissible values for random variable x is >0 to +infinity.
   using zr_boost_1_81::math::tools::max_value;
...
RealType pdf(const lognormal_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "zr_boost_1_81::math::pdf(const lognormal_distribution<%1%>&, %1%)";
...
inline RealType cdf(const lognormal_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "zr_boost_1_81::math::cdf(const lognormal_distribution<%1%>&, %1%)";
...
inline RealType quantile(const lognormal_distribution<RealType, Policy>& dist, const RealType& p)
{
   ...
   static const char* function = "zr_boost_1_81::math::quantile(const lognormal_distribution<%1%>&, %1%)";
...
inline RealType mean(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result = 0;
   if(0 == detail::check_scale("zr_boost_1_81::math::mean(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("zr_boost_1_81::math::mean(const lognormal_distribution<%1%>&)", mu, &result, Policy()))
      return result;
...
inline RealType variance(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result = 0;
   if(0 == detail::check_scale("zr_boost_1_81::math::variance(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("zr_boost_1_81::math::variance(const lognormal_distribution<%1%>&)", mu, &result, Policy()))
      return result;

   return zr_boost_1_81::math::expm1(sigma * sigma, Policy()) * exp(2 * mu + sigma * sigma);
}
...
inline RealType mode(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result = 0;
   if(0 == detail::check_scale("zr_boost_1_81::math::mode(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("zr_boost_1_81::math::mode(const lognormal_distribution<%1%>&)", mu, &result, Policy()))
      return result;
...
inline RealType skewness(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result = 0;
   if(0 == detail::check_scale("zr_boost_1_81::math::skewness(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("zr_boost_1_81::math::skewness(const lognormal_distribution<%1%>&)", dist.location(), &result, Policy()))
      return result;

   return (ess + 2) * sqrt(zr_boost_1_81::math::expm1(ss, Policy()));
}
...
inline RealType kurtosis(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result = 0;
   if(0 == detail::check_scale("zr_boost_1_81::math::kurtosis(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("zr_boost_1_81::math::kurtosis(const lognormal_distribution<%1%>&)", dist.location(), &result, Policy()))
      return result;
...
inline RealType kurtosis_excess(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result = 0;
   if(0 == detail::check_scale("zr_boost_1_81::math::kurtosis_excess(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("zr_boost_1_81::math::kurtosis_excess(const lognormal_distribution<%1%>&)", dist.location(), &result, Policy()))
      return result;
