...
fisher_f_distribution(RealType,RealType)->fisher_f_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
#endif
...
RealType pdf(const fisher_f_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "zr_boost_1_81::math::pdf(fisher_f_distribution<%1%> const&, %1%)";
...
{
   static const char* function = "zr_boost_1_81::math::cdf(fisher_f_distribution<%1%> const&, %1%)";
   RealType df1 = dist.degrees_of_freedom1();
   RealType df2 = dist.degrees_of_freedom2();
   // Error check:
   RealType error_result = 0;
   ...
   //
   return v1x > df2
      ? zr_boost_1_81::math::ibetac(df2 / 2, df1 / 2, df2 / (df2 + v1x), Policy())
      : zr_boost_1_81::math::ibeta(df1 / 2, df2 / 2, v1x / (df2 + v1x), Policy());
} // cdf

template <class RealType, class Policy>
inline RealType quantile(const fisher_f_distribution<RealType, Policy>& dist, const RealType& p)
{
   static const char* function = "zr_boost_1_81::math::quantile(fisher_f_distribution<%1%> const&, %1%)";
   RealType df1 = dist.degrees_of_freedom1();
   RealType df2 = dist.degrees_of_freedom2();
   // Error check:
   RealType error_result = 0;
   ...
   x = zr_boost_1_81::math::ibeta_inv(df1 / 2, df2 / 2, p, &y, Policy());
...
inline RealType cdf(const complemented2_type<fisher_f_distribution<RealType, Policy>, RealType>& c)
{
   ...
   //
   return v1x > df2
      ? zr_boost_1_81::math::ibeta(df2 / 2, df1 / 2, df2 / (df2 + v1x), Policy())
      : zr_boost_1_81::math::ibetac(df1 / 2, df2 / 2, v1x / (df2 + v1x), Policy());
}
...
inline RealType quantile(const complemented2_type<fisher_f_distribution<RealType, Policy>, RealType>& c)
{
   ...
   x = zr_boost_1_81::math::ibetac_inv(df1 / 2, df2 / 2, p, &y, Policy());
...
{ // Mean of F distribution = v.
   static const char* function = "zr_boost_1_81::math::mean(fisher_f_distribution<%1%> const&)";
   RealType df1 = dist.degrees_of_freedom1();
   RealType df2 = dist.degrees_of_freedom2();
   // Error check:
   RealType error_result = 0;
...
{ // Variance of F distribution.
   static const char* function = "zr_boost_1_81::math::variance(fisher_f_distribution<%1%> const&)";
   RealType df1 = dist.degrees_of_freedom1();
   RealType df2 = dist.degrees_of_freedom2();
   // Error check:
   RealType error_result = 0;
...
{
   static const char* function = "zr_boost_1_81::math::mode(fisher_f_distribution<%1%> const&)";
   RealType df1 = dist.degrees_of_freedom1();
   RealType df2 = dist.degrees_of_freedom2();
   // Error check:
   RealType error_result = 0;
...
{
   static const char* function = "zr_boost_1_81::math::skewness(fisher_f_distribution<%1%> const&)";
...
{
   static const char* function = "zr_boost_1_81::math::kurtosis_excess(fisher_f_distribution<%1%> const&)";
   // See http://mathworld.wolfram.com/F-Distribution.html
   RealType df1 = dist.degrees_of_freedom1();
   RealType df2 = dist.degrees_of_freedom2();
   // Error check:
