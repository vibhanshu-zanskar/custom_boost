...
{
   if((l <= 0) || !(zr_boost_1_81::math::isfinite)(l))
   {
...
public:
   ...
   {
      RealType err;
      detail::verify_lambda("zr_boost_1_81::math::exponential_distribution<%1%>::exponential_distribution", l_lambda, &err, Policy());
...
exponential_distribution(RealType)->exponential_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
#endif
...
inline RealType pdf(const exponential_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "zr_boost_1_81::math::pdf(const exponential_distribution<%1%>&, %1%)";
...
inline RealType logpdf(const exponential_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "zr_boost_1_81::math::logpdf(const exponential_distribution<%1%>&, %1%)";
...
inline RealType cdf(const exponential_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "zr_boost_1_81::math::cdf(const exponential_distribution<%1%>&, %1%)";
   ...
   if(0 == detail::verify_exp_x(function, x, &result, Policy()))
      return result;
   result = -zr_boost_1_81::math::expm1(-x * lambda, Policy());
...
inline RealType quantile(const exponential_distribution<RealType, Policy>& dist, const RealType& p)
{
   ...
   static const char* function = "zr_boost_1_81::math::quantile(const exponential_distribution<%1%>&, %1%)";
   ...
   result = -zr_boost_1_81::math::log1p(-p, Policy()) / lambda;
   return result;
} // quantile
...
inline RealType mean(const exponential_distribution<RealType, Policy>& dist)
{
   RealType result = 0;
   RealType lambda = dist.lambda();
   if(0 == detail::verify_lambda("zr_boost_1_81::math::mean(const exponential_distribution<%1%>&)", lambda, &result, Policy()))
      return result;
   return 1 / lambda;
}
...
inline RealType standard_deviation(const exponential_distribution<RealType, Policy>& dist)
{
   RealType result = 0;
   RealType lambda = dist.lambda();
   if(0 == detail::verify_lambda("zr_boost_1_81::math::standard_deviation(const exponential_distribution<%1%>&)", lambda, &result, Policy()))
      return result;
   return 1 / lambda;
}
