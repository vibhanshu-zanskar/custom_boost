...
namespace zr_boost_1_81
{
  namespace math
  {
    namespace negative_binomial_detail
    {
      ...
      {
        if( !(zr_boost_1_81::math::isfinite)(r) || (r <= 0) )
        {
      ...
      {
        if( !(zr_boost_1_81::math::isfinite)(p) || (p < 0) || (p > 1) )
        {
          *result = policies::raise_domain_error<RealType>(
            function,
      ...
      inline bool check_dist_and_k(const char* function, const RealType& r, const RealType& p, RealType k, RealType* result, const Policy& pol)
      {
        ...
        if( !(zr_boost_1_81::math::isfinite)(k) || (k < 0) )
        { // Check k failures.
          *result = policies::raise_domain_error<RealType>(
            function,
    ...
    public:
      ...
      {
        static const char* function = "zr_boost_1_81::math::negative_binomial<%1%>::find_lower_bound_on_p";
      ...
      static RealType find_upper_bound_on_p(
        ...
        RealType alpha) // alpha 0.05 equivalent to 95% for one-sided test.
      {
        static const char* function = "zr_boost_1_81::math::negative_binomial<%1%>::find_upper_bound_on_p";
        RealType result = 0;  // of error checks.
        RealType failures = trials - successes;
      ...
      {
        static const char* function = "zr_boost_1_81::math::negative_binomial<%1%>::find_minimum_number_of_trials";
        // Error checks:
        RealType result = 0;
        if(false == negative_binomial_detail::check_dist_and_k(
      ...
      static RealType find_maximum_number_of_trials(
        ...
        RealType alpha) // risk level threshold 0 <= alpha <= 1.
      {
        static const char* function = "zr_boost_1_81::math::negative_binomial<%1%>::find_maximum_number_of_trials";
        // Error checks:
        RealType result = 0;
        if(false == negative_binomial_detail::check_dist_and_k(
          function, RealType(1), p, k, &result, Policy())
    ...
    negative_binomial_distribution(RealType,RealType)->negative_binomial_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
    #endif
    ...
    { // Probability Density/Mass Function.
      ...
      static const char* function = "zr_boost_1_81::math::pdf(const negative_binomial_distribution<%1%>&, %1%)";
    ...
    { // Cumulative Distribution Function of Negative Binomial.
      static const char* function = "zr_boost_1_81::math::cdf(const negative_binomial_distribution<%1%>&, %1%)";
      using zr_boost_1_81::math::ibeta; // Regularized incomplete beta function.
      ...
      static const char* function = "zr_boost_1_81::math::cdf(const negative_binomial_distribution<%1%>&, %1%)";
      using zr_boost_1_81::math::ibetac; // Regularized incomplete beta function complement.
      // k argument may be integral, signed, or unsigned, or floating point.
      // If necessary, it has already been promoted from an integral type.
    ...
    { // Quantile, percentile/100 or Percent Point Negative Binomial function.
      ...
      static const char* function = "zr_boost_1_81::math::quantile(const negative_binomial_distribution<%1%>&, %1%)";
      BOOST_MATH_STD_USING // ADL of std functions.
      ...
      using zr_boost_1_81::math::ibeta_invb;
    ...
    {  // Quantile or Percent Point Binomial function.
       ...
       if (-Q <= zr_boost_1_81::math::powm1(dist.success_fraction(), dist.successes(), Policy()))
