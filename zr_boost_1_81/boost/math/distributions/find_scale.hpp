...
// using zr_boost_1_81::math::complement; // will be needed by users who want complement,
...
namespace zr_boost_1_81
{
  namespace math
  {
    ...
    {
      static_assert(::zr_boost_1_81::math::tools::is_distribution<Dist>::value, "The provided distribution does not meet the conceptual requirements of a distribution."); 
      static_assert(::zr_boost_1_81::math::tools::is_scaled_distribution<Dist>::value, "The provided distribution does not meet the conceptual requirements of a scaled distribution."); 
      static const char* function = "zr_boost_1_81::math::find_scale<Dist, Policy>(%1%, %1%, %1%, Policy)";
      ...
      if(!(zr_boost_1_81::math::isfinite)(z))
      {
        return policies::raise_domain_error<typename Dist::value_type>(
          function, "find_scale z parameter was %1%, but must be finite!", z, pol);
      }
      if(!(zr_boost_1_81::math::isfinite)(location))
      {
        return policies::raise_domain_error<typename Dist::value_type>(
      ...
      complemented4_type<Real1, Real2, Real3, Policy> const& c)
    {
      ...
      static_assert(::zr_boost_1_81::math::tools::is_distribution<Dist>::value, "The provided distribution does not meet the conceptual requirements of a distribution."); 
      static_assert(::zr_boost_1_81::math::tools::is_scaled_distribution<Dist>::value, "The provided distribution does not meet the conceptual requirements of a scaled distribution."); 
      static const char* function = "zr_boost_1_81::math::find_scale<Dist, Policy>(complement(%1%, %1%, %1%, Policy))";

      // Checks on arguments, as not complemented version,
      // Explicit policy.
      typename Dist::value_type q = c.param1;
      if(!(zr_boost_1_81::math::isfinite)(q) || (q < 0) || (q > 1))
      {
        return policies::raise_domain_error<typename Dist::value_type>(
