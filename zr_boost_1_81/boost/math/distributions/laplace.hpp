...
public:
   ...
   {
      RealType result;
      check_parameters("zr_boost_1_81::math::laplace_distribution<%1%>::laplace_distribution()", &result);
   }
...
laplace_distribution(RealType)->laplace_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
template <class RealType>
laplace_distribution(RealType,RealType)->laplace_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
#endif
...
inline RealType pdf(const laplace_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   RealType result = 0;
   const char* function = "zr_boost_1_81::math::pdf(const laplace_distribution<%1%>&, %1%))";
...
inline RealType logpdf(const laplace_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   const char* function = "zr_boost_1_81::math::logpdf(const laplace_distribution<%1%>&, %1%))";
   ...
   {
      // General case
      const RealType log2 = zr_boost_1_81::math::constants::ln_two<RealType>();
...
inline RealType cdf(const laplace_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   RealType result = 0;
   // Checking function argument.
   const char* function = "zr_boost_1_81::math::cdf(const laplace_distribution<%1%>&, %1%)";
   // Check scale and location.
   if (false == dist.check_parameters(function, &result)) return result;
...
inline RealType quantile(const laplace_distribution<RealType, Policy>& dist, const RealType& p)
{
   ...
   // Checking function argument
   RealType result = 0;
   const char* function = "zr_boost_1_81::math::quantile(const laplace_distribution<%1%>&, %1%)";
   if (false == dist.check_parameters(function, &result)) return result;
...
inline RealType cdf(const complemented2_type<laplace_distribution<RealType, Policy>, RealType>& c)
{
   ...
   // Checking function argument.
   const char* function = "zr_boost_1_81::math::cdf(const complemented2_type<laplace_distribution<%1%>, %1%>&)";
