...
{
   if((b <= 0) || !(zr_boost_1_81::math::isfinite)(b))
   {
...
public:
   ...
   {
      RealType err;
      detail::verify_scale_b("zr_boost_1_81::math::extreme_value_distribution<%1%>::extreme_value_distribution", b, &err, Policy());
      detail::check_finite("zr_boost_1_81::math::extreme_value_distribution<%1%>::extreme_value_distribution", a, &err, Policy());
...
extreme_value_distribution(RealType)->extreme_value_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
template <class RealType>
extreme_value_distribution(RealType,RealType)->extreme_value_distribution<typename zr_boost_1_81::math::tools::promote_args<RealType>::type>;
#endif
...
inline RealType pdf(const extreme_value_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "zr_boost_1_81::math::pdf(const extreme_value_distribution<%1%>&, %1%)";
...
inline RealType logpdf(const extreme_value_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "zr_boost_1_81::math::logpdf(const extreme_value_distribution<%1%>&, %1%)";
...
inline RealType cdf(const extreme_value_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "zr_boost_1_81::math::cdf(const extreme_value_distribution<%1%>&, %1%)";
   ...
   if(0 == detail::check_finite(function, a, &result, Policy()))
      return result;
   if(0 == detail::check_x("zr_boost_1_81::math::cdf(const extreme_value_distribution<%1%>&, %1%)", x, &result, Policy()))
      return result;
...
RealType quantile(const extreme_value_distribution<RealType, Policy>& dist, const RealType& p)
{
   ...
   static const char* function = "zr_boost_1_81::math::quantile(const extreme_value_distribution<%1%>&, %1%)";
...
inline RealType cdf(const complemented2_type<extreme_value_distribution<RealType, Policy>, RealType>& c)
{
   ...
   if((zr_boost_1_81::math::isinf)(c.param))
   ...
   result = -zr_boost_1_81::math::expm1(-exp((a-c.param)/b), Policy());
...
RealType quantile(const complemented2_type<extreme_value_distribution<RealType, Policy>, RealType>& c)
{
   ...
   result = a - log(-zr_boost_1_81::math::log1p(-q, Policy())) * b;
...
inline RealType mean(const extreme_value_distribution<RealType, Policy>& dist)
{
   ...
   RealType b = dist.scale();
   RealType result = 0;
   if(0 == detail::verify_scale_b("zr_boost_1_81::math::mean(const extreme_value_distribution<%1%>&)", b, &result, Policy()))
      return result;
   if (0 == detail::check_finite("zr_boost_1_81::math::mean(const extreme_value_distribution<%1%>&)", a, &result, Policy()))
      return result;
...
inline RealType standard_deviation(const extreme_value_distribution<RealType, Policy>& dist)
{
   ...
   RealType b = dist.scale();
   RealType result = 0;
   if(0 == detail::verify_scale_b("zr_boost_1_81::math::standard_deviation(const extreme_value_distribution<%1%>&)", b, &result, Policy()))
      return result;
   if(0 == detail::check_finite("zr_boost_1_81::math::standard_deviation(const extreme_value_distribution<%1%>&)", dist.location(), &result, Policy()))
      return result;
