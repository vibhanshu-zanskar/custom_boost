...
T expint_1_rational(const T& z, const std::integral_constant<int, 53>&)
{
   ...
   else if(z < -zr_boost_1_81::math::tools::log_min_value<T>())
   {
...
inline T expint_as_fraction(unsigned n, T z, const Policy& pol)
{
   ...
   T result = tools::continued_fraction_b(
      f,
      zr_boost_1_81::math::policies::get_epsilon<T, Policy>(),
      max_iter);
   policies::check_series_iterations<T>("zr_boost_1_81::math::expint_continued_fraction<%1%>(unsigned,%1%)", max_iter, pol);
...
inline T expint_as_series(unsigned n, T z, const Policy& pol)
{
   ...
   result += pow(-z, static_cast<T>(n - 1))
      * (zr_boost_1_81::math::digamma(static_cast<T>(n), pol) - log(z)) / fact;
   BOOST_MATH_INSTRUMENT_VARIABLE(result)

   expint_series<T> s(k, z, x_k, denom, fact);
   result = tools::sum_series(s, policies::get_epsilon<T, Policy>(), max_iter, result);
   policies::check_series_iterations<T>("zr_boost_1_81::math::expint_series<%1%>(unsigned,%1%)", max_iter, pol);
   BOOST_MATH_INSTRUMENT_VARIABLE(result)
   BOOST_MATH_INSTRUMENT_VARIABLE(max_iter)
   return result;
}
...
{
   BOOST_MATH_STD_USING
   static const char* function = "zr_boost_1_81::math::expint<%1%>(unsigned, %1%)";
   if(z < 0)
...
T expint_i_as_series(T z, const Policy& pol)
{
   ...
   std::uintmax_t max_iter = policies::get_max_series_iterations<Policy>();
   result = tools::sum_series(s, policies::get_epsilon<T, Policy>(), max_iter, result);
   policies::check_series_iterations<T>("zr_boost_1_81::math::expint_i_series<%1%>(%1%)", max_iter, pol);
   return result;
}
...
{
   static const char* function = "zr_boost_1_81::math::expint<%1%>(%1%)";
   if(z < 0)
...
T expint_i_imp(T z, const Policy& pol, const std::integral_constant<int, 53>& tag)
{
   ...
   if(z <= 6)
   {
      ...
      if(fabs(t) < 0.1)
      {
         result += zr_boost_1_81::math::log1p(t / r, pol);
      }
      else
      {
         result += log(z / r);
...
struct expint_i_initializer
{
   struct init
   {
      ...
      {
         zr_boost_1_81::math::expint(T(5), Policy());
         zr_boost_1_81::math::expint(T(7), Policy());
         zr_boost_1_81::math::expint(T(18), Policy());
         zr_boost_1_81::math::expint(T(38), Policy());
         zr_boost_1_81::math::expint(T(45), Policy());
      }
      ...
      static void do_init(const std::integral_constant<int, 113>&)
      {
         zr_boost_1_81::math::expint(T(5), Policy());
         zr_boost_1_81::math::expint(T(7), Policy());
         zr_boost_1_81::math::expint(T(17), Policy());
         zr_boost_1_81::math::expint(T(25), Policy());
         zr_boost_1_81::math::expint(T(40), Policy());
         zr_boost_1_81::math::expint(T(50), Policy());
         zr_boost_1_81::math::expint(T(80), Policy());
         zr_boost_1_81::math::expint(T(200), Policy());
         zr_boost_1_81::math::expint(T(220), Policy());
      }
...
struct expint_1_initializer
{
   struct init
   {
      ...
      static void do_init(const std::integral_constant<int, 53>&)
      {
         zr_boost_1_81::math::expint(1, T(0.5), Policy());
         zr_boost_1_81::math::expint(1, T(2), Policy());
      }
      static void do_init(const std::integral_constant<int, 64>&)
      {
         zr_boost_1_81::math::expint(1, T(0.5), Policy());
      ...
      static void do_init(const std::integral_constant<int, 113>&)
      {
         zr_boost_1_81::math::expint(1, T(0.5), Policy());
         zr_boost_1_81::math::expint(1, T(2), Policy());
         zr_boost_1_81::math::expint(1, T(6), Policy());
      }
      void force_instantiate()const{}
   };
   static const init initializer;
   ...
   expint_forwarder(T z, const Policy& /*pol*/, std::true_type const&)
{
   ...
   return policies::checked_narrowing_cast<result_type, forwarding_policy>(detail::expint_i_imp(
      ...
      forwarding_policy(),
      tag_type()), "zr_boost_1_81::math::expint<%1%>(%1%)");
}
...
{
   return zr_boost_1_81::math::expint(n, z, policies::policy<>());
}
   ...
   expint(unsigned n, T z, const Policy& /*pol*/)
{
   ...
   return policies::checked_narrowing_cast<result_type, forwarding_policy>(detail::expint_imp(
      ...
      static_cast<value_type>(z),
      forwarding_policy(),
      tag_type()), "zr_boost_1_81::math::expint<%1%>(unsigned, %1%)");
}
