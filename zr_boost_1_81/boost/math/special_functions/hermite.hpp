   ...
   hermite(unsigned n, T x, const Policy&)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(detail::hermite_imp(n, static_cast<value_type>(x)), "zr_boost_1_81::math::hermite<%1%>(unsigned, %1%)");
}
...
{
   return zr_boost_1_81::math::hermite(n, x, policies::policy<>());
}
