...
namespace zr_boost_1_81{
   namespace math{
      ...
      typename zr_boost_1_81::math::tools::promote_args<T,U>::type relative_difference(const T& arg_a, const U& arg_b)
      {
         typedef typename zr_boost_1_81::math::tools::promote_args<T, U>::type result_type;
         result_type a = arg_a;
         result_type b = arg_b;
         ...
         if((zr_boost_1_81::math::isnan)(a) || (zr_boost_1_81::math::isnan)(b))
            return max_val;
      ...
      template <>
      inline zr_boost_1_81::math::tools::promote_args<double, double>::type relative_difference(const double& arg_a, const double& arg_b)
      {
         BOOST_MATH_STD_USING
         double a = arg_a;
         double b = arg_b;
      ...
      template <class T, class U>
      inline typename zr_boost_1_81::math::tools::promote_args<T, U>::type epsilon_difference(const T& arg_a, const U& arg_b)
      {
         typedef typename zr_boost_1_81::math::tools::promote_args<T, U>::type result_type;
         result_type r = relative_difference(arg_a, arg_b);
         if(tools::max_value<result_type>() * zr_boost_1_81::math::tools::epsilon<result_type>() < r)
            return tools::max_value<result_type>();
         return r / zr_boost_1_81::math::tools::epsilon<result_type>();
      }
} // namespace math
} // namespace zr_boost_1_81
