...
struct erf_asympt_series_t
{
   erf_asympt_series_t(T z) : xx(2 * -z * z), tk(1)
   {
      ...
      result = -exp(-z * z) / sqrt(zr_boost_1_81::math::constants::pi<T>());
      result /= z;
   }
...
T erf_series_near_zero_sum(const T& x, const Policy& pol)
{
   ...
   policies::check_series_iterations<T>("zr_boost_1_81::math::erf<%1%>(%1%, %1%)", max_iter, pol);
   return result;
}
...
T erf_imp(T z, bool invert, const Policy& pol, const Tag& t)
{
   ...
   if(!invert && (z > detail::erf_asymptotic_limit<T, Policy>()))
   {
      ...
      std::uintmax_t max_iter = policies::get_max_series_iterations<Policy>();
      result = zr_boost_1_81::math::tools::sum_series(s, policies::get_epsilon<T, Policy>(), max_iter, 1);
      policies::check_series_iterations<T>("zr_boost_1_81::math::erf<%1%>(%1%, %1%)", max_iter, pol);
   }
   else
   {
      ...
      else
      {
         ...
         invert = !invert;
         result = z * exp(-x);
         result /= zr_boost_1_81::math::constants::root_pi<T>();
...
T erf_imp(T z, bool invert, const Policy& pol, const std::integral_constant<int, 53>& t)
{
   ...
   if ((zr_boost_1_81::math::isnan)(z))
      return policies::raise_denorm_error("zr_boost_1_81::math::erf<%1%>(%1%)", "Expected a finite argument but got %1%", z, pol);
...
struct erf_initializer
{
   struct init
   {
      ...
      {
         zr_boost_1_81::math::erf(static_cast<T>(1e-12), Policy());
         zr_boost_1_81::math::erf(static_cast<T>(0.25), Policy());
         zr_boost_1_81::math::erf(static_cast<T>(1.25), Policy());
         zr_boost_1_81::math::erf(static_cast<T>(2.25), Policy());
         zr_boost_1_81::math::erf(static_cast<T>(4.25), Policy());
         zr_boost_1_81::math::erf(static_cast<T>(5.25), Policy());
      }
      ...
      {
         zr_boost_1_81::math::erf(static_cast<T>(1e-22), Policy());
         zr_boost_1_81::math::erf(static_cast<T>(0.25), Policy());
         zr_boost_1_81::math::erf(static_cast<T>(1.25), Policy());
         zr_boost_1_81::math::erf(static_cast<T>(2.125), Policy());
         zr_boost_1_81::math::erf(static_cast<T>(2.75), Policy());
         zr_boost_1_81::math::erf(static_cast<T>(3.25), Policy());
         zr_boost_1_81::math::erf(static_cast<T>(5.25), Policy());
         zr_boost_1_81::math::erf(static_cast<T>(7.25), Policy());
         zr_boost_1_81::math::erf(static_cast<T>(11.25), Policy());
         zr_boost_1_81::math::erf(static_cast<T>(12.5), Policy());
      }
...
inline typename tools::promote_args<T>::type erf(T z, const Policy& /* pol */)
{
   ...
   return policies::checked_narrowing_cast<result_type, forwarding_policy>(detail::erf_imp(
      ...
      false,
      forwarding_policy(),
      tag_type()), "zr_boost_1_81::math::erf<%1%>(%1%, %1%)");
}
...
inline typename tools::promote_args<T>::type erfc(T z, const Policy& /* pol */)
{
   ...
   return policies::checked_narrowing_cast<result_type, forwarding_policy>(detail::erf_imp(
      ...
      true,
      forwarding_policy(),
      tag_type()), "zr_boost_1_81::math::erfc<%1%>(%1%, %1%)");
}

template <class T>
inline typename tools::promote_args<T>::type erf(T z)
{
   return zr_boost_1_81::math::erf(z, policies::policy<>());
}

template <class T>
inline typename tools::promote_args<T>::type erfc(T z)
{
   return zr_boost_1_81::math::erfc(z, policies::policy<>());
}
