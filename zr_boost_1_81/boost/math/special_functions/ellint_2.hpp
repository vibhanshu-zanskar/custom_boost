...
T ellint_e_imp(T phi, T k, const Policy& pol)
{
    ...
    if(phi >= tools::max_value<T>())
    {
       ...
       result = policies::raise_overflow_error<T>("zr_boost_1_81::math::ellint_e<%1%>(%1%,%1%)", nullptr, pol);
    }
    ...
    else if(fabs(k) == 1)
    {
       ...
       //
       T m = zr_boost_1_81::math::round(phi / zr_boost_1_81::math::constants::pi<T>());
       T remains = phi - m * zr_boost_1_81::math::constants::pi<T>();
    ...
    else
    {
       ...
       //
       T rphi = zr_boost_1_81::math::tools::fmod_workaround(phi, T(constants::half_pi<T>()));
       T m = zr_boost_1_81::math::round((phi - rphi) / constants::half_pi<T>());
       int s = 1;
       if(zr_boost_1_81::math::tools::fmod_workaround(m, T(2)) > 0.5)
       {
          m += 1;
          s = -1;
       ...
       T k2 = k * k;
       if(zr_boost_1_81::math::pow<3>(rphi) * k2 / 6 < tools::epsilon<T>() * fabs(rphi))
       {
       ...
       else
       {
          ...
          if (k2 * sinp * sinp >= 1)
          {
             return policies::raise_domain_error<T>("zr_boost_1_81::math::ellint_2<%1%>(%1%, %1%)", "The parameter k is out of range, got k = %1%", k, pol);
          }
          T cosp = cos(rphi);
          T c = 1 / (sinp * sinp);
...
T ellint_e_imp(T k, const Policy& pol, std::integral_constant<int, 2> const&)
{
    ...
    if (abs(k) > 1)
    {
       return policies::raise_domain_error<T>("zr_boost_1_81::math::ellint_e<%1%>(%1%)",
...
BOOST_FORCEINLINE T ellint_e_imp(T k, const Policy& pol, std::integral_constant<int, 0> const&)
{
   ...
   //if (m < 0.1)
   {
      ...
      return zr_boost_1_81::math::tools::evaluate_polynomial(coef, m - 0.05);
   }
   case 2:
   case 3:
   //else if (m < 0.2)
   {
      ...
      return zr_boost_1_81::math::tools::evaluate_polynomial(coef, m - 0.15);
   }
   case 4:
   case 5:
   //else if (m < 0.3)
   {
      ...
      return zr_boost_1_81::math::tools::evaluate_polynomial(coef, m - 0.25);
   }
   case 6:
   case 7:
   //else if (m < 0.4)
   {
      ...
      return zr_boost_1_81::math::tools::evaluate_polynomial(coef, m - 0.35);
   }
   case 8:
   case 9:
   //else if (m < 0.5)
   {
      ...
      return zr_boost_1_81::math::tools::evaluate_polynomial(coef, m - 0.45);
   }
   case 10:
   case 11:
   //else if (m < 0.6)
   {
      ...
      return zr_boost_1_81::math::tools::evaluate_polynomial(coef, m - 0.55);
   }
   case 12:
   case 13:
   //else if (m < 0.7)
   {
      ...
      return zr_boost_1_81::math::tools::evaluate_polynomial(coef, m - 0.65);
   }
   case 14:
   case 15:
   //else if (m < 0.8)
   {
      ...
      return zr_boost_1_81::math::tools::evaluate_polynomial(coef, m - 0.75);
   }
   case 16:
   //else if (m < 0.85)
   {
      ...
      return zr_boost_1_81::math::tools::evaluate_polynomial(coef, m - 0.825);
   }
   case 17:
   //else if (m < 0.90)
   {
      ...
      return zr_boost_1_81::math::tools::evaluate_polynomial(coef, m - 0.875);
   }
   default:
      //
...
BOOST_FORCEINLINE T ellint_e_imp(T k, const Policy& pol, std::integral_constant<int, 1> const&)
{
      ...
      //if (m < 0.1)
   {
      ...
      return zr_boost_1_81::math::tools::evaluate_polynomial(coef, m - 0.05L);
   }
   case 2:
   case 3:
      //else if (m < 0.2)
   {
      ...
      return zr_boost_1_81::math::tools::evaluate_polynomial(coef, m - 0.15L);
   }
   case 4:
   case 5:
      //else if (m < 0.3L)
   {
      ...
      return zr_boost_1_81::math::tools::evaluate_polynomial(coef, m - 0.25L);
   }
   case 6:
   case 7:
      //else if (m < 0.4L)
   {
      ...
      return zr_boost_1_81::math::tools::evaluate_polynomial(coef, m - 0.35L);
   }
   case 8:
   case 9:
      //else if (m < 0.5L)
   {
      ...
      return zr_boost_1_81::math::tools::evaluate_polynomial(coef, m - 0.45L);
   }
   case 10:
   case 11:
      //else if (m < 0.6L)
   {
      ...
      return zr_boost_1_81::math::tools::evaluate_polynomial(coef, m - 0.55L);
   }
   case 12:
   case 13:
      //else if (m < 0.7L)
   {
      ...
      return zr_boost_1_81::math::tools::evaluate_polynomial(coef, m - 0.65L);
   }
   case 14:
   case 15:
      //else if (m < 0.8L)
   {
      ...
      return zr_boost_1_81::math::tools::evaluate_polynomial(coef, m - 0.75L);
   }
   case 16:
      //else if (m < 0.85L)
   {
      ...
      return zr_boost_1_81::math::tools::evaluate_polynomial(coef, m - 0.825L);
   }
   case 17:
      //else if (m < 0.90L)
   {
      ...
      return zr_boost_1_81::math::tools::evaluate_polynomial(coef, m - 0.875L);
   }
   default:
      //
      // All cases where m > 0.9
...
BOOST_FORCEINLINE typename tools::promote_args<T>::type ellint_2(T k, const Policy& pol, const std::true_type&)
{
   ...
   typedef std::integral_constant<int,
      ...
      std::is_floating_point<T>::value && std::numeric_limits<T>::digits && (std::numeric_limits<T>::digits <= 64) ? 1 : 2
   > precision_tag_type;
   return policies::checked_narrowing_cast<result_type, Policy>(detail::ellint_e_imp(static_cast<value_type>(k), pol, precision_tag_type()), "zr_boost_1_81::math::ellint_2<%1%>(%1%)");
}
...
{
   return zr_boost_1_81::math::ellint_2(k, phi, policies::policy<>());
}
...
BOOST_FORCEINLINE typename tools::promote_args<T1, T2>::type ellint_2(T1 k, T2 phi, const Policy& pol)
{
   ...
   typedef typename policies::evaluation<result_type, Policy>::type value_type;
   return policies::checked_narrowing_cast<result_type, Policy>(detail::ellint_e_imp(static_cast<value_type>(phi), static_cast<value_type>(k), pol), "zr_boost_1_81::math::ellint_2<%1%>(%1%,%1%)");
}
