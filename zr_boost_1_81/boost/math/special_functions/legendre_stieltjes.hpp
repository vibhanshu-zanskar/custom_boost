...
public:
    ...
    std::vector<Real> zeros() const
    {
        ...
        while (k < (int)stieltjes_zeros.size())
        {
            ...
            zr_boost_1_81::math::tools::eps_tolerance<Real> tol(6);
            auto g = [&](Real t) { return this->operator()(t); };
            auto p = zr_boost_1_81::math::tools::bisect(g, lower_bound, upper_bound, tol);
            ...
            const Real x_nk = zr_boost_1_81::math::tools::newton_raphson_iterate(f, x_nk_guess,
                                                  p.first, p.second,
                                                  tools::digits<Real>(),
