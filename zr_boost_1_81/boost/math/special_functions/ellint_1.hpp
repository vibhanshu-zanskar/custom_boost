...
T ellint_f_imp(T phi, T k, const Policy& pol)
{
    ...
    static const char* function = "zr_boost_1_81::math::ellint_f<%1%>(%1%,%1%)";
...
T ellint_k_imp(T k, const Policy& pol, std::integral_constant<int, 2> const&)
{
    ...
    static const char* function = "zr_boost_1_81::math::ellint_k<%1%>(%1%)";
...
BOOST_FORCEINLINE T ellint_k_imp(T k, const Policy& pol, std::integral_constant<int, 0> const&)
{
   ...
   else
   {
      ...
      T lambda_prime_4th = zr_boost_1_81::math::pow<4>(lambda_prime);
      ...
      /*T q_prime_2 = lambda_prime
         + 2 * zr_boost_1_81::math::pow<5>(lambda_prime)
         + 15 * zr_boost_1_81::math::pow<9>(lambda_prime)
         + 150 * zr_boost_1_81::math::pow<13>(lambda_prime)
         + 1707 * zr_boost_1_81::math::pow<17>(lambda_prime)
         + 20910 * zr_boost_1_81::math::pow<21>(lambda_prime);*/
      return -log(q_prime) * k_prime / zr_boost_1_81::math::constants::pi<T>();
   }
#endif
   }
}
...
#endif
   > precision_tag_type;
   return policies::checked_narrowing_cast<result_type, Policy>(detail::ellint_k_imp(static_cast<value_type>(k), pol, precision_tag_type()), "zr_boost_1_81::math::ellint_1<%1%>(%1%)");
}

template <class T1, class T2>
BOOST_FORCEINLINE typename tools::promote_args<T1, T2>::type ellint_1(T1 k, T2 phi, const std::false_type&)
{
   return zr_boost_1_81::math::ellint_1(k, phi, policies::policy<>());
}
...
BOOST_FORCEINLINE typename tools::promote_args<T1, T2>::type ellint_1(T1 k, T2 phi, const Policy& pol)
{
   ...
   typedef typename policies::evaluation<result_type, Policy>::type value_type;
   return policies::checked_narrowing_cast<result_type, Policy>(detail::ellint_f_imp(static_cast<value_type>(phi), static_cast<value_type>(k), pol), "zr_boost_1_81::math::ellint_1<%1%>(%1%,%1%)");
}
