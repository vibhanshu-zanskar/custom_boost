...
namespace zr_boost_1_81
{
    namespace math
    {
       namespace detail{
            ...
            if        (x >= tools::forth_root_epsilon<T>())
            {
               if        (x > 1 / tools::root_epsilon<T>())
                ...
                else if(x < 0.5f)
                {
                   ...
                   return zr_boost_1_81::math::log1p(x + zr_boost_1_81::math::sqrt1pm1(x * x, pol), pol);
                }
                else
                {
        ...
        {
           return zr_boost_1_81::math::asinh(x, policies::policy<>());
        }
