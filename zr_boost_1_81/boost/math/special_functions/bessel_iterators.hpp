   ...
   namespace math {
      namespace detail {
         ...
         struct bessel_jy_recurrence
         {
            ...
            zr_boost_1_81::math::tuple<T, T, T> operator()(int k)
            {
               return zr_boost_1_81::math::tuple<T, T, T>(1, -2 * (v + k) / z, 1);
            }
      ...
      template <class T, class Policy = zr_boost_1_81::math::policies::policy<> >
      struct bessel_j_backwards_iterator
      {
         ...
         bessel_j_backwards_iterator(const T& v, const T& x)
            : it(detail::bessel_jy_recurrence<T>(v, x), zr_boost_1_81::math::cyl_bessel_j(v, x, Policy())) 
         {
            if(v < 0)
               zr_boost_1_81::math::policies::raise_domain_error("bessel_j_backwards_iterator<%1%>", "Order must be > 0 stable backwards recurrence but got %1%", v, Policy());
         }
      ...
      private:
         zr_boost_1_81::math::tools::backward_recurrence_iterator< detail::bessel_jy_recurrence<T> > it;
      };
      ...
      struct bessel_i_backwards_iterator
      {
         ...
         bessel_i_backwards_iterator(const T& v, const T& x)
            : it(detail::bessel_ik_recurrence<T>(v, x), zr_boost_1_81::math::cyl_bessel_i(v, x, Policy()))
         {
            if(v < -1)
               zr_boost_1_81::math::policies::raise_domain_error("bessel_i_backwards_iterator<%1%>", "Order must be > 0 stable backwards recurrence but got %1%", v, Policy());
         }
      ...
      private:
         zr_boost_1_81::math::tools::backward_recurrence_iterator< detail::bessel_ik_recurrence<T> > it;
      };
      ...
      struct bessel_i_forwards_iterator
      {
         ...
         {
            if(v > 1)
               zr_boost_1_81::math::policies::raise_domain_error("bessel_i_forwards_iterator<%1%>", "Order must be < 0 stable forwards recurrence but got %1%", v, Policy());
         }
      ...
      private:
         zr_boost_1_81::math::tools::forward_recurrence_iterator< detail::bessel_ik_recurrence<T> > it;
      };
