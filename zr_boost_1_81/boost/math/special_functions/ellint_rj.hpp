...
T ellint_rc1p_imp(T y, const Policy& pol)
{
  ...
  static const char* function = "zr_boost_1_81::math::ellint_rc<%1%>(%1%,%1%)";
   ...
   else
   {
      ...
      {
         T arg = sqrt(-y);
         result = (zr_boost_1_81::math::log1p(arg, pol) - zr_boost_1_81::math::log1p(-arg, pol)) / (2 * sqrt(-y));
      }
      else
      {
...
T ellint_rj_imp(T x, T y, T z, T p, const Policy& pol)
{
   ...
   static const char* function = "zr_boost_1_81::math::ellint_rj<%1%>(%1%,%1%,%1%)";
   ...
   ellint_rj(T1 x, T2 y, T3 z, T4 p, const Policy& pol)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(
      detail::ellint_rj_imp(
         ...
         pol), "zr_boost_1_81::math::ellint_rj<%1%>(%1%,%1%,%1%,%1%)");
}
