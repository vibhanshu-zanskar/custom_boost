   ...
   namespace math
   {
      namespace detail
      {
         ...
         inline RealType owens_t_znorm1(const RealType x, const Policy& pol)
         {
            ...
            return zr_boost_1_81::math::erf(x*one_div_root_two<RealType>(), pol)*half<RealType>();
         ...
         {
            using namespace zr_boost_1_81::math::constants;
            return zr_boost_1_81::math::erfc(x*one_div_root_two<RealType>(), pol)*half<RealType>();
         ...
         inline unsigned short owens_t_get_order_imp(const unsigned short icode, RealType, const std::integral_constant<int, 64>&)
        {
         ...
         inline RealType owens_t_T1(const RealType h, const RealType a, const unsigned short m, const Policy& pol)
         {
            ...
            RealType dj = zr_boost_1_81::math::expm1( hs, pol);
            RealType gj = hs*dhs;
      ...
      const unsigned short m = 20;
        ...
        inline RealType owens_t_T3(const RealType h, const RealType a, const RealType ah, const Policy& pol)
        {
         ...
         inline RealType owens_t_T5_imp(const RealType h, const RealType a, const std::integral_constant<int, 53>&)
         {
            ...
            const RealType as = a*a;
            const RealType hs = -h*h*zr_boost_1_81::math::constants::half<RealType>();
        ...
        inline RealType owens_t_T5(const RealType h, const RealType a, const Policy&)
        {
         ...
         std::pair<T, T> owens_t_T1_accelerated(T h, T a, const Policy& pol)
         {
            ...
            //
            BOOST_MATH_STD_USING
            static const char* function = "zr_boost_1_81::math::owens_t<%1%>(%1%, %1%)";
            T half_h_h = h * h / 2;
            T a_pow = a;
            T aa = a * a;
            ...
            return std::pair<T, T>((sum / d) / zr_boost_1_81::math::constants::two_pi<T>(), abs_err / sum);
         }
         ...
         inline std::pair<RealType, RealType> owens_t_T2_accelerated(const RealType h, const RealType a, const RealType ah, const Policy& pol)
         {
            ...
            RealType val = 0;
            RealType vi = a * exp( -ah*ah*half<RealType>() ) / root_two_pi<RealType>();
            RealType z = zr_boost_1_81::math::detail::owens_t_znorm1(ah, pol)/h;
            RealType last_z = fabs(z);
         ...
         inline RealType T4_mp(const RealType h, const RealType a, const Policy& pol)
         {
            ...
            RealType lim = zr_boost_1_81::math::policies::get_epsilon<RealType, Policy>();
            ...
            while( true )
            {
               ...
               if(ii > (std::min)(1500, (int)policies::get_max_series_iterations<Policy>()))
                  policies::raise_evaluation_error("zr_boost_1_81::math::owens_t<%1%>", 0, val, pol);
            } // while( true )
         ...
         inline RealType owens_t_dispatch(const RealType h, const RealType a, const RealType ah, const Policy& pol, std::integral_constant<int, 64> const&)
         {
            ...
            case 6: // T6
               ...
               break;
            default:
               val = policies::raise_evaluation_error<RealType>("zr_boost_1_81::math::owens_t", "selection routine in Owen's T function failed with h = %1%", h, pol);
            }
            return val;
         }
         ...
         inline RealType owens_t_dispatch(const RealType h, const RealType a, const RealType ah, const Policy& pol, const std::integral_constant<int, 65>&)
         {
            ...
            typedef typename zr_boost_1_81::math::policies::normalise<Policy, zr_boost_1_81::math::policies::evaluation_error<> >::type forwarding_policy;
            ...
            if(ah < 3)
            {
               ...
               catch(const zr_boost_1_81::math::evaluation_error&){}  // T1 may fail and throw, that's OK
#endif
            }
            if(ah > 1)
            {
               ...
               catch(const zr_boost_1_81::math::evaluation_error&){}  // T2 may fail and throw, that's OK
#endif
            }
            //
            ...
            catch(const zr_boost_1_81::math::evaluation_error&){}  // T4 may fail and throw, that's OK
#endif
            //
         ...
         struct owens_t_initializer
         {
            struct init
            {
               ...
               {
                  zr_boost_1_81::math::owens_t(static_cast<T>(7), static_cast<T>(0.96875), Policy());
                  zr_boost_1_81::math::owens_t(static_cast<T>(2), static_cast<T>(0.5), Policy());
               }
      ...
      inline typename tools::promote_args<T1, T2>::type owens_t(T1 h, T2 a, const Policy& pol)
      {
         ...
         return policies::checked_narrowing_cast<result_type, Policy>(detail::owens_t(static_cast<value_type>(h), static_cast<value_type>(a), pol), "zr_boost_1_81::math::owens_t<%1%>(%1%,%1%)");
      }
