...
namespace detail {
  ...
  // signbit
    ...
    {
       return (zr_boost_1_81::math::signbit)(static_cast<double>(x));
    }
    ...
    inline long double (changesign_impl)(long double x, generic_tag<true> const&)
    {
       ...
       pd[0] = zr_boost_1_81::math::changesign(pd[0]);
       pd[1] = zr_boost_1_81::math::changesign(pd[1]);
       return x;
    }
...
{
   return (z == 0) ? 0 : (zr_boost_1_81::math::signbit)(z) ? -1 : 1;
}
   ...
   copysign BOOST_NO_MACRO_EXPAND(const T& x, const U& y)
{
   ...
   return (zr_boost_1_81::math::signbit)(static_cast<result_type>(x)) != (zr_boost_1_81::math::signbit)(static_cast<result_type>(y)) 
      ? (zr_boost_1_81::math::changesign)(static_cast<result_type>(x)) : static_cast<result_type>(x);
}
