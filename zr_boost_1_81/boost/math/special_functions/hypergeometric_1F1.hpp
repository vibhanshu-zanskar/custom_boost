...
namespace zr_boost_1_81 { namespace math { namespace detail {
   ...
   T hypergeometric_1F1_divergent_fallback(const T& a, const T& b, const T& z, const Policy& pol, long long& log_scaling)
   {
      ...
      if (b > 0)
      {
         ...
         {
            return zr_boost_1_81::math::detail::hypergeometric_1f1_recurrence_on_z_minus_zero(a, b, T(z - k), k, pol, log_scaling);
         }
#endif
         if (z < b)
            return hypergeometric_1F1_backward_recurrence_for_negative_a(a, b, z, pol, function, log_scaling);
      ...
      else  // b < 0
      {
         if (a < 0)
         {
            ...
            else
            {
               ...
               //
               bool can_use_recursion = (z - b + 100 < zr_boost_1_81::math::policies::get_max_series_iterations<Policy>()) && (100 - a < zr_boost_1_81::math::policies::get_max_series_iterations<Policy>());
         ...
         else
         {
            ...
            if ((domain < 0) && ((a > 1) || (zr_boost_1_81::math::policies::digits<T, Policy>() <= 64)))
               return hypergeometric_1F1_from_function_ratio_negative_b(a, b, z, pol, log_scaling);
            else if (domain > 0)
            {
               if (zr_boost_1_81::math::policies::digits<T, Policy>() <= 64)
   ...
   T hypergeometric_1F1_imp(const T& a, const T& b, const T& z, const Policy& pol, long long& log_scaling)
   {
      ...
      static const char* const function = "zr_boost_1_81::math::hypergeometric_1F1<%1%,%1%,%1%>(%1%,%1%,%1%)";
      ...
      if (b_minus_a == 0)
      {
         if ((a < 0) && (floor(a) == a))
         {
            ...
            if ((a < -20) && (z > 0) && (z < 1))
            {
               ...
               return exp(z) * zr_boost_1_81::math::gamma_q(1 - a, z, pol);
            }
      ...
      if ((a == 1) && (b == 2))
         return zr_boost_1_81::math::expm1(z, pol) / z;
      ...
      if (z < 0)
      {
         if (hypergeometric_1F1_is_13_3_6_region(a, b, z))
         {
            ...
            T r = zr_boost_1_81::math::detail::hypergeometric_1F1_AS_13_3_6(b_minus_a, b, T(-z), a, pol, log_scaling);
            long long scale = lltrunc(z, pol);
            log_scaling += scale;
      ...
      if (hypergeometric_1F1_need_kummer_reflection(a, b, z))
      {
         ...
         {
            if ((zr_boost_1_81::math::sign(b_minus_a) == zr_boost_1_81::math::sign(b)) && ((b > 0) || (b < -200)))
            {
      ...
      if (hypergeometric_1F1_is_13_3_6_region(b_minus_a, b, T(-z)))
      {
         ...
         // 13.3.6 appears to be the most efficient and often the most accurate method.
         return zr_boost_1_81::math::detail::hypergeometric_1F1_AS_13_3_6(a, b, z, b_minus_a, pol, log_scaling);
      }
#if 0
      if ((a > 0) && (b > 0) && (a * z / b > 2))
      {
   ...
   inline T hypergeometric_1F1_imp(const T& a, const T& b, const T& z, const Policy& pol)
   {
      ...
      //
      static const thread_local long long max_scaling = lltrunc(zr_boost_1_81::math::tools::log_max_value<T>()) - 2;
   ...
   inline T hypergeometric_1F1_regularized_imp(const T& a, const T& b, const T& z, const Policy& pol)
   {
      ...
      //
      int result_sign = 1;
      T scale = log_scaling - zr_boost_1_81::math::lgamma(b, &result_sign, pol);

      static const thread_local T max_scaling = zr_boost_1_81::math::tools::log_max_value<T>() - 2;
...
inline typename tools::promote_args<T1, T2, T3>::type hypergeometric_1F1(T1 a, T2 b, T3 z, const Policy& /* pol */)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(
      detail::hypergeometric_1F1_imp<value_type>(
         ...
         forwarding_policy()),
      "zr_boost_1_81::math::hypergeometric_1F1<%1%>(%1%,%1%,%1%)");
}
