...
T binomial_coefficient(unsigned n, unsigned k, const Policy& pol)
{
   ...
   static const char* function = "zr_boost_1_81::math::binomial_coefficient<%1%>(unsigned, unsigned)";
   if(k > n)
...
inline float binomial_coefficient<float, policies::policy<> >(unsigned n, unsigned k, const policies::policy<>&)
{
   ...
   return policies::checked_narrowing_cast<float, forwarding_policy>(binomial_coefficient<double>(n, k, forwarding_policy()), "zr_boost_1_81::math::binomial_coefficient<%1%>(unsigned,unsigned)");
}
