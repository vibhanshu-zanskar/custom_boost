...
#include <boost/math/special_functions/detail/hypergeometric_pFq_checked_series.hpp>
  ...
  {
    using result_type = zr_boost_1_81::math::tuple<T, T, T>;
    ...
    result_type operator()(std::intmax_t i) const
    {
      ...
      return zr_boost_1_81::math::make_tuple(an, bn, cn);
    }
  ...
  {
     typedef zr_boost_1_81::math::tuple<T, T, T> result_type;
  ...
  T hypergeometric_1F1_backwards_recursion_on_b_for_negative_a(const T& a, const T& b, const T& z, const Policy& pol, const char*, long long& log_scaling)
  {
     ...
     //
     if (b_shift > static_cast<std::intmax_t>(zr_boost_1_81::math::policies::get_max_series_iterations<Policy>()))
        return hypergeometric_1F1_checked_series_impl(a, b, z, pol, log_scaling);

     if (a_shift > static_cast<std::intmax_t>(zr_boost_1_81::math::policies::get_max_series_iterations<Policy>()))
        return hypergeometric_1F1_checked_series_impl(a, b, z, pol, log_scaling);
     ...
     long long scale1 {};
     long long scale2 {};
     first = zr_boost_1_81::math::detail::hypergeometric_1F1_imp(T(a + a_shift), T(b + b_shift), z, pol, scale1);
     //
     ...
     //
     second = zr_boost_1_81::math::detail::hypergeometric_1F1_imp(T(a + a_shift - 1), T(b + b_shift), z, pol, scale2);
     if (scale1 != scale2)
     ...
     //
     second = zr_boost_1_81::math::tools::apply_recurrence_relation_backward(
