  ...
  namespace zr_boost_1_81 { namespace math { namespace detail {
     ...
     inline T hypergeometric_1F1_imp(const T& a, const T& b, const T& z, const Policy& pol, long long& log_scaling);
      ...
      T max_b_for_1F1_small_a_negative_b_by_ratio(const T& z)
      {
         ...
         //
         b += (std::max)(0, zr_boost_1_81::math::tools::digits<T>() - 53) / 5;
         return b;
      }
      ...
      T hypergeometric_1F1_small_a_negative_b_by_ratio(const T& a, const T& b, const T& z, const Policy& pol, long long& log_scaling)
      {
         ...
         T ratio = zr_boost_1_81::math::tools::function_ratio_from_forwards_recurrence(zr_boost_1_81::math::detail::hypergeometric_1F1_recurrence_b_coefficients<T>(a, b, z), zr_boost_1_81::math::tools::epsilon<T>(), max_iter);
         zr_boost_1_81::math::policies::check_series_iterations<T>("zr_boost_1_81::math::hypergeometric_1F1_small_a_negative_b_by_ratio<%1%>(%1%,%1%,%1%)", max_iter, pol);
         T first = 1;
         T second = 1 / ratio;
         long long scaling1 = 0;
         BOOST_MATH_ASSERT(b + iterations != a);
         second = zr_boost_1_81::math::tools::apply_recurrence_relation_forward(zr_boost_1_81::math::detail::hypergeometric_1F1_recurrence_b_coefficients<T>(a, b + 1, z), iterations, first, second, &scaling1);
