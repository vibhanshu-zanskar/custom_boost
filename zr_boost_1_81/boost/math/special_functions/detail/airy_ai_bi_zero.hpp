  ...
  namespace detail
  {
    ...
    namespace airy_zero
    {
      ...
      T equation_as_10_4_105(const T& z, const Policy& pol)
      {
        ...
        const T z_pow_third     (zr_boost_1_81::math::cbrt(z, pol));
      ...
      namespace airy_ai_zero_detail
      {
        ...
        T initial_guess(const int m, const Policy& pol)
        {
          ...
          switch(m)
          {
            ...
            case 10:
              ...
              break;
            default:
              const T t(((zr_boost_1_81::math::constants::pi<T>() * 3) * ((T(m) * 4) - 1)) / 8);
              guess = -zr_boost_1_81::math::detail::airy_zero::equation_as_10_4_105(t, pol);
              break;
          }
        ...
        public:
          ...
          zr_boost_1_81::math::tuple<T, T> operator()(const T& x) const
          {
            ...
            return zr_boost_1_81::math::make_tuple(
              zr_boost_1_81::math::detail::airy_ai_imp      (x, my_pol),
              zr_boost_1_81::math::detail::airy_ai_prime_imp(x, my_pol));
          }
      ...
      namespace airy_bi_zero_detail
      {
        ...
        T initial_guess(const int m, const Policy& pol)
        {
          ...
          switch(m)
          {
            ...
            case 10:
              ...
              break;
            default:
              const T t(((zr_boost_1_81::math::constants::pi<T>() * 3) * ((T(m) * 4) - 3)) / 8);
              guess = -zr_boost_1_81::math::detail::airy_zero::equation_as_10_4_105(t, pol);
              break;
          }
        ...
        public:
          ...
          zr_boost_1_81::math::tuple<T, T> operator()(const T& x) const
          {
            ...
            return zr_boost_1_81::math::make_tuple(
              zr_boost_1_81::math::detail::airy_bi_imp      (x, my_pol),
              zr_boost_1_81::math::detail::airy_bi_prime_imp(x, my_pol));
          }
