...
#else
   using zr_boost_1_81::math::acosh;
#define BOOST_MATH_ACOSH_POLICY , Policy()
    ...
    {
       std::swap(T0, T1);
       T1 = zr_boost_1_81::math::chebyshev_next(x, T0, T1);
       ++l;
    }
    return T1;
}
...
inline tools::promote_args_t<Real> chebyshev_t(unsigned n, Real const & x, const Policy&)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(detail::chebyshev_imp<value_type, false>(n, static_cast<value_type>(x), forwarding_policy()), "zr_boost_1_81::math::chebyshev_t<%1%>(unsigned, %1%)");
}
...
inline tools::promote_args_t<Real> chebyshev_u(unsigned n, Real const & x, const Policy&)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(detail::chebyshev_imp<value_type, true>(n, static_cast<value_type>(x), forwarding_policy()), "zr_boost_1_81::math::chebyshev_u<%1%>(unsigned, %1%)");
}
...
inline tools::promote_args_t<Real> chebyshev_t_prime(unsigned n, Real const & x, const Policy&)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(n * detail::chebyshev_imp<value_type, true>(n - 1, static_cast<value_type>(x), forwarding_policy()), "zr_boost_1_81::math::chebyshev_t_prime<%1%>(unsigned, %1%)");
}
