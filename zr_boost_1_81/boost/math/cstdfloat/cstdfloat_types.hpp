...
// Implement the types for floating-point typedefs having specified widths.
  ...
  // <boost/math/tools/config.hpp>.
    ...
    namespace zr_boost_1_81 { namespace math { namespace cstdfloat { namespace detail {
    #if defined(__GNUC__)
    ...
    #define BOOST_CSTDFLOAT_FLOAT128_NATIVE_TYPE zr_boost_1_81::math::cstdfloat::detail::float_internal128_t
    #undef  BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH
    #define BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH 128
    #undef  BOOST_CSTDFLOAT_HAS_FLOAT128_NATIVE_TYPE
    #define BOOST_CSTDFLOAT_HAS_FLOAT128_NATIVE_TYPE  1
  ...
  // specified widths. The types are defined in the namespace zr_boost_1_81.
  ...
  namespace zr_boost_1_81
  {
      ...
      typedef zr_boost_1_81::float16_t float_fast16_t;
      typedef zr_boost_1_81::float16_t float_least16_t;

      static_assert(std::numeric_limits<zr_boost_1_81::float16_t>::is_iec559    == true, "zr_boost_1_81::float16_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<zr_boost_1_81::float16_t>::radix        ==    2, "zr_boost_1_81::float16_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<zr_boost_1_81::float16_t>::digits       ==   11, "zr_boost_1_81::float16_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<zr_boost_1_81::float16_t>::max_exponent ==   16, "zr_boost_1_81::float16_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      ...
      typedef zr_boost_1_81::float32_t float_fast32_t;
      typedef zr_boost_1_81::float32_t float_least32_t;

      static_assert(std::numeric_limits<zr_boost_1_81::float32_t>::is_iec559    == true, "zr_boost_1_81::float32_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<zr_boost_1_81::float32_t>::radix        ==    2, "zr_boost_1_81::float32_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<zr_boost_1_81::float32_t>::digits       ==   24, "zr_boost_1_81::float32_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<zr_boost_1_81::float32_t>::max_exponent ==  128, "zr_boost_1_81::float32_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
...
#define BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH 64
      ...
      typedef zr_boost_1_81::float64_t float_fast64_t;
      typedef zr_boost_1_81::float64_t float_least64_t;

      static_assert(std::numeric_limits<zr_boost_1_81::float64_t>::is_iec559    == true, "zr_boost_1_81::float64_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<zr_boost_1_81::float64_t>::radix        ==    2, "zr_boost_1_81::float64_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<zr_boost_1_81::float64_t>::digits       ==   53, "zr_boost_1_81::float64_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<zr_boost_1_81::float64_t>::max_exponent == 1024, "zr_boost_1_81::float64_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      ...
      typedef zr_boost_1_81::float80_t float_fast80_t;
      typedef zr_boost_1_81::float80_t float_least80_t;

      static_assert(std::numeric_limits<zr_boost_1_81::float80_t>::is_iec559    ==  true, "zr_boost_1_81::float80_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<zr_boost_1_81::float80_t>::radix        ==     2, "zr_boost_1_81::float80_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<zr_boost_1_81::float80_t>::digits       ==    64, "zr_boost_1_81::float80_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<zr_boost_1_81::float80_t>::max_exponent == 16384, "zr_boost_1_81::float80_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      ...
      typedef zr_boost_1_81::float128_t float_fast128_t;
      typedef zr_boost_1_81::float128_t float_least128_t;

      #if defined(BOOST_CSTDFLOAT_HAS_INTERNAL_FLOAT128_T) && defined(BOOST_MATH_USE_FLOAT128) && !defined(BOOST_CSTDFLOAT_NO_LIBQUADMATH_SUPPORT)
      // This configuration does not *yet* support std::numeric_limits<zr_boost_1_81::float128_t>.
      // Support for std::numeric_limits<zr_boost_1_81::float128_t> is added in the detail
      // file <boost/math/cstdfloat/cstdfloat_limits.hpp>.
      #else
      static_assert(std::numeric_limits<zr_boost_1_81::float128_t>::is_iec559    ==  true, "zr_boost_1_81::float128_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<zr_boost_1_81::float128_t>::radix        ==     2, "zr_boost_1_81::float128_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<zr_boost_1_81::float128_t>::digits       ==   113, "zr_boost_1_81::float128_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      static_assert(std::numeric_limits<zr_boost_1_81::float128_t>::max_exponent == 16384, "zr_boost_1_81::float128_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      #endif
    ...
    #if  (BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH ==  16)
      typedef zr_boost_1_81::float16_t  floatmax_t;
    #elif(BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH ==  32)
      typedef zr_boost_1_81::float32_t  floatmax_t;
    #elif(BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH ==  64)
      typedef zr_boost_1_81::float64_t  floatmax_t;
    #elif(BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH ==  80)
      typedef zr_boost_1_81::float80_t  floatmax_t;
    #elif(BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH == 128)
      typedef zr_boost_1_81::float128_t floatmax_t;
    #else
      #error The maximum available floating-point width for <boost/cstdfloat.hpp> is undefined.
    #endif
