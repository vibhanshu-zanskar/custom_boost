...
#define BOOST_MATH_META_INT(Type, name, Default)                                                \
   ...
   {                                                                                            \
   public:                                                                                      \
      static constexpr bool value = zr_boost_1_81::math::policies::detail::is_##name##_imp<T>::value;   \
...
public:
   ...
   using type = typename std::conditional<
      (Digits2::value > ::zr_boost_1_81::math::policies::detail::precision<Digits10,Digits2>::digits2_type::value),
...
{
public:
   static constexpr bool value = sizeof(zr_boost_1_81::math::policies::detail::test_is_valid_arg(static_cast<T*>(nullptr))) == sizeof(char);
};
...
{
public:
   static constexpr bool value = zr_boost_1_81::math::policies::detail::is_valid_policy_imp<T>::value;
};
...
{
public:
   static constexpr bool value = sizeof(zr_boost_1_81::math::policies::detail::test_is_default_arg(static_cast<T*>(nullptr))) == sizeof(char);
};
...
{
public:
   static constexpr bool value = zr_boost_1_81::math::policies::detail::is_default_policy_imp<T>::value;
   using type = std::integral_constant<bool, value>;
...
private:
   ...
   //
   static_assert(::zr_boost_1_81::math::policies::detail::is_valid_policy<A1>::value, "::zr_boost_1_81::math::policies::detail::is_valid_policy<A1>::value");
   static_assert(::zr_boost_1_81::math::policies::detail::is_valid_policy<A2>::value, "::zr_boost_1_81::math::policies::detail::is_valid_policy<A2>::value");
   static_assert(::zr_boost_1_81::math::policies::detail::is_valid_policy<A3>::value, "::zr_boost_1_81::math::policies::detail::is_valid_policy<A3>::value");
   static_assert(::zr_boost_1_81::math::policies::detail::is_valid_policy<A4>::value, "::zr_boost_1_81::math::policies::detail::is_valid_policy<A4>::value");
   static_assert(::zr_boost_1_81::math::policies::detail::is_valid_policy<A5>::value, "::zr_boost_1_81::math::policies::detail::is_valid_policy<A5>::value");
   static_assert(::zr_boost_1_81::math::policies::detail::is_valid_policy<A6>::value, "::zr_boost_1_81::math::policies::detail::is_valid_policy<A6>::value");
   static_assert(::zr_boost_1_81::math::policies::detail::is_valid_policy<A7>::value, "::zr_boost_1_81::math::policies::detail::is_valid_policy<A7>::value");
   static_assert(::zr_boost_1_81::math::policies::detail::is_valid_policy<A8>::value, "::zr_boost_1_81::math::policies::detail::is_valid_policy<A8>::value");
   static_assert(::zr_boost_1_81::math::policies::detail::is_valid_policy<A9>::value, "::zr_boost_1_81::math::policies::detail::is_valid_policy<A9>::value");
   static_assert(::zr_boost_1_81::math::policies::detail::is_valid_policy<A10>::value, "::zr_boost_1_81::math::policies::detail::is_valid_policy<A10>::value");
   static_assert(::zr_boost_1_81::math::policies::detail::is_valid_policy<A11>::value, "::zr_boost_1_81::math::policies::detail::is_valid_policy<A11>::value");
   static_assert(::zr_boost_1_81::math::policies::detail::is_valid_policy<A12>::value, "::zr_boost_1_81::math::policies::detail::is_valid_policy<A12>::value");
   static_assert(::zr_boost_1_81::math::policies::detail::is_valid_policy<A13>::value, "::zr_boost_1_81::math::policies::detail::is_valid_policy<A13>::value");
   //
...
inline constexpr int digits_imp(std::true_type const&) noexcept
{
   ...
   typedef typename zr_boost_1_81::math::policies::precision<T, Policy>::type p_t;
   return p_t::value;
}
...
{
   return zr_boost_1_81::math::policies::digits<T, Policy>() * 301 / 1000L;
}
...
struct series_factor_calc<T, Digits, std::true_type, std::true_type>
{
   ...
   {
      return zr_boost_1_81::math::tools::epsilon<T>();
   }
};
template <class T, class Digits>
...
{
public:
   static constexpr bool value = (sizeof(::zr_boost_1_81::math::policies::detail::test_is_policy(static_cast<P*>(nullptr))) == sizeof(char));
};
...
{
public:
   static constexpr bool value = zr_boost_1_81::math::policies::detail::is_policy_imp<P>::value;
   using type = std::integral_constant<bool, value>;
};
