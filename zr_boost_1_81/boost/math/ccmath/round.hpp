...
{
    T iptr = 0;
    const T x = zr_boost_1_81::math::ccmath::modf(arg, &iptr);
    ...
    else if(zr_boost_1_81::math::ccmath::abs(x) >= half && iptr < 0)
    {
        return iptr - 1;
    }
    else
...
inline constexpr Real round(Real arg) noexcept
{
    if(BOOST_MATH_IS_CONSTANT_EVALUATED(arg))
    {
        return zr_boost_1_81::math::ccmath::abs(arg) == Real(0) ? arg :
               ...
               zr_boost_1_81::math::ccmath::detail::round_impl(arg);
    }
    else
    {
        using std::round;
...
{
    return zr_boost_1_81::math::ccmath::round(static_cast<double>(arg));
}

inline constexpr float roundf(float arg) noexcept
{
    return zr_boost_1_81::math::ccmath::round(arg);
}
...
inline constexpr long lround(Real arg)
{
    if(BOOST_MATH_IS_CONSTANT_EVALUATED(arg))
    {
        return zr_boost_1_81::math::ccmath::abs(arg) == Real(0) ? 0l :
               zr_boost_1_81::math::ccmath::isinf(arg) ? 0l :
               zr_boost_1_81::math::ccmath::isnan(arg) ? 0l :
               zr_boost_1_81::math::ccmath::detail::int_round_impl<long>(arg);
    }
    else
    {
        using std::lround;
...
{
    return zr_boost_1_81::math::ccmath::lround(static_cast<double>(arg));
}

inline constexpr long lroundf(float arg)
{
    return zr_boost_1_81::math::ccmath::lround(arg);
}
...
inline constexpr long long llround(Real arg)
{
    if(BOOST_MATH_IS_CONSTANT_EVALUATED(arg))
    {
        return zr_boost_1_81::math::ccmath::abs(arg) == Real(0) ? 0ll :
               zr_boost_1_81::math::ccmath::isinf(arg) ? 0ll :
               zr_boost_1_81::math::ccmath::isnan(arg) ? 0ll :
               zr_boost_1_81::math::ccmath::detail::int_round_impl<long long>(arg);
    }
    else
    {
        using std::llround;
...
{
    return zr_boost_1_81::math::ccmath::llround(static_cast<double>(arg));
}

inline constexpr long long llroundf(float arg)
{
    return zr_boost_1_81::math::ccmath::llround(arg);
}
