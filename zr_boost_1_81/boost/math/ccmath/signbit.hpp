...
ccmath_signbit_test.cpp:32:19: error: static_assert expression is not an integral constant expression
    static_assert(zr_boost_1_81::math::ccmath::signbit(T(-1)) == true);
                  ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
constexpr bool signbit_impl(T arg)
{
    ...
    {
        BOOST_MATH_ASSERT_MSG(!zr_boost_1_81::math::ccmath::isnan(arg), "NAN is not supported with this type or platform");
        BOOST_MATH_ASSERT_MSG(zr_boost_1_81::math::ccmath::abs(arg) != 0, "Signed 0 is not support with this type or platform");
...
constexpr bool signbit_impl(T arg)
{
    BOOST_MATH_ASSERT_MSG(!zr_boost_1_81::math::ccmath::isnan(arg), "NAN is not supported without __builtin_bit_cast or std::bit_cast");
    BOOST_MATH_ASSERT_MSG(zr_boost_1_81::math::ccmath::abs(arg) != 0, "Signed 0 is not support without __builtin_bit_cast or std::bit_cast");
...
constexpr bool signbit(Real arg)
{
    ...
    {
        return zr_boost_1_81::math::ccmath::detail::signbit_impl(arg);
    }
    else
    {
        using std::signbit;
...
{
    return zr_boost_1_81::math::ccmath::signbit(static_cast<double>(arg));
}
