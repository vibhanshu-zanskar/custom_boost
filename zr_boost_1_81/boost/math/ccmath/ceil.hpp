...
{
    T result = zr_boost_1_81::math::ccmath::floor(arg);
...
inline constexpr Real ceil(Real arg) noexcept
{
    if(BOOST_MATH_IS_CONSTANT_EVALUATED(arg))
    {
        return zr_boost_1_81::math::ccmath::abs(arg) == Real(0) ? arg :
               ...
               zr_boost_1_81::math::ccmath::detail::ceil_impl(arg);
    }
    else
    {
        using std::ceil;
...
{
    return zr_boost_1_81::math::ccmath::ceil(static_cast<double>(arg));
}

inline constexpr float ceilf(float arg) noexcept
{
    return zr_boost_1_81::math::ccmath::ceil(arg);
}
