...
inline constexpr Real floor(Real arg) noexcept
{
    if(BOOST_MATH_IS_CONSTANT_EVALUATED(arg))
    {
        return zr_boost_1_81::math::ccmath::abs(arg) == Real(0) ? arg :
               ...
               zr_boost_1_81::math::ccmath::detail::floor_impl(arg);
    }
    else
    {
        using std::floor;
...
{
    return zr_boost_1_81::math::ccmath::floor(static_cast<double>(arg));
}

inline constexpr float floorf(float arg) noexcept
{
    return zr_boost_1_81::math::ccmath::floor(arg);
}
