   ...
   namespace math {
      namespace tools {
         ...
         T function_ratio_from_backwards_recurrence(const Recurrence& r, const T& factor, std::uintmax_t& max_iter)
         {
            ...
            return zr_boost_1_81::math::tools::continued_fraction_a(f, factor, max_iter);
         }
         ...
         {
            zr_boost_1_81::math::tools::detail::function_ratio_from_backwards_recurrence_fraction<zr_boost_1_81::math::tools::detail::recurrence_reverser<Recurrence, T> > f(r);
            return zr_boost_1_81::math::tools::continued_fraction_a(f, factor, max_iter);
         }
         ...
         inline T apply_recurrence_relation_forward(const NextCoefs& get_coefs, unsigned number_of_steps, T first, T second, long long* log_scaling = nullptr, T* previous = nullptr)
         {
            ...
            for (unsigned k = 0; k < number_of_steps; ++k)
            {
               ...
               BOOST_MATH_ASSERT((zr_boost_1_81::math::isfinite)(third));
         ...
         inline T apply_recurrence_relation_backward(const NextCoefs& get_coefs, unsigned number_of_steps, T first, T second, long long* log_scaling = nullptr, T* previous = nullptr)
         {
            ...
            for (unsigned k = 0; k < number_of_steps; ++k)
            {
               ...
               BOOST_MATH_ASSERT((zr_boost_1_81::math::isfinite)(next));
         ...
         struct forward_recurrence_iterator
         {
            ...
            forward_recurrence_iterator(const Recurrence& r, value_type f_n)
               : f_n(f_n), coef(r), k(0)
            {
               std::uintmax_t max_iter = zr_boost_1_81::math::policies::get_max_series_iterations<zr_boost_1_81::math::policies::policy<> >();
               f_n_minus_1 = f_n * zr_boost_1_81::math::tools::function_ratio_from_forwards_recurrence(detail::recurrence_offsetter<Recurrence>(r, -1), value_type(zr_boost_1_81::math::tools::epsilon<value_type>() * 2), max_iter);
               zr_boost_1_81::math::policies::check_series_iterations<value_type>("forward_recurrence_iterator<>::forward_recurrence_iterator", max_iter, zr_boost_1_81::math::policies::policy<>());
            }
         ...
         struct backward_recurrence_iterator
         {
            ...
            {
               std::uintmax_t max_iter = zr_boost_1_81::math::policies::get_max_series_iterations<zr_boost_1_81::math::policies::policy<> >();
               f_n_plus_1 = f_n * zr_boost_1_81::math::tools::function_ratio_from_backwards_recurrence(detail::recurrence_offsetter<Recurrence>(r, 1), value_type(zr_boost_1_81::math::tools::epsilon<value_type>() * 2), max_iter);
               zr_boost_1_81::math::policies::check_series_iterations<value_type>("backward_recurrence_iterator<>::backward_recurrence_iterator", max_iter, zr_boost_1_81::math::policies::policy<>());
            }
