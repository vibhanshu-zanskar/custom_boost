...
namespace zr_boost_1_81 { namespace math { namespace tools { namespace detail {
template <typename T>
struct type {};
...
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(t)              zr_boost_1_81::math::tools::detail::type<t>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(t)         zr_boost_1_81::math::tools::detail::type<t>*
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE(t, v)       zr_boost_1_81::math::tools::detail::non_type<t, v>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE_SPEC(t, v)  zr_boost_1_81::math::tools::detail::non_type<t, v>*
...
#    define BOOST_FPU_EXCEPTION_GUARD zr_boost_1_81::math::detail::fpu_guard local_guard_object;
