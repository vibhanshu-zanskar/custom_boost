...
namespace zr_boost_1_81 { namespace integer {
...
}} // namespace zr_boost_1_81::integer
#endif
...
namespace zr_boost_1_81{
   ...
   namespace integer {
      ...
      namespace gcd_detail {
         ...
         template <class T>
         struct gcd_traits<zr_boost_1_81::math::tools::polynomial<T> >
         {
            inline static const zr_boost_1_81::math::tools::polynomial<T>& abs(const zr_boost_1_81::math::tools::polynomial<T>& val) { return val; }
...
{
    return x ? zr_boost_1_81::integer::gcd_range(x.data().begin(), x.data().end()).first : T(0);
}
...
namespace detail
{
    ...
    */
    ...
    T reduce_to_primitive(polynomial<T> &u, polynomial<T> &v)
    {
        ...
        #else
        return zr_boost_1_81::integer::gcd_detail::Euclid_gcd(u_cont, v_cont);
        #endif
    }
}
...
gcd(polynomial<T> const &u, polynomial<T> const &v)
{
    return zr_boost_1_81::integer::gcd_detail::Euclid_gcd(u, v);
}
...
//
using zr_boost_1_81::math::tools::gcd;
...
} // namespace zr_boost_1_81::math::tools
