...
{
   return zr_boost_1_81::lexical_cast<T>(s);
}
#else
template <typename T>
inline T make_big_value(largest_float, const char* s, std::false_type const&, std::false_type const&)
...
#define BOOST_MATH_BIG_CONSTANT(T, D, x)\
   zr_boost_1_81::math::tools::make_big_value<T>(\
      BOOST_MATH_LARGEST_FLOAT_C(x), \
      BOOST_STRINGIZE(x), \
      std::integral_constant<bool, (std::is_convertible<zr_boost_1_81::math::tools::largest_float, T>::value) && \
      ((D <= zr_boost_1_81::math::tools::numeric_traits<zr_boost_1_81::math::tools::largest_float>::digits) \
          || std::is_floating_point<T>::value \
          || (zr_boost_1_81::math::tools::numeric_traits<T>::is_specialized && \
          (zr_boost_1_81::math::tools::numeric_traits<T>::digits10 <= zr_boost_1_81::math::tools::numeric_traits<zr_boost_1_81::math::tools::largest_float>::digits10))) >(), \
...
#define BOOST_MATH_HUGE_CONSTANT(T, D, x)\
   zr_boost_1_81::math::tools::make_big_value<T>(0.0L, BOOST_STRINGIZE(x), \
   std::integral_constant<bool, std::is_floating_point<T>::value || (zr_boost_1_81::math::tools::numeric_traits<T>::is_specialized && zr_boost_1_81::math::tools::numeric_traits<T>::max_exponent <= zr_boost_1_81::math::tools::numeric_traits<zr_boost_1_81::math::tools::largest_float>::max_exponent && zr_boost_1_81::math::tools::numeric_traits<T>::digits <= zr_boost_1_81::math::tools::numeric_traits<zr_boost_1_81::math::tools::largest_float>::digits)>(), \
   std::is_constructible<T, const char*>())
