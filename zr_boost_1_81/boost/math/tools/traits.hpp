...
/*
This header defines two traits classes, both in namespace zr_boost_1_81::math::tools.
...
{
   static constexpr bool value = (::zr_boost_1_81::math::tools::detail::is_scaled_distribution_helper<D, ::zr_boost_1_81::math::tools::detail::is_distribution_imp<D>::value>::value);
};

} // namespace detail

template <typename T> struct is_distribution : public std::integral_constant<bool, ::zr_boost_1_81::math::tools::detail::is_distribution_imp<T>::value> {};
template <typename T> struct is_scaled_distribution : public std::integral_constant<bool, ::zr_boost_1_81::math::tools::detail::is_scaled_distribution_imp<T>::value> {};
