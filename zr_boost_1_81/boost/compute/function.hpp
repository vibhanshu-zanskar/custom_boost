...
public:
    ...
    /// \internal_
    detail::invoked_function<result_type, zr_boost_1_81::tuple<> >
    operator()() const
    {
        ...
        return detail::invoked_function<result_type, zr_boost_1_81::tuple<> >(
    ...
    /// \internal_
    template<class Arg1>
    detail::invoked_function<result_type, zr_boost_1_81::tuple<Arg1> >
    operator()(const Arg1 &arg1) const
    {
        ...
        return detail::invoked_function<result_type, zr_boost_1_81::tuple<Arg1> >(
            m_name, m_source, m_definitions, zr_boost_1_81::make_tuple(arg1)
        );
    }

    /// \internal_
    template<class Arg1, class Arg2>
    detail::invoked_function<result_type, zr_boost_1_81::tuple<Arg1, Arg2> >
    operator()(const Arg1 &arg1, const Arg2 &arg2) const
    {
        ...
        return detail::invoked_function<result_type, zr_boost_1_81::tuple<Arg1, Arg2> >(
            m_name, m_source, m_definitions, zr_boost_1_81::make_tuple(arg1, arg2)
        );
    }

    /// \internal_
    template<class Arg1, class Arg2, class Arg3>
    detail::invoked_function<result_type, zr_boost_1_81::tuple<Arg1, Arg2, Arg3> >
    operator()(const Arg1 &arg1, const Arg2 &arg2, const Arg3 &arg3) const
    {
        ...
        return detail::invoked_function<result_type, zr_boost_1_81::tuple<Arg1, Arg2, Arg3> >(
            m_name, m_source, m_definitions, zr_boost_1_81::make_tuple(arg1, arg2, arg3)
        );
    }
...
#define BOOST_COMPUTE_FUNCTION(return_type, name, arguments, ...) \
    ::zr_boost_1_81::compute::function<return_type arguments> name = \
        ::zr_boost_1_81::compute::detail::make_function_impl<return_type arguments>( \
