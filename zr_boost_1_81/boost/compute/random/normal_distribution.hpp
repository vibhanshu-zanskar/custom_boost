...
public:
                  ...
                  command_queue &queue)
    {
        ...
        box_muller.define("MEAN", zr_boost_1_81::lexical_cast<std::string>(m_mean));
        box_muller.define("STDDEV", zr_boost_1_81::lexical_cast<std::string>(m_stddev));
...
private:
    ...
    BOOST_STATIC_ASSERT_MSG(
        zr_boost_1_81::is_floating_point<RealType>::value,
