...
public:
                  ...
                  command_queue &queue)
    {
        ...
        scale_random.define("LO", zr_boost_1_81::lexical_cast<std::string>(m_a));
        scale_random.define("HI", zr_boost_1_81::lexical_cast<std::string>(m_b));
...
private:
    ...
    BOOST_STATIC_ASSERT_MSG(
        zr_boost_1_81::is_integral<IntType>::value,
