...
/// \code
/// zr_boost_1_81::compute::program bar_program =
///     zr_boost_1_81::compute::program::create_with_source_file("/path/to/bar.cl", context);
/// \endcode
///
...
/// zr_boost_1_81::compute::kernel foo_kernel = foo_program.create_kernel("foo");
/// \endcode
///
/// \see kernel
class program
...
public:
    ...
    ///     program.build();
    /// }
    /// catch(zr_boost_1_81::compute::opencl_error &e){
            ...
            )
    {
        ...
        try {
            zr_boost_1_81::optional<program> prog = load_program_binary(hash_string, context);
...
private:
    ...
    static zr_boost_1_81::optional<program> load_program_binary(
            ...
            )
    {
        ...
        if (!bfile) return zr_boost_1_81::optional<program>();
        ...
        return zr_boost_1_81::optional<program>(
