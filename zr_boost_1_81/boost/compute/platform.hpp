...
public:
    ...
    std::vector<std::string> extensions() const
    {
        ...
        zr_boost_1_81::split(extensions_vector,
                     extensions_string,
                     zr_boost_1_81::is_any_of("\t "),
                     zr_boost_1_81::token_compress_on);
...
inline zr_boost_1_81::compute::platform device::platform() const
{
    return zr_boost_1_81::compute::platform(get_info<CL_DEVICE_PLATFORM>());
}
