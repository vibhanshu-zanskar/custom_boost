...
#ifndef BOOST_COMPUTE_NO_BOOST_CHRONO
template<class Rep, class Period>
inline zr_boost_1_81::chrono::duration<Rep, Period>
make_duration_from_nanoseconds(zr_boost_1_81::chrono::duration<Rep, Period>, size_t nanoseconds)
{
    return zr_boost_1_81::chrono::duration_cast<zr_boost_1_81::chrono::duration<Rep, Period> >(
        zr_boost_1_81::chrono::nanoseconds(nanoseconds)
    );
}
