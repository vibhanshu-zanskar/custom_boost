...
// converts uchar to ::zr_boost_1_81::compute::uchar_
#define BOOST_COMPUTE_MAKE_SCALAR_TYPE(scalar) \
    BOOST_PP_CAT(::zr_boost_1_81::compute::scalar, _)

// converts float, 4 to ::zr_boost_1_81::compute::float4_
#define BOOST_COMPUTE_MAKE_VECTOR_TYPE(scalar, size) \
    BOOST_PP_CAT(BOOST_PP_CAT(::zr_boost_1_81::compute::scalar, size), _)
