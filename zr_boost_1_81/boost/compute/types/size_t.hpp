...
template <> struct is_fundamental<size_t>    : zr_boost_1_81::true_type {};
template <> struct is_fundamental<ptrdiff_t> : zr_boost_1_81::true_type {};

namespace detail {

template <> struct type_name_trait<size_t>
    : type_name_trait<
        zr_boost_1_81::mpl::if_c<sizeof(size_t) == sizeof(cl_uint), cl_uint, cl_ulong>::type
        >
{};

template <> struct type_name_trait<ptrdiff_t>
    : type_name_trait<
        zr_boost_1_81::mpl::if_c<sizeof(ptrdiff_t) == sizeof(cl_int), cl_int, cl_long>::type
        >
{};
