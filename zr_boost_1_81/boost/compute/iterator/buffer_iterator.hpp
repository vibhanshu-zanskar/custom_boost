...
public:
    typedef ::zr_boost_1_81::iterator_facade<
        ::zr_boost_1_81::compute::buffer_iterator<T>,
        T,
        ::std::random_access_iterator_tag,
        ::zr_boost_1_81::compute::detail::buffer_value<T>
    > type;
};
...
struct buffer_iterator_index_expr
{
    ...
    operator T() const
    {
        BOOST_STATIC_ASSERT_MSG(zr_boost_1_81::is_integral<IndexExpr>::value,
...
template<class T>
struct is_device_iterator<buffer_iterator<T> > : zr_boost_1_81::true_type {};
...
struct is_buffer_iterator<
    ...
    typename zr_boost_1_81::enable_if<
        zr_boost_1_81::is_same<
            ...
            typename zr_boost_1_81::remove_const<Iterator>::type
        >
    >::type
