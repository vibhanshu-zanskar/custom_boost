...
struct make_transform_iterator_value_type
{
    ...
    typedef typename zr_boost_1_81::compute::result_of<UnaryFunction(value_type)>::type type;
};
...
public:
    typedef ::zr_boost_1_81::iterator_adaptor<
        ::zr_boost_1_81::compute::transform_iterator<InputIterator, UnaryFunction>,
        InputIterator,
...
struct is_device_iterator<
    transform_iterator<InputIterator, UnaryFunction> > : zr_boost_1_81::true_type {};
