                           ...
                           command_queue &queue)
{
    ::zr_boost_1_81::compute::copy(
        ::zr_boost_1_81::compute::make_constant_iterator(value, 0),
        ::zr_boost_1_81::compute::make_constant_iterator(value, count),
        first,
        queue
    );
}
...
inline future<void> fill_async_with_copy(BufferIterator first,
                                         ...
                                         command_queue &queue)
{
    return ::zr_boost_1_81::compute::copy_async(
               ::zr_boost_1_81::compute::make_constant_iterator(value, 0),
               ::zr_boost_1_81::compute::make_constant_iterator(value, count),
               first,
               queue
...
template<>
struct is_valid_fill_buffer_iterator<discard_iterator> : public zr_boost_1_81::false_type {};
...
/// zr_boost_1_81::compute::fill(vec.begin(), vec.end(), 7, queue);
/// \endcode
///
/// Space complexity: \Omega(1)
///
/// \see zr_boost_1_81::compute::fill_n()
template<class BufferIterator, class T>
