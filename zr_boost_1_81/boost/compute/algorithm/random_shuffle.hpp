                           ...
                           command_queue &queue = system::default_queue())
{
    ...
    zr_boost_1_81::iota(random_indices, 0);
#ifdef BOOST_COMPUTE_USE_CPP11
    ...
    ::zr_boost_1_81::compute::copy(random_indices.begin(),
                           random_indices.end(),
                           indices.begin(),
                           queue);
    ...
    ::zr_boost_1_81::compute::copy(first,
                           last,
                           tmp.begin(),
                           queue);

    // write values to their new locations
    ::zr_boost_1_81::compute::scatter(tmp.begin(),
                              tmp.end(),
                              indices.begin(),
                              first,
                              queue);
