                   ...
                   command_queue &queue = system::default_queue())
{
    ...
    ::zr_boost_1_81::compute::copy(first, last, temp.begin(), queue);

    ::zr_boost_1_81::compute::copy(temp.begin()+count, temp.end(), first, queue);
    ::zr_boost_1_81::compute::copy(temp.begin(), temp.begin()+count, last-count, queue);
}
