...
template<class T>
inline typename zr_boost_1_81::enable_if_c<is_radix_sortable<T>::value>::type
                        ...
                        command_queue &queue = system::default_queue())
{
    ...
    if(queue.get_device().type() & device::gpu) {
        ::zr_boost_1_81::compute::detail::dispatch_gpu_stable_sort(
            first, last, compare, queue
        );
        return;
    }
                        ...
                        command_queue &queue = system::default_queue())
{
    ...
    ::zr_boost_1_81::compute::less<value_type> less;

    ::zr_boost_1_81::compute::stable_sort(first, last, less, queue);
}
