              ...
              command_queue &queue)
{
    typedef typename
        ...
        input_type;
    typedef typename
        zr_boost_1_81::compute::result_of<BinaryFunction(input_type, input_type)>::type
        result_type;
...
inline vector<
    typename zr_boost_1_81::compute::result_of<
        BinaryFunction(
                           ...
                           command_queue &queue)
{
    ...
    if(device.type() & device::cpu){
        ...
        zr_boost_1_81::compute::copy_n(value.begin(), 1, result, queue);
    }
    else {
        ...
        zr_boost_1_81::compute::copy_n(results.begin(), 1, result, queue);
    }
}
