...
///
/// // create vector
/// zr_boost_1_81::compute::vector<uint2_> data = ...
///
/// zr_boost_1_81::compute::vector<uint2_>::iterator min =
///     zr_boost_1_81::compute::min_element(data.begin(), data.end(), compare_first, queue);
/// \endcode
///
            ...
            command_queue &queue = system::default_queue())
{
    ...
    return ::zr_boost_1_81::compute::min_element(
