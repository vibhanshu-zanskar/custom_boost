                    ...
                    command_queue &queue = system::default_queue())
{
    ...
    if (first == result) {
        ...
        return ::zr_boost_1_81::compute::detail::dispatch_adjacent_difference(
                    ...
                    command_queue &queue = system::default_queue())
{
    ...
    return ::zr_boost_1_81::compute::adjacent_difference(
        first, last, result, ::zr_boost_1_81::compute::minus<value_type>(), queue
    );
}
