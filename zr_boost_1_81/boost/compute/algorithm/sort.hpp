                              ...
                              >::type* = 0)
{
    ...
    if(count < 2){
        ...
        ::zr_boost_1_81::compute::detail::serial_insertion_sort(first, last, queue);
    }
    else {
        ::zr_boost_1_81::compute::detail::radix_sort(first, last, queue);
    }
}
                              ...
                              >::type* = 0)
{
    ...
    if(count < 2){
        ...
        ::zr_boost_1_81::compute::detail::serial_insertion_sort(
            first, last, compare, queue
        );
    }
    else {
        // radix sorts in descending order
        ::zr_boost_1_81::compute::detail::radix_sort(first, last, false, queue);
    }
}
                              ...
                              command_queue &queue)
{
    ...
    if(count < 2){
        ...
        ::zr_boost_1_81::compute::detail::merge_sort_on_gpu(
            first, last, compare, queue
        );
    }
}
                          ...
                          >::type* = 0)
{
    ...
    ::zr_boost_1_81::compute::detail::merge_sort_on_cpu(first, last, compare, queue);
}
                          ...
                          >::type* = 0)
{
    ...
    mapped_view<T> view(
        zr_boost_1_81::addressof(*first), size, queue.get_context()
    );
...
/// zr_boost_1_81::compute::vector<float> vec(data, data + 4, queue);
///
...
///
/// zr_boost_1_81::compute::sort(data.begin(), data.end(), queue);
/// \endcode
///
...
{
    ::zr_boost_1_81::compute::detail::dispatch_sort(first, last, compare, queue);
}
                 ...
                 command_queue &queue = system::default_queue())
{
    ...
    ::zr_boost_1_81::compute::sort(
        first, last, ::zr_boost_1_81::compute::less<value_type>(), queue
    );
}
