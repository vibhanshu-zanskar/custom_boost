                                        ...
                                        command_queue &queue)
{
    ...
    ::zr_boost_1_81::compute::vector<cl_uint> indices(count, context);

    // write counts
    ::zr_boost_1_81::compute::detail::meta_kernel k1("transform_if_write_counts");
    ...
    // copy values
    ::zr_boost_1_81::compute::detail::meta_kernel k2("transform_if_do_copy");
