                             ...
                             command_queue &queue = system::default_queue())
{
    ...
    ::zr_boost_1_81::compute::vector<value_type> tmp(first1, last1, queue);
    ::zr_boost_1_81::compute::copy(first2, last2, first1, queue);
    ::zr_boost_1_81::compute::copy(tmp.begin(), tmp.end(), first2, queue);
