                      ...
                      command_queue &queue = system::default_queue())
{
    ...
    using ::zr_boost_1_81::compute::placeholders::_2;

    return ::zr_boost_1_81::compute::adjacent_find(
        first, last, ::zr_boost_1_81::compute::bind(compare, _2, _1), queue
    ) == last;
}
                      ...
                      command_queue &queue = system::default_queue())
{
    ...
    return ::zr_boost_1_81::compute::is_sorted(
