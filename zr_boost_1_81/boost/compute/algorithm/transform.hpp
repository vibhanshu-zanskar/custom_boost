                                ...
                                command_queue &queue = system::default_queue())
{
    ...
    return copy(
               ::zr_boost_1_81::compute::make_transform_iterator(first, op),
               ::zr_boost_1_81::compute::make_transform_iterator(last, op),
               result,
               queue
           );
}
                                ...
                                command_queue &queue = system::default_queue())
{
    ...
    return transform(
               ::zr_boost_1_81::compute::make_zip_iterator(zr_boost_1_81::make_tuple(first1, first2)),
               ::zr_boost_1_81::compute::make_zip_iterator(zr_boost_1_81::make_tuple(last1, first2 + n)),
               result,
               detail::unpack(op),
               queue
           );
