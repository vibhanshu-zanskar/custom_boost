                             ...
                             command_queue &queue = system::default_queue())
{
    ...
    ::zr_boost_1_81::compute::reduce(
        ::zr_boost_1_81::compute::make_transform_iterator(first, transform_function),
        ::zr_boost_1_81::compute::make_transform_iterator(last, transform_function),
        result,
        reduce_function,
        queue
    );
                             ...
                             command_queue &queue = system::default_queue())
{
    ...
    ::zr_boost_1_81::compute::transform_reduce(
        ::zr_boost_1_81::compute::make_zip_iterator(
            zr_boost_1_81::make_tuple(first1, first2)
        ),
        ::zr_boost_1_81::compute::make_zip_iterator(
            zr_boost_1_81::make_tuple(last1, first2 + n)
        ),
        result,
