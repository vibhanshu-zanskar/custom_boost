                                 ...
                                 command_queue &queue)
{
    ...
    ::zr_boost_1_81::compute::kernel kernel = k.compile(context);
                                     ...
                                     command_queue &queue)
{
    ...
    ::zr_boost_1_81::compute::vector<key_type> temp_keys(count, context);
    ::zr_boost_1_81::compute::vector<value_type> temp_values(count, context);
