                                       ...
                                       command_queue &queue)
{
    ...
    vector<input_type, ::zr_boost_1_81::compute::pinned_allocator<input_type> >
        result(1, context);
    vector<uint_, ::zr_boost_1_81::compute::pinned_allocator<uint_> >
