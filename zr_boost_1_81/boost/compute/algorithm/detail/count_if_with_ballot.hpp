                                   ...
                                   command_queue &queue)
{
    ...
    const ::zr_boost_1_81::compute::context &context = queue.get_context();

    ::zr_boost_1_81::compute::vector<uint_> counts(block_count, context);

    ::zr_boost_1_81::compute::detail::nvidia_popcount<uint_> popc;
    ::zr_boost_1_81::compute::detail::nvidia_ballot<uint_> ballot;
