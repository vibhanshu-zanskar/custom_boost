                                   ...
                                   command_queue &queue)
{
    ...
    ::zr_boost_1_81::compute::reduce(
        ::zr_boost_1_81::compute::make_transform_iterator(first, reduce_predicate),
        ::zr_boost_1_81::compute::make_transform_iterator(last, reduce_predicate),
        &count,
        ::zr_boost_1_81::compute::plus<ulong_>(),
        queue
    );
