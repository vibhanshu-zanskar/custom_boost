                    ...
                    >::type* = 0)
{
    ...
    buffer mapped_host(
        ...
        static_cast<void*>(
            ::zr_boost_1_81::addressof(*result)
        )
    );
    // copy async on device
    ::zr_boost_1_81::compute::future<buffer_iterator<output_type> > future =
...
/// zr_boost_1_81::compute::vector<int> vec(4, context);
///
/// // copy values to the device vector
/// zr_boost_1_81::compute::copy(data, data + 4, vec.begin(), queue);
/// \endcode
///
...
/// zr_boost_1_81::compute::vector<int> device_vector = ...
///
