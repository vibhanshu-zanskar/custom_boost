...
public:
    ...
    typedef typename ::zr_boost_1_81::compute::vector<std::pair<Key, T> > vector_type;
    ...
    insert(const value_type &value, command_queue &queue)
    {
        ...
        if(location != begin()){
            ...
            ::zr_boost_1_81::compute::copy_n(location - 1, 1, &current_value, queue);
    ...
    {
        ::zr_boost_1_81::compute::get<0> get_key;

        return ::zr_boost_1_81::compute::find(
                   ::zr_boost_1_81::compute::make_transform_iterator(begin(), get_key),
                   ::zr_boost_1_81::compute::make_transform_iterator(end(), get_key),
                   value,
                   queue
               ).base();
    }
    ...
    iterator lower_bound(const key_type &value, command_queue &queue)
    {
        ...
        return ::zr_boost_1_81::compute::lower_bound(
                   ::zr_boost_1_81::compute::make_transform_iterator(begin(), get_key),
                   ::zr_boost_1_81::compute::make_transform_iterator(end(), get_key),
                   value,
                   queue
    ...
    iterator upper_bound(const key_type &value, command_queue &queue)
    {
        ...
        return ::zr_boost_1_81::compute::upper_bound(
                   ::zr_boost_1_81::compute::make_transform_iterator(begin(), get_key),
                   ::zr_boost_1_81::compute::make_transform_iterator(end(), get_key),
                   value,
                   queue
...
private:
    ::zr_boost_1_81::compute::vector<std::pair<Key, T> > m_vector;
};
