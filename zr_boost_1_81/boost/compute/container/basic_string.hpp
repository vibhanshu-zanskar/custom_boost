...
/// \code
/// zr_boost_1_81::compute::string str("hello, world!");
/// \endcode
///
...
public:
    ...
    typedef typename ::zr_boost_1_81::compute::vector<CharT>::reference reference;
    typedef typename ::zr_boost_1_81::compute::vector<CharT>::const_reference const_reference;
    typedef typename ::zr_boost_1_81::compute::vector<CharT>::iterator iterator;
    typedef typename ::zr_boost_1_81::compute::vector<CharT>::const_iterator const_iterator;
    typedef typename ::zr_boost_1_81::compute::vector<CharT>::reverse_iterator reverse_iterator;
    typedef typename ::zr_boost_1_81::compute::vector<CharT>::const_reverse_iterator const_reverse_iterator;
    ...
    void swap(basic_string<CharT, Traits> &other)
    {
        if(this != &other)
        {
            ::zr_boost_1_81::compute::vector<CharT> temp_data(other.m_data);
            other.m_data = m_data;
            m_data = temp_data;
        }
    }
    ...
    {
        const_iterator iter = ::zr_boost_1_81::compute::find(begin() + pos, end(), ch);
        if(iter == end()){
            return npos;
        }
        else {
    ...
    {
        const_iterator iter = ::zr_boost_1_81::compute::search(begin() + pos, end(),
                                                       str.begin(), str.end());
        if(iter == end()){
            return npos;
        }
...
private:
    ::zr_boost_1_81::compute::vector<CharT> m_data;
};

template<class CharT, class Traits>
std::ostream&
operator<<(std::ostream& stream,
           zr_boost_1_81::compute::basic_string<CharT, Traits>const& outStr)
{
    command_queue queue = ::zr_boost_1_81::compute::system::default_queue();
    zr_boost_1_81::compute::copy(outStr.begin(),
                        outStr.end(),
