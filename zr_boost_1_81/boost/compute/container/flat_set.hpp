...
public:
    ...
    {
        return ::zr_boost_1_81::compute::find(begin(), end(), value, queue);
    }
    ...
    {
        return ::zr_boost_1_81::compute::lower_bound(begin(), end(), value, queue);
    }
    ...
    {
        return ::zr_boost_1_81::compute::upper_bound(begin(), end(), value, queue);
    }
