...
/// \code
/// zr_boost_1_81::compute::array<int, 8> values(context);
/// \endcode
///
...
public:
    ...
    array(const zr_boost_1_81::array<T, N> &array,
          const context &context = system::default_context())
        : m_buffer(context, sizeof(T) * N)
    {
        command_queue queue = default_queue();
        zr_boost_1_81::compute::copy(array.begin(), array.end(), begin(), queue);
        queue.finish();
    }
    ...
    array<T, N>& operator=(const zr_boost_1_81::array<T, N> &array)
    {
        command_queue queue = default_queue();
        zr_boost_1_81::compute::copy(array.begin(), array.end(), begin(), queue);
        queue.finish();
    ...
    {
        ::zr_boost_1_81::compute::fill(begin(), end(), value, queue);
    }

    void swap(array<T, N> &other, const command_queue &queue)
    {
        ::zr_boost_1_81::compute::swap_ranges(begin(), end(), other.begin(), queue);
    }
