...
struct make_tuple_func
{
    ...
    #define BOOST_COMPUTE_MAKE_TUPLE_RESULT_TYPE(z, n, unused) \
        ...
        { \
            ...
            typedef zr_boost_1_81::tuple<BOOST_PP_ENUM_PARAMS(n, T)> type; \
        };
    ...
    { \
        ...
        typedef typename zr_boost_1_81::tuple<BOOST_PP_ENUM_PARAMS(n, T)> tuple_type; \
...
#define BOOST_COMPUTE_LAMBDA_MAKE_TUPLE_REF_ARG(z, n, unused) \
    BOOST_PP_COMMA_IF(n) ::zr_boost_1_81::ref(BOOST_PP_CAT(arg, n))
