...
#define BOOST_COMPUTE_LAMBDA_WRAP_BOOLEAN_UNARY_FUNCTION(name) \
    namespace detail { \
        ...
        { \
            ...
            { \
                ...
                typedef typename ::zr_boost_1_81::compute::lambda::result_of<Arg, Args>::type result_type; \
                typedef typename ::zr_boost_1_81::compute::make_vector_type< \
                    ::zr_boost_1_81::compute::int_, \
                    ::zr_boost_1_81::compute::vector_size<result_type>::value \
                >::type type; \
            }; \
            \
    ...
    { \
        return proto::make_expr<proto::tag::function>( \
            BOOST_PP_CAT(detail::name, _func)(), ::zr_boost_1_81::ref(arg) \
        ); \
    }
    ...
    namespace detail { \
        ...
        { \
            ...
            { \
                ...
                typedef typename ::zr_boost_1_81::compute::lambda::result_of<Arg1, Args>::type type; \
            }; \
            \
            template<class Context, class Arg> \
            static void apply(Context &ctx, const Arg &arg) \
    ...
    namespace detail { \
        ...
        { \
            ...
            { \
                typedef typename proto::result_of::child_c<Expr, 1>::type Arg; \
                typedef typename ::zr_boost_1_81::compute::lambda::result_of<Arg, Args>::type result_type; \
                typedef typename ::zr_boost_1_81::compute::scalar_type<result_type>::type type; \
            }; \
            \
            template<class Context, class Arg> \
            static void apply(Context &ctx, const Arg &arg) \
...
#define BOOST_COMPUTE_LAMBDA_WRAP_BOOLEAN_BINARY_FUNCTION(name) \
    namespace detail { \
        ...
        { \
            ...
            { \
                ...
                typedef typename ::zr_boost_1_81::compute::make_vector_type< \
                    ::zr_boost_1_81::compute::int_, \
                    ::zr_boost_1_81::compute::vector_size<Arg1>::value \
                >::type type; \
            }; \
            \
    ...
    { \
        return proto::make_expr<proto::tag::function>( \
            BOOST_PP_CAT(detail::name, _func)(), ::zr_boost_1_81::ref(arg1), ::zr_boost_1_81::ref(arg2) \
        ); \
    }
    ...
    namespace detail { \
        ...
        { \
            ...
            { \
                ...
                typedef typename ::zr_boost_1_81::compute::lambda::result_of<Arg2, Args>::type type; \
            }; \
            \
            template<class Context, class Arg1, class Arg2> \
            static void apply(Context &ctx, const Arg1 &arg1, const Arg2 &arg2) \
...
#define BOOST_COMPUTE_LAMBDA_WRAP_BINARY_FUNCTION_ST(name) \
    namespace detail { \
        ...
        { \
            ...
            { \
                typedef typename proto::result_of::child_c<Expr, 1>::type Arg1; \
                typedef typename ::zr_boost_1_81::compute::lambda::result_of<Arg1, Args>::type result_type; \
                typedef typename ::zr_boost_1_81::compute::scalar_type<result_type>::type type; \
            }; \
            \
            template<class Context, class Arg1, class Arg2> \
...
#define BOOST_COMPUTE_LAMBDA_WRAP_TERNARY_FUNCTION(name) \
    ...
    { \
        return proto::make_expr<proto::tag::function>( \
            BOOST_PP_CAT(detail::name, _func)(), ::zr_boost_1_81::ref(arg1), ::zr_boost_1_81::ref(arg2), ::zr_boost_1_81::ref(arg3) \
        ); \
    }
    ...
    namespace detail { \
        ...
        { \
            ...
            { \
                ...
                typedef typename ::zr_boost_1_81::compute::lambda::result_of<Arg3, Args>::type type; \
            }; \
            \
            template<class Context, class Arg1, class Arg2, class Arg3> \
            static void apply(Context &ctx, const Arg1 &arg1, const Arg2 &arg2, const Arg3 &arg3) \
