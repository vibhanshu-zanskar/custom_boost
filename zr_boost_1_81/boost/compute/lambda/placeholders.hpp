...
{
    typedef typename zr_boost_1_81::tuples::element<0, Args>::type arg_type;
...
{
    typedef typename zr_boost_1_81::tuples::element<1, Args>::type arg_type;
...
{
    typedef typename zr_boost_1_81::tuples::element<2, Args>::type arg_type;
...
// lift lambda placeholders up to the zr_boost_1_81::compute namespace
using lambda::_1;
using lambda::_2;
using lambda::_3;
