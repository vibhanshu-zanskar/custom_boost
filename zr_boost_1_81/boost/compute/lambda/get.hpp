...
struct get_func
{
    ...
    struct lambda_result
    {
        ...
        typedef typename ::zr_boost_1_81::compute::lambda::result_of<Arg, Args>::type T;
        typedef typename ::zr_boost_1_81::compute::detail::get_result_type<N, T>::type type;
    };
    ...
    // get<N>() specialization for zr_boost_1_81::tuple<T...>
    #define BOOST_COMPUTE_LAMBDA_GET_MAKE_TUPLE_SUFFIX(z, n, unused) \
    template<BOOST_PP_ENUM_PARAMS(n, class T)> \
    struct make_get_suffix<zr_boost_1_81::tuple<BOOST_PP_ENUM_PARAMS(n, T)> > \
    { \
        static std::string value() \
        { \
            BOOST_STATIC_ASSERT(N < n); \
            return ".v" + zr_boost_1_81::lexical_cast<std::string>(N); \
        } \
    };
    ...
    {
        ctx.stream << ::zr_boost_1_81::compute::get<N>()(::zr_boost_1_81::get<I>(ctx.args));
    }
...
get(const Arg &arg)
{
    return proto::make_expr<proto::tag::function>(
        detail::get_func<N>(), ::zr_boost_1_81::ref(arg)
    );
}
