...
public:
    ...
    BOOST_STATIC_CONSTANT(
        size_t, arity = zr_boost_1_81::tuples::length<ArgTuple>::value
    );
...
public:
    typedef typename
        zr_boost_1_81::function_traits<Signature>::result_type result_type;

    BOOST_STATIC_CONSTANT(
        size_t, arity = zr_boost_1_81::function_traits<Signature>::arity
    );
    ...
    /// \internal_
    detail::invoked_closure<result_type, zr_boost_1_81::tuple<>, CaptureTuple>
    operator()() const
    {
        ...
        return detail::invoked_closure<result_type, zr_boost_1_81::tuple<>, CaptureTuple>(
            m_name, m_source, m_definitions, zr_boost_1_81::make_tuple(), m_capture
        );
    }

    /// \internal_
    template<class Arg1>
    detail::invoked_closure<result_type, zr_boost_1_81::tuple<Arg1>, CaptureTuple>
    operator()(const Arg1 &arg1) const
    {
        ...
        return detail::invoked_closure<result_type, zr_boost_1_81::tuple<Arg1>, CaptureTuple>(
            m_name, m_source, m_definitions, zr_boost_1_81::make_tuple(arg1), m_capture
        );
    }

    /// \internal_
    template<class Arg1, class Arg2>
    detail::invoked_closure<result_type, zr_boost_1_81::tuple<Arg1, Arg2>, CaptureTuple>
    operator()(const Arg1 &arg1, const Arg2 &arg2) const
    {
        ...
        return detail::invoked_closure<result_type, zr_boost_1_81::tuple<Arg1, Arg2>, CaptureTuple>(
            m_name, m_source, m_definitions, zr_boost_1_81::make_tuple(arg1, arg2), m_capture
        );
    }

    /// \internal_
    template<class Arg1, class Arg2, class Arg3>
    detail::invoked_closure<result_type, zr_boost_1_81::tuple<Arg1, Arg2, Arg3>, CaptureTuple>
    operator()(const Arg1 &arg1, const Arg2 &arg2, const Arg3 &arg3) const
    {
        ...
        return detail::invoked_closure<result_type, zr_boost_1_81::tuple<Arg1, Arg2, Arg3>, CaptureTuple>(
            m_name, m_source, m_definitions, zr_boost_1_81::make_tuple(arg1, arg2, arg3), m_capture
        );
    }
...
struct closure_signature_argument_inserter
{
        ...
        : s(s_)
    {
        ...
        zr_boost_1_81::split(m_capture_names, capture_string_ , zr_boost_1_81::is_any_of(","));
    }
    ...
    void operator()(const T&) const
    {
        ...
        zr_boost_1_81::trim(variable_name);
                         ...
                         const char *capture_string)
{
    typedef typename
        zr_boost_1_81::function_traits<Signature>::result_type result_type;
    typedef typename
        zr_boost_1_81::function_types::parameter_types<Signature>::type parameter_types;
    typedef typename
    ...
    mpl::for_each<
        typename mpl::transform<parameter_types, zr_boost_1_81::add_pointer<mpl::_1>
    >::type>(i);
    s << ", ";

    // insert capture arguments
    closure_signature_argument_inserter j(
        s, capture_string, zr_boost_1_81::tuples::length<CaptureTuple>::value
    );
...
///
/// // vector of 2D points
/// zr_boost_1_81::compute::vector<float2_> points = ...
///
/// // count number of points in the circle
/// size_t count = zr_boost_1_81::compute::count_if(
...
#define BOOST_COMPUTE_CLOSURE(return_type, name, arguments, capture, ...) \
    ::zr_boost_1_81::compute::closure< \
        return_type arguments, BOOST_TYPEOF(zr_boost_1_81::tie capture) \
    > name = \
        ::zr_boost_1_81::compute::detail::make_closure_impl< \
            return_type arguments \
        >( \
            #name, #arguments, zr_boost_1_81::tie capture, #capture, #__VA_ARGS__ \
        )
#endif
