...
/// \internal_
template<int I>
struct placeholder : zr_boost_1_81::integral_constant<int, I>
{
    placeholder() { }
};
...
template<class T>
struct is_placeholder : zr_boost_1_81::false_type
{
};

/// \internal_
template<int I>
struct is_placeholder<placeholders::placeholder<I> > : zr_boost_1_81::true_type
{
};
...
struct invoked_bound_function
{
    ...
    {
        typedef typename zr_boost_1_81::tuples::element<N, BoundArgs>::type nth_bound_arg;
    ...
    {
        typedef typename zr_boost_1_81::tuples::element<I, Args>::type type;
    };
    ...
    typename get_nth_arg_type<N>::type get_nth_arg(
        typename zr_boost_1_81::enable_if_c<is_placeholder_arg<N>::value>::type* = 0
    ) const
    {
        typedef typename zr_boost_1_81::tuples::element<N, BoundArgs>::type nth_bound_arg;

        return zr_boost_1_81::get<nth_bound_arg::value>(m_args);
    }

    template<int N>
    typename get_nth_arg_type<N>::type get_nth_arg(
        typename zr_boost_1_81::disable_if_c<is_placeholder_arg<N>::value>::type* = 0
    ) const
    {
        return zr_boost_1_81::get<N>(m_bound_args);
    }
...
inline meta_kernel& apply_invoked_bound_function(
    ...
    typename zr_boost_1_81::enable_if_c<
        zr_boost_1_81::tuples::length<BoundArgs>::value == 1
    >::type* = 0
)
{
...
inline meta_kernel& apply_invoked_bound_function(
    ...
    const invoked_bound_function<Function, BoundArgs, Args> &expr,
    typename zr_boost_1_81::enable_if_c<
        zr_boost_1_81::tuples::length<BoundArgs>::value == 2
    >::type* = 0
)
{
    return k << expr.m_function(expr.template get_nth_arg<0>(),
...
inline meta_kernel& apply_invoked_bound_function(
    ...
    const invoked_bound_function<Function, BoundArgs, Args> &expr,
    typename zr_boost_1_81::enable_if_c<
        zr_boost_1_81::tuples::length<BoundArgs>::value == 3
    >::type* = 0
)
{
    return k << expr.m_function(expr.template get_nth_arg<0>(),
...
struct bound_function
{
    ...
    operator()(const Arg1 &arg1) const
    {
        return detail::invoked_bound_function<
                   ...
                   BoundArgs,
                   zr_boost_1_81::tuple<Arg1>
               >(m_function, m_args, zr_boost_1_81::make_tuple(arg1));
    }
    ...
    operator()(const Arg1 &arg1, const Arg2 &arg2) const
    {
        return detail::invoked_bound_function<
                   ...
                   BoundArgs,
                   zr_boost_1_81::tuple<Arg1, Arg2>
               >(m_function, m_args, zr_boost_1_81::make_tuple(arg1, arg2));
    }
...
/// \code
/// using zr_boost_1_81::compute::less;
/// using zr_boost_1_81::compute::placeholders::_1;
///
/// auto less_than_seven = zr_boost_1_81::compute::bind(less<int>(), _1, 7);
/// \endcode
template<class F, class... Args>
inline detail::bound_function<F, zr_boost_1_81::tuple<Args...> >
bind(F f, Args... args)
{
    typedef typename zr_boost_1_81::tuple<Args...> ArgsTuple;

    return detail::bound_function<F, ArgsTuple>(f, zr_boost_1_81::make_tuple(args...));
}
#else
template<class F, class A1>
inline detail::bound_function<F, zr_boost_1_81::tuple<A1> >
bind(F f, A1 a1)
{
    typedef typename zr_boost_1_81::tuple<A1> Args;

    return detail::bound_function<F, Args>(f, zr_boost_1_81::make_tuple(a1));
}

template<class F, class A1, class A2>
inline detail::bound_function<F, zr_boost_1_81::tuple<A1, A2> >
bind(F f, A1 a1, A2 a2)
{
    typedef typename zr_boost_1_81::tuple<A1, A2> Args;

    return detail::bound_function<F, Args>(f, zr_boost_1_81::make_tuple(a1, a2));
}

template<class F, class A1, class A2, class A3>
inline detail::bound_function<F, zr_boost_1_81::tuple<A1, A2, A3> >
bind(F f, A1 a1, A2 a2, A3 a3)
{
    typedef typename zr_boost_1_81::tuple<A1, A2, A3> Args;

    return detail::bound_function<F, Args>(f, zr_boost_1_81::make_tuple(a1, a2, a3));
}
