...
struct unpacked
{
    ...
    {
        BOOST_STATIC_CONSTANT(size_t, value = zr_boost_1_81::tuples::length<T>::value);
    };
    ...
    struct result_impl<TupleArg, 1>
    {
        ...
        typedef typename zr_boost_1_81::compute::result_of<Function(T1)>::type type;
    };
    ...
    struct result_impl<TupleArg, 2>
    {
        ...
        typedef typename zr_boost_1_81::compute::result_of<Function(T1, T2)>::type type;
    };
    ...
    struct result_impl<TupleArg, 3>
    {
        ...
        typedef typename zr_boost_1_81::compute::result_of<Function(T1, T2, T3)>::type type;
    };
