...
struct logical_not : public unary_function<T, int>
{
    /// \internal_
    template<class Expr>
    detail::invoked_function<int, zr_boost_1_81::tuple<Expr> >
    operator()(const Expr &expr) const
    {
        return detail::invoked_function<int, zr_boost_1_81::tuple<Expr> >(
            "!", std::string(), zr_boost_1_81::make_tuple(expr)
        );
    }
};
