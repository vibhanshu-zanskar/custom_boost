...
public:
    ...
    /// zr_boost_1_81::compute::device device = zr_boost_1_81::compute::system::default_device();
    ///
    ...
    /// \code
    /// for(const auto &device : zr_boost_1_81::compute::system::devices()){
    ...
    /// the system:
    /// \code
    /// for(const auto &platform : zr_boost_1_81::compute::system::platforms()){
