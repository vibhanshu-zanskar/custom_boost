...
zr_boost_1_81::unit_test::make_test_case( zr_boost_1_81::function<void ()>(test_function), \
                                  test_name ,                              \
                                  __FILE__, __LINE__ )
...
zr_boost_1_81::unit_test::make_test_case( (test_function),                         \
...
( new zr_boost_1_81::unit_test::test_suite( testsuite_name, __FILE__, __LINE__ ) )
...
#define BOOST_AUTO_TEST_SUITE_NO_DECOR( suite_name )                    \
    BOOST_AUTO_TEST_SUITE_WITH_DECOR(                                   \
        suite_name,                                                     \
        zr_boost_1_81::unit_test::decorator::collector_t::instance() )          \
/**/
...
BOOST_TEST_DECORATOR( * zr_boost_1_81::unit_test::expected_failures( n ) )      \
/**/
...
BOOST_AUTO_TU_REGISTRAR( test_name )(                                   \
    zr_boost_1_81::unit_test::make_test_case(                                   \
...
struct BOOST_AUTO_TC_INVOKER( test_name ) {                             \
    ...
    static void run( zr_boost_1_81::type<TestType>* = 0 )                       \
    {                                                                   \
        BOOST_TEST_CHECKPOINT('"' << #test_name << "\" fixture ctor");  \
        ...
        BOOST_TEST_CHECKPOINT('"' << #test_name << "\" fixture dtor");  \
                                                                        ...
                                                                        \
BOOST_AUTO_TU_REGISTRAR( test_name )(                                   \
    zr_boost_1_81::unit_test::ut_detail::template_test_case_gen<                \
...
#define BOOST_TEST_CASE_TEMPLATE( name, typelist )                      \
    zr_boost_1_81::unit_test::ut_detail::template_test_case_gen<name,typelist>( \
...
template<typename type_name>                                            \
void BOOST_JOIN( name, _impl )( zr_boost_1_81::type<type_name>* );              \
                                                                        \
struct name {                                                           \
    template<typename TestType>                                         \
    static void run( zr_boost_1_81::type<TestType>* frwrd = 0 )                 \
    {                                                                   \
...
static zr_boost_1_81::unit_test::ut_detail::global_configuration_impl<F> BOOST_JOIN( gf_, F ) \
/**/
...
static zr_boost_1_81::unit_test::ut_detail::global_fixture_impl<F> BOOST_JOIN( gf_, F ) \
/**/
...
static zr_boost_1_81::unit_test::decorator::collector_t const&                  \
...
namespace zr_boost_1_81 { namespace unit_test { namespace ut_detail {
...
typedef ::zr_boost_1_81::unit_test::ut_detail::nil_t BOOST_AUTO_TEST_CASE_FIXTURE;
...
static zr_boost_1_81::unit_test::ut_detail::auto_test_unit_registrar       \
...
static const zr_boost_1_81::unit_test::framework::impl::master_test_suite_name_setter mtsetter(BOOST_TEST_STRINGIZE( BOOST_TEST_MODULE ).trim( "\"" ));
#endif
