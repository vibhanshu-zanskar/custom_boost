...
///
/// All symbols in the Execution Monitor implementation are located in the namespace zr_boost_1_81. To use the Execution Monitor you need to:
...
typedef zr_boost_1_81::shared_ptr<translator_holder_base> translator_holder_base_ptr;

class BOOST_TEST_DECL translator_holder_base {
protected:
    typedef zr_boost_1_81::unit_test::const_string const_string;
public:
    // Constructor
    ...
    virtual int operator()( zr_boost_1_81::function<int ()> const& F ) = 0;
    ...
    translator_holder_base_ptr erase( translator_holder_base_ptr this_, zr_boost_1_81::type<ExceptionType>* = 0 )
    {
        if( m_next )
...
public:
    ...
    /// @see vexecute
    int         execute( zr_boost_1_81::function<int ()> const& F );
    ...
    /// @param[in] F  Function to monitor
    /// @see execute
    void         vexecute( zr_boost_1_81::function<void ()> const& F );
    // @}
    ...
    void        register_exception_translator( ExceptionTranslator const& tr, const_string tag = const_string(), zr_boost_1_81::type<ExceptionType>* = 0 );
    ...
    template<typename ExceptionType>
    void        erase_exception_translator( zr_boost_1_81::type<ExceptionType>* = 0 )
    {
...
private:
    ...
    int         catch_signals( zr_boost_1_81::function<int ()> const& F );

    // Data members
    detail::translator_holder_base_ptr  m_custom_translators;
    zr_boost_1_81::scoped_array<char>           m_alt_stack;
}; // execution_monitor
...
public:
    ...
    // translator holder interface
    int operator()( zr_boost_1_81::function<int ()> const& F ) BOOST_OVERRIDE
    {
        BOOST_TEST_I_TRY {
        ...
        BOOST_TEST_I_CATCH( ExceptionType, e ) {
            m_translator( e );
            return zr_boost_1_81::exit_exception_failure;
        }
    }
#ifndef BOOST_NO_RTTI
...
template<typename ExceptionType, typename ExceptionTranslator>
void
execution_monitor::register_exception_translator( ExceptionTranslator const& tr, const_string tag, zr_boost_1_81::type<ExceptionType>* )
{
...
//!@internal
#define BOOST_TEST_SYS_ASSERT( cond ) BOOST_TEST_I_ASSRT( cond, ::zr_boost_1_81::system_error( BOOST_STRINGIZE( exp ) ) )
