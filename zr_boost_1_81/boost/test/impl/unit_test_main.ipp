...
unit_test_main( init_unit_test_func init_func, int argc, char* argv[] )
{
    ...
    zr_boost_1_81::ignore_unused(shutdown_helper);
    ...
    BOOST_TEST_I_CATCH( framework::internal_error, ex ) {
        ...
        result_code = zr_boost_1_81::exit_exception_failure;
    }
...
main( int argc, char* argv[] )
{
    ...
    zr_boost_1_81::unit_test::init_unit_test_func init_func = &init_unit_test;
#else
    extern ::zr_boost_1_81::unit_test::test_suite* init_unit_test_suite( int argc, char* argv[] );

    zr_boost_1_81::unit_test::init_unit_test_func init_func = &init_unit_test_suite;
#endif

    return ::zr_boost_1_81::unit_test::unit_test_main( init_func, argc, argv );
}
