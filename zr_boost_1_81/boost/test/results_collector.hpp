...
public:
    ...
    /// @returns
    ///   - @c zr_boost_1_81::exit_success on success,
    ///   - @c zr_boost_1_81::exit_exception_failure in case test unit
    ///     was aborted for any reason (including uncaught exception)
    ///   - and @c zr_boost_1_81::exit_test_failure otherwise
...
/// of the test tree.
///
/// @see zr_boost_1_81::unit_test::test_observer
