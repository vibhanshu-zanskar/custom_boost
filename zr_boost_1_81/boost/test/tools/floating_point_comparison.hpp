...
template<typename FPT>
struct fpt_limits : zr_boost_1_81::conditional<std::numeric_limits<FPT>::is_specialized,
 ...
 * by the @ref zr_boost_1_81::math::fpc::strength given at construction.
 *
 ...
 *
 * Serves the same purpose as zr_boost_1_81::math::fpc::close_at_tolerance, but used when one
