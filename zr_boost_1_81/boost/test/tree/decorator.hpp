...
class base;
typedef zr_boost_1_81::shared_ptr<base> base_ptr;
...
inline fixture_t
fixture( zr_boost_1_81::function<void()> const& setup, zr_boost_1_81::function<void()> const& teardown = zr_boost_1_81::function<void()>() )
{
...
public:
    typedef zr_boost_1_81::function<test_tools::assertion_result (test_unit_id)>   predicate_t;
