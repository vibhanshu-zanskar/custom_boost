...
//! @overload zr_boost_1_81::unit_test::data::make()
template<typename T, std::size_t size>
inline monomorphic::array<typename zr_boost_1_81::remove_const<T>::type>
make( T (&a)[size] )
{
    return monomorphic::array<typename zr_boost_1_81::remove_const<T>::type>( a, size );
}
