 ...
 *
 * This class implements the generator concept (see @ref zr_boost_1_81::unit_test::data::monomorphic::generated_by) for implementing
...
template<typename SampleType, typename StepType=SampleType>
struct make_xrange {
    static StepType    abs( StepType s, zr_boost_1_81::true_type* )   { return s; }
    static StepType    abs( StepType s, zr_boost_1_81::false_type* )  { return std::abs(s); }
    ...
    _( Params const& params )
    {
        ...
        if( !end_val.is_initialized() )
            ...
            StepType    abs_step        = make_xrange::abs(step_val, (typename zr_boost_1_81::is_unsigned<StepType>::type*)0 );
...
/// @overload zr_boost_1_81::unit_test::data::xrange()
