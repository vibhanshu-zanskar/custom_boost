...
private:
  ...
  dataset_t& get() const {
      if(!m_dataset) {
          m_dataset = create(zr_boost_1_81::unit_test::data::index_sequence_for<Args...>());
      }
      return *m_dataset;
  }
  ...
  create(zr_boost_1_81::unit_test::data::index_sequence<I...>) const
  {
...
template <class dataset_t, class ...Args>
struct is_dataset< delayed_dataset<dataset_t, Args...> > : zr_boost_1_81::mpl::true_ {};
