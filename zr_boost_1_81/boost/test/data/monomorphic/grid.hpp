...
class grid {
    typedef typename zr_boost_1_81::decay<DataSet1>::type   dataset1_decay;
    typedef typename zr_boost_1_81::decay<DataSet2>::type   dataset2_decay;
...
public:
    static const int arity = zr_boost_1_81::decay<DataSet1>::type::arity + zr_boost_1_81::decay<DataSet2>::type::arity;
...
//! Grid operation
template<typename DataSet1, typename DataSet2>
inline typename zr_boost_1_81::lazy_enable_if_c<is_dataset<DataSet1>::value && is_dataset<DataSet2>::value,
...
//! @overload zr_boost_1_81::unit_test::data::operator*
template<typename DataSet1, typename DataSet2>
inline typename zr_boost_1_81::lazy_enable_if_c<is_dataset<DataSet1>::value && !is_dataset<DataSet2>::value,
