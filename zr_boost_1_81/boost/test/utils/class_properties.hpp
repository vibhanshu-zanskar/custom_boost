...
public:
    ...
    // access methods
    arrow_res_t     operator->() const      { return zr_boost_1_81::addressof( base_prop::value ); }
};
...
#define BOOST_READONLY_PROPERTY( property_type, friends ) zr_boost_1_81::unit_test::readwrite_property<property_type >
...
: public zr_boost_1_81::unit_test::readonly_property<property_type > {                      \
    typedef zr_boost_1_81::unit_test::readonly_property<property_type > base_prop;          \
...
public:
    ...
    arrow_res_t     operator->()            { return zr_boost_1_81::addressof( base_prop::value ); }
    const_arrow_res_t operator->() const    { return zr_boost_1_81::addressof( base_prop::value ); }
