...
#define BOOST_RTTI_SWITCH( type_id_ ) if( ::zr_boost_1_81::rtti::id_t switch_by_id = type_id_ )
#define BOOST_RTTI_CASE( type )       if( switch_by_id == ::zr_boost_1_81::rtti::type_id<type>() )
