...
template< typename CharType, class CharTraits = ::std::char_traits<CharType> >
class basic_onullstream : private zr_boost_1_81::base_from_member<basic_nullbuf<CharType, CharTraits> >
                        , public ::std::basic_ostream<CharType, CharTraits> {
    typedef zr_boost_1_81::base_from_member<basic_nullbuf<CharType, CharTraits> >   pbase_type;
