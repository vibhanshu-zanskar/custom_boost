...
template <typename T, bool is_cstring = is_cstring_impl<typename zr_boost_1_81::decay<T>::type>::value >
...
struct deduce_cstring_transform_impl<T, true> {
    typedef typename zr_boost_1_81::add_const<
        typename zr_boost_1_81::remove_pointer<
            typename zr_boost_1_81::decay<T>::type
        >::type
    >::type U;
    typedef zr_boost_1_81::unit_test::basic_cstring<U> type;
};
...
struct deduce_cstring_transform_impl< std::basic_string<T, std::char_traits<T> >, false > {
    typedef zr_boost_1_81::unit_test::basic_cstring<typename zr_boost_1_81::add_const<T>::type> type;
};
...
public:
    using type = stringview_cstring_helper<typename zr_boost_1_81::add_const<T>::type, sv_t>;
};
#endif
...
template<typename T, bool is_cstring = is_cstring<typename zr_boost_1_81::decay<T>::type>::value >
...
template<typename T>
struct is_cstring_comparable< zr_boost_1_81::unit_test::basic_cstring<T>, false > : public mpl::true_ {};
...
struct deduce_cstring_transform {
    typedef typename
        zr_boost_1_81::remove_const<
            typename zr_boost_1_81::remove_reference<T>::type
        >::type U;
    typedef typename ut_detail::deduce_cstring_transform_impl<typename zr_boost_1_81::decay<U>::type>::type type;
};
