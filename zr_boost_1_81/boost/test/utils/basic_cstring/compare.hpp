...
template<class CharT>
inline bool
operator <( zr_boost_1_81::unit_test::basic_cstring<CharT> const& x,
            zr_boost_1_81::unit_test::basic_cstring<CharT> const& y )
{
    typedef typename zr_boost_1_81::unit_test::basic_cstring<CharT>::traits_type traits_type;
    return x.size() != y.size()
            ? x.size() < y.size()
