...
/// - confirmation report (zr_boost_1_81::unit_test::CONFIRMATION_REPORT). This report level only produces short confirmation
///   message about test module pass/fail status
/// - short report (zr_boost_1_81::unit_test::SHORT_REPORT). This report level produces short summary report for failed/passed
///   assertions and test units.
/// - detailed report (zr_boost_1_81::unit_test::DETAILED_REPORT). This report level produces detailed report per test unit for
///   passed/failed assertions and uncaught exceptions
/// - no report (zr_boost_1_81::unit_test::NO_REPORT). This report level produces no results report. This is used for test modules
...
/// - plain human readable format (zr_boost_1_81::unit_test::OF_CLF)
/// - XML format (zr_boost_1_81::unit_test::OF_XML)
