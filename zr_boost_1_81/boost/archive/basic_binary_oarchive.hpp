...
protected:
    ...
    void save_override(const zr_boost_1_81::archive::version_type & t){
        ...
        if(zr_boost_1_81::serialization::library_version_type(6) < lvt){
            const zr_boost_1_81::uint_least16_t x = t;
            * this->This() << x;
        }
        else{
    ...
    void save_override(const zr_boost_1_81::serialization::item_version_type & t){
        library_version_type lvt = this->get_library_version();
        if(zr_boost_1_81::serialization::library_version_type(7) < lvt){
            this->detail_common_oarchive::save_override(t);
        }
    ...
    void save_override(const serialization::collection_size_type & t){
        if (get_library_version() < zr_boost_1_81::serialization::library_version_type(6)){
            unsigned int x=0;
            * this->This() >> x;
