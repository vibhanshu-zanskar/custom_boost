...
public:
    ...
    virtual void save(const zr_boost_1_81::long_long_type t) = 0;
    virtual void save(const zr_boost_1_81::ulong_long_type t) = 0;
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(zr_boost_1_81::archive::polymorphic_oarchive)
