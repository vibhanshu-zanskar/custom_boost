...
class BOOST_SYMBOL_VISIBLE basic_iarchive :
    ...
    public zr_boost_1_81::archive::detail::helper_collection
{
    friend class basic_iarchive_impl;
    // hide implementation of this class to minimize header conclusion
    zr_boost_1_81::scoped_ptr<basic_iarchive_impl> pimpl;
...
protected:
    ...
    zr_boost_1_81::archive::detail::helper_collection &
...
public:
    ...
    set_library_version(zr_boost_1_81::serialization::library_version_type archive_library_version);
