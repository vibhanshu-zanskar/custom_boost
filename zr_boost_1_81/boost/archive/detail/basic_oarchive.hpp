    ...
    public zr_boost_1_81::archive::detail::helper_collection
{
    ...
    zr_boost_1_81::scoped_ptr<basic_oarchive_impl> pimpl;
...
protected:
    ...
    BOOST_ARCHIVE_DECL zr_boost_1_81::archive::detail::helper_collection &
...
public:
    ...
    BOOST_ARCHIVE_DECL zr_boost_1_81::serialization::library_version_type get_library_version() const;
