...
private:
    void destroy(/*const*/ void *address) const BOOST_OVERRIDE {
        zr_boost_1_81::serialization::access::destroy(static_cast<T *>(address));
    }
public:
    ...
    bool tracking(const unsigned int /* flags */) const BOOST_OVERRIDE {
        return zr_boost_1_81::serialization::tracking_level< T >::value
                == zr_boost_1_81::serialization::track_always
            || ( zr_boost_1_81::serialization::tracking_level< T >::value
                == zr_boost_1_81::serialization::track_selectively
    ...
    if(file_version > static_cast<const unsigned int>(version()))
        zr_boost_1_81::serialization::throw_exception(
            archive::archive_exception(
                zr_boost_1_81::archive::archive_exception::unsupported_class_version,
                get_debug_info()
            )
        );
    #endif
...
struct heap_allocation {
    // zr_boost_1_81::has_new_operator< T > doesn't work on these compilers
    #if BOOST_SERIALIZATION_DONT_USE_HAS_NEW_OPERATOR
        ...
        static T * invoke_new() {
            typedef typename
                mpl::eval_if<
                    zr_boost_1_81::has_new_operator< T >,
...
) const
{
    ...
    BOOST_TRY {
        ...
        zr_boost_1_81::serialization::load_construct_data_adl<Archive, T>(
            ar_impl,
            static_cast<T *>(t),
            file_version
        );
    ...
    ar_impl >> zr_boost_1_81::serialization::make_nvp(NULL, * static_cast<T *>(t));
}
...
struct load_non_pointer_type {
    ...
    struct load_standard {
        template<class T>
        static void invoke(Archive &ar, const T & t){
            void * x = zr_boost_1_81::addressof(const_cast<T &>(t));
            ar.load_object(
                x,
                zr_boost_1_81::serialization::singleton<
                    iserializer<Archive, T>
...
struct load_pointer_type {
    ...
    static const basic_pointer_iserializer * register_type(Archive &ar, const T* const /*t*/){
        ...
        typedef typename
            mpl::eval_if<
                zr_boost_1_81::serialization::is_abstract<const T>,
                zr_boost_1_81::mpl::identity<abstract>,
                zr_boost_1_81::mpl::identity<non_abstract>
            >::type typex;
    ...
    static T * pointer_tweak(
        ...
        void * upcast = const_cast<void *>(
            zr_boost_1_81::serialization::void_upcast(
                eti,
                zr_boost_1_81::serialization::singleton<
                    typename
                    zr_boost_1_81::serialization::type_info_implementation< T >::type
    ...
    find(const zr_boost_1_81::serialization::extended_type_info & type){
...
struct load_array_type {
    ...
    static void invoke(Archive &ar, T &t){
        ...
        zr_boost_1_81::serialization::collection_size_type count;
        ar >> BOOST_SERIALIZATION_NVP(count);
        if(static_cast<std::size_t>(count) > current_count)
            zr_boost_1_81::serialization::throw_exception(
                archive::archive_exception(
                    zr_boost_1_81::archive::archive_exception::array_size_too_short
                )
            );
