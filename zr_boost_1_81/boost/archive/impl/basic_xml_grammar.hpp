...
private:
    ...
    typedef typename zr_boost_1_81::spirit::classic::chset<CharType> chset_t;
    typedef typename zr_boost_1_81::spirit::classic::chlit<CharType> chlit_t;
    typedef typename zr_boost_1_81::spirit::classic::scanner<
        typename  std::basic_string<CharType>::iterator
    > scanner_t;
    typedef typename zr_boost_1_81::spirit::classic::rule<scanner_t> rule_t;
