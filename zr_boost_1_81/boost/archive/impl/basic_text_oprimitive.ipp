...
basic_text_oprimitive<OStream>::save_binary(
    ...
    typedef 
        zr_boost_1_81::archive::iterators::insert_linebreaks<
            zr_boost_1_81::archive::iterators::base64_from_binary<
                zr_boost_1_81::archive::iterators::transform_width<
                    const char *,
                    6,
                    8
                >
    ...
    zr_boost_1_81::archive::iterators::ostream_iterator<CharType> oi(os);
    std::copy(
