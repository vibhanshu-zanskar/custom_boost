...
basic_binary_iarchive<Archive>::init() {
    ...
    * this->This() >> file_signature;
    ...
    zr_boost_1_81::serialization::library_version_type input_library_version;
    //* this->This() >> input_library_version;
    {
        ...
        if(v == 0)
            v = this->This()->m_sb.sbumpc();
        #endif
        input_library_version = static_cast<zr_boost_1_81::serialization::library_version_type>(v);
    }
