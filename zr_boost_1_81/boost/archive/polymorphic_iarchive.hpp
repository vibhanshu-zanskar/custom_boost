...
public:
    ...
    virtual void load(zr_boost_1_81::long_long_type & t) = 0;
    virtual void load(zr_boost_1_81::ulong_long_type & t) = 0;
    ...
    template<class T>
    void load_override(
        const zr_boost_1_81::serialization::nvp< T > & t
    ){
        load_start(t.name());
...
public:
    ...
    virtual void set_library_version(
        zr_boost_1_81::serialization::library_version_type archive_library_version
    ) = 0;
    virtual zr_boost_1_81::serialization::library_version_type get_library_version() const = 0;
    ...
    virtual const detail::basic_pointer_iserializer * load_pointer(
        ...
        const detail::basic_pointer_iserializer * (*finder)(
            const zr_boost_1_81::serialization::extended_type_info & type
        )
    ) = 0;
};
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(zr_boost_1_81::archive::polymorphic_iarchive)
