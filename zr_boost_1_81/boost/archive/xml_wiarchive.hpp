...
protected:
    ...
    zr_boost_1_81::scoped_ptr<xml_wgrammar> gimpl;
    std::wistream & get_is(){
        return is;
    }
    template<class T>
    ...
    void
    load(zr_boost_1_81::serialization::item_version_type & t){
        unsigned int v;
        load(v);
        t = zr_boost_1_81::serialization::item_version_type(v);
    }
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(zr_boost_1_81::archive::xml_wiarchive)
