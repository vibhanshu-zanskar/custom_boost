...
protected:
    ...
    zr_boost_1_81::archive::codecvt_null<typename OStream::char_type> codecvt_null_facet;
    ...
    template<class T>
    void save_impl(const T &t, zr_boost_1_81::mpl::bool_<false> &){
        if(os.fail())
            zr_boost_1_81::serialization::throw_exception(
                archive_exception(archive_exception::output_stream_error)
            );
    ...
    struct is_float {
        typedef typename mpl::bool_<
            zr_boost_1_81::is_floating_point<T>::value
    ...
    template<class T>
    void save_impl(const T &t, zr_boost_1_81::mpl::bool_<true> &){
