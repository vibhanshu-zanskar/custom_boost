...
public:
    ...
    typedef zr_boost_1_81::log::aux::light_function< syslog::level (record_view const&) > severity_mapper_type;
...
public:
     ...
     * \param port The local port number
     */
    BOOST_LOG_API void set_local_address(zr_boost_1_81::asio::ip::address const& addr, unsigned short port = 514);
     ...
     * \param port The port number on the remote host
     */
    BOOST_LOG_API void set_target_address(zr_boost_1_81::asio::ip::address const& addr, unsigned short port = 514);
