...
namespace event_log {
    ...
    public:
        ...
        typedef zr_boost_1_81::log::aux::light_function< event_id (record_view const&) > event_id_mapper_type;
...
public:
    ...
    typedef zr_boost_1_81::log::aux::light_function< event_log::event_type (record_view const&) > event_type_mapper_type;
...
public:
    ...
    typedef zr_boost_1_81::log::aux::light_function< event_log::event_category (record_view const&) > event_category_mapper_type;
    //! Event composer type
    typedef zr_boost_1_81::log::aux::light_function< event_log::event_id (record_view const&, insertion_list&) > event_composer_type;
