...
struct scan_result
{
    ...
    zr_boost_1_81::optional< unsigned int > last_file_counter;
...
public:
    ...
    //! File open handler
    typedef zr_boost_1_81::log::aux::light_function< void (stream_type&) > open_handler_type;
    //! File close handler
    typedef zr_boost_1_81::log::aux::light_function< void (stream_type&) > close_handler_type;

    //! Predicate that defines the time-based condition for file rotation
    typedef zr_boost_1_81::log::aux::light_function< bool () > time_based_rotation_predicate;
