...
#define BOOST_LOG_SINK_CTOR_FORWARD_INTERNAL_1(z, n, data)\
    ...
    explicit unlocked_sink(T0 const& arg0, typename zr_boost_1_81::log::aux::enable_if_named_parameters< T0, zr_boost_1_81::log::aux::sfinae_dummy >::type = zr_boost_1_81::log::aux::sfinae_dummy()) :\
        base_type(false),\
