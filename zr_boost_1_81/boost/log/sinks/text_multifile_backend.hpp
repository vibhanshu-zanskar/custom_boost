...
namespace file {
    ...
    public:
        ...
        {
            zr_boost_1_81::log::aux::cleanup_guard< stream_type > cleanup1(m_FormattingStream);
            zr_boost_1_81::log::aux::cleanup_guard< result_type::string_type > cleanup2(m_FileName);
...
public:
    ...
    typedef zr_boost_1_81::log::aux::light_function< filesystem::path (record_view const&) > file_name_composer_type;
