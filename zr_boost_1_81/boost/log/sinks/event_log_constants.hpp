...
namespace event_log {
    ...
    typedef zr_boost_1_81::log::aux::tagged_integer< unsigned int, event_id_tag > event_id;
    /*!
    ...
    typedef zr_boost_1_81::log::aux::tagged_integer< unsigned short, event_category_tag > event_category;
    /*!
