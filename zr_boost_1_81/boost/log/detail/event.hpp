...
{
private:
    zr_boost_1_81::atomic< zr_boost_1_81::uint32_t > m_state;
...
{
private:
    zr_boost_1_81::atomic_flag m_state;
    sem_t m_semaphore;
...
{
private:
    zr_boost_1_81::mutex m_mutex;
    zr_boost_1_81::condition_variable m_cond;
    bool m_state;
