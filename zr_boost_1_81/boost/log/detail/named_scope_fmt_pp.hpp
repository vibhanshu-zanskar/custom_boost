...
BOOST_FORCEINLINE format_named_scope_actor<
    fallback_to_none,
    typename zr_boost_1_81::log::aux::deduce_char_type<
        typename parameter::binding<
            typename zr_boost_1_81::log::aux::make_arg_list< BOOST_PP_ENUM_PARAMS(BOOST_PP_ITERATION(), ArgT) >::type,
            keywords::tag::format,
            void
        >::type
    >::type
...
{
    typedef typename zr_boost_1_81::log::aux::deduce_char_type<
        typename parameter::binding<
            typename zr_boost_1_81::log::aux::make_arg_list< BOOST_PP_ENUM_PARAMS(BOOST_PP_ITERATION(), ArgT) >::type,
            keywords::tag::format,
            void
        >::type
    >::type char_type;
    return aux::format_named_scope< char_type, zr_boost_1_81phoenix::actor >(name, fallback_to_none(), (BOOST_PP_ENUM_PARAMS(BOOST_PP_ITERATION(), arg)));
}
