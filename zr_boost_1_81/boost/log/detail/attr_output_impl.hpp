...
#define BOOST_LOG_AUX_OVERLOAD(left_ref, right_ref)\
    ...
    BOOST_FORCEINLINE typename aux::make_output_actor< zr_boost_1_81phoenix::actor< LeftExprT >, attribute_actor< T, FallbackPolicyT, TagT, zr_boost_1_81phoenix::actor > >::type\
    operator<< (zr_boost_1_81phoenix::actor< LeftExprT > left_ref left, attribute_actor< T, FallbackPolicyT, TagT, zr_boost_1_81phoenix::actor > right_ref right)\
    {\
        return aux::make_output_actor< zr_boost_1_81phoenix::actor< LeftExprT >, attribute_actor< T, FallbackPolicyT, TagT, zr_boost_1_81phoenix::actor > >::make(left, right);\
    }
