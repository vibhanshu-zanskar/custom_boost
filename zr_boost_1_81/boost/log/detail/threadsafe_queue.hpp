...
public:
    struct node_base
    {
        zr_boost_1_81::atomic< node_base* > next;
    };
...
class threadsafe_queue :
    private zr_boost_1_81::log::aux::rebind_alloc< AllocatorT, threadsafe_queue_node< T > >::type
{
private:
    typedef threadsafe_queue_node< T > node;

public:
    typedef typename zr_boost_1_81::log::aux::rebind_alloc< AllocatorT, node >::type allocator_type;
...
private:
    typedef zr_boost_1_81::log::aux::allocator_traits< allocator_type > alloc_traits;
...
public:
    ...
    bool try_pop(reference value)
    {
        ...
        if (threadsafe_queue_impl::try_pop(m_pImpl, dealloc, destr))
        {
            ...
            value = zr_boost_1_81::move(p->value());
            return true;
        }
        else
            return false;
