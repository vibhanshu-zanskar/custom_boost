...
public:
    ...
    struct result< ThisT(ContextT) >
    {
        ...
        typedef typename zr_boost_1_81::log::aux::copy_cv< ThisT, function_type >::type cv_function_type;

        typedef typename zr_boost_1_81::result_of< cv_function_type(typename fusion::result_of::at_c< args_type, 0 >::type) >::type type;
    };
...
public:
    ...
    {
        return m_fun(fusion::at_c< 0 >(zr_boost_1_81phoenix::env(ctx).args()));
    }
...
template< typename FunT >
struct is_nullary< custom_terminal< zr_boost_1_81::log::expressions::aux::unary_function_terminal< FunT > > > :
    public mpl::false_
{
};
