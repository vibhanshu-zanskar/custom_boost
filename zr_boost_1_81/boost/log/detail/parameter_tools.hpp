...
#define BOOST_LOG_CTOR_FORWARD_1(z, n, types)\
    ...
    explicit BOOST_PP_TUPLE_ELEM(2, 0, types)(T0 const& arg0, typename zr_boost_1_81::log::aux::enable_if_named_parameters< T0, zr_boost_1_81::log::aux::sfinae_dummy >::type = zr_boost_1_81::log::aux::sfinae_dummy()) :\
...
typedef zr_boost_1_81::parameter::aux::empty_arg_list empty_arg_list;
...
{
    typedef zr_boost_1_81::parameter::aux::arg_list< ArgT0, typename make_arg_list< ArgsT... >::type > type;
};

template< typename ArgT0 >
struct make_arg_list< ArgT0 >
{
    typedef zr_boost_1_81::parameter::aux::arg_list< ArgT0 > type;
};
...
struct make_arg_list
{
    typedef zr_boost_1_81::parameter::aux::arg_list< ArgT0, typename make_arg_list< BOOST_PP_ENUM_PARAMS(BOOST_PP_DEC(BOOST_LOG_MAX_PARAMETER_ARGS), T) >::type > type;
};
...
using enable_if_named_parameters = zr_boost_1_81::enable_if_c< zr_boost_1_81::mpl::or_< zr_boost_1_81::is_base_of< zr_boost_1_81::parameter::aux::tagged_argument_base, T >, zr_boost_1_81::is_base_of< empty_arg_list, T > >::value, R >;

#else // !defined(BOOST_NO_CXX11_TEMPLATE_ALIASES)

template< typename T, typename R >
struct enable_if_named_parameters :
    public zr_boost_1_81::enable_if_c< zr_boost_1_81::mpl::or_< zr_boost_1_81::is_base_of< zr_boost_1_81::parameter::aux::tagged_argument_base, T >, zr_boost_1_81::is_base_of< empty_arg_list, T > >::value, R >
{
};
