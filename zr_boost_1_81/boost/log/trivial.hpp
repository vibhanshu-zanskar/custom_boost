...
{
    return zr_boost_1_81::log::trivial::to_string< char >(lvl);
}
...
{
    const CharT* str = zr_boost_1_81::log::trivial::to_string< CharT >(lvl);
    if (BOOST_LIKELY(!!str))
        strm << str;
    else
...
#define BOOST_LOG_TRIVIAL(lvl)\
    BOOST_LOG_STREAM_WITH_PARAMS(::zr_boost_1_81::log::trivial::logger::get(),\
        (::zr_boost_1_81::log::keywords::severity = ::zr_boost_1_81::log::trivial::lvl))
