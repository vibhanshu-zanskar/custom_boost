...
struct matching_expression_kind< zr_boost_1_81::basic_regex< CharT, TraitsT > >
{
...
struct match_traits< ExpressionT, boost_regex_expression_tag >
{
    ...
    static bool matches(StringT const& str, zr_boost_1_81::basic_regex< CharT, TraitsT > const& expr, zr_boost_1_81::regex_constants::match_flag_type flags = zr_boost_1_81::regex_constants::match_default)
    {
        return zr_boost_1_81::regex_match(str.begin(), str.end(), expr, flags);
    }
    ...
    static bool matches(
        ...
        zr_boost_1_81::basic_regex< CharT, ReTraitsT > const& expr,
        zr_boost_1_81::regex_constants::match_flag_type flags = zr_boost_1_81::regex_constants::match_default)
    {
        const CharT* p = str.c_str();
        return zr_boost_1_81::regex_match(p, p + str.size(), expr, flags);
    }
};
