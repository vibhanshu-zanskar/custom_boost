...
inline void decompose_date(DateT const& d, zr_boost_1_81::log::aux::decomposed_time_wrapper< ValueT >& v)
{
...
inline void decompose_time_of_day(TimeDurationT const& tod, zr_boost_1_81::log::aux::decomposed_time_wrapper< ValueT >& v)
{
    ...
    enum
    {
        adjustment_ratio = (traits_type::ticks_per_second > zr_boost_1_81::log::aux::decomposed_time::subseconds_per_second ?
            traits_type::ticks_per_second / zr_boost_1_81::log::aux::decomposed_time::subseconds_per_second :
            zr_boost_1_81::log::aux::decomposed_time::subseconds_per_second / traits_type::ticks_per_second)
    };
    uint64_t frac = tod.fractional_seconds();
    v.subseconds = static_cast< uint32_t >(traits_type::ticks_per_second > zr_boost_1_81::log::aux::decomposed_time::subseconds_per_second ? frac / adjustment_ratio : frac * adjustment_ratio);
}

template< typename TimeDurationT, typename ValueT >
inline void decompose_time_duration(TimeDurationT const& dur, zr_boost_1_81::log::aux::decomposed_time_wrapper< ValueT >& v)
{
    if (dur.is_negative())
    {
        v.negative = true;
...
inline void decompose_date_duration(DateDurationT const& dur, zr_boost_1_81::log::aux::decomposed_time_wrapper< ValueT >& v)
{
    if (dur.is_negative())
    {
        v.negative = true;
...
inline void decompose_time(TimeT const& t, zr_boost_1_81::log::aux::decomposed_time_wrapper< ValueT >& v)
{
...
struct date_time_formatter_generator_traits_impl
{
    ...
    //! Formatter function
    typedef zr_boost_1_81::log::aux::light_function< void (stream_type&, value_type const&) > formatter_function_type;

    //! Formatter implementation
    class formatter :
        public zr_boost_1_81::log::aux::date_time_formatter< zr_boost_1_81::log::aux::decomposed_time_wrapper< value_type >, char_type >
    {
    ...
    public:
        ...
        result_type operator() (stream_type& strm, value_type const& value) const
        {
            ...
            {
                zr_boost_1_81::log::aux::decomposed_time_wrapper< value_type > val(value);
    ...
    {
        formatter fmt;
        zr_boost_1_81::log::aux::decomposed_time_formatter_builder< formatter, char_type > builder(fmt);
        zr_boost_1_81::log::aux::parse_date_time_format(format, builder);
        return formatter_function_type(zr_boost_1_81::move(fmt));
    }
};
...
struct date_time_formatter_generator_traits< local_time::local_date_time_base< TimeT, TimeZoneT >, CharT, VoidT >
{
    ...
    class formatter_builder :
        public zr_boost_1_81::log::aux::decomposed_time_formatter_builder< formatter, char_type >
    {
    private:
        typedef zr_boost_1_81::log::aux::decomposed_time_formatter_builder< formatter, char_type > base_type;
...
struct date_formatter_generator_traits_impl
{
    ...
    static formatter_function_type parse(string_type const& format)
    {
        formatter fmt;
        zr_boost_1_81::log::aux::decomposed_time_formatter_builder< formatter, char_type > builder(fmt);
        zr_boost_1_81::log::aux::parse_date_format(format, builder);
        return formatter_function_type(zr_boost_1_81::move(fmt));
    }
};
...
struct time_duration_formatter_generator_traits_impl
{
    ...
    static formatter_function_type parse(string_type const& format)
    {
        formatter fmt;
        zr_boost_1_81::log::aux::decomposed_time_formatter_builder< formatter, char_type > builder(fmt);
        zr_boost_1_81::log::aux::parse_time_format(format, builder);
        return formatter_function_type(zr_boost_1_81::move(fmt));
    }
};
