...
template< typename T, typename TagT >
BOOST_FORCEINLINE typename zr_boost_1_81::enable_if_c< mpl::is_sequence< T >::value, value_ref< T, TagT > >::type
...
template< typename T, typename TagT >
BOOST_FORCEINLINE typename zr_boost_1_81::disable_if_c< mpl::is_sequence< T >::value, T const& >::type
unwrap_value_ref(value_ref< T, TagT > const& r)
{
    return r.get();
}
...
public:
    ...
    result_type operator() (attribute_name const& name, attribute_value_set const& attrs) const
    {
        ...
        catch (exception& e)
        {
            ...
            zr_boost_1_81::log::aux::attach_attribute_name_info(e, name);
            throw;
        }
    }
