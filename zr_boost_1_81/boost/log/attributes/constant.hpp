...
protected:
    ...
    public:
         ...
         * Constructor with the stored value initialization
         */
        explicit impl(BOOST_RV_REF(value_type) value) BOOST_NOEXCEPT_IF(zr_boost_1_81::is_nothrow_move_constructible< value_type >::value) :
            base_type(zr_boost_1_81::move(value))
        {
        }
    };
...
public:
     ...
     * Constructor with the stored value initialization
     */
    explicit constant(BOOST_RV_REF(value_type) value) : attribute(new impl(zr_boost_1_81::move(value))) {}
    /*!
...
template< typename T >
inline constant<
    typename zr_boost_1_81::log::aux::make_embedded_string_type<
        typename remove_reference< T >::type
    >::type
> make_constant(BOOST_FWD_REF(T) val)
{
    typedef typename zr_boost_1_81::log::aux::make_embedded_string_type<
        typename remove_reference< T >::type
    >::type value_type;
    return constant< value_type >(zr_boost_1_81::forward< T >(val));
}
