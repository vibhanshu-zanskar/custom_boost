...
public:
     ...
     * Constructor with initialization of the stored value
     */
    explicit attribute_value_impl(BOOST_RV_REF(value_type) v) BOOST_NOEXCEPT_IF(zr_boost_1_81::is_nothrow_move_constructible< value_type >::value) :
        m_value(zr_boost_1_81::move(v))
    {
    }
...
inline attribute_value make_attribute_value(T&& v)
{
    ...
    return attribute_value(new attribute_value_impl< value_type >(zr_boost_1_81::forward< T >(v)));
}
