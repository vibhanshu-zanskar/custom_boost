...
typedef zr_boost_1_81::log::aux::thread::id thread_id;
...
protected:
    ...
    public:
        bool dispatch(type_dispatcher& dispatcher)
        {
            ...
            if (callback)
            {
                callback(zr_boost_1_81::log::aux::this_thread::get_id());
                return true;
            }
            else
                return false;
        ...
        intrusive_ptr< attribute_value::impl > detach_from_thread()
        {
            ...
            return new detached_value(zr_boost_1_81::log::aux::this_thread::get_id());
        }
