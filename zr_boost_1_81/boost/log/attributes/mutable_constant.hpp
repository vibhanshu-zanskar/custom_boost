...
template<
    ...
    typename ScopedWriteLockT =
        ...
        typename zr_boost_1_81::conditional<
            zr_boost_1_81::log::aux::is_exclusively_lockable< MutexT >::value,
            zr_boost_1_81::log::aux::exclusive_lock_guard< MutexT >,
            void
        >::type,
#else
        void,
...
#ifndef BOOST_LOG_NO_THREADS
        typename zr_boost_1_81::conditional<
            zr_boost_1_81::log::aux::is_shared_lockable< MutexT >::value,
            zr_boost_1_81::log::aux::shared_lock_guard< MutexT >,
            ScopedWriteLockT
        >::type
#else
        ScopedWriteLockT
...
protected:
    ...
    public:
         ...
         * Initializing constructor
         */
        explicit impl(BOOST_RV_REF(value_type) value) : m_Value(new attr_value(zr_boost_1_81::move(value)))
        {
        }
        ...
        {
            intrusive_ptr< attr_value > p = new attr_value(zr_boost_1_81::move(value));
            scoped_write_lock lock(m_Mutex);
            m_Value.swap(p);
        }
...
public:
     ...
     * Constructor with the stored value initialization
     */
    explicit mutable_constant(BOOST_RV_REF(value_type) value) : attribute(new impl(zr_boost_1_81::move(value)))
    {
    }
    /*!
    ...
    void set(BOOST_RV_REF(value_type) value)
    {
        get_impl()->set(zr_boost_1_81::move(value));
    }
...
protected:
    ...
    public:
        ...
        void set(BOOST_RV_REF(value_type) value)
        {
            m_Value = new attr_value(zr_boost_1_81::move(value));
        }
