...
class BOOST_LOG_API system_error :
    public zr_boost_1_81::system::system_error
{
public:
    /*!
     * Initializing constructor. Creates an exception with the specified error message.
     */
    system_error(zr_boost_1_81::system::error_code code, std::string const& descr);
    /*!
     * Destructor
     */
    ...
    static BOOST_LOG_NORETURN void throw_(const char* file, std::size_t line, const char* descr, zr_boost_1_81::system::error_code code);
    static BOOST_LOG_NORETURN void throw_(const char* file, std::size_t line, std::string const& descr, zr_boost_1_81::system::error_code code);
#endif
};
