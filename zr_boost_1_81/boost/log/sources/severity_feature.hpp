...
namespace aux {
    ...
    public:
        ...
        //! Move constructor
        severity_level(BOOST_RV_REF(severity_level) that) BOOST_NOEXCEPT : attribute(zr_boost_1_81::move(static_cast< attribute& >(that)))
        {
        }
...
public:
    ...
    typedef typename strictest_lock<
        ...
        zr_boost_1_81::log::aux::multiple_unique_lock2< threading_model, threading_model >
#else
        no_lock< threading_model >
...
public:
    ...
    {
        base_type::add_attribute_unlocked(zr_boost_1_81::log::aux::default_attribute_names::severity(), m_SeverityAttr);
    }
    /*!
     * Copy constructor
     */
        ...
        m_SeverityAttr(that.m_SeverityAttr)
    {
        ...
        base_type::attributes()[zr_boost_1_81::log::aux::default_attribute_names::severity()] = m_SeverityAttr;
    }
    /*!
     * Move constructor
     */
    basic_severity_logger(BOOST_RV_REF(basic_severity_logger) that) BOOST_NOEXCEPT_IF(zr_boost_1_81::is_nothrow_move_constructible< base_type >::value &&
                                                                                      zr_boost_1_81::is_nothrow_move_constructible< severity_level >::value &&
                                                                                      zr_boost_1_81::is_nothrow_move_constructible< severity_attribute >::value) :
        base_type(zr_boost_1_81::move(static_cast< base_type& >(that))),
        m_DefaultSeverity(zr_boost_1_81::move(that.m_DefaultSeverity)),
        m_SeverityAttr(zr_boost_1_81::move(that.m_SeverityAttr))
    {
    }
    /*!
...
protected:
    ...
    void swap_unlocked(basic_severity_logger& that)
    {
        ...
        zr_boost_1_81::swap(m_DefaultSeverity, that.m_DefaultSeverity);
...
#define BOOST_LOG_STREAM_SEV(logger, lvl)\
    BOOST_LOG_STREAM_WITH_PARAMS((logger), (::zr_boost_1_81::log::keywords::severity = (lvl)))
