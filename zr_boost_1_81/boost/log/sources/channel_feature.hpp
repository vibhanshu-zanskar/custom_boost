...
public:
    ...
    typedef typename strictest_lock<
        ...
        zr_boost_1_81::log::aux::exclusive_lock_guard< threading_model >
#else
...
public:
    ...
    {
        base_type::add_attribute_unlocked(zr_boost_1_81::log::aux::default_attribute_names::channel(), m_ChannelAttr);
    }
    /*!
     * Copy constructor
     */
        ...
        m_ChannelAttr(that.m_ChannelAttr.get())
    {
        ...
        base_type::attributes()[zr_boost_1_81::log::aux::default_attribute_names::channel()] = m_ChannelAttr;
    }
    /*!
     * Move constructor
     */
    basic_channel_logger(BOOST_RV_REF(basic_channel_logger) that) BOOST_NOEXCEPT_IF(zr_boost_1_81::is_nothrow_move_constructible< base_type >::value && zr_boost_1_81::is_nothrow_move_constructible< channel_attribute >::value) :
        base_type(zr_boost_1_81::move(static_cast< base_type& >(that))),
        m_ChannelAttr(zr_boost_1_81::move(that.m_ChannelAttr))
    {
    }
    /*!
    ...
    {
        BOOST_LOG_EXPR_IF_MT(zr_boost_1_81::log::aux::shared_lock_guard< const threading_model > lock(this->get_threading_model());)
    ...
    {
        BOOST_LOG_EXPR_IF_MT(zr_boost_1_81::log::aux::exclusive_lock_guard< threading_model > lock(this->get_threading_model());)
...
#define BOOST_LOG_STREAM_CHANNEL(logger, chan)\
    BOOST_LOG_STREAM_WITH_PARAMS((logger), (::zr_boost_1_81::log::keywords::channel = (chan)))
