...
public:
    ...
    typedef zr_boost_1_81::log::aux::light_function< void () > exception_handler_type;
...
public:
     ...
     * Move constructor
     */
    basic_exception_handler_logger(BOOST_RV_REF(basic_exception_handler_logger) that) BOOST_NOEXCEPT_IF(zr_boost_1_81::is_nothrow_move_constructible< base_type >::value && zr_boost_1_81::is_nothrow_move_constructible< exception_handler_type >::value) :
        base_type(zr_boost_1_81::move(static_cast< base_type& >(that))),
        m_ExceptionHandler(zr_boost_1_81::move(that.m_ExceptionHandler))
    {
    }
    /*!
    ...
    {
#ifndef BOOST_LOG_NO_THREADS
        zr_boost_1_81::log::aux::exclusive_lock_guard< threading_model > lock(this->get_threading_model());
#endif
...
private:
    ...
    void handle_exception()
    {
        ...
        typedef typename zr_boost_1_81::conditional<
            ...
            zr_boost_1_81::log::aux::shared_lock_guard< threading_model >,
            no_lock< threading_model >
        >::type lock_type;
