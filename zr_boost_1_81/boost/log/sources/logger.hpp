 ...
 */
class logger_mt :
    public basic_composite_logger< char, logger_mt, multi_thread_model< zr_boost_1_81::log::aux::light_rw_mutex >, features< > >
{
 ...
 */
class wlogger_mt :
    public basic_composite_logger< wchar_t, wlogger_mt, multi_thread_model< zr_boost_1_81::log::aux::light_rw_mutex >, features< > >
{
