...
class severity_channel_logger_mt :
    public basic_composite_logger<
        ...
        multi_thread_model< zr_boost_1_81::log::aux::light_rw_mutex >,
        features<
            severity< LevelT >,
            channel< ChannelT >
        >
...
#define BOOST_LOG_STREAM_CHANNEL_SEV(logger, chan, lvl)\
    BOOST_LOG_STREAM_WITH_PARAMS((logger), (::zr_boost_1_81::log::keywords::channel = (chan))(::zr_boost_1_81::log::keywords::severity = (lvl)))
