...
{
    multi_thread_model() BOOST_NOEXCEPT_IF(zr_boost_1_81::has_nothrow_constructor< MutexT >::value) {}
    multi_thread_model(multi_thread_model const&) BOOST_NOEXCEPT_IF(zr_boost_1_81::has_nothrow_constructor< MutexT >::value) {}
    multi_thread_model& operator= (multi_thread_model const&) BOOST_NOEXCEPT { return *this; }
#if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES)
    multi_thread_model(multi_thread_model&&) BOOST_NOEXCEPT_IF(zr_boost_1_81::has_nothrow_constructor< MutexT >::value) {}
...
template< >
struct is_mutex_type< zr_boost_1_81::log::sources::single_thread_model > : zr_boost_1_81::true_type
{
};

template< typename T >
struct is_mutex_type< zr_boost_1_81::log::sources::multi_thread_model< T > > : zr_boost_1_81::true_type
{
};
