...
>::type register_sink_factory(const char* sink_name, shared_ptr< FactoryT > const& factory)
{
    ...
    register_sink_factory(sink_name, zr_boost_1_81::static_pointer_cast< factory_base >(factory));
}
...
{
    typedef sink_factory< typename FactoryT::char_type > factory_base;
    register_sink_factory(sink_name.c_str(), zr_boost_1_81::static_pointer_cast< factory_base >(factory));
}
