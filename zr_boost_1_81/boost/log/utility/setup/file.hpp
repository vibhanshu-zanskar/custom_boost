...
inline shared_ptr< sinks::file::collector > setup_file_collector(ArgsT const&, zr_boost_1_81::true_type)
{
    return shared_ptr< sinks::file::collector >();
}
template< typename ArgsT >
inline shared_ptr< sinks::file::collector > setup_file_collector(ArgsT const& args, zr_boost_1_81::false_type)
{
...
shared_ptr< BOOST_LOG_FILE_SINK_FRONTEND_INTERNAL< sinks::text_file_backend > > add_file_log(ArgsT const& args)
{
    ...
    shared_ptr< backend_t > pBackend = zr_boost_1_81::make_shared< backend_t >(args);
    ...
    shared_ptr< BOOST_LOG_FILE_SINK_FRONTEND_INTERNAL< backend_t > > pSink =
        zr_boost_1_81::make_shared< BOOST_LOG_FILE_SINK_FRONTEND_INTERNAL< backend_t > >(pBackend);
