...
public:
    ...
    //! Stream buffer type
    typedef zr_boost_1_81::log::aux::basic_ostringstreambuf< char_type, traits_type, allocator_type > streambuf_type;
    //! Target string type
...
inline typename zr_boost_1_81::log::aux::enable_formatting_ostream_generic_operator< StreamT, T, true, StreamT& >::type
...
template< typename StreamT, typename T >
inline typename zr_boost_1_81::log::aux::enable_formatting_ostream_generic_operator< StreamT, T, false, StreamT& >::type
