...
private:
    ...
    public:
        ...
        {
            this->m_pVisitor = (void*)zr_boost_1_81::addressof(m_Visitor);
...
public:
    ...
    {
        zr_boost_1_81::shared_ptr< callback_base > p(
            zr_boost_1_81::make_shared< callback_impl< T, VisitorT > >(zr_boost_1_81::cref(visitor)));
