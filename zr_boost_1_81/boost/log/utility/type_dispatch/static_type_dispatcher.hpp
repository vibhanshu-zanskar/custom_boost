...
public:
    ...
    explicit type_sequence_dispatcher(VisitorT& visitor) :
        type_sequence_dispatcher_base(get_dispatching_map< VisitorT >().data(), dispatching_map::static_size, (void*)zr_boost_1_81::addressof(visitor))
    {
    }
...
public:
    ...
    explicit single_type_dispatcher(VisitorT& visitor) BOOST_NOEXCEPT :
        single_type_dispatcher_base(typeindex::type_id< T >(), callback_base((void*)zr_boost_1_81::addressof(visitor), (trampoline_t)&callback_base::trampoline< VisitorT, T >))
    {
    }
...
class static_type_dispatcher
    ...
    public mpl::if_<
        mpl::is_sequence< T >,
        zr_boost_1_81::log::aux::type_sequence_dispatcher< T >,
        zr_boost_1_81::log::aux::single_type_dispatcher< T >
    >::type
#endif
{
private:
