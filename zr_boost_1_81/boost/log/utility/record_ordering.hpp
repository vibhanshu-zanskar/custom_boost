...
private:
    ...
    struct l1_visitor
    {
        ...
        {
            zr_boost_1_81::log::visit< value_type >(m_owner.m_name, m_right, l2_visitor< LeftT >(static_cast< FunT const& >(m_owner), left, m_result));
        }
...
public:
    ...
    {
        bool result = false;
        if (!zr_boost_1_81::log::visit< value_type >(m_name, left, l1_visitor(*this, right, result)))
        {
            return !zr_boost_1_81::log::visit< value_type >(m_name, right, nop());
        }
        return result;
    }
};
...
namespace aux {
    ...
    template<
        typename FunT,
        typename ArityCheckT = typename zr_boost_1_81::enable_if_c< aux::arity_of< FunT >::value == 2 >::type,
        ...
        typename ArgsCheckT = typename zr_boost_1_81::enable_if_c< is_same< Arg1T, Arg2T >::value >::type
    >
