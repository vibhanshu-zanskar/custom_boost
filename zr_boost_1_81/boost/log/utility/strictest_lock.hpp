...
struct thread_access_mode_of< no_lock< MutexT > > : zr_boost_1_81::integral_constant< lock_access_mode, unlocked_access >
{
};
...
template< typename MutexT >
struct thread_access_mode_of< lock_guard< MutexT > > : zr_boost_1_81::integral_constant< lock_access_mode, exclusive_access >
{
};

template< typename MutexT >
struct thread_access_mode_of< shared_lock_guard< MutexT > > : zr_boost_1_81::integral_constant< lock_access_mode, shared_access >
{
};

template< typename MutexT >
struct thread_access_mode_of< unique_lock< MutexT > > : zr_boost_1_81::integral_constant< lock_access_mode, exclusive_access >
{
};

template< typename MutexT >
struct thread_access_mode_of< shared_lock< MutexT > > : zr_boost_1_81::integral_constant< lock_access_mode, shared_access >
{
};

template< typename MutexT >
struct thread_access_mode_of< upgrade_lock< MutexT > > : zr_boost_1_81::integral_constant< lock_access_mode, shared_access >
{
};

template< typename MutexT >
struct thread_access_mode_of< zr_boost_1_81::log::aux::exclusive_lock_guard< MutexT > > : zr_boost_1_81::integral_constant< lock_access_mode, exclusive_access >
{
};

template< typename MutexT >
struct thread_access_mode_of< zr_boost_1_81::log::aux::shared_lock_guard< MutexT > > : zr_boost_1_81::integral_constant< lock_access_mode, shared_access >
{
};

template< typename MutexT1, typename MutexT2 >
struct thread_access_mode_of< zr_boost_1_81::log::aux::multiple_unique_lock2< MutexT1, MutexT2 > > : zr_boost_1_81::integral_constant< lock_access_mode, exclusive_access >
{
};
...
{
    typedef typename strictest_lock<
        typename zr_boost_1_81::log::aux::strictest_lock_impl< T, T0 >::type
