 ...
 */
#define BOOST_LOG_ONCE_BLOCK_INIT { zr_boost_1_81::log::once_block_flag::uninitialized }
...
#define BOOST_LOG_ONCE_BLOCK_FLAG_INTERNAL(flag_var, sentry_var)\
    for (zr_boost_1_81::log::aux::once_block_sentry sentry_var((flag_var));\
...
#define BOOST_LOG_ONCE_BLOCK_INTERNAL(flag_var, sentry_var)\
    static zr_boost_1_81::log::once_block_flag flag_var;\
