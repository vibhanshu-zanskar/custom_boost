...
public:
    ...
    {
        typedef typename zr_boost_1_81::range_const_iterator< RangeT >::type const_iterator;
        const_iterator it = zr_boost_1_81::begin(m_range);
        const const_iterator end = zr_boost_1_81::end(m_range);
...
inline typename zr_boost_1_81::enable_if_c< log::aux::is_ostream< StreamT >::value, StreamT& >::type operator<< (StreamT& strm, range_manipulator< RangeT, DelimiterT > const& manip)
{
