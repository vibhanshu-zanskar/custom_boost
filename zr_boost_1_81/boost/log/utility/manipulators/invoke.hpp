...
inline typename zr_boost_1_81::enable_if_c< log::aux::is_ostream< StreamT >::value, StreamT& >::type operator<< (StreamT& stream, invoke_manipulator< FunctionT > const& manip)
{
    manip.output(stream);
    return stream;
}
...
inline invoke_manipulator<
    typename zr_boost_1_81::remove_cv<
        typename zr_boost_1_81::remove_reference< FunctionT >::type
    >::type
>
...
{
    return zr_boost_1_81::log::invoke_manip
    (
...
//! Invoke manipulator generator function
template< typename FunctionT >
inline invoke_manipulator< typename zr_boost_1_81::remove_cv< FunctionT >::type >
invoke_manip(FunctionT const& func)
{
    return invoke_manipulator< typename zr_boost_1_81::remove_cv< FunctionT >::type >(func);
}
