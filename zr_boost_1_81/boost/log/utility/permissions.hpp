...
public:
...
#ifdef BOOST_WINDOWS
    permissions(zr_boost_1_81::winapi::_SECURITY_ATTRIBUTES* perms) BOOST_NOEXCEPT : m_perms(reinterpret_cast< native_type >(perms))
    {
    }
#endif
     ...
     * Initializing constructor.
     */
    BOOST_LOG_API permissions(zr_boost_1_81::interprocess::permissions const& perms) BOOST_NOEXCEPT;
