...
public:
    ...
    BOOST_CONSTEXPR basic_string_literal(T(&p)[LenV]
        //! \cond
        , typename zr_boost_1_81::enable_if_c< is_same< T, const value_type >::value, zr_boost_1_81::log::aux::sfinae_dummy >::type = zr_boost_1_81::log::aux::sfinae_dummy()
        //! \endcond
        ) BOOST_NOEXCEPT
...
template< typename T, std::size_t LenV >
inline BOOST_CONSTEXPR typename zr_boost_1_81::enable_if_c<
