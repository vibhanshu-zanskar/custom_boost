...
public:
     ...
     * \return \c true if the log record contains the sought attribute value, \c false otherwise
     */
    result_type operator() (zr_boost_1_81::log::record_view const& rec) const
    {
...
BOOST_FORCEINLINE zr_boost_1_81phoenix::actor< aux::unary_function_terminal< has_attribute< AttributeValueT > > > has_attr(attribute_name const& name)
{
    typedef aux::unary_function_terminal< has_attribute< AttributeValueT > > terminal_type;
    zr_boost_1_81phoenix::actor< terminal_type > act = {{ terminal_type(name) }};
    return act;
}
 ...
 */
BOOST_FORCEINLINE zr_boost_1_81phoenix::actor< aux::unary_function_terminal< has_attribute< void > > > has_attr(attribute_name const& name)
{
