...
BOOST_FORCEINLINE ActorT< aux::unary_function_terminal< attribute_contains< T, typename zr_boost_1_81::log::aux::make_embedded_string_type< SubstringT >::type, FallbackPolicyT > > >
contains(attribute_actor< T, FallbackPolicyT, TagT, ActorT > const& attr, SubstringT const& substring)
{
    typedef aux::unary_function_terminal< attribute_contains< T, typename zr_boost_1_81::log::aux::make_embedded_string_type< SubstringT >::type, FallbackPolicyT > > terminal_type;
...
BOOST_FORCEINLINE ActorT< aux::unary_function_terminal< attribute_contains< typename DescriptorT::value_type, typename zr_boost_1_81::log::aux::make_embedded_string_type< SubstringT >::type > > >
contains(attribute_keyword< DescriptorT, ActorT > const&, SubstringT const& substring)
{
    typedef aux::unary_function_terminal< attribute_contains< typename DescriptorT::value_type, typename zr_boost_1_81::log::aux::make_embedded_string_type< SubstringT >::type > > terminal_type;
...
BOOST_FORCEINLINE zr_boost_1_81phoenix::actor< aux::unary_function_terminal< attribute_contains< T, typename zr_boost_1_81::log::aux::make_embedded_string_type< SubstringT >::type > > >
contains(attribute_name const& name, SubstringT const& substring)
{
    typedef aux::unary_function_terminal< attribute_contains< T, typename zr_boost_1_81::log::aux::make_embedded_string_type< SubstringT >::type > > terminal_type;
