...
BOOST_FORCEINLINE ActorT< aux::unary_function_terminal< attribute_is_in_range< T, typename zr_boost_1_81::log::aux::make_embedded_string_type< BoundaryT >::type, FallbackPolicyT > > >
is_in_range(attribute_actor< T, FallbackPolicyT, TagT, ActorT > const& attr, BoundaryT const& least, BoundaryT const& most)
{
    typedef typename zr_boost_1_81::log::aux::make_embedded_string_type< BoundaryT >::type boundary_type;
...
BOOST_FORCEINLINE ActorT< aux::unary_function_terminal< attribute_is_in_range< typename DescriptorT::value_type, typename zr_boost_1_81::log::aux::make_embedded_string_type< BoundaryT >::type > > >
...
BOOST_FORCEINLINE zr_boost_1_81phoenix::actor< aux::unary_function_terminal< attribute_is_in_range< T, typename zr_boost_1_81::log::aux::make_embedded_string_type< BoundaryT >::type > > >
is_in_range(attribute_name const& name, BoundaryT const& least, BoundaryT const& most)
{
    ...
    zr_boost_1_81phoenix::actor< terminal_type > act = {{ terminal_type(name, std::pair< boundary_type, boundary_type >(least, most)) }};
    return act;
}
