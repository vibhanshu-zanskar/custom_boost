...
private:
    ...
    typedef std::map<
        ...
        severity_value_type,
        ChannelOrderT,
        typename zr_boost_1_81::log::aux::rebind_alloc< AllocatorT, std::pair< const channel_value_type, severity_value_type > >::type
    > mapping_type;
...
public:
    ...
    result_type operator() (ContextT const& ctx) const
    {
        ...
        arg_type arg = fusion::at_c< 0 >(zr_boost_1_81phoenix::env(ctx).args());
...
template<
    ...
    typename SeverityCompareT = greater_equal,
    typename AllocatorT = use_std_allocator,
    template< typename > class ActorT = zr_boost_1_81phoenix::actor
>
...
template<
    ...
    typename AllocatorT
>
struct is_nullary< custom_terminal< zr_boost_1_81::log::expressions::channel_severity_filter_terminal< ChannelT, SeverityT, ChannelFallbackT, SeverityFallbackT, ChannelOrderT, SeverityCompareT, AllocatorT > > > :
    public mpl::false_
{
};
