...
public:
    ...
    explicit pattern_replacer(RangeT const& decorations
        ...
        , typename zr_boost_1_81::enable_if_has_type< typename range_const_iterator< RangeT >::type, zr_boost_1_81::log::aux::sfinae_dummy >::type = zr_boost_1_81::log::aux::sfinae_dummy()
#endif
    )
    {
        typedef typename range_const_iterator< RangeT >::type iterator;
        for (iterator it = zr_boost_1_81::begin(decorations), end_ = zr_boost_1_81::end(decorations); it != end_; ++it)
        {
            string_lengths lens;
            {
    ...
    pattern_replacer(FromRangeT const& from, ToRangeT const& to)
    {
        ...
        iterator1 it1 = zr_boost_1_81::begin(from), end1 = zr_boost_1_81::end(from);
        iterator2 it2 = zr_boost_1_81::begin(to), end2 = zr_boost_1_81::end(to);
...
public:
    ...
    struct result< ThisT(ContextT) >
    {
        ...
        typedef typename zr_boost_1_81phoenix::evaluator::impl<
            typename LeftT::proto_base_expr&,
            context_type,
            zr_boost_1_81phoenix::unused
        >::result_type type;
    };
...
public:
    ...
    result_type operator() (ContextT const& ctx)
    {
        ...
        // Invoke the adopted formatter
        typedef zr_boost_1_81phoenix::vector3<
            subactor_type*,
            typename fusion::result_of::at_c<
                typename remove_cv<
                    typename remove_reference<
                        typename zr_boost_1_81phoenix::result_of::env< ContextT const& >::type
                    >::type
                >::type::args_type,
                0
            >::type,
            stream_type&
        > env_type;
        env_type env = { zr_boost_1_81::addressof(m_subactor), fusion::at_c< 0 >(zr_boost_1_81phoenix::env(ctx).args()), strm };
        zr_boost_1_81phoenix::eval(m_subactor, zr_boost_1_81phoenix::make_context(env, zr_boost_1_81phoenix::actions(ctx)));
 ...
 */
template< typename SubactorT, typename ImplT, template< typename > class ActorT = zr_boost_1_81phoenix::actor >
...
#define BOOST_LOG_AUX_OVERLOAD(left_ref, right_ref)\
    ...
    BOOST_FORCEINLINE zr_boost_1_81phoenix::actor< aux::char_decorator_output_terminal< zr_boost_1_81phoenix::actor< LeftExprT >, SubactorT, ImplT > >\
    operator<< (zr_boost_1_81phoenix::actor< LeftExprT > left_ref left, char_decorator_actor< SubactorT, ImplT, ActorT > right_ref right)\
    {\
        typedef aux::char_decorator_output_terminal< zr_boost_1_81phoenix::actor< LeftExprT >, SubactorT, ImplT > terminal_type;\
        zr_boost_1_81phoenix::actor< terminal_type > actor = {{ terminal_type(left, right.get_terminal().get_subactor(), right.get_terminal().get_impl()) }};\
        return actor;\
    }
...
class char_decorator_gen1
{
    ...
    typedef typename zr_boost_1_81::log::aux::deduce_char_type< typename range_value< RangeT >::type::first_type >::type char_type;
...
class char_decorator_gen2
{
    ...
    typedef typename zr_boost_1_81::log::aux::deduce_char_type< typename range_value< FromRangeT >::type >::type from_char_type;
    typedef typename zr_boost_1_81::log::aux::deduce_char_type< typename range_value< ToRangeT >::type >::type to_char_type;
...
template< typename SubactorT, typename ImplT >
struct is_nullary< custom_terminal< zr_boost_1_81::log::expressions::char_decorator_terminal< SubactorT, ImplT > > > :
    public mpl::false_
{
};

template< typename LeftT, typename SubactorT, typename ImplT >
struct is_nullary< custom_terminal< zr_boost_1_81::log::expressions::aux::char_decorator_output_terminal< LeftT, SubactorT, ImplT > > > :
    public mpl::false_
{
};
