 ...
 */
template< typename SubactorT, typename CharT, template< typename > class ActorT = zr_boost_1_81phoenix::actor >
...
#define BOOST_LOG_AUX_OVERLOAD(left_ref, right_ref)\
    ...
    BOOST_FORCEINLINE zr_boost_1_81phoenix::actor< aux::max_size_decorator_output_terminal< zr_boost_1_81phoenix::actor< LeftExprT >, SubactorT, CharT > >\
    operator<< (zr_boost_1_81phoenix::actor< LeftExprT > left_ref left, max_size_decorator_actor< SubactorT, CharT, ActorT > right_ref right)\
    {\
        typedef aux::max_size_decorator_output_terminal< zr_boost_1_81phoenix::actor< LeftExprT >, SubactorT, CharT > terminal_type;\
        zr_boost_1_81phoenix::actor< terminal_type > actor = {{ terminal_type(left, right.get_terminal().get_subactor(), right.get_terminal().get_max_size(), right.get_terminal().get_overflow_marker()) }};\
        return actor;\
    }
...
template< typename SubactorT, typename CharT >
struct is_nullary< custom_terminal< zr_boost_1_81::log::expressions::max_size_decorator_terminal< SubactorT, CharT > > > :
    public mpl::false_
{
};

template< typename LeftT, typename SubactorT, typename CharT >
struct is_nullary< custom_terminal< zr_boost_1_81::log::expressions::aux::max_size_decorator_output_terminal< LeftT, SubactorT, CharT > > > :
    public mpl::false_
{
};
