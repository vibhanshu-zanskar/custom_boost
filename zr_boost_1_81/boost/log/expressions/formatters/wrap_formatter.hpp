...
public:
    ...
    typename result< this_type(ContextT const&) >::type operator() (ContextT const& ctx)
    {
        ...
        m_fun(fusion::at_c< 0 >(zr_boost_1_81phoenix::env(ctx).args()), strm);
        return strm;
    }
...
template<
    ...
    bool HasSecondArgumentV = zr_boost_1_81::log::aux::has_second_argument_type< FunT >::value,
    bool HasArg2V = zr_boost_1_81::log::aux::has_arg2_type< FunT >::value
>
 ...
 */
template< typename FunT, typename CharT, template< typename > class ActorT = zr_boost_1_81phoenix::actor >
...
#define BOOST_LOG_AUX_OVERLOAD(left_ref, right_ref)\
    ...
    BOOST_FORCEINLINE zr_boost_1_81phoenix::actor< aux::wrapped_formatter_output_terminal< zr_boost_1_81phoenix::actor< LeftExprT >, FunT > >\
    operator<< (zr_boost_1_81phoenix::actor< LeftExprT > left_ref left, wrapped_formatter_actor< FunT, CharT > right_ref right)\
    {\
        typedef aux::wrapped_formatter_output_terminal< zr_boost_1_81phoenix::actor< LeftExprT >, FunT > terminal_type;\
        zr_boost_1_81phoenix::actor< terminal_type > actor = {{ terminal_type(left, right.get_function()) }};\
        return actor;\
    }
...
template< typename LeftT, typename FunT >
struct is_nullary< custom_terminal< zr_boost_1_81::log::expressions::aux::wrapped_formatter_output_terminal< LeftT, FunT > > > :
    public mpl::false_
{
};

template< typename FunT, typename CharT >
struct is_nullary< custom_terminal< zr_boost_1_81::log::expressions::wrapped_formatter_terminal< FunT, CharT > > > :
    public mpl::false_
{
};
