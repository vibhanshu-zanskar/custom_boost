...
// It is needed to pass output streams by non-const reference to function objects wrapped in zr_boost_1_81phoenix::bind and zr_boost_1_81phoenix::function.
...
public:
    ...
    BOOST_FORCEINLINE typename zr_boost_1_81::log::aux::enable_if_streamable_char_type< CharT, StreamT& >::type
...
struct message_formatter
{
    ...
    {
        zr_boost_1_81::log::visit< expressions::tag::message::value_type >(m_MessageName, rec, zr_boost_1_81::log::bind_output(strm));
    }
...
private:
    ...
    typedef zr_boost_1_81::log::aux::light_function< void (record_view const&, expressions::aux::stream_ref< stream_type >) > formatter_type;
...
public:
     ...
     */
    basic_formatter(BOOST_RV_REF(this_type) that) BOOST_NOEXCEPT : m_Formatter(zr_boost_1_81::move(that.m_Formatter))
    {
    }
    ...
    basic_formatter(FunT&& fun) : m_Formatter(zr_boost_1_81::forward< FunT >(fun))
    {
    }
#elif !defined(BOOST_MSVC) || BOOST_MSVC >= 1600
    template< typename FunT >
    basic_formatter(FunT const& fun, typename zr_boost_1_81::disable_if_c< move_detail::is_rv< FunT >::value, zr_boost_1_81::log::aux::sfinae_dummy >::type = zr_boost_1_81::log::aux::sfinae_dummy()) : m_Formatter(fun)
    {
    }
#else
    ...
    {
        this_type(zr_boost_1_81::forward< FunT >(fun)).swap(*this);
        return *this;
    }
#else
    template< typename FunT >
    typename zr_boost_1_81::disable_if_c< is_same< typename remove_cv< FunT >::type, this_type >::value, this_type& >::type
