...
public:
    ...
    struct result< ThisT(ContextT) >
    {
        typedef typename remove_cv<
            typename remove_reference< typename zr_boost_1_81phoenix::result_of::env< ContextT >::type >::type
        >::type env_type;
        typedef typename env_type::args_type args_type;
        typedef typename zr_boost_1_81::log::aux::copy_cv< ThisT, value_extractor_type >::type cv_value_extractor_type;

        typedef typename zr_boost_1_81::result_of< cv_value_extractor_type(attribute_name const&, typename fusion::result_of::at_c< args_type, 0 >::type) >::type type;
    };
...
public:
    ...
    {
        return m_value_extractor(m_name, fusion::at_c< 0 >(zr_boost_1_81phoenix::env(ctx).args()));
    }
...
template< typename T, typename FallbackPolicyT, typename TagT >
struct is_nullary< custom_terminal< zr_boost_1_81::log::expressions::attribute_terminal< T, FallbackPolicyT, TagT > > > :
    public mpl::false_
{
};
