...
struct attribute_keyword
{
    ...
    BOOST_PROTO_BASIC_EXTENDS(typename proto::terminal< descriptor_type >::type, this_type, zr_boost_1_81phoenix::phoenix_domain)
...
// expression is constructed. The standard way through a custom domain doesn't work because zr_boost_1_81phoenix::actor
// is bound to phoenix_domain.
template< typename DescriptorT, template< typename > class ActorT, typename DomainT >
struct protoify< zr_boost_1_81::log::expressions::attribute_keyword< DescriptorT, ActorT >, DomainT >
{
    typedef zr_boost_1_81::log::expressions::attribute_keyword< DescriptorT, ActorT > keyword_type;
...
template< typename DescriptorT, template< typename > class ActorT, typename DomainT >
struct protoify< zr_boost_1_81::log::expressions::attribute_keyword< DescriptorT, ActorT >&, DomainT > :
    public protoify< zr_boost_1_81::log::expressions::attribute_keyword< DescriptorT, ActorT >, DomainT >
{
};

template< typename DescriptorT, template< typename > class ActorT, typename DomainT >
struct protoify< zr_boost_1_81::log::expressions::attribute_keyword< DescriptorT, ActorT > const&, DomainT > :
    public protoify< zr_boost_1_81::log::expressions::attribute_keyword< DescriptorT, ActorT >, DomainT >
{
};

template< typename DescriptorT, template< typename > class ActorT, typename DomainT >
struct protoify< zr_boost_1_81::reference_wrapper< zr_boost_1_81::log::expressions::attribute_keyword< DescriptorT, ActorT > >, DomainT > :
    public protoify< zr_boost_1_81::log::expressions::attribute_keyword< DescriptorT, ActorT >, DomainT >
{
};

template< typename DescriptorT, template< typename > class ActorT, typename DomainT >
struct protoify< zr_boost_1_81::reference_wrapper< zr_boost_1_81::log::expressions::attribute_keyword< DescriptorT, ActorT > > const, DomainT > :
    public protoify< zr_boost_1_81::log::expressions::attribute_keyword< DescriptorT, ActorT >, DomainT >
{
};

template< typename DescriptorT, template< typename > class ActorT, typename DomainT >
struct protoify< zr_boost_1_81::reference_wrapper< const zr_boost_1_81::log::expressions::attribute_keyword< DescriptorT, ActorT > >, DomainT > :
    public protoify< zr_boost_1_81::log::expressions::attribute_keyword< DescriptorT, ActorT >, DomainT >
{
};

template< typename DescriptorT, template< typename > class ActorT, typename DomainT >
struct protoify< zr_boost_1_81::reference_wrapper< const zr_boost_1_81::log::expressions::attribute_keyword< DescriptorT, ActorT > > const, DomainT > :
    public protoify< zr_boost_1_81::log::expressions::attribute_keyword< DescriptorT, ActorT >, DomainT >
{
};
...
#define BOOST_LOG_ATTRIBUTE_KEYWORD_TYPE_IMPL(keyword_, name_, value_type_, tag_ns_)\
    ...
    {\
        struct keyword_ :\
            public ::zr_boost_1_81::log::expressions::keyword_descriptor\
        {\
            typedef value_type_ value_type;\
            static ::zr_boost_1_81::log::attribute_name get_name() { return ::zr_boost_1_81::log::attribute_name(name_); }\
        };\
    }\
    typedef ::zr_boost_1_81::log::expressions::attribute_keyword< tag_ns_::keyword_ > BOOST_PP_CAT(keyword_, _type);
 ...
 *   {
 *     typedef value_type_ value_type;
 *     static zr_boost_1_81::log::attribute_name get_name();
 *   };
 * }
 *
 * typedef zr_boost_1_81::log::expressions::attribute_keyword< tag::keyword_ > keyword_type;
 * \endcode
 *
