...
{    
    ...
    struct sequence_config
    {
        ...
        BOOST_STATIC_CONSTANT(bool, allow_null = zr_boost_1_81::is_nullable<T>::value );
    };
    ...
    public:
        ...
        { 
            ...
            BOOST_ASSERT( !::zr_boost_1_81::is_null( this->begin() ) );
            return *this->begin(); 
        }
        ...
        reference back()
        {
            ...
            BOOST_ASSERT( !::zr_boost_1_81::is_null( --this->end() ) );
            return *--this->end(); 
        }
    ...
    public:
        ...
        void unique( iterator first, iterator last, Compare comp )
        {
            ...
            for( ; next != last; ++next )
            {
                BOOST_ASSERT( !::zr_boost_1_81::is_null(prev) );
                BOOST_ASSERT( !::zr_boost_1_81::is_null(next) );
                if( comp( *prev, *next ) )
                {
