...
namespace ptr_container_detail
{
    ...
    public:
        ...
        { 
            ...
            return zr_boost_1_81::ptr_container::move( old );
        }
            ...
            {                                            
                if( this->find( first->first ) == this->end() )
                {
                    ...
                    this->safe_insert( p.first, 
                                       zr_boost_1_81::ptr_container::move( ptr ) );
                                                           // strong, commit 
                }
                ++first;                                                      
            }                                                                 
    ...
    public:
        ...
        {
            insert( zr_boost_1_81::begin(r), zr_boost_1_81::end(r) );
        }
    ...
    public:
        ...
        {
            return transfer( zr_boost_1_81::begin(r), zr_boost_1_81::end(r), from );
        }
