...
namespace ptr_container_detail
{
    ...
    public: // typedefs
        ...
        typedef  BOOST_DEDUCED_TYPENAME Config::const_iterator
                                   const_iterator;
        typedef  zr_boost_1_81::reverse_iterator< iterator > 
                                   reverse_iterator;  
        typedef  zr_boost_1_81::reverse_iterator< const_iterator >     
        ...
        typedef ptr_container_detail::static_move_ptr<Ty_, 
                     BOOST_DEDUCED_TYPENAME zr_boost_1_81::mpl::if_c<is_clone_allocator_empty,
                                                                static_deleter_type,
    ...
    public: // container requirements
        ...
        { 
            zr_boost_1_81::swap( get_clone_allocator(), r.get_clone_allocator() ); // nothrow
    ...
    public: // modifiers
        ...
        {
            return erase( zr_boost_1_81::begin(r), zr_boost_1_81::end(r) );
        }
    ...
    public: // access interface
        ...
        { 
            ...
            return zr_boost_1_81::ptr_container_detail::move( ptr ); 
        }
        ...
        { 
            ...
            return zr_boost_1_81::ptr_container_detail::move( old );
        }
...
#define BOOST_PTR_CONTAINER_DEFINE_RELEASE( base_type ) \
    ...
    {                                               \
        return zr_boost_1_81::ptr_container_detail::move(base_type::release(i)); \
    }                                               
#else
#define BOOST_PTR_CONTAINER_DEFINE_RELEASE( base_type ) \
