...
{ 
        ...
        struct ref_pair
        {
            ...
            friend inline bool operator==( ref_pair l, ref_pair r )
            {
                return l.first == r.first && 
                       zr_boost_1_81::equal_pointees( l.second, r.second );
            }
            ...
            {
                if( l.first == r.first )
                    return zr_boost_1_81::less_pointees( l.second, r.second );
                else 
                    return l.first < r.first;
            }
    ...
    class ptr_map_iterator : 
        public zr_boost_1_81::iterator_adaptor< ptr_map_iterator<I,F,S>, I, 
                                        ptr_container_detail::ref_pair<F,S>, 
                                        use_default, 
                                        ptr_container_detail::ref_pair<F,S> >
    {
        typedef zr_boost_1_81::iterator_adaptor< ptr_map_iterator<I,F,S>, I, 
                                         ptr_container_detail::ref_pair<F,S>,
                                         use_default, 
                                         ptr_container_detail::ref_pair<F,S> > 
            base_type;
