...
namespace zr_boost_1_81
{
    ...
    public:
        ...
        Result    
#else            
        typename zr_boost_1_81::result_of< const Fun( typename pointee<T>::type& ) >::type 
#endif            
        ...
        Result    
#else                        
        typename zr_boost_1_81::result_of< const Fun( typename pointee<T>::type&,
    ...
    public:
        ...
        typename ptr_container_detail::make_lazy<
            zr_boost_1_81::result_of<const Fun(const Arg1&)>, Void>::type
#endif            
        operator()( const Void* r ) const
        { 
            BOOST_STATIC_ASSERT(zr_boost_1_81::is_void<Void>::value);
            BOOST_ASSERT( r != 0 );
...
#else                    
        typename ptr_container_detail::make_lazy<
            zr_boost_1_81::result_of<const Fun(const Arg1&, const Arg2&)>, Void>::type
#endif            
