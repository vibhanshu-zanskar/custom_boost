...
namespace zr_boost_1_81
{
    ...
    < 
        class Key, 
        class T, 
        class Hash           = zr_boost_1_81::hash<Key>,
    ...
    class ptr_unordered_map : 
        public ptr_map_adapter<T,zr_boost_1_81::unordered_map<Key,
            typename ptr_container_detail::void_ptr<T>::type,Hash,Pred,Allocator>,
                               CloneAllocator,false>
    {
        typedef ptr_map_adapter<T,zr_boost_1_81::unordered_map<Key,
            typename ptr_container_detail::void_ptr<T>::type,Hash,Pred,Allocator>,
                               CloneAllocator,false>
            base_type;
    ...
    class ptr_unordered_multimap : 
        public ptr_multimap_adapter<T,zr_boost_1_81::unordered_multimap<Key,void*,Hash,Pred,Allocator>,
                                    CloneAllocator,false>
    {
        typedef ptr_multimap_adapter<T,zr_boost_1_81::unordered_multimap<Key,void*,Hash,Pred,Allocator>,
                                     CloneAllocator,false>
            base_type;
