...
namespace zr_boost_1_81
{
    ...
    class ptr_circular_buffer : public 
        ptr_sequence_adapter< T, zr_boost_1_81::circular_buffer<
                typename ptr_container_detail::void_ptr<T>::type,Allocator>, 
                              CloneAllocator >
    {  
        typedef ptr_sequence_adapter< T, zr_boost_1_81::circular_buffer<
                typename ptr_container_detail::void_ptr<T>::type,Allocator>, 
                                      CloneAllocator > 
            base_type;

        typedef zr_boost_1_81::circular_buffer<typename 
    ...
    public: // circular buffer functions
        ...
        void resize( size_type size ) // basic
        {
            ...
            if( old_size > size )
            {
                this->erase( zr_boost_1_81::next( this->begin(), size ), this->end() );  
            }
            else if( size > old_size )
            {
                for( ; old_size != size; ++old_size )
                    this->push_back( new BOOST_DEDUCED_TYPENAME 
                                     zr_boost_1_81::remove_pointer<value_type>::type() ); 
            }
        ...
        void rresize( size_type size ) // basic
        {
            ...
            {
                this->erase( this->begin(), 
                             zr_boost_1_81::next( this->begin(), old_size - size ) );  
            }
            else if( size > old_size )
            {
                for( ; old_size != size; ++old_size )
        ...
        {
            assign( zr_boost_1_81::begin(r), zr_boost_1_81::end(r ) );
        }
        ...
        zr_boost_1_81::disable_if< ptr_container_detail::is_pointer_or_integral<Range> >::type
        insert( iterator before, const Range& r )
        {
            insert( before, zr_boost_1_81::begin(r), zr_boost_1_81::end(r) );
        }
        ...
        {
            rinsert( before, zr_boost_1_81::begin(r), zr_boost_1_81::end(r) );
        }
        ...
        {
            return rerase( zr_boost_1_81::begin(r), zr_boost_1_81::end(r) );
        }
    ...
    public: // transfer        
        ...
        BOOST_DEDUCED_TYPENAME zr_boost_1_81::disable_if< zr_boost_1_81::is_same< Range,
                      BOOST_DEDUCED_TYPENAME PtrSeqAdapter::iterator > >::type
        transfer( iterator before, const Range& r, PtrSeqAdapter& from ) // nothrow
        {
            transfer( before, zr_boost_1_81::begin(r), zr_boost_1_81::end(r), from );
        }
