...
/// 
///     int main() {
///         auto int_result = zr_boost_1_81::hof::result<int>(id());
...
struct result_adaptor : detail::callable_base<F>
{
    ...
    template<class... Ts, class=typename std::enable_if<(zr_boost_1_81::hof::is_invocable<F, Ts...>::value)>::type>
...
struct result_f
{
    ...
    {
        return result_adaptor<Result, F>(zr_boost_1_81::hof::move(f));
    }
};
