...
///     (
///         zr_boost_1_81::hof::unpack(zr_boost_1_81::hof::proj(f))(sequence)
///     );
/// 
///     auto print = zr_boost_1_81::hof::fix(zr_boost_1_81::hof::first_of(
...
/// this:
/// 
///     print.cpp:49:5: error: no matching function for call to object of type 'zr_boost_1_81::hof::fix_adaptor<zr_boost_1_81::hof::first_of_adaptor<(lambda at print.cpp:29:9), (lambda at print.cpp:33:9), (lambda at print.cpp:37:9)> >'
///         print(foo{});
///         ^~~~~
///     fix.hpp:158:5: note: candidate template ignored: substitution failure [with Ts = <foo>]: no matching function for call to object of type 'const zr_boost_1_81::hof::first_of_adaptor<(lambda at
...
/// 
///     print.cpp:49:5: error: no matching function for call to object of type 'zr_boost_1_81::hof::reveal_adaptor<zr_boost_1_81::hof::fix_adaptor<zr_boost_1_81::hof::first_of_adaptor<(lambda at print.cpp:29:9), (lambda at print.cpp:33:9),
///           (lambda at print.cpp:37:9)> >, zr_boost_1_81::hof::fix_adaptor<zr_boost_1_81::hof::first_of_adaptor<(lambda at print.cpp:29:9), (lambda at print.cpp:33:9), (lambda at print.cpp:37:9)> > >'
///         zr_boost_1_81::hof::reveal(print)(foo{});
///         ^~~~~~~~~~~~~~~~~~
...
/// 
///         struct failure
///         : zr_boost_1_81::hof::as_failure<sum_failure>
///         {};
/// 
///         template<class T, class U>
...
struct reveal_failure
{
    ...
    constexpr auto operator()(Ts&&... xs) const
#if BOOST_HOF_REVEAL_USE_TEMPLATE_ALIAS
        -> typename apply_failure<Failure, Ts...>::template apply<zr_boost_1_81::hof::detail::identity_failure>;
#else
        -> decltype(apply_failure<Failure, Ts...>::apply(zr_boost_1_81::hof::detail::identity_failure()));
#endif
};
