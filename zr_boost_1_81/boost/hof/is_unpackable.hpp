...
/// 
///     int main() {
///         static_assert(zr_boost_1_81::hof::is_unpackable<std::tuple<int>>::value, "Failed");
///     }
/// 
...
struct unpack_impl_f
{
    ...
    (
        zr_boost_1_81::hof::unpack_sequence<typename std::remove_cv<typename std::remove_reference<Sequence>::type>::type>::
...
{
    static_assert(zr_boost_1_81::hof::is_invocable<unpack_impl_f, decltype(zr_boost_1_81::hof::always(private_unpack_type())), Sequence>::value,
        "Unpack is invalid for this sequence. The function used to unpack this sequence is not callable."
    );
    typedef decltype(zr_boost_1_81::hof::detail::unpack_impl(zr_boost_1_81::hof::always(private_unpack_type()), std::declval<Sequence>())) type;
};
