...
namespace zr_boost_1_81 { namespace hof { namespace always_detail {
...
#define BOOST_HOF_ALWAYS_VOID_RETURN zr_boost_1_81::hof::always_detail::always_base<void>::void_
#else
