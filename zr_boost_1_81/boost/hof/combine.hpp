...
/// 
///     int main() {
///         auto f = zr_boost_1_81::hof::combine(
///             zr_boost_1_81::hof::construct<std::tuple>(),
///             zr_boost_1_81::hof::capture(1)(zr_boost_1_81::hof::construct<std::pair>()),
///             zr_boost_1_81::hof::capture(2)(zr_boost_1_81::hof::construct<std::pair>()));
...
// compiler on MSVC
    ...
    (
        (BOOST_HOF_MANGLE_CAST(const F&)(BOOST_HOF_CONST_THIS->base_function(xs...)))
            (zr_boost_1_81::hof::alias_value<pack_tag<seq<Ns>, Gs...>, Gs>(*BOOST_HOF_CONST_THIS, xs)(BOOST_HOF_FORWARD(Ts)(xs))...)
    );
};
