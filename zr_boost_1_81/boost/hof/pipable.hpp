...
struct pipe_pack
{
    ...
    (make_pipe_closure(BOOST_HOF_RETURNS_C_CAST(F&&)(BOOST_HOF_CONST_THIS->get_function(xs...)), zr_boost_1_81::hof::pack_forward(BOOST_HOF_FORWARD(Ts)(xs)...)));
};
...
template<class A, class F>
auto operator|(A&& a, const zr_boost_1_81::hof::detail::static_function_wrapper<F>& f) BOOST_HOF_RETURNS
...
template<class A, class F>
auto operator|(A&& a, const zr_boost_1_81::hof::detail::static_default_function<F>& f) BOOST_HOF_RETURNS
(f(BOOST_HOF_FORWARD(A)(a)));
