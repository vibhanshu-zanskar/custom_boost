...
(
    zr_boost_1_81::hof::detail::make_args_at(typename gens<N>::type())(nullptr, BOOST_HOF_RETURNS_CONSTRUCT(perfect_ref<Ts>)(xs)...)
);
...
struct make_args_f
{
    ...
    (
        zr_boost_1_81::hof::detail::get_args<N>(BOOST_HOF_FORWARD(Ts)(xs)...)
    );
};
