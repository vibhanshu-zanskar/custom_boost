...
/// 
///     int main() {
///         assert(zr_boost_1_81::hof::proj(&foo::x, _ + _)(foo(1), foo(2)) == 3);
///     }
/// 
/// References
/// ----------
...
{
    return zr_boost_1_81::hof::apply_eval(f, make_project_eval(BOOST_HOF_FORWARD(Ts)(xs), p)...);
}
...
#define BOOST_HOF_BY_VOID_RETURN zr_boost_1_81::hof::detail::swallow
#else
...
{
    return zr_boost_1_81::hof::apply_eval(zr_boost_1_81::hof::always(), zr_boost_1_81::hof::detail::make_project_void_eval(BOOST_HOF_FORWARD(Ts)(xs), p)...);
}
...
struct proj_adaptor : detail::compressed_pair<detail::callable_base<Projection>, detail::callable_base<F>>, detail::function_result_type<F>
{
    ...
    (
        zr_boost_1_81::hof::detail::by_eval(
...
struct proj_adaptor<Projection, void> : detail::callable_base<Projection>
{
    ...
    {
#if BOOST_HOF_NO_ORDERED_BRACE_INIT
        return zr_boost_1_81::hof::detail::by_void_eval(this->base_projection(xs...), BOOST_HOF_FORWARD(Ts)(xs)...);
#else
#if BOOST_HOF_NO_CONSTEXPR_VOID
        return
#endif
        zr_boost_1_81::hof::detail::swallow{
