...
/// 
///     int main() {
///         assert(zr_boost_1_81::hof::eval([]{ return 3; }) == 3);
///     }
/// 
/// References
/// ----------
...
struct simple_eval
{
    ...
    (zr_boost_1_81::hof::always_ref(f)(xs...)());
};

struct id_eval
{
    template<class F, class... Ts>
    constexpr BOOST_HOF_SFINAE_RESULT(F, id_<decltype(zr_boost_1_81::hof::identity)>) 
    operator()(F&& f, Ts&&...xs) const BOOST_HOF_SFINAE_RETURNS
    (zr_boost_1_81::hof::always_ref(f)(xs...)(zr_boost_1_81::hof::identity));
};

}

BOOST_HOF_DECLARE_STATIC_VAR(eval, zr_boost_1_81::hof::first_of_adaptor<detail::simple_eval, detail::id_eval>);
