...
/// [`zr_boost_1_81::hof::result`](/include/boost/hof/result):
/// 
///     int r = zr_boost_1_81::hof::result<int>(factorial)(5);
/// 
/// Synopsis
/// --------
/// 
...
/// 
///     int main() {
///         auto factorial = zr_boost_1_81::hof::fix(
...
struct fix_adaptor_base : F
{
    ...
    {
        return derived(zr_boost_1_81::hof::detail::make_indirect_ref(this->base_function(xs...)));
    }
