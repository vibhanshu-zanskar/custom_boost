...
R tuple_get( Tuple&& t ) 
{ 
    return (R&&)(std::get<I>(zr_boost_1_81::hof::forward<Tuple>(t))); 
}
#define BOOST_HOF_UNPACK_TUPLE_GET zr_boost_1_81::hof::detail::tuple_get
#else
...
struct unpack_tuple_apply
{
    ...
    (
        zr_boost_1_81::hof::detail::unpack_tuple(BOOST_HOF_FORWARD(F)(f), BOOST_HOF_FORWARD(S)(t), zr_boost_1_81::hof::detail::make_tuple_gens(t))
    );
};
