...
#define BOOST_HOF_AND_UNPACK(Bs) (zr_boost_1_81::hof::detail::and_c(Bs...))
#else
template<bool...> struct bool_seq {};
template<class... Ts>
BOOST_HOF_USING(and_, std::is_same<bool_seq<Ts::value...>, bool_seq<(Ts::value, true)...>>);

#define BOOST_HOF_AND_UNPACK(Bs) BOOST_HOF_IS_BASE_OF(zr_boost_1_81::hof::detail::bool_seq<Bs...>, zr_boost_1_81::hof::detail::bool_seq<(Bs || true)...>)
