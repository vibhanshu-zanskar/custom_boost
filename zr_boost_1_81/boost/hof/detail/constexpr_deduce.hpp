...
#define BOOST_HOF_DETAIL_CONSTEXPR_DEDUCE true ? zr_boost_1_81::hof::detail::constexpr_deduce() :
#define BOOST_HOF_DETAIL_CONSTEXPR_DEDUCE_UNIQUE(T) true ? zr_boost_1_81::hof::detail::constexpr_deduce_unique<T>() :
