...
/// [`zr_boost_1_81::hof::reveal`](/include/boost/hof/reveal) adaptor to improve error messages.
/// 
/// Example
/// -------
/// 
...
///     BOOST_HOF_STATIC_FUNCTION(partial_sum) = zr_boost_1_81::hof::partial(sum_f());
/// 
///     int main() {
...
#if BOOST_HOF_HAS_INLINE_VARIABLES
#define BOOST_HOF_STATIC_FUNCTION(name) inline const constexpr auto name = zr_boost_1_81::hof::detail::reveal_static_const_factory()
#else
#define BOOST_HOF_STATIC_FUNCTION(name) BOOST_HOF_STATIC_CONST_VAR(name) = BOOST_HOF_DETAIL_MSVC_CONSTEXPR_DEDUCE zr_boost_1_81::hof::detail::reveal_static_const_factory()
#endif
