...
{
    return static_cast<T>(zr_boost_1_81::hof::alias_value<Tag, T>(BOOST_HOF_FORWARD(X)(x), xs...));
}
...
{
    return zr_boost_1_81::hof::alias_value<Tag, T>(x, xs...);
}
...
(
    zr_boost_1_81::hof::alias_value<Tag, T>(BOOST_HOF_FORWARD(X)(x), xs...)
);
...
: pack_holder_base<typename pack_holder_builder<Ts...>::template apply<Ts, Ns>...>
{
    ...
    (
        f(zr_boost_1_81::hof::detail::pack_get<Ts, pack_tag<seq<Ns>, Ts...>>(*BOOST_HOF_CONST_THIS, f)...)
    );
...
: pack_holder_base<pack_holder<T, pack_tag<seq<0>, T>>>
{
    ...
    constexpr auto operator()(F&& f) const BOOST_HOF_RETURNS
    (
        f(zr_boost_1_81::hof::detail::pack_get<T, pack_tag<seq<0>, T>>(*BOOST_HOF_CONST_THIS, f))
    );
...
BOOST_HOF_RETURNS(f(zr_boost_1_81::hof::alias_value<pack_tag<seq<Ns>, Ts...>, Ts>(move(x), f)...))
...
struct pack_join_base<pack_base<seq<Ns1...>, Ts1...>, pack_base<seq<Ns2...>, Ts2...>>
{
    ...
    BOOST_HOF_RETURNS_DEDUCE_NOEXCEPT(
        result_type(
            zr_boost_1_81::hof::detail::pack_get<Ts1, pack_tag<seq<Ns1>, Ts1...>>(BOOST_HOF_FORWARD(P1)(p1))..., 
            zr_boost_1_81::hof::detail::pack_get<Ts2, pack_tag<seq<Ns2>, Ts2...>>(BOOST_HOF_FORWARD(P2)(p2))...)
    )
    {
        return result_type(
            zr_boost_1_81::hof::detail::pack_get<Ts1, pack_tag<seq<Ns1>, Ts1...>>(BOOST_HOF_FORWARD(P1)(p1))..., 
...
struct pack_f
{
    ...
    constexpr auto operator()(Ts&&... xs) const BOOST_HOF_RETURNS
    (
        pack_basic_f()(zr_boost_1_81::hof::decay(BOOST_HOF_FORWARD(Ts)(xs))...)
    );
};
...
struct unpack_sequence<detail::pack_base<T, Ts...>>
{
    ...
    (
        zr_boost_1_81::hof::detail::unpack_pack_base(BOOST_HOF_FORWARD(F)(f), BOOST_HOF_FORWARD(P)(p))
    );
};
