...
/// the `zr_boost_1_81::hof::reveal` adaptor to improve error messages.
/// 
...
#else
#define BOOST_HOF_DETAIL_MAKE_STATIC BOOST_HOF_DETAIL_CONSTEXPR_DEDUCE zr_boost_1_81::hof::detail::static_function_wrapper_factor()
...
#else
#define BOOST_HOF_DETAIL_MAKE_REVEAL_STATIC(T) BOOST_HOF_DETAIL_CONSTEXPR_DEDUCE_UNIQUE(T) zr_boost_1_81::hof::detail::reveal_static_lambda_function_wrapper_factor<T>()
