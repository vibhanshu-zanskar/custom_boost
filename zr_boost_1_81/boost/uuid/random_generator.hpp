...
public:
    ...
    result_type operator()()
    {
        ...
        for (uuid::iterator it = u.begin(), end = u.end(); it != end; ++it, ++i) {
            ...
            // static_cast gets rid of warnings of converting unsigned long to zr_boost_1_81::uint8_t
...
private:
    ...
    typename zr_boost_1_81::enable_if<detail::has_member_function_seed<MaybePseudoRandomNumberGenerator, void> >::type
    ...
    template<class MaybePseudoRandomNumberGenerator>
    typename zr_boost_1_81::disable_if<detail::has_member_function_seed<MaybePseudoRandomNumberGenerator, void> >::type
...
public:
    ...
    random_generator_pure(BOOST_RV_REF(random_generator_pure) that) BOOST_NOEXCEPT :
        prov_(zr_boost_1_81::move(that.prov_))
    {
    }
