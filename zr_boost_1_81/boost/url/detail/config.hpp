...
#  define BOOST_LIB_NAME zr_boost_1_81_url
...
# define BOOST_URL_ERR(ev) (::zr_boost_1_81::system::error_code(ev))
# define BOOST_URL_RETURN_EC(ev) return (ev)
# define BOOST_URL_POS ::zr_boost_1_81::source_location()
#else
# define BOOST_URL_ERR(ev) (::zr_boost_1_81::system::error_code( (ev), [] { \
...
# define BOOST_URL_RETURN_EC(ev) \
    ...
    return ::zr_boost_1_81::system::error_code((ev), &loc ## __LINE__)
