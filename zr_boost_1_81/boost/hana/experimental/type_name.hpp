/*
@file
Defines `zr_boost_1_81::hana::experimental::type_name`.
...
namespace zr_boost_1_81 { namespace hana { namespace experimental {
    namespace detail {
        struct cstring {
            char const* ptr;
            std::size_t length;
        ...
        constexpr cstring type_name_impl2() {
            ...
            constexpr std::size_t prefix_size = sizeof("zr_boost_1_81::hana::experimental::detail::cstring zr_boost_1_81::hana::experimental::detail::type_name_impl2() [T = ") - 1;
