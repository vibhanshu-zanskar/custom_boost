/*
@file
Defines `zr_boost_1_81::hana::experimental::print`.
...
namespace zr_boost_1_81 { namespace hana { namespace experimental {
    ...
    struct print_impl<hana::metafunction_t<F>> {
        ...
        static std::string apply(T const&) {
            return print_detail::strip_type_junk(zr_boost_1_81::core::demangle(typeid(T).name()));
        }
    };
    ...
    struct print_impl<hana::type_tag> {
        ...
        static std::string apply(T const&) {
            ...
            return "type<" + zr_boost_1_81::core::demangle(typeid(Type).name()) + '>';
        }
    };
