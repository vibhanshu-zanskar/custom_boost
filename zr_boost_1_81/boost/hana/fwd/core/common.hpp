/*!
@file
Forward declares `zr_boost_1_81::hana::common` and `zr_boost_1_81::hana::common_t`.
...
namespace zr_boost_1_81 { namespace hana {
    ...
    //! specialize `common` in the `zr_boost_1_81::hana` namespace for pairs of custom
    ...
    //! `common` in the `zr_boost_1_81::hana` namespace.
    //!
