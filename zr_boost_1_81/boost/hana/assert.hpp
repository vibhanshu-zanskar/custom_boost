...
#   define BOOST_HANA_RUNTIME_CHECK_MSG(condition, message)                 \
    do {                                                                    \
        ...
        static_assert(!::zr_boost_1_81::hana::Constant<decltype(__hana_tmp)>::value,\
...
#   define BOOST_HANA_CONSTANT_CHECK_MSG(condition, message)                \
        ...
        static_assert(::zr_boost_1_81::hana::Constant<                              \
        ...
        static_assert(::zr_boost_1_81::hana::value<                                 \
            decltype(BOOST_HANA_PP_CONCAT(__hana_tmp_, __LINE__))           \
        >(), message);                                                      \
        static_assert(true, "force trailing semicolon")                     \
/**/
...
#   define BOOST_HANA_CHECK_MSG(condition, message)                         \
    do {                                                                    \
        auto __hana_tmp = condition;                                        \
        ::zr_boost_1_81::hana::if_(::zr_boost_1_81::hana::bool_c<                           \
            ::zr_boost_1_81::hana::Constant<decltype(__hana_tmp)>::value>,          \
            [](auto expr) {                                                 \
                static_assert(::zr_boost_1_81::hana::value<decltype(expr)>(),       \
                message);                                                   \
            },                                                              \
            [](auto expr) {                                                 \
