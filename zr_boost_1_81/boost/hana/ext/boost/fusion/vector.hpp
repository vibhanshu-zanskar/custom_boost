/*!
@file
Adapts `zr_boost_1_81::fusion::vector` for use with Hana.
...
namespace zr_boost_1_81 { namespace hana {
    ...
    struct tag_of<T, when<
        ...
        >::value
    >> {
        using type = ext::zr_boost_1_81::fusion::vector_tag;
    };

    namespace detail {
        template <>
        struct is_fusion_sequence<ext::zr_boost_1_81::fusion::vector_tag> {
    ...
    //////////////////////////////////////////////////////////////////////////
    template <>
    struct drop_front_impl<ext::zr_boost_1_81::fusion::vector_tag> {
        template <std::size_t n, typename Xs, std::size_t ...i>
        static constexpr auto drop_front_helper(Xs&& xs, std::index_sequence<i...>) {
            return hana::make<ext::zr_boost_1_81::fusion::vector_tag>(
    ...
    //////////////////////////////////////////////////////////////////////////
    template <>
    struct make_impl<ext::zr_boost_1_81::fusion::vector_tag> {
        template <typename ...Xs>
        static constexpr auto apply(Xs&& ...xs) {
            return ::zr_boost_1_81::fusion::make_vector(static_cast<Xs&&>(xs)...);
        }
    };
