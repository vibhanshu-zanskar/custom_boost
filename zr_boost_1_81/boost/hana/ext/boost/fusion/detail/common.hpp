...
namespace zr_boost_1_81 { namespace hana {
    ...
    struct at_impl<S, when<detail::is_fusion_sequence<S>::value>> {
        ...
        static constexpr decltype(auto) apply(Xs&& xs, N const&) {
            ...
            return zr_boost_1_81::fusion::at_c<n>(static_cast<Xs&&>(xs));
        }
    };
    ...
    struct is_empty_impl<S, when<detail::is_fusion_sequence<S>::value>> {
        ...
        static constexpr auto apply(Xs&& xs) {
            using Empty = decltype(zr_boost_1_81::fusion::empty(xs));
    ...
    struct length_impl<S, when<detail::is_fusion_sequence<S>::value>> {
        ...
        static constexpr auto apply(Xs const&) {
            using Size = typename zr_boost_1_81::fusion::result_of::size<Xs>::type;
