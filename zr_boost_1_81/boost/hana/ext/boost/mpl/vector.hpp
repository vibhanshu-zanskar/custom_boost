/*!
@file
Adapts `zr_boost_1_81::mpl::vector` for use with Hana.
...
namespace zr_boost_1_81 { namespace mpl {
    ...
    //! @code
    //!     to<ext::zr_boost_1_81::mpl::vector_tag>(xs) == mpl::vector<t1, ..., tn>
    //! @endcode
...
namespace zr_boost_1_81 { namespace hana {
    namespace ext { namespace zr_boost_1_81 { namespace mpl {
        using vector_tag = ::zr_boost_1_81::mpl::sequence_tag< ::zr_boost_1_81::mpl::vector<>>::type;
    }}}
    ...
    struct tag_of<T, when<
        mpl_detail::is_same_mpl_vector_tag<
            typename ::zr_boost_1_81::mpl::sequence_tag<T>::type,
            ::zr_boost_1_81::mpl::sequence_tag< ::zr_boost_1_81::mpl::vector<>>::type
        >::value
    >> {
        using type = ext::zr_boost_1_81::mpl::vector_tag;
    };
    ...
    //////////////////////////////////////////////////////////////////////////
    template <>
    struct equal_impl<ext::zr_boost_1_81::mpl::vector_tag, ext::zr_boost_1_81::mpl::vector_tag> {
        template <typename Xs, typename Ys>
        static constexpr auto apply(Xs const&, Ys const&) {
            return typename ::zr_boost_1_81::mpl::equal<Xs, Ys>::type{};
        }
    };
    ...
    //////////////////////////////////////////////////////////////////////////
    template <>
    struct length_impl<ext::zr_boost_1_81::mpl::vector_tag> {
        template <typename Xs>
        static constexpr auto apply(Xs const&) {
            return hana::size_c< ::zr_boost_1_81::mpl::size<Xs>::type::value>;
        }
    };
    ...
    //////////////////////////////////////////////////////////////////////////
    template <>
    struct at_impl<ext::zr_boost_1_81::mpl::vector_tag> {
        template <typename Ts, typename N>
        static constexpr auto apply(Ts const&, N const&) {
            constexpr std::size_t n = N::value;
            using T = typename ::zr_boost_1_81::mpl::at_c<Ts, n>::type;
            return hana::type_c<T>;
        }
    };

    template <>
    struct drop_front_impl<ext::zr_boost_1_81::mpl::vector_tag> {
        template <std::size_t n, typename Xs, std::size_t ...i>
        static constexpr auto drop_front_helper(Xs const&, std::index_sequence<i...>) {
            return zr_boost_1_81::mpl::vector<
                typename zr_boost_1_81::mpl::at_c<Xs, n + i>::type...
            >{};
        }
    ...
    template <>
    struct is_empty_impl<ext::zr_boost_1_81::mpl::vector_tag> {
        template <typename xs>
        static constexpr auto apply(xs)
        { return typename ::zr_boost_1_81::mpl::empty<xs>::type{}; }
    };
    ...
    //////////////////////////////////////////////////////////////////////////
    template <typename F>
    struct to_impl<ext::zr_boost_1_81::mpl::vector_tag, F, when<hana::Foldable<F>::value>> {
        template <typename Xs>
        static constexpr auto apply(Xs const& xs) {
            auto vector_type = hana::unpack(xs, hana::template_<zr_boost_1_81::mpl::vector>);
