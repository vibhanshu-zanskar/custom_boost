/*!
@file
Adapts `zr_boost_1_81::mpl::list` for use with Hana.
...
namespace zr_boost_1_81 { namespace mpl {
    ...
    //! @code
    //!     to<ext::zr_boost_1_81::mpl::list_tag>(xs) == mpl::list<t1, ..., tn>{}
    //! @endcode
...
namespace zr_boost_1_81 { namespace hana {
    namespace ext { namespace zr_boost_1_81 { namespace mpl {
        using list_tag = ::zr_boost_1_81::mpl::sequence_tag< ::zr_boost_1_81::mpl::list<>>::type;
    }}}
    ...
    struct tag_of<T, when<
        std::is_same<
            ...
            ::zr_boost_1_81::mpl::sequence_tag< ::zr_boost_1_81::mpl::list<>>::type
        >::value
    >> {
        using type = ext::zr_boost_1_81::mpl::list_tag;
    };
    ...
    //////////////////////////////////////////////////////////////////////////
    template <>
    struct equal_impl<ext::zr_boost_1_81::mpl::list_tag, ext::zr_boost_1_81::mpl::list_tag> {
    ...
    //////////////////////////////////////////////////////////////////////////
    template <>
    struct length_impl<ext::zr_boost_1_81::mpl::list_tag> {
    ...
    //////////////////////////////////////////////////////////////////////////
    template <>
    struct at_impl<ext::zr_boost_1_81::mpl::list_tag> {
    ...
    template <>
    struct drop_front_impl<ext::zr_boost_1_81::mpl::list_tag> {
        template <std::size_t n, typename Xs, std::size_t ...i>
        static constexpr auto drop_front_helper(Xs const&, std::index_sequence<i...>) {
            return zr_boost_1_81::mpl::list<
    ...
    template <>
    struct is_empty_impl<ext::zr_boost_1_81::mpl::list_tag> {
        template <typename Xs>
        static constexpr auto apply(Xs const&)
    ...
    //////////////////////////////////////////////////////////////////////////
    template <typename F>
    struct to_impl<ext::zr_boost_1_81::mpl::list_tag, F, when<hana::Foldable<F>::value>> {
        template <typename Xs>
        static constexpr decltype(auto) apply(Xs&& xs) {
            auto list_type = hana::unpack(static_cast<Xs&&>(xs),
                                          hana::template_<::zr_boost_1_81::mpl::list>);
