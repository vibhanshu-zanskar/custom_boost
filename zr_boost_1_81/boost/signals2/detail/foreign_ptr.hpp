...
namespace zr_boost_1_81
{
  ...
  namespace signals2
  {
    ...
    {};
    template<typename T> struct weak_ptr_traits<zr_boost_1_81::weak_ptr<T> >
    {
      typedef zr_boost_1_81::shared_ptr<T> shared_type;
    };
#ifndef BOOST_NO_CXX11_SMART_PTR
    ...
    template<typename T> struct shared_ptr_traits<zr_boost_1_81::shared_ptr<T> >
    {
      typedef zr_boost_1_81::weak_ptr<T> weak_type;
    };
#ifndef BOOST_NO_CXX11_SMART_PTR
    ...
    namespace detail
    {
      ...
      public:
        ...
        {
          zr_boost_1_81::swap(_p, other._p);
        }
      private:
      ...
      private:
        zr_boost_1_81::scoped_ptr<foreign_weak_ptr_impl_base> _p;
      };
    } // namespace detail
