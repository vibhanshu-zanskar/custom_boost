/*
  Helper class used by variadic implementation of variadic zr_boost_1_81::signals2::signal.
...
// if compiler has std::tuple use it instead of zr_boost_1_81::tuple
// because zr_boost_1_81::tuple does not have variadic template support at present.
#ifdef BOOST_NO_CXX11_HDR_TUPLE
#include <boost/tuple/tuple.hpp>
#define BOOST_SIGNALS2_TUPLE zr_boost_1_81::tuple
#define BOOST_SIGNALS2_GET zr_boost_1_81::get
#else
#include <tuple>
      ...
      private:
        template<typename Func, unsigned ... indices, typename ... Args>
          R m_invoke(Func &func, unsigned_meta_array<indices...>, const BOOST_SIGNALS2_TUPLE<Args...> & args,
            typename zr_boost_1_81::disable_if<zr_boost_1_81::is_void<typename Func::result_type> >::type * = 0
          ) const
        {
        ...
        template<typename Func, unsigned ... indices, typename ... Args>
          R m_invoke(Func &func, unsigned_meta_array<indices...>, const BOOST_SIGNALS2_TUPLE<Args...> & args,
            typename zr_boost_1_81::enable_if<zr_boost_1_81::is_void<typename Func::result_type> >::type * = 0
          ) const
        {
