/*
  zr_boost_1_81::signals2::connection provides a handle to a signal/slot connection.
  ...
  namespace signals2
  {
    ...
    namespace detail
    {
      ...
      public:
        ...
        connection_body(const SlotType &slot_in, const zr_boost_1_81::shared_ptr<mutex_type> &signal_mutex):
      ...
      private:
        mutable zr_boost_1_81::shared_ptr<SlotType> m_slot;
    ...
    public:
      ...
      {}
      connection(const zr_boost_1_81::weak_ptr<detail::connection_body_base> &connectionBody) BOOST_NOEXCEPT:
      ...
      {
        zr_boost_1_81::shared_ptr<detail::connection_body_base> connectionBody(_weak_connection_body.lock());
      ...
      {
        zr_boost_1_81::shared_ptr<detail::connection_body_base> connectionBody(_weak_connection_body.lock());
        zr_boost_1_81::shared_ptr<detail::connection_body_base> otherConnectionBody(other._weak_connection_body.lock());
    ...
    protected:
      ...
      zr_boost_1_81::weak_ptr<detail::connection_body_base> _weak_connection_body;
    };
