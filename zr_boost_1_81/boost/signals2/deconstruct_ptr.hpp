...
// and predestructors through the zr_boost_1_81::signals2::postconstructible and
// zr_boost_1_81::signals2::predestructible base classes.
//
...
namespace zr_boost_1_81
{
  namespace signals2
  {
    ...
    shared_ptr<T> deconstruct_ptr(T *ptr)
    {
      ...
      shared_ptr<T> shared(ptr, zr_boost_1_81::signals2::predestructing_deleter<T>());
