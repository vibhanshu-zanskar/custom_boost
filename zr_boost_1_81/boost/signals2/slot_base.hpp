...
namespace zr_boost_1_81
{
  namespace signals2
  {
    namespace detail
    {
      ...
      typedef zr_boost_1_81::variant<zr_boost_1_81::weak_ptr<trackable_pointee>, zr_boost_1_81::weak_ptr<void>, detail::foreign_void_weak_ptr > void_weak_ptr_variant;
      typedef zr_boost_1_81::variant<zr_boost_1_81::shared_ptr<void>, detail::foreign_void_shared_ptr > void_shared_ptr_variant;
      ...
      public:
        ...
        {
          return zr_boost_1_81::shared_ptr<void>();
        }
      };
    ...
    public:
      ...
      locked_container_type lock() const
      {
        ...
        for(it = tracked_objects().begin(); it != tracked_objects().end(); ++it)
        {
          ...
          {
            zr_boost_1_81::throw_exception(expired_slot());
          }
        }
