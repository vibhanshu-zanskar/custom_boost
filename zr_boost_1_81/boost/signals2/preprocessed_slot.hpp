...
#define BOOST_SIGNALS2_SLOT_N_BINDING_CONSTRUCTOR(z, n, data) \
  ...
  { \
    init_slot_function(zr_boost_1_81::bind(func, BOOST_SIGNALS2_SIGNATURE_ARG_NAMES(n))); \
  }
...
namespace zr_boost_1_81
{
  namespace signals2
  {
    ...
    {
    private:
      typedef typename detail::slotN<zr_boost_1_81::function_traits<Signature>::arity,
