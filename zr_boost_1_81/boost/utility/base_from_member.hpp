...
struct remove_cv_ref
{
    typedef typename ::zr_boost_1_81::remove_cv<typename
     ::zr_boost_1_81::remove_reference<T>::type>::type  type;

};  // zr_boost_1_81::detail::remove_cv_ref
...
struct is_related
    : public ::zr_boost_1_81::is_same<
     typename ::zr_boost_1_81::detail::remove_cv_ref<T>::type,
     typename ::zr_boost_1_81::detail::remove_cv_ref<U>::type >
{};
...
struct enable_if_unrelated
    : public ::zr_boost_1_81::enable_if_c<true>
{};

template<typename T, typename U, typename ...U2>
struct enable_if_unrelated<T, U, U2...>
    : public ::zr_boost_1_81::disable_if< ::zr_boost_1_81::detail::is_related<T, U> >
{};
#endif
...
protected:
    ...
    template <typename ...T, typename EnableIf = typename
     ::zr_boost_1_81::detail::enable_if_unrelated<base_from_member, T...>::type>
...
};  // zr_boost_1_81::base_from_member
