...
#define BOOST_TTI_DETAIL_TRAIT_HAS_STATIC_MEMBER_DATA_OP(trait,name) \
  ...
  struct BOOST_PP_CAT(trait,_detail_hsd_op) \
    ...
    static ::zr_boost_1_81::type_traits::yes_type check2(BOOST_TTI_DETAIL_TP_V *); \
    \
    template<typename BOOST_TTI_DETAIL_TP_U,typename BOOST_TTI_DETAIL_TP_V> \
    ...
    struct ttc_sd \
      { \
      typedef zr_boost_1_81::mpl::bool_<sizeof(has_matching_member<BOOST_TTI_DETAIL_TP_V,BOOST_TTI_DETAIL_TP_U>(0))==sizeof(::zr_boost_1_81::type_traits::yes_type)> type; \
      }; \
    \
...
#define BOOST_TTI_DETAIL_TRAIT_HAS_STATIC_MEMBER_DATA_OP(trait,name) \
  ...
  struct BOOST_PP_CAT(trait,_detail_hsd_op) \
    ...
    static ::zr_boost_1_81::type_traits::yes_type chkt(helper<&BOOST_TTI_DETAIL_TP_U::name> *); \
    \
    template<class BOOST_TTI_DETAIL_TP_U> \
    static ::zr_boost_1_81::type_traits::no_type chkt(...); \
    \
    typedef zr_boost_1_81::mpl::bool_<(!zr_boost_1_81::function_types::is_function<BOOST_TTI_DETAIL_TP_TYPE>::value) && (sizeof(chkt<BOOST_TTI_DETAIL_TP_T>(BOOST_TTI_DETAIL_NULLPTR))==sizeof(::zr_boost_1_81::type_traits::yes_type))> type; \
    }; \
/**/
