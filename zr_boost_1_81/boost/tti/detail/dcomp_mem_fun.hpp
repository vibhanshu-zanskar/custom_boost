...
#define BOOST_TTI_DETAIL_TRAIT_HAS_COMP_MEMBER_FUNCTION(trait,name) \
  ...
  struct BOOST_PP_CAT(trait,_detail_hcmf) \
    ...
    \
    typedef zr_boost_1_81::mpl::bool_<sizeof(chkt<typename cl_type<BOOST_TTI_DETAIL_TP_T>::type>(BOOST_TTI_DETAIL_NULLPTR))==sizeof(::zr_boost_1_81::type_traits::yes_type)> type; \
    }; \
/**/
