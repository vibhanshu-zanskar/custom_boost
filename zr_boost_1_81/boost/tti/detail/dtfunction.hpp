  ...
  namespace tti
    ...
    namespace detail
      ...
      struct tfunction_seq
        {
        typedef typename zr_boost_1_81::mpl::push_front<BOOST_TTI_DETAIL_TP_FS,BOOST_TTI_DETAIL_TP_R>::type ftseq;
        typedef typename zr_boost_1_81::function_types::function_type<ftseq,BOOST_TTI_DETAIL_TP_TAG>::type type;
        };
      }
    }
  }
