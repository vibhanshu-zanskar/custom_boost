...
#define BOOST_TTI_DETAIL_TRAIT_HAS_MEMBER_DATA_OP(trait,name) \
  ...
  struct BOOST_PP_CAT(trait,_detail_hmd_op) \
    ...
    static ::zr_boost_1_81::type_traits::yes_type check2(BOOST_TTI_DETAIL_TP_V BOOST_TTI_DETAIL_TP_U::*); \
    \
    template<typename BOOST_TTI_DETAIL_TP_U,typename BOOST_TTI_DETAIL_TP_V> \
    static ::zr_boost_1_81::type_traits::no_type check2(BOOST_TTI_DETAIL_TP_U); \
    \
    template<typename BOOST_TTI_DETAIL_TP_U,typename BOOST_TTI_DETAIL_TP_V> \
    static typename \
      menable_if \
        < \
        sizeof(check2<BOOST_TTI_DETAIL_TP_U,BOOST_TTI_DETAIL_TP_V>(&BOOST_TTI_DETAIL_TP_U::name))==sizeof(::zr_boost_1_81::type_traits::yes_type), \
        ::zr_boost_1_81::type_traits::yes_type \
        > \
      ::type \
    has_matching_member(int); \
    \
    template<typename BOOST_TTI_DETAIL_TP_U,typename BOOST_TTI_DETAIL_TP_V> \
    static ::zr_boost_1_81::type_traits::no_type has_matching_member(...); \
    \
    template<class BOOST_TTI_DETAIL_TP_U,class BOOST_TTI_DETAIL_TP_V> \
    struct ttc_md \
      { \
      typedef zr_boost_1_81::mpl::bool_<sizeof(has_matching_member<BOOST_TTI_DETAIL_TP_V,typename return_of<BOOST_TTI_DETAIL_TP_U>::type>(0))==sizeof(::zr_boost_1_81::type_traits::yes_type)> type; \
      }; \
    \
...
#define BOOST_TTI_DETAIL_TRAIT_HAS_MEMBER_DATA_INVOKE_ENCLOSING_CLASS(trait) \
  ...
  struct BOOST_PP_CAT(trait,_detail_hmd_invoke_enclosing_class) : \
    BOOST_PP_CAT(trait,_detail_hmd_op) \
        ...
        typename zr_boost_1_81::remove_const<BOOST_TTI_DETAIL_TP_ET>::type \
        > \
    { \
    }; \
/**/
...
#define BOOST_TTI_DETAIL_TRAIT_HAS_MEMBER_DATA(trait,name) \
  ...
  struct BOOST_PP_CAT(trait,_detail_hmd) : \
    zr_boost_1_81::mpl::eval_if \
        < \
        zr_boost_1_81::is_same<BOOST_TTI_DETAIL_TP_TYPE,BOOST_TTI_NAMESPACE::detail::deftype>, \
  ...
  namespace tti
    ...
    namespace detail
      ...
      struct dmem_check_ptmd :
        zr_boost_1_81::mpl::identity<BOOST_TTI_DETAIL_TP_T>
        {
        BOOST_MPL_ASSERT((zr_boost_1_81::function_types::is_member_object_pointer<BOOST_TTI_DETAIL_TP_T>));
        };
      ...
      struct dmem_get_type :
        zr_boost_1_81::mpl::eval_if
          <
          zr_boost_1_81::is_same<BOOST_TTI_DETAIL_TP_T2,BOOST_TTI_NAMESPACE::detail::deftype>,
