...
/**
  ...
  @code
              ...
              The metafunction types and return:
                ...
                BOOST_TTI_TP_FS  = (optional) the parameters of the member function as a zr_boost_1_81::mpl forward sequence
                          if the first parameter is the enclosing type and the member function parameters
                          are not empty.
                
                BOOST_TTI_TP_TAG = (optional) a zr_boost_1_81::function_types tag to apply to the member function
...
#define BOOST_TTI_TRAIT_HAS_MEMBER_FUNCTION(trait,name) \
  ...
  template<class BOOST_TTI_TP_T,class BOOST_TTI_TP_R = BOOST_TTI_NAMESPACE::detail::deftype,class BOOST_TTI_TP_FS = zr_boost_1_81::mpl::vector<>,class BOOST_TTI_TP_TAG = zr_boost_1_81::function_types::null_tag> \
  struct trait \
    { \
    typedef typename \
