...
{
  return zr_boost_1_81::hash_range(str.begin(), str.end());
}
#endif
} // static_strings
...
struct hash<
  ...
  basic_static_string
#else
  zr_boost_1_81::static_strings::basic_static_string<N, CharT, Traits>
#endif
  >
{
  std::size_t
  operator()(
    const zr_boost_1_81::static_strings::basic_static_string<N, CharT, Traits>& str) const noexcept
  {
#ifndef BOOST_STATIC_STRING_STANDALONE
    return zr_boost_1_81::hash_range(str.begin(), str.end());
#else
    using view_type = typename
      zr_boost_1_81::static_strings::basic_string_view<CharT, Traits>;
