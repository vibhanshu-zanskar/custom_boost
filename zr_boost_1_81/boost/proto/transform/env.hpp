...
namespace zr_boost_1_81
{
    ...
    #define BOOST_PROTO_DEFINE_ENV_VAR(TAG, NAME)                                                   \
        ...
        {                                                                                           \
            ...
            zr_boost_1_81::proto::env<TAG, Value &> const                                                   \
                operator =(zr_boost_1_81::reference_wrapper<Value> &value) const                            \
            {                                                                                       \
                return zr_boost_1_81::proto::env<TAG, Value &>(value.get());                                \
            }                                                                                       \
            template<typename Value>                                                                \
            zr_boost_1_81::proto::env<TAG, Value &> const                                                   \
                operator =(zr_boost_1_81::reference_wrapper<Value> const &value) const                      \
            {                                                                                       \
                return zr_boost_1_81::proto::env<TAG, Value &>(value.get());                                \
            }                                                                                       \
            template<typename Value>                                                                \
            typename zr_boost_1_81::disable_if_c<                                                           \
                zr_boost_1_81::is_const<Value>::value                                                       \
              , zr_boost_1_81::proto::env<TAG, typename zr_boost_1_81::proto::detail::value_type<Value>::type>      \
            >::type const operator =(Value &value) const                                            \
            {                                                                                       \
                return zr_boost_1_81::proto::env<TAG, typename zr_boost_1_81::proto::detail::value_type<Value>::type>(value); \
            }                                                                                       \
            template<typename Value>                                                                \
            zr_boost_1_81::proto::env<TAG, typename zr_boost_1_81::proto::detail::value_type<Value const>::type> const \
                operator =(Value const &value) const                                                \
            {                                                                                       \
                return zr_boost_1_81::proto::env<TAG, typename zr_boost_1_81::proto::detail::value_type<Value const>::type>(value); \
            }                                                                                       \
        };                                                                                          \
                                                                                                    \
        TAG const NAME = {}                                                                         \
