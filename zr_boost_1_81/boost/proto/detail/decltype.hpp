...
# define BOOST_PROTO_DECLTYPE_NESTED_TYPEDEF_TPL_(NESTED, EXPR)                                     \
    ...
    static int const BOOST_PP_CAT(sz, NESTED) = sizeof(zr_boost_1_81::proto::detail::check_reference(EXPR));\
    struct NESTED                                                                                   \
...
namespace zr_boost_1_81 { namespace proto
{
    namespace detail
    {
        ...
        {
            using zr_boost_1_81::get_pointer;
            void *(&get_pointer(...))[2];
        ...
        {
            return zr_boost_1_81::addressof(t);
        }
        ...
        using namespace zr_boost_1_81::proto::detail::get_pointerns                                         \
        /**/

        #define BOOST_PROTO_GET_POINTER(Type, Obj)                                                  \
        zr_boost_1_81::proto::detail::proto_get_pointer<Type>(                                              \
            zr_boost_1_81::proto::detail::lvalue(Obj)                                                       \
          , (true ? 0 : get_pointer(Obj))                                                           \
          , (true ? 0 : zr_boost_1_81::addressof(zr_boost_1_81::proto::detail::lvalue(Obj)))                        \
        )                                                                                           \
        /**/
        ...
        namespace get_pointerns
        {
            ...
            ////////////////////////////////////////////////////////////////////////////////////////////
            // result_of_ is a wrapper around zr_boost_1_81::result_of that also handles "invocations" of
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////
        // normalize a function type for use with zr_boost_1_81::result_of
