    ...
    ///             in the \c zr_boost_1_81::proto::tag namespace, but it doesn't
    ///             have to be.
    ///
    ...
    #endif
    {
        ...
        /// If \c Tag is \c zr_boost_1_81::proto::tag::address_of and \c proto_child0 is
        ...
        /// \c zr_boost_1_81::proto::tag::address_of. Otherwise, this function will
        /// fail to compile.
        ///
        ...
        {
            return zr_boost_1_81::addressof(this->child0);
        }
    #else
        /// INTERNAL ONLY
        ///
        ...
        /// Encodes the return type of \c expr\<\>::operator(), for use with \c zr_boost_1_81::result_of\<\>
        ///
