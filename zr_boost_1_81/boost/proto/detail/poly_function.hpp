...
namespace zr_boost_1_81 { namespace proto { namespace detail
{
    ...
    template<typename T>
    struct normalize_arg<zr_boost_1_81::reference_wrapper<T> >
    {
        typedef T &type;
        typedef T &reference;
    };
    ...
    template<typename T>
    struct normalize_arg<zr_boost_1_81::reference_wrapper<T> const>
    {
        typedef T &type;
        typedef T &reference;
    };
...
}}} // namespace zr_boost_1_81::proto::detail
