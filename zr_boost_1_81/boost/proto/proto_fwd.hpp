...
# define BOOST_PROTO_DISABLE_IF_IS_CONST(T)\
    , typename zr_boost_1_81::disable_if_c<zr_boost_1_81::is_const<T>::value, zr_boost_1_81::proto::detail::undefined>::type * = 0
#else
# define BOOST_PROTO_DISABLE_IF_IS_CONST(T)
#endif
...
# define BOOST_PROTO_DISABLE_IF_IS_FUNCTION(T)\
    , typename zr_boost_1_81::disable_if_c<zr_boost_1_81::is_function<T>::value, zr_boost_1_81::proto::detail::undefined>::type * = 0
#else
# define BOOST_PROTO_DISABLE_IF_IS_FUNCTION(T)
#endif
...
# define BOOST_PROTO_RESULT_OF zr_boost_1_81::result_of
#else
# define BOOST_PROTO_RESULT_OF zr_boost_1_81::tr1_result_of
#endif
...
namespace zr_boost_1_81 { namespace proto
{
    namespace detail
    {
        ...
        #define BOOST_PROTO_UNCVREF(X)                                                              \
            typename zr_boost_1_81::proto::detail::uncvref<X>::type                                         \
            /**/
