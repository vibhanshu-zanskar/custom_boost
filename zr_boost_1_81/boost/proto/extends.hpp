...
namespace zr_boost_1_81 { namespace proto
{
    ...
    /// INTERNAL ONLY
    ///
    # define BOOST_PROTO_ADDROF(x) ((char const volatile*)zr_boost_1_81::addressof(x))
    /// INTERNAL ONLY
    ///
    ...
    #define BOOST_PROTO_DEFINE_FUN_OP_IMPL_(Z, N, DATA, Const)                                      \
        ...
        typename BOOST_PROTO_RESULT_OF<                                                             \
            proto_generator(                                                                        \
                typename zr_boost_1_81::proto::result_of::BOOST_PP_CAT(funop, N)<                           \
        ...
        {                                                                                           \
            typedef zr_boost_1_81::proto::result_of::BOOST_PP_CAT(funop, N)<                                \
                proto_derived_expr Const()                                                          \
              , proto_domain                                                                        \
                BOOST_PP_ENUM_TRAILING_PARAMS_Z(Z, N, const A)                                      \
            > funop;                                                                                \
    ...
    #define BOOST_PROTO_DEFINE_FUN_OP_VARIADIC_IMPL_(Const)                                         \
        ...
        typename BOOST_PROTO_RESULT_OF<                                                             \
            proto_generator(                                                                        \
                typename zr_boost_1_81::proto::result_of::funop<                                            \
        ...
        {                                                                                           \
            typedef zr_boost_1_81::proto::result_of::funop<                                                 \
                proto_derived_expr Const()(A const &...)                                            \
              , proto_derived_expr                                                                  \
              , proto_domain                                                                        \
            > funop;                                                                                \
    ...
    #define BOOST_PROTO_BASIC_EXTENDS_(Expr, Derived, Domain)                                       \
        ...
        typedef zr_boost_1_81::proto::tag::proto_expr<proto_tag, proto_domain> fusion_tag;                  \
        ...
        {                                                                                           \
            return zr_boost_1_81::addressof(this->proto_base().child0);                                     \
        }                                                                                           \
                                                                                                    \
        BOOST_PROTO_POP_WARNINGS                                                                    \
        /**/
    ...
    #define BOOST_PROTO_EXTENDS_COPY_ASSIGN_IMPL_(This, Const, Typename)                            \
        ...
        Typename() BOOST_PROTO_RESULT_OF<                                                           \
            Typename() This::proto_generator(                                                       \
                Typename() zr_boost_1_81::proto::base_expr<                                                 \
                    Typename() This::proto_domain                                                   \
                  , zr_boost_1_81::proto::tag::assign                                                       \
                  , zr_boost_1_81::proto::list2<                                                            \
                        This &                                                                      \
                      , This Const() &                                                              \
                    >                                                                               \
                >::type                                                                             \
    ...
    #define BOOST_PROTO_EXTENDS_ASSIGN_IMPL_(ThisConst, ThatConst)                                  \
            ...
            proto_generator(                                                                        \
                typename zr_boost_1_81::proto::base_expr<                                                   \
                  ...
                  , zr_boost_1_81::proto::list2<                                                            \
                      ...
                      , typename zr_boost_1_81::proto::result_of::as_child<A ThatConst(), proto_domain>::type \
                    >                                                                               \
                >::type                                                                             \
            )                                                                                       \
        >::type const                                                                               \
        ...
        {                                                                                           \
            ...
            that_type const that = {                                                                \
              ...
              , zr_boost_1_81::proto::as_child<proto_domain>(a)                                             \
            };                                                                                      \
    ...
    #define BOOST_PROTO_EXTENDS_SUBSCRIPT_IMPL_(ThisConst, ThatConst)                               \
        ...
        typename BOOST_PROTO_RESULT_OF<                                                             \
            proto_generator(                                                                        \
                typename zr_boost_1_81::proto::base_expr<                                                   \
                    proto_domain                                                                    \
                  , zr_boost_1_81::proto::tag::subscript                                                    \
                  , zr_boost_1_81::proto::list2<                                                            \
                        proto_derived_expr ThisConst() &                                            \
                      , typename zr_boost_1_81::proto::result_of::as_child<A ThatConst(), proto_domain>::type \
                    >                                                                               \
    ...
    namespace exprns_
    {
        ...
        struct virtual_member
        {
            ...
            typedef zr_boost_1_81::proto::tag::proto_expr<proto_tag, Domain> fusion_tag;
        ...
        #define BOOST_PROTO_EXTENDS_MEMBER_(R, DOMAIN, ELEM)                                            \
            zr_boost_1_81::proto::exprns_::virtual_member<                                                      \
                proto_derived_expr                                                                      \
