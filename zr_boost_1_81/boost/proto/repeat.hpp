...
#define BOOST_PROTO_ref_a_aux(Z, N, DATA)\
  zr_boost_1_81::ref(BOOST_PP_CAT(proto_a, N))
...
/// \brief Generates a sequence like <tt>zr_boost_1_81::ref(a0), zr_boost_1_81::ref(a1), ...</tt>
///
