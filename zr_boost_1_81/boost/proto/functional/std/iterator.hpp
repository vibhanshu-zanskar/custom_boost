...
namespace zr_boost_1_81 { namespace proto { namespace functional
{
            ...
            typedef
                typename std::iterator_traits<
                    typename zr_boost_1_81::remove_const<
                        typename zr_boost_1_81::remove_reference<InputIter1>::type
                    >::type
                >::difference_type
            type;
        };
    ...
    struct next
    {
        ...
        struct result<This(ForwardIterator)>
        {
            typedef
                typename zr_boost_1_81::remove_const<
                    typename zr_boost_1_81::remove_reference<ForwardIterator>::type
                >::type
            type;
        };
    ...
    struct prior
    {
        ...
        struct result<This(BidirectionalIterator)>
        {
            typedef
                typename zr_boost_1_81::remove_const<
                    typename zr_boost_1_81::remove_reference<BidirectionalIterator>::type
                >::type
            type;
        };
