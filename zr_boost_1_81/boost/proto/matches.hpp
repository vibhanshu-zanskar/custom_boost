...
namespace zr_boost_1_81 { namespace proto
{
    ...
    ///     <tt>zr_boost_1_81::result_of\<when\<_,T\>(E,int,int)\>::type::value</tt>
    ...
    ///     \c E matches <tt>C::case_\<zr_boost_1_81::result_of\<T(E)\>::type\></tt>.
    ...
    /// <tt>zr_boost_1_81::result_of\<when\<_,If\>(E,int,int)\>::type::value</tt>
    /// is \c true and \c E matches \c U; or, if
    /// <tt>zr_boost_1_81::result_of\<when\<_,If\>(E,int,int)\>::type::value</tt>
    ...
    /// if <tt>zr_boost_1_81::result_of\<when\<_,If\>(E,S,V)\>::type::value</tt>
    ...
    /// matches <tt>C::case_\<zr_boost_1_81::result_of\<T(E)\>::type\></tt>.
    ///
    ...
    /// <tt>C::case_\<zr_boost_1_81::result_of\<T(E,S,D)\>::type\>()(e, s, d)</tt>.
