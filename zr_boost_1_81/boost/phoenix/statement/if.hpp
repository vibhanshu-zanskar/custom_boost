...
BOOST_PHOENIX_DEFINE_EXPRESSION_EXT(
    if_actor
  , (zr_boost_1_81)(zr_boost_1_81phoenix)(if_)
  , (meta_grammar) // Cond
    (meta_grammar) // Then
)
    
BOOST_PHOENIX_DEFINE_EXPRESSION(
    (zr_boost_1_81)(zr_boost_1_81phoenix)(if_else_statement)
  , (meta_grammar) // Cond
    (meta_grammar) // Then
    (meta_grammar) // Else
)
...
namespace zr_boost_1_81 { namespace zr_boost_1_81phoenix
{
    ...
    struct if_else_eval
    {
        ...
        {
            if(zr_boost_1_81::zr_boost_1_81phoenix::eval(cond, ctx))
                zr_boost_1_81::zr_boost_1_81phoenix::eval(then, ctx);
        }
        ...
        ) const
        {
            if(zr_boost_1_81::zr_boost_1_81phoenix::eval(cond, ctx))
                ...
                zr_boost_1_81::zr_boost_1_81phoenix::eval(else_, ctx);
        }
    };
