...
namespace zr_boost_1_81 { namespace zr_boost_1_81phoenix
{
    ...
    struct try_catch_eval
    {
        ...
        {
            zr_boost_1_81phoenix::eval(proto::child_c<1>(c), ctx);
        }
        ...
        eval_catch_body(Catch const &c, Exception &e, Context const &ctx) const
        {
            ...
            typedef
                zr_boost_1_81phoenix::scoped_environment<
                    env_type
                  , env_type
                  , local_type
                  , map_type
            ...
            scoped_env_tpe env(zr_boost_1_81phoenix::env(ctx), zr_boost_1_81phoenix::env(ctx), local);

            zr_boost_1_81phoenix::eval(proto::child_c<2>(c), zr_boost_1_81phoenix::context(env, zr_boost_1_81phoenix::actions(ctx)));
        }
    ...
    namespace detail
    {
        struct try_catch_is_nullary
            : proto::or_<
                proto::when<
                    zr_boost_1_81phoenix::rule::catch_all
                  , proto::call<
                        evaluator(
                            proto::_child_c<0>
                          , proto::_data
                ...
                >
              , proto::when<
                    zr_boost_1_81phoenix::rule::catch_
                  , proto::or_<
                        proto::when<
                            zr_boost_1_81phoenix::rule::captured_catch
                          , proto::call<
                                evaluator(
                                    proto::_child_c<2>
                                  , proto::call<
                                        zr_boost_1_81phoenix::functional::context(
                ...
                >
              , proto::when<
                    zr_boost_1_81phoenix::rule::try_catch
                  , proto::make<
                        mpl::and_<
                            proto::call<
                                evaluator(
        ...
        struct catch_push_back<TryCatch, Exception, Capture, Expr, 1>
        {
            typedef
                typename proto::result_of::make_expr<
                    zr_boost_1_81phoenix::tag::catch_
            ...
            typedef
                zr_boost_1_81phoenix::expression::try_catch<
                    TryCatch
                  , catch_expr
                >
                gen_type;
        ...
        struct catch_all_push_back<TryCatch, Expr, 1>
        {
            typedef
                typename proto::result_of::make_expr<
                    zr_boost_1_81phoenix::tag::catch_all
                  , proto::basic_default_domain
                  , Expr
                >::type
                catch_expr;
