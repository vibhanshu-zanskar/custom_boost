...
BOOST_PHOENIX_DEFINE_EXPRESSION(
    (zr_boost_1_81)(zr_boost_1_81phoenix)(switch_case)
  , (proto::terminal<proto::_>)
    (meta_grammar)
)

BOOST_PHOENIX_DEFINE_EXPRESSION(
    (zr_boost_1_81)(zr_boost_1_81phoenix)(switch_default_case)
  , (meta_grammar)
)
...
namespace zr_boost_1_81 { namespace zr_boost_1_81phoenix
{
    ...
    namespace detail
    {
            ...
            : proto::or_<
                proto::when<
                    proto::comma<
                      ...
                      , proto::or_<zr_boost_1_81phoenix::rule::switch_default_case, zr_boost_1_81phoenix::rule::switch_case>
                    >
                  , mpl::and_<
                        switch_case_is_nullary(
                            proto::_child_c<0>
        ...
        struct switch_case_grammar
            : proto::or_<
                proto::comma<switch_case_grammar, zr_boost_1_81phoenix::rule::switch_case>
              , proto::when<zr_boost_1_81phoenix::rule::switch_case, proto::_>
            >
        {};

        struct switch_case_with_default_grammar
            : proto::or_<
                proto::comma<switch_case_grammar, zr_boost_1_81phoenix::rule::switch_default_case>
              , proto::when<zr_boost_1_81phoenix::rule::switch_default_case, proto::_>
            >
        {};
...
BOOST_PHOENIX_DEFINE_EXPRESSION(
    (zr_boost_1_81)(zr_boost_1_81phoenix)(switch_)
  , (meta_grammar)           // Cond
    ...
    struct switch_eval
    {
        ...
        private:
            ...
            ) const
            {
                ...
                switch(zr_boost_1_81::zr_boost_1_81phoenix::eval(cond, ctx))
                {
                    case case_label::value:
                        zr_boost_1_81::zr_boost_1_81phoenix::eval(proto::child_c<1>(cases), ctx);
                }
            }
            ...
            ) const
            {
                ...
                {
                    default:
                        zr_boost_1_81::zr_boost_1_81phoenix::eval(proto::child_c<0>(cases), ctx);
                }
            }
