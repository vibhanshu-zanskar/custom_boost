...
BOOST_PHOENIX_DEFINE_EXPRESSION(
    (zr_boost_1_81)(zr_boost_1_81phoenix)(for_)
  , (meta_grammar) // Cond
    (meta_grammar) // Init
    (meta_grammar) // Step
    (meta_grammar) // Do
...
namespace zr_boost_1_81 { namespace zr_boost_1_81phoenix
{
    struct for_eval
    {
        ...
        {
            for(zr_boost_1_81::zr_boost_1_81phoenix::eval(init, ctx); zr_boost_1_81::zr_boost_1_81phoenix::eval(cond, ctx); zr_boost_1_81::zr_boost_1_81phoenix::eval(step, ctx))
                zr_boost_1_81::zr_boost_1_81phoenix::eval(do_it, ctx);
        }
    };
