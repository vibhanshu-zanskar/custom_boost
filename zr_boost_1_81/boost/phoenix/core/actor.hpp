                ...
                typename zr_boost_1_81::zr_boost_1_81phoenix::evaluator::impl<
                  ...
                  , vector2<
                        typename vector_chooser<sizeof...(A) + 1>::
                          template apply<const ::zr_boost_1_81::zr_boost_1_81phoenix::actor<Expr> *, A...>::type&
                      , default_actions
                    > const &
                  , proto::empty_env
                >::result_type
...
{
    // specialize zr_boost_1_81::result_of to return the proper result type
    template <typename Expr>
    struct result_of<zr_boost_1_81phoenix::actor<Expr>()>
        : zr_boost_1_81phoenix::result_of::actor<typename zr_boost_1_81phoenix::actor<Expr>::proto_base_expr>
    {};

    template <typename Expr>
    struct result_of<zr_boost_1_81phoenix::actor<Expr> const()>
        : zr_boost_1_81phoenix::result_of::actor<typename zr_boost_1_81phoenix::actor<Expr>::proto_base_expr>
    {};
}
