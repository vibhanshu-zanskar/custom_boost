...
#pragma wave option(preserve: 1)
                ...
                typename zr_boost_1_81::add_reference<                                  \
                    typename zr_boost_1_81::add_const<                                  \
                        typename zr_boost_1_81::result_of<                              \
                            zr_boost_1_81::zr_boost_1_81phoenix::evaluator(                          \
                                BOOST_PP_CAT(A, n)                              \
                              , Context                                         \
                            )                                                   \
                        >::type                                                 \
        ...
        #define PHOENIX_EVAL_ARG(z, n, data)                                    \
            help_rvalue_deduction(zr_boost_1_81::zr_boost_1_81phoenix::eval(BOOST_PP_CAT(a, n), ctx))
...
#pragma wave option(output: null)
            ...
            struct result<This(F, BOOST_PHOENIX_A, Context)>
            {
                ...
                typedef typename
                    zr_boost_1_81::result_of<fn(BOOST_PHOENIX_a)>::type
                    type;
            };
            ...
            {
                return zr_boost_1_81::zr_boost_1_81phoenix::eval(f, ctx)(BOOST_PP_ENUM(BOOST_PHOENIX_ITERATION, PHOENIX_EVAL_ARG, _));
            }
