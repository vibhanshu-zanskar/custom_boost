...
BOOST_PHOENIX_DEFINE_EXPRESSION_VARARG(
    (zr_boost_1_81)(zr_boost_1_81phoenix)(detail)(function_eval)
...
namespace zr_boost_1_81 { namespace zr_boost_1_81phoenix {
    namespace detail
    {
        ...
        struct function_eval
        {
            ...
            struct result<This(F, Context)>
            {
                ...
                typedef typename zr_boost_1_81::result_of<fn()>::type type;
            };
            ...
            {
                return zr_boost_1_81::zr_boost_1_81phoenix::eval(f, ctx)();
            }
        ...
        #include <boost/phoenix/core/detail/cpp03/function_eval.hpp>
            ...
            struct result_impl<F, void(A...), Context>
            {
                    ...
                    typedef typename zr_boost_1_81::add_reference<
                        typename zr_boost_1_81::add_const<
                            typename zr_boost_1_81::result_of<
                                zr_boost_1_81::zr_boost_1_81phoenix::evaluator(T, Context)
                            >::type
                        >::type
                    >::type type;
                };
                ...
                {
                    return zr_boost_1_81::zr_boost_1_81phoenix::eval(f, ctx)(help_rvalue_deduction(zr_boost_1_81::zr_boost_1_81phoenix::eval(a, ctx))...);
                }
            };
    ...
    struct default_actions::when<detail::rule::function_eval, Dummy>
        : zr_boost_1_81phoenix::call<detail::function_eval>
    {};
}}
