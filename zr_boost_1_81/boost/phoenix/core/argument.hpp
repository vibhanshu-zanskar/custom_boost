...
namespace zr_boost_1_81 {
    template <int I>
    struct is_placeholder<zr_boost_1_81phoenix::argument<I> >
        : mpl::int_<I>
    {};
}
...
namespace zr_boost_1_81 { namespace zr_boost_1_81phoenix
{
    namespace expression
    {
        template <int I>
        struct argument
            : expression::terminal<zr_boost_1_81phoenix::argument<I> >
        {
            typedef typename expression::terminal<zr_boost_1_81phoenix::argument<I> >::type type;
