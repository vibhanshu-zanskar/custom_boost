...
namespace zr_boost_1_81 { namespace zr_boost_1_81phoenix
{
    ...
    namespace result_of
    {
        ...
        struct is_nullary
            : zr_boost_1_81::zr_boost_1_81phoenix::evaluator::impl<
                Expr const &
              , vector2<
                    mpl::true_
                  , zr_boost_1_81::zr_boost_1_81phoenix::is_nullary
                >
              , proto::empty_env
            >::result_type
        {};
        ...
        template <typename T>
        struct is_nullary<custom_terminal<zr_boost_1_81::reference_wrapper<actor<T> > > >
        {
            BOOST_PROTO_TRANSFORM(is_nullary<custom_terminal<zr_boost_1_81::reference_wrapper<actor<T> > > >)
            template <typename Expr, typename State, typename Data>
            struct impl
            {
        ...
        template <typename T>
        struct is_nullary<custom_terminal<zr_boost_1_81::reference_wrapper<actor<T> const> > >
        {
            BOOST_PROTO_TRANSFORM(is_nullary<custom_terminal<zr_boost_1_81::reference_wrapper<actor<T> const> > >)
            template <typename Expr, typename State, typename Data>
            struct impl
            {
