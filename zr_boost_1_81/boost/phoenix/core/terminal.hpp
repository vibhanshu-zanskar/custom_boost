...
namespace zr_boost_1_81 { namespace zr_boost_1_81phoenix
{
    ...
    {
        struct argument
            : proto::if_<zr_boost_1_81::is_placeholder<proto::_value>()>
        {};

        struct custom_terminal
            : proto::if_<zr_boost_1_81::zr_boost_1_81phoenix::is_custom_terminal<proto::_value>()>
        {};
            ...
            proto::functional::at(
              ...
              , proto::make<
                    detail::placeholder_idx<
                        proto::make<
                            zr_boost_1_81::is_placeholder<proto::_value>()
                        >
                    >()
                >
            )
