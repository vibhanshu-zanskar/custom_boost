...
#define BOOST_PHOENIX_ADAPT_CALLABLE_NULLARY(NAME, FUNC)                        \
    inline                                                                      \
    zr_boost_1_81::zr_boost_1_81phoenix::detail::expression::function_eval<FUNC>::type const         \
    NAME()                                                                      \
    {                                                                           \
        return zr_boost_1_81::zr_boost_1_81phoenix::detail::expression::                             \
...
#define BOOST_PHOENIX_ADAPT_CALLABLE(NAME, FUNC, N)                             \
    ...
    inline                                                                      \
    typename                                                                    \
        zr_boost_1_81::zr_boost_1_81phoenix::detail::expression::function_eval<                      \
            FUNC                                                                \
