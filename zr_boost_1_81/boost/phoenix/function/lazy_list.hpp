...
//////////////////////////////////////////////////////////////////////
    ...
    namespace result_of {
      ...
      {
      public:
        typedef typename zr_boost_1_81::remove_reference<L>::type LType;
...
//////////////////////////////////////////////////////////////////////
   ...
   namespace listlike {
       ...
       void EnsureListLike() {
          ...
          EnsureListLikeHelp<L,zr_boost_1_81::is_base_and_derived<ListLike,LType>::value>::
...
#define BOOST_PHOENIX_FUNCTION_MAX_LAZY_LIST_LENGTH 1000
    ...
    typedef zr_boost_1_81::zr_boost_1_81phoenix::function<impl::Head> Head;
    typedef zr_boost_1_81::zr_boost_1_81phoenix::function<impl::Tail> Tail;
    typedef zr_boost_1_81::zr_boost_1_81phoenix::function<impl::Null> Null;
    typedef zr_boost_1_81::zr_boost_1_81phoenix::function<impl::Delay> Delay;
    typedef zr_boost_1_81::zr_boost_1_81phoenix::function<impl::Force> Force;
    Head head;
    Tail tail;
    Null null;
    Delay delay;
...
namespace impl {
template <class T>
struct strict_cons : public zr_boost_1_81::noncopyable {
   mutable RefCountType refC;
   T head;
   typedef zr_boost_1_81::intrusive_ptr<strict_cons> tail_type;
   tail_type tail;
...
class strict_list_iterator {
   typedef zr_boost_1_81::intrusive_ptr<strict_cons<T> > rep_type;
   rep_type l;
   bool is_nil;
   void advance() {
      l = l->tail;
...
//////////////////////////////////////////////////////////////////////
   ...
   {
       typedef zr_boost_1_81::intrusive_ptr<impl::strict_cons<T> > rep_type;
       rep_type rep;
       struct Make {};
...
//////////////////////////////////////////////////////////////////////{
    namespace impl {
      ...
      class list : public listlike::ListLike
      {
        ...
        zr_boost_1_81::intrusive_ptr<Cache<T> > rep;
        ...
        list( const zr_boost_1_81::intrusive_ptr<Cache<T> >& p ) : rep(p) { }
...
//////////////////////////////////////////////////////////////////////
      ...
      public:
        typedef
        typename zr_boost_1_81::type_with_alignment<zr_boost_1_81::alignment_of<T>::value>::type
        xfst_type;
      private:
...
// memory allocated here is only reclaimed by the operating system.
    ...
    struct fun0_type_helper{
       typedef zr_boost_1_81::function0<odd_list<T> > fun_type;
       typedef zr_boost_1_81::zr_boost_1_81phoenix::function<fun_type> phx_type;
    };
      ...
      struct make_fun0_odd_list {
        ...
        template <class F>
        typename zr_boost_1_81::zr_boost_1_81phoenix::function<F> operator()
          (const zr_boost_1_81::zr_boost_1_81phoenix::function<F>& f) const
        {
            return f;
        }
    ...
    template <class T>
    class Cache : zr_boost_1_81::noncopyable {
       mutable RefCountType refC;
       // This is the zr_boost_1_81::function type
       typedef typename fun0_type_helper<T>::fun_type fun_odd_list_T;
       // This is the zr_boost_1_81::zr_boost_1_81phoenix::function type;
       ...
       static const zr_boost_1_81::intrusive_ptr<Cache<T> >& XEMPTY() {
          static zr_boost_1_81::intrusive_ptr<Cache<T> > xempty( xempty_helper<T>() );
          return xempty;
       }
       static const zr_boost_1_81::intrusive_ptr<Cache<T> >& XNIL() {
       // this list is nil
          static zr_boost_1_81::intrusive_ptr<Cache<T> > xnil( xnil_helper_nil<T>() );
          return xnil;
       }

       static const zr_boost_1_81::intrusive_ptr<Cache<T> >& XBAD() {
       // the pair is invalid; use fxn
          static zr_boost_1_81::intrusive_ptr<Cache<T> > xbad( xnil_helper_bad<T>() );
          return xbad;
       }
...
template <class T, class F> struct ListHelp<T,F,list<T> > {
   zr_boost_1_81::intrusive_ptr<Cache<T> > operator()( const F& f ) const {
      return zr_boost_1_81::intrusive_ptr<Cache<T> >
         (new Cache<T>(typename Cache<T>::CvtFxn(),f));
   }
};
template <class T, class F> struct ListHelp<T,F,odd_list<T> > {
   zr_boost_1_81::intrusive_ptr<Cache<T> > operator()( const F& f ) const {
      return zr_boost_1_81::intrusive_ptr<Cache<T> >(new Cache<T>(f));
   }
};
...
//////////////////////////////////////////////////////////////////////
    namespace impl {
      ...
      struct ConsHelp2<T,F,list<T>,true>
      {
         ...
         static type go( const TT& x, const F& f ) {
            ...
            zr_boost_1_81::intrusive_ptr<Cache<TT> >(new Cache<T>(
      ...
      template <class T, class F> struct ConsHelp1<T,F,false> {
        ...
        typedef ConsHelp2<T,F,L,zr_boost_1_81::is_base_and_derived<ListLike,L>::value> help;
      ...
      struct ConsHelp0<T,L,false> {
          ...
          // identification.
           ...
           zr_boost_1_81::is_base_and_derived<ListLike,LType>::value>::type type;
      };
      ...
      zr_boost_1_81::is_base_and_derived<ListLike,L>::value>::type> {};
        */
        ...
        operator()( const T& x, const L& l ) const {
           ...
           zr_boost_1_81::is_base_and_derived<ListLike,LType>::value> help;
           return help::go(x,l);
          }
        ...
        operator()( const T& x, const a_unique_type_for_nil &n ) const {
           ...
           zr_boost_1_81::is_base_and_derived<ListLike,LL>::value> help;
           return help::go(x,n);
          }
    ...
    typedef zr_boost_1_81::zr_boost_1_81phoenix::function<impl::Cons> Cons;
    Cons cons;
   ...
   // Need to work out the return type here.
      ...
      typename result<Cat(L,M)>::type operator()( const L& l, const M& m ) const
      {
         listlike::EnsureListLike<L>();
         return Helper<L,M,
         zr_boost_1_81::is_base_and_derived<typename listlike::ListLike,M>::value,
    ...
    typedef zr_boost_1_81::zr_boost_1_81phoenix::function<impl::Cat> Cat;
    Cat cat;
