...
namespace zr_boost_1_81 { namespace zr_boost_1_81phoenix { namespace stl
{
///////////////////////////////////////////////////////////////////////////////
//
    ...
    struct const_qualified_reference_of
    {
        typedef typename
            zr_boost_1_81::mpl::eval_if_c<
                zr_boost_1_81::is_const<C>::value
...
///////////////////////////////////////////////////////////////////////////////
    ...
    struct is_key_type_of
        : zr_boost_1_81::is_convertible<Arg, typename key_type_of<C>::type>
    {};
...
///////////////////////////////////////////////////////////////////////////////
    namespace stl_impl
    {
        ...
        struct map_insert_returns_pair
        {
            ...
            typedef zr_boost_1_81::mpl::bool_<value == sizeof(one)> type;
        };
    }
...
}}} // namespace zr_boost_1_81::zr_boost_1_81phoenix::stl
