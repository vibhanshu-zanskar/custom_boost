...
//      ----------------                 --------------
//      my_vector.at(5)                  zr_boost_1_81phoenix::at(arg1, 5)
//      my_list.size()                   zr_boost_1_81phoenix::size(arg1)
//      my_vector1.swap(my_vector2)      zr_boost_1_81phoenix::swap(arg1, arg2)
//
 ...
 && defined(_LIBCPP_VERSION)
        ...
        namespace result_of
        {
                ...
                typedef
                    zr_boost_1_81::mpl::eval_if_c<
                        zr_boost_1_81::mpl::and_<
                            zr_boost_1_81::is_same<Arg3, mpl::void_>
                          , zr_boost_1_81::mpl::not_<zr_boost_1_81::is_same<Arg1, Arg2> >
                        >::value
                      , iterator_of<C>
                      , zr_boost_1_81::mpl::identity<void>
                    >
            ...
            public:
                ...
                typedef typename
                    zr_boost_1_81::mpl::eval_if_c<
                        zr_boost_1_81::is_same<Arg2, mpl::void_>::value
                      , choice_1
                      , choice_2
                    >::type
                type;
    ...
    {
        BOOST_PHOENIX_ADAPT_CALLABLE(assign, zr_boost_1_81::zr_boost_1_81phoenix::stl::assign, 2)
        BOOST_PHOENIX_ADAPT_CALLABLE(assign, zr_boost_1_81::zr_boost_1_81phoenix::stl::assign, 3)
        BOOST_PHOENIX_ADAPT_CALLABLE(assign, zr_boost_1_81::zr_boost_1_81phoenix::stl::assign, 4)
        BOOST_PHOENIX_ADAPT_CALLABLE(at, ::zr_boost_1_81::zr_boost_1_81phoenix::stl::at_impl, 2)
    ...
    using namespace zr_boost_1_81phoenix::adl_barrier;
}} // namespace zr_boost_1_81::zr_boost_1_81phoenix
