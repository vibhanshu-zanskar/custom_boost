...
namespace zr_boost_1_81 { namespace zr_boost_1_81phoenix { namespace tuple_detail
{
...
}}} // namespace zr_boost_1_81::zr_boost_1_81phoenix::tuple_detail

BOOST_PHOENIX_DEFINE_EXPRESSION(
  (zr_boost_1_81)(zr_boost_1_81phoenix)(get_with_type),
  (proto::terminal<tuple_detail::type_wrap<proto::_> >)(meta_grammar))

BOOST_PHOENIX_DEFINE_EXPRESSION(
  (zr_boost_1_81)(zr_boost_1_81phoenix)(get_with_idx),
...
namespace zr_boost_1_81 { namespace zr_boost_1_81phoenix {
    namespace impl {
        struct get_with_type
        {
            ...
            auto& operator()(T, const Expr& t, const Context& ctx) const
            {
                ...
                return get<typename T_::type>(zr_boost_1_81::zr_boost_1_81phoenix::eval(t, ctx));
            }
        };
        ...
        struct get_with_idx
        {
            ...
            auto& operator()(T, const Expr& t, const Context& ctx) const
            {
                using std::get; // Prevents the next line from being a syntax error <
                                // C++20
                using T_ = typename proto::result_of::value<T>::type;
                return get<T_::idx>(zr_boost_1_81::zr_boost_1_81phoenix::eval(t, ctx));
            }
        };
    }
    ...
    namespace placeholders {
        ...
        #define BOOST_PP_LOCAL_MACRO(N)                                                \
            auto uarg##N =                                                             \
            zr_boost_1_81::zr_boost_1_81phoenix::get_<(N)-1>(zr_boost_1_81::zr_boost_1_81phoenix::placeholders::arg1);
