...
namespace zr_boost_1_81 { namespace zr_boost_1_81phoenix
{
    ...
    namespace detail
    {
        struct scope_is_nullary_actions
        {
            ...
            struct when
                : zr_boost_1_81::zr_boost_1_81phoenix::is_nullary::when<Rule, Dummy>
            {};
        };

        template <typename Dummy>
        struct scope_is_nullary_actions::when<zr_boost_1_81::zr_boost_1_81phoenix::rule::custom_terminal, Dummy>
            : proto::or_<
                proto::when<zr_boost_1_81::zr_boost_1_81phoenix::rule::local_variable, mpl::true_()>
              , proto::otherwise<
                    is_nullary::when<zr_boost_1_81::zr_boost_1_81phoenix::rule::custom_terminal, Dummy>
                >
            >
        {};
