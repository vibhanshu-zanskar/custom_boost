...
BOOST_PHOENIX_DEFINE_EXPRESSION(
    (zr_boost_1_81)(zr_boost_1_81phoenix)(lambda_actor)
...
BOOST_PHOENIX_DEFINE_EXPRESSION(
    (zr_boost_1_81)(zr_boost_1_81phoenix)(lambda)
    ...
    struct lambda_eval
    {
        ...
        operator()(OuterEnv const & outer_env, Locals const & locals, Map const &, Lambda const & lambda, Context const & ctx) const
        {
            ...
            typedef
              ...
              , map_type
            >
            env(zr_boost_1_81phoenix::env(ctx), proto::value(outer_env), proto::value(locals));

            return eval(lambda, zr_boost_1_81phoenix::context(env, zr_boost_1_81phoenix::actions(ctx)));
        }
    };
            ...
            return
                expression::
                    lambda<env_type, locals_type, Map, Lambda>::
                        make(zr_boost_1_81phoenix::env(ctx), locals, map, lambda);
        }
    };
