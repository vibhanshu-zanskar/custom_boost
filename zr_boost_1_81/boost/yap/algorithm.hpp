...
namespace zr_boost_1_81 { namespace yap {
    ...
    namespace detail {
            ...
            IsLvalueRef>
        {
            ...
            {
                return ::zr_boost_1_81::yap::detail::value_impl<ValueOfTerminalsOnly>(
                    ::zr_boost_1_81::yap::deref(static_cast<T &&>(x)));
            }
        };
    ...
    namespace detail {
        ...
        struct get_impl<I, Expr, true, IsLvalueRef>
        {
            ...
            {
                return ::zr_boost_1_81::yap::get(
                    ::zr_boost_1_81::yap::deref(static_cast<Expr &&>(expr)), i);
            }
        };
    ...
    */
    ...
    /** Returns <code>get(expr, zr_boost_1_81::hana::llong_c<I>)</code>. */
    template<long long I, typename Expr>
    constexpr decltype(auto) get_c(Expr && expr)
    {
        return ::zr_boost_1_81::yap::get(static_cast<Expr &&>(expr), hana::llong_c<I>);
    }
    ...
    */
    ...
    {
        using namespace hana::literals;
        return ::zr_boost_1_81::yap::get(static_cast<Expr &&>(expr), 0_c);
        constexpr expr_kind kind = detail::remove_cv_ref_t<Expr>::kind;
        static_assert(
            kind == expr_kind::expr_ref ||
    ...
    */
    ...
    {
        using namespace hana::literals;
        return ::zr_boost_1_81::yap::get(static_cast<Expr &&>(expr), 1_c);
        constexpr expr_kind kind = detail::remove_cv_ref_t<Expr>::kind;
        static_assert(
            kind == expr_kind::expr_ref ||
                detail::arity_of<kind>() == detail::expr_arity::two,
    ...
    */
    ...
    {
        using namespace hana::literals;
        return ::zr_boost_1_81::yap::get(static_cast<Expr &&>(expr), 2_c);
        constexpr expr_kind kind = detail::remove_cv_ref_t<Expr>::kind;
        static_assert(
            kind == expr_kind::expr_ref || kind == expr_kind::if_else,
    ...
    */
    ...
    {
        return ::zr_boost_1_81::yap::get(static_cast<Expr &&>(expr), hana::llong_c<0>);
        constexpr expr_kind kind = detail::remove_cv_ref_t<Expr>::kind;
        static_assert(
            kind == expr_kind::expr_ref ||
    ...
    */
    ...
    struct expression_function
    {
        ...
        {
            return ::zr_boost_1_81::yap::evaluate(expr, static_cast<U &&>(u)...);
        }
