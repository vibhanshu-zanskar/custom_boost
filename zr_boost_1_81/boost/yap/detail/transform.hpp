...
namespace zr_boost_1_81 { namespace yap { namespace detail {
    ...
    struct placeholder_transform_t
    {
        ...
        operator()(expr_tag<expr_kind::terminal>, zr_boost_1_81::yap::placeholder<I>) const
        {
            static_assert(
...
//]
    ...
    struct transform_expression_tag<
        ...
        void_t<decltype((*std::declval<TransformTuple>()[hana::llong<I>{}])(
            ...
            terminal_value(::zr_boost_1_81::yap::value(std::declval<Expr>()))))>>
    {
        constexpr decltype(auto) operator()(Expr && expr, TransformTuple transforms) const
        {
            return (*transforms[hana::llong<I>{}])(
                expr_tag<remove_cv_ref_t<Expr>::kind>{},
                terminal_value(
                    ::zr_boost_1_81::yap::value(static_cast<Expr &&>(expr))));
        }
    };
    ...
    struct transform_expression_tag<
        ...
        void_t<decltype((*std::declval<TransformTuple>()[hana::llong<I>{}])(
            expr_tag<remove_cv_ref_t<Expr>::kind>{},
            terminal_value(::zr_boost_1_81::yap::left(std::declval<Expr>())),
            terminal_value(::zr_boost_1_81::yap::right(std::declval<Expr>()))))>>
    {
        constexpr decltype(auto) operator()(Expr && expr, TransformTuple transforms) const
        {
            return (*transforms[hana::llong<I>{}])(
                expr_tag<remove_cv_ref_t<Expr>::kind>{},
                terminal_value(::zr_boost_1_81::yap::left(static_cast<Expr &&>(expr))),
                terminal_value(
                    ::zr_boost_1_81::yap::right(static_cast<Expr &&>(expr))));
        }
    };
    ...
    struct transform_expression_tag<
        ...
        void_t<decltype((*std::declval<TransformTuple>()[hana::llong<I>{}])(
            expr_tag<remove_cv_ref_t<Expr>::kind>{},
            terminal_value(::zr_boost_1_81::yap::cond(std::declval<Expr>())),
            terminal_value(::zr_boost_1_81::yap::then(std::declval<Expr>())),
            terminal_value(::zr_boost_1_81::yap::else_(std::declval<Expr>()))))>>
    {
        constexpr decltype(auto) operator()(Expr && expr, TransformTuple transforms) const
        {
            return (*transforms[hana::llong<I>{}])(
                expr_tag<remove_cv_ref_t<Expr>::kind>{},
                terminal_value(::zr_boost_1_81::yap::cond(static_cast<Expr &&>(expr))),
                terminal_value(::zr_boost_1_81::yap::then(static_cast<Expr &&>(expr))),
                terminal_value(
                    ::zr_boost_1_81::yap::else_(static_cast<Expr &&>(expr))));
        }
    };
    ...
    struct transform_call_unpacker
    {
        ...
        constexpr auto operator()(
            ...
            -> decltype(transform(
                ...
                terminal_value(::zr_boost_1_81::yap::get(
    ...
    struct transform_impl<Strict, I, true>
    {
        ...
        constexpr decltype(auto) operator()(Expr && expr, TransformTuple transforms) const
        {
            return detail::transform_impl<Strict, I, false>{}(
                ::zr_boost_1_81::yap::deref(static_cast<Expr &&>(expr)), transforms);
        }
    };
