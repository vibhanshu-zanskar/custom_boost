...
namespace zr_boost_1_81 { namespace yap {
    ...
    */
    ...
    struct expression
    {
        ...
        {
            return ::zr_boost_1_81::yap::value(*this);
        }
        ...
        constexpr decltype(auto) value() &&
        {
            return ::zr_boost_1_81::yap::value(std::move(*this));
        }
        ...
        /** A convenience member function that dispatches to the free function
            <code>left()</code>. */
        constexpr decltype(auto) left() & { return ::zr_boost_1_81::yap::left(*this); }

#ifndef BOOST_YAP_DOXYGEN

        constexpr decltype(auto) left() const &
        {
            return ::zr_boost_1_81::yap::left(*this);
        }

        constexpr decltype(auto) left() &&
        {
            return ::zr_boost_1_81::yap::left(std::move(*this));
        }
        ...
        {
            return ::zr_boost_1_81::yap::right(*this);
        }
        ...
        constexpr decltype(auto) right() &&
        {
            return ::zr_boost_1_81::yap::right(std::move(*this));
        }

#endif

        BOOST_YAP_USER_ASSIGN_OPERATOR(
            expression, ::zr_boost_1_81::yap::expression)                   // =
        BOOST_YAP_USER_SUBSCRIPT_OPERATOR(::zr_boost_1_81::yap::expression) // []
        BOOST_YAP_USER_CALL_OPERATOR(::zr_boost_1_81::yap::expression)      // ()
    };
    ...
    */
    ...
    /** Returns <code>make_expression<zr_boost_1_81::yap::expression, Kind>(...)</code>.
     */
    ...
    /** Returns <code>make_terminal<zr_boost_1_81::yap::expression>(t)</code>. */
    template<typename T>
    ...
    /** Returns <code>as_expr<zr_boost_1_81::yap::expression>(t)</code>. */
    template<typename T>
