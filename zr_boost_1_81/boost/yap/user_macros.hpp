...
#define BOOST_YAP_USER_UNARY_OPERATOR(                                         \
    ...
    template<::zr_boost_1_81::yap::expr_kind Kind, typename Tuple>                     \
    constexpr auto operator BOOST_YAP_INDIRECT_CALL(op_name)(                  \
        expr_template<Kind, Tuple> const & x)                                  \
    {                                                                          \
        using lhs_type = ::zr_boost_1_81::yap::detail::operand_type_t<                 \
            result_expr_template,                                              \
            expr_template<Kind, Tuple> const &>;                               \
        using tuple_type = ::zr_boost_1_81::hana::tuple<lhs_type>;                     \
        return result_expr_template<                                           \
            ::zr_boost_1_81::yap::expr_kind::op_name,                                  \
            tuple_type>{                                                       \
            tuple_type{::zr_boost_1_81::yap::detail::make_operand<lhs_type>{}(x)}};    \
    }                                                                          \
    template<::zr_boost_1_81::yap::expr_kind Kind, typename Tuple>                     \
    constexpr auto operator BOOST_YAP_INDIRECT_CALL(op_name)(                  \
    ...
    constexpr auto operator BOOST_YAP_INDIRECT_CALL(op_name)(                  \
        expr_template<Kind, Tuple> && x)                                       \
    {                                                                          \
        using tuple_type = ::zr_boost_1_81::hana::tuple<expr_template<Kind, Tuple>>;   \
        return result_expr_template<                                           \
            ::zr_boost_1_81::yap::expr_kind::op_name,                                  \
...
#define BOOST_YAP_USER_BINARY_OPERATOR(                                        \
    op_name, expr_template, result_expr_template)                              \
    template<::zr_boost_1_81::yap::expr_kind Kind, typename Tuple, typename Expr>      \
    constexpr auto operator BOOST_YAP_INDIRECT_CALL(op_name)(                  \
    ...
    {                                                                          \
        using lhs_type = ::zr_boost_1_81::yap::detail::operand_type_t<                 \
            ...
            expr_template<Kind, Tuple> const &>;                               \
        using rhs_type =                                                       \
            ::zr_boost_1_81::yap::detail::operand_type_t<result_expr_template, Expr>;  \
        using tuple_type = ::zr_boost_1_81::hana::tuple<lhs_type, rhs_type>;           \
        return result_expr_template<                                           \
            ::zr_boost_1_81::yap::expr_kind::op_name,                                  \
            tuple_type>{                                                       \
            tuple_type{::zr_boost_1_81::yap::detail::make_operand<lhs_type>{}(lhs),    \
                       ::zr_boost_1_81::yap::detail::make_operand<rhs_type>{}(         \
    ...
    constexpr auto operator BOOST_YAP_INDIRECT_CALL(op_name)(                  \
        expr_template<Kind, Tuple> && lhs, Expr && rhs)                        \
    {                                                                          \
        using lhs_type = ::zr_boost_1_81::yap::detail::remove_cv_ref_t<                \
            expr_template<Kind, Tuple> &&>;                                    \
        using rhs_type =                                                       \
            ::zr_boost_1_81::yap::detail::operand_type_t<result_expr_template, Expr>;  \
        using tuple_type = ::zr_boost_1_81::hana::tuple<lhs_type, rhs_type>;           \
    ...
    template<typename T, ::zr_boost_1_81::yap::expr_kind Kind, typename Tuple>         \
    constexpr auto operator BOOST_YAP_INDIRECT_CALL(op_name)(                  \
        T && lhs, expr_template<Kind, Tuple> && rhs)                           \
        ->::zr_boost_1_81::yap::detail::free_binary_op_result_t<                       \
            result_expr_template,                                              \
            ::zr_boost_1_81::yap::expr_kind::op_name,                                  \
            T,                                                                 \
            expr_template<Kind, Tuple> &&>                                     \
    {                                                                          \
        using result_types = ::zr_boost_1_81::yap::detail::free_binary_op_result<      \
            result_expr_template,                                              \
            ::zr_boost_1_81::yap::expr_kind::op_name,                                  \
            T,                                                                 \
            expr_template<Kind, Tuple> &&>;                                    \
...
#define BOOST_YAP_USER_ASSIGN_OPERATOR(this_type, expr_template)               \
    template<                                                                  \
        ...
        typename = std::enable_if_t<                                           \
            !::zr_boost_1_81::yap::detail::copy_or_move<this_type, Expr &&>::value>>   \
    constexpr auto operator=(Expr && rhs) const &                              \
    {                                                                          \
        using lhs_type = ::zr_boost_1_81::yap::detail::                                \
            operand_type_t<expr_template, this_type const &>;                  \
        using rhs_type =                                                       \
            ::zr_boost_1_81::yap::detail::operand_type_t<expr_template, Expr>;         \
        using tuple_type = ::zr_boost_1_81::hana::tuple<lhs_type, rhs_type>;           \
        return expr_template<::zr_boost_1_81::yap::expr_kind::assign, tuple_type>{     \
            tuple_type{::zr_boost_1_81::yap::detail::make_operand<lhs_type>{}(*this),  \
                       ::zr_boost_1_81::yap::detail::make_operand<rhs_type>{}(         \
                           static_cast<Expr &&>(rhs))}};                       \
    }                                                                          \
    template<                                                                  \
    ...
    {                                                                          \
        using rhs_type =                                                       \
            ::zr_boost_1_81::yap::detail::operand_type_t<expr_template, Expr>;         \
        using tuple_type = ::zr_boost_1_81::hana::tuple<this_type, rhs_type>;          \
        return expr_template<::zr_boost_1_81::yap::expr_kind::assign, tuple_type>{     \
...
#define BOOST_YAP_USER_SUBSCRIPT_OPERATOR(expr_template)                       \
    ...
    {                                                                          \
        ...
        using rhs_type =                                                       \
            ::zr_boost_1_81::yap::detail::operand_type_t<expr_template, Expr>;         \
        using tuple_type = ::zr_boost_1_81::hana::tuple<lhs_type, rhs_type>;           \
        return expr_template<::zr_boost_1_81::yap::expr_kind::subscript, tuple_type>{  \
            tuple_type{::zr_boost_1_81::yap::detail::make_operand<lhs_type>{}(*this),  \
                       ::zr_boost_1_81::yap::detail::make_operand<rhs_type>{}(         \
                           static_cast<Expr &&>(rhs))}};                       \
    }                                                                          \
    ...
    {                                                                          \
        using lhs_type =                                                       \
            ::zr_boost_1_81::yap::detail::remove_cv_ref_t<decltype(*this)>;            \
        using rhs_type =                                                       \
            ::zr_boost_1_81::yap::detail::operand_type_t<expr_template, Expr>;         \
        using tuple_type = ::zr_boost_1_81::hana::tuple<lhs_type, rhs_type>;           \
        return expr_template<::zr_boost_1_81::yap::expr_kind::subscript, tuple_type>{  \
...
#define BOOST_YAP_USER_CALL_OPERATOR(expr_template)                            \
    ...
    {                                                                          \
        using lhs_type = ::zr_boost_1_81::yap::detail::                                \
            operand_type_t<expr_template, decltype(*this)>;                    \
        using tuple_type = ::zr_boost_1_81::hana::tuple<                               \
            lhs_type,                                                          \
            ::zr_boost_1_81::yap::detail::operand_type_t<expr_template, U>...>;        \
        return expr_template<::zr_boost_1_81::yap::expr_kind::call, tuple_type>{       \
            tuple_type{                                                        \
                ::zr_boost_1_81::yap::detail::make_operand<lhs_type>{}(*this),         \
                ::zr_boost_1_81::yap::detail::make_operand<                            \
                    ::zr_boost_1_81::yap::detail::operand_type_t<expr_template, U>>{}( \
                    static_cast<U &&>(u))...}};                                \
    }                                                                          \
    template<typename... U>                                                    \
...
#define BOOST_YAP_USER_CALL_OPERATOR_OPERAND_T(z, n, expr_template)            \
    ::zr_boost_1_81::yap::detail::operand_type_t<expr_template, BOOST_PP_CAT(U, n)>
#define BOOST_YAP_USER_CALL_OPERATOR_MAKE_OPERAND(z, n, expr_template)         \
    ::zr_boost_1_81::yap::detail::make_operand<::zr_boost_1_81::yap::detail::operand_type_t<   \
        expr_template,                                                         \
        BOOST_PP_CAT(U, n)>>{}(                                                \
...
#define BOOST_YAP_USER_EXPR_IF_ELSE(expr_template)                             \
    ...
    constexpr auto if_else(Expr1 && expr1, Expr2 && expr2, Expr3 && expr3)     \
        ->::zr_boost_1_81::yap::detail::                                               \
            ternary_op_result_t<expr_template, Expr1, Expr2, Expr3>            \
    {                                                                          \
        using result_types = ::zr_boost_1_81::yap::detail::                            \
        ...
        using tuple_type =                                                     \
            ::zr_boost_1_81::hana::tuple<cond_type, then_type, else_type>;             \
        return {tuple_type{::zr_boost_1_81::yap::detail::make_operand<cond_type>{}(    \
                               static_cast<Expr1 &&>(expr1)),                  \
                           ::zr_boost_1_81::yap::detail::make_operand<then_type>{}(    \
                               static_cast<Expr2 &&>(expr2)),                  \
                           ::zr_boost_1_81::yap::detail::make_operand<else_type>{}(    \
...
#define BOOST_YAP_USER_UDT_ANY_IF_ELSE(expr_template, udt_trait)               \
    template<typename Expr1, typename Expr2, typename Expr3>                   \
    constexpr auto if_else(Expr1 && expr1, Expr2 && expr2, Expr3 && expr3)     \
        ->::zr_boost_1_81::yap::detail::udt_any_ternary_op_result_t<                   \
            expr_template,                                                     \
            Expr1,                                                             \
            Expr2,                                                             \
            Expr3,                                                             \
            udt_trait>                                                         \
    {                                                                          \
        using result_types = ::zr_boost_1_81::yap::detail::udt_any_ternary_op_result<  \
            expr_template,                                                     \
            Expr1,                                                             \
            Expr2,                                                             \
            Expr3,                                                             \
...
#define BOOST_YAP_USER_UDT_UNARY_OPERATOR(op_name, expr_template, udt_trait)   \
    ...
    constexpr auto operator BOOST_YAP_INDIRECT_CALL(op_name)(T && x)           \
        ->::zr_boost_1_81::yap::detail::udt_unary_op_result_t<                         \
            expr_template,                                                     \
            ::zr_boost_1_81::yap::expr_kind::op_name,                                  \
            T,                                                                 \
            udt_trait>                                                         \
    {                                                                          \
        using result_types = ::zr_boost_1_81::yap::detail::udt_unary_op_result<        \
            expr_template,                                                     \
            ::zr_boost_1_81::yap::expr_kind::op_name,                                  \
            T,                                                                 \
            udt_trait>;                                                        \
        using x_type = typename result_types::x_type;                          \
        using tuple_type = ::zr_boost_1_81::hana::tuple<x_type>;                       \
...
#define BOOST_YAP_USER_UDT_UDT_BINARY_OPERATOR(                                \
    ...
    constexpr auto operator BOOST_YAP_INDIRECT_CALL(op_name)(T && lhs, U && rhs) \
        ->::zr_boost_1_81::yap::detail::udt_udt_binary_op_result_t<                    \
            expr_template,                                                     \
            ::zr_boost_1_81::yap::expr_kind::op_name,                                  \
            T,                                                                 \
            U,                                                                 \
            ...
            u_udt_trait>                                                       \
    {                                                                          \
        using result_types = ::zr_boost_1_81::yap::detail::udt_udt_binary_op_result<   \
            expr_template,                                                     \
            ::zr_boost_1_81::yap::expr_kind::op_name,                                  \
            T,                                                                 \
            U,                                                                 \
...
#define BOOST_YAP_USER_UDT_ANY_BINARY_OPERATOR(                                \
    ...
    template<typename T, typename U>                                           \
    constexpr auto operator BOOST_YAP_INDIRECT_CALL(op_name)(T && lhs, U && rhs) \
        ->::zr_boost_1_81::yap::detail::udt_any_binary_op_result_t<                    \
            expr_template,                                                     \
            ::zr_boost_1_81::yap::expr_kind::op_name,                                  \
            T,                                                                 \
            U,                                                                 \
            udt_trait>                                                         \
    {                                                                          \
        using result_types = ::zr_boost_1_81::yap::detail::udt_any_binary_op_result<   \
            expr_template,                                                     \
            ::zr_boost_1_81::yap::expr_kind::op_name,                                  \
            T,                                                                 \
            U,                                                                 \
...
#define BOOST_YAP_USER_LITERAL_PLACEHOLDER_OPERATOR(expr_template)             \
    ...
    {                                                                          \
        using i = ::zr_boost_1_81::hana::llong<                                        \
            ::zr_boost_1_81::hana::ic_detail::parse<sizeof...(c)>({c...})>;            \
        static_assert(1 <= i::value, "Placeholders must be >= 1.");            \
        return expr_template<                                                  \
            ::zr_boost_1_81::yap::expr_kind::terminal,                                 \
            ::zr_boost_1_81::hana::tuple<::zr_boost_1_81::yap::placeholder<i::value>>>{};      \
    }
